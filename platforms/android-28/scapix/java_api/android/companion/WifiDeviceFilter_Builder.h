...
class WifiDeviceFilter_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_COMPANION_WIFIDEVICEFILTER_BUILDER
...
public:
	...
	static jni::ref<android::companion::WifiDeviceFilter_Builder> new_object() { return object_base::new_object(); }
	jni::ref<android::companion::WifiDeviceFilter_Builder> setNamePattern(jni::ref<java::util::regex::Pattern> regex) { return call_method<"setNamePattern", jni::ref<android::companion::WifiDeviceFilter_Builder>>(regex); }
