...
public:
	...
	jboolean hasCarrierFrequencyHz(jint satIndex) { return call_method<"hasCarrierFrequencyHz", jboolean>(satIndex); }
	jfloat getCarrierFrequencyHz(jint satIndex) { return call_method<"getCarrierFrequencyHz", jfloat>(satIndex); }
};
