...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITEOPENHELPER
...
public:
	...
	static jni::ref<android::database::sqlite::SQLiteOpenHelper> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> name, jni::ref<android::database::sqlite::SQLiteDatabase_CursorFactory> factory, jint version) { return object_base::new_object(context, name, factory, version); }
	static jni::ref<android::database::sqlite::SQLiteOpenHelper> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> name, jni::ref<android::database::sqlite::SQLiteDatabase_CursorFactory> factory, jint version, jni::ref<android::database::DatabaseErrorHandler> errorHandler) { return object_base::new_object(context, name, factory, version, errorHandler); }
	static jni::ref<android::database::sqlite::SQLiteOpenHelper> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> name, jint version, jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams> openParams) { return object_base::new_object(context, name, version, openParams); }
