...
#ifndef SCAPIX_JAVA_API_ANDROID_DRM_DRMSTORE_RIGHTSSTATUS
...
public:
	...
	static jni::ref<android::drm::DrmStore_RightsStatus> new_object() { return object_base::new_object(); }
};
