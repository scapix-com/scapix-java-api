...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATEFORMAT_BOOLEANATTRIBUTE
...
public:
	...
	static jni::ref<android::icu::text::DateFormat_BooleanAttribute> PARSE_PARTIAL_MATCH() { return get_static_field<"PARSE_PARTIAL_MATCH", jni::ref<android::icu::text::DateFormat_BooleanAttribute>>(); }
