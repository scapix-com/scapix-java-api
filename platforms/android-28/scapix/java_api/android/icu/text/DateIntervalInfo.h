...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATEINTERVALINFO
...
public:
	...
	static jni::ref<android::icu::text::DateIntervalInfo> new_object(jni::ref<android::icu::util::ULocale> locale) { return object_base::new_object(locale); }
	static jni::ref<android::icu::text::DateIntervalInfo> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
