...
namespace scapix::java_api::android::provider { class MediaStore_Audio_Albums; }
...
public:
	...
	static jni::ref<android::provider::MediaStore_Audio_Albums> new_object() { return base_::new_object(); }
