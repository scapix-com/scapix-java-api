...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHHIDDEVICE_CALLBACK
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothHidDevice_Callback> new_object() { return object_base::new_object(); }
