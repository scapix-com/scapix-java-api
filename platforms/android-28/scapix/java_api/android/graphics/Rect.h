...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_RECT
...
public:
	...
	static jni::ref<android::graphics::Rect> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::Rect> new_object(jint left, jint top, jint right, jint bottom) { return object_base::new_object(left, top, right, bottom); }
	static jni::ref<android::graphics::Rect> new_object(jni::ref<android::graphics::Rect> r) { return object_base::new_object(r); }
