...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_DRAWABLEWRAPPER
...
public:
	...
	static jni::ref<android::graphics::drawable::DrawableWrapper> new_object(jni::ref<android::graphics::drawable::Drawable> dr) { return object_base::new_object(dr); }
