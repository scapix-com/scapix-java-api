...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_PROPERTY
...
public:
	...
	static jni::ref<android::util::Property> new_object(jni::ref<java::lang::Class> type, jni::ref<java::lang::String> name) { return object_base::new_object(type, name); }
