...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_BROWSE_MEDIABROWSER_MEDIAITEM
...
public:
	...
	static jni::ref<android::media::browse::MediaBrowser_MediaItem> new_object(jni::ref<android::media::MediaDescription> description, jint flags) { return object_base::new_object(description, flags); }
