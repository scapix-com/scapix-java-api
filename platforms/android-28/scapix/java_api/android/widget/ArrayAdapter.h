...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_ARRAYADAPTER
...
public:
	...
	static jni::ref<android::widget::ArrayAdapter> new_object(jni::ref<android::content::Context> context, jint resource) { return object_base::new_object(context, resource); }
	static jni::ref<android::widget::ArrayAdapter> new_object(jni::ref<android::content::Context> context, jint resource, jint textViewResourceId) { return object_base::new_object(context, resource, textViewResourceId); }
	static jni::ref<android::widget::ArrayAdapter> new_object(jni::ref<android::content::Context> context, jint resource, jni::ref<jni::array<java::lang::Object>> objects) { return object_base::new_object(context, resource, objects); }
	static jni::ref<android::widget::ArrayAdapter> new_object(jni::ref<android::content::Context> context, jint resource, jint textViewResourceId, jni::ref<jni::array<java::lang::Object>> objects) { return object_base::new_object(context, resource, textViewResourceId, objects); }
	static jni::ref<android::widget::ArrayAdapter> new_object(jni::ref<android::content::Context> context, jint resource, jni::ref<java::util::List> objects) { return object_base::new_object(context, resource, objects); }
	static jni::ref<android::widget::ArrayAdapter> new_object(jni::ref<android::content::Context> context, jint resource, jint textViewResourceId, jni::ref<java::util::List> objects) { return object_base::new_object(context, resource, textViewResourceId, objects); }
