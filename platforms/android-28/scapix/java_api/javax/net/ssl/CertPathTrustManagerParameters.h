...
public:
	...
	static jni::ref<javax::net::ssl::CertPathTrustManagerParameters> new_object(jni::ref<java::security::cert::CertPathParameters> parameters) { return object_base::new_object(parameters); }
