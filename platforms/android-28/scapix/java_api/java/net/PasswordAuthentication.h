...
#ifndef SCAPIX_JAVA_API_JAVA_NET_PASSWORDAUTHENTICATION
...
public:
	...
	static jni::ref<java::net::PasswordAuthentication> new_object(jni::ref<java::lang::String> userName, jni::ref<jni::array<jchar>> password) { return object_base::new_object(userName, password); }
