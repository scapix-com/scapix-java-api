...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_ASYNCHRONOUSSOCKETCHANNEL
...
public:
	...
	static jni::ref<java::nio::channels::AsynchronousSocketChannel> open(jni::ref<java::nio::channels::AsynchronousChannelGroup> group) { return call_static_method<"open", jni::ref<java::nio::channels::AsynchronousSocketChannel>>(group); }
	...
	void read(jni::ref<java::nio::ByteBuffer> dst, jni::ref<java::lang::Object> attachment, jni::ref<java::nio::channels::CompletionHandler> handler) { return call_method<"read", void>(dst, attachment, handler); }
	...
	void write(jni::ref<java::nio::ByteBuffer> src, jni::ref<java::lang::Object> attachment, jni::ref<java::nio::channels::CompletionHandler> handler) { return call_method<"write", void>(src, attachment, handler); }
