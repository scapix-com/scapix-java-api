...
public:
	...
	static jni::ref<java::util::ServiceConfigurationError> new_object(jni::ref<java::lang::String> msg) { return base_::new_object(msg); }
	static jni::ref<java::util::ServiceConfigurationError> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> cause) { return base_::new_object(msg, cause); }
