...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_PREFS_NODECHANGEEVENT
...
public:
	...
	static jni::ref<java::util::prefs::NodeChangeEvent> new_object(jni::ref<java::util::prefs::Preferences> parent, jni::ref<java::util::prefs::Preferences> child) { return object_base::new_object(parent, child); }
