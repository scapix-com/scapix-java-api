...
#ifndef SCAPIX_JAVA_API_JAVA_IO_FILEOUTPUTSTREAM
...
public:
	...
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::lang::String> name, jboolean append) { return object_base::new_object(name, append); }
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::io::File> file, jboolean append) { return object_base::new_object(file, append); }
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::io::FileDescriptor> fdObj) { return object_base::new_object(fdObj); }
