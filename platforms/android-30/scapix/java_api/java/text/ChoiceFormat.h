...
public:
	...
	static jni::ref<java::text::ChoiceFormat> new_object(jni::ref<java::lang::String> newPattern) { return object_base::new_object(newPattern); }
	...
	jni::ref<java::lang::StringBuffer> format(jlong number, jni::ref<java::lang::StringBuffer> toAppendTo, jni::ref<java::text::FieldPosition> status) { return call_method<"format", jni::ref<java::lang::StringBuffer>>(number, toAppendTo, status); }
	jni::ref<java::lang::StringBuffer> format(jdouble number, jni::ref<java::lang::StringBuffer> toAppendTo, jni::ref<java::text::FieldPosition> status) { return call_method<"format", jni::ref<java::lang::StringBuffer>>(number, toAppendTo, status); }
	...
	static jdouble nextDouble(jdouble d, jboolean positive) { return call_static_method<"nextDouble", jdouble>(d, positive); }
};
