...
public:
	...
	jni::ref<java::time::chrono::JapaneseDate> minus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> p2) { return call_method<"minus", jni::ref<java::time::chrono::JapaneseDate>>(amountToAdd, p2); }
