...
public:
	...
	static jni::ref<java::io::ObjectStreamField> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type) { return base_::new_object(name, type); }
	static jni::ref<java::io::ObjectStreamField> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type, jboolean unshared) { return base_::new_object(name, type, unshared); }
