...
public:
	...
	jlong getAndAccumulate(jni::ref<java::lang::Object> obj, jlong x, jni::ref<java::util::function::LongBinaryOperator> p3) { return call_method<"getAndAccumulate", jlong>(obj, x, p3); }
	jlong accumulateAndGet(jni::ref<java::lang::Object> obj, jlong x, jni::ref<java::util::function::LongBinaryOperator> p3) { return call_method<"accumulateAndGet", jlong>(obj, x, p3); }
