...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_DATATRUNCATION
...
public:
	...
	static jni::ref<java::sql::DataTruncation> new_object(jint index, jboolean parameter, jboolean read, jint dataSize, jint transferSize) { return object_base::new_object(index, parameter, read, dataSize, transferSize); }
	static jni::ref<java::sql::DataTruncation> new_object(jint index, jboolean parameter, jboolean read, jint dataSize, jint transferSize, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(index, parameter, read, dataSize, transferSize, cause); }
