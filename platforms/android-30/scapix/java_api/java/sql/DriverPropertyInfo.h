...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_DRIVERPROPERTYINFO
...
public:
	...
	static jni::ref<java::sql::DriverPropertyInfo> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> value) { return object_base::new_object(name, value); }
};
