...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHARSET_UNSUPPORTEDCHARSETEXCEPTION
...
public:
	...
	static jni::ref<java::nio::charset::UnsupportedCharsetException> new_object(jni::ref<java::lang::String> charsetName) { return object_base::new_object(charsetName); }
