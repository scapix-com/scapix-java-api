...
#ifndef SCAPIX_JAVA_API_ANDROID_DRM_DRMMANAGERCLIENT
...
public:
	...
	static jni::ref<android::drm::DrmManagerClient> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
