...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_ANNOTATION
...
public:
	...
	static jni::ref<android::text::Annotation> new_object(jni::ref<java::lang::String> key, jni::ref<java::lang::String> value) { return object_base::new_object(key, value); }
	static jni::ref<android::text::Annotation> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
