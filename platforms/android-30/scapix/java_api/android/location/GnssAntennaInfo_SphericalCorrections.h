...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSANTENNAINFO_SPHERICALCORRECTIONS
...
public:
	...
	static jni::ref<android::location::GnssAntennaInfo_SphericalCorrections> new_object(jni::ref<jni::array<jni::array<jdouble>>> corrections, jni::ref<jni::array<jni::array<jdouble>>> correctionUncertainties) { return object_base::new_object(corrections, correctionUncertainties); }
