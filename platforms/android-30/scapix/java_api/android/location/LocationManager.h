...
public:
	...
	void addProximityAlert(jdouble latitude, jdouble longitude, jfloat radius, jlong expiration, jni::ref<android::app::PendingIntent> intent) { return call_method<"addProximityAlert", void>(latitude, longitude, radius, expiration, intent); }
