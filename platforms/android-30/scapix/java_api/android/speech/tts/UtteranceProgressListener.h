...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_TTS_UTTERANCEPROGRESSLISTENER
...
public:
	...
	static jni::ref<android::speech::tts::UtteranceProgressListener> new_object() { return object_base::new_object(); }
	...
	void onRangeStart(jni::ref<java::lang::String> utteranceId, jint start, jint end, jint frame) { return call_method<"onRangeStart", void>(utteranceId, start, end, frame); }
};
