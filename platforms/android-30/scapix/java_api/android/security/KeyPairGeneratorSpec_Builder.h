...
class KeyPairGeneratorSpec_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_KEYPAIRGENERATORSPEC_BUILDER
...
public:
	...
	static jni::ref<android::security::KeyPairGeneratorSpec_Builder> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
