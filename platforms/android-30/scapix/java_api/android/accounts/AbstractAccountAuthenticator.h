...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCOUNTS_ABSTRACTACCOUNTAUTHENTICATOR
...
public:
	...
	static jni::ref<java::lang::String> KEY_CUSTOM_TOKEN_EXPIRY() { return get_static_field<"KEY_CUSTOM_TOKEN_EXPIRY", jni::ref<java::lang::String>>(); }

	static jni::ref<android::accounts::AbstractAccountAuthenticator> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	jni::ref<android::os::Bundle> startAddAccountSession(jni::ref<android::accounts::AccountAuthenticatorResponse> response, jni::ref<java::lang::String> accountType, jni::ref<java::lang::String> authTokenType, jni::ref<jni::array<java::lang::String>> requiredFeatures, jni::ref<android::os::Bundle> options) { return call_method<"startAddAccountSession", jni::ref<android::os::Bundle>>(response, accountType, authTokenType, requiredFeatures, options); }
	jni::ref<android::os::Bundle> startUpdateCredentialsSession(jni::ref<android::accounts::AccountAuthenticatorResponse> response, jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> authTokenType, jni::ref<android::os::Bundle> options) { return call_method<"startUpdateCredentialsSession", jni::ref<android::os::Bundle>>(response, account, authTokenType, options); }
	jni::ref<android::os::Bundle> finishSession(jni::ref<android::accounts::AccountAuthenticatorResponse> response, jni::ref<java::lang::String> accountType, jni::ref<android::os::Bundle> sessionBundle) { return call_method<"finishSession", jni::ref<android::os::Bundle>>(response, accountType, sessionBundle); }
	jni::ref<android::os::Bundle> isCredentialsUpdateSuggested(jni::ref<android::accounts::AccountAuthenticatorResponse> response, jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> statusToken) { return call_method<"isCredentialsUpdateSuggested", jni::ref<android::os::Bundle>>(response, account, statusToken); }
};
