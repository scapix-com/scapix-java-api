...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_USAGE_USAGEEVENTS_EVENT
...
public:
	...
	static jint ACTIVITY_PAUSED() { return get_static_field<"ACTIVITY_PAUSED", jint>(); }
	static jint ACTIVITY_RESUMED() { return get_static_field<"ACTIVITY_RESUMED", jint>(); }
	static jint ACTIVITY_STOPPED() { return get_static_field<"ACTIVITY_STOPPED", jint>(); }
	static jint CONFIGURATION_CHANGE() { return get_static_field<"CONFIGURATION_CHANGE", jint>(); }
	static jint DEVICE_SHUTDOWN() { return get_static_field<"DEVICE_SHUTDOWN", jint>(); }
	static jint DEVICE_STARTUP() { return get_static_field<"DEVICE_STARTUP", jint>(); }
	static jint FOREGROUND_SERVICE_START() { return get_static_field<"FOREGROUND_SERVICE_START", jint>(); }
	static jint FOREGROUND_SERVICE_STOP() { return get_static_field<"FOREGROUND_SERVICE_STOP", jint>(); }
	...
	static jni::ref<android::app::usage::UsageEvents_Event> new_object() { return object_base::new_object(); }
