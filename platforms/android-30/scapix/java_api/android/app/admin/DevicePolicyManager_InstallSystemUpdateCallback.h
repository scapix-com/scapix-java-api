...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ADMIN_DEVICEPOLICYMANAGER_INSTALLSYSTEMUPDATECALLBACK
...
public:
	...
	static jni::ref<android::app::admin::DevicePolicyManager_InstallSystemUpdateCallback> new_object() { return object_base::new_object(); }
