...
public:
	...
	void setAlwaysOnVpnPackage(jni::ref<android::content::ComponentName> admin, jni::ref<java::lang::String> vpnPackage, jboolean lockdownEnabled, jni::ref<java::util::Set> lockdownWhitelist) { return call_method<"setAlwaysOnVpnPackage", void>(admin, vpnPackage, lockdownEnabled, lockdownWhitelist); }
