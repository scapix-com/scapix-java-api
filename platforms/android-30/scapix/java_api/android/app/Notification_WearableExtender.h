...
class Notification_WearableExtender;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_WEARABLEEXTENDER
...
public:
	...
	static jni::ref<android::app::Notification_WearableExtender> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::Notification_WearableExtender> new_object(jni::ref<android::app::Notification> notif) { return object_base::new_object(notif); }
	...
	jni::ref<android::app::Notification_WearableExtender> setHintAmbientBigPicture(jboolean hintAmbientBigPicture) { return call_method<"setHintAmbientBigPicture", jni::ref<android::app::Notification_WearableExtender>>(hintAmbientBigPicture); }
	jboolean getHintAmbientBigPicture() { return call_method<"getHintAmbientBigPicture", jboolean>(); }
	jni::ref<android::app::Notification_WearableExtender> setHintContentIntentLaunchesActivity(jboolean hintContentIntentLaunchesActivity) { return call_method<"setHintContentIntentLaunchesActivity", jni::ref<android::app::Notification_WearableExtender>>(hintContentIntentLaunchesActivity); }
	jboolean getHintContentIntentLaunchesActivity() { return call_method<"getHintContentIntentLaunchesActivity", jboolean>(); }
	jni::ref<android::app::Notification_WearableExtender> setDismissalId(jni::ref<java::lang::String> dismissalId) { return call_method<"setDismissalId", jni::ref<android::app::Notification_WearableExtender>>(dismissalId); }
	jni::ref<java::lang::String> getDismissalId() { return call_method<"getDismissalId", jni::ref<java::lang::String>>(); }
	jni::ref<android::app::Notification_WearableExtender> setBridgeTag(jni::ref<java::lang::String> bridgeTag) { return call_method<"setBridgeTag", jni::ref<android::app::Notification_WearableExtender>>(bridgeTag); }
	jni::ref<java::lang::String> getBridgeTag() { return call_method<"getBridgeTag", jni::ref<java::lang::String>>(); }
};
