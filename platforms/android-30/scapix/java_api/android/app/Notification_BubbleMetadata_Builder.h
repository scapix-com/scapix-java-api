...
class Notification_BubbleMetadata_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_BUBBLEMETADATA_BUILDER
...
public:
	...
	static jni::ref<android::app::Notification_BubbleMetadata_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::Notification_BubbleMetadata_Builder> new_object(jni::ref<java::lang::String> shortcutId) { return object_base::new_object(shortcutId); }
	static jni::ref<android::app::Notification_BubbleMetadata_Builder> new_object(jni::ref<android::app::PendingIntent> intent, jni::ref<android::graphics::drawable::Icon> icon) { return object_base::new_object(intent, icon); }
