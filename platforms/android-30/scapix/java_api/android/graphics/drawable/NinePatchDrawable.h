...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_NINEPATCHDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::NinePatchDrawable> new_object(jni::ref<android::graphics::Bitmap> bitmap, jni::ref<jni::array<jbyte>> chunk, jni::ref<android::graphics::Rect> padding, jni::ref<java::lang::String> srcName) { return object_base::new_object(bitmap, chunk, padding, srcName); }
	static jni::ref<android::graphics::drawable::NinePatchDrawable> new_object(jni::ref<android::content::res::Resources> res, jni::ref<android::graphics::Bitmap> bitmap, jni::ref<jni::array<jbyte>> chunk, jni::ref<android::graphics::Rect> padding, jni::ref<java::lang::String> srcName) { return object_base::new_object(res, bitmap, chunk, padding, srcName); }
	static jni::ref<android::graphics::drawable::NinePatchDrawable> new_object(jni::ref<android::graphics::NinePatch> patch) { return object_base::new_object(patch); }
	static jni::ref<android::graphics::drawable::NinePatchDrawable> new_object(jni::ref<android::content::res::Resources> res, jni::ref<android::graphics::NinePatch> patch) { return object_base::new_object(res, patch); }
