...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_FONTS_FONTSTYLE
...
public:
	...
	static jni::ref<android::graphics::fonts::FontStyle> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::fonts::FontStyle> new_object(jint weight, jint slant) { return object_base::new_object(weight, slant); }
