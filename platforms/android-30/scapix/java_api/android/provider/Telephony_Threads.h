...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_TELEPHONY_THREADS
...
public:
	...
	static jlong getOrCreateThreadId(jni::ref<android::content::Context> context, jni::ref<java::lang::String> recipient) { return call_static_method<"getOrCreateThreadId", jlong>(context, recipient); }
	static jlong getOrCreateThreadId(jni::ref<android::content::Context> context, jni::ref<java::util::Set> recipients) { return call_static_method<"getOrCreateThreadId", jlong>(context, recipients); }
};
