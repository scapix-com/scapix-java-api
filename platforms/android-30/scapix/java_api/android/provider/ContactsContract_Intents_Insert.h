...
class ContactsContract_Intents_Insert;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CONTACTSCONTRACT_INTENTS_INSERT
...
public:
	...
	static jni::ref<java::lang::String> EXTRA_ACCOUNT() { return get_static_field<"EXTRA_ACCOUNT", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_DATA_SET() { return get_static_field<"EXTRA_DATA_SET", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::ContactsContract_Intents_Insert> new_object() { return object_base::new_object(); }
};
