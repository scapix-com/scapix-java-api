...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ALBUMS_FWD
#define SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ALBUMS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace android::provider { class MediaStore_Audio_Albums; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::android::provider::MediaStore_Audio_Albums>
{
	static constexpr fixed_string class_name = "android/provider/MediaStore$Audio$Albums";
...
#endif // SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ALBUMS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ALBUMS)
#define SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ALBUMS
...
class android::provider::MediaStore_Audio_Albums : public jni::object_base<"android/provider/MediaStore$Audio$Albums",
	java::lang::Object,
...
public:
	...
	static jni::ref<android::provider::MediaStore_Audio_Albums> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ALBUMS
