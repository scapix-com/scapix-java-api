...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_IMS_IMSREASONINFO
...
public:
	...
	static jni::ref<android::telephony::ims::ImsReasonInfo> new_object(jint code, jint extraCode, jni::ref<java::lang::String> extraMessage) { return object_base::new_object(code, extraCode, extraMessage); }
