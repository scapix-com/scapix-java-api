...
class AudioPresentation_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOPRESENTATION_BUILDER
...
public:
	...
	static jni::ref<android::media::AudioPresentation_Builder> new_object(jint presentationId) { return object_base::new_object(presentationId); }
