...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT_PREVIEWPROGRAMS_FWD
#define SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT_PREVIEWPROGRAMS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace android::media::tv { class TvContract_PreviewPrograms; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::android::media::tv::TvContract_PreviewPrograms>
{
	static constexpr fixed_string class_name = "android/media/tv/TvContract$PreviewPrograms";
...
#endif // SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT_PREVIEWPROGRAMS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT_PREVIEWPROGRAMS)
#define SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT_PREVIEWPROGRAMS
...
class android::media::tv::TvContract_PreviewPrograms : public jni::object_base<"android/media/tv/TvContract$PreviewPrograms",
	java::lang::Object,
...
public:
	...
	static jni::ref<java::lang::String> COLUMN_WEIGHT() { return get_static_field<"COLUMN_WEIGHT", jni::ref<java::lang::String>>(); }
...
#endif // SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT_PREVIEWPROGRAMS
