...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIASESSION2SERVICE_MEDIANOTIFICATION
...
public:
	...
	static jni::ref<android::media::MediaSession2Service_MediaNotification> new_object(jint notificationId, jni::ref<android::app::Notification> notification) { return object_base::new_object(notificationId, notification); }
