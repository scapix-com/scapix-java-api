...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_DYNAMICSPROCESSING_EQ
...
public:
	...
	static jni::ref<android::media::audiofx::DynamicsProcessing_Eq> new_object(jboolean inUse, jboolean enabled, jint bandCount) { return object_base::new_object(inUse, enabled, bandCount); }
	static jni::ref<android::media::audiofx::DynamicsProcessing_Eq> new_object(jni::ref<android::media::audiofx::DynamicsProcessing_Eq> cfg) { return object_base::new_object(cfg); }
