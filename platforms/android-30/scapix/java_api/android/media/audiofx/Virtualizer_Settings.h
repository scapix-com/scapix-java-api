...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_VIRTUALIZER_SETTINGS
...
public:
	...
	static jni::ref<android::media::audiofx::Virtualizer_Settings> new_object() { return object_base::new_object(); }
	static jni::ref<android::media::audiofx::Virtualizer_Settings> new_object(jni::ref<java::lang::String> settings) { return object_base::new_object(settings); }
