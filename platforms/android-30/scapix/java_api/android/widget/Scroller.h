...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_SCROLLER
...
public:
	...
	static jni::ref<android::widget::Scroller> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::Scroller> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::animation::Interpolator> interpolator) { return object_base::new_object(context, interpolator); }
	static jni::ref<android::widget::Scroller> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::animation::Interpolator> interpolator, jboolean flywheel) { return object_base::new_object(context, interpolator, flywheel); }
