...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_RTP_AUDIOSTREAM
...
public:
	...
	static jni::ref<android::net::rtp::AudioStream> new_object(jni::ref<java::net::InetAddress> address) { return object_base::new_object(address); }
