...
#ifndef SCAPIX_JAVA_API_JAVAX_NET_SSL_HANDSHAKECOMPLETEDEVENT
...
public:
	...
	static jni::ref<javax::net::ssl::HandshakeCompletedEvent> new_object(jni::ref<javax::net::ssl::SSLSocket> sock, jni::ref<javax::net::ssl::SSLSession> s) { return object_base::new_object(sock, s); }
