...
public:
	...
	static jni::ref<javax::sql::ConnectionEvent> new_object(jni::ref<javax::sql::PooledConnection> con) { return object_base::new_object(con); }
	static jni::ref<javax::sql::ConnectionEvent> new_object(jni::ref<javax::sql::PooledConnection> con, jni::ref<java::sql::SQLException> ex) { return object_base::new_object(con, ex); }
