...
class PrinterCapabilitiesInfo_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PRINT_PRINTERCAPABILITIESINFO_BUILDER
...
public:
	...
	static jni::ref<android::print::PrinterCapabilitiesInfo_Builder> new_object(jni::ref<android::print::PrinterId> printerId) { return object_base::new_object(printerId); }
