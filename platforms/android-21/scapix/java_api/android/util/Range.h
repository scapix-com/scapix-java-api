...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_RANGE
...
public:
	...
	static jni::ref<android::util::Range> new_object(jni::ref<java::lang::Comparable> lower, jni::ref<java::lang::Comparable> upper) { return object_base::new_object(lower, upper); }
