...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_MEDIAROUTEACTIONPROVIDER
...
public:
	...
	static jni::ref<android::app::MediaRouteActionProvider> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
