...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_SETTINGS_SYSTEM
...
public:
	...
	static jni::ref<java::lang::String> APPEND_FOR_LAST_AUDIBLE() { return get_static_field<"APPEND_FOR_LAST_AUDIBLE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> SYS_PROP_SETTING_VERSION() { return get_static_field<"SYS_PROP_SETTING_VERSION", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> VOLUME_ALARM() { return get_static_field<"VOLUME_ALARM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VOLUME_BLUETOOTH_SCO() { return get_static_field<"VOLUME_BLUETOOTH_SCO", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VOLUME_MUSIC() { return get_static_field<"VOLUME_MUSIC", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VOLUME_NOTIFICATION() { return get_static_field<"VOLUME_NOTIFICATION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VOLUME_RING() { return get_static_field<"VOLUME_RING", jni::ref<java::lang::String>>(); }
	static jni::ref<jni::array<java::lang::String>> VOLUME_SETTINGS() { return get_static_field<"VOLUME_SETTINGS", jni::ref<jni::array<java::lang::String>>>(); }
	static jni::ref<java::lang::String> VOLUME_SYSTEM() { return get_static_field<"VOLUME_SYSTEM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VOLUME_VOICE() { return get_static_field<"VOLUME_VOICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::Settings_System> new_object() { return object_base::new_object(); }
