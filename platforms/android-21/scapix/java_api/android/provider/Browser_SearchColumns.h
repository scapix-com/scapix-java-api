...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_BROWSER_SEARCHCOLUMNS
...
public:
	...
	static jni::ref<android::provider::Browser_SearchColumns> new_object() { return object_base::new_object(); }
};
