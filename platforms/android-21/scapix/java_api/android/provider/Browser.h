...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_BROWSER
...
public:
	...
	static jni::ref<android::provider::Browser> new_object() { return object_base::new_object(); }
	...
	static void deleteHistoryTimeFrame(jni::ref<android::content::ContentResolver> cr, jlong begin, jlong end) { return call_static_method<"deleteHistoryTimeFrame", void>(cr, begin, end); }
