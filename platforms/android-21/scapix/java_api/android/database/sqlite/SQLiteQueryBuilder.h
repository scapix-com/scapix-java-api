...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITEQUERYBUILDER
...
public:
	...
	static jni::ref<android::database::sqlite::SQLiteQueryBuilder> new_object() { return object_base::new_object(); }
