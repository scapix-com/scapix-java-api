...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_ASYNCPLAYER
...
public:
	...
	static jni::ref<android::media::AsyncPlayer> new_object(jni::ref<java::lang::String> tag) { return object_base::new_object(tag); }
