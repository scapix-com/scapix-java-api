...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGESTATS
...
public:
	...
	static jni::ref<android::content::pm::PackageStats> new_object(jni::ref<java::lang::String> pkgName) { return object_base::new_object(pkgName); }
	static jni::ref<android::content::pm::PackageStats> new_object(jni::ref<android::os::Parcel> source) { return object_base::new_object(source); }
	static jni::ref<android::content::pm::PackageStats> new_object(jni::ref<android::content::pm::PackageStats> pStats) { return object_base::new_object(pStats); }
