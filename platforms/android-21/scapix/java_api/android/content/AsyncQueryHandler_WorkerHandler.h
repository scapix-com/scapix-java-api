...
public:
	...
	static jni::ref<android::content::AsyncQueryHandler_WorkerHandler> new_object(jni::ref<android::content::AsyncQueryHandler> p1, jni::ref<android::os::Looper> p2) { return object_base::new_object(p1, p2); }
