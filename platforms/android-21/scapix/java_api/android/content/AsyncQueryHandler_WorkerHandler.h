...
public:
	...
	static jni::ref<android::content::AsyncQueryHandler_WorkerHandler> new_object(jni::ref<android::content::AsyncQueryHandler> p1, jni::ref<android::os::Looper> looper) { return base_::new_object(p1, looper); }
