...
public:
	...
	void registerContentObserver(jni::ref<android::net::Uri> uri, jboolean notifyForDescendents, jni::ref<android::database::ContentObserver> observer) { return call_method<"registerContentObserver", void>(uri, notifyForDescendents, observer); }
