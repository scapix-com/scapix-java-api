...
public:
	...
	static jni::ref<android::inputmethodservice::InputMethodService_InputMethodSessionImpl> new_object(jni::ref<android::inputmethodservice::InputMethodService> p1) { return object_base::new_object(p1); }
