...
public:
	...
	static jni::ref<android::inputmethodservice::AbstractInputMethodService_AbstractInputMethodImpl> new_object(jni::ref<android::inputmethodservice::AbstractInputMethodService> p1) { return object_base::new_object(p1); }
