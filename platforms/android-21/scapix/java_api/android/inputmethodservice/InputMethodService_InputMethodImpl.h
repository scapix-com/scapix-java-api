...
public:
	...
	static jni::ref<android::inputmethodservice::InputMethodService_InputMethodImpl> new_object(jni::ref<android::inputmethodservice::InputMethodService> p1) { return object_base::new_object(p1); }
