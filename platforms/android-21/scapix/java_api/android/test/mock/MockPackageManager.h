...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKPACKAGEMANAGER
...
public:
	...
	static jni::ref<android::test::mock::MockPackageManager> new_object() { return object_base::new_object(); }
