...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_INSTRUMENTATIONTESTRUNNER
...
public:
	...
	static jni::ref<android::test::InstrumentationTestRunner> new_object() { return object_base::new_object(); }
