...
#ifndef SCAPIX_JAVA_API_ANDROID_TRANSITION_VISIBILITY
...
public:
	...
	static jni::ref<android::transition::Visibility> new_object() { return object_base::new_object(); }
	static jni::ref<android::transition::Visibility> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
