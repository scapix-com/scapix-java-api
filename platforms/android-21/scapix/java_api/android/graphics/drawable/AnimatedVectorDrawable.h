...
namespace scapix::java_api { namespace android::graphics::drawable { class AnimatedVectorDrawable; }}
...
struct scapix::jni::object_traits<scapix::java_api::android::graphics::drawable::AnimatedVectorDrawable>
{
	...
	using base_classes = std::tuple<scapix::java_api::android::graphics::drawable::Drawable, scapix::java_api::android::graphics::drawable::Animatable>;
};
...
public:
	...
	static jni::ref<android::graphics::drawable::AnimatedVectorDrawable> new_object() { return object_base::new_object(); }
