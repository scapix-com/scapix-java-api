...
namespace scapix::java_api::android::graphics::drawable { class BitmapDrawable; }
...
public:
	...
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object() { return base_::new_object(); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<android::content::res::Resources> res) { return base_::new_object(res); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<android::graphics::Bitmap> bitmap) { return base_::new_object(bitmap); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<android::content::res::Resources> res, jni::ref<android::graphics::Bitmap> bitmap) { return base_::new_object(res, bitmap); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<java::lang::String> filepath) { return base_::new_object(filepath); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<android::content::res::Resources> res, jni::ref<java::lang::String> filepath) { return base_::new_object(res, filepath); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<java::io::InputStream> is) { return base_::new_object(is); }
	static jni::ref<android::graphics::drawable::BitmapDrawable> new_object(jni::ref<android::content::res::Resources> res, jni::ref<java::io::InputStream> is) { return base_::new_object(res, is); }
