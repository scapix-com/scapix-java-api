...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_TRANSITIONDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::TransitionDrawable> new_object(jni::ref<jni::array<android::graphics::drawable::Drawable>> layers) { return object_base::new_object(layers); }
