...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_SHAPES_ROUNDRECTSHAPE
...
public:
	...
	static jni::ref<android::graphics::drawable::shapes::RoundRectShape> new_object(jni::ref<jni::array<jfloat>> outerRadii, jni::ref<android::graphics::RectF> inset, jni::ref<jni::array<jfloat>> innerRadii) { return object_base::new_object(outerRadii, inset, innerRadii); }
