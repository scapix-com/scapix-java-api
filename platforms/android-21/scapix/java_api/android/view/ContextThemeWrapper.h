...
public:
	...
	static jni::ref<android::view::ContextThemeWrapper> new_object(jni::ref<android::content::Context> base, jint themeres) { return object_base::new_object(base, themeres); }
