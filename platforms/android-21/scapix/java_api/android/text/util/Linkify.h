...
public:
	...
	static void addLinks(jni::ref<android::widget::TextView> text, jni::ref<java::util::regex::Pattern> p, jni::ref<java::lang::String> scheme, jni::ref<android::text::util::Linkify_MatchFilter> matchFilter, jni::ref<android::text::util::Linkify_TransformFilter> transformFilter) { return call_static_method<"addLinks", void>(text, p, scheme, matchFilter, transformFilter); }
	...
	static jboolean addLinks(jni::ref<android::text::Spannable> s, jni::ref<java::util::regex::Pattern> p, jni::ref<java::lang::String> scheme, jni::ref<android::text::util::Linkify_MatchFilter> matchFilter, jni::ref<android::text::util::Linkify_TransformFilter> transformFilter) { return call_static_method<"addLinks", jboolean>(s, p, scheme, matchFilter, transformFilter); }
};
