...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_BULLETSPAN
...
public:
	...
	static jni::ref<android::text::style::BulletSpan> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::style::BulletSpan> new_object(jint gapWidth) { return object_base::new_object(gapWidth); }
	static jni::ref<android::text::style::BulletSpan> new_object(jint gapWidth, jint color) { return object_base::new_object(gapWidth, color); }
	static jni::ref<android::text::style::BulletSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
	...
	void drawLeadingMargin(jni::ref<android::graphics::Canvas> c, jni::ref<android::graphics::Paint> p, jint x, jint dir, jint top, jint baseline, jint bottom, jni::ref<java::lang::CharSequence> text, jint start, jint end, jboolean first, jni::ref<android::text::Layout> l) { return call_method<"drawLeadingMargin", void>(c, p, x, dir, top, baseline, bottom, text, start, end, first, l); }
};
