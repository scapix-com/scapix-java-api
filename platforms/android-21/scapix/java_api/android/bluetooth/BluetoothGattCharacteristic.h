...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHGATTCHARACTERISTIC
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothGattCharacteristic> new_object(jni::ref<java::util::UUID> uuid, jint properties, jint permissions) { return object_base::new_object(uuid, properties, permissions); }
