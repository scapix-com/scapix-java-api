...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_SSLCERTIFICATESOCKETFACTORY
...
public:
	...
	static jni::ref<android::net::SSLCertificateSocketFactory> new_object(jint handshakeTimeoutMillis) { return object_base::new_object(handshakeTimeoutMillis); }
