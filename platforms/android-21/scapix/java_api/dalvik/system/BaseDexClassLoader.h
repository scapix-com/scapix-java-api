...
public:
	...
	static jni::ref<dalvik::system::BaseDexClassLoader> new_object(jni::ref<java::lang::String> dexPath, jni::ref<java::io::File> optimizedDirectory, jni::ref<java::lang::String> libraryPath, jni::ref<java::lang::ClassLoader> parent) { return base_::new_object(dexPath, optimizedDirectory, libraryPath, parent); }
