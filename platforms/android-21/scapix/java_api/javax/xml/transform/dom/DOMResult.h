...
public:
	...
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> node) { return base_::new_object(node); }
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> node, jni::ref<java::lang::String> systemId) { return base_::new_object(node, systemId); }
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> node, jni::ref<org::w3c::dom::Node> nextSibling) { return base_::new_object(node, nextSibling); }
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> node, jni::ref<org::w3c::dom::Node> nextSibling, jni::ref<java::lang::String> systemId) { return base_::new_object(node, nextSibling, systemId); }
