...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_CIPHER
...
public:
	...
	void updateAAD(jni::ref<jni::array<jbyte>> input) { return call_method<"updateAAD", void>(input); }
	void updateAAD(jni::ref<jni::array<jbyte>> input, jint inputOffset, jint inputLen) { return call_method<"updateAAD", void>(input, inputOffset, inputLen); }
	void updateAAD(jni::ref<java::nio::ByteBuffer> input) { return call_method<"updateAAD", void>(input); }
