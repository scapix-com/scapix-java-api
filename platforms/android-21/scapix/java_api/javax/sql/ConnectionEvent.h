...
#ifndef SCAPIX_JAVA_API_JAVAX_SQL_CONNECTIONEVENT
...
public:
	...
	static jni::ref<javax::sql::ConnectionEvent> new_object(jni::ref<javax::sql::PooledConnection> theConnection) { return object_base::new_object(theConnection); }
	static jni::ref<javax::sql::ConnectionEvent> new_object(jni::ref<javax::sql::PooledConnection> theConnection, jni::ref<java::sql::SQLException> theException) { return object_base::new_object(theConnection, theException); }
