...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_PROTOCOLVERSION
...
public:
	...
	static jni::ref<org::apache::http::ProtocolVersion> new_object(jni::ref<java::lang::String> protocol, jint major, jint minor) { return object_base::new_object(protocol, major, minor); }
