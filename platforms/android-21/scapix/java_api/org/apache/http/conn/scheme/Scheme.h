...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_SCHEME_SCHEME
...
public:
	...
	static jni::ref<org::apache::http::conn::scheme::Scheme> new_object(jni::ref<java::lang::String> name, jni::ref<org::apache::http::conn::scheme::SocketFactory> factory, jint port) { return object_base::new_object(name, factory, port); }
