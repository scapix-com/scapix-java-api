...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_BASICEOFSENSORWATCHER
...
public:
	...
	static jni::ref<org::apache::http::conn::BasicEofSensorWatcher> new_object(jni::ref<org::apache::http::conn::ManagedClientConnection> conn, jboolean reuse) { return object_base::new_object(conn, reuse); }
