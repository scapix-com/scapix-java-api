...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_SCHEME_PLAINSOCKETFACTORY
...
public:
	...
	static jni::ref<org::apache::http::conn::scheme::PlainSocketFactory> new_object(jni::ref<org::apache::http::conn::scheme::HostNameResolver> nameResolver) { return object_base::new_object(nameResolver); }
	static jni::ref<org::apache::http::conn::scheme::PlainSocketFactory> new_object() { return object_base::new_object(); }
