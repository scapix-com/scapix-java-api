...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_COOKIE_PARAMS_COOKIESPECPARAMBEAN
...
public:
	...
	static jni::ref<org::apache::http::cookie::params::CookieSpecParamBean> new_object(jni::ref<org::apache::http::params::HttpParams> params) { return object_base::new_object(params); }
