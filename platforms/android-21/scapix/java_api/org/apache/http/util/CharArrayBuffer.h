...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_UTIL_CHARARRAYBUFFER
...
public:
	...
	static jni::ref<org::apache::http::util::CharArrayBuffer> new_object(jint capacity) { return object_base::new_object(capacity); }
