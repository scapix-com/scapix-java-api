...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICHTTPRESPONSE
...
public:
	...
	static jni::ref<org::apache::http::message::BasicHttpResponse> new_object(jni::ref<org::apache::http::StatusLine> statusline, jni::ref<org::apache::http::ReasonPhraseCatalog> catalog, jni::ref<java::util::Locale> locale) { return object_base::new_object(statusline, catalog, locale); }
	static jni::ref<org::apache::http::message::BasicHttpResponse> new_object(jni::ref<org::apache::http::StatusLine> statusline) { return object_base::new_object(statusline); }
	static jni::ref<org::apache::http::message::BasicHttpResponse> new_object(jni::ref<org::apache::http::ProtocolVersion> ver, jint code, jni::ref<java::lang::String> reason) { return object_base::new_object(ver, code, reason); }
