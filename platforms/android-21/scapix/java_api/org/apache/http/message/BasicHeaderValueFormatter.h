...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICHEADERVALUEFORMATTER
...
public:
	...
	static jni::ref<org::apache::http::message::BasicHeaderValueFormatter> new_object() { return object_base::new_object(); }
