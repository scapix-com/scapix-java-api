...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICHEADERVALUEPARSER
...
public:
	...
	static jni::ref<org::apache::http::message::BasicHeaderValueParser> new_object() { return object_base::new_object(); }
