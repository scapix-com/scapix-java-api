...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_PROTOCOL_HTTPSERVICE
...
public:
	...
	static jni::ref<org::apache::http::protocol::HttpService> new_object(jni::ref<org::apache::http::protocol::HttpProcessor> proc, jni::ref<org::apache::http::ConnectionReuseStrategy> connStrategy, jni::ref<org::apache::http::HttpResponseFactory> responseFactory) { return object_base::new_object(proc, connStrategy, responseFactory); }
