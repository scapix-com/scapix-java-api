...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_PROTOCOL_BASICHTTPCONTEXT
...
public:
	...
	static jni::ref<org::apache::http::protocol::BasicHttpContext> new_object() { return object_base::new_object(); }
	static jni::ref<org::apache::http::protocol::BasicHttpContext> new_object(jni::ref<org::apache::http::protocol::HttpContext> parentContext) { return object_base::new_object(parentContext); }
