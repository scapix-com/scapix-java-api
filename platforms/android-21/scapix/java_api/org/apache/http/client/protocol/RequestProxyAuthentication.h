...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CLIENT_PROTOCOL_REQUESTPROXYAUTHENTICATION
...
public:
	...
	static jni::ref<org::apache::http::client::protocol::RequestProxyAuthentication> new_object() { return object_base::new_object(); }
