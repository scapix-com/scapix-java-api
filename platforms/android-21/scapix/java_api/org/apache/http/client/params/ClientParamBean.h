...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CLIENT_PARAMS_CLIENTPARAMBEAN
...
public:
	...
	static jni::ref<org::apache::http::client::params::ClientParamBean> new_object(jni::ref<org::apache::http::params::HttpParams> params) { return object_base::new_object(params); }
