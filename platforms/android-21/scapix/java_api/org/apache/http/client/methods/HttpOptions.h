...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CLIENT_METHODS_HTTPOPTIONS
...
public:
	...
	static jni::ref<org::apache::http::client::methods::HttpOptions> new_object() { return object_base::new_object(); }
	static jni::ref<org::apache::http::client::methods::HttpOptions> new_object(jni::ref<java::net::URI> uri) { return object_base::new_object(uri); }
	static jni::ref<org::apache::http::client::methods::HttpOptions> new_object(jni::ref<java::lang::String> uri) { return object_base::new_object(uri); }
