...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_PARAMS_HTTPCONNECTIONPARAMBEAN
...
public:
	...
	static jni::ref<org::apache::http::params::HttpConnectionParamBean> new_object(jni::ref<org::apache::http::params::HttpParams> params) { return object_base::new_object(params); }
