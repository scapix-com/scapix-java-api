...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_HTTPHOST
...
public:
	...
	static jni::ref<org::apache::http::HttpHost> new_object(jni::ref<java::lang::String> hostname, jint port, jni::ref<java::lang::String> scheme) { return object_base::new_object(hostname, port, scheme); }
	static jni::ref<org::apache::http::HttpHost> new_object(jni::ref<java::lang::String> hostname, jint port) { return object_base::new_object(hostname, port); }
	static jni::ref<org::apache::http::HttpHost> new_object(jni::ref<java::lang::String> hostname) { return object_base::new_object(hostname); }
	static jni::ref<org::apache::http::HttpHost> new_object(jni::ref<org::apache::http::HttpHost> httphost) { return object_base::new_object(httphost); }
