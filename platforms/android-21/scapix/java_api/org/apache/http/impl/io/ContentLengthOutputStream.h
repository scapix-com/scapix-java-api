...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_IO_CONTENTLENGTHOUTPUTSTREAM
...
public:
	...
	static jni::ref<org::apache::http::impl::io::ContentLengthOutputStream> new_object(jni::ref<org::apache::http::io::SessionOutputBuffer> out, jlong contentLength) { return object_base::new_object(out, contentLength); }
