...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_TSCCM_ROUTESPECIFICPOOL
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::tsccm::RouteSpecificPool> new_object(jni::ref<org::apache::http::conn::routing::HttpRoute> route, jint maxEntries) { return object_base::new_object(route, maxEntries); }
