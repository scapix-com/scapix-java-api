...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_ABSTRACTCLIENTCONNADAPTER
...
public:
	...
	void setIdleDuration(jlong duration, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"setIdleDuration", void>(duration, unit); }
