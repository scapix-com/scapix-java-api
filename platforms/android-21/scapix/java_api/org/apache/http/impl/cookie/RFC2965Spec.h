...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_COOKIE_RFC2965SPEC
...
public:
	...
	static jni::ref<org::apache::http::impl::cookie::RFC2965Spec> new_object() { return object_base::new_object(); }
	static jni::ref<org::apache::http::impl::cookie::RFC2965Spec> new_object(jni::ref<jni::array<java::lang::String>> datepatterns, jboolean oneHeader) { return object_base::new_object(datepatterns, oneHeader); }
