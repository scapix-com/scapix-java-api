...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CLIENT_BASICCOOKIESTORE
...
public:
	...
	static jni::ref<org::apache::http::impl::client::BasicCookieStore> new_object() { return object_base::new_object(); }
