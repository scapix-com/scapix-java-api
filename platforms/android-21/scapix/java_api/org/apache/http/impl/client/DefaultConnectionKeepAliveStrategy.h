...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CLIENT_DEFAULTCONNECTIONKEEPALIVESTRATEGY
...
public:
	...
	static jni::ref<org::apache::http::impl::client::DefaultConnectionKeepAliveStrategy> new_object() { return object_base::new_object(); }
