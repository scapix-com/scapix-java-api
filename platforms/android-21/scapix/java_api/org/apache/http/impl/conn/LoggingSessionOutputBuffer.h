...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_LOGGINGSESSIONOUTPUTBUFFER
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::LoggingSessionOutputBuffer> new_object(jni::ref<org::apache::http::io::SessionOutputBuffer> out, jni::ref<org::apache::http::impl::conn::Wire> wire) { return object_base::new_object(out, wire); }
