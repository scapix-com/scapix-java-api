...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_TSCCM_WAITINGTHREAD
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::tsccm::WaitingThread> new_object(jni::ref<java::util::concurrent::locks::Condition> cond, jni::ref<org::apache::http::impl::conn::tsccm::RouteSpecificPool> pool) { return object_base::new_object(cond, pool); }
