...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_COOKIE_NETSCAPEDRAFTSPEC
...
public:
	...
	static jni::ref<org::apache::http::impl::cookie::NetscapeDraftSpec> new_object(jni::ref<jni::array<java::lang::String>> datepatterns) { return object_base::new_object(datepatterns); }
	static jni::ref<org::apache::http::impl::cookie::NetscapeDraftSpec> new_object() { return object_base::new_object(); }
