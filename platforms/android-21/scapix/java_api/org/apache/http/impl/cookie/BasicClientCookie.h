...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_COOKIE_BASICCLIENTCOOKIE
...
public:
	...
	static jni::ref<org::apache::http::impl::cookie::BasicClientCookie> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> value) { return object_base::new_object(name, value); }
