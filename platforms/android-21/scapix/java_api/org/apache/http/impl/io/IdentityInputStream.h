...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_IO_IDENTITYINPUTSTREAM
...
public:
	...
	static jni::ref<org::apache::http::impl::io::IdentityInputStream> new_object(jni::ref<org::apache::http::io::SessionInputBuffer> in) { return object_base::new_object(in); }
