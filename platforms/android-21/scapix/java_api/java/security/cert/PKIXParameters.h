...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_PKIXPARAMETERS
...
public:
	...
	static jni::ref<java::security::cert::PKIXParameters> new_object(jni::ref<java::util::Set> trustAnchors) { return object_base::new_object(trustAnchors); }
	static jni::ref<java::security::cert::PKIXParameters> new_object(jni::ref<java::security::KeyStore> keyStore) { return object_base::new_object(keyStore); }
	...
	void setAnyPolicyInhibited(jboolean anyPolicyInhibited) { return call_method<"setAnyPolicyInhibited", void>(anyPolicyInhibited); }
	jni::ref<java::util::List> getCertPathCheckers() { return call_method<"getCertPathCheckers", jni::ref<java::util::List>>(); }
	void setCertPathCheckers(jni::ref<java::util::List> certPathCheckers) { return call_method<"setCertPathCheckers", void>(certPathCheckers); }
	...
	void setCertStores(jni::ref<java::util::List> certStores) { return call_method<"setCertStores", void>(certStores); }
	...
	void setExplicitPolicyRequired(jboolean explicitPolicyRequired) { return call_method<"setExplicitPolicyRequired", void>(explicitPolicyRequired); }
	...
	void setPolicyMappingInhibited(jboolean policyMappingInhibited) { return call_method<"setPolicyMappingInhibited", void>(policyMappingInhibited); }
	jboolean getPolicyQualifiersRejected() { return call_method<"getPolicyQualifiersRejected", jboolean>(); }
	void setPolicyQualifiersRejected(jboolean policyQualifiersRejected) { return call_method<"setPolicyQualifiersRejected", void>(policyQualifiersRejected); }
	jboolean isRevocationEnabled() { return call_method<"isRevocationEnabled", jboolean>(); }
	void setRevocationEnabled(jboolean revocationEnabled) { return call_method<"setRevocationEnabled", void>(revocationEnabled); }
	...
	void setTargetCertConstraints(jni::ref<java::security::cert::CertSelector> targetCertConstraints) { return call_method<"setTargetCertConstraints", void>(targetCertConstraints); }
