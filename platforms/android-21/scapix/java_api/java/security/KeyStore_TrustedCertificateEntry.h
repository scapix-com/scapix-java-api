...
public:
	...
	static jni::ref<java::security::KeyStore_TrustedCertificateEntry> new_object(jni::ref<java::security::cert::Certificate> trustCertificate) { return base_::new_object(trustCertificate); }
