...
public:
	...
	static jni::ref<java::security::BasicPermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> action) { return base_::new_object(name, action); }
