...
public:
	...
	static jni::ref<java::security::spec::ECFieldF2m> new_object(jint m) { return object_base::new_object(m); }
	static jni::ref<java::security::spec::ECFieldF2m> new_object(jint m, jni::ref<java::math::BigInteger> rp) { return object_base::new_object(m, rp); }
	static jni::ref<java::security::spec::ECFieldF2m> new_object(jint m, jni::ref<jni::array<jint>> ks) { return object_base::new_object(m, ks); }
