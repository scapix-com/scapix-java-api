...
#ifndef SCAPIX_JAVA_API_JAVA_NET_MULTICASTSOCKET
...
public:
	...
	static jni::ref<java::net::MulticastSocket> new_object(jni::ref<java::net::SocketAddress> localAddress) { return object_base::new_object(localAddress); }
