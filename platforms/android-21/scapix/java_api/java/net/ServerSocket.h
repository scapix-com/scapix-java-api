...
public:
	...
	static jni::ref<java::net::ServerSocket> new_object(jint port, jint backlog, jni::ref<java::net::InetAddress> localAddress) { return base_::new_object(port, backlog, localAddress); }
