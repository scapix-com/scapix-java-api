...
public:
	...
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> searchUrls, jni::ref<java::lang::ClassLoader> parent, jni::ref<java::net::URLStreamHandlerFactory> factory) { return object_base::new_object(searchUrls, parent, factory); }
