...
public:
	...
	static jni::ref<java::net::Socket> new_object(jni::ref<java::lang::String> dstName, jint dstPort) { return object_base::new_object(dstName, dstPort); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::lang::String> dstName, jint dstPort, jni::ref<java::net::InetAddress> localAddress, jint localPort) { return object_base::new_object(dstName, dstPort, localAddress, localPort); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::lang::String> hostName, jint port, jboolean streaming) { return object_base::new_object(hostName, port, streaming); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::InetAddress> dstAddress, jint dstPort) { return object_base::new_object(dstAddress, dstPort); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::InetAddress> dstAddress, jint dstPort, jni::ref<java::net::InetAddress> localAddress, jint localPort) { return object_base::new_object(dstAddress, dstPort, localAddress, localPort); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::InetAddress> addr, jint port, jboolean streaming) { return object_base::new_object(addr, port, streaming); }
