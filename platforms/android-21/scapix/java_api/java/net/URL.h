...
#ifndef SCAPIX_JAVA_API_JAVA_NET_URL
...
public:
	...
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> spec) { return object_base::new_object(spec); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::net::URL> context, jni::ref<java::lang::String> spec) { return object_base::new_object(context, spec); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::net::URL> context, jni::ref<java::lang::String> spec, jni::ref<java::net::URLStreamHandler> handler) { return object_base::new_object(context, spec, handler); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> protocol, jni::ref<java::lang::String> host, jni::ref<java::lang::String> file) { return object_base::new_object(protocol, host, file); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> protocol, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> file) { return object_base::new_object(protocol, host, port, file); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> protocol, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> file, jni::ref<java::net::URLStreamHandler> handler) { return object_base::new_object(protocol, host, port, file, handler); }
