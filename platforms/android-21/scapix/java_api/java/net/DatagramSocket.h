...
public:
	...
	static jni::ref<java::net::DatagramSocket> new_object(jint aPort) { return base_::new_object(aPort); }
	static jni::ref<java::net::DatagramSocket> new_object(jint aPort, jni::ref<java::net::InetAddress> addr) { return base_::new_object(aPort, addr); }
	static jni::ref<java::net::DatagramSocket> new_object(jni::ref<java::net::SocketAddress> localAddr) { return base_::new_object(localAddr); }
