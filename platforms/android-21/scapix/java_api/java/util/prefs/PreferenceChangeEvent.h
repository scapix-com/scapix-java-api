...
public:
	...
	static jni::ref<java::util::prefs::PreferenceChangeEvent> new_object(jni::ref<java::util::prefs::Preferences> p, jni::ref<java::lang::String> k, jni::ref<java::lang::String> v) { return object_base::new_object(p, k, v); }
