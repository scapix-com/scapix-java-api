...
public:
	...
	static jni::ref<java::util::prefs::InvalidPreferencesFormatException> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	static jni::ref<java::util::prefs::InvalidPreferencesFormatException> new_object(jni::ref<java::lang::String> s, jni::ref<java::lang::Throwable> t) { return object_base::new_object(s, t); }
	static jni::ref<java::util::prefs::InvalidPreferencesFormatException> new_object(jni::ref<java::lang::Throwable> t) { return object_base::new_object(t); }
};
