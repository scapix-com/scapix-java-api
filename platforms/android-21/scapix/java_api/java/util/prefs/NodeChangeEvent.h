...
public:
	...
	static jni::ref<java::util::prefs::NodeChangeEvent> new_object(jni::ref<java::util::prefs::Preferences> p, jni::ref<java::util::prefs::Preferences> c) { return object_base::new_object(p, c); }
