...
public:
	...
	static jni::ref<java::util::logging::StreamHandler> new_object(jni::ref<java::io::OutputStream> os, jni::ref<java::util::logging::Formatter> formatter) { return object_base::new_object(os, formatter); }
