...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_STRINGTOKENIZER
...
public:
	...
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> string, jni::ref<java::lang::String> delimiters) { return object_base::new_object(string, delimiters); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> string, jni::ref<java::lang::String> delimiters, jboolean returnDelimiters) { return object_base::new_object(string, delimiters, returnDelimiters); }
	...
	jni::ref<java::lang::String> nextToken(jni::ref<java::lang::String> delims) { return call_method<"nextToken", jni::ref<java::lang::String>>(delims); }
};
