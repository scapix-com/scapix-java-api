...
public:
	...
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> string) { return base_::new_object(string); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> string, jni::ref<java::lang::String> delimiters) { return base_::new_object(string, delimiters); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> string, jni::ref<java::lang::String> delimiters, jboolean returnDelimiters) { return base_::new_object(string, delimiters, returnDelimiters); }
