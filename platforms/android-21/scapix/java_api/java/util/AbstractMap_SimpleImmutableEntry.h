...
public:
	...
	static jni::ref<java::util::AbstractMap_SimpleImmutableEntry> new_object(jni::ref<java::lang::Object> theKey, jni::ref<java::lang::Object> theValue) { return object_base::new_object(theKey, theValue); }
	static jni::ref<java::util::AbstractMap_SimpleImmutableEntry> new_object(jni::ref<java::util::Map_Entry> copyFrom) { return object_base::new_object(copyFrom); }
