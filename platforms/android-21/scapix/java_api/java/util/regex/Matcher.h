...
public:
	...
	jni::ref<java::util::regex::Matcher> appendReplacement(jni::ref<java::lang::StringBuffer> buffer, jni::ref<java::lang::String> replacement) { return call_method<"appendReplacement", jni::ref<java::util::regex::Matcher>>(buffer, replacement); }
	...
	jni::ref<java::util::regex::Matcher> usePattern(jni::ref<java::util::regex::Pattern> pattern) { return call_method<"usePattern", jni::ref<java::util::regex::Matcher>>(pattern); }
	...
	jni::ref<java::lang::StringBuffer> appendTail(jni::ref<java::lang::StringBuffer> buffer) { return call_method<"appendTail", jni::ref<java::lang::StringBuffer>>(buffer); }
