...
public:
	...
	static jni::ref<java::util::ResourceBundle> getBundle(jni::ref<java::lang::String> bundleName) { return call_static_method<"getBundle", jni::ref<java::util::ResourceBundle>>(bundleName); }
	static jni::ref<java::util::ResourceBundle> getBundle(jni::ref<java::lang::String> bundleName, jni::ref<java::util::Locale> locale) { return call_static_method<"getBundle", jni::ref<java::util::ResourceBundle>>(bundleName, locale); }
	static jni::ref<java::util::ResourceBundle> getBundle(jni::ref<java::lang::String> bundleName, jni::ref<java::util::Locale> locale, jni::ref<java::lang::ClassLoader> loader) { return call_static_method<"getBundle", jni::ref<java::util::ResourceBundle>>(bundleName, locale, loader); }
