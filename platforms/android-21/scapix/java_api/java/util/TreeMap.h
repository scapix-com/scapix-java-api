...
public:
	...
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Map> copyFrom) { return base_::new_object(copyFrom); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Comparator> comparator) { return base_::new_object(comparator); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::SortedMap> copyFrom) { return base_::new_object(copyFrom); }
