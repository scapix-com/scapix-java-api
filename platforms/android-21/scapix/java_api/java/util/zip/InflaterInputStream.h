...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_INFLATERINPUTSTREAM
...
public:
	...
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> is, jni::ref<java::util::zip::Inflater> inflater) { return object_base::new_object(is, inflater); }
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> is, jni::ref<java::util::zip::Inflater> inflater, jint bufferSize) { return object_base::new_object(is, inflater, bufferSize); }
