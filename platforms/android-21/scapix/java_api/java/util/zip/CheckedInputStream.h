...
public:
	...
	static jni::ref<java::util::zip::CheckedInputStream> new_object(jni::ref<java::io::InputStream> is, jni::ref<java::util::zip::Checksum> csum) { return object_base::new_object(is, csum); }
