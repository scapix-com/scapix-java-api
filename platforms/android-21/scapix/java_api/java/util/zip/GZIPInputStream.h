...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_GZIPINPUTSTREAM
...
public:
	...
	static jni::ref<java::util::zip::GZIPInputStream> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
	static jni::ref<java::util::zip::GZIPInputStream> new_object(jni::ref<java::io::InputStream> is, jint size) { return object_base::new_object(is, size); }
