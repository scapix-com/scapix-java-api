...
public:
	...
	static jni::ref<java::util::jar::JarInputStream> new_object(jni::ref<java::io::InputStream> stream, jboolean verify) { return base_::new_object(stream, verify); }
	static jni::ref<java::util::jar::JarInputStream> new_object(jni::ref<java::io::InputStream> stream) { return base_::new_object(stream); }
