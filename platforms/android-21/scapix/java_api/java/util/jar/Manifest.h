...
public:
	...
	static jni::ref<java::util::jar::Manifest> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
	static jni::ref<java::util::jar::Manifest> new_object(jni::ref<java::util::jar::Manifest> man) { return object_base::new_object(man); }
	...
	void write(jni::ref<java::io::OutputStream> os) { return call_method<"write", void>(os); }
