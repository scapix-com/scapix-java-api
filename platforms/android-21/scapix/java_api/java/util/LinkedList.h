...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST
...
public:
	...
	static jni::ref<java::util::LinkedList> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::LinkedList> new_object(jni::ref<java::util::Collection> collection) { return object_base::new_object(collection); }
