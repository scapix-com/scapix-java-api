...
public:
	...
	static jni::ref<java::util::IdentityHashMap> new_object(jint maxSize) { return object_base::new_object(maxSize); }
	static jni::ref<java::util::IdentityHashMap> new_object(jni::ref<java::util::Map> map) { return object_base::new_object(map); }
