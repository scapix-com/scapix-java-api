...
public:
	...
	static jni::ref<java::sql::Date> new_object(jint theYear, jint theMonth, jint theDay) { return object_base::new_object(theYear, theMonth, theDay); }
	static jni::ref<java::sql::Date> new_object(jlong theDate) { return object_base::new_object(theDate); }
