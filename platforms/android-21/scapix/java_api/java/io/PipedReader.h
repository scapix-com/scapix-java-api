...
public:
	...
	static jni::ref<java::io::PipedReader> new_object(jni::ref<java::io::PipedWriter> out) { return base_::new_object(out); }
	static jni::ref<java::io::PipedReader> new_object(jint pipeSize) { return base_::new_object(pipeSize); }
	static jni::ref<java::io::PipedReader> new_object(jni::ref<java::io::PipedWriter> out, jint pipeSize) { return base_::new_object(out, pipeSize); }
