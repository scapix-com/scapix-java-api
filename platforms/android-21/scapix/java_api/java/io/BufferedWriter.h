...
#ifndef SCAPIX_JAVA_API_JAVA_IO_BUFFEREDWRITER
...
public:
	...
	static jni::ref<java::io::BufferedWriter> new_object(jni::ref<java::io::Writer> out) { return object_base::new_object(out); }
	static jni::ref<java::io::BufferedWriter> new_object(jni::ref<java::io::Writer> out, jint size) { return object_base::new_object(out, size); }
