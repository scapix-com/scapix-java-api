...
public:
	...
	static jni::ref<java::io::SequenceInputStream> new_object(jni::ref<java::io::InputStream> s1, jni::ref<java::io::InputStream> s2) { return object_base::new_object(s1, s2); }
	static jni::ref<java::io::SequenceInputStream> new_object(jni::ref<java::util::Enumeration> e) { return object_base::new_object(e); }
