...
#ifndef SCAPIX_JAVA_API_JAVA_IO_NOTACTIVEEXCEPTION
...
public:
	...
	static jni::ref<java::io::NotActiveException> new_object() { return object_base::new_object(); }
	static jni::ref<java::io::NotActiveException> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
};
