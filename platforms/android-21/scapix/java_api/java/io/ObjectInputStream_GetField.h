...
namespace scapix::java_api::java::io { class ObjectInputStream_GetField; }
...
public:
	...
	static jni::ref<java::io::ObjectInputStream_GetField> new_object() { return base_::new_object(); }
