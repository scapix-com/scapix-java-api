...
#ifndef SCAPIX_JAVA_API_JAVA_IO_LINENUMBERREADER
...
public:
	...
	static jni::ref<java::io::LineNumberReader> new_object(jni::ref<java::io::Reader> in) { return object_base::new_object(in); }
	static jni::ref<java::io::LineNumberReader> new_object(jni::ref<java::io::Reader> in, jint size) { return object_base::new_object(in, size); }
