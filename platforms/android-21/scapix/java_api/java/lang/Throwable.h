...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_THROWABLE
...
public:
	...
	static jni::ref<java::lang::Throwable> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::String> detailMessage, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(detailMessage, cause); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
	...
	void setStackTrace(jni::ref<jni::array<java::lang::StackTraceElement>> trace) { return call_method<"setStackTrace", void>(trace); }
	void printStackTrace() { return call_method<"printStackTrace", void>(); }
	void printStackTrace(jni::ref<java::io::PrintStream> err) { return call_method<"printStackTrace", void>(err); }
	void printStackTrace(jni::ref<java::io::PrintWriter> err) { return call_method<"printStackTrace", void>(err); }
	jni::ref<java::lang::String> toString() { return call_method<"toString", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::Throwable> initCause(jni::ref<java::lang::Throwable> throwable) { return call_method<"initCause", jni::ref<java::lang::Throwable>>(throwable); }
	jni::ref<java::lang::Throwable> getCause() { return call_method<"getCause", jni::ref<java::lang::Throwable>>(); }
	void addSuppressed(jni::ref<java::lang::Throwable> throwable) { return call_method<"addSuppressed", void>(throwable); }
