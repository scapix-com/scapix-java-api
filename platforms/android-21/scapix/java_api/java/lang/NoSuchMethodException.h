...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_NOSUCHMETHODEXCEPTION
...
public:
	...
	static jni::ref<java::lang::NoSuchMethodException> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::NoSuchMethodException> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
};
