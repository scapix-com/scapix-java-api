...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REFLECT_ARRAY
...
public:
	...
	static jni::ref<java::lang::Object> newInstance(jni::ref<java::lang::Class> componentType, jint size) { return call_static_method<"newInstance", jni::ref<java::lang::Object>>(componentType, size); }
	...
	static void setBoolean(jni::ref<java::lang::Object> array, jint index, jboolean value) { return call_static_method<"setBoolean", void>(array, index, value); }
	static void setByte(jni::ref<java::lang::Object> array, jint index, jbyte value) { return call_static_method<"setByte", void>(array, index, value); }
	static void setChar(jni::ref<java::lang::Object> array, jint index, jchar value) { return call_static_method<"setChar", void>(array, index, value); }
	static void setDouble(jni::ref<java::lang::Object> array, jint index, jdouble value) { return call_static_method<"setDouble", void>(array, index, value); }
	static void setFloat(jni::ref<java::lang::Object> array, jint index, jfloat value) { return call_static_method<"setFloat", void>(array, index, value); }
	static void setInt(jni::ref<java::lang::Object> array, jint index, jint value) { return call_static_method<"setInt", void>(array, index, value); }
	static void setLong(jni::ref<java::lang::Object> array, jint index, jlong value) { return call_static_method<"setLong", void>(array, index, value); }
	static void setShort(jni::ref<java::lang::Object> array, jint index, jshort value) { return call_static_method<"setShort", void>(array, index, value); }
};
