...
struct scapix::jni::object_traits<scapix::java_api::java::lang::StringBuffer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Appendable, scapix::java_api::java::io::Serializable, scapix::java_api::java::lang::CharSequence>;
};
...
public:
	...
	static jni::ref<java::lang::StringBuffer> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
	static jni::ref<java::lang::StringBuffer> new_object(jni::ref<java::lang::CharSequence> cs) { return object_base::new_object(cs); }
