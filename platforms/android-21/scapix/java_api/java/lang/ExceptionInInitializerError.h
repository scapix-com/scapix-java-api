...
public:
	...
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::String> detailMessage) { return base_::new_object(detailMessage); }
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::Throwable> exception) { return base_::new_object(exception); }
