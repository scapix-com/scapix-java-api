...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_EXCEPTIONININITIALIZERERROR
...
public:
	...
	static jni::ref<java::lang::ExceptionInInitializerError> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::Throwable> exception) { return object_base::new_object(exception); }
