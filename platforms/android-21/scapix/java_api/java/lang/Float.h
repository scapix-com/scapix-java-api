...
public:
	...
	static jni::ref<java::lang::Float> new_object(jfloat value) { return object_base::new_object(value); }
	static jni::ref<java::lang::Float> new_object(jdouble value) { return object_base::new_object(value); }
	static jni::ref<java::lang::Float> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
