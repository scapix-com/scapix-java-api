...
public:
	...
	jni::ref<java::nio::charset::CharsetDecoder> replaceWith(jni::ref<java::lang::String> replacement) { return call_method<"replaceWith", jni::ref<java::nio::charset::CharsetDecoder>>(replacement); }
