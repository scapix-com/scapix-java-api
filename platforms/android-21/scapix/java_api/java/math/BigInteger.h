...
public:
	...
	static jni::ref<java::math::BigInteger> new_object(jint numBits, jni::ref<java::util::Random> random) { return object_base::new_object(numBits, random); }
	static jni::ref<java::math::BigInteger> new_object(jint bitLength, jint certainty, jni::ref<java::util::Random> random) { return object_base::new_object(bitLength, certainty, random); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<java::lang::String> value) { return object_base::new_object(value); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<java::lang::String> value, jint radix) { return object_base::new_object(value, radix); }
	...
	static jni::ref<java::math::BigInteger> new_object(jni::ref<jni::array<jbyte>> value) { return object_base::new_object(value); }
