...
public:
	...
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(msg, cause); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> cause, jni::ref<java::security::cert::CertPath> certPath, jint index) { return object_base::new_object(msg, cause, certPath, index); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> cause, jni::ref<java::security::cert::CertPath> certPath, jint index, jni::ref<java::security::cert::CertPathValidatorException_Reason> reason) { return object_base::new_object(msg, cause, certPath, index, reason); }
