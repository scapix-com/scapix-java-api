...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_PHASER
...
public:
	...
	static jni::ref<java::util::concurrent::Phaser> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jint parties) { return object_base::new_object(parties); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jni::ref<java::util::concurrent::Phaser> parent) { return object_base::new_object(parent); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jni::ref<java::util::concurrent::Phaser> parent, jint parties) { return object_base::new_object(parent, parties); }
	jint register_() { return call_method<"register", jint>(); }
	jint bulkRegister(jint parties) { return call_method<"bulkRegister", jint>(parties); }
	...
	jint awaitAdvance(jint phase) { return call_method<"awaitAdvance", jint>(phase); }
	jint awaitAdvanceInterruptibly(jint phase) { return call_method<"awaitAdvanceInterruptibly", jint>(phase); }
	jint awaitAdvanceInterruptibly(jint phase, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"awaitAdvanceInterruptibly", jint>(phase, timeout, unit); }
