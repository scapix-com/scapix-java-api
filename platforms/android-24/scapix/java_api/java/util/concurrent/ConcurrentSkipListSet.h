...
public:
	...
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Comparator> comparator) { return base_::new_object(comparator); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Collection> c) { return base_::new_object(c); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::SortedSet> s) { return base_::new_object(s); }
