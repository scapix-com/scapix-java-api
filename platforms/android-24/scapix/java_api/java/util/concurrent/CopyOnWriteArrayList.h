...
public:
	...
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object(jni::ref<java::util::Collection> collection) { return object_base::new_object(collection); }
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object(jni::ref<jni::array<java::lang::Object>> array) { return object_base::new_object(array); }
