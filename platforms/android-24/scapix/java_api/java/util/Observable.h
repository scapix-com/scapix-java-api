...
public:
	...
	void addObserver(jni::ref<java::util::Observer> o) { return call_method<"addObserver", void>(o); }
	void deleteObserver(jni::ref<java::util::Observer> o) { return call_method<"deleteObserver", void>(o); }
	void notifyObservers() { return call_method<"notifyObservers", void>(); }
	void notifyObservers(jni::ref<java::lang::Object> arg) { return call_method<"notifyObservers", void>(arg); }
