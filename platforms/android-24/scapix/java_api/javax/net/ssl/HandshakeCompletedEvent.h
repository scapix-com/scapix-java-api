...
public:
	...
	static jni::ref<javax::net::ssl::HandshakeCompletedEvent> new_object(jni::ref<javax::net::ssl::SSLSocket> sock, jni::ref<javax::net::ssl::SSLSession> s) { return base_::new_object(sock, s); }
