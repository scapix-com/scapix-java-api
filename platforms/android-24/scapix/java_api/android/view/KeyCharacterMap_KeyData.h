...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_KEYCHARACTERMAP_KEYDATA
...
public:
	...
	static jni::ref<android::view::KeyCharacterMap_KeyData> new_object() { return object_base::new_object(); }
};
