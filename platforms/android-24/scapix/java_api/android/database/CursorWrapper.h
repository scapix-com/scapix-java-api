...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_CURSORWRAPPER
...
public:
	...
	static jni::ref<android::database::CursorWrapper> new_object(jni::ref<android::database::Cursor> cursor) { return object_base::new_object(cursor); }
