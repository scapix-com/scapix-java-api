...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_SPINNER
...
public:
	...
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context, jint mode) { return object_base::new_object(context, mode); }
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint mode) { return object_base::new_object(context, attrs, defStyleAttr, mode); }
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes, jint mode) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes, mode); }
	static jni::ref<android::widget::Spinner> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes, jint mode, jni::ref<android::content::res::Resources_Theme> popupTheme) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes, mode, popupTheme); }
