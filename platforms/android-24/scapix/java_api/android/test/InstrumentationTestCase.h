...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_INSTRUMENTATIONTESTCASE
...
public:
	...
	static jni::ref<android::test::InstrumentationTestCase> new_object() { return object_base::new_object(); }
