...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_COMPARISONFAILURE
...
public:
	...
	static jni::ref<android::test::ComparisonFailure> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::String> expected, jni::ref<java::lang::String> actual) { return object_base::new_object(message, expected, actual); }
