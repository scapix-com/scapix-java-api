...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTENTRESOLVER
...
public:
	...
	static jni::ref<android::test::mock::MockContentResolver> new_object() { return object_base::new_object(); }
	static jni::ref<android::test::mock::MockContentResolver> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
