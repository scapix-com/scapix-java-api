...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_SETTINGS_NAMEVALUETABLE
...
public:
	...
	static jni::ref<android::provider::Settings_NameValueTable> new_object() { return object_base::new_object(); }
