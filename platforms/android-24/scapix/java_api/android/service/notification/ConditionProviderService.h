...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_NOTIFICATION_CONDITIONPROVIDERSERVICE
...
public:
	...
	static jni::ref<android::service::notification::ConditionProviderService> new_object() { return object_base::new_object(); }
