...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_TEXTSERVICE_SPELLCHECKERSERVICE_SESSION
...
public:
	...
	static jni::ref<android::service::textservice::SpellCheckerService_Session> new_object() { return object_base::new_object(); }
