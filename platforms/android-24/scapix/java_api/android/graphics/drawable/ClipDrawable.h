...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_CLIPDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::ClipDrawable> new_object(jni::ref<android::graphics::drawable::Drawable> drawable, jint gravity, jint orientation) { return object_base::new_object(drawable, gravity, orientation); }
