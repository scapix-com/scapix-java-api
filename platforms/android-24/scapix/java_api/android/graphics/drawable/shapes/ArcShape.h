...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_SHAPES_ARCSHAPE
...
public:
	...
	static jni::ref<android::graphics::drawable::shapes::ArcShape> new_object(jfloat startAngle, jfloat sweepAngle) { return object_base::new_object(startAngle, sweepAngle); }
