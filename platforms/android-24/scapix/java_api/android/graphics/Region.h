...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_REGION
...
public:
	...
	static jni::ref<android::graphics::Region> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::Region> new_object(jni::ref<android::graphics::Region> region) { return object_base::new_object(region); }
	static jni::ref<android::graphics::Region> new_object(jni::ref<android::graphics::Rect> r) { return object_base::new_object(r); }
	static jni::ref<android::graphics::Region> new_object(jint left, jint top, jint right, jint bottom) { return object_base::new_object(left, top, right, bottom); }
