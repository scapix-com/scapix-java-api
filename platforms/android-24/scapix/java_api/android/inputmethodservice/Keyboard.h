...
#ifndef SCAPIX_JAVA_API_ANDROID_INPUTMETHODSERVICE_KEYBOARD
...
public:
	...
	static jni::ref<android::inputmethodservice::Keyboard> new_object(jni::ref<android::content::Context> context, jint xmlLayoutResId) { return object_base::new_object(context, xmlLayoutResId); }
	static jni::ref<android::inputmethodservice::Keyboard> new_object(jni::ref<android::content::Context> context, jint xmlLayoutResId, jint modeId, jint width, jint height) { return object_base::new_object(context, xmlLayoutResId, modeId, width, height); }
	static jni::ref<android::inputmethodservice::Keyboard> new_object(jni::ref<android::content::Context> context, jint xmlLayoutResId, jint modeId) { return object_base::new_object(context, xmlLayoutResId, modeId); }
	static jni::ref<android::inputmethodservice::Keyboard> new_object(jni::ref<android::content::Context> context, jint layoutTemplateResId, jni::ref<java::lang::CharSequence> characters, jint columns, jint horizontalPadding) { return object_base::new_object(context, layoutTemplateResId, characters, columns, horizontalPadding); }
