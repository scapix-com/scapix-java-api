...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SOUNDPOOL
...
public:
	...
	static jni::ref<android::media::SoundPool> new_object(jint maxStreams, jint streamType, jint srcQuality) { return object_base::new_object(maxStreams, streamType, srcQuality); }
	...
	jint load(jni::ref<java::io::FileDescriptor> fd, jlong offset, jlong length, jint priority) { return call_method<"load", jint>(fd, offset, length, priority); }
	jboolean unload(jint p1) { return call_method<"unload", jboolean>(p1); }
	...
	void pause(jint p1) { return call_method<"pause", void>(p1); }
	void resume(jint p1) { return call_method<"resume", void>(p1); }
	...
	void setPriority(jint p1, jint p2) { return call_method<"setPriority", void>(p1, p2); }
	void setLoop(jint p1, jint p2) { return call_method<"setLoop", void>(p1, p2); }
	void setRate(jint p1, jfloat p2) { return call_method<"setRate", void>(p1, p2); }
