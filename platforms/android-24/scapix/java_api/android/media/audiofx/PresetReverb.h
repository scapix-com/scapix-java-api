...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_PRESETREVERB
...
public:
	...
	static jni::ref<android::media::audiofx::PresetReverb> new_object(jint priority, jint audioSession) { return object_base::new_object(priority, audioSession); }
