...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_CONFIGURATIONINFO
...
public:
	...
	static jni::ref<android::content::pm::ConfigurationInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::ConfigurationInfo> new_object(jni::ref<android::content::pm::ConfigurationInfo> orig) { return object_base::new_object(orig); }
