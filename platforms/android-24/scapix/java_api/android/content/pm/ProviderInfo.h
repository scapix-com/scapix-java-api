...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PROVIDERINFO
...
public:
	...
	static jni::ref<android::content::pm::ProviderInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::ProviderInfo> new_object(jni::ref<android::content::pm::ProviderInfo> orig) { return object_base::new_object(orig); }
