...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_SHORT3
...
public:
	...
	static jni::ref<android::renderscript::Short3> new_object() { return object_base::new_object(); }
	static jni::ref<android::renderscript::Short3> new_object(jshort x, jshort y, jshort z) { return object_base::new_object(x, y, z); }
};
