...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_URLSPAN
...
public:
	...
	static jni::ref<android::text::style::URLSpan> new_object(jni::ref<java::lang::String> url) { return object_base::new_object(url); }
	static jni::ref<android::text::style::URLSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
