...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_AEADBADTAGEXCEPTION
...
public:
	...
	static jni::ref<javax::crypto::AEADBadTagException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::crypto::AEADBadTagException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
