...
public:
	...
	static jni::ref<javax::crypto::EncryptedPrivateKeyInfo> new_object(jni::ref<java::lang::String> encryptionAlgorithmName, jni::ref<jni::array<jbyte>> encryptedData) { return object_base::new_object(encryptionAlgorithmName, encryptedData); }
