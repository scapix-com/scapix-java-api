...
public:
	...
	static jni::ref<javax::security::auth::Subject> new_object(jboolean readOnly, jni::ref<java::util::Set> subjPrincipals, jni::ref<java::util::Set> pubCredentials, jni::ref<java::util::Set> privCredentials) { return object_base::new_object(readOnly, subjPrincipals, pubCredentials, privCredentials); }
