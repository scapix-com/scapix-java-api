...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_DATATYPE_DATATYPECONFIGURATIONEXCEPTION
...
public:
	...
	static jni::ref<javax::xml::datatype::DatatypeConfigurationException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::xml::datatype::DatatypeConfigurationException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<javax::xml::datatype::DatatypeConfigurationException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
	static jni::ref<javax::xml::datatype::DatatypeConfigurationException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
