...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHARSET_CHARSETENCODER
...
public:
	...
	jboolean canEncode(jni::ref<java::lang::CharSequence> sequence) { return call_method<"canEncode", jboolean>(sequence); }
	...
	jboolean isLegalReplacement(jni::ref<jni::array<jbyte>> replacement) { return call_method<"isLegalReplacement", jboolean>(replacement); }
	...
	jni::ref<java::nio::charset::CharsetEncoder> replaceWith(jni::ref<jni::array<jbyte>> replacement) { return call_method<"replaceWith", jni::ref<java::nio::charset::CharsetEncoder>>(replacement); }
