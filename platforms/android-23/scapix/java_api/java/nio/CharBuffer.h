...
struct scapix::jni::object_traits<scapix::java_api::java::nio::CharBuffer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::nio::Buffer, scapix::java_api::java::lang::Comparable, scapix::java_api::java::lang::CharSequence, scapix::java_api::java::lang::Appendable, scapix::java_api::java::lang::Readable>;
};
...
public:
	...
	static jni::ref<java::nio::CharBuffer> wrap(jni::ref<jni::array<jchar>> array, jint start, jint charCount) { return call_static_method<"wrap", jni::ref<java::nio::CharBuffer>>(array, start, charCount); }
	static jni::ref<java::nio::CharBuffer> wrap(jni::ref<java::lang::CharSequence> chseq) { return call_static_method<"wrap", jni::ref<java::nio::CharBuffer>>(chseq); }
	static jni::ref<java::nio::CharBuffer> wrap(jni::ref<java::lang::CharSequence> cs, jint start, jint end) { return call_static_method<"wrap", jni::ref<java::nio::CharBuffer>>(cs, start, end); }
	...
	jint compareTo(jni::ref<java::nio::CharBuffer> otherBuffer) { return call_method<"compareTo", jint>(otherBuffer); }
	...
	jni::ref<java::nio::CharBuffer> get(jni::ref<jni::array<jchar>> dst, jint dstOffset, jint charCount) { return call_method<"get", jni::ref<java::nio::CharBuffer>>(dst, dstOffset, charCount); }
	...
	jni::ref<java::nio::CharBuffer> put(jni::ref<jni::array<jchar>> src, jint srcOffset, jint charCount) { return call_method<"put", jni::ref<java::nio::CharBuffer>>(src, srcOffset, charCount); }
	...
	jni::ref<java::nio::CharBuffer> put(jni::ref<java::lang::String> str) { return call_method<"put", jni::ref<java::nio::CharBuffer>>(str); }
	jni::ref<java::nio::CharBuffer> put(jni::ref<java::lang::String> str, jint start, jint end) { return call_method<"put", jni::ref<java::nio::CharBuffer>>(str, start, end); }
