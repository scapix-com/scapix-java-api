...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_FIELDPOSITION
...
public:
	...
	static jni::ref<java::text::FieldPosition> new_object(jint field) { return object_base::new_object(field); }
	static jni::ref<java::text::FieldPosition> new_object(jni::ref<java::text::Format_Field> attribute) { return object_base::new_object(attribute); }
	static jni::ref<java::text::FieldPosition> new_object(jni::ref<java::text::Format_Field> attribute, jint field) { return object_base::new_object(attribute, field); }
	...
	void setBeginIndex(jint index) { return call_method<"setBeginIndex", void>(index); }
	void setEndIndex(jint index) { return call_method<"setEndIndex", void>(index); }
