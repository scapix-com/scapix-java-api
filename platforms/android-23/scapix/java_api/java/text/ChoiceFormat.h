...
public:
	...
	static jni::ref<java::text::ChoiceFormat> new_object(jni::ref<java::lang::String> template_) { return base_::new_object(template_); }
	...
	static jdouble nextDouble(jdouble value, jboolean p2) { return call_static_method<"nextDouble", jdouble>(value, p2); }
