...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_COLLATOR
...
public:
	...
	jint compare(jni::ref<java::lang::Object> object1, jni::ref<java::lang::Object> object2) { return call_method<"compare", jint>(object1, object2); }
	...
	jboolean equals(jni::ref<java::lang::String> string1, jni::ref<java::lang::String> string2) { return call_method<"equals", jboolean>(string1, string2); }
	...
	static jni::ref<java::text::Collator> getInstance(jni::ref<java::util::Locale> locale) { return call_static_method<"getInstance", jni::ref<java::text::Collator>>(locale); }
	jint getStrength() { return call_method<"getStrength", jint>(); }
	jint hashCode() { return call_method<"hashCode", jint>(); }
	void setDecomposition(jint value) { return call_method<"setDecomposition", void>(value); }
	void setStrength(jint value) { return call_method<"setStrength", void>(value); }
};
