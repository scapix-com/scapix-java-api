...
public:
	...
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> template_, jni::ref<java::text::DateFormatSymbols> value) { return object_base::new_object(template_, value); }
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> template_, jni::ref<java::util::Locale> locale) { return object_base::new_object(template_, locale); }
