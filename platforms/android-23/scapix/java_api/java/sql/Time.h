...
public:
	...
	static jni::ref<java::sql::Time> new_object(jint theHour, jint theMinute, jint theSecond) { return object_base::new_object(theHour, theMinute, theSecond); }
	static jni::ref<java::sql::Time> new_object(jlong theTime) { return object_base::new_object(theTime); }
