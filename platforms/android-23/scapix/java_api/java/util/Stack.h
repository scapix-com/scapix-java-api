...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_STACK
...
public:
	...
	static jni::ref<java::util::Stack> new_object() { return object_base::new_object(); }
	...
	jni::ref<java::lang::Object> push(jni::ref<java::lang::Object> object) { return call_method<"push", jni::ref<java::lang::Object>>(object); }
