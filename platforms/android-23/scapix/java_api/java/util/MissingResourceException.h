...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_MISSINGRESOURCEEXCEPTION
...
public:
	...
	static jni::ref<java::util::MissingResourceException> new_object(jni::ref<java::lang::String> detailMessage, jni::ref<java::lang::String> className, jni::ref<java::lang::String> resourceName) { return object_base::new_object(detailMessage, className, resourceName); }
