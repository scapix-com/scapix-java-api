...
public:
	...
	static jni::ref<java::util::MissingResourceException> new_object(jni::ref<java::lang::String> detailMessage, jni::ref<java::lang::String> className, jni::ref<java::lang::String> resourceName) { return base_::new_object(detailMessage, className, resourceName); }
