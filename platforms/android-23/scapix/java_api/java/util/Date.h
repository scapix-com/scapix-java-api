...
public:
	...
	static jni::ref<java::util::Date> new_object(jint year, jint month, jint day) { return object_base::new_object(year, month, day); }
	static jni::ref<java::util::Date> new_object(jint year, jint month, jint day, jint hour, jint minute) { return object_base::new_object(year, month, day, hour, minute); }
	static jni::ref<java::util::Date> new_object(jint year, jint month, jint day, jint hour, jint minute, jint second) { return object_base::new_object(year, month, day, hour, minute, second); }
	static jni::ref<java::util::Date> new_object(jlong milliseconds) { return object_base::new_object(milliseconds); }
	static jni::ref<java::util::Date> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
