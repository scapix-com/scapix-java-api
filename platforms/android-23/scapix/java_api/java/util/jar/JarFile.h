...
public:
	...
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> filename) { return object_base::new_object(filename); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> filename, jboolean verify) { return object_base::new_object(filename, verify); }
