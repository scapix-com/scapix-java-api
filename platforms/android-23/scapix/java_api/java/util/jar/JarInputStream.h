...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_JAR_JARINPUTSTREAM
...
public:
	...
	static jni::ref<java::util::jar::JarInputStream> new_object(jni::ref<java::io::InputStream> stream, jboolean verify) { return object_base::new_object(stream, verify); }
	static jni::ref<java::util::jar::JarInputStream> new_object(jni::ref<java::io::InputStream> stream) { return object_base::new_object(stream); }
