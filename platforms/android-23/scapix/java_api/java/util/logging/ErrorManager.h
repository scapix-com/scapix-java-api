...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOGGING_ERRORMANAGER
...
public:
	...
	static jni::ref<java::util::logging::ErrorManager> new_object() { return object_base::new_object(); }
	void error(jni::ref<java::lang::String> message, jni::ref<java::lang::Exception> exception, jint errorCode) { return call_method<"error", void>(message, exception, errorCode); }
};
