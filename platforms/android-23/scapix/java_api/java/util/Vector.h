...
public:
	...
	static jni::ref<java::util::Vector> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::Vector> new_object(jint capacity, jint capacityIncrement) { return object_base::new_object(capacity, capacityIncrement); }
	static jni::ref<java::util::Vector> new_object(jni::ref<java::util::Collection> collection) { return object_base::new_object(collection); }
