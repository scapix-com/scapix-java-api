...
public:
	...
	static jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> new_object(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer> p1) { return object_base::new_object(p1); }
