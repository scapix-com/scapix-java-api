...
public:
	...
	static jni::ref<java::util::HashSet> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::HashSet> new_object(jint capacity, jfloat loadFactor) { return object_base::new_object(capacity, loadFactor); }
	static jni::ref<java::util::HashSet> new_object(jni::ref<java::util::Collection> collection) { return object_base::new_object(collection); }
