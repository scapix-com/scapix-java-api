...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CALENDAR
...
public:
	...
	jboolean after(jni::ref<java::lang::Object> calendar) { return call_method<"after", jboolean>(calendar); }
	jboolean before(jni::ref<java::lang::Object> calendar) { return call_method<"before", jboolean>(calendar); }
	...
	static jni::ref<java::util::Calendar> getInstance(jni::ref<java::util::Locale> locale) { return call_static_method<"getInstance", jni::ref<java::util::Calendar>>(locale); }
	static jni::ref<java::util::Calendar> getInstance(jni::ref<java::util::TimeZone> timezone) { return call_static_method<"getInstance", jni::ref<java::util::Calendar>>(timezone); }
	static jni::ref<java::util::Calendar> getInstance(jni::ref<java::util::TimeZone> timezone, jni::ref<java::util::Locale> locale) { return call_static_method<"getInstance", jni::ref<java::util::Calendar>>(timezone, locale); }
	...
	void set(jint year, jint month, jint day) { return call_method<"set", void>(year, month, day); }
	void set(jint year, jint month, jint day, jint hourOfDay, jint minute) { return call_method<"set", void>(year, month, day, hourOfDay, minute); }
	void set(jint year, jint month, jint day, jint hourOfDay, jint minute, jint second) { return call_method<"set", void>(year, month, day, hourOfDay, minute, second); }
	...
	void setTimeInMillis(jlong milliseconds) { return call_method<"setTimeInMillis", void>(milliseconds); }
	void setTimeZone(jni::ref<java::util::TimeZone> timezone) { return call_method<"setTimeZone", void>(timezone); }
	jni::ref<java::lang::String> toString() { return call_method<"toString", jni::ref<java::lang::String>>(); }
	jint compareTo(jni::ref<java::util::Calendar> anotherCalendar) { return call_method<"compareTo", jint>(anotherCalendar); }
