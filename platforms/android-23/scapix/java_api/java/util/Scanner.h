...
public:
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> src) { return object_base::new_object(src); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> src, jni::ref<java::lang::String> charsetName) { return object_base::new_object(src, charsetName); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::lang::String> src) { return object_base::new_object(src); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> src) { return object_base::new_object(src); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> src, jni::ref<java::lang::String> charsetName) { return object_base::new_object(src, charsetName); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::lang::Readable> src) { return object_base::new_object(src); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> src) { return object_base::new_object(src); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> src, jni::ref<java::lang::String> charsetName) { return object_base::new_object(src, charsetName); }
