...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_OBSERVABLE
...
public:
	...
	static jni::ref<java::util::Observable> new_object() { return object_base::new_object(); }
	void addObserver(jni::ref<java::util::Observer> observer) { return call_method<"addObserver", void>(observer); }
	jint countObservers() { return call_method<"countObservers", jint>(); }
	void deleteObserver(jni::ref<java::util::Observer> observer) { return call_method<"deleteObserver", void>(observer); }
	...
	void notifyObservers(jni::ref<java::lang::Object> data) { return call_method<"notifyObservers", void>(data); }
};
