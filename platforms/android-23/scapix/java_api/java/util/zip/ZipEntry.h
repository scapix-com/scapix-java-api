...
public:
	...
	static jni::ref<java::util::zip::ZipEntry> new_object(jni::ref<java::util::zip::ZipEntry> ze) { return object_base::new_object(ze); }
	...
	void setCompressedSize(jlong value) { return call_method<"setCompressedSize", void>(value); }
	void setCrc(jlong value) { return call_method<"setCrc", void>(value); }
	void setExtra(jni::ref<jni::array<jbyte>> data) { return call_method<"setExtra", void>(data); }
	void setMethod(jint value) { return call_method<"setMethod", void>(value); }
	void setSize(jlong value) { return call_method<"setSize", void>(value); }
	void setTime(jlong value) { return call_method<"setTime", void>(value); }
