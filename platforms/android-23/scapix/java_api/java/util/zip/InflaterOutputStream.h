...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_INFLATEROUTPUTSTREAM
...
public:
	...
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> out) { return object_base::new_object(out); }
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::zip::Inflater> inf) { return object_base::new_object(out, inf); }
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::zip::Inflater> inf, jint bufferSize) { return object_base::new_object(out, inf, bufferSize); }
