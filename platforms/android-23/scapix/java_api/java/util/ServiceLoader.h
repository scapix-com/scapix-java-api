...
public:
	...
	static jni::ref<java::util::ServiceLoader> load(jni::ref<java::lang::Class> service, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"load", jni::ref<java::util::ServiceLoader>>(service, classLoader); }
