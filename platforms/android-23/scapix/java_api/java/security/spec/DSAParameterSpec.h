...
public:
	...
	static jni::ref<java::security::spec::DSAParameterSpec> new_object(jni::ref<java::math::BigInteger> p, jni::ref<java::math::BigInteger> q, jni::ref<java::math::BigInteger> g) { return object_base::new_object(p, q, g); }
