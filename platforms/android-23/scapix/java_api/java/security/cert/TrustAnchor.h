...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_TRUSTANCHOR
...
public:
	...
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<java::security::cert::X509Certificate> trustedCert, jni::ref<jni::array<jbyte>> nameConstraints) { return object_base::new_object(trustedCert, nameConstraints); }
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<java::lang::String> caName, jni::ref<java::security::PublicKey> caPublicKey, jni::ref<jni::array<jbyte>> nameConstraints) { return object_base::new_object(caName, caPublicKey, nameConstraints); }
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<javax::security::auth::x500::X500Principal> caPrincipal, jni::ref<java::security::PublicKey> caPublicKey, jni::ref<jni::array<jbyte>> nameConstraints) { return object_base::new_object(caPrincipal, caPublicKey, nameConstraints); }
