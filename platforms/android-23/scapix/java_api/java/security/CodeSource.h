...
public:
	...
	static jni::ref<java::security::CodeSource> new_object(jni::ref<java::net::URL> location, jni::ref<jni::array<java::security::cert::Certificate>> certs) { return object_base::new_object(location, certs); }
	static jni::ref<java::security::CodeSource> new_object(jni::ref<java::net::URL> location, jni::ref<jni::array<java::security::CodeSigner>> signers) { return object_base::new_object(location, signers); }
