...
public:
	...
	static jdouble max(jdouble d1, jdouble d2) { return call_static_method<"max", jdouble>(d1, d2); }
	...
	static jlong max(jlong l1, jlong l2) { return call_static_method<"max", jlong>(l1, l2); }
	static jdouble min(jdouble d1, jdouble d2) { return call_static_method<"min", jdouble>(d1, d2); }
	...
	static jlong min(jlong l1, jlong l2) { return call_static_method<"min", jlong>(l1, l2); }
