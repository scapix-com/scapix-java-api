...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_BOOLEAN
...
public:
	...
	static jni::ref<java::lang::Boolean> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
	static jni::ref<java::lang::Boolean> new_object(jboolean value) { return object_base::new_object(value); }
