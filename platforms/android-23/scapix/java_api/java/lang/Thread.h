...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_THREAD
...
public:
	...
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> runnable) { return object_base::new_object(runnable); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> runnable, jni::ref<java::lang::String> threadName) { return object_base::new_object(runnable, threadName); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::String> threadName) { return object_base::new_object(threadName); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> runnable) { return object_base::new_object(group, runnable); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> runnable, jni::ref<java::lang::String> threadName) { return object_base::new_object(group, runnable, threadName); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::String> threadName) { return object_base::new_object(group, threadName); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> runnable, jni::ref<java::lang::String> threadName, jlong stackSize) { return object_base::new_object(group, runnable, threadName, stackSize); }
