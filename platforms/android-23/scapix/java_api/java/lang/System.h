...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_SYSTEM
...
public:
	...
	static void setIn(jni::ref<java::io::InputStream> newIn) { return call_static_method<"setIn", void>(newIn); }
	static void setOut(jni::ref<java::io::PrintStream> newOut) { return call_static_method<"setOut", void>(newOut); }
	static void setErr(jni::ref<java::io::PrintStream> newErr) { return call_static_method<"setErr", void>(newErr); }
	...
	static void exit(jint code) { return call_static_method<"exit", void>(code); }
	...
	static jni::ref<java::lang::String> getProperty(jni::ref<java::lang::String> propertyName) { return call_static_method<"getProperty", jni::ref<java::lang::String>>(propertyName); }
	static jni::ref<java::lang::String> getProperty(jni::ref<java::lang::String> name, jni::ref<java::lang::String> defaultValue) { return call_static_method<"getProperty", jni::ref<java::lang::String>>(name, defaultValue); }
	static jni::ref<java::lang::String> setProperty(jni::ref<java::lang::String> name, jni::ref<java::lang::String> value) { return call_static_method<"setProperty", jni::ref<java::lang::String>>(name, value); }
	static jni::ref<java::lang::String> clearProperty(jni::ref<java::lang::String> name) { return call_static_method<"clearProperty", jni::ref<java::lang::String>>(name); }
	...
	static void load(jni::ref<java::lang::String> pathName) { return call_static_method<"load", void>(pathName); }
	...
	static void runFinalizersOnExit(jboolean flag) { return call_static_method<"runFinalizersOnExit", void>(flag); }
	static void setProperties(jni::ref<java::util::Properties> p) { return call_static_method<"setProperties", void>(p); }
	static void setSecurityManager(jni::ref<java::lang::SecurityManager> sm) { return call_static_method<"setSecurityManager", void>(sm); }
	static jni::ref<java::lang::String> mapLibraryName(jni::ref<java::lang::String> nickname) { return call_static_method<"mapLibraryName", jni::ref<java::lang::String>>(nickname); }
};
