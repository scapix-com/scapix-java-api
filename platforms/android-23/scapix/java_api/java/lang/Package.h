...
public:
	...
	static jni::ref<java::lang::Package> getPackage(jni::ref<java::lang::String> packageName) { return call_static_method<"getPackage", jni::ref<java::lang::Package>>(packageName); }
	...
	jboolean isCompatibleWith(jni::ref<java::lang::String> version) { return call_method<"isCompatibleWith", jboolean>(version); }
