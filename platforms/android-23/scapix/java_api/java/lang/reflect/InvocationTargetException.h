...
public:
	...
	static jni::ref<java::lang::reflect::InvocationTargetException> new_object(jni::ref<java::lang::Throwable> exception) { return base_::new_object(exception); }
	static jni::ref<java::lang::reflect::InvocationTargetException> new_object(jni::ref<java::lang::Throwable> exception, jni::ref<java::lang::String> detailMessage) { return base_::new_object(exception, detailMessage); }
