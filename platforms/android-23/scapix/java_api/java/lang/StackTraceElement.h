...
public:
	...
	static jni::ref<java::lang::StackTraceElement> new_object(jni::ref<java::lang::String> cls, jni::ref<java::lang::String> method, jni::ref<java::lang::String> file, jint line) { return base_::new_object(cls, method, file, line); }
