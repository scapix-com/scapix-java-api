...
#ifndef SCAPIX_JAVA_API_JAVA_NET_PORTUNREACHABLEEXCEPTION
...
public:
	...
	static jni::ref<java::net::PortUnreachableException> new_object() { return object_base::new_object(); }
	static jni::ref<java::net::PortUnreachableException> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
};
