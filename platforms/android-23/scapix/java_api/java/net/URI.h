...
public:
	...
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> spec) { return object_base::new_object(spec); }
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> scheme, jni::ref<java::lang::String> schemeSpecificPart, jni::ref<java::lang::String> fragment) { return object_base::new_object(scheme, schemeSpecificPart, fragment); }
