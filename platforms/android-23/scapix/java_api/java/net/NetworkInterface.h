...
public:
	...
	static jni::ref<java::net::NetworkInterface> getByName(jni::ref<java::lang::String> interfaceName) { return call_static_method<"getByName", jni::ref<java::net::NetworkInterface>>(interfaceName); }
	static jni::ref<java::net::NetworkInterface> getByInetAddress(jni::ref<java::net::InetAddress> address) { return call_static_method<"getByInetAddress", jni::ref<java::net::NetworkInterface>>(address); }
