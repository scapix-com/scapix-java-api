...
#ifndef SCAPIX_JAVA_API_JAVA_NET_HTTPURLCONNECTION
...
public:
	...
	static void setFollowRedirects(jboolean auto_) { return call_static_method<"setFollowRedirects", void>(auto_); }
	...
	void setChunkedStreamingMode(jint chunkLength) { return call_method<"setChunkedStreamingMode", void>(chunkLength); }
};
