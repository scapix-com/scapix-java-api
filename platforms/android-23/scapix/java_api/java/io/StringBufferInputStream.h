...
#ifndef SCAPIX_JAVA_API_JAVA_IO_STRINGBUFFERINPUTSTREAM
...
public:
	...
	static jni::ref<java::io::StringBufferInputStream> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
