...
#ifndef SCAPIX_JAVA_API_JAVA_IO_BYTEARRAYOUTPUTSTREAM
...
public:
	...
	static jni::ref<java::io::ByteArrayOutputStream> new_object() { return object_base::new_object(); }
	static jni::ref<java::io::ByteArrayOutputStream> new_object(jint size) { return object_base::new_object(size); }
