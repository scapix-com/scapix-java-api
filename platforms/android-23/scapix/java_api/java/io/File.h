...
public:
	...
	static jni::ref<java::io::File> new_object(jni::ref<java::io::File> dir, jni::ref<java::lang::String> name) { return object_base::new_object(dir, name); }
	static jni::ref<java::io::File> new_object(jni::ref<java::lang::String> path) { return object_base::new_object(path); }
	static jni::ref<java::io::File> new_object(jni::ref<java::lang::String> dirPath, jni::ref<java::lang::String> name) { return object_base::new_object(dirPath, name); }
