...
public:
	...
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> className, jni::ref<java::lang::String> detailMessage) { return object_base::new_object(className, detailMessage); }
