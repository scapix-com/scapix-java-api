...
public:
	...
	static jni::ref<java::io::FileInputStream> new_object(jni::ref<java::io::FileDescriptor> fd) { return base_::new_object(fd); }
	static jni::ref<java::io::FileInputStream> new_object(jni::ref<java::lang::String> path) { return base_::new_object(path); }
