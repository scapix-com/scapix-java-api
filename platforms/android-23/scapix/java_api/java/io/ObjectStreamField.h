...
public:
	...
	static jni::ref<java::io::ObjectStreamField> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> cl) { return object_base::new_object(name, cl); }
	static jni::ref<java::io::ObjectStreamField> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> cl, jboolean unshared) { return object_base::new_object(name, cl, unshared); }
