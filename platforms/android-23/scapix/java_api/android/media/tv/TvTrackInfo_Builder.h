...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVTRACKINFO_BUILDER
...
public:
	...
	static jni::ref<android::media::tv::TvTrackInfo_Builder> new_object(jint type, jni::ref<java::lang::String> id) { return object_base::new_object(type, id); }
