...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_GALLERY_LAYOUTPARAMS
...
public:
	...
	static jni::ref<android::widget::Gallery_LayoutParams> new_object(jni::ref<android::content::Context> c, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(c, attrs); }
	static jni::ref<android::widget::Gallery_LayoutParams> new_object(jint w, jint h) { return object_base::new_object(w, h); }
	static jni::ref<android::widget::Gallery_LayoutParams> new_object(jni::ref<android::view::ViewGroup_LayoutParams> source) { return object_base::new_object(source); }
};
