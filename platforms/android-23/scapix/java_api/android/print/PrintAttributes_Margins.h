...
#ifndef SCAPIX_JAVA_API_ANDROID_PRINT_PRINTATTRIBUTES_MARGINS
...
public:
	...
	static jni::ref<android::print::PrintAttributes_Margins> new_object(jint leftMils, jint topMils, jint rightMils, jint bottomMils) { return object_base::new_object(leftMils, topMils, rightMils, bottomMils); }
