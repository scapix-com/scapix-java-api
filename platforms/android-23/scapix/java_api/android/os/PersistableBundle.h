...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_PERSISTABLEBUNDLE
...
public:
	...
	static jni::ref<android::os::PersistableBundle> new_object() { return object_base::new_object(); }
	static jni::ref<android::os::PersistableBundle> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<android::os::PersistableBundle> new_object(jni::ref<android::os::PersistableBundle> b) { return object_base::new_object(b); }
