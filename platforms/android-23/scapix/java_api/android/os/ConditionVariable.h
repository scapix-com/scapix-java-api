...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_CONDITIONVARIABLE
...
public:
	...
	static jni::ref<android::os::ConditionVariable> new_object() { return object_base::new_object(); }
	static jni::ref<android::os::ConditionVariable> new_object(jboolean state) { return object_base::new_object(state); }
