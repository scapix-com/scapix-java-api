...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ANIMATION_ANIMATION
...
public:
	...
	static jni::ref<android::view::animation::Animation> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::animation::Animation> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	...
	jboolean getTransformation(jlong currentTime, jni::ref<android::view::animation::Transformation> outTransformation) { return call_method<"getTransformation", jboolean>(currentTime, outTransformation); }
	jboolean getTransformation(jlong currentTime, jni::ref<android::view::animation::Transformation> outTransformation, jfloat scale) { return call_method<"getTransformation", jboolean>(currentTime, outTransformation, scale); }
