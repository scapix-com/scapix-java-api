...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TOUCHDELEGATE
...
public:
	...
	static jni::ref<android::view::TouchDelegate> new_object(jni::ref<android::graphics::Rect> bounds, jni::ref<android::view::View> delegateView) { return object_base::new_object(bounds, delegateView); }
