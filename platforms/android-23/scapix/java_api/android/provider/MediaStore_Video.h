...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_VIDEO
...
public:
	...
	static jni::ref<android::provider::MediaStore_Video> new_object() { return object_base::new_object(); }
