...
public:
	...
	static jni::ref<android::service::wallpaper::WallpaperService_Engine> new_object(jni::ref<android::service::wallpaper::WallpaperService> p1) { return object_base::new_object(p1); }
