...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_ASYNCTASKLOADER
...
public:
	...
	static jni::ref<android::content::AsyncTaskLoader> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
