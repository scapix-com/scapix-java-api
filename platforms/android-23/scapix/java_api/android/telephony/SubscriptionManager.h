...
public:
	...
	jni::ref<android::telephony::SubscriptionInfo> getActiveSubscriptionInfoForSimSlotIndex(jint slotIdx) { return call_method<"getActiveSubscriptionInfoForSimSlotIndex", jni::ref<android::telephony::SubscriptionInfo>>(slotIdx); }
