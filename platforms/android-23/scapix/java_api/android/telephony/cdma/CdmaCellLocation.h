...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_CDMA_CDMACELLLOCATION
...
public:
	...
	static jni::ref<android::telephony::cdma::CdmaCellLocation> new_object() { return object_base::new_object(); }
	static jni::ref<android::telephony::cdma::CdmaCellLocation> new_object(jni::ref<android::os::Bundle> bundle) { return object_base::new_object(bundle); }
