...
public:
	...
	static jni::ref<android::location::Location> new_object(jni::ref<android::location::Location> l) { return object_base::new_object(l); }
	...
	void setAccuracy(jfloat accuracy) { return call_method<"setAccuracy", void>(accuracy); }
