...
public:
	...
	static jni::ref<android::app::DatePickerDialog> new_object(jni::ref<android::content::Context> context, jni::ref<android::app::DatePickerDialog_OnDateSetListener> callBack, jint year, jint monthOfYear, jint dayOfMonth) { return base_::new_object(context, callBack, year, monthOfYear, dayOfMonth); }
	static jni::ref<android::app::DatePickerDialog> new_object(jni::ref<android::content::Context> context, jint theme, jni::ref<android::app::DatePickerDialog_OnDateSetListener> listener, jint year, jint monthOfYear, jint dayOfMonth) { return base_::new_object(context, theme, listener, year, monthOfYear, dayOfMonth); }
