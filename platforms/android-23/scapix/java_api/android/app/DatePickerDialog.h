...
public:
	...
	static jni::ref<android::app::DatePickerDialog> new_object(jni::ref<android::content::Context> context, jni::ref<android::app::DatePickerDialog_OnDateSetListener> callBack, jint year, jint monthOfYear, jint dayOfMonth) { return object_base::new_object(context, callBack, year, monthOfYear, dayOfMonth); }
	static jni::ref<android::app::DatePickerDialog> new_object(jni::ref<android::content::Context> context, jint theme, jni::ref<android::app::DatePickerDialog_OnDateSetListener> listener, jint year, jint monthOfYear, jint dayOfMonth) { return object_base::new_object(context, theme, listener, year, monthOfYear, dayOfMonth); }
	void onDateChanged(jni::ref<android::widget::DatePicker> view, jint year, jint month, jint day) { return call_method<"onDateChanged", void>(view, year, month, day); }
	...
	void updateDate(jint year, jint monthOfYear, jint dayOfMonth) { return call_method<"updateDate", void>(year, monthOfYear, dayOfMonth); }
