...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_LAUNCHERACTIVITY_LISTITEM
...
public:
	...
	static jni::ref<android::app::LauncherActivity_ListItem> new_object() { return object_base::new_object(); }
};
