...
#ifndef SCAPIX_JAVA_API_JAVAX_SMARTCARDIO_CARDNOTPRESENTEXCEPTION
...
public:
	...
	static jni::ref<javax::smartcardio::CardNotPresentException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<javax::smartcardio::CardNotPresentException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
	static jni::ref<javax::smartcardio::CardNotPresentException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
};
