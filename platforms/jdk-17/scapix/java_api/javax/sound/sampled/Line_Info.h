...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_LINE_INFO
...
public:
	...
	static jni::ref<javax::sound::sampled::Line_Info> new_object(jni::ref<java::lang::Class> lineClass) { return object_base::new_object(lineClass); }
