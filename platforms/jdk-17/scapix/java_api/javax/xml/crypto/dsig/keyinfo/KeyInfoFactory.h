...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_KEYINFO_KEYINFOFACTORY
...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::keyinfo::KeyInfoFactory> getInstance(jni::ref<java::lang::String> mechanismType) { return call_static_method<"getInstance", jni::ref<javax::xml::crypto::dsig::keyinfo::KeyInfoFactory>>(mechanismType); }
	static jni::ref<javax::xml::crypto::dsig::keyinfo::KeyInfoFactory> getInstance(jni::ref<java::lang::String> mechanismType, jni::ref<java::security::Provider> provider) { return call_static_method<"getInstance", jni::ref<javax::xml::crypto::dsig::keyinfo::KeyInfoFactory>>(mechanismType, provider); }
	static jni::ref<javax::xml::crypto::dsig::keyinfo::KeyInfoFactory> getInstance(jni::ref<java::lang::String> mechanismType, jni::ref<java::lang::String> provider) { return call_static_method<"getInstance", jni::ref<javax::xml::crypto::dsig::keyinfo::KeyInfoFactory>>(mechanismType, provider); }
