...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_CANONICALIZATIONMETHOD
...
public:
	...
	static jni::ref<java::lang::String> INCLUSIVE_11() { return get_static_field<"INCLUSIVE_11", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> INCLUSIVE_11_WITH_COMMENTS() { return get_static_field<"INCLUSIVE_11_WITH_COMMENTS", jni::ref<java::lang::String>>(); }
