...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_DIGESTMETHOD
...
public:
	...
	static jni::ref<java::lang::String> SHA224() { return get_static_field<"SHA224", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SHA256() { return get_static_field<"SHA256", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SHA384() { return get_static_field<"SHA384", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> SHA3_224() { return get_static_field<"SHA3_224", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SHA3_256() { return get_static_field<"SHA3_256", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SHA3_384() { return get_static_field<"SHA3_384", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SHA3_512() { return get_static_field<"SHA3_512", jni::ref<java::lang::String>>(); }
