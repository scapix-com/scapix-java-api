...
public:
	...
	static jni::ref<javax::xml::transform::TransformerFactoryConfigurationError> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<javax::xml::transform::TransformerFactoryConfigurationError> new_object(jni::ref<java::lang::Exception> e) { return object_base::new_object(e); }
	static jni::ref<javax::xml::transform::TransformerFactoryConfigurationError> new_object(jni::ref<java::lang::Exception> e, jni::ref<java::lang::String> msg) { return object_base::new_object(e, msg); }
