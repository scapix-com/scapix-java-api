...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_STREAM_XMLEVENTFACTORY
...
public:
	...
	static jni::ref<javax::xml::stream::XMLEventFactory> newDefaultFactory() { return call_static_method<"newDefaultFactory", jni::ref<javax::xml::stream::XMLEventFactory>>(); }
	...
	static jni::ref<javax::xml::stream::XMLEventFactory> newInstance(jni::ref<java::lang::String> factoryId, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"newInstance", jni::ref<javax::xml::stream::XMLEventFactory>>(factoryId, classLoader); }
	static jni::ref<javax::xml::stream::XMLEventFactory> newFactory(jni::ref<java::lang::String> factoryId, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"newFactory", jni::ref<javax::xml::stream::XMLEventFactory>>(factoryId, classLoader); }
