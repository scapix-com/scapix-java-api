...
#ifndef SCAPIX_JAVA_API_JAVAX_NAMING_LINKEXCEPTION
...
public:
	...
	static jni::ref<javax::naming::LinkException> new_object(jni::ref<java::lang::String> explanation) { return object_base::new_object(explanation); }
	static jni::ref<javax::naming::LinkException> new_object() { return object_base::new_object(); }
	...
	void setLinkExplanation(jni::ref<java::lang::String> msg) { return call_method<"setLinkExplanation", void>(msg); }
	void setLinkResolvedName(jni::ref<javax::naming::Name> name) { return call_method<"setLinkResolvedName", void>(name); }
	void setLinkRemainingName(jni::ref<javax::naming::Name> name) { return call_method<"setLinkRemainingName", void>(name); }
	void setLinkResolvedObj(jni::ref<java::lang::Object> obj) { return call_method<"setLinkResolvedObj", void>(obj); }
