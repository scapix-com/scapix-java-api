...
#ifndef SCAPIX_JAVA_API_JAVAX_NAMING_DIRECTORY_MODIFICATIONITEM
...
public:
	...
	static jni::ref<javax::naming::directory::ModificationItem> new_object(jint mod_op, jni::ref<javax::naming::directory::Attribute> attr) { return object_base::new_object(mod_op, attr); }
