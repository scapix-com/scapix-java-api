...
#ifndef SCAPIX_JAVA_API_JAVAX_LANG_MODEL_TYPE_MIRROREDTYPESEXCEPTION
...
public:
	...
	static jni::ref<javax::lang::model::type::MirroredTypesException> new_object(jni::ref<java::util::List> types) { return object_base::new_object(types); }
