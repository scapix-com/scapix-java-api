...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_SPI_IMAGETRANSCODERSPI
...
public:
	...
	static jni::ref<javax::imageio::spi::ImageTranscoderSpi> new_object(jni::ref<java::lang::String> vendorName, jni::ref<java::lang::String> version) { return object_base::new_object(vendorName, version); }
