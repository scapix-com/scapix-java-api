...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_EVENT_INTERNALFRAMEEVENT
...
public:
	...
	static jni::ref<javax::swing::event::InternalFrameEvent> new_object(jni::ref<javax::swing::JInternalFrame> source, jint id) { return object_base::new_object(source, id); }
