...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_EVENT_MENUEVENT
...
public:
	...
	static jni::ref<javax::swing::event::MenuEvent> new_object(jni::ref<java::lang::Object> source) { return object_base::new_object(source); }
};
