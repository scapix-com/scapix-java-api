...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_EVENT_TABLEMODELEVENT
...
public:
	...
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> source) { return object_base::new_object(source); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> source, jint row) { return object_base::new_object(source, row); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> source, jint firstRow, jint lastRow) { return object_base::new_object(source, firstRow, lastRow); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> source, jint firstRow, jint lastRow, jint column) { return object_base::new_object(source, firstRow, lastRow, column); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> source, jint firstRow, jint lastRow, jint column, jint type) { return object_base::new_object(source, firstRow, lastRow, column, type); }
