...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_ABSTRACTACTION
...
public:
	...
	static jni::ref<javax::swing::AbstractAction> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::AbstractAction> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<javax::swing::AbstractAction> new_object(jni::ref<java::lang::String> name, jni::ref<javax::swing::Icon> icon) { return object_base::new_object(name, icon); }
	jni::ref<java::lang::Object> getValue(jni::ref<java::lang::String> key) { return call_method<"getValue", jni::ref<java::lang::Object>>(key); }
	void putValue(jni::ref<java::lang::String> key, jni::ref<java::lang::Object> newValue) { return call_method<"putValue", void>(key, newValue); }
	jboolean isEnabled() { return call_method<"isEnabled", jboolean>(); }
	void setEnabled(jboolean newValue) { return call_method<"setEnabled", void>(newValue); }
