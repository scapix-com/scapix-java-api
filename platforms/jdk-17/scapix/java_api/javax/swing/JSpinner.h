...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_JSPINNER
...
public:
	...
	static jni::ref<javax::swing::JSpinner> new_object(jni::ref<javax::swing::SpinnerModel> model) { return object_base::new_object(model); }
	static jni::ref<javax::swing::JSpinner> new_object() { return object_base::new_object(); }
	jni::ref<javax::swing::plaf::SpinnerUI> getUI() { return call_method<"getUI", jni::ref<javax::swing::plaf::SpinnerUI>>(); }
	void setUI(jni::ref<javax::swing::plaf::SpinnerUI> ui) { return call_method<"setUI", void>(ui); }
	...
	void setModel(jni::ref<javax::swing::SpinnerModel> model) { return call_method<"setModel", void>(model); }
	...
	void addChangeListener(jni::ref<javax::swing::event::ChangeListener> listener) { return call_method<"addChangeListener", void>(listener); }
	void removeChangeListener(jni::ref<javax::swing::event::ChangeListener> listener) { return call_method<"removeChangeListener", void>(listener); }
	...
	void setEditor(jni::ref<javax::swing::JComponent> editor) { return call_method<"setEditor", void>(editor); }
