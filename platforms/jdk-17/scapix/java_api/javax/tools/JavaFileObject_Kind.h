...
#ifndef SCAPIX_JAVA_API_JAVAX_TOOLS_JAVAFILEOBJECT_KIND
...
public:
	...
	static jni::ref<javax::tools::JavaFileObject_Kind> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<javax::tools::JavaFileObject_Kind>>(name); }
};
