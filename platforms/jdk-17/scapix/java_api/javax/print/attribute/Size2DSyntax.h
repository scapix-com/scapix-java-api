...
#ifndef SCAPIX_JAVA_API_JAVAX_PRINT_ATTRIBUTE_SIZE2DSYNTAX
...
public:
	...
	jni::ref<jni::array<jfloat>> getSize(jint units) { return call_method<"getSize", jni::ref<jni::array<jfloat>>>(units); }
