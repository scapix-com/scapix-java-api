...
#ifndef SCAPIX_JAVA_API_JAVAX_PRINT_ATTRIBUTE_STANDARD_PRINTERMOREINFO
...
public:
	...
	static jni::ref<javax::print::attribute::standard::PrinterMoreInfo> new_object(jni::ref<java::net::URI> uri) { return object_base::new_object(uri); }
