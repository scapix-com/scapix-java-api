...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_KERBEROS_KERBEROSKEY
...
public:
	...
	static jni::ref<javax::security::auth::kerberos::KerberosKey> new_object(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> principal, jni::ref<jni::array<jbyte>> keyBytes, jint keyType, jint versionNum) { return object_base::new_object(principal, keyBytes, keyType, versionNum); }
	static jni::ref<javax::security::auth::kerberos::KerberosKey> new_object(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> principal, jni::ref<jni::array<jchar>> password, jni::ref<java::lang::String> algorithm) { return object_base::new_object(principal, password, algorithm); }
