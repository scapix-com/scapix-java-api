...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_KERBEROS_DELEGATIONPERMISSION
...
public:
	...
	static jni::ref<javax::security::auth::kerberos::DelegationPermission> new_object(jni::ref<java::lang::String> principals) { return object_base::new_object(principals); }
	static jni::ref<javax::security::auth::kerberos::DelegationPermission> new_object(jni::ref<java::lang::String> principals, jni::ref<java::lang::String> actions) { return object_base::new_object(principals, actions); }
