...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_LOGIN_CREDENTIALEXCEPTION
...
public:
	...
	static jni::ref<javax::security::auth::login::CredentialException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::security::auth::login::CredentialException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
