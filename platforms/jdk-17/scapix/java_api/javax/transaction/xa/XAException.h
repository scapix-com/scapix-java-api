...
#ifndef SCAPIX_JAVA_API_JAVAX_TRANSACTION_XA_XAEXCEPTION
...
public:
	...
	static jni::ref<javax::transaction::xa::XAException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::transaction::xa::XAException> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	static jni::ref<javax::transaction::xa::XAException> new_object(jint errcode) { return object_base::new_object(errcode); }
};
