...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_DHPARAMETERSPEC
...
public:
	...
	static jni::ref<javax::crypto::spec::DHParameterSpec> new_object(jni::ref<java::math::BigInteger> p, jni::ref<java::math::BigInteger> g) { return object_base::new_object(p, g); }
	static jni::ref<javax::crypto::spec::DHParameterSpec> new_object(jni::ref<java::math::BigInteger> p, jni::ref<java::math::BigInteger> g, jint l) { return object_base::new_object(p, g, l); }
