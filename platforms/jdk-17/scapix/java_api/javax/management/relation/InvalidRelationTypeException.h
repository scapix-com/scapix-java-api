...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_RELATION_INVALIDRELATIONTYPEEXCEPTION
...
public:
	...
	static jni::ref<javax::management::relation::InvalidRelationTypeException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::management::relation::InvalidRelationTypeException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
