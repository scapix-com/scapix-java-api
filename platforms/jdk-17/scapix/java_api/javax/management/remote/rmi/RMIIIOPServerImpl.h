...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_REMOTE_RMI_RMIIIOPSERVERIMPL
...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIIIOPServerImpl> new_object(jni::ref<java::util::Map> env) { return object_base::new_object(env); }
