...
public:
	...
	static jni::ref<javax::management::remote::JMXServerErrorException> new_object(jni::ref<java::lang::String> s, jni::ref<java::lang::Error> err) { return object_base::new_object(s, err); }
