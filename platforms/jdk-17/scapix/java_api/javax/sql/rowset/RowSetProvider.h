...
public:
	...
	static jni::ref<javax::sql::rowset::RowSetFactory> newFactory(jni::ref<java::lang::String> factoryClassName, jni::ref<java::lang::ClassLoader> cl) { return call_static_method<"newFactory", jni::ref<javax::sql::rowset::RowSetFactory>>(factoryClassName, cl); }
};
