...
public:
	...
	jni::ref<java::nio::ShortBuffer> slice(jint p1, jint p2) { return call_method<"slice", jni::ref<java::nio::ShortBuffer>>(p1, p2); }
	...
	jni::ref<java::nio::ShortBuffer> get(jint index, jni::ref<jni::array<jshort>> dst) { return call_method<"get", jni::ref<java::nio::ShortBuffer>>(index, dst); }
	...
	jni::ref<java::nio::ShortBuffer> put(jint index, jni::ref<jni::array<jshort>> src) { return call_method<"put", jni::ref<java::nio::ShortBuffer>>(index, src); }
