...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFER
...
public:
	...
	jni::ref<java::nio::ByteBuffer> get(jint index, jni::ref<jni::array<jbyte>> dst) { return call_method<"get", jni::ref<java::nio::ByteBuffer>>(index, dst); }
	...
	jni::ref<java::nio::ByteBuffer> put(jint index, jni::ref<jni::array<jbyte>> src) { return call_method<"put", jni::ref<java::nio::ByteBuffer>>(index, src); }
	...
	jni::ref<java::nio::ByteBuffer> position(jint newPosition) { return call_method<"position", jni::ref<java::nio::ByteBuffer>>(newPosition); }
	jni::ref<java::nio::ByteBuffer> limit(jint newLimit) { return call_method<"limit", jni::ref<java::nio::ByteBuffer>>(newLimit); }
	jni::ref<java::nio::ByteBuffer> mark() { return call_method<"mark", jni::ref<java::nio::ByteBuffer>>(); }
	jni::ref<java::nio::ByteBuffer> reset() { return call_method<"reset", jni::ref<java::nio::ByteBuffer>>(); }
	jni::ref<java::nio::ByteBuffer> clear() { return call_method<"clear", jni::ref<java::nio::ByteBuffer>>(); }
	jni::ref<java::nio::ByteBuffer> flip() { return call_method<"flip", jni::ref<java::nio::ByteBuffer>>(); }
	jni::ref<java::nio::ByteBuffer> rewind() { return call_method<"rewind", jni::ref<java::nio::ByteBuffer>>(); }
