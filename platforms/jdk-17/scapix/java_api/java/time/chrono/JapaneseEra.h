...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_JAPANESEERA
...
public:
	...
	static jni::ref<java::time::chrono::JapaneseEra> REIWA() { return get_static_field<"REIWA", jni::ref<java::time::chrono::JapaneseEra>>(); }
