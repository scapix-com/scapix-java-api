...
namespace scapix::java_api { namespace java::time::chrono { class ChronoLocalDateTimeImpl; }}
...
public:
	...
	jni::ref<java::time::chrono::ChronoLocalDateTimeImpl> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::chrono::ChronoLocalDateTimeImpl>>(amountToAdd, unit); }
