...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_ZONE_ZONEOFFSETTRANSITIONRULE
...
public:
	...
	static jni::ref<java::time::zone::ZoneOffsetTransitionRule> of(jni::ref<java::time::Month> month, jint dayOfMonthIndicator, jni::ref<java::time::DayOfWeek> dayOfWeek, jni::ref<java::time::LocalTime> time, jboolean timeEndOfDay, jni::ref<java::time::zone::ZoneOffsetTransitionRule_TimeDefinition> timeDefinition, jni::ref<java::time::ZoneOffset> standardOffset, jni::ref<java::time::ZoneOffset> offsetBefore, jni::ref<java::time::ZoneOffset> offsetAfter) { return call_static_method<"of", jni::ref<java::time::zone::ZoneOffsetTransitionRule>>(month, dayOfMonthIndicator, dayOfWeek, time, timeEndOfDay, timeDefinition, standardOffset, offsetBefore, offsetAfter); }
