...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_WEAKHASHMAP
...
public:
	...
	static jni::ref<java::util::WeakHashMap> new_object(jint initialCapacity, jfloat loadFactor) { return object_base::new_object(initialCapacity, loadFactor); }
	static jni::ref<java::util::WeakHashMap> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::WeakHashMap> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::WeakHashMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
