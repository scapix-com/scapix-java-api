...
public:
	...
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::zip::Inflater> infl) { return base_::new_object(out, infl); }
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::zip::Inflater> infl, jint bufLen) { return base_::new_object(out, infl, bufLen); }
