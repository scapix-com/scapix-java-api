...
public:
	...
	static jni::ref<java::util::MissingResourceException> new_object(jni::ref<java::lang::String> s, jni::ref<java::lang::String> className, jni::ref<java::lang::String> key) { return object_base::new_object(s, className, key); }
