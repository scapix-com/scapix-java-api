...
public:
	...
	jni::ref<java::util::stream::Node_OfInt> truncate(jlong from, jlong to, jni::ref<java::util::function::IntFunction> generator) { return call_method<"truncate", jni::ref<java::util::stream::Node_OfInt>>(from, to, generator); }
