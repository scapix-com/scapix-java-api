...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDMAP_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDMAP_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::util { class Collections_SynchronizedMap; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::Collections_SynchronizedMap>
{
	static constexpr fixed_string class_name = "java/util/Collections$SynchronizedMap";
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDMAP_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDMAP)
#define SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDMAP
...
// private
class java::util::Collections_SynchronizedMap : public jni::object_base<"java/util/Collections$SynchronizedMap",
	java::lang::Object,
	java::util::Map,
...
protected:
	...
	Collections_SynchronizedMap(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDMAP
