...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOGGING_LOGRECORD
...
public:
	...
	static jni::ref<java::util::logging::LogRecord> new_object(jni::ref<java::util::logging::Level> level, jni::ref<java::lang::String> msg) { return object_base::new_object(level, msg); }
	jni::ref<java::lang::String> getLoggerName() { return call_method<"getLoggerName", jni::ref<java::lang::String>>(); }
	void setLoggerName(jni::ref<java::lang::String> name) { return call_method<"setLoggerName", void>(name); }
	...
	void setResourceBundleName(jni::ref<java::lang::String> name) { return call_method<"setResourceBundleName", void>(name); }
	...
	void setSequenceNumber(jlong seq) { return call_method<"setSequenceNumber", void>(seq); }
	...
	jlong getLongThreadID() { return call_method<"getLongThreadID", jlong>(); }
	jni::ref<java::util::logging::LogRecord> setLongThreadID(jlong longThreadID) { return call_method<"setLongThreadID", jni::ref<java::util::logging::LogRecord>>(longThreadID); }
	...
	void setInstant(jni::ref<java::time::Instant> instant) { return call_method<"setInstant", void>(instant); }
