...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOGGING_LOGMANAGER
...
public:
	...
	void updateConfiguration(jni::ref<java::util::function::Function> mapper) { return call_method<"updateConfiguration", void>(mapper); }
	void updateConfiguration(jni::ref<java::io::InputStream> ins, jni::ref<java::util::function::Function> mapper) { return call_method<"updateConfiguration", void>(ins, mapper); }
	...
	jni::ref<java::util::logging::LogManager> addConfigurationListener(jni::ref<java::lang::Runnable> listener) { return call_method<"addConfigurationListener", jni::ref<java::util::logging::LogManager>>(listener); }
	void removeConfigurationListener(jni::ref<java::lang::Runnable> listener) { return call_method<"removeConfigurationListener", void>(listener); }
};
