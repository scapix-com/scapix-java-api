...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LOCKS_ABSTRACTQUEUEDLONGSYNCHRONIZER_CONDITIONOBJECT
...
public:
	...
	static jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> new_object(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer> this_0) { return object_base::new_object(this_0); }
	...
	jboolean await(jlong time, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"await", jboolean>(time, unit); }
};
