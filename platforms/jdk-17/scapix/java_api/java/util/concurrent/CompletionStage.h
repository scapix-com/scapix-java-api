...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COMPLETIONSTAGE
...
public:
	...
	jni::ref<java::util::concurrent::CompletionStage> exceptionallyAsync(jni::ref<java::util::function::Function> fn) { return call_method<"exceptionallyAsync", jni::ref<java::util::concurrent::CompletionStage>>(fn); }
	jni::ref<java::util::concurrent::CompletionStage> exceptionallyAsync(jni::ref<java::util::function::Function> fn, jni::ref<java::util::concurrent::Executor> executor) { return call_method<"exceptionallyAsync", jni::ref<java::util::concurrent::CompletionStage>>(fn, executor); }
	jni::ref<java::util::concurrent::CompletionStage> exceptionallyCompose(jni::ref<java::util::function::Function> fn) { return call_method<"exceptionallyCompose", jni::ref<java::util::concurrent::CompletionStage>>(fn); }
	jni::ref<java::util::concurrent::CompletionStage> exceptionallyComposeAsync(jni::ref<java::util::function::Function> fn) { return call_method<"exceptionallyComposeAsync", jni::ref<java::util::concurrent::CompletionStage>>(fn); }
	jni::ref<java::util::concurrent::CompletionStage> exceptionallyComposeAsync(jni::ref<java::util::function::Function> fn, jni::ref<java::util::concurrent::Executor> executor) { return call_method<"exceptionallyComposeAsync", jni::ref<java::util::concurrent::CompletionStage>>(fn, executor); }
