...
namespace scapix::java_api { namespace java::util { class ArraysParallelSortHelpers_Relay; }}
...
public:
	...
	void onCompletion(jni::ref<java::util::concurrent::CountedCompleter> t) { return call_method<"onCompletion", void>(t); }
