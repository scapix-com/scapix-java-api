...
namespace scapix::java_api { namespace java::util { class AbstractList_SubList; }}
...
public:
	...
	static jni::ref<java::util::AbstractList_SubList> new_object(jni::ref<java::util::AbstractList> root, jint fromIndex, jint toIndex) { return object_base::new_object(root, fromIndex, toIndex); }
