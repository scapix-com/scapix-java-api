...
public:
	...
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> text) { return base_::new_object(text); }
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> text, jint pos) { return base_::new_object(text, pos); }
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> text, jint begin, jint end, jint pos) { return base_::new_object(text, begin, end, pos); }
