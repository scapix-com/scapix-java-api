...
namespace scapix::java_api { namespace java::text { class MergeCollation; }}
...
public:
	...
	static jni::ref<java::text::MergeCollation> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
	jni::ref<java::lang::String> getPattern() { return call_method<"getPattern", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getPattern(jboolean withWhiteSpace) { return call_method<"getPattern", jni::ref<java::lang::String>>(withWhiteSpace); }
	jni::ref<java::lang::String> emitPattern() { return call_method<"emitPattern", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> emitPattern(jboolean withWhiteSpace) { return call_method<"emitPattern", jni::ref<java::lang::String>>(withWhiteSpace); }
	void setPattern(jni::ref<java::lang::String> pattern) { return call_method<"setPattern", void>(pattern); }
	void addPattern(jni::ref<java::lang::String> pattern) { return call_method<"addPattern", void>(pattern); }
	jint getCount() { return call_method<"getCount", jint>(); }
	jni::ref<java::text::PatternEntry> getItemAt(jint index) { return call_method<"getItemAt", jni::ref<java::text::PatternEntry>>(index); }
