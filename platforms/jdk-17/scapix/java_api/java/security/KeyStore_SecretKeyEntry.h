...
public:
	...
	static jni::ref<java::security::KeyStore_SecretKeyEntry> new_object(jni::ref<javax::crypto::SecretKey> secretKey, jni::ref<java::util::Set> attributes) { return object_base::new_object(secretKey, attributes); }
