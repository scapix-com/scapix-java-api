...
namespace scapix::java_api { namespace java::lang::invoke { class InfoFromMemberName; }}
...
public:
	...
	jni::ref<java::lang::reflect::Member> reflectAs(jni::ref<java::lang::Class> expected, jni::ref<java::lang::invoke::MethodHandles_Lookup> lookup) { return call_method<"reflectAs", jni::ref<java::lang::reflect::Member>>(expected, lookup); }
