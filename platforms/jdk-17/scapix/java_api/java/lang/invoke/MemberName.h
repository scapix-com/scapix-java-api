...
public:
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Method> m) { return base_::new_object(m); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Method> m, jboolean wantSpecial) { return base_::new_object(m, wantSpecial); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Constructor> ctor) { return base_::new_object(ctor); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Field> fld) { return base_::new_object(fld); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Field> fld, jboolean makeSetter) { return base_::new_object(fld, makeSetter); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> type) { return base_::new_object(type); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> defClass, jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type, jbyte refKind) { return base_::new_object(defClass, name, type, refKind); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> defClass, jni::ref<java::lang::String> name, jni::ref<java::lang::invoke::MethodType> type, jbyte refKind) { return base_::new_object(defClass, name, type, refKind); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jbyte refKind, jni::ref<java::lang::Class> defClass, jni::ref<java::lang::String> name, jni::ref<java::lang::Object> type) { return base_::new_object(refKind, defClass, name, type); }
