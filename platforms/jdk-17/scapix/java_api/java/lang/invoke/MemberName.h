...
namespace scapix::java_api { namespace java::lang::invoke { class MemberName; }}
...
public:
	...
	static jboolean isMethodHandleInvokeName(jni::ref<java::lang::String> name) { return call_static_method<"isMethodHandleInvokeName", jboolean>(name); }
	jboolean isVarHandleMethodInvoke() { return call_method<"isVarHandleMethodInvoke", jboolean>(); }
	static jboolean isVarHandleMethodInvokeName(jni::ref<java::lang::String> name) { return call_static_method<"isVarHandleMethodInvokeName", jboolean>(name); }
	...
	jboolean isTrustedFinalField() { return call_method<"isTrustedFinalField", jboolean>(); }
	jboolean isAccessibleFrom(jni::ref<java::lang::Class> lookupClass) { return call_method<"isAccessibleFrom", jboolean>(lookupClass); }
	jboolean refersTo(jni::ref<java::lang::Class> declc, jni::ref<java::lang::String> n) { return call_method<"refersTo", jboolean>(declc, n); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Method> m) { return object_base::new_object(m); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Method> m, jboolean wantSpecial) { return object_base::new_object(m, wantSpecial); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Constructor> ctor) { return object_base::new_object(ctor); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Field> fld) { return object_base::new_object(fld); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Field> fld, jboolean makeSetter) { return object_base::new_object(fld, makeSetter); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> type) { return object_base::new_object(type); }
	...
	jboolean equals(jni::ref<java::lang::invoke::MemberName> that) { return call_method<"equals", jboolean>(that); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> defClass, jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type, jbyte refKind) { return object_base::new_object(defClass, name, type, refKind); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> defClass, jni::ref<java::lang::String> name, jni::ref<java::lang::invoke::MethodType> type, jbyte refKind) { return object_base::new_object(defClass, name, type, refKind); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jbyte refKind, jni::ref<java::lang::Class> defClass, jni::ref<java::lang::String> name, jni::ref<java::lang::Object> type) { return object_base::new_object(refKind, defClass, name, type); }
	...
	jni::ref<java::lang::IllegalAccessException> makeAccessException(jni::ref<java::lang::String> message, jni::ref<java::lang::Object> from) { return call_method<"makeAccessException", jni::ref<java::lang::IllegalAccessException>>(message, from); }
