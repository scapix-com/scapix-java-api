...
struct scapix::jni::object_traits<scapix::java_api::java::lang::Enum>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::constant::Constable, scapix::java_api::java::lang::Comparable, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_ENUM
