...
struct scapix::jni::object_traits<scapix::java_api::java::lang::StringBuffer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::AbstractStringBuilder, scapix::java_api::java::io::Serializable, scapix::java_api::java::lang::Comparable, scapix::java_api::java::lang::CharSequence>;
};
