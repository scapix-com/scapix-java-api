...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_MANAGEMENT_MANAGEMENTFACTORY
...
public:
	...
	static jni::ref<java::lang::Object> newPlatformMXBeanProxy(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<java::lang::String> mxbeanName, jni::ref<java::lang::Class> mxbeanInterface) { return call_static_method<"newPlatformMXBeanProxy", jni::ref<java::lang::Object>>(connection, mxbeanName, mxbeanInterface); }
	static jni::ref<java::lang::management::PlatformManagedObject> getPlatformMXBean(jni::ref<java::lang::Class> mxbeanInterface) { return call_static_method<"getPlatformMXBean", jni::ref<java::lang::management::PlatformManagedObject>>(mxbeanInterface); }
	static jni::ref<java::util::List> getPlatformMXBeans(jni::ref<java::lang::Class> mxbeanInterface) { return call_static_method<"getPlatformMXBeans", jni::ref<java::util::List>>(mxbeanInterface); }
	static jni::ref<java::lang::management::PlatformManagedObject> getPlatformMXBean(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<java::lang::Class> mxbeanInterface) { return call_static_method<"getPlatformMXBean", jni::ref<java::lang::management::PlatformManagedObject>>(connection, mxbeanInterface); }
	static jni::ref<java::util::List> getPlatformMXBeans(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<java::lang::Class> mxbeanInterface) { return call_static_method<"getPlatformMXBeans", jni::ref<java::util::List>>(connection, mxbeanInterface); }
