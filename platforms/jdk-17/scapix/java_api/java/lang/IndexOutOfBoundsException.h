...
public:
	...
	static jni::ref<java::lang::IndexOutOfBoundsException> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	static jni::ref<java::lang::IndexOutOfBoundsException> new_object(jint index) { return object_base::new_object(index); }
	static jni::ref<java::lang::IndexOutOfBoundsException> new_object(jlong index) { return object_base::new_object(index); }
};
