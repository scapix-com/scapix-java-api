...
public:
	...
	static void setAccessible(jni::ref<jni::array<java::lang::reflect::AccessibleObject>> array, jboolean flag) { return call_static_method<"setAccessible", void>(array, flag); }
	void setAccessible(jboolean flag) { return call_method<"setAccessible", void>(flag); }
	jboolean trySetAccessible() { return call_method<"trySetAccessible", jboolean>(); }
	jboolean isAccessible() { return call_method<"isAccessible", jboolean>(); }
	jboolean canAccess(jni::ref<java::lang::Object> obj) { return call_method<"canAccess", jboolean>(obj); }
