...
public:
	...
	static jni::ref<java::lang::System_Logger> getLogger(jni::ref<java::lang::String> name) { return call_static_method<"getLogger", jni::ref<java::lang::System_Logger>>(name); }
	static jni::ref<java::lang::System_Logger> getLogger(jni::ref<java::lang::String> name, jni::ref<java::util::ResourceBundle> bundle) { return call_static_method<"getLogger", jni::ref<java::lang::System_Logger>>(name, bundle); }
