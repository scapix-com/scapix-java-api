...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_SERVER_OBJID
...
public:
	...
	static jni::ref<java::rmi::server::ObjID> new_object() { return object_base::new_object(); }
	static jni::ref<java::rmi::server::ObjID> new_object(jint objNum) { return object_base::new_object(objNum); }
	void write(jni::ref<java::io::ObjectOutput> out) { return call_method<"write", void>(out); }
	static jni::ref<java::rmi::server::ObjID> read(jni::ref<java::io::ObjectInput> in) { return call_static_method<"read", jni::ref<java::rmi::server::ObjID>>(in); }
