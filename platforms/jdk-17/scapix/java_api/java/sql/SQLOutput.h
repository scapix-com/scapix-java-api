...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT
...
public:
	...
	void writeObject(jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType) { return call_method<"writeObject", void>(x, targetSqlType); }
};
