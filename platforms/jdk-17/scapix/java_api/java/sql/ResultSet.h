...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_RESULTSET
...
public:
	...
	void updateObject(jint columnIndex, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType, jint scaleOrLength) { return call_method<"updateObject", void>(columnIndex, x, targetSqlType, scaleOrLength); }
	void updateObject(jni::ref<java::lang::String> columnLabel, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType, jint scaleOrLength) { return call_method<"updateObject", void>(columnLabel, x, targetSqlType, scaleOrLength); }
	void updateObject(jint columnIndex, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType) { return call_method<"updateObject", void>(columnIndex, x, targetSqlType); }
	void updateObject(jni::ref<java::lang::String> columnLabel, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType) { return call_method<"updateObject", void>(columnLabel, x, targetSqlType); }
};
