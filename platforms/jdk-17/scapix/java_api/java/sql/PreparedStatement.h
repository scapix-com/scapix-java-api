...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_PREPAREDSTATEMENT
...
public:
	...
	void setObject(jint parameterIndex, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType, jint scaleOrLength) { return call_method<"setObject", void>(parameterIndex, x, targetSqlType, scaleOrLength); }
	void setObject(jint parameterIndex, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType) { return call_method<"setObject", void>(parameterIndex, x, targetSqlType); }
	jlong executeLargeUpdate() { return call_method<"executeLargeUpdate", jlong>(); }
};
