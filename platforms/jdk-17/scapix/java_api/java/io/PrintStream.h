...
#ifndef SCAPIX_JAVA_API_JAVA_IO_PRINTSTREAM
...
public:
	...
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::OutputStream> out) { return object_base::new_object(out); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::OutputStream> out, jboolean autoFlush) { return object_base::new_object(out, autoFlush); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::OutputStream> out, jboolean autoFlush, jni::ref<java::lang::String> encoding) { return object_base::new_object(out, autoFlush, encoding); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::OutputStream> out, jboolean autoFlush, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(out, autoFlush, charset); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::lang::String> fileName) { return object_base::new_object(fileName); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::lang::String> fileName, jni::ref<java::lang::String> csn) { return object_base::new_object(fileName, csn); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::lang::String> fileName, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(fileName, charset); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::File> file, jni::ref<java::lang::String> csn) { return object_base::new_object(file, csn); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::File> file, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(file, charset); }
