...
#ifndef SCAPIX_JAVA_API_JAVA_IO_LINENUMBERINPUTSTREAM
...
public:
	...
	static jni::ref<java::io::LineNumberInputStream> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
