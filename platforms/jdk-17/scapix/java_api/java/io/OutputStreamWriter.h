...
public:
	...
	static jni::ref<java::io::OutputStreamWriter> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::nio::charset::CharsetEncoder> enc) { return object_base::new_object(out, enc); }
