...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_ITEMEVENT
...
public:
	...
	static jni::ref<java::awt::event::ItemEvent> new_object(jni::ref<java::awt::ItemSelectable> source, jint id, jni::ref<java::lang::Object> item, jint stateChange) { return object_base::new_object(source, id, item, stateChange); }
