...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_AWTEVENTLISTENERPROXY
...
public:
	...
	static jni::ref<java::awt::event::AWTEventListenerProxy> new_object(jlong eventMask, jni::ref<java::awt::event::AWTEventListener> listener) { return object_base::new_object(eventMask, listener); }
	void eventDispatched(jni::ref<java::awt::AWTEvent> event) { return call_method<"eventDispatched", void>(event); }
