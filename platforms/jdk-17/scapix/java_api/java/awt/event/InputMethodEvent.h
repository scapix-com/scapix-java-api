...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_INPUTMETHODEVENT
...
public:
	...
	static jni::ref<java::awt::event::InputMethodEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jni::ref<java::text::AttributedCharacterIterator> text, jint committedCharacterCount, jni::ref<java::awt::font::TextHitInfo> caret, jni::ref<java::awt::font::TextHitInfo> visiblePosition) { return object_base::new_object(source, id, when, text, committedCharacterCount, caret, visiblePosition); }
	static jni::ref<java::awt::event::InputMethodEvent> new_object(jni::ref<java::awt::Component> source, jint id, jni::ref<java::text::AttributedCharacterIterator> text, jint committedCharacterCount, jni::ref<java::awt::font::TextHitInfo> caret, jni::ref<java::awt::font::TextHitInfo> visiblePosition) { return object_base::new_object(source, id, text, committedCharacterCount, caret, visiblePosition); }
	static jni::ref<java::awt::event::InputMethodEvent> new_object(jni::ref<java::awt::Component> source, jint id, jni::ref<java::awt::font::TextHitInfo> caret, jni::ref<java::awt::font::TextHitInfo> visiblePosition) { return object_base::new_object(source, id, caret, visiblePosition); }
