...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_GEOM_RECTANGULARSHAPE
...
public:
	...
	void setFrame(jni::ref<java::awt::geom::Point2D> loc, jni::ref<java::awt::geom::Dimension2D> size) { return call_method<"setFrame", void>(loc, size); }
	void setFrame(jni::ref<java::awt::geom::Rectangle2D> r) { return call_method<"setFrame", void>(r); }
	void setFrameFromDiagonal(jdouble x1, jdouble y1, jdouble x2, jdouble y2) { return call_method<"setFrameFromDiagonal", void>(x1, y1, x2, y2); }
	...
	void setFrameFromCenter(jdouble centerX, jdouble centerY, jdouble cornerX, jdouble cornerY) { return call_method<"setFrameFromCenter", void>(centerX, centerY, cornerX, cornerY); }
	void setFrameFromCenter(jni::ref<java::awt::geom::Point2D> center, jni::ref<java::awt::geom::Point2D> corner) { return call_method<"setFrameFromCenter", void>(center, corner); }
