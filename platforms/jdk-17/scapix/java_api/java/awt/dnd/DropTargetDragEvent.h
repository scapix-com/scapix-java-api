...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_DND_DROPTARGETDRAGEVENT
...
public:
	...
	static jni::ref<java::awt::dnd::DropTargetDragEvent> new_object(jni::ref<java::awt::dnd::DropTargetContext> dtc, jni::ref<java::awt::Point> cursorLocn, jint dropAction, jint srcActions) { return object_base::new_object(dtc, cursorLocn, dropAction, srcActions); }
	...
	void acceptDrag(jint dragOperation) { return call_method<"acceptDrag", void>(dragOperation); }
