...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_FONT_NUMERICSHAPER
...
public:
	...
	static jni::ref<java::awt::font::NumericShaper> getShaper(jni::ref<java::awt::font::NumericShaper_Range> singleRange) { return call_static_method<"getShaper", jni::ref<java::awt::font::NumericShaper>>(singleRange); }
	...
	static jni::ref<java::awt::font::NumericShaper> getContextualShaper(jni::ref<java::util::Set> ranges) { return call_static_method<"getContextualShaper", jni::ref<java::awt::font::NumericShaper>>(ranges); }
	...
	static jni::ref<java::awt::font::NumericShaper> getContextualShaper(jni::ref<java::util::Set> ranges, jni::ref<java::awt::font::NumericShaper_Range> defaultContext) { return call_static_method<"getContextualShaper", jni::ref<java::awt::font::NumericShaper>>(ranges, defaultContext); }
	...
	void shape(jni::ref<jni::array<jchar>> text, jint start, jint count, jni::ref<java::awt::font::NumericShaper_Range> context) { return call_method<"shape", void>(text, start, count, context); }
