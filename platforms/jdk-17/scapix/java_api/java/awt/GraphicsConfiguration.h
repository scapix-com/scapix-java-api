...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_GRAPHICSCONFIGURATION
...
public:
	...
	jni::ref<java::awt::image::BufferedImage> createCompatibleImage(jint width, jint height) { return call_method<"createCompatibleImage", jni::ref<java::awt::image::BufferedImage>>(width, height); }
	jni::ref<java::awt::image::BufferedImage> createCompatibleImage(jint width, jint height, jint transparency) { return call_method<"createCompatibleImage", jni::ref<java::awt::image::BufferedImage>>(width, height, transparency); }
	jni::ref<java::awt::image::VolatileImage> createCompatibleVolatileImage(jint width, jint height) { return call_method<"createCompatibleVolatileImage", jni::ref<java::awt::image::VolatileImage>>(width, height); }
	jni::ref<java::awt::image::VolatileImage> createCompatibleVolatileImage(jint width, jint height, jint transparency) { return call_method<"createCompatibleVolatileImage", jni::ref<java::awt::image::VolatileImage>>(width, height, transparency); }
	jni::ref<java::awt::image::VolatileImage> createCompatibleVolatileImage(jint width, jint height, jni::ref<java::awt::ImageCapabilities> caps) { return call_method<"createCompatibleVolatileImage", jni::ref<java::awt::image::VolatileImage>>(width, height, caps); }
	jni::ref<java::awt::image::VolatileImage> createCompatibleVolatileImage(jint width, jint height, jni::ref<java::awt::ImageCapabilities> caps, jint transparency) { return call_method<"createCompatibleVolatileImage", jni::ref<java::awt::image::VolatileImage>>(width, height, caps, transparency); }
