...
namespace scapix::java_api { namespace java::net { class SocketInputStream; }}
...
public:
	...
	jint read(jni::ref<jni::array<jbyte>> b, jint off, jint length) { return call_method<"read", jint>(b, off, length); }
	jint read() { return call_method<"read", jint>(); }
	jlong skip(jlong numbytes) { return call_method<"skip", jlong>(numbytes); }
