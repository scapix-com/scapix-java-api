...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_BEANDESCRIPTOR
...
public:
	...
	static jni::ref<java::beans::BeanDescriptor> new_object(jni::ref<java::lang::Class> beanClass) { return object_base::new_object(beanClass); }
	static jni::ref<java::beans::BeanDescriptor> new_object(jni::ref<java::lang::Class> beanClass, jni::ref<java::lang::Class> customizerClass) { return object_base::new_object(beanClass, customizerClass); }
