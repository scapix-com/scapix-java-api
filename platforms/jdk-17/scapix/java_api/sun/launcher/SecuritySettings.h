...
namespace scapix::java_api { namespace sun::launcher { class SecuritySettings; }}
...
public:
	...
	static jni::ref<sun::launcher::SecuritySettings> new_object() { return object_base::new_object(); }
