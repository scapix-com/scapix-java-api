...
namespace scapix::java_api { namespace sun::security::pkcs { class ContentInfo; }}
...
public:
	...
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::ObjectIdentifier> contentType, jni::ref<sun::security::util::DerValue> content) { return object_base::new_object(contentType, content); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<jni::array<jbyte>> bytes) { return object_base::new_object(bytes); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::DerInputStream> derin) { return object_base::new_object(derin); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::DerInputStream> derin, jboolean oldStyle) { return object_base::new_object(derin, oldStyle); }
