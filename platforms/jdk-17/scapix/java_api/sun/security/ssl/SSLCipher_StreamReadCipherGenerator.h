...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMREADCIPHERGENERATOR_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMREADCIPHERGENERATOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::security::ssl { class SSLCipher_StreamReadCipherGenerator; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::SSLCipher_StreamReadCipherGenerator>
{
	static constexpr fixed_string class_name = "sun/security/ssl/SSLCipher$StreamReadCipherGenerator";
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMREADCIPHERGENERATOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMREADCIPHERGENERATOR)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMREADCIPHERGENERATOR
...
// private
class sun::security::ssl::SSLCipher_StreamReadCipherGenerator : public jni::object_base<"sun/security/ssl/SSLCipher$StreamReadCipherGenerator",
	java::lang::Object,
...
protected:
	...
	SSLCipher_StreamReadCipherGenerator(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMREADCIPHERGENERATOR
