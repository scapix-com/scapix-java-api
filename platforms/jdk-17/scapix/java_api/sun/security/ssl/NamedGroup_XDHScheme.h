...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_XDHSCHEME_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_XDHSCHEME_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::security::ssl { class NamedGroup_XDHScheme; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::NamedGroup_XDHScheme>
{
	static constexpr fixed_string class_name = "sun/security/ssl/NamedGroup$XDHScheme";
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_XDHSCHEME_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_XDHSCHEME)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_XDHSCHEME
...
// private
class sun::security::ssl::NamedGroup_XDHScheme : public jni::object_base<"sun/security/ssl/NamedGroup$XDHScheme",
	java::lang::Object,
	sun::security::ssl::NamedGroup_NamedGroupScheme>
{
public:

	jni::ref<jni::array<jbyte>> encodePossessionPublicKey(jni::ref<sun::security::ssl::NamedGroupPossession> poss) { return call_method<"encodePossessionPublicKey", jni::ref<jni::array<jbyte>>>(poss); }
...
protected:
	...
	NamedGroup_XDHScheme(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_XDHSCHEME
