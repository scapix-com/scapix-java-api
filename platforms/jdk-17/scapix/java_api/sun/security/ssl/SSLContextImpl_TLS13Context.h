...
namespace scapix::java_api { namespace sun::security::ssl { class SSLContextImpl_TLS13Context; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLContextImpl_TLS13Context> new_object() { return object_base::new_object(); }
