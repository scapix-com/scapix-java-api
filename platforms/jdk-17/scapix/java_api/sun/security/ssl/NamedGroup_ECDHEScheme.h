...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_ECDHESCHEME_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_ECDHESCHEME_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::security::ssl { class NamedGroup_ECDHEScheme; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::NamedGroup_ECDHEScheme>
{
	static constexpr fixed_string class_name = "sun/security/ssl/NamedGroup$ECDHEScheme";
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_ECDHESCHEME_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_ECDHESCHEME)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_ECDHESCHEME
...
// private
class sun::security::ssl::NamedGroup_ECDHEScheme : public jni::object_base<"sun/security/ssl/NamedGroup$ECDHEScheme",
	java::lang::Object,
...
protected:
	...
	NamedGroup_ECDHEScheme(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_NAMEDGROUP_ECDHESCHEME
