...
namespace scapix::java_api { namespace sun::security::ssl { class KeyManagerFactoryImpl_X509; }}
...
public:
	...
	static jni::ref<sun::security::ssl::KeyManagerFactoryImpl_X509> new_object() { return object_base::new_object(); }
