...
namespace scapix::java_api { namespace sun::security::util { class ManifestDigester_Section; }}
...
public:
	...
	static jni::ref<sun::security::util::ManifestDigester_Section> new_object(jint offset, jint length, jint lengthWithBlankLine, jni::ref<jni::array<jbyte>> rawBytes) { return object_base::new_object(offset, length, lengthWithBlankLine, rawBytes); }
