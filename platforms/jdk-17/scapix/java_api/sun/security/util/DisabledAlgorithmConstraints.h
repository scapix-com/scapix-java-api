...
public:
	...
	static jni::ref<sun::security::util::DisabledAlgorithmConstraints> new_object(jni::ref<java::lang::String> propertyName) { return object_base::new_object(propertyName); }
	static jni::ref<sun::security::util::DisabledAlgorithmConstraints> new_object(jni::ref<java::lang::String> propertyName, jni::ref<sun::security::util::AlgorithmDecomposer> decomposer) { return object_base::new_object(propertyName, decomposer); }
	...
	jboolean permits(jni::ref<java::lang::String> algorithm, jni::ref<java::util::Set> scopes) { return call_method<"permits", jboolean>(algorithm, scopes); }
