...
namespace scapix::java_api { namespace sun::security::util { class BitArray; }}
...
public:
	...
	static jni::ref<sun::security::util::BitArray> new_object(jint length) { return object_base::new_object(length); }
	static jni::ref<sun::security::util::BitArray> new_object(jint length, jni::ref<jni::array<jbyte>> a) { return object_base::new_object(length, a); }
	static jni::ref<sun::security::util::BitArray> new_object(jint length, jni::ref<jni::array<jbyte>> a, jint ofs) { return object_base::new_object(length, a, ofs); }
	static jni::ref<sun::security::util::BitArray> new_object(jni::ref<jni::array<jboolean>> bits) { return object_base::new_object(bits); }
