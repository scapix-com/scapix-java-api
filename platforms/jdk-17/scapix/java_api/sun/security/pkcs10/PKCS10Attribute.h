...
namespace scapix::java_api { namespace sun::security::pkcs10 { class PKCS10Attribute; }}
...
public:
	...
	static jni::ref<sun::security::pkcs10::PKCS10Attribute> new_object(jni::ref<sun::security::util::DerValue> derVal) { return object_base::new_object(derVal); }
	static jni::ref<sun::security::pkcs10::PKCS10Attribute> new_object(jni::ref<sun::security::util::ObjectIdentifier> attributeId, jni::ref<java::lang::Object> attributeValue) { return object_base::new_object(attributeId, attributeValue); }
	static jni::ref<sun::security::pkcs10::PKCS10Attribute> new_object(jni::ref<sun::security::pkcs::PKCS9Attribute> attr) { return object_base::new_object(attr); }
