...
namespace scapix::java_api { namespace sun::security::tools::keytool { class Resources_de; }}
...
public:
	...
	static jni::ref<sun::security::tools::keytool::Resources_de> new_object() { return object_base::new_object(); }
