...
namespace scapix::java_api { namespace sun::security::jca { class ServiceId; }}
...
public:
	...
	static jni::ref<sun::security::jca::ServiceId> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::String> algorithm) { return object_base::new_object(type, algorithm); }
