...
public:
	...
	static jni::ref<sun::security::action::GetPropertyAction> new_object(jni::ref<java::lang::String> theProp) { return object_base::new_object(theProp); }
	static jni::ref<sun::security::action::GetPropertyAction> new_object(jni::ref<java::lang::String> theProp, jni::ref<java::lang::String> defaultVal) { return object_base::new_object(theProp, defaultVal); }
