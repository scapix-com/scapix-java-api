...
namespace scapix::java_api { namespace sun::security::provider { class PolicyParser_GrantEntry; }}
...
public:
	...
	static jni::ref<sun::security::provider::PolicyParser_GrantEntry> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::provider::PolicyParser_GrantEntry> new_object(jni::ref<java::lang::String> signedBy, jni::ref<java::lang::String> codeBase) { return object_base::new_object(signedBy, codeBase); }
	void add(jni::ref<sun::security::provider::PolicyParser_PermissionEntry> pe) { return call_method<"add", void>(pe); }
	jboolean remove(jni::ref<sun::security::provider::PolicyParser_PrincipalEntry> pe) { return call_method<"remove", jboolean>(pe); }
	jboolean remove(jni::ref<sun::security::provider::PolicyParser_PermissionEntry> pe) { return call_method<"remove", jboolean>(pe); }
	jboolean contains(jni::ref<sun::security::provider::PolicyParser_PrincipalEntry> pe) { return call_method<"contains", jboolean>(pe); }
	jboolean contains(jni::ref<sun::security::provider::PolicyParser_PermissionEntry> pe) { return call_method<"contains", jboolean>(pe); }
