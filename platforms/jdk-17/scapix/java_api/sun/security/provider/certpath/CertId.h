...
namespace scapix::java_api { namespace sun::security::provider::certpath { class CertId; }}
...
public:
	...
	static jni::ref<sun::security::provider::certpath::CertId> new_object(jni::ref<java::security::cert::X509Certificate> issuerCert, jni::ref<sun::security::x509::SerialNumber> serialNumber) { return object_base::new_object(issuerCert, serialNumber); }
	static jni::ref<sun::security::provider::certpath::CertId> new_object(jni::ref<javax::security::auth::x500::X500Principal> issuerName, jni::ref<java::security::PublicKey> issuerKey, jni::ref<sun::security::x509::SerialNumber> serialNumber) { return object_base::new_object(issuerName, issuerKey, serialNumber); }
	static jni::ref<sun::security::provider::certpath::CertId> new_object(jni::ref<sun::security::util::DerInputStream> derIn) { return object_base::new_object(derIn); }
