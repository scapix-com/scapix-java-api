...
namespace scapix::java_api { namespace sun::security::provider::certpath { class ResponderId; }}
...
public:
	...
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<javax::security::auth::x500::X500Principal> subjectName) { return object_base::new_object(subjectName); }
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<java::security::PublicKey> pubKey) { return object_base::new_object(pubKey); }
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<jni::array<jbyte>> encodedData) { return object_base::new_object(encodedData); }
