...
namespace scapix::java_api { namespace sun::security::provider { class SHA5_SHA512; }}
...
public:
	...
	static jni::ref<sun::security::provider::SHA5_SHA512> new_object() { return object_base::new_object(); }
