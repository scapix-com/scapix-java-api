...
namespace scapix::java_api { namespace sun::security::internal::spec { class TlsMasterSecretParameterSpec; }}
...
public:
	...
	static jni::ref<sun::security::internal::spec::TlsMasterSecretParameterSpec> new_object(jni::ref<javax::crypto::SecretKey> premasterSecret, jint majorVersion, jint minorVersion, jni::ref<jni::array<jbyte>> clientRandom, jni::ref<jni::array<jbyte>> serverRandom, jni::ref<java::lang::String> prfHashAlg, jint prfHashLength, jint prfBlockSize) { return object_base::new_object(premasterSecret, majorVersion, minorVersion, clientRandom, serverRandom, prfHashAlg, prfHashLength, prfBlockSize); }
	static jni::ref<sun::security::internal::spec::TlsMasterSecretParameterSpec> new_object(jni::ref<javax::crypto::SecretKey> premasterSecret, jint majorVersion, jint minorVersion, jni::ref<jni::array<jbyte>> extendedMasterSecretSessionHash, jni::ref<java::lang::String> prfHashAlg, jint prfHashLength, jint prfBlockSize) { return object_base::new_object(premasterSecret, majorVersion, minorVersion, extendedMasterSecretSessionHash, prfHashAlg, prfHashLength, prfBlockSize); }
