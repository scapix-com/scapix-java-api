...
public:
	...
	static jni::ref<sun::security::x509::CertificateValidity> new_object(jni::ref<java::util::Date> notBefore, jni::ref<java::util::Date> notAfter) { return object_base::new_object(notBefore, notAfter); }
	static jni::ref<sun::security::x509::CertificateValidity> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
