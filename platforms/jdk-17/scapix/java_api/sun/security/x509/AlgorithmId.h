...
public:
	...
	static jni::ref<sun::security::util::ObjectIdentifier> ed25519_oid() { return get_static_field<"ed25519_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> ed448_oid() { return get_static_field<"ed448_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> x25519_oid() { return get_static_field<"x25519_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> x448_oid() { return get_static_field<"x448_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> SHA224withECDSA_oid() { return get_static_field<"SHA224withECDSA_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> SHA256withECDSA_oid() { return get_static_field<"SHA256withECDSA_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> SHA384withECDSA_oid() { return get_static_field<"SHA384withECDSA_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	static jni::ref<sun::security::util::ObjectIdentifier> SHA512withECDSA_oid() { return get_static_field<"SHA512withECDSA_oid", jni::ref<sun::security::util::ObjectIdentifier>>(); }
	...
	static jni::ref<sun::security::x509::AlgorithmId> new_object(jni::ref<sun::security::util::ObjectIdentifier> oid, jni::ref<sun::security::util::DerValue> params) { return object_base::new_object(oid, params); }
