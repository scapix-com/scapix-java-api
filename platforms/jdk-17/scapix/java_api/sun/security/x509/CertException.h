...
namespace scapix::java_api { namespace sun::security::x509 { class CertException; }}
...
public:
	...
	static jni::ref<sun::security::x509::CertException> new_object(jint code, jni::ref<java::lang::String> moredata) { return object_base::new_object(code, moredata); }
	static jni::ref<sun::security::x509::CertException> new_object(jint code) { return object_base::new_object(code); }
