...
public:
	...
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> issuer, jni::ref<java::util::Date> thisDate, jni::ref<java::util::Date> nextDate) { return object_base::new_object(issuer, thisDate, nextDate); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> issuer, jni::ref<java::util::Date> thisDate, jni::ref<java::util::Date> nextDate, jni::ref<jni::array<java::security::cert::X509CRLEntry>> badCerts) { return object_base::new_object(issuer, thisDate, nextDate, badCerts); }
