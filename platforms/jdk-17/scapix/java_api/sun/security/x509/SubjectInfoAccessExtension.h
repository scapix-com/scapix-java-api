...
namespace scapix::java_api { namespace sun::security::x509 { class SubjectInfoAccessExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::SubjectInfoAccessExtension> new_object(jni::ref<java::util::List> accessDescriptions) { return object_base::new_object(accessDescriptions); }
	static jni::ref<sun::security::x509::SubjectInfoAccessExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
