...
namespace scapix::java_api { namespace sun::security::x509 { class SubjectKeyIdentifierExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::SubjectKeyIdentifierExtension> new_object(jni::ref<jni::array<jbyte>> octetString) { return object_base::new_object(octetString); }
	static jni::ref<sun::security::x509::SubjectKeyIdentifierExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
