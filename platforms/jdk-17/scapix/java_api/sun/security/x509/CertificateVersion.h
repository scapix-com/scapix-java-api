...
public:
	...
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jint version) { return object_base::new_object(version); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
