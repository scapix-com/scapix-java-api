...
public:
	...
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<java::math::BigInteger> num) { return base_::new_object(num); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jint num) { return base_::new_object(num); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<sun::security::util::DerInputStream> in) { return base_::new_object(in); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<sun::security::util::DerValue> val) { return base_::new_object(val); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<java::io::InputStream> in) { return base_::new_object(in); }
