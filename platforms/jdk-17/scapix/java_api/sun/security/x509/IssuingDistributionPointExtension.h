...
namespace scapix::java_api { namespace sun::security::x509 { class IssuingDistributionPointExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::IssuingDistributionPointExtension> new_object(jni::ref<sun::security::x509::DistributionPointName> distributionPoint, jni::ref<sun::security::x509::ReasonFlags> revocationReasons, jboolean hasOnlyUserCerts, jboolean hasOnlyCACerts, jboolean hasOnlyAttributeCerts, jboolean isIndirectCRL) { return object_base::new_object(distributionPoint, revocationReasons, hasOnlyUserCerts, hasOnlyCACerts, hasOnlyAttributeCerts, isIndirectCRL); }
	static jni::ref<sun::security::x509::IssuingDistributionPointExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
