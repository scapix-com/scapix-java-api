...
namespace scapix::java_api { namespace sun::security::x509 { class CRLExtensions; }}
...
public:
	...
	static jni::ref<sun::security::x509::CRLExtensions> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::CRLExtensions> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
	void encode(jni::ref<java::io::OutputStream> out, jboolean isExplicit) { return call_method<"encode", void>(out, isExplicit); }
	jni::ref<sun::security::x509::Extension> get(jni::ref<java::lang::String> alias) { return call_method<"get", jni::ref<sun::security::x509::Extension>>(alias); }
	void set(jni::ref<java::lang::String> alias, jni::ref<java::lang::Object> obj) { return call_method<"set", void>(alias, obj); }
