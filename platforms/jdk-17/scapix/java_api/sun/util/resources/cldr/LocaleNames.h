...
namespace scapix::java_api { namespace sun::util::resources::cldr { class LocaleNames; }}
...
public:
	...
	static jni::ref<sun::util::resources::cldr::LocaleNames> new_object() { return object_base::new_object(); }
