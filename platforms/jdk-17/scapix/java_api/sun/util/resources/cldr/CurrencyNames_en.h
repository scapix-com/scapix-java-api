...
namespace scapix::java_api { namespace sun::util::resources::cldr { class CurrencyNames_en; }}
...
public:
	...
	static jni::ref<sun::util::resources::cldr::CurrencyNames_en> new_object() { return object_base::new_object(); }
