...
namespace scapix::java_api { namespace sun::util::cldr { class CLDRBaseLocaleDataMetaInfo; }}
...
public:
	...
	static jni::ref<sun::util::cldr::CLDRBaseLocaleDataMetaInfo> new_object() { return object_base::new_object(); }
