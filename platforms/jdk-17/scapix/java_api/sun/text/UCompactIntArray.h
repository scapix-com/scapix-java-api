...
namespace scapix::java_api { namespace sun::text { class UCompactIntArray; }}
...
public:
	...
	static jni::ref<sun::text::UCompactIntArray> new_object(jint defaultValue) { return object_base::new_object(defaultValue); }
