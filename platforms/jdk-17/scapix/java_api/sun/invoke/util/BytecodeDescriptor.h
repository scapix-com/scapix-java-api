...
namespace scapix::java_api { namespace sun::invoke::util { class BytecodeDescriptor; }}
...
public:
	...
	static jni::ref<java::lang::String> unparse(jni::ref<java::lang::invoke::MethodType> type) { return call_static_method<"unparse", jni::ref<java::lang::String>>(type); }
