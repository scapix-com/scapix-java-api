...
namespace scapix::java_api { namespace sun::nio::ch { class FileKey; }}
...
public:
	...
	static jni::ref<sun::nio::ch::FileKey> create(jni::ref<java::io::FileDescriptor> fd) { return call_static_method<"create", jni::ref<sun::nio::ch::FileKey>>(fd); }
