...
namespace scapix::java_api { namespace sun::nio::cs { class DoubleByte_Encoder; }}
...
public:
	...
	static jni::ref<sun::nio::cs::DoubleByte_Encoder> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jchar>> c2b, jni::ref<jni::array<jchar>> c2bIndex) { return object_base::new_object(cs, c2b, c2bIndex); }
	static jni::ref<sun::nio::cs::DoubleByte_Encoder> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jchar>> c2b, jni::ref<jni::array<jchar>> c2bIndex, jboolean isASCIICompatible) { return object_base::new_object(cs, c2b, c2bIndex, isASCIICompatible); }
	static jni::ref<sun::nio::cs::DoubleByte_Encoder> new_object(jni::ref<java::nio::charset::Charset> cs, jfloat avg, jfloat max, jni::ref<jni::array<jbyte>> repl, jni::ref<jni::array<jchar>> c2b, jni::ref<jni::array<jchar>> c2bIndex, jboolean isASCIICompatible) { return object_base::new_object(cs, avg, max, repl, c2b, c2bIndex, isASCIICompatible); }
