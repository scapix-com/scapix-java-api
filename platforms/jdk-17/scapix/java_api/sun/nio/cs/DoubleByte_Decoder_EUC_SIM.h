...
namespace scapix::java_api { namespace sun::nio::cs { class DoubleByte_Decoder_EUC_SIM; }}
...
public:
	...
	static jni::ref<sun::nio::cs::DoubleByte_Decoder_EUC_SIM> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jni::array<jchar>>> b2c, jni::ref<jni::array<jchar>> b2cSB, jint b2Min, jint b2Max, jboolean isASCIICompatible) { return object_base::new_object(cs, b2c, b2cSB, b2Min, b2Max, isASCIICompatible); }
