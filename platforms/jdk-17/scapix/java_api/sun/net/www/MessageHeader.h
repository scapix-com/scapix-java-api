...
public:
	...
	static jni::ref<sun::net::www::MessageHeader> new_object(jint maxHeaderSize) { return object_base::new_object(maxHeaderSize); }
	static jni::ref<sun::net::www::MessageHeader> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
