...
namespace scapix::java_api { namespace sun::net::www::protocol::http { class HttpURLConnection; }}
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::HttpURLConnection> new_object(jni::ref<java::net::URL> u, jni::ref<java::lang::String> host, jint port) { return object_base::new_object(u, host, port); }
	static jni::ref<sun::net::www::protocol::http::HttpURLConnection> new_object(jni::ref<java::net::URL> u, jni::ref<java::net::Proxy> p) { return object_base::new_object(u, p); }
