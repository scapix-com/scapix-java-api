...
namespace scapix::java_api { namespace sun::net::www::protocol::http { class BasicAuthentication; }}
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm, jni::ref<java::net::PasswordAuthentication> pw, jboolean isUTF8, jni::ref<java::lang::String> authenticatorKey) { return object_base::new_object(isProxy, host, port, realm, pw, isUTF8, authenticatorKey); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm, jni::ref<java::lang::String> auth, jni::ref<java::lang::String> authenticatorKey) { return object_base::new_object(isProxy, host, port, realm, auth, authenticatorKey); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::lang::String> realm, jni::ref<java::net::PasswordAuthentication> pw, jboolean isUTF8, jni::ref<java::lang::String> authenticatorKey) { return object_base::new_object(isProxy, url, realm, pw, isUTF8, authenticatorKey); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::lang::String> realm, jni::ref<java::lang::String> auth, jni::ref<java::lang::String> authenticatorKey) { return object_base::new_object(isProxy, url, realm, auth, authenticatorKey); }
