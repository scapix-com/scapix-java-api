...
public:
	...
	static jni::ref<sun::net::www::protocol::http::ntlm::NTLMAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::net::PasswordAuthentication> pw, jni::ref<java::lang::String> authenticatorKey) { return base_::new_object(isProxy, url, pw, authenticatorKey); }
	static jni::ref<sun::net::www::protocol::http::ntlm::NTLMAuthentication> new_object(jboolean isProxy, jni::ref<java::lang::String> host, jint port, jni::ref<java::net::PasswordAuthentication> pw, jni::ref<java::lang::String> authenticatorKey) { return base_::new_object(isProxy, host, port, pw, authenticatorKey); }
