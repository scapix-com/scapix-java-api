...
namespace scapix::java_api { namespace sun::net::www::protocol::jar { class JarURLConnection; }}
...
public:
	...
	static jni::ref<sun::net::www::protocol::jar::JarURLConnection> new_object(jni::ref<java::net::URL> url, jni::ref<sun::net::www::protocol::jar::Handler> handler) { return object_base::new_object(url, handler); }
