...
namespace scapix::java_api { namespace sun::net::www::protocol::ftp { class FtpURLConnection; }}
...
public:
	...
	static jni::ref<sun::net::www::protocol::ftp::FtpURLConnection> new_object(jni::ref<java::net::URL> url) { return object_base::new_object(url); }
