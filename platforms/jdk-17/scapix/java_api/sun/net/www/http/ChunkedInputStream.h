...
namespace scapix::java_api { namespace sun::net::www::http { class ChunkedInputStream; }}
...
public:
	...
	static jni::ref<sun::net::www::http::ChunkedInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<sun::net::www::http::HttpClient> hc, jni::ref<sun::net::www::MessageHeader> responses) { return object_base::new_object(in, hc, responses); }
