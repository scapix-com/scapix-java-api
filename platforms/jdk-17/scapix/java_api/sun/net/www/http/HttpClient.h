...
namespace scapix::java_api { namespace sun::net::www::http { class HttpClient; }}
...
public:
	...
	static jni::ref<sun::net::www::http::HttpClient> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::String> proxyHost, jint proxyPort) { return object_base::new_object(url, proxyHost, proxyPort); }
	static jni::ref<sun::net::www::http::HttpClient> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::String> proxyHost, jint proxyPort, jboolean proxyDisabled, jint to) { return object_base::new_object(url, proxyHost, proxyPort, proxyDisabled, to); }
	...
	jboolean parseHTTP(jni::ref<sun::net::www::MessageHeader> responses, jni::ref<sun::net::ProgressSource> pi, jni::ref<sun::net::www::protocol::http::HttpURLConnection> httpuc) { return call_method<"parseHTTP", jboolean>(responses, pi, httpuc); }
