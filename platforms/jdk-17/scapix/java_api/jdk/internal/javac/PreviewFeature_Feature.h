...
public:
	...
	static jni::ref<jdk::internal::javac::PreviewFeature_Feature> SEALED_CLASSES() { return get_static_field<"SEALED_CLASSES", jni::ref<jdk::internal::javac::PreviewFeature_Feature>>(); }
	static jni::ref<jdk::internal::javac::PreviewFeature_Feature> SWITCH_PATTERN_MATCHING() { return get_static_field<"SWITCH_PATTERN_MATCHING", jni::ref<jdk::internal::javac::PreviewFeature_Feature>>(); }
