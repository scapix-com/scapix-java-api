...
namespace scapix::java_api { namespace jdk::internal::util::xml::impl { class XMLStreamWriterImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::impl::XMLStreamWriterImpl> new_object(jni::ref<java::io::OutputStream> os) { return object_base::new_object(os); }
	static jni::ref<jdk::internal::util::xml::impl::XMLStreamWriterImpl> new_object(jni::ref<java::io::OutputStream> os, jni::ref<java::nio::charset::Charset> cs) { return object_base::new_object(os, cs); }
