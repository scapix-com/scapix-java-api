...
namespace scapix::java_api { namespace jdk::internal::perf { class Perf_GetPerfAction; }}
...
public:
	...
	static jni::ref<jdk::internal::perf::Perf_GetPerfAction> new_object() { return object_base::new_object(); }
