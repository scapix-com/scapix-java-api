...
namespace scapix::java_api { namespace jdk::internal::ref { class CleanerFactory; }}
...
public:
	...
	static jni::ref<jdk::internal::ref::CleanerFactory> new_object() { return object_base::new_object(); }
