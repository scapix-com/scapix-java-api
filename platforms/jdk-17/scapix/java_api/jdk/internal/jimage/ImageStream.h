...
namespace scapix::java_api { namespace jdk::internal::jimage { class ImageStream; }}
...
public:
	...
	static jni::ref<jdk::internal::jimage::ImageStream> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::jimage::ImageStream> new_object(jint size) { return object_base::new_object(size); }
	static jni::ref<jdk::internal::jimage::ImageStream> new_object(jni::ref<jni::array<jbyte>> bytes) { return object_base::new_object(bytes); }
	static jni::ref<jdk::internal::jimage::ImageStream> new_object(jni::ref<java::nio::ByteOrder> byteOrder) { return object_base::new_object(byteOrder); }
	static jni::ref<jdk::internal::jimage::ImageStream> new_object(jint size, jni::ref<java::nio::ByteOrder> byteOrder) { return object_base::new_object(size, byteOrder); }
	static jni::ref<jdk::internal::jimage::ImageStream> new_object(jni::ref<jni::array<jbyte>> bytes, jni::ref<java::nio::ByteOrder> byteOrder) { return object_base::new_object(bytes, byteOrder); }
	static jni::ref<jdk::internal::jimage::ImageStream> new_object(jni::ref<java::nio::ByteBuffer> buffer) { return object_base::new_object(buffer); }
