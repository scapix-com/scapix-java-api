...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_FIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_FIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::reflect { class FieldAccessorImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::FieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/FieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::MagicAccessorImpl, scapix::java_api::jdk::internal::reflect::FieldAccessor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_FIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_FIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_FIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::FieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/FieldAccessorImpl",
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_FIELDACCESSORIMPL
