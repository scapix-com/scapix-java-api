...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFESTATICBOOLEANFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFESTATICBOOLEANFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class UnsafeStaticBooleanFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::UnsafeStaticBooleanFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/UnsafeStaticBooleanFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::UnsafeStaticFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFESTATICBOOLEANFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFESTATICBOOLEANFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFESTATICBOOLEANFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::UnsafeStaticBooleanFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/UnsafeStaticBooleanFieldAccessorImpl",
...
protected:
	...
	UnsafeStaticBooleanFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFESTATICBOOLEANFIELDACCESSORIMPL
