...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDLONGFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDLONGFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class UnsafeQualifiedLongFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::UnsafeQualifiedLongFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/UnsafeQualifiedLongFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::UnsafeQualifiedFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDLONGFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDLONGFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDLONGFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::UnsafeQualifiedLongFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/UnsafeQualifiedLongFieldAccessorImpl",
...
protected:
	...
	UnsafeQualifiedLongFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDLONGFIELDACCESSORIMPL
