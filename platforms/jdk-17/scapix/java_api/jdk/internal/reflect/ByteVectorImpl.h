...
namespace scapix::java_api { namespace jdk::internal::reflect { class ByteVectorImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::reflect::ByteVectorImpl> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::reflect::ByteVectorImpl> new_object(jint sz) { return object_base::new_object(sz); }
