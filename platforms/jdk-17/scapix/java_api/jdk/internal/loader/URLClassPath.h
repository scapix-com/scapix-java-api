...
namespace scapix::java_api { namespace jdk::internal::loader { class URLClassPath; }}
...
public:
	...
	static jni::ref<jdk::internal::loader::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::net::URLStreamHandlerFactory> factory, jni::ref<java::security::AccessControlContext> acc) { return object_base::new_object(urls, factory, acc); }
	static jni::ref<jdk::internal::loader::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::security::AccessControlContext> acc) { return object_base::new_object(urls, acc); }
