...
namespace scapix::java_api { namespace jdk::internal::loader { class NativeLibraries; }}
...
public:
	...
	static jni::ref<jdk::internal::loader::NativeLibraries> jniNativeLibraries(jni::ref<java::lang::ClassLoader> loader) { return call_static_method<"jniNativeLibraries", jni::ref<jdk::internal::loader::NativeLibraries>>(loader); }
	static jni::ref<jdk::internal::loader::NativeLibraries> rawNativeLibraries(jni::ref<java::lang::Class> trustedCaller, jboolean searchJavaLibraryPath) { return call_static_method<"rawNativeLibraries", jni::ref<jdk::internal::loader::NativeLibraries>>(trustedCaller, searchJavaLibraryPath); }
