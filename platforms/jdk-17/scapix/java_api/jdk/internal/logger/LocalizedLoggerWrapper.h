...
namespace scapix::java_api { namespace jdk::internal::logger { class LocalizedLoggerWrapper; }}
...
public:
	...
	static jni::ref<jdk::internal::logger::LocalizedLoggerWrapper> new_object(jni::ref<java::lang::System_Logger> wrapped, jni::ref<java::util::ResourceBundle> bundle) { return object_base::new_object(wrapped, bundle); }
