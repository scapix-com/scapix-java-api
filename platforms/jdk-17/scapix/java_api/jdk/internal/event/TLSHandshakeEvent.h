...
namespace scapix::java_api { namespace jdk::internal::event { class TLSHandshakeEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::TLSHandshakeEvent> new_object() { return object_base::new_object(); }
