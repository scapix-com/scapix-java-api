...
namespace scapix::java_api { namespace jdk::internal::access::foreign { class MemorySegmentProxy; }}
...
public:
	...
	static jni::ref<jdk::internal::access::foreign::MemorySegmentProxy> new_object() { return object_base::new_object(); }
	...
	static jlong addOffsets(jlong op1, jlong op2, jni::ref<jdk::internal::access::foreign::MemorySegmentProxy> segmentProxy) { return call_static_method<"addOffsets", jlong>(op1, op2, segmentProxy); }
	static jlong multiplyOffsets(jlong op1, jlong op2, jni::ref<jdk::internal::access::foreign::MemorySegmentProxy> segmentProxy) { return call_static_method<"multiplyOffsets", jlong>(op1, op2, segmentProxy); }
