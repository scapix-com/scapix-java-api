...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ACCESS_JAVAUTILJARACCESS_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ACCESS_JAVAUTILJARACCESS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::access { class JavaUtilJarAccess; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::access::JavaUtilJarAccess>
{
	static constexpr fixed_string class_name = "jdk/internal/access/JavaUtilJarAccess";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ACCESS_JAVAUTILJARACCESS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ACCESS_JAVAUTILJARACCESS)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ACCESS_JAVAUTILJARACCESS
...
class jdk::internal::access::JavaUtilJarAccess : public jni::object_base<"jdk/internal/access/JavaUtilJarAccess",
	java::lang::Object>
{
public:
	...
	jni::ref<java::util::jar::JarEntry> entryFor(jni::ref<java::util::jar::JarFile> p1, jni::ref<java::lang::String> p2) { return call_method<"entryFor", jni::ref<java::util::jar::JarEntry>>(p1, p2); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ACCESS_JAVAUTILJARACCESS
