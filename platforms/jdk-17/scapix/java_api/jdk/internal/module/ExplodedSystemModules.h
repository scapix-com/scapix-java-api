...
#include <scapix/java_api/jdk/internal/module/SystemModules.h>

#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_MODULE_EXPLODEDSYSTEMMODULES_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_MODULE_EXPLODEDSYSTEMMODULES_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::module { class ExplodedSystemModules; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::module::ExplodedSystemModules>
{
	static constexpr fixed_string class_name = "jdk/internal/module/ExplodedSystemModules";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::jdk::internal::module::SystemModules>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_MODULE_EXPLODEDSYSTEMMODULES_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_MODULE_EXPLODEDSYSTEMMODULES)
#define SCAPIX_JAVA_API_JDK_INTERNAL_MODULE_EXPLODEDSYSTEMMODULES
...
// private
class jdk::internal::module::ExplodedSystemModules : public jni::object_base<"jdk/internal/module/ExplodedSystemModules",
	java::lang::Object,
...
protected:
	...
	ExplodedSystemModules(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_MODULE_EXPLODEDSYSTEMMODULES
