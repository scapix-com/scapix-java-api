...
namespace scapix::java_api { namespace jdk::internal::org::xml::sax { class SAXParseException; }}
...
public:
	...
	static jni::ref<jdk::internal::org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<jdk::internal::org::xml::sax::Locator> locator) { return object_base::new_object(message, locator); }
	static jni::ref<jdk::internal::org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<jdk::internal::org::xml::sax::Locator> locator, jni::ref<java::lang::Exception> e) { return object_base::new_object(message, locator, e); }
	static jni::ref<jdk::internal::org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::String> publicId, jni::ref<java::lang::String> systemId, jint lineNumber, jint columnNumber) { return object_base::new_object(message, publicId, systemId, lineNumber, columnNumber); }
