...
namespace scapix::java_api { namespace jdk::internal::org::xml::sax { class SAXNotRecognizedException; }}
...
public:
	...
	static jni::ref<jdk::internal::org::xml::sax::SAXNotRecognizedException> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::org::xml::sax::SAXNotRecognizedException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
