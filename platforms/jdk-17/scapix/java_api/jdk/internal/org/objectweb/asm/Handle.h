...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class Handle; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::Handle> new_object(jint tag, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return object_base::new_object(tag, owner, name, descriptor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::Handle> new_object(jint tag, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jboolean isInterface) { return object_base::new_object(tag, owner, name, descriptor, isInterface); }
