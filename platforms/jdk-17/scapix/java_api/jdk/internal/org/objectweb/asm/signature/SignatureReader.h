...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::signature { class SignatureReader; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureReader> new_object(jni::ref<java::lang::String> signature) { return object_base::new_object(signature); }
