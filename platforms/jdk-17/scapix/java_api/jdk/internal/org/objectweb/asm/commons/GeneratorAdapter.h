...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return base_::new_object(methodVisitor, access, name, descriptor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jint access, jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> method, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor) { return base_::new_object(access, method, methodVisitor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jint access, jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> method, jni::ref<java::lang::String> signature, jni::ref<jni::array<jdk::internal::org::objectweb::asm_::Type>> exceptions, jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor) { return base_::new_object(access, method, signature, exceptions, classVisitor); }
