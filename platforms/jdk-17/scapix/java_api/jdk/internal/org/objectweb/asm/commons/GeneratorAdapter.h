...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class GeneratorAdapter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return object_base::new_object(methodVisitor, access, name, descriptor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jint access, jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> method, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor) { return object_base::new_object(access, method, methodVisitor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jint access, jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> method, jni::ref<java::lang::String> signature, jni::ref<jni::array<jdk::internal::org::objectweb::asm_::Type>> exceptions, jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor) { return object_base::new_object(access, method, signature, exceptions, classVisitor); }
	...
	void push(jni::ref<jdk::internal::org::objectweb::asm_::ConstantDynamic> constantDynamic) { return call_method<"push", void>(constantDynamic); }
	...
	void throwException(jni::ref<jdk::internal::org::objectweb::asm_::Type> type, jni::ref<java::lang::String> message) { return call_method<"throwException", void>(type, message); }
