...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class RemappingClassAdapter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::RemappingClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return object_base::new_object(classVisitor, remapper); }
