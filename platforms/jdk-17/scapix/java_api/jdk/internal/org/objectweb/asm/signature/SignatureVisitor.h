...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::signature { class SignatureVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> new_object(jint api) { return object_base::new_object(api); }
