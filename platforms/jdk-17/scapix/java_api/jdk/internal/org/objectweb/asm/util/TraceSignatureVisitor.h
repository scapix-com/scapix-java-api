...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class TraceSignatureVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceSignatureVisitor> new_object(jint accessFlags) { return object_base::new_object(accessFlags); }
