...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_::util { class TraceMethodVisitor; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return base_::new_object(printer); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return base_::new_object(methodVisitor, printer); }
...
protected:
	...
	TraceMethodVisitor(handle_type h) : base_(h) {}
