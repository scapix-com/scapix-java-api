...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class AnalyzerAdapter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::AnalyzerAdapter> new_object(jni::ref<java::lang::String> owner, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor) { return object_base::new_object(owner, access, name, descriptor, methodVisitor); }
