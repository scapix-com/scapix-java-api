...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::LocalVariablesSorter> new_object(jint access, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor) { return base_::new_object(access, descriptor, methodVisitor); }
