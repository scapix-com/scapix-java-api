...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class ModuleExportNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::ModuleExportNode> new_object(jni::ref<java::lang::String> packaze, jint access, jni::ref<java::util::List> modules) { return object_base::new_object(packaze, access, modules); }
