...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_ { class MethodVisitor; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> new_object(jint api) { return base_::new_object(api); }
	static jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor) { return base_::new_object(api, methodVisitor); }
...
protected:
	...
	MethodVisitor(handle_type h) : base_(h) {}
