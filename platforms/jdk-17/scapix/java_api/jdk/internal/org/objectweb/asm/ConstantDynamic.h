...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ConstantDynamic; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ConstantDynamic> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::Handle> bootstrapMethod, jni::ref<jni::array<java::lang::Object>> bootstrapMethodArguments) { return object_base::new_object(name, descriptor, bootstrapMethod, bootstrapMethodArguments); }
