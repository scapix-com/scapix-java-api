...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class ModuleRequireNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::ModuleRequireNode> new_object(jni::ref<java::lang::String> module, jint access, jni::ref<java::lang::String> version) { return object_base::new_object(module, access, version); }
