...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class AnnotationVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> new_object(jint api) { return object_base::new_object(api); }
	static jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> annotationVisitor) { return object_base::new_object(api, annotationVisitor); }
