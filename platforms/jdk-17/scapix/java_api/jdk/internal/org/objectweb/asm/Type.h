...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class Type; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::Type> getType(jni::ref<java::lang::Class> clazz) { return call_static_method<"getType", jni::ref<jdk::internal::org::objectweb::asm_::Type>>(clazz); }
	static jni::ref<jdk::internal::org::objectweb::asm_::Type> getType(jni::ref<java::lang::reflect::Constructor> constructor) { return call_static_method<"getType", jni::ref<jdk::internal::org::objectweb::asm_::Type>>(constructor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::Type> getType(jni::ref<java::lang::reflect::Method> method) { return call_static_method<"getType", jni::ref<jdk::internal::org::objectweb::asm_::Type>>(method); }
	...
	static jni::ref<java::lang::String> getInternalName(jni::ref<java::lang::Class> clazz) { return call_static_method<"getInternalName", jni::ref<java::lang::String>>(clazz); }
	jni::ref<java::lang::String> getDescriptor() { return call_method<"getDescriptor", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> getDescriptor(jni::ref<java::lang::Class> clazz) { return call_static_method<"getDescriptor", jni::ref<java::lang::String>>(clazz); }
	static jni::ref<java::lang::String> getConstructorDescriptor(jni::ref<java::lang::reflect::Constructor> constructor) { return call_static_method<"getConstructorDescriptor", jni::ref<java::lang::String>>(constructor); }
	...
	static jni::ref<java::lang::String> getMethodDescriptor(jni::ref<java::lang::reflect::Method> method) { return call_static_method<"getMethodDescriptor", jni::ref<java::lang::String>>(method); }
	...
	static jint getArgumentsAndReturnSizes(jni::ref<java::lang::String> methodDescriptor) { return call_static_method<"getArgumentsAndReturnSizes", jint>(methodDescriptor); }
