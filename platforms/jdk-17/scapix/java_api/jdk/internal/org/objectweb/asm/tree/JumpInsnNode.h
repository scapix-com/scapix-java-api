...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class JumpInsnNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::JumpInsnNode> new_object(jint opcode, jni::ref<jdk::internal::org::objectweb::asm_::tree::LabelNode> label) { return object_base::new_object(opcode, label); }
