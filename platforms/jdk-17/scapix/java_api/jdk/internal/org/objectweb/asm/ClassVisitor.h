...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ClassVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> new_object(jint api) { return object_base::new_object(api); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor) { return object_base::new_object(api, classVisitor); }
