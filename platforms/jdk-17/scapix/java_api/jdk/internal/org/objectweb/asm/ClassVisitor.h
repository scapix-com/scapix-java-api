...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor) { return base_::new_object(api, classVisitor); }
