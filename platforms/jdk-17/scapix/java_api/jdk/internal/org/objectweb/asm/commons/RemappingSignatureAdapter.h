...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_::commons { class RemappingSignatureAdapter; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::RemappingSignatureAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> signatureVisitor, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return base_::new_object(signatureVisitor, remapper); }
...
protected:
	...
	RemappingSignatureAdapter(handle_type h) : base_(h) {}
