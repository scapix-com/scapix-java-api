...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_REMAPPINGSIGNATUREADAPTER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_REMAPPINGSIGNATUREADAPTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class RemappingSignatureAdapter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::commons::RemappingSignatureAdapter>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/commons/RemappingSignatureAdapter";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::signature::SignatureVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_REMAPPINGSIGNATUREADAPTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_REMAPPINGSIGNATUREADAPTER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_REMAPPINGSIGNATUREADAPTER
...
class jdk::internal::org::objectweb::asm_::commons::RemappingSignatureAdapter : public jni::object_base<"jdk/internal/org/objectweb/asm/commons/RemappingSignatureAdapter",
	jdk::internal::org::objectweb::asm_::signature::SignatureVisitor>
{
public:

	static jni::ref<jdk::internal::org::objectweb::asm_::commons::RemappingSignatureAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> signatureVisitor, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return object_base::new_object(signatureVisitor, remapper); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_REMAPPINGSIGNATUREADAPTER
