...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree::analysis { class Frame; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> new_object(jint numLocals, jint numStack) { return object_base::new_object(numLocals, numStack); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> frame) { return object_base::new_object(frame); }
