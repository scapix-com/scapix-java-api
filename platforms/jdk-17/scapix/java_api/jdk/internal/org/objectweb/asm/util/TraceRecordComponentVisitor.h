...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class TraceRecordComponentVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceRecordComponentVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return object_base::new_object(printer); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceRecordComponentVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::RecordComponentVisitor> recordComponentVisitor, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return object_base::new_object(recordComponentVisitor, printer); }
