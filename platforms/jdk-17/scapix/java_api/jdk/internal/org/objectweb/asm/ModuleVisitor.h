...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ModuleVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> new_object(jint api) { return object_base::new_object(api); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> moduleVisitor) { return object_base::new_object(api, moduleVisitor); }
