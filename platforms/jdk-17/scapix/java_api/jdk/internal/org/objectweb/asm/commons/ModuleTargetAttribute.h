...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class ModuleTargetAttribute; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::ModuleTargetAttribute> new_object(jni::ref<java::lang::String> platform) { return object_base::new_object(platform); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::ModuleTargetAttribute> new_object() { return object_base::new_object(); }
