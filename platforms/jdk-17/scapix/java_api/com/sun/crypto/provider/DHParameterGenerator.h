...
namespace scapix::java_api { namespace com::sun::crypto::provider { class DHParameterGenerator; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::DHParameterGenerator> new_object() { return object_base::new_object(); }
