...
namespace scapix::java_api { namespace com::sun::crypto::provider { class JceKeyStore; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::JceKeyStore> new_object() { return object_base::new_object(); }
