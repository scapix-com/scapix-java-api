...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBKDF2HmacSHA1Factory; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBKDF2HmacSHA1Factory> new_object() { return object_base::new_object(); }
