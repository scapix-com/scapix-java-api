...
#ifndef SCAPIX_JAVA_API_COM_SUN_NIO_SCTP_SCTPSERVERCHANNEL
...
public:
	...
	jni::ref<com::sun::nio::sctp::SctpServerChannel> bind(jni::ref<java::net::SocketAddress> local) { return call_method<"bind", jni::ref<com::sun::nio::sctp::SctpServerChannel>>(local); }
