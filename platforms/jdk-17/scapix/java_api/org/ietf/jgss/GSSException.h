...
#ifndef SCAPIX_JAVA_API_ORG_IETF_JGSS_GSSEXCEPTION
...
public:
	...
	static jni::ref<org::ietf::jgss::GSSException> new_object(jint majorCode) { return object_base::new_object(majorCode); }
	static jni::ref<org::ietf::jgss::GSSException> new_object(jint majorCode, jint minorCode, jni::ref<java::lang::String> minorString) { return object_base::new_object(majorCode, minorCode, minorString); }
	...
	void setMinor(jint minorCode, jni::ref<java::lang::String> message) { return call_method<"setMinor", void>(minorCode, message); }
