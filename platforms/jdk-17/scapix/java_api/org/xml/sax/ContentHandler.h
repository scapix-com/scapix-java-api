...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_CONTENTHANDLER
...
public:
	...
	void declaration(jni::ref<java::lang::String> version, jni::ref<java::lang::String> encoding, jni::ref<java::lang::String> standalone) { return call_method<"declaration", void>(version, encoding, standalone); }
