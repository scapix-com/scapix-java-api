...
struct scapix::jni::object_traits<scapix::java_api::org::xml::sax::ext::DefaultHandler2>
{
	...
	using base_classes = std::tuple<scapix::java_api::org::xml::sax::helpers::DefaultHandler, scapix::java_api::org::xml::sax::ext::DeclHandler, scapix::java_api::org::xml::sax::ext::EntityResolver2, scapix::java_api::org::xml::sax::ext::LexicalHandler>;
};
...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_EXT_DEFAULTHANDLER2
...
public:
	...
	static jni::ref<org::xml::sax::ext::DefaultHandler2> new_object() { return object_base::new_object(); }
