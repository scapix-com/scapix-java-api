...
struct scapix::jni::object_traits<scapix::java_api::org::xml::sax::helpers::DefaultHandler>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::org::xml::sax::ContentHandler, scapix::java_api::org::xml::sax::DTDHandler, scapix::java_api::org::xml::sax::EntityResolver, scapix::java_api::org::xml::sax::ErrorHandler>;
};
...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_HELPERS_DEFAULTHANDLER
...
public:
	...
	static jni::ref<org::xml::sax::helpers::DefaultHandler> new_object() { return object_base::new_object(); }
