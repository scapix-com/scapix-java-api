...
struct scapix::jni::object_traits<scapix::java_api::org::xml::sax::helpers::ParserAdapter>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::org::xml::sax::DocumentHandler, scapix::java_api::org::xml::sax::XMLReader>;
};
...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_HELPERS_PARSERADAPTER
...
public:
	...
	static jni::ref<org::xml::sax::helpers::ParserAdapter> new_object() { return object_base::new_object(); }
	static jni::ref<org::xml::sax::helpers::ParserAdapter> new_object(jni::ref<org::xml::sax::Parser> parser) { return object_base::new_object(parser); }
