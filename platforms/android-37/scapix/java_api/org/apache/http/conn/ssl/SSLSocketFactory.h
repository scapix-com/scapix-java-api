...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_SSL_SSLSOCKETFACTORY
...
public:
	...
	static jni::ref<org::apache::http::conn::ssl::SSLSocketFactory> new_object(jni::ref<java::lang::String> algorithm, jni::ref<java::security::KeyStore> keystore, jni::ref<java::lang::String> keystorePassword, jni::ref<java::security::KeyStore> truststore, jni::ref<java::security::SecureRandom> random, jni::ref<org::apache::http::conn::scheme::HostNameResolver> nameResolver) { return object_base::new_object(algorithm, keystore, keystorePassword, truststore, random, nameResolver); }
	static jni::ref<org::apache::http::conn::ssl::SSLSocketFactory> new_object(jni::ref<java::security::KeyStore> truststore) { return object_base::new_object(truststore); }
	static jni::ref<org::apache::http::conn::ssl::SSLSocketFactory> new_object(jni::ref<java::security::KeyStore> keystore, jni::ref<java::lang::String> keystorePassword) { return object_base::new_object(keystore, keystorePassword); }
	static jni::ref<org::apache::http::conn::ssl::SSLSocketFactory> new_object(jni::ref<java::security::KeyStore> keystore, jni::ref<java::lang::String> keystorePassword, jni::ref<java::security::KeyStore> truststore) { return object_base::new_object(keystore, keystorePassword, truststore); }
