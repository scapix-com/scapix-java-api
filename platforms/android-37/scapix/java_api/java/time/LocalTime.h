...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_LOCALTIME
...
public:
	...
	jni::ref<java::time::LocalTime> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::LocalTime>>(amountToSubtract, unit); }
	...
	static jni::ref<java::time::LocalTime> ofInstant(jni::ref<java::time::Instant> instant, jni::ref<java::time::ZoneId> zone) { return call_static_method<"ofInstant", jni::ref<java::time::LocalTime>>(instant, zone); }
	...
	jni::ref<java::time::LocalTime> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::LocalTime>>(amountToAdd, unit); }
	...
	jlong toEpochSecond(jni::ref<java::time::LocalDate> date, jni::ref<java::time::ZoneOffset> offset) { return call_method<"toEpochSecond", jlong>(date, offset); }
