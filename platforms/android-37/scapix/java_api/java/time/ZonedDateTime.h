...
struct scapix::jni::object_traits<scapix::java_api::java::time::ZonedDateTime>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::time::chrono::ChronoZonedDateTime, scapix::java_api::java::io::Serializable, scapix::java_api::java::time::temporal::Temporal>;
};
...
public:
	...
	jni::ref<java::time::ZonedDateTime> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::ZonedDateTime>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::ZonedDateTime> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::ZonedDateTime>>(amountToAdd, unit); }
