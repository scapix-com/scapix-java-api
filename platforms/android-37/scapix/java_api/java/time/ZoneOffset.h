...
struct scapix::jni::object_traits<scapix::java_api::java::time::ZoneOffset>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::time::ZoneId, scapix::java_api::java::lang::Comparable, scapix::java_api::java::io::Serializable, scapix::java_api::java::time::temporal::TemporalAccessor, scapix::java_api::java::time::temporal::TemporalAdjuster>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_ZONEOFFSET
