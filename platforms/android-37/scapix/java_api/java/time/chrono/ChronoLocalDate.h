...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_CHRONOLOCALDATE
...
public:
	...
	jni::ref<java::time::chrono::ChronoLocalDate> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::chrono::ChronoLocalDate>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::chrono::ChronoLocalDate> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::chrono::ChronoLocalDate>>(amountToAdd, unit); }
