...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_THAIBUDDHISTERA
...
public:
	...
	static jni::ref<java::time::chrono::ThaiBuddhistEra> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::time::chrono::ThaiBuddhistEra>>(name); }
	...
	static jni::ref<java::time::chrono::ThaiBuddhistEra> of(jint thaiBuddhistEra) { return call_static_method<"of", jni::ref<java::time::chrono::ThaiBuddhistEra>>(thaiBuddhistEra); }
};
