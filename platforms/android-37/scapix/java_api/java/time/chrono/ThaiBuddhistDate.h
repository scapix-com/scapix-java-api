...
public:
	...
	jni::ref<java::time::chrono::ThaiBuddhistDate> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::chrono::ThaiBuddhistDate> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(amountToAdd, unit); }
