...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_JAPANESEDATE
...
public:
	...
	jni::ref<java::time::chrono::JapaneseDate> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::chrono::JapaneseDate>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::chrono::JapaneseDate> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::chrono::JapaneseDate>>(amountToAdd, unit); }
