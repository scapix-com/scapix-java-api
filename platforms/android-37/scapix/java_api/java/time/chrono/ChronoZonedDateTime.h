...
struct scapix::jni::object_traits<scapix::java_api::java::time::chrono::ChronoZonedDateTime>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Comparable, scapix::java_api::java::time::temporal::Temporal>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_CHRONOZONEDDATETIME
...
public:
	...
	jint compareTo(jni::ref<java::time::chrono::ChronoZonedDateTime> other) { return call_method<"compareTo", jint>(other); }
	...
	static jni::ref<java::time::chrono::ChronoZonedDateTime> from(jni::ref<java::time::temporal::TemporalAccessor> temporal) { return call_static_method<"from", jni::ref<java::time::chrono::ChronoZonedDateTime>>(temporal); }
	...
	jboolean isAfter(jni::ref<java::time::chrono::ChronoZonedDateTime> other) { return call_method<"isAfter", jboolean>(other); }
	jboolean isBefore(jni::ref<java::time::chrono::ChronoZonedDateTime> other) { return call_method<"isBefore", jboolean>(other); }
	jboolean isEqual(jni::ref<java::time::chrono::ChronoZonedDateTime> other) { return call_method<"isEqual", jboolean>(other); }
	...
	jni::ref<java::time::chrono::ChronoZonedDateTime> minus(jni::ref<java::time::temporal::TemporalAmount> amount) { return call_method<"minus", jni::ref<java::time::chrono::ChronoZonedDateTime>>(amount); }
	jni::ref<java::time::chrono::ChronoZonedDateTime> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::chrono::ChronoZonedDateTime>>(amountToSubtract, unit); }
	jni::ref<java::time::chrono::ChronoZonedDateTime> plus(jni::ref<java::time::temporal::TemporalAmount> amount) { return call_method<"plus", jni::ref<java::time::chrono::ChronoZonedDateTime>>(amount); }
	...
	jni::ref<java::time::chrono::ChronoZonedDateTime> with(jni::ref<java::time::temporal::TemporalAdjuster> adjuster) { return call_method<"with", jni::ref<java::time::chrono::ChronoZonedDateTime>>(adjuster); }
