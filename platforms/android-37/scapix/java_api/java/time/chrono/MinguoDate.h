...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_MINGUODATE
...
public:
	...
	jni::ref<java::time::chrono::MinguoDate> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::chrono::MinguoDate>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::chrono::MinguoDate> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::chrono::MinguoDate>>(amountToAdd, unit); }
