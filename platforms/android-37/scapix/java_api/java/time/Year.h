...
public:
	...
	jni::ref<java::time::Year> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::Year>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::Year> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::Year>>(amountToAdd, unit); }
