...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_INSTANT
...
public:
	...
	jni::ref<java::time::Instant> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::Instant>>(amountToSubtract, unit); }
	...
	static jni::ref<java::time::Instant> ofEpochSecond(jlong epochSecond, jlong nanoAdjustment) { return call_static_method<"ofEpochSecond", jni::ref<java::time::Instant>>(epochSecond, nanoAdjustment); }
	...
	jni::ref<java::time::Instant> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::Instant>>(amountToAdd, unit); }
