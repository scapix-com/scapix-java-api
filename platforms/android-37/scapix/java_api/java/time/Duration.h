...
struct scapix::jni::object_traits<scapix::java_api::java::time::Duration>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Comparable, scapix::java_api::java::io::Serializable, scapix::java_api::java::time::temporal::TemporalAmount>;
};
...
public:
	...
	jboolean isPositive() { return call_method<"isPositive", jboolean>(); }
	...
	jni::ref<java::time::Duration> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::Duration>>(amountToSubtract, unit); }
	...
	static jni::ref<java::time::Duration> of(jlong amount, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_static_method<"of", jni::ref<java::time::Duration>>(amount, unit); }
	...
	static jni::ref<java::time::Duration> ofSeconds(jlong seconds, jlong nanoAdjustment) { return call_static_method<"ofSeconds", jni::ref<java::time::Duration>>(seconds, nanoAdjustment); }
	...
	jni::ref<java::time::Duration> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::Duration>>(amountToAdd, unit); }
