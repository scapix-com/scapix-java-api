...
public:
	...
	jni::ref<java::time::LocalDate> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::LocalDate>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::LocalDate> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::LocalDate>>(amountToAdd, unit); }
