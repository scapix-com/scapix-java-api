...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_TEMPORAL_WEEKFIELDS
...
public:
	...
	static jni::ref<java::time::temporal::WeekFields> of(jni::ref<java::time::DayOfWeek> firstDayOfWeek, jint minimalDaysInFirstWeek) { return call_static_method<"of", jni::ref<java::time::temporal::WeekFields>>(firstDayOfWeek, minimalDaysInFirstWeek); }
	static jni::ref<java::time::temporal::WeekFields> of(jni::ref<java::util::Locale> locale) { return call_static_method<"of", jni::ref<java::time::temporal::WeekFields>>(locale); }
