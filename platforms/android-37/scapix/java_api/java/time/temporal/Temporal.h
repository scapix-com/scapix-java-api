...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_TEMPORAL_TEMPORAL
...
public:
	...
	jni::ref<java::time::temporal::Temporal> minus(jni::ref<java::time::temporal::TemporalAmount> amount) { return call_method<"minus", jni::ref<java::time::temporal::Temporal>>(amount); }
	jni::ref<java::time::temporal::Temporal> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::temporal::Temporal>>(amountToSubtract, unit); }
	jni::ref<java::time::temporal::Temporal> plus(jni::ref<java::time::temporal::TemporalAmount> amount) { return call_method<"plus", jni::ref<java::time::temporal::Temporal>>(amount); }
	...
	jni::ref<java::time::temporal::Temporal> with(jni::ref<java::time::temporal::TemporalAdjuster> adjuster) { return call_method<"with", jni::ref<java::time::temporal::Temporal>>(adjuster); }
