...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_TEMPORAL_CHRONOUNIT
...
public:
	...
	static jni::ref<java::time::temporal::ChronoUnit> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::time::temporal::ChronoUnit>>(name); }
