...
public:
	...
	jni::ref<java::time::OffsetTime> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::OffsetTime>>(amountToSubtract, unit); }
	...
	jni::ref<java::time::OffsetTime> plus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"plus", jni::ref<java::time::OffsetTime>>(amountToAdd, unit); }
	...
	jlong toEpochSecond(jni::ref<java::time::LocalDate> date) { return call_method<"toEpochSecond", jlong>(date); }
