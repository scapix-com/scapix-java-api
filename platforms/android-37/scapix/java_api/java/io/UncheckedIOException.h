...
#ifndef SCAPIX_JAVA_API_JAVA_IO_UNCHECKEDIOEXCEPTION
...
public:
	...
	static jni::ref<java::io::UncheckedIOException> new_object(jni::ref<java::io::IOException> cause) { return object_base::new_object(cause); }
	static jni::ref<java::io::UncheckedIOException> new_object(jni::ref<java::lang::String> message, jni::ref<java::io::IOException> cause) { return object_base::new_object(message, cause); }
