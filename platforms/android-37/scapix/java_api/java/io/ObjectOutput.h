...
struct scapix::jni::object_traits<scapix::java_api::java::io::ObjectOutput>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::AutoCloseable, scapix::java_api::java::io::DataOutput>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OBJECTOUTPUT
