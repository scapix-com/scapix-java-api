...
struct scapix::jni::object_traits<scapix::java_api::java::io::ObjectInput>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::AutoCloseable, scapix::java_api::java::io::DataInput>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUT
