...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REFLECT_CONSTRUCTOR
...
public:
	...
	jni::ref<java::lang::Object> newInstance(jni::ref<jni::array<java::lang::Object>> initargs) { return call_method<"newInstance", jni::ref<java::lang::Object>>(initargs); }
