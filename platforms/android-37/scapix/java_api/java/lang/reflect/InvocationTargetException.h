...
public:
	...
	static jni::ref<java::lang::reflect::InvocationTargetException> new_object(jni::ref<java::lang::Throwable> target) { return object_base::new_object(target); }
	static jni::ref<java::lang::reflect::InvocationTargetException> new_object(jni::ref<java::lang::Throwable> target, jni::ref<java::lang::String> s) { return object_base::new_object(target, s); }
