...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REF_WEAKREFERENCE
...
public:
	...
	static jni::ref<java::lang::ref::WeakReference> new_object(jni::ref<java::lang::Object> referent) { return object_base::new_object(referent); }
	static jni::ref<java::lang::ref::WeakReference> new_object(jni::ref<java::lang::Object> referent, jni::ref<java::lang::ref::ReferenceQueue> q) { return object_base::new_object(referent, q); }
};
