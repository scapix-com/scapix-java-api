...
public:
	...
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
	void addSuppressed(jni::ref<java::lang::Throwable> exception) { return call_method<"addSuppressed", void>(exception); }
