...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_ANNOTATION_ELEMENTTYPE
...
public:
	...
	static jni::ref<java::lang::annotation::ElementType> MODULE() { return get_static_field<"MODULE", jni::ref<java::lang::annotation::ElementType>>(); }
	...
	static jni::ref<java::lang::annotation::ElementType> RECORD_COMPONENT() { return get_static_field<"RECORD_COMPONENT", jni::ref<java::lang::annotation::ElementType>>(); }
