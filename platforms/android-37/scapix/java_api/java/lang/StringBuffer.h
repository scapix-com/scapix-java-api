...
struct scapix::jni::object_traits<scapix::java_api::java::lang::StringBuffer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Appendable, scapix::java_api::java::lang::CharSequence, scapix::java_api::java::lang::Comparable, scapix::java_api::java::io::Serializable>;
};
...
public:
	...
	static jni::ref<java::lang::StringBuffer> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::lang::StringBuffer> new_object(jni::ref<java::lang::CharSequence> seq) { return object_base::new_object(seq); }
	static jni::ref<java::lang::StringBuffer> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
