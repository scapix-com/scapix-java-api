...
public:
	...
	static jni::ref<java::lang::invoke::MethodHandles_Lookup> privateLookupIn(jni::ref<java::lang::Class> targetClass, jni::ref<java::lang::invoke::MethodHandles_Lookup> lookup) { return call_static_method<"privateLookupIn", jni::ref<java::lang::invoke::MethodHandles_Lookup>>(targetClass, lookup); }
