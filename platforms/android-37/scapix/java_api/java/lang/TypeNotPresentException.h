...
public:
	...
	static jni::ref<java::lang::TypeNotPresentException> new_object(jni::ref<java::lang::String> typeName, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(typeName, cause); }
