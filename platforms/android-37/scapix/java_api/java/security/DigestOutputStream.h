...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_DIGESTOUTPUTSTREAM
...
public:
	...
	static jni::ref<java::security::DigestOutputStream> new_object(jni::ref<java::io::OutputStream> stream, jni::ref<java::security::MessageDigest> digest) { return object_base::new_object(stream, digest); }
