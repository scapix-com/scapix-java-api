...
public:
	...
	static jni::ref<java::security::Provider_Service> new_object(jni::ref<java::security::Provider> provider, jni::ref<java::lang::String> type, jni::ref<java::lang::String> algorithm, jni::ref<java::lang::String> className, jni::ref<java::util::List> aliases, jni::ref<java::util::Map> attributes) { return object_base::new_object(provider, type, algorithm, className, aliases, attributes); }
