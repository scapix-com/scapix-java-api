...
class CertPathValidatorException_BasicReason;
...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_CERTPATHVALIDATOREXCEPTION_BASICREASON
...
public:
	...
	static jni::ref<java::security::cert::CertPathValidatorException_BasicReason> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::security::cert::CertPathValidatorException_BasicReason>>(name); }
};
