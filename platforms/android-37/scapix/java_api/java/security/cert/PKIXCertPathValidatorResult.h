...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_PKIXCERTPATHVALIDATORRESULT
...
public:
	...
	static jni::ref<java::security::cert::PKIXCertPathValidatorResult> new_object(jni::ref<java::security::cert::TrustAnchor> trustAnchor, jni::ref<java::security::cert::PolicyNode> policyTree, jni::ref<java::security::PublicKey> subjectPublicKey) { return object_base::new_object(trustAnchor, policyTree, subjectPublicKey); }
