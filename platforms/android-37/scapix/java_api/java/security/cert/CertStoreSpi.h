...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_CERTSTORESPI
...
public:
	...
	static jni::ref<java::security::cert::CertStoreSpi> new_object(jni::ref<java::security::cert::CertStoreParameters> params) { return object_base::new_object(params); }
