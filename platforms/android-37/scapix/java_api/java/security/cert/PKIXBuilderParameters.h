...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_PKIXBUILDERPARAMETERS
...
public:
	...
	static jni::ref<java::security::cert::PKIXBuilderParameters> new_object(jni::ref<java::security::KeyStore> keystore, jni::ref<java::security::cert::CertSelector> targetConstraints) { return object_base::new_object(keystore, targetConstraints); }
	static jni::ref<java::security::cert::PKIXBuilderParameters> new_object(jni::ref<java::util::Set> trustAnchors, jni::ref<java::security::cert::CertSelector> targetConstraints) { return object_base::new_object(trustAnchors, targetConstraints); }
