...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_CERTIFICATEFACTORYSPI
...
public:
	...
	static jni::ref<java::security::cert::CertificateFactorySpi> new_object() { return object_base::new_object(); }
