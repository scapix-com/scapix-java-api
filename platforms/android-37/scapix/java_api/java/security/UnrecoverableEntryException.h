...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_UNRECOVERABLEENTRYEXCEPTION
...
public:
	...
	static jni::ref<java::security::UnrecoverableEntryException> new_object() { return object_base::new_object(); }
	static jni::ref<java::security::UnrecoverableEntryException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
