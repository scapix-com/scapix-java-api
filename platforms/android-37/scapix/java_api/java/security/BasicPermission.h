...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_BASICPERMISSION
...
public:
	...
	static jni::ref<java::security::BasicPermission> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::security::BasicPermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions) { return object_base::new_object(name, actions); }
