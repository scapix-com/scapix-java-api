...
public:
	...
	static jni::ref<java::security::spec::ECParameterSpec> new_object(jni::ref<java::security::spec::EllipticCurve> curve, jni::ref<java::security::spec::ECPoint> g, jni::ref<java::math::BigInteger> n, jint h) { return object_base::new_object(curve, g, n, h); }
