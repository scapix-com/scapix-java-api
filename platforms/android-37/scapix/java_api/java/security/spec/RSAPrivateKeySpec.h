...
public:
	...
	static jni::ref<java::security::spec::RSAPrivateKeySpec> new_object(jni::ref<java::math::BigInteger> modulus, jni::ref<java::math::BigInteger> privateExponent, jni::ref<java::security::spec::AlgorithmParameterSpec> params) { return object_base::new_object(modulus, privateExponent, params); }
