...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_RSAMULTIPRIMEPRIVATECRTKEYSPEC
...
public:
	...
	static jni::ref<java::security::spec::RSAMultiPrimePrivateCrtKeySpec> new_object(jni::ref<java::math::BigInteger> modulus, jni::ref<java::math::BigInteger> publicExponent, jni::ref<java::math::BigInteger> privateExponent, jni::ref<java::math::BigInteger> primeP, jni::ref<java::math::BigInteger> primeQ, jni::ref<java::math::BigInteger> primeExponentP, jni::ref<java::math::BigInteger> primeExponentQ, jni::ref<java::math::BigInteger> crtCoefficient, jni::ref<jni::array<java::security::spec::RSAOtherPrimeInfo>> otherPrimeInfo) { return object_base::new_object(modulus, publicExponent, privateExponent, primeP, primeQ, primeExponentP, primeExponentQ, crtCoefficient, otherPrimeInfo); }
	static jni::ref<java::security::spec::RSAMultiPrimePrivateCrtKeySpec> new_object(jni::ref<java::math::BigInteger> modulus, jni::ref<java::math::BigInteger> publicExponent, jni::ref<java::math::BigInteger> privateExponent, jni::ref<java::math::BigInteger> primeP, jni::ref<java::math::BigInteger> primeQ, jni::ref<java::math::BigInteger> primeExponentP, jni::ref<java::math::BigInteger> primeExponentQ, jni::ref<java::math::BigInteger> crtCoefficient, jni::ref<jni::array<java::security::spec::RSAOtherPrimeInfo>> otherPrimeInfo, jni::ref<java::security::spec::AlgorithmParameterSpec> keyParams) { return object_base::new_object(modulus, publicExponent, privateExponent, primeP, primeQ, primeExponentP, primeExponentQ, crtCoefficient, otherPrimeInfo, keyParams); }
