...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_ELLIPTICCURVE
...
public:
	...
	static jni::ref<java::security::spec::EllipticCurve> new_object(jni::ref<java::security::spec::ECField> field, jni::ref<java::math::BigInteger> a, jni::ref<java::math::BigInteger> b) { return object_base::new_object(field, a, b); }
	static jni::ref<java::security::spec::EllipticCurve> new_object(jni::ref<java::security::spec::ECField> field, jni::ref<java::math::BigInteger> a, jni::ref<java::math::BigInteger> b, jni::ref<jni::array<jbyte>> seed) { return object_base::new_object(field, a, b, seed); }
