...
public:
	...
	static jni::ref<java::security::spec::RSAKeyGenParameterSpec> new_object(jint keysize, jni::ref<java::math::BigInteger> publicExponent, jni::ref<java::security::spec::AlgorithmParameterSpec> keyParams) { return object_base::new_object(keysize, publicExponent, keyParams); }
	jni::ref<java::security::spec::AlgorithmParameterSpec> getKeyParams() { return call_method<"getKeyParams", jni::ref<java::security::spec::AlgorithmParameterSpec>>(); }
