...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_EDECPRIVATEKEYSPEC
...
public:
	...
	static jni::ref<java::security::spec::EdECPrivateKeySpec> new_object(jni::ref<java::security::spec::NamedParameterSpec> params, jni::ref<jni::array<jbyte>> bytes) { return object_base::new_object(params, bytes); }
