...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_RSAOTHERPRIMEINFO
...
public:
	...
	static jni::ref<java::security::spec::RSAOtherPrimeInfo> new_object(jni::ref<java::math::BigInteger> prime, jni::ref<java::math::BigInteger> primeExponent, jni::ref<java::math::BigInteger> crtCoefficient) { return object_base::new_object(prime, primeExponent, crtCoefficient); }
