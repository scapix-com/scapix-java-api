...
public:
	...
	static jni::ref<java::security::SecurityPermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions) { return object_base::new_object(name, actions); }
};
