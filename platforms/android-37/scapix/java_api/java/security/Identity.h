...
public:
	...
	static jni::ref<java::security::Identity> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::security::Identity> new_object(jni::ref<java::lang::String> name, jni::ref<java::security::IdentityScope> scope) { return object_base::new_object(name, scope); }
