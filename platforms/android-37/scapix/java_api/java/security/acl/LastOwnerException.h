...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_ACL_LASTOWNEREXCEPTION
...
public:
	...
	static jni::ref<java::security::acl::LastOwnerException> new_object() { return object_base::new_object(); }
};
