...
class KeyStore_TrustedCertificateEntry;
...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_KEYSTORE_TRUSTEDCERTIFICATEENTRY
...
public:
	...
	static jni::ref<java::security::KeyStore_TrustedCertificateEntry> new_object(jni::ref<java::security::cert::Certificate> trustedCert) { return object_base::new_object(trustedCert); }
	static jni::ref<java::security::KeyStore_TrustedCertificateEntry> new_object(jni::ref<java::security::cert::Certificate> trustedCert, jni::ref<java::util::Set> attributes) { return object_base::new_object(trustedCert, attributes); }
