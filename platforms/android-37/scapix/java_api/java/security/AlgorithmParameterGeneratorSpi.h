...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_ALGORITHMPARAMETERGENERATORSPI
...
public:
	...
	static jni::ref<java::security::AlgorithmParameterGeneratorSpi> new_object() { return object_base::new_object(); }
};
