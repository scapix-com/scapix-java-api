...
#ifndef SCAPIX_JAVA_API_JAVA_MATH_MATHCONTEXT
...
public:
	...
	static jni::ref<java::math::MathContext> new_object(jint setPrecision) { return object_base::new_object(setPrecision); }
	static jni::ref<java::math::MathContext> new_object(jint setPrecision, jni::ref<java::math::RoundingMode> setRoundingMode) { return object_base::new_object(setPrecision, setRoundingMode); }
	static jni::ref<java::math::MathContext> new_object(jni::ref<java::lang::String> val) { return object_base::new_object(val); }
