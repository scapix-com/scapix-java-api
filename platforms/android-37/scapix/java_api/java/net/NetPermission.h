...
#ifndef SCAPIX_JAVA_API_JAVA_NET_NETPERMISSION
...
public:
	...
	static jni::ref<java::net::NetPermission> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::net::NetPermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions) { return object_base::new_object(name, actions); }
};
