...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_FILELOCKINTERRUPTIONEXCEPTION
...
public:
	...
	static jni::ref<java::nio::channels::FileLockInterruptionException> new_object() { return object_base::new_object(); }
};
