...
struct scapix::jni::object_traits<scapix::java_api::java::nio::channels::FileChannel>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::nio::channels::spi::AbstractInterruptibleChannel, scapix::java_api::java::nio::channels::GatheringByteChannel, scapix::java_api::java::nio::channels::ScatteringByteChannel, scapix::java_api::java::nio::channels::SeekableByteChannel>;
};
