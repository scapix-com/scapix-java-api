...
struct scapix::jni::object_traits<scapix::java_api::java::nio::channels::SocketChannel>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::nio::channels::spi::AbstractSelectableChannel, scapix::java_api::java::nio::channels::ByteChannel, scapix::java_api::java::nio::channels::GatheringByteChannel, scapix::java_api::java::nio::channels::NetworkChannel, scapix::java_api::java::nio::channels::ScatteringByteChannel>;
};
...
public:
	...
	static jni::ref<java::nio::channels::SocketChannel> open(jni::ref<java::net::SocketAddress> remote) { return call_static_method<"open", jni::ref<java::nio::channels::SocketChannel>>(remote); }
