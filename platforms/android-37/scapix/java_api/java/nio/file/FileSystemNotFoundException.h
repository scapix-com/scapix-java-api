...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_FILESYSTEMNOTFOUNDEXCEPTION
...
public:
	...
	static jni::ref<java::nio::file::FileSystemNotFoundException> new_object() { return object_base::new_object(); }
	static jni::ref<java::nio::file::FileSystemNotFoundException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
