...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_ACCESSDENIEDEXCEPTION
...
public:
	...
	static jni::ref<java::nio::file::AccessDeniedException> new_object(jni::ref<java::lang::String> file) { return object_base::new_object(file); }
	static jni::ref<java::nio::file::AccessDeniedException> new_object(jni::ref<java::lang::String> file, jni::ref<java::lang::String> other, jni::ref<java::lang::String> reason) { return object_base::new_object(file, other, reason); }
};
