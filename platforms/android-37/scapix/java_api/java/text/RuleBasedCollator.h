...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_RULEBASEDCOLLATOR
...
public:
	...
	static jni::ref<java::text::RuleBasedCollator> new_object(jni::ref<java::lang::String> rules) { return object_base::new_object(rules); }
