...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_STRINGCHARACTERITERATOR
...
public:
	...
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> text) { return object_base::new_object(text); }
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> text, jint pos) { return object_base::new_object(text, pos); }
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> text, jint begin, jint end, jint pos) { return object_base::new_object(text, begin, end, pos); }
	...
	jchar setIndex(jint p) { return call_method<"setIndex", jchar>(p); }
