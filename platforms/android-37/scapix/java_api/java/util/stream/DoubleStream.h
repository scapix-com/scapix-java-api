...
public:
	...
	using DoubleMapMultiConsumer = DoubleStream_DoubleMapMultiConsumer;
	...
	static jni::ref<java::util::stream::DoubleStream> iterate(jdouble seed, jni::ref<java::util::function::DoublePredicate> hasNext, jni::ref<java::util::function::DoubleUnaryOperator> next) { return call_static_method<"iterate", jni::ref<java::util::stream::DoubleStream>>(seed, hasNext, next); }
	static jni::ref<java::util::stream::DoubleStream> iterate(jdouble seed, jni::ref<java::util::function::DoubleUnaryOperator> f) { return call_static_method<"iterate", jni::ref<java::util::stream::DoubleStream>>(seed, f); }
