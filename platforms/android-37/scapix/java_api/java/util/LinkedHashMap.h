...
struct scapix::jni::object_traits<scapix::java_api::java::util::LinkedHashMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::HashMap, scapix::java_api::java::util::Map, scapix::java_api::java::util::SequencedMap>;
};
...
public:
	...
	static jni::ref<java::util::LinkedHashMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
