...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_JAR_ATTRIBUTES_NAME
...
public:
	...
	static jni::ref<java::util::jar::Attributes_Name> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
