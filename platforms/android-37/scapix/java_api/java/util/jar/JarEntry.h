...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_JAR_JARENTRY
...
public:
	...
	static jni::ref<java::util::jar::JarEntry> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::util::jar::JarEntry> new_object(jni::ref<java::util::jar::JarEntry> je) { return object_base::new_object(je); }
	static jni::ref<java::util::jar::JarEntry> new_object(jni::ref<java::util::zip::ZipEntry> ze) { return object_base::new_object(ze); }
