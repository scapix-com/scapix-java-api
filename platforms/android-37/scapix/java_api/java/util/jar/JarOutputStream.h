...
public:
	...
	static jni::ref<java::util::jar::JarOutputStream> new_object(jni::ref<java::io::OutputStream> out) { return object_base::new_object(out); }
	static jni::ref<java::util::jar::JarOutputStream> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::jar::Manifest> man) { return object_base::new_object(out, man); }
