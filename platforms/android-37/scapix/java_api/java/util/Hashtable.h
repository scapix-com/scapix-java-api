...
struct scapix::jni::object_traits<scapix::java_api::java::util::Hashtable>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::Dictionary, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::Map, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_HASHTABLE
...
public:
	...
	static jni::ref<java::util::Hashtable> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::Hashtable> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::Hashtable> new_object(jint initialCapacity, jfloat loadFactor) { return object_base::new_object(initialCapacity, loadFactor); }
	static jni::ref<java::util::Hashtable> new_object(jni::ref<java::util::Map> t) { return object_base::new_object(t); }
