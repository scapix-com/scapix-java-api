...
struct scapix::jni::object_traits<scapix::java_api::java::util::List>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::Collection, scapix::java_api::java::util::SequencedCollection>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LIST
