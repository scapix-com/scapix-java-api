...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_PROPERTIES
...
public:
	...
	static jni::ref<java::util::Properties> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::Properties> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::Properties> new_object(jni::ref<java::util::Properties> defaults) { return object_base::new_object(defaults); }
