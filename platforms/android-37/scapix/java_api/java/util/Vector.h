...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_VECTOR
...
public:
	...
	static jni::ref<java::util::Vector> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::Vector> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::Vector> new_object(jint initialCapacity, jint capacityIncrement) { return object_base::new_object(initialCapacity, capacityIncrement); }
	static jni::ref<java::util::Vector> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
