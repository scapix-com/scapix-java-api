...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_IDENTITYHASHMAP
...
public:
	...
	static jni::ref<java::util::IdentityHashMap> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::IdentityHashMap> new_object(jint expectedMaxSize) { return object_base::new_object(expectedMaxSize); }
	static jni::ref<java::util::IdentityHashMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
