...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::ConcurrentSkipListMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractMap, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::concurrent::ConcurrentNavigableMap, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTMAP
...
public:
	...
	static jni::ref<java::util::concurrent::ConcurrentSkipListMap> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListMap> new_object(jni::ref<java::util::Comparator> comparator) { return object_base::new_object(comparator); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListMap> new_object(jni::ref<java::util::SortedMap> m) { return object_base::new_object(m); }
