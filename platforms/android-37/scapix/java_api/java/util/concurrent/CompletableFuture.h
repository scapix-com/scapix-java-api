...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::CompletableFuture>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::concurrent::CompletionStage, scapix::java_api::java::util::concurrent::Future>;
};
...
public:
	...
	jni::ref<java::util::concurrent::CompletableFuture> completeOnTimeout(jni::ref<java::lang::Object> value, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"completeOnTimeout", jni::ref<java::util::concurrent::CompletableFuture>>(value, timeout, unit); }
	...
	static jni::ref<java::util::concurrent::Executor> delayedExecutor(jlong delay, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_static_method<"delayedExecutor", jni::ref<java::util::concurrent::Executor>>(delay, unit); }
	static jni::ref<java::util::concurrent::Executor> delayedExecutor(jlong delay, jni::ref<java::util::concurrent::TimeUnit> unit, jni::ref<java::util::concurrent::Executor> executor) { return call_static_method<"delayedExecutor", jni::ref<java::util::concurrent::Executor>>(delay, unit, executor); }
	...
	jni::ref<java::util::concurrent::CompletableFuture> orTimeout(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"orTimeout", jni::ref<java::util::concurrent::CompletableFuture>>(timeout, unit); }
