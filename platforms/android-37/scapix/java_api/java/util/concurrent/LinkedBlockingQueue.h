...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LINKEDBLOCKINGQUEUE
...
public:
	...
	static jni::ref<java::util::concurrent::LinkedBlockingQueue> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::LinkedBlockingQueue> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::concurrent::LinkedBlockingQueue> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
