...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_EXECUTORCOMPLETIONSERVICE
...
public:
	...
	static jni::ref<java::util::concurrent::ExecutorCompletionService> new_object(jni::ref<java::util::concurrent::Executor> executor) { return object_base::new_object(executor); }
	static jni::ref<java::util::concurrent::ExecutorCompletionService> new_object(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::concurrent::BlockingQueue> completionQueue) { return object_base::new_object(executor, completionQueue); }
	jni::ref<java::util::concurrent::Future> poll() { return call_method<"poll", jni::ref<java::util::concurrent::Future>>(); }
	jni::ref<java::util::concurrent::Future> poll(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"poll", jni::ref<java::util::concurrent::Future>>(timeout, unit); }
