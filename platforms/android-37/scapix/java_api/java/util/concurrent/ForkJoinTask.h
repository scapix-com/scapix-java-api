...
public:
	...
	jboolean quietlyJoin(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"quietlyJoin", jboolean>(timeout, unit); }
	jboolean quietlyJoinUninterruptibly(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"quietlyJoinUninterruptibly", jboolean>(timeout, unit); }
