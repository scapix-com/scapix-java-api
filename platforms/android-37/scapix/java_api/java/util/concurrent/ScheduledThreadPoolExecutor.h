...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_SCHEDULEDTHREADPOOLEXECUTOR
...
public:
	...
	static jni::ref<java::util::concurrent::ScheduledThreadPoolExecutor> new_object(jint corePoolSize) { return object_base::new_object(corePoolSize); }
	static jni::ref<java::util::concurrent::ScheduledThreadPoolExecutor> new_object(jint corePoolSize, jni::ref<java::util::concurrent::RejectedExecutionHandler> handler) { return object_base::new_object(corePoolSize, handler); }
	static jni::ref<java::util::concurrent::ScheduledThreadPoolExecutor> new_object(jint corePoolSize, jni::ref<java::util::concurrent::ThreadFactory> threadFactory) { return object_base::new_object(corePoolSize, threadFactory); }
	static jni::ref<java::util::concurrent::ScheduledThreadPoolExecutor> new_object(jint corePoolSize, jni::ref<java::util::concurrent::ThreadFactory> threadFactory, jni::ref<java::util::concurrent::RejectedExecutionHandler> handler) { return object_base::new_object(corePoolSize, threadFactory, handler); }
