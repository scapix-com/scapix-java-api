...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_RECURSIVEACTION
...
public:
	...
	static jni::ref<java::util::concurrent::RecursiveAction> new_object() { return object_base::new_object(); }
