...
public:
	...
	static jni::ref<java::util::concurrent::CountDownLatch> new_object(jint count) { return object_base::new_object(count); }
	void await() { return call_method<"await", void>(); }
	jboolean await(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"await", jboolean>(timeout, unit); }
