...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::LinkedTransferQueue>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractQueue, scapix::java_api::java::io::Serializable, scapix::java_api::java::util::concurrent::TransferQueue>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LINKEDTRANSFERQUEUE
...
public:
	...
	static jni::ref<java::util::concurrent::LinkedTransferQueue> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::LinkedTransferQueue> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
	...
	jboolean tryTransfer(jni::ref<java::lang::Object> e, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"tryTransfer", jboolean>(e, timeout, unit); }
};
