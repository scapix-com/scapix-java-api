...
public:
	...
	jni::ref<java::lang::Object> accumulateAndGet(jni::ref<java::lang::Object> obj, jni::ref<java::lang::Object> x, jni::ref<java::util::function::BinaryOperator> accumulatorFunction) { return call_method<"accumulateAndGet", jni::ref<java::lang::Object>>(obj, x, accumulatorFunction); }
	...
	jni::ref<java::lang::Object> getAndAccumulate(jni::ref<java::lang::Object> obj, jni::ref<java::lang::Object> x, jni::ref<java::util::function::BinaryOperator> accumulatorFunction) { return call_method<"getAndAccumulate", jni::ref<java::lang::Object>>(obj, x, accumulatorFunction); }
	...
	jni::ref<java::lang::Object> getAndUpdate(jni::ref<java::lang::Object> obj, jni::ref<java::util::function::UnaryOperator> updateFunction) { return call_method<"getAndUpdate", jni::ref<java::lang::Object>>(obj, updateFunction); }
	...
	jni::ref<java::lang::Object> updateAndGet(jni::ref<java::lang::Object> obj, jni::ref<java::util::function::UnaryOperator> updateFunction) { return call_method<"updateAndGet", jni::ref<java::lang::Object>>(obj, updateFunction); }
