...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_BROKENBARRIEREXCEPTION
...
public:
	...
	static jni::ref<java::util::concurrent::BrokenBarrierException> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::BrokenBarrierException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
