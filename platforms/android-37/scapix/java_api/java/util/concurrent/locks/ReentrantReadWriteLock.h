...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LOCKS_REENTRANTREADWRITELOCK
...
public:
	...
	static jni::ref<java::util::concurrent::locks::ReentrantReadWriteLock> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::locks::ReentrantReadWriteLock> new_object(jboolean fair) { return object_base::new_object(fair); }
