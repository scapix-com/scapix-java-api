...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::CopyOnWriteArrayList>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::List, scapix::java_api::java::util::RandomAccess, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST
...
public:
	...
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object(jni::ref<jni::array<java::lang::Object>> toCopyIn) { return object_base::new_object(toCopyIn); }
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
