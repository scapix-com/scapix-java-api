...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COMPLETIONEXCEPTION
...
public:
	...
	static jni::ref<java::util::concurrent::CompletionException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
	static jni::ref<java::util::concurrent::CompletionException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
};
