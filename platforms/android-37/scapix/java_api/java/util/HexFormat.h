...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_HEXFORMAT
...
public:
	...
	jni::ref<java::lang::String> toHexDigits(jlong value, jint digits) { return call_method<"toHexDigits", jni::ref<java::lang::String>>(value, digits); }
