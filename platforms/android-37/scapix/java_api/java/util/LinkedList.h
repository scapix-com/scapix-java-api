...
struct scapix::jni::object_traits<scapix::java_api::java::util::LinkedList>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractSequentialList, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::Deque, scapix::java_api::java::util::List, scapix::java_api::java::io::Serializable>;
};
...
public:
	...
	static jni::ref<java::util::LinkedList> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
