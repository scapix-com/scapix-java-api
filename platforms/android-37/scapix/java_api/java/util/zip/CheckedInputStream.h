...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_CHECKEDINPUTSTREAM
...
public:
	...
	static jni::ref<java::util::zip::CheckedInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<java::util::zip::Checksum> cksum) { return object_base::new_object(in, cksum); }
