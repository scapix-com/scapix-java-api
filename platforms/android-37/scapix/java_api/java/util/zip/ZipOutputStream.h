...
public:
	...
	static jni::ref<java::util::zip::ZipOutputStream> new_object(jni::ref<java::io::OutputStream> out) { return object_base::new_object(out); }
	static jni::ref<java::util::zip::ZipOutputStream> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(out, charset); }
