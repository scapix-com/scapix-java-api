...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_FUNCTION_DOUBLEUNARYOPERATOR
...
public:
	...
	jni::ref<java::util::function::DoubleUnaryOperator> andThen(jni::ref<java::util::function::DoubleUnaryOperator> after) { return call_method<"andThen", jni::ref<java::util::function::DoubleUnaryOperator>>(after); }
	jdouble applyAsDouble(jdouble p1) { return call_method<"applyAsDouble", jdouble>(p1); }
	jni::ref<java::util::function::DoubleUnaryOperator> compose(jni::ref<java::util::function::DoubleUnaryOperator> before) { return call_method<"compose", jni::ref<java::util::function::DoubleUnaryOperator>>(before); }
