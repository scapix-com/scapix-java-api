...
struct scapix::jni::object_traits<scapix::java_api::java::util::HashSet>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractSet, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::io::Serializable, scapix::java_api::java::util::Set>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_HASHSET
...
public:
	...
	static jni::ref<java::util::HashSet> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::HashSet> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::HashSet> new_object(jint initialCapacity, jfloat loadFactor) { return object_base::new_object(initialCapacity, loadFactor); }
	static jni::ref<java::util::HashSet> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
	...
	static jni::ref<java::util::HashSet> newHashSet(jint numElements) { return call_static_method<"newHashSet", jni::ref<java::util::HashSet>>(numElements); }
