...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOGGING_STREAMHANDLER
...
public:
	...
	static jni::ref<java::util::logging::StreamHandler> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::logging::StreamHandler> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::logging::Formatter> formatter) { return object_base::new_object(out, formatter); }
