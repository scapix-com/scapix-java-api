...
struct scapix::jni::object_traits<scapix::java_api::java::util::ArrayList>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractList, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::List, scapix::java_api::java::util::RandomAccess, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ARRAYLIST
...
public:
	...
	static jni::ref<java::util::ArrayList> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::ArrayList> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::ArrayList> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
	...
	void addFirst(jni::ref<java::lang::Object> element) { return call_method<"addFirst", void>(element); }
	void addLast(jni::ref<java::lang::Object> element) { return call_method<"addLast", void>(element); }
