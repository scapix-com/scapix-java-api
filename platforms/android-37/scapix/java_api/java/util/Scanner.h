...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_SCANNER
...
public:
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> source) { return object_base::new_object(source); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> source, jni::ref<java::lang::String> charsetName) { return object_base::new_object(source, charsetName); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> source, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(source, charset); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> source) { return object_base::new_object(source); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> source, jni::ref<java::lang::String> charsetName) { return object_base::new_object(source, charsetName); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> source, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(source, charset); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::lang::Readable> source) { return object_base::new_object(source); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::lang::String> source) { return object_base::new_object(source); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> source) { return object_base::new_object(source); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> source, jni::ref<java::lang::String> charsetName) { return object_base::new_object(source, charsetName); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> source, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(source, charset); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::file::Path> source) { return object_base::new_object(source); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::file::Path> source, jni::ref<java::lang::String> charsetName) { return object_base::new_object(source, charsetName); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::file::Path> source, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(source, charset); }
	void close() { return call_method<"close", void>(); }
	jni::ref<java::util::regex::Pattern> delimiter() { return call_method<"delimiter", jni::ref<java::util::regex::Pattern>>(); }
	jni::ref<java::util::stream::Stream> findAll(jni::ref<java::lang::String> patString) { return call_method<"findAll", jni::ref<java::util::stream::Stream>>(patString); }
	jni::ref<java::util::stream::Stream> findAll(jni::ref<java::util::regex::Pattern> pattern) { return call_method<"findAll", jni::ref<java::util::stream::Stream>>(pattern); }
	...
	jni::ref<java::util::stream::Stream> tokens() { return call_method<"tokens", jni::ref<java::util::stream::Stream>>(); }
