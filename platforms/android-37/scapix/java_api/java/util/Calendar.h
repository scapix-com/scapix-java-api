...
public:
	...
	static jni::ref<java::util::Calendar> getInstance(jni::ref<java::util::Locale> aLocale) { return call_static_method<"getInstance", jni::ref<java::util::Calendar>>(aLocale); }
	static jni::ref<java::util::Calendar> getInstance(jni::ref<java::util::TimeZone> zone) { return call_static_method<"getInstance", jni::ref<java::util::Calendar>>(zone); }
	static jni::ref<java::util::Calendar> getInstance(jni::ref<java::util::TimeZone> zone, jni::ref<java::util::Locale> aLocale) { return call_static_method<"getInstance", jni::ref<java::util::Calendar>>(zone, aLocale); }
	...
	void set(jint year, jint month, jint date, jint hourOfDay, jint minute) { return call_method<"set", void>(year, month, date, hourOfDay, minute); }
	void set(jint year, jint month, jint date, jint hourOfDay, jint minute, jint second) { return call_method<"set", void>(year, month, date, hourOfDay, minute, second); }
	...
	void setTimeZone(jni::ref<java::util::TimeZone> value) { return call_method<"setTimeZone", void>(value); }
