...
struct scapix::jni::object_traits<scapix::java_api::java::util::TreeMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractMap, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::NavigableMap, scapix::java_api::java::io::Serializable>;
};
...
public:
	...
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::SortedMap> m) { return object_base::new_object(m); }
