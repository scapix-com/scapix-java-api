...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_MAP
...
public:
	...
	static jni::ref<java::util::Map> copyOf(jni::ref<java::util::Map> map) { return call_static_method<"copyOf", jni::ref<java::util::Map>>(map); }
