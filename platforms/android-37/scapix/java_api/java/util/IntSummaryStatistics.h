...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_INTSUMMARYSTATISTICS
...
public:
	...
	static jni::ref<java::util::IntSummaryStatistics> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::IntSummaryStatistics> new_object(jlong count, jint min, jint max, jlong sum) { return object_base::new_object(count, min, max, sum); }
