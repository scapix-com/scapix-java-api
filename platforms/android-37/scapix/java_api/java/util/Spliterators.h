...
public:
	...
	static jni::ref<java::util::Spliterator> spliterator(jni::ref<java::util::Iterator> iterator, jlong size, jint characteristics) { return call_static_method<"spliterator", jni::ref<java::util::Spliterator>>(iterator, size, characteristics); }
	static jni::ref<java::util::Spliterator_OfDouble> spliterator(jni::ref<java::util::PrimitiveIterator_OfDouble> iterator, jlong size, jint characteristics) { return call_static_method<"spliterator", jni::ref<java::util::Spliterator_OfDouble>>(iterator, size, characteristics); }
	static jni::ref<java::util::Spliterator_OfInt> spliterator(jni::ref<java::util::PrimitiveIterator_OfInt> iterator, jlong size, jint characteristics) { return call_static_method<"spliterator", jni::ref<java::util::Spliterator_OfInt>>(iterator, size, characteristics); }
	static jni::ref<java::util::Spliterator_OfLong> spliterator(jni::ref<java::util::PrimitiveIterator_OfLong> iterator, jlong size, jint characteristics) { return call_static_method<"spliterator", jni::ref<java::util::Spliterator_OfLong>>(iterator, size, characteristics); }
