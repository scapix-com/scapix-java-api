...
#ifndef SCAPIX_JAVA_API_DALVIK_SYSTEM_DEXFILE
...
public:
	...
	static jni::ref<dalvik::system::DexFile> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<dalvik::system::DexFile> new_object(jni::ref<java::lang::String> fileName) { return object_base::new_object(fileName); }
