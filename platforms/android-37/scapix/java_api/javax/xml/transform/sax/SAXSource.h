...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_TRANSFORM_SAX_SAXSOURCE
...
public:
	...
	static jni::ref<javax::xml::transform::sax::SAXSource> new_object() { return object_base::new_object(); }
	static jni::ref<javax::xml::transform::sax::SAXSource> new_object(jni::ref<org::xml::sax::InputSource> inputSource) { return object_base::new_object(inputSource); }
	static jni::ref<javax::xml::transform::sax::SAXSource> new_object(jni::ref<org::xml::sax::XMLReader> reader, jni::ref<org::xml::sax::InputSource> inputSource) { return object_base::new_object(reader, inputSource); }
