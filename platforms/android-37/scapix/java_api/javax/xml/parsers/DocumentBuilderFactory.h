...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_PARSERS_DOCUMENTBUILDERFACTORY
...
public:
	...
	static jni::ref<javax::xml::parsers::DocumentBuilderFactory> newDefaultInstance() { return call_static_method<"newDefaultInstance", jni::ref<javax::xml::parsers::DocumentBuilderFactory>>(); }
	static jni::ref<javax::xml::parsers::DocumentBuilderFactory> newDefaultNSInstance() { return call_static_method<"newDefaultNSInstance", jni::ref<javax::xml::parsers::DocumentBuilderFactory>>(); }
	...
	static jni::ref<javax::xml::parsers::DocumentBuilderFactory> newInstance(jni::ref<java::lang::String> factoryClassName, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"newInstance", jni::ref<javax::xml::parsers::DocumentBuilderFactory>>(factoryClassName, classLoader); }
	static jni::ref<javax::xml::parsers::DocumentBuilderFactory> newNSInstance() { return call_static_method<"newNSInstance", jni::ref<javax::xml::parsers::DocumentBuilderFactory>>(); }
	static jni::ref<javax::xml::parsers::DocumentBuilderFactory> newNSInstance(jni::ref<java::lang::String> factoryClassName, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"newNSInstance", jni::ref<javax::xml::parsers::DocumentBuilderFactory>>(factoryClassName, classLoader); }
	void setAttribute(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return call_method<"setAttribute", void>(p1, p2); }
	void setCoalescing(jboolean coalescing) { return call_method<"setCoalescing", void>(coalescing); }
	void setExpandEntityReferences(jboolean expandEntityRef) { return call_method<"setExpandEntityReferences", void>(expandEntityRef); }
	void setFeature(jni::ref<java::lang::String> p1, jboolean p2) { return call_method<"setFeature", void>(p1, p2); }
	void setIgnoringComments(jboolean ignoreComments) { return call_method<"setIgnoringComments", void>(ignoreComments); }
	void setIgnoringElementContentWhitespace(jboolean whitespace) { return call_method<"setIgnoringElementContentWhitespace", void>(whitespace); }
