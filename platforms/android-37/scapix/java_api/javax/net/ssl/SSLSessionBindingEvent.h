...
#ifndef SCAPIX_JAVA_API_JAVAX_NET_SSL_SSLSESSIONBINDINGEVENT
...
public:
	...
	static jni::ref<javax::net::ssl::SSLSessionBindingEvent> new_object(jni::ref<javax::net::ssl::SSLSession> session, jni::ref<java::lang::String> name) { return object_base::new_object(session, name); }
