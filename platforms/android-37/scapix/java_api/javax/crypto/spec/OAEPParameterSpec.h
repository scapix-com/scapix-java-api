...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_OAEPPARAMETERSPEC
...
public:
	...
	static jni::ref<javax::crypto::spec::OAEPParameterSpec> new_object(jni::ref<java::lang::String> mdName, jni::ref<java::lang::String> mgfName, jni::ref<java::security::spec::AlgorithmParameterSpec> mgfSpec, jni::ref<javax::crypto::spec::PSource> pSrc) { return object_base::new_object(mdName, mgfName, mgfSpec, pSrc); }
