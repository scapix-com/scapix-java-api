...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_DESKEYSPEC
...
public:
	...
	static jni::ref<javax::crypto::spec::DESKeySpec> new_object(jni::ref<jni::array<jbyte>> key) { return object_base::new_object(key); }
	static jni::ref<javax::crypto::spec::DESKeySpec> new_object(jni::ref<jni::array<jbyte>> key, jint offset) { return object_base::new_object(key, offset); }
