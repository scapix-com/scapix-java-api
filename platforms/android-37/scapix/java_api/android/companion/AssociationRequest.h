...
#ifndef SCAPIX_JAVA_API_ANDROID_COMPANION_ASSOCIATIONREQUEST
...
public:
	...
	static jni::ref<java::lang::String> DEVICE_PROFILE_FITNESS_TRACKER() { return get_static_field<"DEVICE_PROFILE_FITNESS_TRACKER", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DEVICE_PROFILE_MEDICAL() { return get_static_field<"DEVICE_PROFILE_MEDICAL", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> PERMISSION_GROUP_NEARBY() { return get_static_field<"PERMISSION_GROUP_NEARBY", jni::ref<java::lang::String>>(); }

	jint describeContents() { return call_method<"describeContents", jint>(); }
	jboolean equals(jni::ref<java::lang::Object> o) { return call_method<"equals", jboolean>(o); }
	jni::ref<android::graphics::drawable::Icon> getDeviceIcon() { return call_method<"getDeviceIcon", jni::ref<android::graphics::drawable::Icon>>(); }
	...
	jni::ref<java::util::Set> getExtraPermissions() { return call_method<"getExtraPermissions", jni::ref<java::util::Set>>(); }
	jboolean isForceConfirmation() { return call_method<"isForceConfirmation", jboolean>(); }
	jboolean isRemoteAiAgentSupported() { return call_method<"isRemoteAiAgentSupported", jboolean>(); }
