...
#ifndef SCAPIX_JAVA_API_ANDROID_COMPANION_COMPANIONDEVICEMANAGER
...
public:
	...
	static jint FLAG_AIRPLANE_MODE() { return get_static_field<"FLAG_AIRPLANE_MODE", jint>(); }
	static jint FLAG_CALL_METADATA() { return get_static_field<"FLAG_CALL_METADATA", jint>(); }
	static jint FLAG_TASK_CONTINUITY() { return get_static_field<"FLAG_TASK_CONTINUITY", jint>(); }
	static jint FLAG_UNIVERSAL_MODES() { return get_static_field<"FLAG_UNIVERSAL_MODES", jint>(); }
	...
	jni::ref<android::companion::DeviceId> createAndSetDeviceId(jint associationId, jni::ref<android::companion::DeviceId> deviceId) { return call_method<"createAndSetDeviceId", jni::ref<android::companion::DeviceId>>(associationId, deviceId); }
	...
	jboolean isSystemDataTransportAttached(jint associationId) { return call_method<"isSystemDataTransportAttached", jboolean>(associationId); }
	void notifyActionResult(jint associationId, jni::ref<android::companion::ActionResult> result) { return call_method<"notifyActionResult", void>(associationId, result); }
