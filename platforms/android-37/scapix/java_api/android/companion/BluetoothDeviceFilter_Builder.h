...
class BluetoothDeviceFilter_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_COMPANION_BLUETOOTHDEVICEFILTER_BUILDER
...
public:
	...
	static jni::ref<android::companion::BluetoothDeviceFilter_Builder> new_object() { return object_base::new_object(); }
