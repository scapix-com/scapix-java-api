...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_BUILD_VERSION_CODES_FULL_FWD
#define SCAPIX_JAVA_API_ANDROID_OS_BUILD_VERSION_CODES_FULL_FWD
...
class Build_VERSION_CODES_FULL;

} // namespace android::os
} // namespace scapix::java_api

template<>
struct scapix::jni::object_traits<scapix::java_api::android::os::Build_VERSION_CODES_FULL>
{
	static constexpr fixed_string class_name = "android/os/Build$VERSION_CODES_FULL";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ANDROID_OS_BUILD_VERSION_CODES_FULL_FWD

#ifndef SCAPIX_JAVA_API_FWD
#ifndef SCAPIX_JAVA_API_ANDROID_OS_BUILD_VERSION_CODES_FULL
#define SCAPIX_JAVA_API_ANDROID_OS_BUILD_VERSION_CODES_FULL

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class android::os::Build_VERSION_CODES_FULL : public jni::object_base<"android/os/Build$VERSION_CODES_FULL",
	java::lang::Object>
{
public:

	static jint BAKLAVA() { return get_static_field<"BAKLAVA", jint>(); }
	static jint BAKLAVA_1() { return get_static_field<"BAKLAVA_1", jint>(); }
	static jint BASE() { return get_static_field<"BASE", jint>(); }
	static jint BASE_1_1() { return get_static_field<"BASE_1_1", jint>(); }
	static jint CINNAMON_BUN() { return get_static_field<"CINNAMON_BUN", jint>(); }
	...
	static jint Q() { return get_static_field<"Q", jint>(); }
	static jint R() { return get_static_field<"R", jint>(); }
	static jint S() { return get_static_field<"S", jint>(); }
	static jint S_V2() { return get_static_field<"S_V2", jint>(); }
	static jint TIRAMISU() { return get_static_field<"TIRAMISU", jint>(); }
	static jint UPSIDE_DOWN_CAKE() { return get_static_field<"UPSIDE_DOWN_CAKE", jint>(); }
	static jint VANILLA_ICE_CREAM() { return get_static_field<"VANILLA_ICE_CREAM", jint>(); }
};
...
#endif // SCAPIX_JAVA_API_ANDROID_OS_BUILD_VERSION_CODES_FULL
