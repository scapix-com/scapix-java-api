...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_TOKENWATCHER
...
public:
	...
	static jni::ref<android::os::TokenWatcher> new_object(jni::ref<android::os::Handler> h, jni::ref<java::lang::String> tag) { return object_base::new_object(h, tag); }
