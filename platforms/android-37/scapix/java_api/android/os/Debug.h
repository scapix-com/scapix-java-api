...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_DEBUG
...
public:
	...
	static void attachJvmtiAgent(jni::ref<java::lang::String> library, jni::ref<java::lang::String> options, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"attachJvmtiAgent", void>(library, options, classLoader); }
	...
	static jlong getInstanceCount(jni::ref<java::lang::Class> cls) { return call_static_method<"getInstanceCount", jlong>(cls); }
	static jlong getInstanceCount(jni::ref<java::lang::Class> cls, jboolean includeAssignable) { return call_static_method<"getInstanceCount", jlong>(cls, includeAssignable); }
	static jni::ref<jni::array<jlong>> getInstanceCounts(jni::ref<java::util::List> classes) { return call_static_method<"getInstanceCounts", jni::ref<jni::array<jlong>>>(classes); }
	static jni::ref<jni::array<jlong>> getInstanceCounts(jni::ref<java::util::List> classes, jboolean includeAssignable) { return call_static_method<"getInstanceCounts", jni::ref<jni::array<jlong>>>(classes, includeAssignable); }
	...
	static jlong getRss() { return call_static_method<"getRss", jlong>(); }
