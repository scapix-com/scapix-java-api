...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_IBINDER
#define SCAPIX_JAVA_API_ANDROID_OS_IBINDER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/os/IBinder_DeathRecipient.h>
#include <scapix/java_api/android/os/IBinder_FrozenStateChangeCallback.h>
...
public:
	...
	using FrozenStateChangeCallback = IBinder_FrozenStateChangeCallback;
	...
	void addFrozenStateChangeCallback(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::IBinder_FrozenStateChangeCallback> callback) { return call_method<"addFrozenStateChangeCallback", void>(executor, callback); }
	...
	jboolean removeFrozenStateChangeCallback(jni::ref<android::os::IBinder_FrozenStateChangeCallback> callback) { return call_method<"removeFrozenStateChangeCallback", jboolean>(callback); }
