...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_HEALTH_TIMERSTAT
...
public:
	...
	static jni::ref<android::os::health::TimerStat> new_object() { return object_base::new_object(); }
	static jni::ref<android::os::health::TimerStat> new_object(jni::ref<android::os::Parcel> in) { return object_base::new_object(in); }
	static jni::ref<android::os::health::TimerStat> new_object(jint count, jlong time) { return object_base::new_object(count, time); }
