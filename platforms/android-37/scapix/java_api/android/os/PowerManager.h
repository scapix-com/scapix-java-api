...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_POWERMANAGER
#define SCAPIX_JAVA_API_ANDROID_OS_POWERMANAGER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/os/PowerManager_OnThermalHeadroomChangedListener.h>
...
public:
	...
	using WakeLockStateListener = PowerManager_WakeLockStateListener;
	using WakeLock = PowerManager_WakeLock;
	using OnThermalStatusChangedListener = PowerManager_OnThermalStatusChangedListener;
	using OnThermalHeadroomChangedListener = PowerManager_OnThermalHeadroomChangedListener;
	...
	static jni::ref<java::lang::String> ACTION_DEVICE_LIGHT_IDLE_MODE_CHANGED() { return get_static_field<"ACTION_DEVICE_LIGHT_IDLE_MODE_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_LOW_POWER_STANDBY_ENABLED_CHANGED() { return get_static_field<"ACTION_LOW_POWER_STANDBY_ENABLED_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_LOW_POWER_STANDBY_POLICY_CHANGED() { return get_static_field<"ACTION_LOW_POWER_STANDBY_POLICY_CHANGED", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_WAKE_ON_LAN_IN_LOW_POWER_STANDBY() { return get_static_field<"FEATURE_WAKE_ON_LAN_IN_LOW_POWER_STANDBY", jni::ref<java::lang::String>>(); }
	...
	static jint LOW_POWER_STANDBY_ALLOWED_REASON_ONGOING_CALL() { return get_static_field<"LOW_POWER_STANDBY_ALLOWED_REASON_ONGOING_CALL", jint>(); }
	static jint LOW_POWER_STANDBY_ALLOWED_REASON_TEMP_POWER_SAVE_ALLOWLIST() { return get_static_field<"LOW_POWER_STANDBY_ALLOWED_REASON_TEMP_POWER_SAVE_ALLOWLIST", jint>(); }
	static jint LOW_POWER_STANDBY_ALLOWED_REASON_VOICE_INTERACTION() { return get_static_field<"LOW_POWER_STANDBY_ALLOWED_REASON_VOICE_INTERACTION", jint>(); }
	...
	void addThermalHeadroomListener(jni::ref<android::os::PowerManager_OnThermalHeadroomChangedListener> listener) { return call_method<"addThermalHeadroomListener", void>(listener); }
	void addThermalHeadroomListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::PowerManager_OnThermalHeadroomChangedListener> listener) { return call_method<"addThermalHeadroomListener", void>(executor, listener); }
	...
	jni::ref<java::time::Duration> getBatteryDischargePrediction() { return call_method<"getBatteryDischargePrediction", jni::ref<java::time::Duration>>(); }
	...
	jfloat getThermalHeadroom(jint forecastSeconds) { return call_method<"getThermalHeadroom", jfloat>(forecastSeconds); }
	jni::ref<java::util::Map> getThermalHeadroomThresholds() { return call_method<"getThermalHeadroomThresholds", jni::ref<java::util::Map>>(); }
	jboolean isAllowedInLowPowerStandby(jint reason) { return call_method<"isAllowedInLowPowerStandby", jboolean>(reason); }
	jboolean isAllowedInLowPowerStandby(jni::ref<java::lang::String> feature) { return call_method<"isAllowedInLowPowerStandby", jboolean>(feature); }
	jboolean isBatteryDischargePredictionPersonalized() { return call_method<"isBatteryDischargePredictionPersonalized", jboolean>(); }
	jboolean isDeviceIdleMode() { return call_method<"isDeviceIdleMode", jboolean>(); }
	jboolean isDeviceLightIdleMode() { return call_method<"isDeviceLightIdleMode", jboolean>(); }
	jboolean isExemptFromLowPowerStandby() { return call_method<"isExemptFromLowPowerStandby", jboolean>(); }
	...
	jboolean isLowPowerStandbyEnabled() { return call_method<"isLowPowerStandbyEnabled", jboolean>(); }
	jboolean isPowerSaveMode() { return call_method<"isPowerSaveMode", jboolean>(); }
	jboolean isRebootingUserspaceSupported() { return call_method<"isRebootingUserspaceSupported", jboolean>(); }
	...
	void removeThermalHeadroomListener(jni::ref<android::os::PowerManager_OnThermalHeadroomChangedListener> listener) { return call_method<"removeThermalHeadroomListener", void>(listener); }
