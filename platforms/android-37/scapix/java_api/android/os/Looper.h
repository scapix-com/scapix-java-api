...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_LOOPER
...
public:
	...
	jni::ref<android::os::MessageQueue> getQueue() { return call_method<"getQueue", jni::ref<android::os::MessageQueue>>(); }
	jni::ref<java::lang::Thread> getThread() { return call_method<"getThread", jni::ref<java::lang::Thread>>(); }
	jboolean isCurrentThread() { return call_method<"isCurrentThread", jboolean>(); }
