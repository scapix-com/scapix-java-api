...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_PROCESS
...
public:
	...
	static jint INVALID_PID() { return get_static_field<"INVALID_PID", jint>(); }
	...
	static jni::ref<android::os::Process> new_object() { return object_base::new_object(); }
	static jint getAppUidForSdkSandboxUid(jint uid) { return call_static_method<"getAppUidForSdkSandboxUid", jint>(uid); }
	...
	static jint getSdkSandboxUidForAppUid(jint uid) { return call_static_method<"getSdkSandboxUidForAppUid", jint>(uid); }
	static jlong getStartElapsedRealtime() { return call_static_method<"getStartElapsedRealtime", jlong>(); }
	static jlong getStartRequestedElapsedRealtime() { return call_static_method<"getStartRequestedElapsedRealtime", jlong>(); }
	static jlong getStartRequestedUptimeMillis() { return call_static_method<"getStartRequestedUptimeMillis", jlong>(); }
	...
	static jboolean isIsolatedUid(jint uid) { return call_static_method<"isIsolatedUid", jboolean>(uid); }
	static jboolean isPrivateComputeCoreUid(jint uid) { return call_static_method<"isPrivateComputeCoreUid", jboolean>(uid); }
	static jboolean isSdkSandbox() { return call_static_method<"isSdkSandbox", jboolean>(); }
	static jboolean isSdkSandboxUid(jint uid) { return call_static_method<"isSdkSandboxUid", jboolean>(uid); }
	...
	static jni::ref<java::lang::String> myProcessName() { return call_static_method<"myProcessName", jni::ref<java::lang::String>>(); }
	...
	static void setThreadPriority(jint priority) { return call_static_method<"setThreadPriority", void>(priority); }
	static void setThreadPriority(jint tid, jint priority) { return call_static_method<"setThreadPriority", void>(tid, priority); }
