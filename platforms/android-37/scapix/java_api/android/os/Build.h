...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_BUILD
#define SCAPIX_JAVA_API_ANDROID_OS_BUILD

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/java/lang/String.h>
#include <scapix/java_api/java/util/List.h>
#include <scapix/java_api/android/os/Build_VERSION_CODES_FULL.h>
...
public:
	...
	using VERSION_CODES_FULL = Build_VERSION_CODES_FULL;
	using VERSION_CODES = Build_VERSION_CODES;
	using VERSION = Build_VERSION;
	using Partition = Build_Partition;

	static jint BACKPORTED_FIX_STATUS_FIXED() { return get_static_field<"BACKPORTED_FIX_STATUS_FIXED", jint>(); }
	static jint BACKPORTED_FIX_STATUS_NOT_APPLICABLE() { return get_static_field<"BACKPORTED_FIX_STATUS_NOT_APPLICABLE", jint>(); }
	static jint BACKPORTED_FIX_STATUS_NOT_FIXED() { return get_static_field<"BACKPORTED_FIX_STATUS_NOT_FIXED", jint>(); }
	static jint BACKPORTED_FIX_STATUS_UNKNOWN() { return get_static_field<"BACKPORTED_FIX_STATUS_UNKNOWN", jint>(); }
	...
	static jni::ref<java::lang::String> STRONGBOX_MANUFACTURER() { return get_static_field<"STRONGBOX_MANUFACTURER", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> STRONGBOX_MODEL() { return get_static_field<"STRONGBOX_MODEL", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::os::Build> new_object() { return object_base::new_object(); }
	static jint getBackportedFixStatus(jlong id) { return call_static_method<"getBackportedFixStatus", jint>(id); }
	...
	static jint getMajorSdkVersion(jint sdkIntFull) { return call_static_method<"getMajorSdkVersion", jint>(sdkIntFull); }
	static jint getMinorSdkVersion(jint sdkIntFull) { return call_static_method<"getMinorSdkVersion", jint>(sdkIntFull); }
