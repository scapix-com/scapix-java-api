...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_PARCEL
...
public:
	...
	void marshall(jni::ref<java::nio::ByteBuffer> buffer) { return call_method<"marshall", void>(buffer); }
	...
	void unmarshall(jni::ref<java::nio::ByteBuffer> buffer) { return call_method<"unmarshall", void>(buffer); }
