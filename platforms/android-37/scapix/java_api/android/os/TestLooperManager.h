...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_TESTLOOPERMANAGER
...
public:
	...
	jboolean isBlockedOnSyncBarrier() { return call_method<"isBlockedOnSyncBarrier", jboolean>(); }
	jni::ref<android::os::Message> next() { return call_method<"next", jni::ref<android::os::Message>>(); }
	jni::ref<java::lang::Long> peekWhen() { return call_method<"peekWhen", jni::ref<java::lang::Long>>(); }
	jni::ref<android::os::Message> poll() { return call_method<"poll", jni::ref<android::os::Message>>(); }
