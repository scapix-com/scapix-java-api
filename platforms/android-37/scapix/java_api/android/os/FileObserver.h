...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_FILEOBSERVER
...
public:
	...
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::io::File> file, jint mask) { return object_base::new_object(file, mask); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::lang::String> path) { return object_base::new_object(path); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::lang::String> path, jint mask) { return object_base::new_object(path, mask); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::util::List> files) { return object_base::new_object(files); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::util::List> files, jint mask) { return object_base::new_object(files, mask); }
