...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_USERMANAGER
...
public:
	...
	static jni::ref<java::lang::String> DISALLOW_ADD_PRIVATE_PROFILE() { return get_static_field<"DISALLOW_ADD_PRIVATE_PROFILE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_ASSIST_CONTENT() { return get_static_field<"DISALLOW_ASSIST_CONTENT", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_CELLULAR_2G() { return get_static_field<"DISALLOW_CELLULAR_2G", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DISALLOW_CHANGE_NEAR_FIELD_COMMUNICATION_RADIO() { return get_static_field<"DISALLOW_CHANGE_NEAR_FIELD_COMMUNICATION_RADIO", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_CONFIG_DEFAULT_APPS() { return get_static_field<"DISALLOW_CONFIG_DEFAULT_APPS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_GRANT_ADMIN() { return get_static_field<"DISALLOW_GRANT_ADMIN", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_NEAR_FIELD_COMMUNICATION_RADIO() { return get_static_field<"DISALLOW_NEAR_FIELD_COMMUNICATION_RADIO", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_SIM_GLOBALLY() { return get_static_field<"DISALLOW_SIM_GLOBALLY", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISALLOW_TASK_CONTINUITY_HANDOFF() { return get_static_field<"DISALLOW_TASK_CONTINUITY_HANDOFF", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DISALLOW_THREAD_NETWORK() { return get_static_field<"DISALLOW_THREAD_NETWORK", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DISALLOW_ULTRA_WIDEBAND_RADIO() { return get_static_field<"DISALLOW_ULTRA_WIDEBAND_RADIO", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> USER_TYPE_PROFILE_CLONE() { return get_static_field<"USER_TYPE_PROFILE_CLONE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> USER_TYPE_PROFILE_MANAGED() { return get_static_field<"USER_TYPE_PROFILE_MANAGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> USER_TYPE_PROFILE_PRIVATE() { return get_static_field<"USER_TYPE_PROFILE_PRIVATE", jni::ref<java::lang::String>>(); }
	...
	jboolean isAdminUser() { return call_method<"isAdminUser", jboolean>(); }
