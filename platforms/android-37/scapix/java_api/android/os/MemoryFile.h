...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_MEMORYFILE
...
public:
	...
	static jni::ref<android::os::MemoryFile> new_object(jni::ref<java::lang::String> name, jint length) { return object_base::new_object(name, length); }
