...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_VIBRATIONEFFECT_COMPOSITION
...
public:
	...
	static jint DELAY_TYPE_PAUSE() { return get_static_field<"DELAY_TYPE_PAUSE", jint>(); }
	static jint DELAY_TYPE_RELATIVE_START_OFFSET() { return get_static_field<"DELAY_TYPE_RELATIVE_START_OFFSET", jint>(); }
	static jint PRIMITIVE_CLICK() { return get_static_field<"PRIMITIVE_CLICK", jint>(); }
	static jint PRIMITIVE_LOW_TICK() { return get_static_field<"PRIMITIVE_LOW_TICK", jint>(); }
	...
	static jint PRIMITIVE_SPIN() { return get_static_field<"PRIMITIVE_SPIN", jint>(); }
	static jint PRIMITIVE_THUD() { return get_static_field<"PRIMITIVE_THUD", jint>(); }
	...
	jni::ref<android::os::VibrationEffect_Composition> addPrimitive(jint primitiveId, jfloat scale, jint delay, jint delayType) { return call_method<"addPrimitive", jni::ref<android::os::VibrationEffect_Composition>>(primitiveId, scale, delay, delayType); }
