...
#ifndef SCAPIX_JAVA_API_ANDROID_APPWIDGET_APPWIDGETPROVIDERINFO
...
public:
	...
	static jint WIDGET_CATEGORY_NOT_KEYGUARD() { return get_static_field<"WIDGET_CATEGORY_NOT_KEYGUARD", jint>(); }
	...
	jint generatedPreviewCategories() { return get_field<"generatedPreviewCategories", jint>(); }
	void generatedPreviewCategories(jint v) { set_field<"generatedPreviewCategories", jint>(v); }
	...
	static jni::ref<android::appwidget::AppWidgetProviderInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::appwidget::AppWidgetProviderInfo> new_object(jni::ref<android::os::Parcel> in) { return object_base::new_object(in); }
