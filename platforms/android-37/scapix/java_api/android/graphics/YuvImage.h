...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_YUVIMAGE
...
public:
	...
	static jni::ref<android::graphics::YuvImage> new_object(jni::ref<jni::array<jbyte>> yuv, jint format, jint width, jint height, jni::ref<jni::array<jint>> strides) { return object_base::new_object(yuv, format, width, height, strides); }
	static jni::ref<android::graphics::YuvImage> new_object(jni::ref<jni::array<jbyte>> yuv, jint format, jint width, jint height, jni::ref<jni::array<jint>> strides, jni::ref<android::graphics::ColorSpace> colorSpace) { return object_base::new_object(yuv, format, width, height, strides, colorSpace); }
