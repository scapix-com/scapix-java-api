...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_PATH
...
#include <scapix/java_api/android/graphics/PathIterator.h>
...
public:
	...
	static jni::ref<android::graphics::Path> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::Path> new_object(jni::ref<android::graphics::Path> src) { return object_base::new_object(src); }
	...
	jni::ref<jni::array<jfloat>> approximate(jfloat acceptableError) { return call_method<"approximate", jni::ref<jni::array<jfloat>>>(acceptableError); }
	...
	void computeBounds(jni::ref<android::graphics::RectF> bounds) { return call_method<"computeBounds", void>(bounds); }
	...
	void conicTo(jfloat x1, jfloat y1, jfloat x2, jfloat y2, jfloat weight) { return call_method<"conicTo", void>(x1, y1, x2, y2, weight); }
	...
	jni::ref<android::graphics::PathIterator> getPathIterator() { return call_method<"getPathIterator", jni::ref<android::graphics::PathIterator>>(); }
	void incReserve(jint extraPtCount) { return call_method<"incReserve", void>(extraPtCount); }
	jboolean interpolate(jni::ref<android::graphics::Path> otherPath, jfloat t, jni::ref<android::graphics::Path> interpolatedPath) { return call_method<"interpolate", jboolean>(otherPath, t, interpolatedPath); }
	jboolean isConvex() { return call_method<"isConvex", jboolean>(); }
	jboolean isEmpty() { return call_method<"isEmpty", jboolean>(); }
	jboolean isInterpolatable(jni::ref<android::graphics::Path> otherPath) { return call_method<"isInterpolatable", jboolean>(otherPath); }
	...
	void rConicTo(jfloat dx1, jfloat dy1, jfloat dx2, jfloat dy2, jfloat weight) { return call_method<"rConicTo", void>(dx1, dy1, dx2, dy2, weight); }
