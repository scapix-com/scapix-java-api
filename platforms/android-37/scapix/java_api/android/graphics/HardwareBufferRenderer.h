...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_HARDWAREBUFFERRENDERER
...
public:
	...
	static jni::ref<android::graphics::HardwareBufferRenderer> new_object(jni::ref<android::hardware::HardwareBuffer> buffer) { return object_base::new_object(buffer); }
