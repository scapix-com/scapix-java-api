...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_PAINT
...
public:
	...
	static jint CURSOR_AFTER() { return get_static_field<"CURSOR_AFTER", jint>(); }
	static jint CURSOR_AT() { return get_static_field<"CURSOR_AT", jint>(); }
	static jint CURSOR_AT_OR_AFTER() { return get_static_field<"CURSOR_AT_OR_AFTER", jint>(); }
	static jint CURSOR_AT_OR_BEFORE() { return get_static_field<"CURSOR_AT_OR_BEFORE", jint>(); }
	static jint CURSOR_BEFORE() { return get_static_field<"CURSOR_BEFORE", jint>(); }
	...
	static jint END_HYPHEN_EDIT_INSERT_ARMENIAN_HYPHEN() { return get_static_field<"END_HYPHEN_EDIT_INSERT_ARMENIAN_HYPHEN", jint>(); }
	static jint END_HYPHEN_EDIT_INSERT_HYPHEN() { return get_static_field<"END_HYPHEN_EDIT_INSERT_HYPHEN", jint>(); }
	static jint END_HYPHEN_EDIT_INSERT_MAQAF() { return get_static_field<"END_HYPHEN_EDIT_INSERT_MAQAF", jint>(); }
	static jint END_HYPHEN_EDIT_INSERT_UCAS_HYPHEN() { return get_static_field<"END_HYPHEN_EDIT_INSERT_UCAS_HYPHEN", jint>(); }
	static jint END_HYPHEN_EDIT_INSERT_ZWJ_AND_HYPHEN() { return get_static_field<"END_HYPHEN_EDIT_INSERT_ZWJ_AND_HYPHEN", jint>(); }
	static jint END_HYPHEN_EDIT_NO_EDIT() { return get_static_field<"END_HYPHEN_EDIT_NO_EDIT", jint>(); }
	static jint END_HYPHEN_EDIT_REPLACE_WITH_HYPHEN() { return get_static_field<"END_HYPHEN_EDIT_REPLACE_WITH_HYPHEN", jint>(); }
	...
	static jint START_HYPHEN_EDIT_INSERT_HYPHEN() { return get_static_field<"START_HYPHEN_EDIT_INSERT_HYPHEN", jint>(); }
	static jint START_HYPHEN_EDIT_INSERT_ZWJ() { return get_static_field<"START_HYPHEN_EDIT_INSERT_ZWJ", jint>(); }
	static jint START_HYPHEN_EDIT_NO_EDIT() { return get_static_field<"START_HYPHEN_EDIT_NO_EDIT", jint>(); }
	...
	static jint TEXT_RUN_FLAG_LEFT_EDGE() { return get_static_field<"TEXT_RUN_FLAG_LEFT_EDGE", jint>(); }
	static jint TEXT_RUN_FLAG_RIGHT_EDGE() { return get_static_field<"TEXT_RUN_FLAG_RIGHT_EDGE", jint>(); }
	static jint UNDERLINE_TEXT_FLAG() { return get_static_field<"UNDERLINE_TEXT_FLAG", jint>(); }
	static jint VERTICAL_TEXT_FLAG() { return get_static_field<"VERTICAL_TEXT_FLAG", jint>(); }

	static jni::ref<android::graphics::Paint> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::Paint> new_object(jni::ref<android::graphics::Paint> paint) { return object_base::new_object(paint); }
	static jni::ref<android::graphics::Paint> new_object(jint flags) { return object_base::new_object(flags); }
	...
	jboolean equalsForTextMeasurement(jni::ref<android::graphics::Paint> other) { return call_method<"equalsForTextMeasurement", jboolean>(other); }
	...
	jlong getColorLong() { return call_method<"getColorLong", jlong>(); }
	jint getEndHyphenEdit() { return call_method<"getEndHyphenEdit", jint>(); }
	...
	void getFontMetricsForLocale(jni::ref<android::graphics::Paint_FontMetrics> metrics) { return call_method<"getFontMetricsForLocale", void>(metrics); }
	...
	void getFontMetricsInt(jni::ref<jni::array<jchar>> text, jint start, jint count, jint contextStart, jint contextCount, jboolean isRtl, jni::ref<android::graphics::Paint_FontMetricsInt> outMetrics) { return call_method<"getFontMetricsInt", void>(text, start, count, contextStart, contextCount, isRtl, outMetrics); }
	void getFontMetricsInt(jni::ref<java::lang::CharSequence> text, jint start, jint count, jint contextStart, jint contextCount, jboolean isRtl, jni::ref<android::graphics::Paint_FontMetricsInt> outMetrics) { return call_method<"getFontMetricsInt", void>(text, start, count, contextStart, contextCount, isRtl, outMetrics); }
	void getFontMetricsIntForLocale(jni::ref<android::graphics::Paint_FontMetricsInt> metrics) { return call_method<"getFontMetricsIntForLocale", void>(metrics); }
	jfloat getFontSpacing() { return call_method<"getFontSpacing", jfloat>(); }
	jni::ref<java::lang::String> getFontVariationOverride() { return call_method<"getFontVariationOverride", jni::ref<java::lang::String>>(); }
	...
	jfloat getRunCharacterAdvance(jni::ref<jni::array<jchar>> text, jint start, jint end, jint contextStart, jint contextEnd, jboolean isRtl, jint offset, jni::ref<jni::array<jfloat>> advances, jint advancesIndex) { return call_method<"getRunCharacterAdvance", jfloat>(text, start, end, contextStart, contextEnd, isRtl, offset, advances, advancesIndex); }
	jfloat getRunCharacterAdvance(jni::ref<java::lang::CharSequence> text, jint start, jint end, jint contextStart, jint contextEnd, jboolean isRtl, jint offset, jni::ref<jni::array<jfloat>> advances, jint advancesIndex) { return call_method<"getRunCharacterAdvance", jfloat>(text, start, end, contextStart, contextEnd, isRtl, offset, advances, advancesIndex); }
	jni::ref<android::graphics::Shader> getShader() { return call_method<"getShader", jni::ref<android::graphics::Shader>>(); }
	jint getShadowLayerColor() { return call_method<"getShadowLayerColor", jint>(); }
	jlong getShadowLayerColorLong() { return call_method<"getShadowLayerColorLong", jlong>(); }
	jfloat getShadowLayerDx() { return call_method<"getShadowLayerDx", jfloat>(); }
	jfloat getShadowLayerDy() { return call_method<"getShadowLayerDy", jfloat>(); }
	jfloat getShadowLayerRadius() { return call_method<"getShadowLayerRadius", jfloat>(); }
	jint getStartHyphenEdit() { return call_method<"getStartHyphenEdit", jint>(); }
	jfloat getStrikeThruPosition() { return call_method<"getStrikeThruPosition", jfloat>(); }
	jfloat getStrikeThruThickness() { return call_method<"getStrikeThruThickness", jfloat>(); }
	...
	void getTextBounds(jni::ref<java::lang::CharSequence> text, jint start, jint end, jni::ref<android::graphics::Rect> bounds) { return call_method<"getTextBounds", void>(text, start, end, bounds); }
	...
	jfloat getTextRunAdvances(jni::ref<jni::array<jchar>> chars, jint index, jint count, jint contextIndex, jint contextCount, jboolean isRtl, jni::ref<jni::array<jfloat>> advances, jint advancesIndex) { return call_method<"getTextRunAdvances", jfloat>(chars, index, count, contextIndex, contextCount, isRtl, advances, advancesIndex); }
	jint getTextRunCursor(jni::ref<jni::array<jchar>> text, jint contextStart, jint contextLength, jboolean isRtl, jint offset, jint cursorOpt) { return call_method<"getTextRunCursor", jint>(text, contextStart, contextLength, isRtl, offset, cursorOpt); }
	jint getTextRunCursor(jni::ref<java::lang::CharSequence> text, jint contextStart, jint contextEnd, jboolean isRtl, jint offset, jint cursorOpt) { return call_method<"getTextRunCursor", jint>(text, contextStart, contextEnd, isRtl, offset, cursorOpt); }
	...
	jfloat getUnderlinePosition() { return call_method<"getUnderlinePosition", jfloat>(); }
	jfloat getUnderlineThickness() { return call_method<"getUnderlineThickness", jfloat>(); }
	jfloat getWordSpacing() { return call_method<"getWordSpacing", jfloat>(); }
	...
	void setColor(jlong color) { return call_method<"setColor", void>(color); }
	...
	void setEndHyphenEdit(jint endHyphen) { return call_method<"setEndHyphenEdit", void>(endHyphen); }
	...
	void setFontVariationOverride(jni::ref<java::lang::String> fontVariationOverride) { return call_method<"setFontVariationOverride", void>(fontVariationOverride); }
	...
	void setShadowLayer(jfloat radius, jfloat dx, jfloat dy, jlong shadowColor) { return call_method<"setShadowLayer", void>(radius, dx, dy, shadowColor); }
	void setStartHyphenEdit(jint startHyphen) { return call_method<"setStartHyphenEdit", void>(startHyphen); }
	...
	void setWordSpacing(jfloat wordSpacing) { return call_method<"setWordSpacing", void>(wordSpacing); }
