...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_FONTS_FONT_BUILDER
...
public:
	...
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<android::content::res::AssetManager> am, jni::ref<java::lang::String> path) { return object_base::new_object(am, path); }
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<android::content::res::Resources> res, jint resId) { return object_base::new_object(res, resId); }
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<android::graphics::fonts::Font> font) { return object_base::new_object(font); }
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<android::os::ParcelFileDescriptor> fd) { return object_base::new_object(fd); }
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<android::os::ParcelFileDescriptor> fd, jlong offset, jlong size) { return object_base::new_object(fd, offset, size); }
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<java::io::File> path) { return object_base::new_object(path); }
	static jni::ref<android::graphics::fonts::Font_Builder> new_object(jni::ref<java::nio::ByteBuffer> buffer) { return object_base::new_object(buffer); }
