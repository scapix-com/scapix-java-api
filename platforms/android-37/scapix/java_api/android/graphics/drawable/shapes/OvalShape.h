...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_SHAPES_OVALSHAPE
...
public:
	...
	static jni::ref<android::graphics::drawable::shapes::OvalShape> new_object() { return object_base::new_object(); }
