...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_ICON
...
public:
	...
	static jint TYPE_URI_ADAPTIVE_BITMAP() { return get_static_field<"TYPE_URI_ADAPTIVE_BITMAP", jint>(); }
	...
	static jni::ref<android::graphics::drawable::Icon> createWithAdaptiveBitmapContentUri(jni::ref<android::net::Uri> uri) { return call_static_method<"createWithAdaptiveBitmapContentUri", jni::ref<android::graphics::drawable::Icon>>(uri); }
	static jni::ref<android::graphics::drawable::Icon> createWithAdaptiveBitmapContentUri(jni::ref<java::lang::String> uri) { return call_static_method<"createWithAdaptiveBitmapContentUri", jni::ref<android::graphics::drawable::Icon>>(uri); }
