...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_COLORSTATELISTDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::ColorStateListDrawable> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::drawable::ColorStateListDrawable> new_object(jni::ref<android::content::res::ColorStateList> colorStateList) { return object_base::new_object(colorStateList); }
