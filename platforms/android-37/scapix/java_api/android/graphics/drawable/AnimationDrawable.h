...
struct scapix::jni::object_traits<scapix::java_api::android::graphics::drawable::AnimationDrawable>
{
	...
	using base_classes = std::tuple<scapix::java_api::android::graphics::drawable::DrawableContainer, scapix::java_api::android::graphics::drawable::Animatable, scapix::java_api::java::lang::Runnable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_ANIMATIONDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::AnimationDrawable> new_object() { return object_base::new_object(); }
