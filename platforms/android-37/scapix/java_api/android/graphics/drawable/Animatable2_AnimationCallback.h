...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_ANIMATABLE2_ANIMATIONCALLBACK
...
public:
	...
	static jni::ref<android::graphics::drawable::Animatable2_AnimationCallback> new_object() { return object_base::new_object(); }
