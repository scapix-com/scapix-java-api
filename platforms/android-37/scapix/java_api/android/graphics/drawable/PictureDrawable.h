...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_PICTUREDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::PictureDrawable> new_object(jni::ref<android::graphics::Picture> picture) { return object_base::new_object(picture); }
