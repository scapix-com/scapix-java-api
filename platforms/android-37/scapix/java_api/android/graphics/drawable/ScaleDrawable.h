...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_SCALEDRAWABLE
...
public:
	...
	static jni::ref<android::graphics::drawable::ScaleDrawable> new_object(jni::ref<android::graphics::drawable::Drawable> drawable, jint gravity, jfloat scaleWidth, jfloat scaleHeight) { return object_base::new_object(drawable, gravity, scaleWidth, scaleHeight); }
