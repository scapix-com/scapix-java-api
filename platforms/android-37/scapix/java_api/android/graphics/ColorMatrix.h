...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_COLORMATRIX
...
public:
	...
	static jni::ref<android::graphics::ColorMatrix> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::ColorMatrix> new_object(jni::ref<android::graphics::ColorMatrix> src) { return object_base::new_object(src); }
	static jni::ref<android::graphics::ColorMatrix> new_object(jni::ref<jni::array<jfloat>> src) { return object_base::new_object(src); }
