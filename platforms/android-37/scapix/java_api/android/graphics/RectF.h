...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_RECTF
...
public:
	...
	static jni::ref<android::graphics::RectF> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::RectF> new_object(jni::ref<android::graphics::Rect> r) { return object_base::new_object(r); }
	static jni::ref<android::graphics::RectF> new_object(jni::ref<android::graphics::RectF> r) { return object_base::new_object(r); }
	static jni::ref<android::graphics::RectF> new_object(jfloat left, jfloat top, jfloat right, jfloat bottom) { return object_base::new_object(left, top, right, bottom); }
