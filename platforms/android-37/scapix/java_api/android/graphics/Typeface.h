...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_TYPEFACE
...
#include <scapix/java_api/android/graphics/Typeface_CustomFallbackBuilder.h>
...
public:
	...
	using CustomFallbackBuilder = Typeface_CustomFallbackBuilder;
	...
	static jni::ref<android::graphics::Typeface> create(jni::ref<android::graphics::Typeface> family, jint weight, jboolean italic) { return call_static_method<"create", jni::ref<android::graphics::Typeface>>(family, weight, italic); }
	...
	static jni::ref<android::graphics::Typeface> createFromFile(jni::ref<java::io::File> file) { return call_static_method<"createFromFile", jni::ref<android::graphics::Typeface>>(file); }
