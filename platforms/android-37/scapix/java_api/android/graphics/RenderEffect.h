...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_RENDEREFFECT
...
#include <scapix/java_api/android/graphics/RuntimeShader.h>
...
public:
	...
	static jni::ref<android::graphics::RenderEffect> createRuntimeShaderEffect(jni::ref<android::graphics::RuntimeShader> shader, jni::ref<java::lang::String> uniformShaderName) { return call_static_method<"createRuntimeShaderEffect", jni::ref<android::graphics::RenderEffect>>(shader, uniformShaderName); }
