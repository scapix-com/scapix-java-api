...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMESHADER
...
public:
	...
	static jni::ref<android::graphics::RuntimeShader> new_object(jni::ref<java::lang::String> shader) { return object_base::new_object(shader); }
	...
	void setWorkingColorSpace(jni::ref<android::graphics::ColorSpace> colorSpace) { return call_method<"setWorkingColorSpace", void>(colorSpace); }
};
