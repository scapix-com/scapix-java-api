...
class Typeface_CustomFallbackBuilder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_TYPEFACE_CUSTOMFALLBACKBUILDER
...
public:
	...
	static jni::ref<android::graphics::Typeface_CustomFallbackBuilder> new_object(jni::ref<android::graphics::fonts::FontFamily> family) { return object_base::new_object(family); }
