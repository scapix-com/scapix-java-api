...
class ChangeLogsResponse_DeletedLog;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_CHANGELOG_CHANGELOGSRESPONSE_DELETEDLOG
...
public:
	...
	static jni::ref<android::health::connect::changelog::ChangeLogsResponse_DeletedLog> new_object(jni::ref<java::lang::String> deletedRecordId, jni::ref<java::time::Instant> deletedTime) { return object_base::new_object(deletedRecordId, deletedTime); }
	static jni::ref<android::health::connect::changelog::ChangeLogsResponse_DeletedLog> new_object(jni::ref<java::lang::String> deletedRecordId, jlong deletedTime) { return object_base::new_object(deletedRecordId, deletedTime); }
