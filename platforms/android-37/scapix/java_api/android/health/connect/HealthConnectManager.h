...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_HEALTHCONNECTMANAGER
...
public:
	...
	static jni::ref<java::lang::String> ACTION_SHOW_ONBOARDING() { return get_static_field<"ACTION_SHOW_ONBOARDING", jni::ref<java::lang::String>>(); }
	...
	jni::ref<android::content::Intent> createMatchmakingIntent(jni::ref<android::health::connect::MatchmakingRequest> request) { return call_method<"createMatchmakingIntent", jni::ref<android::content::Intent>>(request); }
	...
	void getCurrentDeviceDataSource(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::OutcomeReceiver> callback) { return call_method<"getCurrentDeviceDataSource", void>(executor, callback); }
	void getDeviceDataSourceCapabilities(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::OutcomeReceiver> callback) { return call_method<"getDeviceDataSourceCapabilities", void>(executor, callback); }
	void getDeviceDataSources(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::OutcomeReceiver> callback) { return call_method<"getDeviceDataSources", void>(executor, callback); }
	...
	static jni::ref<java::util::Set> getPermissionSensitiveDeviceDataSourceCapabilities() { return call_static_method<"getPermissionSensitiveDeviceDataSourceCapabilities", jni::ref<java::util::Set>>(); }
	...
	void isMatchmakingPossible(jni::ref<android::health::connect::MatchmakingRequest> request, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::OutcomeReceiver> callback) { return call_method<"isMatchmakingPossible", void>(request, executor, callback); }
