...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_DEVICE_BUILDER
...
public:
	...
	static jni::ref<android::health::connect::datatypes::Device_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::health::connect::datatypes::Device_Builder> setDisplayName(jni::ref<java::lang::String> displayName) { return call_method<"setDisplayName", jni::ref<android::health::connect::datatypes::Device_Builder>>(displayName); }
