...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_DEVICE
...
public:
	...
	static jint DEVICE_TYPE_CONSUMER_MEDICAL_DEVICE() { return get_static_field<"DEVICE_TYPE_CONSUMER_MEDICAL_DEVICE", jint>(); }
	static jint DEVICE_TYPE_FITNESS_BAND() { return get_static_field<"DEVICE_TYPE_FITNESS_BAND", jint>(); }
	static jint DEVICE_TYPE_FITNESS_EQUIPMENT() { return get_static_field<"DEVICE_TYPE_FITNESS_EQUIPMENT", jint>(); }
	static jint DEVICE_TYPE_FITNESS_MACHINE() { return get_static_field<"DEVICE_TYPE_FITNESS_MACHINE", jint>(); }
	static jint DEVICE_TYPE_GLASSES() { return get_static_field<"DEVICE_TYPE_GLASSES", jint>(); }
	static jint DEVICE_TYPE_HEAD_MOUNTED() { return get_static_field<"DEVICE_TYPE_HEAD_MOUNTED", jint>(); }
	static jint DEVICE_TYPE_HEARABLE() { return get_static_field<"DEVICE_TYPE_HEARABLE", jint>(); }
	static jint DEVICE_TYPE_METER() { return get_static_field<"DEVICE_TYPE_METER", jint>(); }
	static jint DEVICE_TYPE_PHONE() { return get_static_field<"DEVICE_TYPE_PHONE", jint>(); }
	static jint DEVICE_TYPE_PORTABLE_COMPUTER() { return get_static_field<"DEVICE_TYPE_PORTABLE_COMPUTER", jint>(); }
