...
class ReadRecordsRequestUsingFilters_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_READRECORDSREQUESTUSINGFILTERS_BUILDER
...
public:
	...
	static jni::ref<android::health::connect::ReadRecordsRequestUsingFilters_Builder> new_object(jni::ref<java::lang::Class> recordType) { return object_base::new_object(recordType); }
