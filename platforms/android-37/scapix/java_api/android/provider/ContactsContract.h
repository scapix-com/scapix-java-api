...
#include <scapix/java_api/android/provider/ContactsContract_SimContacts.h>
#include <scapix/java_api/android/provider/ContactsContract_SimAccount.h>
...
public:
	...
	using SimContacts = ContactsContract_SimContacts;
	using SimAccount = ContactsContract_SimAccount;
