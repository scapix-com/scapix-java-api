...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_FONTSCONTRACT_FONTREQUESTCALLBACK
...
public:
	...
	static jni::ref<android::provider::FontsContract_FontRequestCallback> new_object() { return object_base::new_object(); }
