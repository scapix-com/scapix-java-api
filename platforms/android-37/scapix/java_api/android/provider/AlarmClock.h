...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_ALARMCLOCK
...
public:
	...
	static jni::ref<java::lang::String> ACTION_DISMISS_TIMER() { return get_static_field<"ACTION_DISMISS_TIMER", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::AlarmClock> new_object() { return object_base::new_object(); }
};
