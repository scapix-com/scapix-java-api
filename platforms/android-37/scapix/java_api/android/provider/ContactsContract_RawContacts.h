...
class ContactsContract_RawContacts;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CONTACTSCONTRACT_RAWCONTACTS
...
#include <scapix/java_api/android/provider/ContactsContract_RawContacts_DefaultAccount.h>
...
public:
	...
	using DefaultAccount = ContactsContract_RawContacts_DefaultAccount;
	...
	static jni::ref<java::lang::String> getLocalAccountName(jni::ref<android::content::Context> context) { return call_static_method<"getLocalAccountName", jni::ref<java::lang::String>>(context); }
	static jni::ref<java::lang::String> getLocalAccountType(jni::ref<android::content::Context> context) { return call_static_method<"getLocalAccountType", jni::ref<java::lang::String>>(context); }
