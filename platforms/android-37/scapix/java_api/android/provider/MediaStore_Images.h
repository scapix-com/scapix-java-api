...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_IMAGES
...
public:
	...
	static jni::ref<android::provider::MediaStore_Images> new_object() { return object_base::new_object(); }
};
