...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_SETTINGS_SETTINGNOTFOUNDEXCEPTION
...
public:
	...
	static jni::ref<android::provider::Settings_SettingNotFoundException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
