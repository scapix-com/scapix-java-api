...
class MediaStore_Audio_AudioColumns;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_AUDIOCOLUMNS
...
public:
	...
	static jni::ref<java::lang::String> BITS_PER_SAMPLE() { return get_static_field<"BITS_PER_SAMPLE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> IS_RECORDING() { return get_static_field<"IS_RECORDING", jni::ref<java::lang::String>>(); }
