...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CALENDARCONTRACT
...
public:
	...
	static jni::ref<java::lang::String> ACTION_VIEW_MANAGED_PROFILE_CALENDAR_EVENT() { return get_static_field<"ACTION_VIEW_MANAGED_PROFILE_CALENDAR_EVENT", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_EVENT_ID() { return get_static_field<"EXTRA_EVENT_ID", jni::ref<java::lang::String>>(); }

	static jboolean startViewCalendarEventInManagedProfile(jni::ref<android::content::Context> context, jlong eventId, jlong startMs, jlong endMs, jboolean allDay, jint flags) { return call_static_method<"startViewCalendarEventInManagedProfile", jboolean>(context, eventId, startMs, endMs, allDay, flags); }
};
