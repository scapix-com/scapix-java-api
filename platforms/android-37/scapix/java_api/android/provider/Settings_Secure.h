...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_SETTINGS_SECURE
...
public:
	...
	static jni::ref<java::lang::String> RTT_CALLING_MODE() { return get_static_field<"RTT_CALLING_MODE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::Settings_Secure> new_object() { return object_base::new_object(); }
