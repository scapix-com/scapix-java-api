...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_USERDICTIONARY_WORDS
...
public:
	...
	static jni::ref<android::provider::UserDictionary_Words> new_object() { return object_base::new_object(); }
