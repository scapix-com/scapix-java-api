...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CALLLOG_CALLS
...
public:
	...
	static jni::ref<java::lang::String> ASSERTED_DISPLAY_NAME() { return get_static_field<"ASSERTED_DISPLAY_NAME", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::net::Uri> CONTENT_URI_WITH_VOIP_CALLS() { return get_static_field<"CONTENT_URI_WITH_VOIP_CALLS", jni::ref<android::net::Uri>>(); }
	static jni::ref<android::net::Uri> CONTENT_VOIP_URI() { return get_static_field<"CONTENT_VOIP_URI", jni::ref<android::net::Uri>>(); }
	...
	static jint FEATURES_GROUP_CALL() { return get_static_field<"FEATURES_GROUP_CALL", jint>(); }
	static jint FEATURES_HD_CALL() { return get_static_field<"FEATURES_HD_CALL", jint>(); }
	static jint FEATURES_HD_PLUS_CALL() { return get_static_field<"FEATURES_HD_PLUS_CALL", jint>(); }
	...
	static jint FEATURES_VONR() { return get_static_field<"FEATURES_VONR", jint>(); }
	...
	static jni::ref<java::lang::String> INCLUDE_VOIP_CALLS_PARAM_KEY() { return get_static_field<"INCLUDE_VOIP_CALLS_PARAM_KEY", jni::ref<java::lang::String>>(); }
	static jint INCOMING_TYPE() { return get_static_field<"INCOMING_TYPE", jint>(); }
	static jni::ref<java::lang::String> IS_BUSINESS_CALL() { return get_static_field<"IS_BUSINESS_CALL", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> PREFERRED_DISPLAY_NAME() { return get_static_field<"PREFERRED_DISPLAY_NAME", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> UUID() { return get_static_field<"UUID", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::CallLog_Calls> new_object() { return object_base::new_object(); }
