...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_DOCUMENTSPROVIDER
...
public:
	...
	static jni::ref<android::provider::DocumentsProvider> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::database::Cursor> queryTrashDocuments(jni::ref<java::lang::String> rootId, jni::ref<jni::array<java::lang::String>> projection, jni::ref<android::os::Bundle> queryArgs, jni::ref<android::os::CancellationSignal> signal) { return call_method<"queryTrashDocuments", jni::ref<android::database::Cursor>>(rootId, projection, queryArgs, signal); }
	...
	jni::ref<java::lang::String> restoreDocumentFromTrash(jni::ref<java::lang::String> documentId, jni::ref<java::lang::String> targetParentDocumentId) { return call_method<"restoreDocumentFromTrash", jni::ref<java::lang::String>>(documentId, targetParentDocumentId); }
	...
	jni::ref<java::lang::String> trashDocument(jni::ref<java::lang::String> documentId) { return call_method<"trashDocument", jni::ref<java::lang::String>>(documentId); }
