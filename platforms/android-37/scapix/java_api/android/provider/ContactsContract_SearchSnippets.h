...
class ContactsContract_SearchSnippets;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CONTACTSCONTRACT_SEARCHSNIPPETS
...
public:
	...
	static jni::ref<android::provider::ContactsContract_SearchSnippets> new_object() { return object_base::new_object(); }
};
