...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE
...
public:
	...
	static jni::ref<java::lang::String> ACCESS_MEDIA_OWNER_PACKAGE_NAME_PERMISSION() { return get_static_field<"ACCESS_MEDIA_OWNER_PACKAGE_NAME_PERMISSION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACCESS_OEM_METADATA_PERMISSION() { return get_static_field<"ACCESS_OEM_METADATA_PERMISSION", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> ACTION_MOTION_PHOTO_CAPTURE() { return get_static_field<"ACTION_MOTION_PHOTO_CAPTURE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_MOTION_PHOTO_CAPTURE_SECURE() { return get_static_field<"ACTION_MOTION_PHOTO_CAPTURE_SECURE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_PICKER_PRE_SELECTION_URIS() { return get_static_field<"EXTRA_PICKER_PRE_SELECTION_URIS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_ACCENT_COLOR() { return get_static_field<"EXTRA_PICK_IMAGES_ACCENT_COLOR", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_HIGHLIGHT_ALBUM() { return get_static_field<"EXTRA_PICK_IMAGES_HIGHLIGHT_ALBUM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_HIGHLIGHT_SEARCH_RESULTS() { return get_static_field<"EXTRA_PICK_IMAGES_HIGHLIGHT_SEARCH_RESULTS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_IN_ORDER() { return get_static_field<"EXTRA_PICK_IMAGES_IN_ORDER", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_LAUNCH_TAB() { return get_static_field<"EXTRA_PICK_IMAGES_LAUNCH_TAB", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_SELECTION_PARAMS() { return get_static_field<"EXTRA_PICK_IMAGES_SELECTION_PARAMS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PICK_IMAGES_UI_CUSTOMIZATION_PARAMS() { return get_static_field<"EXTRA_PICK_IMAGES_UI_CUSTOMIZATION_PARAMS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> KEY_PICK_IMAGES_HIGHLIGHT_ALBUM_ID() { return get_static_field<"KEY_PICK_IMAGES_HIGHLIGHT_ALBUM_ID", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> KEY_PICK_IMAGES_HIGHLIGHT_SEARCH_TEXT_QUERY() { return get_static_field<"KEY_PICK_IMAGES_HIGHLIGHT_SEARCH_TEXT_QUERY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> KEY_PICK_IMAGES_HIGHLIGHT_TYPE() { return get_static_field<"KEY_PICK_IMAGES_HIGHLIGHT_TYPE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> PICK_IMAGES_HIGHLIGHT_ALBUM_CAMERA() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_ALBUM_CAMERA", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PICK_IMAGES_HIGHLIGHT_ALBUM_DOWNLOADS() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_ALBUM_DOWNLOADS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PICK_IMAGES_HIGHLIGHT_ALBUM_FAVORITES() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_ALBUM_FAVORITES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PICK_IMAGES_HIGHLIGHT_ALBUM_SCREENSHOTS() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_ALBUM_SCREENSHOTS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PICK_IMAGES_HIGHLIGHT_ALBUM_VIDEOS() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_ALBUM_VIDEOS", jni::ref<java::lang::String>>(); }
	static jint PICK_IMAGES_HIGHLIGHT_TYPE_COLLAPSED() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_TYPE_COLLAPSED", jint>(); }
	static jint PICK_IMAGES_HIGHLIGHT_TYPE_EXPANDED() { return get_static_field<"PICK_IMAGES_HIGHLIGHT_TYPE_EXPANDED", jint>(); }
	static jint PICK_IMAGES_TAB_ALBUMS() { return get_static_field<"PICK_IMAGES_TAB_ALBUMS", jint>(); }
	static jint PICK_IMAGES_TAB_IMAGES() { return get_static_field<"PICK_IMAGES_TAB_IMAGES", jint>(); }
	...
	static jni::ref<java::lang::String> QUERY_ARG_LATEST_SELECTION_ONLY() { return get_static_field<"QUERY_ARG_LATEST_SELECTION_ONLY", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> QUERY_ARG_MEDIA_STANDARD_SORT_ORDER() { return get_static_field<"QUERY_ARG_MEDIA_STANDARD_SORT_ORDER", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::MediaStore> new_object() { return object_base::new_object(); }
	...
	static jni::ref<java::lang::String> getPackageForSearchMediaService(jni::ref<android::content::ContentResolver> resolver) { return call_static_method<"getPackageForSearchMediaService", jni::ref<java::lang::String>>(resolver); }
	...
	static void markIsFavoriteStatus(jni::ref<android::content::ContentResolver> resolver, jni::ref<java::util::Collection> uris, jboolean areFavorites) { return call_static_method<"markIsFavoriteStatus", void>(resolver, uris, areFavorites); }
	...
	static jni::ref<android::content::res::AssetFileDescriptor> openAssetFileDescriptor(jni::ref<android::content::ContentResolver> resolver, jni::ref<android::net::Uri> uri, jni::ref<java::lang::String> mode, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_static_method<"openAssetFileDescriptor", jni::ref<android::content::res::AssetFileDescriptor>>(resolver, uri, mode, cancellationSignal); }
	static jni::ref<android::os::ParcelFileDescriptor> openFileDescriptor(jni::ref<android::content::ContentResolver> resolver, jni::ref<android::net::Uri> uri, jni::ref<java::lang::String> mode, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_static_method<"openFileDescriptor", jni::ref<android::os::ParcelFileDescriptor>>(resolver, uri, mode, cancellationSignal); }
	static jni::ref<android::content::res::AssetFileDescriptor> openTypedAssetFileDescriptor(jni::ref<android::content::ContentResolver> resolver, jni::ref<android::net::Uri> uri, jni::ref<java::lang::String> mimeType, jni::ref<android::os::Bundle> opts, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_static_method<"openTypedAssetFileDescriptor", jni::ref<android::content::res::AssetFileDescriptor>>(resolver, uri, mimeType, opts, cancellationSignal); }
	static jni::ref<java::lang::String> restoreFileFromTrash(jni::ref<android::content::ContentResolver> resolver, jni::ref<java::lang::String> path, jni::ref<java::lang::String> targetPath) { return call_static_method<"restoreFileFromTrash", jni::ref<java::lang::String>>(resolver, path, targetPath); }
	...
	static jni::ref<java::lang::String> trashFile(jni::ref<android::content::ContentResolver> resolver, jni::ref<java::lang::String> path) { return call_static_method<"trashFile", jni::ref<java::lang::String>>(resolver, path); }
};
