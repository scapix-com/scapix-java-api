...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CLOUDMEDIAPROVIDER
...
public:
	...
	static jni::ref<android::provider::CloudMediaProvider> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::provider::CloudMediaProviderContract_Capabilities> onGetCapabilities() { return call_method<"onGetCapabilities", jni::ref<android::provider::CloudMediaProviderContract_Capabilities>>(); }
	...
	jni::ref<android::database::Cursor> onQueryMediaCategories(jni::ref<java::lang::String> parentCategoryId, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"onQueryMediaCategories", jni::ref<android::database::Cursor>>(parentCategoryId, extras, cancellationSignal); }
	jni::ref<android::database::Cursor> onQueryMediaInMediaSet(jni::ref<java::lang::String> mediaSetId, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"onQueryMediaInMediaSet", jni::ref<android::database::Cursor>>(mediaSetId, extras, cancellationSignal); }
	jni::ref<android::database::Cursor> onQueryMediaSets(jni::ref<java::lang::String> mediaCategoryId, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"onQueryMediaSets", jni::ref<android::database::Cursor>>(mediaCategoryId, extras, cancellationSignal); }
	jni::ref<android::database::Cursor> onQuerySearchSuggestions(jni::ref<java::lang::String> prefixText, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"onQuerySearchSuggestions", jni::ref<android::database::Cursor>>(prefixText, extras, cancellationSignal); }
	jni::ref<android::database::Cursor> onSearchMedia(jni::ref<java::lang::String> searchText, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"onSearchMedia", jni::ref<android::database::Cursor>>(searchText, extras, cancellationSignal); }
	jni::ref<android::database::Cursor> onSearchMedia(jni::ref<java::lang::String> suggestedMediaSetId, jni::ref<java::lang::String> fallbackSearchText, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"onSearchMedia", jni::ref<android::database::Cursor>>(suggestedMediaSetId, fallbackSearchText, extras, cancellationSignal); }
