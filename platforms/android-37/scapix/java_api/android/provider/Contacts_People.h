...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CONTACTS_PEOPLE
...
public:
	...
	static jni::ref<android::net::Uri> addToGroup(jni::ref<android::content::ContentResolver> resolver, jlong personId, jni::ref<java::lang::String> groupName) { return call_static_method<"addToGroup", jni::ref<android::net::Uri>>(resolver, personId, groupName); }
	static jni::ref<android::net::Uri> addToGroup(jni::ref<android::content::ContentResolver> resolver, jlong personId, jlong groupId) { return call_static_method<"addToGroup", jni::ref<android::net::Uri>>(resolver, personId, groupId); }
