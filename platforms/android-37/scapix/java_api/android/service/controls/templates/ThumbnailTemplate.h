...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CONTROLS_TEMPLATES_THUMBNAILTEMPLATE
...
public:
	...
	static jni::ref<android::service::controls::templates::ThumbnailTemplate> new_object(jni::ref<java::lang::String> templateId, jboolean active, jni::ref<android::graphics::drawable::Icon> thumbnail, jni::ref<java::lang::CharSequence> contentDescription) { return object_base::new_object(templateId, active, thumbnail, contentDescription); }
