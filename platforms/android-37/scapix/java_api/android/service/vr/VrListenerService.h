...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_VR_VRLISTENERSERVICE
...
public:
	...
	static jni::ref<android::service::vr::VrListenerService> new_object() { return object_base::new_object(); }
