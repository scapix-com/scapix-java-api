...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_QUICKSETTINGS_TILESERVICE
...
public:
	...
	static jni::ref<java::lang::String> CATEGORY_ACCESSIBILITY() { return get_static_field<"CATEGORY_ACCESSIBILITY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CATEGORY_CONNECTIVITY() { return get_static_field<"CATEGORY_CONNECTIVITY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CATEGORY_DISPLAY() { return get_static_field<"CATEGORY_DISPLAY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CATEGORY_PRIVACY() { return get_static_field<"CATEGORY_PRIVACY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CATEGORY_UTILITIES() { return get_static_field<"CATEGORY_UTILITIES", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> META_DATA_TILE_CATEGORY() { return get_static_field<"META_DATA_TILE_CATEGORY", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::service::quicksettings::TileService> new_object() { return object_base::new_object(); }
