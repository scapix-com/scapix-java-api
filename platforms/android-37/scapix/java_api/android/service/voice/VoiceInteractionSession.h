...
struct scapix::jni::object_traits<scapix::java_api::android::service::voice::VoiceInteractionSession>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::android::content::ComponentCallbacks2, scapix::java_api::android::view::KeyEvent_Callback>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_VOICE_VOICEINTERACTIONSESSION
...
public:
	...
	static jni::ref<java::lang::String> KEY_FOREGROUND_ACTIVITIES() { return get_static_field<"KEY_FOREGROUND_ACTIVITIES", jni::ref<java::lang::String>>(); }
	...
	static jint SHOW_WITH_ASSIST_STRUCTURE_SCREEN_CONTENT() { return get_static_field<"SHOW_WITH_ASSIST_STRUCTURE_SCREEN_CONTENT", jint>(); }
	static jint SHOW_WITH_SCREENSHOT() { return get_static_field<"SHOW_WITH_SCREENSHOT", jint>(); }

	static jni::ref<android::service::voice::VoiceInteractionSession> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::service::voice::VoiceInteractionSession> new_object(jni::ref<android::content::Context> context, jni::ref<android::os::Handler> handler) { return object_base::new_object(context, handler); }
	...
	jni::ref<android::app::appfunctions::AppFunctionActivityId> getAppFunctionActivityId(jni::ref<android::service::voice::VoiceInteractionSession_ActivityId> activityId) { return call_method<"getAppFunctionActivityId", jni::ref<android::app::appfunctions::AppFunctionActivityId>>(activityId); }
