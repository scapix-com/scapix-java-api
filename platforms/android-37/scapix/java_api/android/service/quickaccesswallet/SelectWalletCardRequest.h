...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_QUICKACCESSWALLET_SELECTWALLETCARDREQUEST
...
public:
	...
	static jni::ref<android::service::quickaccesswallet::SelectWalletCardRequest> new_object(jni::ref<java::lang::String> cardId) { return object_base::new_object(cardId); }
