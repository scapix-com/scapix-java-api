...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_QUICKACCESSWALLET_QUICKACCESSWALLETSERVICE
...
public:
	...
	static jni::ref<android::service::quickaccesswallet::QuickAccessWalletService> new_object() { return object_base::new_object(); }
	jni::ref<android::app::PendingIntent> getGestureTargetActivityPendingIntent() { return call_method<"getGestureTargetActivityPendingIntent", jni::ref<android::app::PendingIntent>>(); }
	jni::ref<android::app::PendingIntent> getTargetActivityPendingIntent() { return call_method<"getTargetActivityPendingIntent", jni::ref<android::app::PendingIntent>>(); }
