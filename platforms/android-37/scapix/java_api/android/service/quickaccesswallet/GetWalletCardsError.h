...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_QUICKACCESSWALLET_GETWALLETCARDSERROR
...
public:
	...
	static jni::ref<android::service::quickaccesswallet::GetWalletCardsError> new_object(jni::ref<android::graphics::drawable::Icon> icon, jni::ref<java::lang::CharSequence> message) { return object_base::new_object(icon, message); }
