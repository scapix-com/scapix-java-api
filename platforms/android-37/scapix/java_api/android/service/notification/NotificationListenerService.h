...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_NOTIFICATION_NOTIFICATIONLISTENERSERVICE
...
public:
	...
	static jni::ref<java::lang::String> ACTION_SETTINGS_HOME() { return get_static_field<"ACTION_SETTINGS_HOME", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> META_DATA_DEFAULT_AUTOBIND() { return get_static_field<"META_DATA_DEFAULT_AUTOBIND", jni::ref<java::lang::String>>(); }
	...
	static jint REASON_ASSISTANT_CANCEL() { return get_static_field<"REASON_ASSISTANT_CANCEL", jint>(); }
	static jint REASON_BUNDLE_DISMISSED() { return get_static_field<"REASON_BUNDLE_DISMISSED", jint>(); }
	...
	static jint REASON_LOCKDOWN() { return get_static_field<"REASON_LOCKDOWN", jint>(); }
	...
	static jni::ref<android::service::notification::NotificationListenerService> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::app::NotificationChannel> createConversationNotificationChannelForPackage(jni::ref<java::lang::String> pkg, jni::ref<android::os::UserHandle> user, jni::ref<java::lang::String> parentChannelId, jni::ref<java::lang::String> conversationId) { return call_method<"createConversationNotificationChannelForPackage", jni::ref<android::app::NotificationChannel>>(pkg, user, parentChannelId, conversationId); }
	void deleteConversationNotificationChannel(jni::ref<java::lang::String> pkg, jni::ref<android::os::UserHandle> user, jni::ref<java::lang::String> channelId) { return call_method<"deleteConversationNotificationChannel", void>(pkg, user, channelId); }
	...
	static void requestUnbind(jni::ref<android::content::ComponentName> componentName) { return call_static_method<"requestUnbind", void>(componentName); }
