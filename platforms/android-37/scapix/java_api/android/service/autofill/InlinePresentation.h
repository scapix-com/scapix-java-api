...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_INLINEPRESENTATION
...
public:
	...
	static jni::ref<android::service::autofill::InlinePresentation> new_object(jni::ref<android::app::slice::Slice> slice, jni::ref<android::widget::inline_::InlinePresentationSpec> inlinePresentationSpec, jboolean pinned) { return object_base::new_object(slice, inlinePresentationSpec, pinned); }
	static jni::ref<android::service::autofill::InlinePresentation> createTooltipPresentation(jni::ref<android::app::slice::Slice> slice, jni::ref<android::widget::inline_::InlinePresentationSpec> spec) { return call_static_method<"createTooltipPresentation", jni::ref<android::service::autofill::InlinePresentation>>(slice, spec); }
