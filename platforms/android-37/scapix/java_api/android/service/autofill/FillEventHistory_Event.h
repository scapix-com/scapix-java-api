...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_FILLEVENTHISTORY_EVENT
...
public:
	...
	static jint NO_SAVE_UI_REASON_USING_CREDMAN() { return get_static_field<"NO_SAVE_UI_REASON_USING_CREDMAN", jint>(); }
	...
	static jint TYPE_RESPONSE_DISCARDED() { return get_static_field<"TYPE_RESPONSE_DISCARDED", jint>(); }
	static jint TYPE_SAVE_SHOWN() { return get_static_field<"TYPE_SAVE_SHOWN", jint>(); }
	static jint TYPE_VIEW_REQUESTED_AUTOFILL() { return get_static_field<"TYPE_VIEW_REQUESTED_AUTOFILL", jint>(); }
	static jint UI_TYPE_CREDENTIAL_MANAGER() { return get_static_field<"UI_TYPE_CREDENTIAL_MANAGER", jint>(); }
	static jint UI_TYPE_DIALOG() { return get_static_field<"UI_TYPE_DIALOG", jint>(); }
	static jint UI_TYPE_INLINE() { return get_static_field<"UI_TYPE_INLINE", jint>(); }
	static jint UI_TYPE_MENU() { return get_static_field<"UI_TYPE_MENU", jint>(); }
	static jint UI_TYPE_UNKNOWN() { return get_static_field<"UI_TYPE_UNKNOWN", jint>(); }
	...
	jni::ref<android::view::autofill::AutofillId> getFocusedId() { return call_method<"getFocusedId", jni::ref<android::view::autofill::AutofillId>>(); }
	...
	jni::ref<java::util::Set> getShownDatasetIds() { return call_method<"getShownDatasetIds", jni::ref<java::util::Set>>(); }
	jint getType() { return call_method<"getType", jint>(); }
	jint getUiType() { return call_method<"getUiType", jint>(); }
