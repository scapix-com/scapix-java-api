...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_LUHNCHECKSUMVALIDATOR
...
public:
	...
	static jni::ref<android::service::autofill::LuhnChecksumValidator> new_object(jni::ref<jni::array<android::view::autofill::AutofillId>> ids) { return object_base::new_object(ids); }
