...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CREDENTIALS_CREDENTIALPROVIDERSERVICE
...
public:
	...
	static jni::ref<android::service::credentials::CredentialProviderService> new_object() { return object_base::new_object(); }
