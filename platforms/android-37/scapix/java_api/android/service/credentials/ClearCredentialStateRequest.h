...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CREDENTIALS_CLEARCREDENTIALSTATEREQUEST
...
public:
	...
	static jni::ref<android::service::credentials::ClearCredentialStateRequest> new_object(jni::ref<android::service::credentials::CallingAppInfo> callingAppInfo, jni::ref<android::os::Bundle> data) { return object_base::new_object(callingAppInfo, data); }
