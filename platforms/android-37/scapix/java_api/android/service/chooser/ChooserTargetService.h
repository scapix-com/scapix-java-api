...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CHOOSER_CHOOSERTARGETSERVICE
...
public:
	...
	static jni::ref<android::service::chooser::ChooserTargetService> new_object() { return object_base::new_object(); }
