...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_TEXTSERVICE_SPELLCHECKERSERVICE
...
public:
	...
	static jni::ref<android::service::textservice::SpellCheckerService> new_object() { return object_base::new_object(); }
