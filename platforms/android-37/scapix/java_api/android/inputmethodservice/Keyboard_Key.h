...
#ifndef SCAPIX_JAVA_API_ANDROID_INPUTMETHODSERVICE_KEYBOARD_KEY
...
public:
	...
	static jni::ref<android::inputmethodservice::Keyboard_Key> new_object(jni::ref<android::content::res::Resources> res, jni::ref<android::inputmethodservice::Keyboard_Row> parent, jint x, jint y, jni::ref<android::content::res::XmlResourceParser> parser) { return object_base::new_object(res, parent, x, y, parser); }
	static jni::ref<android::inputmethodservice::Keyboard_Key> new_object(jni::ref<android::inputmethodservice::Keyboard_Row> parent) { return object_base::new_object(parent); }
