...
#ifndef SCAPIX_JAVA_API_ANDROID_INPUTMETHODSERVICE_ABSTRACTINPUTMETHODSERVICE
...
public:
	...
	static jni::ref<android::inputmethodservice::AbstractInputMethodService> new_object() { return object_base::new_object(); }
	...
	void onConfigurationChanged(jni::ref<android::content::res::Configuration> configuration) { return call_method<"onConfigurationChanged", void>(configuration); }
