...
struct scapix::jni::object_traits<scapix::java_api::android::app::Dialog>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::android::content::DialogInterface, scapix::java_api::android::view::KeyEvent_Callback, scapix::java_api::android::view::View_OnCreateContextMenuListener, scapix::java_api::android::view::Window_Callback>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_DIALOG
...
public:
	...
	static jni::ref<android::app::Dialog> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::app::Dialog> new_object(jni::ref<android::content::Context> context, jint themeResId) { return object_base::new_object(context, themeResId); }
