...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FRAGMENTCONTROLLER
...
public:
	...
	void dispatchMultiWindowModeChanged(jboolean isInMultiWindowMode, jni::ref<android::content::res::Configuration> newConfig) { return call_method<"dispatchMultiWindowModeChanged", void>(isInMultiWindowMode, newConfig); }
	...
	void dispatchPictureInPictureModeChanged(jboolean isInPictureInPictureMode, jni::ref<android::content::res::Configuration> newConfig) { return call_method<"dispatchPictureInPictureModeChanged", void>(isInPictureInPictureMode, newConfig); }
