...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_PENDINGINTENT
...
public:
	...
	static jint FLAG_ALLOW_UNSAFE_IMPLICIT_INTENT() { return get_static_field<"FLAG_ALLOW_UNSAFE_IMPLICIT_INTENT", jint>(); }
	...
	static jint FLAG_MUTABLE() { return get_static_field<"FLAG_MUTABLE", jint>(); }
	...
	jboolean isActivity() { return call_method<"isActivity", jboolean>(); }
	jboolean isBroadcast() { return call_method<"isBroadcast", jboolean>(); }
	jboolean isForegroundService() { return call_method<"isForegroundService", jboolean>(); }
	jboolean isImmutable() { return call_method<"isImmutable", jboolean>(); }
	jboolean isService() { return call_method<"isService", jboolean>(); }
	...
	void send(jni::ref<android::os::Bundle> options) { return call_method<"send", void>(options); }
