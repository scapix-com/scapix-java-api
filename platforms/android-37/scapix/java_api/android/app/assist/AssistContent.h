...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ASSIST_ASSISTCONTENT
...
public:
	...
	static jni::ref<java::lang::String> EXTRA_APP_FUNCTION_DATA() { return get_static_field<"EXTRA_APP_FUNCTION_DATA", jni::ref<java::lang::String>>(); }

	static jni::ref<android::app::assist::AssistContent> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::net::Uri> getSessionTransferUri() { return call_method<"getSessionTransferUri", jni::ref<android::net::Uri>>(); }
	...
	void setSessionTransferUri(jni::ref<android::net::Uri> uri) { return call_method<"setSessionTransferUri", void>(uri); }
