...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ACTIVITYMANAGER
...
public:
	...
	void addApplicationStartInfoCompletionListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> listener) { return call_method<"addApplicationStartInfoCompletionListener", void>(executor, listener); }
	void addStartInfoTimestamp(jint key, jlong timestampNs) { return call_method<"addStartInfoTimestamp", void>(key, timestampNs); }
	void appNotResponding(jni::ref<java::lang::String> reason) { return call_method<"appNotResponding", void>(reason); }
	...
	jni::ref<java::util::List> getHistoricalProcessExitReasons(jni::ref<java::lang::String> packageName, jint pid, jint maxNum) { return call_method<"getHistoricalProcessExitReasons", jni::ref<java::util::List>>(packageName, pid, maxNum); }
	jni::ref<java::util::List> getHistoricalProcessStartReasons(jint maxNum) { return call_method<"getHistoricalProcessStartReasons", jni::ref<java::util::List>>(maxNum); }
	...
	static jboolean isLowMemoryKillReportSupported() { return call_static_method<"isLowMemoryKillReportSupported", jboolean>(); }
	...
	void registerAnrWarningListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> listener) { return call_method<"registerAnrWarningListener", void>(executor, listener); }
	void removeApplicationStartInfoCompletionListener(jni::ref<java::util::function::Consumer> listener) { return call_method<"removeApplicationStartInfoCompletionListener", void>(listener); }
	void restartPackage(jni::ref<java::lang::String> packageName) { return call_method<"restartPackage", void>(packageName); }
	void setProcessStateSummary(jni::ref<jni::array<jbyte>> state) { return call_method<"setProcessStateSummary", void>(state); }
	...
	void unregisterAnrWarningListener(jni::ref<java::util::function::Consumer> listener) { return call_method<"unregisterAnrWarningListener", void>(listener); }
};
