...
struct scapix::jni::object_traits<scapix::java_api::android::app::NativeActivity>
{
	...
	using base_classes = std::tuple<scapix::java_api::android::app::Activity, scapix::java_api::android::view::InputQueue_Callback, scapix::java_api::android::view::SurfaceHolder_Callback2, scapix::java_api::android::view::ViewTreeObserver_OnGlobalLayoutListener>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NATIVEACTIVITY
...
public:
	...
	static jni::ref<android::app::NativeActivity> new_object() { return object_base::new_object(); }
