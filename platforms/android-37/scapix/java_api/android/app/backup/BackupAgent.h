...
#include <scapix/java_api/android/app/backup/FullRestoreDataInput.h>
...
public:
	...
	static jint FLAG_CROSS_PLATFORM_DATA_TRANSFER_IOS() { return get_static_field<"FLAG_CROSS_PLATFORM_DATA_TRANSFER_IOS", jint>(); }
	...
	jlong onEstimateFullBackupBytes(jlong quotaBytes, jint transportFlags) { return call_method<"onEstimateFullBackupBytes", jlong>(quotaBytes, transportFlags); }
	...
	void onRestoreFile(jni::ref<android::app::backup::FullRestoreDataInput> data) { return call_method<"onRestoreFile", void>(data); }
