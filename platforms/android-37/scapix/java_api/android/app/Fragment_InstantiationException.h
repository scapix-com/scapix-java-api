...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FRAGMENT_INSTANTIATIONEXCEPTION
...
public:
	...
	static jni::ref<android::app::Fragment_InstantiationException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Exception> cause) { return object_base::new_object(msg, cause); }
};
