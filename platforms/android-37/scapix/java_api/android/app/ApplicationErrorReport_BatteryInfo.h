...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPLICATIONERRORREPORT_BATTERYINFO
...
public:
	...
	static jni::ref<android::app::ApplicationErrorReport_BatteryInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::ApplicationErrorReport_BatteryInfo> new_object(jni::ref<android::os::Parcel> in) { return object_base::new_object(in); }
