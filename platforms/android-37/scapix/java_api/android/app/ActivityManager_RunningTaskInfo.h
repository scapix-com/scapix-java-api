...
class ActivityManager_RunningTaskInfo;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ACTIVITYMANAGER_RUNNINGTASKINFO
...
public:
	...
	static jni::ref<android::app::ActivityManager_RunningTaskInfo> new_object() { return object_base::new_object(); }
