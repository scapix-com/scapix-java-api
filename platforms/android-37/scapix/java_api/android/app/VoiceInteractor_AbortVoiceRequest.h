...
class VoiceInteractor_AbortVoiceRequest;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_VOICEINTERACTOR_ABORTVOICEREQUEST
...
public:
	...
	static jni::ref<android::app::VoiceInteractor_AbortVoiceRequest> new_object(jni::ref<android::app::VoiceInteractor_Prompt> prompt, jni::ref<android::os::Bundle> extras) { return object_base::new_object(prompt, extras); }
