...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATIONCHANNEL
...
public:
	...
	static jni::ref<java::lang::String> EDIT_CONVERSATION() { return get_static_field<"EDIT_CONVERSATION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EDIT_IMPORTANCE() { return get_static_field<"EDIT_IMPORTANCE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EDIT_LAUNCHER() { return get_static_field<"EDIT_LAUNCHER", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EDIT_LOCKED_DEVICE() { return get_static_field<"EDIT_LOCKED_DEVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EDIT_SOUND() { return get_static_field<"EDIT_SOUND", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EDIT_VIBRATION() { return get_static_field<"EDIT_VIBRATION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EDIT_ZEN() { return get_static_field<"EDIT_ZEN", jni::ref<java::lang::String>>(); }

	static jni::ref<android::app::NotificationChannel> new_object(jni::ref<java::lang::String> id, jni::ref<java::lang::CharSequence> name, jint importance) { return object_base::new_object(id, name, importance); }
	...
	jni::ref<java::lang::String> getConversationId() { return call_method<"getConversationId", jni::ref<java::lang::String>>(); }
	...
	jint getOriginalImportance() { return call_method<"getOriginalImportance", jint>(); }
	jni::ref<java::lang::String> getParentChannelId() { return call_method<"getParentChannelId", jni::ref<java::lang::String>>(); }
	jni::ref<android::net::Uri> getSound() { return call_method<"getSound", jni::ref<android::net::Uri>>(); }
	jni::ref<android::os::VibrationEffect> getVibrationEffect() { return call_method<"getVibrationEffect", jni::ref<android::os::VibrationEffect>>(); }
	...
	jboolean hasUserSetSound() { return call_method<"hasUserSetSound", jboolean>(); }
	jint hashCode() { return call_method<"hashCode", jint>(); }
	jboolean isBlockable() { return call_method<"isBlockable", jboolean>(); }
	jboolean isConversation() { return call_method<"isConversation", jboolean>(); }
	jboolean isDemoted() { return call_method<"isDemoted", jboolean>(); }
	jboolean isImportantConversation() { return call_method<"isImportantConversation", jboolean>(); }
	void setAllowBubbles(jboolean allowBubbles) { return call_method<"setAllowBubbles", void>(allowBubbles); }
	void setBlockable(jboolean blockable) { return call_method<"setBlockable", void>(blockable); }
	void setBypassDnd(jboolean bypassDnd) { return call_method<"setBypassDnd", void>(bypassDnd); }
	void setConversationId(jni::ref<java::lang::String> parentChannelId, jni::ref<java::lang::String> conversationId) { return call_method<"setConversationId", void>(parentChannelId, conversationId); }
	...
	void setVibrationEffect(jni::ref<android::os::VibrationEffect> effect) { return call_method<"setVibrationEffect", void>(effect); }
