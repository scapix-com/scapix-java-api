...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ACTIVITYGROUP
...
public:
	...
	static jni::ref<android::app::ActivityGroup> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::ActivityGroup> new_object(jboolean singleActivityMode) { return object_base::new_object(singleActivityMode); }
