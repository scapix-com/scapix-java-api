...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_WALLPAPERINFO
...
public:
	...
	static jni::ref<android::app::WallpaperInfo> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::pm::ResolveInfo> service) { return object_base::new_object(context, service); }
	...
	jboolean shouldUseDefaultUnfoldTransition() { return call_method<"shouldUseDefaultUnfoldTransition", jboolean>(); }
