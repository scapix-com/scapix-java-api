...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_MESSAGINGSTYLE_MESSAGE
...
public:
	...
	static jni::ref<android::app::Notification_MessagingStyle_Message> new_object(jni::ref<java::lang::CharSequence> text, jlong timestamp, jni::ref<android::app::Person> sender) { return object_base::new_object(text, timestamp, sender); }
	static jni::ref<android::app::Notification_MessagingStyle_Message> new_object(jni::ref<java::lang::CharSequence> text, jlong timestamp, jni::ref<java::lang::CharSequence> sender) { return object_base::new_object(text, timestamp, sender); }
	...
	static jni::ref<java::util::List> getMessagesFromBundleArray(jni::ref<jni::array<android::os::Parcelable>> bundles) { return call_static_method<"getMessagesFromBundleArray", jni::ref<java::util::List>>(bundles); }
	jni::ref<java::lang::CharSequence> getSender() { return call_method<"getSender", jni::ref<java::lang::CharSequence>>(); }
	jni::ref<android::app::Person> getSenderPerson() { return call_method<"getSenderPerson", jni::ref<android::app::Person>>(); }
