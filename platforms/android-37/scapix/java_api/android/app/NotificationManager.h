...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATIONMANAGER
...
public:
	...
	static jni::ref<java::lang::String> ACTION_CONSOLIDATED_NOTIFICATION_POLICY_CHANGED() { return get_static_field<"ACTION_CONSOLIDATED_NOTIFICATION_POLICY_CHANGED", jni::ref<java::lang::String>>(); }
	...
	static jint AUTOMATIC_RULE_STATUS_ACTIVATED() { return get_static_field<"AUTOMATIC_RULE_STATUS_ACTIVATED", jint>(); }
	static jint AUTOMATIC_RULE_STATUS_DEACTIVATED() { return get_static_field<"AUTOMATIC_RULE_STATUS_DEACTIVATED", jint>(); }
	...
	static jni::ref<java::lang::String> EXTRA_NOTIFICATION_POLICY() { return get_static_field<"EXTRA_NOTIFICATION_POLICY", jni::ref<java::lang::String>>(); }
	...
	jboolean areAutomaticZenRulesUserManaged() { return call_method<"areAutomaticZenRulesUserManaged", jboolean>(); }
	...
	jboolean canPostPromotedNotifications() { return call_method<"canPostPromotedNotifications", jboolean>(); }
	jboolean canUseFullScreenIntent() { return call_method<"canUseFullScreenIntent", jboolean>(); }
	...
	jint getAutomaticZenRuleState(jni::ref<java::lang::String> id) { return call_method<"getAutomaticZenRuleState", jint>(id); }
	...
	jboolean matchesCallFilter(jni::ref<android::net::Uri> uri) { return call_method<"matchesCallFilter", jboolean>(uri); }
