...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FRAGMENTHOSTCALLBACK
...
public:
	...
	static jni::ref<android::app::FragmentHostCallback> new_object(jni::ref<android::content::Context> context, jni::ref<android::os::Handler> handler, jint windowAnimations) { return object_base::new_object(context, handler, windowAnimations); }
	...
	void onStartIntentSenderFromFragment(jni::ref<android::app::Fragment> fragment, jni::ref<android::content::IntentSender> intent, jint requestCode, jni::ref<android::content::Intent> fillInIntent, jint flagsMask, jint flagsValues, jint extraFlags, jni::ref<android::os::Bundle> options) { return call_method<"onStartIntentSenderFromFragment", void>(fragment, intent, requestCode, fillInIntent, flagsMask, flagsValues, extraFlags, options); }
