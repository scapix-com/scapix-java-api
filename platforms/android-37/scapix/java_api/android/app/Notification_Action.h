...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_ACTION
...
public:
	...
	static jint EMPHASIS_AUTO() { return get_static_field<"EMPHASIS_AUTO", jint>(); }
	static jint EMPHASIS_PRIMARY() { return get_static_field<"EMPHASIS_PRIMARY", jint>(); }
	static jint EMPHASIS_SECONDARY() { return get_static_field<"EMPHASIS_SECONDARY", jint>(); }
	...
	static jint SEMANTIC_ACTION_PAUSE() { return get_static_field<"SEMANTIC_ACTION_PAUSE", jint>(); }
	static jint SEMANTIC_ACTION_PLAY() { return get_static_field<"SEMANTIC_ACTION_PLAY", jint>(); }
	static jint SEMANTIC_ACTION_REPLY() { return get_static_field<"SEMANTIC_ACTION_REPLY", jint>(); }
	static jint SEMANTIC_ACTION_STOP() { return get_static_field<"SEMANTIC_ACTION_STOP", jint>(); }
	...
	static jint STYLE_AUTO() { return get_static_field<"STYLE_AUTO", jint>(); }
	static jint STYLE_ICON_AND_TEXT() { return get_static_field<"STYLE_ICON_AND_TEXT", jint>(); }
	static jint STYLE_ICON_ONLY() { return get_static_field<"STYLE_ICON_ONLY", jint>(); }
	static jint STYLE_TEXT_ONLY() { return get_static_field<"STYLE_TEXT_ONLY", jint>(); }
	...
	static jni::ref<android::app::Notification_Action> new_object(jint icon, jni::ref<java::lang::CharSequence> title, jni::ref<android::app::PendingIntent> intent) { return object_base::new_object(icon, title, intent); }
	...
	jint getEmphasisHint() { return call_method<"getEmphasisHint", jint>(); }
	...
	jint getStyleHint() { return call_method<"getStyleHint", jint>(); }
