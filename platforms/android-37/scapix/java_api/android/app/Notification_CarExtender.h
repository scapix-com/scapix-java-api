...
class Notification_CarExtender;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_CAREXTENDER
...
public:
	...
	static jni::ref<android::app::Notification_CarExtender> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::Notification_CarExtender> new_object(jni::ref<android::app::Notification> notif) { return object_base::new_object(notif); }
