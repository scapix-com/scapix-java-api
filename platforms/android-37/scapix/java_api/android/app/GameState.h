...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_GAMESTATE
...
public:
	...
	static jni::ref<android::app::GameState> new_object(jboolean isLoading, jint mode) { return object_base::new_object(isLoading, mode); }
	static jni::ref<android::app::GameState> new_object(jboolean isLoading, jint mode, jint label, jint quality) { return object_base::new_object(isLoading, mode, label, quality); }
