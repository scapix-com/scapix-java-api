...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FRAGMENTTRANSACTION
...
public:
	...
	static jni::ref<android::app::FragmentTransaction> new_object() { return object_base::new_object(); }
	...
	void commitNow() { return call_method<"commitNow", void>(); }
	void commitNowAllowingStateLoss() { return call_method<"commitNowAllowingStateLoss", void>(); }
	...
	jni::ref<android::app::FragmentTransaction> runOnCommit(jni::ref<java::lang::Runnable> p1) { return call_method<"runOnCommit", jni::ref<android::app::FragmentTransaction>>(p1); }
	...
	jni::ref<android::app::FragmentTransaction> setPrimaryNavigationFragment(jni::ref<android::app::Fragment> p1) { return call_method<"setPrimaryNavigationFragment", jni::ref<android::app::FragmentTransaction>>(p1); }
	jni::ref<android::app::FragmentTransaction> setReorderingAllowed(jboolean p1) { return call_method<"setReorderingAllowed", jni::ref<android::app::FragmentTransaction>>(p1); }
