...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_JOB_JOBINFO_BUILDER
...
public:
	...
	static jni::ref<android::app::job::JobInfo_Builder> new_object(jint jobId, jni::ref<android::content::ComponentName> jobService) { return object_base::new_object(jobId, jobService); }
	jni::ref<android::app::job::JobInfo_Builder> addDebugTag(jni::ref<java::lang::String> tag) { return call_method<"addDebugTag", jni::ref<android::app::job::JobInfo_Builder>>(tag); }
	...
	jni::ref<android::app::job::JobInfo_Builder> removeDebugTag(jni::ref<java::lang::String> tag) { return call_method<"removeDebugTag", jni::ref<android::app::job::JobInfo_Builder>>(tag); }
	jni::ref<android::app::job::JobInfo_Builder> setBackoffCriteria(jlong initialBackoffMillis, jint backoffPolicy) { return call_method<"setBackoffCriteria", jni::ref<android::app::job::JobInfo_Builder>>(initialBackoffMillis, backoffPolicy); }
	...
	jni::ref<android::app::job::JobInfo_Builder> setEstimatedNetworkBytes(jlong downloadBytes, jlong uploadBytes) { return call_method<"setEstimatedNetworkBytes", jni::ref<android::app::job::JobInfo_Builder>>(downloadBytes, uploadBytes); }
	...
	jni::ref<android::app::job::JobInfo_Builder> setPeriodic(jlong intervalMillis, jlong flexMillis) { return call_method<"setPeriodic", jni::ref<android::app::job::JobInfo_Builder>>(intervalMillis, flexMillis); }
	...
	jni::ref<android::app::job::JobInfo_Builder> setTraceTag(jni::ref<java::lang::String> traceTag) { return call_method<"setTraceTag", jni::ref<android::app::job::JobInfo_Builder>>(traceTag); }
