...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_JOB_JOBSCHEDULER
...
public:
	...
	static jint PENDING_JOB_REASON_CONSTRAINT_DEADLINE() { return get_static_field<"PENDING_JOB_REASON_CONSTRAINT_DEADLINE", jint>(); }
	...
	static jni::ref<android::app::job::JobScheduler> new_object() { return object_base::new_object(); }
	...
	jni::ref<java::util::Map> getPendingJobReasonStats(jint jobId) { return call_method<"getPendingJobReasonStats", jni::ref<java::util::Map>>(jobId); }
	jni::ref<jni::array<jint>> getPendingJobReasons(jint jobId) { return call_method<"getPendingJobReasons", jni::ref<jni::array<jint>>>(jobId); }
	jni::ref<java::util::List> getPendingJobReasonsHistory(jint jobId) { return call_method<"getPendingJobReasonsHistory", jni::ref<java::util::List>>(jobId); }
