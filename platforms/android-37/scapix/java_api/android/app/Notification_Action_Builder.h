...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_ACTION_BUILDER
...
public:
	...
	static jni::ref<android::app::Notification_Action_Builder> new_object(jni::ref<android::app::Notification_Action> action) { return object_base::new_object(action); }
	static jni::ref<android::app::Notification_Action_Builder> new_object(jni::ref<android::graphics::drawable::Icon> icon, jni::ref<java::lang::CharSequence> title, jni::ref<android::app::PendingIntent> intent) { return object_base::new_object(icon, title, intent); }
	static jni::ref<android::app::Notification_Action_Builder> new_object(jint icon, jni::ref<java::lang::CharSequence> title, jni::ref<android::app::PendingIntent> intent) { return object_base::new_object(icon, title, intent); }
	...
	jni::ref<android::app::Notification_Action_Builder> setAuthenticationRequired(jboolean authenticationRequired) { return call_method<"setAuthenticationRequired", jni::ref<android::app::Notification_Action_Builder>>(authenticationRequired); }
	...
	jni::ref<android::app::Notification_Action_Builder> setEmphasisHint(jint emphasis) { return call_method<"setEmphasisHint", jni::ref<android::app::Notification_Action_Builder>>(emphasis); }
	...
	jni::ref<android::app::Notification_Action_Builder> setStyleHint(jint style) { return call_method<"setStyleHint", jni::ref<android::app::Notification_Action_Builder>>(style); }
};
