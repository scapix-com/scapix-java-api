...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SLICE_SLICEPROVIDER
...
public:
	...
	static jni::ref<android::app::slice::SliceProvider> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::slice::SliceProvider> new_object(jni::ref<jni::array<java::lang::String>> autoGrantPermissions) { return object_base::new_object(autoGrantPermissions); }
