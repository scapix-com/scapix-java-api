...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SLICE_SLICE_BUILDER
...
public:
	...
	static jni::ref<android::app::slice::Slice_Builder> new_object(jni::ref<android::app::slice::Slice_Builder> parent) { return object_base::new_object(parent); }
	static jni::ref<android::app::slice::Slice_Builder> new_object(jni::ref<android::net::Uri> uri, jni::ref<android::app::slice::SliceSpec> spec) { return object_base::new_object(uri, spec); }
	...
	jni::ref<android::app::slice::Slice_Builder> addLong(jlong value, jni::ref<java::lang::String> subType, jni::ref<java::util::List> hints) { return call_method<"addLong", jni::ref<android::app::slice::Slice_Builder>>(value, subType, hints); }
