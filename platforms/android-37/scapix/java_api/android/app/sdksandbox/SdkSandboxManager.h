...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SDKSANDBOX_SDKSANDBOXMANAGER
#define SCAPIX_JAVA_API_ANDROID_APP_SDKSANDBOX_SDKSANDBOXMANAGER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/app/Activity.h>
#include <scapix/java_api/android/app/sdksandbox/AppOwnedSdkSandboxInterface.h>
...
public:
	...
	void registerAppOwnedSdkSandboxInterface(jni::ref<android::app::sdksandbox::AppOwnedSdkSandboxInterface> appOwnedSdkSandboxInterface) { return call_method<"registerAppOwnedSdkSandboxInterface", void>(appOwnedSdkSandboxInterface); }
	...
	void startSdkSandboxActivity(jni::ref<android::app::Activity> fromActivity, jni::ref<android::os::IBinder> sdkActivityToken) { return call_method<"startSdkSandboxActivity", void>(fromActivity, sdkActivityToken); }
	void unloadSdk(jni::ref<java::lang::String> sdkName) { return call_method<"unloadSdk", void>(sdkName); }
	void unregisterAppOwnedSdkSandboxInterface(jni::ref<java::lang::String> name) { return call_method<"unregisterAppOwnedSdkSandboxInterface", void>(name); }
};
