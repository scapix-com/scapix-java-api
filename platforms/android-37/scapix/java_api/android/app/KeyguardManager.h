...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_KEYGUARDMANAGER
#define SCAPIX_JAVA_API_ANDROID_APP_KEYGUARDMANAGER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/app/Activity.h>
#include <scapix/java_api/android/app/KeyguardManager_DeviceLockedStateListener.h>
...
#include <scapix/java_api/android/app/KeyguardManager_KeyguardLockedStateListener.h>
...
public:
	...
	using KeyguardLockedStateListener = KeyguardManager_KeyguardLockedStateListener;
	using KeyguardLock = KeyguardManager_KeyguardLock;
	using KeyguardDismissCallback = KeyguardManager_KeyguardDismissCallback;
	using DeviceLockedStateListener = KeyguardManager_DeviceLockedStateListener;

	void addDeviceLockedStateListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::app::KeyguardManager_DeviceLockedStateListener> listener) { return call_method<"addDeviceLockedStateListener", void>(executor, listener); }
	void addKeyguardLockedStateListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::app::KeyguardManager_KeyguardLockedStateListener> listener) { return call_method<"addKeyguardLockedStateListener", void>(executor, listener); }
	...
	void removeDeviceLockedStateListener(jni::ref<android::app::KeyguardManager_DeviceLockedStateListener> listener) { return call_method<"removeDeviceLockedStateListener", void>(listener); }
	void removeKeyguardLockedStateListener(jni::ref<android::app::KeyguardManager_KeyguardLockedStateListener> listener) { return call_method<"removeKeyguardLockedStateListener", void>(listener); }
