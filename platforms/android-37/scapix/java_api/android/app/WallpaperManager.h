...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_WALLPAPERMANAGER
...
public:
	...
	jni::ref<android::graphics::drawable::Drawable> getDrawable(jint which) { return call_method<"getDrawable", jni::ref<android::graphics::drawable::Drawable>>(which); }
	...
	jni::ref<android::graphics::drawable::Drawable> getFastDrawable(jint which) { return call_method<"getFastDrawable", jni::ref<android::graphics::drawable::Drawable>>(which); }
	...
	jni::ref<android::app::WallpaperInfo> getWallpaperInfo(jint which) { return call_method<"getWallpaperInfo", jni::ref<android::app::WallpaperInfo>>(which); }
	...
	jni::ref<android::graphics::drawable::Drawable> peekDrawable(jint which) { return call_method<"peekDrawable", jni::ref<android::graphics::drawable::Drawable>>(which); }
	...
	jni::ref<android::graphics::drawable::Drawable> peekFastDrawable(jint which) { return call_method<"peekFastDrawable", jni::ref<android::graphics::drawable::Drawable>>(which); }
	...
	void setDisplayPadding(jni::ref<android::graphics::Rect> padding) { return call_method<"setDisplayPadding", void>(padding); }
