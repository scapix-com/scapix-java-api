...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ACTIVITYOPTIONS
...
public:
	...
	static jint MODE_BACKGROUND_ACTIVITY_START_ALLOWED() { return get_static_field<"MODE_BACKGROUND_ACTIVITY_START_ALLOWED", jint>(); }
	static jint MODE_BACKGROUND_ACTIVITY_START_ALLOW_ALWAYS() { return get_static_field<"MODE_BACKGROUND_ACTIVITY_START_ALLOW_ALWAYS", jint>(); }
	static jint MODE_BACKGROUND_ACTIVITY_START_ALLOW_IF_VISIBLE() { return get_static_field<"MODE_BACKGROUND_ACTIVITY_START_ALLOW_IF_VISIBLE", jint>(); }
	static jint MODE_BACKGROUND_ACTIVITY_START_DENIED() { return get_static_field<"MODE_BACKGROUND_ACTIVITY_START_DENIED", jint>(); }
	static jint MODE_BACKGROUND_ACTIVITY_START_SYSTEM_DEFINED() { return get_static_field<"MODE_BACKGROUND_ACTIVITY_START_SYSTEM_DEFINED", jint>(); }
	...
	jint getPendingIntentBackgroundActivityStartMode() { return call_method<"getPendingIntentBackgroundActivityStartMode", jint>(); }
	jint getPendingIntentCreatorBackgroundActivityStartMode() { return call_method<"getPendingIntentCreatorBackgroundActivityStartMode", jint>(); }
	jint getSplashScreenStyle() { return call_method<"getSplashScreenStyle", jint>(); }
	jboolean isAllowPassThroughOnTouchOutside() { return call_method<"isAllowPassThroughOnTouchOutside", jboolean>(); }
	jboolean isMovableTaskRequired() { return call_method<"isMovableTaskRequired", jboolean>(); }
	jboolean isPendingIntentBackgroundActivityLaunchAllowed() { return call_method<"isPendingIntentBackgroundActivityLaunchAllowed", jboolean>(); }
	...
	static jni::ref<android::app::ActivityOptions> makeCustomAnimation(jni::ref<android::content::Context> context, jint enterResId, jint exitResId, jint backgroundColor) { return call_static_method<"makeCustomAnimation", jni::ref<android::app::ActivityOptions>>(context, enterResId, exitResId, backgroundColor); }
	static jni::ref<android::app::ActivityOptions> makeLaunchIntoPip(jni::ref<android::app::PictureInPictureParams> pictureInPictureParams) { return call_static_method<"makeLaunchIntoPip", jni::ref<android::app::ActivityOptions>>(pictureInPictureParams); }
	...
	void setAllowPassThroughOnTouchOutside(jboolean allowed) { return call_method<"setAllowPassThroughOnTouchOutside", void>(allowed); }
	...
	jni::ref<android::app::ActivityOptions> setMovableTaskRequired(jboolean movableTaskRequired) { return call_method<"setMovableTaskRequired", jni::ref<android::app::ActivityOptions>>(movableTaskRequired); }
	void setPendingIntentBackgroundActivityLaunchAllowed(jboolean allowed) { return call_method<"setPendingIntentBackgroundActivityLaunchAllowed", void>(allowed); }
	jni::ref<android::app::ActivityOptions> setPendingIntentBackgroundActivityStartMode(jint state) { return call_method<"setPendingIntentBackgroundActivityStartMode", jni::ref<android::app::ActivityOptions>>(state); }
	jni::ref<android::app::ActivityOptions> setPendingIntentCreatorBackgroundActivityStartMode(jint mode) { return call_method<"setPendingIntentCreatorBackgroundActivityStartMode", jni::ref<android::app::ActivityOptions>>(mode); }
	jni::ref<android::app::ActivityOptions> setShareIdentityEnabled(jboolean shareIdentity) { return call_method<"setShareIdentityEnabled", jni::ref<android::app::ActivityOptions>>(shareIdentity); }
	jni::ref<android::app::ActivityOptions> setSplashScreenStyle(jint style) { return call_method<"setSplashScreenStyle", jni::ref<android::app::ActivityOptions>>(style); }
