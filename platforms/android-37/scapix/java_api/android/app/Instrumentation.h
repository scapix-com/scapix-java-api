...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_INSTRUMENTATION
...
public:
	...
	static jni::ref<android::app::Instrumentation> new_object() { return object_base::new_object(); }
	...
	void callActivityOnNewIntent(jni::ref<android::app::Activity> activity, jni::ref<android::content::Intent> intent, jni::ref<android::app::ComponentCaller> caller) { return call_method<"callActivityOnNewIntent", void>(activity, intent, caller); }
