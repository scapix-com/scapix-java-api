...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATIONMANAGER_POLICY
...
public:
	...
	static jint CONVERSATION_SENDERS_ANYONE() { return get_static_field<"CONVERSATION_SENDERS_ANYONE", jint>(); }
	static jint CONVERSATION_SENDERS_IMPORTANT() { return get_static_field<"CONVERSATION_SENDERS_IMPORTANT", jint>(); }
	static jint CONVERSATION_SENDERS_NONE() { return get_static_field<"CONVERSATION_SENDERS_NONE", jint>(); }
	...
	static jint PRIORITY_CATEGORY_CONVERSATIONS() { return get_static_field<"PRIORITY_CATEGORY_CONVERSATIONS", jint>(); }
	...
	jint priorityConversationSenders() { return get_field<"priorityConversationSenders", jint>(); }
	...
	static jni::ref<android::app::NotificationManager_Policy> new_object(jint priorityCategories, jint priorityCallSenders, jint priorityMessageSenders) { return object_base::new_object(priorityCategories, priorityCallSenders, priorityMessageSenders); }
	static jni::ref<android::app::NotificationManager_Policy> new_object(jint priorityCategories, jint priorityCallSenders, jint priorityMessageSenders, jint suppressedVisualEffects) { return object_base::new_object(priorityCategories, priorityCallSenders, priorityMessageSenders, suppressedVisualEffects); }
	static jni::ref<android::app::NotificationManager_Policy> new_object(jint priorityCategories, jint priorityCallSenders, jint priorityMessageSenders, jint suppressedVisualEffects, jint priorityConversationSenders) { return object_base::new_object(priorityCategories, priorityCallSenders, priorityMessageSenders, suppressedVisualEffects, priorityConversationSenders); }
