...
class AppSearchManager_SearchContext_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPSEARCH_APPSEARCHMANAGER_SEARCHCONTEXT_BUILDER
...
public:
	...
	static jni::ref<android::app::appsearch::AppSearchManager_SearchContext_Builder> new_object(jni::ref<java::lang::String> databaseName) { return object_base::new_object(databaseName); }
