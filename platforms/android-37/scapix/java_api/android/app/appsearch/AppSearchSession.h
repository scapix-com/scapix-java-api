...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPSEARCH_APPSEARCHSESSION
...
public:
	...
	void commitBlob(jni::ref<java::util::Set> handles, jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> callback) { return call_method<"commitBlob", void>(handles, executor, callback); }
	...
	void openBlobForWrite(jni::ref<java::util::Set> handles, jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> callback) { return call_method<"openBlobForWrite", void>(handles, executor, callback); }
	...
	void removeBlob(jni::ref<java::util::Set> handles, jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> callback) { return call_method<"removeBlob", void>(handles, executor, callback); }
	...
	void setBlobVisibility(jni::ref<android::app::appsearch::SetBlobVisibilityRequest> request, jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> callback) { return call_method<"setBlobVisibility", void>(request, executor, callback); }
