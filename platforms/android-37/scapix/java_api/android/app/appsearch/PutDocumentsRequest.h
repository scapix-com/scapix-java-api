...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPSEARCH_PUTDOCUMENTSREQUEST
...
public:
	...
	jni::ref<java::util::List> getTakenActionGenericDocuments() { return call_method<"getTakenActionGenericDocuments", jni::ref<java::util::List>>(); }
};
