...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPSEARCH_SEARCHRESULT
...
public:
	...
	using TextMatchInfo = SearchResult_TextMatchInfo;
	using MatchRange = SearchResult_MatchRange;
	using MatchInfo = SearchResult_MatchInfo;
	using EmbeddingMatchInfo = SearchResult_EmbeddingMatchInfo;
	...
	jni::ref<java::util::List> getInformationalRankingSignals() { return call_method<"getInformationalRankingSignals", jni::ref<java::util::List>>(); }
	...
	jni::ref<java::util::Map> getParentTypeMap() { return call_method<"getParentTypeMap", jni::ref<java::util::Map>>(); }
