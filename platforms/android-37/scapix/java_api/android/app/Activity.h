...
#include <scapix/java_api/android/app/HandoffActivityDataRequestInfo.h>
...
public:
	...
	jboolean isHandoffEnabled() { return call_method<"isHandoffEnabled", jboolean>(); }
	...
	jni::ref<android::app::HandoffActivityData> onHandoffActivityDataRequested(jni::ref<android::app::HandoffActivityDataRequestInfo> requestInfo) { return call_method<"onHandoffActivityDataRequested", jni::ref<android::app::HandoffActivityData>>(requestInfo); }
	...
	void setHandoffEnabled(jboolean handoffEnabled, jni::ref<android::app::HandoffActivityParams> handoffActivityParams) { return call_method<"setHandoffEnabled", void>(handoffEnabled, handoffActivityParams); }
