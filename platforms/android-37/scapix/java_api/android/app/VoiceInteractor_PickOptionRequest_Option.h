...
class VoiceInteractor_PickOptionRequest_Option;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_VOICEINTERACTOR_PICKOPTIONREQUEST_OPTION
...
public:
	...
	static jni::ref<android::app::VoiceInteractor_PickOptionRequest_Option> new_object(jni::ref<java::lang::CharSequence> label, jint index) { return object_base::new_object(label, index); }
