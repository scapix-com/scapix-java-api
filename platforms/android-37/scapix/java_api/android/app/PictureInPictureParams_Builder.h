...
class PictureInPictureParams_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_PICTUREINPICTUREPARAMS_BUILDER
...
public:
	...
	static jni::ref<android::app::PictureInPictureParams_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::PictureInPictureParams_Builder> new_object(jni::ref<android::app::PictureInPictureParams> original) { return object_base::new_object(original); }
