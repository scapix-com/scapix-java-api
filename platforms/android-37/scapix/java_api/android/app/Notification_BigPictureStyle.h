...
class Notification_BigPictureStyle;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_BIGPICTURESTYLE
...
public:
	...
	static jni::ref<android::app::Notification_BigPictureStyle> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::Notification_BigPictureStyle> new_object(jni::ref<android::app::Notification_Builder> builder) { return object_base::new_object(builder); }
	...
	jni::ref<android::app::Notification_BigPictureStyle> bigPicture(jni::ref<android::graphics::drawable::Icon> icon) { return call_method<"bigPicture", jni::ref<android::app::Notification_BigPictureStyle>>(icon); }
	...
	jni::ref<android::app::Notification_BigPictureStyle> setContentDescription(jni::ref<java::lang::CharSequence> contentDescription) { return call_method<"setContentDescription", jni::ref<android::app::Notification_BigPictureStyle>>(contentDescription); }
	...
	jni::ref<android::app::Notification_BigPictureStyle> showBigPictureWhenCollapsed(jboolean show) { return call_method<"showBigPictureWhenCollapsed", jni::ref<android::app::Notification_BigPictureStyle>>(show); }
};
