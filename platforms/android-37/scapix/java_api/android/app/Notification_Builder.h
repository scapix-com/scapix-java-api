...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_BUILDER
...
public:
	...
	static jni::ref<android::app::Notification_Builder> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::app::Notification_Builder> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> channelId) { return object_base::new_object(context, channelId); }
	...
	jni::ref<android::app::Notification_Builder> setHasSummarizedContent(jboolean hasSummarizedContent) { return call_method<"setHasSummarizedContent", jni::ref<android::app::Notification_Builder>>(hasSummarizedContent); }
	...
	jni::ref<android::app::Notification_Builder> setRequestPromotedOngoing(jboolean requestPromotedOngoing) { return call_method<"setRequestPromotedOngoing", jni::ref<android::app::Notification_Builder>>(requestPromotedOngoing); }
	...
	jni::ref<android::app::Notification_Builder> setShortCriticalText(jni::ref<java::lang::String> shortCriticalText) { return call_method<"setShortCriticalText", jni::ref<android::app::Notification_Builder>>(shortCriticalText); }
