...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ADMIN_DEVICEADMININFO
...
public:
	...
	static jint HEADLESS_DEVICE_OWNER_MODE_AFFILIATED() { return get_static_field<"HEADLESS_DEVICE_OWNER_MODE_AFFILIATED", jint>(); }
	static jint HEADLESS_DEVICE_OWNER_MODE_SINGLE_USER() { return get_static_field<"HEADLESS_DEVICE_OWNER_MODE_SINGLE_USER", jint>(); }
	static jint HEADLESS_DEVICE_OWNER_MODE_UNSUPPORTED() { return get_static_field<"HEADLESS_DEVICE_OWNER_MODE_UNSUPPORTED", jint>(); }
	...
	static jni::ref<android::app::admin::DeviceAdminInfo> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::pm::ResolveInfo> resolveInfo) { return object_base::new_object(context, resolveInfo); }
	...
	jint getHeadlessDeviceOwnerMode() { return call_method<"getHeadlessDeviceOwnerMode", jint>(); }
