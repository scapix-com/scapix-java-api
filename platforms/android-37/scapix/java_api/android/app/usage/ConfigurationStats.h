...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_USAGE_CONFIGURATIONSTATS
...
public:
	...
	static jni::ref<android::app::usage::ConfigurationStats> new_object(jni::ref<android::app::usage::ConfigurationStats> stats) { return object_base::new_object(stats); }
