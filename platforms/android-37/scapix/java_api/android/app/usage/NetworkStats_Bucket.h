...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_USAGE_NETWORKSTATS_BUCKET
...
public:
	...
	static jint DEFAULT_NETWORK_ALL() { return get_static_field<"DEFAULT_NETWORK_ALL", jint>(); }
	static jint DEFAULT_NETWORK_NO() { return get_static_field<"DEFAULT_NETWORK_NO", jint>(); }
	static jint DEFAULT_NETWORK_YES() { return get_static_field<"DEFAULT_NETWORK_YES", jint>(); }
	static jint METERED_ALL() { return get_static_field<"METERED_ALL", jint>(); }
	static jint METERED_NO() { return get_static_field<"METERED_NO", jint>(); }
	static jint METERED_YES() { return get_static_field<"METERED_YES", jint>(); }
	...
	static jni::ref<android::app::usage::NetworkStats_Bucket> new_object() { return object_base::new_object(); }
	jint getDefaultNetworkStatus() { return call_method<"getDefaultNetworkStatus", jint>(); }
