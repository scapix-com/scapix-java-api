...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_KEYSTORE_KEYPROTECTION_BUILDER
...
public:
	...
	static jni::ref<android::security::keystore::KeyProtection_Builder> new_object(jint purposes) { return object_base::new_object(purposes); }
	...
	jni::ref<android::security::keystore::KeyProtection_Builder> setMgf1Digests(jni::ref<jni::array<java::lang::String>> mgf1Digests) { return call_method<"setMgf1Digests", jni::ref<android::security::keystore::KeyProtection_Builder>>(mgf1Digests); }
