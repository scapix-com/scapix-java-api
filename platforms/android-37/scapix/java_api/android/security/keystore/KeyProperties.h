...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_KEYSTORE_KEYPROPERTIES
...
public:
	...
	static jint AUTH_BIOMETRIC_STRONG() { return get_static_field<"AUTH_BIOMETRIC_STRONG", jint>(); }
	static jint AUTH_DEVICE_CREDENTIAL() { return get_static_field<"AUTH_DEVICE_CREDENTIAL", jint>(); }
	...
	static jni::ref<java::lang::String> KEY_ALGORITHM_ML_DSA() { return get_static_field<"KEY_ALGORITHM_ML_DSA", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> KEY_ALGORITHM_ML_DSA_65() { return get_static_field<"KEY_ALGORITHM_ML_DSA_65", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> KEY_ALGORITHM_ML_DSA_87() { return get_static_field<"KEY_ALGORITHM_ML_DSA_87", jni::ref<java::lang::String>>(); }
	...
	static jint PURPOSE_AGREE_KEY() { return get_static_field<"PURPOSE_AGREE_KEY", jint>(); }
	static jint PURPOSE_ATTEST_KEY() { return get_static_field<"PURPOSE_ATTEST_KEY", jint>(); }
	...
	static jint SECURITY_LEVEL_SOFTWARE() { return get_static_field<"SECURITY_LEVEL_SOFTWARE", jint>(); }
	static jint SECURITY_LEVEL_STRONGBOX() { return get_static_field<"SECURITY_LEVEL_STRONGBOX", jint>(); }
	static jint SECURITY_LEVEL_TRUSTED_ENVIRONMENT() { return get_static_field<"SECURITY_LEVEL_TRUSTED_ENVIRONMENT", jint>(); }
	static jint SECURITY_LEVEL_UNKNOWN() { return get_static_field<"SECURITY_LEVEL_UNKNOWN", jint>(); }
	static jint SECURITY_LEVEL_UNKNOWN_SECURE() { return get_static_field<"SECURITY_LEVEL_UNKNOWN_SECURE", jint>(); }
	...
	static jint UNRESTRICTED_USAGE_COUNT() { return get_static_field<"UNRESTRICTED_USAGE_COUNT", jint>(); }
};
