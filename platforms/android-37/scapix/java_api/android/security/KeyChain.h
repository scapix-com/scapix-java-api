...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_KEYCHAIN
...
public:
	...
	static jni::ref<java::lang::String> ACTION_KEYCHAIN_CHANGED() { return get_static_field<"ACTION_KEYCHAIN_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_KEY_ACCESS_CHANGED() { return get_static_field<"ACTION_KEY_ACCESS_CHANGED", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> ACTION_TRUST_STORE_CHANGED() { return get_static_field<"ACTION_TRUST_STORE_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_CERTIFICATE() { return get_static_field<"EXTRA_CERTIFICATE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_KEY_ACCESSIBLE() { return get_static_field<"EXTRA_KEY_ACCESSIBLE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_KEY_ALIAS() { return get_static_field<"EXTRA_KEY_ALIAS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> KEY_ALIAS_SELECTION_DENIED() { return get_static_field<"KEY_ALIAS_SELECTION_DENIED", jni::ref<java::lang::String>>(); }

	static jni::ref<android::security::KeyChain> new_object() { return object_base::new_object(); }
	...
	static jni::ref<android::content::Intent> createManageCredentialsIntent(jni::ref<android::security::AppUriAuthenticationPolicy> policy) { return call_static_method<"createManageCredentialsIntent", jni::ref<android::content::Intent>>(policy); }
	...
	static jni::ref<android::security::AppUriAuthenticationPolicy> getCredentialManagementAppPolicy(jni::ref<android::content::Context> context) { return call_static_method<"getCredentialManagementAppPolicy", jni::ref<android::security::AppUriAuthenticationPolicy>>(context); }
	...
	static jboolean isCredentialManagementApp(jni::ref<android::content::Context> context) { return call_static_method<"isCredentialManagementApp", jboolean>(context); }
	...
	static jboolean removeCredentialManagementApp(jni::ref<android::content::Context> context) { return call_static_method<"removeCredentialManagementApp", jboolean>(context); }
};
