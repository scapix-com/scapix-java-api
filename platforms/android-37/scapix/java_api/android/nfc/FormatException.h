...
#ifndef SCAPIX_JAVA_API_ANDROID_NFC_FORMATEXCEPTION
...
public:
	...
	static jni::ref<android::nfc::FormatException> new_object() { return object_base::new_object(); }
	static jni::ref<android::nfc::FormatException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<android::nfc::FormatException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> e) { return object_base::new_object(message, e); }
};
