...
#ifndef SCAPIX_JAVA_API_ANDROID_NFC_NFCADAPTER
...
public:
	...
	static jni::ref<java::lang::String> ACTION_CHANGE_TAG_INTENT_PREFERENCE() { return get_static_field<"ACTION_CHANGE_TAG_INTENT_PREFERENCE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_READER_TECH_A_POLLING_LOOP_ANNOTATION() { return get_static_field<"EXTRA_READER_TECH_A_POLLING_LOOP_ANNOTATION", jni::ref<java::lang::String>>(); }
	...
	static jint FLAG_LISTEN_DISABLE() { return get_static_field<"FLAG_LISTEN_DISABLE", jint>(); }
	static jint FLAG_LISTEN_KEEP() { return get_static_field<"FLAG_LISTEN_KEEP", jint>(); }
	static jint FLAG_LISTEN_NFC_PASSIVE_A() { return get_static_field<"FLAG_LISTEN_NFC_PASSIVE_A", jint>(); }
	static jint FLAG_LISTEN_NFC_PASSIVE_B() { return get_static_field<"FLAG_LISTEN_NFC_PASSIVE_B", jint>(); }
	static jint FLAG_LISTEN_NFC_PASSIVE_F() { return get_static_field<"FLAG_LISTEN_NFC_PASSIVE_F", jint>(); }
	static jint FLAG_READER_DISABLE() { return get_static_field<"FLAG_READER_DISABLE", jint>(); }
	static jint FLAG_READER_KEEP() { return get_static_field<"FLAG_READER_KEEP", jint>(); }
	...
	void allowOneTransaction() { return call_method<"allowOneTransaction", void>(); }
	...
	jni::ref<java::lang::String> getGestureExchangeAid() { return call_method<"getGestureExchangeAid", jni::ref<java::lang::String>>(); }
	...
	jboolean isExitFramesSupported() { return call_method<"isExitFramesSupported", jboolean>(); }
	jboolean isObserveModeEnabled() { return call_method<"isObserveModeEnabled", jboolean>(); }
	jboolean isObserveModeSupported() { return call_method<"isObserveModeSupported", jboolean>(); }
	jboolean isPowerSavingModeEnabled() { return call_method<"isPowerSavingModeEnabled", jboolean>(); }
	jboolean isPowerSavingModeSupported() { return call_method<"isPowerSavingModeSupported", jboolean>(); }
	jboolean isReaderModeAnnotationSupported() { return call_method<"isReaderModeAnnotationSupported", jboolean>(); }
	jboolean isReaderOptionEnabled() { return call_method<"isReaderOptionEnabled", jboolean>(); }
	jboolean isReaderOptionSupported() { return call_method<"isReaderOptionSupported", jboolean>(); }
	...
	jboolean isTagIntentAllowed() { return call_method<"isTagIntentAllowed", jboolean>(); }
	jboolean isTagIntentAppPreferenceSupported() { return call_method<"isTagIntentAppPreferenceSupported", jboolean>(); }
	void resetDiscoveryTechnology(jni::ref<android::app::Activity> activity) { return call_method<"resetDiscoveryTechnology", void>(activity); }
	void setDiscoveryTechnology(jni::ref<android::app::Activity> activity, jint pollTechnology, jint listenTechnology) { return call_method<"setDiscoveryTechnology", void>(activity, pollTechnology, listenTechnology); }
	jboolean setObserveModeEnabled(jboolean enabled) { return call_method<"setObserveModeEnabled", jboolean>(enabled); }
	void setPowerSavingMode(jboolean enabled) { return call_method<"setPowerSavingMode", void>(enabled); }
};
