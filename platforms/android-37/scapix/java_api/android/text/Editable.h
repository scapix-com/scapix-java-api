...
struct scapix::jni::object_traits<scapix::java_api::android::text::Editable>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Appendable, scapix::java_api::java::lang::CharSequence, scapix::java_api::android::text::GetChars, scapix::java_api::android::text::Spannable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_EDITABLE
