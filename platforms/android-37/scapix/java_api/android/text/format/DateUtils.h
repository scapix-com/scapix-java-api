...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_FORMAT_DATEUTILS
...
public:
	...
	static jni::ref<android::text::format::DateUtils> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::Formatter> formatDateRange(jni::ref<android::content::Context> context, jni::ref<java::util::Formatter> formatter, jlong startMillis, jlong endMillis, jint flags) { return call_static_method<"formatDateRange", jni::ref<java::util::Formatter>>(context, formatter, startMillis, endMillis, flags); }
	static jni::ref<java::util::Formatter> formatDateRange(jni::ref<android::content::Context> context, jni::ref<java::util::Formatter> formatter, jlong startMillis, jlong endMillis, jint flags, jni::ref<java::lang::String> timeZone) { return call_static_method<"formatDateRange", jni::ref<java::util::Formatter>>(context, formatter, startMillis, endMillis, flags, timeZone); }
	static jni::ref<java::lang::String> formatDateRange(jni::ref<android::content::Context> context, jlong startMillis, jlong endMillis, jint flags) { return call_static_method<"formatDateRange", jni::ref<java::lang::String>>(context, startMillis, endMillis, flags); }
	static jni::ref<java::lang::String> formatDateTime(jni::ref<android::content::Context> context, jlong millis, jint flags) { return call_static_method<"formatDateTime", jni::ref<java::lang::String>>(context, millis, flags); }
	...
	static jni::ref<java::lang::CharSequence> formatSameDayTime(jlong then, jlong now, jint dateStyle, jint timeStyle) { return call_static_method<"formatSameDayTime", jni::ref<java::lang::CharSequence>>(then, now, dateStyle, timeStyle); }
	...
	static jni::ref<java::lang::CharSequence> getRelativeDateTimeString(jni::ref<android::content::Context> c, jlong time, jlong minResolution, jlong transitionResolution, jint flags) { return call_static_method<"getRelativeDateTimeString", jni::ref<java::lang::CharSequence>>(c, time, minResolution, transitionResolution, flags); }
	...
	static jni::ref<java::lang::CharSequence> getRelativeTimeSpanString(jni::ref<android::content::Context> c, jlong millis, jboolean withPreposition) { return call_static_method<"getRelativeTimeSpanString", jni::ref<java::lang::CharSequence>>(c, millis, withPreposition); }
	...
	static jni::ref<java::lang::CharSequence> getRelativeTimeSpanString(jlong time, jlong now, jlong minResolution) { return call_static_method<"getRelativeTimeSpanString", jni::ref<java::lang::CharSequence>>(time, now, minResolution); }
	static jni::ref<java::lang::CharSequence> getRelativeTimeSpanString(jlong time, jlong now, jlong minResolution, jint flags) { return call_static_method<"getRelativeTimeSpanString", jni::ref<java::lang::CharSequence>>(time, now, minResolution, flags); }
