...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_FORMAT_TIME
...
public:
	...
	static jni::ref<android::text::format::Time> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::format::Time> new_object(jni::ref<android::text::format::Time> other) { return object_base::new_object(other); }
	static jni::ref<android::text::format::Time> new_object(jni::ref<java::lang::String> timezoneId) { return object_base::new_object(timezoneId); }
	...
	static jint getJulianDay(jlong millis, jlong gmtoffSeconds) { return call_static_method<"getJulianDay", jint>(millis, gmtoffSeconds); }
