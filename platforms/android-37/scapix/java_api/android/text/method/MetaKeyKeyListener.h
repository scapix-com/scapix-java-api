...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_METHOD_METAKEYKEYLISTENER
...
public:
	...
	static jni::ref<android::text::method::MetaKeyKeyListener> new_object() { return object_base::new_object(); }
	...
	jlong clearMetaKeyState(jlong state, jint which) { return call_method<"clearMetaKeyState", jlong>(state, which); }
	...
	static jint getMetaState(jlong state, jint meta) { return call_static_method<"getMetaState", jint>(state, meta); }
	static jlong handleKeyDown(jlong state, jint keyCode, jni::ref<android::view::KeyEvent> event) { return call_static_method<"handleKeyDown", jlong>(state, keyCode, event); }
	static jlong handleKeyUp(jlong state, jint keyCode, jni::ref<android::view::KeyEvent> event) { return call_static_method<"handleKeyUp", jlong>(state, keyCode, event); }
