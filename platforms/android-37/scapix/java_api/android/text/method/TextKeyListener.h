...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_METHOD_TEXTKEYLISTENER
...
public:
	...
	static jni::ref<android::text::method::TextKeyListener> new_object(jni::ref<android::text::method::TextKeyListener_Capitalize> cap, jboolean autotext) { return object_base::new_object(cap, autotext); }
