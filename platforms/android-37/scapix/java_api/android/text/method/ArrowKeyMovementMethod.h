...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_METHOD_ARROWKEYMOVEMENTMETHOD
...
public:
	...
	static jni::ref<android::text::method::ArrowKeyMovementMethod> new_object() { return object_base::new_object(); }
