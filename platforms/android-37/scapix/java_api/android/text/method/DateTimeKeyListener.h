...
public:
	...
	static jni::ref<android::text::method::DateTimeKeyListener> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
	...
	static jni::ref<android::text::method::DateTimeKeyListener> getInstance(jni::ref<java::util::Locale> locale) { return call_static_method<"getInstance", jni::ref<android::text::method::DateTimeKeyListener>>(locale); }
};
