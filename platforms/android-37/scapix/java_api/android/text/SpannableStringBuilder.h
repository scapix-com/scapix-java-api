...
struct scapix::jni::object_traits<scapix::java_api::android::text::SpannableStringBuilder>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Appendable, scapix::java_api::java::lang::CharSequence, scapix::java_api::android::text::Editable, scapix::java_api::android::text::GetChars, scapix::java_api::android::text::Spannable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_SPANNABLESTRINGBUILDER
...
public:
	...
	static jni::ref<android::text::SpannableStringBuilder> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::SpannableStringBuilder> new_object(jni::ref<java::lang::CharSequence> text) { return object_base::new_object(text); }
	static jni::ref<android::text::SpannableStringBuilder> new_object(jni::ref<java::lang::CharSequence> text, jint start, jint end) { return object_base::new_object(text, start, end); }
	...
	jint getTextWatcherDepth() { return call_method<"getTextWatcherDepth", jint>(); }
