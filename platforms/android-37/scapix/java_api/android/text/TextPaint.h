...
public:
	...
	jint underlineColor() { return get_field<"underlineColor", jint>(); }
	void underlineColor(jint v) { set_field<"underlineColor", jint>(v); }
	jfloat underlineThickness() { return get_field<"underlineThickness", jfloat>(); }
	void underlineThickness(jfloat v) { set_field<"underlineThickness", jfloat>(v); }
