...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_EASYEDITSPAN
...
public:
	...
	static jni::ref<android::text::style::EasyEditSpan> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::style::EasyEditSpan> new_object(jni::ref<android::app::PendingIntent> pendingIntent) { return object_base::new_object(pendingIntent); }
	static jni::ref<android::text::style::EasyEditSpan> new_object(jni::ref<android::os::Parcel> source) { return object_base::new_object(source); }
