...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_MASKFILTERSPAN
...
public:
	...
	static jni::ref<android::text::style::MaskFilterSpan> new_object(jni::ref<android::graphics::MaskFilter> filter) { return object_base::new_object(filter); }
