...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_FOREGROUNDCOLORSPAN
...
public:
	...
	static jni::ref<android::text::style::ForegroundColorSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
	static jni::ref<android::text::style::ForegroundColorSpan> new_object(jint color) { return object_base::new_object(color); }
