...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_QUOTESPAN
...
public:
	...
	static jni::ref<android::text::style::QuoteSpan> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::style::QuoteSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
	static jni::ref<android::text::style::QuoteSpan> new_object(jint color) { return object_base::new_object(color); }
	static jni::ref<android::text::style::QuoteSpan> new_object(jint color, jint stripeWidth, jint gapWidth) { return object_base::new_object(color, stripeWidth, gapWidth); }
