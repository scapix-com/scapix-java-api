...
public:
	...
	static jni::ref<android::text::style::BulletSpan> new_object(jint gapWidth, jint color, jint bulletRadius) { return object_base::new_object(gapWidth, color, bulletRadius); }
