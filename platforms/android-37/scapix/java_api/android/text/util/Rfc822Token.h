...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_UTIL_RFC822TOKEN
...
public:
	...
	static jni::ref<android::text::util::Rfc822Token> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> address, jni::ref<java::lang::String> comment) { return object_base::new_object(name, address, comment); }
