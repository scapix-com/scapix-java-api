...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_GRAPHEMECLUSTERSEGMENTFINDER
...
public:
	...
	static jni::ref<android::text::GraphemeClusterSegmentFinder> new_object(jni::ref<java::lang::CharSequence> text, jni::ref<android::text::TextPaint> textPaint) { return object_base::new_object(text, textPaint); }
