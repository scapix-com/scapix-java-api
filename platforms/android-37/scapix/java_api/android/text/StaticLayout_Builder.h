...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STATICLAYOUT_BUILDER
...
public:
	...
	jni::ref<android::text::StaticLayout_Builder> setJustificationMode(jint justificationMode) { return call_method<"setJustificationMode", jni::ref<android::text::StaticLayout_Builder>>(justificationMode); }
	jni::ref<android::text::StaticLayout_Builder> setLineBreakConfig(jni::ref<android::graphics::text::LineBreakConfig> lineBreakConfig) { return call_method<"setLineBreakConfig", jni::ref<android::text::StaticLayout_Builder>>(lineBreakConfig); }
	...
	jni::ref<android::text::StaticLayout_Builder> setMinimumFontMetrics(jni::ref<android::graphics::Paint_FontMetrics> minimumFontMetrics) { return call_method<"setMinimumFontMetrics", jni::ref<android::text::StaticLayout_Builder>>(minimumFontMetrics); }
	jni::ref<android::text::StaticLayout_Builder> setShiftDrawingOffsetForStartOverhang(jboolean shiftDrawingOffsetForStartOverhang) { return call_method<"setShiftDrawingOffsetForStartOverhang", jni::ref<android::text::StaticLayout_Builder>>(shiftDrawingOffsetForStartOverhang); }
	...
	jni::ref<android::text::StaticLayout_Builder> setUseBoundsForWidth(jboolean useBoundsForWidth) { return call_method<"setUseBoundsForWidth", jni::ref<android::text::StaticLayout_Builder>>(useBoundsForWidth); }
	jni::ref<android::text::StaticLayout_Builder> setUseLineSpacingFromFallbacks(jboolean useLineSpacingFromFallbacks) { return call_method<"setUseLineSpacingFromFallbacks", jni::ref<android::text::StaticLayout_Builder>>(useLineSpacingFromFallbacks); }
};
