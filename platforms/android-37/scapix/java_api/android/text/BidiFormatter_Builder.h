...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_BIDIFORMATTER_BUILDER
...
public:
	...
	static jni::ref<android::text::BidiFormatter_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::BidiFormatter_Builder> new_object(jboolean rtlContext) { return object_base::new_object(rtlContext); }
	static jni::ref<android::text::BidiFormatter_Builder> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
