...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_TELEPHONYSCANMANAGER
...
public:
	...
	static jni::ref<android::telephony::TelephonyScanManager> new_object() { return object_base::new_object(); }
};
