...
public:
	...
	static jint PHONE_NUMBER_SOURCE_TS43() { return get_static_field<"PHONE_NUMBER_SOURCE_TS43", jint>(); }
	...
	void setTs43PhoneNumber(jint subscriptionId, jni::ref<java::lang::String> number) { return call_method<"setTs43PhoneNumber", void>(subscriptionId, number); }
