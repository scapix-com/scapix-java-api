...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_DATA_APNSETTING_BUILDER
...
public:
	...
	static jni::ref<android::telephony::data::ApnSetting_Builder> new_object() { return object_base::new_object(); }
	jni::ref<android::telephony::data::ApnSetting> build() { return call_method<"build", jni::ref<android::telephony::data::ApnSetting>>(); }
	jni::ref<android::telephony::data::ApnSetting_Builder> setAlwaysOn(jboolean alwaysOn) { return call_method<"setAlwaysOn", jni::ref<android::telephony::data::ApnSetting_Builder>>(alwaysOn); }
	...
	jni::ref<android::telephony::data::ApnSetting_Builder> setMtuV4(jint mtuV4) { return call_method<"setMtuV4", jni::ref<android::telephony::data::ApnSetting_Builder>>(mtuV4); }
	jni::ref<android::telephony::data::ApnSetting_Builder> setMtuV6(jint mtuV6) { return call_method<"setMtuV6", jni::ref<android::telephony::data::ApnSetting_Builder>>(mtuV6); }
	...
	jni::ref<android::telephony::data::ApnSetting_Builder> setPersistent(jboolean isPersistent) { return call_method<"setPersistent", jni::ref<android::telephony::data::ApnSetting_Builder>>(isPersistent); }
	jni::ref<android::telephony::data::ApnSetting_Builder> setProfileId(jint profileId) { return call_method<"setProfileId", jni::ref<android::telephony::data::ApnSetting_Builder>>(profileId); }
