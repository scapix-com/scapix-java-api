...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_DATA_APNSETTING
...
public:
	...
	static jint PROTOCOL_NON_IP() { return get_static_field<"PROTOCOL_NON_IP", jint>(); }
	static jint PROTOCOL_PPP() { return get_static_field<"PROTOCOL_PPP", jint>(); }
	static jint PROTOCOL_UNSTRUCTURED() { return get_static_field<"PROTOCOL_UNSTRUCTURED", jint>(); }
	static jint TYPE_BIP() { return get_static_field<"TYPE_BIP", jint>(); }
	...
	static jint TYPE_ENTERPRISE() { return get_static_field<"TYPE_ENTERPRISE", jint>(); }
	...
	static jint TYPE_MCX() { return get_static_field<"TYPE_MCX", jint>(); }
	static jint TYPE_MMS() { return get_static_field<"TYPE_MMS", jint>(); }
	static jint TYPE_OEM_PAID() { return get_static_field<"TYPE_OEM_PAID", jint>(); }
	static jint TYPE_OEM_PRIVATE() { return get_static_field<"TYPE_OEM_PRIVATE", jint>(); }
	static jint TYPE_RCS() { return get_static_field<"TYPE_RCS", jint>(); }
	static jint TYPE_SUPL() { return get_static_field<"TYPE_SUPL", jint>(); }
	static jint TYPE_VSIM() { return get_static_field<"TYPE_VSIM", jint>(); }
	static jint TYPE_XCAP() { return get_static_field<"TYPE_XCAP", jint>(); }
	...
	jni::ref<java::lang::String> getMmsProxyAddressAsString() { return call_method<"getMmsProxyAddressAsString", jni::ref<java::lang::String>>(); }
	...
	jint getMtuV4() { return call_method<"getMtuV4", jint>(); }
	jint getMtuV6() { return call_method<"getMtuV6", jint>(); }
	...
	jint getProfileId() { return call_method<"getProfileId", jint>(); }
	...
	jni::ref<java::lang::String> getProxyAddressAsString() { return call_method<"getProxyAddressAsString", jni::ref<java::lang::String>>(); }
