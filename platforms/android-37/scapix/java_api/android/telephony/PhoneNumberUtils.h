...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_PHONENUMBERUTILS
...
public:
	...
	static jni::ref<android::telephony::PhoneNumberUtils> new_object() { return object_base::new_object(); }
	...
	static jboolean isWpsCallNumber(jni::ref<java::lang::String> number) { return call_static_method<"isWpsCallNumber", jboolean>(number); }
