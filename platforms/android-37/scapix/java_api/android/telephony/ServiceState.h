...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_SERVICESTATE
...
public:
	...
	static jni::ref<android::telephony::ServiceState> new_object() { return object_base::new_object(); }
	static jni::ref<android::telephony::ServiceState> new_object(jni::ref<android::os::Parcel> in) { return object_base::new_object(in); }
	static jni::ref<android::telephony::ServiceState> new_object(jni::ref<android::telephony::ServiceState> s) { return object_base::new_object(s); }
	...
	jboolean isUsingNonTerrestrialNetwork() { return call_method<"isUsingNonTerrestrialNetwork", jboolean>(); }
