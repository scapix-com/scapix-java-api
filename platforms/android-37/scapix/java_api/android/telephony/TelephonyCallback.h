...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_TELEPHONYCALLBACK
...
#include <scapix/java_api/android/telephony/TelephonyCallback_CarrierRoamingNtnListener.h>
...
public:
	...
	using CarrierRoamingNtnListener = TelephonyCallback_CarrierRoamingNtnListener;
	...
	static jni::ref<android::telephony::TelephonyCallback> new_object() { return object_base::new_object(); }
};
