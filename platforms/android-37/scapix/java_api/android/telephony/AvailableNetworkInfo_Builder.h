...
class AvailableNetworkInfo_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_AVAILABLENETWORKINFO_BUILDER
...
public:
	...
	static jni::ref<android::telephony::AvailableNetworkInfo_Builder> new_object(jint subId) { return object_base::new_object(subId); }
