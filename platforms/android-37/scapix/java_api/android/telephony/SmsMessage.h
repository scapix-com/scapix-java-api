...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_SMSMESSAGE
...
public:
	...
	static jint ENCODING_KSC5601() { return get_static_field<"ENCODING_KSC5601", jint>(); }
	static jint ENCODING_UNKNOWN() { return get_static_field<"ENCODING_UNKNOWN", jint>(); }
	static jni::ref<java::lang::String> FORMAT_3GPP() { return get_static_field<"FORMAT_3GPP", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FORMAT_3GPP2() { return get_static_field<"FORMAT_3GPP2", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::telephony::SmsMessage> createFromPdu(jni::ref<jni::array<jbyte>> pdu, jni::ref<java::lang::String> format) { return call_static_method<"createFromPdu", jni::ref<android::telephony::SmsMessage>>(pdu, format); }
	...
	jni::ref<java::lang::String> getRecipientAddress() { return call_method<"getRecipientAddress", jni::ref<java::lang::String>>(); }
