...
class SignalThresholdInfo_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_SIGNALTHRESHOLDINFO_BUILDER
...
public:
	...
	static jni::ref<android::telephony::SignalThresholdInfo_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::telephony::SignalThresholdInfo_Builder> setHysteresisDb(jint hysteresisDb) { return call_method<"setHysteresisDb", jni::ref<android::telephony::SignalThresholdInfo_Builder>>(hysteresisDb); }
