...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHADAPTER
...
public:
	...
	jint isLeHighDataThroughputPhySupported() { return call_method<"isLeHighDataThroughputPhySupported", jint>(); }
	...
	jni::ref<android::bluetooth::BluetoothServerSocket> listenUsingSocketSettings(jni::ref<android::bluetooth::BluetoothSocketSettings> settings) { return call_method<"listenUsingSocketSettings", jni::ref<android::bluetooth::BluetoothServerSocket>>(settings); }
