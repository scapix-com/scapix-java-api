...
class AdvertiseSettings_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_LE_ADVERTISESETTINGS_BUILDER
...
public:
	...
	static jni::ref<android::bluetooth::le::AdvertiseSettings_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::bluetooth::le::AdvertiseSettings_Builder> setDiscoverable(jboolean discoverable) { return call_method<"setDiscoverable", jni::ref<android::bluetooth::le::AdvertiseSettings_Builder>>(discoverable); }
