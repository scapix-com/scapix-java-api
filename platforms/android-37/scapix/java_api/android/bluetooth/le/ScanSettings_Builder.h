...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_LE_SCANSETTINGS_BUILDER
...
public:
	...
	static jni::ref<android::bluetooth::le::ScanSettings_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::bluetooth::le::ScanSettings_Builder> setRssiThreshold(jint rssiThreshold) { return call_method<"setRssiThreshold", jni::ref<android::bluetooth::le::ScanSettings_Builder>>(rssiThreshold); }
	...
	jni::ref<android::bluetooth::le::ScanSettings_Builder> setScanType(jint scanType) { return call_method<"setScanType", jni::ref<android::bluetooth::le::ScanSettings_Builder>>(scanType); }
};
