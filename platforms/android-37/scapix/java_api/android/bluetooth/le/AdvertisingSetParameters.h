...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_LE_ADVERTISINGSETPARAMETERS
...
public:
	...
	static jint TX_POWER_MAX_AVAILABLE() { return get_static_field<"TX_POWER_MAX_AVAILABLE", jint>(); }
