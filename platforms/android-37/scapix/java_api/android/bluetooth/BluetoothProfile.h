...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHPROFILE
...
public:
	...
	static jni::ref<java::lang::String> EXTRA_PROFILE() { return get_static_field<"EXTRA_PROFILE", jni::ref<java::lang::String>>(); }
