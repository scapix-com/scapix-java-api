...
class BluetoothLeAudioCodecConfig_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHLEAUDIOCODECCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothLeAudioCodecConfig_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::bluetooth::BluetoothLeAudioCodecConfig_Builder> new_object(jni::ref<android::bluetooth::BluetoothLeAudioCodecConfig> config) { return object_base::new_object(config); }
	...
	jni::ref<android::bluetooth::BluetoothLeAudioCodecConfig_Builder> setCodecId(jlong codecId) { return call_method<"setCodecId", jni::ref<android::bluetooth::BluetoothLeAudioCodecConfig_Builder>>(codecId); }
