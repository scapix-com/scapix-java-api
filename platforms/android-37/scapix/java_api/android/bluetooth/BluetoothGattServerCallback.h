...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHGATTSERVERCALLBACK
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothGattServerCallback> new_object() { return object_base::new_object(); }
	...
	void onMtuChanged(jni::ref<android::bluetooth::BluetoothDevice> device, jint mtu) { return call_method<"onMtuChanged", void>(device, mtu); }
	...
	void onPhyRead(jni::ref<android::bluetooth::BluetoothDevice> device, jint txPhy, jint rxPhy, jint status) { return call_method<"onPhyRead", void>(device, txPhy, rxPhy, status); }
	void onPhyUpdate(jni::ref<android::bluetooth::BluetoothDevice> device, jint txPhy, jint rxPhy, jint status) { return call_method<"onPhyUpdate", void>(device, txPhy, rxPhy, status); }
	...
	void onSubrateChange(jni::ref<android::bluetooth::BluetoothDevice> device, jint subrateMode, jint status) { return call_method<"onSubrateChange", void>(device, subrateMode, status); }
};
