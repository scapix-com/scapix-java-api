...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHDEVICE
#define SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHDEVICE

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/bluetooth/BluetoothClass.h>
#include <scapix/java_api/android/bluetooth/BluetoothDevice_BluetoothAddress.h>
...
#include <scapix/java_api/android/bluetooth/BondStatus.h>
#include <scapix/java_api/android/bluetooth/EncryptionStatus.h>
...
public:
	...
	using BluetoothAddress = BluetoothDevice_BluetoothAddress;
	...
	static jni::ref<java::lang::String> ACTION_ENCRYPTION_CHANGE() { return get_static_field<"ACTION_ENCRYPTION_CHANGE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_FOUND() { return get_static_field<"ACTION_FOUND", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_KEY_MISSING() { return get_static_field<"ACTION_KEY_MISSING", jni::ref<java::lang::String>>(); }
	...
	static jint ADDRESS_TYPE_ANONYMOUS() { return get_static_field<"ADDRESS_TYPE_ANONYMOUS", jint>(); }
	...
	static jint BOND_LOSS_REASON_BREDR_AUTH_FAILURE() { return get_static_field<"BOND_LOSS_REASON_BREDR_AUTH_FAILURE", jint>(); }
	static jint BOND_LOSS_REASON_BREDR_INCOMING_PAIRING() { return get_static_field<"BOND_LOSS_REASON_BREDR_INCOMING_PAIRING", jint>(); }
	static jint BOND_LOSS_REASON_LE_ENCRYPT_FAILURE() { return get_static_field<"BOND_LOSS_REASON_LE_ENCRYPT_FAILURE", jint>(); }
	static jint BOND_LOSS_REASON_LE_INCOMING_PAIRING() { return get_static_field<"BOND_LOSS_REASON_LE_INCOMING_PAIRING", jint>(); }
	static jint BOND_LOSS_REASON_UNKNOWN() { return get_static_field<"BOND_LOSS_REASON_UNKNOWN", jint>(); }
	...
	static jint ENCRYPTION_ALGORITHM_AES() { return get_static_field<"ENCRYPTION_ALGORITHM_AES", jint>(); }
	static jint ENCRYPTION_ALGORITHM_E0() { return get_static_field<"ENCRYPTION_ALGORITHM_E0", jint>(); }
	static jint ENCRYPTION_ALGORITHM_NONE() { return get_static_field<"ENCRYPTION_ALGORITHM_NONE", jint>(); }
	static jint ENCRYPTION_ALGORITHM_UNKNOWN() { return get_static_field<"ENCRYPTION_ALGORITHM_UNKNOWN", jint>(); }
	static jint ERROR() { return get_static_field<"ERROR", jint>(); }
	static jni::ref<java::lang::String> EXTRA_BOND_LOSS_REASON() { return get_static_field<"EXTRA_BOND_LOSS_REASON", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_DISCOVERY_RESULT_TYPE() { return get_static_field<"EXTRA_DISCOVERY_RESULT_TYPE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_ENCRYPTION_ALGORITHM() { return get_static_field<"EXTRA_ENCRYPTION_ALGORITHM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_ENCRYPTION_ENABLED() { return get_static_field<"EXTRA_ENCRYPTION_ENABLED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_ENCRYPTION_STATUS() { return get_static_field<"EXTRA_ENCRYPTION_STATUS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_KEY_SIZE() { return get_static_field<"EXTRA_KEY_SIZE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_NAME() { return get_static_field<"EXTRA_NAME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PAIRING_ALGORITHM() { return get_static_field<"EXTRA_PAIRING_ALGORITHM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_PAIRING_CONTEXT() { return get_static_field<"EXTRA_PAIRING_CONTEXT", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_UUID_LE() { return get_static_field<"EXTRA_UUID_LE", jni::ref<java::lang::String>>(); }
	static jint PAIRING_ALGORITHM_BREDR_LEGACY() { return get_static_field<"PAIRING_ALGORITHM_BREDR_LEGACY", jint>(); }
	static jint PAIRING_ALGORITHM_BREDR_SSP() { return get_static_field<"PAIRING_ALGORITHM_BREDR_SSP", jint>(); }
	static jint PAIRING_ALGORITHM_LE_LEGACY() { return get_static_field<"PAIRING_ALGORITHM_LE_LEGACY", jint>(); }
	static jint PAIRING_ALGORITHM_SC() { return get_static_field<"PAIRING_ALGORITHM_SC", jint>(); }
	static jint PAIRING_CONTEXT_REPAIRING() { return get_static_field<"PAIRING_CONTEXT_REPAIRING", jint>(); }
	static jint PAIRING_CONTEXT_USER_APPROVAL_REQUESTED() { return get_static_field<"PAIRING_CONTEXT_USER_APPROVAL_REQUESTED", jint>(); }
	static jint PAIRING_CONTEXT_USER_PARTICIPATION_REQUESTED() { return get_static_field<"PAIRING_CONTEXT_USER_PARTICIPATION_REQUESTED", jint>(); }
	...
	static jint PHY_LE_HDT() { return get_static_field<"PHY_LE_HDT", jint>(); }
	static jint PHY_LE_HDT_MASK() { return get_static_field<"PHY_LE_HDT_MASK", jint>(); }
	...
	jboolean cancelBondProcess() { return call_method<"cancelBondProcess", jboolean>(); }
	jint connect() { return call_method<"connect", jint>(); }
	jni::ref<android::bluetooth::BluetoothGatt> connectGatt(jni::ref<android::bluetooth::BluetoothGattConnectionSettings> gattConnectionSettings, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::bluetooth::BluetoothGattCallback> callback) { return call_method<"connectGatt", jni::ref<android::bluetooth::BluetoothGatt>>(gattConnectionSettings, executor, callback); }
	...
	jboolean createBond(jint transport) { return call_method<"createBond", jboolean>(transport); }
	...
	jni::ref<android::bluetooth::BluetoothSocket> createUsingSocketSettings(jni::ref<android::bluetooth::BluetoothSocketSettings> settings) { return call_method<"createUsingSocketSettings", jni::ref<android::bluetooth::BluetoothSocket>>(settings); }
	jint describeContents() { return call_method<"describeContents", jint>(); }
	jint disconnect() { return call_method<"disconnect", jint>(); }
	jboolean equals(jni::ref<java::lang::Object> o) { return call_method<"equals", jboolean>(o); }
	jboolean fetchUuids(jint transport) { return call_method<"fetchUuids", jboolean>(transport); }
	...
	jni::ref<android::bluetooth::BondStatus> getBondStatus(jint transport) { return call_method<"getBondStatus", jni::ref<android::bluetooth::BondStatus>>(transport); }
	jni::ref<android::bluetooth::EncryptionStatus> getEncryptionStatus(jint transport) { return call_method<"getEncryptionStatus", jni::ref<android::bluetooth::EncryptionStatus>>(transport); }
	jni::ref<android::bluetooth::BluetoothDevice_BluetoothAddress> getIdentityAddressWithType() { return call_method<"getIdentityAddressWithType", jni::ref<android::bluetooth::BluetoothDevice_BluetoothAddress>>(); }
	jint getKeyMissingCount() { return call_method<"getKeyMissingCount", jint>(); }
	...
	jboolean isConnected(jint transport) { return call_method<"isConnected", jboolean>(transport); }
