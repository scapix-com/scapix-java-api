...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHGATTCALLBACK
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothGattCallback> new_object() { return object_base::new_object(); }
	...
	void onCharacteristicChanged(jni::ref<android::bluetooth::BluetoothGatt> gatt, jni::ref<android::bluetooth::BluetoothGattCharacteristic> characteristic, jni::ref<jni::array<jbyte>> value) { return call_method<"onCharacteristicChanged", void>(gatt, characteristic, value); }
	void onCharacteristicRead(jni::ref<android::bluetooth::BluetoothGatt> gatt, jni::ref<android::bluetooth::BluetoothGattCharacteristic> characteristic, jni::ref<jni::array<jbyte>> value, jint status) { return call_method<"onCharacteristicRead", void>(gatt, characteristic, value, status); }
	...
	void onDescriptorRead(jni::ref<android::bluetooth::BluetoothGatt> gatt, jni::ref<android::bluetooth::BluetoothGattDescriptor> descriptor, jint status, jni::ref<jni::array<jbyte>> value) { return call_method<"onDescriptorRead", void>(gatt, descriptor, status, value); }
	...
	void onServiceChanged(jni::ref<android::bluetooth::BluetoothGatt> gatt) { return call_method<"onServiceChanged", void>(gatt); }
	...
	void onSubrateChange(jni::ref<android::bluetooth::BluetoothGatt> gatt, jint subrateMode, jint status) { return call_method<"onSubrateChange", void>(gatt, subrateMode, status); }
};
