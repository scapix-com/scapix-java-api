...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSSTATUS_BUILDER
...
public:
	...
	static jni::ref<android::location::GnssStatus_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::location::GnssStatus_Builder> addSatellite(jint constellationType, jint svid, jfloat cn0DbHz, jfloat elevation, jfloat azimuth, jboolean hasEphemeris, jboolean hasAlmanac, jboolean usedInFix, jboolean hasCarrierFrequency, jfloat carrierFrequency, jboolean hasBasebandCn0DbHz, jfloat basebandCn0DbHz, jboolean hasCodeType, jni::ref<java::lang::String> codeType, jboolean hasElapsedRealtimeNanos, jlong elapsedRealtimeNanos, jboolean hasElapsedRealtimeUncertaintyNanos, jdouble elapsedRealtimeUncertaintyNanos) { return call_method<"addSatellite", jni::ref<android::location::GnssStatus_Builder>>(constellationType, svid, cn0DbHz, elevation, azimuth, hasEphemeris, hasAlmanac, usedInFix, hasCarrierFrequency, carrierFrequency, hasBasebandCn0DbHz, basebandCn0DbHz, hasCodeType, codeType, hasElapsedRealtimeNanos, elapsedRealtimeNanos, hasElapsedRealtimeUncertaintyNanos, elapsedRealtimeUncertaintyNanos); }
