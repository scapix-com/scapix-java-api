...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_ADDRESS
...
public:
	...
	static jni::ref<android::location::Address> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
