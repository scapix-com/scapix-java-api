...
public:
	...
	jni::ref<android::location::GnssCapabilities_Builder> setHasGnssEngineRestartAfterPowerModeChange(jboolean capable) { return call_method<"setHasGnssEngineRestartAfterPowerModeChange", jni::ref<android::location::GnssCapabilities_Builder>>(capable); }
