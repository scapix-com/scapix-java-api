...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSMEASUREMENT
...
public:
	...
	static jni::ref<java::lang::String> CODE_TYPE_A() { return get_static_field<"CODE_TYPE_A", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_B() { return get_static_field<"CODE_TYPE_B", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_C() { return get_static_field<"CODE_TYPE_C", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_D() { return get_static_field<"CODE_TYPE_D", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_E() { return get_static_field<"CODE_TYPE_E", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_I() { return get_static_field<"CODE_TYPE_I", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_L() { return get_static_field<"CODE_TYPE_L", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_M() { return get_static_field<"CODE_TYPE_M", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_N() { return get_static_field<"CODE_TYPE_N", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_P() { return get_static_field<"CODE_TYPE_P", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_Q() { return get_static_field<"CODE_TYPE_Q", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_S() { return get_static_field<"CODE_TYPE_S", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_UNKNOWN() { return get_static_field<"CODE_TYPE_UNKNOWN", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_W() { return get_static_field<"CODE_TYPE_W", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_X() { return get_static_field<"CODE_TYPE_X", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_Y() { return get_static_field<"CODE_TYPE_Y", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CODE_TYPE_Z() { return get_static_field<"CODE_TYPE_Z", jni::ref<java::lang::String>>(); }
