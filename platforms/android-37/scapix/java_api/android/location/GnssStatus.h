...
public:
	...
	jni::ref<java::lang::String> getCodeType(jint satelliteIndex) { return call_method<"getCodeType", jni::ref<java::lang::String>>(satelliteIndex); }
	jint getConstellationType(jint satelliteIndex) { return call_method<"getConstellationType", jint>(satelliteIndex); }
	jlong getElapsedRealtimeNanos(jint satelliteIndex) { return call_method<"getElapsedRealtimeNanos", jlong>(satelliteIndex); }
	jdouble getElapsedRealtimeUncertaintyNanos(jint satelliteIndex) { return call_method<"getElapsedRealtimeUncertaintyNanos", jdouble>(satelliteIndex); }
	...
	jboolean hasCodeType(jint satelliteIndex) { return call_method<"hasCodeType", jboolean>(satelliteIndex); }
	jboolean hasElapsedRealtimeNanos(jint satelliteIndex) { return call_method<"hasElapsedRealtimeNanos", jboolean>(satelliteIndex); }
	jboolean hasElapsedRealtimeUncertaintyNanos(jint satelliteIndex) { return call_method<"hasElapsedRealtimeUncertaintyNanos", jboolean>(satelliteIndex); }
