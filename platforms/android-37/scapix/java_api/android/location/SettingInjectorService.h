...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_SETTINGINJECTORSERVICE
...
public:
	...
	static jni::ref<android::location::SettingInjectorService> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
