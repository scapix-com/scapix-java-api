...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSANTENNAINFO_BUILDER
...
public:
	...
	static jni::ref<android::location::GnssAntennaInfo_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::location::GnssAntennaInfo_Builder> new_object(jni::ref<android::location::GnssAntennaInfo> antennaInfo) { return object_base::new_object(antennaInfo); }
	static jni::ref<android::location::GnssAntennaInfo_Builder> new_object(jdouble carrierFrequencyMHz, jni::ref<android::location::GnssAntennaInfo_PhaseCenterOffset> phaseCenterOffset) { return object_base::new_object(carrierFrequencyMHz, phaseCenterOffset); }
