...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CONFERENCE
...
public:
	...
	static jni::ref<android::telecom::Conference> new_object(jni::ref<android::telecom::PhoneAccountHandle> phoneAccount) { return object_base::new_object(phoneAccount); }
	...
	static jni::ref<android::telecom::Conference> createFailedConference(jni::ref<android::telecom::DisconnectCause> disconnectCause, jni::ref<android::telecom::PhoneAccountHandle> phoneAccount) { return call_static_method<"createFailedConference", jni::ref<android::telecom::Conference>>(disconnectCause, phoneAccount); }
	...
	void onMerge(jni::ref<android::telecom::Conference> conference) { return call_method<"onMerge", void>(conference); }
