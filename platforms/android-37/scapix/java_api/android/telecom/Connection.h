...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CONNECTION
...
public:
	...
	static jint CAPABILITY_ADD_PARTICIPANT() { return get_static_field<"CAPABILITY_ADD_PARTICIPANT", jint>(); }
	...
	static jint CAPABILITY_REMOTE_PARTY_SUPPORTS_RTT() { return get_static_field<"CAPABILITY_REMOTE_PARTY_SUPPORTS_RTT", jint>(); }
	...
	static jint CAPABILITY_TRANSFER() { return get_static_field<"CAPABILITY_TRANSFER", jint>(); }
	static jint CAPABILITY_TRANSFER_CONSULTATIVE() { return get_static_field<"CAPABILITY_TRANSFER_CONSULTATIVE", jint>(); }
	...
	static jni::ref<java::lang::String> EVENT_CALL_RESUME_FAILED() { return get_static_field<"EVENT_CALL_RESUME_FAILED", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EVENT_DISCONNECT_FAILED() { return get_static_field<"EVENT_DISCONNECT_FAILED", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_AUDIO_CODEC_BANDWIDTH_KHZ() { return get_static_field<"EXTRA_AUDIO_CODEC_BANDWIDTH_KHZ", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_AUDIO_CODEC_BITRATE_KBPS() { return get_static_field<"EXTRA_AUDIO_CODEC_BITRATE_KBPS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_LAST_KNOWN_CELL_IDENTITY() { return get_static_field<"EXTRA_LAST_KNOWN_CELL_IDENTITY", jni::ref<java::lang::String>>(); }
	...
	static jint PROPERTY_CROSS_SIM() { return get_static_field<"PROPERTY_CROSS_SIM", jint>(); }
	...
	static jint PROPERTY_IS_ADHOC_CONFERENCE() { return get_static_field<"PROPERTY_IS_ADHOC_CONFERENCE", jint>(); }
	...
	static jni::ref<android::telecom::Connection> new_object() { return object_base::new_object(); }
	...
	jint getAudioProcessingUseCase() { return call_method<"getAudioProcessingUseCase", jint>(); }
	...
	void onAddConferenceParticipants(jni::ref<java::util::List> participants) { return call_method<"onAddConferenceParticipants", void>(participants); }
	...
	void onTrackedByNonUiService(jboolean isTracked) { return call_method<"onTrackedByNonUiService", void>(isTracked); }
	void onTransfer(jni::ref<android::net::Uri> address, jboolean isConfirmationRequired) { return call_method<"onTransfer", void>(address, isConfirmationRequired); }
	void onTransfer(jni::ref<android::telecom::Connection> toConnection) { return call_method<"onTransfer", void>(toConnection); }
	void onUnhold() { return call_method<"onUnhold", void>(); }
	void onUsingAlternativeUi(jboolean isUsingAlternativeUi) { return call_method<"onUsingAlternativeUi", void>(isUsingAlternativeUi); }
	...
	void queryLocationForEmergency(jlong timeoutMillis, jni::ref<java::lang::String> provider, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::OutcomeReceiver> callback) { return call_method<"queryLocationForEmergency", void>(timeoutMillis, provider, executor, callback); }
	...
	void setAudioProcessing(jint useCase) { return call_method<"setAudioProcessing", void>(useCase); }
	...
	void setSimulatedRinging() { return call_method<"setSimulatedRinging", void>(); }
