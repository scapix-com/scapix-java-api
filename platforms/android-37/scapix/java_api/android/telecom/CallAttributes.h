...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CALLATTRIBUTES
...
public:
	...
	static jint MESSAGING() { return get_static_field<"MESSAGING", jint>(); }
	...
	static jint SUPPORTS_VIDEO_CALLING() { return get_static_field<"SUPPORTS_VIDEO_CALLING", jint>(); }
	...
	jni::ref<android::net::Uri> getContactUri() { return call_method<"getContactUri", jni::ref<android::net::Uri>>(); }
	...
	jboolean isGroupCall() { return call_method<"isGroupCall", jboolean>(); }
	jboolean isLogExcluded() { return call_method<"isLogExcluded", jboolean>(); }
