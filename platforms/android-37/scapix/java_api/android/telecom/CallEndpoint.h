...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CALLENDPOINT
...
public:
	...
	static jni::ref<android::telecom::CallEndpoint> new_object(jni::ref<java::lang::CharSequence> name, jint type, jni::ref<android::os::ParcelUuid> id) { return object_base::new_object(name, type, id); }
