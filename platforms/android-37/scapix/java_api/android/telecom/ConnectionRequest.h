...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CONNECTIONREQUEST
...
public:
	...
	static jni::ref<android::telecom::ConnectionRequest> new_object(jni::ref<android::telecom::PhoneAccountHandle> accountHandle, jni::ref<android::net::Uri> handle, jni::ref<android::os::Bundle> extras) { return object_base::new_object(accountHandle, handle, extras); }
	static jni::ref<android::telecom::ConnectionRequest> new_object(jni::ref<android::telecom::PhoneAccountHandle> accountHandle, jni::ref<android::net::Uri> handle, jni::ref<android::os::Bundle> extras, jint videoState) { return object_base::new_object(accountHandle, handle, extras, videoState); }
