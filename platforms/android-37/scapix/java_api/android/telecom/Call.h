...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CALL
...
public:
	...
	static jint AUDIO_PROCESSING_USE_CASE_ASK_TO_HOLD() { return get_static_field<"AUDIO_PROCESSING_USE_CASE_ASK_TO_HOLD", jint>(); }
	static jint AUDIO_PROCESSING_USE_CASE_CALL_SCREENING() { return get_static_field<"AUDIO_PROCESSING_USE_CASE_CALL_SCREENING", jint>(); }
	static jint AUDIO_PROCESSING_USE_CASE_UNKNOWN() { return get_static_field<"AUDIO_PROCESSING_USE_CASE_UNKNOWN", jint>(); }
	static jint AUDIO_PROCESSING_USE_CASE_VOICEMAIL() { return get_static_field<"AUDIO_PROCESSING_USE_CASE_VOICEMAIL", jint>(); }
	...
	static jint CRS_MEDIA_TYPE_AUDIO() { return get_static_field<"CRS_MEDIA_TYPE_AUDIO", jint>(); }
	static jint CRS_MEDIA_TYPE_NONE() { return get_static_field<"CRS_MEDIA_TYPE_NONE", jint>(); }
	static jint CRS_MEDIA_TYPE_VIDEO() { return get_static_field<"CRS_MEDIA_TYPE_VIDEO", jint>(); }
	...
	static jni::ref<java::lang::String> EVENT_PHONE_ACCOUNT_CHANGED() { return get_static_field<"EVENT_PHONE_ACCOUNT_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_ASSERTED_DISPLAY_NAME() { return get_static_field<"EXTRA_ASSERTED_DISPLAY_NAME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_CRS_AUDIO_MODE() { return get_static_field<"EXTRA_CRS_AUDIO_MODE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_CRS_MEDIA_TYPE() { return get_static_field<"EXTRA_CRS_MEDIA_TYPE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_IS_BUSINESS_CALL() { return get_static_field<"EXTRA_IS_BUSINESS_CALL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_IS_SUPPRESSED_BY_DO_NOT_DISTURB() { return get_static_field<"EXTRA_IS_SUPPRESSED_BY_DO_NOT_DISTURB", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_IS_USING_UNIDIRECTIONAL_VIDEO_SERVICE() { return get_static_field<"EXTRA_IS_USING_UNIDIRECTIONAL_VIDEO_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_IS_USING_VIDEO_RINGBACK() { return get_static_field<"EXTRA_IS_USING_VIDEO_RINGBACK", jni::ref<java::lang::String>>(); }
	...
	void transfer(jni::ref<android::net::Uri> targetNumber, jboolean isConfirmationRequired) { return call_method<"transfer", void>(targetNumber, isConfirmationRequired); }
	void transfer(jni::ref<android::telecom::Call> toCall) { return call_method<"transfer", void>(toCall); }
