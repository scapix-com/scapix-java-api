...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CALL_DETAILS
...
public:
	...
	static jint DIRECTION_UNKNOWN() { return get_static_field<"DIRECTION_UNKNOWN", jint>(); }
	...
	static jint PROPERTY_IS_TRANSACTIONAL() { return get_static_field<"PROPERTY_IS_TRANSACTIONAL", jint>(); }
	...
	static jint PROPERTY_REMOTELY_HOSTED() { return get_static_field<"PROPERTY_REMOTELY_HOSTED", jint>(); }
	static jint PROPERTY_RTT() { return get_static_field<"PROPERTY_RTT", jint>(); }
	static jint PROPERTY_SELF_MANAGED() { return get_static_field<"PROPERTY_SELF_MANAGED", jint>(); }
	static jint PROPERTY_VOIP_AUDIO_MODE() { return get_static_field<"PROPERTY_VOIP_AUDIO_MODE", jint>(); }
	...
	jni::ref<android::os::UserHandle> getAssociatedUser() { return call_method<"getAssociatedUser", jni::ref<android::os::UserHandle>>(); }
	jint getCallCapabilities() { return call_method<"getCallCapabilities", jint>(); }
	jint getCallDirection() { return call_method<"getCallDirection", jint>(); }
	...
	jni::ref<java::lang::String> getContactDisplayName() { return call_method<"getContactDisplayName", jni::ref<java::lang::String>>(); }
	jni::ref<android::net::Uri> getContactPhotoUri() { return call_method<"getContactPhotoUri", jni::ref<android::net::Uri>>(); }
	jlong getCreationTimeMillis() { return call_method<"getCreationTimeMillis", jlong>(); }
