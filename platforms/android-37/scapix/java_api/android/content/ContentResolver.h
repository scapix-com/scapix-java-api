...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTRESOLVER
...
#include <scapix/java_api/android/content/ContentResolver_MimeTypeInfo.h>
...
public:
	...
	using MimeTypeInfo = ContentResolver_MimeTypeInfo;
	...
	static jni::ref<java::lang::String> EXTRA_HONORED_ARGS() { return get_static_field<"EXTRA_HONORED_ARGS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_REFRESH_SUPPORTED() { return get_static_field<"EXTRA_REFRESH_SUPPORTED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_SIZE() { return get_static_field<"EXTRA_SIZE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_TOTAL_COUNT() { return get_static_field<"EXTRA_TOTAL_COUNT", jni::ref<java::lang::String>>(); }
	static jint NOTIFY_DELETE() { return get_static_field<"NOTIFY_DELETE", jint>(); }
	static jint NOTIFY_INSERT() { return get_static_field<"NOTIFY_INSERT", jint>(); }
	...
	static jint NOTIFY_UPDATE() { return get_static_field<"NOTIFY_UPDATE", jint>(); }
	static jni::ref<java::lang::String> QUERY_ARG_GROUP_COLUMNS() { return get_static_field<"QUERY_ARG_GROUP_COLUMNS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_LIMIT() { return get_static_field<"QUERY_ARG_LIMIT", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_OFFSET() { return get_static_field<"QUERY_ARG_OFFSET", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SORT_COLLATION() { return get_static_field<"QUERY_ARG_SORT_COLLATION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SORT_COLUMNS() { return get_static_field<"QUERY_ARG_SORT_COLUMNS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SORT_DIRECTION() { return get_static_field<"QUERY_ARG_SORT_DIRECTION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SORT_LOCALE() { return get_static_field<"QUERY_ARG_SORT_LOCALE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SQL_GROUP_BY() { return get_static_field<"QUERY_ARG_SQL_GROUP_BY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SQL_HAVING() { return get_static_field<"QUERY_ARG_SQL_HAVING", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SQL_LIMIT() { return get_static_field<"QUERY_ARG_SQL_LIMIT", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SQL_SELECTION() { return get_static_field<"QUERY_ARG_SQL_SELECTION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SQL_SELECTION_ARGS() { return get_static_field<"QUERY_ARG_SQL_SELECTION_ARGS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> QUERY_ARG_SQL_SORT_ORDER() { return get_static_field<"QUERY_ARG_SQL_SORT_ORDER", jni::ref<java::lang::String>>(); }
	static jint QUERY_SORT_DIRECTION_ASCENDING() { return get_static_field<"QUERY_SORT_DIRECTION_ASCENDING", jint>(); }
	static jint QUERY_SORT_DIRECTION_DESCENDING() { return get_static_field<"QUERY_SORT_DIRECTION_DESCENDING", jint>(); }
	...
	static jni::ref<java::lang::String> SYNC_EXTRAS_SCHEDULE_AS_EXPEDITED_JOB() { return get_static_field<"SYNC_EXTRAS_SCHEDULE_AS_EXPEDITED_JOB", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::content::ContentResolver> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	jint delete_(jni::ref<android::net::Uri> url, jni::ref<android::os::Bundle> extras) { return call_method<"delete", jint>(url, extras); }
	...
	jni::ref<android::content::ContentResolver_MimeTypeInfo> getTypeInfo(jni::ref<java::lang::String> mimeType) { return call_method<"getTypeInfo", jni::ref<android::content::ContentResolver_MimeTypeInfo>>(mimeType); }
	...
	jni::ref<android::net::Uri> insert(jni::ref<android::net::Uri> url, jni::ref<android::content::ContentValues> values, jni::ref<android::os::Bundle> extras) { return call_method<"insert", jni::ref<android::net::Uri>>(url, values, extras); }
	...
	jni::ref<android::graphics::Bitmap> loadThumbnail(jni::ref<android::net::Uri> uri, jni::ref<android::util::Size> size, jni::ref<android::os::CancellationSignal> signal) { return call_method<"loadThumbnail", jni::ref<android::graphics::Bitmap>>(uri, size, signal); }
	...
	void notifyChange(jni::ref<java::util::Collection> uris, jni::ref<android::database::ContentObserver> observer, jint flags) { return call_method<"notifyChange", void>(uris, observer, flags); }
	...
	jboolean refresh(jni::ref<android::net::Uri> url, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"refresh", jboolean>(url, extras, cancellationSignal); }
	...
	jint update(jni::ref<android::net::Uri> uri, jni::ref<android::content::ContentValues> values, jni::ref<android::os::Bundle> extras) { return call_method<"update", jint>(uri, values, extras); }
	...
	static jni::ref<android::content::ContentResolver> wrap(jni::ref<android::content::ContentProvider> wrapped) { return call_static_method<"wrap", jni::ref<android::content::ContentResolver>>(wrapped); }
	static jni::ref<android::content::ContentResolver> wrap(jni::ref<android::content::ContentProviderClient> wrapped) { return call_static_method<"wrap", jni::ref<android::content::ContentResolver>>(wrapped); }
};
