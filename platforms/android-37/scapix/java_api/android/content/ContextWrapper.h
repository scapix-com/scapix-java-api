...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTEXTWRAPPER
...
public:
	...
	static jni::ref<android::content::ContextWrapper> new_object(jni::ref<android::content::Context> base) { return object_base::new_object(base); }
	...
	jni::ref<android::content::Context> createContextForSplit(jni::ref<java::lang::String> splitName) { return call_method<"createContextForSplit", jni::ref<android::content::Context>>(splitName); }
	...
	jni::ref<android::content::Intent> registerReceiver(jni::ref<android::content::BroadcastReceiver> receiver, jni::ref<android::content::IntentFilter> filter, jint flags) { return call_method<"registerReceiver", jni::ref<android::content::Intent>>(receiver, filter, flags); }
	...
	jni::ref<android::content::Intent> registerReceiver(jni::ref<android::content::BroadcastReceiver> receiver, jni::ref<android::content::IntentFilter> filter, jni::ref<java::lang::String> broadcastPermission, jni::ref<android::os::Handler> scheduler, jint flags) { return call_method<"registerReceiver", jni::ref<android::content::Intent>>(receiver, filter, broadcastPermission, scheduler, flags); }
	...
	void revokeUriPermission(jni::ref<java::lang::String> targetPackage, jni::ref<android::net::Uri> uri, jint modeFlags) { return call_method<"revokeUriPermission", void>(targetPackage, uri, modeFlags); }
	...
	void sendOrderedBroadcast(jni::ref<android::content::Intent> intent, jint initialCode, jni::ref<java::lang::String> receiverPermission, jni::ref<java::lang::String> receiverAppOp, jni::ref<android::content::BroadcastReceiver> resultReceiver, jni::ref<android::os::Handler> scheduler, jni::ref<java::lang::String> initialData, jni::ref<android::os::Bundle> initialExtras, jni::ref<android::os::Bundle> options) { return call_method<"sendOrderedBroadcast", void>(intent, initialCode, receiverPermission, receiverAppOp, resultReceiver, scheduler, initialData, initialExtras, options); }
	...
	jni::ref<android::content::ComponentName> startForegroundService(jni::ref<android::content::Intent> service) { return call_method<"startForegroundService", jni::ref<android::content::ComponentName>>(service); }
