...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTEXT
...
#include <scapix/java_api/android/content/Context_UpdateBindingParams.h>
...
public:
	...
	using UpdateBindingParams = Context_UpdateBindingParams;
	using BindServiceFlags = Context_BindServiceFlags;
	...
	static jni::ref<java::lang::String> ADVANCED_PROTECTION_SERVICE() { return get_static_field<"ADVANCED_PROTECTION_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> APP_FUNCTION_SERVICE() { return get_static_field<"APP_FUNCTION_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> APP_OPS_SERVICE() { return get_static_field<"APP_OPS_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> APP_SEARCH_SERVICE() { return get_static_field<"APP_SEARCH_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> AUDIO_SERVICE() { return get_static_field<"AUDIO_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> AUTOFILL_SERVICE() { return get_static_field<"AUTOFILL_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jint BIND_ALLOW_ACTIVITY_STARTS() { return get_static_field<"BIND_ALLOW_ACTIVITY_STARTS", jint>(); }
	...
	static jlong BIND_EXTERNAL_SERVICE_LONG() { return get_static_field<"BIND_EXTERNAL_SERVICE_LONG", jlong>(); }
	static jint BIND_IMPORTANT() { return get_static_field<"BIND_IMPORTANT", jint>(); }
	static jint BIND_INCLUDE_CAPABILITIES() { return get_static_field<"BIND_INCLUDE_CAPABILITIES", jint>(); }
	static jint BIND_NOT_FOREGROUND() { return get_static_field<"BIND_NOT_FOREGROUND", jint>(); }
	static jint BIND_NOT_PERCEPTIBLE() { return get_static_field<"BIND_NOT_PERCEPTIBLE", jint>(); }
	static jint BIND_PACKAGE_ISOLATED_PROCESS() { return get_static_field<"BIND_PACKAGE_ISOLATED_PROCESS", jint>(); }
	static jint BIND_SHARED_ISOLATED_PROCESS() { return get_static_field<"BIND_SHARED_ISOLATED_PROCESS", jint>(); }
	static jint BIND_WAIVE_PRIORITY() { return get_static_field<"BIND_WAIVE_PRIORITY", jint>(); }
	static jni::ref<java::lang::String> BIOMETRIC_SERVICE() { return get_static_field<"BIOMETRIC_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> BLOB_STORE_SERVICE() { return get_static_field<"BLOB_STORE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> BLUETOOTH_SERVICE() { return get_static_field<"BLUETOOTH_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> BUGREPORT_SERVICE() { return get_static_field<"BUGREPORT_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> CHOOSER_SERVICE() { return get_static_field<"CHOOSER_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CLIPBOARD_SERVICE() { return get_static_field<"CLIPBOARD_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> COMPANION_DEVICE_SERVICE() { return get_static_field<"COMPANION_DEVICE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CONNECTIVITY_DIAGNOSTICS_SERVICE() { return get_static_field<"CONNECTIVITY_DIAGNOSTICS_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> CONTACT_KEYS_SERVICE() { return get_static_field<"CONTACT_KEYS_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> CREDENTIAL_SERVICE() { return get_static_field<"CREDENTIAL_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> CROSS_PROFILE_APPS_SERVICE() { return get_static_field<"CROSS_PROFILE_APPS_SERVICE", jni::ref<java::lang::String>>(); }
	static jint DEVICE_ID_DEFAULT() { return get_static_field<"DEVICE_ID_DEFAULT", jint>(); }
	static jint DEVICE_ID_INVALID() { return get_static_field<"DEVICE_ID_INVALID", jint>(); }
	static jni::ref<java::lang::String> DEVICE_LOCK_SERVICE() { return get_static_field<"DEVICE_LOCK_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DISPLAY_HASH_SERVICE() { return get_static_field<"DISPLAY_HASH_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DISPLAY_SERVICE() { return get_static_field<"DISPLAY_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DOMAIN_VERIFICATION_SERVICE() { return get_static_field<"DOMAIN_VERIFICATION_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EUICC_SERVICE() { return get_static_field<"EUICC_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FILE_INTEGRITY_SERVICE() { return get_static_field<"FILE_INTEGRITY_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FILE_SERVICE() { return get_static_field<"FILE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> GAME_SERVICE() { return get_static_field<"GAME_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> GRAMMATICAL_INFLECTION_SERVICE() { return get_static_field<"GRAMMATICAL_INFLECTION_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> HEALTHCONNECT_SERVICE() { return get_static_field<"HEALTHCONNECT_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> IPSEC_SERVICE() { return get_static_field<"IPSEC_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> KEYSTORE_SERVICE() { return get_static_field<"KEYSTORE_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> LOCALE_SERVICE() { return get_static_field<"LOCALE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> LOCATION_SERVICE() { return get_static_field<"LOCATION_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> MEDIA_COMMUNICATION_SERVICE() { return get_static_field<"MEDIA_COMMUNICATION_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> MEDIA_METRICS_SERVICE() { return get_static_field<"MEDIA_METRICS_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> MEDIA_QUALITY_SERVICE() { return get_static_field<"MEDIA_QUALITY_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> NPU_SERVICE() { return get_static_field<"NPU_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> NSD_SERVICE() { return get_static_field<"NSD_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> OVERLAY_SERVICE() { return get_static_field<"OVERLAY_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PCC_SANDBOX_SERVICE() { return get_static_field<"PCC_SANDBOX_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PEOPLE_SERVICE() { return get_static_field<"PEOPLE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PERFORMANCE_HINT_SERVICE() { return get_static_field<"PERFORMANCE_HINT_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PERSISTENT_DATA_BLOCK_SERVICE() { return get_static_field<"PERSISTENT_DATA_BLOCK_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> PROFILING_SERVICE() { return get_static_field<"PROFILING_SERVICE", jni::ref<java::lang::String>>(); }
	static jint RECEIVER_EXPORTED() { return get_static_field<"RECEIVER_EXPORTED", jint>(); }
	static jint RECEIVER_NOT_EXPORTED() { return get_static_field<"RECEIVER_NOT_EXPORTED", jint>(); }
	static jint RECEIVER_VISIBLE_TO_INSTANT_APPS() { return get_static_field<"RECEIVER_VISIBLE_TO_INSTANT_APPS", jint>(); }
	...
	static jni::ref<java::lang::String> ROLE_SERVICE() { return get_static_field<"ROLE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SATELLITE_SERVICE() { return get_static_field<"SATELLITE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SEARCH_SERVICE() { return get_static_field<"SEARCH_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SECURITY_STATE_SERVICE() { return get_static_field<"SECURITY_STATE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SENSOR_SERVICE() { return get_static_field<"SENSOR_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SERIAL_SERVICE() { return get_static_field<"SERIAL_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SHORTCUT_SERVICE() { return get_static_field<"SHORTCUT_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> STATUS_BAR_SERVICE() { return get_static_field<"STATUS_BAR_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> STORAGE_SERVICE() { return get_static_field<"STORAGE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> STORAGE_STATS_SERVICE() { return get_static_field<"STORAGE_STATS_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> TELEPHONY_IMS_SERVICE() { return get_static_field<"TELEPHONY_IMS_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> TELEPHONY_PHONE_NUMBER_SERVICE() { return get_static_field<"TELEPHONY_PHONE_NUMBER_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> TETHERING_SERVICE() { return get_static_field<"TETHERING_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> TEXT_CLASSIFICATION_SERVICE() { return get_static_field<"TEXT_CLASSIFICATION_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> TV_AD_SERVICE() { return get_static_field<"TV_AD_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> TV_INPUT_SERVICE() { return get_static_field<"TV_INPUT_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> TV_INTERACTIVE_APP_SERVICE() { return get_static_field<"TV_INTERACTIVE_APP_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> VIBRATOR_MANAGER_SERVICE() { return get_static_field<"VIBRATOR_MANAGER_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VIBRATOR_SERVICE() { return get_static_field<"VIBRATOR_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VIRTUAL_DEVICE_SERVICE() { return get_static_field<"VIRTUAL_DEVICE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> VPN_MANAGEMENT_SERVICE() { return get_static_field<"VPN_MANAGEMENT_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> WALLPAPER_SERVICE() { return get_static_field<"WALLPAPER_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> WEB_APP_SERVICE() { return get_static_field<"WEB_APP_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> WIFI_AWARE_SERVICE() { return get_static_field<"WIFI_AWARE_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> WIFI_P2P_SERVICE() { return get_static_field<"WIFI_P2P_SERVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> WIFI_RTT_RANGING_SERVICE() { return get_static_field<"WIFI_RTT_RANGING_SERVICE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::content::Context> new_object() { return object_base::new_object(); }
	jboolean bindIsolatedService(jni::ref<android::content::Intent> service, jni::ref<android::content::Context_BindServiceFlags> flags, jni::ref<java::lang::String> instanceName, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::content::ServiceConnection> conn) { return call_method<"bindIsolatedService", jboolean>(service, flags, instanceName, executor, conn); }
	jboolean bindIsolatedService(jni::ref<android::content::Intent> service, jint flags, jni::ref<java::lang::String> instanceName, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::content::ServiceConnection> conn) { return call_method<"bindIsolatedService", jboolean>(service, flags, instanceName, executor, conn); }
	jboolean bindService(jni::ref<android::content::Intent> service, jni::ref<android::content::Context_BindServiceFlags> flags, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::content::ServiceConnection> conn) { return call_method<"bindService", jboolean>(service, flags, executor, conn); }
	jboolean bindService(jni::ref<android::content::Intent> service, jni::ref<android::content::ServiceConnection> conn, jni::ref<android::content::Context_BindServiceFlags> flags) { return call_method<"bindService", jboolean>(service, conn, flags); }
	...
	jboolean bindService(jni::ref<android::content::Intent> service, jint flags, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::content::ServiceConnection> conn) { return call_method<"bindService", jboolean>(service, flags, executor, conn); }
	jboolean bindServiceAsUser(jni::ref<android::content::Intent> service, jni::ref<android::content::ServiceConnection> conn, jni::ref<android::content::Context_BindServiceFlags> flags, jni::ref<android::os::UserHandle> user) { return call_method<"bindServiceAsUser", jboolean>(service, conn, flags, user); }
	jboolean bindServiceAsUser(jni::ref<android::content::Intent> service, jni::ref<android::content::ServiceConnection> conn, jint flags, jni::ref<android::os::UserHandle> user) { return call_method<"bindServiceAsUser", jboolean>(service, conn, flags, user); }
	...
	jni::ref<jni::array<jint>> checkCallingOrSelfUriPermissions(jni::ref<java::util::List> uris, jint modeFlags) { return call_method<"checkCallingOrSelfUriPermissions", jni::ref<jni::array<jint>>>(uris, modeFlags); }
	...
	jni::ref<jni::array<jint>> checkCallingUriPermissions(jni::ref<java::util::List> uris, jint modeFlags) { return call_method<"checkCallingUriPermissions", jni::ref<jni::array<jint>>>(uris, modeFlags); }
	jint checkContentUriPermissionFull(jni::ref<android::net::Uri> uri, jint pid, jint uid, jint modeFlags) { return call_method<"checkContentUriPermissionFull", jint>(uri, pid, uid, modeFlags); }
	...
	jni::ref<jni::array<jint>> checkUriPermissions(jni::ref<java::util::List> uris, jint pid, jint uid, jint modeFlags) { return call_method<"checkUriPermissions", jni::ref<jni::array<jint>>>(uris, pid, uid, modeFlags); }
	void clearWallpaper() { return call_method<"clearWallpaper", void>(); }
	jni::ref<android::content::Context> createAttributionContext(jni::ref<java::lang::String> attributionTag) { return call_method<"createAttributionContext", jni::ref<android::content::Context>>(attributionTag); }
	...
	jni::ref<android::content::Context> createContextForSplit(jni::ref<java::lang::String> p1) { return call_method<"createContextForSplit", jni::ref<android::content::Context>>(p1); }
	jni::ref<android::content::Context> createDeviceContext(jint deviceId) { return call_method<"createDeviceContext", jni::ref<android::content::Context>>(deviceId); }
	...
	jni::ref<android::content::Context> createWindowContext(jni::ref<android::view::Display> display, jint type, jni::ref<android::os::Bundle> options) { return call_method<"createWindowContext", jni::ref<android::content::Context>>(display, type, options); }
	jni::ref<android::content::Context> createWindowContext(jint type, jni::ref<android::os::Bundle> options) { return call_method<"createWindowContext", jni::ref<android::content::Context>>(type, options); }
	...
	jni::ref<android::content::AttributionSource> getAttributionSource() { return call_method<"getAttributionSource", jni::ref<android::content::AttributionSource>>(); }
	...
	jni::ref<java::util::concurrent::Executor> getMainExecutor() { return call_method<"getMainExecutor", jni::ref<java::util::concurrent::Executor>>(); }
	...
	jni::ref<java::lang::String> getOpPackageName() { return call_method<"getOpPackageName", jni::ref<java::lang::String>>(); }
	...
	jni::ref<android::content::ContextParams> getParams() { return call_method<"getParams", jni::ref<android::content::ContextParams>>(); }
	...
	jni::ref<android::content::Context_BindServiceFlags> getUpdateableFlags() { return call_method<"getUpdateableFlags", jni::ref<android::content::Context_BindServiceFlags>>(); }
	...
	void rebindService(jni::ref<android::content::ServiceConnection> conn, jni::ref<android::content::Context_BindServiceFlags> flags) { return call_method<"rebindService", void>(conn, flags); }
	...
	void registerDeviceIdChangeListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::IntConsumer> listener) { return call_method<"registerDeviceIdChangeListener", void>(executor, listener); }
	...
	jni::ref<android::content::Intent> registerReceiver(jni::ref<android::content::BroadcastReceiver> p1, jni::ref<android::content::IntentFilter> p2, jint p3) { return call_method<"registerReceiver", jni::ref<android::content::Intent>>(p1, p2, p3); }
	...
	jni::ref<android::content::Intent> registerReceiver(jni::ref<android::content::BroadcastReceiver> p1, jni::ref<android::content::IntentFilter> p2, jni::ref<java::lang::String> p3, jni::ref<android::os::Handler> p4, jint p5) { return call_method<"registerReceiver", jni::ref<android::content::Intent>>(p1, p2, p3, p4, p5); }
	...
	void revokeSelfPermissionOnKill(jni::ref<java::lang::String> permName) { return call_method<"revokeSelfPermissionOnKill", void>(permName); }
	void revokeSelfPermissionsOnKill(jni::ref<java::util::Collection> permissions) { return call_method<"revokeSelfPermissionsOnKill", void>(permissions); }
	void revokeUriPermission(jni::ref<android::net::Uri> p1, jint p2) { return call_method<"revokeUriPermission", void>(p1, p2); }
	void revokeUriPermission(jni::ref<java::lang::String> p1, jni::ref<android::net::Uri> p2, jint p3) { return call_method<"revokeUriPermission", void>(p1, p2, p3); }
	...
	void sendBroadcast(jni::ref<android::content::Intent> intent, jni::ref<java::lang::String> receiverPermission, jni::ref<android::os::Bundle> options) { return call_method<"sendBroadcast", void>(intent, receiverPermission, options); }
	...
	void sendBroadcastWithMultiplePermissions(jni::ref<android::content::Intent> intent, jni::ref<jni::array<java::lang::String>> receiverPermissions) { return call_method<"sendBroadcastWithMultiplePermissions", void>(intent, receiverPermissions); }
	...
	void sendOrderedBroadcast(jni::ref<android::content::Intent> intent, jni::ref<java::lang::String> receiverPermission, jni::ref<android::os::Bundle> options) { return call_method<"sendOrderedBroadcast", void>(intent, receiverPermission, options); }
	void sendOrderedBroadcast(jni::ref<android::content::Intent> intent, jni::ref<java::lang::String> receiverPermission, jni::ref<android::os::Bundle> options, jni::ref<android::content::BroadcastReceiver> resultReceiver, jni::ref<android::os::Handler> scheduler, jint initialCode, jni::ref<java::lang::String> initialData, jni::ref<android::os::Bundle> initialExtras) { return call_method<"sendOrderedBroadcast", void>(intent, receiverPermission, options, resultReceiver, scheduler, initialCode, initialData, initialExtras); }
	void sendOrderedBroadcast(jni::ref<android::content::Intent> intent, jni::ref<java::lang::String> receiverPermission, jni::ref<java::lang::String> receiverAppOp, jni::ref<android::content::BroadcastReceiver> resultReceiver, jni::ref<android::os::Handler> scheduler, jint initialCode, jni::ref<java::lang::String> initialData, jni::ref<android::os::Bundle> initialExtras) { return call_method<"sendOrderedBroadcast", void>(intent, receiverPermission, receiverAppOp, resultReceiver, scheduler, initialCode, initialData, initialExtras); }
	...
	void sendStickyBroadcast(jni::ref<android::content::Intent> intent, jni::ref<android::os::Bundle> options) { return call_method<"sendStickyBroadcast", void>(intent, options); }
	...
	jni::ref<android::content::ComponentName> startForegroundService(jni::ref<android::content::Intent> p1) { return call_method<"startForegroundService", jni::ref<android::content::ComponentName>>(p1); }
	...
	void unregisterDeviceIdChangeListener(jni::ref<java::util::function::IntConsumer> listener) { return call_method<"unregisterDeviceIdChangeListener", void>(listener); }
	void unregisterReceiver(jni::ref<android::content::BroadcastReceiver> p1) { return call_method<"unregisterReceiver", void>(p1); }
	void updateServiceBindings(jni::ref<java::util::Collection> params) { return call_method<"updateServiceBindings", void>(params); }
	void updateServiceGroup(jni::ref<android::content::ServiceConnection> conn, jint group, jint importance) { return call_method<"updateServiceGroup", void>(conn, group, importance); }
};
