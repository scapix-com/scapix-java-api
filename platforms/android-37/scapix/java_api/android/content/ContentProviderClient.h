...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTPROVIDERCLIENT
...
public:
	...
	jni::ref<android::net::Uri> insert(jni::ref<android::net::Uri> url, jni::ref<android::content::ContentValues> initialValues, jni::ref<android::os::Bundle> extras) { return call_method<"insert", jni::ref<android::net::Uri>>(url, initialValues, extras); }
	...
	jint update(jni::ref<android::net::Uri> url, jni::ref<android::content::ContentValues> values, jni::ref<android::os::Bundle> extras) { return call_method<"update", jint>(url, values, extras); }
