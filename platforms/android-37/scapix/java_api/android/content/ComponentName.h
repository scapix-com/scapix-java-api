...
struct scapix::jni::object_traits<scapix::java_api::android::content::ComponentName>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::lang::Comparable, scapix::java_api::android::os::Parcelable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_COMPONENTNAME
...
public:
	...
	static jni::ref<android::content::ComponentName> new_object(jni::ref<android::content::Context> pkg, jni::ref<java::lang::Class> cls) { return object_base::new_object(pkg, cls); }
	static jni::ref<android::content::ComponentName> new_object(jni::ref<android::content::Context> pkg, jni::ref<java::lang::String> cls) { return object_base::new_object(pkg, cls); }
	static jni::ref<android::content::ComponentName> new_object(jni::ref<android::os::Parcel> in) { return object_base::new_object(in); }
	static jni::ref<android::content::ComponentName> new_object(jni::ref<java::lang::String> pkg, jni::ref<java::lang::String> cls) { return object_base::new_object(pkg, cls); }
	...
	static jni::ref<android::content::ComponentName> createRelative(jni::ref<android::content::Context> pkg, jni::ref<java::lang::String> cls) { return call_static_method<"createRelative", jni::ref<android::content::ComponentName>>(pkg, cls); }
	static jni::ref<android::content::ComponentName> createRelative(jni::ref<java::lang::String> pkg, jni::ref<java::lang::String> cls) { return call_static_method<"createRelative", jni::ref<android::content::ComponentName>>(pkg, cls); }
