...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_RESOLVEINFO
...
public:
	...
	jboolean isInstantAppAvailable() { return get_field<"isInstantAppAvailable", jboolean>(); }
	void isInstantAppAvailable(jboolean v) { set_field<"isInstantAppAvailable", jboolean>(v); }
	...
	static jni::ref<android::content::pm::ResolveInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::ResolveInfo> new_object(jni::ref<android::content::pm::ResolveInfo> orig) { return object_base::new_object(orig); }
	...
	jboolean isCrossProfileIntentForwarderActivity() { return call_method<"isCrossProfileIntentForwarderActivity", jboolean>(); }
