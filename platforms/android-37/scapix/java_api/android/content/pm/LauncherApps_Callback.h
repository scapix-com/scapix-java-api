...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_LAUNCHERAPPS_CALLBACK
...
public:
	...
	static jni::ref<android::content::pm::LauncherApps_Callback> new_object() { return object_base::new_object(); }
	...
	void onPackageLoadingProgressChanged(jni::ref<java::lang::String> packageName, jni::ref<android::os::UserHandle> user, jfloat progress) { return call_method<"onPackageLoadingProgressChanged", void>(packageName, user, progress); }
	...
	void onUserConfigChanged(jni::ref<android::content::pm::LauncherUserInfo> launcherUserInfo) { return call_method<"onUserConfigChanged", void>(launcherUserInfo); }
};
