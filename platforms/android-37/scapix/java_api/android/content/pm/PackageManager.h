...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGEMANAGER
...
#include <scapix/java_api/android/content/pm/ArchivedPackageInfo.h>
...
#include <scapix/java_api/android/content/pm/PackageManager_ApplicationInfoFlags.h>
#include <scapix/java_api/android/content/pm/PackageManager_ComponentInfoFlags.h>
#include <scapix/java_api/android/content/pm/PackageManager_OnChecksumsReadyListener.h>
#include <scapix/java_api/android/content/pm/PackageManager_PackageInfoFlags.h>
#include <scapix/java_api/android/content/pm/PackageManager_Property.h>
#include <scapix/java_api/android/content/pm/PackageManager_ResolveInfoFlags.h>
...
#include <scapix/java_api/android/content/pm/PackageManager_ComponentEnabledSetting.h>
...
public:
	...
	using ResolveInfoFlags = PackageManager_ResolveInfoFlags;
	using Property = PackageManager_Property;
	using PackageInfoFlags = PackageManager_PackageInfoFlags;
	...
	using ComponentInfoFlags = PackageManager_ComponentInfoFlags;
	using ComponentEnabledSetting = PackageManager_ComponentEnabledSetting;
	using ApplicationInfoFlags = PackageManager_ApplicationInfoFlags;
	...
	static jint DELETE_ARCHIVE() { return get_static_field<"DELETE_ARCHIVE", jint>(); }
	...
	static jni::ref<java::lang::String> FEATURE_AUDIO_SPATIAL_HEADTRACKING_LOW_LATENCY() { return get_static_field<"FEATURE_AUDIO_SPATIAL_HEADTRACKING_LOW_LATENCY", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_BLUETOOTH_LE_CHANNEL_SOUNDING() { return get_static_field<"FEATURE_BLUETOOTH_LE_CHANNEL_SOUNDING", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_CREDENTIALS() { return get_static_field<"FEATURE_CREDENTIALS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_DEVICE_ID_ATTESTATION() { return get_static_field<"FEATURE_DEVICE_ID_ATTESTATION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_DEVICE_LOCK() { return get_static_field<"FEATURE_DEVICE_LOCK", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_EXPANDED_PICTURE_IN_PICTURE() { return get_static_field<"FEATURE_EXPANDED_PICTURE_IN_PICTURE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_IPSEC_TUNNEL_MIGRATION() { return get_static_field<"FEATURE_IPSEC_TUNNEL_MIGRATION", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_NEURAL_PROCESSING_UNIT() { return get_static_field<"FEATURE_NEURAL_PROCESSING_UNIT", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_SENSOR_ACCELEROMETER_LIMITED_AXES() { return get_static_field<"FEATURE_SENSOR_ACCELEROMETER_LIMITED_AXES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_SENSOR_ACCELEROMETER_LIMITED_AXES_UNCALIBRATED() { return get_static_field<"FEATURE_SENSOR_ACCELEROMETER_LIMITED_AXES_UNCALIBRATED", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_SENSOR_DYNAMIC_HEAD_TRACKER() { return get_static_field<"FEATURE_SENSOR_DYNAMIC_HEAD_TRACKER", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_SENSOR_GYROSCOPE_LIMITED_AXES() { return get_static_field<"FEATURE_SENSOR_GYROSCOPE_LIMITED_AXES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_SENSOR_GYROSCOPE_LIMITED_AXES_UNCALIBRATED() { return get_static_field<"FEATURE_SENSOR_GYROSCOPE_LIMITED_AXES_UNCALIBRATED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_SENSOR_HEADING() { return get_static_field<"FEATURE_SENSOR_HEADING", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_TELECOM() { return get_static_field<"FEATURE_TELECOM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_TELEPHONY() { return get_static_field<"FEATURE_TELEPHONY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_TELEPHONY_CALLING() { return get_static_field<"FEATURE_TELEPHONY_CALLING", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_TELEPHONY_DATA() { return get_static_field<"FEATURE_TELEPHONY_DATA", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_TELEPHONY_EUICC_MEP() { return get_static_field<"FEATURE_TELEPHONY_EUICC_MEP", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_TELEPHONY_MESSAGING() { return get_static_field<"FEATURE_TELEPHONY_MESSAGING", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_TELEPHONY_RADIO_ACCESS() { return get_static_field<"FEATURE_TELEPHONY_RADIO_ACCESS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_TELEPHONY_SUBSCRIPTION() { return get_static_field<"FEATURE_TELEPHONY_SUBSCRIPTION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_TELEVISION() { return get_static_field<"FEATURE_TELEVISION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> FEATURE_THREAD_NETWORK() { return get_static_field<"FEATURE_THREAD_NETWORK", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_UWB() { return get_static_field<"FEATURE_UWB", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_WALLET_LOCATION_BASED_SUGGESTIONS() { return get_static_field<"FEATURE_WALLET_LOCATION_BASED_SUGGESTIONS", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> FEATURE_WINDOW_MAGNIFICATION() { return get_static_field<"FEATURE_WINDOW_MAGNIFICATION", jni::ref<java::lang::String>>(); }
	...
	static jlong GET_ATTRIBUTIONS_LONG() { return get_static_field<"GET_ATTRIBUTIONS_LONG", jlong>(); }
	...
	static jlong MATCH_ARCHIVED_PACKAGES() { return get_static_field<"MATCH_ARCHIVED_PACKAGES", jlong>(); }
	...
	static jni::ref<java::lang::String> PROPERTY_COMPAT_OVERRIDE_LANDSCAPE_TO_PORTRAIT() { return get_static_field<"PROPERTY_COMPAT_OVERRIDE_LANDSCAPE_TO_PORTRAIT", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> PROPERTY_NATIVE_SERVICE_FUNCTION_NAME() { return get_static_field<"PROPERTY_NATIVE_SERVICE_FUNCTION_NAME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PROPERTY_NATIVE_SERVICE_LIBRARY_NAME() { return get_static_field<"PROPERTY_NATIVE_SERVICE_LIBRARY_NAME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PROPERTY_SELF_CERTIFIED_NETWORK_CAPABILITIES() { return get_static_field<"PROPERTY_SELF_CERTIFIED_NETWORK_CAPABILITIES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PROPERTY_SPECIAL_USE_FGS_SUBTYPE() { return get_static_field<"PROPERTY_SPECIAL_USE_FGS_SUBTYPE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PROPERTY_USE_RESTRICTED_BACKUP_MODE() { return get_static_field<"PROPERTY_USE_RESTRICTED_BACKUP_MODE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::content::pm::PackageManager> new_object() { return object_base::new_object(); }
	...
	jboolean canPackageQuery(jni::ref<java::lang::String> sourcePackageName, jni::ref<java::lang::String> targetPackageName) { return call_method<"canPackageQuery", jboolean>(sourcePackageName, targetPackageName); }
	jni::ref<jni::array<jboolean>> canPackageQuery(jni::ref<java::lang::String> sourcePackageName, jni::ref<jni::array<java::lang::String>> targetPackageNames) { return call_method<"canPackageQuery", jni::ref<jni::array<jboolean>>>(sourcePackageName, targetPackageNames); }
	...
	jni::ref<android::content::pm::ActivityInfo> getActivityInfo(jni::ref<android::content::ComponentName> component, jni::ref<android::content::pm::PackageManager_ComponentInfoFlags> flags) { return call_method<"getActivityInfo", jni::ref<android::content::pm::ActivityInfo>>(component, flags); }
	...
	jint getAppUidForPrivateComputeCoreUid(jint pccUid) { return call_method<"getAppUidForPrivateComputeCoreUid", jint>(pccUid); }
	...
	jni::ref<android::content::pm::ApplicationInfo> getApplicationInfo(jni::ref<java::lang::String> packageName, jni::ref<android::content::pm::PackageManager_ApplicationInfoFlags> flags) { return call_method<"getApplicationInfo", jni::ref<android::content::pm::ApplicationInfo>>(packageName, flags); }
	...
	jni::ref<android::content::pm::ArchivedPackageInfo> getArchivedPackage(jni::ref<java::lang::String> packageName) { return call_method<"getArchivedPackage", jni::ref<android::content::pm::ArchivedPackageInfo>>(packageName); }
	...
	jni::ref<java::util::List> getInstalledApplications(jni::ref<android::content::pm::PackageManager_ApplicationInfoFlags> flags) { return call_method<"getInstalledApplications", jni::ref<java::util::List>>(flags); }
	...
	jni::ref<java::util::List> getInstalledPackages(jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getInstalledPackages", jni::ref<java::util::List>>(flags); }
	...
	jni::ref<android::content::IntentSender> getLaunchIntentSenderForPackage(jni::ref<java::lang::String> packageName) { return call_method<"getLaunchIntentSenderForPackage", jni::ref<android::content::IntentSender>>(packageName); }
	...
	jni::ref<android::content::pm::PackageInfo> getPackageArchiveInfo(jni::ref<java::lang::String> archiveFilePath, jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getPackageArchiveInfo", jni::ref<android::content::pm::PackageInfo>>(archiveFilePath, flags); }
	...
	jni::ref<jni::array<jint>> getPackageGids(jni::ref<java::lang::String> packageName, jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getPackageGids", jni::ref<jni::array<jint>>>(packageName, flags); }
	...
	jni::ref<android::content::pm::PackageInfo> getPackageInfo(jni::ref<android::content::pm::VersionedPackage> versionedPackage, jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getPackageInfo", jni::ref<android::content::pm::PackageInfo>>(versionedPackage, flags); }
	...
	jni::ref<android::content::pm::PackageInfo> getPackageInfo(jni::ref<java::lang::String> packageName, jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getPackageInfo", jni::ref<android::content::pm::PackageInfo>>(packageName, flags); }
	...
	jint getPackageUid(jni::ref<java::lang::String> packageName, jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getPackageUid", jint>(packageName, flags); }
	...
	jni::ref<java::util::List> getPackagesHoldingPermissions(jni::ref<jni::array<java::lang::String>> permissions, jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getPackagesHoldingPermissions", jni::ref<java::util::List>>(permissions, flags); }
	...
	jni::ref<android::content::pm::ProviderInfo> getProviderInfo(jni::ref<android::content::ComponentName> component, jni::ref<android::content::pm::PackageManager_ComponentInfoFlags> flags) { return call_method<"getProviderInfo", jni::ref<android::content::pm::ProviderInfo>>(component, flags); }
	...
	jni::ref<android::content::pm::ActivityInfo> getReceiverInfo(jni::ref<android::content::ComponentName> component, jni::ref<android::content::pm::PackageManager_ComponentInfoFlags> flags) { return call_method<"getReceiverInfo", jni::ref<android::content::pm::ActivityInfo>>(component, flags); }
	...
	jni::ref<android::content::pm::ServiceInfo> getServiceInfo(jni::ref<android::content::ComponentName> component, jni::ref<android::content::pm::PackageManager_ComponentInfoFlags> flags) { return call_method<"getServiceInfo", jni::ref<android::content::pm::ServiceInfo>>(component, flags); }
	...
	jni::ref<java::util::List> getSharedLibraries(jni::ref<android::content::pm::PackageManager_PackageInfoFlags> flags) { return call_method<"getSharedLibraries", jni::ref<java::util::List>>(flags); }
	...
	static jni::ref<android::content::pm::SigningInfo> getVerifiedSigningInfo(jni::ref<java::lang::String> path, jint minAppSigningSchemeVersion) { return call_static_method<"getVerifiedSigningInfo", jni::ref<android::content::pm::SigningInfo>>(path, minAppSigningSchemeVersion); }
	...
	jboolean isAppArchivable(jni::ref<java::lang::String> packageName) { return call_method<"isAppArchivable", jboolean>(packageName); }
	...
	jboolean isPackageStopped(jni::ref<java::lang::String> packageName) { return call_method<"isPackageStopped", jboolean>(packageName); }
	...
	jni::ref<java::lang::Object> parseAndroidManifest(jni::ref<android::os::ParcelFileDescriptor> apkFileDescriptor, jni::ref<java::util::function::Function> parserFunction) { return call_method<"parseAndroidManifest", jni::ref<java::lang::Object>>(apkFileDescriptor, parserFunction); }
	jni::ref<java::lang::Object> parseAndroidManifest(jni::ref<java::io::File> apkFile, jni::ref<java::util::function::Function> parserFunction) { return call_method<"parseAndroidManifest", jni::ref<java::lang::Object>>(apkFile, parserFunction); }
	...
	jni::ref<java::util::List> queryBroadcastReceivers(jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"queryBroadcastReceivers", jni::ref<java::util::List>>(intent, flags); }
	...
	jni::ref<java::util::List> queryContentProviders(jni::ref<java::lang::String> processName, jint uid, jni::ref<android::content::pm::PackageManager_ComponentInfoFlags> flags) { return call_method<"queryContentProviders", jni::ref<java::util::List>>(processName, uid, flags); }
	...
	jni::ref<java::util::List> queryIntentActivities(jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"queryIntentActivities", jni::ref<java::util::List>>(intent, flags); }
	...
	jni::ref<java::util::List> queryIntentActivityOptions(jni::ref<android::content::ComponentName> caller, jni::ref<java::util::List> specifics, jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"queryIntentActivityOptions", jni::ref<java::util::List>>(caller, specifics, intent, flags); }
	jni::ref<java::util::List> queryIntentContentProviders(jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"queryIntentContentProviders", jni::ref<java::util::List>>(intent, flags); }
	...
	jni::ref<java::util::List> queryIntentServices(jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"queryIntentServices", jni::ref<java::util::List>>(intent, flags); }
	...
	void relinquishUpdateOwnership(jni::ref<java::lang::String> targetPackage) { return call_method<"relinquishUpdateOwnership", void>(targetPackage); }
	...
	jni::ref<android::content::pm::ResolveInfo> resolveActivity(jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"resolveActivity", jni::ref<android::content::pm::ResolveInfo>>(intent, flags); }
	...
	jni::ref<android::content::pm::ProviderInfo> resolveContentProvider(jni::ref<java::lang::String> authority, jni::ref<android::content::pm::PackageManager_ComponentInfoFlags> flags) { return call_method<"resolveContentProvider", jni::ref<android::content::pm::ProviderInfo>>(authority, flags); }
	...
	jni::ref<android::content::pm::ResolveInfo> resolveService(jni::ref<android::content::Intent> intent, jni::ref<android::content::pm::PackageManager_ResolveInfoFlags> flags) { return call_method<"resolveService", jni::ref<android::content::pm::ResolveInfo>>(intent, flags); }
	...
	void setComponentEnabledSettings(jni::ref<java::util::List> settings) { return call_method<"setComponentEnabledSettings", void>(settings); }
