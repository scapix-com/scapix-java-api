...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PERMISSIONINFO
...
public:
	...
	static jint FLAG_ALLOWED_IN_PRIVATE_COMPUTE_CORE() { return get_static_field<"FLAG_ALLOWED_IN_PRIVATE_COMPUTE_CORE", jint>(); }
	...
	static jint PROTECTION_INTERNAL() { return get_static_field<"PROTECTION_INTERNAL", jint>(); }
	...
	static jni::ref<android::content::pm::PermissionInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::PermissionInfo> new_object(jni::ref<android::content::pm::PermissionInfo> orig) { return object_base::new_object(orig); }
