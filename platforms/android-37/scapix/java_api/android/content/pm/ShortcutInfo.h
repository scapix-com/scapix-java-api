...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_SHORTCUTINFO
...
public:
	...
	static jint SURFACE_LAUNCHER() { return get_static_field<"SURFACE_LAUNCHER", jint>(); }

	static jni::ref<android::content::pm::ShortcutInfo> createFromGenericDocument(jni::ref<android::content::Context> context, jni::ref<android::app::appsearch::GenericDocument> document) { return call_static_method<"createFromGenericDocument", jni::ref<android::content::pm::ShortcutInfo>>(context, document); }
	...
	jni::ref<java::util::List> getCapabilities() { return call_method<"getCapabilities", jni::ref<java::util::List>>(); }
	jni::ref<java::util::List> getCapabilityParams(jni::ref<android::content::pm::Capability> capability) { return call_method<"getCapabilityParams", jni::ref<java::util::List>>(capability); }
	...
	jint getExcludedFromSurfaces() { return call_method<"getExcludedFromSurfaces", jint>(); }
	...
	jboolean isExcludedFromSurfaces(jint surface) { return call_method<"isExcludedFromSurfaces", jboolean>(surface); }
