...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGEINFO
...
#include <scapix/java_api/android/content/pm/Attribution.h>
...
public:
	...
	static jint REQUESTED_PERMISSION_IMPLICIT() { return get_static_field<"REQUESTED_PERMISSION_IMPLICIT", jint>(); }
	static jint REQUESTED_PERMISSION_NEVER_FOR_LOCATION() { return get_static_field<"REQUESTED_PERMISSION_NEVER_FOR_LOCATION", jint>(); }
	static jint REQUESTED_PERMISSION_ONLY_FOR_LOCATION_BUTTON() { return get_static_field<"REQUESTED_PERMISSION_ONLY_FOR_LOCATION_BUTTON", jint>(); }
	...
	jni::ref<jni::array<android::content::pm::Attribution>> attributions() { return get_field<"attributions", jni::ref<jni::array<android::content::pm::Attribution>>>(); }
	void attributions(jni::ref<jni::array<android::content::pm::Attribution>> v) { set_field<"attributions", jni::ref<jni::array<android::content::pm::Attribution>>>(v); }
	...
	jboolean isApex() { return get_field<"isApex", jboolean>(); }
	void isApex(jboolean v) { set_field<"isApex", jboolean>(v); }
	...
	static jni::ref<android::content::pm::PackageInfo> new_object() { return object_base::new_object(); }
	jint describeContents() { return call_method<"describeContents", jint>(); }
	jni::ref<java::lang::String> getApexPackageName() { return call_method<"getApexPackageName", jni::ref<java::lang::String>>(); }
	jlong getArchiveTimeMillis() { return call_method<"getArchiveTimeMillis", jlong>(); }
	jlong getLongVersionCode() { return call_method<"getLongVersionCode", jlong>(); }
	jboolean isAppMetadataVerified() { return call_method<"isAppMetadataVerified", jboolean>(); }
