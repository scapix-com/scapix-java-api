...
class PackageItemInfo_DisplayNameComparator;
...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGEITEMINFO_DISPLAYNAMECOMPARATOR
...
public:
	...
	static jni::ref<android::content::pm::PackageItemInfo_DisplayNameComparator> new_object(jni::ref<android::content::pm::PackageManager> pm) { return object_base::new_object(pm); }
