...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGEINSTALLER_SESSIONPARAMS
...
public:
	...
	static jint PERMISSION_STATE_DEFAULT() { return get_static_field<"PERMISSION_STATE_DEFAULT", jint>(); }
	static jint PERMISSION_STATE_DENIED() { return get_static_field<"PERMISSION_STATE_DENIED", jint>(); }
	static jint PERMISSION_STATE_GRANTED() { return get_static_field<"PERMISSION_STATE_GRANTED", jint>(); }
	...
	static jint USER_ACTION_NOT_REQUIRED() { return get_static_field<"USER_ACTION_NOT_REQUIRED", jint>(); }
	static jint USER_ACTION_REQUIRED() { return get_static_field<"USER_ACTION_REQUIRED", jint>(); }
	static jint USER_ACTION_UNSPECIFIED() { return get_static_field<"USER_ACTION_UNSPECIFIED", jint>(); }

	static jni::ref<android::content::pm::PackageInstaller_SessionParams> new_object(jint mode) { return object_base::new_object(mode); }
	...
	void setApplicationEnabledSettingPersistent() { return call_method<"setApplicationEnabledSettingPersistent", void>(); }
	void setAutoInstallDependenciesEnabled(jboolean enableAutoInstallDependencies) { return call_method<"setAutoInstallDependenciesEnabled", void>(enableAutoInstallDependencies); }
	...
	void setDontKillApp(jboolean dontKillApp) { return call_method<"setDontKillApp", void>(dontKillApp); }
	void setExtensionParams(jni::ref<android::os::PersistableBundle> extensionParams) { return call_method<"setExtensionParams", void>(extensionParams); }
	...
	void setInstallScenario(jint installScenario) { return call_method<"setInstallScenario", void>(installScenario); }
	void setInstallerPackageName(jni::ref<java::lang::String> installerPackageName) { return call_method<"setInstallerPackageName", void>(installerPackageName); }
	...
	void setPackageSource(jint packageSource) { return call_method<"setPackageSource", void>(packageSource); }
	jni::ref<android::content::pm::PackageInstaller_SessionParams> setPermissionState(jni::ref<java::lang::String> permissionName, jint state) { return call_method<"setPermissionState", jni::ref<android::content::pm::PackageInstaller_SessionParams>>(permissionName, state); }
	void setReferrerUri(jni::ref<android::net::Uri> referrerUri) { return call_method<"setReferrerUri", void>(referrerUri); }
	void setRequestUpdateOwnership(jboolean enable) { return call_method<"setRequestUpdateOwnership", void>(enable); }
	void setRequireUserAction(jint requireUserAction) { return call_method<"setRequireUserAction", void>(requireUserAction); }
	void setSize(jlong sizeBytes) { return call_method<"setSize", void>(sizeBytes); }
	void setUnarchiveId(jint unarchiveId) { return call_method<"setUnarchiveId", void>(unarchiveId); }
