...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGEINSTALLER_SESSIONCALLBACK
...
public:
	...
	static jni::ref<android::content::pm::PackageInstaller_SessionCallback> new_object() { return object_base::new_object(); }
