...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTURIS
...
public:
	...
	static jni::ref<android::content::ContentUris> new_object() { return object_base::new_object(); }
	...
	static jni::ref<android::net::Uri> removeId(jni::ref<android::net::Uri> contentUri) { return call_static_method<"removeId", jni::ref<android::net::Uri>>(contentUri); }
