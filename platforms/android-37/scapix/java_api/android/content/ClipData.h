...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CLIPDATA
...
public:
	...
	static jni::ref<android::content::ClipData> new_object(jni::ref<android::content::ClipData> other) { return object_base::new_object(other); }
	static jni::ref<android::content::ClipData> new_object(jni::ref<android::content::ClipDescription> description, jni::ref<android::content::ClipData_Item> item) { return object_base::new_object(description, item); }
	static jni::ref<android::content::ClipData> new_object(jni::ref<java::lang::CharSequence> label, jni::ref<jni::array<java::lang::String>> mimeTypes, jni::ref<android::content::ClipData_Item> item) { return object_base::new_object(label, mimeTypes, item); }
	void addItem(jni::ref<android::content::ClipData_Item> item) { return call_method<"addItem", void>(item); }
	void addItem(jni::ref<android::content::ContentResolver> resolver, jni::ref<android::content::ClipData_Item> item) { return call_method<"addItem", void>(resolver, item); }
