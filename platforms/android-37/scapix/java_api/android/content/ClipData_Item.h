...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CLIPDATA_ITEM
...
#include <scapix/java_api/android/content/ClipData_Item_Builder.h>
...
public:
	...
	using Builder = ClipData_Item_Builder;

	static jni::ref<android::content::ClipData_Item> new_object(jni::ref<android::content::Intent> intent) { return object_base::new_object(intent); }
	static jni::ref<android::content::ClipData_Item> new_object(jni::ref<android::net::Uri> uri) { return object_base::new_object(uri); }
	static jni::ref<android::content::ClipData_Item> new_object(jni::ref<java::lang::CharSequence> text) { return object_base::new_object(text); }
	static jni::ref<android::content::ClipData_Item> new_object(jni::ref<java::lang::CharSequence> text, jni::ref<android::content::Intent> intent, jni::ref<android::net::Uri> uri) { return object_base::new_object(text, intent, uri); }
	static jni::ref<android::content::ClipData_Item> new_object(jni::ref<java::lang::CharSequence> text, jni::ref<java::lang::String> htmlText) { return object_base::new_object(text, htmlText); }
	static jni::ref<android::content::ClipData_Item> new_object(jni::ref<java::lang::CharSequence> text, jni::ref<java::lang::String> htmlText, jni::ref<android::content::Intent> intent, jni::ref<android::net::Uri> uri) { return object_base::new_object(text, htmlText, intent, uri); }
