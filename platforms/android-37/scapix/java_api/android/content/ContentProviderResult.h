...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTPROVIDERRESULT
...
public:
	...
	static jni::ref<android::content::ContentProviderResult> new_object(jni::ref<android::net::Uri> uri) { return object_base::new_object(uri); }
	static jni::ref<android::content::ContentProviderResult> new_object(jni::ref<android::os::Bundle> extras) { return object_base::new_object(extras); }
	static jni::ref<android::content::ContentProviderResult> new_object(jni::ref<android::os::Parcel> source) { return object_base::new_object(source); }
	static jni::ref<android::content::ContentProviderResult> new_object(jint count) { return object_base::new_object(count); }
	static jni::ref<android::content::ContentProviderResult> new_object(jni::ref<java::lang::Throwable> exception) { return object_base::new_object(exception); }
