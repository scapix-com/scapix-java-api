...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CLIPDESCRIPTION
...
public:
	...
	static jint CLASSIFICATION_COMPLETE() { return get_static_field<"CLASSIFICATION_COMPLETE", jint>(); }
	static jint CLASSIFICATION_NOT_COMPLETE() { return get_static_field<"CLASSIFICATION_NOT_COMPLETE", jint>(); }
	static jint CLASSIFICATION_NOT_PERFORMED() { return get_static_field<"CLASSIFICATION_NOT_PERFORMED", jint>(); }
	static jni::ref<android::os::Parcelable_Creator> CREATOR() { return get_static_field<"CREATOR", jni::ref<android::os::Parcelable_Creator>>(); }
	static jni::ref<java::lang::String> EXTRA_IS_REMOTE_DEVICE() { return get_static_field<"EXTRA_IS_REMOTE_DEVICE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_IS_SENSITIVE() { return get_static_field<"EXTRA_IS_SENSITIVE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> MIMETYPE_UNKNOWN() { return get_static_field<"MIMETYPE_UNKNOWN", jni::ref<java::lang::String>>(); }

	static jni::ref<android::content::ClipDescription> new_object(jni::ref<android::content::ClipDescription> o) { return object_base::new_object(o); }
	static jni::ref<android::content::ClipDescription> new_object(jni::ref<java::lang::CharSequence> label, jni::ref<jni::array<java::lang::String>> mimeTypes) { return object_base::new_object(label, mimeTypes); }
	...
	jint getClassificationStatus() { return call_method<"getClassificationStatus", jint>(); }
	...
	jboolean isStyledText() { return call_method<"isStyledText", jboolean>(); }
	void setExtras(jni::ref<android::os::PersistableBundle> extras) { return call_method<"setExtras", void>(extras); }
