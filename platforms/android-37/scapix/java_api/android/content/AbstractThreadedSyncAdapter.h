...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_ABSTRACTTHREADEDSYNCADAPTER
...
public:
	...
	static jni::ref<android::content::AbstractThreadedSyncAdapter> new_object(jni::ref<android::content::Context> context, jboolean autoInitialize) { return object_base::new_object(context, autoInitialize); }
	static jni::ref<android::content::AbstractThreadedSyncAdapter> new_object(jni::ref<android::content::Context> context, jboolean autoInitialize, jboolean allowParallelSyncs) { return object_base::new_object(context, autoInitialize, allowParallelSyncs); }
	...
	jboolean onUnsyncableAccount() { return call_method<"onUnsyncableAccount", jboolean>(); }
};
