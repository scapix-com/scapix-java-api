...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_SEARCHRECENTSUGGESTIONSPROVIDER
...
public:
	...
	static jni::ref<android::content::SearchRecentSuggestionsProvider> new_object() { return object_base::new_object(); }
