...
struct scapix::jni::object_traits<scapix::java_api::android::content::res::XmlResourceParser>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::android::util::AttributeSet, scapix::java_api::java::lang::AutoCloseable, scapix::java_api::org::xmlpull::v1::XmlPullParser>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_XMLRESOURCEPARSER
