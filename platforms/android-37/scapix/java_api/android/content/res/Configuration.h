...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_CONFIGURATION
...
public:
	...
	static jni::ref<android::content::res::Configuration> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::res::Configuration> new_object(jni::ref<android::content::res::Configuration> o) { return object_base::new_object(o); }
