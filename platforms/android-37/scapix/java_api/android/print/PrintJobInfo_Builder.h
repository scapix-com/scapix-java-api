...
#ifndef SCAPIX_JAVA_API_ANDROID_PRINT_PRINTJOBINFO_BUILDER
...
public:
	...
	static jni::ref<android::print::PrintJobInfo_Builder> new_object(jni::ref<android::print::PrintJobInfo> prototype) { return object_base::new_object(prototype); }
