...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTDEVICE
#define SCAPIX_JAVA_API_ANDROID_VIEW_INPUTDEVICE

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/hardware/BatteryState.h>
#include <scapix/java_api/android/hardware/SensorManager.h>
#include <scapix/java_api/android/hardware/lights/LightsManager.h>
#include <scapix/java_api/android/os/Parcel.h>
#include <scapix/java_api/android/os/Parcelable_Creator.h>
#include <scapix/java_api/android/os/Vibrator.h>
#include <scapix/java_api/android/os/VibratorManager.h>
...
#include <scapix/java_api/android/view/InputDevice_ViewBehavior.h>
...
public:
	...
	using ViewBehavior = InputDevice_ViewBehavior;
	...
	static jint SOURCE_SENSOR() { return get_static_field<"SOURCE_SENSOR", jint>(); }
	...
	jint getAssociatedDisplayId() { return call_method<"getAssociatedDisplayId", jint>(); }
	jni::ref<android::hardware::BatteryState> getBatteryState() { return call_method<"getBatteryState", jni::ref<android::hardware::BatteryState>>(); }
	...
	jint getKeyCodeForKeyLocation(jint locationKeyCode) { return call_method<"getKeyCodeForKeyLocation", jint>(locationKeyCode); }
	jint getKeyboardType() { return call_method<"getKeyboardType", jint>(); }
	jni::ref<android::hardware::lights::LightsManager> getLightsManager() { return call_method<"getLightsManager", jni::ref<android::hardware::lights::LightsManager>>(); }
	...
	jni::ref<android::hardware::SensorManager> getSensorManager() { return call_method<"getSensorManager", jni::ref<android::hardware::SensorManager>>(); }
	...
	jni::ref<android::os::VibratorManager> getVibratorManager() { return call_method<"getVibratorManager", jni::ref<android::os::VibratorManager>>(); }
