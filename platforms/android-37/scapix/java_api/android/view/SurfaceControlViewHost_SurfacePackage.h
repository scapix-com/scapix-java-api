...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_SURFACECONTROLVIEWHOST_SURFACEPACKAGE
...
public:
	...
	static jni::ref<android::view::SurfaceControlViewHost_SurfacePackage> new_object(jni::ref<android::view::SurfaceControlViewHost_SurfacePackage> other) { return object_base::new_object(other); }
