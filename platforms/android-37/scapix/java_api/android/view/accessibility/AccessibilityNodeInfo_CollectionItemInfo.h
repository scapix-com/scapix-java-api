...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEINFO_COLLECTIONITEMINFO
#define SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEINFO_COLLECTIONITEMINFO

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/java/lang/String.h>
#include <scapix/java_api/android/view/accessibility/AccessibilityNodeInfo_CollectionItemInfo_Builder.h>
...
public:
	...
	using Builder = AccessibilityNodeInfo_CollectionItemInfo_Builder;

	static jint SORT_DIRECTION_ASCENDING() { return get_static_field<"SORT_DIRECTION_ASCENDING", jint>(); }
	static jint SORT_DIRECTION_DESCENDING() { return get_static_field<"SORT_DIRECTION_DESCENDING", jint>(); }
	static jint SORT_DIRECTION_NONE() { return get_static_field<"SORT_DIRECTION_NONE", jint>(); }
	static jint SORT_DIRECTION_OTHER() { return get_static_field<"SORT_DIRECTION_OTHER", jint>(); }

	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_CollectionItemInfo> new_object(jint rowIndex, jint rowSpan, jint columnIndex, jint columnSpan, jboolean heading) { return object_base::new_object(rowIndex, rowSpan, columnIndex, columnSpan, heading); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_CollectionItemInfo> new_object(jint rowIndex, jint rowSpan, jint columnIndex, jint columnSpan, jboolean heading, jboolean selected) { return object_base::new_object(rowIndex, rowSpan, columnIndex, columnSpan, heading, selected); }
	jint getColumnIndex() { return call_method<"getColumnIndex", jint>(); }
	jint getColumnSpan() { return call_method<"getColumnSpan", jint>(); }
	jni::ref<java::lang::String> getColumnTitle() { return call_method<"getColumnTitle", jni::ref<java::lang::String>>(); }
	jint getRowIndex() { return call_method<"getRowIndex", jint>(); }
	jint getRowSpan() { return call_method<"getRowSpan", jint>(); }
	jni::ref<java::lang::String> getRowTitle() { return call_method<"getRowTitle", jni::ref<java::lang::String>>(); }
	jint getSortDirection() { return call_method<"getSortDirection", jint>(); }
