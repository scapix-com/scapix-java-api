...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEPROVIDER
...
public:
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeProvider> new_object() { return object_base::new_object(); }
	void addExtraDataToAccessibilityNodeInfo(jint virtualViewId, jni::ref<android::view::accessibility::AccessibilityNodeInfo> info, jni::ref<java::lang::String> extraDataKey, jni::ref<android::os::Bundle> arguments) { return call_method<"addExtraDataToAccessibilityNodeInfo", void>(virtualViewId, info, extraDataKey, arguments); }
