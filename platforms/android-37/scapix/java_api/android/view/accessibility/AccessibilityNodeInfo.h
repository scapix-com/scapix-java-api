...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEINFO
...
#include <scapix/java_api/android/view/accessibility/AccessibilityNodeInfo_Selection.h>
...
#include <scapix/java_api/android/view/accessibility/AccessibilityNodeInfo_MathInfo.h>
...
public:
	...
	using StructuredDataInfo = AccessibilityNodeInfo_StructuredDataInfo;
	using SelectionPosition = AccessibilityNodeInfo_SelectionPosition;
	using Selection = AccessibilityNodeInfo_Selection;
	using RangeInfo = AccessibilityNodeInfo_RangeInfo;
	using MathInfo = AccessibilityNodeInfo_MathInfo;
	...
	static jni::ref<java::lang::String> ACTION_ARGUMENT_SELECTION_PARCELABLE() { return get_static_field<"ACTION_ARGUMENT_SELECTION_PARCELABLE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> EXTRA_DATA_REQUEST_LAYOUT_BASED_ACTIONS_KEY() { return get_static_field<"EXTRA_DATA_REQUEST_LAYOUT_BASED_ACTIONS_KEY", jni::ref<java::lang::String>>(); }
	...
	jni::ref<android::view::accessibility::AccessibilityNodeInfo_Selection> getSelection() { return call_method<"getSelection", jni::ref<android::view::accessibility::AccessibilityNodeInfo_Selection>>(); }
	jni::ref<java::lang::CharSequence> getStateDescription() { return call_method<"getStateDescription", jni::ref<java::lang::CharSequence>>(); }
	jni::ref<android::view::accessibility::AccessibilityNodeInfo_StructuredDataInfo> getStructuredDataInfo() { return call_method<"getStructuredDataInfo", jni::ref<android::view::accessibility::AccessibilityNodeInfo_StructuredDataInfo>>(); }
	...
	void setExtraRenderingInfo(jni::ref<android::view::accessibility::AccessibilityNodeInfo_ExtraRenderingInfo> extraRenderingInfo) { return call_method<"setExtraRenderingInfo", void>(extraRenderingInfo); }
	...
	void setSelection(jni::ref<android::view::accessibility::AccessibilityNodeInfo_Selection> selection) { return call_method<"setSelection", void>(selection); }
	...
	void setStructuredDataInfo(jni::ref<android::view::accessibility::AccessibilityNodeInfo_StructuredDataInfo> info) { return call_method<"setStructuredDataInfo", void>(info); }
