...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYMANAGER
...
#include <scapix/java_api/android/view/accessibility/AccessibilityManager_AccessibilityServicesStateChangeListener.h>
#include <scapix/java_api/android/view/accessibility/AccessibilityManager_AccessibilityStateChangeListener.h>
#include <scapix/java_api/android/view/accessibility/AccessibilityManager_AudioDescriptionRequestedChangeListener.h>
#include <scapix/java_api/android/view/accessibility/AccessibilityManager_HighContrastTextStateChangeListener.h>
...
public:
	...
	using HighContrastTextStateChangeListener = AccessibilityManager_HighContrastTextStateChangeListener;
	using AudioDescriptionRequestedChangeListener = AccessibilityManager_AudioDescriptionRequestedChangeListener;
	using AccessibilityStateChangeListener = AccessibilityManager_AccessibilityStateChangeListener;
	using AccessibilityServicesStateChangeListener = AccessibilityManager_AccessibilityServicesStateChangeListener;
	...
	void addAccessibilityServicesStateChangeListener(jni::ref<android::view::accessibility::AccessibilityManager_AccessibilityServicesStateChangeListener> listener) { return call_method<"addAccessibilityServicesStateChangeListener", void>(listener); }
	void addAccessibilityServicesStateChangeListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::view::accessibility::AccessibilityManager_AccessibilityServicesStateChangeListener> listener) { return call_method<"addAccessibilityServicesStateChangeListener", void>(executor, listener); }
	...
	void addAudioDescriptionRequestedChangeListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::view::accessibility::AccessibilityManager_AudioDescriptionRequestedChangeListener> listener) { return call_method<"addAudioDescriptionRequestedChangeListener", void>(executor, listener); }
	void addHighContrastTextStateChangeListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::view::accessibility::AccessibilityManager_HighContrastTextStateChangeListener> listener) { return call_method<"addHighContrastTextStateChangeListener", void>(executor, listener); }
	...
	jboolean isAudioDescriptionRequested() { return call_method<"isAudioDescriptionRequested", jboolean>(); }
	jboolean isEnabled() { return call_method<"isEnabled", jboolean>(); }
	jboolean isHighContrastTextEnabled() { return call_method<"isHighContrastTextEnabled", jboolean>(); }
	jboolean isRequestFromAccessibilityTool() { return call_method<"isRequestFromAccessibilityTool", jboolean>(); }
	...
	jboolean removeAccessibilityServicesStateChangeListener(jni::ref<android::view::accessibility::AccessibilityManager_AccessibilityServicesStateChangeListener> listener) { return call_method<"removeAccessibilityServicesStateChangeListener", jboolean>(listener); }
	...
	jboolean removeAudioDescriptionRequestedChangeListener(jni::ref<android::view::accessibility::AccessibilityManager_AudioDescriptionRequestedChangeListener> listener) { return call_method<"removeAudioDescriptionRequestedChangeListener", jboolean>(listener); }
	void removeHighContrastTextStateChangeListener(jni::ref<android::view::accessibility::AccessibilityManager_HighContrastTextStateChangeListener> listener) { return call_method<"removeHighContrastTextStateChangeListener", void>(listener); }
