...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEINFO_ACCESSIBILITYACTION
...
public:
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_DRAG_CANCEL() { return get_static_field<"ACTION_DRAG_CANCEL", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_DRAG_DROP() { return get_static_field<"ACTION_DRAG_DROP", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_DRAG_START() { return get_static_field<"ACTION_DRAG_START", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_IME_ENTER() { return get_static_field<"ACTION_IME_ENTER", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_PAGE_DOWN() { return get_static_field<"ACTION_PAGE_DOWN", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_PAGE_LEFT() { return get_static_field<"ACTION_PAGE_LEFT", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_PAGE_RIGHT() { return get_static_field<"ACTION_PAGE_RIGHT", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_PAGE_UP() { return get_static_field<"ACTION_PAGE_UP", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_PRESS_AND_HOLD() { return get_static_field<"ACTION_PRESS_AND_HOLD", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_SCROLL_IN_DIRECTION() { return get_static_field<"ACTION_SCROLL_IN_DIRECTION", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_SET_EXTENDED_SELECTION() { return get_static_field<"ACTION_SET_EXTENDED_SELECTION", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> ACTION_SHOW_TEXT_SUGGESTIONS() { return get_static_field<"ACTION_SHOW_TEXT_SUGGESTIONS", jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction>>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_AccessibilityAction> new_object(jint actionId, jni::ref<java::lang::CharSequence> label) { return object_base::new_object(actionId, label); }
