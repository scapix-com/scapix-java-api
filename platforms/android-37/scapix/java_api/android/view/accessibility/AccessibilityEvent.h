...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYEVENT
...
public:
	...
	static jint CONTENT_CHANGE_TYPE_CHECKED() { return get_static_field<"CONTENT_CHANGE_TYPE_CHECKED", jint>(); }
	static jint CONTENT_CHANGE_TYPE_CONTENT_DESCRIPTION() { return get_static_field<"CONTENT_CHANGE_TYPE_CONTENT_DESCRIPTION", jint>(); }
	static jint CONTENT_CHANGE_TYPE_CONTENT_INVALID() { return get_static_field<"CONTENT_CHANGE_TYPE_CONTENT_INVALID", jint>(); }
	static jint CONTENT_CHANGE_TYPE_DRAG_CANCELLED() { return get_static_field<"CONTENT_CHANGE_TYPE_DRAG_CANCELLED", jint>(); }
	static jint CONTENT_CHANGE_TYPE_DRAG_DROPPED() { return get_static_field<"CONTENT_CHANGE_TYPE_DRAG_DROPPED", jint>(); }
	static jint CONTENT_CHANGE_TYPE_DRAG_STARTED() { return get_static_field<"CONTENT_CHANGE_TYPE_DRAG_STARTED", jint>(); }
	static jint CONTENT_CHANGE_TYPE_ENABLED() { return get_static_field<"CONTENT_CHANGE_TYPE_ENABLED", jint>(); }
	static jint CONTENT_CHANGE_TYPE_ERROR() { return get_static_field<"CONTENT_CHANGE_TYPE_ERROR", jint>(); }
	static jint CONTENT_CHANGE_TYPE_EXPANDED() { return get_static_field<"CONTENT_CHANGE_TYPE_EXPANDED", jint>(); }
	...
	static jint CONTENT_CHANGE_TYPE_SORT_DIRECTION() { return get_static_field<"CONTENT_CHANGE_TYPE_SORT_DIRECTION", jint>(); }
	...
	static jint CONTENT_CHANGE_TYPE_SUPPLEMENTAL_DESCRIPTION() { return get_static_field<"CONTENT_CHANGE_TYPE_SUPPLEMENTAL_DESCRIPTION", jint>(); }
	...
	static jint SPEECH_STATE_LISTENING_END() { return get_static_field<"SPEECH_STATE_LISTENING_END", jint>(); }
	static jint SPEECH_STATE_LISTENING_START() { return get_static_field<"SPEECH_STATE_LISTENING_START", jint>(); }
	static jint SPEECH_STATE_SPEAKING_END() { return get_static_field<"SPEECH_STATE_SPEAKING_END", jint>(); }
	static jint SPEECH_STATE_SPEAKING_START() { return get_static_field<"SPEECH_STATE_SPEAKING_START", jint>(); }
	static jint TEXT_CHANGE_TYPE_COMMITTED_BY_IME() { return get_static_field<"TEXT_CHANGE_TYPE_COMMITTED_BY_IME", jint>(); }
	static jint TEXT_CHANGE_TYPE_CONVERSION_SUGGESTION_SELECTED_BY_IME() { return get_static_field<"TEXT_CHANGE_TYPE_CONVERSION_SUGGESTION_SELECTED_BY_IME", jint>(); }
	static jint TEXT_CHANGE_TYPE_IN_COMPOSITION() { return get_static_field<"TEXT_CHANGE_TYPE_IN_COMPOSITION", jint>(); }
	static jint TEXT_CHANGE_TYPE_UNDEFINED() { return get_static_field<"TEXT_CHANGE_TYPE_UNDEFINED", jint>(); }
	...
	static jint TYPE_SPEECH_STATE_CHANGE() { return get_static_field<"TYPE_SPEECH_STATE_CHANGE", jint>(); }
	...
	static jint TYPE_VIEW_TARGETED_BY_SCROLL() { return get_static_field<"TYPE_VIEW_TARGETED_BY_SCROLL", jint>(); }
	...
	static jni::ref<android::view::accessibility::AccessibilityEvent> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::accessibility::AccessibilityEvent> new_object(jni::ref<android::view::accessibility::AccessibilityEvent> event) { return object_base::new_object(event); }
	static jni::ref<android::view::accessibility::AccessibilityEvent> new_object(jint eventType) { return object_base::new_object(eventType); }
	...
	jint getSpeechStateChangeTypes() { return call_method<"getSpeechStateChangeTypes", jint>(); }
	jint getTextChangeTypes() { return call_method<"getTextChangeTypes", jint>(); }
	...
	void setSpeechStateChangeTypes(jint state) { return call_method<"setSpeechStateChangeTypes", void>(state); }
	void setTextChangeTypes(jint types) { return call_method<"setTextChangeTypes", void>(types); }
