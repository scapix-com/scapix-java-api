...
class AccessibilityManager_AudioDescriptionRequestedChangeListener;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYMANAGER_AUDIODESCRIPTIONREQUESTEDCHANGELISTENER
