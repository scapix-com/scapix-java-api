...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_AUTOFILL_AUTOFILLMANAGER
...
public:
	...
	static jni::ref<java::lang::String> EXTRA_AUTHENTICATION_RESULT_EPHEMERAL_DATASET() { return get_static_field<"EXTRA_AUTHENTICATION_RESULT_EPHEMERAL_DATASET", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_CLIENT_STATE() { return get_static_field<"EXTRA_CLIENT_STATE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_INLINE_SUGGESTIONS_REQUEST() { return get_static_field<"EXTRA_INLINE_SUGGESTIONS_REQUEST", jni::ref<java::lang::String>>(); }
	...
	void notifyVirtualViewsReady(jni::ref<android::view::View> view, jni::ref<android::util::SparseArray> infos) { return call_method<"notifyVirtualViewsReady", void>(view, infos); }
	...
	jboolean showAutofillDialog(jni::ref<android::view::View> view) { return call_method<"showAutofillDialog", jboolean>(view); }
	jboolean showAutofillDialog(jni::ref<android::view::View> view, jint virtualId) { return call_method<"showAutofillDialog", jboolean>(view, virtualId); }
