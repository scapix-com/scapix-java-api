...
struct scapix::jni::object_traits<scapix::java_api::android::view::ViewGroup>
{
	...
	using base_classes = std::tuple<scapix::java_api::android::view::View, scapix::java_api::android::view::ViewManager, scapix::java_api::android::view::ViewParent>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_VIEWGROUP
...
public:
	...
	static jni::ref<android::view::ViewGroup> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::view::ViewGroup> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::view::ViewGroup> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	static jni::ref<android::view::ViewGroup> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes); }
	...
	jni::ref<android::window::OnBackInvokedDispatcher> findOnBackInvokedDispatcherForChild(jni::ref<android::view::View> child, jni::ref<android::view::View> requester) { return call_method<"findOnBackInvokedDispatcherForChild", jni::ref<android::window::OnBackInvokedDispatcher>>(child, requester); }
	...
	jint getChildDrawingOrder(jint drawingPosition) { return call_method<"getChildDrawingOrder", jint>(drawingPosition); }
	...
	jboolean isLayoutSuppressed() { return call_method<"isLayoutSuppressed", jboolean>(); }
	...
	void onDescendantInvalidated(jni::ref<android::view::View> child, jni::ref<android::view::View> target) { return call_method<"onDescendantInvalidated", void>(child, target); }
	...
	void propagateRequestedFrameRate(jfloat frameRate, jboolean forceOverride) { return call_method<"propagateRequestedFrameRate", void>(frameRate, forceOverride); }
	...
	void suppressLayout(jboolean suppress) { return call_method<"suppressLayout", void>(suppress); }
