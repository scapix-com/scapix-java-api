...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_TEXTATTRIBUTE_BUILDER
...
public:
	...
	static jni::ref<android::view::inputmethod::TextAttribute_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::view::inputmethod::TextAttribute_Builder> setTextSuggestionSelected(jboolean textSuggestionSelected) { return call_method<"setTextSuggestionSelected", jni::ref<android::view::inputmethod::TextAttribute_Builder>>(textSuggestionSelected); }
};
