...
class InlineSuggestionsRequest_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_INLINESUGGESTIONSREQUEST_BUILDER
...
public:
	...
	static jni::ref<android::view::inputmethod::InlineSuggestionsRequest_Builder> new_object(jni::ref<java::util::List> inlinePresentationSpecs) { return object_base::new_object(inlinePresentationSpecs); }
