...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_INPUTMETHODINFO
...
public:
	...
	static jni::ref<java::lang::String> ACTION_IME_LANGUAGE_SETTINGS() { return get_static_field<"ACTION_IME_LANGUAGE_SETTINGS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ACTION_STYLUS_HANDWRITING_SETTINGS() { return get_static_field<"ACTION_STYLUS_HANDWRITING_SETTINGS", jni::ref<java::lang::String>>(); }
	static jni::ref<android::os::Parcelable_Creator> CREATOR() { return get_static_field<"CREATOR", jni::ref<android::os::Parcelable_Creator>>(); }

	static jni::ref<android::view::inputmethod::InputMethodInfo> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::pm::ResolveInfo> service) { return object_base::new_object(context, service); }
	static jni::ref<android::view::inputmethod::InputMethodInfo> new_object(jni::ref<java::lang::String> packageName, jni::ref<java::lang::String> className, jni::ref<java::lang::CharSequence> label, jni::ref<java::lang::String> settingsActivity) { return object_base::new_object(packageName, className, label, settingsActivity); }
	jni::ref<android::content::Intent> createImeLanguageSettingsActivityIntent() { return call_method<"createImeLanguageSettingsActivityIntent", jni::ref<android::content::Intent>>(); }
	jni::ref<android::content::Intent> createStylusHandwritingSettingsActivityIntent() { return call_method<"createStylusHandwritingSettingsActivityIntent", jni::ref<android::content::Intent>>(); }
	...
	jboolean supportsConnectionlessStylusHandwriting() { return call_method<"supportsConnectionlessStylusHandwriting", jboolean>(); }
	jboolean supportsStylusHandwriting() { return call_method<"supportsStylusHandwriting", jboolean>(); }
