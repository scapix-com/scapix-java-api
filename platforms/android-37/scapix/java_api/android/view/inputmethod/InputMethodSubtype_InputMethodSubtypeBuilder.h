...
class InputMethodSubtype_InputMethodSubtypeBuilder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_INPUTMETHODSUBTYPE_INPUTMETHODSUBTYPEBUILDER
...
public:
	...
	static jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder> setLayoutLabelNonLocalized(jni::ref<java::lang::CharSequence> layoutLabelNonLocalized) { return call_method<"setLayoutLabelNonLocalized", jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder>>(layoutLabelNonLocalized); }
	jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder> setLayoutLabelResource(jint layoutLabelResId) { return call_method<"setLayoutLabelResource", jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder>>(layoutLabelResId); }
	...
	jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder> setPhysicalKeyboardHint(jni::ref<android::icu::util::ULocale> languageTag, jni::ref<java::lang::String> layoutType) { return call_method<"setPhysicalKeyboardHint", jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder>>(languageTag, layoutType); }
	...
	jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder> setSubtypeNameOverride(jni::ref<java::lang::CharSequence> nameOverride) { return call_method<"setSubtypeNameOverride", jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder>>(nameOverride); }
	...
	jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder> setSubtypeShortLabel(jni::ref<java::lang::CharSequence> subtypeShortLabel) { return call_method<"setSubtypeShortLabel", jni::ref<android::view::inputmethod::InputMethodSubtype_InputMethodSubtypeBuilder>>(subtypeShortLabel); }
};
