...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_EDITORINFO
...
public:
	...
	static jni::ref<android::view::inputmethod::EditorInfo> new_object() { return object_base::new_object(); }
	...
	jboolean isStylusHandwritingEnabled() { return call_method<"isStylusHandwritingEnabled", jboolean>(); }
	jboolean isWritingToolsEnabled() { return call_method<"isWritingToolsEnabled", jboolean>(); }
	void makeCompatible(jint targetSdkVersion) { return call_method<"makeCompatible", void>(targetSdkVersion); }
	void setAutofillId(jni::ref<android::view::autofill::AutofillId> autofillId) { return call_method<"setAutofillId", void>(autofillId); }
	...
	void setStylusHandwritingEnabled(jboolean enabled) { return call_method<"setStylusHandwritingEnabled", void>(enabled); }
	...
	void setWritingToolsEnabled(jboolean enabled) { return call_method<"setWritingToolsEnabled", void>(enabled); }
