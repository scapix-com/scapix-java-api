...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_VIEWSTRUCTURE
...
public:
	...
	static jni::ref<java::lang::String> EXTRA_VIRTUAL_STRUCTURE_TYPE() { return get_static_field<"EXTRA_VIRTUAL_STRUCTURE_TYPE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_VIRTUAL_STRUCTURE_VERSION_NUMBER() { return get_static_field<"EXTRA_VIRTUAL_STRUCTURE_VERSION_NUMBER", jni::ref<java::lang::String>>(); }

	static jni::ref<android::view::ViewStructure> new_object() { return object_base::new_object(); }
	...
	void clearCredentialManagerRequest() { return call_method<"clearCredentialManagerRequest", void>(); }
	...
	void setReceiveContentMimeTypes(jni::ref<jni::array<java::lang::String>> mimeTypes) { return call_method<"setReceiveContentMimeTypes", void>(mimeTypes); }
