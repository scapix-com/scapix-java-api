...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_SURFACECONTROL_TRANSACTION
...
#include <scapix/java_api/android/hardware/DisplayLuts.h>
...
public:
	...
	static jni::ref<android::view::SurfaceControl_Transaction> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::view::SurfaceControl_Transaction> addTransactionCompletedListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> listener) { return call_method<"addTransactionCompletedListener", jni::ref<android::view::SurfaceControl_Transaction>>(executor, listener); }
	...
	jni::ref<android::view::SurfaceControl_Transaction> setContentPriority(jni::ref<android::view::SurfaceControl> sc, jint priority) { return call_method<"setContentPriority", jni::ref<android::view::SurfaceControl_Transaction>>(sc, priority); }
	...
	jni::ref<android::view::SurfaceControl_Transaction> setDesiredHdrHeadroom(jni::ref<android::view::SurfaceControl> sc, jfloat desiredRatio) { return call_method<"setDesiredHdrHeadroom", jni::ref<android::view::SurfaceControl_Transaction>>(sc, desiredRatio); }
	jni::ref<android::view::SurfaceControl_Transaction> setDesiredPresentTimeNanos(jlong desiredPresentTimeNanos) { return call_method<"setDesiredPresentTimeNanos", jni::ref<android::view::SurfaceControl_Transaction>>(desiredPresentTimeNanos); }
	...
	jni::ref<android::view::SurfaceControl_Transaction> setFrameTimeline(jlong vsyncId) { return call_method<"setFrameTimeline", jni::ref<android::view::SurfaceControl_Transaction>>(vsyncId); }
	...
	jni::ref<android::view::SurfaceControl_Transaction> setLuts(jni::ref<android::view::SurfaceControl> sc, jni::ref<android::hardware::DisplayLuts> displayLuts) { return call_method<"setLuts", jni::ref<android::view::SurfaceControl_Transaction>>(sc, displayLuts); }
