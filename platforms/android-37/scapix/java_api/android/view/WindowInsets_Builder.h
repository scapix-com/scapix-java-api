...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_WINDOWINSETS_BUILDER
...
public:
	...
	static jni::ref<android::view::WindowInsets_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::WindowInsets_Builder> new_object(jni::ref<android::view::WindowInsets> insets) { return object_base::new_object(insets); }
	jni::ref<android::view::WindowInsets> build() { return call_method<"build", jni::ref<android::view::WindowInsets>>(); }
	jni::ref<android::view::WindowInsets_Builder> setBoundingRects(jint typeMask, jni::ref<java::util::List> rects) { return call_method<"setBoundingRects", jni::ref<android::view::WindowInsets_Builder>>(typeMask, rects); }
	jni::ref<android::view::WindowInsets_Builder> setBoundingRectsIgnoringVisibility(jint typeMask, jni::ref<java::util::List> rects) { return call_method<"setBoundingRectsIgnoringVisibility", jni::ref<android::view::WindowInsets_Builder>>(typeMask, rects); }
	...
	jni::ref<android::view::WindowInsets_Builder> setDisplayShape(jni::ref<android::view::DisplayShape> displayShape) { return call_method<"setDisplayShape", jni::ref<android::view::WindowInsets_Builder>>(displayShape); }
	jni::ref<android::view::WindowInsets_Builder> setFrame(jint width, jint height) { return call_method<"setFrame", jni::ref<android::view::WindowInsets_Builder>>(width, height); }
