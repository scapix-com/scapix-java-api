...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_PIXELCOPY
...
#include <scapix/java_api/android/view/PixelCopy_Result.h>
...
public:
	...
	using Result = PixelCopy_Result;
	using Request = PixelCopy_Request;
	...
	static void request(jni::ref<android::view::PixelCopy_Request> request, jni::ref<java::util::concurrent::Executor> callbackExecutor, jni::ref<java::util::function::Consumer> listener) { return call_static_method<"request", void>(request, callbackExecutor, listener); }
