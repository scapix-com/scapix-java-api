...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_VIEWTREEOBSERVER
...
#include <scapix/java_api/android/view/ViewTreeObserver_OnWindowVisibilityChangeListener.h>
...
public:
	...
	using OnWindowVisibilityChangeListener = ViewTreeObserver_OnWindowVisibilityChangeListener;
	...
	void addOnWindowVisibilityChangeListener(jni::ref<android::view::ViewTreeObserver_OnWindowVisibilityChangeListener> listener) { return call_method<"addOnWindowVisibilityChangeListener", void>(listener); }
	...
	void dispatchOnScrollChanged() { return call_method<"dispatchOnScrollChanged", void>(); }
	...
	void removeOnWindowVisibilityChangeListener(jni::ref<android::view::ViewTreeObserver_OnWindowVisibilityChangeListener> victim) { return call_method<"removeOnWindowVisibilityChangeListener", void>(victim); }
