...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTSERVICE_SPELLCHECKERSUBTYPE
...
public:
	...
	static jni::ref<android::view::textservice::SpellCheckerSubtype> new_object(jint nameId, jni::ref<java::lang::String> locale, jni::ref<java::lang::String> extraValue) { return object_base::new_object(nameId, locale, extraValue); }
