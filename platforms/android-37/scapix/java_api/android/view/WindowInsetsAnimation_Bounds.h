...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_WINDOWINSETSANIMATION_BOUNDS
...
public:
	...
	static jni::ref<android::view::WindowInsetsAnimation_Bounds> new_object(jni::ref<android::graphics::Insets> lowerBound, jni::ref<android::graphics::Insets> upperBound) { return object_base::new_object(lowerBound, upperBound); }
