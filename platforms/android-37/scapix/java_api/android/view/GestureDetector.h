...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_GESTUREDETECTOR
...
public:
	...
	static jni::ref<android::view::GestureDetector> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::GestureDetector_OnGestureListener> listener) { return object_base::new_object(context, listener); }
	static jni::ref<android::view::GestureDetector> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::GestureDetector_OnGestureListener> listener, jni::ref<android::os::Handler> handler) { return object_base::new_object(context, listener, handler); }
	static jni::ref<android::view::GestureDetector> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::GestureDetector_OnGestureListener> listener, jni::ref<android::os::Handler> handler, jboolean unused) { return object_base::new_object(context, listener, handler, unused); }
	static jni::ref<android::view::GestureDetector> new_object(jni::ref<android::view::GestureDetector_OnGestureListener> listener) { return object_base::new_object(listener); }
	static jni::ref<android::view::GestureDetector> new_object(jni::ref<android::view::GestureDetector_OnGestureListener> listener, jni::ref<android::os::Handler> handler) { return object_base::new_object(listener, handler); }
