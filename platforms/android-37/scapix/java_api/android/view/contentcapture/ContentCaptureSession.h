...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_CONTENTCAPTURE_CONTENTCAPTURESESSION
...
public:
	...
	void notifyContentInteractionEvent(jni::ref<android::view::autofill::AutofillId> autofillId) { return call_method<"notifyContentInteractionEvent", void>(autofillId); }
