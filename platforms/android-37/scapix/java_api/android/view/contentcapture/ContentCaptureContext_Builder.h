...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_CONTENTCAPTURE_CONTENTCAPTURECONTEXT_BUILDER
...
public:
	...
	static jni::ref<android::view::contentcapture::ContentCaptureContext_Builder> new_object(jni::ref<android::content::LocusId> id) { return object_base::new_object(id); }
