...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_TEXTLINKS
...
public:
	...
	static jint STATUS_UNSUPPORTED_CHARACTER() { return get_static_field<"STATUS_UNSUPPORTED_CHARACTER", jint>(); }
