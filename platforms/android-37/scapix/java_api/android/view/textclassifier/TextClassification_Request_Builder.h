...
class TextClassification_Request_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_TEXTCLASSIFICATION_REQUEST_BUILDER
...
public:
	...
	static jni::ref<android::view::textclassifier::TextClassification_Request_Builder> new_object(jni::ref<java::lang::CharSequence> text, jint startIndex, jint endIndex) { return object_base::new_object(text, startIndex, endIndex); }
	...
	jni::ref<android::view::textclassifier::TextClassification_Request_Builder> setExtras(jni::ref<android::os::Bundle> extras) { return call_method<"setExtras", jni::ref<android::view::textclassifier::TextClassification_Request_Builder>>(extras); }
