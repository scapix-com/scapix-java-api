...
class TextClassificationContext_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_TEXTCLASSIFICATIONCONTEXT_BUILDER
...
public:
	...
	static jni::ref<android::view::textclassifier::TextClassificationContext_Builder> new_object(jni::ref<java::lang::String> packageName, jni::ref<java::lang::String> widgetType) { return object_base::new_object(packageName, widgetType); }
