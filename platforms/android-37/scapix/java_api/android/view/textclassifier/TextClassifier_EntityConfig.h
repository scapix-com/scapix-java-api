...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_TEXTCLASSIFIER_ENTITYCONFIG
...
#include <scapix/java_api/android/view/textclassifier/TextClassifier_EntityConfig_Builder.h>
...
public:
	...
	using Builder = TextClassifier_EntityConfig_Builder;
	...
	jni::ref<java::util::Collection> resolveEntityListModifications(jni::ref<java::util::Collection> entityTypes) { return call_method<"resolveEntityListModifications", jni::ref<java::util::Collection>>(entityTypes); }
	jboolean shouldIncludeTypesFromTextClassifier() { return call_method<"shouldIncludeTypesFromTextClassifier", jboolean>(); }
