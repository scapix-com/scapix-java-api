...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_TEXTSELECTION_BUILDER
...
public:
	...
	static jni::ref<android::view::textclassifier::TextSelection_Builder> new_object(jint startIndex, jint endIndex) { return object_base::new_object(startIndex, endIndex); }
	...
	jni::ref<android::view::textclassifier::TextSelection_Builder> setExtras(jni::ref<android::os::Bundle> extras) { return call_method<"setExtras", jni::ref<android::view::textclassifier::TextSelection_Builder>>(extras); }
	jni::ref<android::view::textclassifier::TextSelection_Builder> setId(jni::ref<java::lang::String> id) { return call_method<"setId", jni::ref<android::view::textclassifier::TextSelection_Builder>>(id); }
	jni::ref<android::view::textclassifier::TextSelection_Builder> setTextClassification(jni::ref<android::view::textclassifier::TextClassification> textClassification) { return call_method<"setTextClassification", jni::ref<android::view::textclassifier::TextSelection_Builder>>(textClassification); }
};
