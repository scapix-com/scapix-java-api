...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_VIEWGROUP_MARGINLAYOUTPARAMS
...
public:
	...
	static jni::ref<android::view::ViewGroup_MarginLayoutParams> new_object(jni::ref<android::content::Context> c, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(c, attrs); }
	static jni::ref<android::view::ViewGroup_MarginLayoutParams> new_object(jni::ref<android::view::ViewGroup_LayoutParams> source) { return object_base::new_object(source); }
	static jni::ref<android::view::ViewGroup_MarginLayoutParams> new_object(jni::ref<android::view::ViewGroup_MarginLayoutParams> source) { return object_base::new_object(source); }
	static jni::ref<android::view::ViewGroup_MarginLayoutParams> new_object(jint width, jint height) { return object_base::new_object(width, height); }
