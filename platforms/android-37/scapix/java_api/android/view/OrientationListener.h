...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ORIENTATIONLISTENER
...
public:
	...
	static jni::ref<android::view::OrientationListener> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::view::OrientationListener> new_object(jni::ref<android::content::Context> context, jint rate) { return object_base::new_object(context, rate); }
