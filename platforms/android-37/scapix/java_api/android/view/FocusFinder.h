...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_FOCUSFINDER
...
public:
	...
	jni::ref<android::view::View> findNextKeyboardNavigationCluster(jni::ref<android::view::View> root, jni::ref<android::view::View> currentCluster, jint direction) { return call_method<"findNextKeyboardNavigationCluster", jni::ref<android::view::View>>(root, currentCluster, direction); }
