...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_VIEWPARENT
...
public:
	...
	jni::ref<android::view::View> keyboardNavigationClusterSearch(jni::ref<android::view::View> p1, jint p2) { return call_method<"keyboardNavigationClusterSearch", jni::ref<android::view::View>>(p1, p2); }
	...
	jboolean requestChildRectangleOnScreen(jni::ref<android::view::View> child, jni::ref<android::graphics::Rect> rectangle, jboolean immediate, jint source) { return call_method<"requestChildRectangleOnScreen", jboolean>(child, rectangle, immediate, source); }
