...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ANIMATION_ANTICIPATEINTERPOLATOR
...
public:
	...
	static jni::ref<android::view::animation::AnticipateInterpolator> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::animation::AnticipateInterpolator> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::view::animation::AnticipateInterpolator> new_object(jfloat tension) { return object_base::new_object(tension); }
