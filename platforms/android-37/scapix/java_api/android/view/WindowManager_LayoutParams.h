...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_WINDOWMANAGER_LAYOUTPARAMS
...
public:
	...
	static jni::ref<android::view::WindowManager_LayoutParams> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::WindowManager_LayoutParams> new_object(jni::ref<android::os::Parcel> in) { return object_base::new_object(in); }
	static jni::ref<android::view::WindowManager_LayoutParams> new_object(jint _type) { return object_base::new_object(_type); }
	static jni::ref<android::view::WindowManager_LayoutParams> new_object(jint _type, jint _flags) { return object_base::new_object(_type, _flags); }
	static jni::ref<android::view::WindowManager_LayoutParams> new_object(jint _type, jint _flags, jint _format) { return object_base::new_object(_type, _flags, _format); }
	static jni::ref<android::view::WindowManager_LayoutParams> new_object(jint w, jint h, jint _type, jint _flags, jint _format) { return object_base::new_object(w, h, _type, _flags, _format); }
	static jni::ref<android::view::WindowManager_LayoutParams> new_object(jint w, jint h, jint xpos, jint ypos, jint _type, jint _flags, jint _format) { return object_base::new_object(w, h, xpos, ypos, _type, _flags, _format); }
	...
	jboolean hasKeyboardCapture() { return call_method<"hasKeyboardCapture", jboolean>(); }
	...
	void setKeyboardCaptureEnabled(jboolean enabled) { return call_method<"setKeyboardCaptureEnabled", void>(enabled); }
