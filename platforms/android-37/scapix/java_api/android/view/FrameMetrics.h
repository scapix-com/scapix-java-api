...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_FRAMEMETRICS
...
public:
	...
	static jint DEADLINE() { return get_static_field<"DEADLINE", jint>(); }
	...
	static jint FRAME_TIMELINE_VSYNC_ID() { return get_static_field<"FRAME_TIMELINE_VSYNC_ID", jint>(); }
	static jint GPU_DURATION() { return get_static_field<"GPU_DURATION", jint>(); }
	...
	static jni::ref<android::view::FrameMetrics> new_object(jni::ref<android::view::FrameMetrics> other) { return object_base::new_object(other); }
