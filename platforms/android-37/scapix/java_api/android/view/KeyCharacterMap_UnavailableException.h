...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_KEYCHARACTERMAP_UNAVAILABLEEXCEPTION
...
public:
	...
	static jni::ref<android::view::KeyCharacterMap_UnavailableException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
