...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_SURFACE
...
public:
	...
	static jint CHANGE_FRAME_RATE_ALWAYS() { return get_static_field<"CHANGE_FRAME_RATE_ALWAYS", jint>(); }
	static jint CHANGE_FRAME_RATE_ONLY_IF_SEAMLESS() { return get_static_field<"CHANGE_FRAME_RATE_ONLY_IF_SEAMLESS", jint>(); }
	static jni::ref<android::os::Parcelable_Creator> CREATOR() { return get_static_field<"CREATOR", jni::ref<android::os::Parcelable_Creator>>(); }
	static jint FRAME_RATE_COMPATIBILITY_AT_LEAST() { return get_static_field<"FRAME_RATE_COMPATIBILITY_AT_LEAST", jint>(); }
	static jint FRAME_RATE_COMPATIBILITY_DEFAULT() { return get_static_field<"FRAME_RATE_COMPATIBILITY_DEFAULT", jint>(); }
	static jint FRAME_RATE_COMPATIBILITY_FIXED_SOURCE() { return get_static_field<"FRAME_RATE_COMPATIBILITY_FIXED_SOURCE", jint>(); }
	...
	static jni::ref<android::view::Surface> new_object(jni::ref<android::graphics::SurfaceTexture> surfaceTexture) { return object_base::new_object(surfaceTexture); }
	static jni::ref<android::view::Surface> new_object(jni::ref<android::view::SurfaceControl> from) { return object_base::new_object(from); }
	void clearFrameRate() { return call_method<"clearFrameRate", void>(); }
	jint describeContents() { return call_method<"describeContents", jint>(); }
	jboolean isProducerThrottlingEnabled() { return call_method<"isProducerThrottlingEnabled", jboolean>(); }
	...
	void setFrameRate(jfloat frameRate, jint compatibility) { return call_method<"setFrameRate", void>(frameRate, compatibility); }
	void setFrameRate(jfloat frameRate, jint compatibility, jint changeFrameRateStrategy) { return call_method<"setFrameRate", void>(frameRate, compatibility, changeFrameRateStrategy); }
	void setProducerThrottlingEnabled(jboolean enabled) { return call_method<"setProducerThrottlingEnabled", void>(enabled); }
