...
class InspectionCompanion_UninitializedPropertyMapException;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INSPECTOR_INSPECTIONCOMPANION_UNINITIALIZEDPROPERTYMAPEXCEPTION
...
public:
	...
	static jni::ref<android::view::inspector::InspectionCompanion_UninitializedPropertyMapException> new_object() { return object_base::new_object(); }
};
