...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_WINDOW
...
public:
	...
	static jint DECOR_CAPTION_SHADE_AUTO() { return get_static_field<"DECOR_CAPTION_SHADE_AUTO", jint>(); }
	static jint DECOR_CAPTION_SHADE_DARK() { return get_static_field<"DECOR_CAPTION_SHADE_DARK", jint>(); }
	static jint DECOR_CAPTION_SHADE_LIGHT() { return get_static_field<"DECOR_CAPTION_SHADE_LIGHT", jint>(); }
	...
	static jni::ref<android::view::Window> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	void addOnFrameMetricsAvailableListener(jni::ref<android::view::Window_OnFrameMetricsAvailableListener> listener, jni::ref<android::os::Handler> handler) { return call_method<"addOnFrameMetricsAvailableListener", void>(listener, handler); }
	...
	jfloat getDesiredHdrHeadroom() { return call_method<"getDesiredHdrHeadroom", jfloat>(); }
	...
	jboolean getFrameRateBoostOnTouchEnabled() { return call_method<"getFrameRateBoostOnTouchEnabled", jboolean>(); }
	jni::ref<android::view::WindowInsetsController> getInsetsController() { return call_method<"getInsetsController", jni::ref<android::view::WindowInsetsController>>(); }
	...
	jint getNavigationBarDividerColor() { return call_method<"getNavigationBarDividerColor", jint>(); }
	...
	jboolean isFrameRatePowerSavingsBalanced() { return call_method<"isFrameRatePowerSavingsBalanced", jboolean>(); }
	jboolean isNavigationBarContrastEnforced() { return call_method<"isNavigationBarContrastEnforced", jboolean>(); }
	jboolean isShortcutKey(jint p1, jni::ref<android::view::KeyEvent> p2) { return call_method<"isShortcutKey", jboolean>(p1, p2); }
	jboolean isStatusBarContrastEnforced() { return call_method<"isStatusBarContrastEnforced", jboolean>(); }
	...
	void registerScrollCaptureCallback(jni::ref<android::view::ScrollCaptureCallback> callback) { return call_method<"registerScrollCaptureCallback", void>(callback); }
	void removeOnFrameMetricsAvailableListener(jni::ref<android::view::Window_OnFrameMetricsAvailableListener> listener) { return call_method<"removeOnFrameMetricsAvailableListener", void>(listener); }
	...
	void setBackgroundBlurRadius(jint blurRadius) { return call_method<"setBackgroundBlurRadius", void>(blurRadius); }
	...
	void setDecorCaptionShade(jint p1) { return call_method<"setDecorCaptionShade", void>(p1); }
	void setDecorFitsSystemWindows(jboolean decorFitsSystemWindows) { return call_method<"setDecorFitsSystemWindows", void>(decorFitsSystemWindows); }
	void setDesiredHdrHeadroom(jfloat desiredHeadroom) { return call_method<"setDesiredHdrHeadroom", void>(desiredHeadroom); }
	...
	void setFrameRateBoostOnTouchEnabled(jboolean enabled) { return call_method<"setFrameRateBoostOnTouchEnabled", void>(enabled); }
	void setFrameRatePowerSavingsBalanced(jboolean enabled) { return call_method<"setFrameRatePowerSavingsBalanced", void>(enabled); }
	void setGravity(jint gravity) { return call_method<"setGravity", void>(gravity); }
	void setHideOverlayWindows(jboolean hide) { return call_method<"setHideOverlayWindows", void>(hide); }
	...
	void setNavigationBarContrastEnforced(jboolean enforceContrast) { return call_method<"setNavigationBarContrastEnforced", void>(enforceContrast); }
	void setNavigationBarDividerColor(jint dividerColor) { return call_method<"setNavigationBarDividerColor", void>(dividerColor); }
	void setPreferMinimalPostProcessing(jboolean isPreferred) { return call_method<"setPreferMinimalPostProcessing", void>(isPreferred); }
	...
	void setResizingCaptionDrawable(jni::ref<android::graphics::drawable::Drawable> p1) { return call_method<"setResizingCaptionDrawable", void>(p1); }
	void setRestrictedCaptionAreaListener(jni::ref<android::view::Window_OnRestrictedCaptionAreaChangedListener> listener) { return call_method<"setRestrictedCaptionAreaListener", void>(listener); }
	...
	void setStatusBarContrastEnforced(jboolean ensureContrast) { return call_method<"setStatusBarContrastEnforced", void>(ensureContrast); }
	void setSustainedPerformanceMode(jboolean enable) { return call_method<"setSustainedPerformanceMode", void>(enable); }
	...
	void unregisterScrollCaptureCallback(jni::ref<android::view::ScrollCaptureCallback> callback) { return call_method<"unregisterScrollCaptureCallback", void>(callback); }
};
