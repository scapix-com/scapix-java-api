...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_CONTEXTTHEMEWRAPPER
...
public:
	...
	static jni::ref<android::view::ContextThemeWrapper> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::ContextThemeWrapper> new_object(jni::ref<android::content::Context> base, jni::ref<android::content::res::Resources_Theme> theme) { return object_base::new_object(base, theme); }
	static jni::ref<android::view::ContextThemeWrapper> new_object(jni::ref<android::content::Context> base, jint themeResId) { return object_base::new_object(base, themeResId); }
	...
	void setTheme(jni::ref<android::content::res::Resources_Theme> theme) { return call_method<"setTheme", void>(theme); }
