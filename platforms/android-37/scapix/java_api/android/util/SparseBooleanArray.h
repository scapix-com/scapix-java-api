...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_SPARSEBOOLEANARRAY
...
public:
	...
	static jni::ref<android::util::SparseBooleanArray> new_object() { return object_base::new_object(); }
	static jni::ref<android::util::SparseBooleanArray> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	...
	void setValueAt(jint index, jboolean value) { return call_method<"setValueAt", void>(index, value); }
