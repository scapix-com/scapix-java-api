...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_TYPEDVALUE
...
public:
	...
	static jni::ref<android::util::TypedValue> new_object() { return object_base::new_object(); }
	...
	static jfloat convertDimensionToPixels(jint unitToConvertFrom, jfloat value, jni::ref<android::util::DisplayMetrics> metrics) { return call_static_method<"convertDimensionToPixels", jfloat>(unitToConvertFrom, value, metrics); }
	static jfloat convertPixelsToDimension(jint unitToConvertTo, jfloat pixelValue, jni::ref<android::util::DisplayMetrics> metrics) { return call_static_method<"convertPixelsToDimension", jfloat>(unitToConvertTo, pixelValue, metrics); }
	static jfloat deriveDimension(jint unitToConvertTo, jfloat pixelValue, jni::ref<android::util::DisplayMetrics> metrics) { return call_static_method<"deriveDimension", jfloat>(unitToConvertTo, pixelValue, metrics); }
