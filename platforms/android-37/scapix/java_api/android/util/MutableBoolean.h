...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_MUTABLEBOOLEAN
...
public:
	...
	static jni::ref<android::util::MutableBoolean> new_object(jboolean value) { return object_base::new_object(value); }
};
