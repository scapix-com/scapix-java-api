...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_UTIL_MEASUREUNIT_MEASUREPREFIX
...
public:
	...
	static jni::ref<android::icu::util::MeasureUnit_MeasurePrefix> QUECTO() { return get_static_field<"QUECTO", jni::ref<android::icu::util::MeasureUnit_MeasurePrefix>>(); }
	static jni::ref<android::icu::util::MeasureUnit_MeasurePrefix> QUETTA() { return get_static_field<"QUETTA", jni::ref<android::icu::util::MeasureUnit_MeasurePrefix>>(); }
	static jni::ref<android::icu::util::MeasureUnit_MeasurePrefix> RONNA() { return get_static_field<"RONNA", jni::ref<android::icu::util::MeasureUnit_MeasurePrefix>>(); }
	static jni::ref<android::icu::util::MeasureUnit_MeasurePrefix> RONTO() { return get_static_field<"RONTO", jni::ref<android::icu::util::MeasureUnit_MeasurePrefix>>(); }
