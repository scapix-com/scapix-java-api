...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_UTIL_TIMEZONE
...
public:
	...
	static jni::ref<android::icu::util::TimeZone> new_object() { return object_base::new_object(); }
	...
	static jni::ref<java::lang::String> getIanaID(jni::ref<java::lang::String> id) { return call_static_method<"getIanaID", jni::ref<java::lang::String>>(id); }
	...
	void getOffset(jlong date, jboolean local, jni::ref<jni::array<jint>> offsets) { return call_method<"getOffset", void>(date, local, offsets); }
