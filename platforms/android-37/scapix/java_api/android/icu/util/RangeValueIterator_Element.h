...
class RangeValueIterator_Element;
...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_UTIL_RANGEVALUEITERATOR_ELEMENT
...
public:
	...
	static jni::ref<android::icu::util::RangeValueIterator_Element> new_object() { return object_base::new_object(); }
};
