...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_UTIL_ULOCALE
#define SCAPIX_JAVA_API_ANDROID_ICU_UTIL_ULOCALE

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/icu/util/ULocale_AvailableType.h>
...
public:
	...
	using AvailableType = ULocale_AvailableType;
	...
	static jni::ref<android::icu::util::ULocale> new_object(jni::ref<java::lang::String> localeID) { return object_base::new_object(localeID); }
	static jni::ref<android::icu::util::ULocale> new_object(jni::ref<java::lang::String> a, jni::ref<java::lang::String> b) { return object_base::new_object(a, b); }
	static jni::ref<android::icu::util::ULocale> new_object(jni::ref<java::lang::String> a, jni::ref<java::lang::String> b, jni::ref<java::lang::String> c) { return object_base::new_object(a, b, c); }
	...
	static jni::ref<android::icu::util::ULocale> createCanonical(jni::ref<android::icu::util::ULocale> locale) { return call_static_method<"createCanonical", jni::ref<android::icu::util::ULocale>>(locale); }
	...
	static jni::ref<java::util::Collection> getAvailableLocalesByType(jni::ref<android::icu::util::ULocale_AvailableType> type) { return call_static_method<"getAvailableLocalesByType", jni::ref<java::util::Collection>>(type); }
