...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_NUMBER_NUMBERFORMATTERSETTINGS
...
public:
	...
	jni::ref<android::icu::number::NumberFormatterSettings> displayOptions(jni::ref<android::icu::text::DisplayOptions> displayOptions) { return call_method<"displayOptions", jni::ref<android::icu::number::NumberFormatterSettings>>(displayOptions); }
	...
	jni::ref<java::lang::String> toSkeleton() { return call_method<"toSkeleton", jni::ref<java::lang::String>>(); }
