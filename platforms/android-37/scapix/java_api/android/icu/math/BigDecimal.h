...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_MATH_BIGDECIMAL
...
public:
	...
	static jni::ref<android::icu::math::BigDecimal> new_object(jni::ref<jni::array<jchar>> inchars) { return object_base::new_object(inchars); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jni::ref<jni::array<jchar>> inchars, jint offset, jint length) { return object_base::new_object(inchars, offset, length); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jdouble num) { return object_base::new_object(num); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jint num) { return object_base::new_object(num); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jni::ref<java::math::BigDecimal> bd) { return object_base::new_object(bd); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jni::ref<java::math::BigInteger> bi) { return object_base::new_object(bi); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jni::ref<java::math::BigInteger> bi, jint scale) { return object_base::new_object(bi, scale); }
	static jni::ref<android::icu::math::BigDecimal> new_object(jlong num) { return object_base::new_object(num); }
	...
	static jni::ref<android::icu::math::BigDecimal> valueOf(jlong lint, jint scale) { return call_static_method<"valueOf", jni::ref<android::icu::math::BigDecimal>>(lint, scale); }
};
