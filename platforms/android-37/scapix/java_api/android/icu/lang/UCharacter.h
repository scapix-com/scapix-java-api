...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_LANG_UCHARACTER
#define SCAPIX_JAVA_API_ANDROID_ICU_LANG_UCHARACTER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/icu/lang/UCharacter_IdentifierType.h>
...
#include <scapix/java_api/android/icu/lang/UCharacter_VerticalOrientation.h>
...
#include <scapix/java_api/android/icu/lang/UCharacter_IndicSyllabicCategory.h>
#include <scapix/java_api/android/icu/lang/UCharacter_IndicPositionalCategory.h>
...
public:
	...
	using VerticalOrientation = UCharacter_VerticalOrientation;
	...
	using IndicSyllabicCategory = UCharacter_IndicSyllabicCategory;
	using IndicPositionalCategory = UCharacter_IndicPositionalCategory;
	using IdentifierType = UCharacter_IdentifierType;
	...
	static jint getCodePoint(jint lead, jint trail) { return call_static_method<"getCodePoint", jint>(lead, trail); }
	...
	static jint getIdentifierTypes(jint c, jni::ref<java::util::EnumSet> types) { return call_static_method<"getIdentifierTypes", jint>(c, types); }
	...
	static jboolean hasBinaryProperty(jni::ref<java::lang::CharSequence> s, jint property) { return call_static_method<"hasBinaryProperty", jboolean>(s, property); }
	static jboolean hasIdentifierType(jint c, jni::ref<android::icu::lang::UCharacter_IdentifierType> type) { return call_static_method<"hasIdentifierType", jboolean>(c, type); }
	...
	static jboolean isHighSurrogate(jint codePoint) { return call_static_method<"isHighSurrogate", jboolean>(codePoint); }
	...
	static jboolean isLowSurrogate(jint codePoint) { return call_static_method<"isLowSurrogate", jboolean>(codePoint); }
	...
	static jboolean isSurrogatePair(jint high, jint low) { return call_static_method<"isSurrogatePair", jboolean>(high, low); }
	...
	static jint toCodePoint(jint high, jint low) { return call_static_method<"toCodePoint", jint>(high, low); }
