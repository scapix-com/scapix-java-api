...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATEFORMAT
...
public:
	...
	jni::ref<java::lang::String> format(jni::ref<java::time::temporal::Temporal> date) { return call_method<"format", jni::ref<java::lang::String>>(date); }
	jni::ref<java::lang::StringBuffer> format(jni::ref<java::time::temporal::Temporal> date, jni::ref<java::lang::StringBuffer> toAppendTo, jni::ref<java::text::FieldPosition> fieldPosition) { return call_method<"format", jni::ref<java::lang::StringBuffer>>(date, toAppendTo, fieldPosition); }
