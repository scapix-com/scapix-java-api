...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_RELATIVEDATETIMEFORMATTER
...
public:
	...
	jni::ref<java::lang::String> format(jdouble quantity, jni::ref<android::icu::text::RelativeDateTimeFormatter_Direction> direction, jni::ref<android::icu::text::RelativeDateTimeFormatter_RelativeUnit> unit) { return call_method<"format", jni::ref<java::lang::String>>(quantity, direction, unit); }
	jni::ref<java::lang::String> format(jdouble offset, jni::ref<android::icu::text::RelativeDateTimeFormatter_RelativeDateTimeUnit> unit) { return call_method<"format", jni::ref<java::lang::String>>(offset, unit); }
	jni::ref<java::lang::String> formatNumeric(jdouble offset, jni::ref<android::icu::text::RelativeDateTimeFormatter_RelativeDateTimeUnit> unit) { return call_method<"formatNumeric", jni::ref<java::lang::String>>(offset, unit); }
	jni::ref<android::icu::text::RelativeDateTimeFormatter_FormattedRelativeDateTime> formatNumericToValue(jdouble offset, jni::ref<android::icu::text::RelativeDateTimeFormatter_RelativeDateTimeUnit> unit) { return call_method<"formatNumericToValue", jni::ref<android::icu::text::RelativeDateTimeFormatter_FormattedRelativeDateTime>>(offset, unit); }
	...
	jni::ref<android::icu::text::RelativeDateTimeFormatter_FormattedRelativeDateTime> formatToValue(jdouble quantity, jni::ref<android::icu::text::RelativeDateTimeFormatter_Direction> direction, jni::ref<android::icu::text::RelativeDateTimeFormatter_RelativeUnit> unit) { return call_method<"formatToValue", jni::ref<android::icu::text::RelativeDateTimeFormatter_FormattedRelativeDateTime>>(quantity, direction, unit); }
	jni::ref<android::icu::text::RelativeDateTimeFormatter_FormattedRelativeDateTime> formatToValue(jdouble offset, jni::ref<android::icu::text::RelativeDateTimeFormatter_RelativeDateTimeUnit> unit) { return call_method<"formatToValue", jni::ref<android::icu::text::RelativeDateTimeFormatter_FormattedRelativeDateTime>>(offset, unit); }
