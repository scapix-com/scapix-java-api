...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATEINTERVALINFO_PATTERNINFO
...
public:
	...
	static jni::ref<android::icu::text::DateIntervalInfo_PatternInfo> new_object(jni::ref<java::lang::String> firstPart, jni::ref<java::lang::String> secondPart, jboolean firstDateInPtnIsLaterDate) { return object_base::new_object(firstPart, secondPart, firstDateInPtnIsLaterDate); }
