...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_BIDI
...
public:
	...
	static jni::ref<android::icu::text::Bidi> new_object() { return object_base::new_object(); }
	static jni::ref<android::icu::text::Bidi> new_object(jni::ref<jni::array<jchar>> text, jint textStart, jni::ref<jni::array<jbyte>> embeddings, jint embStart, jint paragraphLength, jint flags) { return object_base::new_object(text, textStart, embeddings, embStart, paragraphLength, flags); }
	static jni::ref<android::icu::text::Bidi> new_object(jint maxLength, jint maxRunCount) { return object_base::new_object(maxLength, maxRunCount); }
	static jni::ref<android::icu::text::Bidi> new_object(jni::ref<java::lang::String> paragraph, jint flags) { return object_base::new_object(paragraph, flags); }
	static jni::ref<android::icu::text::Bidi> new_object(jni::ref<java::text::AttributedCharacterIterator> paragraph) { return object_base::new_object(paragraph); }
