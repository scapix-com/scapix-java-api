...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATEINTERVALFORMAT
#define SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATEINTERVALFORMAT

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/icu/text/DateFormat.h>
#include <scapix/java_api/android/icu/text/DateIntervalFormat_FormattedDateInterval.h>
...
public:
	...
	using FormattedDateInterval = DateIntervalFormat_FormattedDateInterval;
	...
	jni::ref<java::lang::StringBuffer> format(jni::ref<java::time::temporal::Temporal> fromTemporal, jni::ref<java::time::temporal::Temporal> toTemporal, jni::ref<java::lang::StringBuffer> appendTo, jni::ref<java::text::FieldPosition> pos) { return call_method<"format", jni::ref<java::lang::StringBuffer>>(fromTemporal, toTemporal, appendTo, pos); }
	jni::ref<android::icu::text::DateIntervalFormat_FormattedDateInterval> formatToValue(jni::ref<android::icu::util::Calendar> fromCalendar, jni::ref<android::icu::util::Calendar> toCalendar) { return call_method<"formatToValue", jni::ref<android::icu::text::DateIntervalFormat_FormattedDateInterval>>(fromCalendar, toCalendar); }
	jni::ref<android::icu::text::DateIntervalFormat_FormattedDateInterval> formatToValue(jni::ref<android::icu::util::DateInterval> dtInterval) { return call_method<"formatToValue", jni::ref<android::icu::text::DateIntervalFormat_FormattedDateInterval>>(dtInterval); }
	jni::ref<android::icu::text::DateIntervalFormat_FormattedDateInterval> formatToValue(jni::ref<java::time::temporal::Temporal> fromTemporal, jni::ref<java::time::temporal::Temporal> toTemporal) { return call_method<"formatToValue", jni::ref<android::icu::text::DateIntervalFormat_FormattedDateInterval>>(fromTemporal, toTemporal); }
