...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_CONSTRAINEDFIELDPOSITION
...
public:
	...
	static jni::ref<android::icu::text::ConstrainedFieldPosition> new_object() { return object_base::new_object(); }
