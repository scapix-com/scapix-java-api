...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_UNICODESETSPANNER
...
public:
	...
	static jni::ref<android::icu::text::UnicodeSetSpanner> new_object(jni::ref<android::icu::text::UnicodeSet> source) { return object_base::new_object(source); }
