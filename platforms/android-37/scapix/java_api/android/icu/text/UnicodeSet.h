...
struct scapix::jni::object_traits<scapix::java_api::android::icu::text::UnicodeSet>
{
	...
	using base_classes = std::tuple<scapix::java_api::android::icu::text::UnicodeFilter, scapix::java_api::java::lang::Comparable, scapix::java_api::android::icu::util::Freezable, scapix::java_api::java::lang::Iterable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_UNICODESET
...
public:
	...
	static jint SIMPLE_CASE_INSENSITIVE() { return get_static_field<"SIMPLE_CASE_INSENSITIVE", jint>(); }

	static jni::ref<android::icu::text::UnicodeSet> new_object() { return object_base::new_object(); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<android::icu::text::UnicodeSet> other) { return object_base::new_object(other); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jint start, jint end) { return object_base::new_object(start, end); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<jni::array<jint>> pairs) { return object_base::new_object(pairs); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<java::lang::String> pattern, jboolean ignoreWhitespace) { return object_base::new_object(pattern, ignoreWhitespace); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<java::lang::String> pattern, jint options) { return object_base::new_object(pattern, options); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::text::ParsePosition> pos, jni::ref<android::icu::text::SymbolTable> symbols) { return object_base::new_object(pattern, pos, symbols); }
	static jni::ref<android::icu::text::UnicodeSet> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::text::ParsePosition> pos, jni::ref<android::icu::text::SymbolTable> symbols, jint options) { return object_base::new_object(pattern, pos, symbols, options); }
	...
	jni::ref<java::util::stream::IntStream> codePointStream() { return call_method<"codePointStream", jni::ref<java::util::stream::IntStream>>(); }
	jni::ref<java::lang::Iterable> codePoints() { return call_method<"codePoints", jni::ref<java::lang::Iterable>>(); }
	...
	jboolean hasStrings() { return call_method<"hasStrings", jboolean>(); }
	...
	jni::ref<java::util::stream::Stream> rangeStream() { return call_method<"rangeStream", jni::ref<java::util::stream::Stream>>(); }
	...
	jni::ref<java::util::stream::Stream> stringStream() { return call_method<"stringStream", jni::ref<java::util::stream::Stream>>(); }
