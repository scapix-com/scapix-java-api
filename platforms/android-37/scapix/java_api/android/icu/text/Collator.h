...
struct scapix::jni::object_traits<scapix::java_api::android::icu::text::Collator>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::Comparator, scapix::java_api::android::icu::util::Freezable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_COLLATOR
