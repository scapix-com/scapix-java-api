...
#ifndef SCAPIX_JAVA_API_ANDROID_ANIMATION_BIDIRECTIONALTYPECONVERTER
...
public:
	...
	static jni::ref<android::animation::BidirectionalTypeConverter> new_object(jni::ref<java::lang::Class> fromClass, jni::ref<java::lang::Class> toClass) { return object_base::new_object(fromClass, toClass); }
