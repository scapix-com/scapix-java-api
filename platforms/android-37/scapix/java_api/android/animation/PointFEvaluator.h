...
#ifndef SCAPIX_JAVA_API_ANDROID_ANIMATION_POINTFEVALUATOR
...
public:
	...
	static jni::ref<android::animation::PointFEvaluator> new_object() { return object_base::new_object(); }
	static jni::ref<android::animation::PointFEvaluator> new_object(jni::ref<android::graphics::PointF> reuse) { return object_base::new_object(reuse); }
