...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_SCRIPT_LAUNCHOPTIONS
...
public:
	...
	static jni::ref<android::renderscript::Script_LaunchOptions> new_object() { return object_base::new_object(); }
