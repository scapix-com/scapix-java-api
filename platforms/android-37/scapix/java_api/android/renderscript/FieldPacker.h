...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_FIELDPACKER
...
public:
	...
	static jni::ref<android::renderscript::FieldPacker> new_object(jni::ref<jni::array<jbyte>> data) { return object_base::new_object(data); }
	static jni::ref<android::renderscript::FieldPacker> new_object(jint len) { return object_base::new_object(len); }
