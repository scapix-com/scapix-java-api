...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_RSINVALIDSTATEEXCEPTION
...
public:
	...
	static jni::ref<android::renderscript::RSInvalidStateException> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
};
