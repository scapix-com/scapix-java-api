...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_SCRIPTGROUP_BINDING
...
public:
	...
	static jni::ref<android::renderscript::ScriptGroup_Binding> new_object(jni::ref<android::renderscript::Script_FieldID> field, jni::ref<java::lang::Object> value) { return object_base::new_object(field, value); }
};
