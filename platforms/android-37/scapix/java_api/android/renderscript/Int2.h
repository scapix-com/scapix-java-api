...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_INT2
...
public:
	...
	static jni::ref<android::renderscript::Int2> new_object() { return object_base::new_object(); }
	static jni::ref<android::renderscript::Int2> new_object(jint x, jint y) { return object_base::new_object(x, y); }
};
