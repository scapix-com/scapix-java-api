...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_SAMPLER_BUILDER
...
public:
	...
	static jni::ref<android::renderscript::Sampler_Builder> new_object(jni::ref<android::renderscript::RenderScript> rs) { return object_base::new_object(rs); }
