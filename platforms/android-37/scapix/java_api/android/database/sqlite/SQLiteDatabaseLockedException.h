...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITEDATABASELOCKEDEXCEPTION
...
public:
	...
	static jni::ref<android::database::sqlite::SQLiteDatabaseLockedException> new_object() { return object_base::new_object(); }
	static jni::ref<android::database::sqlite::SQLiteDatabaseLockedException> new_object(jni::ref<java::lang::String> error) { return object_base::new_object(error); }
};
