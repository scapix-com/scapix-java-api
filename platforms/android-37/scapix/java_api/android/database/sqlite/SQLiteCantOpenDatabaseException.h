...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITECANTOPENDATABASEEXCEPTION
...
public:
	...
	static jni::ref<android::database::sqlite::SQLiteCantOpenDatabaseException> new_object() { return object_base::new_object(); }
	static jni::ref<android::database::sqlite::SQLiteCantOpenDatabaseException> new_object(jni::ref<java::lang::String> error) { return object_base::new_object(error); }
};
