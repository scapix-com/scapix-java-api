...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITECURSOR
...
public:
	...
	static jni::ref<android::database::sqlite::SQLiteCursor> new_object(jni::ref<android::database::sqlite::SQLiteCursorDriver> driver, jni::ref<java::lang::String> editTable, jni::ref<android::database::sqlite::SQLiteQuery> query) { return object_base::new_object(driver, editTable, query); }
	static jni::ref<android::database::sqlite::SQLiteCursor> new_object(jni::ref<android::database::sqlite::SQLiteDatabase> db, jni::ref<android::database::sqlite::SQLiteCursorDriver> driver, jni::ref<java::lang::String> editTable, jni::ref<android::database::sqlite::SQLiteQuery> query) { return object_base::new_object(db, driver, editTable, query); }
