...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_CURSORWINDOW
...
public:
	...
	static jni::ref<android::database::CursorWindow> new_object(jboolean localWindow) { return object_base::new_object(localWindow); }
	static jni::ref<android::database::CursorWindow> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<android::database::CursorWindow> new_object(jni::ref<java::lang::String> name, jlong windowSizeBytes) { return object_base::new_object(name, windowSizeBytes); }
	...
	jboolean putDouble(jdouble value, jint row, jint column) { return call_method<"putDouble", jboolean>(value, row, column); }
	jboolean putLong(jlong value, jint row, jint column) { return call_method<"putLong", jboolean>(value, row, column); }
