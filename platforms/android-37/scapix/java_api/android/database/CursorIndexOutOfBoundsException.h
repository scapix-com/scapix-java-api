...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_CURSORINDEXOUTOFBOUNDSEXCEPTION
...
public:
	...
	static jni::ref<android::database::CursorIndexOutOfBoundsException> new_object(jint index, jint size) { return object_base::new_object(index, size); }
	static jni::ref<android::database::CursorIndexOutOfBoundsException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
