...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_BASEEXPANDABLELISTADAPTER
...
public:
	...
	static jni::ref<android::widget::BaseExpandableListAdapter> new_object() { return object_base::new_object(); }
	...
	jlong getCombinedChildId(jlong groupId, jlong childId) { return call_method<"getCombinedChildId", jlong>(groupId, childId); }
