...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_CURSORADAPTER
...
public:
	...
	static jni::ref<android::widget::CursorAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<android::database::Cursor> c) { return object_base::new_object(context, c); }
	static jni::ref<android::widget::CursorAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<android::database::Cursor> c, jboolean autoRequery) { return object_base::new_object(context, c, autoRequery); }
	static jni::ref<android::widget::CursorAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<android::database::Cursor> c, jint flags) { return object_base::new_object(context, c, flags); }
