...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_CURSORTREEADAPTER
...
public:
	...
	static jni::ref<android::widget::CursorTreeAdapter> new_object(jni::ref<android::database::Cursor> cursor, jni::ref<android::content::Context> context) { return object_base::new_object(cursor, context); }
	static jni::ref<android::widget::CursorTreeAdapter> new_object(jni::ref<android::database::Cursor> cursor, jni::ref<android::content::Context> context, jboolean autoRequery) { return object_base::new_object(cursor, context, autoRequery); }
