...
class AbsoluteLayout_LayoutParams;
...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_ABSOLUTELAYOUT_LAYOUTPARAMS
...
public:
	...
	static jni::ref<android::widget::AbsoluteLayout_LayoutParams> new_object(jni::ref<android::content::Context> c, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(c, attrs); }
	static jni::ref<android::widget::AbsoluteLayout_LayoutParams> new_object(jni::ref<android::view::ViewGroup_LayoutParams> source) { return object_base::new_object(source); }
	static jni::ref<android::widget::AbsoluteLayout_LayoutParams> new_object(jint width, jint height, jint x, jint y) { return object_base::new_object(width, height, x, y); }
