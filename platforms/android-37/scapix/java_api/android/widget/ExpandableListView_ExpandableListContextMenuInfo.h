...
class ExpandableListView_ExpandableListContextMenuInfo;
...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_EXPANDABLELISTVIEW_EXPANDABLELISTCONTEXTMENUINFO
...
public:
	...
	static jni::ref<android::widget::ExpandableListView_ExpandableListContextMenuInfo> new_object(jni::ref<android::view::View> targetView, jlong packedPosition, jlong id) { return object_base::new_object(targetView, packedPosition, id); }
};
