...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_DIALERFILTER
...
public:
	...
	static jni::ref<android::widget::DialerFilter> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::DialerFilter> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
