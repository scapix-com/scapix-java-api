...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_SERVICEWORKERCONTROLLER
...
public:
	...
	static jni::ref<android::webkit::ServiceWorkerController> new_object() { return object_base::new_object(); }
