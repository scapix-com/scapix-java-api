...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_WEBCHROMECLIENT_FILECHOOSERPARAMS
...
public:
	...
	static jint MODE_OPEN_FOLDER() { return get_static_field<"MODE_OPEN_FOLDER", jint>(); }
	...
	static jint PERMISSION_MODE_READ() { return get_static_field<"PERMISSION_MODE_READ", jint>(); }
	static jint PERMISSION_MODE_READ_WRITE() { return get_static_field<"PERMISSION_MODE_READ_WRITE", jint>(); }

	static jni::ref<android::webkit::WebChromeClient_FileChooserParams> new_object() { return object_base::new_object(); }
	...
	jint getPermissionMode() { return call_method<"getPermissionMode", jint>(); }
