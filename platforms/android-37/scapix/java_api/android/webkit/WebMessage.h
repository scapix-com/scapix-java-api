...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_WEBMESSAGE
...
public:
	...
	static jni::ref<android::webkit::WebMessage> new_object(jni::ref<java::lang::String> data) { return object_base::new_object(data); }
	static jni::ref<android::webkit::WebMessage> new_object(jni::ref<java::lang::String> data, jni::ref<jni::array<android::webkit::WebMessagePort>> ports) { return object_base::new_object(data, ports); }
