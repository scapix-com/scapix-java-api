...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACAS
...
public:
	...
	static jint SCRAMBLING_MODE_AES_CBC() { return get_static_field<"SCRAMBLING_MODE_AES_CBC", jint>(); }
	...
	static jni::ref<android::media::MediaCas> new_object(jni::ref<android::content::Context> context, jint casSystemId, jni::ref<java::lang::String> tvInputServiceSessionId, jint priorityHint) { return object_base::new_object(context, casSystemId, tvInputServiceSessionId, priorityHint); }
	static jni::ref<android::media::MediaCas> new_object(jni::ref<android::content::Context> context, jint casSystemId, jni::ref<java::lang::String> tvInputServiceSessionId, jint priorityHint, jni::ref<android::os::Handler> handler, jni::ref<android::media::MediaCas_EventListener> listener) { return object_base::new_object(context, casSystemId, tvInputServiceSessionId, priorityHint, handler, listener); }
	static jni::ref<android::media::MediaCas> new_object(jint casSystemId) { return object_base::new_object(casSystemId); }
