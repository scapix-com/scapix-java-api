...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOTRACK_BUILDER
...
public:
	...
	static jni::ref<android::media::AudioTrack_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::media::AudioTrack_Builder> setCodecProvenance(jni::ref<java::lang::String> codecMediaType) { return call_method<"setCodecProvenance", jni::ref<android::media::AudioTrack_Builder>>(codecMediaType); }
