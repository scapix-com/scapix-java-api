...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODECINFO_VIDEOCAPABILITIES
...
#include <scapix/java_api/android/media/MediaCodecInfo_VideoCapabilities_PerformancePoint.h>
...
public:
	...
	using PerformancePoint = MediaCodecInfo_VideoCapabilities_PerformancePoint;
	...
	jni::ref<java::util::List> getSupportedPerformancePoints() { return call_method<"getSupportedPerformancePoints", jni::ref<java::util::List>>(); }
