...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIAROUTE2PROVIDERSERVICE
...
public:
	...
	static jni::ref<android::media::MediaRoute2ProviderService> new_object() { return object_base::new_object(); }
	...
	void notifyRequestFailed(jlong requestId, jint reason) { return call_method<"notifyRequestFailed", void>(requestId, reason); }
	void notifyRoutes(jni::ref<java::util::Collection> routes) { return call_method<"notifyRoutes", void>(routes); }
	void notifySessionCreated(jlong requestId, jni::ref<android::media::RoutingSessionInfo> sessionInfo) { return call_method<"notifySessionCreated", void>(requestId, sessionInfo); }
	...
	void onDiscoveryPreferenceChanged(jni::ref<android::media::RouteDiscoveryPreference> compositePreference, jni::ref<java::util::Map> perAppPreferences) { return call_method<"onDiscoveryPreferenceChanged", void>(compositePreference, perAppPreferences); }
