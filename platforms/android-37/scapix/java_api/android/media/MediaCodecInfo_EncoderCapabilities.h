...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODECINFO_ENCODERCAPABILITIES
...
public:
	...
	jni::ref<jni::array<java::lang::String>> getSupportedLayeringSchemas() { return call_method<"getSupportedLayeringSchemas", jni::ref<jni::array<java::lang::String>>>(); }
