...
class RouteListingPreference_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_ROUTELISTINGPREFERENCE_BUILDER
...
public:
	...
	static jni::ref<android::media::RouteListingPreference_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::media::RouteListingPreference_Builder> setMissingPermissionsComponentName(jni::ref<android::content::ComponentName> componentName) { return call_method<"setMissingPermissionsComponentName", jni::ref<android::media::RouteListingPreference_Builder>>(componentName); }
