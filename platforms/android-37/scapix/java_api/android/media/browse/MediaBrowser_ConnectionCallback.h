...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_BROWSE_MEDIABROWSER_CONNECTIONCALLBACK
...
public:
	...
	static jni::ref<android::media::browse::MediaBrowser_ConnectionCallback> new_object() { return object_base::new_object(); }
