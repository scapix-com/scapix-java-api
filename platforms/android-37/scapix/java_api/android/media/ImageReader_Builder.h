...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_IMAGEREADER_BUILDER
...
public:
	...
	static jni::ref<android::media::ImageReader_Builder> new_object(jint width, jint height) { return object_base::new_object(width, height); }
