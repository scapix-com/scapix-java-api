...
class VolumeShaper_Configuration_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_VOLUMESHAPER_CONFIGURATION_BUILDER
...
public:
	...
	static jni::ref<android::media::VolumeShaper_Configuration_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::media::VolumeShaper_Configuration_Builder> new_object(jni::ref<android::media::VolumeShaper_Configuration> configuration) { return object_base::new_object(configuration); }
