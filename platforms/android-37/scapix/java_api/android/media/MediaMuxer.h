...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIAMUXER
...
public:
	...
	static jni::ref<android::media::MediaMuxer> new_object(jni::ref<java::io::FileDescriptor> fd, jint format) { return object_base::new_object(fd, format); }
	static jni::ref<android::media::MediaMuxer> new_object(jni::ref<java::lang::String> path, jint format) { return object_base::new_object(path, format); }
