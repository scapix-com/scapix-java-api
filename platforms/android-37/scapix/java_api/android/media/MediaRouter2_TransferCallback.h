...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIAROUTER2_TRANSFERCALLBACK
...
public:
	...
	static jni::ref<android::media::MediaRouter2_TransferCallback> new_object() { return object_base::new_object(); }
