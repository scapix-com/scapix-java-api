...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIORECORD
...
public:
	...
	static jni::ref<android::media::AudioRecord> new_object(jint audioSource, jint sampleRateInHz, jint channelConfig, jint audioFormat, jint bufferSizeInBytes) { return object_base::new_object(audioSource, sampleRateInHz, channelConfig, audioFormat, bufferSizeInBytes); }
