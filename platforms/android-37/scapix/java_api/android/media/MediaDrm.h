...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIADRM
...
public:
	...
	static jni::ref<android::media::MediaDrm> new_object(jni::ref<java::util::UUID> uuid) { return object_base::new_object(uuid); }
	...
	jni::ref<jni::array<jbyte>> getSecureStop(jni::ref<jni::array<jbyte>> ssid) { return call_method<"getSecureStop", jni::ref<jni::array<jbyte>>>(ssid); }
	...
	void releaseSecureStops(jni::ref<jni::array<jbyte>> ssRelease) { return call_method<"releaseSecureStops", void>(ssRelease); }
	...
	void removeSecureStop(jni::ref<jni::array<jbyte>> ssid) { return call_method<"removeSecureStop", void>(ssid); }
