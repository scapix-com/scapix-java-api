...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_RINGTONEMANAGER
...
public:
	...
	static jni::ref<android::media::RingtoneManager> new_object(jni::ref<android::app::Activity> activity) { return object_base::new_object(activity); }
	static jni::ref<android::media::RingtoneManager> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	static jni::ref<android::net::Uri> getRingtoneUriForPhoneAccountHandle(jni::ref<android::content::Context> context, jni::ref<android::telecom::PhoneAccountHandle> phoneAccountHandle) { return call_static_method<"getRingtoneUriForPhoneAccountHandle", jni::ref<android::net::Uri>>(context, phoneAccountHandle); }
	...
	static void setRingtoneUri(jni::ref<android::content::Context> context, jni::ref<android::net::Uri> ringtoneUri, jni::ref<android::telecom::PhoneAccountHandle> phoneAccountHandle) { return call_static_method<"setRingtoneUri", void>(context, ringtoneUri, phoneAccountHandle); }
