...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACRYPTO
...
public:
	...
	static jni::ref<android::media::MediaCrypto> new_object(jni::ref<java::util::UUID> uuid, jni::ref<jni::array<jbyte>> sessionId) { return object_base::new_object(uuid, sessionId); }
