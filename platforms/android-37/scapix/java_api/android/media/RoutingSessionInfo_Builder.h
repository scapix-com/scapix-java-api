...
class RoutingSessionInfo_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_ROUTINGSESSIONINFO_BUILDER
...
public:
	...
	static jni::ref<android::media::RoutingSessionInfo_Builder> new_object(jni::ref<android::media::RoutingSessionInfo> sessionInfo) { return object_base::new_object(sessionInfo); }
	static jni::ref<android::media::RoutingSessionInfo_Builder> new_object(jni::ref<java::lang::String> originalId, jni::ref<java::lang::String> clientPackageName) { return object_base::new_object(originalId, clientPackageName); }
	...
	jni::ref<android::media::RoutingSessionInfo_Builder> setTransferInitiator(jni::ref<android::os::UserHandle> transferInitiatorUserHandle, jni::ref<java::lang::String> transferInitiatorPackageName) { return call_method<"setTransferInitiator", jni::ref<android::media::RoutingSessionInfo_Builder>>(transferInitiatorUserHandle, transferInitiatorPackageName); }
	jni::ref<android::media::RoutingSessionInfo_Builder> setTransferReason(jint transferReason) { return call_method<"setTransferReason", jni::ref<android::media::RoutingSessionInfo_Builder>>(transferReason); }
