...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SPATIALIZER
...
#include <scapix/java_api/android/media/Spatializer_OnHeadTrackerAvailableListener.h>
...
public:
	...
	using OnHeadTrackerAvailableListener = Spatializer_OnHeadTrackerAvailableListener;
	...
	void addOnHeadTrackerAvailableListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::media::Spatializer_OnHeadTrackerAvailableListener> listener) { return call_method<"addOnHeadTrackerAvailableListener", void>(executor, listener); }
	...
	jni::ref<java::util::List> getSpatializedChannelMasks() { return call_method<"getSpatializedChannelMasks", jni::ref<java::util::List>>(); }
	jboolean isAvailable() { return call_method<"isAvailable", jboolean>(); }
	jboolean isEnabled() { return call_method<"isEnabled", jboolean>(); }
	jboolean isHeadTrackerAvailable() { return call_method<"isHeadTrackerAvailable", jboolean>(); }
	void removeOnHeadTrackerAvailableListener(jni::ref<android::media::Spatializer_OnHeadTrackerAvailableListener> listener) { return call_method<"removeOnHeadTrackerAvailableListener", void>(listener); }
