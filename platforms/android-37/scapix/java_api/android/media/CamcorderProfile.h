...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_CAMCORDERPROFILE
#define SCAPIX_JAVA_API_ANDROID_MEDIA_CAMCORDERPROFILE

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/media/EncoderProfiles.h>
...
public:
	...
	static jint QUALITY_8KUHD() { return get_static_field<"QUALITY_8KUHD", jint>(); }
	...
	static jint QUALITY_TIME_LAPSE_8KUHD() { return get_static_field<"QUALITY_TIME_LAPSE_8KUHD", jint>(); }
	...
	static jni::ref<android::media::EncoderProfiles> getAll(jni::ref<java::lang::String> cameraId, jint quality) { return call_static_method<"getAll", jni::ref<android::media::EncoderProfiles>>(cameraId, quality); }
