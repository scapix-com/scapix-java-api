...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_REMOTECONTROLLER
...
public:
	...
	static jni::ref<android::media::RemoteController> new_object(jni::ref<android::content::Context> context, jni::ref<android::media::RemoteController_OnClientUpdateListener> updateListener) { return object_base::new_object(context, updateListener); }
	static jni::ref<android::media::RemoteController> new_object(jni::ref<android::content::Context> context, jni::ref<android::media::RemoteController_OnClientUpdateListener> updateListener, jni::ref<android::os::Looper> looper) { return object_base::new_object(context, updateListener, looper); }
