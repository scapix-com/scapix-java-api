...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_REMOTECONTROLCLIENT
...
public:
	...
	static jni::ref<android::media::RemoteControlClient> new_object(jni::ref<android::app::PendingIntent> mediaButtonIntent) { return object_base::new_object(mediaButtonIntent); }
	static jni::ref<android::media::RemoteControlClient> new_object(jni::ref<android::app::PendingIntent> mediaButtonIntent, jni::ref<android::os::Looper> looper) { return object_base::new_object(mediaButtonIntent, looper); }
	...
	void setPlaybackState(jint state, jlong timeInMs, jfloat playbackSpeed) { return call_method<"setPlaybackState", void>(state, timeInMs, playbackSpeed); }
