...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOMANAGER
...
public:
	...
	static jint MODE_ASSISTANT_CONVERSATION() { return get_static_field<"MODE_ASSISTANT_CONVERSATION", jint>(); }
	...
	static jint STREAM_ASSISTANT() { return get_static_field<"STREAM_ASSISTANT", jint>(); }
	...
	jni::ref<java::util::Set> getSupportedDeviceTypes(jint direction) { return call_method<"getSupportedDeviceTypes", jni::ref<java::util::Set>>(direction); }
