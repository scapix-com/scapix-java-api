...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIADESCRAMBLER
...
public:
	...
	static jbyte SCRAMBLE_CONTROL_EVEN_KEY() { return get_static_field<"SCRAMBLE_CONTROL_EVEN_KEY", jbyte>(); }
	static jbyte SCRAMBLE_CONTROL_ODD_KEY() { return get_static_field<"SCRAMBLE_CONTROL_ODD_KEY", jbyte>(); }
	static jbyte SCRAMBLE_CONTROL_RESERVED() { return get_static_field<"SCRAMBLE_CONTROL_RESERVED", jbyte>(); }
	static jbyte SCRAMBLE_CONTROL_UNSCRAMBLED() { return get_static_field<"SCRAMBLE_CONTROL_UNSCRAMBLED", jbyte>(); }
	static jbyte SCRAMBLE_FLAG_PES_HEADER() { return get_static_field<"SCRAMBLE_FLAG_PES_HEADER", jbyte>(); }

	static jni::ref<android::media::MediaDescrambler> new_object(jint CA_system_id) { return object_base::new_object(CA_system_id); }
