...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_AUDIOEFFECT
...
public:
	...
	static jni::ref<java::lang::String> EFFECT_POST_PROCESSING() { return get_static_field<"EFFECT_POST_PROCESSING", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EFFECT_PRE_PROCESSING() { return get_static_field<"EFFECT_PRE_PROCESSING", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::util::UUID> EFFECT_TYPE_HAPTIC_GENERATOR() { return get_static_field<"EFFECT_TYPE_HAPTIC_GENERATOR", jni::ref<java::util::UUID>>(); }
