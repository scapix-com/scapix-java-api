...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_DYNAMICSPROCESSING_EQBAND
...
public:
	...
	static jni::ref<android::media::audiofx::DynamicsProcessing_EqBand> new_object(jni::ref<android::media::audiofx::DynamicsProcessing_EqBand> cfg) { return object_base::new_object(cfg); }
	static jni::ref<android::media::audiofx::DynamicsProcessing_EqBand> new_object(jboolean enabled, jfloat cutoffFrequency, jfloat gain) { return object_base::new_object(enabled, cutoffFrequency, gain); }
