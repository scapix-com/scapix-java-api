...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_DYNAMICSPROCESSING_LIMITER
...
public:
	...
	static jni::ref<android::media::audiofx::DynamicsProcessing_Limiter> new_object(jni::ref<android::media::audiofx::DynamicsProcessing_Limiter> cfg) { return object_base::new_object(cfg); }
	static jni::ref<android::media::audiofx::DynamicsProcessing_Limiter> new_object(jboolean inUse, jboolean enabled, jint linkGroup, jfloat attackTime, jfloat releaseTime, jfloat ratio, jfloat threshold, jfloat postGain) { return object_base::new_object(inUse, enabled, linkGroup, attackTime, releaseTime, ratio, threshold, postGain); }
