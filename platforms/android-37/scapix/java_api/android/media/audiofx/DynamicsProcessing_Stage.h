...
class DynamicsProcessing_Stage;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_DYNAMICSPROCESSING_STAGE
...
public:
	...
	static jni::ref<android::media::audiofx::DynamicsProcessing_Stage> new_object(jboolean inUse, jboolean enabled) { return object_base::new_object(inUse, enabled); }
