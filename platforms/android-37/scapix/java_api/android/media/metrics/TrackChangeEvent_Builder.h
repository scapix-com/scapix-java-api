...
class TrackChangeEvent_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_METRICS_TRACKCHANGEEVENT_BUILDER
...
public:
	...
	static jni::ref<android::media::metrics::TrackChangeEvent_Builder> new_object(jint type) { return object_base::new_object(type); }
