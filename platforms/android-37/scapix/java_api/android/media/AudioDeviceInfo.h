...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIODEVICEINFO
...
public:
	...
	static jint TYPE_BLE_BROADCAST() { return get_static_field<"TYPE_BLE_BROADCAST", jint>(); }
	static jint TYPE_BLE_CENTRAL() { return get_static_field<"TYPE_BLE_CENTRAL", jint>(); }
	static jint TYPE_BLE_CENTRAL_BROADCAST() { return get_static_field<"TYPE_BLE_CENTRAL_BROADCAST", jint>(); }
	static jint TYPE_BLE_HEADSET() { return get_static_field<"TYPE_BLE_HEADSET", jint>(); }
	static jint TYPE_BLE_HEARING_AID() { return get_static_field<"TYPE_BLE_HEARING_AID", jint>(); }
	static jint TYPE_BLE_SPEAKER() { return get_static_field<"TYPE_BLE_SPEAKER", jint>(); }
	...
	static jint TYPE_BUILTIN_SPEAKER_SAFE() { return get_static_field<"TYPE_BUILTIN_SPEAKER_SAFE", jint>(); }
	static jint TYPE_BUS() { return get_static_field<"TYPE_BUS", jint>(); }
	static jint TYPE_DOCK() { return get_static_field<"TYPE_DOCK", jint>(); }
	static jint TYPE_DOCK_ANALOG() { return get_static_field<"TYPE_DOCK_ANALOG", jint>(); }
	...
	static jint TYPE_MULTICHANNEL_GROUP() { return get_static_field<"TYPE_MULTICHANNEL_GROUP", jint>(); }
	static jint TYPE_REMOTE_SUBMIX() { return get_static_field<"TYPE_REMOTE_SUBMIX", jint>(); }
	...
	jni::ref<java::util::List> getAudioDescriptors() { return call_method<"getAudioDescriptors", jni::ref<java::util::List>>(); }
	...
	jni::ref<jni::array<jint>> getEncapsulationMetadataTypes() { return call_method<"getEncapsulationMetadataTypes", jni::ref<jni::array<jint>>>(); }
	jni::ref<jni::array<jint>> getEncapsulationModes() { return call_method<"getEncapsulationModes", jni::ref<jni::array<jint>>>(); }
	...
	jint getSpeakerLayoutChannelMask() { return call_method<"getSpeakerLayoutChannelMask", jint>(); }
