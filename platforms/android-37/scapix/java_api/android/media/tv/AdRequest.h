...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_ADREQUEST
...
public:
	...
	static jni::ref<android::media::tv::AdRequest> new_object(jint id, jint requestType, jni::ref<android::net::Uri> uri, jlong startTime, jlong stopTime, jlong echoInterval, jni::ref<android::os::Bundle> metadata) { return object_base::new_object(id, requestType, uri, startTime, stopTime, echoInterval, metadata); }
	static jni::ref<android::media::tv::AdRequest> new_object(jint id, jint requestType, jni::ref<android::os::ParcelFileDescriptor> fileDescriptor, jlong startTime, jlong stopTime, jlong echoInterval, jni::ref<java::lang::String> mediaFileType, jni::ref<android::os::Bundle> metadata) { return object_base::new_object(id, requestType, fileDescriptor, startTime, stopTime, echoInterval, mediaFileType, metadata); }
