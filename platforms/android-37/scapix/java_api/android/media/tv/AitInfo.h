...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_AITINFO
...
public:
	...
	static jni::ref<android::media::tv::AitInfo> new_object(jint type, jint version) { return object_base::new_object(type, version); }
