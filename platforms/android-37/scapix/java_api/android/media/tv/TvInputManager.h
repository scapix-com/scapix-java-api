...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVINPUTMANAGER
...
public:
	...
	static jni::ref<java::lang::String> SESSION_DATA_KEY_AD_RESPONSE() { return get_static_field<"SESSION_DATA_KEY_AD_RESPONSE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_BROADCAST_INFO_RESPONSE() { return get_static_field<"SESSION_DATA_KEY_BROADCAST_INFO_RESPONSE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_CHANNEL_URI() { return get_static_field<"SESSION_DATA_KEY_CHANNEL_URI", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_TRACKS() { return get_static_field<"SESSION_DATA_KEY_TRACKS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_TRACK_ID() { return get_static_field<"SESSION_DATA_KEY_TRACK_ID", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_TRACK_TYPE() { return get_static_field<"SESSION_DATA_KEY_TRACK_TYPE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_TV_MESSAGE_TYPE() { return get_static_field<"SESSION_DATA_KEY_TV_MESSAGE_TYPE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_KEY_VIDEO_UNAVAILABLE_REASON() { return get_static_field<"SESSION_DATA_KEY_VIDEO_UNAVAILABLE_REASON", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_AD_BUFFER_CONSUMED() { return get_static_field<"SESSION_DATA_TYPE_AD_BUFFER_CONSUMED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_AD_RESPONSE() { return get_static_field<"SESSION_DATA_TYPE_AD_RESPONSE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_BROADCAST_INFO_RESPONSE() { return get_static_field<"SESSION_DATA_TYPE_BROADCAST_INFO_RESPONSE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_TRACKS_CHANGED() { return get_static_field<"SESSION_DATA_TYPE_TRACKS_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_TRACK_SELECTED() { return get_static_field<"SESSION_DATA_TYPE_TRACK_SELECTED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_TUNED() { return get_static_field<"SESSION_DATA_TYPE_TUNED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_TV_MESSAGE() { return get_static_field<"SESSION_DATA_TYPE_TV_MESSAGE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_VIDEO_AVAILABLE() { return get_static_field<"SESSION_DATA_TYPE_VIDEO_AVAILABLE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SESSION_DATA_TYPE_VIDEO_UNAVAILABLE() { return get_static_field<"SESSION_DATA_TYPE_VIDEO_UNAVAILABLE", jni::ref<java::lang::String>>(); }
	...
	static jint VIDEO_UNAVAILABLE_REASON_STOPPED() { return get_static_field<"VIDEO_UNAVAILABLE_REASON_STOPPED", jint>(); }
