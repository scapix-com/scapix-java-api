...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVINPUTSERVICE_RECORDINGSESSION
...
public:
	...
	static jni::ref<android::media::tv::TvInputService_RecordingSession> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	void onPauseRecording(jni::ref<android::os::Bundle> params) { return call_method<"onPauseRecording", void>(params); }
	void onRelease() { return call_method<"onRelease", void>(); }
	void onResumeRecording(jni::ref<android::os::Bundle> params) { return call_method<"onResumeRecording", void>(params); }
