...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_DSMCCRESPONSE
...
public:
	...
	static jni::ref<android::media::tv::DsmccResponse> new_object(jint requestId, jint sequence, jint responseResult, jni::ref<android::os::ParcelFileDescriptor> file) { return object_base::new_object(requestId, sequence, responseResult, file); }
	static jni::ref<android::media::tv::DsmccResponse> new_object(jint requestId, jint sequence, jint responseResult, jboolean isServiceGateway, jni::ref<java::util::List> childList) { return object_base::new_object(requestId, sequence, responseResult, isServiceGateway, childList); }
	static jni::ref<android::media::tv::DsmccResponse> new_object(jint requestId, jint sequence, jint responseResult, jni::ref<jni::array<jint>> eventIds, jni::ref<jni::array<java::lang::String>> eventNames) { return object_base::new_object(requestId, sequence, responseResult, eventIds, eventNames); }
