...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_STREAMEVENTREQUEST
...
public:
	...
	static jni::ref<android::media::tv::StreamEventRequest> new_object(jint requestId, jint option, jni::ref<android::net::Uri> targetUri, jni::ref<java::lang::String> eventName) { return object_base::new_object(requestId, option, targetUri, eventName); }
