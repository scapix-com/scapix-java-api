...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVCONTRACT
...
public:
	...
	static jni::ref<android::net::Uri> buildProgramsUriForChannel(jni::ref<android::net::Uri> channelUri, jlong startTime, jlong endTime) { return call_static_method<"buildProgramsUriForChannel", jni::ref<android::net::Uri>>(channelUri, startTime, endTime); }
	...
	static jni::ref<android::net::Uri> buildProgramsUriForChannel(jlong channelId, jlong startTime, jlong endTime) { return call_static_method<"buildProgramsUriForChannel", jni::ref<android::net::Uri>>(channelId, startTime, endTime); }
