...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_INTERACTIVE_TVINTERACTIVEAPPVIEW
...
public:
	...
	static jni::ref<android::media::tv::interactive::TvInteractiveAppView> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::media::tv::interactive::TvInteractiveAppView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::media::tv::interactive::TvInteractiveAppView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	...
	void sendCertificate(jni::ref<java::lang::String> host, jint port, jni::ref<android::net::http::SslCertificate> cert) { return call_method<"sendCertificate", void>(host, port, cert); }
	...
	void sendSelectedTrackInfo(jni::ref<java::util::List> tracks) { return call_method<"sendSelectedTrackInfo", void>(tracks); }
