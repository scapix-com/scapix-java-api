...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_INTERACTIVE_TVINTERACTIVEAPPVIEW_TVINTERACTIVEAPPCALLBACK
...
public:
	...
	static jni::ref<android::media::tv::interactive::TvInteractiveAppView_TvInteractiveAppCallback> new_object() { return object_base::new_object(); }
	...
	void onRequestCertificate(jni::ref<java::lang::String> iAppServiceId, jni::ref<java::lang::String> host, jint port) { return call_method<"onRequestCertificate", void>(iAppServiceId, host, port); }
	...
	void onRequestScheduleRecording(jni::ref<java::lang::String> iAppServiceId, jni::ref<java::lang::String> requestId, jni::ref<java::lang::String> inputId, jni::ref<android::net::Uri> channelUri, jlong startTime, jlong duration, jint repeatDays, jni::ref<android::os::Bundle> params) { return call_method<"onRequestScheduleRecording", void>(iAppServiceId, requestId, inputId, channelUri, startTime, duration, repeatDays, params); }
	void onRequestSelectedTrackInfo(jni::ref<java::lang::String> iAppServiceId) { return call_method<"onRequestSelectedTrackInfo", void>(iAppServiceId); }
	...
	void onRequestSigning(jni::ref<java::lang::String> iAppServiceId, jni::ref<java::lang::String> signingId, jni::ref<java::lang::String> algorithm, jni::ref<java::lang::String> host, jint port, jni::ref<jni::array<jbyte>> data) { return call_method<"onRequestSigning", void>(iAppServiceId, signingId, algorithm, host, port, data); }
