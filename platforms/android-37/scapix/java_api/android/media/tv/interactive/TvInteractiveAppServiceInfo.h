...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_INTERACTIVE_TVINTERACTIVEAPPSERVICEINFO
...
public:
	...
	static jni::ref<android::media::tv::interactive::TvInteractiveAppServiceInfo> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::ComponentName> component) { return object_base::new_object(context, component); }
