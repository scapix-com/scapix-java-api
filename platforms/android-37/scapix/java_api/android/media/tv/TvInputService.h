...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVINPUTSERVICE
...
public:
	...
	static jni::ref<android::media::tv::TvInputService> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::media::tv::TvInputService_Session> onCreateSession(jni::ref<java::lang::String> inputId, jni::ref<java::lang::String> sessionId, jni::ref<android::content::AttributionSource> tvAppAttributionSource) { return call_method<"onCreateSession", jni::ref<android::media::tv::TvInputService_Session>>(inputId, sessionId, tvAppAttributionSource); }
};
