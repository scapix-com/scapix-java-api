...
class AudioMixerAttributes_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOMIXERATTRIBUTES_BUILDER
...
public:
	...
	static jni::ref<android::media::AudioMixerAttributes_Builder> new_object(jni::ref<android::media::AudioFormat> format) { return object_base::new_object(format); }
