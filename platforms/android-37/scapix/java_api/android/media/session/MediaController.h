...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SESSION_MEDIACONTROLLER
...
public:
	...
	static jni::ref<android::media::session::MediaController> new_object(jni::ref<android::content::Context> context, jni::ref<android::media::session::MediaSession_Token> token) { return object_base::new_object(context, token); }
