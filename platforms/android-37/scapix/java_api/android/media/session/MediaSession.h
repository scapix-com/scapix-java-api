...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SESSION_MEDIASESSION
...
public:
	...
	static jni::ref<android::media::session::MediaSession> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> tag) { return object_base::new_object(context, tag); }
	static jni::ref<android::media::session::MediaSession> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> tag, jni::ref<android::os::Bundle> sessionInfo) { return object_base::new_object(context, tag, sessionInfo); }
	static jni::ref<android::media::session::MediaSession> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> tag, jni::ref<android::os::Bundle> sessionInfo, jni::ref<java::lang::String> overridePackageName) { return object_base::new_object(context, tag, sessionInfo, overridePackageName); }
	...
	void setMediaButtonBroadcastReceiver(jni::ref<android::content::ComponentName> broadcastReceiver) { return call_method<"setMediaButtonBroadcastReceiver", void>(broadcastReceiver); }
