...
public:
	...
	jni::ref<java::lang::String> getProviderPackageName() { return call_method<"getProviderPackageName", jni::ref<java::lang::String>>(); }
	jni::ref<java::util::List> getRequiredPermissions() { return call_method<"getRequiredPermissions", jni::ref<java::util::List>>(); }
