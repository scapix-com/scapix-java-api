...
#ifndef SCAPIX_JAVA_API_ANDROID_SYSTEM_STRUCTMSGHDR
...
public:
	...
	static jni::ref<android::system::StructMsghdr> new_object(jni::ref<java::net::SocketAddress> msg_name, jni::ref<jni::array<java::nio::ByteBuffer>> msg_iov, jni::ref<jni::array<android::system::StructCmsghdr>> msg_control, jint msg_flags) { return object_base::new_object(msg_name, msg_iov, msg_control, msg_flags); }
};
