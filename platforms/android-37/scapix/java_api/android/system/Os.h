...
#ifndef SCAPIX_JAVA_API_ANDROID_SYSTEM_OS
#define SCAPIX_JAVA_API_ANDROID_SYSTEM_OS

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/system/Int64Ref.h>
#include <scapix/java_api/android/system/StructDlInfo.h>
#include <scapix/java_api/android/system/StructMsghdr.h>
...
public:
	...
	static jni::ref<android::system::StructDlInfo> dladdr(jlong addr) { return call_static_method<"dladdr", jni::ref<android::system::StructDlInfo>>(addr); }
	...
	static jlong lseek(jni::ref<java::io::FileDescriptor> fd, jlong offset, jint whence) { return call_static_method<"lseek", jlong>(fd, offset, whence); }
	...
	static void mincore(jlong address, jlong byteCount, jni::ref<jni::array<jbyte>> vector) { return call_static_method<"mincore", void>(address, byteCount, vector); }
	...
	static void mlock(jlong address, jlong byteCount) { return call_static_method<"mlock", void>(address, byteCount); }
	static jlong mmap(jlong address, jlong byteCount, jint prot, jint flags, jni::ref<java::io::FileDescriptor> fd, jlong offset) { return call_static_method<"mmap", jlong>(address, byteCount, prot, flags, fd, offset); }
	static void msync(jlong address, jlong byteCount, jint flags) { return call_static_method<"msync", void>(address, byteCount, flags); }
	static void munlock(jlong address, jlong byteCount) { return call_static_method<"munlock", void>(address, byteCount); }
	static void munmap(jlong address, jlong byteCount) { return call_static_method<"munmap", void>(address, byteCount); }
	...
	static void posix_fallocate(jni::ref<java::io::FileDescriptor> fd, jlong offset, jlong length) { return call_static_method<"posix_fallocate", void>(fd, offset, length); }
	static jint prctl(jint option, jlong arg2, jlong arg3, jlong arg4, jlong arg5) { return call_static_method<"prctl", jint>(option, arg2, arg3, arg4, arg5); }
	...
	static jint recvmsg(jni::ref<java::io::FileDescriptor> fd, jni::ref<android::system::StructMsghdr> msg, jint flags) { return call_static_method<"recvmsg", jint>(fd, msg, flags); }
	...
	static jint sendmsg(jni::ref<java::io::FileDescriptor> fd, jni::ref<android::system::StructMsghdr> msg, jint flags) { return call_static_method<"sendmsg", jint>(fd, msg, flags); }
