...
#ifndef SCAPIX_JAVA_API_ANDROID_TRANSITION_TRANSITIONLISTENERADAPTER
...
public:
	...
	static jni::ref<android::transition::TransitionListenerAdapter> new_object() { return object_base::new_object(); }
