...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_TTS_SYNTHESISCALLBACK
...
public:
	...
	void rangeStart(jint markerInFrames, jint start, jint end) { return call_method<"rangeStart", void>(markerInFrames, start, end); }
