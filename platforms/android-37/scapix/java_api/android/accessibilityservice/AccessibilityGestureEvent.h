...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCESSIBILITYSERVICE_ACCESSIBILITYGESTUREEVENT
...
public:
	...
	static jni::ref<android::accessibilityservice::AccessibilityGestureEvent> new_object(jint gestureId, jint displayId, jni::ref<java::util::List> motionEvents) { return object_base::new_object(gestureId, displayId, motionEvents); }
