...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCESSIBILITYSERVICE_INPUTMETHOD
...
public:
	...
	static jni::ref<android::accessibilityservice::InputMethod> new_object(jni::ref<android::accessibilityservice::AccessibilityService> service) { return object_base::new_object(service); }
