...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCESSIBILITYSERVICE_ACCESSIBILITYSERVICE
...
#include <scapix/java_api/android/accessibilityservice/BrailleDisplayController.h>
...
#include <scapix/java_api/android/accessibilityservice/InputMethod.h>
#include <scapix/java_api/android/accessibilityservice/TouchInteractionController.h>
...
public:
	...
	static jint ERROR_TAKE_SCREENSHOT_INVALID_WINDOW() { return get_static_field<"ERROR_TAKE_SCREENSHOT_INVALID_WINDOW", jint>(); }
	...
	static jint ERROR_TAKE_SCREENSHOT_SECURE_WINDOW() { return get_static_field<"ERROR_TAKE_SCREENSHOT_SECURE_WINDOW", jint>(); }
	...
	static jint GESTURE_2_FINGER_TRIPLE_TAP_AND_HOLD() { return get_static_field<"GESTURE_2_FINGER_TRIPLE_TAP_AND_HOLD", jint>(); }
	...
	static jint GESTURE_3_FINGER_SINGLE_TAP_AND_HOLD() { return get_static_field<"GESTURE_3_FINGER_SINGLE_TAP_AND_HOLD", jint>(); }
	...
	static jint GESTURE_3_FINGER_TRIPLE_TAP_AND_HOLD() { return get_static_field<"GESTURE_3_FINGER_TRIPLE_TAP_AND_HOLD", jint>(); }
	...
	static jint GESTURE_UNKNOWN() { return get_static_field<"GESTURE_UNKNOWN", jint>(); }
	static jint GLOBAL_ACTION_ACCESSIBILITY_ALL_APPS() { return get_static_field<"GLOBAL_ACTION_ACCESSIBILITY_ALL_APPS", jint>(); }
	static jint GLOBAL_ACTION_ACCESSIBILITY_BUTTON() { return get_static_field<"GLOBAL_ACTION_ACCESSIBILITY_BUTTON", jint>(); }
	static jint GLOBAL_ACTION_ACCESSIBILITY_BUTTON_CHOOSER() { return get_static_field<"GLOBAL_ACTION_ACCESSIBILITY_BUTTON_CHOOSER", jint>(); }
	static jint GLOBAL_ACTION_ACCESSIBILITY_SHORTCUT() { return get_static_field<"GLOBAL_ACTION_ACCESSIBILITY_SHORTCUT", jint>(); }
	static jint GLOBAL_ACTION_BACK() { return get_static_field<"GLOBAL_ACTION_BACK", jint>(); }
	static jint GLOBAL_ACTION_DISMISS_NOTIFICATION_SHADE() { return get_static_field<"GLOBAL_ACTION_DISMISS_NOTIFICATION_SHADE", jint>(); }
	static jint GLOBAL_ACTION_DPAD_CENTER() { return get_static_field<"GLOBAL_ACTION_DPAD_CENTER", jint>(); }
	static jint GLOBAL_ACTION_DPAD_DOWN() { return get_static_field<"GLOBAL_ACTION_DPAD_DOWN", jint>(); }
	static jint GLOBAL_ACTION_DPAD_LEFT() { return get_static_field<"GLOBAL_ACTION_DPAD_LEFT", jint>(); }
	static jint GLOBAL_ACTION_DPAD_RIGHT() { return get_static_field<"GLOBAL_ACTION_DPAD_RIGHT", jint>(); }
	static jint GLOBAL_ACTION_DPAD_UP() { return get_static_field<"GLOBAL_ACTION_DPAD_UP", jint>(); }
	static jint GLOBAL_ACTION_HOME() { return get_static_field<"GLOBAL_ACTION_HOME", jint>(); }
	static jint GLOBAL_ACTION_KEYCODE_HEADSETHOOK() { return get_static_field<"GLOBAL_ACTION_KEYCODE_HEADSETHOOK", jint>(); }
	static jint GLOBAL_ACTION_LOCK_SCREEN() { return get_static_field<"GLOBAL_ACTION_LOCK_SCREEN", jint>(); }
	static jint GLOBAL_ACTION_MEDIA_PLAY_PAUSE() { return get_static_field<"GLOBAL_ACTION_MEDIA_PLAY_PAUSE", jint>(); }
	static jint GLOBAL_ACTION_MENU() { return get_static_field<"GLOBAL_ACTION_MENU", jint>(); }
	...
	static jni::ref<android::accessibilityservice::AccessibilityService> new_object() { return object_base::new_object(); }
	void attachAccessibilityOverlayToDisplay(jint displayId, jni::ref<android::view::SurfaceControl> sc) { return call_method<"attachAccessibilityOverlayToDisplay", void>(displayId, sc); }
	void attachAccessibilityOverlayToWindow(jint accessibilityWindowId, jni::ref<android::view::SurfaceControl> sc) { return call_method<"attachAccessibilityOverlayToWindow", void>(accessibilityWindowId, sc); }
	jboolean clearCache() { return call_method<"clearCache", jboolean>(); }
	jboolean clearCachedSubtree(jni::ref<android::view::accessibility::AccessibilityNodeInfo> node) { return call_method<"clearCachedSubtree", jboolean>(node); }
	...
	jni::ref<android::accessibilityservice::BrailleDisplayController> getBrailleDisplayController() { return call_method<"getBrailleDisplayController", jni::ref<android::accessibilityservice::BrailleDisplayController>>(); }
	...
	jni::ref<android::accessibilityservice::InputMethod> getInputMethod() { return call_method<"getInputMethod", jni::ref<android::accessibilityservice::InputMethod>>(); }
	...
	jni::ref<android::view::accessibility::AccessibilityNodeInfo> getRootInActiveWindow(jint prefetchingStrategy) { return call_method<"getRootInActiveWindow", jni::ref<android::view::accessibility::AccessibilityNodeInfo>>(prefetchingStrategy); }
	...
	jni::ref<android::accessibilityservice::TouchInteractionController> getTouchInteractionController(jint displayId) { return call_method<"getTouchInteractionController", jni::ref<android::accessibilityservice::TouchInteractionController>>(displayId); }
	...
	jboolean isCacheEnabled() { return call_method<"isCacheEnabled", jboolean>(); }
	jboolean isNodeInCache(jni::ref<android::view::accessibility::AccessibilityNodeInfo> node) { return call_method<"isNodeInCache", jboolean>(node); }
	...
	jni::ref<android::accessibilityservice::InputMethod> onCreateInputMethod() { return call_method<"onCreateInputMethod", jni::ref<android::accessibilityservice::InputMethod>>(); }
	...
	void onMotionEvent(jni::ref<android::view::MotionEvent> event) { return call_method<"onMotionEvent", void>(event); }
	...
	void setAccessibilityFocusAppearance(jint strokeWidth, jint color) { return call_method<"setAccessibilityFocusAppearance", void>(strokeWidth, color); }
	void setAnimationScale(jfloat scale) { return call_method<"setAnimationScale", void>(scale); }
	jboolean setCacheEnabled(jboolean enabled) { return call_method<"setCacheEnabled", jboolean>(enabled); }
	...
	void takeScreenshotOfWindow(jint accessibilityWindowId, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::accessibilityservice::AccessibilityService_TakeScreenshotCallback> callback) { return call_method<"takeScreenshotOfWindow", void>(accessibilityWindowId, executor, callback); }
};
