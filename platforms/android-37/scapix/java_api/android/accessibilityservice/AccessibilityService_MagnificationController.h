...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCESSIBILITYSERVICE_ACCESSIBILITYSERVICE_MAGNIFICATIONCONTROLLER
...
public:
	...
	jni::ref<android::graphics::Region> getCurrentMagnificationRegion() { return call_method<"getCurrentMagnificationRegion", jni::ref<android::graphics::Region>>(); }
	jni::ref<android::accessibilityservice::MagnificationConfig> getMagnificationConfig() { return call_method<"getMagnificationConfig", jni::ref<android::accessibilityservice::MagnificationConfig>>(); }
	...
	jboolean resetCurrentMagnification(jboolean animate) { return call_method<"resetCurrentMagnification", jboolean>(animate); }
	...
	jboolean setMagnificationConfig(jni::ref<android::accessibilityservice::MagnificationConfig> config, jboolean animate) { return call_method<"setMagnificationConfig", jboolean>(config, animate); }
