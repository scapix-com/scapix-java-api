...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCOUNTS_AUTHENTICATORDESCRIPTION
...
public:
	...
	static jni::ref<android::accounts::AuthenticatorDescription> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::String> packageName, jint labelId, jint iconId, jint smallIconId, jint prefId) { return object_base::new_object(type, packageName, labelId, iconId, smallIconId, prefId); }
	static jni::ref<android::accounts::AuthenticatorDescription> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::String> packageName, jint labelId, jint iconId, jint smallIconId, jint prefId, jboolean customTokens) { return object_base::new_object(type, packageName, labelId, iconId, smallIconId, prefId, customTokens); }
