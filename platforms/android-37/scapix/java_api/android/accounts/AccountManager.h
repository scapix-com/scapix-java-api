...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCOUNTS_ACCOUNTMANAGER
...
public:
	...
	static jni::ref<java::lang::String> ACTION_ACCOUNT_REMOVED() { return get_static_field<"ACTION_ACCOUNT_REMOVED", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> KEY_ACCOUNT_SESSION_BUNDLE() { return get_static_field<"KEY_ACCOUNT_SESSION_BUNDLE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> KEY_ACCOUNT_STATUS_TOKEN() { return get_static_field<"KEY_ACCOUNT_STATUS_TOKEN", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> PACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE() { return get_static_field<"PACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PACKAGE_NAME_KEY_LEGACY_VISIBLE() { return get_static_field<"PACKAGE_NAME_KEY_LEGACY_VISIBLE", jni::ref<java::lang::String>>(); }
	static jint VISIBILITY_NOT_VISIBLE() { return get_static_field<"VISIBILITY_NOT_VISIBLE", jint>(); }
	static jint VISIBILITY_UNDEFINED() { return get_static_field<"VISIBILITY_UNDEFINED", jint>(); }
	static jint VISIBILITY_USER_MANAGED_NOT_VISIBLE() { return get_static_field<"VISIBILITY_USER_MANAGED_NOT_VISIBLE", jint>(); }
	static jint VISIBILITY_USER_MANAGED_VISIBLE() { return get_static_field<"VISIBILITY_USER_MANAGED_VISIBLE", jint>(); }
	...
	jboolean addAccountExplicitly(jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> password, jni::ref<android::os::Bundle> extras, jni::ref<java::util::Map> visibility) { return call_method<"addAccountExplicitly", jboolean>(account, password, extras, visibility); }
	...
	void addOnAccountsUpdatedListener(jni::ref<android::accounts::OnAccountsUpdateListener> listener, jni::ref<android::os::Handler> handler, jboolean updateImmediately, jni::ref<jni::array<java::lang::String>> accountTypes) { return call_method<"addOnAccountsUpdatedListener", void>(listener, handler, updateImmediately, accountTypes); }
	...
	jni::ref<android::accounts::AccountManagerFuture> finishSession(jni::ref<android::os::Bundle> sessionBundle, jni::ref<android::app::Activity> activity, jni::ref<android::accounts::AccountManagerCallback> callback, jni::ref<android::os::Handler> handler) { return call_method<"finishSession", jni::ref<android::accounts::AccountManagerFuture>>(sessionBundle, activity, callback, handler); }
	...
	jint getAccountVisibility(jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> packageName) { return call_method<"getAccountVisibility", jint>(account, packageName); }
	...
	jni::ref<java::util::Map> getAccountsAndVisibilityForPackage(jni::ref<java::lang::String> packageName, jni::ref<java::lang::String> accountType) { return call_method<"getAccountsAndVisibilityForPackage", jni::ref<java::util::Map>>(packageName, accountType); }
	...
	jni::ref<java::util::Map> getPackagesAndVisibilityForAccount(jni::ref<android::accounts::Account> account) { return call_method<"getPackagesAndVisibilityForAccount", jni::ref<java::util::Map>>(account); }
	...
	jni::ref<android::accounts::AccountManagerFuture> isCredentialsUpdateSuggested(jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> statusToken, jni::ref<android::accounts::AccountManagerCallback> callback, jni::ref<android::os::Handler> handler) { return call_method<"isCredentialsUpdateSuggested", jni::ref<android::accounts::AccountManagerFuture>>(account, statusToken, callback, handler); }
	...
	jboolean setAccountVisibility(jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> packageName, jint visibility) { return call_method<"setAccountVisibility", jboolean>(account, packageName, visibility); }
	...
	jni::ref<android::accounts::AccountManagerFuture> startAddAccountSession(jni::ref<java::lang::String> accountType, jni::ref<java::lang::String> authTokenType, jni::ref<jni::array<java::lang::String>> requiredFeatures, jni::ref<android::os::Bundle> options, jni::ref<android::app::Activity> activity, jni::ref<android::accounts::AccountManagerCallback> callback, jni::ref<android::os::Handler> handler) { return call_method<"startAddAccountSession", jni::ref<android::accounts::AccountManagerFuture>>(accountType, authTokenType, requiredFeatures, options, activity, callback, handler); }
	jni::ref<android::accounts::AccountManagerFuture> startUpdateCredentialsSession(jni::ref<android::accounts::Account> account, jni::ref<java::lang::String> authTokenType, jni::ref<android::os::Bundle> options, jni::ref<android::app::Activity> activity, jni::ref<android::accounts::AccountManagerCallback> callback, jni::ref<android::os::Handler> handler) { return call_method<"startUpdateCredentialsSession", jni::ref<android::accounts::AccountManagerFuture>>(account, authTokenType, options, activity, callback, handler); }
