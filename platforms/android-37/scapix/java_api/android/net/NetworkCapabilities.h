...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_NETWORKCAPABILITIES
...
public:
	...
	static jint NET_CAPABILITY_LOCAL_NETWORK() { return get_static_field<"NET_CAPABILITY_LOCAL_NETWORK", jint>(); }
	...
	static jint NET_CAPABILITY_MMTEL() { return get_static_field<"NET_CAPABILITY_MMTEL", jint>(); }
	static jint NET_CAPABILITY_NOT_BANDWIDTH_CONSTRAINED() { return get_static_field<"NET_CAPABILITY_NOT_BANDWIDTH_CONSTRAINED", jint>(); }
	...
	static jint NET_CAPABILITY_PRIORITIZE_BANDWIDTH() { return get_static_field<"NET_CAPABILITY_PRIORITIZE_BANDWIDTH", jint>(); }
	static jint NET_CAPABILITY_PRIORITIZE_LATENCY() { return get_static_field<"NET_CAPABILITY_PRIORITIZE_LATENCY", jint>(); }
	static jint NET_CAPABILITY_PRIORITIZE_UNIFIED_COMMUNICATIONS() { return get_static_field<"NET_CAPABILITY_PRIORITIZE_UNIFIED_COMMUNICATIONS", jint>(); }
	...
	static jint NET_ENTERPRISE_ID_1() { return get_static_field<"NET_ENTERPRISE_ID_1", jint>(); }
	static jint NET_ENTERPRISE_ID_2() { return get_static_field<"NET_ENTERPRISE_ID_2", jint>(); }
	static jint NET_ENTERPRISE_ID_3() { return get_static_field<"NET_ENTERPRISE_ID_3", jint>(); }
	static jint NET_ENTERPRISE_ID_4() { return get_static_field<"NET_ENTERPRISE_ID_4", jint>(); }
	static jint NET_ENTERPRISE_ID_5() { return get_static_field<"NET_ENTERPRISE_ID_5", jint>(); }
	...
	static jint TRANSPORT_SATELLITE() { return get_static_field<"TRANSPORT_SATELLITE", jint>(); }
	static jint TRANSPORT_THREAD() { return get_static_field<"TRANSPORT_THREAD", jint>(); }
	...
	static jni::ref<android::net::NetworkCapabilities> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::NetworkCapabilities> new_object(jni::ref<android::net::NetworkCapabilities> nc) { return object_base::new_object(nc); }
	...
	jni::ref<jni::array<jint>> getEnterpriseIds() { return call_method<"getEnterpriseIds", jni::ref<jni::array<jint>>>(); }
	...
	jboolean hasEnterpriseId(jint enterpriseId) { return call_method<"hasEnterpriseId", jboolean>(enterpriseId); }
