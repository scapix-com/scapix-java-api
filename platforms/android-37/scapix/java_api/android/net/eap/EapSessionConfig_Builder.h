...
class EapSessionConfig_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_EAP_EAPSESSIONCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::eap::EapSessionConfig_Builder> new_object() { return object_base::new_object(); }
