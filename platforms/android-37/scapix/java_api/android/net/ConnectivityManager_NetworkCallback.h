...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_CONNECTIVITYMANAGER_NETWORKCALLBACK
...
public:
	...
	static jint FLAG_INCLUDE_LOCATION_INFO() { return get_static_field<"FLAG_INCLUDE_LOCATION_INFO", jint>(); }

	static jni::ref<android::net::ConnectivityManager_NetworkCallback> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::ConnectivityManager_NetworkCallback> new_object(jint flags) { return object_base::new_object(flags); }
	void onAvailable(jni::ref<android::net::Network> network) { return call_method<"onAvailable", void>(network); }
	void onBlockedStatusChanged(jni::ref<android::net::Network> network, jboolean blocked) { return call_method<"onBlockedStatusChanged", void>(network, blocked); }
	...
	void onReserved(jni::ref<android::net::NetworkCapabilities> networkCapabilities) { return call_method<"onReserved", void>(networkCapabilities); }
