...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_SSL_SSLSOCKETS
...
public:
	...
	static void setEchConfigList(jni::ref<javax::net::ssl::SSLSocket> socket, jni::ref<android::net::ssl::EchConfigList> echConfigList) { return call_static_method<"setEchConfigList", void>(socket, echConfigList); }
