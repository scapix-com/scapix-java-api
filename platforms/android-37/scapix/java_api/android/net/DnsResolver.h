...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_DNSRESOLVER
...
public:
	...
	static jint HTTPS_QUERY_WAIT_AUTO() { return get_static_field<"HTTPS_QUERY_WAIT_AUTO", jint>(); }
	static jint HTTPS_QUERY_WAIT_NONE() { return get_static_field<"HTTPS_QUERY_WAIT_NONE", jint>(); }
	static jint HTTPS_QUERY_WAIT_UNTIL_TIMEOUT() { return get_static_field<"HTTPS_QUERY_WAIT_UNTIL_TIMEOUT", jint>(); }
	static jint TYPE_A() { return get_static_field<"TYPE_A", jint>(); }
	static jint TYPE_AAAA() { return get_static_field<"TYPE_AAAA", jint>(); }
	static jint TYPE_HTTPS() { return get_static_field<"TYPE_HTTPS", jint>(); }

	static jni::ref<android::net::DnsResolver> new_object(jni::ref<android::content::Context> context, jni::ref<android::os::Looper> looper) { return object_base::new_object(context, looper); }
	...
	void query(jni::ref<android::net::Network> network, jni::ref<java::lang::String> domain, jint flags, jni::ref<java::util::concurrent::Executor> executor, jint httpsTimeoutMillis, jni::ref<android::os::CancellationSignal> cancellationSignal, jni::ref<android::net::DnsResolver_Callback> callback) { return call_method<"query", void>(network, domain, flags, executor, httpsTimeoutMillis, cancellationSignal, callback); }
