...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_PARSEEXCEPTION
...
public:
	...
	static jni::ref<android::net::ParseException> new_object(jni::ref<java::lang::String> response) { return object_base::new_object(response); }
	static jni::ref<android::net::ParseException> new_object(jni::ref<java::lang::String> response, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(response, cause); }
};
