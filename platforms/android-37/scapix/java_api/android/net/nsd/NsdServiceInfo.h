...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_NSD_NSDSERVICEINFO
...
public:
	...
	void setAttribute(jni::ref<java::lang::String> key, jni::ref<jni::array<jbyte>> value) { return call_method<"setAttribute", void>(key, value); }
