...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_NSD_NSDMANAGER
...
public:
	...
	static jint FAILURE_PERMISSION_DENIED() { return get_static_field<"FAILURE_PERMISSION_DENIED", jint>(); }
	...
	static jint SERVICE_PERMISSION_DENIED() { return get_static_field<"SERVICE_PERMISSION_DENIED", jint>(); }
	static jint SERVICE_PERMISSION_GRANTED() { return get_static_field<"SERVICE_PERMISSION_GRANTED", jint>(); }

	void checkPermissionForService(jni::ref<java::lang::String> serviceName, jni::ref<java::lang::String> serviceType, jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::IntConsumer> resultReceiver) { return call_method<"checkPermissionForService", void>(serviceName, serviceType, executor, resultReceiver); }
	void discoverServices(jni::ref<android::net::nsd::DiscoveryRequest> discoveryRequest, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::net::nsd::NsdManager_DiscoveryListener> listener) { return call_method<"discoverServices", void>(discoveryRequest, executor, listener); }
	...
	void registerService(jni::ref<android::net::nsd::AdvertisingRequest> advertisingRequest, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::net::nsd::NsdManager_RegistrationListener> listener) { return call_method<"registerService", void>(advertisingRequest, executor, listener); }
	...
	void registerServiceInfoCallback(jni::ref<android::net::nsd::DiscoveryRequest> discoveryRequest, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::net::nsd::NsdManager_ServiceInfoCallback> listener) { return call_method<"registerServiceInfoCallback", void>(discoveryRequest, executor, listener); }
