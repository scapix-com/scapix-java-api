...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_CONNECTIVITYMANAGER
...
#include <scapix/java_api/android/net/SocketKeepalive.h>
...
public:
	...
	jni::ref<android::net::SocketKeepalive> createSocketKeepalive(jni::ref<android::net::Network> network, jni::ref<android::net::IpSecManager_UdpEncapsulationSocket> socket, jni::ref<java::net::InetAddress> source, jni::ref<java::net::InetAddress> destination, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::net::SocketKeepalive_Callback> callback) { return call_method<"createSocketKeepalive", jni::ref<android::net::SocketKeepalive>>(network, socket, source, destination, executor, callback); }
	...
	jint getConnectionOwnerUid(jint protocol, jni::ref<java::net::InetSocketAddress> local, jni::ref<java::net::InetSocketAddress> remote) { return call_method<"getConnectionOwnerUid", jint>(protocol, local, remote); }
	...
	jni::ref<jni::array<jbyte>> getNetworkWatchlistConfigHash() { return call_method<"getNetworkWatchlistConfigHash", jni::ref<jni::array<jbyte>>>(); }
	...
	void registerBestMatchingNetworkCallback(jni::ref<android::net::NetworkRequest> request, jni::ref<android::net::ConnectivityManager_NetworkCallback> networkCallback, jni::ref<android::os::Handler> handler) { return call_method<"registerBestMatchingNetworkCallback", void>(request, networkCallback, handler); }
	...
	void reserveNetwork(jni::ref<android::net::NetworkRequest> request, jni::ref<android::os::Handler> handler, jni::ref<android::net::ConnectivityManager_NetworkCallback> networkCallback) { return call_method<"reserveNetwork", void>(request, handler, networkCallback); }
