...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_SIP_SIPPROFILE_BUILDER
...
public:
	...
	static jni::ref<android::net::sip::SipProfile_Builder> new_object(jni::ref<android::net::sip::SipProfile> profile) { return object_base::new_object(profile); }
	static jni::ref<android::net::sip::SipProfile_Builder> new_object(jni::ref<java::lang::String> uriString) { return object_base::new_object(uriString); }
	static jni::ref<android::net::sip::SipProfile_Builder> new_object(jni::ref<java::lang::String> username, jni::ref<java::lang::String> serverDomain) { return object_base::new_object(username, serverDomain); }
