...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_SIP_SIPAUDIOCALL_LISTENER
...
public:
	...
	static jni::ref<android::net::sip::SipAudioCall_Listener> new_object() { return object_base::new_object(); }
