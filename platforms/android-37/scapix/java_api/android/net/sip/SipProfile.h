...
struct scapix::jni::object_traits<scapix::java_api::android::net::sip::SipProfile>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::Cloneable, scapix::java_api::android::os::Parcelable, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_SIP_SIPPROFILE
...
public:
	...
	void setCallingUid(jint uid) { return call_method<"setCallingUid", void>(uid); }
