...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_IKEFQDNIDENTIFICATION
...
public:
	...
	static jni::ref<android::net::ipsec::ike::IkeFqdnIdentification> new_object(jni::ref<java::lang::String> fqdn) { return object_base::new_object(fqdn); }
