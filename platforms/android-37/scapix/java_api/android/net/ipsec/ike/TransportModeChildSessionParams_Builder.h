...
class TransportModeChildSessionParams_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_TRANSPORTMODECHILDSESSIONPARAMS_BUILDER
...
public:
	...
	static jni::ref<android::net::ipsec::ike::TransportModeChildSessionParams_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::ipsec::ike::TransportModeChildSessionParams_Builder> new_object(jni::ref<android::net::ipsec::ike::TransportModeChildSessionParams> childParams) { return object_base::new_object(childParams); }
