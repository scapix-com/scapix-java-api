...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_IKESESSIONPARAMS
...
public:
	...
	static jint IKE_DPD_DELAY_SEC_DISABLED() { return get_static_field<"IKE_DPD_DELAY_SEC_DISABLED", jint>(); }
	...
	jni::ref<java::util::Set> getIkeOptions() { return call_method<"getIkeOptions", jni::ref<java::util::Set>>(); }
