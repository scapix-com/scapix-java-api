...
class IkeSessionParams_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_IKESESSIONPARAMS_BUILDER
...
public:
	...
	static jni::ref<android::net::ipsec::ike::IkeSessionParams_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::ipsec::ike::IkeSessionParams_Builder> new_object(jni::ref<android::net::ipsec::ike::IkeSessionParams> ikeSessionParams) { return object_base::new_object(ikeSessionParams); }
