...
class IkeSessionConfiguration_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_IKESESSIONCONFIGURATION_BUILDER
...
public:
	...
	static jni::ref<android::net::ipsec::ike::IkeSessionConfiguration_Builder> new_object(jni::ref<android::net::ipsec::ike::IkeSessionConnectionInfo> ikeConnInfo) { return object_base::new_object(ikeConnInfo); }
	...
	jni::ref<android::net::ipsec::ike::IkeSessionConfiguration_Builder> setEapInfo(jni::ref<android::net::eap::EapInfo> eapInfo) { return call_method<"setEapInfo", jni::ref<android::net::ipsec::ike::IkeSessionConfiguration_Builder>>(eapInfo); }
