...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_CONNECTIVITYDIAGNOSTICSMANAGER_CONNECTIVITYREPORT
...
public:
	...
	static jni::ref<android::net::ConnectivityDiagnosticsManager_ConnectivityReport> new_object(jni::ref<android::net::Network> network, jlong reportTimestamp, jni::ref<android::net::LinkProperties> linkProperties, jni::ref<android::net::NetworkCapabilities> networkCapabilities, jni::ref<android::os::PersistableBundle> additionalInfo) { return object_base::new_object(network, reportTimestamp, linkProperties, networkCapabilities, additionalInfo); }
