...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IKEV2VPNPROFILE_BUILDER
...
public:
	...
	static jni::ref<android::net::Ikev2VpnProfile_Builder> new_object(jni::ref<android::net::ipsec::ike::IkeTunnelConnectionParams> ikeTunConnParams) { return object_base::new_object(ikeTunConnParams); }
	static jni::ref<android::net::Ikev2VpnProfile_Builder> new_object(jni::ref<java::lang::String> serverAddr, jni::ref<java::lang::String> identity) { return object_base::new_object(serverAddr, identity); }
