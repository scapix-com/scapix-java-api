...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_CONNECTIVITYDIAGNOSTICSMANAGER_DATASTALLREPORT
...
public:
	...
	static jni::ref<android::net::ConnectivityDiagnosticsManager_DataStallReport> new_object(jni::ref<android::net::Network> network, jlong reportTimestamp, jint detectionMethod, jni::ref<android::net::LinkProperties> linkProperties, jni::ref<android::net::NetworkCapabilities> networkCapabilities, jni::ref<android::os::PersistableBundle> stallDetails) { return object_base::new_object(network, reportTimestamp, detectionMethod, linkProperties, networkCapabilities, stallDetails); }
