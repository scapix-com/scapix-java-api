...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_HTTPENGINE_BUILDER
...
#include <scapix/java_api/android/net/http/ProxyOptions.h>
...
public:
	...
	static jni::ref<android::net::http::HttpEngine_Builder> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	jni::ref<android::net::http::HttpEngine_Builder> setConnectionMigrationOptions(jni::ref<android::net::http::ConnectionMigrationOptions> options) { return call_method<"setConnectionMigrationOptions", jni::ref<android::net::http::HttpEngine_Builder>>(options); }
	jni::ref<android::net::http::HttpEngine_Builder> setDnsOptions(jni::ref<android::net::http::DnsOptions> options) { return call_method<"setDnsOptions", jni::ref<android::net::http::HttpEngine_Builder>>(options); }
	...
	jni::ref<android::net::http::HttpEngine_Builder> setProxyOptions(jni::ref<android::net::http::ProxyOptions> options) { return call_method<"setProxyOptions", jni::ref<android::net::http::HttpEngine_Builder>>(options); }
	jni::ref<android::net::http::HttpEngine_Builder> setQuicOptions(jni::ref<android::net::http::QuicOptions> options) { return call_method<"setQuicOptions", jni::ref<android::net::http::HttpEngine_Builder>>(options); }
