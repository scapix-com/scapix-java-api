...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_SSLERROR
...
public:
	...
	static jni::ref<android::net::http::SslError> new_object(jint error, jni::ref<android::net::http::SslCertificate> certificate) { return object_base::new_object(error, certificate); }
	static jni::ref<android::net::http::SslError> new_object(jint error, jni::ref<android::net::http::SslCertificate> certificate, jni::ref<java::lang::String> url) { return object_base::new_object(error, certificate, url); }
	static jni::ref<android::net::http::SslError> new_object(jint error, jni::ref<java::security::cert::X509Certificate> certificate) { return object_base::new_object(error, certificate); }
	static jni::ref<android::net::http::SslError> new_object(jint error, jni::ref<java::security::cert::X509Certificate> certificate, jni::ref<java::lang::String> url) { return object_base::new_object(error, certificate, url); }
