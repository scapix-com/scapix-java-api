...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_X509TRUSTMANAGEREXTENSIONS
...
public:
	...
	static jni::ref<android::net::http::X509TrustManagerExtensions> new_object(jni::ref<javax::net::ssl::X509TrustManager> tm) { return object_base::new_object(tm); }
	jni::ref<java::util::List> checkServerTrusted(jni::ref<jni::array<java::security::cert::X509Certificate>> chain, jni::ref<jni::array<jbyte>> ocspData, jni::ref<jni::array<jbyte>> tlsSctData, jni::ref<java::lang::String> authType, jni::ref<java::lang::String> host) { return call_method<"checkServerTrusted", jni::ref<java::util::List>>(chain, ocspData, tlsSctData, authType, host); }
