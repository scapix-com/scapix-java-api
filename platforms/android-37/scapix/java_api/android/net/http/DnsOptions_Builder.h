...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_DNSOPTIONS_BUILDER
...
public:
	...
	static jni::ref<android::net::http::DnsOptions_Builder> new_object() { return object_base::new_object(); }
