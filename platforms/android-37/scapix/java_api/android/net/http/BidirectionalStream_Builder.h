...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_BIDIRECTIONALSTREAM_BUILDER
...
public:
	...
	static jni::ref<android::net::http::BidirectionalStream_Builder> new_object() { return object_base::new_object(); }
