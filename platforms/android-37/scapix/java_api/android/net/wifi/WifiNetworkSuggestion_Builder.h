...
class WifiNetworkSuggestion_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFINETWORKSUGGESTION_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::WifiNetworkSuggestion_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::net::wifi::WifiNetworkSuggestion_Builder> setWifi7Enabled(jboolean enabled) { return call_method<"setWifi7Enabled", jni::ref<android::net::wifi::WifiNetworkSuggestion_Builder>>(enabled); }
