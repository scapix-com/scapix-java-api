...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_P2P_WIFIP2PDEVICE
...
public:
	...
	static jni::ref<android::net::wifi::p2p::WifiP2pDevice> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::p2p::WifiP2pDevice> new_object(jni::ref<android::net::wifi::p2p::WifiP2pDevice> source) { return object_base::new_object(source); }
	jint describeContents() { return call_method<"describeContents", jint>(); }
	jboolean equals(jni::ref<java::lang::Object> obj) { return call_method<"equals", jboolean>(obj); }
	jni::ref<java::net::InetAddress> getIpAddress() { return call_method<"getIpAddress", jni::ref<java::net::InetAddress>>(); }
	...
	jni::ref<android::net::wifi::p2p::WifiP2pConnectionInfo> getWifiP2pConnectionInfo() { return call_method<"getWifiP2pConnectionInfo", jni::ref<android::net::wifi::p2p::WifiP2pConnectionInfo>>(); }
	jint hashCode() { return call_method<"hashCode", jint>(); }
	jboolean isGroupOwner() { return call_method<"isGroupOwner", jboolean>(); }
	jboolean isOpportunisticBootstrappingMethodSupported() { return call_method<"isOpportunisticBootstrappingMethodSupported", jboolean>(); }
	jboolean isPassphraseDisplayBootstrappingMethodSupported() { return call_method<"isPassphraseDisplayBootstrappingMethodSupported", jboolean>(); }
	jboolean isPassphraseKeypadBootstrappingMethodSupported() { return call_method<"isPassphraseKeypadBootstrappingMethodSupported", jboolean>(); }
	jboolean isPinCodeDisplayBootstrappingMethodSupported() { return call_method<"isPinCodeDisplayBootstrappingMethodSupported", jboolean>(); }
	jboolean isPinCodeKeypadBootstrappingMethodSupported() { return call_method<"isPinCodeKeypadBootstrappingMethodSupported", jboolean>(); }
