...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_P2P_WIFIP2PCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder> setAuthorizeConnectionFromPeerEnabled(jboolean enabled) { return call_method<"setAuthorizeConnectionFromPeerEnabled", jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder>>(enabled); }
	...
	jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder> setGroupClientIpProvisioningMode(jint groupClientIpProvisioningMode) { return call_method<"setGroupClientIpProvisioningMode", jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder>>(groupClientIpProvisioningMode); }
	...
	jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder> setPairingBootstrappingConfig(jni::ref<android::net::wifi::p2p::WifiP2pPairingBootstrappingConfig> config) { return call_method<"setPairingBootstrappingConfig", jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder>>(config); }
	jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder> setPairingDiscoveryChannelFrequencyMhz(jint frequencyMhz) { return call_method<"setPairingDiscoveryChannelFrequencyMhz", jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder>>(frequencyMhz); }
	...
	jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder> setPccModeConnectionType(jint connectionType) { return call_method<"setPccModeConnectionType", jni::ref<android::net::wifi::p2p::WifiP2pConfig_Builder>>(connectionType); }
};
