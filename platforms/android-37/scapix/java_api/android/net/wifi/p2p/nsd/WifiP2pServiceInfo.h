...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_P2P_NSD_WIFIP2PSERVICEINFO
...
public:
	...
	static jni::ref<android::net::wifi::p2p::nsd::WifiP2pServiceInfo> new_object(jni::ref<android::net::wifi::p2p::nsd::WifiP2pUsdBasedServiceConfig> usdConfig) { return object_base::new_object(usdConfig); }
