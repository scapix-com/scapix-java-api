...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFIAVAILABLECHANNEL
...
public:
	...
	static jni::ref<android::net::wifi::WifiAvailableChannel> new_object(jint freq, jint opModes) { return object_base::new_object(freq, opModes); }
