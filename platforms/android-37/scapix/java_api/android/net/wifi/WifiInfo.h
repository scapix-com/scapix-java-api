...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFIINFO
...
public:
	...
	jni::ref<java::lang::String> getPasspointUniqueId() { return call_method<"getPasspointUniqueId", jni::ref<java::lang::String>>(); }
