...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFICONFIGURATION
...
public:
	...
	static jint RANDOMIZATION_AUTO() { return get_static_field<"RANDOMIZATION_AUTO", jint>(); }
	static jint RANDOMIZATION_NONE() { return get_static_field<"RANDOMIZATION_NONE", jint>(); }
	...
	jboolean allowAutojoin() { return get_field<"allowAutojoin", jboolean>(); }
	void allowAutojoin(jboolean v) { set_field<"allowAutojoin", jboolean>(v); }
	...
	jboolean shared() { return get_field<"shared", jboolean>(); }
	void shared(jboolean v) { set_field<"shared", jboolean>(v); }
	...
	static jni::ref<android::net::wifi::WifiConfiguration> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::WifiConfiguration> new_object(jni::ref<android::net::wifi::WifiConfiguration> source) { return object_base::new_object(source); }
	...
	jboolean isAllowedToUpdateByOtherUsers() { return call_method<"isAllowedToUpdateByOtherUsers", jboolean>(); }
	jboolean isDppConfigurator() { return call_method<"isDppConfigurator", jboolean>(); }
	jboolean isPasspoint() { return call_method<"isPasspoint", jboolean>(); }
	void setAllowedToUpdateByOtherUsers(jboolean isAllowed) { return call_method<"setAllowedToUpdateByOtherUsers", void>(isAllowed); }
	void setHttpProxy(jni::ref<android::net::ProxyInfo> httpProxy) { return call_method<"setHttpProxy", void>(httpProxy); }
	void setIpConfiguration(jni::ref<android::net::IpConfiguration> ipConfiguration) { return call_method<"setIpConfiguration", void>(ipConfiguration); }
	void setMacRandomizationSetting(jint macRandomizationSetting) { return call_method<"setMacRandomizationSetting", void>(macRandomizationSetting); }
