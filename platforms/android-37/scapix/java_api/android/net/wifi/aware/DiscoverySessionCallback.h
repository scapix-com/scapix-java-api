...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_DISCOVERYSESSIONCALLBACK
...
#include <scapix/java_api/android/net/wifi/aware/WifiAwareNetworkInfo.h>
...
public:
	...
	static jni::ref<android::net::wifi::aware::DiscoverySessionCallback> new_object() { return object_base::new_object(); }
	...
	void onBootstrappingSucceeded(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle, jint method, jni::ref<jni::array<jbyte>> message) { return call_method<"onBootstrappingSucceeded", void>(peerHandle, method, message); }
	void onDataPathConnected(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle, jni::ref<android::net::wifi::aware::WifiAwareNetworkInfo> info) { return call_method<"onDataPathConnected", void>(peerHandle, info); }
	void onDataPathDisconnected(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle) { return call_method<"onDataPathDisconnected", void>(peerHandle); }
	void onDataPathRequestFailed(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle, jint reason) { return call_method<"onDataPathRequestFailed", void>(peerHandle, reason); }
	void onDataPathRequestReceived(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle) { return call_method<"onDataPathRequestReceived", void>(peerHandle); }
