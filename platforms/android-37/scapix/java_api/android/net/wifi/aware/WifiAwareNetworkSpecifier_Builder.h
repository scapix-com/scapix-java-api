...
class WifiAwareNetworkSpecifier_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_WIFIAWARENETWORKSPECIFIER_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::aware::WifiAwareNetworkSpecifier_Builder> new_object(jni::ref<android::net::wifi::aware::DiscoverySession> discoverySession, jni::ref<android::net::wifi::aware::PeerHandle> peerHandle) { return object_base::new_object(discoverySession, peerHandle); }
	static jni::ref<android::net::wifi::aware::WifiAwareNetworkSpecifier_Builder> new_object(jni::ref<android::net::wifi::aware::PublishDiscoverySession> publishDiscoverySession) { return object_base::new_object(publishDiscoverySession); }
