...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_PUBLISHCONFIG
...
public:
	...
	jni::ref<android::net::wifi::aware::WifiAwareDataPathSecurityConfig> getSecurityConfig() { return call_method<"getSecurityConfig", jni::ref<android::net::wifi::aware::WifiAwareDataPathSecurityConfig>>(); }
