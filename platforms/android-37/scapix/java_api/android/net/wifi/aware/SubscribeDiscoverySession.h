...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_SUBSCRIBEDISCOVERYSESSION
...
public:
	...
	jboolean initiateDataPathRequest(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle, jni::ref<android::net::wifi::aware::AwareDataPathRequest> request) { return call_method<"initiateDataPathRequest", jboolean>(peerHandle, request); }
