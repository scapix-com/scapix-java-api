...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_SUBSCRIBECONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::aware::SubscribeConfig_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::net::wifi::aware::SubscribeConfig_Builder> setEgressDistanceMm(jint egressDistanceMm) { return call_method<"setEgressDistanceMm", jni::ref<android::net::wifi::aware::SubscribeConfig_Builder>>(egressDistanceMm); }
	jni::ref<android::net::wifi::aware::SubscribeConfig_Builder> setIngressDistanceMm(jint ingressDistanceMm) { return call_method<"setIngressDistanceMm", jni::ref<android::net::wifi::aware::SubscribeConfig_Builder>>(ingressDistanceMm); }
	jni::ref<android::net::wifi::aware::SubscribeConfig_Builder> setInstantCommunicationModeEnabled(jboolean enabled, jint band) { return call_method<"setInstantCommunicationModeEnabled", jni::ref<android::net::wifi::aware::SubscribeConfig_Builder>>(enabled, band); }
	...
	jni::ref<android::net::wifi::aware::SubscribeConfig_Builder> setPairingConfig(jni::ref<android::net::wifi::aware::AwarePairingConfig> config) { return call_method<"setPairingConfig", jni::ref<android::net::wifi::aware::SubscribeConfig_Builder>>(config); }
