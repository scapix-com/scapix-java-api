...
class AwarePairingConfig_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_AWAREPAIRINGCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::aware::AwarePairingConfig_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::net::wifi::aware::AwarePairingConfig_Builder> setSupportedCipherSuites(jint cipherSuites) { return call_method<"setSupportedCipherSuites", jni::ref<android::net::wifi::aware::AwarePairingConfig_Builder>>(cipherSuites); }
};
