...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_WIFIAWAREMANAGER
...
public:
	...
	static jni::ref<java::util::Map> createTxtRecordMap(jni::ref<jni::array<jbyte>> txtRecordTlvBuffer) { return call_static_method<"createTxtRecordMap", jni::ref<java::util::Map>>(txtRecordTlvBuffer); }
	static jni::ref<jni::array<jbyte>> createTxtRecordTlvBuffer(jni::ref<java::util::Map> txtRecord) { return call_static_method<"createTxtRecordTlvBuffer", jni::ref<jni::array<jbyte>>>(txtRecord); }
	...
	void getPairedDevices(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> resultsCallback) { return call_method<"getPairedDevices", void>(executor, resultsCallback); }
	...
	void isOpportunisticModeEnabled(jni::ref<java::util::concurrent::Executor> executor, jni::ref<java::util::function::Consumer> resultsCallback) { return call_method<"isOpportunisticModeEnabled", void>(executor, resultsCallback); }
	jboolean isSetChannelOnDataPathSupported() { return call_method<"isSetChannelOnDataPathSupported", jboolean>(); }
	void removePairedDevice(jni::ref<java::lang::String> alias) { return call_method<"removePairedDevice", void>(alias); }
	void resetPairedDevices() { return call_method<"resetPairedDevices", void>(); }
	void setOpportunisticModeEnabled(jboolean enabled) { return call_method<"setOpportunisticModeEnabled", void>(enabled); }
};
