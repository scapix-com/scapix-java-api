...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_HOTSPOT2_PASSPOINTCONFIGURATION
...
public:
	...
	static jni::ref<android::net::wifi::hotspot2::PasspointConfiguration> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::hotspot2::PasspointConfiguration> new_object(jni::ref<android::net::wifi::hotspot2::PasspointConfiguration> source) { return object_base::new_object(source); }
	...
	void setSubscriptionExpirationTimeInMillis(jlong subscriptionExpirationTimeInMillis) { return call_method<"setSubscriptionExpirationTimeInMillis", void>(subscriptionExpirationTimeInMillis); }
