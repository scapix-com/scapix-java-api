...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_RTT_RESPONDERCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::rtt::ResponderConfig_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::rtt::ResponderConfig_Builder> new_object(jni::ref<android::net::wifi::rtt::ResponderConfig> config) { return object_base::new_object(config); }
	jni::ref<android::net::wifi::rtt::ResponderConfig> build() { return call_method<"build", jni::ref<android::net::wifi::rtt::ResponderConfig>>(); }
	jni::ref<android::net::wifi::rtt::ResponderConfig_Builder> set80211azNtbSupported(jboolean supports80211azNtb) { return call_method<"set80211azNtbSupported", jni::ref<android::net::wifi::rtt::ResponderConfig_Builder>>(supports80211azNtb); }
	...
	jni::ref<android::net::wifi::rtt::ResponderConfig_Builder> setPeerHandle(jni::ref<android::net::wifi::aware::PeerHandle> peerHandle) { return call_method<"setPeerHandle", jni::ref<android::net::wifi::rtt::ResponderConfig_Builder>>(peerHandle); }
	...
	jni::ref<android::net::wifi::rtt::ResponderConfig_Builder> setSecureRangingConfig(jni::ref<android::net::wifi::rtt::SecureRangingConfig> secureRangingConfig) { return call_method<"setSecureRangingConfig", jni::ref<android::net::wifi::rtt::ResponderConfig_Builder>>(secureRangingConfig); }
	jni::ref<android::net::wifi::rtt::ResponderConfig_Builder> setUsdPeerId(jint peerId) { return call_method<"setUsdPeerId", jni::ref<android::net::wifi::rtt::ResponderConfig_Builder>>(peerId); }
};
