...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_RTT_RESPONDERCONFIG
...
public:
	...
	jni::ref<android::net::wifi::rtt::SecureRangingConfig> getSecureRangingConfig() { return call_method<"getSecureRangingConfig", jni::ref<android::net::wifi::rtt::SecureRangingConfig>>(); }
