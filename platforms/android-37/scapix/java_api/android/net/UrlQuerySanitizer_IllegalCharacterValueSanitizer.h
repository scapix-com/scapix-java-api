...
class UrlQuerySanitizer_IllegalCharacterValueSanitizer;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_URLQUERYSANITIZER_ILLEGALCHARACTERVALUESANITIZER
...
public:
	...
	static jni::ref<android::net::UrlQuerySanitizer_IllegalCharacterValueSanitizer> new_object(jint flags) { return object_base::new_object(flags); }
