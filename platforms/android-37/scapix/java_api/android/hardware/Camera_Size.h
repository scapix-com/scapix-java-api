...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA_SIZE
...
public:
	...
	static jni::ref<android::hardware::Camera_Size> new_object(jni::ref<android::hardware::Camera> this_0, jint w, jint h) { return object_base::new_object(this_0, w, h); }
