...
class VirtualDisplayConfig_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_DISPLAY_VIRTUALDISPLAYCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::hardware::display::VirtualDisplayConfig_Builder> new_object(jni::ref<java::lang::String> name, jint width, jint height, jint densityDpi) { return object_base::new_object(name, width, height, densityDpi); }
	...
	jni::ref<android::hardware::display::VirtualDisplayConfig_Builder> setBrightnessListener(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::hardware::display::VirtualDisplayConfig_BrightnessListener> listener) { return call_method<"setBrightnessListener", jni::ref<android::hardware::display::VirtualDisplayConfig_Builder>>(executor, listener); }
	jni::ref<android::hardware::display::VirtualDisplayConfig_Builder> setDefaultBrightness(jfloat brightness) { return call_method<"setDefaultBrightness", jni::ref<android::hardware::display::VirtualDisplayConfig_Builder>>(brightness); }
	jni::ref<android::hardware::display::VirtualDisplayConfig_Builder> setDimBrightness(jfloat brightness) { return call_method<"setDimBrightness", jni::ref<android::hardware::display::VirtualDisplayConfig_Builder>>(brightness); }
