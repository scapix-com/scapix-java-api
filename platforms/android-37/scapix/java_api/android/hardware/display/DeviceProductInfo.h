...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_DISPLAY_DEVICEPRODUCTINFO
#define SCAPIX_JAVA_API_ANDROID_HARDWARE_DISPLAY_DEVICEPRODUCTINFO

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/hardware/display/DeviceProductInfo_EdidStructureMetadata.h>
#include <scapix/java_api/android/os/Parcel.h>
#include <scapix/java_api/android/os/Parcelable_Creator.h>
#include <scapix/java_api/java/lang/String.h>
#include <scapix/java_api/android/hardware/display/DeviceProductInfo_Builder.h>
...
public:
	...
	using EdidStructureMetadata = DeviceProductInfo_EdidStructureMetadata;
	using Builder = DeviceProductInfo_Builder;
	...
	static jint VIDEO_INPUT_TYPE_ANALOG() { return get_static_field<"VIDEO_INPUT_TYPE_ANALOG", jint>(); }
	static jint VIDEO_INPUT_TYPE_DIGITAL() { return get_static_field<"VIDEO_INPUT_TYPE_DIGITAL", jint>(); }
	static jint VIDEO_INPUT_TYPE_UNKNOWN() { return get_static_field<"VIDEO_INPUT_TYPE_UNKNOWN", jint>(); }

	static jni::ref<android::hardware::display::DeviceProductInfo> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> manufacturerPnpId, jni::ref<java::lang::String> productId, jint modelYear, jint connectionToSinkType) { return object_base::new_object(name, manufacturerPnpId, productId, modelYear, connectionToSinkType); }
	jint describeContents() { return call_method<"describeContents", jint>(); }
	jboolean equals(jni::ref<java::lang::Object> o) { return call_method<"equals", jboolean>(o); }
	jint getConnectionToSinkType() { return call_method<"getConnectionToSinkType", jint>(); }
	jni::ref<android::hardware::display::DeviceProductInfo_EdidStructureMetadata> getEdidStructureMetadata() { return call_method<"getEdidStructureMetadata", jni::ref<android::hardware::display::DeviceProductInfo_EdidStructureMetadata>>(); }
	...
	jint getVideoInputType() { return call_method<"getVideoInputType", jint>(); }
