...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_BIOMETRICS_BIOMETRICPROMPT_BUILDER
...
public:
	...
	static jni::ref<android::hardware::biometrics::BiometricPrompt_Builder> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	jni::ref<android::hardware::biometrics::BiometricPrompt_Builder> addFallbackOption(jni::ref<java::lang::CharSequence> text, jint iconType, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::content::DialogInterface_OnClickListener> listener) { return call_method<"addFallbackOption", jni::ref<android::hardware::biometrics::BiometricPrompt_Builder>>(text, iconType, executor, listener); }
	...
	jni::ref<android::hardware::biometrics::BiometricPrompt_Builder> setContentView(jni::ref<android::hardware::biometrics::PromptContentView> view) { return call_method<"setContentView", jni::ref<android::hardware::biometrics::BiometricPrompt_Builder>>(view); }
	...
	jni::ref<android::hardware::biometrics::BiometricPrompt_Builder> setLogoBitmap(jni::ref<android::graphics::Bitmap> logoBitmap) { return call_method<"setLogoBitmap", jni::ref<android::hardware::biometrics::BiometricPrompt_Builder>>(logoBitmap); }
	jni::ref<android::hardware::biometrics::BiometricPrompt_Builder> setLogoDescription(jni::ref<java::lang::String> logoDescription) { return call_method<"setLogoDescription", jni::ref<android::hardware::biometrics::BiometricPrompt_Builder>>(logoDescription); }
	jni::ref<android::hardware::biometrics::BiometricPrompt_Builder> setLogoRes(jint logoRes) { return call_method<"setLogoRes", jni::ref<android::hardware::biometrics::BiometricPrompt_Builder>>(logoRes); }
