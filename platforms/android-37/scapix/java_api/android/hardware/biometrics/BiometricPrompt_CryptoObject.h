...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_BIOMETRICS_BIOMETRICPROMPT_CRYPTOOBJECT
...
#include <scapix/java_api/javax/crypto/KeyAgreement.h>
...
public:
	...
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jni::ref<android::security::identity::IdentityCredential> credential) { return object_base::new_object(credential); }
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jni::ref<android::security::identity::PresentationSession> session) { return object_base::new_object(session); }
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jni::ref<java::security::Signature> signature) { return object_base::new_object(signature); }
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jni::ref<javax::crypto::Cipher> cipher) { return object_base::new_object(cipher); }
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jni::ref<javax::crypto::KeyAgreement> keyAgreement) { return object_base::new_object(keyAgreement); }
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jni::ref<javax::crypto::Mac> mac) { return object_base::new_object(mac); }
	static jni::ref<android::hardware::biometrics::BiometricPrompt_CryptoObject> new_object(jlong operationHandle) { return object_base::new_object(operationHandle); }
	...
	jni::ref<javax::crypto::KeyAgreement> getKeyAgreement() { return call_method<"getKeyAgreement", jni::ref<javax::crypto::KeyAgreement>>(); }
	jni::ref<javax::crypto::Mac> getMac() { return call_method<"getMac", jni::ref<javax::crypto::Mac>>(); }
	jlong getOperationHandle() { return call_method<"getOperationHandle", jlong>(); }
