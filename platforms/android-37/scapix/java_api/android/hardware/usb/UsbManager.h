...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_USB_USBMANAGER
...
public:
	...
	jni::ref<java::io::InputStream> openAccessoryInputStream(jni::ref<android::hardware::usb::UsbAccessory> accessory) { return call_method<"openAccessoryInputStream", jni::ref<java::io::InputStream>>(accessory); }
	jni::ref<java::io::OutputStream> openAccessoryOutputStream(jni::ref<android::hardware::usb::UsbAccessory> accessory) { return call_method<"openAccessoryOutputStream", jni::ref<java::io::OutputStream>>(accessory); }
