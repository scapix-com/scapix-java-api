...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAPTURERESULT
...
public:
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> COLOR_CORRECTION_COLOR_TEMPERATURE() { return get_static_field<"COLOR_CORRECTION_COLOR_TEMPERATURE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> COLOR_CORRECTION_COLOR_TINT() { return get_static_field<"COLOR_CORRECTION_COLOR_TINT", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_AE_PRIORITY_MODE() { return get_static_field<"CONTROL_AE_PRIORITY_MODE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_AF_SCENE_CHANGE() { return get_static_field<"CONTROL_AF_SCENE_CHANGE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_AUTOFRAMING() { return get_static_field<"CONTROL_AUTOFRAMING", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_AUTOFRAMING_STATE() { return get_static_field<"CONTROL_AUTOFRAMING_STATE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_EXTENDED_SCENE_MODE() { return get_static_field<"CONTROL_EXTENDED_SCENE_MODE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_LOW_LIGHT_BOOST_STATE() { return get_static_field<"CONTROL_LOW_LIGHT_BOOST_STATE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_SETTINGS_OVERRIDE() { return get_static_field<"CONTROL_SETTINGS_OVERRIDE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_ZOOM_METHOD() { return get_static_field<"CONTROL_ZOOM_METHOD", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> CONTROL_ZOOM_RATIO() { return get_static_field<"CONTROL_ZOOM_RATIO", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> DISTORTION_CORRECTION_MODE() { return get_static_field<"DISTORTION_CORRECTION_MODE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> EXTENSION_CURRENT_TYPE() { return get_static_field<"EXTENSION_CURRENT_TYPE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> EXTENSION_NIGHT_MODE_INDICATOR() { return get_static_field<"EXTENSION_NIGHT_MODE_INDICATOR", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> EXTENSION_STRENGTH() { return get_static_field<"EXTENSION_STRENGTH", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> FLASH_STRENGTH_LEVEL() { return get_static_field<"FLASH_STRENGTH_LEVEL", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> INFO_DEVICE_TYPE() { return get_static_field<"INFO_DEVICE_TYPE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> LENS_DISTORTION() { return get_static_field<"LENS_DISTORTION", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID() { return get_static_field<"LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_ID", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_SENSOR_CROP_REGION() { return get_static_field<"LOGICAL_MULTI_CAMERA_ACTIVE_PHYSICAL_SENSOR_CROP_REGION", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> LOGICAL_MULTI_CAMERA_ADDITIONAL_RESULTS() { return get_static_field<"LOGICAL_MULTI_CAMERA_ADDITIONAL_RESULTS", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> SCALER_RAW_CROP_REGION() { return get_static_field<"SCALER_RAW_CROP_REGION", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> SCALER_ROTATE_AND_CROP() { return get_static_field<"SCALER_ROTATE_AND_CROP", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> SENSOR_PIXEL_MODE() { return get_static_field<"SENSOR_PIXEL_MODE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> SENSOR_RAW_BINNING_FACTOR_USED() { return get_static_field<"SENSOR_RAW_BINNING_FACTOR_USED", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> STATISTICS_LENS_INTRINSICS_SAMPLES() { return get_static_field<"STATISTICS_LENS_INTRINSICS_SAMPLES", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> STATISTICS_OIS_DATA_MODE() { return get_static_field<"STATISTICS_OIS_DATA_MODE", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	static jni::ref<android::hardware::camera2::CaptureResult_Key> STATISTICS_OIS_SAMPLES() { return get_static_field<"STATISTICS_OIS_SAMPLES", jni::ref<android::hardware::camera2::CaptureResult_Key>>(); }
	...
	jni::ref<java::lang::String> getCameraId() { return call_method<"getCameraId", jni::ref<java::lang::String>>(); }
