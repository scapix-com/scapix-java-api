...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERACHARACTERISTICS
...
public:
	...
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> COLOR_CORRECTION_AVAILABLE_MODES() { return get_static_field<"COLOR_CORRECTION_AVAILABLE_MODES", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> COLOR_CORRECTION_COLOR_TEMPERATURE_RANGE() { return get_static_field<"COLOR_CORRECTION_COLOR_TEMPERATURE_RANGE", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> CONTROL_AE_AVAILABLE_PRIORITY_MODES() { return get_static_field<"CONTROL_AE_AVAILABLE_PRIORITY_MODES", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> CONTROL_LOW_LIGHT_BOOST_INFO_LUMINANCE_RANGE() { return get_static_field<"CONTROL_LOW_LIGHT_BOOST_INFO_LUMINANCE_RANGE", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> FLASH_SINGLE_STRENGTH_DEFAULT_LEVEL() { return get_static_field<"FLASH_SINGLE_STRENGTH_DEFAULT_LEVEL", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> FLASH_SINGLE_STRENGTH_MAX_LEVEL() { return get_static_field<"FLASH_SINGLE_STRENGTH_MAX_LEVEL", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> FLASH_TORCH_STRENGTH_DEFAULT_LEVEL() { return get_static_field<"FLASH_TORCH_STRENGTH_DEFAULT_LEVEL", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> FLASH_TORCH_STRENGTH_MAX_LEVEL() { return get_static_field<"FLASH_TORCH_STRENGTH_MAX_LEVEL", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	...
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> INFO_DEVICE_TYPE() { return get_static_field<"INFO_DEVICE_TYPE", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	static jni::ref<android::hardware::camera2::CameraCharacteristics_Key> INFO_SESSION_CONFIGURATION_QUERY_VERSION() { return get_static_field<"INFO_SESSION_CONFIGURATION_QUERY_VERSION", jni::ref<android::hardware::camera2::CameraCharacteristics_Key>>(); }
	...
	jni::ref<java::util::List> getAvailableSessionCharacteristicsKeys() { return call_method<"getAvailableSessionCharacteristicsKeys", jni::ref<java::util::List>>(); }
