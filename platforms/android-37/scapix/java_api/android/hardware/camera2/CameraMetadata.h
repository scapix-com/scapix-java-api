...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERAMETADATA
...
public:
	...
	static jint AUTOMOTIVE_LENS_FACING_EXTERIOR_FRONT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_EXTERIOR_FRONT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_EXTERIOR_LEFT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_EXTERIOR_LEFT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_EXTERIOR_OTHER() { return get_static_field<"AUTOMOTIVE_LENS_FACING_EXTERIOR_OTHER", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_EXTERIOR_REAR() { return get_static_field<"AUTOMOTIVE_LENS_FACING_EXTERIOR_REAR", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_EXTERIOR_RIGHT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_EXTERIOR_RIGHT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_OTHER() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_OTHER", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_1_CENTER() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_1_CENTER", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_1_LEFT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_1_LEFT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_1_RIGHT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_1_RIGHT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_2_CENTER() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_2_CENTER", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_2_LEFT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_2_LEFT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_2_RIGHT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_2_RIGHT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_3_CENTER() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_3_CENTER", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_3_LEFT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_3_LEFT", jint>(); }
	static jint AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_3_RIGHT() { return get_static_field<"AUTOMOTIVE_LENS_FACING_INTERIOR_SEAT_ROW_3_RIGHT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTERIOR_FRONT() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTERIOR_FRONT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTERIOR_LEFT() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTERIOR_LEFT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTERIOR_OTHER() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTERIOR_OTHER", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTERIOR_REAR() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTERIOR_REAR", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTERIOR_RIGHT() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTERIOR_RIGHT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTRA_FRONT() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTRA_FRONT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTRA_LEFT() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTRA_LEFT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTRA_OTHER() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTRA_OTHER", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTRA_REAR() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTRA_REAR", jint>(); }
	static jint AUTOMOTIVE_LOCATION_EXTRA_RIGHT() { return get_static_field<"AUTOMOTIVE_LOCATION_EXTRA_RIGHT", jint>(); }
	static jint AUTOMOTIVE_LOCATION_INTERIOR() { return get_static_field<"AUTOMOTIVE_LOCATION_INTERIOR", jint>(); }
	...
	static jint COLOR_CORRECTION_MODE_CCT() { return get_static_field<"COLOR_CORRECTION_MODE_CCT", jint>(); }
	...
	static jint CONTROL_AE_MODE_ON_EXTERNAL_FLASH() { return get_static_field<"CONTROL_AE_MODE_ON_EXTERNAL_FLASH", jint>(); }
	static jint CONTROL_AE_MODE_ON_LOW_LIGHT_BOOST_BRIGHTNESS_PRIORITY() { return get_static_field<"CONTROL_AE_MODE_ON_LOW_LIGHT_BOOST_BRIGHTNESS_PRIORITY", jint>(); }
	...
	static jint CONTROL_AE_PRIORITY_MODE_OFF() { return get_static_field<"CONTROL_AE_PRIORITY_MODE_OFF", jint>(); }
	static jint CONTROL_AE_PRIORITY_MODE_SENSOR_EXPOSURE_TIME_PRIORITY() { return get_static_field<"CONTROL_AE_PRIORITY_MODE_SENSOR_EXPOSURE_TIME_PRIORITY", jint>(); }
	static jint CONTROL_AE_PRIORITY_MODE_SENSOR_SENSITIVITY_PRIORITY() { return get_static_field<"CONTROL_AE_PRIORITY_MODE_SENSOR_SENSITIVITY_PRIORITY", jint>(); }
	...
	static jint CONTROL_AF_SCENE_CHANGE_DETECTED() { return get_static_field<"CONTROL_AF_SCENE_CHANGE_DETECTED", jint>(); }
	static jint CONTROL_AF_SCENE_CHANGE_NOT_DETECTED() { return get_static_field<"CONTROL_AF_SCENE_CHANGE_NOT_DETECTED", jint>(); }
	...
	static jint CONTROL_AUTOFRAMING_OFF() { return get_static_field<"CONTROL_AUTOFRAMING_OFF", jint>(); }
	static jint CONTROL_AUTOFRAMING_ON() { return get_static_field<"CONTROL_AUTOFRAMING_ON", jint>(); }
	static jint CONTROL_AUTOFRAMING_STATE_CONVERGED() { return get_static_field<"CONTROL_AUTOFRAMING_STATE_CONVERGED", jint>(); }
	static jint CONTROL_AUTOFRAMING_STATE_FRAMING() { return get_static_field<"CONTROL_AUTOFRAMING_STATE_FRAMING", jint>(); }
	static jint CONTROL_AUTOFRAMING_STATE_INACTIVE() { return get_static_field<"CONTROL_AUTOFRAMING_STATE_INACTIVE", jint>(); }
	...
	static jint CONTROL_CAPTURE_INTENT_MOTION_TRACKING() { return get_static_field<"CONTROL_CAPTURE_INTENT_MOTION_TRACKING", jint>(); }
	...
	static jint CONTROL_EXTENDED_SCENE_MODE_BOKEH_CONTINUOUS() { return get_static_field<"CONTROL_EXTENDED_SCENE_MODE_BOKEH_CONTINUOUS", jint>(); }
	static jint CONTROL_EXTENDED_SCENE_MODE_BOKEH_STILL_CAPTURE() { return get_static_field<"CONTROL_EXTENDED_SCENE_MODE_BOKEH_STILL_CAPTURE", jint>(); }
	static jint CONTROL_EXTENDED_SCENE_MODE_DISABLED() { return get_static_field<"CONTROL_EXTENDED_SCENE_MODE_DISABLED", jint>(); }
	static jint CONTROL_LOW_LIGHT_BOOST_STATE_ACTIVE() { return get_static_field<"CONTROL_LOW_LIGHT_BOOST_STATE_ACTIVE", jint>(); }
	static jint CONTROL_LOW_LIGHT_BOOST_STATE_INACTIVE() { return get_static_field<"CONTROL_LOW_LIGHT_BOOST_STATE_INACTIVE", jint>(); }
	...
	static jint CONTROL_MODE_USE_EXTENDED_SCENE_MODE() { return get_static_field<"CONTROL_MODE_USE_EXTENDED_SCENE_MODE", jint>(); }
	...
	static jint CONTROL_SETTINGS_OVERRIDE_OFF() { return get_static_field<"CONTROL_SETTINGS_OVERRIDE_OFF", jint>(); }
	static jint CONTROL_SETTINGS_OVERRIDE_ZOOM() { return get_static_field<"CONTROL_SETTINGS_OVERRIDE_ZOOM", jint>(); }
	...
	static jint CONTROL_VIDEO_STABILIZATION_MODE_PREVIEW_STABILIZATION() { return get_static_field<"CONTROL_VIDEO_STABILIZATION_MODE_PREVIEW_STABILIZATION", jint>(); }
	static jint CONTROL_ZOOM_METHOD_AUTO() { return get_static_field<"CONTROL_ZOOM_METHOD_AUTO", jint>(); }
	static jint CONTROL_ZOOM_METHOD_ZOOM_RATIO() { return get_static_field<"CONTROL_ZOOM_METHOD_ZOOM_RATIO", jint>(); }
	static jint DISTORTION_CORRECTION_MODE_FAST() { return get_static_field<"DISTORTION_CORRECTION_MODE_FAST", jint>(); }
	static jint DISTORTION_CORRECTION_MODE_HIGH_QUALITY() { return get_static_field<"DISTORTION_CORRECTION_MODE_HIGH_QUALITY", jint>(); }
	static jint DISTORTION_CORRECTION_MODE_OFF() { return get_static_field<"DISTORTION_CORRECTION_MODE_OFF", jint>(); }
	...
	static jint EXTENSION_NIGHT_MODE_INDICATOR_OFF() { return get_static_field<"EXTENSION_NIGHT_MODE_INDICATOR_OFF", jint>(); }
	static jint EXTENSION_NIGHT_MODE_INDICATOR_ON() { return get_static_field<"EXTENSION_NIGHT_MODE_INDICATOR_ON", jint>(); }
	static jint EXTENSION_NIGHT_MODE_INDICATOR_UNKNOWN() { return get_static_field<"EXTENSION_NIGHT_MODE_INDICATOR_UNKNOWN", jint>(); }
	...
	static jint INFO_DEVICE_TYPE_BUILT_IN() { return get_static_field<"INFO_DEVICE_TYPE_BUILT_IN", jint>(); }
	static jint INFO_DEVICE_TYPE_EXTERNAL() { return get_static_field<"INFO_DEVICE_TYPE_EXTERNAL", jint>(); }
	static jint INFO_DEVICE_TYPE_UNKNOWN() { return get_static_field<"INFO_DEVICE_TYPE_UNKNOWN", jint>(); }
	static jint INFO_DEVICE_TYPE_VIRTUAL() { return get_static_field<"INFO_DEVICE_TYPE_VIRTUAL", jint>(); }
	static jint INFO_SUPPORTED_HARDWARE_LEVEL_3() { return get_static_field<"INFO_SUPPORTED_HARDWARE_LEVEL_3", jint>(); }
	static jint INFO_SUPPORTED_HARDWARE_LEVEL_EXTERNAL() { return get_static_field<"INFO_SUPPORTED_HARDWARE_LEVEL_EXTERNAL", jint>(); }
	...
	static jint LENS_POSE_REFERENCE_AUTOMOTIVE() { return get_static_field<"LENS_POSE_REFERENCE_AUTOMOTIVE", jint>(); }
	static jint LENS_POSE_REFERENCE_GYROSCOPE() { return get_static_field<"LENS_POSE_REFERENCE_GYROSCOPE", jint>(); }
	static jint LENS_POSE_REFERENCE_PRIMARY_CAMERA() { return get_static_field<"LENS_POSE_REFERENCE_PRIMARY_CAMERA", jint>(); }
	static jint LENS_POSE_REFERENCE_UNDEFINED() { return get_static_field<"LENS_POSE_REFERENCE_UNDEFINED", jint>(); }
	...
	static jint LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE_APPROXIMATE() { return get_static_field<"LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE_APPROXIMATE", jint>(); }
	static jint LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE_CALIBRATED() { return get_static_field<"LOGICAL_MULTI_CAMERA_SENSOR_SYNC_TYPE_CALIBRATED", jint>(); }
	...
	static jint REQUEST_AVAILABLE_CAPABILITIES_COLOR_SPACE_PROFILES() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_COLOR_SPACE_PROFILES", jint>(); }
	...
	static jint REQUEST_AVAILABLE_CAPABILITIES_DYNAMIC_RANGE_TEN_BIT() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_DYNAMIC_RANGE_TEN_BIT", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA", jint>(); }
	...
	static jint REQUEST_AVAILABLE_CAPABILITIES_MONOCHROME() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_MONOCHROME", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_MOTION_TRACKING() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_MOTION_TRACKING", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_OFFLINE_PROCESSING() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_OFFLINE_PROCESSING", jint>(); }
	...
	static jint REQUEST_AVAILABLE_CAPABILITIES_REMOSAIC_REPROCESSING() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_REMOSAIC_REPROCESSING", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_SECURE_IMAGE_DATA() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_SECURE_IMAGE_DATA", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_STREAM_USE_CASE() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_STREAM_USE_CASE", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_SYSTEM_CAMERA() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_SYSTEM_CAMERA", jint>(); }
	static jint REQUEST_AVAILABLE_CAPABILITIES_ULTRA_HIGH_RESOLUTION_SENSOR() { return get_static_field<"REQUEST_AVAILABLE_CAPABILITIES_ULTRA_HIGH_RESOLUTION_SENSOR", jint>(); }
	...
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_CROPPED_RAW() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_CROPPED_RAW", jint>(); }
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_DEFAULT() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_DEFAULT", jint>(); }
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_PREVIEW() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_PREVIEW", jint>(); }
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_PREVIEW_VIDEO_STILL() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_PREVIEW_VIDEO_STILL", jint>(); }
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_STILL_CAPTURE() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_STILL_CAPTURE", jint>(); }
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_VIDEO_CALL() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_VIDEO_CALL", jint>(); }
	static jint SCALER_AVAILABLE_STREAM_USE_CASES_VIDEO_RECORD() { return get_static_field<"SCALER_AVAILABLE_STREAM_USE_CASES_VIDEO_RECORD", jint>(); }
	...
	static jint SCALER_ROTATE_AND_CROP_180() { return get_static_field<"SCALER_ROTATE_AND_CROP_180", jint>(); }
	static jint SCALER_ROTATE_AND_CROP_270() { return get_static_field<"SCALER_ROTATE_AND_CROP_270", jint>(); }
	static jint SCALER_ROTATE_AND_CROP_90() { return get_static_field<"SCALER_ROTATE_AND_CROP_90", jint>(); }
	static jint SCALER_ROTATE_AND_CROP_AUTO() { return get_static_field<"SCALER_ROTATE_AND_CROP_AUTO", jint>(); }
	static jint SCALER_ROTATE_AND_CROP_NONE() { return get_static_field<"SCALER_ROTATE_AND_CROP_NONE", jint>(); }
	...
	static jint SENSOR_INFO_COLOR_FILTER_ARRANGEMENT_MONO() { return get_static_field<"SENSOR_INFO_COLOR_FILTER_ARRANGEMENT_MONO", jint>(); }
	static jint SENSOR_INFO_COLOR_FILTER_ARRANGEMENT_NIR() { return get_static_field<"SENSOR_INFO_COLOR_FILTER_ARRANGEMENT_NIR", jint>(); }
	...
	static jint SENSOR_PIXEL_MODE_DEFAULT() { return get_static_field<"SENSOR_PIXEL_MODE_DEFAULT", jint>(); }
	static jint SENSOR_PIXEL_MODE_MAXIMUM_RESOLUTION() { return get_static_field<"SENSOR_PIXEL_MODE_MAXIMUM_RESOLUTION", jint>(); }
	static jint SENSOR_READOUT_TIMESTAMP_HARDWARE() { return get_static_field<"SENSOR_READOUT_TIMESTAMP_HARDWARE", jint>(); }
	static jint SENSOR_READOUT_TIMESTAMP_NOT_SUPPORTED() { return get_static_field<"SENSOR_READOUT_TIMESTAMP_NOT_SUPPORTED", jint>(); }
	...
	static jint STATISTICS_OIS_DATA_MODE_OFF() { return get_static_field<"STATISTICS_OIS_DATA_MODE_OFF", jint>(); }
	static jint STATISTICS_OIS_DATA_MODE_ON() { return get_static_field<"STATISTICS_OIS_DATA_MODE_ON", jint>(); }
