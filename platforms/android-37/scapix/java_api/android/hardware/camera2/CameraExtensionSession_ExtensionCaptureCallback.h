...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERAEXTENSIONSESSION_EXTENSIONCAPTURECALLBACK
...
public:
	...
	static jni::ref<android::hardware::camera2::CameraExtensionSession_ExtensionCaptureCallback> new_object() { return object_base::new_object(); }
	...
	void onCaptureFailed(jni::ref<android::hardware::camera2::CameraExtensionSession> session, jni::ref<android::hardware::camera2::CaptureRequest> request, jint failure) { return call_method<"onCaptureFailed", void>(session, request, failure); }
