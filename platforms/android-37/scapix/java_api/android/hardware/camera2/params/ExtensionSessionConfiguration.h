...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_EXTENSIONSESSIONCONFIGURATION
...
public:
	...
	jni::ref<android::hardware::camera2::CaptureRequest> getSessionWideParams() { return call_method<"getSessionWideParams", jni::ref<android::hardware::camera2::CaptureRequest>>(); }
	...
	void setSessionWideParams(jni::ref<android::hardware::camera2::CaptureRequest> sessionCaptureParams) { return call_method<"setSessionWideParams", void>(sessionCaptureParams); }
};
