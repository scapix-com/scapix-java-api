...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_MULTIRESOLUTIONSTREAMCONFIGURATIONMAP
...
public:
	...
	jboolean isConcurrentReadersSupported(jint format) { return call_method<"isConcurrentReadersSupported", jboolean>(format); }
