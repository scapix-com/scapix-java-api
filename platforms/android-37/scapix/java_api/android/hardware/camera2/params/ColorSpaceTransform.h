...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_COLORSPACETRANSFORM
...
public:
	...
	static jni::ref<android::hardware::camera2::params::ColorSpaceTransform> new_object(jni::ref<jni::array<android::util::Rational>> elements) { return object_base::new_object(elements); }
	static jni::ref<android::hardware::camera2::params::ColorSpaceTransform> new_object(jni::ref<jni::array<jint>> elements) { return object_base::new_object(elements); }
