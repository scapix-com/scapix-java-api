...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_METERINGRECTANGLE
...
public:
	...
	static jni::ref<android::hardware::camera2::params::MeteringRectangle> new_object(jni::ref<android::graphics::Point> xy, jni::ref<android::util::Size> dimensions, jint meteringWeight) { return object_base::new_object(xy, dimensions, meteringWeight); }
	static jni::ref<android::hardware::camera2::params::MeteringRectangle> new_object(jni::ref<android::graphics::Rect> rect, jint meteringWeight) { return object_base::new_object(rect, meteringWeight); }
	static jni::ref<android::hardware::camera2::params::MeteringRectangle> new_object(jint x, jint y, jint width, jint height, jint meteringWeight) { return object_base::new_object(x, y, width, height, meteringWeight); }
