...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_OUTPUTCONFIGURATION
...
public:
	...
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jni::ref<android::util::Size> surfaceSize, jni::ref<java::lang::Class> klass) { return object_base::new_object(surfaceSize, klass); }
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jni::ref<android::view::Surface> surface) { return object_base::new_object(surface); }
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jint format, jni::ref<android::util::Size> surfaceSize) { return object_base::new_object(format, surfaceSize); }
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jint format, jni::ref<android::util::Size> surfaceSize, jlong usage) { return object_base::new_object(format, surfaceSize, usage); }
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jint surfaceGroupId, jni::ref<android::view::Surface> surface) { return object_base::new_object(surfaceGroupId, surface); }
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jint surfaceGroupId, jint format, jni::ref<android::util::Size> surfaceSize) { return object_base::new_object(surfaceGroupId, format, surfaceSize); }
	static jni::ref<android::hardware::camera2::params::OutputConfiguration> new_object(jint surfaceGroupId, jint format, jni::ref<android::util::Size> surfaceSize, jlong usage) { return object_base::new_object(surfaceGroupId, format, surfaceSize, usage); }
	...
	static jni::ref<java::util::List> createInstancesForMultiResolutionOutput(jni::ref<java::util::Collection> streams, jint format) { return call_static_method<"createInstancesForMultiResolutionOutput", jni::ref<java::util::List>>(streams, format); }
	jint describeContents() { return call_method<"describeContents", jint>(); }
	void enableSurfaceSharing() { return call_method<"enableSurfaceSharing", void>(); }
	jboolean equals(jni::ref<java::lang::Object> obj) { return call_method<"equals", jboolean>(obj); }
	jint getConfiguredFormat() { return call_method<"getConfiguredFormat", jint>(); }
	jni::ref<android::util::Size> getConfiguredSize() { return call_method<"getConfiguredSize", jni::ref<android::util::Size>>(); }
	...
	jint getMirrorMode(jni::ref<android::view::Surface> surface) { return call_method<"getMirrorMode", jint>(surface); }
	...
	jni::ref<android::hardware::camera2::params::OutputConfiguration> makeDeferredAndRemoveSurfaces() { return call_method<"makeDeferredAndRemoveSurfaces", jni::ref<android::hardware::camera2::params::OutputConfiguration>>(); }
	...
	void setMirrorMode(jni::ref<android::view::Surface> surface, jint mirrorMode) { return call_method<"setMirrorMode", void>(surface, mirrorMode); }
	...
	static void setSurfacesForMultiResolutionOutput(jni::ref<java::util::Collection> outputConfigurations, jni::ref<android::hardware::camera2::MultiResolutionImageReader> multiResolutionImageReader) { return call_static_method<"setSurfacesForMultiResolutionOutput", void>(outputConfigurations, multiResolutionImageReader); }
