...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAPTURERESULT_KEY
...
public:
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type) { return object_base::new_object(name, type); }
