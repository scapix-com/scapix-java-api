...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERAMANAGER
...
#include <scapix/java_api/android/hardware/camera2/CameraDevice_CameraDeviceSetup.h>
#include <scapix/java_api/android/hardware/camera2/CameraDevice_StateCallback.h>
#include <scapix/java_api/android/hardware/camera2/CameraExtensionCharacteristics.h>
...
public:
	...
	jni::ref<android::hardware::camera2::CameraDevice_CameraDeviceSetup> getCameraDeviceSetup(jni::ref<java::lang::String> cameraId) { return call_method<"getCameraDeviceSetup", jni::ref<android::hardware::camera2::CameraDevice_CameraDeviceSetup>>(cameraId); }
	jni::ref<android::hardware::camera2::CameraExtensionCharacteristics> getCameraExtensionCharacteristics(jni::ref<java::lang::String> cameraId) { return call_method<"getCameraExtensionCharacteristics", jni::ref<android::hardware::camera2::CameraExtensionCharacteristics>>(cameraId); }
	...
	jint getTorchStrengthLevel(jni::ref<java::lang::String> cameraId) { return call_method<"getTorchStrengthLevel", jint>(cameraId); }
	jboolean isCameraDeviceSetupSupported(jni::ref<java::lang::String> cameraId) { return call_method<"isCameraDeviceSetupSupported", jboolean>(cameraId); }
	...
	void turnOnTorchWithStrengthLevel(jni::ref<java::lang::String> cameraId, jint torchStrength) { return call_method<"turnOnTorchWithStrengthLevel", void>(cameraId, torchStrength); }
