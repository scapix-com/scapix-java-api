...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_DNGCREATOR
...
public:
	...
	static jni::ref<android::hardware::camera2::DngCreator> new_object(jni::ref<android::hardware::camera2::CameraCharacteristics> characteristics, jni::ref<android::hardware::camera2::CaptureResult> metadata) { return object_base::new_object(characteristics, metadata); }
