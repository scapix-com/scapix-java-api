...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_LIGHTS_LIGHTSREQUEST_BUILDER
...
public:
	...
	static jni::ref<android::hardware::lights::LightsRequest_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::hardware::lights::LightsRequest_Builder> setEffect(jni::ref<android::hardware::lights::MultiLightEffect> effect) { return call_method<"setEffect", jni::ref<android::hardware::lights::LightsRequest_Builder>>(effect); }
};
