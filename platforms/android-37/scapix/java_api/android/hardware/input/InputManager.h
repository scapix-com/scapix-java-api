...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_INPUT_INPUTMANAGER
#define SCAPIX_JAVA_API_ANDROID_HARDWARE_INPUT_INPUTMANAGER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/hardware/input/HostUsiVersion.h>
...
public:
	...
	jni::ref<android::hardware::input::HostUsiVersion> getHostUsiVersion(jni::ref<android::view::Display> display) { return call_method<"getHostUsiVersion", jni::ref<android::hardware::input::HostUsiVersion>>(display); }
	...
	jni::ref<android::view::InputDevice_ViewBehavior> getInputDeviceViewBehavior(jint deviceId) { return call_method<"getInputDeviceViewBehavior", jni::ref<android::view::InputDevice_ViewBehavior>>(deviceId); }
	jfloat getMaximumObscuringOpacityForTouch() { return call_method<"getMaximumObscuringOpacityForTouch", jfloat>(); }
	jboolean isStylusPointerIconEnabled() { return call_method<"isStylusPointerIconEnabled", jboolean>(); }
