...
#ifndef SCAPIX_JAVA_API_ANDROID_ADSERVICES_MEASUREMENT_MEASUREMENTMANAGER
#define SCAPIX_JAVA_API_ANDROID_ADSERVICES_MEASUREMENT_MEASUREMENTMANAGER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/adservices/common/AdServicesOutcomeReceiver.h>
...
public:
	...
	void deleteRegistrations(jni::ref<android::adservices::measurement::DeletionRequest> deletionRequest, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"deleteRegistrations", void>(deletionRequest, executor, callback); }
	...
	static jni::ref<android::adservices::measurement::MeasurementManager> get(jni::ref<android::content::Context> context) { return call_static_method<"get", jni::ref<android::adservices::measurement::MeasurementManager>>(context); }
	void getMeasurementApiStatus(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"getMeasurementApiStatus", void>(executor, callback); }
	...
	void registerSource(jni::ref<android::adservices::measurement::SourceRegistrationRequest> request, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"registerSource", void>(request, executor, callback); }
	void registerSource(jni::ref<android::adservices::measurement::SourceRegistrationRequest> request, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::os::OutcomeReceiver> callback) { return call_method<"registerSource", void>(request, executor, callback); }
	void registerSource(jni::ref<android::net::Uri> attributionSource, jni::ref<android::view::InputEvent> inputEvent, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"registerSource", void>(attributionSource, inputEvent, executor, callback); }
	...
	void registerTrigger(jni::ref<android::net::Uri> trigger, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"registerTrigger", void>(trigger, executor, callback); }
	...
	void registerWebSource(jni::ref<android::adservices::measurement::WebSourceRegistrationRequest> request, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"registerWebSource", void>(request, executor, callback); }
	...
	void registerWebTrigger(jni::ref<android::adservices::measurement::WebTriggerRegistrationRequest> request, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::adservices::common::AdServicesOutcomeReceiver> callback) { return call_method<"registerWebTrigger", void>(request, executor, callback); }
