...
#ifndef SCAPIX_JAVA_API_ANDROID_ADSERVICES_MEASUREMENT_WEBSOURCEPARAMS_BUILDER
...
public:
	...
	static jni::ref<android::adservices::measurement::WebSourceParams_Builder> new_object(jni::ref<android::net::Uri> registrationUri) { return object_base::new_object(registrationUri); }
