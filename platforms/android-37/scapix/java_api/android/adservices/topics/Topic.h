...
#ifndef SCAPIX_JAVA_API_ANDROID_ADSERVICES_TOPICS_TOPIC
...
public:
	...
	static jni::ref<android::adservices::topics::Topic> new_object(jlong mTaxonomyVersion, jlong mModelVersion, jint mTopicId) { return object_base::new_object(mTaxonomyVersion, mModelVersion, mTopicId); }
