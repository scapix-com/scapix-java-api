...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_UNRESOLVEDPERMISSION
...
public:
	...
	static jni::ref<java::security::UnresolvedPermission> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions, jni::ref<jni::array<java::security::cert::Certificate>> certs) { return object_base::new_object(type, name, actions, certs); }
