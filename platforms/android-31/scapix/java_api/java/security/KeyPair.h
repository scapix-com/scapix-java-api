...
public:
	...
	static jni::ref<java::security::KeyPair> new_object(jni::ref<java::security::PublicKey> publicKey, jni::ref<java::security::PrivateKey> privateKey) { return base_::new_object(publicKey, privateKey); }
