...
public:
	...
	static jni::ref<java::lang::AssertionError> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return base_::new_object(message, cause); }
