...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OBJECTSTREAMFIELD
...
public:
	...
	static jni::ref<java::io::ObjectStreamField> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type) { return object_base::new_object(name, type); }
	static jni::ref<java::io::ObjectStreamField> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type, jboolean unshared) { return object_base::new_object(name, type, unshared); }
