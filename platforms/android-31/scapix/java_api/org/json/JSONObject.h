...
#ifndef SCAPIX_JAVA_API_ORG_JSON_JSONOBJECT
...
public:
	...
	static jni::ref<org::json::JSONObject> new_object() { return object_base::new_object(); }
	static jni::ref<org::json::JSONObject> new_object(jni::ref<java::util::Map> copyFrom) { return object_base::new_object(copyFrom); }
	static jni::ref<org::json::JSONObject> new_object(jni::ref<org::json::JSONTokener> readFrom) { return object_base::new_object(readFrom); }
	static jni::ref<org::json::JSONObject> new_object(jni::ref<java::lang::String> json) { return object_base::new_object(json); }
	static jni::ref<org::json::JSONObject> new_object(jni::ref<org::json::JSONObject> copyFrom, jni::ref<jni::array<java::lang::String>> names) { return object_base::new_object(copyFrom, names); }
