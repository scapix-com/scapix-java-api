...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_CHARARRAYBUFFER
...
public:
	...
	static jni::ref<android::database::CharArrayBuffer> new_object(jint size) { return object_base::new_object(size); }
	static jni::ref<android::database::CharArrayBuffer> new_object(jni::ref<jni::array<jchar>> buf) { return object_base::new_object(buf); }
};
