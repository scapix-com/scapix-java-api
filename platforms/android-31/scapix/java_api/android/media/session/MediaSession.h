...
public:
	...
	static jni::ref<android::media::session::MediaSession> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> tag, jni::ref<android::os::Bundle> sessionInfo) { return base_::new_object(context, tag, sessionInfo); }
