...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVINPUTINFO_BUILDER
...
public:
	...
	static jni::ref<android::media::tv::TvInputInfo_Builder> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::ComponentName> component) { return object_base::new_object(context, component); }
