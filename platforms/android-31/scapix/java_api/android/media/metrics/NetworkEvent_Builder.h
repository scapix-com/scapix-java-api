...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_METRICS_NETWORKEVENT_BUILDER
...
public:
	...
	static jni::ref<android::media::metrics::NetworkEvent_Builder> new_object() { return object_base::new_object(); }
