...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SUBTITLEDATA
...
public:
	...
	static jni::ref<android::media::SubtitleData> new_object(jint trackIndex, jlong startTimeUs, jlong durationUs, jni::ref<jni::array<jbyte>> data) { return object_base::new_object(trackIndex, startTimeUs, durationUs, data); }
