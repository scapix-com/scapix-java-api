...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIASCANNERCONNECTION
...
public:
	...
	static jni::ref<android::media::MediaScannerConnection> new_object(jni::ref<android::content::Context> context, jni::ref<android::media::MediaScannerConnection_MediaScannerConnectionClient> client) { return object_base::new_object(context, client); }
