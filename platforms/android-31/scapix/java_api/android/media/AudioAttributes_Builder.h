...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOATTRIBUTES_BUILDER
...
public:
	...
	static jni::ref<android::media::AudioAttributes_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::media::AudioAttributes_Builder> new_object(jni::ref<android::media::AudioAttributes> aa) { return object_base::new_object(aa); }
