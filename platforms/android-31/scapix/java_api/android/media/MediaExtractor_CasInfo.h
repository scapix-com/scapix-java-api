...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIAEXTRACTOR_CASINFO
...
public:
	...
	jni::ref<jni::array<jbyte>> getPrivateData() { return call_method<"getPrivateData", jni::ref<jni::array<jbyte>>>(); }
