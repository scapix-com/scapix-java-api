...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_VISUALIZER
...
public:
	...
	static jni::ref<android::media::audiofx::Visualizer> new_object(jint audioSession) { return object_base::new_object(audioSession); }
