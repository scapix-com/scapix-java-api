...
class AudioFocusRequest_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFOCUSREQUEST_BUILDER
...
public:
	...
	static jni::ref<android::media::AudioFocusRequest_Builder> new_object(jint focusGain) { return object_base::new_object(focusGain); }
	static jni::ref<android::media::AudioFocusRequest_Builder> new_object(jni::ref<android::media::AudioFocusRequest> requestToCopy) { return object_base::new_object(requestToCopy); }
