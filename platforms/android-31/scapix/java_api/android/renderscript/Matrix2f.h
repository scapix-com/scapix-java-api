...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_MATRIX2F
...
public:
	...
	static jni::ref<android::renderscript::Matrix2f> new_object() { return object_base::new_object(); }
	static jni::ref<android::renderscript::Matrix2f> new_object(jni::ref<jni::array<jfloat>> dataArray) { return object_base::new_object(dataArray); }
