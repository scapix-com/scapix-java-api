...
class Telephony_ServiceStateTable;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_TELEPHONY_SERVICESTATETABLE
...
public:
	...
	static jni::ref<java::lang::String> DATA_NETWORK_TYPE() { return get_static_field<"DATA_NETWORK_TYPE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DATA_REG_STATE() { return get_static_field<"DATA_REG_STATE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DUPLEX_MODE() { return get_static_field<"DUPLEX_MODE", jni::ref<java::lang::String>>(); }
