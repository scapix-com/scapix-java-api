...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_TIMEZONEFORMAT
...
public:
	...
	jni::ref<java::lang::String> format(jni::ref<android::icu::text::TimeZoneFormat_Style> style, jni::ref<android::icu::util::TimeZone> tz, jlong date, jni::ref<android::icu::util::Output> timeType) { return call_method<"format", jni::ref<java::lang::String>>(style, tz, date, timeType); }
