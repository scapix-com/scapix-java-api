...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_SELECTFORMAT
...
public:
	...
	static jni::ref<android::icu::text::SelectFormat> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
