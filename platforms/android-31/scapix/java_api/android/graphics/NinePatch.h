...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_NINEPATCH
...
public:
	...
	static jni::ref<android::graphics::NinePatch> new_object(jni::ref<android::graphics::Bitmap> bitmap, jni::ref<jni::array<jbyte>> chunk) { return object_base::new_object(bitmap, chunk); }
	static jni::ref<android::graphics::NinePatch> new_object(jni::ref<android::graphics::Bitmap> bitmap, jni::ref<jni::array<jbyte>> chunk, jni::ref<java::lang::String> srcName) { return object_base::new_object(bitmap, chunk, srcName); }
