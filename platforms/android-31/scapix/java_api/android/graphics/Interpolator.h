...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_INTERPOLATOR
...
public:
	...
	static jni::ref<android::graphics::Interpolator> new_object(jint valueCount) { return object_base::new_object(valueCount); }
	static jni::ref<android::graphics::Interpolator> new_object(jint valueCount, jint frameCount) { return object_base::new_object(valueCount, frameCount); }
