...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_SURFACETEXTURE
...
public:
	...
	static jni::ref<android::graphics::SurfaceTexture> new_object(jint texName) { return object_base::new_object(texName); }
	static jni::ref<android::graphics::SurfaceTexture> new_object(jint texName, jboolean singleBufferMode) { return object_base::new_object(texName, singleBufferMode); }
	static jni::ref<android::graphics::SurfaceTexture> new_object(jboolean singleBufferMode) { return object_base::new_object(singleBufferMode); }
