...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_MEDIA_MEDIABROWSERSERVICE
...
public:
	...
	static jni::ref<android::service::media::MediaBrowserService> new_object() { return object_base::new_object(); }
	...
	void onLoadChildren(jni::ref<java::lang::String> parentId, jni::ref<android::service::media::MediaBrowserService_Result> result, jni::ref<android::os::Bundle> options) { return call_method<"onLoadChildren", void>(parentId, result, options); }
	void onLoadItem(jni::ref<java::lang::String> itemId, jni::ref<android::service::media::MediaBrowserService_Result> result) { return call_method<"onLoadItem", void>(itemId, result); }
	...
	jni::ref<android::os::Bundle> getBrowserRootHints() { return call_method<"getBrowserRootHints", jni::ref<android::os::Bundle>>(); }
	jni::ref<android::media::session::MediaSessionManager_RemoteUserInfo> getCurrentBrowserInfo() { return call_method<"getCurrentBrowserInfo", jni::ref<android::media::session::MediaSessionManager_RemoteUserInfo>>(); }
	void notifyChildrenChanged(jni::ref<java::lang::String> parentId) { return call_method<"notifyChildrenChanged", void>(parentId); }
	void notifyChildrenChanged(jni::ref<java::lang::String> parentId, jni::ref<android::os::Bundle> options) { return call_method<"notifyChildrenChanged", void>(parentId, options); }
};
