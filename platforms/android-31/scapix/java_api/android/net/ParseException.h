...
public:
	...
	static jni::ref<android::net::ParseException> new_object(jni::ref<java::lang::String> response) { return base_::new_object(response); }
	static jni::ref<android::net::ParseException> new_object(jni::ref<java::lang::String> response, jni::ref<java::lang::Throwable> cause) { return base_::new_object(response, cause); }
