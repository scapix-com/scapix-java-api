...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_IKETRAFFICSELECTOR
...
public:
	...
	static jni::ref<android::net::ipsec::ike::IkeTrafficSelector> new_object(jint startPort, jint endPort, jni::ref<java::net::InetAddress> startingAddress, jni::ref<java::net::InetAddress> endingAddress) { return object_base::new_object(startPort, endPort, startingAddress, endingAddress); }
