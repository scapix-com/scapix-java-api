...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WPSINFO
...
public:
	...
	static jni::ref<android::net::wifi::WpsInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::WpsInfo> new_object(jni::ref<android::net::wifi::WpsInfo> source) { return object_base::new_object(source); }
