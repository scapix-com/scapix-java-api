...
#ifndef SCAPIX_JAVA_API_ANDROID_OPENGL_MATRIX
...
public:
	...
	static jni::ref<android::opengl::Matrix> new_object() { return object_base::new_object(); }
	static void multiplyMM(jni::ref<jni::array<jfloat>> p1, jint p2, jni::ref<jni::array<jfloat>> p3, jint p4, jni::ref<jni::array<jfloat>> p5, jint p6) { return call_static_method<"multiplyMM", void>(p1, p2, p3, p4, p5, p6); }
	static void multiplyMV(jni::ref<jni::array<jfloat>> p1, jint p2, jni::ref<jni::array<jfloat>> p3, jint p4, jni::ref<jni::array<jfloat>> p5, jint p6) { return call_static_method<"multiplyMV", void>(p1, p2, p3, p4, p5, p6); }
