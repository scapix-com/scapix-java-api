...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_BLOB_BLOBSTOREMANAGER_SESSION
...
public:
	...
	jni::ref<android::os::ParcelFileDescriptor> openWrite(jlong offsetBytes, jlong lengthBytes) { return call_method<"openWrite", jni::ref<android::os::ParcelFileDescriptor>>(offsetBytes, lengthBytes); }
