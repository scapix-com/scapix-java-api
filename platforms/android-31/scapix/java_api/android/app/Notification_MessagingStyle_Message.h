...
public:
	...
	static jni::ref<android::app::Notification_MessagingStyle_Message> new_object(jni::ref<java::lang::CharSequence> text, jlong timestamp, jni::ref<android::app::Person> p3) { return base_::new_object(text, timestamp, p3); }
