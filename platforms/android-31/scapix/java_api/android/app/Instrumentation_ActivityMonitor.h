...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_INSTRUMENTATION_ACTIVITYMONITOR
...
public:
	...
	static jni::ref<android::app::Instrumentation_ActivityMonitor> new_object(jni::ref<android::content::IntentFilter> which, jni::ref<android::app::Instrumentation_ActivityResult> result, jboolean block) { return object_base::new_object(which, result, block); }
	static jni::ref<android::app::Instrumentation_ActivityMonitor> new_object(jni::ref<java::lang::String> cls, jni::ref<android::app::Instrumentation_ActivityResult> result, jboolean block) { return object_base::new_object(cls, result, block); }
	static jni::ref<android::app::Instrumentation_ActivityMonitor> new_object() { return object_base::new_object(); }
