...
public:
	...
	static jni::ref<android::app::AutomaticZenRule> new_object(jni::ref<java::lang::String> name, jni::ref<android::content::ComponentName> owner, jni::ref<android::content::ComponentName> configurationActivity, jni::ref<android::net::Uri> conditionId, jni::ref<android::service::notification::ZenPolicy> policy, jint interruptionFilter, jboolean enabled) { return base_::new_object(name, owner, configurationActivity, conditionId, policy, interruptionFilter, enabled); }
