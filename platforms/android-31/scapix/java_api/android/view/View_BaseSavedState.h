...
public:
	...
	static jni::ref<android::view::View_BaseSavedState> new_object(jni::ref<android::os::Parcel> source, jni::ref<java::lang::ClassLoader> loader) { return base_::new_object(source, loader); }
