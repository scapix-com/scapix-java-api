...
class TextClassifierEvent_ConversationActionsEvent_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_TEXTCLASSIFIEREVENT_CONVERSATIONACTIONSEVENT_BUILDER
...
public:
	...
	static jni::ref<android::view::textclassifier::TextClassifierEvent_ConversationActionsEvent_Builder> new_object(jint eventType) { return object_base::new_object(eventType); }
