...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_EXTRACTEDTEXT
...
public:
	...
	jni::ref<java::lang::CharSequence> hint() { return get_field<"hint", jni::ref<java::lang::CharSequence>>(); }
	void hint(jni::ref<java::lang::CharSequence> v) { set_field<"hint", jni::ref<java::lang::CharSequence>>(v); }
	...
	static jni::ref<android::view::inputmethod::ExtractedText> new_object() { return object_base::new_object(); }
