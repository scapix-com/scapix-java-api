...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_SIMPLECURSORTREEADAPTER
...
public:
	...
	static jni::ref<android::widget::SimpleCursorTreeAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<android::database::Cursor> cursor, jint collapsedGroupLayout, jint expandedGroupLayout, jni::ref<jni::array<java::lang::String>> groupFrom, jni::ref<jni::array<jint>> groupTo, jint childLayout, jint lastChildLayout, jni::ref<jni::array<java::lang::String>> childFrom, jni::ref<jni::array<jint>> childTo) { return object_base::new_object(context, cursor, collapsedGroupLayout, expandedGroupLayout, groupFrom, groupTo, childLayout, lastChildLayout, childFrom, childTo); }
	static jni::ref<android::widget::SimpleCursorTreeAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<android::database::Cursor> cursor, jint collapsedGroupLayout, jint expandedGroupLayout, jni::ref<jni::array<java::lang::String>> groupFrom, jni::ref<jni::array<jint>> groupTo, jint childLayout, jni::ref<jni::array<java::lang::String>> childFrom, jni::ref<jni::array<jint>> childTo) { return object_base::new_object(context, cursor, collapsedGroupLayout, expandedGroupLayout, groupFrom, groupTo, childLayout, childFrom, childTo); }
	static jni::ref<android::widget::SimpleCursorTreeAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<android::database::Cursor> cursor, jint groupLayout, jni::ref<jni::array<java::lang::String>> groupFrom, jni::ref<jni::array<jint>> groupTo, jint childLayout, jni::ref<jni::array<java::lang::String>> childFrom, jni::ref<jni::array<jint>> childTo) { return object_base::new_object(context, cursor, groupLayout, groupFrom, groupTo, childLayout, childFrom, childTo); }
