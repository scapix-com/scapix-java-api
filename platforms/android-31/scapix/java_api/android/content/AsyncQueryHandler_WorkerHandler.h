...
namespace scapix::java_api { namespace android::content { class AsyncQueryHandler_WorkerHandler; }}
...
public:
	...
	static jni::ref<android::content::AsyncQueryHandler_WorkerHandler> new_object(jni::ref<android::content::AsyncQueryHandler> this_0, jni::ref<android::os::Looper> looper) { return object_base::new_object(this_0, looper); }
