...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTPROVIDER
...
public:
	...
	static jni::ref<android::content::ContentProvider> new_object() { return object_base::new_object(); }
	jni::ref<android::content::Context> getContext() { return call_method<"getContext", jni::ref<android::content::Context>>(); }
	jni::ref<android::content::Context> requireContext() { return call_method<"requireContext", jni::ref<android::content::Context>>(); }
	...
	jni::ref<java::lang::String> getCallingAttributionTag() { return call_method<"getCallingAttributionTag", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getCallingPackageUnchecked() { return call_method<"getCallingPackageUnchecked", jni::ref<java::lang::String>>(); }
	void onCallingPackageChanged() { return call_method<"onCallingPackageChanged", void>(); }
	...
	jboolean refresh(jni::ref<android::net::Uri> uri, jni::ref<android::os::Bundle> extras, jni::ref<android::os::CancellationSignal> cancellationSignal) { return call_method<"refresh", jboolean>(uri, extras, cancellationSignal); }
	...
	jni::ref<android::net::Uri> insert(jni::ref<android::net::Uri> uri, jni::ref<android::content::ContentValues> values, jni::ref<android::os::Bundle> extras) { return call_method<"insert", jni::ref<android::net::Uri>>(uri, values, extras); }
	...
	jint delete_(jni::ref<android::net::Uri> uri, jni::ref<android::os::Bundle> extras) { return call_method<"delete", jint>(uri, extras); }
