...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_COLORSTATELIST
...
public:
	...
	static jni::ref<android::content::res::ColorStateList> new_object(jni::ref<jni::array<jni::array<jint>>> states, jni::ref<jni::array<jint>> colors) { return object_base::new_object(states, colors); }
	...
	jni::ref<android::content::res::ColorStateList> withLStar(jfloat lStar) { return call_method<"withLStar", jni::ref<android::content::res::ColorStateList>>(lStar); }
