...
public:
	...
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::io::File> file) { return base_::new_object(file); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::util::List> files) { return base_::new_object(files); }
	...
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::io::File> file, jint mask) { return base_::new_object(file, mask); }
	static jni::ref<android::os::FileObserver> new_object(jni::ref<java::util::List> files, jint mask) { return base_::new_object(files, mask); }
