...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_SENSOREVENTCALLBACK
...
public:
	...
	static jni::ref<android::hardware::SensorEventCallback> new_object() { return object_base::new_object(); }
