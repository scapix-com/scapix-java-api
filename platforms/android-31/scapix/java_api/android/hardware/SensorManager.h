...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_SENSORMANAGER
...
public:
	...
	jni::ref<android::hardware::SensorDirectChannel> createDirectChannel(jni::ref<android::os::MemoryFile> mem) { return call_method<"createDirectChannel", jni::ref<android::hardware::SensorDirectChannel>>(mem); }
	jni::ref<android::hardware::SensorDirectChannel> createDirectChannel(jni::ref<android::hardware::HardwareBuffer> mem) { return call_method<"createDirectChannel", jni::ref<android::hardware::SensorDirectChannel>>(mem); }
