...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_RELATIVESIZESPAN
...
public:
	...
	static jni::ref<android::text::style::RelativeSizeSpan> new_object(jfloat proportion) { return object_base::new_object(proportion); }
	static jni::ref<android::text::style::RelativeSizeSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
