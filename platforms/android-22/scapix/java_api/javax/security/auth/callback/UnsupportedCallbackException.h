...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_CALLBACK_UNSUPPORTEDCALLBACKEXCEPTION
...
public:
	...
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> callback) { return object_base::new_object(callback); }
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> callback, jni::ref<java::lang::String> message) { return object_base::new_object(callback, message); }
