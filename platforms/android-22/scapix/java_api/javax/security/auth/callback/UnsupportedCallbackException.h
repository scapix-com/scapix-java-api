...
public:
	...
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> callback) { return base_::new_object(callback); }
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> callback, jni::ref<java::lang::String> message) { return base_::new_object(callback, message); }
