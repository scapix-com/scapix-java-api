...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_CIPHEROUTPUTSTREAM
...
public:
	...
	static jni::ref<javax::crypto::CipherOutputStream> new_object(jni::ref<java::io::OutputStream> os, jni::ref<javax::crypto::Cipher> c) { return object_base::new_object(os, c); }
