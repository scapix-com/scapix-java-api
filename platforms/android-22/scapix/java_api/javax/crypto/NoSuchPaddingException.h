...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_NOSUCHPADDINGEXCEPTION
...
public:
	...
	static jni::ref<javax::crypto::NoSuchPaddingException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<javax::crypto::NoSuchPaddingException> new_object() { return object_base::new_object(); }
};
