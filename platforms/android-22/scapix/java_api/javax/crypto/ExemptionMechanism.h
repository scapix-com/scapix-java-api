...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_EXEMPTIONMECHANISM
...
public:
	...
	void init(jni::ref<java::security::Key> key, jni::ref<java::security::AlgorithmParameters> param) { return call_method<"init", void>(key, param); }
	void init(jni::ref<java::security::Key> key, jni::ref<java::security::spec::AlgorithmParameterSpec> param) { return call_method<"init", void>(key, param); }
