...
public:
	...
	static jni::ref<dalvik::system::DexClassLoader> new_object(jni::ref<java::lang::String> dexPath, jni::ref<java::lang::String> optimizedDirectory, jni::ref<java::lang::String> libraryPath, jni::ref<java::lang::ClassLoader> parent) { return object_base::new_object(dexPath, optimizedDirectory, libraryPath, parent); }
};
