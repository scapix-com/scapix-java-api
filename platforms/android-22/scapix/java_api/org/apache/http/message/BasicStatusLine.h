...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICSTATUSLINE
...
public:
	...
	static jni::ref<org::apache::http::message::BasicStatusLine> new_object(jni::ref<org::apache::http::ProtocolVersion> version, jint statusCode, jni::ref<java::lang::String> reasonPhrase) { return object_base::new_object(version, statusCode, reasonPhrase); }
