...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICHTTPREQUEST
...
public:
	...
	static jni::ref<org::apache::http::message::BasicHttpRequest> new_object(jni::ref<java::lang::String> method, jni::ref<java::lang::String> uri) { return object_base::new_object(method, uri); }
	static jni::ref<org::apache::http::message::BasicHttpRequest> new_object(jni::ref<java::lang::String> method, jni::ref<java::lang::String> uri, jni::ref<org::apache::http::ProtocolVersion> ver) { return object_base::new_object(method, uri, ver); }
	static jni::ref<org::apache::http::message::BasicHttpRequest> new_object(jni::ref<org::apache::http::RequestLine> requestline) { return object_base::new_object(requestline); }
