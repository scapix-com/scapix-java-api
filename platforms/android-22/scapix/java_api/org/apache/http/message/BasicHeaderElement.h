...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICHEADERELEMENT
...
public:
	...
	static jni::ref<org::apache::http::message::BasicHeaderElement> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> value, jni::ref<jni::array<org::apache::http::NameValuePair>> parameters) { return object_base::new_object(name, value, parameters); }
	static jni::ref<org::apache::http::message::BasicHeaderElement> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> value) { return object_base::new_object(name, value); }
