...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICLINEPARSER
...
public:
	...
	static jni::ref<org::apache::http::message::BasicLineParser> new_object(jni::ref<org::apache::http::ProtocolVersion> proto) { return object_base::new_object(proto); }
	static jni::ref<org::apache::http::message::BasicLineParser> new_object() { return object_base::new_object(); }
