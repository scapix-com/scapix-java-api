...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICLISTHEADERITERATOR
...
public:
	...
	static jni::ref<org::apache::http::message::BasicListHeaderIterator> new_object(jni::ref<java::util::List> headers, jni::ref<java::lang::String> name) { return object_base::new_object(headers, name); }
