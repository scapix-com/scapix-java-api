...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICHEADER
...
public:
	...
	static jni::ref<org::apache::http::message::BasicHeader> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> value) { return object_base::new_object(name, value); }
