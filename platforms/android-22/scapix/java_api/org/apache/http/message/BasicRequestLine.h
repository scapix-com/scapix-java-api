...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_MESSAGE_BASICREQUESTLINE
...
public:
	...
	static jni::ref<org::apache::http::message::BasicRequestLine> new_object(jni::ref<java::lang::String> method, jni::ref<java::lang::String> uri, jni::ref<org::apache::http::ProtocolVersion> version) { return object_base::new_object(method, uri, version); }
