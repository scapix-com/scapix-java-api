...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_HTTPVERSION
...
public:
	...
	static jni::ref<org::apache::http::HttpVersion> new_object(jint major, jint minor) { return object_base::new_object(major, minor); }
