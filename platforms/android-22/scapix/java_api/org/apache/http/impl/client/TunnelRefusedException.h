...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CLIENT_TUNNELREFUSEDEXCEPTION
...
public:
	...
	static jni::ref<org::apache::http::impl::client::TunnelRefusedException> new_object(jni::ref<java::lang::String> message, jni::ref<org::apache::http::HttpResponse> response) { return object_base::new_object(message, response); }
