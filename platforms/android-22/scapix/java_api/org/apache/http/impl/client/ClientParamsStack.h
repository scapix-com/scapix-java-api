...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CLIENT_CLIENTPARAMSSTACK
...
public:
	...
	static jni::ref<org::apache::http::impl::client::ClientParamsStack> new_object(jni::ref<org::apache::http::params::HttpParams> aparams, jni::ref<org::apache::http::params::HttpParams> cparams, jni::ref<org::apache::http::params::HttpParams> rparams, jni::ref<org::apache::http::params::HttpParams> oparams) { return object_base::new_object(aparams, cparams, rparams, oparams); }
	static jni::ref<org::apache::http::impl::client::ClientParamsStack> new_object(jni::ref<org::apache::http::impl::client::ClientParamsStack> stack) { return object_base::new_object(stack); }
	static jni::ref<org::apache::http::impl::client::ClientParamsStack> new_object(jni::ref<org::apache::http::impl::client::ClientParamsStack> stack, jni::ref<org::apache::http::params::HttpParams> aparams, jni::ref<org::apache::http::params::HttpParams> cparams, jni::ref<org::apache::http::params::HttpParams> rparams, jni::ref<org::apache::http::params::HttpParams> oparams) { return object_base::new_object(stack, aparams, cparams, rparams, oparams); }
