...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CLIENT_REQUESTWRAPPER
...
public:
	...
	static jni::ref<org::apache::http::impl::client::RequestWrapper> new_object(jni::ref<org::apache::http::HttpRequest> request) { return object_base::new_object(request); }
