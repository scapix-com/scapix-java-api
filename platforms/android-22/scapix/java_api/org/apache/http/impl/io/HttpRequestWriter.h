...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_IO_HTTPREQUESTWRITER
...
public:
	...
	static jni::ref<org::apache::http::impl::io::HttpRequestWriter> new_object(jni::ref<org::apache::http::io::SessionOutputBuffer> buffer, jni::ref<org::apache::http::message::LineFormatter> formatter, jni::ref<org::apache::http::params::HttpParams> params) { return object_base::new_object(buffer, formatter, params); }
};
