...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_COOKIE_RFC2965VERSIONATTRIBUTEHANDLER
...
public:
	...
	static jni::ref<org::apache::http::impl::cookie::RFC2965VersionAttributeHandler> new_object() { return object_base::new_object(); }
