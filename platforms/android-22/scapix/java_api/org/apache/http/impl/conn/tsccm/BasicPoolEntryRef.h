...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_TSCCM_BASICPOOLENTRYREF
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::tsccm::BasicPoolEntryRef> new_object(jni::ref<org::apache::http::impl::conn::tsccm::BasicPoolEntry> entry, jni::ref<java::lang::ref::ReferenceQueue> queue) { return object_base::new_object(entry, queue); }
