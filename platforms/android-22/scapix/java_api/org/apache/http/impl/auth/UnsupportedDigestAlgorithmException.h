...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_AUTH_UNSUPPORTEDDIGESTALGORITHMEXCEPTION
...
public:
	...
	static jni::ref<org::apache::http::impl::auth::UnsupportedDigestAlgorithmException> new_object() { return object_base::new_object(); }
	static jni::ref<org::apache::http::impl::auth::UnsupportedDigestAlgorithmException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<org::apache::http::impl::auth::UnsupportedDigestAlgorithmException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
};
