...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_IO_ABSTRACTSESSIONINPUTBUFFER
...
public:
	...
	static jni::ref<org::apache::http::impl::io::AbstractSessionInputBuffer> new_object() { return object_base::new_object(); }
