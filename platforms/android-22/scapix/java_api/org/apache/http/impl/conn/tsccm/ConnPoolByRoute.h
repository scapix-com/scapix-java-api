...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_TSCCM_CONNPOOLBYROUTE
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::tsccm::ConnPoolByRoute> new_object(jni::ref<org::apache::http::conn::ClientConnectionOperator> operator_, jni::ref<org::apache::http::params::HttpParams> params) { return object_base::new_object(operator_, params); }
	...
	void freeEntry(jni::ref<org::apache::http::impl::conn::tsccm::BasicPoolEntry> entry, jboolean reusable, jlong validDuration, jni::ref<java::util::concurrent::TimeUnit> timeUnit) { return call_method<"freeEntry", void>(entry, reusable, validDuration, timeUnit); }
