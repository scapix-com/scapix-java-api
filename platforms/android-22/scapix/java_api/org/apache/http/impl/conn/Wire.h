...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_WIRE
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::Wire> new_object(jni::ref<org::apache::commons::logging::Log> log) { return object_base::new_object(log); }
