...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_COOKIE_NETSCAPEDRAFTSPECFACTORY
...
public:
	...
	static jni::ref<org::apache::http::impl::cookie::NetscapeDraftSpecFactory> new_object() { return object_base::new_object(); }
