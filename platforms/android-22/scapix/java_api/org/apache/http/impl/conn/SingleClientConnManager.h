...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_CONN_SINGLECLIENTCONNMANAGER
...
public:
	...
	static jni::ref<org::apache::http::impl::conn::SingleClientConnManager> new_object(jni::ref<org::apache::http::params::HttpParams> params, jni::ref<org::apache::http::conn::scheme::SchemeRegistry> schreg) { return object_base::new_object(params, schreg); }
	...
	void closeIdleConnections(jlong idletime, jni::ref<java::util::concurrent::TimeUnit> tunit) { return call_method<"closeIdleConnections", void>(idletime, tunit); }
