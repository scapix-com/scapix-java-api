...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_IO_CHUNKEDOUTPUTSTREAM
...
public:
	...
	static jni::ref<org::apache::http::impl::io::ChunkedOutputStream> new_object(jni::ref<org::apache::http::io::SessionOutputBuffer> out, jint bufferSize) { return object_base::new_object(out, bufferSize); }
	static jni::ref<org::apache::http::impl::io::ChunkedOutputStream> new_object(jni::ref<org::apache::http::io::SessionOutputBuffer> out) { return object_base::new_object(out); }
