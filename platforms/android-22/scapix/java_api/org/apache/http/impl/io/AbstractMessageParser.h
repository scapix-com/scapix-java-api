...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_IMPL_IO_ABSTRACTMESSAGEPARSER
...
public:
	...
	static jni::ref<org::apache::http::impl::io::AbstractMessageParser> new_object(jni::ref<org::apache::http::io::SessionInputBuffer> buffer, jni::ref<org::apache::http::message::LineParser> parser, jni::ref<org::apache::http::params::HttpParams> params) { return object_base::new_object(buffer, parser, params); }
