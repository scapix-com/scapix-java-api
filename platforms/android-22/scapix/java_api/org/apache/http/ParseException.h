...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_PARSEEXCEPTION
...
public:
	...
	static jni::ref<org::apache::http::ParseException> new_object() { return object_base::new_object(); }
	static jni::ref<org::apache::http::ParseException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
