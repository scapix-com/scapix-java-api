...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_ENTITY_HTTPENTITYWRAPPER
...
public:
	...
	static jni::ref<org::apache::http::entity::HttpEntityWrapper> new_object(jni::ref<org::apache::http::HttpEntity> wrapped) { return object_base::new_object(wrapped); }
