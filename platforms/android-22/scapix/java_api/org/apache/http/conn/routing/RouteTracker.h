...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_ROUTING_ROUTETRACKER
...
public:
	...
	static jni::ref<org::apache::http::conn::routing::RouteTracker> new_object(jni::ref<org::apache::http::HttpHost> target, jni::ref<java::net::InetAddress> local) { return object_base::new_object(target, local); }
	static jni::ref<org::apache::http::conn::routing::RouteTracker> new_object(jni::ref<org::apache::http::conn::routing::HttpRoute> route) { return object_base::new_object(route); }
