...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_BASICMANAGEDENTITY
...
public:
	...
	static jni::ref<org::apache::http::conn::BasicManagedEntity> new_object(jni::ref<org::apache::http::HttpEntity> entity, jni::ref<org::apache::http::conn::ManagedClientConnection> conn, jboolean reuse) { return object_base::new_object(entity, conn, reuse); }
