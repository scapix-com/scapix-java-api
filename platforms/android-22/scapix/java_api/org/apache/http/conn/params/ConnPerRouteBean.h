...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_PARAMS_CONNPERROUTEBEAN
...
public:
	...
	static jni::ref<org::apache::http::conn::params::ConnPerRouteBean> new_object(jint defaultMax) { return object_base::new_object(defaultMax); }
	static jni::ref<org::apache::http::conn::params::ConnPerRouteBean> new_object() { return object_base::new_object(); }
