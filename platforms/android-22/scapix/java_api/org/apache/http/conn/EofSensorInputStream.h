...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CONN_EOFSENSORINPUTSTREAM
...
public:
	...
	static jni::ref<org::apache::http::conn::EofSensorInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<org::apache::http::conn::EofSensorWatcher> watcher) { return object_base::new_object(in, watcher); }
