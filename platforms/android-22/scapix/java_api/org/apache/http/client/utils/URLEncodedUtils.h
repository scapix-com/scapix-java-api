...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CLIENT_UTILS_URLENCODEDUTILS
...
public:
	...
	static jni::ref<org::apache::http::client::utils::URLEncodedUtils> new_object() { return object_base::new_object(); }
