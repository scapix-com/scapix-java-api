...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_CLIENT_PROTOCOL_CLIENTCONTEXTCONFIGURER
...
public:
	...
	static jni::ref<org::apache::http::client::protocol::ClientContextConfigurer> new_object(jni::ref<org::apache::http::protocol::HttpContext> context) { return object_base::new_object(context); }
