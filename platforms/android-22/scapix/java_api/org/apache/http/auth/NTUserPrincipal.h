...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_AUTH_NTUSERPRINCIPAL
...
public:
	...
	static jni::ref<org::apache::http::auth::NTUserPrincipal> new_object(jni::ref<java::lang::String> domain, jni::ref<java::lang::String> username) { return object_base::new_object(domain, username); }
