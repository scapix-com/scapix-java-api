...
#ifndef SCAPIX_JAVA_API_ORG_APACHE_HTTP_AUTH_AUTHSCOPE
...
public:
	...
	static jni::ref<org::apache::http::auth::AuthScope> new_object(jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm, jni::ref<java::lang::String> scheme) { return object_base::new_object(host, port, realm, scheme); }
	static jni::ref<org::apache::http::auth::AuthScope> new_object(jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm) { return object_base::new_object(host, port, realm); }
	static jni::ref<org::apache::http::auth::AuthScope> new_object(jni::ref<java::lang::String> host, jint port) { return object_base::new_object(host, port); }
	static jni::ref<org::apache::http::auth::AuthScope> new_object(jni::ref<org::apache::http::auth::AuthScope> authscope) { return object_base::new_object(authscope); }
