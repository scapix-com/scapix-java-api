...
public:
	...
	static jni::ref<java::io::FileInputStream> new_object(jni::ref<java::io::FileDescriptor> fd) { return object_base::new_object(fd); }
	static jni::ref<java::io::FileInputStream> new_object(jni::ref<java::lang::String> path) { return object_base::new_object(path); }
