...
public:
	...
	static jni::ref<java::io::RandomAccessFile> new_object(jni::ref<java::lang::String> fileName, jni::ref<java::lang::String> mode) { return object_base::new_object(fileName, mode); }
