...
public:
	...
	static jni::ref<java::io::StreamTokenizer> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
	static jni::ref<java::io::StreamTokenizer> new_object(jni::ref<java::io::Reader> r) { return object_base::new_object(r); }
	...
	void lowerCaseMode(jboolean flag) { return call_method<"lowerCaseMode", void>(flag); }
