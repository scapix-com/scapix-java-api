...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OUTPUTSTREAMWRITER
...
public:
	...
	static jni::ref<java::io::OutputStreamWriter> new_object(jni::ref<java::io::OutputStream> out) { return object_base::new_object(out); }
	static jni::ref<java::io::OutputStreamWriter> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::lang::String> charsetName) { return object_base::new_object(out, charsetName); }
	static jni::ref<java::io::OutputStreamWriter> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::nio::charset::Charset> cs) { return object_base::new_object(out, cs); }
	static jni::ref<java::io::OutputStreamWriter> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::nio::charset::CharsetEncoder> charsetEncoder) { return object_base::new_object(out, charsetEncoder); }
