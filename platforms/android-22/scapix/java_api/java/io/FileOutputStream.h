...
public:
	...
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::io::FileDescriptor> fd) { return object_base::new_object(fd); }
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::lang::String> path) { return object_base::new_object(path); }
	static jni::ref<java::io::FileOutputStream> new_object(jni::ref<java::lang::String> path, jboolean append) { return object_base::new_object(path, append); }
