...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OBJECTOUTPUTSTREAM
...
public:
	...
	static jni::ref<java::io::ObjectOutputStream> new_object(jni::ref<java::io::OutputStream> output) { return object_base::new_object(output); }
