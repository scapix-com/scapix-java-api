...
public:
	...
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::OutputStream> out, jboolean autoFlush, jni::ref<java::lang::String> charsetName) { return object_base::new_object(out, autoFlush, charsetName); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::io::File> file, jni::ref<java::lang::String> charsetName) { return object_base::new_object(file, charsetName); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::lang::String> fileName) { return object_base::new_object(fileName); }
	static jni::ref<java::io::PrintStream> new_object(jni::ref<java::lang::String> fileName, jni::ref<java::lang::String> charsetName) { return object_base::new_object(fileName, charsetName); }
