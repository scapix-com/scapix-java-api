...
public:
	...
	static jni::ref<java::beans::PropertyChangeEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<java::lang::String> propertyName, jni::ref<java::lang::Object> oldValue, jni::ref<java::lang::Object> newValue) { return object_base::new_object(source, propertyName, oldValue, newValue); }
