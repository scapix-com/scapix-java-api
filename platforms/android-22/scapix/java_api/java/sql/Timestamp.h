...
public:
	...
	static jni::ref<java::sql::Timestamp> new_object(jint theYear, jint theMonth, jint theDate, jint theHour, jint theMinute, jint theSecond, jint theNano) { return object_base::new_object(theYear, theMonth, theDate, theHour, theMinute, theSecond, theNano); }
	static jni::ref<java::sql::Timestamp> new_object(jlong theTime) { return object_base::new_object(theTime); }
