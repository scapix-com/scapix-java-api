...
public:
	...
	static jni::ref<java::lang::String> decode(jni::ref<java::lang::String> s, jni::ref<java::lang::String> charsetName) { return call_static_method<"decode", jni::ref<java::lang::String>>(s, charsetName); }
};
