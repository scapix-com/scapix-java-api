...
public:
	...
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::net::InetAddress> address, jint port) { return object_base::new_object(address, port); }
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::lang::String> host, jint port) { return object_base::new_object(host, port); }
