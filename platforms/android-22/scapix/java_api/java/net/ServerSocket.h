...
#ifndef SCAPIX_JAVA_API_JAVA_NET_SERVERSOCKET
...
public:
	...
	static jni::ref<java::net::ServerSocket> new_object(jint port, jint backlog, jni::ref<java::net::InetAddress> localAddress) { return object_base::new_object(port, backlog, localAddress); }
	...
	static void setSocketFactory(jni::ref<java::net::SocketImplFactory> aFactory) { return call_static_method<"setSocketFactory", void>(aFactory); }
	...
	void bind(jni::ref<java::net::SocketAddress> localAddr, jint backlog) { return call_method<"bind", void>(localAddr, backlog); }
