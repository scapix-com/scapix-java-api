...
#ifndef SCAPIX_JAVA_API_JAVA_NET_DATAGRAMSOCKET
...
public:
	...
	static jni::ref<java::net::DatagramSocket> new_object(jint aPort) { return object_base::new_object(aPort); }
	static jni::ref<java::net::DatagramSocket> new_object(jint aPort, jni::ref<java::net::InetAddress> addr) { return object_base::new_object(aPort, addr); }
	static jni::ref<java::net::DatagramSocket> new_object(jni::ref<java::net::SocketAddress> localAddr) { return object_base::new_object(localAddr); }
	...
	void receive(jni::ref<java::net::DatagramPacket> pack) { return call_method<"receive", void>(pack); }
	void send(jni::ref<java::net::DatagramPacket> pack) { return call_method<"send", void>(pack); }
	...
	void connect(jni::ref<java::net::SocketAddress> peer) { return call_method<"connect", void>(peer); }
	...
	void setBroadcast(jboolean broadcast) { return call_method<"setBroadcast", void>(broadcast); }
