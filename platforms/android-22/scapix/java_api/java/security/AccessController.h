...
public:
	...
	static jni::ref<java::lang::Object> doPrivileged(jni::ref<java::security::PrivilegedAction> action) { return call_static_method<"doPrivileged", jni::ref<java::lang::Object>>(action); }
	static jni::ref<java::lang::Object> doPrivileged(jni::ref<java::security::PrivilegedAction> action, jni::ref<java::security::AccessControlContext> context) { return call_static_method<"doPrivileged", jni::ref<java::lang::Object>>(action, context); }
	static jni::ref<java::lang::Object> doPrivileged(jni::ref<java::security::PrivilegedExceptionAction> action) { return call_static_method<"doPrivileged", jni::ref<java::lang::Object>>(action); }
	static jni::ref<java::lang::Object> doPrivileged(jni::ref<java::security::PrivilegedExceptionAction> action, jni::ref<java::security::AccessControlContext> context) { return call_static_method<"doPrivileged", jni::ref<java::lang::Object>>(action, context); }
	...
	static void checkPermission(jni::ref<java::security::Permission> permission) { return call_static_method<"checkPermission", void>(permission); }
