...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_ECPARAMETERSPEC
...
public:
	...
	static jni::ref<java::security::spec::ECParameterSpec> new_object(jni::ref<java::security::spec::EllipticCurve> curve, jni::ref<java::security::spec::ECPoint> generator, jni::ref<java::math::BigInteger> order, jint cofactor) { return object_base::new_object(curve, generator, order, cofactor); }
