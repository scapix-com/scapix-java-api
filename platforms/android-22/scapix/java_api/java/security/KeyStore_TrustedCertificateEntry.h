...
public:
	...
	static jni::ref<java::security::KeyStore_TrustedCertificateEntry> new_object(jni::ref<java::security::cert::Certificate> trustCertificate) { return object_base::new_object(trustCertificate); }
