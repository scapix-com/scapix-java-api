...
public:
	...
	static jni::ref<java::security::NoSuchAlgorithmException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<java::security::NoSuchAlgorithmException> new_object() { return object_base::new_object(); }
	static jni::ref<java::security::NoSuchAlgorithmException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
	static jni::ref<java::security::NoSuchAlgorithmException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
};
