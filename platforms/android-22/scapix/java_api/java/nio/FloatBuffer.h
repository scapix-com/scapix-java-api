...
public:
	...
	static jni::ref<java::nio::FloatBuffer> wrap(jni::ref<jni::array<jfloat>> array, jint start, jint floatCount) { return call_static_method<"wrap", jni::ref<java::nio::FloatBuffer>>(array, start, floatCount); }
	...
	jint compareTo(jni::ref<java::nio::FloatBuffer> otherBuffer) { return call_method<"compareTo", jint>(otherBuffer); }
	...
	jni::ref<java::nio::FloatBuffer> get(jni::ref<jni::array<jfloat>> dst, jint dstOffset, jint floatCount) { return call_method<"get", jni::ref<java::nio::FloatBuffer>>(dst, dstOffset, floatCount); }
	...
	jni::ref<java::nio::FloatBuffer> put(jni::ref<jni::array<jfloat>> src, jint srcOffset, jint floatCount) { return call_method<"put", jni::ref<java::nio::FloatBuffer>>(src, srcOffset, floatCount); }
