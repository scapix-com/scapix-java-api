...
public:
	...
	static jni::ref<java::util::IdentityHashMap> new_object(jint maxSize) { return base_::new_object(maxSize); }
	static jni::ref<java::util::IdentityHashMap> new_object(jni::ref<java::util::Map> map) { return base_::new_object(map); }
