...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_JAR_JAROUTPUTSTREAM
...
public:
	...
	static jni::ref<java::util::jar::JarOutputStream> new_object(jni::ref<java::io::OutputStream> os, jni::ref<java::util::jar::Manifest> manifest) { return object_base::new_object(os, manifest); }
	static jni::ref<java::util::jar::JarOutputStream> new_object(jni::ref<java::io::OutputStream> os) { return object_base::new_object(os); }
