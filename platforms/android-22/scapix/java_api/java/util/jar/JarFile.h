...
public:
	...
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> filename) { return base_::new_object(filename); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> filename, jboolean verify) { return base_::new_object(filename, verify); }
