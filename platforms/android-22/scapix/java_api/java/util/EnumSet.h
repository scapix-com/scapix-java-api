...
public:
	...
	static jni::ref<java::util::EnumSet> of(jni::ref<java::lang::Enum> start, jni::ref<jni::array<java::lang::Enum>> others) { return call_static_method<"of", jni::ref<java::util::EnumSet>>(start, others); }
	static jni::ref<java::util::EnumSet> range(jni::ref<java::lang::Enum> start, jni::ref<java::lang::Enum> end) { return call_static_method<"range", jni::ref<java::util::EnumSet>>(start, end); }
