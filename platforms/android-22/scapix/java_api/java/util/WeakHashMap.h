...
public:
	...
	static jni::ref<java::util::WeakHashMap> new_object(jint capacity) { return base_::new_object(capacity); }
	static jni::ref<java::util::WeakHashMap> new_object(jint capacity, jfloat loadFactor) { return base_::new_object(capacity, loadFactor); }
	static jni::ref<java::util::WeakHashMap> new_object(jni::ref<java::util::Map> map) { return base_::new_object(map); }
