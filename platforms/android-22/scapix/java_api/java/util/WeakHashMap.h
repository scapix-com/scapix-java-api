...
public:
	...
	static jni::ref<java::util::WeakHashMap> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::WeakHashMap> new_object(jint capacity, jfloat loadFactor) { return object_base::new_object(capacity, loadFactor); }
	static jni::ref<java::util::WeakHashMap> new_object(jni::ref<java::util::Map> map) { return object_base::new_object(map); }
