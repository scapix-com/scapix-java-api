...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ILLEGALFORMATFLAGSEXCEPTION
...
public:
	...
	static jni::ref<java::util::IllegalFormatFlagsException> new_object(jni::ref<java::lang::String> flags) { return object_base::new_object(flags); }
