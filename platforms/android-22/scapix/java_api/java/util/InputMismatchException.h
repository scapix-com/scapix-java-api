...
struct scapix::jni::object_traits<scapix::java_api::java::util::InputMismatchException>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::NoSuchElementException, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_INPUTMISMATCHEXCEPTION
...
public:
	...
	static jni::ref<java::util::InputMismatchException> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::InputMismatchException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
