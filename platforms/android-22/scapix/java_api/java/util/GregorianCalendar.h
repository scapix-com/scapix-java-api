...
public:
	...
	static jni::ref<java::util::GregorianCalendar> new_object(jint year, jint month, jint day) { return object_base::new_object(year, month, day); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint year, jint month, jint day, jint hour, jint minute) { return object_base::new_object(year, month, day, hour, minute); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint year, jint month, jint day, jint hour, jint minute, jint second) { return object_base::new_object(year, month, day, hour, minute, second); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::TimeZone> timezone) { return object_base::new_object(timezone); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::TimeZone> timezone, jni::ref<java::util::Locale> locale) { return object_base::new_object(timezone, locale); }
