...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LINKEDBLOCKINGDEQUE
...
public:
	...
	static jni::ref<java::util::concurrent::LinkedBlockingDeque> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::LinkedBlockingDeque> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::concurrent::LinkedBlockingDeque> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
	...
	jboolean offerFirst(jni::ref<java::lang::Object> e, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"offerFirst", jboolean>(e, timeout, unit); }
	jboolean offerLast(jni::ref<java::lang::Object> e, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"offerLast", jboolean>(e, timeout, unit); }
	...
	jni::ref<java::lang::Object> pollFirst(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"pollFirst", jni::ref<java::lang::Object>>(timeout, unit); }
	jni::ref<java::lang::Object> pollLast(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"pollLast", jni::ref<java::lang::Object>>(timeout, unit); }
