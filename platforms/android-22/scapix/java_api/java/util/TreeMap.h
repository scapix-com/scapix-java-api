...
struct scapix::jni::object_traits<scapix::java_api::java::util::TreeMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractMap, scapix::java_api::java::util::SortedMap, scapix::java_api::java::util::NavigableMap, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::io::Serializable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_TREEMAP
...
public:
	...
	static jni::ref<java::util::TreeMap> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Map> copyFrom) { return object_base::new_object(copyFrom); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Comparator> comparator) { return object_base::new_object(comparator); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::SortedMap> copyFrom) { return object_base::new_object(copyFrom); }
	...
	jni::ref<java::util::NavigableMap> subMap(jni::ref<java::lang::Object> from, jboolean fromInclusive, jni::ref<java::lang::Object> to, jboolean toInclusive) { return call_method<"subMap", jni::ref<java::util::NavigableMap>>(from, fromInclusive, to, toInclusive); }
	jni::ref<java::util::SortedMap> subMap(jni::ref<java::lang::Object> fromInclusive, jni::ref<java::lang::Object> toExclusive) { return call_method<"subMap", jni::ref<java::util::SortedMap>>(fromInclusive, toExclusive); }
	jni::ref<java::util::NavigableMap> headMap(jni::ref<java::lang::Object> to, jboolean inclusive) { return call_method<"headMap", jni::ref<java::util::NavigableMap>>(to, inclusive); }
	jni::ref<java::util::SortedMap> headMap(jni::ref<java::lang::Object> toExclusive) { return call_method<"headMap", jni::ref<java::util::SortedMap>>(toExclusive); }
	jni::ref<java::util::NavigableMap> tailMap(jni::ref<java::lang::Object> from, jboolean inclusive) { return call_method<"tailMap", jni::ref<java::util::NavigableMap>>(from, inclusive); }
	jni::ref<java::util::SortedMap> tailMap(jni::ref<java::lang::Object> fromInclusive) { return call_method<"tailMap", jni::ref<java::util::SortedMap>>(fromInclusive); }
