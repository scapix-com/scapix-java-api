...
public:
	...
	static jni::ref<java::util::LinkedHashSet> new_object(jint capacity) { return base_::new_object(capacity); }
	static jni::ref<java::util::LinkedHashSet> new_object(jint capacity, jfloat loadFactor) { return base_::new_object(capacity, loadFactor); }
	static jni::ref<java::util::LinkedHashSet> new_object(jni::ref<java::util::Collection> collection) { return base_::new_object(collection); }
