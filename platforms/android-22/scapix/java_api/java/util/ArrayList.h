...
public:
	...
	static jni::ref<java::util::ArrayList> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::ArrayList> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::ArrayList> new_object(jni::ref<java::util::Collection> collection) { return object_base::new_object(collection); }
