...
public:
	...
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::util::EnumMap> map) { return object_base::new_object(map); }
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::util::Map> map) { return object_base::new_object(map); }
