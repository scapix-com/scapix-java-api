...
public:
	...
	static jni::ref<java::text::MessageFormat> new_object(jni::ref<java::lang::String> template_, jni::ref<java::util::Locale> locale) { return object_base::new_object(template_, locale); }
	static jni::ref<java::text::MessageFormat> new_object(jni::ref<java::lang::String> template_) { return object_base::new_object(template_); }
