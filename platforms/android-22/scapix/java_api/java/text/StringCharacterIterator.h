...
public:
	...
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> value) { return object_base::new_object(value); }
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> value, jint location) { return object_base::new_object(value, location); }
	static jni::ref<java::text::StringCharacterIterator> new_object(jni::ref<java::lang::String> value, jint start, jint end, jint location) { return object_base::new_object(value, start, end, location); }
