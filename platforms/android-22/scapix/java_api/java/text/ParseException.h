...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_PARSEEXCEPTION
...
public:
	...
	static jni::ref<java::text::ParseException> new_object(jni::ref<java::lang::String> detailMessage, jint location) { return object_base::new_object(detailMessage, location); }
