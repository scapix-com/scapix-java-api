...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_RUNTIMEPERMISSION
...
public:
	...
	static jni::ref<java::lang::RuntimePermission> new_object(jni::ref<java::lang::String> permissionName) { return object_base::new_object(permissionName); }
	static jni::ref<java::lang::RuntimePermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions) { return object_base::new_object(name, actions); }
