...
public:
	...
	static jni::ref<java::lang::Enum> valueOf(jni::ref<java::lang::Class> enumType, jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::lang::Enum>>(enumType, name); }
};
