...
public:
	...
	static jni::ref<java::lang::Double> new_object(jni::ref<java::lang::String> string) { return object_base::new_object(string); }
	...
	static jint compare(jdouble double1, jdouble double2) { return call_static_method<"compare", jint>(double1, double2); }
