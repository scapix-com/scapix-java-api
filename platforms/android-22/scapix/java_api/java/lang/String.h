...
public:
	...
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data) { return object_base::new_object(data); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jint high) { return object_base::new_object(data, high); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jint offset, jint byteCount) { return object_base::new_object(data, offset, byteCount); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jint high, jint offset, jint byteCount) { return object_base::new_object(data, high, offset, byteCount); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jint offset, jint byteCount, jni::ref<java::lang::String> charsetName) { return object_base::new_object(data, offset, byteCount, charsetName); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jni::ref<java::lang::String> charsetName) { return object_base::new_object(data, charsetName); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jint offset, jint byteCount, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(data, offset, byteCount, charset); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jbyte>> data, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(data, charset); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jchar>> data) { return object_base::new_object(data); }
	static jni::ref<java::lang::String> new_object(jni::ref<jni::array<jchar>> data, jint offset, jint charCount) { return object_base::new_object(data, offset, charCount); }
	static jni::ref<java::lang::String> new_object(jni::ref<java::lang::String> toCopy) { return object_base::new_object(toCopy); }
	static jni::ref<java::lang::String> new_object(jni::ref<java::lang::StringBuffer> stringBuffer) { return object_base::new_object(stringBuffer); }
	...
	static jni::ref<java::lang::String> new_object(jni::ref<java::lang::StringBuilder> stringBuilder) { return object_base::new_object(stringBuilder); }
	...
	jni::ref<java::lang::String> concat(jni::ref<java::lang::String> string) { return call_method<"concat", jni::ref<java::lang::String>>(string); }
