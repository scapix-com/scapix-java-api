...
public:
	...
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::String> detailMessage) { return base_::new_object(detailMessage); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::String> detailMessage, jni::ref<java::lang::Throwable> cause) { return base_::new_object(detailMessage, cause); }
	static jni::ref<java::lang::Throwable> new_object(jni::ref<java::lang::Throwable> cause) { return base_::new_object(cause); }
