...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REFLECT_INVOCATIONTARGETEXCEPTION
...
public:
	...
	static jni::ref<java::lang::reflect::InvocationTargetException> new_object(jni::ref<java::lang::Throwable> exception) { return object_base::new_object(exception); }
	static jni::ref<java::lang::reflect::InvocationTargetException> new_object(jni::ref<java::lang::Throwable> exception, jni::ref<java::lang::String> detailMessage) { return object_base::new_object(exception, detailMessage); }
