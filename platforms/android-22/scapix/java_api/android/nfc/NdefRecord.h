...
#ifndef SCAPIX_JAVA_API_ANDROID_NFC_NDEFRECORD
...
public:
	...
	static jni::ref<android::nfc::NdefRecord> new_object(jshort tnf, jni::ref<jni::array<jbyte>> type, jni::ref<jni::array<jbyte>> id, jni::ref<jni::array<jbyte>> payload) { return object_base::new_object(tnf, type, id, payload); }
	static jni::ref<android::nfc::NdefRecord> new_object(jni::ref<jni::array<jbyte>> data) { return object_base::new_object(data); }
