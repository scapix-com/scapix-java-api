...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHCLASS_DEVICE
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothClass_Device> new_object() { return object_base::new_object(); }
};
