...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_INSTRUMENTATIONINFO
...
public:
	...
	static jni::ref<android::content::pm::InstrumentationInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::InstrumentationInfo> new_object(jni::ref<android::content::pm::InstrumentationInfo> orig) { return object_base::new_object(orig); }
