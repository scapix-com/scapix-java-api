...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_TELEPHONY_SMS_INTENTS
...
public:
	...
	static jni::ref<java::lang::String> SMS_EMERGENCY_CB_RECEIVED_ACTION() { return get_static_field<"SMS_EMERGENCY_CB_RECEIVED_ACTION", jni::ref<java::lang::String>>(); }
