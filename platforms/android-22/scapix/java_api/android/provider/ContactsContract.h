...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CONTACTSCONTRACT
...
#include <scapix/java_api/android/provider/ContactsContract_StreamItemPhotos.h>
#include <scapix/java_api/android/provider/ContactsContract_StreamItems.h>
...
public:
	...
	using StreamItemPhotos = ContactsContract_StreamItemPhotos;
	using StreamItems = ContactsContract_StreamItems;
	...
	static jni::ref<android::provider::ContactsContract> new_object() { return object_base::new_object(); }
