...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_MEDIA
...
public:
	...
	static jni::ref<android::provider::MediaStore_Audio_Media> new_object() { return object_base::new_object(); }
