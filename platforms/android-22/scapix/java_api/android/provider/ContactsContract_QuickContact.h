...
class ContactsContract_QuickContact;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_CONTACTSCONTRACT_QUICKCONTACT
...
public:
	...
	static jni::ref<android::provider::ContactsContract_QuickContact> new_object() { return object_base::new_object(); }
