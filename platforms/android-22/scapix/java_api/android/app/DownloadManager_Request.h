...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_DOWNLOADMANAGER_REQUEST
...
public:
	...
	static jni::ref<android::app::DownloadManager_Request> new_object(jni::ref<android::net::Uri> uri) { return object_base::new_object(uri); }
