...
public:
	...
	static jni::ref<android::app::admin::DeviceAdminInfo> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::pm::ResolveInfo> receiver) { return object_base::new_object(context, receiver); }
