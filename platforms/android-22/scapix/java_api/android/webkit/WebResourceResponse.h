...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_WEBRESOURCERESPONSE
...
public:
	...
	static jni::ref<android::webkit::WebResourceResponse> new_object(jni::ref<java::lang::String> mimeType, jni::ref<java::lang::String> encoding, jni::ref<java::io::InputStream> data) { return object_base::new_object(mimeType, encoding, data); }
	static jni::ref<android::webkit::WebResourceResponse> new_object(jni::ref<java::lang::String> mimeType, jni::ref<java::lang::String> encoding, jint statusCode, jni::ref<java::lang::String> reasonPhrase, jni::ref<java::util::Map> responseHeaders, jni::ref<java::io::InputStream> data) { return object_base::new_object(mimeType, encoding, statusCode, reasonPhrase, responseHeaders, data); }
