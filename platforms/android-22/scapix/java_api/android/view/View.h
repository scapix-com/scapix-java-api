...
public:
	...
	void addChildrenForAccessibility(jni::ref<java::util::ArrayList> children) { return call_method<"addChildrenForAccessibility", void>(children); }
	...
	void getLocationOnScreen(jni::ref<jni::array<jint>> location) { return call_method<"getLocationOnScreen", void>(location); }
	void getLocationInWindow(jni::ref<jni::array<jint>> location) { return call_method<"getLocationInWindow", void>(location); }
