...
public:
	...
	void addChildrenForAccessibility(jni::ref<java::util::ArrayList> childrenForAccessibility) { return call_method<"addChildrenForAccessibility", void>(childrenForAccessibility); }
