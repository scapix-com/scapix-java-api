...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_SCALEGESTUREDETECTOR
...
public:
	...
	static jni::ref<android::view::ScaleGestureDetector> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::ScaleGestureDetector_OnScaleGestureListener> listener) { return object_base::new_object(context, listener); }
	static jni::ref<android::view::ScaleGestureDetector> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::ScaleGestureDetector_OnScaleGestureListener> listener, jni::ref<android::os::Handler> handler) { return object_base::new_object(context, listener, handler); }
