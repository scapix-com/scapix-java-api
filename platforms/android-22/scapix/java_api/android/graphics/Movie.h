...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_MOVIE
...
public:
	...
	void draw(jni::ref<android::graphics::Canvas> p1, jfloat p2, jfloat p3, jni::ref<android::graphics::Paint> p4) { return call_method<"draw", void>(p1, p2, p3, p4); }
