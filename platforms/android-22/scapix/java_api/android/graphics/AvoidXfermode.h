...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_AVOIDXFERMODE
...
public:
	...
	static jni::ref<android::graphics::AvoidXfermode> new_object(jint opColor, jint tolerance, jni::ref<android::graphics::AvoidXfermode_Mode> mode) { return object_base::new_object(opColor, tolerance, mode); }
};
