...
public:
	...
	static void startMethodTracing(jni::ref<java::lang::String> traceName) { return call_static_method<"startMethodTracing", void>(traceName); }
	static void startMethodTracing(jni::ref<java::lang::String> traceName, jint bufferSize) { return call_static_method<"startMethodTracing", void>(traceName, bufferSize); }
	static void startMethodTracing(jni::ref<java::lang::String> traceName, jint bufferSize, jint flags) { return call_static_method<"startMethodTracing", void>(traceName, bufferSize, flags); }
	static void startMethodTracingSampling(jni::ref<java::lang::String> traceName, jint bufferSize, jint intervalUs) { return call_static_method<"startMethodTracingSampling", void>(traceName, bufferSize, intervalUs); }
