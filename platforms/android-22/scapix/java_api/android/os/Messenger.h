...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_MESSENGER
...
public:
	...
	static jni::ref<android::os::Messenger> new_object(jni::ref<android::os::Handler> target) { return object_base::new_object(target); }
	static jni::ref<android::os::Messenger> new_object(jni::ref<android::os::IBinder> target) { return object_base::new_object(target); }
