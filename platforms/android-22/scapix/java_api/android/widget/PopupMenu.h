...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_POPUPMENU
...
public:
	...
	static jni::ref<android::widget::PopupMenu> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::View> anchor) { return object_base::new_object(context, anchor); }
	static jni::ref<android::widget::PopupMenu> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::View> anchor, jint gravity) { return object_base::new_object(context, anchor, gravity); }
	static jni::ref<android::widget::PopupMenu> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::View> anchor, jint gravity, jint popupStyleAttr, jint popupStyleRes) { return object_base::new_object(context, anchor, gravity, popupStyleAttr, popupStyleRes); }
