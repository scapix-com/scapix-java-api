...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_SUITEBUILDER_TESTMETHOD
...
public:
	...
	static jni::ref<android::test::suitebuilder::TestMethod> new_object(jni::ref<java::lang::reflect::Method> method, jni::ref<java::lang::Class> enclosingClass) { return object_base::new_object(method, enclosingClass); }
	static jni::ref<android::test::suitebuilder::TestMethod> new_object(jni::ref<java::lang::String> methodName, jni::ref<java::lang::Class> enclosingClass) { return object_base::new_object(methodName, enclosingClass); }
	static jni::ref<android::test::suitebuilder::TestMethod> new_object(jni::ref<junit::framework::TestCase> testCase) { return object_base::new_object(testCase); }
