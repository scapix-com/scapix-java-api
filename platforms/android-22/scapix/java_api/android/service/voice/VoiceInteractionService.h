...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_VOICE_VOICEINTERACTIONSERVICE
...
public:
	...
	static jni::ref<android::service::voice::VoiceInteractionService> new_object() { return object_base::new_object(); }
	...
	void startSession(jni::ref<android::os::Bundle> args) { return call_method<"startSession", void>(args); }
	...
	jni::ref<android::service::voice::AlwaysOnHotwordDetector> createAlwaysOnHotwordDetector(jni::ref<java::lang::String> keyphrase, jni::ref<java::util::Locale> locale, jni::ref<android::service::voice::AlwaysOnHotwordDetector_Callback> callback) { return call_method<"createAlwaysOnHotwordDetector", jni::ref<android::service::voice::AlwaysOnHotwordDetector>>(keyphrase, locale, callback); }
};
