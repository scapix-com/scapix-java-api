...
#ifndef SCAPIX_JAVA_API_JUNIT_FRAMEWORK_ASSERT
...
public:
	...
	static void assertEquals(jni::ref<java::lang::String> message, jdouble expected, jdouble actual, jdouble delta) { return call_static_method<"assertEquals", void>(message, expected, actual, delta); }
	static void assertEquals(jdouble expected, jdouble actual, jdouble delta) { return call_static_method<"assertEquals", void>(expected, actual, delta); }
	...
	static void assertEquals(jni::ref<java::lang::String> message, jlong expected, jlong actual) { return call_static_method<"assertEquals", void>(message, expected, actual); }
	static void assertEquals(jlong expected, jlong actual) { return call_static_method<"assertEquals", void>(expected, actual); }
