...
public:
	...
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<org::xml::sax::Locator> locator) { return base_::new_object(message, locator); }
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<org::xml::sax::Locator> locator, jni::ref<java::lang::Exception> e) { return base_::new_object(message, locator, e); }
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::String> publicId, jni::ref<java::lang::String> systemId, jint lineNumber, jint columnNumber) { return base_::new_object(message, publicId, systemId, lineNumber, columnNumber); }
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::String> publicId, jni::ref<java::lang::String> systemId, jint lineNumber, jint columnNumber, jni::ref<java::lang::Exception> e) { return base_::new_object(message, publicId, systemId, lineNumber, columnNumber, e); }
