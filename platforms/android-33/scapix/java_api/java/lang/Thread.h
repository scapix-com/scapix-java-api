...
public:
	...
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> target) { return base_::new_object(target); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> target) { return base_::new_object(group, target); }
	...
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> target, jni::ref<java::lang::String> name) { return base_::new_object(target, name); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> target, jni::ref<java::lang::String> name) { return base_::new_object(group, target, name); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> target, jni::ref<java::lang::String> name, jlong stackSize) { return base_::new_object(group, target, name, stackSize); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> target, jni::ref<java::lang::String> name, jlong stackSize, jboolean p5) { return base_::new_object(group, target, name, stackSize, p5); }
