...
public:
	...
	static jni::ref<java::util::zip::CheckedInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<java::util::zip::Checksum> cksum) { return base_::new_object(in, cksum); }
