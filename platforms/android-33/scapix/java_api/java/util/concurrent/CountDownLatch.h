...
public:
	...
	static jni::ref<java::util::concurrent::CountDownLatch> new_object(jint count) { return base_::new_object(count); }
	void await() { return call_method<"await", void>(); }
	jboolean await(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> p2) { return call_method<"await", jboolean>(timeout, p2); }
