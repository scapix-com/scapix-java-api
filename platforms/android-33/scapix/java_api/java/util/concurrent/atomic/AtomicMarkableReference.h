...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ATOMIC_ATOMICMARKABLEREFERENCE
...
public:
	...
	static jni::ref<java::util::concurrent::atomic::AtomicMarkableReference> new_object(jni::ref<java::lang::Object> initialRef, jboolean initialMark) { return object_base::new_object(initialRef, initialMark); }
