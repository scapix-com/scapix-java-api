...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ATOMIC_ATOMICSTAMPEDREFERENCE
...
public:
	...
	static jni::ref<java::util::concurrent::atomic::AtomicStampedReference> new_object(jni::ref<java::lang::Object> initialRef, jint initialStamp) { return object_base::new_object(initialRef, initialStamp); }
