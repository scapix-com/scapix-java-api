...
public:
	...
	static jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> new_object(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer> this_0) { return base_::new_object(this_0); }
