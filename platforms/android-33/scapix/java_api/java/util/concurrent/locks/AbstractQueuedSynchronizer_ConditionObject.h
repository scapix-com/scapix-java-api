...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LOCKS_ABSTRACTQUEUEDSYNCHRONIZER_CONDITIONOBJECT
...
public:
	...
	static jni::ref<java::util::concurrent::locks::AbstractQueuedSynchronizer_ConditionObject> new_object(jni::ref<java::util::concurrent::locks::AbstractQueuedSynchronizer> this_0) { return object_base::new_object(this_0); }
