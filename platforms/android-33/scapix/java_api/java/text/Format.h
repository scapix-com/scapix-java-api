...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_FORMAT
...
public:
	...
	jni::ref<java::lang::String> format(jni::ref<java::lang::Object> obj) { return call_method<"format", jni::ref<java::lang::String>>(obj); }
	...
	jni::ref<java::lang::Object> parseObject(jni::ref<java::lang::String> source) { return call_method<"parseObject", jni::ref<java::lang::Object>>(source); }
