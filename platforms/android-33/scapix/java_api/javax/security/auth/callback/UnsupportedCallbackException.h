...
public:
	...
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> callback, jni::ref<java::lang::String> msg) { return base_::new_object(callback, msg); }
