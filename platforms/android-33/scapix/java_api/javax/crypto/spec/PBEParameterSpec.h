...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_PBEPARAMETERSPEC
...
public:
	...
	static jni::ref<javax::crypto::spec::PBEParameterSpec> new_object(jni::ref<jni::array<jbyte>> salt, jint iterationCount) { return object_base::new_object(salt, iterationCount); }
	static jni::ref<javax::crypto::spec::PBEParameterSpec> new_object(jni::ref<jni::array<jbyte>> salt, jint iterationCount, jni::ref<java::security::spec::AlgorithmParameterSpec> paramSpec) { return object_base::new_object(salt, iterationCount, paramSpec); }
