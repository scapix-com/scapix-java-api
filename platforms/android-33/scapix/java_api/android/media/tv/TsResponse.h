...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TSRESPONSE
...
public:
	...
	static jni::ref<android::media::tv::TsResponse> new_object(jint requestId, jint sequence, jint responseResult, jni::ref<java::lang::String> sharedFilterToken) { return object_base::new_object(requestId, sequence, responseResult, sharedFilterToken); }
