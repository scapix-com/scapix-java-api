...
class MediaDrm_SessionException;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIADRM_SESSIONEXCEPTION
...
public:
	...
	static jni::ref<android::media::MediaDrm_SessionException> new_object(jint errorCode, jni::ref<java::lang::String> detailMessage) { return object_base::new_object(errorCode, detailMessage); }
