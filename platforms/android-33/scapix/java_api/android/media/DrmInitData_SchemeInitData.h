...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_DRMINITDATA_SCHEMEINITDATA
...
public:
	...
	static jni::ref<android::media::DrmInitData_SchemeInitData> new_object(jni::ref<java::util::UUID> uuid, jni::ref<java::lang::String> mimeType, jni::ref<jni::array<jbyte>> data) { return object_base::new_object(uuid, mimeType, data); }
