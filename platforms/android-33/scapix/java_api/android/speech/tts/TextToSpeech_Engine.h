...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_TTS_TEXTTOSPEECH_ENGINE
...
public:
	...
	static jni::ref<android::speech::tts::TextToSpeech_Engine> new_object(jni::ref<android::speech::tts::TextToSpeech> this_0) { return object_base::new_object(this_0); }
};
