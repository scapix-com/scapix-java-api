...
class SyncStateContract_Helpers;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_SYNCSTATECONTRACT_HELPERS
...
public:
	...
	static jni::ref<android::provider::SyncStateContract_Helpers> new_object() { return object_base::new_object(); }
