...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_PROTO_PROTOOUTPUTSTREAM
...
public:
	...
	static jni::ref<android::util::proto::ProtoOutputStream> new_object() { return object_base::new_object(); }
	static jni::ref<android::util::proto::ProtoOutputStream> new_object(jint chunkSize) { return object_base::new_object(chunkSize); }
	static jni::ref<android::util::proto::ProtoOutputStream> new_object(jni::ref<java::io::OutputStream> stream) { return object_base::new_object(stream); }
	jint getRawSize() { return call_method<"getRawSize", jint>(); }
	void write(jlong fieldId, jdouble val) { return call_method<"write", void>(fieldId, val); }
	void write(jlong fieldId, jfloat val) { return call_method<"write", void>(fieldId, val); }
	void write(jlong fieldId, jint val) { return call_method<"write", void>(fieldId, val); }
	void write(jlong fieldId, jlong val) { return call_method<"write", void>(fieldId, val); }
	void write(jlong fieldId, jboolean val) { return call_method<"write", void>(fieldId, val); }
	void write(jlong fieldId, jni::ref<java::lang::String> val) { return call_method<"write", void>(fieldId, val); }
	void write(jlong fieldId, jni::ref<jni::array<jbyte>> val) { return call_method<"write", void>(fieldId, val); }
	...
	static jint checkFieldId(jlong fieldId, jlong expectedFlags) { return call_static_method<"checkFieldId", jint>(fieldId, expectedFlags); }
