...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_ATOMICFILE
...
public:
	...
	static jni::ref<android::util::AtomicFile> new_object(jni::ref<java::io::File> baseName) { return object_base::new_object(baseName); }
	...
	jlong getLastModifiedTime() { return call_method<"getLastModifiedTime", jlong>(); }
