...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSNAVIGATIONMESSAGE_CALLBACK
...
public:
	...
	static jni::ref<android::location::GnssNavigationMessage_Callback> new_object() { return object_base::new_object(); }
