...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_COMPOUNDBUTTON
...
public:
	...
	static jni::ref<android::widget::CompoundButton> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::CompoundButton> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::widget::CompoundButton> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	static jni::ref<android::widget::CompoundButton> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes); }
	...
	void setButtonIcon(jni::ref<android::graphics::drawable::Icon> icon) { return call_method<"setButtonIcon", void>(icon); }
	...
	void setButtonTintBlendMode(jni::ref<android::graphics::BlendMode> tintMode) { return call_method<"setButtonTintBlendMode", void>(tintMode); }
	...
	jni::ref<android::graphics::BlendMode> getButtonTintBlendMode() { return call_method<"getButtonTintBlendMode", jni::ref<android::graphics::BlendMode>>(); }
