...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_IMAGEVIEW
...
public:
	...
	static jni::ref<android::widget::ImageView> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::ImageView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::widget::ImageView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	static jni::ref<android::widget::ImageView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes); }
	...
	void setImageTintBlendMode(jni::ref<android::graphics::BlendMode> blendMode) { return call_method<"setImageTintBlendMode", void>(blendMode); }
	...
	jni::ref<android::graphics::BlendMode> getImageTintBlendMode() { return call_method<"getImageTintBlendMode", jni::ref<android::graphics::BlendMode>>(); }
	...
	void animateTransform(jni::ref<android::graphics::Matrix> matrix) { return call_method<"animateTransform", void>(matrix); }
