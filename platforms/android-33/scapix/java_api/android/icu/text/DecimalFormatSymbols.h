...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DECIMALFORMATSYMBOLS
...
public:
	...
	static jni::ref<android::icu::text::DecimalFormatSymbols> new_object() { return object_base::new_object(); }
	static jni::ref<android::icu::text::DecimalFormatSymbols> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
	static jni::ref<android::icu::text::DecimalFormatSymbols> new_object(jni::ref<android::icu::util::ULocale> locale) { return object_base::new_object(locale); }
	...
	static jni::ref<android::icu::text::DecimalFormatSymbols> forNumberingSystem(jni::ref<java::util::Locale> locale, jni::ref<android::icu::text::NumberingSystem> ns) { return call_static_method<"forNumberingSystem", jni::ref<android::icu::text::DecimalFormatSymbols>>(locale, ns); }
	static jni::ref<android::icu::text::DecimalFormatSymbols> forNumberingSystem(jni::ref<android::icu::util::ULocale> locale, jni::ref<android::icu::text::NumberingSystem> ns) { return call_static_method<"forNumberingSystem", jni::ref<android::icu::text::DecimalFormatSymbols>>(locale, ns); }
