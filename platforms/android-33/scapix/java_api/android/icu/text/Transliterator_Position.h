...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_TRANSLITERATOR_POSITION
...
public:
	...
	static jni::ref<android::icu::text::Transliterator_Position> new_object() { return object_base::new_object(); }
	static jni::ref<android::icu::text::Transliterator_Position> new_object(jint contextStart, jint contextLimit, jint start) { return object_base::new_object(contextStart, contextLimit, start); }
	static jni::ref<android::icu::text::Transliterator_Position> new_object(jint contextStart, jint contextLimit, jint start, jint limit) { return object_base::new_object(contextStart, contextLimit, start, limit); }
	static jni::ref<android::icu::text::Transliterator_Position> new_object(jni::ref<android::icu::text::Transliterator_Position> pos) { return object_base::new_object(pos); }
