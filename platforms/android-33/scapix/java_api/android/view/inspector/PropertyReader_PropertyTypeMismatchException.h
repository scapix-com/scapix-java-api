...
class PropertyReader_PropertyTypeMismatchException;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INSPECTOR_PROPERTYREADER_PROPERTYTYPEMISMATCHEXCEPTION
...
public:
	...
	static jni::ref<android::view::inspector::PropertyReader_PropertyTypeMismatchException> new_object(jint id, jni::ref<java::lang::String> expectedPropertyType, jni::ref<java::lang::String> actualPropertyType, jni::ref<java::lang::String> propertyName) { return object_base::new_object(id, expectedPropertyType, actualPropertyType, propertyName); }
	static jni::ref<android::view::inspector::PropertyReader_PropertyTypeMismatchException> new_object(jint id, jni::ref<java::lang::String> expectedPropertyType, jni::ref<java::lang::String> actualPropertyType) { return object_base::new_object(id, expectedPropertyType, actualPropertyType); }
};
