...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INSPECTOR_INTFLAGMAPPING
...
public:
	...
	static jni::ref<android::view::inspector::IntFlagMapping> new_object() { return object_base::new_object(); }
