...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_CONTENTCAPTURE_DATASHAREREQUEST
...
public:
	...
	static jni::ref<android::view::contentcapture::DataShareRequest> new_object(jni::ref<android::content::LocusId> locusId, jni::ref<java::lang::String> mimeType) { return object_base::new_object(locusId, mimeType); }
