...
public:
	...
	jni::ref<java::util::List> getEnabledInputMethodSubtypeList(jni::ref<android::view::inputmethod::InputMethodInfo> imi, jboolean allowsImplicitlySelectedSubtypes) { return call_method<"getEnabledInputMethodSubtypeList", jni::ref<java::util::List>>(imi, allowsImplicitlySelectedSubtypes); }
