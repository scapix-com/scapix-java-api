...
class ConversationActions_Request_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TEXTCLASSIFIER_CONVERSATIONACTIONS_REQUEST_BUILDER
...
public:
	...
	static jni::ref<android::view::textclassifier::ConversationActions_Request_Builder> new_object(jni::ref<java::util::List> conversation) { return object_base::new_object(conversation); }
