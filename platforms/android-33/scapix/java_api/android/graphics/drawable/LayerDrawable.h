...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_LAYERDRAWABLE
...
public:
	...
	static jint INSET_UNDEFINED() { return get_static_field<"INSET_UNDEFINED", jint>(); }
	...
	static jni::ref<android::graphics::drawable::LayerDrawable> new_object(jni::ref<jni::array<android::graphics::drawable::Drawable>> layers) { return object_base::new_object(layers); }
