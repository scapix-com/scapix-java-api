...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_LE_SCANFILTER_BUILDER
...
public:
	...
	static jni::ref<android::bluetooth::le::ScanFilter_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::bluetooth::le::ScanFilter_Builder> setServiceSolicitationUuid(jni::ref<android::os::ParcelUuid> serviceSolicitationUuid) { return call_method<"setServiceSolicitationUuid", jni::ref<android::bluetooth::le::ScanFilter_Builder>>(serviceSolicitationUuid); }
	jni::ref<android::bluetooth::le::ScanFilter_Builder> setServiceSolicitationUuid(jni::ref<android::os::ParcelUuid> serviceSolicitationUuid, jni::ref<android::os::ParcelUuid> solicitationUuidMask) { return call_method<"setServiceSolicitationUuid", jni::ref<android::bluetooth::le::ScanFilter_Builder>>(serviceSolicitationUuid, solicitationUuidMask); }
	...
	jni::ref<android::bluetooth::le::ScanFilter_Builder> setAdvertisingDataTypeWithData(jint advertisingDataType, jni::ref<jni::array<jbyte>> advertisingData, jni::ref<jni::array<jbyte>> advertisingDataMask) { return call_method<"setAdvertisingDataTypeWithData", jni::ref<android::bluetooth::le::ScanFilter_Builder>>(advertisingDataType, advertisingData, advertisingDataMask); }
	jni::ref<android::bluetooth::le::ScanFilter_Builder> setAdvertisingDataType(jint advertisingDataType) { return call_method<"setAdvertisingDataType", jni::ref<android::bluetooth::le::ScanFilter_Builder>>(advertisingDataType); }
