...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHGATTSERVER
...
public:
	...
	void setPreferredPhy(jni::ref<android::bluetooth::BluetoothDevice> device, jint txPhy, jint rxPhy, jint phyOptions) { return call_method<"setPreferredPhy", void>(device, txPhy, rxPhy, phyOptions); }
	void readPhy(jni::ref<android::bluetooth::BluetoothDevice> device) { return call_method<"readPhy", void>(device); }
	...
	jint notifyCharacteristicChanged(jni::ref<android::bluetooth::BluetoothDevice> device, jni::ref<android::bluetooth::BluetoothGattCharacteristic> characteristic, jboolean confirm, jni::ref<jni::array<jbyte>> value) { return call_method<"notifyCharacteristicChanged", jint>(device, characteristic, confirm, value); }
