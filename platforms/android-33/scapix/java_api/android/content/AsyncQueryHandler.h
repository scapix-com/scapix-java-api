...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_ASYNCQUERYHANDLER
...
public:
	...
	static jni::ref<android::content::AsyncQueryHandler> new_object(jni::ref<android::content::ContentResolver> cr) { return object_base::new_object(cr); }
