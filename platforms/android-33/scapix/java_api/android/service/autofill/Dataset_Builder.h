...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_DATASET_BUILDER
...
public:
	...
	static jni::ref<android::service::autofill::Dataset_Builder> new_object(jni::ref<android::widget::RemoteViews> presentation) { return object_base::new_object(presentation); }
	static jni::ref<android::service::autofill::Dataset_Builder> new_object(jni::ref<android::service::autofill::Presentations> presentations) { return object_base::new_object(presentations); }
	static jni::ref<android::service::autofill::Dataset_Builder> new_object() { return object_base::new_object(); }
