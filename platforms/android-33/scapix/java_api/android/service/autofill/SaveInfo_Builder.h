...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_SAVEINFO_BUILDER
...
public:
	...
	static jni::ref<android::service::autofill::SaveInfo_Builder> new_object(jint type, jni::ref<jni::array<android::view::autofill::AutofillId>> requiredIds) { return object_base::new_object(type, requiredIds); }
	static jni::ref<android::service::autofill::SaveInfo_Builder> new_object(jint type) { return object_base::new_object(type); }
	...
	jni::ref<android::service::autofill::SaveInfo_Builder> setPositiveAction(jint style) { return call_method<"setPositiveAction", jni::ref<android::service::autofill::SaveInfo_Builder>>(style); }
