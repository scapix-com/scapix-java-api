...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_SAVEDDATASETSINFO
...
public:
	...
	static jni::ref<android::service::autofill::SavedDatasetsInfo> new_object(jni::ref<java::lang::String> type, jint count) { return object_base::new_object(type, count); }
