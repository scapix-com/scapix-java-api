...
public:
	...
	static jni::ref<android::service::carrier::CarrierIdentifier> new_object(jni::ref<java::lang::String> mcc, jni::ref<java::lang::String> mnc, jni::ref<java::lang::String> spn, jni::ref<java::lang::String> imsi, jni::ref<java::lang::String> gid1, jni::ref<java::lang::String> gid2, jint carrierid, jint specificCarrierId) { return base_::new_object(mcc, mnc, spn, imsi, gid1, gid2, carrierid, specificCarrierId); }
	static jni::ref<android::service::carrier::CarrierIdentifier> new_object(jni::ref<jni::array<jbyte>> mccMnc, jni::ref<java::lang::String> gid1, jni::ref<java::lang::String> gid2) { return base_::new_object(mccMnc, gid1, gid2); }
