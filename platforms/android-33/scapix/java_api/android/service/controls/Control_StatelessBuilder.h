...
class Control_StatelessBuilder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CONTROLS_CONTROL_STATELESSBUILDER
...
public:
	...
	static jni::ref<android::service::controls::Control_StatelessBuilder> new_object(jni::ref<java::lang::String> controlId, jni::ref<android::app::PendingIntent> appIntent) { return object_base::new_object(controlId, appIntent); }
	static jni::ref<android::service::controls::Control_StatelessBuilder> new_object(jni::ref<android::service::controls::Control> control) { return object_base::new_object(control); }
