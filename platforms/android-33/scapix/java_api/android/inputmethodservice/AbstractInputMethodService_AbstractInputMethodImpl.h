...
public:
	...
	static jni::ref<android::inputmethodservice::AbstractInputMethodService_AbstractInputMethodImpl> new_object(jni::ref<android::inputmethodservice::AbstractInputMethodService> this_0) { return base_::new_object(this_0); }
