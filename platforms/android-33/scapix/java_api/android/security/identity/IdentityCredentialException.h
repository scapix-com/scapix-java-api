...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_IDENTITY_IDENTITYCREDENTIALEXCEPTION
...
public:
	...
	static jni::ref<android::security::identity::IdentityCredentialException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<android::security::identity::IdentityCredentialException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
};
