...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_CONFIRMATIONALREADYPRESENTINGEXCEPTION
...
public:
	...
	static jni::ref<android::security::ConfirmationAlreadyPresentingException> new_object() { return object_base::new_object(); }
	static jni::ref<android::security::ConfirmationAlreadyPresentingException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
