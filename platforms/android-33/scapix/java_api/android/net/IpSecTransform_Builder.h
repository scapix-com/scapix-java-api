...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSECTRANSFORM_BUILDER
...
public:
	...
	static jni::ref<android::net::IpSecTransform_Builder> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
