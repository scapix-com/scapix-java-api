...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_NETWORKINFO
...
public:
	...
	static jni::ref<android::net::NetworkInfo> new_object(jint type, jint subtype, jni::ref<java::lang::String> typeName, jni::ref<java::lang::String> subtypeName) { return object_base::new_object(type, subtype, typeName, subtypeName); }
	...
	void setDetailedState(jni::ref<android::net::NetworkInfo_DetailedState> detailedState, jni::ref<java::lang::String> reason, jni::ref<java::lang::String> extraInfo) { return call_method<"setDetailedState", void>(detailedState, reason, extraInfo); }
