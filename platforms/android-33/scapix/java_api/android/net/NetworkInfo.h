...
public:
	...
	static jni::ref<android::net::NetworkInfo> new_object(jint type, jint subtype, jni::ref<java::lang::String> typeName, jni::ref<java::lang::String> subtypeName) { return base_::new_object(type, subtype, typeName, subtypeName); }
