...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_VPNPROFILESTATE
...
public:
	...
	static jni::ref<android::net::VpnProfileState> new_object(jint state, jni::ref<java::lang::String> sessionKey, jboolean alwaysOn, jboolean lockdown) { return object_base::new_object(state, sessionKey, alwaysOn, lockdown); }
