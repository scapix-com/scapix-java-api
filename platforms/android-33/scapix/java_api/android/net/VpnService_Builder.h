...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_VPNSERVICE_BUILDER
...
public:
	...
	static jni::ref<android::net::VpnService_Builder> new_object(jni::ref<android::net::VpnService> this_0) { return object_base::new_object(this_0); }
	...
	jni::ref<android::net::VpnService_Builder> addRoute(jni::ref<android::net::IpPrefix> prefix) { return call_method<"addRoute", jni::ref<android::net::VpnService_Builder>>(prefix); }
	...
	jni::ref<android::net::VpnService_Builder> excludeRoute(jni::ref<android::net::IpPrefix> prefix) { return call_method<"excludeRoute", jni::ref<android::net::VpnService_Builder>>(prefix); }
