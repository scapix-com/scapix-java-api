...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_TONEMAPCURVE
...
public:
	...
	static jni::ref<android::hardware::camera2::params::TonemapCurve> new_object(jni::ref<jni::array<jfloat>> red, jni::ref<jni::array<jfloat>> green, jni::ref<jni::array<jfloat>> blue) { return object_base::new_object(red, green, blue); }
