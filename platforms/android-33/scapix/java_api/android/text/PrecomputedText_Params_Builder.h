...
public:
	...
	static jni::ref<android::text::PrecomputedText_Params_Builder> new_object(jni::ref<android::text::PrecomputedText_Params> params) { return base_::new_object(params); }
