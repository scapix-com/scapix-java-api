...
class PrecomputedText_Params_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_PRECOMPUTEDTEXT_PARAMS_BUILDER
...
public:
	...
	static jni::ref<android::text::PrecomputedText_Params_Builder> new_object(jni::ref<android::text::TextPaint> paint) { return object_base::new_object(paint); }
	static jni::ref<android::text::PrecomputedText_Params_Builder> new_object(jni::ref<android::text::PrecomputedText_Params> params) { return object_base::new_object(params); }
	...
	jni::ref<android::text::PrecomputedText_Params_Builder> setLineBreakConfig(jni::ref<android::graphics::text::LineBreakConfig> lineBreakConfig) { return call_method<"setLineBreakConfig", jni::ref<android::text::PrecomputedText_Params_Builder>>(lineBreakConfig); }
