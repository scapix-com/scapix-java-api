...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_EUICC_EUICCINFO
...
public:
	...
	static jni::ref<android::telephony::euicc::EuiccInfo> new_object(jni::ref<java::lang::String> osVersion) { return object_base::new_object(osVersion); }
