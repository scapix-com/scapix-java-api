...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODEC_QUEUEREQUEST
...
public:
	...
	jni::ref<android::media::MediaCodec_QueueRequest> setMultiFrameLinearBlock(jni::ref<android::media::MediaCodec_LinearBlock> block, jni::ref<java::util::ArrayDeque> infos) { return call_method<"setMultiFrameLinearBlock", jni::ref<android::media::MediaCodec_QueueRequest>>(block, infos); }
	...
	jni::ref<android::media::MediaCodec_QueueRequest> setMultiFrameEncryptedLinearBlock(jni::ref<android::media::MediaCodec_LinearBlock> block, jni::ref<java::util::ArrayDeque> bufferInfos, jni::ref<java::util::ArrayDeque> cryptoInfos) { return call_method<"setMultiFrameEncryptedLinearBlock", jni::ref<android::media::MediaCodec_QueueRequest>>(block, bufferInfos, cryptoInfos); }
