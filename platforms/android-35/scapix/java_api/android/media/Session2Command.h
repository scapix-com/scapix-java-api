...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SESSION2COMMAND
...
public:
	...
	static jni::ref<android::media::Session2Command> new_object(jint commandCode) { return object_base::new_object(commandCode); }
	static jni::ref<android::media::Session2Command> new_object(jni::ref<java::lang::String> action, jni::ref<android::os::Bundle> extras) { return object_base::new_object(action, extras); }
