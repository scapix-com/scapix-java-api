...
public:
	...
	static jni::ref<android::media::RoutingSessionInfo_Builder> new_object(jni::ref<java::lang::String> id, jni::ref<java::lang::String> clientPackageName) { return object_base::new_object(id, clientPackageName); }
