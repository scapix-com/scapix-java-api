...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_ENVIRONMENTALREVERB_SETTINGS
...
public:
	...
	static jni::ref<android::media::audiofx::EnvironmentalReverb_Settings> new_object() { return object_base::new_object(); }
	static jni::ref<android::media::audiofx::EnvironmentalReverb_Settings> new_object(jni::ref<java::lang::String> settings) { return object_base::new_object(settings); }
