...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_DYNAMICSPROCESSING
...
public:
	...
	static jni::ref<android::media::audiofx::DynamicsProcessing> new_object(jint audioSession) { return object_base::new_object(audioSession); }
	static jni::ref<android::media::audiofx::DynamicsProcessing> new_object(jint priority, jint audioSession, jni::ref<android::media::audiofx::DynamicsProcessing_Config> cfg) { return object_base::new_object(priority, audioSession, cfg); }
