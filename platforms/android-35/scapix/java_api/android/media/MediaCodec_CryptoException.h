...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODEC_CRYPTOEXCEPTION
...
public:
	...
	static jni::ref<android::media::MediaCodec_CryptoException> new_object(jint errorCode, jni::ref<java::lang::String> detailMessage) { return object_base::new_object(errorCode, detailMessage); }
