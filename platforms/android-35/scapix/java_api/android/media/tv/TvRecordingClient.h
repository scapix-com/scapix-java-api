...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVRECORDINGCLIENT
...
public:
	...
	static jni::ref<android::media::tv::TvRecordingClient> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> tag, jni::ref<android::media::tv::TvRecordingClient_RecordingCallback> callback, jni::ref<android::os::Handler> handler) { return object_base::new_object(context, tag, callback, handler); }
