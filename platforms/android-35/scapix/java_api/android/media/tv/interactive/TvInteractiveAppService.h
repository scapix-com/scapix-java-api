...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_INTERACTIVE_TVINTERACTIVEAPPSERVICE
...
public:
	...
	static jni::ref<android::media::tv::interactive::TvInteractiveAppService> new_object() { return object_base::new_object(); }
