...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_ADRESPONSE
...
public:
	...
	static jni::ref<android::media::tv::AdResponse> new_object(jint id, jint responseType, jlong elapsedTime) { return object_base::new_object(id, responseType, elapsedTime); }
