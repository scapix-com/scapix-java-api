...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TABLERESPONSE
...
#include <scapix/java_api/android/media/tv/TableResponse_Builder.h>
...
public:
	...
	using Builder = TableResponse_Builder;

	static jni::ref<android::os::Parcelable_Creator> CREATOR() { return get_static_field<"CREATOR", jni::ref<android::os::Parcelable_Creator>>(); }

	static jni::ref<android::media::tv::TableResponse> new_object(jint requestId, jint sequence, jint responseResult, jni::ref<android::net::Uri> tableUri, jint version, jint size) { return object_base::new_object(requestId, sequence, responseResult, tableUri, version, size); }
	jni::ref<android::net::Uri> getTableUri() { return call_method<"getTableUri", jni::ref<android::net::Uri>>(); }
	jni::ref<jni::array<jbyte>> getTableByteArray() { return call_method<"getTableByteArray", jni::ref<jni::array<jbyte>>>(); }
	jni::ref<android::os::SharedMemory> getTableSharedMemory() { return call_method<"getTableSharedMemory", jni::ref<android::os::SharedMemory>>(); }
