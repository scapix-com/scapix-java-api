...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODEC
...
public:
	...
	static jint CONFIGURE_FLAG_DETACHED_SURFACE() { return get_static_field<"CONFIGURE_FLAG_DETACHED_SURFACE", jint>(); }
	...
	static jni::ref<java::lang::String> PARAMETER_KEY_QP_OFFSET_MAP() { return get_static_field<"PARAMETER_KEY_QP_OFFSET_MAP", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PARAMETER_KEY_QP_OFFSET_RECTS() { return get_static_field<"PARAMETER_KEY_QP_OFFSET_RECTS", jni::ref<java::lang::String>>(); }
	...
	void detachOutputSurface() { return call_method<"detachOutputSurface", void>(); }
	...
	void queueInputBuffer(jint index, jint offset, jint size, jlong presentationTimeUs, jint flags) { return call_method<"queueInputBuffer", void>(index, offset, size, presentationTimeUs, flags); }
	void queueInputBuffers(jint index, jni::ref<java::util::ArrayDeque> bufferInfos) { return call_method<"queueInputBuffers", void>(index, bufferInfos); }
	void queueSecureInputBuffer(jint index, jint offset, jni::ref<android::media::MediaCodec_CryptoInfo> info, jlong presentationTimeUs, jint flags) { return call_method<"queueSecureInputBuffer", void>(index, offset, info, presentationTimeUs, flags); }
	void queueSecureInputBuffers(jint index, jni::ref<java::util::ArrayDeque> bufferInfos, jni::ref<java::util::ArrayDeque> cryptoInfos) { return call_method<"queueSecureInputBuffers", void>(index, bufferInfos, cryptoInfos); }
