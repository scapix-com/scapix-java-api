...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SESSION_MEDIACONTROLLER_CALLBACK
...
public:
	...
	static jni::ref<android::media::session::MediaController_Callback> new_object() { return object_base::new_object(); }
	...
	void onAudioInfoChanged(jni::ref<android::media::session::MediaController_PlaybackInfo> playbackInfo) { return call_method<"onAudioInfoChanged", void>(playbackInfo); }
};
