...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_TIMEUTILS
...
public:
	...
	static jni::ref<java::util::TimeZone> getTimeZone(jint offset, jboolean dst, jlong when, jni::ref<java::lang::String> country) { return call_static_method<"getTimeZone", jni::ref<java::util::TimeZone>>(offset, dst, when, country); }
