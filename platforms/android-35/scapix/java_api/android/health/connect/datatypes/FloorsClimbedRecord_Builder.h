...
class FloorsClimbedRecord_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_FLOORSCLIMBEDRECORD_BUILDER
...
public:
	...
	static jni::ref<android::health::connect::datatypes::FloorsClimbedRecord_Builder> new_object(jni::ref<android::health::connect::datatypes::Metadata> metadata, jni::ref<java::time::Instant> startTime, jni::ref<java::time::Instant> endTime, jdouble floors) { return object_base::new_object(metadata, startTime, endTime, floors); }
