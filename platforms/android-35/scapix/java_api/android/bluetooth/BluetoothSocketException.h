...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHSOCKETEXCEPTION
...
public:
	...
	static jint UNIX_FILE_SOCKET_CREATION_FAILURE() { return get_static_field<"UNIX_FILE_SOCKET_CREATION_FAILURE", jint>(); }
	static jint UNSPECIFIED() { return get_static_field<"UNSPECIFIED", jint>(); }

	static jni::ref<android::bluetooth::BluetoothSocketException> new_object(jint code, jni::ref<java::lang::String> msg) { return object_base::new_object(code, msg); }
	static jni::ref<android::bluetooth::BluetoothSocketException> new_object(jint code) { return object_base::new_object(code); }
