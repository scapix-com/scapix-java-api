...
class BluetoothCodecConfig_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHCODECCONFIG_BUILDER
...
#include <scapix/java_api/android/bluetooth/BluetoothCodecType.h>
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothCodecConfig_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::bluetooth::BluetoothCodecConfig_Builder> setExtendedCodecType(jni::ref<android::bluetooth::BluetoothCodecType> codecType) { return call_method<"setExtendedCodecType", jni::ref<android::bluetooth::BluetoothCodecConfig_Builder>>(codecType); }
