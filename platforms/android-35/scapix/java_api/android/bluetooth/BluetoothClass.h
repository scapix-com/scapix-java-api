...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHCLASS
...
public:
	...
	static jint PROFILE_A2DP() { return get_static_field<"PROFILE_A2DP", jint>(); }
	static jint PROFILE_HEADSET() { return get_static_field<"PROFILE_HEADSET", jint>(); }
	static jint PROFILE_HID() { return get_static_field<"PROFILE_HID", jint>(); }
	...
	jboolean doesClassMatch(jint profile) { return call_method<"doesClassMatch", jboolean>(profile); }
};
