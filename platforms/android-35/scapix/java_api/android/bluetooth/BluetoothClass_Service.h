...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHCLASS_SERVICE
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothClass_Service> new_object() { return object_base::new_object(); }
};
