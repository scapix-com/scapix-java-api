...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_SESSIONCONFIGURATION
...
public:
	...
	static jni::ref<android::hardware::camera2::params::SessionConfiguration> new_object(jint sessionType, jni::ref<java::util::List> outputs, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::hardware::camera2::CameraCaptureSession_StateCallback> cb) { return object_base::new_object(sessionType, outputs, executor, cb); }
	static jni::ref<android::hardware::camera2::params::SessionConfiguration> new_object(jint sessionType, jni::ref<java::util::List> outputs) { return object_base::new_object(sessionType, outputs); }
	...
	void setStateCallback(jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::hardware::camera2::CameraCaptureSession_StateCallback> cb) { return call_method<"setStateCallback", void>(executor, cb); }
};
