...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_COLORSPACEPROFILES
...
public:
	...
	static jni::ref<android::hardware::camera2::params::ColorSpaceProfiles> new_object(jni::ref<jni::array<jlong>> elements) { return object_base::new_object(elements); }
