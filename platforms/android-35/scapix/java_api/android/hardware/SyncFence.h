...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_SYNCFENCE
...
public:
	...
	static jni::ref<android::hardware::SyncFence> new_object(jni::ref<android::hardware::SyncFence> other) { return object_base::new_object(other); }
