...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_LOCATIONREQUEST_BUILDER
...
public:
	...
	static jni::ref<android::location::LocationRequest_Builder> new_object(jlong intervalMillis) { return object_base::new_object(intervalMillis); }
	static jni::ref<android::location::LocationRequest_Builder> new_object(jni::ref<android::location::LocationRequest> locationRequest) { return object_base::new_object(locationRequest); }
