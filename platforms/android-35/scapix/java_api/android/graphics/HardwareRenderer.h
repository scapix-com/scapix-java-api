...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_HARDWARERENDERER
...
public:
	...
	static jni::ref<android::graphics::HardwareRenderer> new_object() { return object_base::new_object(); }
	...
	static jboolean isDrawingEnabled() { return call_static_method<"isDrawingEnabled", jboolean>(); }
	static void setDrawingEnabled(jboolean drawingEnabled) { return call_static_method<"setDrawingEnabled", void>(drawingEnabled); }
};
