...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_MESH
...
public:
	...
	static jni::ref<android::graphics::Mesh> new_object(jni::ref<android::graphics::MeshSpecification> meshSpec, jint mode, jni::ref<java::nio::Buffer> vertexBuffer, jint vertexCount, jni::ref<android::graphics::RectF> bounds) { return object_base::new_object(meshSpec, mode, vertexBuffer, vertexCount, bounds); }
	static jni::ref<android::graphics::Mesh> new_object(jni::ref<android::graphics::MeshSpecification> meshSpec, jint mode, jni::ref<java::nio::Buffer> vertexBuffer, jint vertexCount, jni::ref<java::nio::ShortBuffer> indexBuffer, jni::ref<android::graphics::RectF> bounds) { return object_base::new_object(meshSpec, mode, vertexBuffer, vertexCount, indexBuffer, bounds); }
