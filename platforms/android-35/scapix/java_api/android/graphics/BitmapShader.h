...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_BITMAPSHADER
...
public:
	...
	static jni::ref<android::graphics::BitmapShader> new_object(jni::ref<android::graphics::Bitmap> bitmap, jni::ref<android::graphics::Shader_TileMode> tileX, jni::ref<android::graphics::Shader_TileMode> tileY) { return object_base::new_object(bitmap, tileX, tileY); }
	...
	void setOverrideGainmap(jni::ref<android::graphics::Gainmap> overrideGainmap) { return call_method<"setOverrideGainmap", void>(overrideGainmap); }
