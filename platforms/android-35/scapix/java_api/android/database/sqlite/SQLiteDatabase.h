...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITEDATABASE
...
#include <scapix/java_api/android/database/sqlite/SQLiteRawStatement.h>
...
public:
	...
	static jni::ref<java::lang::String> JOURNAL_MODE_DELETE() { return get_static_field<"JOURNAL_MODE_DELETE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> JOURNAL_MODE_MEMORY() { return get_static_field<"JOURNAL_MODE_MEMORY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> JOURNAL_MODE_OFF() { return get_static_field<"JOURNAL_MODE_OFF", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> JOURNAL_MODE_PERSIST() { return get_static_field<"JOURNAL_MODE_PERSIST", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> JOURNAL_MODE_TRUNCATE() { return get_static_field<"JOURNAL_MODE_TRUNCATE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> JOURNAL_MODE_WAL() { return get_static_field<"JOURNAL_MODE_WAL", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> SYNC_MODE_EXTRA() { return get_static_field<"SYNC_MODE_EXTRA", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SYNC_MODE_FULL() { return get_static_field<"SYNC_MODE_FULL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SYNC_MODE_NORMAL() { return get_static_field<"SYNC_MODE_NORMAL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SYNC_MODE_OFF() { return get_static_field<"SYNC_MODE_OFF", jni::ref<java::lang::String>>(); }
	...
	void beginTransactionReadOnly() { return call_method<"beginTransactionReadOnly", void>(); }
	...
	void beginTransactionWithListenerReadOnly(jni::ref<android::database::sqlite::SQLiteTransactionListener> transactionListener) { return call_method<"beginTransactionWithListenerReadOnly", void>(transactionListener); }
	...
	static jni::ref<android::database::sqlite::SQLiteDatabase> openDatabase(jni::ref<java::io::File> path, jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams> openParams) { return call_static_method<"openDatabase", jni::ref<android::database::sqlite::SQLiteDatabase>>(path, openParams); }
	...
	static jni::ref<android::database::sqlite::SQLiteDatabase> createInMemory(jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams> openParams) { return call_static_method<"createInMemory", jni::ref<android::database::sqlite::SQLiteDatabase>>(openParams); }
	void setCustomScalarFunction(jni::ref<java::lang::String> functionName, jni::ref<java::util::function::UnaryOperator> scalarFunction) { return call_method<"setCustomScalarFunction", void>(functionName, scalarFunction); }
	void setCustomAggregateFunction(jni::ref<java::lang::String> functionName, jni::ref<java::util::function::BinaryOperator> aggregateFunction) { return call_method<"setCustomAggregateFunction", void>(functionName, aggregateFunction); }
	void execPerConnectionSQL(jni::ref<java::lang::String> sql, jni::ref<jni::array<java::lang::Object>> bindArgs) { return call_method<"execPerConnectionSQL", void>(sql, bindArgs); }
	...
	jni::ref<android::database::sqlite::SQLiteRawStatement> createRawStatement(jni::ref<java::lang::String> sql) { return call_method<"createRawStatement", jni::ref<android::database::sqlite::SQLiteRawStatement>>(sql); }
	jlong getLastInsertRowId() { return call_method<"getLastInsertRowId", jlong>(); }
	jlong getLastChangedRowCount() { return call_method<"getLastChangedRowCount", jlong>(); }
	jlong getTotalChangedRowCount() { return call_method<"getTotalChangedRowCount", jlong>(); }
