...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_CURSORWINDOWALLOCATIONEXCEPTION
...
public:
	...
	static jni::ref<android::database::CursorWindowAllocationException> new_object(jni::ref<java::lang::String> description) { return object_base::new_object(description); }
};
