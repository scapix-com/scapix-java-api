...
#ifndef SCAPIX_JAVA_API_ANDROID_ACCESSIBILITYSERVICE_ACCESSIBILITYSERVICE_MAGNIFICATIONCONTROLLER_ONMAGNIFICATIONCHANGEDLISTENER
...
public:
	...
	void onMagnificationChanged(jni::ref<android::accessibilityservice::AccessibilityService_MagnificationController> controller, jni::ref<android::graphics::Region> region, jni::ref<android::accessibilityservice::MagnificationConfig> config) { return call_method<"onMagnificationChanged", void>(controller, region, config); }
};
