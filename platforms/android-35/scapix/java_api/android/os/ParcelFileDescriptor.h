...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_PARCELFILEDESCRIPTOR
...
public:
	...
	static jni::ref<android::os::ParcelFileDescriptor> new_object(jni::ref<android::os::ParcelFileDescriptor> wrapped) { return object_base::new_object(wrapped); }
	...
	static jni::ref<android::os::ParcelFileDescriptor> wrap(jni::ref<android::os::ParcelFileDescriptor> pfd, jni::ref<android::os::Handler> handler, jni::ref<android::os::ParcelFileDescriptor_OnCloseListener> listener) { return call_static_method<"wrap", jni::ref<android::os::ParcelFileDescriptor>>(pfd, handler, listener); }
