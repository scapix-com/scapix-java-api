...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_STORAGE_STORAGEVOLUME
...
public:
	...
	jni::ref<android::os::UserHandle> getOwner() { return call_method<"getOwner", jni::ref<android::os::UserHandle>>(); }
	jni::ref<java::util::UUID> getStorageUuid() { return call_method<"getStorageUuid", jni::ref<java::util::UUID>>(); }
	jni::ref<java::lang::String> getUuid() { return call_method<"getUuid", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getMediaStoreVolumeName() { return call_method<"getMediaStoreVolumeName", jni::ref<java::lang::String>>(); }
