...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_NETWORKREQUEST_BUILDER
...
public:
	...
	static jni::ref<android::net::NetworkRequest_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::NetworkRequest_Builder> new_object(jni::ref<android::net::NetworkRequest> request) { return object_base::new_object(request); }
	...
	jni::ref<android::net::NetworkRequest_Builder> setSubscriptionIds(jni::ref<java::util::Set> subIds) { return call_method<"setSubscriptionIds", jni::ref<android::net::NetworkRequest_Builder>>(subIds); }
