...
class VcnGatewayConnectionConfig_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_VCN_VCNGATEWAYCONNECTIONCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::vcn::VcnGatewayConnectionConfig_Builder> new_object(jni::ref<java::lang::String> gatewayConnectionName, jni::ref<android::net::ipsec::ike::IkeTunnelConnectionParams> tunnelConnectionParams) { return object_base::new_object(gatewayConnectionName, tunnelConnectionParams); }
	...
	jni::ref<android::net::vcn::VcnGatewayConnectionConfig_Builder> setSafeModeEnabled(jboolean enabled) { return call_method<"setSafeModeEnabled", jni::ref<android::net::vcn::VcnGatewayConnectionConfig_Builder>>(enabled); }
