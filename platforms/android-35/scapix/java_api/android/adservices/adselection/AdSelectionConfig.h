...
#ifndef SCAPIX_JAVA_API_ANDROID_ADSERVICES_ADSELECTION_ADSELECTIONCONFIG
...
public:
	...
	jni::ref<java::util::Map> getPerBuyerSignedContextualAds() { return call_method<"getPerBuyerSignedContextualAds", jni::ref<java::util::Map>>(); }
