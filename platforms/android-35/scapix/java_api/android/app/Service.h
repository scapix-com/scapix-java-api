...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SERVICE
...
public:
	...
	static jint STOP_FOREGROUND_LEGACY() { return get_static_field<"STOP_FOREGROUND_LEGACY", jint>(); }
	static jint STOP_FOREGROUND_REMOVE() { return get_static_field<"STOP_FOREGROUND_REMOVE", jint>(); }

	static jni::ref<android::app::Service> new_object() { return object_base::new_object(); }
	...
	void stopForeground(jint notificationBehavior) { return call_method<"stopForeground", void>(notificationBehavior); }
	jint getForegroundServiceType() { return call_method<"getForegroundServiceType", jint>(); }
	void onTimeout(jint startId) { return call_method<"onTimeout", void>(startId); }
	void onTimeout(jint startId, jint fgsType) { return call_method<"onTimeout", void>(startId, fgsType); }
};
