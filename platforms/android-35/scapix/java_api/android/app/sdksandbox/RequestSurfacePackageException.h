...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SDKSANDBOX_REQUESTSURFACEPACKAGEEXCEPTION
...
public:
	...
	static jni::ref<android::app::sdksandbox::RequestSurfacePackageException> new_object(jint requestSurfacePackageErrorCode, jni::ref<java::lang::String> message) { return object_base::new_object(requestSurfacePackageErrorCode, message); }
	static jni::ref<android::app::sdksandbox::RequestSurfacePackageException> new_object(jint requestSurfacePackageErrorCode, jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(requestSurfacePackageErrorCode, message, cause); }
	static jni::ref<android::app::sdksandbox::RequestSurfacePackageException> new_object(jint requestSurfacePackageErrorCode, jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause, jni::ref<android::os::Bundle> extraInfo) { return object_base::new_object(requestSurfacePackageErrorCode, message, cause, extraInfo); }
