...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_UIAUTOMATION
...
public:
	...
	static jint FLAG_DONT_USE_ACCESSIBILITY() { return get_static_field<"FLAG_DONT_USE_ACCESSIBILITY", jint>(); }
	...
	void waitForIdle(jlong idleTimeoutMillis, jlong globalTimeoutMillis) { return call_method<"waitForIdle", void>(idleTimeoutMillis, globalTimeoutMillis); }
	jni::ref<android::graphics::Bitmap> takeScreenshot() { return call_method<"takeScreenshot", jni::ref<android::graphics::Bitmap>>(); }
	jni::ref<android::graphics::Bitmap> takeScreenshot(jni::ref<android::view::Window> window) { return call_method<"takeScreenshot", jni::ref<android::graphics::Bitmap>>(window); }
	...
	jni::ref<jni::array<android::os::ParcelFileDescriptor>> executeShellCommandRw(jni::ref<java::lang::String> command) { return call_method<"executeShellCommandRw", jni::ref<jni::array<android::os::ParcelFileDescriptor>>>(command); }
	jni::ref<jni::array<android::os::ParcelFileDescriptor>> executeShellCommandRwe(jni::ref<java::lang::String> command) { return call_method<"executeShellCommandRwe", jni::ref<jni::array<android::os::ParcelFileDescriptor>>>(command); }
