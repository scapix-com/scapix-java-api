...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPSEARCH_APPSEARCHSCHEMA_DOCUMENTPROPERTYCONFIG
...
public:
	...
	jni::ref<java::util::List> getIndexableNestedProperties() { return call_method<"getIndexableNestedProperties", jni::ref<java::util::List>>(); }
};
