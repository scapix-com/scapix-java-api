...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ACTIVITYMANAGER_RUNNINGAPPPROCESSINFO
...
public:
	...
	static jint IMPORTANCE_CANT_SAVE_STATE() { return get_static_field<"IMPORTANCE_CANT_SAVE_STATE", jint>(); }
	...
	static jint IMPORTANCE_TOP_SLEEPING_PRE_28() { return get_static_field<"IMPORTANCE_TOP_SLEEPING_PRE_28", jint>(); }
	...
	static jni::ref<android::app::ActivityManager_RunningAppProcessInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::app::ActivityManager_RunningAppProcessInfo> new_object(jni::ref<java::lang::String> pProcessName, jint pPid, jni::ref<jni::array<java::lang::String>> pArr) { return object_base::new_object(pProcessName, pPid, pArr); }
