...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_NETWORKSCANREQUEST
...
public:
	...
	static jni::ref<android::telephony::NetworkScanRequest> new_object(jint scanType, jni::ref<jni::array<android::telephony::RadioAccessSpecifier>> specifiers, jint searchPeriodicity, jint maxSearchTime, jboolean incrementalResults, jint incrementalResultsPeriodicity, jni::ref<java::util::ArrayList> mccMncs) { return object_base::new_object(scanType, specifiers, searchPeriodicity, maxSearchTime, incrementalResults, incrementalResultsPeriodicity, mccMncs); }
