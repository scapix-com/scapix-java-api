...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CALLAUDIOSTATE
...
public:
	...
	static jni::ref<android::telecom::CallAudioState> new_object(jboolean muted, jint route, jint supportedRouteMask) { return object_base::new_object(muted, route, supportedRouteMask); }
