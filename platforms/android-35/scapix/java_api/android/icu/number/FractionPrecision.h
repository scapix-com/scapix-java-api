...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_NUMBER_FRACTIONPRECISION
...
public:
	...
	jni::ref<android::icu::number::Precision> withSignificantDigits(jint minSignificantDigits, jint maxSignificantDigits, jni::ref<android::icu::number::NumberFormatter_RoundingPriority> priority) { return call_method<"withSignificantDigits", jni::ref<android::icu::number::Precision>>(minSignificantDigits, maxSignificantDigits, priority); }
