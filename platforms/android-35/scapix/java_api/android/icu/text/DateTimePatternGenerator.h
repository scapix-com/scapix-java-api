...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_DATETIMEPATTERNGENERATOR
...
public:
	...
	void setDateTimeFormat(jint style, jni::ref<java::lang::String> dateTimeFormat) { return call_method<"setDateTimeFormat", void>(style, dateTimeFormat); }
	jni::ref<java::lang::String> getDateTimeFormat(jint style) { return call_method<"getDateTimeFormat", jni::ref<java::lang::String>>(style); }
