...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_KEYSTORE_KEYGENPARAMETERSPEC_BUILDER
...
public:
	...
	static jni::ref<android::security::keystore::KeyGenParameterSpec_Builder> new_object(jni::ref<java::lang::String> keystoreAlias, jint purposes) { return object_base::new_object(keystoreAlias, purposes); }
	...
	jni::ref<android::security::keystore::KeyGenParameterSpec_Builder> setMgf1Digests(jni::ref<jni::array<java::lang::String>> mgf1Digests) { return call_method<"setMgf1Digests", jni::ref<android::security::keystore::KeyGenParameterSpec_Builder>>(mgf1Digests); }
