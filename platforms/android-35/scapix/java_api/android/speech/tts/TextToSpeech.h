...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_TTS_TEXTTOSPEECH
...
public:
	...
	static jni::ref<android::speech::tts::TextToSpeech> new_object(jni::ref<android::content::Context> context, jni::ref<android::speech::tts::TextToSpeech_OnInitListener> listener) { return object_base::new_object(context, listener); }
	static jni::ref<android::speech::tts::TextToSpeech> new_object(jni::ref<android::content::Context> context, jni::ref<android::speech::tts::TextToSpeech_OnInitListener> listener, jni::ref<java::lang::String> engine) { return object_base::new_object(context, listener, engine); }
	...
	jint addSpeech(jni::ref<java::lang::CharSequence> text, jni::ref<android::net::Uri> uri) { return call_method<"addSpeech", jint>(text, uri); }
	...
	jint addEarcon(jni::ref<java::lang::String> earcon, jni::ref<android::net::Uri> uri) { return call_method<"addEarcon", jint>(earcon, uri); }
	...
	jint playSilentUtterance(jlong durationInMs, jint queueMode, jni::ref<java::lang::String> utteranceId) { return call_method<"playSilentUtterance", jint>(durationInMs, queueMode, utteranceId); }
	jint playSilence(jlong durationInMs, jint queueMode, jni::ref<java::util::HashMap> params) { return call_method<"playSilence", jint>(durationInMs, queueMode, params); }
	...
	jint synthesizeToFile(jni::ref<java::lang::CharSequence> text, jni::ref<android::os::Bundle> params, jni::ref<android::os::ParcelFileDescriptor> fileDescriptor, jni::ref<java::lang::String> utteranceId) { return call_method<"synthesizeToFile", jint>(text, params, fileDescriptor, utteranceId); }
