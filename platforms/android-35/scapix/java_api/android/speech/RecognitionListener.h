...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_RECOGNITIONLISTENER
...
public:
	...
	void onSegmentResults(jni::ref<android::os::Bundle> segmentResults) { return call_method<"onSegmentResults", void>(segmentResults); }
	void onEndOfSegmentedSession() { return call_method<"onEndOfSegmentedSession", void>(); }
	void onLanguageDetection(jni::ref<android::os::Bundle> results) { return call_method<"onLanguageDetection", void>(results); }
