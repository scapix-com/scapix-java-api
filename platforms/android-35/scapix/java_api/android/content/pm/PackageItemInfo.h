...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_PACKAGEITEMINFO
...
public:
	...
	jboolean isArchived() { return get_field<"isArchived", jboolean>(); }
	void isArchived(jboolean v) { set_field<"isArchived", jboolean>(v); }
	...
	static jni::ref<android::content::pm::PackageItemInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::PackageItemInfo> new_object(jni::ref<android::content::pm::PackageItemInfo> orig) { return object_base::new_object(orig); }
