...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_VERSIONEDPACKAGE
...
public:
	...
	static jni::ref<android::content::pm::VersionedPackage> new_object(jni::ref<java::lang::String> packageName, jint versionCode) { return object_base::new_object(packageName, versionCode); }
	static jni::ref<android::content::pm::VersionedPackage> new_object(jni::ref<java::lang::String> packageName, jlong versionCode) { return object_base::new_object(packageName, versionCode); }
