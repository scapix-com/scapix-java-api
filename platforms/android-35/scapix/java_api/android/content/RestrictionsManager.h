...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RESTRICTIONSMANAGER
...
public:
	...
	jni::ref<java::util::List> getApplicationRestrictionsPerAdmin() { return call_method<"getApplicationRestrictionsPerAdmin", jni::ref<java::util::List>>(); }
