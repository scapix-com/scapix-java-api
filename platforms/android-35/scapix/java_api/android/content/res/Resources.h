...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_RESOURCES
...
#include <scapix/java_api/android/content/res/loader/ResourcesLoader.h>
...
public:
	...
	static jint ID_NULL() { return get_static_field<"ID_NULL", jint>(); }

	static jni::ref<android::content::res::Resources> new_object(jni::ref<android::content::res::AssetManager> assets, jni::ref<android::util::DisplayMetrics> metrics, jni::ref<android::content::res::Configuration> config) { return object_base::new_object(assets, metrics, config); }
	...
	jfloat getFloat(jint id) { return call_method<"getFloat", jfloat>(id); }
	...
	static jint getAttributeSetSourceResId(jni::ref<android::util::AttributeSet> set) { return call_static_method<"getAttributeSetSourceResId", jint>(set); }
	...
	void addLoaders(jni::ref<jni::array<android::content::res::loader::ResourcesLoader>> loaders) { return call_method<"addLoaders", void>(loaders); }
	void removeLoaders(jni::ref<jni::array<android::content::res::loader::ResourcesLoader>> loaders) { return call_method<"removeLoaders", void>(loaders); }
	static void registerResourcePaths(jni::ref<java::lang::String> uniqueId, jni::ref<android::content::pm::ApplicationInfo> appInfo) { return call_static_method<"registerResourcePaths", void>(uniqueId, appInfo); }
};
