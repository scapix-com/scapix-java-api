...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_TYPEDARRAY
...
public:
	...
	jint getSourceResourceId(jint index, jint defaultValue) { return call_method<"getSourceResourceId", jint>(index, defaultValue); }
