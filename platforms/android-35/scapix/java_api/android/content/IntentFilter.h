...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_INTENTFILTER
...
#include <scapix/java_api/android/content/UriRelativeFilterGroup.h>
...
public:
	...
	static jni::ref<android::content::IntentFilter> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::IntentFilter> new_object(jni::ref<java::lang::String> action) { return object_base::new_object(action); }
	static jni::ref<android::content::IntentFilter> new_object(jni::ref<java::lang::String> action, jni::ref<java::lang::String> dataType) { return object_base::new_object(action, dataType); }
	static jni::ref<android::content::IntentFilter> new_object(jni::ref<android::content::IntentFilter> o) { return object_base::new_object(o); }
	...
	void addUriRelativeFilterGroup(jni::ref<android::content::UriRelativeFilterGroup> group) { return call_method<"addUriRelativeFilterGroup", void>(group); }
	jint countUriRelativeFilterGroups() { return call_method<"countUriRelativeFilterGroups", jint>(); }
	jni::ref<android::content::UriRelativeFilterGroup> getUriRelativeFilterGroup(jint index) { return call_method<"getUriRelativeFilterGroup", jni::ref<android::content::UriRelativeFilterGroup>>(index); }
	void clearUriRelativeFilterGroups() { return call_method<"clearUriRelativeFilterGroups", void>(); }
	...
	jni::ref<java::util::function::Predicate> asPredicateWithTypeResolution(jni::ref<android::content::ContentResolver> resolver) { return call_method<"asPredicateWithTypeResolution", jni::ref<java::util::function::Predicate>>(resolver); }
