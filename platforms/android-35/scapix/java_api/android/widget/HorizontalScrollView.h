...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_HORIZONTALSCROLLVIEW
...
public:
	...
	static jni::ref<android::widget::HorizontalScrollView> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::HorizontalScrollView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::widget::HorizontalScrollView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	static jni::ref<android::widget::HorizontalScrollView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes); }
	void setEdgeEffectColor(jint color) { return call_method<"setEdgeEffectColor", void>(color); }
	void setRightEdgeEffectColor(jint color) { return call_method<"setRightEdgeEffectColor", void>(color); }
	void setLeftEdgeEffectColor(jint color) { return call_method<"setLeftEdgeEffectColor", void>(color); }
	jint getLeftEdgeEffectColor() { return call_method<"getLeftEdgeEffectColor", jint>(); }
	jint getRightEdgeEffectColor() { return call_method<"getRightEdgeEffectColor", jint>(); }
