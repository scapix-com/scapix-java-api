...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_TEXTVIEW
...
public:
	...
	static jint FOCUSED_SEARCH_RESULT_INDEX_NONE() { return get_static_field<"FOCUSED_SEARCH_RESULT_INDEX_NONE", jint>(); }

	static jni::ref<android::widget::TextView> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::TextView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::widget::TextView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr) { return object_base::new_object(context, attrs, defStyleAttr); }
	static jni::ref<android::widget::TextView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs, jint defStyleAttr, jint defStyleRes) { return object_base::new_object(context, attrs, defStyleAttr, defStyleRes); }
	...
	void setCompoundDrawableTintBlendMode(jni::ref<android::graphics::BlendMode> blendMode) { return call_method<"setCompoundDrawableTintBlendMode", void>(blendMode); }
	...
	jni::ref<android::graphics::BlendMode> getCompoundDrawableTintBlendMode() { return call_method<"getCompoundDrawableTintBlendMode", jni::ref<android::graphics::BlendMode>>(); }
	...
	void setFirstBaselineToTopHeight(jint firstBaselineToTopHeight) { return call_method<"setFirstBaselineToTopHeight", void>(firstBaselineToTopHeight); }
	void setLastBaselineToBottomHeight(jint lastBaselineToBottomHeight) { return call_method<"setLastBaselineToBottomHeight", void>(lastBaselineToBottomHeight); }
	jint getFirstBaselineToTopHeight() { return call_method<"getFirstBaselineToTopHeight", jint>(); }
	jint getLastBaselineToBottomHeight() { return call_method<"getLastBaselineToBottomHeight", jint>(); }
	jint getAutoLinkMask() { return call_method<"getAutoLinkMask", jint>(); }
	void setTextSelectHandle(jni::ref<android::graphics::drawable::Drawable> textSelectHandle) { return call_method<"setTextSelectHandle", void>(textSelectHandle); }
	void setTextSelectHandle(jint textSelectHandle) { return call_method<"setTextSelectHandle", void>(textSelectHandle); }
	jni::ref<android::graphics::drawable::Drawable> getTextSelectHandle() { return call_method<"getTextSelectHandle", jni::ref<android::graphics::drawable::Drawable>>(); }
	void setTextSelectHandleLeft(jni::ref<android::graphics::drawable::Drawable> textSelectHandleLeft) { return call_method<"setTextSelectHandleLeft", void>(textSelectHandleLeft); }
	void setTextSelectHandleLeft(jint textSelectHandleLeft) { return call_method<"setTextSelectHandleLeft", void>(textSelectHandleLeft); }
	jni::ref<android::graphics::drawable::Drawable> getTextSelectHandleLeft() { return call_method<"getTextSelectHandleLeft", jni::ref<android::graphics::drawable::Drawable>>(); }
	void setTextSelectHandleRight(jni::ref<android::graphics::drawable::Drawable> textSelectHandleRight) { return call_method<"setTextSelectHandleRight", void>(textSelectHandleRight); }
	void setTextSelectHandleRight(jint textSelectHandleRight) { return call_method<"setTextSelectHandleRight", void>(textSelectHandleRight); }
	jni::ref<android::graphics::drawable::Drawable> getTextSelectHandleRight() { return call_method<"getTextSelectHandleRight", jni::ref<android::graphics::drawable::Drawable>>(); }
	void setTextCursorDrawable(jni::ref<android::graphics::drawable::Drawable> textCursorDrawable) { return call_method<"setTextCursorDrawable", void>(textCursorDrawable); }
	void setTextCursorDrawable(jint textCursorDrawable) { return call_method<"setTextCursorDrawable", void>(textCursorDrawable); }
	jni::ref<android::graphics::drawable::Drawable> getTextCursorDrawable() { return call_method<"getTextCursorDrawable", jni::ref<android::graphics::drawable::Drawable>>(); }
	...
	void setFallbackLineSpacing(jboolean enabled) { return call_method<"setFallbackLineSpacing", void>(enabled); }
	void setUseBoundsForWidth(jboolean useBoundsForWidth) { return call_method<"setUseBoundsForWidth", void>(useBoundsForWidth); }
	jboolean getUseBoundsForWidth() { return call_method<"getUseBoundsForWidth", jboolean>(); }
	void setShiftDrawingOffsetForStartOverhang(jboolean shiftDrawingOffsetForStartOverhang) { return call_method<"setShiftDrawingOffsetForStartOverhang", void>(shiftDrawingOffsetForStartOverhang); }
	jboolean getShiftDrawingOffsetForStartOverhang() { return call_method<"getShiftDrawingOffsetForStartOverhang", jboolean>(); }
	void setMinimumFontMetrics(jni::ref<android::graphics::Paint_FontMetrics> minimumFontMetrics) { return call_method<"setMinimumFontMetrics", void>(minimumFontMetrics); }
	jni::ref<android::graphics::Paint_FontMetrics> getMinimumFontMetrics() { return call_method<"getMinimumFontMetrics", jni::ref<android::graphics::Paint_FontMetrics>>(); }
	jboolean isLocalePreferredLineHeightForMinimumUsed() { return call_method<"isLocalePreferredLineHeightForMinimumUsed", jboolean>(); }
	void setLocalePreferredLineHeightForMinimumUsed(jboolean flag) { return call_method<"setLocalePreferredLineHeightForMinimumUsed", void>(flag); }
	...
	void setLineBreakStyle(jint lineBreakStyle) { return call_method<"setLineBreakStyle", void>(lineBreakStyle); }
	void setLineBreakWordStyle(jint lineBreakWordStyle) { return call_method<"setLineBreakWordStyle", void>(lineBreakWordStyle); }
	...
	jni::ref<android::text::PrecomputedText_Params> getTextMetricsParams() { return call_method<"getTextMetricsParams", jni::ref<android::text::PrecomputedText_Params>>(); }
	void setTextMetricsParams(jni::ref<android::text::PrecomputedText_Params> params) { return call_method<"setTextMetricsParams", void>(params); }
	...
	jboolean isHorizontallyScrollable() { return call_method<"isHorizontallyScrollable", jboolean>(); }
	...
	void setLineHeight(jint lineHeight) { return call_method<"setLineHeight", void>(lineHeight); }
	void setLineHeight(jint unit, jfloat lineHeight) { return call_method<"setLineHeight", void>(unit, lineHeight); }
	void setHighlights(jni::ref<android::text::Highlights> highlights) { return call_method<"setHighlights", void>(highlights); }
	jni::ref<android::text::Highlights> getHighlights() { return call_method<"getHighlights", jni::ref<android::text::Highlights>>(); }
	void setSearchResultHighlights(jni::ref<jni::array<jint>> ranges) { return call_method<"setSearchResultHighlights", void>(ranges); }
	jni::ref<jni::array<jint>> getSearchResultHighlights() { return call_method<"getSearchResultHighlights", jni::ref<jni::array<jint>>>(); }
	void setFocusedSearchResultIndex(jint index) { return call_method<"setFocusedSearchResultIndex", void>(index); }
	jint getFocusedSearchResultIndex() { return call_method<"getFocusedSearchResultIndex", jint>(); }
	void setSearchResultHighlightColor(jint color) { return call_method<"setSearchResultHighlightColor", void>(color); }
	jint getSearchResultHighlightColor() { return call_method<"getSearchResultHighlightColor", jint>(); }
	void setFocusedSearchResultHighlightColor(jint color) { return call_method<"setFocusedSearchResultHighlightColor", void>(color); }
	jint getFocusedSearchResultHighlightColor() { return call_method<"getFocusedSearchResultHighlightColor", jint>(); }
	...
	jboolean isSingleLine() { return call_method<"isSingleLine", jboolean>(); }
	...
	jboolean bringPointIntoView(jint offset, jboolean requestRectWithoutFocus) { return call_method<"bringPointIntoView", jboolean>(offset, requestRectWithoutFocus); }
	...
	jni::ref<android::text::TextDirectionHeuristic> getTextDirectionHeuristic() { return call_method<"getTextDirectionHeuristic", jni::ref<android::text::TextDirectionHeuristic>>(); }
