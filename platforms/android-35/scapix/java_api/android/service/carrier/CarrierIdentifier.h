...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CARRIER_CARRIERIDENTIFIER
...
public:
	...
	static jni::ref<android::service::carrier::CarrierIdentifier> new_object(jni::ref<java::lang::String> mcc, jni::ref<java::lang::String> mnc, jni::ref<java::lang::String> spn, jni::ref<java::lang::String> imsi, jni::ref<java::lang::String> gid1, jni::ref<java::lang::String> gid2) { return object_base::new_object(mcc, mnc, spn, imsi, gid1, gid2); }
	static jni::ref<android::service::carrier::CarrierIdentifier> new_object(jni::ref<java::lang::String> mcc, jni::ref<java::lang::String> mnc, jni::ref<java::lang::String> spn, jni::ref<java::lang::String> imsi, jni::ref<java::lang::String> gid1, jni::ref<java::lang::String> gid2, jint carrierid, jint specificCarrierId) { return object_base::new_object(mcc, mnc, spn, imsi, gid1, gid2, carrierid, specificCarrierId); }
	static jni::ref<android::service::carrier::CarrierIdentifier> new_object(jni::ref<jni::array<jbyte>> mccMnc, jni::ref<java::lang::String> gid1, jni::ref<java::lang::String> gid2) { return object_base::new_object(mccMnc, gid1, gid2); }
	...
	jint getSpecificCarrierId() { return call_method<"getSpecificCarrierId", jint>(); }
