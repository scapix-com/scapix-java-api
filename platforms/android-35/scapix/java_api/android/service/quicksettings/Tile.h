...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_QUICKSETTINGS_TILE
...
public:
	...
	jni::ref<android::app::PendingIntent> getActivityLaunchForClick() { return call_method<"getActivityLaunchForClick", jni::ref<android::app::PendingIntent>>(); }
	void setActivityLaunchForClick(jni::ref<android::app::PendingIntent> pendingIntent) { return call_method<"setActivityLaunchForClick", void>(pendingIntent); }
