...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_CONTROLS_CONTROLSPROVIDERSERVICE
...
public:
	...
	static jint CONTROLS_SURFACE_ACTIVITY_PANEL() { return get_static_field<"CONTROLS_SURFACE_ACTIVITY_PANEL", jint>(); }
	static jint CONTROLS_SURFACE_DREAM() { return get_static_field<"CONTROLS_SURFACE_DREAM", jint>(); }
	static jni::ref<java::lang::String> EXTRA_CONTROLS_SURFACE() { return get_static_field<"EXTRA_CONTROLS_SURFACE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::service::controls::ControlsProviderService> new_object() { return object_base::new_object(); }
