...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_NOTIFICATION_ZENPOLICY_BUILDER
...
public:
	...
	static jni::ref<android::service::notification::ZenPolicy_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::service::notification::ZenPolicy_Builder> allowConversations(jint audienceType) { return call_method<"allowConversations", jni::ref<android::service::notification::ZenPolicy_Builder>>(audienceType); }
	...
	jni::ref<android::service::notification::ZenPolicy_Builder> allowPriorityChannels(jboolean allow) { return call_method<"allowPriorityChannels", jni::ref<android::service::notification::ZenPolicy_Builder>>(allow); }
};
