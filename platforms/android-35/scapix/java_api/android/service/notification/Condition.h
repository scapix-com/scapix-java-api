...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_NOTIFICATION_CONDITION
...
public:
	...
	static jint SOURCE_CONTEXT() { return get_static_field<"SOURCE_CONTEXT", jint>(); }
	static jint SOURCE_SCHEDULE() { return get_static_field<"SOURCE_SCHEDULE", jint>(); }
	static jint SOURCE_UNKNOWN() { return get_static_field<"SOURCE_UNKNOWN", jint>(); }
	static jint SOURCE_USER_ACTION() { return get_static_field<"SOURCE_USER_ACTION", jint>(); }
	...
	jint source() { return get_field<"source", jint>(); }
	jint state() { return get_field<"state", jint>(); }
	jni::ref<java::lang::String> summary() { return get_field<"summary", jni::ref<java::lang::String>>(); }

	static jni::ref<android::service::notification::Condition> new_object(jni::ref<android::net::Uri> id, jni::ref<java::lang::String> summary, jint state) { return object_base::new_object(id, summary, state); }
	static jni::ref<android::service::notification::Condition> new_object(jni::ref<android::net::Uri> id, jni::ref<java::lang::String> summary, jint state, jint source) { return object_base::new_object(id, summary, state, source); }
	static jni::ref<android::service::notification::Condition> new_object(jni::ref<android::net::Uri> id, jni::ref<java::lang::String> summary, jni::ref<java::lang::String> line1, jni::ref<java::lang::String> line2, jint icon, jint state, jint flags) { return object_base::new_object(id, summary, line1, line2, icon, state, flags); }
	static jni::ref<android::service::notification::Condition> new_object(jni::ref<android::net::Uri> id, jni::ref<java::lang::String> summary, jni::ref<java::lang::String> line1, jni::ref<java::lang::String> line2, jint icon, jint state, jint source, jint flags) { return object_base::new_object(id, summary, line1, line2, icon, state, source, flags); }
	static jni::ref<android::service::notification::Condition> new_object(jni::ref<android::os::Parcel> source) { return object_base::new_object(source); }
