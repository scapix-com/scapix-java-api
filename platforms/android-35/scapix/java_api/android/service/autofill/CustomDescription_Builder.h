...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_CUSTOMDESCRIPTION_BUILDER
...
public:
	...
	static jni::ref<android::service::autofill::CustomDescription_Builder> new_object(jni::ref<android::widget::RemoteViews> parentPresentation) { return object_base::new_object(parentPresentation); }
	...
	jni::ref<android::service::autofill::CustomDescription_Builder> addOnClickAction(jint id, jni::ref<android::service::autofill::OnClickAction> action) { return call_method<"addOnClickAction", jni::ref<android::service::autofill::CustomDescription_Builder>>(id, action); }
