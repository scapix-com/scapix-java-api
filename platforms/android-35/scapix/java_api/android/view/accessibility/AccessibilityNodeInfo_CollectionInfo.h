...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEINFO_COLLECTIONINFO
#define SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYNODEINFO_COLLECTIONINFO

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/view/accessibility/AccessibilityNodeInfo_CollectionInfo_Builder.h>
...
public:
	...
	using Builder = AccessibilityNodeInfo_CollectionInfo_Builder;
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_CollectionInfo> new_object(jint rowCount, jint columnCount, jboolean hierarchical) { return object_base::new_object(rowCount, columnCount, hierarchical); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_CollectionInfo> new_object(jint rowCount, jint columnCount, jboolean hierarchical, jint selectionMode) { return object_base::new_object(rowCount, columnCount, hierarchical, selectionMode); }
	...
	jint getImportantForAccessibilityItemCount() { return call_method<"getImportantForAccessibilityItemCount", jint>(); }
};
