...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_TRACINGCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::webkit::TracingConfig_Builder> new_object() { return object_base::new_object(); }
