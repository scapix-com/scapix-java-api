...
namespace scapix::java_api { namespace android::provider { class ContactsContract_DataColumns; }}
...
public:
	...
	static jni::ref<java::lang::String> PREFERRED_PHONE_ACCOUNT_COMPONENT_NAME() { return get_static_field<"PREFERRED_PHONE_ACCOUNT_COMPONENT_NAME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PREFERRED_PHONE_ACCOUNT_ID() { return get_static_field<"PREFERRED_PHONE_ACCOUNT_ID", jni::ref<java::lang::String>>(); }
