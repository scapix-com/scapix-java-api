...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_FILES
...
public:
	...
	static jni::ref<android::provider::MediaStore_Files> new_object() { return object_base::new_object(); }
