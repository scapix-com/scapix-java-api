...
#ifndef SCAPIX_JAVA_API_ANDROID_GESTURE_GESTURELIBRARIES
...
public:
	...
	static jni::ref<android::gesture::GestureLibrary> fromFileDescriptor(jni::ref<android::os::ParcelFileDescriptor> pfd) { return call_static_method<"fromFileDescriptor", jni::ref<android::gesture::GestureLibrary>>(pfd); }
