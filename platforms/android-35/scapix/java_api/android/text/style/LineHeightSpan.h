...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_LINEHEIGHTSPAN
...
#include <scapix/java_api/android/text/style/LineHeightSpan_Standard.h>
...
public:
	...
	using Standard = LineHeightSpan_Standard;
