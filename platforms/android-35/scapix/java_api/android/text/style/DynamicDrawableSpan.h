...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_DYNAMICDRAWABLESPAN
...
public:
	...
	static jni::ref<android::text::style::DynamicDrawableSpan> new_object() { return object_base::new_object(); }
