...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_TEXTAPPEARANCESPAN
...
public:
	...
	static jni::ref<android::text::style::TextAppearanceSpan> new_object(jni::ref<android::content::Context> context, jint appearance) { return object_base::new_object(context, appearance); }
	static jni::ref<android::text::style::TextAppearanceSpan> new_object(jni::ref<android::content::Context> context, jint appearance, jint colorList) { return object_base::new_object(context, appearance, colorList); }
	static jni::ref<android::text::style::TextAppearanceSpan> new_object(jni::ref<java::lang::String> family, jint style, jint size, jni::ref<android::content::res::ColorStateList> color, jni::ref<android::content::res::ColorStateList> linkColor) { return object_base::new_object(family, style, size, color, linkColor); }
	static jni::ref<android::text::style::TextAppearanceSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
