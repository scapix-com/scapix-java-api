...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_BIDIFORMATTER
...
public:
	...
	jboolean isRtl(jni::ref<java::lang::CharSequence> str) { return call_method<"isRtl", jboolean>(str); }
	...
	jni::ref<java::lang::CharSequence> unicodeWrap(jni::ref<java::lang::CharSequence> str, jni::ref<android::text::TextDirectionHeuristic> heuristic, jboolean isolate) { return call_method<"unicodeWrap", jni::ref<java::lang::CharSequence>>(str, heuristic, isolate); }
	...
	jni::ref<java::lang::CharSequence> unicodeWrap(jni::ref<java::lang::CharSequence> str, jni::ref<android::text::TextDirectionHeuristic> heuristic) { return call_method<"unicodeWrap", jni::ref<java::lang::CharSequence>>(str, heuristic); }
	...
	jni::ref<java::lang::CharSequence> unicodeWrap(jni::ref<java::lang::CharSequence> str, jboolean isolate) { return call_method<"unicodeWrap", jni::ref<java::lang::CharSequence>>(str, isolate); }
	...
	jni::ref<java::lang::CharSequence> unicodeWrap(jni::ref<java::lang::CharSequence> str) { return call_method<"unicodeWrap", jni::ref<java::lang::CharSequence>>(str); }
};
