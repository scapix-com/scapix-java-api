...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STATICLAYOUT
...
public:
	...
	static jni::ref<android::text::StaticLayout> new_object(jni::ref<java::lang::CharSequence> source, jni::ref<android::text::TextPaint> paint, jint width, jni::ref<android::text::Layout_Alignment> align, jfloat spacingmult, jfloat spacingadd, jboolean includepad) { return object_base::new_object(source, paint, width, align, spacingmult, spacingadd, includepad); }
	static jni::ref<android::text::StaticLayout> new_object(jni::ref<java::lang::CharSequence> source, jint bufstart, jint bufend, jni::ref<android::text::TextPaint> paint, jint outerwidth, jni::ref<android::text::Layout_Alignment> align, jfloat spacingmult, jfloat spacingadd, jboolean includepad) { return object_base::new_object(source, bufstart, bufend, paint, outerwidth, align, spacingmult, spacingadd, includepad); }
	static jni::ref<android::text::StaticLayout> new_object(jni::ref<java::lang::CharSequence> source, jint bufstart, jint bufend, jni::ref<android::text::TextPaint> paint, jint outerwidth, jni::ref<android::text::Layout_Alignment> align, jfloat spacingmult, jfloat spacingadd, jboolean includepad, jni::ref<android::text::TextUtils_TruncateAt> ellipsize, jint ellipsizedWidth) { return object_base::new_object(source, bufstart, bufend, paint, outerwidth, align, spacingmult, spacingadd, includepad, ellipsize, ellipsizedWidth); }
