...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_METHOD_BASEMOVEMENTMETHOD
...
public:
	...
	static jni::ref<android::text::method::BaseMovementMethod> new_object() { return object_base::new_object(); }
