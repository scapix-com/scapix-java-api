...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_TIMESTAMP
...
public:
	...
	static jni::ref<java::security::Timestamp> new_object(jni::ref<java::util::Date> timestamp, jni::ref<java::security::cert::CertPath> signerCertPath) { return object_base::new_object(timestamp, signerCertPath); }
