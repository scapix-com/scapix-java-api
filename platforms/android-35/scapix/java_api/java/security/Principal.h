...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_PRINCIPAL
...
public:
	...
	jboolean implies(jni::ref<javax::security::auth::Subject> subject) { return call_method<"implies", jboolean>(subject); }
};
