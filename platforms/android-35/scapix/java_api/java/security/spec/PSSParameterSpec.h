...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_PSSPARAMETERSPEC
...
public:
	...
	static jni::ref<java::security::spec::PSSParameterSpec> new_object(jni::ref<java::lang::String> mdName, jni::ref<java::lang::String> mgfName, jni::ref<java::security::spec::AlgorithmParameterSpec> mgfSpec, jint saltLen, jint trailerField) { return object_base::new_object(mdName, mgfName, mgfSpec, saltLen, trailerField); }
	static jni::ref<java::security::spec::PSSParameterSpec> new_object(jint saltLen) { return object_base::new_object(saltLen); }
