...
#ifndef SCAPIX_JAVA_API_JAVA_NET_URI
...
public:
	...
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> scheme, jni::ref<java::lang::String> userInfo, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> path, jni::ref<java::lang::String> query, jni::ref<java::lang::String> fragment) { return object_base::new_object(scheme, userInfo, host, port, path, query, fragment); }
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> scheme, jni::ref<java::lang::String> authority, jni::ref<java::lang::String> path, jni::ref<java::lang::String> query, jni::ref<java::lang::String> fragment) { return object_base::new_object(scheme, authority, path, query, fragment); }
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> scheme, jni::ref<java::lang::String> host, jni::ref<java::lang::String> path, jni::ref<java::lang::String> fragment) { return object_base::new_object(scheme, host, path, fragment); }
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> scheme, jni::ref<java::lang::String> ssp, jni::ref<java::lang::String> fragment) { return object_base::new_object(scheme, ssp, fragment); }
	static jni::ref<java::net::URI> create(jni::ref<java::lang::String> str) { return call_static_method<"create", jni::ref<java::net::URI>>(str); }
	...
	jni::ref<java::net::URI> resolve(jni::ref<java::net::URI> uri) { return call_method<"resolve", jni::ref<java::net::URI>>(uri); }
	jni::ref<java::net::URI> resolve(jni::ref<java::lang::String> str) { return call_method<"resolve", jni::ref<java::net::URI>>(str); }
	jni::ref<java::net::URI> relativize(jni::ref<java::net::URI> uri) { return call_method<"relativize", jni::ref<java::net::URI>>(uri); }
	...
	jint compareTo(jni::ref<java::net::URI> that) { return call_method<"compareTo", jint>(that); }
