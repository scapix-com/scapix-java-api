...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_CLOSEDFILESYSTEMEXCEPTION
...
public:
	...
	static jni::ref<java::nio::file::ClosedFileSystemException> new_object() { return object_base::new_object(); }
};
