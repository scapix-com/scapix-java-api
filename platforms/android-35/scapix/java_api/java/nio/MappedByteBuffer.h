...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_MAPPEDBYTEBUFFER
...
public:
	...
	jni::ref<java::nio::MappedByteBuffer> force(jint index, jint length) { return call_method<"force", jni::ref<java::nio::MappedByteBuffer>>(index, length); }
