...
public:
	...
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::lang::Class> keyType) { return object_base::new_object(keyType); }
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::util::EnumMap> m) { return object_base::new_object(m); }
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
