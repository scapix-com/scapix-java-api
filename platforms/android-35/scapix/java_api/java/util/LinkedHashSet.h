...
struct scapix::jni::object_traits<scapix::java_api::java::util::LinkedHashSet>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::HashSet, scapix::java_api::java::util::SequencedSet, scapix::java_api::java::util::Set, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::io::Serializable>;
};
