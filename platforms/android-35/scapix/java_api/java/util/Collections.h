...
public:
	...
	static void shuffle(jni::ref<java::util::List> list, jni::ref<java::util::random::RandomGenerator> rnd) { return call_static_method<"shuffle", void>(list, rnd); }
	...
	static jni::ref<java::util::SequencedCollection> unmodifiableSequencedCollection(jni::ref<java::util::SequencedCollection> c) { return call_static_method<"unmodifiableSequencedCollection", jni::ref<java::util::SequencedCollection>>(c); }
	...
	static jni::ref<java::util::SequencedSet> unmodifiableSequencedSet(jni::ref<java::util::SequencedSet> s) { return call_static_method<"unmodifiableSequencedSet", jni::ref<java::util::SequencedSet>>(s); }
	...
	static jni::ref<java::util::SequencedMap> unmodifiableSequencedMap(jni::ref<java::util::SequencedMap> m) { return call_static_method<"unmodifiableSequencedMap", jni::ref<java::util::SequencedMap>>(m); }
	...
	static jni::ref<java::util::SequencedSet> newSequencedSetFromMap(jni::ref<java::util::SequencedMap> map) { return call_static_method<"newSequencedSetFromMap", jni::ref<java::util::SequencedSet>>(map); }
