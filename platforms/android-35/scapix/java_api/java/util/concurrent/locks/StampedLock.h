...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LOCKS_STAMPEDLOCK
...
public:
	...
	static jni::ref<java::util::concurrent::locks::StampedLock> new_object() { return object_base::new_object(); }
	jlong writeLock() { return call_method<"writeLock", jlong>(); }
	jlong tryWriteLock() { return call_method<"tryWriteLock", jlong>(); }
	jlong tryWriteLock(jlong time, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"tryWriteLock", jlong>(time, unit); }
	...
	jlong tryReadLock(jlong time, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"tryReadLock", jlong>(time, unit); }
