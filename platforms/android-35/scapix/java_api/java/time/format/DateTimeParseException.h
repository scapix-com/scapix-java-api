...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_FORMAT_DATETIMEPARSEEXCEPTION
...
public:
	...
	static jni::ref<java::time::format::DateTimeParseException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::CharSequence> parsedData, jint errorIndex) { return object_base::new_object(message, parsedData, errorIndex); }
	static jni::ref<java::time::format::DateTimeParseException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::CharSequence> parsedData, jint errorIndex, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, parsedData, errorIndex, cause); }
