...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_CERT_CERTIFICATEENCODINGEXCEPTION
...
public:
	...
	static jni::ref<javax::security::cert::CertificateEncodingException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::security::cert::CertificateEncodingException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
