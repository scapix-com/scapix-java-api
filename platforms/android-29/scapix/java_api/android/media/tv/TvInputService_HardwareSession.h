...
class TvInputService_HardwareSession;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVINPUTSERVICE_HARDWARESESSION
...
public:
	...
	static jni::ref<android::media::tv::TvInputService_HardwareSession> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
