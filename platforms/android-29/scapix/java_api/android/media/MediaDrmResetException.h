...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIADRMRESETEXCEPTION
...
public:
	...
	static jni::ref<android::media::MediaDrmResetException> new_object(jni::ref<java::lang::String> detailMessage) { return object_base::new_object(detailMessage); }
};
