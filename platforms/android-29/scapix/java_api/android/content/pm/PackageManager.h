...
public:
	...
	jboolean addWhitelistedRestrictedPermission(jni::ref<java::lang::String> packageName, jni::ref<java::lang::String> permission, jint whitelistFlags) { return call_method<"addWhitelistedRestrictedPermission", jboolean>(packageName, permission, whitelistFlags); }
	jboolean removeWhitelistedRestrictedPermission(jni::ref<java::lang::String> packageName, jni::ref<java::lang::String> permission, jint whitelistFlags) { return call_method<"removeWhitelistedRestrictedPermission", jboolean>(packageName, permission, whitelistFlags); }
