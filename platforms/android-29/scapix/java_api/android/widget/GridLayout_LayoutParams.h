...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_GRIDLAYOUT_LAYOUTPARAMS
...
public:
	...
	static jni::ref<android::widget::GridLayout_LayoutParams> new_object(jni::ref<android::widget::GridLayout_Spec> rowSpec, jni::ref<android::widget::GridLayout_Spec> columnSpec) { return object_base::new_object(rowSpec, columnSpec); }
	static jni::ref<android::widget::GridLayout_LayoutParams> new_object() { return object_base::new_object(); }
	static jni::ref<android::widget::GridLayout_LayoutParams> new_object(jni::ref<android::view::ViewGroup_LayoutParams> params) { return object_base::new_object(params); }
	static jni::ref<android::widget::GridLayout_LayoutParams> new_object(jni::ref<android::view::ViewGroup_MarginLayoutParams> params) { return object_base::new_object(params); }
	static jni::ref<android::widget::GridLayout_LayoutParams> new_object(jni::ref<android::widget::GridLayout_LayoutParams> source) { return object_base::new_object(source); }
	static jni::ref<android::widget::GridLayout_LayoutParams> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
