...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_SIMPLEEXPANDABLELISTADAPTER
...
public:
	...
	static jni::ref<android::widget::SimpleExpandableListAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<java::util::List> groupData, jint groupLayout, jni::ref<jni::array<java::lang::String>> groupFrom, jni::ref<jni::array<jint>> groupTo, jni::ref<java::util::List> childData, jint childLayout, jni::ref<jni::array<java::lang::String>> childFrom, jni::ref<jni::array<jint>> childTo) { return object_base::new_object(context, groupData, groupLayout, groupFrom, groupTo, childData, childLayout, childFrom, childTo); }
	static jni::ref<android::widget::SimpleExpandableListAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<java::util::List> groupData, jint expandedGroupLayout, jint collapsedGroupLayout, jni::ref<jni::array<java::lang::String>> groupFrom, jni::ref<jni::array<jint>> groupTo, jni::ref<java::util::List> childData, jint childLayout, jni::ref<jni::array<java::lang::String>> childFrom, jni::ref<jni::array<jint>> childTo) { return object_base::new_object(context, groupData, expandedGroupLayout, collapsedGroupLayout, groupFrom, groupTo, childData, childLayout, childFrom, childTo); }
	static jni::ref<android::widget::SimpleExpandableListAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<java::util::List> groupData, jint expandedGroupLayout, jint collapsedGroupLayout, jni::ref<jni::array<java::lang::String>> groupFrom, jni::ref<jni::array<jint>> groupTo, jni::ref<java::util::List> childData, jint childLayout, jint lastChildLayout, jni::ref<jni::array<java::lang::String>> childFrom, jni::ref<jni::array<jint>> childTo) { return object_base::new_object(context, groupData, expandedGroupLayout, collapsedGroupLayout, groupFrom, groupTo, childData, childLayout, lastChildLayout, childFrom, childTo); }
