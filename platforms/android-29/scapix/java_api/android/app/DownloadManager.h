...
public:
	...
	jlong addCompletedDownload(jni::ref<java::lang::String> title, jni::ref<java::lang::String> description, jboolean isMediaScannerScannable, jni::ref<java::lang::String> mimeType, jni::ref<java::lang::String> path, jlong length, jboolean p7, jni::ref<android::net::Uri> showNotification, jni::ref<android::net::Uri> uri) { return call_method<"addCompletedDownload", jlong>(title, description, isMediaScannerScannable, mimeType, path, length, p7, showNotification, uri); }
