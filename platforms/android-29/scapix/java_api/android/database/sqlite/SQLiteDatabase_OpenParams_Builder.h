...
class SQLiteDatabase_OpenParams_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_SQLITE_SQLITEDATABASE_OPENPARAMS_BUILDER
...
public:
	...
	static jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams_Builder> new_object(jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams> params) { return object_base::new_object(params); }
	...
	jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams_Builder> setJournalMode(jni::ref<java::lang::String> journalMode) { return call_method<"setJournalMode", jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams_Builder>>(journalMode); }
	jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams_Builder> setSynchronousMode(jni::ref<java::lang::String> syncMode) { return call_method<"setSynchronousMode", jni::ref<android::database::sqlite::SQLiteDatabase_OpenParams_Builder>>(syncMode); }
