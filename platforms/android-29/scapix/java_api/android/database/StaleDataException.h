...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_STALEDATAEXCEPTION
...
public:
	...
	static jni::ref<android::database::StaleDataException> new_object() { return object_base::new_object(); }
	static jni::ref<android::database::StaleDataException> new_object(jni::ref<java::lang::String> description) { return object_base::new_object(description); }
};
