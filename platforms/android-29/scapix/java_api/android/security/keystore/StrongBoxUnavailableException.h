...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_KEYSTORE_STRONGBOXUNAVAILABLEEXCEPTION
...
public:
	...
	static jni::ref<android::security::keystore::StrongBoxUnavailableException> new_object() { return object_base::new_object(); }
	static jni::ref<android::security::keystore::StrongBoxUnavailableException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<android::security::keystore::StrongBoxUnavailableException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
	static jni::ref<android::security::keystore::StrongBoxUnavailableException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
};
