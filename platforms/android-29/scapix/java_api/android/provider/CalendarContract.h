...
public:
	...
	static jboolean startViewCalendarEventInManagedProfile(jni::ref<android::content::Context> context, jlong eventId, jlong p3, jlong startMs, jboolean p5, jint endMs) { return call_static_method<"startViewCalendarEventInManagedProfile", jboolean>(context, eventId, p3, startMs, p5, endMs); }
