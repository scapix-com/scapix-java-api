...
class MediaStore_Video_Thumbnails;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_VIDEO_THUMBNAILS
...
public:
	...
	static jni::ref<android::provider::MediaStore_Video_Thumbnails> new_object() { return object_base::new_object(); }
	...
	static jni::ref<android::graphics::Bitmap> getThumbnail(jni::ref<android::content::ContentResolver> cr, jlong videoId, jint kind, jni::ref<android::graphics::BitmapFactory_Options> options) { return call_static_method<"getThumbnail", jni::ref<android::graphics::Bitmap>>(cr, videoId, kind, options); }
	static void cancelThumbnailRequest(jni::ref<android::content::ContentResolver> cr, jlong videoId, jlong groupId) { return call_static_method<"cancelThumbnailRequest", void>(cr, videoId, groupId); }
	static jni::ref<android::graphics::Bitmap> getThumbnail(jni::ref<android::content::ContentResolver> cr, jlong videoId, jlong groupId, jint kind, jni::ref<android::graphics::BitmapFactory_Options> options) { return call_static_method<"getThumbnail", jni::ref<android::graphics::Bitmap>>(cr, videoId, groupId, kind, options); }
