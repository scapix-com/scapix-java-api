...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_HOTSPOT2_PPS_CREDENTIAL
...
public:
	...
	static jni::ref<android::net::wifi::hotspot2::pps::Credential> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::hotspot2::pps::Credential> new_object(jni::ref<android::net::wifi::hotspot2::pps::Credential> source) { return object_base::new_object(source); }
