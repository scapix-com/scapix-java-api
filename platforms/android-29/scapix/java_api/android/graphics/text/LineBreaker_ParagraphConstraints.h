...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_TEXT_LINEBREAKER_PARAGRAPHCONSTRAINTS
...
public:
	...
	static jni::ref<android::graphics::text::LineBreaker_ParagraphConstraints> new_object() { return object_base::new_object(); }
