...
namespace scapix::java_api { namespace android::graphics::drawable { class ShapeDrawable; }}
...
public:
	...
	static jni::ref<android::graphics::drawable::ShapeDrawable> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::drawable::ShapeDrawable> new_object(jni::ref<android::graphics::drawable::shapes::Shape> s) { return object_base::new_object(s); }
