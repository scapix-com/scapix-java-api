...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_INPUTCONTENTINFO
...
public:
	...
	static jni::ref<android::view::inputmethod::InputContentInfo> new_object(jni::ref<android::net::Uri> contentUri, jni::ref<android::content::ClipDescription> description) { return object_base::new_object(contentUri, description); }
	static jni::ref<android::view::inputmethod::InputContentInfo> new_object(jni::ref<android::net::Uri> contentUri, jni::ref<android::content::ClipDescription> description, jni::ref<android::net::Uri> linkUri) { return object_base::new_object(contentUri, description, linkUri); }
