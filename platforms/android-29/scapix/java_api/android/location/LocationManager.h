...
public:
	...
	void requestLocationUpdates(jni::ref<java::lang::String> provider, jlong minTime, jfloat minDistance, jni::ref<android::location::LocationListener> listener) { return call_method<"requestLocationUpdates", void>(provider, minTime, minDistance, listener); }
	void requestLocationUpdates(jni::ref<java::lang::String> provider, jlong minTime, jfloat minDistance, jni::ref<android::location::LocationListener> listener, jni::ref<android::os::Looper> looper) { return call_method<"requestLocationUpdates", void>(provider, minTime, minDistance, listener, looper); }
	void requestLocationUpdates(jlong minTime, jfloat minDistance, jni::ref<android::location::Criteria> criteria, jni::ref<android::location::LocationListener> listener, jni::ref<android::os::Looper> looper) { return call_method<"requestLocationUpdates", void>(minTime, minDistance, criteria, listener, looper); }
	void requestLocationUpdates(jni::ref<java::lang::String> provider, jlong minTime, jfloat minDistance, jni::ref<android::app::PendingIntent> intent) { return call_method<"requestLocationUpdates", void>(provider, minTime, minDistance, intent); }
	void requestLocationUpdates(jlong minTime, jfloat minDistance, jni::ref<android::location::Criteria> criteria, jni::ref<android::app::PendingIntent> intent) { return call_method<"requestLocationUpdates", void>(minTime, minDistance, criteria, intent); }
