...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSMEASUREMENTSEVENT_CALLBACK
...
public:
	...
	static jni::ref<android::location::GnssMeasurementsEvent_Callback> new_object() { return object_base::new_object(); }
