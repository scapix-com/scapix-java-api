...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_SPARSEARRAY
...
public:
	...
	static jni::ref<android::util::SparseArray> new_object() { return object_base::new_object(); }
	static jni::ref<android::util::SparseArray> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
