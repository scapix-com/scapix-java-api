...
public:
	...
	static jni::ref<android::hardware::camera2::CaptureResult_Key> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type) { return base_::new_object(name, type); }
