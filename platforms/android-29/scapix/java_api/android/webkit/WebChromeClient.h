...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_WEBCHROMECLIENT
...
public:
	...
	static jni::ref<android::webkit::WebChromeClient> new_object() { return object_base::new_object(); }
	...
	void onExceededDatabaseQuota(jni::ref<java::lang::String> url, jni::ref<java::lang::String> databaseIdentifier, jlong quota, jlong estimatedDatabaseSize, jlong totalQuota, jni::ref<android::webkit::WebStorage_QuotaUpdater> quotaUpdater) { return call_method<"onExceededDatabaseQuota", void>(url, databaseIdentifier, quota, estimatedDatabaseSize, totalQuota, quotaUpdater); }
	void onReachedMaxAppCacheSize(jlong requiredStorage, jlong quota, jni::ref<android::webkit::WebStorage_QuotaUpdater> quotaUpdater) { return call_method<"onReachedMaxAppCacheSize", void>(requiredStorage, quota, quotaUpdater); }
