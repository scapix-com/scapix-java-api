...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_ALLOCATION
...
public:
	...
	static jni::ref<jni::array<android::renderscript::Allocation>> createAllocations(jni::ref<android::renderscript::RenderScript> rs, jni::ref<android::renderscript::Type> t, jint usage, jint numAlloc) { return call_static_method<"createAllocations", jni::ref<jni::array<android::renderscript::Allocation>>>(rs, t, usage, numAlloc); }
	jlong getStride() { return call_method<"getStride", jlong>(); }
