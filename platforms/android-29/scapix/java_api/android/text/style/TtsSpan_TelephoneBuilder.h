...
class TtsSpan_TelephoneBuilder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_TTSSPAN_TELEPHONEBUILDER
...
public:
	...
	static jni::ref<android::text::style::TtsSpan_TelephoneBuilder> new_object() { return object_base::new_object(); }
	static jni::ref<android::text::style::TtsSpan_TelephoneBuilder> new_object(jni::ref<java::lang::String> numberParts) { return object_base::new_object(numberParts); }
