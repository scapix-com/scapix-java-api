...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_TEXTUTILS
...
public:
	...
	static jint SAFE_STRING_FLAG_FIRST_LINE() { return get_static_field<"SAFE_STRING_FLAG_FIRST_LINE", jint>(); }
	static jint SAFE_STRING_FLAG_SINGLE_LINE() { return get_static_field<"SAFE_STRING_FLAG_SINGLE_LINE", jint>(); }
	static jint SAFE_STRING_FLAG_TRIM() { return get_static_field<"SAFE_STRING_FLAG_TRIM", jint>(); }
	...
	static jni::ref<java::lang::CharSequence> makeSafeForPresentation(jni::ref<java::lang::String> unclean, jint maxCharactersToConsider, jfloat ellipsizeDip, jint flags) { return call_static_method<"makeSafeForPresentation", jni::ref<java::lang::CharSequence>>(unclean, maxCharactersToConsider, ellipsizeDip, flags); }
};
