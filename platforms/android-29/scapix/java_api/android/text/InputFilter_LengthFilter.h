...
class InputFilter_LengthFilter;
...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_INPUTFILTER_LENGTHFILTER
...
public:
	...
	static jni::ref<android::text::InputFilter_LengthFilter> new_object(jint max) { return object_base::new_object(max); }
