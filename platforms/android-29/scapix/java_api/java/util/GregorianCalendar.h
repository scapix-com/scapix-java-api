...
public:
	...
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::TimeZone> zone) { return object_base::new_object(zone); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::Locale> aLocale) { return object_base::new_object(aLocale); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::TimeZone> zone, jni::ref<java::util::Locale> aLocale) { return object_base::new_object(zone, aLocale); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint year, jint month, jint dayOfMonth) { return object_base::new_object(year, month, dayOfMonth); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint year, jint month, jint dayOfMonth, jint hourOfDay, jint minute) { return object_base::new_object(year, month, dayOfMonth, hourOfDay, minute); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint year, jint month, jint dayOfMonth, jint hourOfDay, jint minute, jint second) { return object_base::new_object(year, month, dayOfMonth, hourOfDay, minute, second); }
