...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_FUNCTION_BINARYOPERATOR
...
public:
	...
	static jni::ref<java::util::function::BinaryOperator> minBy(jni::ref<java::util::Comparator> comparator) { return call_static_method<"minBy", jni::ref<java::util::function::BinaryOperator>>(comparator); }
	static jni::ref<java::util::function::BinaryOperator> maxBy(jni::ref<java::util::Comparator> comparator) { return call_static_method<"maxBy", jni::ref<java::util::function::BinaryOperator>>(comparator); }
};
