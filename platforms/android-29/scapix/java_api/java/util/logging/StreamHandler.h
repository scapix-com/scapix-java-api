...
public:
	...
	static jni::ref<java::util::logging::StreamHandler> new_object(jni::ref<java::io::OutputStream> out, jni::ref<java::util::logging::Formatter> formatter) { return base_::new_object(out, formatter); }
