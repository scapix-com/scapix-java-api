...
public:
	...
	static jni::ref<javax::net::ssl::KeyStoreBuilderParameters> new_object(jni::ref<java::security::KeyStore_Builder> builder) { return base_::new_object(builder); }
	static jni::ref<javax::net::ssl::KeyStoreBuilderParameters> new_object(jni::ref<java::util::List> parameters) { return base_::new_object(parameters); }
