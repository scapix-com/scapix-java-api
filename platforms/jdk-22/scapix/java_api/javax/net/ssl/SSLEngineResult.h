...
public:
	...
	static jni::ref<javax::net::ssl::SSLEngineResult> new_object(jni::ref<javax::net::ssl::SSLEngineResult_Status> status, jni::ref<javax::net::ssl::SSLEngineResult_HandshakeStatus> handshakeStatus, jint bytesConsumed, jint bytesProduced, jlong sequenceNumber) { return base_::new_object(status, handshakeStatus, bytesConsumed, bytesProduced, sequenceNumber); }
