...
public:
	...
	static jni::ref<java::security::spec::RSAKeyGenParameterSpec> new_object(jint keysize, jni::ref<java::math::BigInteger> publicExponent, jni::ref<java::security::spec::AlgorithmParameterSpec> keyParams) { return base_::new_object(keysize, publicExponent, keyParams); }
