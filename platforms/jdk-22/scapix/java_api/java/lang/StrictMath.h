...
public:
	...
	static jlong divideExact(jlong x, jlong p2) { return call_static_method<"divideExact", jlong>(x, p2); }
	static jint floorDivExact(jint x, jint y) { return call_static_method<"floorDivExact", jint>(x, y); }
	static jlong floorDivExact(jlong x, jlong p2) { return call_static_method<"floorDivExact", jlong>(x, p2); }
	static jint ceilDivExact(jint x, jint y) { return call_static_method<"ceilDivExact", jint>(x, y); }
	static jlong ceilDivExact(jlong x, jlong p2) { return call_static_method<"ceilDivExact", jlong>(x, p2); }
	...
	static jlong unsignedMultiplyHigh(jlong x, jlong p2) { return call_static_method<"unsignedMultiplyHigh", jlong>(x, p2); }
	...
	static jlong ceilDiv(jlong x, jint p2) { return call_static_method<"ceilDiv", jlong>(x, p2); }
	static jlong ceilDiv(jlong x, jlong p2) { return call_static_method<"ceilDiv", jlong>(x, p2); }
	static jint ceilMod(jint x, jint y) { return call_static_method<"ceilMod", jint>(x, y); }
	static jint ceilMod(jlong x, jint p2) { return call_static_method<"ceilMod", jint>(x, p2); }
	static jlong ceilMod(jlong x, jlong p2) { return call_static_method<"ceilMod", jlong>(x, p2); }
	...
	static jint clamp(jlong value, jint p2, jint min) { return call_static_method<"clamp", jint>(value, p2, min); }
	static jlong clamp(jlong value, jlong p2, jlong min) { return call_static_method<"clamp", jlong>(value, p2, min); }
	static jdouble clamp(jdouble value, jdouble p2, jdouble min) { return call_static_method<"clamp", jdouble>(value, p2, min); }
