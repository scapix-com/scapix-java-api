...
public:
	...
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> reason, jni::ref<java::lang::Throwable> cause) { return base_::new_object(reason, cause); }
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> cname, jni::ref<java::lang::String> reason, jni::ref<java::lang::Throwable> cause) { return base_::new_object(cname, reason, cause); }
