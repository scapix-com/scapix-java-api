...
public:
	...
	static jni::ref<java::io::RandomAccessFile> new_object(jni::ref<java::lang::String> pathname, jni::ref<java::lang::String> mode) { return base_::new_object(pathname, mode); }
