...
public:
	...
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> str) { return base_::new_object(str); }
	...
	static jni::ref<java::net::URI> new_object(jni::ref<java::lang::String> scheme, jni::ref<java::lang::String> ssp, jni::ref<java::lang::String> fragment) { return base_::new_object(scheme, ssp, fragment); }
