...
public:
	...
	static jni::ref<java::util::zip::ZipFile_Source_Key> new_object(jni::ref<java::io::File> file, jni::ref<java::nio::file::attribute::BasicFileAttributes> attrs, jni::ref<java::util::zip::ZipCoder> zc) { return base_::new_object(file, attrs, zc); }
