...
public:
	...
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> str, jni::ref<java::lang::String> delim, jboolean returnDelims) { return base_::new_object(str, delim, returnDelims); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> str, jni::ref<java::lang::String> delim) { return base_::new_object(str, delim); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> str) { return base_::new_object(str); }
