...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST_REVERSED_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST_REVERSED_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::util::concurrent { class CopyOnWriteArrayList_Reversed; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::CopyOnWriteArrayList_Reversed>
{
	static constexpr fixed_string class_name = "java/util/concurrent/CopyOnWriteArrayList$Reversed";
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST_REVERSED_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST_REVERSED)
#define SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST_REVERSED
...
// private
class java::util::concurrent::CopyOnWriteArrayList_Reversed : public jni::object_base<"java/util/concurrent/CopyOnWriteArrayList$Reversed",
	java::lang::Object,
	java::util::List,
...
protected:
	...
	CopyOnWriteArrayList_Reversed(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYLIST_REVERSED
