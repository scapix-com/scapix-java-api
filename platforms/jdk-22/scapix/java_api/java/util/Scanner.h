...
public:
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> source, jni::ref<java::nio::charset::Charset> charset) { return base_::new_object(source, charset); }
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> source, jni::ref<java::nio::charset::Charset> charset) { return base_::new_object(source, charset); }
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::file::Path> source, jni::ref<java::nio::charset::Charset> charset) { return base_::new_object(source, charset); }
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> source, jni::ref<java::nio::charset::Charset> charset) { return base_::new_object(source, charset); }
