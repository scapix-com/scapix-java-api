...
namespace scapix::java_api::sun::nio::cs { class ISO_8859_2; }
...
public:
	...
	static jni::ref<sun::nio::cs::ISO_8859_2> new_object() { return base_::new_object(); }
...
protected:
	...
	ISO_8859_2(handle_type h) : base_(h) {}
