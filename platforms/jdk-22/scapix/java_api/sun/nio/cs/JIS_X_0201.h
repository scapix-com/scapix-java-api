...
namespace scapix::java_api::sun::nio::cs { class JIS_X_0201; }
...
public:
	...
	static jni::ref<sun::nio::cs::JIS_X_0201> new_object() { return base_::new_object(); }
...
protected:
	...
	JIS_X_0201(handle_type h) : base_(h) {}
