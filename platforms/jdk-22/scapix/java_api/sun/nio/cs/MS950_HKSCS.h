...
namespace scapix::java_api::sun::nio::cs { class MS950_HKSCS; }
...
public:
	...
	static jni::ref<sun::nio::cs::MS950_HKSCS> new_object() { return base_::new_object(); }
...
protected:
	...
	MS950_HKSCS(handle_type h) : base_(h) {}
