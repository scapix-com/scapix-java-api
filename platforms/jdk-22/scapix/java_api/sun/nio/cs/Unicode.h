...
public:
	...
	static jni::ref<sun::nio::cs::Unicode> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<java::lang::String>> aliases) { return base_::new_object(name, aliases); }
