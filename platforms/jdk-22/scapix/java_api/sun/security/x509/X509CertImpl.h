...
public:
	...
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::x509::X509CertInfo> info, jni::ref<sun::security::x509::AlgorithmId> algId, jni::ref<jni::array<jbyte>> signature, jni::ref<jni::array<jbyte>> signedCert) { return base_::new_object(info, algId, signature, signedCert); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<jni::array<jbyte>> certData) { return base_::new_object(certData); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::util::DerValue> derVal) { return base_::new_object(derVal); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<java::io::InputStream> in) { return base_::new_object(in); }
