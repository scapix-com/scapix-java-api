...
public:
	...
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X509CRLImpl_TBSCertList> info, jni::ref<sun::security::x509::AlgorithmId> sigAlgId, jni::ref<jni::array<jbyte>> signature, jni::ref<jni::array<jbyte>> tbsCertList, jni::ref<jni::array<jbyte>> signedCRL) { return base_::new_object(info, sigAlgId, signature, tbsCertList, signedCRL); }
