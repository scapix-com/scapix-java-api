...
public:
	...
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<jni::array<jbyte>> octetString) { return base_::new_object(octetString); }
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<sun::security::util::DerValue> val) { return base_::new_object(val); }
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<java::security::PublicKey> pubKey) { return base_::new_object(pubKey); }
