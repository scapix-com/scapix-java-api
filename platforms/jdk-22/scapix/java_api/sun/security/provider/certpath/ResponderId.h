...
public:
	...
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<javax::security::auth::x500::X500Principal> subjectName) { return base_::new_object(subjectName); }
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<java::security::PublicKey> pubKey) { return base_::new_object(pubKey); }
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<jni::array<jbyte>> encodedData) { return base_::new_object(encodedData); }
