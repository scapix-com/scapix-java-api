...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLALGORITHMCONSTRAINTS_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLALGORITHMCONSTRAINTS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::security::ssl { class SSLAlgorithmConstraints; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::SSLAlgorithmConstraints>
{
	static constexpr fixed_string class_name = "sun/security/ssl/SSLAlgorithmConstraints";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::security::AlgorithmConstraints>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLALGORITHMCONSTRAINTS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLALGORITHMCONSTRAINTS)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLALGORITHMCONSTRAINTS
...
// private
class sun::security::ssl::SSLAlgorithmConstraints : public jni::object_base<"sun/security/ssl/SSLAlgorithmConstraints",
	java::lang::Object,
...
protected:
	...
	SSLAlgorithmConstraints(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLALGORITHMCONSTRAINTS
