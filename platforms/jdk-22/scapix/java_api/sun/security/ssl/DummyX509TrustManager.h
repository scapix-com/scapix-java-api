...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509TRUSTMANAGER_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509TRUSTMANAGER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::security::ssl { class DummyX509TrustManager; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::DummyX509TrustManager>
{
	static constexpr fixed_string class_name = "sun/security/ssl/DummyX509TrustManager";
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509TRUSTMANAGER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509TRUSTMANAGER)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509TRUSTMANAGER
...
// private
class sun::security::ssl::DummyX509TrustManager : public jni::object_base<"sun/security/ssl/DummyX509TrustManager",
...
protected:
	...
	DummyX509TrustManager(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509TRUSTMANAGER
