...
public:
	...
	static jni::ref<sun::net::www::protocol::http::AuthenticationInfo> new_object(jchar type, jni::ref<sun::net::www::protocol::http::AuthScheme> authScheme, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm) { return base_::new_object(type, authScheme, host, port, realm); }
	jni::ref<java::lang::Object> clone() { return call_method<"clone", jni::ref<java::lang::Object>>(); }
	static jni::ref<sun::net::www::protocol::http::AuthenticationInfo> new_object(jchar type, jni::ref<sun::net::www::protocol::http::AuthScheme> authScheme, jni::ref<java::net::URL> url, jni::ref<java::lang::String> realm) { return base_::new_object(type, authScheme, url, realm); }
