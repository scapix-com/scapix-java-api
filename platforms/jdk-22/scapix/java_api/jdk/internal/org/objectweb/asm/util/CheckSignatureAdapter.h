...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckSignatureAdapter> new_object(jint type, jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> signatureVisitor) { return base_::new_object(type, signatureVisitor); }
