...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_::signature { class SignatureWriter; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureWriter> new_object() { return base_::new_object(); }
...
protected:
	...
	SignatureWriter(handle_type h) : base_(h) {}
