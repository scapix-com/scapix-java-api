...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_::util { class CheckClassAdapter; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor) { return base_::new_object(classVisitor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor, jboolean checkDataFlow) { return base_::new_object(classVisitor, checkDataFlow); }
...
protected:
	...
	CheckClassAdapter(handle_type h) : base_(h) {}
