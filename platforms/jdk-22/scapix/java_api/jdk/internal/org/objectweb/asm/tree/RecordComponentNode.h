...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_::tree { class RecordComponentNode; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::RecordComponentNode> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature) { return base_::new_object(name, descriptor, signature); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::RecordComponentNode> new_object(jint api, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature) { return base_::new_object(api, name, descriptor, signature); }
...
protected:
	...
	RecordComponentNode(handle_type h) : base_(h) {}
