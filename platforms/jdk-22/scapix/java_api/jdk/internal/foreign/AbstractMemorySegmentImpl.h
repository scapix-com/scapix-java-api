...
public:
	...
	jni::ref<java::lang::String> getString(jlong offset, jni::ref<java::nio::charset::Charset> p2) { return call_method<"getString", jni::ref<java::lang::String>>(offset, p2); }
	void setString(jlong offset, jni::ref<java::lang::String> p2) { return call_method<"setString", void>(offset, p2); }
	void setString(jlong offset, jni::ref<java::lang::String> p2, jni::ref<java::nio::charset::Charset> str) { return call_method<"setString", void>(offset, p2, str); }
