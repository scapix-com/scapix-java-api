...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEDOUBLEFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEDOUBLEFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class MethodHandleDoubleFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::MethodHandleDoubleFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/MethodHandleDoubleFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::MethodHandleFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEDOUBLEFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEDOUBLEFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEDOUBLEFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::MethodHandleDoubleFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/MethodHandleDoubleFieldAccessorImpl",
...
protected:
	...
	MethodHandleDoubleFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEDOUBLEFIELDACCESSORIMPL
