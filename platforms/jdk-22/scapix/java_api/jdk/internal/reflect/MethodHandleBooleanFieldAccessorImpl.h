...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEBOOLEANFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEBOOLEANFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class MethodHandleBooleanFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::MethodHandleBooleanFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/MethodHandleBooleanFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::MethodHandleFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEBOOLEANFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEBOOLEANFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEBOOLEANFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::MethodHandleBooleanFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/MethodHandleBooleanFieldAccessorImpl",
...
protected:
	...
	MethodHandleBooleanFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEBOOLEANFIELDACCESSORIMPL
