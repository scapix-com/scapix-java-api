...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEINTEGERFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEINTEGERFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class MethodHandleIntegerFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::MethodHandleIntegerFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/MethodHandleIntegerFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::MethodHandleFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEINTEGERFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEINTEGERFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEINTEGERFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::MethodHandleIntegerFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/MethodHandleIntegerFieldAccessorImpl",
...
protected:
	...
	MethodHandleIntegerFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLEINTEGERFIELDACCESSORIMPL
