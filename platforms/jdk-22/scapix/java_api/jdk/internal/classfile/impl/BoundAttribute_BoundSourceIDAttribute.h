...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundSourceIDAttribute> new_object(jni::ref<java::lang::classfile::ClassReader> cf, jni::ref<java::lang::classfile::AttributeMapper> mapper, jint pos) { return base_::new_object(cf, mapper, pos); }
