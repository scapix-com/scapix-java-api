...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::SignaturesImpl_TypeArgImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::Signature_TypeArg>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_TypeArgImpl> new_object(jni::ref<java::lang::classfile::Signature_TypeArg_WildcardIndicator> wildcardIndicator, jni::ref<java::util::Optional> boundType) { return base_::new_object(wildcardIndicator, boundType); }
