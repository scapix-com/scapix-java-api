...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_BoundArgumentConstantInstruction> new_object(jni::ref<java::lang::classfile::Opcode> op, jni::ref<jdk::internal::classfile::impl::CodeImpl> code, jint pos) { return base_::new_object(op, code, pos); }
