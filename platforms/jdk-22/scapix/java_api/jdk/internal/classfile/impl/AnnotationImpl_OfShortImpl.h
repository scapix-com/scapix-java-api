...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfShortImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfConstantImpl, scapix::java_api::java::lang::classfile::AnnotationValue_OfShort>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfShortImpl> new_object(jni::ref<java::lang::classfile::constantpool::IntegerEntry> constant) { return base_::new_object(constant); }
