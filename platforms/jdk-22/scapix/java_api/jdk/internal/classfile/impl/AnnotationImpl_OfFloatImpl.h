...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfFloatImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfConstantImpl, scapix::java_api::java::lang::classfile::AnnotationValue_OfFloat>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfFloatImpl> new_object(jni::ref<java::lang::classfile::constantpool::FloatEntry> constant) { return base_::new_object(constant); }
