...
public:
	...
	static jni::ref<java::lang::classfile::constantpool::Utf8Entry> rawUtf8EntryFromStandardAttributeName(jni::ref<java::lang::String> name) { return call_static_method<"rawUtf8EntryFromStandardAttributeName", jni::ref<java::lang::classfile::constantpool::Utf8Entry>>(name); }
	static jni::ref<java::lang::classfile::constantpool::PoolEntry> maybeClone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp, jni::ref<java::lang::classfile::constantpool::PoolEntry> entry) { return call_static_method<"maybeClone", jni::ref<java::lang::classfile::constantpool::PoolEntry>>(cp, entry); }
