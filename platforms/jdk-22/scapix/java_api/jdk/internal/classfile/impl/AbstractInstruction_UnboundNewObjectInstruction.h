...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundNewObjectInstruction> new_object(jni::ref<java::lang::classfile::constantpool::ClassEntry> classEntry) { return base_::new_object(classEntry); }
