...
#include <scapix/java_api/java/lang/classfile/components/CodeStackTracker.h>
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::CodeStackTrackerImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::classfile::components::CodeStackTracker>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::CodeStackTrackerImpl> new_object(jni::ref<jni::array<java::lang::classfile::TypeKind>> initialStack) { return base_::new_object(initialStack); }
	...
	void accept(jni::ref<java::lang::classfile::CodeBuilder> cb, jni::ref<java::lang::classfile::CodeElement> el) { return call_method<"accept", void>(cb, el); }
