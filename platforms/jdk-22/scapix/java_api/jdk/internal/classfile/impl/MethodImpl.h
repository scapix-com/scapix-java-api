...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::MethodImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::java::lang::classfile::MethodModel, scapix::java_api::jdk::internal::classfile::impl::MethodInfo>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::MethodImpl> new_object(jni::ref<java::lang::classfile::ClassReader> reader, jint startPos, jint endPos, jint attrStart) { return base_::new_object(reader, startPos, endPos, attrStart); }
