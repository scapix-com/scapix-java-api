...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::CatchBuilderImpl> new_object(jni::ref<java::lang::classfile::CodeBuilder> b, jni::ref<jdk::internal::classfile::impl::BlockCodeBuilderImpl> tryBlock, jni::ref<java::lang::classfile::Label> tryCatchEnd) { return base_::new_object(b, tryBlock, tryCatchEnd); }
