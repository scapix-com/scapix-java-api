...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundAnnotationDefaultAttribute> new_object(jni::ref<java::lang::classfile::AnnotationValue> annotationDefault) { return base_::new_object(annotationDefault); }
