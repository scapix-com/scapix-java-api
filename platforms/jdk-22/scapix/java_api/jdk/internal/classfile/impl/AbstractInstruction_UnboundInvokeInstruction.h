...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundInvokeInstruction> new_object(jni::ref<java::lang::classfile::Opcode> op, jni::ref<java::lang::classfile::constantpool::MemberRefEntry> methodEntry) { return base_::new_object(op, methodEntry); }
