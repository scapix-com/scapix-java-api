...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfAnnotationImpl> new_object(jni::ref<java::lang::classfile::Annotation> annotation) { return base_::new_object(annotation); }
