...
public:
	...
	static void toYaml(jni::ref<java::lang::classfile::components::ClassPrinter_Node> node, jni::ref<java::util::function::Consumer> out) { return call_static_method<"toYaml", void>(node, out); }
	static void toJson(jni::ref<java::lang::classfile::components::ClassPrinter_Node> node, jni::ref<java::util::function::Consumer> out) { return call_static_method<"toJson", void>(node, out); }
	static void toXml(jni::ref<java::lang::classfile::components::ClassPrinter_Node> node, jni::ref<java::util::function::Consumer> out) { return call_static_method<"toXml", void>(node, out); }
	static jni::ref<java::lang::classfile::components::ClassPrinter_MapNode> modelToTree(jni::ref<java::lang::classfile::CompoundElement> model, jni::ref<java::lang::classfile::components::ClassPrinter_Verbosity> verbosity) { return call_static_method<"modelToTree", jni::ref<java::lang::classfile::components::ClassPrinter_MapNode>>(model, verbosity); }
	static jni::ref<java::lang::classfile::components::ClassPrinter_MapNode> methodToTree(jni::ref<java::lang::classfile::MethodModel> m, jni::ref<java::lang::classfile::components::ClassPrinter_Verbosity> verbosity) { return call_static_method<"methodToTree", jni::ref<java::lang::classfile::components::ClassPrinter_MapNode>>(m, verbosity); }
