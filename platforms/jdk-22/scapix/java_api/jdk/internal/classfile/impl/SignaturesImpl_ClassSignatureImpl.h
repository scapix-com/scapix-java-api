...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_ClassSignatureImpl> new_object(jni::ref<java::util::List> typeParameters, jni::ref<java::lang::classfile::Signature_RefTypeSig> superclassSignature, jni::ref<java::util::List> superinterfaceSignatures) { return base_::new_object(typeParameters, superclassSignature, superinterfaceSignatures); }
