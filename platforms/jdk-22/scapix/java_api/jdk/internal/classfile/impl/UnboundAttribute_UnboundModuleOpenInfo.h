...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleOpenInfo> new_object(jni::ref<java::lang::classfile::constantpool::PackageEntry> openedPackage, jint opensFlagsMask, jni::ref<java::util::List> opensTo) { return base_::new_object(openedPackage, opensFlagsMask, opensTo); }
