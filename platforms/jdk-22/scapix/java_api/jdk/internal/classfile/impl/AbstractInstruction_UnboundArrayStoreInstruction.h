...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundArrayStoreInstruction> new_object(jni::ref<java::lang::classfile::Opcode> op) { return base_::new_object(op); }
