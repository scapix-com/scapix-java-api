...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BufferedMethodBuilder_Model>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractUnboundModel, scapix::java_api::java::lang::classfile::MethodModel, scapix::java_api::jdk::internal::classfile::impl::MethodInfo>;
};
