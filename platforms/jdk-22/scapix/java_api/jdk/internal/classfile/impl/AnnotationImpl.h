...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl> new_object(jni::ref<java::lang::classfile::constantpool::Utf8Entry> className, jni::ref<java::util::List> elems) { return base_::new_object(className, elems); }
