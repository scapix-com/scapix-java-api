...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfStringImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfConstantImpl, scapix::java_api::java::lang::classfile::AnnotationValue_OfString>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfStringImpl> new_object(jni::ref<java::lang::classfile::constantpool::Utf8Entry> constant) { return base_::new_object(constant); }
