...
public:
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> load(jni::ref<java::lang::Class> vmClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean p6, jni::ref<java::lang::Object> fromSegment, jlong container, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> index, jni::ref<jdk::internal::vm::vector::VectorSupport_LoadOperation> p10) { return call_static_method<"load", jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload>>(vmClass, eClass, length, base, offset, p6, fromSegment, container, index, p10); }
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> loadMasked(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean p7, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> fromSegment, jint m, jni::ref<java::lang::Object> offsetInRange, jlong container, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> index, jni::ref<jdk::internal::vm::vector::VectorSupport_LoadVectorMaskedOperation> p13) { return call_static_method<"loadMasked", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(vClass, mClass, eClass, length, base, offset, p7, fromSegment, m, offsetInRange, container, index, p13); }
	...
	static void store(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean p6, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> fromSegment, jni::ref<java::lang::Object> v, jlong container, jni::ref<jdk::internal::vm::vector::VectorSupport_StoreVectorOperation> index) { return call_static_method<"store", void>(vClass, eClass, length, base, offset, p6, fromSegment, v, container, index); }
	static void storeMasked(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean p7, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> fromSegment, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> v, jni::ref<java::lang::Object> m, jlong container, jni::ref<jdk::internal::vm::vector::VectorSupport_StoreVectorMaskedOperation> index) { return call_static_method<"storeMasked", void>(vClass, mClass, eClass, length, base, offset, p7, fromSegment, v, m, container, index); }
