...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_MANAGEMENT_MEMORYNOTIFICATIONINFO
...
public:
	...
	static jni::ref<java::lang::management::MemoryNotificationInfo> new_object(jni::ref<java::lang::String> poolName, jni::ref<java::lang::management::MemoryUsage> usage, jlong count) { return object_base::new_object(poolName, usage, count); }
	...
	static jni::ref<java::lang::management::MemoryNotificationInfo> from(jni::ref<javax::management::openmbean::CompositeData> cd) { return call_static_method<"from", jni::ref<java::lang::management::MemoryNotificationInfo>>(cd); }
};
