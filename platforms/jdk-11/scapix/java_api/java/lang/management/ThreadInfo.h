...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_MANAGEMENT_THREADINFO
...
public:
	...
	static jni::ref<java::lang::management::ThreadInfo> from(jni::ref<javax::management::openmbean::CompositeData> cd) { return call_static_method<"from", jni::ref<java::lang::management::ThreadInfo>>(cd); }
