...
public:
	...
	static jni::ref<java::lang::StackTraceElement> new_object(jni::ref<java::lang::String> classLoaderName, jni::ref<java::lang::String> moduleName, jni::ref<java::lang::String> moduleVersion, jni::ref<java::lang::String> declaringClass, jni::ref<java::lang::String> methodName, jni::ref<java::lang::String> fileName, jint lineNumber) { return base_::new_object(classLoaderName, moduleName, moduleVersion, declaringClass, methodName, fileName, lineNumber); }
