...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION_FWD
#define SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION_FWD
...
template<>
struct scapix::jni::object_traits<scapix::java_api::java::lang::instrument::Instrumentation>
{
	static constexpr fixed_string class_name = "java/lang/instrument/Instrumentation";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION_FWD

#ifndef SCAPIX_JAVA_API_FWD
#ifndef SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION
#define SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION
...
class java::lang::instrument::Instrumentation : public jni::object_base<"java/lang/instrument/Instrumentation",
	java::lang::Object>
{
public:
	...
	void redefineModule(jni::ref<java::lang::Module> p1, jni::ref<java::util::Set> p2, jni::ref<java::util::Map> p3, jni::ref<java::util::Map> p4, jni::ref<java::util::Set> p5, jni::ref<java::util::Map> p6) { return call_method<"redefineModule", void>(p1, p2, p3, p4, p5, p6); }
	jboolean isModifiableModule(jni::ref<java::lang::Module> p1) { return call_method<"isModifiableModule", jboolean>(p1); }
};
...
#endif // SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION
