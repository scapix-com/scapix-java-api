...
public:
	...
	static jni::ref<java::lang::invoke::InnerClassLambdaMetafactory> new_object(jni::ref<java::lang::invoke::MethodHandles_Lookup> caller, jni::ref<java::lang::invoke::MethodType> invokedType, jni::ref<java::lang::String> samMethodName, jni::ref<java::lang::invoke::MethodType> samMethodType, jni::ref<java::lang::invoke::MethodHandle> implMethod, jni::ref<java::lang::invoke::MethodType> instantiatedMethodType, jboolean isSerializable, jni::ref<jni::array<java::lang::Class>> markerInterfaces, jni::ref<jni::array<java::lang::invoke::MethodType>> additionalBridges) { return object_base::new_object(caller, invokedType, samMethodName, samMethodType, implMethod, instantiatedMethodType, isSerializable, markerInterfaces, additionalBridges); }
