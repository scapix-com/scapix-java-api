...
namespace scapix::java_api { namespace java::lang::invoke { class ClassSpecializer_Factory; }}
...
public:
	...
	static jni::ref<java::lang::invoke::ClassSpecializer_Factory> new_object(jni::ref<java::lang::invoke::ClassSpecializer> this_0) { return object_base::new_object(this_0); }
