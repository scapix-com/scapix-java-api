...
public:
	...
	static jni::ref<java::lang::ProcessBuilder> new_object(jni::ref<java::util::List> command) { return object_base::new_object(command); }
	static jni::ref<java::lang::ProcessBuilder> new_object(jni::ref<jni::array<java::lang::String>> command) { return object_base::new_object(command); }
	...
	static jni::ref<java::util::List> startPipeline(jni::ref<java::util::List> builders) { return call_static_method<"startPipeline", jni::ref<java::util::List>>(builders); }
};
