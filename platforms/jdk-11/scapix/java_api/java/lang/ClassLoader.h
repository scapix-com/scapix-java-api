...
public:
	...
	jni::ref<java::util::stream::Stream> resources(jni::ref<java::lang::String> name) { return call_method<"resources", jni::ref<java::util::stream::Stream>>(name); }
	jboolean isRegisteredAsParallelCapable() { return call_method<"isRegisteredAsParallelCapable", jboolean>(); }
	...
	jni::ref<java::lang::Module> getUnnamedModule() { return call_method<"getUnnamedModule", jni::ref<java::lang::Module>>(); }
	static jni::ref<java::lang::ClassLoader> getPlatformClassLoader() { return call_static_method<"getPlatformClassLoader", jni::ref<java::lang::ClassLoader>>(); }
	...
	jni::ref<java::lang::Package> getDefinedPackage(jni::ref<java::lang::String> name) { return call_method<"getDefinedPackage", jni::ref<java::lang::Package>>(name); }
	jni::ref<jni::array<java::lang::Package>> getDefinedPackages() { return call_method<"getDefinedPackages", jni::ref<jni::array<java::lang::Package>>>(); }
