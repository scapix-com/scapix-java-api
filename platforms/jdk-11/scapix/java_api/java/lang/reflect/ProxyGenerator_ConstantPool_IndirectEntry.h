...
namespace scapix::java_api { namespace java::lang::reflect { class ProxyGenerator_ConstantPool_IndirectEntry; }}
...
public:
	...
	static jni::ref<java::lang::reflect::ProxyGenerator_ConstantPool_IndirectEntry> new_object(jint tag, jshort index) { return object_base::new_object(tag, index); }
	static jni::ref<java::lang::reflect::ProxyGenerator_ConstantPool_IndirectEntry> new_object(jint tag, jshort index0, jshort index1) { return object_base::new_object(tag, index0, index1); }
