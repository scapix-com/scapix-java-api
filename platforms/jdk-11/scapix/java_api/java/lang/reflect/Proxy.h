...
public:
	...
	static jni::ref<java::lang::Object> newProxyInstance(jni::ref<java::lang::ClassLoader> loader, jni::ref<jni::array<java::lang::Class>> interfaces, jni::ref<java::lang::reflect::InvocationHandler> h) { return call_static_method<"newProxyInstance", jni::ref<java::lang::Object>>(loader, interfaces, h); }
