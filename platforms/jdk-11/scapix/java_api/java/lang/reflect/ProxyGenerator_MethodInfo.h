...
namespace scapix::java_api::java::lang::reflect { class ProxyGenerator_MethodInfo; }
...
public:
	...
	static jni::ref<java::lang::reflect::ProxyGenerator_MethodInfo> new_object(jni::ref<java::lang::reflect::ProxyGenerator> p1, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jint accessFlags) { return base_::new_object(p1, name, descriptor, accessFlags); }
