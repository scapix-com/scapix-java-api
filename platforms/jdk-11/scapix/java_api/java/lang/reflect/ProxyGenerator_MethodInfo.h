...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REFLECT_PROXYGENERATOR_METHODINFO_FWD
#define SCAPIX_JAVA_API_JAVA_LANG_REFLECT_PROXYGENERATOR_METHODINFO_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::lang::reflect { class ProxyGenerator_MethodInfo; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::lang::reflect::ProxyGenerator_MethodInfo>
{
	static constexpr fixed_string class_name = "java/lang/reflect/ProxyGenerator$MethodInfo";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_LANG_REFLECT_PROXYGENERATOR_METHODINFO_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_LANG_REFLECT_PROXYGENERATOR_METHODINFO)
#define SCAPIX_JAVA_API_JAVA_LANG_REFLECT_PROXYGENERATOR_METHODINFO
...
// private
class java::lang::reflect::ProxyGenerator_MethodInfo : public jni::object_base<"java/lang/reflect/ProxyGenerator$MethodInfo",
	java::lang::Object>
{
public:
	...
	static jni::ref<java::lang::reflect::ProxyGenerator_MethodInfo> new_object(jni::ref<java::lang::reflect::ProxyGenerator> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
...
#endif // SCAPIX_JAVA_API_JAVA_LANG_REFLECT_PROXYGENERATOR_METHODINFO
