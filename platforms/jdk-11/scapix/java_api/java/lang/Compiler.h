...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_COMPILER
...
public:
	...
	static jboolean compileClass(jni::ref<java::lang::Class> clazz) { return call_static_method<"compileClass", jboolean>(clazz); }
	static jboolean compileClasses(jni::ref<java::lang::String> string) { return call_static_method<"compileClasses", jboolean>(string); }
	static jni::ref<java::lang::Object> command(jni::ref<java::lang::Object> any) { return call_static_method<"command", jni::ref<java::lang::Object>>(any); }
