...
public:
	...
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Field> field) { return base_::new_object(field); }
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Constructor> cons) { return base_::new_object(cons); }
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Method> meth) { return base_::new_object(meth); }
