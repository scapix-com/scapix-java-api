...
namespace scapix::java_api { namespace java::io { class SerialCallbackContext; }}
...
public:
	...
	static jni::ref<java::io::SerialCallbackContext> new_object(jni::ref<java::lang::Object> obj, jni::ref<java::io::ObjectStreamClass> desc) { return object_base::new_object(obj, desc); }
