...
#ifndef SCAPIX_JAVA_API_JAVA_NET_PROXYSELECTOR
...
public:
	...
	static jni::ref<java::net::ProxySelector> new_object() { return object_base::new_object(); }
	static jni::ref<java::net::ProxySelector> getDefault() { return call_static_method<"getDefault", jni::ref<java::net::ProxySelector>>(); }
	static void setDefault(jni::ref<java::net::ProxySelector> ps) { return call_static_method<"setDefault", void>(ps); }
	...
	static jni::ref<java::net::ProxySelector> of(jni::ref<java::net::InetSocketAddress> proxyAddress) { return call_static_method<"of", jni::ref<java::net::ProxySelector>>(proxyAddress); }
};
