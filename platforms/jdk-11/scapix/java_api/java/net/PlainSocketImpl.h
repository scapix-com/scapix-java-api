...
namespace scapix::java_api { namespace java::net { class PlainSocketImpl; }}
...
public:
	...
	static jni::ref<java::net::PlainSocketImpl> new_object() { return object_base::new_object(); }
	static jni::ref<java::net::PlainSocketImpl> new_object(jni::ref<java::io::FileDescriptor> fd) { return object_base::new_object(fd); }
