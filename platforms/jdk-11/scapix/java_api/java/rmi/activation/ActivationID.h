...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_ACTIVATION_ACTIVATIONID
...
public:
	...
	static jni::ref<java::rmi::activation::ActivationID> new_object(jni::ref<java::rmi::activation::Activator> activator) { return object_base::new_object(activator); }
	jni::ref<java::rmi::Remote> activate(jboolean force) { return call_method<"activate", jni::ref<java::rmi::Remote>>(force); }
