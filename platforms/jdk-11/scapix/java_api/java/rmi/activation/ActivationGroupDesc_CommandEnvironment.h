...
class ActivationGroupDesc_CommandEnvironment;
...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_ACTIVATION_ACTIVATIONGROUPDESC_COMMANDENVIRONMENT
...
public:
	...
	static jni::ref<java::rmi::activation::ActivationGroupDesc_CommandEnvironment> new_object(jni::ref<java::lang::String> cmdpath, jni::ref<jni::array<java::lang::String>> argv) { return object_base::new_object(cmdpath, argv); }
