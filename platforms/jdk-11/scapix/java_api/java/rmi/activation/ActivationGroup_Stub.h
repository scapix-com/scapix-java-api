...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_ACTIVATION_ACTIVATIONGROUP_STUB
...
public:
	...
	static jni::ref<java::rmi::activation::ActivationGroup_Stub> new_object(jni::ref<java::rmi::server::RemoteRef> p1) { return object_base::new_object(p1); }
