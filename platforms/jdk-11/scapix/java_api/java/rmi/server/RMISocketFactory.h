...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_SERVER_RMISOCKETFACTORY
...
public:
	...
	static jni::ref<java::rmi::server::RMISocketFactory> new_object() { return object_base::new_object(); }
	...
	static void setSocketFactory(jni::ref<java::rmi::server::RMISocketFactory> fac) { return call_static_method<"setSocketFactory", void>(fac); }
	...
	static void setFailureHandler(jni::ref<java::rmi::server::RMIFailureHandler> fh) { return call_static_method<"setFailureHandler", void>(fh); }
