...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_IMAGECAPABILITIES
...
public:
	...
	static jni::ref<java::awt::ImageCapabilities> new_object(jboolean accelerated) { return object_base::new_object(accelerated); }
