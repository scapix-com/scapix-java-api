...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_JOBATTRIBUTES
...
public:
	...
	static jni::ref<java::awt::JobAttributes> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::JobAttributes> new_object(jni::ref<java::awt::JobAttributes> obj) { return object_base::new_object(obj); }
	static jni::ref<java::awt::JobAttributes> new_object(jint copies, jni::ref<java::awt::JobAttributes_DefaultSelectionType> defaultSelection, jni::ref<java::awt::JobAttributes_DestinationType> destination, jni::ref<java::awt::JobAttributes_DialogType> dialog, jni::ref<java::lang::String> fileName, jint maxPage, jint minPage, jni::ref<java::awt::JobAttributes_MultipleDocumentHandlingType> multipleDocumentHandling, jni::ref<jni::array<jni::array<jint>>> pageRanges, jni::ref<java::lang::String> printer, jni::ref<java::awt::JobAttributes_SidesType> sides) { return object_base::new_object(copies, defaultSelection, destination, dialog, fileName, maxPage, minPage, multipleDocumentHandling, pageRanges, printer, sides); }
	jni::ref<java::lang::Object> clone() { return call_method<"clone", jni::ref<java::lang::Object>>(); }
	void set(jni::ref<java::awt::JobAttributes> obj) { return call_method<"set", void>(obj); }
	...
	void setDefaultSelection(jni::ref<java::awt::JobAttributes_DefaultSelectionType> defaultSelection) { return call_method<"setDefaultSelection", void>(defaultSelection); }
	...
	void setDestination(jni::ref<java::awt::JobAttributes_DestinationType> destination) { return call_method<"setDestination", void>(destination); }
	...
	void setDialog(jni::ref<java::awt::JobAttributes_DialogType> dialog) { return call_method<"setDialog", void>(dialog); }
	...
	void setFromPage(jint fromPage) { return call_method<"setFromPage", void>(fromPage); }
	jint getMaxPage() { return call_method<"getMaxPage", jint>(); }
	void setMaxPage(jint maxPage) { return call_method<"setMaxPage", void>(maxPage); }
	jint getMinPage() { return call_method<"getMinPage", jint>(); }
	void setMinPage(jint minPage) { return call_method<"setMinPage", void>(minPage); }
	...
	void setMultipleDocumentHandling(jni::ref<java::awt::JobAttributes_MultipleDocumentHandlingType> multipleDocumentHandling) { return call_method<"setMultipleDocumentHandling", void>(multipleDocumentHandling); }
	...
	void setPageRanges(jni::ref<jni::array<jni::array<jint>>> pageRanges) { return call_method<"setPageRanges", void>(pageRanges); }
	jni::ref<java::lang::String> getPrinter() { return call_method<"getPrinter", jni::ref<java::lang::String>>(); }
	void setPrinter(jni::ref<java::lang::String> printer) { return call_method<"setPrinter", void>(printer); }
	jni::ref<java::awt::JobAttributes_SidesType> getSides() { return call_method<"getSides", jni::ref<java::awt::JobAttributes_SidesType>>(); }
	void setSides(jni::ref<java::awt::JobAttributes_SidesType> sides) { return call_method<"setSides", void>(sides); }
	void setSidesToDefault() { return call_method<"setSidesToDefault", void>(); }
	jint getToPage() { return call_method<"getToPage", jint>(); }
	void setToPage(jint toPage) { return call_method<"setToPage", void>(toPage); }
