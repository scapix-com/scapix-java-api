...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_FONT_GLYPHVECTOR
...
public:
	...
	static jni::ref<java::awt::font::GlyphVector> new_object() { return object_base::new_object(); }
	...
	jint getGlyphCharIndex(jint glyphIndex) { return call_method<"getGlyphCharIndex", jint>(glyphIndex); }
	jni::ref<jni::array<jint>> getGlyphCharIndices(jint beginGlyphIndex, jint numEntries, jni::ref<jni::array<jint>> codeReturn) { return call_method<"getGlyphCharIndices", jni::ref<jni::array<jint>>>(beginGlyphIndex, numEntries, codeReturn); }
	...
	jni::ref<java::awt::Rectangle> getPixelBounds(jni::ref<java::awt::font::FontRenderContext> renderFRC, jfloat x, jfloat y) { return call_method<"getPixelBounds", jni::ref<java::awt::Rectangle>>(renderFRC, x, y); }
	...
	jni::ref<java::awt::Shape> getGlyphOutline(jint glyphIndex, jfloat x, jfloat y) { return call_method<"getGlyphOutline", jni::ref<java::awt::Shape>>(glyphIndex, x, y); }
	...
	jni::ref<java::awt::Rectangle> getGlyphPixelBounds(jint index, jni::ref<java::awt::font::FontRenderContext> renderFRC, jfloat x, jfloat y) { return call_method<"getGlyphPixelBounds", jni::ref<java::awt::Rectangle>>(index, renderFRC, x, y); }
