...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_CONTAINEREVENT
...
public:
	...
	static jni::ref<java::awt::event::ContainerEvent> new_object(jni::ref<java::awt::Component> source, jint id, jni::ref<java::awt::Component> child) { return object_base::new_object(source, id, child); }
