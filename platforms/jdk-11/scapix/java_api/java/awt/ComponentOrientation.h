...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_COMPONENTORIENTATION
...
public:
	...
	static jni::ref<java::awt::ComponentOrientation> getOrientation(jni::ref<java::util::Locale> locale) { return call_static_method<"getOrientation", jni::ref<java::awt::ComponentOrientation>>(locale); }
	static jni::ref<java::awt::ComponentOrientation> getOrientation(jni::ref<java::util::ResourceBundle> bdl) { return call_static_method<"getOrientation", jni::ref<java::awt::ComponentOrientation>>(bdl); }
};
