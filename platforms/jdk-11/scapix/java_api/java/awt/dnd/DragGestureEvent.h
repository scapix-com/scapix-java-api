...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_DND_DRAGGESTUREEVENT
...
public:
	...
	static jni::ref<java::awt::dnd::DragGestureEvent> new_object(jni::ref<java::awt::dnd::DragGestureRecognizer> dgr, jint act, jni::ref<java::awt::Point> ori, jni::ref<java::util::List> evs) { return object_base::new_object(dgr, act, ori, evs); }
	...
	void startDrag(jni::ref<java::awt::Cursor> dragCursor, jni::ref<java::awt::datatransfer::Transferable> transferable) { return call_method<"startDrag", void>(dragCursor, transferable); }
	void startDrag(jni::ref<java::awt::Cursor> dragCursor, jni::ref<java::awt::datatransfer::Transferable> transferable, jni::ref<java::awt::dnd::DragSourceListener> dsl) { return call_method<"startDrag", void>(dragCursor, transferable, dsl); }
	void startDrag(jni::ref<java::awt::Cursor> dragCursor, jni::ref<java::awt::Image> dragImage, jni::ref<java::awt::Point> imageOffset, jni::ref<java::awt::datatransfer::Transferable> transferable, jni::ref<java::awt::dnd::DragSourceListener> dsl) { return call_method<"startDrag", void>(dragCursor, dragImage, imageOffset, transferable, dsl); }
};
