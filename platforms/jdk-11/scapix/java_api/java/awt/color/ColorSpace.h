...
public:
	...
	static jni::ref<java::awt::color::ColorSpace> getInstance(jint colorspace) { return call_static_method<"getInstance", jni::ref<java::awt::color::ColorSpace>>(colorspace); }
	...
	jni::ref<java::lang::String> getName(jint idx) { return call_method<"getName", jni::ref<java::lang::String>>(idx); }
