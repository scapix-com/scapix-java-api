...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_GRAPHICS
...
public:
	...
	void drawPolygon(jni::ref<java::awt::Polygon> p) { return call_method<"drawPolygon", void>(p); }
	...
	void fillPolygon(jni::ref<java::awt::Polygon> p) { return call_method<"fillPolygon", void>(p); }
	...
	jboolean hitClip(jint x, jint y, jint width, jint height) { return call_method<"hitClip", jboolean>(x, y, width, height); }
	jni::ref<java::awt::Rectangle> getClipBounds(jni::ref<java::awt::Rectangle> r) { return call_method<"getClipBounds", jni::ref<java::awt::Rectangle>>(r); }
};
