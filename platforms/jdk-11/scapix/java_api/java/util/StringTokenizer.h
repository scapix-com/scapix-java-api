...
public:
	...
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> str, jni::ref<java::lang::String> delim, jboolean returnDelims) { return object_base::new_object(str, delim, returnDelims); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> str, jni::ref<java::lang::String> delim) { return object_base::new_object(str, delim); }
	static jni::ref<java::util::StringTokenizer> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
	...
	jni::ref<java::lang::String> nextToken(jni::ref<java::lang::String> delim) { return call_method<"nextToken", jni::ref<java::lang::String>>(delim); }
