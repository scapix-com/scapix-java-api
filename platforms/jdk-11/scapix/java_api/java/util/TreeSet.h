...
public:
	...
	static jni::ref<java::util::TreeSet> new_object(jni::ref<java::util::Collection> c) { return base_::new_object(c); }
	static jni::ref<java::util::TreeSet> new_object(jni::ref<java::util::SortedSet> s) { return base_::new_object(s); }
