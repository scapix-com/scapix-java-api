...
namespace scapix::java_api { namespace java::util::stream { class DoublePipeline; }}
...
public:
	...
	jdouble reduce(jdouble identity, jni::ref<java::util::function::DoubleBinaryOperator> op) { return call_method<"reduce", jdouble>(identity, op); }
