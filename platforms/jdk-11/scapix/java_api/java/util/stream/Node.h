...
public:
	...
	jni::ref<java::util::stream::Node> truncate(jlong from, jlong p2, jni::ref<java::util::function::IntFunction> to) { return call_method<"truncate", jni::ref<java::util::stream::Node>>(from, p2, to); }
