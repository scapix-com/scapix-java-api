...
namespace scapix::java_api { namespace java::util::stream { class Node; }}
...
public:
	...
	jni::ref<java::util::stream::Node> getChild(jint i) { return call_method<"getChild", jni::ref<java::util::stream::Node>>(i); }
	jni::ref<java::util::stream::Node> truncate(jlong from, jlong to, jni::ref<java::util::function::IntFunction> generator) { return call_method<"truncate", jni::ref<java::util::stream::Node>>(from, to, generator); }
