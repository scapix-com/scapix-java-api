...
namespace scapix::java_api { namespace java::util::stream { class Collectors_CollectorImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::util::stream::Collectors_CollectorImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::stream::Collector>;
};
