...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_JAR_JARFILE
...
public:
	...
	static jni::ref<java::lang::Runtime_Version> baseVersion() { return call_static_method<"baseVersion", jni::ref<java::lang::Runtime_Version>>(); }
	static jni::ref<java::lang::Runtime_Version> runtimeVersion() { return call_static_method<"runtimeVersion", jni::ref<java::lang::Runtime_Version>>(); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> name, jboolean verify) { return object_base::new_object(name, verify); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> file, jboolean verify) { return object_base::new_object(file, verify); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> file, jboolean verify, jint mode) { return object_base::new_object(file, verify, mode); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> file, jboolean verify, jint mode, jni::ref<java::lang::Runtime_Version> version) { return object_base::new_object(file, verify, mode, version); }
	jni::ref<java::lang::Runtime_Version> getVersion() { return call_method<"getVersion", jni::ref<java::lang::Runtime_Version>>(); }
	jboolean isMultiRelease() { return call_method<"isMultiRelease", jboolean>(); }
	...
	jni::ref<java::util::stream::Stream> versionedStream() { return call_method<"versionedStream", jni::ref<java::util::stream::Stream>>(); }
