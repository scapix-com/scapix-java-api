...
public:
	...
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> file, jboolean verify, jint mode, jni::ref<java::lang::Runtime_Version> version) { return base_::new_object(file, verify, mode, version); }
