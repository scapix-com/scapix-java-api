...
namespace scapix::java_api { namespace java::util { class ArrayList_SubList; }}
...
public:
	...
	static jni::ref<java::util::ArrayList_SubList> new_object(jni::ref<java::util::ArrayList> root, jint fromIndex, jint toIndex) { return object_base::new_object(root, fromIndex, toIndex); }
