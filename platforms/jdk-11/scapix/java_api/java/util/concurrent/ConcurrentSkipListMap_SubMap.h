...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::ConcurrentSkipListMap_SubMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractMap, scapix::java_api::java::util::concurrent::ConcurrentNavigableMap, scapix::java_api::java::io::Serializable>;
};
...
public:
	...
	jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap> subMap(jni::ref<java::lang::Object> fromKey, jboolean fromInclusive, jni::ref<java::lang::Object> toKey, jboolean toInclusive) { return call_method<"subMap", jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap>>(fromKey, fromInclusive, toKey, toInclusive); }
	jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap> headMap(jni::ref<java::lang::Object> toKey, jboolean inclusive) { return call_method<"headMap", jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap>>(toKey, inclusive); }
	jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap> tailMap(jni::ref<java::lang::Object> fromKey, jboolean inclusive) { return call_method<"tailMap", jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap>>(fromKey, inclusive); }
	jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap> subMap(jni::ref<java::lang::Object> fromKey, jni::ref<java::lang::Object> toKey) { return call_method<"subMap", jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap>>(fromKey, toKey); }
	jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap> headMap(jni::ref<java::lang::Object> toKey) { return call_method<"headMap", jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap>>(toKey); }
	jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap> tailMap(jni::ref<java::lang::Object> fromKey) { return call_method<"tailMap", jni::ref<java::util::concurrent::ConcurrentSkipListMap_SubMap>>(fromKey); }
