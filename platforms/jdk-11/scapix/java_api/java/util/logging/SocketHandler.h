...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOGGING_SOCKETHANDLER
...
public:
	...
	static jni::ref<java::util::logging::SocketHandler> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::logging::SocketHandler> new_object(jni::ref<java::lang::String> host, jint port) { return object_base::new_object(host, port); }
