...
namespace scapix::java_api { namespace java::util::regex { class CharPredicates; }}
...
public:
	...
	static jni::ref<java::util::regex::Pattern_CharPredicate> forUnicodeProperty(jni::ref<java::lang::String> propName) { return call_static_method<"forUnicodeProperty", jni::ref<java::util::regex::Pattern_CharPredicate>>(propName); }
	static jni::ref<java::util::regex::Pattern_CharPredicate> forPOSIXName(jni::ref<java::lang::String> propName) { return call_static_method<"forPOSIXName", jni::ref<java::util::regex::Pattern_CharPredicate>>(propName); }
