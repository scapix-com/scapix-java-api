...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_DATE
...
public:
	...
	static jni::ref<java::sql::Date> new_object(jint year, jint month, jint day) { return object_base::new_object(year, month, day); }
	static jni::ref<java::sql::Date> new_object(jlong date) { return object_base::new_object(date); }
	...
	static jni::ref<java::sql::Date> valueOf(jni::ref<java::time::LocalDate> date) { return call_static_method<"valueOf", jni::ref<java::sql::Date>>(date); }
