...
namespace scapix::java_api { namespace java::text { class PatternEntry; }}
...
public:
	...
	void appendQuotedExtension(jni::ref<java::lang::StringBuffer> toAddTo) { return call_method<"appendQuotedExtension", void>(toAddTo); }
	void appendQuotedChars(jni::ref<java::lang::StringBuffer> toAddTo) { return call_method<"appendQuotedChars", void>(toAddTo); }
