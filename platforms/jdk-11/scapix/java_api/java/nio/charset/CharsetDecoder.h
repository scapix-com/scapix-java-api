...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHARSET_CHARSETDECODER
...
public:
	...
	jni::ref<java::nio::charset::CharsetDecoder> replaceWith(jni::ref<java::lang::String> newReplacement) { return call_method<"replaceWith", jni::ref<java::nio::charset::CharsetDecoder>>(newReplacement); }
	...
	jni::ref<java::nio::charset::CharsetDecoder> onMalformedInput(jni::ref<java::nio::charset::CodingErrorAction> newAction) { return call_method<"onMalformedInput", jni::ref<java::nio::charset::CharsetDecoder>>(newAction); }
	...
	jni::ref<java::nio::charset::CharsetDecoder> onUnmappableCharacter(jni::ref<java::nio::charset::CodingErrorAction> newAction) { return call_method<"onUnmappableCharacter", jni::ref<java::nio::charset::CharsetDecoder>>(newAction); }
	...
	jni::ref<java::nio::charset::CoderResult> decode(jni::ref<java::nio::ByteBuffer> in, jni::ref<java::nio::CharBuffer> out, jboolean endOfInput) { return call_method<"decode", jni::ref<java::nio::charset::CoderResult>>(in, out, endOfInput); }
	jni::ref<java::nio::charset::CoderResult> flush(jni::ref<java::nio::CharBuffer> out) { return call_method<"flush", jni::ref<java::nio::charset::CoderResult>>(out); }
	jni::ref<java::nio::charset::CharsetDecoder> reset() { return call_method<"reset", jni::ref<java::nio::charset::CharsetDecoder>>(); }
	jni::ref<java::nio::CharBuffer> decode(jni::ref<java::nio::ByteBuffer> in) { return call_method<"decode", jni::ref<java::nio::CharBuffer>>(in); }
