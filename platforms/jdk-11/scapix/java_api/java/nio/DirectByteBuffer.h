...
namespace scapix::java_api { namespace java::nio { class DirectByteBuffer; }}
...
public:
	...
	jni::ref<java::nio::ByteBuffer> slice(jint pos, jint lim) { return call_method<"slice", jni::ref<java::nio::ByteBuffer>>(pos, lim); }
