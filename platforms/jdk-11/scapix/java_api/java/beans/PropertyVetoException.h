...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_PROPERTYVETOEXCEPTION
...
public:
	...
	static jni::ref<java::beans::PropertyVetoException> new_object(jni::ref<java::lang::String> mess, jni::ref<java::beans::PropertyChangeEvent> evt) { return object_base::new_object(mess, evt); }
