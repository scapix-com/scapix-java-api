...
public:
	...
	static jni::ref<java::security::KeyStore_PasswordProtection> new_object(jni::ref<jni::array<jchar>> password, jni::ref<java::lang::String> protectionAlgorithm, jni::ref<java::security::spec::AlgorithmParameterSpec> protectionParameters) { return base_::new_object(password, protectionAlgorithm, protectionParameters); }
