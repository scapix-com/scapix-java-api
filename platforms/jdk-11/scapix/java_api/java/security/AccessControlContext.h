...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_ACCESSCONTROLCONTEXT
...
public:
	...
	static jni::ref<java::security::AccessControlContext> new_object(jni::ref<jni::array<java::security::ProtectionDomain>> context) { return object_base::new_object(context); }
	static jni::ref<java::security::AccessControlContext> new_object(jni::ref<java::security::AccessControlContext> acc, jni::ref<java::security::DomainCombiner> combiner) { return object_base::new_object(acc, combiner); }
