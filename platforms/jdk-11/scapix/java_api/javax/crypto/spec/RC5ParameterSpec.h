...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_RC5PARAMETERSPEC
...
public:
	...
	static jni::ref<javax::crypto::spec::RC5ParameterSpec> new_object(jint version, jint rounds, jint wordSize) { return object_base::new_object(version, rounds, wordSize); }
	static jni::ref<javax::crypto::spec::RC5ParameterSpec> new_object(jint version, jint rounds, jint wordSize, jni::ref<jni::array<jbyte>> iv) { return object_base::new_object(version, rounds, wordSize, iv); }
	static jni::ref<javax::crypto::spec::RC5ParameterSpec> new_object(jint version, jint rounds, jint wordSize, jni::ref<jni::array<jbyte>> iv, jint offset) { return object_base::new_object(version, rounds, wordSize, iv, offset); }
