...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_DHPRIVATEKEYSPEC
...
public:
	...
	static jni::ref<javax::crypto::spec::DHPrivateKeySpec> new_object(jni::ref<java::math::BigInteger> x, jni::ref<java::math::BigInteger> p, jni::ref<java::math::BigInteger> g) { return object_base::new_object(x, p, g); }
