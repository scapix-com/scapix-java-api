...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_SPI_MIXERPROVIDER
...
public:
	...
	static jni::ref<javax::sound::sampled::spi::MixerProvider> new_object() { return object_base::new_object(); }
	jboolean isMixerSupported(jni::ref<javax::sound::sampled::Mixer_Info> info) { return call_method<"isMixerSupported", jboolean>(info); }
