...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_SPI_AUDIOFILEWRITER
...
public:
	...
	static jni::ref<javax::sound::sampled::spi::AudioFileWriter> new_object() { return object_base::new_object(); }
	...
	jboolean isFileTypeSupported(jni::ref<javax::sound::sampled::AudioFileFormat_Type> fileType) { return call_method<"isFileTypeSupported", jboolean>(fileType); }
	...
	jboolean isFileTypeSupported(jni::ref<javax::sound::sampled::AudioFileFormat_Type> fileType, jni::ref<javax::sound::sampled::AudioInputStream> stream) { return call_method<"isFileTypeSupported", jboolean>(fileType, stream); }
