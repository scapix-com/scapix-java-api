...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_SPI_FORMATCONVERSIONPROVIDER
...
public:
	...
	static jni::ref<javax::sound::sampled::spi::FormatConversionProvider> new_object() { return object_base::new_object(); }
	...
	jboolean isSourceEncodingSupported(jni::ref<javax::sound::sampled::AudioFormat_Encoding> sourceEncoding) { return call_method<"isSourceEncodingSupported", jboolean>(sourceEncoding); }
	jboolean isTargetEncodingSupported(jni::ref<javax::sound::sampled::AudioFormat_Encoding> targetEncoding) { return call_method<"isTargetEncodingSupported", jboolean>(targetEncoding); }
	...
	jboolean isConversionSupported(jni::ref<javax::sound::sampled::AudioFormat_Encoding> targetEncoding, jni::ref<javax::sound::sampled::AudioFormat> sourceFormat) { return call_method<"isConversionSupported", jboolean>(targetEncoding, sourceFormat); }
	...
	jboolean isConversionSupported(jni::ref<javax::sound::sampled::AudioFormat> targetFormat, jni::ref<javax::sound::sampled::AudioFormat> sourceFormat) { return call_method<"isConversionSupported", jboolean>(targetFormat, sourceFormat); }
