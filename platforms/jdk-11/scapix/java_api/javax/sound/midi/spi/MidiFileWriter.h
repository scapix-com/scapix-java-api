...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_MIDI_SPI_MIDIFILEWRITER
...
public:
	...
	static jni::ref<javax::sound::midi::spi::MidiFileWriter> new_object() { return object_base::new_object(); }
	...
	jboolean isFileTypeSupported(jint fileType) { return call_method<"isFileTypeSupported", jboolean>(fileType); }
	jboolean isFileTypeSupported(jint fileType, jni::ref<javax::sound::midi::Sequence> sequence) { return call_method<"isFileTypeSupported", jboolean>(fileType, sequence); }
