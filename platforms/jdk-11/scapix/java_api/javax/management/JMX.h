...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_JMX
...
public:
	...
	static jni::ref<java::lang::Object> newMBeanProxy(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName, jni::ref<java::lang::Class> interfaceClass) { return call_static_method<"newMBeanProxy", jni::ref<java::lang::Object>>(connection, objectName, interfaceClass); }
	static jni::ref<java::lang::Object> newMBeanProxy(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName, jni::ref<java::lang::Class> interfaceClass, jboolean notificationEmitter) { return call_static_method<"newMBeanProxy", jni::ref<java::lang::Object>>(connection, objectName, interfaceClass, notificationEmitter); }
	static jni::ref<java::lang::Object> newMXBeanProxy(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName, jni::ref<java::lang::Class> interfaceClass) { return call_static_method<"newMXBeanProxy", jni::ref<java::lang::Object>>(connection, objectName, interfaceClass); }
	static jni::ref<java::lang::Object> newMXBeanProxy(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName, jni::ref<java::lang::Class> interfaceClass, jboolean notificationEmitter) { return call_static_method<"newMXBeanProxy", jni::ref<java::lang::Object>>(connection, objectName, interfaceClass, notificationEmitter); }
	static jboolean isMXBeanInterface(jni::ref<java::lang::Class> interfaceClass) { return call_static_method<"isMXBeanInterface", jboolean>(interfaceClass); }
};
