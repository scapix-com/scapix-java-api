...
#ifndef SCAPIX_JAVA_API_JAVAX_SQL_ROWSET_SERIAL_SERIALSTRUCT
...
public:
	...
	static jni::ref<javax::sql::rowset::serial::SerialStruct> new_object(jni::ref<java::sql::Struct> in, jni::ref<java::util::Map> map) { return object_base::new_object(in, map); }
	static jni::ref<javax::sql::rowset::serial::SerialStruct> new_object(jni::ref<java::sql::SQLData> in, jni::ref<java::util::Map> map) { return object_base::new_object(in, map); }
	...
	jni::ref<jni::array<java::lang::Object>> getAttributes(jni::ref<java::util::Map> map) { return call_method<"getAttributes", jni::ref<jni::array<java::lang::Object>>>(map); }
