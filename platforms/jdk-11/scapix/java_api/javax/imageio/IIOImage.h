...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_IIOIMAGE
...
public:
	...
	static jni::ref<javax::imageio::IIOImage> new_object(jni::ref<java::awt::image::RenderedImage> image, jni::ref<java::util::List> thumbnails, jni::ref<javax::imageio::metadata::IIOMetadata> metadata) { return object_base::new_object(image, thumbnails, metadata); }
	static jni::ref<javax::imageio::IIOImage> new_object(jni::ref<java::awt::image::Raster> raster, jni::ref<java::util::List> thumbnails, jni::ref<javax::imageio::metadata::IIOMetadata> metadata) { return object_base::new_object(raster, thumbnails, metadata); }
	...
	void setRenderedImage(jni::ref<java::awt::image::RenderedImage> image) { return call_method<"setRenderedImage", void>(image); }
	...
	void setRaster(jni::ref<java::awt::image::Raster> raster) { return call_method<"setRaster", void>(raster); }
	jint getNumThumbnails() { return call_method<"getNumThumbnails", jint>(); }
	jni::ref<java::awt::image::BufferedImage> getThumbnail(jint index) { return call_method<"getThumbnail", jni::ref<java::awt::image::BufferedImage>>(index); }
	jni::ref<java::util::List> getThumbnails() { return call_method<"getThumbnails", jni::ref<java::util::List>>(); }
	void setThumbnails(jni::ref<java::util::List> thumbnails) { return call_method<"setThumbnails", void>(thumbnails); }
	...
	void setMetadata(jni::ref<javax::imageio::metadata::IIOMetadata> metadata) { return call_method<"setMetadata", void>(metadata); }
};
