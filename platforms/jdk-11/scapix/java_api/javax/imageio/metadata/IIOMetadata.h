...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_METADATA_IIOMETADATA
...
public:
	...
	jni::ref<javax::imageio::metadata::IIOMetadataFormat> getMetadataFormat(jni::ref<java::lang::String> formatName) { return call_method<"getMetadataFormat", jni::ref<javax::imageio::metadata::IIOMetadataFormat>>(formatName); }
	...
	void setFromTree(jni::ref<java::lang::String> formatName, jni::ref<org::w3c::dom::Node> root) { return call_method<"setFromTree", void>(formatName, root); }
	void reset() { return call_method<"reset", void>(); }
	void setController(jni::ref<javax::imageio::metadata::IIOMetadataController> controller) { return call_method<"setController", void>(controller); }
