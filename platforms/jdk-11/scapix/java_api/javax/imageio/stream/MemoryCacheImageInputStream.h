...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_STREAM_MEMORYCACHEIMAGEINPUTSTREAM
...
public:
	...
	static jni::ref<javax::imageio::stream::MemoryCacheImageInputStream> new_object(jni::ref<java::io::InputStream> stream) { return object_base::new_object(stream); }
