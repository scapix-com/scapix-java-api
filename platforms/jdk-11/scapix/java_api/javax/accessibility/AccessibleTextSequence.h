...
#ifndef SCAPIX_JAVA_API_JAVAX_ACCESSIBILITY_ACCESSIBLETEXTSEQUENCE
...
public:
	...
	static jni::ref<javax::accessibility::AccessibleTextSequence> new_object(jint start, jint end, jni::ref<java::lang::String> txt) { return object_base::new_object(start, end, txt); }
};
