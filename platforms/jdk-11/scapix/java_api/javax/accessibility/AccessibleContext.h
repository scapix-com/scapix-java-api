...
#ifndef SCAPIX_JAVA_API_JAVAX_ACCESSIBILITY_ACCESSIBLECONTEXT
...
public:
	...
	static jni::ref<javax::accessibility::AccessibleContext> new_object() { return object_base::new_object(); }
	...
	void setAccessibleParent(jni::ref<javax::accessibility::Accessible> a) { return call_method<"setAccessibleParent", void>(a); }
