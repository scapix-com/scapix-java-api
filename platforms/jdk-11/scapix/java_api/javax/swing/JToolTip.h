...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_JTOOLTIP
...
public:
	...
	static jni::ref<javax::swing::JToolTip> new_object() { return object_base::new_object(); }
	...
	void setTipText(jni::ref<java::lang::String> tipText) { return call_method<"setTipText", void>(tipText); }
	jni::ref<java::lang::String> getTipText() { return call_method<"getTipText", jni::ref<java::lang::String>>(); }
	void setComponent(jni::ref<javax::swing::JComponent> c) { return call_method<"setComponent", void>(c); }
