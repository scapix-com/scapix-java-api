...
public:
	...
	static jni::ref<javax::swing::AbstractButton> new_object() { return object_base::new_object(); }
	...
	void setMultiClickThreshhold(jlong threshhold) { return call_method<"setMultiClickThreshhold", void>(threshhold); }
