...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_INTERNATIONALFORMATTER
...
public:
	...
	static jni::ref<javax::swing::text::InternationalFormatter> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::text::InternationalFormatter> new_object(jni::ref<java::text::Format> format) { return object_base::new_object(format); }
	...
	void setMaximum(jni::ref<java::lang::Comparable> max) { return call_method<"setMaximum", void>(max); }
	...
	jni::ref<java::lang::Object> stringToValue(jni::ref<java::lang::String> text) { return call_method<"stringToValue", jni::ref<java::lang::Object>>(text); }
	jni::ref<jni::array<java::text::Format_Field>> getFields(jint offset) { return call_method<"getFields", jni::ref<jni::array<java::text::Format_Field>>>(offset); }
