...
class DefaultStyledDocument_AttributeUndoableEdit;
...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_DEFAULTSTYLEDDOCUMENT_ATTRIBUTEUNDOABLEEDIT
...
public:
	...
	static jni::ref<javax::swing::text::DefaultStyledDocument_AttributeUndoableEdit> new_object(jni::ref<javax::swing::text::Element> element, jni::ref<javax::swing::text::AttributeSet> newAttributes, jboolean isReplacing) { return object_base::new_object(element, newAttributes, isReplacing); }
