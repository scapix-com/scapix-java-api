...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER
...
public:
	...
	jni::ref<javax::swing::text::GlyphView_GlyphPainter> getPainter(jni::ref<javax::swing::text::GlyphView> v, jint p0, jint p1) { return call_method<"getPainter", jni::ref<javax::swing::text::GlyphView_GlyphPainter>>(v, p0, p1); }
	jint getNextVisualPositionFrom(jni::ref<javax::swing::text::GlyphView> v, jint pos, jni::ref<javax::swing::text::Position_Bias> b, jni::ref<java::awt::Shape> a, jint direction, jni::ref<jni::array<javax::swing::text::Position_Bias>> biasRet) { return call_method<"getNextVisualPositionFrom", jint>(v, pos, b, a, direction, biasRet); }
};
