...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_SEGMENT
...
public:
	...
	static jni::ref<javax::swing::text::Segment> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::text::Segment> new_object(jni::ref<jni::array<jchar>> array, jint offset, jint count) { return object_base::new_object(array, offset, count); }
	void setPartialReturn(jboolean p) { return call_method<"setPartialReturn", void>(p); }
