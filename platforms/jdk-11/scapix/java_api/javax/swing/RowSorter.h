...
public:
	...
	void addRowSorterListener(jni::ref<javax::swing::event::RowSorterListener> l) { return call_method<"addRowSorterListener", void>(l); }
	void removeRowSorterListener(jni::ref<javax::swing::event::RowSorterListener> l) { return call_method<"removeRowSorterListener", void>(l); }
};
