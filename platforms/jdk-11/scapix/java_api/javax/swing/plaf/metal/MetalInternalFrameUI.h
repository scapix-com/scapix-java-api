...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_METAL_METALINTERNALFRAMEUI
...
public:
	...
	static jni::ref<javax::swing::plaf::metal::MetalInternalFrameUI> new_object(jni::ref<javax::swing::JInternalFrame> b) { return object_base::new_object(b); }
	...
	void setPalette(jboolean isPalette) { return call_method<"setPalette", void>(isPalette); }
};
