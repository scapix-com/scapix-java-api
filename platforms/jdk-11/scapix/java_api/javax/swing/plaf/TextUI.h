...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_TEXTUI_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_PLAF_TEXTUI_FWD
...
template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::plaf::TextUI>
{
	static constexpr fixed_string class_name = "javax/swing/plaf/TextUI";
	using base_classes = std::tuple<scapix::java_api::javax::swing::plaf::ComponentUI>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_PLAF_TEXTUI_FWD

#ifndef SCAPIX_JAVA_API_FWD
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_TEXTUI
#define SCAPIX_JAVA_API_JAVAX_SWING_PLAF_TEXTUI
...
class javax::swing::plaf::TextUI : public jni::object_base<"javax/swing/plaf/TextUI",
	javax::swing::plaf::ComponentUI>
{
public:

	static jni::ref<javax::swing::plaf::TextUI> new_object() { return object_base::new_object(); }
	...
	jni::ref<java::awt::geom::Rectangle2D> modelToView2D(jni::ref<javax::swing::text::JTextComponent> t, jint pos, jni::ref<javax::swing::text::Position_Bias> bias) { return call_method<"modelToView2D", jni::ref<java::awt::geom::Rectangle2D>>(t, pos, bias); }
	...
	jint viewToModel2D(jni::ref<javax::swing::text::JTextComponent> t, jni::ref<java::awt::geom::Point2D> pt, jni::ref<jni::array<javax::swing::text::Position_Bias>> biasReturn) { return call_method<"viewToModel2D", jint>(t, pt, biasReturn); }
	...
	jni::ref<java::lang::String> getToolTipText2D(jni::ref<javax::swing::text::JTextComponent> t, jni::ref<java::awt::geom::Point2D> pt) { return call_method<"getToolTipText2D", jni::ref<java::lang::String>>(t, pt); }
};
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_PLAF_TEXTUI
