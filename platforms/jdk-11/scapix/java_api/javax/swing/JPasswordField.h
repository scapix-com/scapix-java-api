...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_JPASSWORDFIELD
...
public:
	...
	static jni::ref<javax::swing::JPasswordField> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::JPasswordField> new_object(jni::ref<java::lang::String> text) { return object_base::new_object(text); }
	static jni::ref<javax::swing::JPasswordField> new_object(jint columns) { return object_base::new_object(columns); }
	static jni::ref<javax::swing::JPasswordField> new_object(jni::ref<java::lang::String> text, jint columns) { return object_base::new_object(text, columns); }
	static jni::ref<javax::swing::JPasswordField> new_object(jni::ref<javax::swing::text::Document> doc, jni::ref<java::lang::String> txt, jint columns) { return object_base::new_object(doc, txt, columns); }
