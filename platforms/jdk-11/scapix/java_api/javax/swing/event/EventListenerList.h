...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_EVENT_EVENTLISTENERLIST
...
public:
	...
	static jni::ref<javax::swing::event::EventListenerList> new_object() { return object_base::new_object(); }
	jni::ref<jni::array<java::lang::Object>> getListenerList() { return call_method<"getListenerList", jni::ref<jni::array<java::lang::Object>>>(); }
	jni::ref<jni::array<java::util::EventListener>> getListeners(jni::ref<java::lang::Class> t) { return call_method<"getListeners", jni::ref<jni::array<java::util::EventListener>>>(t); }
