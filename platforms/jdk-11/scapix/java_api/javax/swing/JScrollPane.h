...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_JSCROLLPANE
...
public:
	...
	static jni::ref<javax::swing::JScrollPane> new_object(jni::ref<java::awt::Component> view, jint vsbPolicy, jint hsbPolicy) { return object_base::new_object(view, vsbPolicy, hsbPolicy); }
	static jni::ref<javax::swing::JScrollPane> new_object(jni::ref<java::awt::Component> view) { return object_base::new_object(view); }
	static jni::ref<javax::swing::JScrollPane> new_object(jint vsbPolicy, jint hsbPolicy) { return object_base::new_object(vsbPolicy, hsbPolicy); }
	static jni::ref<javax::swing::JScrollPane> new_object() { return object_base::new_object(); }
	jni::ref<javax::swing::plaf::ScrollPaneUI> getUI() { return call_method<"getUI", jni::ref<javax::swing::plaf::ScrollPaneUI>>(); }
	void setUI(jni::ref<javax::swing::plaf::ScrollPaneUI> ui) { return call_method<"setUI", void>(ui); }
	...
	void setLayout(jni::ref<java::awt::LayoutManager> layout) { return call_method<"setLayout", void>(layout); }
	...
	void setVerticalScrollBarPolicy(jint policy) { return call_method<"setVerticalScrollBarPolicy", void>(policy); }
	jint getHorizontalScrollBarPolicy() { return call_method<"getHorizontalScrollBarPolicy", jint>(); }
	void setHorizontalScrollBarPolicy(jint policy) { return call_method<"setHorizontalScrollBarPolicy", void>(policy); }
	...
	void setViewportBorder(jni::ref<javax::swing::border::Border> viewportBorder) { return call_method<"setViewportBorder", void>(viewportBorder); }
	...
	void setHorizontalScrollBar(jni::ref<javax::swing::JScrollBar> horizontalScrollBar) { return call_method<"setHorizontalScrollBar", void>(horizontalScrollBar); }
	...
	void setVerticalScrollBar(jni::ref<javax::swing::JScrollBar> verticalScrollBar) { return call_method<"setVerticalScrollBar", void>(verticalScrollBar); }
	jni::ref<javax::swing::JViewport> getViewport() { return call_method<"getViewport", jni::ref<javax::swing::JViewport>>(); }
	void setViewport(jni::ref<javax::swing::JViewport> viewport) { return call_method<"setViewport", void>(viewport); }
	void setViewportView(jni::ref<java::awt::Component> view) { return call_method<"setViewportView", void>(view); }
	jni::ref<javax::swing::JViewport> getRowHeader() { return call_method<"getRowHeader", jni::ref<javax::swing::JViewport>>(); }
	void setRowHeader(jni::ref<javax::swing::JViewport> rowHeader) { return call_method<"setRowHeader", void>(rowHeader); }
	void setRowHeaderView(jni::ref<java::awt::Component> view) { return call_method<"setRowHeaderView", void>(view); }
	jni::ref<javax::swing::JViewport> getColumnHeader() { return call_method<"getColumnHeader", jni::ref<javax::swing::JViewport>>(); }
	void setColumnHeader(jni::ref<javax::swing::JViewport> columnHeader) { return call_method<"setColumnHeader", void>(columnHeader); }
	void setColumnHeaderView(jni::ref<java::awt::Component> view) { return call_method<"setColumnHeaderView", void>(view); }
	jni::ref<java::awt::Component> getCorner(jni::ref<java::lang::String> key) { return call_method<"getCorner", jni::ref<java::awt::Component>>(key); }
	void setCorner(jni::ref<java::lang::String> key, jni::ref<java::awt::Component> corner) { return call_method<"setCorner", void>(key, corner); }
	void setComponentOrientation(jni::ref<java::awt::ComponentOrientation> co) { return call_method<"setComponentOrientation", void>(co); }
	jboolean isWheelScrollingEnabled() { return call_method<"isWheelScrollingEnabled", jboolean>(); }
	void setWheelScrollingEnabled(jboolean handleWheel) { return call_method<"setWheelScrollingEnabled", void>(handleWheel); }
