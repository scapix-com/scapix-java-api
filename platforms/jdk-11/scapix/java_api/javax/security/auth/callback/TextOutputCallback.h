...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_CALLBACK_TEXTOUTPUTCALLBACK
...
public:
	...
	static jni::ref<javax::security::auth::callback::TextOutputCallback> new_object(jint messageType, jni::ref<java::lang::String> message) { return object_base::new_object(messageType, message); }
