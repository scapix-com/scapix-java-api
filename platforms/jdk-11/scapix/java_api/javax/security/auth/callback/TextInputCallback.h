...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_CALLBACK_TEXTINPUTCALLBACK
...
public:
	...
	static jni::ref<javax::security::auth::callback::TextInputCallback> new_object(jni::ref<java::lang::String> prompt) { return object_base::new_object(prompt); }
	static jni::ref<javax::security::auth::callback::TextInputCallback> new_object(jni::ref<java::lang::String> prompt, jni::ref<java::lang::String> defaultText) { return object_base::new_object(prompt, defaultText); }
