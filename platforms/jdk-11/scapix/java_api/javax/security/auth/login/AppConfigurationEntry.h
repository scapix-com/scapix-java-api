...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_LOGIN_APPCONFIGURATIONENTRY
...
public:
	...
	static jni::ref<javax::security::auth::login::AppConfigurationEntry> new_object(jni::ref<java::lang::String> loginModuleName, jni::ref<javax::security::auth::login::AppConfigurationEntry_LoginModuleControlFlag> controlFlag, jni::ref<java::util::Map> options) { return object_base::new_object(loginModuleName, controlFlag, options); }
