...
#ifndef SCAPIX_JAVA_API_JAVAX_PRINT_ATTRIBUTE_STANDARD_JOBMEDIASHEETSSUPPORTED
...
public:
	...
	static jni::ref<javax::print::attribute::standard::JobMediaSheetsSupported> new_object(jint lowerBound, jint upperBound) { return object_base::new_object(lowerBound, upperBound); }
