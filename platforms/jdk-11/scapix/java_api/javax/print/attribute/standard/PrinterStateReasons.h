...
#ifndef SCAPIX_JAVA_API_JAVAX_PRINT_ATTRIBUTE_STANDARD_PRINTERSTATEREASONS
...
public:
	...
	static jni::ref<javax::print::attribute::standard::PrinterStateReasons> new_object() { return object_base::new_object(); }
	static jni::ref<javax::print::attribute::standard::PrinterStateReasons> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<javax::print::attribute::standard::PrinterStateReasons> new_object(jint initialCapacity, jfloat loadFactor) { return object_base::new_object(initialCapacity, loadFactor); }
	static jni::ref<javax::print::attribute::standard::PrinterStateReasons> new_object(jni::ref<java::util::Map> map) { return object_base::new_object(map); }
	jni::ref<javax::print::attribute::standard::Severity> put(jni::ref<javax::print::attribute::standard::PrinterStateReason> reason, jni::ref<javax::print::attribute::standard::Severity> severity) { return call_method<"put", jni::ref<javax::print::attribute::standard::Severity>>(reason, severity); }
	jni::ref<java::lang::Class> getCategory() { return call_method<"getCategory", jni::ref<java::lang::Class>>(); }
	jni::ref<java::lang::String> getName() { return call_method<"getName", jni::ref<java::lang::String>>(); }
	jni::ref<java::util::Set> printerStateReasonSet(jni::ref<javax::print::attribute::standard::Severity> severity) { return call_method<"printerStateReasonSet", jni::ref<java::util::Set>>(severity); }
};
