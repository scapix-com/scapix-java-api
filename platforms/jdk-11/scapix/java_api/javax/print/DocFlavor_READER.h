...
#ifndef SCAPIX_JAVA_API_JAVAX_PRINT_DOCFLAVOR_READER
...
public:
	...
	static jni::ref<javax::print::DocFlavor_READER> new_object(jni::ref<java::lang::String> mimeType) { return object_base::new_object(mimeType); }
};
