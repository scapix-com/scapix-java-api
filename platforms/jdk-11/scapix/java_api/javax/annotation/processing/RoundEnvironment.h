...
#ifndef SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_ROUNDENVIRONMENT
...
public:
	...
	jni::ref<java::util::Set> getElementsAnnotatedWithAny(jni::ref<jni::array<javax::lang::model::element::TypeElement>> annotations) { return call_method<"getElementsAnnotatedWithAny", jni::ref<java::util::Set>>(annotations); }
	...
	jni::ref<java::util::Set> getElementsAnnotatedWithAny(jni::ref<java::util::Set> annotations) { return call_method<"getElementsAnnotatedWithAny", jni::ref<java::util::Set>>(annotations); }
};
