...
#ifndef SCAPIX_JAVA_API_JAVAX_TOOLS_DIAGNOSTICCOLLECTOR
...
public:
	...
	static jni::ref<javax::tools::DiagnosticCollector> new_object() { return object_base::new_object(); }
	void report(jni::ref<javax::tools::Diagnostic> diagnostic) { return call_method<"report", void>(diagnostic); }
