...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_DOM_DOMSIGNCONTEXT
...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<java::security::Key> signingKey, jni::ref<org::w3c::dom::Node> parent) { return object_base::new_object(signingKey, parent); }
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<java::security::Key> signingKey, jni::ref<org::w3c::dom::Node> parent, jni::ref<org::w3c::dom::Node> nextSibling) { return object_base::new_object(signingKey, parent, nextSibling); }
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<javax::xml::crypto::KeySelector> ks, jni::ref<org::w3c::dom::Node> parent) { return object_base::new_object(ks, parent); }
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<javax::xml::crypto::KeySelector> ks, jni::ref<org::w3c::dom::Node> parent, jni::ref<org::w3c::dom::Node> nextSibling) { return object_base::new_object(ks, parent, nextSibling); }
	void setParent(jni::ref<org::w3c::dom::Node> parent) { return call_method<"setParent", void>(parent); }
