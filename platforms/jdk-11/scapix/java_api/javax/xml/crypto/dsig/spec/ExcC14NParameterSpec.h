...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_SPEC_EXCC14NPARAMETERSPEC
...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::spec::ExcC14NParameterSpec> new_object() { return object_base::new_object(); }
	static jni::ref<javax::xml::crypto::dsig::spec::ExcC14NParameterSpec> new_object(jni::ref<java::util::List> prefixList) { return object_base::new_object(prefixList); }
