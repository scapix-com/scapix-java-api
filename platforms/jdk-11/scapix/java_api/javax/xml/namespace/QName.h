...
public:
	...
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> namespaceURI, jni::ref<java::lang::String> localPart) { return object_base::new_object(namespaceURI, localPart); }
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> namespaceURI, jni::ref<java::lang::String> localPart, jni::ref<java::lang::String> prefix) { return object_base::new_object(namespaceURI, localPart, prefix); }
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> localPart) { return object_base::new_object(localPart); }
