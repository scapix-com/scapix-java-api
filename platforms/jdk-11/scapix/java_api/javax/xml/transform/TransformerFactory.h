...
public:
	...
	static jni::ref<javax::xml::transform::TransformerFactory> newDefaultInstance() { return call_static_method<"newDefaultInstance", jni::ref<javax::xml::transform::TransformerFactory>>(); }
