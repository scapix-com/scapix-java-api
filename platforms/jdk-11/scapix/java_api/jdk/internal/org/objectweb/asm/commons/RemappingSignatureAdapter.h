...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::RemappingSignatureAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> v, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return base_::new_object(v, remapper); }
