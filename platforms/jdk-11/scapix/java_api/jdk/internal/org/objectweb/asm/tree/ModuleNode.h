...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class ModuleNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::ModuleNode> new_object(jni::ref<java::lang::String> name, jint access, jni::ref<java::lang::String> version) { return object_base::new_object(name, access, version); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::ModuleNode> new_object(jint api, jni::ref<java::lang::String> name, jint access, jni::ref<java::lang::String> version, jni::ref<java::util::List> requires_, jni::ref<java::util::List> exports, jni::ref<java::util::List> opens, jni::ref<java::util::List> uses, jni::ref<java::util::List> provides) { return object_base::new_object(api, name, access, version, requires_, exports, opens, uses, provides); }
