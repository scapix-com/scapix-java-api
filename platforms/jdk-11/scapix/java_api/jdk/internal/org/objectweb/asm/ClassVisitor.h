...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv) { return object_base::new_object(api, cv); }
