...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv) { return object_base::new_object(api, mv); }
