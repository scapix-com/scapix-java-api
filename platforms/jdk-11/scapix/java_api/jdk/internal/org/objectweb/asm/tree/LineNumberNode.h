...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class LineNumberNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::LineNumberNode> new_object(jint line, jni::ref<jdk::internal::org::objectweb::asm_::tree::LabelNode> start) { return object_base::new_object(line, start); }
