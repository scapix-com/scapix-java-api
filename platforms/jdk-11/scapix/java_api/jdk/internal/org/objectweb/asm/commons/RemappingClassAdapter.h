...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::RemappingClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return object_base::new_object(cv, remapper); }
