...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class CheckMethodAdapter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckMethodAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv) { return object_base::new_object(mv); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckMethodAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv, jni::ref<java::util::Map> labels) { return object_base::new_object(mv, labels); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckMethodAdapter> new_object(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> cmv, jni::ref<java::util::Map> labels) { return object_base::new_object(access, name, desc, cmv, labels); }
