...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::FrameNode> new_object(jint type, jint nLocal, jni::ref<jni::array<java::lang::Object>> local, jint nStack, jni::ref<jni::array<java::lang::Object>> stack) { return object_base::new_object(type, nLocal, local, nStack, stack); }
