...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_SIGNATURE_SIGNATUREWRITER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_SIGNATURE_SIGNATUREWRITER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::signature { class SignatureWriter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::signature::SignatureWriter>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/signature/SignatureWriter";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::signature::SignatureVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_SIGNATURE_SIGNATUREWRITER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_SIGNATURE_SIGNATUREWRITER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_SIGNATURE_SIGNATUREWRITER
...
class jdk::internal::org::objectweb::asm_::signature::SignatureWriter : public jni::object_base<"jdk/internal/org/objectweb/asm/signature/SignatureWriter",
	jdk::internal::org::objectweb::asm_::signature::SignatureVisitor>
{
public:

	static jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureWriter> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_SIGNATURE_SIGNATUREWRITER
