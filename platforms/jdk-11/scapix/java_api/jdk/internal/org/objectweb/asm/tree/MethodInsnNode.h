...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodInsnNode> new_object(jint opcode, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc) { return object_base::new_object(opcode, owner, name, desc); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodInsnNode> new_object(jint opcode, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jboolean itf) { return object_base::new_object(opcode, owner, name, desc, itf); }
