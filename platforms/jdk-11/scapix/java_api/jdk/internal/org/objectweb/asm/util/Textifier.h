...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class Textifier; }}
...
public:
	...
	static jint TYPE_DECLARATION() { return get_static_field<"TYPE_DECLARATION", jint>(); }
	static jint CLASS_DECLARATION() { return get_static_field<"CLASS_DECLARATION", jint>(); }
	static jint PARAMETERS_DECLARATION() { return get_static_field<"PARAMETERS_DECLARATION", jint>(); }
	static jint HANDLE_DESCRIPTOR() { return get_static_field<"HANDLE_DESCRIPTOR", jint>(); }

	static jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> new_object() { return object_base::new_object(); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitClassAnnotation(jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitClassAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(desc, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> visitClassTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitClassTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Printer>>(typeRef, typePath, desc, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitField(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<java::lang::Object> value) { return call_method<"visitField", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(access, name, desc, signature, value); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitMethod(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<jni::array<java::lang::String>> exceptions) { return call_method<"visitMethod", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(access, name, desc, signature, exceptions); }
	...
	void visitExport(jni::ref<java::lang::String> export_, jint access, jni::ref<jni::array<java::lang::String>> modules) { return call_method<"visitExport", void>(export_, access, modules); }
	void visitOpen(jni::ref<java::lang::String> export_, jint access, jni::ref<jni::array<java::lang::String>> modules) { return call_method<"visitOpen", void>(export_, access, modules); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitAnnotation(jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc) { return call_method<"visitAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(name, desc); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitFieldAnnotation(jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitFieldAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(desc, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> visitFieldTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitFieldTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Printer>>(typeRef, typePath, desc, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitMethodAnnotation(jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitMethodAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(desc, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> visitMethodTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitMethodTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Printer>>(typeRef, typePath, desc, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitParameterAnnotation(jint parameter, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitParameterAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(parameter, desc, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> visitInsnAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitInsnAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Printer>>(typeRef, typePath, desc, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> visitTryCatchAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitTryCatchAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Printer>>(typeRef, typePath, desc, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitAnnotation(jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(desc, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier> visitTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc, jboolean visible) { return call_method<"visitTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::Textifier>>(typeRef, typePath, desc, visible); }
