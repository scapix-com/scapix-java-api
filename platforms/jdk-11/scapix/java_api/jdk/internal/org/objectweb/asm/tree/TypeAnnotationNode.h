...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::TypeAnnotationNode> new_object(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc) { return object_base::new_object(typeRef, typePath, desc); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::TypeAnnotationNode> new_object(jint api, jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> desc) { return object_base::new_object(api, typeRef, typePath, desc); }
