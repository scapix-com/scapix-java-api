...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::Handle> new_object(jint tag, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc) { return base_::new_object(tag, owner, name, desc); }
	static jni::ref<jdk::internal::org::objectweb::asm_::Handle> new_object(jint tag, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jboolean itf) { return base_::new_object(tag, owner, name, desc, itf); }
