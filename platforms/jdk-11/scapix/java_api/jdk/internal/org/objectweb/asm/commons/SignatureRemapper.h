...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::SignatureRemapper> new_object(jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> v, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return object_base::new_object(v, remapper); }
