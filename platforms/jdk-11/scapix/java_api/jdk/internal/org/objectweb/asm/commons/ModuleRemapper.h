...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::ModuleRemapper> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> mv, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return base_::new_object(mv, remapper); }
