...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckAnnotationAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> av) { return object_base::new_object(av); }
