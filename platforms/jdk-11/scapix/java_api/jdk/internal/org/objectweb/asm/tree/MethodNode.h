...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class MethodNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> new_object(jint api) { return object_base::new_object(api); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> new_object(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<jni::array<java::lang::String>> exceptions) { return object_base::new_object(access, name, desc, signature, exceptions); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> new_object(jint api, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<jni::array<java::lang::String>> exceptions) { return object_base::new_object(api, access, name, desc, signature, exceptions); }
