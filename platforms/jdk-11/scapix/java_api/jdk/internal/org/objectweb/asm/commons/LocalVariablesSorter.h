...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::LocalVariablesSorter> new_object(jint access, jni::ref<java::lang::String> desc, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv) { return object_base::new_object(access, desc, mv); }
