...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class Attribute_NestMembers; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::Attribute_NestMembers> new_object() { return object_base::new_object(); }
