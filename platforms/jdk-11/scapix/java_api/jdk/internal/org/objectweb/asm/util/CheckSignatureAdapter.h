...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckSignatureAdapter> new_object(jint type, jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> sv) { return object_base::new_object(type, sv); }
