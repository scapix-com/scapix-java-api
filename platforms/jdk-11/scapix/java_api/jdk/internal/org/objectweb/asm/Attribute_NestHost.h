...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class Attribute_NestHost; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::Attribute_NestHost> new_object() { return object_base::new_object(); }
