...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceModuleVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> p) { return object_base::new_object(p); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceModuleVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> mv, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> p) { return object_base::new_object(mv, p); }
