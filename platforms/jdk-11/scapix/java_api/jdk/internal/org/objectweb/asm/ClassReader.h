...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<jni::array<jbyte>> b) { return object_base::new_object(b); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<jni::array<jbyte>> b, jint off, jint len) { return object_base::new_object(b, off, len); }
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
