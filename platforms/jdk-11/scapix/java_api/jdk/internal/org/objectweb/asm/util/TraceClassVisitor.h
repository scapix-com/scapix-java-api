...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceClassVisitor> new_object(jni::ref<java::io::PrintWriter> pw) { return object_base::new_object(pw); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceClassVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv, jni::ref<java::io::PrintWriter> pw) { return object_base::new_object(cv, pw); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceClassVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> p, jni::ref<java::io::PrintWriter> pw) { return object_base::new_object(cv, p, pw); }
