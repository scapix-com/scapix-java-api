...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class FieldNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::FieldNode> new_object(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<java::lang::Object> value) { return object_base::new_object(access, name, desc, signature, value); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::FieldNode> new_object(jint api, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<java::lang::Object> value) { return object_base::new_object(api, access, name, desc, signature, value); }
