...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class Printer; }}
...
public:
	...
	void print(jni::ref<java::io::PrintWriter> pw) { return call_method<"print", void>(pw); }
	static void appendString(jni::ref<java::lang::StringBuffer> buf, jni::ref<java::lang::String> s) { return call_static_method<"appendString", void>(buf, s); }
