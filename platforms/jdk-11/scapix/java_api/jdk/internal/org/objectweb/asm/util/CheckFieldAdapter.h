...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckFieldAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::FieldVisitor> fv) { return base_::new_object(fv); }
