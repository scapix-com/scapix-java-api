...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::InstructionAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv) { return object_base::new_object(mv); }
