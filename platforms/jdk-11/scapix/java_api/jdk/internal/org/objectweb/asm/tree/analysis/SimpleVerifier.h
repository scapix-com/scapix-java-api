...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree::analysis { class SimpleVerifier; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::SimpleVerifier> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::SimpleVerifier> new_object(jni::ref<jdk::internal::org::objectweb::asm_::Type> currentClass, jni::ref<jdk::internal::org::objectweb::asm_::Type> currentSuperClass, jboolean isInterface) { return object_base::new_object(currentClass, currentSuperClass, isInterface); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::SimpleVerifier> new_object(jni::ref<jdk::internal::org::objectweb::asm_::Type> currentClass, jni::ref<jdk::internal::org::objectweb::asm_::Type> currentSuperClass, jni::ref<java::util::List> currentClassInterfaces, jboolean isInterface) { return object_base::new_object(currentClass, currentSuperClass, currentClassInterfaces, isInterface); }
