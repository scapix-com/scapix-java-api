...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv) { return base_::new_object(cv); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv, jboolean checkDataFlow) { return base_::new_object(cv, checkDataFlow); }
