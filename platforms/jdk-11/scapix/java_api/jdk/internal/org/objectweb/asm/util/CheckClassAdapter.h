...
public:
	...
	static void verify(jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> cr, jni::ref<java::lang::ClassLoader> loader, jboolean dump, jni::ref<java::io::PrintWriter> pw) { return call_static_method<"verify", void>(cr, loader, dump, pw); }
	static void verify(jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> cr, jboolean dump, jni::ref<java::io::PrintWriter> pw) { return call_static_method<"verify", void>(cr, dump, pw); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv) { return object_base::new_object(cv); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv, jboolean checkDataFlow) { return object_base::new_object(cv, checkDataFlow); }
