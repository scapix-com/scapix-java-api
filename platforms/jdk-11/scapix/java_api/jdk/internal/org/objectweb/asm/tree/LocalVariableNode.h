...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class LocalVariableNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::LocalVariableNode> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<java::lang::String> signature, jni::ref<jdk::internal::org::objectweb::asm_::tree::LabelNode> start, jni::ref<jdk::internal::org::objectweb::asm_::tree::LabelNode> end, jint index) { return object_base::new_object(name, desc, signature, start, end, index); }
