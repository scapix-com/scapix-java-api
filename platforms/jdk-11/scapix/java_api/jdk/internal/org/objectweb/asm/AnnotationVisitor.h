...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> av) { return object_base::new_object(api, av); }
