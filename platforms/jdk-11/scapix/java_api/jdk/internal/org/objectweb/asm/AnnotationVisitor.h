...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> av) { return base_::new_object(api, av); }
