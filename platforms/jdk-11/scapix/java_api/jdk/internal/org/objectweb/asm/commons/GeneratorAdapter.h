...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc) { return object_base::new_object(mv, access, name, desc); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jint access, jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> method, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv) { return object_base::new_object(access, method, mv); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::GeneratorAdapter> new_object(jint access, jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> method, jni::ref<java::lang::String> signature, jni::ref<jni::array<jdk::internal::org::objectweb::asm_::Type>> exceptions, jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> cv) { return object_base::new_object(access, method, signature, exceptions, cv); }
