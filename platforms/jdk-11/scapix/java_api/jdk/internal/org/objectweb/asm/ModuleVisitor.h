...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> mv) { return object_base::new_object(api, mv); }
