...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> new_object(jint api, jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> mv) { return base_::new_object(api, mv); }
