...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> p) { return base_::new_object(p); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> p) { return base_::new_object(mv, p); }
