...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc) { return base_::new_object(name, desc); }
