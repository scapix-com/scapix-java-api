...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class Method; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc) { return object_base::new_object(name, desc); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> new_object(jni::ref<java::lang::String> name, jni::ref<jdk::internal::org::objectweb::asm_::Type> returnType, jni::ref<jni::array<jdk::internal::org::objectweb::asm_::Type>> argumentTypes) { return object_base::new_object(name, returnType, argumentTypes); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> getMethod(jni::ref<java::lang::reflect::Method> m) { return call_static_method<"getMethod", jni::ref<jdk::internal::org::objectweb::asm_::commons::Method>>(m); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> getMethod(jni::ref<java::lang::reflect::Constructor> c) { return call_static_method<"getMethod", jni::ref<jdk::internal::org::objectweb::asm_::commons::Method>>(c); }
