...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::AnalyzerException> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::AbstractInsnNode> node, jni::ref<java::lang::String> msg) { return object_base::new_object(node, msg); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::AnalyzerException> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::AbstractInsnNode> node, jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> exception) { return object_base::new_object(node, msg, exception); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::AnalyzerException> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::AbstractInsnNode> node, jni::ref<java::lang::String> msg, jni::ref<java::lang::Object> expected, jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value> encountered) { return object_base::new_object(node, msg, expected, encountered); }
