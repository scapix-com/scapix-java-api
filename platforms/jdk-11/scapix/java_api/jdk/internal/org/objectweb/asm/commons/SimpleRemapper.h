...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class SimpleRemapper; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::SimpleRemapper> new_object(jni::ref<java::util::Map> mapping) { return object_base::new_object(mapping); }
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::SimpleRemapper> new_object(jni::ref<java::lang::String> oldName, jni::ref<java::lang::String> newName) { return object_base::new_object(oldName, newName); }
