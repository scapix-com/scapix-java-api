...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree::analysis { class Analyzer; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Analyzer> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Interpreter> interpreter) { return object_base::new_object(interpreter); }
	jni::ref<jni::array<jdk::internal::org::objectweb::asm_::tree::analysis::Frame>> analyze(jni::ref<java::lang::String> owner, jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> m) { return call_method<"analyze", jni::ref<jni::array<jdk::internal::org::objectweb::asm_::tree::analysis::Frame>>>(owner, m); }
	...
	jni::ref<java::util::List> getHandlers(jint insn) { return call_method<"getHandlers", jni::ref<java::util::List>>(insn); }
