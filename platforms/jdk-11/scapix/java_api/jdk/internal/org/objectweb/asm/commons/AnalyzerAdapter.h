...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::AnalyzerAdapter> new_object(jni::ref<java::lang::String> owner, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> desc, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> mv) { return object_base::new_object(owner, access, name, desc, mv); }
