...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> new_object(jint nLocals, jint nStack) { return object_base::new_object(nLocals, nStack); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> src) { return object_base::new_object(src); }
