...
public:
	...
	static void logX509ValidationEvent(jint anchorCertId, jni::ref<jni::array<jint>> certIds) { return call_static_method<"logX509ValidationEvent", void>(anchorCertId, certIds); }
