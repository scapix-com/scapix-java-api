...
namespace scapix::java_api { namespace jdk::internal::module { class IllegalAccessLogger_Builder; }}
...
public:
	...
	static jni::ref<jdk::internal::module::IllegalAccessLogger_Builder> new_object(jni::ref<jdk::internal::module::IllegalAccessLogger_Mode> mode, jni::ref<java::io::PrintStream> warningStream) { return object_base::new_object(mode, warningStream); }
