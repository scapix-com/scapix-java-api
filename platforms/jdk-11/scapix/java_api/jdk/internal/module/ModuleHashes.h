...
namespace scapix::java_api { namespace jdk::internal::module { class ModuleHashes; }}
...
public:
	...
	static jni::ref<jdk::internal::module::ModuleHashes> new_object(jni::ref<java::lang::String> algorithm, jni::ref<java::util::Map> nameToHash) { return object_base::new_object(algorithm, nameToHash); }
