...
public:
	...
	static jni::ref<jdk::internal::module::ServicesCatalog_ServiceProvider> new_object(jni::ref<jdk::internal::module::ServicesCatalog> this_0, jni::ref<java::lang::Module> module, jni::ref<java::lang::String> providerName) { return base_::new_object(this_0, module, providerName); }
