...
namespace scapix::java_api { namespace jdk::internal::ref { class SoftCleanable; }}
...
public:
	...
	static jni::ref<jdk::internal::ref::SoftCleanable> new_object(jni::ref<java::lang::Object> referent, jni::ref<java::lang::ref::Cleaner> cleaner) { return object_base::new_object(referent, cleaner); }
