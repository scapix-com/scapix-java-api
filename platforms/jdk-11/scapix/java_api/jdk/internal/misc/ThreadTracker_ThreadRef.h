...
namespace scapix::java_api { namespace jdk::internal::misc { class ThreadTracker_ThreadRef; }}
...
#include <scapix/java_api/jdk/internal/misc/ThreadTracker.h>
...
public:
	...
	static jni::ref<jdk::internal::misc::ThreadTracker_ThreadRef> new_object(jni::ref<jdk::internal::misc::ThreadTracker> p1, jni::ref<java::lang::Thread> p2) { return object_base::new_object(p1, p2); }
