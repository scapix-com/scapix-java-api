...
public:
	...
	static jni::ref<jdk::internal::misc::ThreadTracker_ThreadRef> new_object(jni::ref<jdk::internal::misc::ThreadTracker> p1, jni::ref<java::lang::Thread> thread) { return base_::new_object(p1, thread); }
