...
namespace scapix::java_api { namespace jdk::internal::misc { class VM; }}
...
public:
	...
	static jni::ref<jdk::internal::misc::VM> new_object() { return object_base::new_object(); }
	...
	static void saveAndRemoveProperties(jni::ref<java::util::Properties> props) { return call_static_method<"saveAndRemoveProperties", void>(props); }
