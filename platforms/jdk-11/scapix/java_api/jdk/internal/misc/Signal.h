...
namespace scapix::java_api { namespace jdk::internal::misc { class Signal; }}
...
public:
	...
	static jni::ref<jdk::internal::misc::Signal> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
