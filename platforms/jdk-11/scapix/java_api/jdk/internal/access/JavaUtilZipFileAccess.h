...
namespace scapix::java_api { namespace jdk::internal::access { class JavaUtilZipFileAccess; }}
...
public:
	...
	jni::ref<jni::array<java::lang::String>> getMetaInfEntryNames(jni::ref<java::util::zip::ZipFile> p1) { return call_method<"getMetaInfEntryNames", jni::ref<jni::array<java::lang::String>>>(p1); }
	jni::ref<java::util::jar::JarEntry> getEntry(jni::ref<java::util::zip::ZipFile> p1, jni::ref<java::lang::String> p2, jni::ref<java::util::function::Function> p3) { return call_method<"getEntry", jni::ref<java::util::jar::JarEntry>>(p1, p2, p3); }
	jint getManifestNum(jni::ref<java::util::jar::JarFile> p1) { return call_method<"getManifestNum", jint>(p1); }
	jni::ref<java::util::Enumeration> entries(jni::ref<java::util::zip::ZipFile> p1, jni::ref<java::util::function::Function> p2) { return call_method<"entries", jni::ref<java::util::Enumeration>>(p1, p2); }
	jni::ref<java::util::stream::Stream> stream(jni::ref<java::util::zip::ZipFile> p1, jni::ref<java::util::function::Function> p2) { return call_method<"stream", jni::ref<java::util::stream::Stream>>(p1, p2); }
