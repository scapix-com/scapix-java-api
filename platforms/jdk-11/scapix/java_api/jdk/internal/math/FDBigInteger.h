...
namespace scapix::java_api { namespace jdk::internal::math { class FDBigInteger; }}
...
public:
	...
	static jni::ref<jdk::internal::math::FDBigInteger> new_object(jlong lValue, jni::ref<jni::array<jchar>> digits, jint kDigits, jint nDigits) { return object_base::new_object(lValue, digits, kDigits, nDigits); }
	...
	static jni::ref<jdk::internal::math::FDBigInteger> valueOfMulPow52(jlong value, jint p5, jint p2) { return call_static_method<"valueOfMulPow52", jni::ref<jdk::internal::math::FDBigInteger>>(value, p5, p2); }
