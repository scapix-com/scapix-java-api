...
namespace scapix::java_api { namespace jdk::internal::jmod { class JmodFile; }}
...
public:
	...
	static jni::ref<jdk::internal::jmod::JmodFile> new_object(jni::ref<java::nio::file::Path> file) { return object_base::new_object(file); }
