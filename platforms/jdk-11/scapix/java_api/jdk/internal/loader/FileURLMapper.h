...
namespace scapix::java_api { namespace jdk::internal::loader { class FileURLMapper; }}
...
public:
	...
	static jni::ref<jdk::internal::loader::FileURLMapper> new_object(jni::ref<java::net::URL> url) { return object_base::new_object(url); }
