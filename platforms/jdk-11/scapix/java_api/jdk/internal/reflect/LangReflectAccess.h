...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_LANGREFLECTACCESS_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_LANGREFLECTACCESS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::reflect { class LangReflectAccess; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::LangReflectAccess>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/LangReflectAccess";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_LANGREFLECTACCESS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_LANGREFLECTACCESS)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_LANGREFLECTACCESS
...
class jdk::internal::reflect::LangReflectAccess : public jni::object_base<"jdk/internal/reflect/LangReflectAccess",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_LANGREFLECTACCESS
