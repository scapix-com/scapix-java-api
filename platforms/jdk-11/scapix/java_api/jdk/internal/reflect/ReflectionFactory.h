...
public:
	...
	void setLangReflectAccess(jni::ref<jdk::internal::reflect::LangReflectAccess> access) { return call_method<"setLangReflectAccess", void>(access); }
	...
	jni::ref<jdk::internal::reflect::MethodAccessor> newMethodAccessor(jni::ref<java::lang::reflect::Method> method) { return call_method<"newMethodAccessor", jni::ref<jdk::internal::reflect::MethodAccessor>>(method); }
	...
	jni::ref<java::lang::reflect::Field> newField(jni::ref<java::lang::Class> declaringClass, jni::ref<java::lang::String> name, jni::ref<java::lang::Class> type, jint modifiers, jint slot, jni::ref<java::lang::String> signature, jni::ref<jni::array<jbyte>> annotations) { return call_method<"newField", jni::ref<java::lang::reflect::Field>>(declaringClass, name, type, modifiers, slot, signature, annotations); }
	jni::ref<java::lang::reflect::Method> newMethod(jni::ref<java::lang::Class> declaringClass, jni::ref<java::lang::String> name, jni::ref<jni::array<java::lang::Class>> parameterTypes, jni::ref<java::lang::Class> returnType, jni::ref<jni::array<java::lang::Class>> checkedExceptions, jint modifiers, jint slot, jni::ref<java::lang::String> signature, jni::ref<jni::array<jbyte>> annotations, jni::ref<jni::array<jbyte>> parameterAnnotations, jni::ref<jni::array<jbyte>> annotationDefault) { return call_method<"newMethod", jni::ref<java::lang::reflect::Method>>(declaringClass, name, parameterTypes, returnType, checkedExceptions, modifiers, slot, signature, annotations, parameterAnnotations, annotationDefault); }
