...
namespace scapix::java_api { namespace jdk::internal::reflect { class Reflection; }}
...
public:
	...
	static jni::ref<jdk::internal::reflect::Reflection> new_object() { return object_base::new_object(); }
