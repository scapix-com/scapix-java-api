...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_LOGGER_ABSTRACTLOGGERWRAPPER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_LOGGER_ABSTRACTLOGGERWRAPPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::logger { class AbstractLoggerWrapper; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::logger::AbstractLoggerWrapper>
{
	static constexpr fixed_string class_name = "jdk/internal/logger/AbstractLoggerWrapper";
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_LOGGER_ABSTRACTLOGGERWRAPPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_LOGGER_ABSTRACTLOGGERWRAPPER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_LOGGER_ABSTRACTLOGGERWRAPPER
...
// private
class jdk::internal::logger::AbstractLoggerWrapper : public jni::object_base<"jdk/internal/logger/AbstractLoggerWrapper",
	java::lang::Object,
...
protected:
	...
	AbstractLoggerWrapper(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_LOGGER_ABSTRACTLOGGERWRAPPER
