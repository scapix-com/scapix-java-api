...
public:
	...
	void read(jni::ref<java::nio::ByteBuffer> dst, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> p3, jni::ref<java::lang::Object> unit, jni::ref<java::nio::channels::CompletionHandler> attachment) { return call_method<"read", void>(dst, timeout, p3, unit, attachment); }
	void read(jni::ref<jni::array<java::nio::ByteBuffer>> dsts, jint offset, jint length, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> p5, jni::ref<java::lang::Object> unit, jni::ref<java::nio::channels::CompletionHandler> attachment) { return call_method<"read", void>(dsts, offset, length, timeout, p5, unit, attachment); }
	...
	void write(jni::ref<java::nio::ByteBuffer> src, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> p3, jni::ref<java::lang::Object> unit, jni::ref<java::nio::channels::CompletionHandler> attachment) { return call_method<"write", void>(src, timeout, p3, unit, attachment); }
	void write(jni::ref<jni::array<java::nio::ByteBuffer>> srcs, jint offset, jint length, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> p5, jni::ref<java::lang::Object> unit, jni::ref<java::nio::channels::CompletionHandler> attachment) { return call_method<"write", void>(srcs, offset, length, timeout, p5, unit, attachment); }
