...
public:
	...
	static jni::ref<sun::nio::ch::DatagramChannelImpl> new_object(jni::ref<java::nio::channels::spi::SelectorProvider> sp) { return object_base::new_object(sp); }
	static jni::ref<sun::nio::ch::DatagramChannelImpl> new_object(jni::ref<java::nio::channels::spi::SelectorProvider> sp, jni::ref<java::net::ProtocolFamily> family) { return object_base::new_object(sp, family); }
	static jni::ref<sun::nio::ch::DatagramChannelImpl> new_object(jni::ref<java::nio::channels::spi::SelectorProvider> sp, jni::ref<java::io::FileDescriptor> fd) { return object_base::new_object(sp, fd); }
