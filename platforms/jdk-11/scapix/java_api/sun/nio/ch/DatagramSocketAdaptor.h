...
public:
	...
	static jni::ref<java::net::DatagramSocket> create(jni::ref<sun::nio::ch::DatagramChannelImpl> dc) { return call_static_method<"create", jni::ref<java::net::DatagramSocket>>(dc); }
