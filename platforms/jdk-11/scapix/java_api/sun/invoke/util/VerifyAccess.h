...
namespace scapix::java_api { namespace sun::invoke::util { class VerifyAccess; }}
...
public:
	...
	static jboolean isMemberAccessible(jni::ref<java::lang::Class> refc, jni::ref<java::lang::Class> defc, jint mods, jni::ref<java::lang::Class> lookupClass, jint allowedModes) { return call_static_method<"isMemberAccessible", jboolean>(refc, defc, mods, lookupClass, allowedModes); }
	static jboolean isClassAccessible(jni::ref<java::lang::Class> refc, jni::ref<java::lang::Class> lookupClass, jint allowedModes) { return call_static_method<"isClassAccessible", jboolean>(refc, lookupClass, allowedModes); }
