...
namespace scapix::java_api { namespace sun::invoke::util { class ValueConversions; }}
...
public:
	...
	static jni::ref<sun::invoke::util::ValueConversions> new_object() { return object_base::new_object(); }
	...
	static jni::ref<java::lang::invoke::MethodHandle> zeroConstantFunction(jni::ref<sun::invoke::util::Wrapper> wrap) { return call_static_method<"zeroConstantFunction", jni::ref<java::lang::invoke::MethodHandle>>(wrap); }
	...
	static jni::ref<java::lang::invoke::MethodHandle> cast() { return call_static_method<"cast", jni::ref<java::lang::invoke::MethodHandle>>(); }
