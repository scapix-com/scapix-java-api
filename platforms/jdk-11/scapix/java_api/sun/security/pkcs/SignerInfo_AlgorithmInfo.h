...
public:
	...
	static jni::ref<sun::security::pkcs::SignerInfo_AlgorithmInfo> new_object(jni::ref<sun::security::pkcs::SignerInfo> this_0, jni::ref<java::lang::String> field, jboolean checkKey) { return base_::new_object(this_0, field, checkKey); }
