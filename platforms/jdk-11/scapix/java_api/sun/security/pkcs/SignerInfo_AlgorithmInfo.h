...
namespace scapix::java_api { namespace sun::security::pkcs { class SignerInfo_AlgorithmInfo; }}
...
public:
	...
	static jni::ref<sun::security::pkcs::SignerInfo_AlgorithmInfo> new_object(jni::ref<sun::security::pkcs::SignerInfo> this_0, jni::ref<java::lang::String> field, jboolean checkKey) { return object_base::new_object(this_0, field, checkKey); }
