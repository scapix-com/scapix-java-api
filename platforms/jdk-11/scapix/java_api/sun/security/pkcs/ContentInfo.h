...
public:
	...
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::ObjectIdentifier> contentType, jni::ref<sun::security::util::DerValue> content) { return base_::new_object(contentType, content); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<jni::array<jbyte>> bytes) { return base_::new_object(bytes); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::DerInputStream> derin) { return base_::new_object(derin); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::DerInputStream> derin, jboolean oldStyle) { return base_::new_object(derin, oldStyle); }
