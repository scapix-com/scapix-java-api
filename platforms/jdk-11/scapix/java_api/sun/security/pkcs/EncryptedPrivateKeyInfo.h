...
namespace scapix::java_api { namespace sun::security::pkcs { class EncryptedPrivateKeyInfo; }}
...
public:
	...
	static jni::ref<sun::security::pkcs::EncryptedPrivateKeyInfo> new_object(jni::ref<jni::array<jbyte>> encoded) { return object_base::new_object(encoded); }
	static jni::ref<sun::security::pkcs::EncryptedPrivateKeyInfo> new_object(jni::ref<sun::security::x509::AlgorithmId> algid, jni::ref<jni::array<jbyte>> encryptedData) { return object_base::new_object(algid, encryptedData); }
