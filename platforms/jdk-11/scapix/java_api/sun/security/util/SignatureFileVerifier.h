...
namespace scapix::java_api { namespace sun::security::util { class SignatureFileVerifier; }}
...
public:
	...
	static jni::ref<sun::security::util::SignatureFileVerifier> new_object(jni::ref<java::util::ArrayList> signerCache, jni::ref<sun::security::util::ManifestDigester> md, jni::ref<java::lang::String> name, jni::ref<jni::array<jbyte>> rawBytes) { return object_base::new_object(signerCache, md, name, rawBytes); }
