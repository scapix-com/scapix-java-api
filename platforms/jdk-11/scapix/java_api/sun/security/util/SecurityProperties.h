...
public:
	...
	static jni::ref<java::lang::String> privilegedGet(jni::ref<java::lang::String> propName) { return call_static_method<"privilegedGet", jni::ref<java::lang::String>>(propName); }
