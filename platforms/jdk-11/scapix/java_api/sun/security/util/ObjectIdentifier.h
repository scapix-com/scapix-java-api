...
public:
	...
	static jni::ref<sun::security::util::ObjectIdentifier> new_object(jni::ref<java::lang::String> oid) { return base_::new_object(oid); }
	static jni::ref<sun::security::util::ObjectIdentifier> new_object(jni::ref<jni::array<jint>> values) { return base_::new_object(values); }
