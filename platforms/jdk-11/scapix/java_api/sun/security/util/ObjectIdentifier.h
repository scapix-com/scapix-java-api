...
public:
	...
	static jni::ref<sun::security::util::ObjectIdentifier> new_object(jni::ref<java::lang::String> oid) { return object_base::new_object(oid); }
	static jni::ref<sun::security::util::ObjectIdentifier> new_object(jni::ref<jni::array<jint>> values) { return object_base::new_object(values); }
	static jni::ref<sun::security::util::ObjectIdentifier> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
	...
	static jni::ref<sun::security::util::ObjectIdentifier> newInternal(jni::ref<jni::array<jint>> values) { return call_static_method<"newInternal", jni::ref<sun::security::util::ObjectIdentifier>>(values); }
