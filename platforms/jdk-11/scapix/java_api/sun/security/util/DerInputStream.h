...
public:
	...
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> data, jint offset, jint len, jboolean allowBER) { return base_::new_object(data, offset, len, allowBER); }
