...
public:
	...
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> data) { return object_base::new_object(data); }
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> data, jint offset, jint len, jboolean allowBER) { return object_base::new_object(data, offset, len, allowBER); }
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> data, jint offset, jint len) { return object_base::new_object(data, offset, len); }
	jni::ref<sun::security::util::DerInputStream> subStream(jint len, jboolean do_skip) { return call_method<"subStream", jni::ref<sun::security::util::DerInputStream>>(len, do_skip); }
	...
	void getBytes(jni::ref<jni::array<jbyte>> val) { return call_method<"getBytes", void>(val); }
	...
	void mark(jint value) { return call_method<"mark", void>(value); }
