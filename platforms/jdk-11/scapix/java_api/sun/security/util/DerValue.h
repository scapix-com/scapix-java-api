...
public:
	...
	static jni::ref<sun::security::util::DerValue> new_object(jbyte tag, jni::ref<jni::array<jbyte>> data) { return object_base::new_object(tag, data); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> buf) { return object_base::new_object(buf); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> buf, jint offset, jint len) { return object_base::new_object(buf, offset, len); }
