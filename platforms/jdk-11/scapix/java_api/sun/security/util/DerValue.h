...
public:
	...
	static jni::ref<sun::security::util::DerValue> new_object(jbyte tag, jni::ref<jni::array<jbyte>> data) { return base_::new_object(tag, data); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> buf) { return base_::new_object(buf); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> buf, jint offset, jint len) { return base_::new_object(buf, offset, len); }
