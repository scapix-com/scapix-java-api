...
namespace scapix::java_api { namespace sun::security::util::math::intpoly { class IntegerPolynomial_Element; }}
...
public:
	...
	static jni::ref<sun::security::util::math::intpoly::IntegerPolynomial_Element> new_object(jni::ref<sun::security::util::math::intpoly::IntegerPolynomial> p1, jni::ref<java::math::BigInteger> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::util::math::intpoly::IntegerPolynomial_Element> new_object(jni::ref<sun::security::util::math::intpoly::IntegerPolynomial> p1, jboolean p2) { return object_base::new_object(p1, p2); }
