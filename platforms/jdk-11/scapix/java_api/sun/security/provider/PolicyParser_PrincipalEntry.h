...
namespace scapix::java_api { namespace sun::security::provider { class PolicyParser_PrincipalEntry; }}
...
public:
	...
	static jni::ref<sun::security::provider::PolicyParser_PrincipalEntry> new_object(jni::ref<java::lang::String> principalClass, jni::ref<java::lang::String> principalName) { return object_base::new_object(principalClass, principalName); }
