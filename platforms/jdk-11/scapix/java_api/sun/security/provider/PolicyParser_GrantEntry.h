...
public:
	...
	static jni::ref<sun::security::provider::PolicyParser_GrantEntry> new_object(jni::ref<java::lang::String> signedBy, jni::ref<java::lang::String> codeBase) { return base_::new_object(signedBy, codeBase); }
