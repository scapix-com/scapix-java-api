...
namespace scapix::java_api { namespace sun::security::ssl { class SSLLogger; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLLogger> new_object() { return object_base::new_object(); }
