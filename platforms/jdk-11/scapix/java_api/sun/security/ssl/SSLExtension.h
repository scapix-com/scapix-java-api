...
namespace scapix::java_api { namespace sun::security::ssl { class SSLExtension; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLExtension> SESSION_TICKET() { return get_static_field<"SESSION_TICKET", jni::ref<sun::security::ssl::SSLExtension>>(); }
	...
	jni::ref<java::lang::String> toString(jni::ref<java::nio::ByteBuffer> byteBuffer) { return call_method<"toString", jni::ref<java::lang::String>>(byteBuffer); }
