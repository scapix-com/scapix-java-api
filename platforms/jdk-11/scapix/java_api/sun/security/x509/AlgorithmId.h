...
namespace scapix::java_api { namespace sun::security::x509 { class AlgorithmId; }}
...
public:
	...
	static jni::ref<sun::security::x509::AlgorithmId> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::AlgorithmId> new_object(jni::ref<sun::security::util::ObjectIdentifier> oid) { return object_base::new_object(oid); }
	static jni::ref<sun::security::x509::AlgorithmId> new_object(jni::ref<sun::security::util::ObjectIdentifier> oid, jni::ref<java::security::AlgorithmParameters> algparams) { return object_base::new_object(oid, algparams); }
