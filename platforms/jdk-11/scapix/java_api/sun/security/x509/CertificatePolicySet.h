...
namespace scapix::java_api { namespace sun::security::x509 { class CertificatePolicySet; }}
...
public:
	...
	static jni::ref<sun::security::x509::CertificatePolicySet> new_object(jni::ref<java::util::Vector> ids) { return object_base::new_object(ids); }
	static jni::ref<sun::security::x509::CertificatePolicySet> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
