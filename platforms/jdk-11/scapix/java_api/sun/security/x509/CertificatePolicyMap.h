...
namespace scapix::java_api { namespace sun::security::x509 { class CertificatePolicyMap; }}
...
public:
	...
	static jni::ref<sun::security::x509::CertificatePolicyMap> new_object(jni::ref<sun::security::x509::CertificatePolicyId> issuer, jni::ref<sun::security::x509::CertificatePolicyId> subject) { return object_base::new_object(issuer, subject); }
	static jni::ref<sun::security::x509::CertificatePolicyMap> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
