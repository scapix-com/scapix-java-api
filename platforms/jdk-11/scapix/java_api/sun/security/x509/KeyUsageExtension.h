...
public:
	...
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<jni::array<jbyte>> bitString) { return object_base::new_object(bitString); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<jni::array<jboolean>> bitString) { return object_base::new_object(bitString); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<sun::security::util::BitArray> bitString) { return object_base::new_object(bitString); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
