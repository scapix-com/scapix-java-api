...
public:
	...
	static jni::ref<sun::security::x509::X509CertImpl> new_object() { return object_base::new_object(); }
	...
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::x509::X509CertInfo> certInfo) { return object_base::new_object(certInfo); }
	...
	void sign(jni::ref<java::security::PrivateKey> key, jni::ref<java::security::spec::AlgorithmParameterSpec> signingParams, jni::ref<java::lang::String> algorithm, jni::ref<java::lang::String> provider) { return call_method<"sign", void>(key, signingParams, algorithm, provider); }
	...
	jni::ref<java::lang::String> getFingerprint(jni::ref<java::lang::String> algorithm) { return call_method<"getFingerprint", jni::ref<java::lang::String>>(algorithm); }
	static jni::ref<java::lang::String> getFingerprint(jni::ref<java::lang::String> algorithm, jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"getFingerprint", jni::ref<java::lang::String>>(algorithm, cert); }
