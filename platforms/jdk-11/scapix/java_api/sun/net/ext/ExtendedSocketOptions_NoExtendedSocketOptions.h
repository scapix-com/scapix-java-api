...
namespace scapix::java_api { namespace sun::net::ext { class ExtendedSocketOptions_NoExtendedSocketOptions; }}
...
public:
	...
	void setOption(jni::ref<java::io::FileDescriptor> fd, jni::ref<java::net::SocketOption> option, jni::ref<java::lang::Object> value) { return call_method<"setOption", void>(fd, option, value); }
	jni::ref<java::lang::Object> getOption(jni::ref<java::io::FileDescriptor> fd, jni::ref<java::net::SocketOption> option) { return call_method<"getOption", jni::ref<java::lang::Object>>(fd, option); }
