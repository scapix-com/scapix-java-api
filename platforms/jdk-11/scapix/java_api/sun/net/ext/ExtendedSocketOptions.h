...
namespace scapix::java_api { namespace sun::net::ext { class ExtendedSocketOptions; }}
...
public:
	...
	static jni::ref<java::util::Set> options(jshort type) { return call_static_method<"options", jni::ref<java::util::Set>>(type); }
