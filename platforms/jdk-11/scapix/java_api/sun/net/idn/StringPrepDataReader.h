...
namespace scapix::java_api { namespace sun::net::idn { class StringPrepDataReader; }}
...
public:
	...
	static jni::ref<sun::net::idn::StringPrepDataReader> new_object(jni::ref<java::io::InputStream> inputStream) { return object_base::new_object(inputStream); }
