...
#ifndef SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERCATEGORY_FWD
#define SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERCATEGORY_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::net::idn { class UCharacterEnums_ECharacterCategory; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::net::idn::UCharacterEnums_ECharacterCategory>
{
	static constexpr fixed_string class_name = "sun/net/idn/UCharacterEnums$ECharacterCategory";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERCATEGORY_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERCATEGORY)
#define SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERCATEGORY

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class sun::net::idn::UCharacterEnums_ECharacterCategory : public jni::object_base<"sun/net/idn/UCharacterEnums$ECharacterCategory",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERCATEGORY
