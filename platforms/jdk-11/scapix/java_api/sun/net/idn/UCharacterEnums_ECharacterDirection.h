...
#ifndef SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERDIRECTION_FWD
#define SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERDIRECTION_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::net::idn { class UCharacterEnums_ECharacterDirection; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::net::idn::UCharacterEnums_ECharacterDirection>
{
	static constexpr fixed_string class_name = "sun/net/idn/UCharacterEnums$ECharacterDirection";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERDIRECTION_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERDIRECTION)
#define SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERDIRECTION

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class sun::net::idn::UCharacterEnums_ECharacterDirection : public jni::object_base<"sun/net/idn/UCharacterEnums$ECharacterDirection",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_NET_IDN_UCHARACTERENUMS_ECHARACTERDIRECTION
