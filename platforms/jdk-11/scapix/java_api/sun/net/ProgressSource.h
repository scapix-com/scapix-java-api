...
namespace scapix::java_api { namespace sun::net { class ProgressSource; }}
...
public:
	...
	static jni::ref<sun::net::ProgressSource> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::String> method) { return object_base::new_object(url, method); }
	static jni::ref<sun::net::ProgressSource> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::String> method, jlong expected) { return object_base::new_object(url, method, expected); }
	...
	void updateProgress(jlong latestProgress, jlong expectedProgress) { return call_method<"updateProgress", void>(latestProgress, expectedProgress); }
