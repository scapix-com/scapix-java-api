...
namespace scapix::java_api { namespace sun::net::www::protocol::http { class AuthCacheValue; }}
...
public:
	...
	static void setAuthCache(jni::ref<sun::net::www::protocol::http::AuthCache> map) { return call_static_method<"setAuthCache", void>(map); }
