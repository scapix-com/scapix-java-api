...
public:
	...
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::lang::String> realm, jni::ref<java::net::PasswordAuthentication> pw, jni::ref<java::lang::String> authenticatorKey) { return object_base::new_object(isProxy, url, realm, pw, authenticatorKey); }
