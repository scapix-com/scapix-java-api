...
namespace scapix::java_api { namespace sun::net::www { class MeteredStream; }}
...
public:
	...
	static jni::ref<sun::net::www::MeteredStream> new_object(jni::ref<java::io::InputStream> is, jni::ref<sun::net::ProgressSource> pi, jlong expected) { return object_base::new_object(is, pi, expected); }
