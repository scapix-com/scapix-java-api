...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_BIDI_BIDIBASE_FWD
#define SCAPIX_JAVA_API_SUN_TEXT_BIDI_BIDIBASE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::text::bidi { class BidiBase; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::text::bidi::BidiBase>
{
	static constexpr fixed_string class_name = "sun/text/bidi/BidiBase";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_TEXT_BIDI_BIDIBASE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_TEXT_BIDI_BIDIBASE)
#define SCAPIX_JAVA_API_SUN_TEXT_BIDI_BIDIBASE

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/java/lang/String.h>
#include <scapix/java_api/java/text/AttributedCharacterIterator.h>
#include <scapix/java_api/java/text/Bidi.h>
#include <scapix/java_api/sun/text/bidi/BidiBase_BidiPairedBracketType.h>
...
class sun::text::bidi::BidiBase : public jni::object_base<"sun/text/bidi/BidiBase",
	java::lang::Object>
{
public:
	...
	static jni::ref<sun::text::bidi::BidiBase> new_object(jint maxLength, jint maxRunCount) { return object_base::new_object(maxLength, maxRunCount); }
	...
	jni::ref<java::text::Bidi> setLine(jni::ref<java::text::Bidi> bidi, jni::ref<sun::text::bidi::BidiBase> bidiBase, jni::ref<java::text::Bidi> newBidi, jni::ref<sun::text::bidi::BidiBase> newBidiBase, jint start, jint limit) { return call_method<"setLine", jni::ref<java::text::Bidi>>(bidi, bidiBase, newBidi, newBidiBase, start, limit); }
	...
	static jni::ref<sun::text::bidi::BidiBase> new_object(jni::ref<jni::array<jchar>> text, jint textStart, jni::ref<jni::array<jbyte>> embeddings, jint embStart, jint paragraphLength, jint flags) { return object_base::new_object(text, textStart, embeddings, embStart, paragraphLength, flags); }
...
#endif // SCAPIX_JAVA_API_SUN_TEXT_BIDI_BIDIBASE
