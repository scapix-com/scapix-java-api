...
namespace scapix::java_api::sun::text::bidi { class BidiBase; }
...
public:
	...
	static jni::ref<sun::text::bidi::BidiBase> new_object(jint maxLength, jint maxRunCount) { return base_::new_object(maxLength, maxRunCount); }
	...
	static jni::ref<sun::text::bidi::BidiBase> new_object(jni::ref<jni::array<jchar>> text, jint textStart, jni::ref<jni::array<jbyte>> embeddings, jint embStart, jint paragraphLength, jint flags) { return base_::new_object(text, textStart, embeddings, embStart, paragraphLength, flags); }
