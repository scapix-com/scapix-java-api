...
namespace scapix::java_api { namespace sun::text::normalizer { class ReplaceableUCharacterIterator; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::ReplaceableUCharacterIterator> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
	static jni::ref<sun::text::normalizer::ReplaceableUCharacterIterator> new_object(jni::ref<java::lang::StringBuffer> buf) { return object_base::new_object(buf); }
