...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_UTF16_FWD
#define SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_UTF16_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::text::normalizer { class UTF16; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::text::normalizer::UTF16>
{
	static constexpr fixed_string class_name = "sun/text/normalizer/UTF16";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_UTF16_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_UTF16)
#define SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_UTF16
...
class sun::text::normalizer::UTF16 : public jni::object_base<"sun/text/normalizer/UTF16",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_UTF16
