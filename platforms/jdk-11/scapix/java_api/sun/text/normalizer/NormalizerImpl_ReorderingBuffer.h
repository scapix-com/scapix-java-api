...
namespace scapix::java_api { namespace sun::text::normalizer { class NormalizerImpl_ReorderingBuffer; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::NormalizerImpl_ReorderingBuffer> new_object(jni::ref<sun::text::normalizer::NormalizerImpl> ni, jni::ref<java::lang::Appendable> dest, jint destCapacity) { return object_base::new_object(ni, dest, destCapacity); }
