...
namespace scapix::java_api { namespace sun::text::normalizer { class UnicodeSet; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::UnicodeSet> new_object(jint start, jint end) { return object_base::new_object(start, end); }
	static jni::ref<sun::text::normalizer::UnicodeSet> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
