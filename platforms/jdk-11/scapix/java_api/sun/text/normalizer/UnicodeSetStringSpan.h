...
namespace scapix::java_api { namespace sun::text::normalizer { class UnicodeSetStringSpan; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::UnicodeSetStringSpan> new_object(jni::ref<sun::text::normalizer::UnicodeSet> set, jni::ref<java::util::ArrayList> setStrings, jint which) { return object_base::new_object(set, setStrings, which); }
