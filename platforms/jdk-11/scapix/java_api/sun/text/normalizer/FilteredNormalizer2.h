...
namespace scapix::java_api { namespace sun::text::normalizer { class FilteredNormalizer2; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::FilteredNormalizer2> new_object(jni::ref<sun::text::normalizer::Normalizer2> n2, jni::ref<sun::text::normalizer::UnicodeSet> filterSet) { return object_base::new_object(n2, filterSet); }
