...
namespace scapix::java_api { namespace sun::text::normalizer { class Norm2AllModes_ComposeNormalizer2; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::Norm2AllModes_ComposeNormalizer2> new_object(jni::ref<sun::text::normalizer::NormalizerImpl> ni, jboolean fcc) { return object_base::new_object(ni, fcc); }
