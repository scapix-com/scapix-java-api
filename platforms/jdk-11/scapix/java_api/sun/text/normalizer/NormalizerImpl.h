...
namespace scapix::java_api { namespace sun::text::normalizer { class NormalizerImpl; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::NormalizerImpl> new_object() { return object_base::new_object(); }
