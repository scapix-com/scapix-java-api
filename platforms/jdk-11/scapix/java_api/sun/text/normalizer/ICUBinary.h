...
namespace scapix::java_api { namespace sun::text::normalizer { class ICUBinary; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::ICUBinary> new_object() { return object_base::new_object(); }
