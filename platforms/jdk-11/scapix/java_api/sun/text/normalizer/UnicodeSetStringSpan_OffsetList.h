...
namespace scapix::java_api { namespace sun::text::normalizer { class UnicodeSetStringSpan_OffsetList; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::UnicodeSetStringSpan_OffsetList> new_object() { return object_base::new_object(); }
