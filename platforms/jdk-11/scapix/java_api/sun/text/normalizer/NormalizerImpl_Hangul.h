...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORMALIZERIMPL_HANGUL_FWD
#define SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORMALIZERIMPL_HANGUL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::text::normalizer { class NormalizerImpl_Hangul; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::text::normalizer::NormalizerImpl_Hangul>
{
	static constexpr fixed_string class_name = "sun/text/normalizer/NormalizerImpl$Hangul";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORMALIZERIMPL_HANGUL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORMALIZERIMPL_HANGUL)
#define SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORMALIZERIMPL_HANGUL
...
class sun::text::normalizer::NormalizerImpl_Hangul : public jni::object_base<"sun/text/normalizer/NormalizerImpl$Hangul",
	java::lang::Object>
{
public:
	...
	static jni::ref<sun::text::normalizer::NormalizerImpl_Hangul> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORMALIZERIMPL_HANGUL
