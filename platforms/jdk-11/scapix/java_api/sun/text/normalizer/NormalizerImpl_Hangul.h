...
namespace scapix::java_api::sun::text::normalizer { class NormalizerImpl_Hangul; }
...
public:
	...
	static jni::ref<sun::text::normalizer::NormalizerImpl_Hangul> new_object() { return base_::new_object(); }
