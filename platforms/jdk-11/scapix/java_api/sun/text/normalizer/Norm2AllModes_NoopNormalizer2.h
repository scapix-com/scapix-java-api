...
namespace scapix::java_api { namespace sun::text::normalizer { class Norm2AllModes_NoopNormalizer2; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::Norm2AllModes_NoopNormalizer2> new_object() { return object_base::new_object(); }
