...
namespace scapix::java_api { namespace sun::text::normalizer { class NormalizerImpl_UTF16Plus; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::NormalizerImpl_UTF16Plus> new_object() { return object_base::new_object(); }
