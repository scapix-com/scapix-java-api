...
namespace scapix::java_api { namespace sun::text::normalizer { class CharTrie; }}
...
public:
	...
	static jni::ref<sun::text::normalizer::CharTrie> new_object(jni::ref<java::io::InputStream> inputStream, jni::ref<sun::text::normalizer::Trie_DataManipulate> dataManipulate) { return object_base::new_object(inputStream, dataManipulate); }
