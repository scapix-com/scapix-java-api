...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORM2ALLMODES_NORMALIZER2WITHIMPL_FWD
#define SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORM2ALLMODES_NORMALIZER2WITHIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::text::normalizer { class Norm2AllModes_Normalizer2WithImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::text::normalizer::Norm2AllModes_Normalizer2WithImpl>
{
	static constexpr fixed_string class_name = "sun/text/normalizer/Norm2AllModes$Normalizer2WithImpl";
	using base_classes = std::tuple<scapix::java_api::sun::text::normalizer::Normalizer2>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORM2ALLMODES_NORMALIZER2WITHIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORM2ALLMODES_NORMALIZER2WITHIMPL)
#define SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORM2ALLMODES_NORMALIZER2WITHIMPL
...
class sun::text::normalizer::Norm2AllModes_Normalizer2WithImpl : public jni::object_base<"sun/text/normalizer/Norm2AllModes$Normalizer2WithImpl",
...
public:
	...
	static jni::ref<sun::text::normalizer::Norm2AllModes_Normalizer2WithImpl> new_object(jni::ref<sun::text::normalizer::NormalizerImpl> ni) { return object_base::new_object(ni); }
...
#endif // SCAPIX_JAVA_API_SUN_TEXT_NORMALIZER_NORM2ALLMODES_NORMALIZER2WITHIMPL
