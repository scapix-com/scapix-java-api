...
namespace scapix::java_api::sun::text::normalizer { class Norm2AllModes_Normalizer2WithImpl; }
...
public:
	...
	static jni::ref<sun::text::normalizer::Norm2AllModes_Normalizer2WithImpl> new_object(jni::ref<sun::text::normalizer::NormalizerImpl> ni) { return base_::new_object(ni); }
