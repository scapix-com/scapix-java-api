...
namespace scapix::java_api { namespace sun::text { class CollatorUtilities; }}
...
public:
	...
	static jint toLegacyMode(jni::ref<sun::text::normalizer::NormalizerBase_Mode> mode) { return call_static_method<"toLegacyMode", jint>(mode); }
	static jni::ref<sun::text::normalizer::NormalizerBase_Mode> toNormalizerMode(jint mode) { return call_static_method<"toNormalizerMode", jni::ref<sun::text::normalizer::NormalizerBase_Mode>>(mode); }
