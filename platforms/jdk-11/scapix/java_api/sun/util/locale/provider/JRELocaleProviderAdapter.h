...
namespace scapix::java_api::sun::util::locale::provider { class JRELocaleProviderAdapter; }
...
public:
	...
	static jni::ref<sun::util::locale::provider::JRELocaleProviderAdapter> new_object() { return base_::new_object(); }
...
protected:
	...
	JRELocaleProviderAdapter(handle_type h) : base_(h) {}
