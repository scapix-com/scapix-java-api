...
namespace scapix::java_api { namespace sun::util::locale::provider { class SPILocaleProviderAdapter_DateFormatSymbolsProviderDelegate; }}
...
public:
	...
	void addImpl(jni::ref<java::text::spi::DateFormatSymbolsProvider> impl) { return call_method<"addImpl", void>(impl); }
	jni::ref<java::text::spi::DateFormatSymbolsProvider> getImpl(jni::ref<java::util::Locale> locale) { return call_method<"getImpl", jni::ref<java::text::spi::DateFormatSymbolsProvider>>(locale); }
