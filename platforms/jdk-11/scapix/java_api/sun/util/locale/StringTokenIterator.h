...
public:
	...
	static jni::ref<sun::util::locale::StringTokenIterator> new_object(jni::ref<java::lang::String> text, jni::ref<java::lang::String> dlms) { return base_::new_object(text, dlms); }
