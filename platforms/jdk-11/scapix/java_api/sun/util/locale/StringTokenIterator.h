...
namespace scapix::java_api { namespace sun::util::locale { class StringTokenIterator; }}
...
public:
	...
	static jni::ref<sun::util::locale::StringTokenIterator> new_object(jni::ref<java::lang::String> text, jni::ref<java::lang::String> dlms) { return object_base::new_object(text, dlms); }
	...
	jni::ref<sun::util::locale::StringTokenIterator> setStart(jint offset) { return call_method<"setStart", jni::ref<sun::util::locale::StringTokenIterator>>(offset); }
	jni::ref<sun::util::locale::StringTokenIterator> setText(jni::ref<java::lang::String> text) { return call_method<"setText", jni::ref<sun::util::locale::StringTokenIterator>>(text); }
