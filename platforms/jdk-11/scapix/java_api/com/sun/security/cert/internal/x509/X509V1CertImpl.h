...
namespace scapix::java_api { namespace com::sun::security::cert::internal::x509 { class X509V1CertImpl; }}
...
public:
	...
	static jni::ref<com::sun::security::cert::internal::x509::X509V1CertImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::security::cert::internal::x509::X509V1CertImpl> new_object(jni::ref<jni::array<jbyte>> certData) { return object_base::new_object(certData); }
	static jni::ref<com::sun::security::cert::internal::x509::X509V1CertImpl> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
