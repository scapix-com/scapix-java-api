...
namespace scapix::java_api { namespace com::sun::net::ssl { class TrustManagerFactory; }}
...
public:
	...
	static jni::ref<com::sun::net::ssl::TrustManagerFactory> getInstance(jni::ref<java::lang::String> algorithm) { return call_static_method<"getInstance", jni::ref<com::sun::net::ssl::TrustManagerFactory>>(algorithm); }
	static jni::ref<com::sun::net::ssl::TrustManagerFactory> getInstance(jni::ref<java::lang::String> algorithm, jni::ref<java::lang::String> provider) { return call_static_method<"getInstance", jni::ref<com::sun::net::ssl::TrustManagerFactory>>(algorithm, provider); }
	static jni::ref<com::sun::net::ssl::TrustManagerFactory> getInstance(jni::ref<java::lang::String> algorithm, jni::ref<java::security::Provider> provider) { return call_static_method<"getInstance", jni::ref<com::sun::net::ssl::TrustManagerFactory>>(algorithm, provider); }
