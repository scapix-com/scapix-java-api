...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_SSL_INTERNAL_WWW_PROTOCOL_HTTPS_HTTPSURLCONNECTIONOLDIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_NET_SSL_INTERNAL_WWW_PROTOCOL_HTTPS_HTTPSURLCONNECTIONOLDIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::net::ssl::internal::www::protocol::https { class HttpsURLConnectionOldImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::net::ssl::internal::www::protocol::https::HttpsURLConnectionOldImpl>
{
	static constexpr fixed_string class_name = "com/sun/net/ssl/internal/www/protocol/https/HttpsURLConnectionOldImpl";
	using base_classes = std::tuple<scapix::java_api::com::sun::net::ssl::HttpsURLConnection>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_NET_SSL_INTERNAL_WWW_PROTOCOL_HTTPS_HTTPSURLCONNECTIONOLDIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_NET_SSL_INTERNAL_WWW_PROTOCOL_HTTPS_HTTPSURLCONNECTIONOLDIMPL)
#define SCAPIX_JAVA_API_COM_SUN_NET_SSL_INTERNAL_WWW_PROTOCOL_HTTPS_HTTPSURLCONNECTIONOLDIMPL
...
class com::sun::net::ssl::internal::www::protocol::https::HttpsURLConnectionOldImpl : public jni::object_base<"com/sun/net/ssl/internal/www/protocol/https/HttpsURLConnectionOldImpl",
...
public:
	...
	jint getHeaderFieldInt(jni::ref<java::lang::String> name, jint Default) { return call_method<"getHeaderFieldInt", jint>(name, Default); }
	jlong getHeaderFieldLong(jni::ref<java::lang::String> name, jlong Default) { return call_method<"getHeaderFieldLong", jlong>(name, Default); }
...
protected:
	...
	HttpsURLConnectionOldImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_NET_SSL_INTERNAL_WWW_PROTOCOL_HTTPS_HTTPSURLCONNECTIONOLDIMPL
