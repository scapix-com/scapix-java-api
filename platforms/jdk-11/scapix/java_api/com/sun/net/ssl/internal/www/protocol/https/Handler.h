...
namespace scapix::java_api { namespace com::sun::net::ssl::internal::www::protocol::https { class Handler; }}
...
public:
	...
	static jni::ref<com::sun::net::ssl::internal::www::protocol::https::Handler> new_object(jni::ref<java::lang::String> proxy, jint port) { return object_base::new_object(proxy, port); }
