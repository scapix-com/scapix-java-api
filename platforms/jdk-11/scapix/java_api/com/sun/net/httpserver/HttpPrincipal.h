...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_HTTPSERVER_HTTPPRINCIPAL
...
public:
	...
	static jni::ref<com::sun::net::httpserver::HttpPrincipal> new_object(jni::ref<java::lang::String> username, jni::ref<java::lang::String> realm) { return object_base::new_object(username, realm); }
	jboolean equals(jni::ref<java::lang::Object> another) { return call_method<"equals", jboolean>(another); }
