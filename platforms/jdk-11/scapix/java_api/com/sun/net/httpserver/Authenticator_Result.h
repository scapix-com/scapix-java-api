...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_HTTPSERVER_AUTHENTICATOR_RESULT
...
public:
	...
	static jni::ref<com::sun::net::httpserver::Authenticator_Result> new_object() { return object_base::new_object(); }
};
