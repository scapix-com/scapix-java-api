...
#ifndef SCAPIX_JAVA_API_COM_SUN_NIO_SCTP_MESSAGEINFO
...
public:
	...
	static jni::ref<com::sun::nio::sctp::MessageInfo> createOutgoing(jni::ref<java::net::SocketAddress> address, jint streamNumber) { return call_static_method<"createOutgoing", jni::ref<com::sun::nio::sctp::MessageInfo>>(address, streamNumber); }
	static jni::ref<com::sun::nio::sctp::MessageInfo> createOutgoing(jni::ref<com::sun::nio::sctp::Association> association, jni::ref<java::net::SocketAddress> address, jint streamNumber) { return call_static_method<"createOutgoing", jni::ref<com::sun::nio::sctp::MessageInfo>>(association, address, streamNumber); }
