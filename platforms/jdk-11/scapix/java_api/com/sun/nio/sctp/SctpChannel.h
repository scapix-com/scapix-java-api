...
#ifndef SCAPIX_JAVA_API_COM_SUN_NIO_SCTP_SCTPCHANNEL
...
public:
	...
	static jni::ref<com::sun::nio::sctp::SctpChannel> open(jni::ref<java::net::SocketAddress> remote, jint maxOutStreams, jint maxInStreams) { return call_static_method<"open", jni::ref<com::sun::nio::sctp::SctpChannel>>(remote, maxOutStreams, maxInStreams); }
