...
#ifndef SCAPIX_JAVA_API_COM_SUN_NIO_FILE_SENSITIVITYWATCHEVENTMODIFIER
...
public:
	...
	static jni::ref<com::sun::nio::file::SensitivityWatchEventModifier> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<com::sun::nio::file::SensitivityWatchEventModifier>>(name); }
