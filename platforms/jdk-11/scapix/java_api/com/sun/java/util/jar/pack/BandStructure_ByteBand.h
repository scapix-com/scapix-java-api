...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::BandStructure_ByteBand> new_object(jni::ref<com::sun::java::util::jar::pack::BandStructure> this_0, jni::ref<java::lang::String> name) { return object_base::new_object(this_0, name); }
