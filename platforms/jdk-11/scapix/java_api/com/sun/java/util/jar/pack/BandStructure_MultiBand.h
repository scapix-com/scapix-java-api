...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class BandStructure_MultiBand; }}
...
public:
	...
	void setCapacity(jint cap) { return call_method<"setCapacity", void>(cap); }
