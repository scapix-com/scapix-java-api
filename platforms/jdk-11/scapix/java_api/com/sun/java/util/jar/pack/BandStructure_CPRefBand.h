...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::BandStructure_CPRefBand> new_object(jni::ref<com::sun::java::util::jar::pack::BandStructure> this_0, jni::ref<java::lang::String> name, jni::ref<com::sun::java::util::jar::pack::Coding> regularCoding, jbyte cpTag, jboolean nullOK) { return object_base::new_object(this_0, name, regularCoding, cpTag, nullOK); }
	static jni::ref<com::sun::java::util::jar::pack::BandStructure_CPRefBand> new_object(jni::ref<com::sun::java::util::jar::pack::BandStructure> this_0, jni::ref<java::lang::String> name, jni::ref<com::sun::java::util::jar::pack::Coding> regularCoding, jbyte cpTag) { return object_base::new_object(this_0, name, regularCoding, cpTag); }
	static jni::ref<com::sun::java::util::jar::pack::BandStructure_CPRefBand> new_object(jni::ref<com::sun::java::util::jar::pack::BandStructure> this_0, jni::ref<java::lang::String> name, jni::ref<com::sun::java::util::jar::pack::Coding> regularCoding, jni::ref<java::lang::Object> undef) { return object_base::new_object(this_0, name, regularCoding, undef); }
