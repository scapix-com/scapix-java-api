...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class PropMap; }}
...
public:
	...
	jni::ref<java::lang::String> put(jni::ref<java::lang::String> key, jni::ref<java::lang::String> value) { return call_method<"put", jni::ref<java::lang::String>>(key, value); }
	...
	jni::ref<java::lang::String> get(jni::ref<java::lang::Object> key) { return call_method<"get", jni::ref<java::lang::String>>(key); }
	jni::ref<java::lang::String> remove(jni::ref<java::lang::Object> key) { return call_method<"remove", jni::ref<java::lang::String>>(key); }
	...
	jni::ref<java::util::SortedMap> subMap(jni::ref<java::lang::String> fromKey, jni::ref<java::lang::String> toKey) { return call_method<"subMap", jni::ref<java::util::SortedMap>>(fromKey, toKey); }
	jni::ref<java::util::SortedMap> headMap(jni::ref<java::lang::String> toKey) { return call_method<"headMap", jni::ref<java::util::SortedMap>>(toKey); }
	jni::ref<java::util::SortedMap> tailMap(jni::ref<java::lang::String> fromKey) { return call_method<"tailMap", jni::ref<java::util::SortedMap>>(fromKey); }
