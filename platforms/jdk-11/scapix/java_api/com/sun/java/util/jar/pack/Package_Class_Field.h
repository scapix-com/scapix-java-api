...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Package_Class_Field> new_object(jni::ref<com::sun::java::util::jar::pack::Package_Class> this_1, jint flags, jni::ref<com::sun::java::util::jar::pack::ConstantPool_DescriptorEntry> descriptor) { return object_base::new_object(this_1, flags, descriptor); }
