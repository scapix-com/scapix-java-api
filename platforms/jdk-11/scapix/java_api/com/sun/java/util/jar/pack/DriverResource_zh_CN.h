...
namespace scapix::java_api::com::sun::java::util::jar::pack { class DriverResource_zh_CN; }
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::DriverResource_zh_CN> new_object() { return base_::new_object(); }

protected:

	DriverResource_zh_CN(handle_type h) : base_(h) {}
