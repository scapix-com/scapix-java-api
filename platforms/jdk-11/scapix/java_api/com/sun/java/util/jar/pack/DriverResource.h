...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class DriverResource; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::DriverResource> new_object() { return object_base::new_object(); }
