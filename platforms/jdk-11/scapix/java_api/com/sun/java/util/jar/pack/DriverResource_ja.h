...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_DRIVERRESOURCE_JA_FWD
#define SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_DRIVERRESOURCE_JA_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class DriverResource_ja; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::java::util::jar::pack::DriverResource_ja>
{
	static constexpr fixed_string class_name = "com/sun/java/util/jar/pack/DriverResource_ja";
	using base_classes = std::tuple<scapix::java_api::java::util::ListResourceBundle>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_DRIVERRESOURCE_JA_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_DRIVERRESOURCE_JA)
#define SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_DRIVERRESOURCE_JA
...
class com::sun::java::util::jar::pack::DriverResource_ja : public jni::object_base<"com/sun/java/util/jar/pack/DriverResource_ja",
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::DriverResource_ja> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_DRIVERRESOURCE_JA
