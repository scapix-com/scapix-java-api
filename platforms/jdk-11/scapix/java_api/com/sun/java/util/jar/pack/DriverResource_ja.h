...
namespace scapix::java_api::com::sun::java::util::jar::pack { class DriverResource_ja; }
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::DriverResource_ja> new_object() { return base_::new_object(); }

protected:

	DriverResource_ja(handle_type h) : base_(h) {}
