...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::ClassReader_ClassFormatException> new_object(jni::ref<java::lang::String> message) { return base_::new_object(message); }
	static jni::ref<com::sun::java::util::jar::pack::ClassReader_ClassFormatException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return base_::new_object(message, cause); }
