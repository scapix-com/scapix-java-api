...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class ClassReader_ClassFormatException; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::ClassReader_ClassFormatException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<com::sun::java::util::jar::pack::ClassReader_ClassFormatException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
