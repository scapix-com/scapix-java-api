...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Fixups; }}
...
public:
	...
	void visitRefs(jni::ref<java::util::Collection> refs) { return call_method<"visitRefs", void>(refs); }
	void clear() { return call_method<"clear", void>(); }
	jni::ref<jni::array<jbyte>> getBytes() { return call_method<"getBytes", jni::ref<jni::array<jbyte>>>(); }
	void setBytes(jni::ref<jni::array<jbyte>> newBytes) { return call_method<"setBytes", void>(newBytes); }
	jni::ref<java::util::Iterator> iterator() { return call_method<"iterator", jni::ref<java::util::Iterator>>(); }
	void add(jint location, jint format, jni::ref<com::sun::java::util::jar::pack::ConstantPool_Entry> entry) { return call_method<"add", void>(location, format, entry); }
	jboolean add(jni::ref<com::sun::java::util::jar::pack::Fixups_Fixup> f) { return call_method<"add", jboolean>(f); }
	jboolean addAll(jni::ref<java::util::Collection> c) { return call_method<"addAll", jboolean>(c); }
	static void setBytes(jni::ref<java::lang::Object> fixups, jni::ref<jni::array<jbyte>> bytes) { return call_static_method<"setBytes", void>(fixups, bytes); }
	static jni::ref<java::lang::Object> trimToSize(jni::ref<java::lang::Object> fixups) { return call_static_method<"trimToSize", jni::ref<java::lang::Object>>(fixups); }
	static void visitRefs(jni::ref<java::lang::Object> fixups, jni::ref<java::util::Collection> refs) { return call_static_method<"visitRefs", void>(fixups, refs); }
	static void finishRefs(jni::ref<java::lang::Object> fixups, jni::ref<jni::array<jbyte>> bytes, jni::ref<com::sun::java::util::jar::pack::ConstantPool_Index> ix) { return call_static_method<"finishRefs", void>(fixups, bytes, ix); }
