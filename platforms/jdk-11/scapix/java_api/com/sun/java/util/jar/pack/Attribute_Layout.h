...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Attribute_Layout> new_object(jint ctype, jni::ref<java::lang::String> name, jni::ref<java::lang::String> layout) { return object_base::new_object(ctype, name, layout); }
