...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Attribute; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Attribute> new_object(jni::ref<com::sun::java::util::jar::pack::Attribute_Layout> def, jni::ref<jni::array<jbyte>> bytes, jni::ref<java::lang::Object> fixups) { return object_base::new_object(def, bytes, fixups); }
	static jni::ref<com::sun::java::util::jar::pack::Attribute> new_object(jni::ref<com::sun::java::util::jar::pack::Attribute_Layout> def, jni::ref<jni::array<jbyte>> bytes) { return object_base::new_object(def, bytes); }
