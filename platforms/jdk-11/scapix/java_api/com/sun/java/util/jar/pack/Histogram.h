...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Histogram; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Histogram> new_object(jni::ref<jni::array<jint>> valueSequence) { return object_base::new_object(valueSequence); }
	static jni::ref<com::sun::java::util::jar::pack::Histogram> new_object(jni::ref<jni::array<jint>> valueSequence, jint start, jint end) { return object_base::new_object(valueSequence, start, end); }
	static jni::ref<com::sun::java::util::jar::pack::Histogram> new_object(jni::ref<jni::array<jni::array<jint>>> matrix) { return object_base::new_object(matrix); }
