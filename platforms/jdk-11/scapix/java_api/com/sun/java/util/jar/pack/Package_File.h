...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Package_File; }}
...
public:
	...
	jint compareTo(jni::ref<com::sun::java::util::jar::pack::Package_File> that) { return call_method<"compareTo", jint>(that); }
	...
	void addBytes(jni::ref<jni::array<jbyte>> bytes) { return call_method<"addBytes", void>(bytes); }
	void addBytes(jni::ref<jni::array<jbyte>> bytes, jint off, jint len) { return call_method<"addBytes", void>(bytes, off, len); }
	...
	void readFrom(jni::ref<java::io::InputStream> in) { return call_method<"readFrom", void>(in); }
