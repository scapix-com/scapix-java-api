...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class AdaptiveCoding; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::AdaptiveCoding> new_object(jint headLength, jni::ref<com::sun::java::util::jar::pack::CodingMethod> headCoding, jni::ref<com::sun::java::util::jar::pack::CodingMethod> tailCoding) { return object_base::new_object(headLength, headCoding, tailCoding); }
