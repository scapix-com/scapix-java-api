...
namespace scapix::java_api { namespace com::sun::crypto::provider { class AESCipher; }}
...
#include <scapix/java_api/com/sun/crypto/provider/AESCipher_AES256_GCM_NoPadding.h>
#include <scapix/java_api/com/sun/crypto/provider/AESCipher_AES192_GCM_NoPadding.h>
#include <scapix/java_api/com/sun/crypto/provider/AESCipher_AES128_GCM_NoPadding.h>
...
public:
	...
	using AES256_GCM_NoPadding = AESCipher_AES256_GCM_NoPadding;
	using AES192_GCM_NoPadding = AESCipher_AES192_GCM_NoPadding;
	using AES128_GCM_NoPadding = AESCipher_AES128_GCM_NoPadding;
