...
namespace scapix::java_api { namespace com::sun::crypto::provider { class AESWrapCipher; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::AESWrapCipher> new_object(jint keySize) { return object_base::new_object(keySize); }
