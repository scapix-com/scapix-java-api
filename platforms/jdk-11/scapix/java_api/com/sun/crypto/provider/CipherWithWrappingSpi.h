...
namespace scapix::java_api { namespace com::sun::crypto::provider { class CipherWithWrappingSpi; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::CipherWithWrappingSpi> new_object() { return object_base::new_object(); }
