...
namespace scapix::java_api { namespace com::sun::crypto::provider { class AESWrapCipher_AES256; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::AESWrapCipher_AES256> new_object() { return object_base::new_object(); }
