...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHARSET_CHARACTERCODINGEXCEPTION
...
public:
	...
	static jni::ref<java::nio::charset::CharacterCodingException> new_object() { return object_base::new_object(); }
};
