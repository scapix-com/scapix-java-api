...
public:
	...
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Comparator> comparator) { return object_base::new_object(comparator); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::SortedSet> s) { return object_base::new_object(s); }
