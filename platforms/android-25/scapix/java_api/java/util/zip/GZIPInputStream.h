...
public:
	...
	static jni::ref<java::util::zip::GZIPInputStream> new_object(jni::ref<java::io::InputStream> in, jint size) { return object_base::new_object(in, size); }
	static jni::ref<java::util::zip::GZIPInputStream> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
