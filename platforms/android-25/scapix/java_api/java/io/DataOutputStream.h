...
#ifndef SCAPIX_JAVA_API_JAVA_IO_DATAOUTPUTSTREAM
...
public:
	...
	static jni::ref<java::io::DataOutputStream> new_object(jni::ref<java::io::OutputStream> out) { return object_base::new_object(out); }
