...
public:
	...
	static jni::ref<android::media::MediaCrypto> new_object(jni::ref<java::util::UUID> uuid, jni::ref<jni::array<jbyte>> initData) { return object_base::new_object(uuid, initData); }
