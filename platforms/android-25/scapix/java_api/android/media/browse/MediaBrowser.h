...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_BROWSE_MEDIABROWSER
...
public:
	...
	static jni::ref<android::media::browse::MediaBrowser> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::ComponentName> serviceComponent, jni::ref<android::media::browse::MediaBrowser_ConnectionCallback> callback, jni::ref<android::os::Bundle> rootHints) { return object_base::new_object(context, serviceComponent, callback, rootHints); }
