...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SESSION_MEDIASESSION_QUEUEITEM
...
public:
	...
	static jni::ref<android::media::session::MediaSession_QueueItem> new_object(jni::ref<android::media::MediaDescription> description, jlong id) { return object_base::new_object(description, id); }
