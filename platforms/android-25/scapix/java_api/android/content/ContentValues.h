...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTVALUES
...
public:
	...
	static jni::ref<android::content::ContentValues> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::ContentValues> new_object(jint size) { return object_base::new_object(size); }
	static jni::ref<android::content::ContentValues> new_object(jni::ref<android::content::ContentValues> from) { return object_base::new_object(from); }
