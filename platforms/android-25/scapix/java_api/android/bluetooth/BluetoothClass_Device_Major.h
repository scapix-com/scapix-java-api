...
class BluetoothClass_Device_Major;
...
#ifndef SCAPIX_JAVA_API_ANDROID_BLUETOOTH_BLUETOOTHCLASS_DEVICE_MAJOR
...
public:
	...
	static jni::ref<android::bluetooth::BluetoothClass_Device_Major> new_object() { return object_base::new_object(); }
};
