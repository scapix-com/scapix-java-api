...
namespace scapix::java_api { namespace android::icu::text { class MessageFormat; }}
...
public:
	...
	static jni::ref<android::icu::text::MessageFormat> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
	static jni::ref<android::icu::text::MessageFormat> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::util::Locale> locale) { return object_base::new_object(pattern, locale); }
	static jni::ref<android::icu::text::MessageFormat> new_object(jni::ref<java::lang::String> pattern, jni::ref<android::icu::util::ULocale> locale) { return object_base::new_object(pattern, locale); }
