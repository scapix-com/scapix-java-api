...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_INTENTSERVICE
...
public:
	...
	static jni::ref<android::app::IntentService> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
