...
namespace scapix::java_api { namespace android::provider { class ContactsContract_RawContactsColumns; }}
...
public:
	...
	static jni::ref<java::lang::String> BACKUP_ID() { return get_static_field<"BACKUP_ID", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> METADATA_DIRTY() { return get_static_field<"METADATA_DIRTY", jni::ref<java::lang::String>>(); }
