...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_VIEW_ACCESSIBILITYDELEGATE
...
public:
	...
	static jni::ref<android::view::View_AccessibilityDelegate> new_object() { return object_base::new_object(); }
