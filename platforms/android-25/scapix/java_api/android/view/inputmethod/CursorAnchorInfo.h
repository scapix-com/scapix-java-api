...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_CURSORANCHORINFO
...
public:
	...
	static jni::ref<android::view::inputmethod::CursorAnchorInfo> new_object(jni::ref<android::os::Parcel> source) { return object_base::new_object(source); }
