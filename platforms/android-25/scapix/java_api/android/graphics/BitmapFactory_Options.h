...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_BITMAPFACTORY_OPTIONS
...
public:
	...
	static jni::ref<android::graphics::BitmapFactory_Options> new_object() { return object_base::new_object(); }
