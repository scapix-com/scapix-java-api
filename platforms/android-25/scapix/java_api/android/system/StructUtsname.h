...
#ifndef SCAPIX_JAVA_API_ANDROID_SYSTEM_STRUCTUTSNAME
...
public:
	...
	static jni::ref<android::system::StructUtsname> new_object(jni::ref<java::lang::String> sysname, jni::ref<java::lang::String> nodename, jni::ref<java::lang::String> release, jni::ref<java::lang::String> version, jni::ref<java::lang::String> machine) { return object_base::new_object(sysname, nodename, release, version, machine); }
