...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_PARAMS_RGGBCHANNELVECTOR
...
public:
	...
	static jni::ref<android::hardware::camera2::params::RggbChannelVector> new_object(jfloat red, jfloat greenEven, jfloat greenOdd, jfloat blue) { return object_base::new_object(red, greenEven, greenOdd, blue); }
