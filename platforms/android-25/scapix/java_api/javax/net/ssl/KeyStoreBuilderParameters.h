...
#ifndef SCAPIX_JAVA_API_JAVAX_NET_SSL_KEYSTOREBUILDERPARAMETERS
...
public:
	...
	static jni::ref<javax::net::ssl::KeyStoreBuilderParameters> new_object(jni::ref<java::security::KeyStore_Builder> builder) { return object_base::new_object(builder); }
	static jni::ref<javax::net::ssl::KeyStoreBuilderParameters> new_object(jni::ref<java::util::List> parameters) { return object_base::new_object(parameters); }
