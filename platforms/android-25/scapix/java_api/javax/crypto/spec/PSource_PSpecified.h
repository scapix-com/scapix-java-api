...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_SPEC_PSOURCE_PSPECIFIED
...
public:
	...
	static jni::ref<javax::crypto::spec::PSource_PSpecified> new_object(jni::ref<jni::array<jbyte>> p) { return object_base::new_object(p); }
