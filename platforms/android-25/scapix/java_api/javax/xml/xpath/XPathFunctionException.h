...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_XPATH_XPATHFUNCTIONEXCEPTION
...
public:
	...
	static jni::ref<javax::xml::xpath::XPathFunctionException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<javax::xml::xpath::XPathFunctionException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
};
