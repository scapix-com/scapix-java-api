...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_CERT_X509CERTIFICATE
...
public:
	...
	static jni::ref<javax::security::cert::X509Certificate> new_object() { return object_base::new_object(); }
	static jni::ref<javax::security::cert::X509Certificate> getInstance(jni::ref<java::io::InputStream> inStream) { return call_static_method<"getInstance", jni::ref<javax::security::cert::X509Certificate>>(inStream); }
	static jni::ref<javax::security::cert::X509Certificate> getInstance(jni::ref<jni::array<jbyte>> certData) { return call_static_method<"getInstance", jni::ref<javax::security::cert::X509Certificate>>(certData); }
