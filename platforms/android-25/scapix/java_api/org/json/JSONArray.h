...
#ifndef SCAPIX_JAVA_API_ORG_JSON_JSONARRAY
...
public:
	...
	static jni::ref<org::json::JSONArray> new_object() { return object_base::new_object(); }
	static jni::ref<org::json::JSONArray> new_object(jni::ref<java::util::Collection> copyFrom) { return object_base::new_object(copyFrom); }
	static jni::ref<org::json::JSONArray> new_object(jni::ref<org::json::JSONTokener> readFrom) { return object_base::new_object(readFrom); }
	static jni::ref<org::json::JSONArray> new_object(jni::ref<java::lang::String> json) { return object_base::new_object(json); }
	static jni::ref<org::json::JSONArray> new_object(jni::ref<java::lang::Object> array) { return object_base::new_object(array); }
