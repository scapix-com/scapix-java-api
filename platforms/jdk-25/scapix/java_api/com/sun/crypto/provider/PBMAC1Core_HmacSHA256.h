...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBMAC1Core_HmacSHA256; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBMAC1Core_HmacSHA256> new_object() { return object_base::new_object(); }
