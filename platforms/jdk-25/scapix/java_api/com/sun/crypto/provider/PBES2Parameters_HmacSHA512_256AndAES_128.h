...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBES2Parameters_HmacSHA512_256AndAES_128; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBES2Parameters_HmacSHA512_256AndAES_128> new_object() { return object_base::new_object(); }
