...
namespace scapix::java_api { namespace com::sun::crypto::provider { class HmacCore_HmacSHA384; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::HmacCore_HmacSHA384> new_object() { return object_base::new_object(); }
