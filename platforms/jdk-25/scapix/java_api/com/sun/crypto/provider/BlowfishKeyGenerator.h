...
namespace scapix::java_api { namespace com::sun::crypto::provider { class BlowfishKeyGenerator; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::BlowfishKeyGenerator> new_object() { return object_base::new_object(); }
