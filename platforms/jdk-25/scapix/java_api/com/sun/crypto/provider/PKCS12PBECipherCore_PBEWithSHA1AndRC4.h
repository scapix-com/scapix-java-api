...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PKCS12PBECipherCore_PBEWithSHA1AndRC4; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PKCS12PBECipherCore_PBEWithSHA1AndRC4> new_object(jint keysize) { return object_base::new_object(keysize); }
