...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBEWithMD5AndDESCipher; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBEWithMD5AndDESCipher> new_object() { return object_base::new_object(); }
