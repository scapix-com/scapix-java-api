...
namespace scapix::java_api { namespace com::sun::crypto::provider { class HmacPKCS12PBECore; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::HmacPKCS12PBECore> new_object(jni::ref<java::lang::String> algorithm, jint bl) { return object_base::new_object(algorithm, bl); }
