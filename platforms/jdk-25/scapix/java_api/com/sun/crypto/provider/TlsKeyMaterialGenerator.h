...
namespace scapix::java_api { namespace com::sun::crypto::provider { class TlsKeyMaterialGenerator; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::TlsKeyMaterialGenerator> new_object() { return object_base::new_object(); }
