...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBES2Core_HmacSHA512AndAES_128; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBES2Core_HmacSHA512AndAES_128> new_object() { return object_base::new_object(); }
