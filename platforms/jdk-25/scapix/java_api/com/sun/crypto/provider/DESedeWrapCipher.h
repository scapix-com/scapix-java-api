...
namespace scapix::java_api { namespace com::sun::crypto::provider { class DESedeWrapCipher; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::DESedeWrapCipher> new_object() { return object_base::new_object(); }
