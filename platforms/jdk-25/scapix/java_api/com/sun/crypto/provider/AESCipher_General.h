...
namespace scapix::java_api { namespace com::sun::crypto::provider { class AESCipher_General; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::AESCipher_General> new_object() { return object_base::new_object(); }
