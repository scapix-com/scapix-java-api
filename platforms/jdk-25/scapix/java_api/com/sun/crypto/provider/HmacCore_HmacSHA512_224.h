...
namespace scapix::java_api { namespace com::sun::crypto::provider { class HmacCore_HmacSHA512_224; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::HmacCore_HmacSHA512_224> new_object() { return object_base::new_object(); }
