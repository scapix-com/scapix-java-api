...
namespace scapix::java_api { namespace com::sun::crypto::provider { class DHKEM; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::DHKEM> new_object() { return object_base::new_object(); }
