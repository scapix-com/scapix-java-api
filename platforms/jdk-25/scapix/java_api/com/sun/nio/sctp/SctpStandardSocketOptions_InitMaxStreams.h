...
class SctpStandardSocketOptions_InitMaxStreams;
...
#ifndef SCAPIX_JAVA_API_COM_SUN_NIO_SCTP_SCTPSTANDARDSOCKETOPTIONS_INITMAXSTREAMS
...
public:
	...
	static jni::ref<com::sun::nio::sctp::SctpStandardSocketOptions_InitMaxStreams> create(jint maxInStreams, jint maxOutStreams) { return call_static_method<"create", jni::ref<com::sun::nio::sctp::SctpStandardSocketOptions_InitMaxStreams>>(maxInStreams, maxOutStreams); }
