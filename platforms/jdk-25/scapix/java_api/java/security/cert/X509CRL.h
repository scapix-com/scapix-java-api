...
struct scapix::jni::object_traits<scapix::java_api::java::security::cert::X509CRL>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::security::cert::CRL, scapix::java_api::java::security::cert::X509Extension, scapix::java_api::java::security::DEREncodable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_X509CRL
