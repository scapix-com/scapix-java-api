...
public:
	...
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<javax::security::auth::x500::X500Principal> caPrincipal, jni::ref<java::security::PublicKey> pubKey, jni::ref<jni::array<jbyte>> nameConstraints) { return object_base::new_object(caPrincipal, pubKey, nameConstraints); }
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<java::lang::String> caName, jni::ref<java::security::PublicKey> pubKey, jni::ref<jni::array<jbyte>> nameConstraints) { return object_base::new_object(caName, pubKey, nameConstraints); }
