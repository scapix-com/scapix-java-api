...
struct scapix::jni::object_traits<scapix::java_api::java::security::KeyPair>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::io::Serializable, scapix::java_api::java::security::DEREncodable>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_KEYPAIR
...
public:
	...
	static jni::ref<java::security::KeyPair> new_object(jni::ref<java::security::PublicKey> publicKey, jni::ref<java::security::PrivateKey> privateKey) { return object_base::new_object(publicKey, privateKey); }
