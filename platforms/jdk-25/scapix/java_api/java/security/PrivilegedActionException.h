...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_PRIVILEGEDACTIONEXCEPTION
...
public:
	...
	static jni::ref<java::security::PrivilegedActionException> new_object(jni::ref<java::lang::Exception> exception) { return object_base::new_object(exception); }
