...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_DOMAINLOADSTOREPARAMETER
...
public:
	...
	static jni::ref<java::security::DomainLoadStoreParameter> new_object(jni::ref<java::net::URI> configuration, jni::ref<java::util::Map> protectionParams) { return object_base::new_object(configuration, protectionParams); }
