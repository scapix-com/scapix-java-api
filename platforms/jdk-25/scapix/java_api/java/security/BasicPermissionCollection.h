...
namespace scapix::java_api { namespace java::security { class BasicPermissionCollection; }}
...
public:
	...
	static jni::ref<java::security::BasicPermissionCollection> new_object(jni::ref<java::lang::Class> clazz) { return object_base::new_object(clazz); }
