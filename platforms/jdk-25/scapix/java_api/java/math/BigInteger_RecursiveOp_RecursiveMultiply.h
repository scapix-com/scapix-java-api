...
namespace scapix::java_api { namespace java::math { class BigInteger_RecursiveOp_RecursiveMultiply; }}
...
public:
	...
	static jni::ref<java::math::BigInteger_RecursiveOp_RecursiveMultiply> new_object(jni::ref<java::math::BigInteger> a, jni::ref<java::math::BigInteger> b, jboolean parallel, jint depth) { return object_base::new_object(a, b, parallel, depth); }
