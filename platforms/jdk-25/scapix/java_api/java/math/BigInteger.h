...
#ifndef SCAPIX_JAVA_API_JAVA_MATH_BIGINTEGER
...
public:
	...
	static jni::ref<java::math::BigInteger> new_object(jni::ref<jni::array<jbyte>> val, jint off, jint len) { return object_base::new_object(val, off, len); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<jni::array<jbyte>> val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigInteger> new_object(jint signum, jni::ref<jni::array<jbyte>> magnitude, jint off, jint len) { return object_base::new_object(signum, magnitude, off, len); }
	static jni::ref<java::math::BigInteger> new_object(jint signum, jni::ref<jni::array<jbyte>> magnitude) { return object_base::new_object(signum, magnitude); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<java::lang::String> val, jint radix) { return object_base::new_object(val, radix); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<java::lang::String> val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigInteger> new_object(jint numBits, jni::ref<java::util::Random> rnd) { return object_base::new_object(numBits, rnd); }
	static jni::ref<java::math::BigInteger> new_object(jint bitLength, jint certainty, jni::ref<java::util::Random> rnd) { return object_base::new_object(bitLength, certainty, rnd); }
