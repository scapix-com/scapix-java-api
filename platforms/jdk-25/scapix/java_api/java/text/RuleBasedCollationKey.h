...
namespace scapix::java_api { namespace java::text { class RuleBasedCollationKey; }}
...
public:
	...
	jint compareTo(jni::ref<java::text::CollationKey> target) { return call_method<"compareTo", jint>(target); }
