...
public:
	...
	static jni::ref<java::text::MessageFormat> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
	static jni::ref<java::text::MessageFormat> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::util::Locale> locale) { return object_base::new_object(pattern, locale); }
