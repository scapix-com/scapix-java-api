...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_NUMBERFORMAT
...
public:
	...
	using Style = NumberFormat_Style;
	...
	static jni::ref<java::text::NumberFormat> getCompactNumberInstance() { return call_static_method<"getCompactNumberInstance", jni::ref<java::text::NumberFormat>>(); }
	static jni::ref<java::text::NumberFormat> getCompactNumberInstance(jni::ref<java::util::Locale> locale, jni::ref<java::text::NumberFormat_Style> formatStyle) { return call_static_method<"getCompactNumberInstance", jni::ref<java::text::NumberFormat>>(locale, formatStyle); }
