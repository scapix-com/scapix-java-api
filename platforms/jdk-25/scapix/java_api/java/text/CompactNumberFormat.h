...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_COMPACTNUMBERFORMAT
...
public:
	...
	static jni::ref<java::text::CompactNumberFormat> new_object(jni::ref<java::lang::String> decimalPattern, jni::ref<java::text::DecimalFormatSymbols> symbols, jni::ref<jni::array<java::lang::String>> compactPatterns) { return object_base::new_object(decimalPattern, symbols, compactPatterns); }
	static jni::ref<java::text::CompactNumberFormat> new_object(jni::ref<java::lang::String> decimalPattern, jni::ref<java::text::DecimalFormatSymbols> symbols, jni::ref<jni::array<java::lang::String>> compactPatterns, jni::ref<java::lang::String> pluralRules) { return object_base::new_object(decimalPattern, symbols, compactPatterns, pluralRules); }
