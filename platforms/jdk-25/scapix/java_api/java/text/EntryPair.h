...
namespace scapix::java_api { namespace java::text { class EntryPair; }}
...
public:
	...
	static jni::ref<java::text::EntryPair> new_object(jni::ref<java::lang::String> name, jint value) { return object_base::new_object(name, value); }
	static jni::ref<java::text::EntryPair> new_object(jni::ref<java::lang::String> name, jint value, jboolean fwd) { return object_base::new_object(name, value, fwd); }
