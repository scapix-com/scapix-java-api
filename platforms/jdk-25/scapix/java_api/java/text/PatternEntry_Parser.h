...
namespace scapix::java_api { namespace java::text { class PatternEntry_Parser; }}
...
public:
	...
	static jni::ref<java::text::PatternEntry_Parser> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
