...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REFLECT_ACCESSFLAG_LOCATION
...
public:
	...
	jint flagsMask(jni::ref<java::lang::reflect::ClassFileFormatVersion> cffv) { return call_method<"flagsMask", jint>(cffv); }
	jni::ref<java::util::Set> flags() { return call_method<"flags", jni::ref<java::util::Set>>(); }
	jni::ref<java::util::Set> flags(jni::ref<java::lang::reflect::ClassFileFormatVersion> cffv) { return call_method<"flags", jni::ref<java::util::Set>>(cffv); }
};
