...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_REFLECT_ACCESSFLAG
...
public:
	...
	static jni::ref<java::util::Set> maskToAccessFlags(jint mask, jni::ref<java::lang::reflect::AccessFlag_Location> location, jni::ref<java::lang::reflect::ClassFileFormatVersion> cffv) { return call_static_method<"maskToAccessFlags", jni::ref<java::util::Set>>(mask, location, cffv); }
};
