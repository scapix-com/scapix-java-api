...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CONSTANT_CLASSDESC
...
public:
	...
	jni::ref<java::lang::constant::ClassDesc> arrayType(jint p1) { return call_method<"arrayType", jni::ref<java::lang::constant::ClassDesc>>(p1); }
