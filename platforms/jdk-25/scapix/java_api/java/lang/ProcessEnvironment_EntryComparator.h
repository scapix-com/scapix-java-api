...
namespace scapix::java_api { namespace java::lang { class ProcessEnvironment_EntryComparator; }}
...
public:
	...
	jint compare(jni::ref<java::util::Map_Entry> e1, jni::ref<java::util::Map_Entry> e2) { return call_method<"compare", jint>(e1, e2); }
