...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_ANNOTATION_ANNOTATIONFORMATERROR
...
public:
	...
	static jni::ref<java::lang::annotation::AnnotationFormatError> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<java::lang::annotation::AnnotationFormatError> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
	static jni::ref<java::lang::annotation::AnnotationFormatError> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
};
