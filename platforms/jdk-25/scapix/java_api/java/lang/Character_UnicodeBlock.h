...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CHARACTER_UNICODEBLOCK
...
public:
	...
	static jni::ref<java::lang::Character_UnicodeBlock> CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I() { return get_static_field<"CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> TODHRI() { return get_static_field<"TODHRI", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> GARAY() { return get_static_field<"GARAY", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> TULU_TIGALARI() { return get_static_field<"TULU_TIGALARI", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> MYANMAR_EXTENDED_C() { return get_static_field<"MYANMAR_EXTENDED_C", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> SUNUWAR() { return get_static_field<"SUNUWAR", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> EGYPTIAN_HIEROGLYPHS_EXTENDED_A() { return get_static_field<"EGYPTIAN_HIEROGLYPHS_EXTENDED_A", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> GURUNG_KHEMA() { return get_static_field<"GURUNG_KHEMA", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> KIRAT_RAI() { return get_static_field<"KIRAT_RAI", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT() { return get_static_field<"SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT", jni::ref<java::lang::Character_UnicodeBlock>>(); }
	static jni::ref<java::lang::Character_UnicodeBlock> OL_ONAL() { return get_static_field<"OL_ONAL", jni::ref<java::lang::Character_UnicodeBlock>>(); }
