...
namespace scapix::java_api { namespace java::lang::invoke { class VarHandleBytes_FieldStaticReadWrite; }}
...
public:
	...
	jni::ref<java::lang::invoke::VarHandleBytes_FieldStaticReadWrite> withInvokeExactBehavior() { return call_method<"withInvokeExactBehavior", jni::ref<java::lang::invoke::VarHandleBytes_FieldStaticReadWrite>>(); }
	jni::ref<java::lang::invoke::VarHandleBytes_FieldStaticReadWrite> withInvokeBehavior() { return call_method<"withInvokeBehavior", jni::ref<java::lang::invoke::VarHandleBytes_FieldStaticReadWrite>>(); }
