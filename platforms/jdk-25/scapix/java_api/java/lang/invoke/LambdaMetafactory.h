...
public:
	...
	static jni::ref<java::lang::invoke::CallSite> metafactory(jni::ref<java::lang::invoke::MethodHandles_Lookup> caller, jni::ref<java::lang::String> interfaceMethodName, jni::ref<java::lang::invoke::MethodType> factoryType, jni::ref<java::lang::invoke::MethodType> interfaceMethodType, jni::ref<java::lang::invoke::MethodHandle> implementation, jni::ref<java::lang::invoke::MethodType> dynamicMethodType) { return call_static_method<"metafactory", jni::ref<java::lang::invoke::CallSite>>(caller, interfaceMethodName, factoryType, interfaceMethodType, implementation, dynamicMethodType); }
	static jni::ref<java::lang::invoke::CallSite> altMetafactory(jni::ref<java::lang::invoke::MethodHandles_Lookup> caller, jni::ref<java::lang::String> interfaceMethodName, jni::ref<java::lang::invoke::MethodType> factoryType, jni::ref<jni::array<java::lang::Object>> args) { return call_static_method<"altMetafactory", jni::ref<java::lang::invoke::CallSite>>(caller, interfaceMethodName, factoryType, args); }
};
