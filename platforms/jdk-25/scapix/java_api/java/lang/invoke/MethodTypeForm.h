...
namespace scapix::java_api { namespace java::lang::invoke { class MethodTypeForm; }}
...
public:
	...
	jni::ref<java::lang::invoke::MemberName> cachedInterpretEntry() { return call_method<"cachedInterpretEntry", jni::ref<java::lang::invoke::MemberName>>(); }
	jni::ref<java::lang::invoke::MemberName> setCachedInterpretEntry(jni::ref<java::lang::invoke::MemberName> mn) { return call_method<"setCachedInterpretEntry", jni::ref<java::lang::invoke::MemberName>>(mn); }
