...
#include <scapix/java_api/java/lang/invoke/MethodHandles_Lookup_ClassOption.h>
...
public:
	...
	using ClassOption = MethodHandles_Lookup_ClassOption;
	...
	static jint ORIGINAL() { return get_static_field<"ORIGINAL", jint>(); }

	jni::ref<java::lang::Class> lookupClass() { return call_method<"lookupClass", jni::ref<java::lang::Class>>(); }
	jni::ref<java::lang::Class> previousLookupClass() { return call_method<"previousLookupClass", jni::ref<java::lang::Class>>(); }
	...
	jni::ref<java::lang::invoke::MethodHandles_Lookup> defineHiddenClass(jni::ref<jni::array<jbyte>> bytes, jboolean initialize, jni::ref<jni::array<java::lang::invoke::MethodHandles_Lookup_ClassOption>> options) { return call_method<"defineHiddenClass", jni::ref<java::lang::invoke::MethodHandles_Lookup>>(bytes, initialize, options); }
	jni::ref<java::lang::invoke::MethodHandles_Lookup> defineHiddenClassWithClassData(jni::ref<jni::array<jbyte>> bytes, jni::ref<java::lang::Object> classData, jboolean initialize, jni::ref<jni::array<java::lang::invoke::MethodHandles_Lookup_ClassOption>> options) { return call_method<"defineHiddenClassWithClassData", jni::ref<java::lang::invoke::MethodHandles_Lookup>>(bytes, classData, initialize, options); }
	...
	jni::ref<java::lang::Class> ensureInitialized(jni::ref<java::lang::Class> targetClass) { return call_method<"ensureInitialized", jni::ref<java::lang::Class>>(targetClass); }
	...
	jboolean hasFullPrivilegeAccess() { return call_method<"hasFullPrivilegeAccess", jboolean>(); }
};
