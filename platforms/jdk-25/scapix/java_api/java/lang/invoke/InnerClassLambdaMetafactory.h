...
namespace scapix::java_api { namespace java::lang::invoke { class InnerClassLambdaMetafactory; }}
...
public:
	...
	static jni::ref<java::lang::invoke::InnerClassLambdaMetafactory> new_object(jni::ref<java::lang::invoke::MethodHandles_Lookup> caller, jni::ref<java::lang::invoke::MethodType> factoryType, jni::ref<java::lang::String> interfaceMethodName, jni::ref<java::lang::invoke::MethodType> interfaceMethodType, jni::ref<java::lang::invoke::MethodHandle> implementation, jni::ref<java::lang::invoke::MethodType> dynamicMethodType, jboolean isSerializable, jni::ref<jni::array<java::lang::Class>> altInterfaces, jni::ref<jni::array<java::lang::invoke::MethodType>> altMethods) { return object_base::new_object(caller, factoryType, interfaceMethodName, interfaceMethodType, implementation, dynamicMethodType, isSerializable, altInterfaces, altMethods); }
