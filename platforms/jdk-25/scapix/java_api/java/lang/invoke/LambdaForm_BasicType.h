...
namespace scapix::java_api { namespace java::lang::invoke { class LambdaForm_BasicType; }}
...
public:
	...
	static jni::ref<java::lang::invoke::LambdaForm_BasicType> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::lang::invoke::LambdaForm_BasicType>>(name); }
