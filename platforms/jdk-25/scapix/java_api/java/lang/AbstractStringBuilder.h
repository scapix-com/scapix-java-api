...
public:
	...
	jni::ref<java::lang::AbstractStringBuilder> repeat(jint codePoint, jint count) { return call_method<"repeat", jni::ref<java::lang::AbstractStringBuilder>>(codePoint, count); }
	jni::ref<java::lang::AbstractStringBuilder> repeat(jni::ref<java::lang::CharSequence> cs, jint count) { return call_method<"repeat", jni::ref<java::lang::AbstractStringBuilder>>(cs, count); }
