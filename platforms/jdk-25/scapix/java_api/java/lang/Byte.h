...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_BYTE
...
public:
	...
	static jni::ref<java::lang::Byte> new_object(jbyte value) { return object_base::new_object(value); }
	static jni::ref<java::lang::Byte> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
