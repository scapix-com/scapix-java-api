...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_PROCESS
...
public:
	...
	static jni::ref<java::lang::Process> new_object() { return object_base::new_object(); }
	...
	jni::ref<java::io::BufferedReader> inputReader() { return call_method<"inputReader", jni::ref<java::io::BufferedReader>>(); }
	jni::ref<java::io::BufferedReader> inputReader(jni::ref<java::nio::charset::Charset> charset) { return call_method<"inputReader", jni::ref<java::io::BufferedReader>>(charset); }
	jni::ref<java::io::BufferedReader> errorReader() { return call_method<"errorReader", jni::ref<java::io::BufferedReader>>(); }
	jni::ref<java::io::BufferedReader> errorReader(jni::ref<java::nio::charset::Charset> charset) { return call_method<"errorReader", jni::ref<java::io::BufferedReader>>(charset); }
	jni::ref<java::io::BufferedWriter> outputWriter() { return call_method<"outputWriter", jni::ref<java::io::BufferedWriter>>(); }
	jni::ref<java::io::BufferedWriter> outputWriter(jni::ref<java::nio::charset::Charset> charset) { return call_method<"outputWriter", jni::ref<java::io::BufferedWriter>>(charset); }
	jint waitFor() { return call_method<"waitFor", jint>(); }
	jboolean waitFor(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"waitFor", jboolean>(timeout, unit); }
	jboolean waitFor(jni::ref<java::time::Duration> duration) { return call_method<"waitFor", jboolean>(duration); }
