...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_FOREIGN_LINKER_OPTION
...
public:
	...
	static jni::ref<java::lang::foreign::Linker_Option> critical(jboolean allowHeapAccess) { return call_static_method<"critical", jni::ref<java::lang::foreign::Linker_Option>>(allowHeapAccess); }
};
