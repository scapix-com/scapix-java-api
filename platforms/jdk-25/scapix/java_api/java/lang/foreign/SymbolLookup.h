...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_FOREIGN_SYMBOLLOOKUP
...
public:
	...
	jni::ref<java::lang::foreign::MemorySegment> findOrThrow(jni::ref<java::lang::String> name) { return call_method<"findOrThrow", jni::ref<java::lang::foreign::MemorySegment>>(name); }
