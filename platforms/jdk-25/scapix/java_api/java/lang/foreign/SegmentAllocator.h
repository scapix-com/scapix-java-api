...
public:
	...
	jni::ref<java::lang::foreign::MemorySegment> allocateFrom(jni::ref<java::lang::foreign::ValueLayout> elementLayout, jni::ref<java::lang::foreign::MemorySegment> source, jni::ref<java::lang::foreign::ValueLayout> sourceElementLayout, jlong sourceOffset, jlong elementCount) { return call_method<"allocateFrom", jni::ref<java::lang::foreign::MemorySegment>>(elementLayout, source, sourceElementLayout, sourceOffset, elementCount); }
