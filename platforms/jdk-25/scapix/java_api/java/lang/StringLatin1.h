...
namespace scapix::java_api { namespace java::lang { class StringLatin1; }}
...
public:
	...
	static jboolean canEncode(jchar cp) { return call_static_method<"canEncode", jboolean>(cp); }
	static jboolean canEncode(jint cp) { return call_static_method<"canEncode", jboolean>(cp); }
	static jbyte coderFromChar(jchar cp) { return call_static_method<"coderFromChar", jbyte>(cp); }
