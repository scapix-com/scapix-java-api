...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_SCOPEDVALUE_CARRIER
...
public:
	...
	jni::ref<java::lang::Object> call(jni::ref<java::lang::ScopedValue_CallableOp> op) { return call_method<"call", jni::ref<java::lang::Object>>(op); }
