...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_STRINGBUILDER
...
public:
	...
	static jni::ref<java::lang::StringBuilder> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::StringBuilder> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::lang::StringBuilder> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
	static jni::ref<java::lang::StringBuilder> new_object(jni::ref<java::lang::CharSequence> seq) { return object_base::new_object(seq); }
	...
	jni::ref<java::lang::StringBuilder> repeat(jint codePoint, jint count) { return call_method<"repeat", jni::ref<java::lang::StringBuilder>>(codePoint, count); }
	jni::ref<java::lang::StringBuilder> repeat(jni::ref<java::lang::CharSequence> cs, jint count) { return call_method<"repeat", jni::ref<java::lang::StringBuilder>>(cs, count); }
