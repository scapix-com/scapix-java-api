...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASSFILE_CONSTANTPOOL_METHODTYPEENTRY
...
public:
	...
	jboolean matches(jni::ref<java::lang::constant::MethodTypeDesc> p1) { return call_method<"matches", jboolean>(p1); }
};
