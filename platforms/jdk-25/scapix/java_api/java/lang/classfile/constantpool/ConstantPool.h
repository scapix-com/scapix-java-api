...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASSFILE_CONSTANTPOOL_CONSTANTPOOL
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::PoolEntry> entryByIndex(jint p1, jni::ref<java::lang::Class> p2) { return call_method<"entryByIndex", jni::ref<java::lang::classfile::constantpool::PoolEntry>>(p1, p2); }
