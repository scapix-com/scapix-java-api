...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASSFILE_CONSTANTPOOL_CONSTANTPOOLEXCEPTION
...
public:
	...
	static jni::ref<java::lang::classfile::constantpool::ConstantPoolException> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::classfile::constantpool::ConstantPoolException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<java::lang::classfile::constantpool::ConstantPoolException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
	static jni::ref<java::lang::classfile::constantpool::ConstantPoolException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
};
