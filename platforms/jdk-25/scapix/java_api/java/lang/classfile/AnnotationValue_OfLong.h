...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASSFILE_ANNOTATIONVALUE_OFLONG
...
public:
	...
	jni::ref<java::lang::Long> resolvedValue() { return call_method<"resolvedValue", jni::ref<java::lang::Long>>(); }
};
