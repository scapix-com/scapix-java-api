...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASSFILE_CLASSREADER
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::PoolEntry> readEntryOrNull(jint p1, jni::ref<java::lang::Class> p2) { return call_method<"readEntryOrNull", jni::ref<java::lang::classfile::constantpool::PoolEntry>>(p1, p2); }
