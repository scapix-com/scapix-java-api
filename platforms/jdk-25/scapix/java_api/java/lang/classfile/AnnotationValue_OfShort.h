...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASSFILE_ANNOTATIONVALUE_OFSHORT
...
public:
	...
	jni::ref<java::lang::Short> resolvedValue() { return call_method<"resolvedValue", jni::ref<java::lang::Short>>(); }
};
