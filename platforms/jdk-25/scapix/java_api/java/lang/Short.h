...
public:
	...
	static jni::ref<java::lang::Short> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	...
	static jint compareUnsigned(jshort x, jshort y) { return call_static_method<"compareUnsigned", jint>(x, y); }
