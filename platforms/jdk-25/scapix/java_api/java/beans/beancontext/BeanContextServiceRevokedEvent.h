...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_BEANCONTEXT_BEANCONTEXTSERVICEREVOKEDEVENT
...
public:
	...
	static jni::ref<java::beans::beancontext::BeanContextServiceRevokedEvent> new_object(jni::ref<java::beans::beancontext::BeanContextServices> bcs, jni::ref<java::lang::Class> sc, jboolean invalidate) { return object_base::new_object(bcs, sc, invalidate); }
	...
	jboolean isServiceClass(jni::ref<java::lang::Class> service) { return call_method<"isServiceClass", jboolean>(service); }
