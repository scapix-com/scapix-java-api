...
public:
	...
	static jni::ref<java::beans::beancontext::BeanContextServiceAvailableEvent> new_object(jni::ref<java::beans::beancontext::BeanContextServices> bcs, jni::ref<java::lang::Class> sc) { return object_base::new_object(bcs, sc); }
