...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_INTROSPECTIONEXCEPTION
...
public:
	...
	static jni::ref<java::beans::IntrospectionException> new_object(jni::ref<java::lang::String> mess) { return object_base::new_object(mess); }
};
