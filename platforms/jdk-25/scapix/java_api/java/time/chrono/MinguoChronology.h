...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_MINGUOCHRONOLOGY
...
public:
	...
	jni::ref<java::time::chrono::MinguoDate> date(jni::ref<java::time::chrono::Era> era, jint yearOfEra, jint month, jint dayOfMonth) { return call_method<"date", jni::ref<java::time::chrono::MinguoDate>>(era, yearOfEra, month, dayOfMonth); }
	jni::ref<java::time::chrono::MinguoDate> date(jint prolepticYear, jint month, jint dayOfMonth) { return call_method<"date", jni::ref<java::time::chrono::MinguoDate>>(prolepticYear, month, dayOfMonth); }
	jni::ref<java::time::chrono::MinguoDate> dateYearDay(jni::ref<java::time::chrono::Era> era, jint yearOfEra, jint dayOfYear) { return call_method<"dateYearDay", jni::ref<java::time::chrono::MinguoDate>>(era, yearOfEra, dayOfYear); }
	jni::ref<java::time::chrono::MinguoDate> dateYearDay(jint prolepticYear, jint dayOfYear) { return call_method<"dateYearDay", jni::ref<java::time::chrono::MinguoDate>>(prolepticYear, dayOfYear); }
	jni::ref<java::time::chrono::MinguoDate> dateEpochDay(jlong epochDay) { return call_method<"dateEpochDay", jni::ref<java::time::chrono::MinguoDate>>(epochDay); }
	jni::ref<java::time::chrono::MinguoDate> dateNow() { return call_method<"dateNow", jni::ref<java::time::chrono::MinguoDate>>(); }
	jni::ref<java::time::chrono::MinguoDate> dateNow(jni::ref<java::time::ZoneId> zone) { return call_method<"dateNow", jni::ref<java::time::chrono::MinguoDate>>(zone); }
	jni::ref<java::time::chrono::MinguoDate> dateNow(jni::ref<java::time::Clock> clock) { return call_method<"dateNow", jni::ref<java::time::chrono::MinguoDate>>(clock); }
	jni::ref<java::time::chrono::MinguoDate> date(jni::ref<java::time::temporal::TemporalAccessor> temporal) { return call_method<"date", jni::ref<java::time::chrono::MinguoDate>>(temporal); }
	...
	jni::ref<java::time::chrono::MinguoEra> eraOf(jint eraValue) { return call_method<"eraOf", jni::ref<java::time::chrono::MinguoEra>>(eraValue); }
	...
	jni::ref<java::time::chrono::MinguoDate> resolveDate(jni::ref<java::util::Map> fieldValues, jni::ref<java::time::format::ResolverStyle> resolverStyle) { return call_method<"resolveDate", jni::ref<java::time::chrono::MinguoDate>>(fieldValues, resolverStyle); }
