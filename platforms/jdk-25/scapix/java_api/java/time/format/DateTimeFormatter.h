...
public:
	...
	static jni::ref<java::time::format::DateTimeFormatter> ofLocalizedPattern(jni::ref<java::lang::String> requestedTemplate) { return call_static_method<"ofLocalizedPattern", jni::ref<java::time::format::DateTimeFormatter>>(requestedTemplate); }
