...
namespace scapix::java_api { namespace java::time::format { class DateTimeFormatter_ClassicFormat; }}
...
public:
	...
	static jni::ref<java::time::format::DateTimeFormatter_ClassicFormat> new_object(jni::ref<java::time::format::DateTimeFormatter> formatter, jni::ref<java::time::temporal::TemporalQuery> parseType) { return object_base::new_object(formatter, parseType); }
