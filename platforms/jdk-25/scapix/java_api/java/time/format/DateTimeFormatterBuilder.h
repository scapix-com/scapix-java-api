...
public:
	...
	static jni::ref<java::lang::String> getLocalizedDateTimePattern(jni::ref<java::lang::String> requestedTemplate, jni::ref<java::time::chrono::Chronology> chrono, jni::ref<java::util::Locale> locale) { return call_static_method<"getLocalizedDateTimePattern", jni::ref<java::lang::String>>(requestedTemplate, chrono, locale); }
	...
	jni::ref<java::time::format::DateTimeFormatterBuilder> appendGenericZoneText(jni::ref<java::time::format::TextStyle> textStyle) { return call_method<"appendGenericZoneText", jni::ref<java::time::format::DateTimeFormatterBuilder>>(textStyle); }
	jni::ref<java::time::format::DateTimeFormatterBuilder> appendGenericZoneText(jni::ref<java::time::format::TextStyle> textStyle, jni::ref<java::util::Set> preferredZones) { return call_method<"appendGenericZoneText", jni::ref<java::time::format::DateTimeFormatterBuilder>>(textStyle, preferredZones); }
	...
	jni::ref<java::time::format::DateTimeFormatterBuilder> appendLocalized(jni::ref<java::lang::String> requestedTemplate) { return call_method<"appendLocalized", jni::ref<java::time::format::DateTimeFormatterBuilder>>(requestedTemplate); }
	...
	jni::ref<java::time::format::DateTimeFormatterBuilder> appendDayPeriodText(jni::ref<java::time::format::TextStyle> style) { return call_method<"appendDayPeriodText", jni::ref<java::time::format::DateTimeFormatterBuilder>>(style); }
