...
public:
	...
	static jni::ref<java::time::temporal::JulianFields_Field> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::time::temporal::JulianFields_Field>>(name); }
