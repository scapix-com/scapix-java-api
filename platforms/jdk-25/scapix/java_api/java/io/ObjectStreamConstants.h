...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OBJECTSTREAMCONSTANTS
...
public:
	...
	static jni::ref<java::io::SerializablePermission> SERIAL_FILTER_PERMISSION() { return get_static_field<"SERIAL_FILTER_PERMISSION", jni::ref<java::io::SerializablePermission>>(); }
