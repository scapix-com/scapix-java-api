...
public:
	...
	static jni::ref<java::io::PushbackReader> new_object(jni::ref<java::io::Reader> in, jint size) { return object_base::new_object(in, size); }
	static jni::ref<java::io::PushbackReader> new_object(jni::ref<java::io::Reader> in) { return object_base::new_object(in); }
