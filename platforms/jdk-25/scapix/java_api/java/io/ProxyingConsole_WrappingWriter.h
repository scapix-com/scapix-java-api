...
namespace scapix::java_api { namespace java::io { class ProxyingConsole_WrappingWriter; }}
...
public:
	...
	static jni::ref<java::io::ProxyingConsole_WrappingWriter> new_object(jni::ref<java::io::PrintWriter> pw, jni::ref<java::lang::Object> lock) { return object_base::new_object(pw, lock); }
