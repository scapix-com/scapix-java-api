...
namespace scapix::java_api { namespace java::io { class ObjectStreamClass_MemberSignature; }}
...
public:
	...
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Field> field) { return object_base::new_object(field); }
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Constructor> cons) { return object_base::new_object(cons); }
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Method> meth) { return object_base::new_object(meth); }
