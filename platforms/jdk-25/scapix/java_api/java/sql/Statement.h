...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_STATEMENT
...
public:
	...
	void setLargeMaxRows(jlong max) { return call_method<"setLargeMaxRows", void>(max); }
	...
	jlong executeLargeUpdate(jni::ref<java::lang::String> sql) { return call_method<"executeLargeUpdate", jlong>(sql); }
	jlong executeLargeUpdate(jni::ref<java::lang::String> sql, jint autoGeneratedKeys) { return call_method<"executeLargeUpdate", jlong>(sql, autoGeneratedKeys); }
	jlong executeLargeUpdate(jni::ref<java::lang::String> sql, jni::ref<jni::array<jint>> columnIndexes) { return call_method<"executeLargeUpdate", jlong>(sql, columnIndexes); }
	jlong executeLargeUpdate(jni::ref<java::lang::String> sql, jni::ref<jni::array<java::lang::String>> columnNames) { return call_method<"executeLargeUpdate", jlong>(sql, columnNames); }
	jni::ref<java::lang::String> enquoteLiteral(jni::ref<java::lang::String> val) { return call_method<"enquoteLiteral", jni::ref<java::lang::String>>(val); }
	jni::ref<java::lang::String> enquoteIdentifier(jni::ref<java::lang::String> identifier, jboolean alwaysQuote) { return call_method<"enquoteIdentifier", jni::ref<java::lang::String>>(identifier, alwaysQuote); }
	jboolean isSimpleIdentifier(jni::ref<java::lang::String> identifier) { return call_method<"isSimpleIdentifier", jboolean>(identifier); }
	jni::ref<java::lang::String> enquoteNCharLiteral(jni::ref<java::lang::String> val) { return call_method<"enquoteNCharLiteral", jni::ref<java::lang::String>>(val); }
};
