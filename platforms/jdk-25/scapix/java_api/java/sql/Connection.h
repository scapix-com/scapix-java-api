...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_CONNECTION
...
public:
	...
	void beginRequest() { return call_method<"beginRequest", void>(); }
	void endRequest() { return call_method<"endRequest", void>(); }
	jboolean setShardingKeyIfValid(jni::ref<java::sql::ShardingKey> shardingKey, jni::ref<java::sql::ShardingKey> superShardingKey, jint timeout) { return call_method<"setShardingKeyIfValid", jboolean>(shardingKey, superShardingKey, timeout); }
	jboolean setShardingKeyIfValid(jni::ref<java::sql::ShardingKey> shardingKey, jint timeout) { return call_method<"setShardingKeyIfValid", jboolean>(shardingKey, timeout); }
	void setShardingKey(jni::ref<java::sql::ShardingKey> shardingKey, jni::ref<java::sql::ShardingKey> superShardingKey) { return call_method<"setShardingKey", void>(shardingKey, superShardingKey); }
	void setShardingKey(jni::ref<java::sql::ShardingKey> shardingKey) { return call_method<"setShardingKey", void>(shardingKey); }
};
