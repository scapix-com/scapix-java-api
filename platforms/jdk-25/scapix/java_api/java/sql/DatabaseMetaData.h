...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_DATABASEMETADATA
...
public:
	...
	jni::ref<java::sql::ResultSet> getPseudoColumns(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return call_method<"getPseudoColumns", jni::ref<java::sql::ResultSet>>(p1, p2, p3, p4); }
	jboolean generatedKeyAlwaysReturned() { return call_method<"generatedKeyAlwaysReturned", jboolean>(); }
	jlong getMaxLogicalLobSize() { return call_method<"getMaxLogicalLobSize", jlong>(); }
	jboolean supportsRefCursors() { return call_method<"supportsRefCursors", jboolean>(); }
	jboolean supportsSharding() { return call_method<"supportsSharding", jboolean>(); }
};
