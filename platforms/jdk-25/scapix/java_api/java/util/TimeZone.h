...
public:
	...
	static jni::ref<java::util::TimeZone> getTimeZone(jni::ref<java::time::ZoneId> zoneId) { return call_static_method<"getTimeZone", jni::ref<java::util::TimeZone>>(zoneId); }
	...
	static void setDefault(jni::ref<java::util::TimeZone> zone) { return call_static_method<"setDefault", void>(zone); }
