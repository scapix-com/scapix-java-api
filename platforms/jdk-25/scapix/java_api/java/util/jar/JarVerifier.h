...
public:
	...
	static jni::ref<java::util::jar::JarVerifier> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jbyte>> rawBytes) { return object_base::new_object(name, rawBytes); }
