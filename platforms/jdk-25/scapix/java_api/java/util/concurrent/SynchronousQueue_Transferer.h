...
#include <scapix/java_api/java/util/concurrent/LinkedTransferQueue.h>
...
namespace scapix::java_api { namespace java::util::concurrent { class SynchronousQueue_Transferer; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::SynchronousQueue_Transferer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::concurrent::LinkedTransferQueue>;
};
