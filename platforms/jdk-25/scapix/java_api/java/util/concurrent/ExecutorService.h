...
namespace scapix::java_api { namespace java::util::concurrent { class ExecutorService; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::ExecutorService>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::concurrent::Executor, scapix::java_api::java::lang::AutoCloseable>;
};
