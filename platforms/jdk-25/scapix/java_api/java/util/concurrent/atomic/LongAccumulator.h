...
public:
	...
	static jni::ref<java::util::concurrent::atomic::LongAccumulator> new_object(jni::ref<java::util::function::LongBinaryOperator> accumulatorFunction, jlong identity) { return object_base::new_object(accumulatorFunction, identity); }
