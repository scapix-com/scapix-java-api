...
namespace scapix::java_api { namespace java::util { class Spliterators_LongIteratorSpliterator; }}
...
public:
	...
	static jni::ref<java::util::Spliterators_LongIteratorSpliterator> new_object(jni::ref<java::util::PrimitiveIterator_OfLong> iterator, jlong size, jint characteristics) { return object_base::new_object(iterator, size, characteristics); }
	static jni::ref<java::util::Spliterators_LongIteratorSpliterator> new_object(jni::ref<java::util::PrimitiveIterator_OfLong> iterator, jint characteristics) { return object_base::new_object(iterator, characteristics); }
