...
namespace scapix::java_api { namespace java::util { class Comparators_NaturalOrderComparator; }}
...
public:
	...
	static jni::ref<java::util::Comparators_NaturalOrderComparator> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::util::Comparators_NaturalOrderComparator>>(name); }
