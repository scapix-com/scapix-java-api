...
namespace scapix::java_api { namespace java::util::stream { class MatchOps_MatchOp; }}
...
public:
	...
	jni::ref<java::lang::Boolean> evaluateSequential(jni::ref<java::util::stream::PipelineHelper> helper, jni::ref<java::util::Spliterator> spliterator) { return call_method<"evaluateSequential", jni::ref<java::lang::Boolean>>(helper, spliterator); }
	jni::ref<java::lang::Boolean> evaluateParallel(jni::ref<java::util::stream::PipelineHelper> helper, jni::ref<java::util::Spliterator> spliterator) { return call_method<"evaluateParallel", jni::ref<java::lang::Boolean>>(helper, spliterator); }
