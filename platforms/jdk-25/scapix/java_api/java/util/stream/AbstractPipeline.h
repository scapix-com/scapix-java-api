...
namespace scapix::java_api { namespace java::util::stream { class AbstractPipeline; }}
...
public:
	...
	jni::ref<java::util::stream::BaseStream> onClose(jni::ref<java::lang::Runnable> closeHandler) { return call_method<"onClose", jni::ref<java::util::stream::BaseStream>>(closeHandler); }
