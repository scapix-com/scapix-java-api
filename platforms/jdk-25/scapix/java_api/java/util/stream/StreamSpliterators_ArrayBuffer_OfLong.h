...
namespace scapix::java_api { namespace java::util::stream { class StreamSpliterators_ArrayBuffer_OfLong; }}
...
public:
	...
	void forEach(jni::ref<java::util::function::LongConsumer> action, jlong fence) { return call_method<"forEach", void>(action, fence); }
