...
namespace scapix::java_api { namespace java::util::stream { class Sink_ChainedDouble; }}
...
public:
	...
	static jni::ref<java::util::stream::Sink_ChainedDouble> new_object(jni::ref<java::util::stream::Sink> downstream) { return object_base::new_object(downstream); }
