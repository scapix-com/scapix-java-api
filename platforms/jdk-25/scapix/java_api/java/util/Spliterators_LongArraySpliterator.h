...
namespace scapix::java_api { namespace java::util { class Spliterators_LongArraySpliterator; }}
...
public:
	...
	static jni::ref<java::util::Spliterators_LongArraySpliterator> new_object(jni::ref<jni::array<jlong>> array, jint additionalCharacteristics) { return object_base::new_object(array, additionalCharacteristics); }
	static jni::ref<java::util::Spliterators_LongArraySpliterator> new_object(jni::ref<jni::array<jlong>> array, jint origin, jint fence, jint additionalCharacteristics) { return object_base::new_object(array, origin, fence, additionalCharacteristics); }
