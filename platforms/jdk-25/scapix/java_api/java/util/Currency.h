...
public:
	...
	static jni::ref<java::util::stream::Stream> availableCurrencies() { return call_static_method<"availableCurrencies", jni::ref<java::util::stream::Stream>>(); }
	...
	jni::ref<java::lang::String> getNumericCodeAsString() { return call_method<"getNumericCodeAsString", jni::ref<java::lang::String>>(); }
