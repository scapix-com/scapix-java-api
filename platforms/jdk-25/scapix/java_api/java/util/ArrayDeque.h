...
namespace scapix::java_api { namespace java::util { class ArrayDeque; }}
...
public:
	...
	static jni::ref<java::util::ArrayDeque> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::ArrayDeque> new_object(jint numElements) { return object_base::new_object(numElements); }
	static jni::ref<java::util::ArrayDeque> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
