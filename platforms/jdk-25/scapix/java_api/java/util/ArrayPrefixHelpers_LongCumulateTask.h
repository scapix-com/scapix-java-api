...
namespace scapix::java_api { namespace java::util { class ArrayPrefixHelpers_LongCumulateTask; }}
...
public:
	...
	static jni::ref<java::util::ArrayPrefixHelpers_LongCumulateTask> new_object(jni::ref<java::util::ArrayPrefixHelpers_LongCumulateTask> parent, jni::ref<java::util::function::LongBinaryOperator> function, jni::ref<jni::array<jlong>> array, jint lo, jint hi) { return object_base::new_object(parent, function, array, lo, hi); }
