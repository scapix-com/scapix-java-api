...
public:
	...
	static jni::ref<java::util::Locale> new_object(jni::ref<java::lang::String> language, jni::ref<java::lang::String> country, jni::ref<java::lang::String> variant) { return object_base::new_object(language, country, variant); }
	static jni::ref<java::util::Locale> new_object(jni::ref<java::lang::String> language, jni::ref<java::lang::String> country) { return object_base::new_object(language, country); }
	static jni::ref<java::util::Locale> new_object(jni::ref<java::lang::String> language) { return object_base::new_object(language); }
	static jni::ref<java::util::Locale> of(jni::ref<java::lang::String> language, jni::ref<java::lang::String> country, jni::ref<java::lang::String> variant) { return call_static_method<"of", jni::ref<java::util::Locale>>(language, country, variant); }
	static jni::ref<java::util::Locale> of(jni::ref<java::lang::String> language, jni::ref<java::lang::String> country) { return call_static_method<"of", jni::ref<java::util::Locale>>(language, country); }
	static jni::ref<java::util::Locale> of(jni::ref<java::lang::String> language) { return call_static_method<"of", jni::ref<java::util::Locale>>(language); }
	...
	static jni::ref<java::util::stream::Stream> availableLocales() { return call_static_method<"availableLocales", jni::ref<java::util::stream::Stream>>(); }
	...
	static jni::ref<java::lang::String> caseFoldLanguageTag(jni::ref<java::lang::String> languageTag) { return call_static_method<"caseFoldLanguageTag", jni::ref<java::lang::String>>(languageTag); }
