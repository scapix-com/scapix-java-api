...
namespace scapix::java_api { namespace java::util::zip { class ZipUtils; }}
...
public:
	...
	static jlong get64S(jni::ref<jni::array<jbyte>> b, jint off) { return call_static_method<"get64S", jlong>(b, off); }
