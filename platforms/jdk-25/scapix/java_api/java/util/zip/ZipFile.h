...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_ZIPFILE
...
public:
	...
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> file, jint mode) { return object_base::new_object(file, mode); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> file, jint mode, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(file, mode, charset); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::lang::String> name, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(name, charset); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> file, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(file, charset); }
