...
namespace scapix::java_api { namespace java::util::zip { class ZipOutputStream_XEntry; }}
...
public:
	...
	static jni::ref<java::util::zip::ZipOutputStream_XEntry> new_object(jni::ref<java::util::zip::ZipEntry> entry, jlong offset) { return object_base::new_object(entry, offset); }
