...
public:
	...
	static jni::ref<java::util::zip::ZipFile_Source_Key> new_object(jni::ref<java::io::File> file, jni::ref<java::nio::file::attribute::BasicFileAttributes> attrs, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(file, attrs, charset); }
