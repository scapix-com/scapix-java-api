...
namespace scapix::java_api { namespace java::util { class Spliterators_DoubleArraySpliterator; }}
...
public:
	...
	static jni::ref<java::util::Spliterators_DoubleArraySpliterator> new_object(jni::ref<jni::array<jdouble>> array, jint additionalCharacteristics) { return object_base::new_object(array, additionalCharacteristics); }
	static jni::ref<java::util::Spliterators_DoubleArraySpliterator> new_object(jni::ref<jni::array<jdouble>> array, jint origin, jint fence, jint additionalCharacteristics) { return object_base::new_object(array, origin, fence, additionalCharacteristics); }
