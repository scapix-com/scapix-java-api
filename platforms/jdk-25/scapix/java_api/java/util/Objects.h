...
public:
	...
	static jni::ref<java::lang::String> toIdentityString(jni::ref<java::lang::Object> o) { return call_static_method<"toIdentityString", jni::ref<java::lang::String>>(o); }
	...
	static jlong checkIndex(jlong index, jlong length) { return call_static_method<"checkIndex", jlong>(index, length); }
	static jlong checkFromToIndex(jlong fromIndex, jlong toIndex, jlong length) { return call_static_method<"checkFromToIndex", jlong>(fromIndex, toIndex, length); }
	static jlong checkFromIndexSize(jlong fromIndex, jlong size, jlong length) { return call_static_method<"checkFromIndexSize", jlong>(fromIndex, size, length); }
};
