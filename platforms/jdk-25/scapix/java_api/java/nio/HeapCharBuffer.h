...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_HEAPCHARBUFFER_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_HEAPCHARBUFFER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class HeapCharBuffer; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::HeapCharBuffer>
{
	static constexpr fixed_string class_name = "java/nio/HeapCharBuffer";
	using base_classes = std::tuple<scapix::java_api::java::nio::CharBuffer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_HEAPCHARBUFFER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_HEAPCHARBUFFER)
#define SCAPIX_JAVA_API_JAVA_NIO_HEAPCHARBUFFER
...
// private
class java::nio::HeapCharBuffer : public jni::object_base<"java/nio/HeapCharBuffer",
	java::nio::CharBuffer>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_HEAPCHARBUFFER
