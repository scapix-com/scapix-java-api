...
public:
	...
	jboolean exists(jni::ref<java::nio::file::Path> path, jni::ref<jni::array<java::nio::file::LinkOption>> options) { return call_method<"exists", jboolean>(path, options); }
	jni::ref<java::nio::file::attribute::BasicFileAttributes> readAttributesIfExists(jni::ref<java::nio::file::Path> path, jni::ref<java::lang::Class> type, jni::ref<jni::array<java::nio::file::LinkOption>> options) { return call_method<"readAttributesIfExists", jni::ref<java::nio::file::attribute::BasicFileAttributes>>(path, type, options); }
};
