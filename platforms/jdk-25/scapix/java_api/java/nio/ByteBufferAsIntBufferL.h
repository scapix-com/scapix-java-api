...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASINTBUFFERL_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASINTBUFFERL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class ByteBufferAsIntBufferL; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::ByteBufferAsIntBufferL>
{
	static constexpr fixed_string class_name = "java/nio/ByteBufferAsIntBufferL";
	using base_classes = std::tuple<scapix::java_api::java::nio::IntBuffer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASINTBUFFERL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASINTBUFFERL)
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASINTBUFFERL
...
// private
class java::nio::ByteBufferAsIntBufferL : public jni::object_base<"java/nio/ByteBufferAsIntBufferL",
	java::nio::IntBuffer>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASINTBUFFERL
