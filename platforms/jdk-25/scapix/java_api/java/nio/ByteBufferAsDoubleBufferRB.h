...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERRB_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERRB_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class ByteBufferAsDoubleBufferRB; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::ByteBufferAsDoubleBufferRB>
{
	static constexpr fixed_string class_name = "java/nio/ByteBufferAsDoubleBufferRB";
	using base_classes = std::tuple<scapix::java_api::java::nio::ByteBufferAsDoubleBufferB>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERRB_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERRB)
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERRB
...
// private
class java::nio::ByteBufferAsDoubleBufferRB : public jni::object_base<"java/nio/ByteBufferAsDoubleBufferRB",
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERRB
