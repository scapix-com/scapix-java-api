...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_SERVERSOCKETCHANNEL
...
public:
	...
	static jni::ref<java::nio::channels::ServerSocketChannel> open(jni::ref<java::net::ProtocolFamily> family) { return call_static_method<"open", jni::ref<java::nio::channels::ServerSocketChannel>>(family); }
