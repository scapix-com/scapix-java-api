...
public:
	...
	static jni::ref<java::nio::channels::SocketChannel> open(jni::ref<java::net::ProtocolFamily> family) { return call_static_method<"open", jni::ref<java::nio::channels::SocketChannel>>(family); }
