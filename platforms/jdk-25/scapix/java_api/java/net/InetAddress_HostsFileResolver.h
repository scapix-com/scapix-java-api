...
namespace scapix::java_api { namespace java::net { class InetAddress_HostsFileResolver; }}
...
public:
	...
	static jni::ref<java::net::InetAddress_HostsFileResolver> new_object(jni::ref<java::lang::String> hostsFileName) { return object_base::new_object(hostsFileName); }
