...
public:
	...
	static jni::ref<java::net::InetAddress> ofLiteral(jni::ref<java::lang::String> ipAddressLiteral) { return call_static_method<"ofLiteral", jni::ref<java::net::InetAddress>>(ipAddressLiteral); }
