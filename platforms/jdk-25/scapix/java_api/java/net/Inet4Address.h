...
#ifndef SCAPIX_JAVA_API_JAVA_NET_INET4ADDRESS
...
public:
	...
	static jni::ref<java::net::Inet4Address> ofLiteral(jni::ref<java::lang::String> ipv4AddressLiteral) { return call_static_method<"ofLiteral", jni::ref<java::net::Inet4Address>>(ipv4AddressLiteral); }
	static jni::ref<java::net::Inet4Address> ofPosixLiteral(jni::ref<java::lang::String> posixIPAddressLiteral) { return call_static_method<"ofPosixLiteral", jni::ref<java::net::Inet4Address>>(posixIPAddressLiteral); }
