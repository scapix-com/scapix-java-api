...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_MOUSEEVENT
...
public:
	...
	static jni::ref<java::awt::event::MouseEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jint modifiers, jint x, jint y, jint clickCount, jboolean popupTrigger, jint button) { return object_base::new_object(source, id, when, modifiers, x, y, clickCount, popupTrigger, button); }
	static jni::ref<java::awt::event::MouseEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jint modifiers, jint x, jint y, jint clickCount, jboolean popupTrigger) { return object_base::new_object(source, id, when, modifiers, x, y, clickCount, popupTrigger); }
	jint getModifiersEx() { return call_method<"getModifiersEx", jint>(); }
	static jni::ref<java::awt::event::MouseEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jint modifiers, jint x, jint y, jint xAbs, jint yAbs, jint clickCount, jboolean popupTrigger, jint button) { return object_base::new_object(source, id, when, modifiers, x, y, xAbs, yAbs, clickCount, popupTrigger, button); }
	...
	void translatePoint(jint x, jint y) { return call_method<"translatePoint", void>(x, y); }
	...
	static jni::ref<java::lang::String> getMouseModifiersText(jint modifiers) { return call_static_method<"getMouseModifiersText", jni::ref<java::lang::String>>(modifiers); }
