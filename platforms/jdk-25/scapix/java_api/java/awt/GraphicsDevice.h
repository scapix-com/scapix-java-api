...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_GRAPHICSDEVICE
...
public:
	...
	jni::ref<java::awt::GraphicsConfiguration> getBestConfiguration(jni::ref<java::awt::GraphicsConfigTemplate> gct) { return call_method<"getBestConfiguration", jni::ref<java::awt::GraphicsConfiguration>>(gct); }
	jboolean isFullScreenSupported() { return call_method<"isFullScreenSupported", jboolean>(); }
	void setFullScreenWindow(jni::ref<java::awt::Window> w) { return call_method<"setFullScreenWindow", void>(w); }
	...
	void setDisplayMode(jni::ref<java::awt::DisplayMode> dm) { return call_method<"setDisplayMode", void>(dm); }
	...
	jboolean isWindowTranslucencySupported(jni::ref<java::awt::GraphicsDevice_WindowTranslucency> translucencyKind) { return call_method<"isWindowTranslucencySupported", jboolean>(translucencyKind); }
};
