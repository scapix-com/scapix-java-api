...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_IMAGE_RENDERABLE_RENDERABLEIMAGEOP
...
public:
	...
	static jni::ref<java::awt::image::renderable::RenderableImageOp> new_object(jni::ref<java::awt::image::renderable::ContextualRenderedImageFactory> CRIF, jni::ref<java::awt::image::renderable::ParameterBlock> paramBlock) { return object_base::new_object(CRIF, paramBlock); }
	...
	jni::ref<java::awt::image::renderable::ParameterBlock> setParameterBlock(jni::ref<java::awt::image::renderable::ParameterBlock> paramBlock) { return call_method<"setParameterBlock", jni::ref<java::awt::image::renderable::ParameterBlock>>(paramBlock); }
	...
	jni::ref<java::awt::image::RenderedImage> createScaledRendering(jint w, jint h, jni::ref<java::awt::RenderingHints> hints) { return call_method<"createScaledRendering", jni::ref<java::awt::image::RenderedImage>>(w, h, hints); }
	...
	jni::ref<java::awt::image::RenderedImage> createRendering(jni::ref<java::awt::image::renderable::RenderContext> renderContext) { return call_method<"createRendering", jni::ref<java::awt::image::RenderedImage>>(renderContext); }
};
