...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENTQUEUE
...
public:
	...
	static jni::ref<java::awt::EventQueue> new_object() { return object_base::new_object(); }
	void postEvent(jni::ref<java::awt::AWTEvent> theEvent) { return call_method<"postEvent", void>(theEvent); }
	...
	jni::ref<java::awt::AWTEvent> peekEvent(jint id) { return call_method<"peekEvent", jni::ref<java::awt::AWTEvent>>(id); }
	...
	void push(jni::ref<java::awt::EventQueue> newEventQueue) { return call_method<"push", void>(newEventQueue); }
	...
	static void invokeLater(jni::ref<java::lang::Runnable> runnable) { return call_static_method<"invokeLater", void>(runnable); }
	static void invokeAndWait(jni::ref<java::lang::Runnable> runnable) { return call_static_method<"invokeAndWait", void>(runnable); }
};
