...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_CANVAS
...
public:
	...
	static jni::ref<java::awt::Canvas> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::Canvas> new_object(jni::ref<java::awt::GraphicsConfiguration> config) { return object_base::new_object(config); }
