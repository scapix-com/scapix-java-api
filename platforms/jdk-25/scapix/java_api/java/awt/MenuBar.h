...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_MENUBAR
...
public:
	...
	static jni::ref<java::awt::MenuBar> new_object() { return object_base::new_object(); }
	...
	void setHelpMenu(jni::ref<java::awt::Menu> m) { return call_method<"setHelpMenu", void>(m); }
	jni::ref<java::awt::Menu> add(jni::ref<java::awt::Menu> m) { return call_method<"add", jni::ref<java::awt::Menu>>(m); }
	...
	jni::ref<java::awt::Menu> getMenu(jint i) { return call_method<"getMenu", jni::ref<java::awt::Menu>>(i); }
	jni::ref<java::util::Enumeration> shortcuts() { return call_method<"shortcuts", jni::ref<java::util::Enumeration>>(); }
	jni::ref<java::awt::MenuItem> getShortcutMenuItem(jni::ref<java::awt::MenuShortcut> s) { return call_method<"getShortcutMenuItem", jni::ref<java::awt::MenuItem>>(s); }
	void deleteShortcut(jni::ref<java::awt::MenuShortcut> s) { return call_method<"deleteShortcut", void>(s); }
