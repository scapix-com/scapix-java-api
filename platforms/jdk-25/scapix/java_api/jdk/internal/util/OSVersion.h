...
namespace scapix::java_api { namespace jdk::internal::util { class OSVersion; }}
...
public:
	...
	static jni::ref<jdk::internal::util::OSVersion> new_object(jint major, jint minor) { return object_base::new_object(major, minor); }
	static jni::ref<jdk::internal::util::OSVersion> new_object(jint major, jint minor, jint micro) { return object_base::new_object(major, minor, micro); }
