...
namespace scapix::java_api { namespace jdk::internal::util::random { class RandomSupport; }}
...
public:
	...
	static void checkRange(jdouble origin, jdouble bound) { return call_static_method<"checkRange", void>(origin, bound); }
	static void checkRange(jint origin, jint bound) { return call_static_method<"checkRange", void>(origin, bound); }
	static void checkRange(jlong origin, jlong bound) { return call_static_method<"checkRange", void>(origin, bound); }
	...
	static jlong boundedNextLong(jni::ref<java::util::random::RandomGenerator> rng, jlong origin, jlong bound) { return call_static_method<"boundedNextLong", jlong>(rng, origin, bound); }
	...
	static jdouble boundedNextDouble(jni::ref<java::util::random::RandomGenerator> rng, jdouble origin, jdouble bound) { return call_static_method<"boundedNextDouble", jdouble>(rng, origin, bound); }
	...
	static jdouble computeNextExponentialSoftCapped(jni::ref<java::util::random::RandomGenerator> rng, jdouble maxValue) { return call_static_method<"computeNextExponentialSoftCapped", jdouble>(rng, maxValue); }
