...
namespace scapix::java_api { namespace jdk::internal::util { class Preconditions; }}
...
public:
	...
	static jni::ref<java::util::function::BiFunction> SIOOBE_FORMATTER() { return get_static_field<"SIOOBE_FORMATTER", jni::ref<java::util::function::BiFunction>>(); }
	static jni::ref<java::util::function::BiFunction> AIOOBE_FORMATTER() { return get_static_field<"AIOOBE_FORMATTER", jni::ref<java::util::function::BiFunction>>(); }
	static jni::ref<java::util::function::BiFunction> IOOBE_FORMATTER() { return get_static_field<"IOOBE_FORMATTER", jni::ref<java::util::function::BiFunction>>(); }

	static jni::ref<jdk::internal::util::Preconditions> new_object() { return object_base::new_object(); }
	...
	static jlong checkIndex(jlong index, jlong length, jni::ref<java::util::function::BiFunction> oobef) { return call_static_method<"checkIndex", jlong>(index, length, oobef); }
	static jlong checkFromToIndex(jlong fromIndex, jlong toIndex, jlong length, jni::ref<java::util::function::BiFunction> oobef) { return call_static_method<"checkFromToIndex", jlong>(fromIndex, toIndex, length, oobef); }
	static jlong checkFromIndexSize(jlong fromIndex, jlong size, jlong length, jni::ref<java::util::function::BiFunction> oobef) { return call_static_method<"checkFromIndexSize", jlong>(fromIndex, size, length, oobef); }
