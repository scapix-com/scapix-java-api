...
namespace scapix::java_api { namespace jdk::internal::util { class ImmutableBitSetPredicate_SmallImmutableBitSetPredicate; }}
...
public:
	...
	static jni::ref<jdk::internal::util::ImmutableBitSetPredicate_SmallImmutableBitSetPredicate> new_object(jlong first, jlong second) { return object_base::new_object(first, second); }
