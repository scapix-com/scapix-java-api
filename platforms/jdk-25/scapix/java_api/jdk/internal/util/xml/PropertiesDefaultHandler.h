...
namespace scapix::java_api { namespace jdk::internal::util::xml { class PropertiesDefaultHandler; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::PropertiesDefaultHandler> new_object() { return object_base::new_object(); }
