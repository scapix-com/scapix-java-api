...
namespace scapix::java_api { namespace jdk::internal::util::xml::impl { class ParserSAX; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::impl::ParserSAX> new_object() { return object_base::new_object(); }
