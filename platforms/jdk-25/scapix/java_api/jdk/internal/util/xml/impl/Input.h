...
namespace scapix::java_api { namespace jdk::internal::util::xml::impl { class Input; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::impl::Input> new_object(jint buffsize) { return object_base::new_object(buffsize); }
	static jni::ref<jdk::internal::util::xml::impl::Input> new_object(jni::ref<jni::array<jchar>> buff) { return object_base::new_object(buff); }
	static jni::ref<jdk::internal::util::xml::impl::Input> new_object() { return object_base::new_object(); }
