...
namespace scapix::java_api { namespace jdk::internal::util { class ArraysSupport; }}
...
public:
	...
	static jint vectorizedMismatch(jni::ref<java::lang::Object> a, jlong aOffset, jni::ref<java::lang::Object> b, jlong bOffset, jint length, jint log2ArrayIndexScale) { return call_static_method<"vectorizedMismatch", jint>(a, aOffset, b, bOffset, length, log2ArrayIndexScale); }
	static jint hashCode(jni::ref<jni::array<jint>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCode", jint>(a, fromIndex, length, initialValue); }
	static jint hashCode(jni::ref<jni::array<jshort>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCode", jint>(a, fromIndex, length, initialValue); }
	static jint hashCode(jni::ref<jni::array<jchar>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCode", jint>(a, fromIndex, length, initialValue); }
	static jint hashCode(jni::ref<jni::array<jbyte>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCode", jint>(a, fromIndex, length, initialValue); }
	static jint hashCodeOfUnsigned(jni::ref<jni::array<jbyte>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCodeOfUnsigned", jint>(a, fromIndex, length, initialValue); }
	static jint hashCodeOfUTF16(jni::ref<jni::array<jbyte>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCodeOfUTF16", jint>(a, fromIndex, length, initialValue); }
	static jint hashCode(jni::ref<jni::array<java::lang::Object>> a, jint fromIndex, jint length, jint initialValue) { return call_static_method<"hashCode", jint>(a, fromIndex, length, initialValue); }
