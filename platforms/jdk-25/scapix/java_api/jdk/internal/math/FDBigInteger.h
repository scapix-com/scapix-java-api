...
public:
	...
	static jni::ref<jdk::internal::math::FDBigInteger> new_object(jlong lValue, jni::ref<jni::array<jbyte>> digits, jint kDigits, jint nDigits) { return object_base::new_object(lValue, digits, kDigits, nDigits); }
