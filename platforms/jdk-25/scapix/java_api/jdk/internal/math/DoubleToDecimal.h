...
namespace scapix::java_api { namespace jdk::internal::math { class DoubleToDecimal; }}
...
public:
	...
	static jni::ref<jdk::internal::math::DoubleToDecimal> LATIN1() { return get_static_field<"LATIN1", jni::ref<jdk::internal::math::DoubleToDecimal>>(); }
	static jni::ref<jdk::internal::math::DoubleToDecimal> UTF16() { return get_static_field<"UTF16", jni::ref<jdk::internal::math::DoubleToDecimal>>(); }
	...
	static void split(jdouble v, jni::ref<jdk::internal::math::FormattedFPDecimal> fd) { return call_static_method<"split", void>(v, fd); }
	jint putDecimal(jni::ref<jni::array<jbyte>> str, jint index, jdouble v) { return call_method<"putDecimal", jint>(str, index, v); }
