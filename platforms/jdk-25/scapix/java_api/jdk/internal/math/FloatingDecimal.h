...
namespace scapix::java_api { namespace jdk::internal::math { class FloatingDecimal; }}
...
public:
	...
	static jni::ref<jdk::internal::math::FloatingDecimal> new_object() { return object_base::new_object(); }
	...
	static void appendTo(jdouble d, jni::ref<java::lang::Appendable> buf) { return call_static_method<"appendTo", void>(d, buf); }
