...
public:
	...
	static jni::ref<jdk::internal::math::FormattedFPDecimal> valueForDoubleToString(jdouble v) { return call_static_method<"valueForDoubleToString", jni::ref<jdk::internal::math::FormattedFPDecimal>>(v); }
	jlong getSignificand() { return call_method<"getSignificand", jlong>(); }
	jint getPrecision() { return call_method<"getPrecision", jint>(); }
	jint getExp() { return call_method<"getExp", jint>(); }
