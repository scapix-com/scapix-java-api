...
namespace scapix::java_api { namespace jdk::internal::logger { class LoggerWrapper; }}
...
public:
	...
	static jni::ref<jdk::internal::logger::LoggerWrapper> new_object(jni::ref<java::lang::System_Logger> wrapped) { return object_base::new_object(wrapped); }
