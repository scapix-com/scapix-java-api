...
namespace scapix::java_api { namespace jdk::internal::jrtfs { class JrtFileSystemProvider; }}
...
public:
	...
	static jni::ref<jdk::internal::jrtfs::JrtFileSystemProvider> new_object() { return object_base::new_object(); }
