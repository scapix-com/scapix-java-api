...
namespace scapix::java_api { namespace jdk::internal::module { class Modules; }}
...
public:
	...
	static void addExports(jni::ref<java::lang::Module> m, jni::ref<java::lang::String> pn) { return call_static_method<"addExports", void>(m, pn); }
	...
	static void addEnableNativeAccessToAllUnnamed() { return call_static_method<"addEnableNativeAccessToAllUnnamed", void>(); }
	...
	static jni::ref<java::lang::module::Configuration> newBootLayerConfiguration(jni::ref<java::lang::module::ModuleFinder> finder, jni::ref<java::util::Collection> roots, jni::ref<java::io::PrintStream> traceOutput) { return call_static_method<"newBootLayerConfiguration", jni::ref<java::lang::module::Configuration>>(finder, roots, traceOutput); }
