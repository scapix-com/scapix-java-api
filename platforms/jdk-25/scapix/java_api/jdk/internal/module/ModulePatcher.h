...
namespace scapix::java_api { namespace jdk::internal::module { class ModulePatcher; }}
...
public:
	...
	static jni::ref<jdk::internal::module::ModulePatcher> new_object(jni::ref<java::util::Map> input) { return object_base::new_object(input); }
