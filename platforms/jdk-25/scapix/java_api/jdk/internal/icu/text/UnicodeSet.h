...
namespace scapix::java_api { namespace jdk::internal::icu::text { class UnicodeSet; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::text::UnicodeSet> new_object(jint start, jint end) { return object_base::new_object(start, end); }
	static jni::ref<jdk::internal::icu::text::UnicodeSet> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
