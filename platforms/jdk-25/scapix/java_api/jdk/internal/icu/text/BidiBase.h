...
namespace scapix::java_api { namespace jdk::internal::icu::text { class BidiBase; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::text::BidiBase> new_object(jint maxLength, jint maxRunCount) { return object_base::new_object(maxLength, maxRunCount); }
	...
	static jni::ref<jdk::internal::icu::text::BidiBase> new_object(jni::ref<jni::array<jchar>> text, jint textStart, jni::ref<jni::array<jbyte>> embeddings, jint embStart, jint paragraphLength, jint flags) { return object_base::new_object(text, textStart, embeddings, embStart, paragraphLength, flags); }
