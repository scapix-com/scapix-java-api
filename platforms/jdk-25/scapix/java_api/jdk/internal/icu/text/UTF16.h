...
namespace scapix::java_api { namespace jdk::internal::icu::text { class UTF16; }}
...
public:
	...
	static jboolean isSurrogate(jint codePoint) { return call_static_method<"isSurrogate", jboolean>(codePoint); }
	static jboolean isTrailSurrogate(jint codePoint) { return call_static_method<"isTrailSurrogate", jboolean>(codePoint); }
	static jboolean isLeadSurrogate(jint codePoint) { return call_static_method<"isLeadSurrogate", jboolean>(codePoint); }
