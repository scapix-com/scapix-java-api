...
namespace scapix::java_api { namespace jdk::internal::icu::text { class ReplaceableString; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::text::ReplaceableString> new_object(jni::ref<java::lang::String> str) { return object_base::new_object(str); }
	static jni::ref<jdk::internal::icu::text::ReplaceableString> new_object(jni::ref<java::lang::StringBuffer> buf) { return object_base::new_object(buf); }
