...
namespace scapix::java_api { namespace jdk::internal::icu::text { class FilteredNormalizer2; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::text::FilteredNormalizer2> new_object(jni::ref<jdk::internal::icu::text::Normalizer2> n2, jni::ref<jdk::internal::icu::text::UnicodeSet> filterSet) { return object_base::new_object(n2, filterSet); }
