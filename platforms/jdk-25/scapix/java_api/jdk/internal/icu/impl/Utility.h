...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class Utility; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::Utility> new_object() { return object_base::new_object(); }
