...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class Norm2AllModes_Normalizer2WithImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::Norm2AllModes_Normalizer2WithImpl> new_object(jni::ref<jdk::internal::icu::impl::NormalizerImpl> ni) { return object_base::new_object(ni); }
