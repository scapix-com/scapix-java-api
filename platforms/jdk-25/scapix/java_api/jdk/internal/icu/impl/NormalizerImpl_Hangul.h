...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class NormalizerImpl_Hangul; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::NormalizerImpl_Hangul> new_object() { return object_base::new_object(); }
