...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class Norm2AllModes_NoopNormalizer2; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::Norm2AllModes_NoopNormalizer2> new_object() { return object_base::new_object(); }
