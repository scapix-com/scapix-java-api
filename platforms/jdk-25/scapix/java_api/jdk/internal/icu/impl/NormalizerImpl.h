...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class NormalizerImpl; }}
...
public:
	...
	static jint IX_MIN_MAYBE_NO() { return get_static_field<"IX_MIN_MAYBE_NO", jint>(); }
	static jint IX_MIN_MAYBE_NO_COMBINES_FWD() { return get_static_field<"IX_MIN_MAYBE_NO_COMBINES_FWD", jint>(); }
	...
	static jni::ref<jdk::internal::icu::impl::NormalizerImpl> new_object() { return object_base::new_object(); }
	...
	static jint getCCFromYesOrMaybeYes(jint norm16) { return call_static_method<"getCCFromYesOrMaybeYes", jint>(norm16); }
	jint getCCFromYesOrMaybeYesCP(jint c) { return call_method<"getCCFromYesOrMaybeYesCP", jint>(c); }
