...
namespace scapix::java_api { namespace jdk::internal::icu::util { class OutputInt; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::util::OutputInt> new_object() { return object_base::new_object(); }
