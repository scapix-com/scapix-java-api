...
namespace scapix::java_api { namespace jdk::internal::event { class ErrorThrownEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::ErrorThrownEvent> new_object() { return object_base::new_object(); }
