...
namespace scapix::java_api { namespace jdk::internal::event { class VirtualThreadStartEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::VirtualThreadStartEvent> new_object() { return object_base::new_object(); }
