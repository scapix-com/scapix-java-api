...
namespace scapix::java_api { namespace jdk::internal::event { class X509CertificateEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::X509CertificateEvent> new_object() { return object_base::new_object(); }
