...
namespace scapix::java_api { namespace jdk::internal::event { class EventHelper; }}
...
public:
	...
	static jni::ref<jdk::internal::event::EventHelper> new_object() { return object_base::new_object(); }
	...
	static void logX509ValidationEvent(jlong anchorCertId, jni::ref<jni::array<jlong>> certIds) { return call_static_method<"logX509ValidationEvent", void>(anchorCertId, certIds); }
	static void logX509CertificateEvent(jni::ref<java::lang::String> algId, jni::ref<java::lang::String> serialNum, jni::ref<java::lang::String> subject, jni::ref<java::lang::String> issuer, jni::ref<java::lang::String> keyType, jint length, jlong certId, jlong beginDate, jlong endDate) { return call_static_method<"logX509CertificateEvent", void>(algId, serialNum, subject, issuer, keyType, length, certId, beginDate, endDate); }
