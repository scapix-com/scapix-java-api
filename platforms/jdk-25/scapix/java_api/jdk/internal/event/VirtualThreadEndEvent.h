...
namespace scapix::java_api { namespace jdk::internal::event { class VirtualThreadEndEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::VirtualThreadEndEvent> new_object() { return object_base::new_object(); }
