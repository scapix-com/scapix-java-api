...
namespace scapix::java_api { namespace jdk::internal::event { class ProcessStartEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::ProcessStartEvent> new_object() { return object_base::new_object(); }
