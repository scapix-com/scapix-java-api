...
namespace scapix::java_api { namespace jdk::internal::event { class SecurityProviderServiceEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::SecurityProviderServiceEvent> new_object() { return object_base::new_object(); }
