...
namespace scapix::java_api { namespace jdk::internal::event { class ThrowableTracer; }}
...
public:
	...
	static jni::ref<jdk::internal::event::ThrowableTracer> new_object() { return object_base::new_object(); }
