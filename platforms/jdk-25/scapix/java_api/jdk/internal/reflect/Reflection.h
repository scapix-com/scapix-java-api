...
public:
	...
	static void ensureNativeAccess(jni::ref<java::lang::Class> currentClass, jni::ref<java::lang::Class> owner, jni::ref<java::lang::String> methodName, jboolean jni) { return call_static_method<"ensureNativeAccess", void>(currentClass, owner, methodName, jni); }
