...
namespace scapix::java_api { namespace jdk::internal::reflect { class ConstructorAccessorImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::ConstructorAccessorImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::jdk::internal::reflect::ConstructorAccessor>;
};
