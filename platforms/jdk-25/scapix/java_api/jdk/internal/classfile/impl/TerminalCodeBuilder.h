...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class TerminalCodeBuilder; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::TerminalCodeBuilder>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::classfile::CodeBuilder, scapix::java_api::jdk::internal::classfile::impl::LabelContext>;
};
...
public:
	...
	static jint setupTopLocal(jni::ref<jdk::internal::classfile::impl::MethodInfo> methodInfo, jni::ref<java::lang::classfile::CodeModel> original) { return call_static_method<"setupTopLocal", jint>(methodInfo, original); }
