...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_ClassEntryImpl; }}
...
public:
	...
	jboolean matches(jni::ref<java::lang::constant::ClassDesc> desc) { return call_method<"matches", jboolean>(desc); }
