...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_StringEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_StringEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_AbstractRefEntry, scapix::java_api::java::lang::classfile::constantpool::StringEntry>;
};
...
public:
	...
	jboolean equalsString(jni::ref<java::lang::String> value) { return call_method<"equalsString", jboolean>(value); }
	...
	jni::ref<java::lang::classfile::constantpool::StringEntry> clone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<java::lang::classfile::constantpool::StringEntry>>(cp); }
