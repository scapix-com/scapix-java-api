...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundRecordComponentInfo> new_object(jni::ref<java::lang::classfile::ClassReader> reader, jint startPos) { return object_base::new_object(reader, startPos); }
