...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundAttribute_BoundModulePackagesAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute_BoundModulePackagesAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute, scapix::java_api::java::lang::classfile::attribute::ModulePackagesAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundModulePackagesAttribute> new_object(jni::ref<java::lang::classfile::ClassReader> cf, jni::ref<java::lang::classfile::AttributeMapper> mapper, jint pos) { return object_base::new_object(cf, mapper, pos); }
