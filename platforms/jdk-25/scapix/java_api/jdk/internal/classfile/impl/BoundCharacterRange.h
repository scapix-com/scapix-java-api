...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundCharacterRange; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundCharacterRange>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::java::lang::classfile::instruction::CharacterRange>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundCharacterRange> new_object(jni::ref<jdk::internal::classfile::impl::CodeImpl> code, jint offset) { return object_base::new_object(code, offset); }
