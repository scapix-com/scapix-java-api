...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractBoundLocalVariable; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractBoundLocalVariable>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::jdk::internal::classfile::impl::Util_WritableLocalVariable>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractBoundLocalVariable> new_object(jni::ref<jdk::internal::classfile::impl::CodeImpl> code, jint offset) { return object_base::new_object(code, offset); }
