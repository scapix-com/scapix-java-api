...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class SignaturesImpl_TypeParamImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::SignaturesImpl_TypeParamImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::Signature_TypeParam>;
};
...
class jdk::internal::classfile::impl::SignaturesImpl_TypeParamImpl : public jni::object_base<"jdk/internal/classfile/impl/SignaturesImpl$TypeParamImpl",
	java::lang::Record,
	java::lang::classfile::Signature_TypeParam>
{
public:

	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_TypeParamImpl> new_object(jni::ref<java::lang::String> identifier, jni::ref<java::util::Optional> classBound, jni::ref<java::util::List> interfaceBounds) { return object_base::new_object(identifier, classBound, interfaceBounds); }
