...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class TransformImpl_ClassMethodTransform; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TransformImpl_ClassMethodTransform> new_object(jni::ref<java::lang::classfile::MethodTransform> transform, jni::ref<java::util::function::Predicate> filter) { return object_base::new_object(transform, filter); }
