...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_AdHocAttribute; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_AdHocAttribute> new_object(jni::ref<java::lang::classfile::AttributeMapper> mapper) { return object_base::new_object(mapper); }
	void writeBody(jni::ref<jdk::internal::classfile::impl::BufWriterImpl> p1) { return call_method<"writeBody", void>(p1); }
