...
#include <scapix/java_api/java/lang/classfile/instruction/ArrayStoreInstruction.h>
...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction_UnboundArrayStoreInstruction; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundArrayStoreInstruction>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundInstruction, scapix::java_api::java::lang::classfile::instruction::ArrayStoreInstruction>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundArrayStoreInstruction> new_object(jni::ref<java::lang::classfile::Opcode> op) { return object_base::new_object(op); }
