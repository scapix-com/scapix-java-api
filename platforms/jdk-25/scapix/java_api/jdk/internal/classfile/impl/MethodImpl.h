...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class MethodImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::MethodImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::java::lang::classfile::MethodModel, scapix::java_api::jdk::internal::classfile::impl::MethodInfo, scapix::java_api::jdk::internal::classfile::impl::Util_Writable>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::MethodImpl> new_object(jni::ref<java::lang::classfile::ClassReader> reader, jint startPos, jint endPos, jint attrStart) { return object_base::new_object(reader, startPos, endPos, attrStart); }
