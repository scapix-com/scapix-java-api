...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_FloatEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_FloatEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry, scapix::java_api::java::lang::classfile::constantpool::FloatEntry>;
};
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::FloatEntry> clone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<java::lang::classfile::constantpool::FloatEntry>>(cp); }
