...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_NameAndTypeEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_NameAndTypeEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_AbstractRefsEntry, scapix::java_api::java::lang::classfile::constantpool::NameAndTypeEntry>;
};
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::NameAndTypeEntry> clone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<java::lang::classfile::constantpool::NameAndTypeEntry>>(cp); }
