...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_ArrayTypeSigImpl> new_object(jint arrayDepth, jni::ref<java::lang::classfile::Signature> elemType) { return object_base::new_object(arrayDepth, elemType); }
