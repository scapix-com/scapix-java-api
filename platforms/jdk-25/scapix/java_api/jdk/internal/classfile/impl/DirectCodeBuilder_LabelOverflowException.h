...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class DirectCodeBuilder_LabelOverflowException; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::DirectCodeBuilder_LabelOverflowException> new_object() { return object_base::new_object(); }
