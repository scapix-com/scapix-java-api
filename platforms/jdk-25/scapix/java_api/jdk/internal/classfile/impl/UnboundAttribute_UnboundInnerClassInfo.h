...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundInnerClassInfo> new_object(jni::ref<java::lang::classfile::constantpool::ClassEntry> innerClass, jni::ref<java::util::Optional> outerClass, jni::ref<java::util::Optional> innerName, jint flagsMask) { return object_base::new_object(innerClass, outerClass, innerName, flagsMask); }
