...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundAttribute_BoundCodeAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute_BoundCodeAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute, scapix::java_api::java::lang::classfile::attribute::CodeAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundCodeAttribute> new_object(jni::ref<java::lang::classfile::AttributedElement> enclosing, jni::ref<java::lang::classfile::ClassReader> reader, jni::ref<java::lang::classfile::AttributeMapper> mapper, jint payloadStart) { return object_base::new_object(enclosing, reader, mapper, payloadStart); }
