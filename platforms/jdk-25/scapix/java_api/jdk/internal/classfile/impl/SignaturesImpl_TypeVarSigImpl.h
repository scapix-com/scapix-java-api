...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class SignaturesImpl_TypeVarSigImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::SignaturesImpl_TypeVarSigImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::Signature_TypeVarSig>;
};
...
class jdk::internal::classfile::impl::SignaturesImpl_TypeVarSigImpl : public jni::object_base<"jdk/internal/classfile/impl/SignaturesImpl$TypeVarSigImpl",
	java::lang::Record,
	java::lang::classfile::Signature_TypeVarSig>
{
public:

	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_TypeVarSigImpl> new_object(jni::ref<java::lang::String> identifier) { return object_base::new_object(identifier); }
