...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AnnotationImpl_OfStringImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfStringImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::AnnotationValue_OfString>;
};
...
class jdk::internal::classfile::impl::AnnotationImpl_OfStringImpl : public jni::object_base<"jdk/internal/classfile/impl/AnnotationImpl$OfStringImpl",
	java::lang::Record,
	java::lang::classfile::AnnotationValue_OfString>
{
public:

	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfStringImpl> new_object(jni::ref<java::lang::classfile::constantpool::Utf8Entry> constant) { return object_base::new_object(constant); }
