...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPseudoInstruction_UnboundCharacterRange; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction_UnboundCharacterRange>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction, scapix::java_api::java::lang::classfile::instruction::CharacterRange>;
};
...
public:
	...
	jni::ref<java::lang::classfile::Label> startScope_() { return get_field<"startScope", jni::ref<java::lang::classfile::Label>>(); }
	jni::ref<java::lang::classfile::Label> endScope_() { return get_field<"endScope", jni::ref<java::lang::classfile::Label>>(); }
