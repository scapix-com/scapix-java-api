...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassPrinterImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassPrinterImpl> new_object() { return object_base::new_object(); }
	...
	static jni::ref<jdk::internal::classfile::components::ClassPrinter_MapNode> modelToTree(jni::ref<java::lang::classfile::CompoundElement> model, jni::ref<jdk::internal::classfile::components::ClassPrinter_Verbosity> verbosity) { return call_static_method<"modelToTree", jni::ref<jdk::internal::classfile::components::ClassPrinter_MapNode>>(model, verbosity); }
	static jni::ref<jdk::internal::classfile::components::ClassPrinter_MapNode> methodToTree(jni::ref<java::lang::classfile::MethodModel> m, jni::ref<jdk::internal::classfile::components::ClassPrinter_Verbosity> verbosity) { return call_static_method<"methodToTree", jni::ref<jdk::internal::classfile::components::ClassPrinter_MapNode>>(m, verbosity); }
