...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundAnnotationDefaultAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundAnnotationDefaultAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute, scapix::java_api::java::lang::classfile::attribute::AnnotationDefaultAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundAnnotationDefaultAttribute> new_object(jni::ref<java::lang::classfile::AnnotationValue> annotationDefault) { return object_base::new_object(annotationDefault); }
