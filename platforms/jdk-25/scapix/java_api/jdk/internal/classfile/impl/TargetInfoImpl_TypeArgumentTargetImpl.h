...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TargetInfoImpl_TypeArgumentTargetImpl> new_object(jni::ref<java::lang::classfile::TypeAnnotation_TargetType> targetType, jni::ref<java::lang::classfile::Label> target, jint typeArgumentIndex) { return object_base::new_object(targetType, target, typeArgumentIndex); }
