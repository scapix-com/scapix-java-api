...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AnnotationImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::Annotation>;
};
...
#include <scapix/java_api/jdk/internal/classfile/impl/AnnotationImpl_OfCharImpl.h>
#include <scapix/java_api/jdk/internal/classfile/impl/AnnotationImpl_OfShortImpl.h>
#include <scapix/java_api/jdk/internal/classfile/impl/AnnotationImpl_OfIntImpl.h>
...
public:
	...
	using OfCharImpl = AnnotationImpl_OfCharImpl;
	using OfShortImpl = AnnotationImpl_OfShortImpl;
	using OfIntImpl = AnnotationImpl_OfIntImpl;
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl> new_object(jni::ref<java::lang::classfile::constantpool::Utf8Entry> className, jni::ref<java::util::List> elements) { return object_base::new_object(className, elements); }
