...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundLineNumberInfo; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundLineNumberInfo> new_object(jint startPc, jint lineNumber) { return object_base::new_object(startPc, lineNumber); }
