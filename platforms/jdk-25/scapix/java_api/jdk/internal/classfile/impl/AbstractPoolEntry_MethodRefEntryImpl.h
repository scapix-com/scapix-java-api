...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_MethodRefEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_MethodRefEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_AbstractMemberRefEntry, scapix::java_api::java::lang::classfile::constantpool::MethodRefEntry>;
};
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::MethodRefEntry> clone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<java::lang::classfile::constantpool::MethodRefEntry>>(cp); }
