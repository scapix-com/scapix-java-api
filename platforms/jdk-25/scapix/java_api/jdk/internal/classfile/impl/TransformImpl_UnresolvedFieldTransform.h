...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class TransformImpl_UnresolvedFieldTransform; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::TransformImpl_UnresolvedFieldTransform>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::classfile::FieldTransform, scapix::java_api::jdk::internal::classfile::impl::TransformImpl_ResolvableTransform>;
};
...
public:
	...
	void accept(jni::ref<java::lang::classfile::FieldBuilder> builder, jni::ref<java::lang::classfile::FieldElement> element) { return call_method<"accept", void>(builder, element); }
	void atEnd(jni::ref<java::lang::classfile::FieldBuilder> builder) { return call_method<"atEnd", void>(builder); }
	void atStart(jni::ref<java::lang::classfile::FieldBuilder> builder) { return call_method<"atStart", void>(builder); }
