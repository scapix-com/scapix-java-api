...
public:
	...
	jni::ref<java::lang::constant::DirectMethodHandleDesc> sym() { return get_field<"sym", jni::ref<java::lang::constant::DirectMethodHandleDesc>>(); }
	void sym(jni::ref<java::lang::constant::DirectMethodHandleDesc> v) { set_field<"sym", jni::ref<java::lang::constant::DirectMethodHandleDesc>>(v); }
