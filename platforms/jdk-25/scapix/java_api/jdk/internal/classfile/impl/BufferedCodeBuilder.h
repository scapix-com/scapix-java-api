...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BufferedCodeBuilder; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BufferedCodeBuilder> new_object(jni::ref<jdk::internal::classfile::impl::MethodInfo> methodInfo, jni::ref<jdk::internal::classfile::impl::SplitConstantPool> constantPool, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context, jni::ref<java::lang::classfile::CodeModel> original) { return object_base::new_object(methodInfo, constantPool, context, original); }
