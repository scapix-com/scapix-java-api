...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BufferedFieldBuilder> new_object(jni::ref<jdk::internal::classfile::impl::SplitConstantPool> constantPool, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context, jni::ref<java::lang::classfile::constantpool::Utf8Entry> name, jni::ref<java::lang::classfile::constantpool::Utf8Entry> type) { return object_base::new_object(constantPool, context, name, type); }
