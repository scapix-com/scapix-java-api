...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundLookupSwitchInstruction> new_object(jni::ref<java::lang::classfile::Label> defaultTarget, jni::ref<java::util::List> cases) { return object_base::new_object(defaultTarget, cases); }
