...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ChainedMethodBuilder> new_object(jni::ref<java::lang::classfile::MethodBuilder> downstream, jni::ref<java::util::function::Consumer> consumer) { return object_base::new_object(downstream, consumer); }
