...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::StackMapDecoder_StackMapFrameImpl> new_object(jint frameType, jni::ref<java::lang::classfile::Label> target, jni::ref<java::util::List> locals, jni::ref<java::util::List> stack) { return object_base::new_object(frameType, target, locals, stack); }
