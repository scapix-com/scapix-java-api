...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::TerminalMethodBuilder>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::classfile::MethodBuilder, scapix::java_api::jdk::internal::classfile::impl::MethodInfo>;
};
