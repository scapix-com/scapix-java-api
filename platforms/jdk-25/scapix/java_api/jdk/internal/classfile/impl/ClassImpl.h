...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassImpl> new_object(jni::ref<jni::array<jbyte>> cfbytes, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context) { return object_base::new_object(cfbytes, context); }
