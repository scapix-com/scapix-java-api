...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_PackageEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_PackageEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_AbstractNamedEntry, scapix::java_api::java::lang::classfile::constantpool::PackageEntry>;
};
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::PackageEntry> clone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<java::lang::classfile::constantpool::PackageEntry>>(cp); }
	jni::ref<java::lang::constant::PackageDesc> asSymbol() { return call_method<"asSymbol", jni::ref<java::lang::constant::PackageDesc>>(); }
	jboolean matches(jni::ref<java::lang::constant::PackageDesc> desc) { return call_method<"matches", jboolean>(desc); }
