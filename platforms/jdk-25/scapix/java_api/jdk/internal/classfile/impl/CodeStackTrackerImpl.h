...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class CodeStackTrackerImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::CodeStackTrackerImpl> new_object(jni::ref<jni::array<java::lang::classfile::TypeKind>> initialStack) { return object_base::new_object(initialStack); }
