...
#include <scapix/java_api/java/lang/classfile/ClassFileVersion.h>
...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassFileVersionImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::ClassFileVersionImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::java::lang::classfile::ClassFileVersion>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassFileVersionImpl> new_object(jint majorVersion, jint minorVersion) { return object_base::new_object(majorVersion, minorVersion); }
