...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class DirectCodeBuilder_DedupLineNumberTableAttribute; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::DirectCodeBuilder_DedupLineNumberTableAttribute> new_object(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> constantPool, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context) { return object_base::new_object(constantPool, context); }
	void writeLineNumber(jint pc, jint lineNo) { return call_method<"writeLineNumber", void>(pc, lineNo); }
	void writeBody(jni::ref<jdk::internal::classfile::impl::BufWriterImpl> b) { return call_method<"writeBody", void>(b); }
	void writeTo(jni::ref<jdk::internal::classfile::impl::BufWriterImpl> b) { return call_method<"writeTo", void>(b); }
