...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassHierarchyImpl_ResourceParsingClassHierarchyResolver; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassHierarchyImpl_ResourceParsingClassHierarchyResolver> new_object(jni::ref<java::util::function::Function> classStreamProvider) { return object_base::new_object(classStreamProvider); }
