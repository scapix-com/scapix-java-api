...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AnnotationImpl_OfAnnotationImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfAnnotationImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::AnnotationValue_OfAnnotation>;
};
...
class jdk::internal::classfile::impl::AnnotationImpl_OfAnnotationImpl : public jni::object_base<"jdk/internal/classfile/impl/AnnotationImpl$OfAnnotationImpl",
	java::lang::Record,
	java::lang::classfile::AnnotationValue_OfAnnotation>
{
public:

	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfAnnotationImpl> new_object(jni::ref<java::lang::classfile::Annotation> annotation) { return object_base::new_object(annotation); }
