...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BufferedMethodBuilder; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BufferedMethodBuilder>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::jdk::internal::classfile::impl::TerminalMethodBuilder>;
};
