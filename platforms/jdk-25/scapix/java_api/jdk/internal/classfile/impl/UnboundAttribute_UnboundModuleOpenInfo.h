...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundModuleOpenInfo; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleOpenInfo>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::attribute::ModuleOpenInfo>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleOpenInfo> new_object(jni::ref<java::lang::classfile::constantpool::PackageEntry> openedPackage, jint opensFlagsMask, jni::ref<java::util::List> opensTo) { return object_base::new_object(openedPackage, opensFlagsMask, opensTo); }
