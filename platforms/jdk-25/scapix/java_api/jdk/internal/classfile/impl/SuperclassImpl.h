...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SuperclassImpl> new_object(jni::ref<java::lang::classfile::constantpool::ClassEntry> superclassEntry) { return object_base::new_object(superclassEntry); }
