...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TargetInfoImpl_TypeParameterTargetImpl> new_object(jni::ref<java::lang::classfile::TypeAnnotation_TargetType> targetType, jint typeParameterIndex) { return object_base::new_object(targetType, typeParameterIndex); }
