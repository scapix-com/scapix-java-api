...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPseudoInstruction_UnboundLocalVariable; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction_UnboundLocalVariable>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction_AbstractLocalPseudo, scapix::java_api::java::lang::classfile::instruction::LocalVariable>;
};
