...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class SignaturesImpl_MethodSignatureImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::SignaturesImpl_MethodSignatureImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::MethodSignature>;
};
