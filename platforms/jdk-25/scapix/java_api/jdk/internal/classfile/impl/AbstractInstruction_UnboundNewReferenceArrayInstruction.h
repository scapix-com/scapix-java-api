...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundNewReferenceArrayInstruction> new_object(jni::ref<java::lang::classfile::constantpool::ClassEntry> componentTypeEntry) { return object_base::new_object(componentTypeEntry); }
