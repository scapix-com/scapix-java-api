...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundOperatorInstruction> new_object(jni::ref<java::lang::classfile::Opcode> op) { return object_base::new_object(op); }
