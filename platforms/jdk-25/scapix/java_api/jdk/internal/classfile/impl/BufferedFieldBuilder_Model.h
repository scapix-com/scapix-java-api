...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BufferedFieldBuilder_Model; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BufferedFieldBuilder_Model>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractUnboundModel, scapix::java_api::java::lang::classfile::FieldModel>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BufferedFieldBuilder_Model> new_object(jni::ref<jdk::internal::classfile::impl::BufferedFieldBuilder> this_0) { return object_base::new_object(this_0); }
