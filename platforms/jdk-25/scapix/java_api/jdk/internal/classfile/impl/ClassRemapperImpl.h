...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassRemapperImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassRemapperImpl> new_object(jni::ref<java::util::function::Function> mapFunction) { return object_base::new_object(mapFunction); }
