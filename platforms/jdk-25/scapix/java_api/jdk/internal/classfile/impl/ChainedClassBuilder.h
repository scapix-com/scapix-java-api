...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ChainedClassBuilder> new_object(jni::ref<java::lang::classfile::ClassBuilder> downstream, jni::ref<java::util::function::Consumer> consumer) { return object_base::new_object(downstream, consumer); }
