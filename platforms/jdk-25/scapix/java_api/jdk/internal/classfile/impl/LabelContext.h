...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class LabelContext; }}
...
public:
	...
	jboolean canWriteDirect(jni::ref<jdk::internal::classfile::impl::LabelContext> original) { return call_method<"canWriteDirect", jboolean>(original); }
