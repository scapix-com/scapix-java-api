...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AnnotationImpl_OfFloatImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfFloatImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::AnnotationValue_OfFloat>;
};
...
class jdk::internal::classfile::impl::AnnotationImpl_OfFloatImpl : public jni::object_base<"jdk/internal/classfile/impl/AnnotationImpl$OfFloatImpl",
	java::lang::Record,
	java::lang::classfile::AnnotationValue_OfFloat>
{
public:

	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfFloatImpl> new_object(jni::ref<java::lang::classfile::constantpool::FloatEntry> constant) { return object_base::new_object(constant); }
