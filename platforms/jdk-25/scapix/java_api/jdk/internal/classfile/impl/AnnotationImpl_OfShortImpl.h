...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AnnotationImpl_OfShortImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AnnotationImpl_OfShortImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::java::lang::classfile::AnnotationValue_OfShort>;
};
...
class jdk::internal::classfile::impl::AnnotationImpl_OfShortImpl : public jni::object_base<"jdk/internal/classfile/impl/AnnotationImpl$OfShortImpl",
	java::lang::Record,
	java::lang::classfile::AnnotationValue_OfShort>
{
public:

	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfShortImpl> new_object(jni::ref<java::lang::classfile::constantpool::IntegerEntry> constant) { return object_base::new_object(constant); }
