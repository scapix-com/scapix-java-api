...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundBootstrapMethodsAttribute> new_object(jni::ref<java::lang::classfile::ClassReader> reader, jni::ref<java::lang::classfile::AttributeMapper> mapper, jint pos) { return object_base::new_object(reader, mapper, pos); }
