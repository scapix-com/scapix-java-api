...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassHierarchyImpl> new_object(jni::ref<java::lang::classfile::ClassHierarchyResolver> classHierarchyResolver) { return object_base::new_object(classHierarchyResolver); }
