...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class TransformImpl_ChainedMethodTransform; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TransformImpl_ChainedMethodTransform> new_object(jni::ref<java::lang::classfile::MethodTransform> t, jni::ref<java::lang::classfile::MethodTransform> next) { return object_base::new_object(t, next); }
