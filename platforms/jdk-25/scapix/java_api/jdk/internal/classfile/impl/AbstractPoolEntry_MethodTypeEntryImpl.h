...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_MethodTypeEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_MethodTypeEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_AbstractRefEntry, scapix::java_api::java::lang::classfile::constantpool::MethodTypeEntry>;
};
...
public:
	...
	jni::ref<java::lang::classfile::constantpool::MethodTypeEntry> clone(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<java::lang::classfile::constantpool::MethodTypeEntry>>(cp); }
	jni::ref<java::lang::constant::MethodTypeDesc> asSymbol() { return call_method<"asSymbol", jni::ref<java::lang::constant::MethodTypeDesc>>(); }
	jboolean matches(jni::ref<java::lang::constant::MethodTypeDesc> desc) { return call_method<"matches", jboolean>(desc); }
