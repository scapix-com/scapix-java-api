...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BufWriterImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BufWriterImpl> new_object(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> constantPool, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context) { return object_base::new_object(constantPool, context); }
	static jni::ref<jdk::internal::classfile::impl::BufWriterImpl> new_object(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> constantPool, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context, jint initialSize) { return object_base::new_object(constantPool, context, initialSize); }
	static jni::ref<jdk::internal::classfile::impl::BufWriterImpl> new_object(jni::ref<java::lang::classfile::constantpool::ConstantPoolBuilder> constantPool, jni::ref<jdk::internal::classfile::impl::ClassFileImpl> context, jint initialSize, jni::ref<java::lang::classfile::constantpool::ClassEntry> thisClass, jint majorVersion) { return object_base::new_object(constantPool, context, initialSize, thisClass, majorVersion); }
	...
	void setLabelContext(jni::ref<jdk::internal::classfile::impl::LabelContext> labelContext, jboolean labelsMatch) { return call_method<"setLabelContext", void>(labelContext, labelsMatch); }
	jboolean labelsMatch(jni::ref<jdk::internal::classfile::impl::LabelContext> lc) { return call_method<"labelsMatch", jboolean>(lc); }
	...
	void writeU1U1(jint x1, jint x2) { return call_method<"writeU1U1", void>(x1, x2); }
	void writeU1U2(jint u1, jint u2) { return call_method<"writeU1U2", void>(u1, u2); }
	void writeU1U1U1(jint x1, jint x2, jint x3) { return call_method<"writeU1U1U1", void>(x1, x2, x3); }
	void writeU1U1U2(jint x1, jint x2, jint x3) { return call_method<"writeU1U1U2", void>(x1, x2, x3); }
	void writeU1U2U2(jint x1, jint x2, jint x3) { return call_method<"writeU1U2U2", void>(x1, x2, x3); }
	void writeU2U1(jint x1, jint x2) { return call_method<"writeU2U1", void>(x1, x2); }
	void writeU2U2(jint x1, jint x2) { return call_method<"writeU2U2", void>(x1, x2); }
	void writeU2U2U2(jint x1, jint x2, jint x3) { return call_method<"writeU2U2U2", void>(x1, x2, x3); }
	void writeInt(jint x) { return call_method<"writeInt", void>(x); }
	void writeIntInt(jint x1, jint x2) { return call_method<"writeIntInt", void>(x1, x2); }
	...
	void writeBytes(jni::ref<jdk::internal::classfile::impl::BufWriterImpl> other) { return call_method<"writeBytes", void>(other); }
	...
	void patchU2(jint offset, jint x) { return call_method<"patchU2", void>(offset, x); }
	void patchInt(jint offset, jint x) { return call_method<"patchInt", void>(offset, x); }
	void writeIntBytes(jint intSize, jlong intValue) { return call_method<"writeIntBytes", void>(intSize, intValue); }
	jint skip(jint bytes) { return call_method<"skip", jint>(bytes); }
	void reserveSpace(jint freeBytes) { return call_method<"reserveSpace", void>(freeBytes); }
	jint size() { return call_method<"size", jint>(); }
	jni::ref<jdk::internal::classfile::impl::RawBytecodeHelper_CodeRange> bytecodeView() { return call_method<"bytecodeView", jni::ref<jdk::internal::classfile::impl::RawBytecodeHelper_CodeRange>>(); }
	void copyTo(jni::ref<jni::array<jbyte>> array, jint bufferOffset) { return call_method<"copyTo", void>(array, bufferOffset); }
	jint cpIndex(jni::ref<java::lang::classfile::constantpool::PoolEntry> entry) { return call_method<"cpIndex", jint>(entry); }
	jint cpIndexOrZero(jni::ref<java::lang::classfile::constantpool::PoolEntry> entry) { return call_method<"cpIndexOrZero", jint>(entry); }
	void writeIndex(jni::ref<java::lang::classfile::constantpool::PoolEntry> entry) { return call_method<"writeIndex", void>(entry); }
	void writeIndex(jint bytecode, jni::ref<java::lang::classfile::constantpool::PoolEntry> entry) { return call_method<"writeIndex", void>(bytecode, entry); }
