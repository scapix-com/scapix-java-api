...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundExceptionsAttribute; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundExceptionsAttribute> new_object(jni::ref<java::util::List> exceptions) { return object_base::new_object(exceptions); }
