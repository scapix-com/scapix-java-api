...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundTypeAnnotation> new_object(jni::ref<java::lang::classfile::TypeAnnotation_TargetInfo> targetInfo, jni::ref<java::util::List> targetPath, jni::ref<java::lang::classfile::Annotation> annotation) { return object_base::new_object(targetInfo, targetPath, annotation); }
