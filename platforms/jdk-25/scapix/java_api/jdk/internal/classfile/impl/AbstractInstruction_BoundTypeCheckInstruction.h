...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction_BoundTypeCheckInstruction; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_BoundTypeCheckInstruction>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_BoundInstruction, scapix::java_api::java::lang::classfile::instruction::TypeCheckInstruction>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_BoundTypeCheckInstruction> new_object(jni::ref<java::lang::classfile::Opcode> op, jni::ref<jdk::internal::classfile::impl::CodeImpl> code, jint pos) { return object_base::new_object(op, code, pos); }
