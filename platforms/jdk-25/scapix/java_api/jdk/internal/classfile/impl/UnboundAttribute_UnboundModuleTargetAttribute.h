...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleTargetAttribute> new_object(jni::ref<java::lang::classfile::constantpool::Utf8Entry> moduleTarget) { return object_base::new_object(moduleTarget); }
