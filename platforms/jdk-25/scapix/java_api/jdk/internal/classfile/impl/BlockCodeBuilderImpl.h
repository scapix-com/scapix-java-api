...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BlockCodeBuilderImpl> new_object(jni::ref<java::lang::classfile::CodeBuilder> parent, jni::ref<java::lang::classfile::Label> breakLabel) { return object_base::new_object(parent, breakLabel); }
