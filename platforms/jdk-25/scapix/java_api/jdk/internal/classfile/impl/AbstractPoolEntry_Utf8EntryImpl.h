...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_Utf8EntryImpl; }}
...
public:
	...
	jboolean isFieldType(jni::ref<java::lang::constant::ClassDesc> desc) { return call_method<"isFieldType", jboolean>(desc); }
	jboolean isMethodType(jni::ref<java::lang::constant::MethodTypeDesc> desc) { return call_method<"isMethodType", jboolean>(desc); }
