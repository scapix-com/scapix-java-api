...
namespace scapix::java_api { namespace jdk::internal::classfile::components { class CodeLocalsShifter; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::components::CodeLocalsShifter> of(jni::ref<java::lang::classfile::AccessFlags> methodFlags, jni::ref<java::lang::constant::MethodTypeDesc> methodDescriptor) { return call_static_method<"of", jni::ref<jdk::internal::classfile::components::CodeLocalsShifter>>(methodFlags, methodDescriptor); }
