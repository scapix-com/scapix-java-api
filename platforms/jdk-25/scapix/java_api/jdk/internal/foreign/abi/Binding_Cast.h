...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class Binding_Cast; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> INT_TO_LONG() { return get_static_field<"INT_TO_LONG", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> LONG_TO_INT() { return get_static_field<"LONG_TO_INT", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> LONG_TO_BYTE() { return get_static_field<"LONG_TO_BYTE", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> LONG_TO_SHORT() { return get_static_field<"LONG_TO_SHORT", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> LONG_TO_CHAR() { return get_static_field<"LONG_TO_CHAR", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> BYTE_TO_LONG() { return get_static_field<"BYTE_TO_LONG", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> SHORT_TO_LONG() { return get_static_field<"SHORT_TO_LONG", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
	static jni::ref<jdk::internal::foreign::abi::Binding_Cast> CHAR_TO_LONG() { return get_static_field<"CHAR_TO_LONG", jni::ref<jdk::internal::foreign::abi::Binding_Cast>>(); }
