...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class Binding; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_BufferStore> bufferStore(jlong offset, jni::ref<java::lang::Class> type) { return call_static_method<"bufferStore", jni::ref<jdk::internal::foreign::abi::Binding_BufferStore>>(offset, type); }
	static jni::ref<jdk::internal::foreign::abi::Binding_BufferStore> bufferStore(jlong offset, jni::ref<java::lang::Class> type, jint byteWidth) { return call_static_method<"bufferStore", jni::ref<jdk::internal::foreign::abi::Binding_BufferStore>>(offset, type, byteWidth); }
	static jni::ref<jdk::internal::foreign::abi::Binding_BufferLoad> bufferLoad(jlong offset, jni::ref<java::lang::Class> type) { return call_static_method<"bufferLoad", jni::ref<jdk::internal::foreign::abi::Binding_BufferLoad>>(offset, type); }
	static jni::ref<jdk::internal::foreign::abi::Binding_BufferLoad> bufferLoad(jlong offset, jni::ref<java::lang::Class> type, jint byteWidth) { return call_static_method<"bufferLoad", jni::ref<jdk::internal::foreign::abi::Binding_BufferLoad>>(offset, type, byteWidth); }
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_BoxAddress> boxAddressRaw(jlong size, jlong align) { return call_static_method<"boxAddressRaw", jni::ref<jdk::internal::foreign::abi::Binding_BoxAddress>>(size, align); }
