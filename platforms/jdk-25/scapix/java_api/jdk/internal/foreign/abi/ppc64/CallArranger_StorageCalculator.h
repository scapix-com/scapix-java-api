...
namespace scapix::java_api { namespace jdk::internal::foreign::abi::ppc64 { class CallArranger_StorageCalculator; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::ppc64::CallArranger_StorageCalculator> new_object(jni::ref<jdk::internal::foreign::abi::ppc64::CallArranger> this_0, jboolean forArguments) { return object_base::new_object(this_0, forArguments); }
