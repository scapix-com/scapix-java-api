...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class Binding_Builder; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_Builder> new_object() { return object_base::new_object(); }
	...
	jni::ref<jdk::internal::foreign::abi::Binding_Builder> bufferStore(jlong offset, jni::ref<java::lang::Class> type) { return call_method<"bufferStore", jni::ref<jdk::internal::foreign::abi::Binding_Builder>>(offset, type); }
	jni::ref<jdk::internal::foreign::abi::Binding_Builder> bufferStore(jlong offset, jni::ref<java::lang::Class> type, jint byteWidth) { return call_method<"bufferStore", jni::ref<jdk::internal::foreign::abi::Binding_Builder>>(offset, type, byteWidth); }
	jni::ref<jdk::internal::foreign::abi::Binding_Builder> bufferLoad(jlong offset, jni::ref<java::lang::Class> type) { return call_method<"bufferLoad", jni::ref<jdk::internal::foreign::abi::Binding_Builder>>(offset, type); }
	jni::ref<jdk::internal::foreign::abi::Binding_Builder> bufferLoad(jlong offset, jni::ref<java::lang::Class> type, jint byteWidth) { return call_method<"bufferLoad", jni::ref<jdk::internal::foreign::abi::Binding_Builder>>(offset, type, byteWidth); }
	...
	jni::ref<jdk::internal::foreign::abi::Binding_Builder> boxAddressRaw(jlong size, jlong align) { return call_method<"boxAddressRaw", jni::ref<jdk::internal::foreign::abi::Binding_Builder>>(size, align); }
