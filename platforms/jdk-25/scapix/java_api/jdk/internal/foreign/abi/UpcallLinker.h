...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class UpcallLinker; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::UpcallLinker> new_object() { return object_base::new_object(); }
