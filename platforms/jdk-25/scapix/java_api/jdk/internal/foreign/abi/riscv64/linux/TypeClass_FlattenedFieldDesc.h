...
namespace scapix::java_api { namespace jdk::internal::foreign::abi::riscv64::linux { class TypeClass_FlattenedFieldDesc; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::riscv64::linux::TypeClass_FlattenedFieldDesc> new_object(jni::ref<jdk::internal::foreign::abi::riscv64::linux::TypeClass> typeClass, jlong offset, jni::ref<java::lang::foreign::ValueLayout> layout) { return object_base::new_object(typeClass, offset, layout); }
