...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class CallingSequence; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::CallingSequence> new_object(jboolean forUpcall, jni::ref<java::lang::invoke::MethodType> callerMethodType, jni::ref<java::lang::invoke::MethodType> calleeMethodType, jni::ref<java::lang::foreign::FunctionDescriptor> desc, jboolean needsReturnBuffer, jlong returnBufferSize, jlong allocationSize, jni::ref<java::util::List> argumentBindings, jni::ref<java::util::List> returnBindings, jni::ref<jdk::internal::foreign::abi::LinkerOptions> linkerOptions) { return object_base::new_object(forUpcall, callerMethodType, calleeMethodType, desc, needsReturnBuffer, returnBufferSize, allocationSize, argumentBindings, returnBindings, linkerOptions); }
	...
	jboolean usingAddressPairs() { return call_method<"usingAddressPairs", jboolean>(); }
