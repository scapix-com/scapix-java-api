...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class DowncallLinker; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::DowncallLinker> new_object(jni::ref<jdk::internal::foreign::abi::ABIDescriptor> abi, jni::ref<jdk::internal::foreign::abi::CallingSequence> callingSequence) { return object_base::new_object(abi, callingSequence); }
