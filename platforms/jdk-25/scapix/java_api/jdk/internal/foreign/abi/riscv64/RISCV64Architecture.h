...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_RISCV64_RISCV64ARCHITECTURE_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_RISCV64_RISCV64ARCHITECTURE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::foreign::abi::riscv64 { class RISCV64Architecture; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::foreign::abi::riscv64::RISCV64Architecture>
{
	static constexpr fixed_string class_name = "jdk/internal/foreign/abi/riscv64/RISCV64Architecture";
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_RISCV64_RISCV64ARCHITECTURE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_RISCV64_RISCV64ARCHITECTURE)
#define SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_RISCV64_RISCV64ARCHITECTURE
...
#include <scapix/java_api/jdk/internal/foreign/abi/riscv64/RISCV64Architecture_StorageType.h>
#include <scapix/java_api/jdk/internal/foreign/abi/riscv64/RISCV64Architecture_Regs.h>
...
class jdk::internal::foreign::abi::riscv64::RISCV64Architecture : public jni::object_base<"jdk/internal/foreign/abi/riscv64/RISCV64Architecture",
	java::lang::Object,
	jdk::internal::foreign::abi::Architecture>
{
public:

	using StorageType = RISCV64Architecture_StorageType;
	using Regs = RISCV64Architecture_Regs;
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_RISCV64_RISCV64ARCHITECTURE
