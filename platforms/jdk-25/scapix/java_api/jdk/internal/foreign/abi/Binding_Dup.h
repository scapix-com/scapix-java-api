...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class Binding_Dup; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_Dup> new_object() { return object_base::new_object(); }
