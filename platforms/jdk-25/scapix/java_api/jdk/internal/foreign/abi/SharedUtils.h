...
public:
	...
	static jlong remainsToAlignment(jlong addr, jlong alignment) { return call_static_method<"remainsToAlignment", jlong>(addr, alignment); }
	...
	static jint unboxSegment32(jni::ref<java::lang::foreign::MemorySegment> segment) { return call_static_method<"unboxSegment32", jint>(segment); }
