...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class Binding_SegmentOffset; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::Binding_SegmentOffset> new_object(jboolean allowHeap) { return object_base::new_object(allowHeap); }
