...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_S390_S390ARCHITECTURE_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_S390_S390ARCHITECTURE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::foreign::abi::s390 { class S390Architecture; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::foreign::abi::s390::S390Architecture>
{
	static constexpr fixed_string class_name = "jdk/internal/foreign/abi/s390/S390Architecture";
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_S390_S390ARCHITECTURE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_S390_S390ARCHITECTURE)
#define SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_S390_S390ARCHITECTURE
...
#include <scapix/java_api/jdk/internal/foreign/abi/s390/S390Architecture_StorageType.h>
#include <scapix/java_api/jdk/internal/foreign/abi/s390/S390Architecture_Regs.h>
...
class jdk::internal::foreign::abi::s390::S390Architecture : public jni::object_base<"jdk/internal/foreign/abi/s390/S390Architecture",
	java::lang::Object,
	jdk::internal::foreign::abi::Architecture>
{
public:

	using StorageType = S390Architecture_StorageType;
	using Regs = S390Architecture_Regs;
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_FOREIGN_ABI_S390_S390ARCHITECTURE
