...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class AbstractLinker; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::AbstractLinker> new_object() { return object_base::new_object(); }
