...
namespace scapix::java_api { namespace jdk::internal::foreign::abi::x64::windows { class CallArranger_StorageCalculator; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::x64::windows::CallArranger_StorageCalculator> new_object(jboolean forArguments) { return object_base::new_object(forArguments); }
