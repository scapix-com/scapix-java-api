...
namespace scapix::java_api { namespace jdk::internal::foreign::abi::s390::linux { class LinuxS390CallArranger; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::s390::linux::LinuxS390CallArranger> new_object() { return object_base::new_object(); }
