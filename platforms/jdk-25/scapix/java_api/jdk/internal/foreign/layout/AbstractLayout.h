...
namespace scapix::java_api { namespace jdk::internal::foreign::layout { class AbstractLayout; }}
...
public:
	...
	jlong scale(jlong offset, jlong index) { return call_method<"scale", jlong>(offset, index); }
	...
	jni::ref<java::lang::invoke::VarHandle> varHandleInternal(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"varHandleInternal", jni::ref<java::lang::invoke::VarHandle>>(elements); }
	jni::ref<java::lang::invoke::VarHandle> arrayElementVarHandle(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"arrayElementVarHandle", jni::ref<java::lang::invoke::VarHandle>>(elements); }
