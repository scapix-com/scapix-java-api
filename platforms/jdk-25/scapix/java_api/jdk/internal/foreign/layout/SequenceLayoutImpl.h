...
namespace scapix::java_api { namespace jdk::internal::foreign::layout { class SequenceLayoutImpl; }}
...
public:
	...
	static jni::ref<java::lang::foreign::SequenceLayout> of(jlong elementCount, jni::ref<java::lang::foreign::MemoryLayout> elementLayout) { return call_static_method<"of", jni::ref<java::lang::foreign::SequenceLayout>>(elementCount, elementLayout); }
