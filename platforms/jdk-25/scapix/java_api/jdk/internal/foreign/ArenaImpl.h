...
namespace scapix::java_api { namespace jdk::internal::foreign { class ArenaImpl; }}
...
public:
	...
	jni::ref<jdk::internal::foreign::NativeMemorySegmentImpl> allocateNoInit(jlong byteSize, jlong byteAlignment) { return call_method<"allocateNoInit", jni::ref<jdk::internal::foreign::NativeMemorySegmentImpl>>(byteSize, byteAlignment); }
	jni::ref<jdk::internal::foreign::NativeMemorySegmentImpl> allocate(jlong byteSize, jlong byteAlignment) { return call_method<"allocate", jni::ref<jdk::internal::foreign::NativeMemorySegmentImpl>>(byteSize, byteAlignment); }
