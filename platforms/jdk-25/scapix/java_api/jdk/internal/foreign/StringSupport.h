...
namespace scapix::java_api { namespace jdk::internal::foreign { class StringSupport; }}
...
public:
	...
	static jni::ref<java::lang::String> read(jni::ref<jdk::internal::foreign::AbstractMemorySegmentImpl> segment, jlong offset, jni::ref<java::nio::charset::Charset> charset) { return call_static_method<"read", jni::ref<java::lang::String>>(segment, offset, charset); }
	static void write(jni::ref<jdk::internal::foreign::AbstractMemorySegmentImpl> segment, jlong offset, jni::ref<java::nio::charset::Charset> charset, jni::ref<java::lang::String> string) { return call_static_method<"write", void>(segment, offset, charset, string); }
	static jint strlenByte(jni::ref<jdk::internal::foreign::AbstractMemorySegmentImpl> segment, jlong fromOffset, jlong toOffset) { return call_static_method<"strlenByte", jint>(segment, fromOffset, toOffset); }
	static jint strlenShort(jni::ref<jdk::internal::foreign::AbstractMemorySegmentImpl> segment, jlong fromOffset, jlong toOffset) { return call_static_method<"strlenShort", jint>(segment, fromOffset, toOffset); }
	static jint strlenInt(jni::ref<jdk::internal::foreign::AbstractMemorySegmentImpl> segment, jlong fromOffset, jlong toOffset) { return call_static_method<"strlenInt", jint>(segment, fromOffset, toOffset); }
