...
namespace scapix::java_api { namespace jdk::internal::foreign { class Utils_BaseAndScale; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::Utils_BaseAndScale> new_object(jlong base, jlong scale) { return object_base::new_object(base, scale); }
	...
	jlong base() { return call_method<"base", jlong>(); }
