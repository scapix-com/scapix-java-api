...
namespace scapix::java_api { namespace jdk::internal::foreign { class MemorySessionImpl; }}
...
#include <scapix/java_api/jdk/internal/foreign/ArenaImpl.h>
...
public:
	...
	static jni::ref<jdk::internal::foreign::MemorySessionImpl> GLOBAL_SESSION() { return get_static_field<"GLOBAL_SESSION", jni::ref<jdk::internal::foreign::MemorySessionImpl>>(); }

	jni::ref<jdk::internal::foreign::ArenaImpl> asArena() { return call_method<"asArena", jni::ref<jdk::internal::foreign::ArenaImpl>>(); }
	...
	static jni::ref<jdk::internal::foreign::MemorySessionImpl> createHeap(jni::ref<java::lang::Object> ref) { return call_static_method<"createHeap", jni::ref<jdk::internal::foreign::MemorySessionImpl>>(ref); }
