...
public:
	...
	static jni::ref<jdk::internal::loader::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::net::URLStreamHandlerFactory> factory) { return object_base::new_object(urls, factory); }
	static jni::ref<jdk::internal::loader::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> urls) { return object_base::new_object(urls); }
