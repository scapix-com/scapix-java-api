...
namespace scapix::java_api { namespace jdk::internal::loader { class Loader; }}
...
public:
	...
	static jni::ref<jdk::internal::loader::Loader> new_object(jni::ref<java::lang::module::ResolvedModule> resolvedModule, jni::ref<jdk::internal::loader::LoaderPool> pool, jni::ref<java::lang::ClassLoader> parent) { return object_base::new_object(resolvedModule, pool, parent); }
	static jni::ref<jdk::internal::loader::Loader> new_object(jni::ref<java::util::Collection> modules, jni::ref<java::lang::ClassLoader> parent) { return object_base::new_object(modules, parent); }
