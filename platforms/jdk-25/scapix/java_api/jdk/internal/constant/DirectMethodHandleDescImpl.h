...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_CONSTANT_DIRECTMETHODHANDLEDESCIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_CONSTANT_DIRECTMETHODHANDLEDESCIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::constant { class DirectMethodHandleDescImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::constant::DirectMethodHandleDescImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/constant/DirectMethodHandleDescImpl";
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_CONSTANT_DIRECTMETHODHANDLEDESCIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_CONSTANT_DIRECTMETHODHANDLEDESCIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_CONSTANT_DIRECTMETHODHANDLEDESCIMPL
...
class jdk::internal::constant::DirectMethodHandleDescImpl : public jni::object_base<"jdk/internal/constant/DirectMethodHandleDescImpl",
	java::lang::Object,
	java::lang::constant::DirectMethodHandleDesc>
{
public:

	static jni::ref<jdk::internal::constant::DirectMethodHandleDescImpl> new_object(jni::ref<java::lang::constant::DirectMethodHandleDesc_Kind> kind, jni::ref<java::lang::constant::ClassDesc> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::constant::MethodTypeDesc> type) { return object_base::new_object(kind, owner, name, type); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_CONSTANT_DIRECTMETHODHANDLEDESCIMPL
