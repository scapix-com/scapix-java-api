...
namespace scapix::java_api { namespace jdk::internal::org::xml::sax::helpers { class DefaultHandler; }}
...
public:
	...
	static jni::ref<jdk::internal::org::xml::sax::helpers::DefaultHandler> new_object() { return object_base::new_object(); }
