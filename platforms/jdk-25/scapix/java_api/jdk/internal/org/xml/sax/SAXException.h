...
namespace scapix::java_api { namespace jdk::internal::org::xml::sax { class SAXException; }}
...
public:
	...
	static jni::ref<jdk::internal::org::xml::sax::SAXException> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::org::xml::sax::SAXException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
	static jni::ref<jdk::internal::org::xml::sax::SAXException> new_object(jni::ref<java::lang::Exception> e) { return object_base::new_object(e); }
	static jni::ref<jdk::internal::org::xml::sax::SAXException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Exception> e) { return object_base::new_object(message, e); }
