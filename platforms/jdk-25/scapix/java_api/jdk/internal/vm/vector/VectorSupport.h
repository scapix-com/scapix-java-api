...
#include <scapix/java_api/jdk/internal/vm/vector/VectorSupport_SelectFromTwoVector.h>
...
#include <scapix/java_api/jdk/internal/vm/vector/VectorSupport_VectorSelectFromOp.h>
...
public:
	...
	using SelectFromTwoVector = VectorSupport_SelectFromTwoVector;
	...
	using VectorSelectFromOp = VectorSupport_VectorSelectFromOp;
	...
	static jint VECTOR_OP_MATHLIB_FIRST() { return get_static_field<"VECTOR_OP_MATHLIB_FIRST", jint>(); }
	static jint VECTOR_OP_MATHLIB_LAST() { return get_static_field<"VECTOR_OP_MATHLIB_LAST", jint>(); }
	static jint VECTOR_OP_SADD() { return get_static_field<"VECTOR_OP_SADD", jint>(); }
	static jint VECTOR_OP_SSUB() { return get_static_field<"VECTOR_OP_SSUB", jint>(); }
	static jint VECTOR_OP_SUADD() { return get_static_field<"VECTOR_OP_SUADD", jint>(); }
	static jint VECTOR_OP_SUSUB() { return get_static_field<"VECTOR_OP_SUSUB", jint>(); }
	static jint VECTOR_OP_UMIN() { return get_static_field<"VECTOR_OP_UMIN", jint>(); }
	static jint VECTOR_OP_UMAX() { return get_static_field<"VECTOR_OP_UMAX", jint>(); }
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> fromBitsCoerced(jni::ref<java::lang::Class> vmClass, jni::ref<java::lang::Class> eClass, jint length, jlong bits, jint mode, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> s, jni::ref<jdk::internal::vm::vector::VectorSupport_FromBitsCoercedOperation> defaultImpl) { return call_static_method<"fromBitsCoerced", jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload>>(vmClass, eClass, length, bits, mode, s, defaultImpl); }
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> indexPartiallyInUpperRange(jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jlong offset, jlong limit, jni::ref<jdk::internal::vm::vector::VectorSupport_IndexPartiallyInUpperRangeOperation> defaultImpl) { return call_static_method<"indexPartiallyInUpperRange", jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask>>(mClass, eClass, length, offset, limit, defaultImpl); }
	...
	static jlong extract(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> vm, jint i, jni::ref<jdk::internal::vm::vector::VectorSupport_VecExtractOp> defaultImpl) { return call_static_method<"extract", jlong>(vClass, eClass, length, vm, i, defaultImpl); }
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> insert(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v, jint i, jlong val, jni::ref<jdk::internal::vm::vector::VectorSupport_VecInsertOp> defaultImpl) { return call_static_method<"insert", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(vClass, eClass, length, v, i, val, defaultImpl); }
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> libraryUnaryOp(jlong addr, jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::String> debugName, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v, jni::ref<jdk::internal::vm::vector::VectorSupport_UnaryOperation> defaultImpl) { return call_static_method<"libraryUnaryOp", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(addr, vClass, eClass, length, debugName, v, defaultImpl); }
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> libraryBinaryOp(jlong addr, jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::String> debugName, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> v1, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> v2, jni::ref<jdk::internal::vm::vector::VectorSupport_BinaryOperation> defaultImpl) { return call_static_method<"libraryBinaryOp", jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload>>(addr, vClass, eClass, length, debugName, v1, v2, defaultImpl); }
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> selectFromTwoVectorOp(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v1, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v2, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v3, jni::ref<jdk::internal::vm::vector::VectorSupport_SelectFromTwoVector> defaultImpl) { return call_static_method<"selectFromTwoVectorOp", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(vClass, eClass, length, v1, v2, v3, defaultImpl); }
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> load(jni::ref<java::lang::Class> vmClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean fromSegment, jni::ref<java::lang::Object> container, jlong index, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> s, jni::ref<jdk::internal::vm::vector::VectorSupport_LoadOperation> defaultImpl) { return call_static_method<"load", jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload>>(vmClass, eClass, length, base, offset, fromSegment, container, index, s, defaultImpl); }
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> loadMasked(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean fromSegment, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> m, jint offsetInRange, jni::ref<java::lang::Object> container, jlong index, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> s, jni::ref<jdk::internal::vm::vector::VectorSupport_LoadVectorMaskedOperation> defaultImpl) { return call_static_method<"loadMasked", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(vClass, mClass, eClass, length, base, offset, fromSegment, m, offsetInRange, container, index, s, defaultImpl); }
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> loadWithMap(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Class> vectorIndexClass, jni::ref<java::lang::Object> base, jlong offset, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> index_vector, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> m, jni::ref<java::lang::Object> container, jint index, jni::ref<jni::array<jint>> indexMap, jint indexM, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> s, jni::ref<jdk::internal::vm::vector::VectorSupport_LoadVectorOperationWithMap> defaultImpl) { return call_static_method<"loadWithMap", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(vClass, mClass, eClass, length, vectorIndexClass, base, offset, index_vector, m, container, index, indexMap, indexM, s, defaultImpl); }
	static void store(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean fromSegment, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorPayload> v, jni::ref<java::lang::Object> container, jlong index, jni::ref<jdk::internal::vm::vector::VectorSupport_StoreVectorOperation> defaultImpl) { return call_static_method<"store", void>(vClass, eClass, length, base, offset, fromSegment, v, container, index, defaultImpl); }
	static void storeMasked(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Object> base, jlong offset, jboolean fromSegment, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> m, jni::ref<java::lang::Object> container, jlong index, jni::ref<jdk::internal::vm::vector::VectorSupport_StoreVectorMaskedOperation> defaultImpl) { return call_static_method<"storeMasked", void>(vClass, mClass, eClass, length, base, offset, fromSegment, v, m, container, index, defaultImpl); }
	static void storeWithMap(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<java::lang::Class> vectorIndexClass, jni::ref<java::lang::Object> base, jlong offset, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> index_vector, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> m, jni::ref<java::lang::Object> container, jint index, jni::ref<jni::array<jint>> indexMap, jint indexM, jni::ref<jdk::internal::vm::vector::VectorSupport_StoreVectorOperationWithMap> defaultImpl) { return call_static_method<"storeWithMap", void>(vClass, mClass, eClass, length, vectorIndexClass, base, offset, index_vector, v, m, container, index, indexMap, indexM, defaultImpl); }
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> selectFromOp(jni::ref<java::lang::Class> vClass, jni::ref<java::lang::Class> mClass, jni::ref<java::lang::Class> eClass, jint length, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v1, jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> v2, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> m, jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSelectFromOp> defaultImpl) { return call_static_method<"selectFromOp", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(vClass, mClass, eClass, length, v1, v2, m, defaultImpl); }
	...
	static jni::ref<java::lang::String> getCPUFeatures() { return call_static_method<"getCPUFeatures", jni::ref<java::lang::String>>(); }
	static jint getMaxLaneCount(jni::ref<java::lang::Class> p1) { return call_static_method<"getMaxLaneCount", jint>(p1); }
	static void loadNativeLibrary(jni::ref<java::lang::String> name) { return call_static_method<"loadNativeLibrary", void>(name); }
