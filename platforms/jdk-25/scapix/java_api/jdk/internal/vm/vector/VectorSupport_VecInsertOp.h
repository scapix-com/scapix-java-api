...
namespace scapix::java_api { namespace jdk::internal::vm::vector { class VectorSupport_VecInsertOp; }}
...
public:
	...
	jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> apply(jni::ref<jdk::internal::vm::vector::VectorSupport_Vector> p1, jint p2, jlong p3) { return call_method<"apply", jni::ref<jdk::internal::vm::vector::VectorSupport_Vector>>(p1, p2, p3); }
