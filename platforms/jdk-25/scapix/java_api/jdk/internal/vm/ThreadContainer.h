...
namespace scapix::java_api { namespace jdk::internal::vm { class ThreadContainer; }}
...
public:
	...
	void add(jni::ref<java::lang::Thread> thread) { return call_method<"add", void>(thread); }
	void remove(jni::ref<java::lang::Thread> thread) { return call_method<"remove", void>(thread); }
