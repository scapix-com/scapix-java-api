...
public:
	...
	static void decodeAndThrowThrowable(jint format, jlong buffer, jboolean inJVMHeap, jboolean debug) { return call_static_method<"decodeAndThrowThrowable", void>(format, buffer, inJVMHeap, debug); }
