...
namespace scapix::java_api { namespace jdk::internal::vm { class StackChunk; }}
...
public:
	...
	static jni::ref<jdk::internal::vm::StackChunk> new_object() { return object_base::new_object(); }
