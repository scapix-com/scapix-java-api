...
namespace scapix::java_api { namespace jdk::internal::vm { class Continuation; }}
...
public:
	...
	static jni::ref<jdk::internal::vm::Continuation> new_object(jni::ref<jdk::internal::vm::ContinuationScope> scope, jni::ref<java::lang::Runnable> target) { return object_base::new_object(scope, target); }
