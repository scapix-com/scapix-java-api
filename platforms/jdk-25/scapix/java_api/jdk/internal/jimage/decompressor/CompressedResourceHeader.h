...
public:
	...
	static jni::ref<jdk::internal::jimage::decompressor::CompressedResourceHeader> new_object(jlong compressedSize, jlong uncompressedSize, jint decompressorNameOffset, jboolean isTerminal) { return object_base::new_object(compressedSize, uncompressedSize, decompressorNameOffset, isTerminal); }
