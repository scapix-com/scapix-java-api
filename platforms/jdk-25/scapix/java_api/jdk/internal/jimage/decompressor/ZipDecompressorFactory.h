...
namespace scapix::java_api { namespace jdk::internal::jimage::decompressor { class ZipDecompressorFactory; }}
...
public:
	...
	static jni::ref<jdk::internal::jimage::decompressor::ZipDecompressorFactory> new_object() { return object_base::new_object(); }
