...
namespace scapix::java_api { namespace jdk::internal::jimage { class ImageHeader; }}
...
public:
	...
	static jni::ref<jdk::internal::jimage::ImageHeader> new_object(jint resourceCount, jint tableCount, jint locationsSize, jint stringsSize) { return object_base::new_object(resourceCount, tableCount, locationsSize, stringsSize); }
	static jni::ref<jdk::internal::jimage::ImageHeader> new_object(jint magic, jint majorVersion, jint minorVersion, jint flags, jint resourceCount, jint tableLength, jint locationsSize, jint stringsSize) { return object_base::new_object(magic, majorVersion, minorVersion, flags, resourceCount, tableLength, locationsSize, stringsSize); }
