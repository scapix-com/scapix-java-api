...
namespace scapix::java_api { namespace jdk::internal::jimage { class ImageLocation; }}
...
public:
	...
	static jni::ref<jdk::internal::jimage::ImageLocation> new_object(jni::ref<jni::array<jlong>> attributes, jni::ref<jdk::internal::jimage::ImageStrings> strings) { return object_base::new_object(attributes, strings); }
