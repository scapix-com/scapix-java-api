...
namespace scapix::java_api { namespace jdk::internal::misc { class ThreadTracker; }}
...
public:
	...
	static jni::ref<jdk::internal::misc::ThreadTracker> new_object() { return object_base::new_object(); }
