...
namespace scapix::java_api { namespace jdk::internal::misc { class InnocuousThread; }}
...
public:
	...
	static jni::ref<java::lang::Thread> newThread(jni::ref<java::lang::String> name, jni::ref<java::lang::Runnable> target, jint priority) { return call_static_method<"newThread", jni::ref<java::lang::Thread>>(name, target, priority); }
	...
	static jni::ref<java::lang::Thread> newSystemThread(jni::ref<java::lang::String> name, jni::ref<java::lang::Runnable> target, jint priority) { return call_static_method<"newSystemThread", jni::ref<java::lang::Thread>>(name, target, priority); }
	static jni::ref<java::lang::Thread> newSystemThread(jni::ref<java::lang::String> name, jni::ref<java::lang::Runnable> target, jlong stackSize, jint priority) { return call_static_method<"newSystemThread", jni::ref<java::lang::Thread>>(name, target, stackSize, priority); }
