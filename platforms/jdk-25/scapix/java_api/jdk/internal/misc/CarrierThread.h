...
namespace scapix::java_api { namespace jdk::internal::misc { class CarrierThread; }}
...
public:
	...
	static jni::ref<jdk::internal::misc::CarrierThread> new_object(jni::ref<java::util::concurrent::ForkJoinPool> pool) { return object_base::new_object(pool); }
	jboolean beginBlocking() { return call_method<"beginBlocking", jboolean>(); }
	void endBlocking() { return call_method<"endBlocking", void>(); }
