...
#include <scapix/java_api/jdk/internal/access/JavaxSecurityAccess.h>
...
public:
	...
	static jni::ref<jdk::internal::access::JavaObjectStreamReflectionAccess> getJavaObjectStreamReflectionAccess() { return call_static_method<"getJavaObjectStreamReflectionAccess", jni::ref<jdk::internal::access::JavaObjectStreamReflectionAccess>>(); }
	static void setJavaObjectStreamReflectionAccess(jni::ref<jdk::internal::access::JavaObjectStreamReflectionAccess> access) { return call_static_method<"setJavaObjectStreamReflectionAccess", void>(access); }
	...
	static void setJavaxSecurityAccess(jni::ref<jdk::internal::access::JavaxSecurityAccess> jsa) { return call_static_method<"setJavaxSecurityAccess", void>(jsa); }
	static jni::ref<jdk::internal::access::JavaxSecurityAccess> getJavaxSecurityAccess() { return call_static_method<"getJavaxSecurityAccess", jni::ref<jdk::internal::access::JavaxSecurityAccess>>(); }
