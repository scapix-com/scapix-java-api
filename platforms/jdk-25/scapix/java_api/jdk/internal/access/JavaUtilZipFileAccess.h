...
public:
	...
	jni::ref<java::util::BitSet> getMetaInfVersions(jni::ref<java::util::jar::JarFile> p1, jni::ref<java::lang::String> p2) { return call_method<"getMetaInfVersions", jni::ref<java::util::BitSet>>(p1, p2); }
	...
	void setExternalFileAttributes(jni::ref<java::util::zip::ZipEntry> p1, jint p2) { return call_method<"setExternalFileAttributes", void>(p1, p2); }
	jint getExternalFileAttributes(jni::ref<java::util::zip::ZipEntry> p1) { return call_method<"getExternalFileAttributes", jint>(p1); }
