...
namespace scapix::java_api { namespace jdk::internal::access { class JavaLangAccess; }}
...
#include <scapix/java_api/jdk/internal/loader/NativeLibraries.h>
...
public:
	...
	jint classFileVersion(jni::ref<java::lang::Class> p1) { return call_method<"classFileVersion", jint>(p1); }
	...
	jboolean addEnableNativeAccess(jni::ref<java::lang::ModuleLayer> p1, jni::ref<java::lang::String> p2) { return call_method<"addEnableNativeAccess", jboolean>(p1, p2); }
	void addEnableNativeAccessToAllUnnamed() { return call_method<"addEnableNativeAccessToAllUnnamed", void>(); }
	void ensureNativeAccess(jni::ref<java::lang::Module> p1, jni::ref<java::lang::Class> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::Class> p4, jboolean p5) { return call_method<"ensureNativeAccess", void>(p1, p2, p3, p4, p5); }
	...
	jint uncheckedCountPositives(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return call_method<"uncheckedCountPositives", jint>(p1, p2, p3); }
	jint countNonZeroAscii(jni::ref<java::lang::String> p1) { return call_method<"countNonZeroAscii", jint>(p1); }
	jni::ref<java::lang::String> uncheckedNewStringNoRepl(jni::ref<jni::array<jbyte>> p1, jni::ref<java::nio::charset::Charset> p2) { return call_method<"uncheckedNewStringNoRepl", jni::ref<java::lang::String>>(p1, p2); }
	jni::ref<jni::array<jbyte>> uncheckedGetBytesNoRepl(jni::ref<java::lang::String> p1, jni::ref<java::nio::charset::Charset> p2) { return call_method<"uncheckedGetBytesNoRepl", jni::ref<jni::array<jbyte>>>(p1, p2); }
	...
	jchar uncheckedGetUTF16Char(jni::ref<jni::array<jbyte>> p1, jint p2) { return call_method<"uncheckedGetUTF16Char", jchar>(p1, p2); }
	void uncheckedPutCharUTF16(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return call_method<"uncheckedPutCharUTF16", void>(p1, p2, p3); }
	...
	void uncheckedInflateBytesToChars(jni::ref<jni::array<jbyte>> p1, jint p2, jni::ref<jni::array<jchar>> p3, jint p4, jint p5) { return call_method<"uncheckedInflateBytesToChars", void>(p1, p2, p3, p4, p5); }
	jint uncheckedDecodeASCII(jni::ref<jni::array<jbyte>> p1, jint p2, jni::ref<jni::array<jchar>> p3, jint p4, jint p5) { return call_method<"uncheckedDecodeASCII", jint>(p1, p2, p3, p4, p5); }
	jni::ref<java::io::InputStream> initialSystemIn() { return call_method<"initialSystemIn", jni::ref<java::io::InputStream>>(); }
	jni::ref<java::io::PrintStream> initialSystemErr() { return call_method<"initialSystemErr", jni::ref<java::io::PrintStream>>(); }
	jint uncheckedEncodeASCII(jni::ref<jni::array<jchar>> p1, jint p2, jni::ref<jni::array<jbyte>> p3, jint p4, jint p5) { return call_method<"uncheckedEncodeASCII", jint>(p1, p2, p3, p4, p5); }
	...
	jlong stringConcatMix(jlong p1, jchar p2) { return call_method<"stringConcatMix", jlong>(p1, p2); }
	jni::ref<java::lang::Object> uncheckedStringConcat1(jni::ref<jni::array<java::lang::String>> p1) { return call_method<"uncheckedStringConcat1", jni::ref<java::lang::Object>>(p1); }
	jbyte stringInitCoder() { return call_method<"stringInitCoder", jbyte>(); }
	jbyte stringCoder(jni::ref<java::lang::String> p1) { return call_method<"stringCoder", jbyte>(p1); }
	...
	jni::ref<java::lang::String> concat(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::String> p3) { return call_method<"concat", jni::ref<java::lang::String>>(p1, p2, p3); }
	jni::ref<java::lang::Object> classData(jni::ref<java::lang::Class> p1) { return call_method<"classData", jni::ref<java::lang::Object>>(p1); }
	jni::ref<jdk::internal::loader::NativeLibraries> nativeLibrariesFor(jni::ref<java::lang::ClassLoader> p1) { return call_method<"nativeLibrariesFor", jni::ref<jdk::internal::loader::NativeLibraries>>(p1); }
	...
	jni::ref<java::util::concurrent::Executor> virtualThreadDefaultScheduler() { return call_method<"virtualThreadDefaultScheduler", jni::ref<java::util::concurrent::Executor>>(); }
