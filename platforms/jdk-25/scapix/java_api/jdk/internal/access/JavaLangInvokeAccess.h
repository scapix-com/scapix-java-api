...
namespace scapix::java_api { namespace jdk::internal::access { class JavaLangInvokeAccess; }}
...
public:
	...
	jni::ref<java::lang::invoke::VarHandle> memorySegmentViewHandle(jni::ref<java::lang::Class> p1, jni::ref<java::lang::foreign::MemoryLayout> p2, jlong p3, jni::ref<java::nio::ByteOrder> p4, jboolean p5, jlong p6) { return call_method<"memorySegmentViewHandle", jni::ref<java::lang::invoke::VarHandle>>(p1, p2, p3, p4, p5, p6); }
