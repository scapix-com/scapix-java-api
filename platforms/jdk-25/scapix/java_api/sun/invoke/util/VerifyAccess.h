...
public:
	...
	static jboolean ensureTypeVisible(jni::ref<java::lang::Class> type, jni::ref<java::lang::Class> refc) { return call_static_method<"ensureTypeVisible", jboolean>(type, refc); }
	static jboolean ensureTypeVisible(jni::ref<java::lang::invoke::MethodType> type, jni::ref<java::lang::Class> refc) { return call_static_method<"ensureTypeVisible", jboolean>(type, refc); }
