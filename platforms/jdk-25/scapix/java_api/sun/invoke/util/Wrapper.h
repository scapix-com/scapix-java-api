...
namespace scapix::java_api { namespace sun::invoke::util { class Wrapper; }}
...
#include <scapix/java_api/sun/invoke/util/Wrapper_NumericClasses.h>
...
public:
	...
	using NumericClasses = Wrapper_NumericClasses;
	...
	jni::ref<java::lang::constant::ClassDesc> basicClassDescriptor() { return call_method<"basicClassDescriptor", jni::ref<java::lang::constant::ClassDesc>>(); }
	jni::ref<java::lang::constant::ClassDesc> wrapperClassDescriptor() { return call_method<"wrapperClassDescriptor", jni::ref<java::lang::constant::ClassDesc>>(); }
	...
	static jboolean isWrapperNumericOrBooleanType(jni::ref<java::lang::Class> type) { return call_static_method<"isWrapperNumericOrBooleanType", jboolean>(type); }
	...
	jboolean isStrictSubRangeOf(jni::ref<sun::invoke::util::Wrapper> target) { return call_method<"isStrictSubRangeOf", jboolean>(target); }
