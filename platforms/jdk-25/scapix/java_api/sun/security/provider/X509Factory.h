...
public:
	...
	static jni::ref<sun::security::x509::X509CertImpl> cachedGetX509Cert(jni::ref<jni::array<jbyte>> encoding) { return call_static_method<"cachedGetX509Cert", jni::ref<sun::security::x509::X509CertImpl>>(encoding); }
