...
namespace scapix::java_api { namespace sun::security::provider { class DSA_SHA224withDSAinP1363Format; }}
...
public:
	...
	static jni::ref<sun::security::provider::DSA_SHA224withDSAinP1363Format> new_object() { return object_base::new_object(); }
