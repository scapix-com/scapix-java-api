...
namespace scapix::java_api { namespace sun::security::provider::certpath { class X509CertPath; }}
...
public:
	...
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::util::List> certs) { return object_base::new_object(certs); }
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::io::InputStream> is, jni::ref<java::lang::String> encoding) { return object_base::new_object(is, encoding); }
