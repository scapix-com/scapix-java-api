...
namespace scapix::java_api { namespace sun::security::provider::certpath { class AdjacencyList; }}
...
public:
	...
	static jni::ref<sun::security::provider::certpath::AdjacencyList> new_object(jni::ref<java::util::List> list) { return object_base::new_object(list); }
