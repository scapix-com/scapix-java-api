...
namespace scapix::java_api { namespace sun::security::provider::certpath { class PKIXExtendedParameters; }}
...
public:
	...
	static jni::ref<sun::security::provider::certpath::PKIXExtendedParameters> new_object(jni::ref<java::security::cert::PKIXBuilderParameters> params, jni::ref<java::security::Timestamp> timestamp, jni::ref<java::lang::String> variant) { return object_base::new_object(params, timestamp, variant); }
