...
namespace scapix::java_api { namespace sun::security::provider { class JavaKeyStore_JKS; }}
...
public:
	...
	static jni::ref<sun::security::provider::JavaKeyStore_JKS> new_object() { return object_base::new_object(); }
