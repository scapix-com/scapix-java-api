...
namespace scapix::java_api { namespace sun::security::provider { class KeyProtector; }}
...
public:
	...
	static jni::ref<sun::security::provider::KeyProtector> new_object(jni::ref<jni::array<jbyte>> passwordBytes) { return object_base::new_object(passwordBytes); }
	jni::ref<jni::array<jbyte>> protect(jni::ref<java::security::Key> key) { return call_method<"protect", jni::ref<jni::array<jbyte>>>(key); }
	jni::ref<java::security::Key> recover(jni::ref<sun::security::pkcs::EncryptedPrivateKeyInfo> encrInfo) { return call_method<"recover", jni::ref<java::security::Key>>(encrInfo); }
