...
namespace scapix::java_api { namespace sun::security::provider { class DSA_SHA512withDSA; }}
...
public:
	...
	static jni::ref<sun::security::provider::DSA_SHA512withDSA> new_object() { return object_base::new_object(); }
