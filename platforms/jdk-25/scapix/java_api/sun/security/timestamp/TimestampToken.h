...
namespace scapix::java_api { namespace sun::security::timestamp { class TimestampToken; }}
...
public:
	...
	static jni::ref<sun::security::timestamp::TimestampToken> new_object(jni::ref<jni::array<jbyte>> timestampTokenInfo) { return object_base::new_object(timestampTokenInfo); }
