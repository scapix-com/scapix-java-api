...
public:
	...
	static jni::ref<sun::security::timestamp::TSRequest> new_object(jni::ref<java::lang::String> tSAPolicyID, jni::ref<jni::array<jbyte>> toBeTimeStamped, jni::ref<java::security::MessageDigest> messageDigest) { return object_base::new_object(tSAPolicyID, toBeTimeStamped, messageDigest); }
