...
namespace scapix::java_api { namespace sun::security::x509 { class AuthorityKeyIdentifierExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::AuthorityKeyIdentifierExtension> new_object(jni::ref<sun::security::x509::KeyIdentifier> kid, jni::ref<sun::security::x509::GeneralNames> names, jni::ref<sun::security::x509::SerialNumber> sn) { return object_base::new_object(kid, names, sn); }
	static jni::ref<sun::security::x509::AuthorityKeyIdentifierExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
