...
namespace scapix::java_api { namespace sun::security::x509 { class SerialNumber; }}
...
public:
	...
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<java::math::BigInteger> num) { return object_base::new_object(num); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jint num) { return object_base::new_object(num); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
