...
namespace scapix::java_api { namespace sun::security::x509 { class Extension; }}
...
struct scapix::jni::object_traits<scapix::java_api::sun::security::x509::Extension>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::security::cert::Extension, scapix::java_api::sun::security::util::DerEncoder>;
};
...
public:
	...
	static jni::ref<sun::security::x509::Extension> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::util::DerValue> derVal) { return object_base::new_object(derVal); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::util::ObjectIdentifier> extensionId, jboolean critical, jni::ref<jni::array<jbyte>> extensionValue) { return object_base::new_object(extensionId, critical, extensionValue); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::x509::Extension> ext) { return object_base::new_object(ext); }
	static jni::ref<sun::security::x509::Extension> newExtension(jni::ref<sun::security::util::ObjectIdentifier> extensionId, jboolean critical, jni::ref<jni::array<jbyte>> rawExtensionValue) { return call_static_method<"newExtension", jni::ref<sun::security::x509::Extension>>(extensionId, critical, rawExtensionValue); }
