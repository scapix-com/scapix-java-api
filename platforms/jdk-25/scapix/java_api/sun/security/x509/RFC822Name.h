...
public:
	...
	static jni::ref<sun::security::x509::RFC822Name> new_object(jni::ref<sun::security::util::DerValue> derValue) { return object_base::new_object(derValue); }
	static jni::ref<sun::security::x509::RFC822Name> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
