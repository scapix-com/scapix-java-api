...
namespace scapix::java_api { namespace sun::security::x509 { class X509CertImpl; }}
...
public:
	...
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::x509::X509CertInfo> info, jni::ref<sun::security::x509::AlgorithmId> algId, jni::ref<jni::array<jbyte>> signature, jni::ref<jni::array<jbyte>> signedCert) { return object_base::new_object(info, algId, signature, signedCert); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<jni::array<jbyte>> certData) { return object_base::new_object(certData); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::util::DerValue> derVal) { return object_base::new_object(derVal); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
	static jni::ref<sun::security::x509::X509CertImpl> newX509CertImpl(jni::ref<jni::array<jbyte>> certData) { return call_static_method<"newX509CertImpl", jni::ref<sun::security::x509::X509CertImpl>>(certData); }
	...
	static jni::ref<sun::security::x509::X509CertImpl> newSigned(jni::ref<sun::security::x509::X509CertInfo> info, jni::ref<java::security::PrivateKey> key, jni::ref<java::lang::String> algorithm) { return call_static_method<"newSigned", jni::ref<sun::security::x509::X509CertImpl>>(info, key, algorithm); }
	static jni::ref<sun::security::x509::X509CertImpl> newSigned(jni::ref<sun::security::x509::X509CertInfo> info, jni::ref<java::security::PrivateKey> key, jni::ref<java::lang::String> algorithm, jni::ref<java::lang::String> provider) { return call_static_method<"newSigned", jni::ref<sun::security::x509::X509CertImpl>>(info, key, algorithm, provider); }
	...
	jni::ref<sun::security::x509::X509CertInfo> getInfo() { return call_method<"getInfo", jni::ref<sun::security::x509::X509CertInfo>>(); }
	...
	jni::ref<sun::security::x509::AlgorithmId> getSigAlg() { return call_method<"getSigAlg", jni::ref<sun::security::x509::AlgorithmId>>(); }
	...
	jni::ref<sun::security::x509::Extension> getUnparseableExtension(jni::ref<sun::security::util::ObjectIdentifier> oid) { return call_method<"getUnparseableExtension", jni::ref<sun::security::x509::Extension>>(oid); }
	...
	static jni::ref<java::util::List> getExtendedKeyUsage(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"getExtendedKeyUsage", jni::ref<java::util::List>>(cert); }
	...
	static jni::ref<java::util::Collection> getSubjectAlternativeNames(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"getSubjectAlternativeNames", jni::ref<java::util::Collection>>(cert); }
	...
	static jni::ref<java::util::Collection> getIssuerAlternativeNames(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"getIssuerAlternativeNames", jni::ref<java::util::Collection>>(cert); }
	...
	static jni::ref<javax::security::auth::x500::X500Principal> getSubjectX500Principal(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"getSubjectX500Principal", jni::ref<javax::security::auth::x500::X500Principal>>(cert); }
	static jni::ref<javax::security::auth::x500::X500Principal> getIssuerX500Principal(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"getIssuerX500Principal", jni::ref<javax::security::auth::x500::X500Principal>>(cert); }
	static jni::ref<jni::array<jbyte>> getEncodedInternal(jni::ref<java::security::cert::Certificate> cert) { return call_static_method<"getEncodedInternal", jni::ref<jni::array<jbyte>>>(cert); }
	static jni::ref<sun::security::x509::X509CertImpl> toImpl(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"toImpl", jni::ref<sun::security::x509::X509CertImpl>>(cert); }
	static jboolean isSelfIssued(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"isSelfIssued", jboolean>(cert); }
	static jboolean isSelfSigned(jni::ref<java::security::cert::X509Certificate> cert, jni::ref<java::lang::String> sigProvider) { return call_static_method<"isSelfSigned", jboolean>(cert, sigProvider); }
	static jni::ref<java::lang::String> getFingerprint(jni::ref<java::lang::String> algorithm, jni::ref<java::security::cert::X509Certificate> cert, jni::ref<sun::security::util::Debug> debug) { return call_static_method<"getFingerprint", jni::ref<java::lang::String>>(algorithm, cert, debug); }
