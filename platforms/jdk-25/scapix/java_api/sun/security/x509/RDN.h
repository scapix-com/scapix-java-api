...
namespace scapix::java_api { namespace sun::security::x509 { class RDN; }}
...
public:
	...
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<java::lang::String> name, jni::ref<java::util::Map> keywordMap) { return object_base::new_object(name, keywordMap); }
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<sun::security::x509::AVA> ava) { return object_base::new_object(ava); }
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<jni::array<sun::security::x509::AVA>> avas) { return object_base::new_object(avas); }
