...
namespace scapix::java_api { namespace sun::security::x509 { class X509Key; }}
...
struct scapix::jni::object_traits<scapix::java_api::sun::security::x509::X509Key>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::security::PublicKey, scapix::java_api::sun::security::util::DerEncoder>;
};
...
public:
	...
	static jni::ref<sun::security::x509::X509Key> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::X509Key> new_object(jni::ref<sun::security::x509::AlgorithmId> algid, jni::ref<sun::security::util::BitArray> key) { return object_base::new_object(algid, key); }
	jni::ref<sun::security::util::BitArray> getKey() { return call_method<"getKey", jni::ref<sun::security::util::BitArray>>(); }
	static jni::ref<java::security::PublicKey> parse(jni::ref<sun::security::util::DerValue> in) { return call_static_method<"parse", jni::ref<java::security::PublicKey>>(in); }
	...
	void decode(jni::ref<sun::security::util::DerValue> val) { return call_method<"decode", void>(val); }
