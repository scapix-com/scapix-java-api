...
public:
	...
	static jni::ref<sun::security::x509::InhibitAnyPolicyExtension> new_object(jint skipCerts) { return object_base::new_object(skipCerts); }
	static jni::ref<sun::security::x509::InhibitAnyPolicyExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
