...
namespace scapix::java_api { namespace sun::security::x509 { class KeyIdentifier; }}
...
public:
	...
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<jni::array<jbyte>> octetString) { return object_base::new_object(octetString); }
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<java::security::PublicKey> pubKey) { return object_base::new_object(pubKey); }
