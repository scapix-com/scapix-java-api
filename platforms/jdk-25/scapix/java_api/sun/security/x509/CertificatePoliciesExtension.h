...
namespace scapix::java_api { namespace sun::security::x509 { class CertificatePoliciesExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::CertificatePoliciesExtension> new_object(jni::ref<java::util::List> certPolicies) { return object_base::new_object(certPolicies); }
	static jni::ref<sun::security::x509::CertificatePoliciesExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::util::List> certPolicies) { return object_base::new_object(critical, certPolicies); }
	static jni::ref<sun::security::x509::CertificatePoliciesExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
	jni::ref<java::lang::String> toString() { return call_method<"toString", jni::ref<java::lang::String>>(); }
	void encode(jni::ref<sun::security::util::DerOutputStream> out) { return call_method<"encode", void>(out); }
	jni::ref<java::util::List> getCertPolicies() { return call_method<"getCertPolicies", jni::ref<java::util::List>>(); }
