...
namespace scapix::java_api { namespace sun::security::x509 { class DistributionPoint; }}
...
public:
	...
	static jni::ref<sun::security::x509::DistributionPoint> new_object(jni::ref<sun::security::x509::GeneralNames> fullName, jni::ref<jni::array<jboolean>> reasonFlags, jni::ref<sun::security::x509::GeneralNames> crlIssuer) { return object_base::new_object(fullName, reasonFlags, crlIssuer); }
	static jni::ref<sun::security::x509::DistributionPoint> new_object(jni::ref<sun::security::x509::RDN> relativeName, jni::ref<jni::array<jboolean>> reasonFlags, jni::ref<sun::security::x509::GeneralNames> crlIssuer) { return object_base::new_object(relativeName, reasonFlags, crlIssuer); }
	static jni::ref<sun::security::x509::DistributionPoint> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
