...
namespace scapix::java_api { namespace sun::security::x509 { class NetscapeCertTypeExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::NetscapeCertTypeExtension> new_object(jni::ref<jni::array<jbyte>> bitString) { return object_base::new_object(bitString); }
	static jni::ref<sun::security::x509::NetscapeCertTypeExtension> new_object(jni::ref<jni::array<jboolean>> bitString) { return object_base::new_object(bitString); }
	static jni::ref<sun::security::x509::NetscapeCertTypeExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
	static jni::ref<sun::security::x509::NetscapeCertTypeExtension> new_object() { return object_base::new_object(); }
	void set(jni::ref<java::lang::String> name, jni::ref<java::lang::Boolean> val) { return call_method<"set", void>(name, val); }
