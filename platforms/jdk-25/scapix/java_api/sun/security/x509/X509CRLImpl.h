...
#include <scapix/java_api/sun/security/x509/X509CRLImpl_TBSCertList.h>
...
public:
	...
	using TBSCertList = X509CRLImpl_TBSCertList;

	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X509CRLImpl_TBSCertList> info, jni::ref<sun::security::x509::AlgorithmId> sigAlgId, jni::ref<jni::array<jbyte>> signature, jni::ref<jni::array<jbyte>> tbsCertList, jni::ref<jni::array<jbyte>> signedCRL) { return object_base::new_object(info, sigAlgId, signature, tbsCertList, signedCRL); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<jni::array<jbyte>> crlData) { return object_base::new_object(crlData); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<java::io::InputStream> inStrm) { return object_base::new_object(inStrm); }
	jni::ref<sun::security::x509::X509CRLImpl_TBSCertList> info() { return call_method<"info", jni::ref<sun::security::x509::X509CRLImpl_TBSCertList>>(); }
	...
	static jni::ref<sun::security::x509::X509CRLImpl> newSigned(jni::ref<sun::security::x509::X509CRLImpl_TBSCertList> info, jni::ref<java::security::PrivateKey> key, jni::ref<java::lang::String> algorithm) { return call_static_method<"newSigned", jni::ref<sun::security::x509::X509CRLImpl>>(info, key, algorithm); }
	static jni::ref<sun::security::x509::X509CRLImpl> newSigned(jni::ref<sun::security::x509::X509CRLImpl_TBSCertList> info, jni::ref<java::security::PrivateKey> key, jni::ref<java::lang::String> algorithm, jni::ref<java::lang::String> provider) { return call_static_method<"newSigned", jni::ref<sun::security::x509::X509CRLImpl>>(info, key, algorithm, provider); }
