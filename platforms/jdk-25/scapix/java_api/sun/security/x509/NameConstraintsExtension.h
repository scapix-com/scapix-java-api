...
namespace scapix::java_api { namespace sun::security::x509 { class NameConstraintsExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::NameConstraintsExtension> new_object(jni::ref<sun::security::x509::GeneralSubtrees> permitted, jni::ref<sun::security::x509::GeneralSubtrees> excluded) { return object_base::new_object(permitted, excluded); }
	static jni::ref<sun::security::x509::NameConstraintsExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
