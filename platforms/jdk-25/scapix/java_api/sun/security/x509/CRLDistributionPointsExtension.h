...
namespace scapix::java_api { namespace sun::security::x509 { class CRLDistributionPointsExtension; }}
...
public:
	...
	static jni::ref<sun::security::x509::CRLDistributionPointsExtension> new_object(jni::ref<java::util::List> distributionPoints) { return object_base::new_object(distributionPoints); }
	static jni::ref<sun::security::x509::CRLDistributionPointsExtension> new_object(jboolean isCritical, jni::ref<java::util::List> distributionPoints) { return object_base::new_object(isCritical, distributionPoints); }
	static jni::ref<sun::security::x509::CRLDistributionPointsExtension> new_object(jni::ref<java::lang::Boolean> critical, jni::ref<java::lang::Object> value) { return object_base::new_object(critical, value); }
