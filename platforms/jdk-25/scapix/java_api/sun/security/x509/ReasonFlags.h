...
namespace scapix::java_api { namespace sun::security::x509 { class ReasonFlags; }}
...
public:
	...
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<jni::array<jbyte>> reasons) { return object_base::new_object(reasons); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<jni::array<jboolean>> reasons) { return object_base::new_object(reasons); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::BitArray> reasons) { return object_base::new_object(reasons); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::DerInputStream> in) { return object_base::new_object(in); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::DerValue> derVal) { return object_base::new_object(derVal); }
