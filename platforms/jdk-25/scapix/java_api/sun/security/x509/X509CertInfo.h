...
public:
	...
	static jni::ref<sun::security::x509::X509CertInfo> new_object(jni::ref<jni::array<jbyte>> cert) { return object_base::new_object(cert); }
	static jni::ref<sun::security::x509::X509CertInfo> new_object(jni::ref<sun::security::util::DerValue> derVal) { return object_base::new_object(derVal); }
