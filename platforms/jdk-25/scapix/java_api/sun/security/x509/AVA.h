...
namespace scapix::java_api { namespace sun::security::x509 { class AVA; }}
...
public:
	...
	static jni::ref<sun::security::x509::AVA> new_object(jni::ref<sun::security::util::ObjectIdentifier> type, jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(type, val); }
