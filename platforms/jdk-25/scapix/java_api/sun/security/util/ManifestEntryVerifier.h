...
namespace scapix::java_api { namespace sun::security::util { class ManifestEntryVerifier; }}
...
public:
	...
	static jni::ref<sun::security::util::ManifestEntryVerifier> new_object(jni::ref<java::util::jar::Manifest> man, jni::ref<java::lang::String> manifestFileName) { return object_base::new_object(man, manifestFileName); }
