...
public:
	...
	static jni::ref<java::lang::String> expandNonStrict(jni::ref<java::lang::String> value) { return call_static_method<"expandNonStrict", jni::ref<java::lang::String>>(value); }
