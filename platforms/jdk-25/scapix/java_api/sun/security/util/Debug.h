...
namespace scapix::java_api { namespace sun::security::util { class Debug; }}
...
public:
	...
	static jni::ref<sun::security::util::Debug> new_object() { return object_base::new_object(); }
	...
	static jni::ref<sun::security::util::Debug> of(jni::ref<java::lang::String> prefix, jni::ref<java::lang::String> property) { return call_static_method<"of", jni::ref<sun::security::util::Debug>>(prefix, property); }
	...
	void println(jni::ref<java::lang::String> prefix, jni::ref<java::lang::String> message) { return call_method<"println", void>(prefix, message); }
	...
	static jni::ref<java::lang::String> toString(jni::ref<java::math::BigInteger> b) { return call_static_method<"toString", jni::ref<java::lang::String>>(b); }
