...
namespace scapix::java_api { namespace sun::security::util { class DerValue; }}
...
public:
	...
	static jbyte TAG_CONSTRUCT() { return get_static_field<"TAG_CONSTRUCT", jbyte>(); }
	...
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<java::lang::String> value) { return object_base::new_object(value); }
	static jni::ref<sun::security::util::DerValue> new_object(jbyte stringTag, jni::ref<java::lang::String> value) { return object_base::new_object(stringTag, value); }
	static jni::ref<sun::security::util::DerValue> new_object(jbyte tag, jni::ref<jni::array<jbyte>> buffer) { return object_base::new_object(tag, buffer); }
	...
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> encoding) { return object_base::new_object(encoding); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
	...
	void validateBMPString() { return call_method<"validateBMPString", void>(); }
	...
	jni::ref<jni::array<sun::security::util::DerValue>> subs(jbyte expectedTag, jint startLen) { return call_method<"subs", jni::ref<jni::array<sun::security::util::DerValue>>>(expectedTag, startLen); }
