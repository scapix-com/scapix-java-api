...
namespace scapix::java_api { namespace sun::security::util { class ECUtil; }}
...
public:
	...
	static jni::ref<java::security::AlgorithmParameters> getECParameters() { return call_static_method<"getECParameters", jni::ref<java::security::AlgorithmParameters>>(); }
	static jni::ref<jni::array<jbyte>> encodeECParameterSpec(jni::ref<java::security::spec::ECParameterSpec> spec) { return call_static_method<"encodeECParameterSpec", jni::ref<jni::array<jbyte>>>(spec); }
	static jni::ref<java::security::spec::ECParameterSpec> getECParameterSpec(jni::ref<java::security::spec::ECParameterSpec> spec) { return call_static_method<"getECParameterSpec", jni::ref<java::security::spec::ECParameterSpec>>(spec); }
	static jni::ref<java::security::spec::ECParameterSpec> getECParameterSpec(jni::ref<jni::array<jbyte>> params) { return call_static_method<"getECParameterSpec", jni::ref<java::security::spec::ECParameterSpec>>(params); }
	static jni::ref<java::security::spec::ECParameterSpec> getECParameterSpec(jni::ref<java::lang::String> name) { return call_static_method<"getECParameterSpec", jni::ref<java::security::spec::ECParameterSpec>>(name); }
	static jni::ref<java::security::spec::ECParameterSpec> getECParameterSpec(jint keySize) { return call_static_method<"getECParameterSpec", jni::ref<java::security::spec::ECParameterSpec>>(keySize); }
	static jni::ref<java::lang::String> getCurveName(jni::ref<java::security::spec::ECParameterSpec> spec) { return call_static_method<"getCurveName", jni::ref<java::lang::String>>(spec); }
