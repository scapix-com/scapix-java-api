...
namespace scapix::java_api { namespace sun::security::util { class PBEUtil_PBES2Params; }}
...
public:
	...
	static jni::ref<sun::security::util::PBEUtil_PBES2Params> new_object() { return object_base::new_object(); }
