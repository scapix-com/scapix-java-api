...
namespace scapix::java_api { namespace sun::security::util::math { class IntegerModuloP_MultiplicativeInverser_Secp256R1Field; }}
...
public:
	...
	static jni::ref<sun::security::util::math::IntegerModuloP_MultiplicativeInverser_Secp256R1Field> new_object() { return object_base::new_object(); }
