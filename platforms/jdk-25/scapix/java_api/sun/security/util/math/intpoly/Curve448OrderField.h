...
namespace scapix::java_api { namespace sun::security::util::math::intpoly { class Curve448OrderField; }}
...
public:
	...
	static jni::ref<sun::security::util::math::intpoly::Curve448OrderField> ONE() { return get_static_field<"ONE", jni::ref<sun::security::util::math::intpoly::Curve448OrderField>>(); }
