...
namespace scapix::java_api { namespace sun::security::util::math::intpoly { class P521OrderField; }}
...
public:
	...
	static jni::ref<sun::security::util::math::intpoly::P521OrderField> ONE() { return get_static_field<"ONE", jni::ref<sun::security::util::math::intpoly::P521OrderField>>(); }
