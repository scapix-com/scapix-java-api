...
namespace scapix::java_api { namespace sun::security::util { class PropertyExpander_ExpandException; }}
...
public:
	...
	static jni::ref<sun::security::util::PropertyExpander_ExpandException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
