...
public:
	...
	static jni::ref<sun::security::util::SafeDHParameterSpec> new_object(jni::ref<java::math::BigInteger> p, jni::ref<java::math::BigInteger> g) { return object_base::new_object(p, g); }
	static jni::ref<sun::security::util::SafeDHParameterSpec> new_object(jni::ref<java::math::BigInteger> p, jni::ref<java::math::BigInteger> g, jint l) { return object_base::new_object(p, g, l); }
