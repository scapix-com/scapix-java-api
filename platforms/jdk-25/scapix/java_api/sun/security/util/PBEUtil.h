...
namespace scapix::java_api { namespace sun::security::util { class PBEUtil; }}
...
public:
	...
	static jni::ref<sun::security::util::PBEUtil> new_object() { return object_base::new_object(); }
	...
	static jni::ref<jni::array<jbyte>> encodePassword(jni::ref<jni::array<jchar>> passwd) { return call_static_method<"encodePassword", jni::ref<jni::array<jbyte>>>(passwd); }
