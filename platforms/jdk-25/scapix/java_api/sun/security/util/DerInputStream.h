...
public:
	...
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> data, jint start, jint length, jboolean allowBER) { return object_base::new_object(data, start, length, allowBER); }
