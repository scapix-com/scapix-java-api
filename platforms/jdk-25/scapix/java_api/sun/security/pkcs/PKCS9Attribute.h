...
namespace scapix::java_api { namespace sun::security::pkcs { class PKCS9Attribute; }}
...
public:
	...
	using Decoder = PKCS9Attribute_Decoder;
	using Encoder = PKCS9Attribute_Encoder;
	...
	static jni::ref<sun::security::util::ObjectIdentifier> CMS_ALGORITHM_PROTECTION_OID() { return get_static_field<"CMS_ALGORITHM_PROTECTION_OID", jni::ref<sun::security::util::ObjectIdentifier>>(); }

	static jni::ref<sun::security::pkcs::PKCS9Attribute> new_object(jni::ref<sun::security::util::ObjectIdentifier> oid, jni::ref<java::lang::Object> value) { return object_base::new_object(oid, value); }
	static jni::ref<sun::security::pkcs::PKCS9Attribute> new_object(jni::ref<sun::security::util::DerValue> derVal) { return object_base::new_object(derVal); }
	...
	static jni::ref<java::util::Set> getOIDs() { return call_static_method<"getOIDs", jni::ref<java::util::Set>>(); }
