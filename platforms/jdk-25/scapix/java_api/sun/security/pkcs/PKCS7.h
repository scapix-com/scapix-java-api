...
namespace scapix::java_api { namespace sun::security::pkcs { class PKCS7; }}
...
public:
	...
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<sun::security::util::DerInputStream> derin) { return object_base::new_object(derin); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<jni::array<jbyte>> bytes) { return object_base::new_object(bytes); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<jni::array<sun::security::x509::AlgorithmId>> digestAlgorithmIds, jni::ref<sun::security::pkcs::ContentInfo> contentInfo, jni::ref<jni::array<java::security::cert::X509Certificate>> certificates, jni::ref<jni::array<java::security::cert::X509CRL>> crls, jni::ref<jni::array<sun::security::pkcs::SignerInfo>> signerInfos) { return object_base::new_object(digestAlgorithmIds, contentInfo, certificates, crls, signerInfos); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<jni::array<sun::security::x509::AlgorithmId>> digestAlgorithmIds, jni::ref<sun::security::pkcs::ContentInfo> contentInfo, jni::ref<jni::array<java::security::cert::X509Certificate>> certificates, jni::ref<jni::array<sun::security::pkcs::SignerInfo>> signerInfos) { return object_base::new_object(digestAlgorithmIds, contentInfo, certificates, signerInfos); }
	...
	static jni::ref<jni::array<jbyte>> generateSignedData(jni::ref<java::lang::String> sigalg, jni::ref<java::security::Provider> sigProvider, jni::ref<java::security::PrivateKey> privateKey, jni::ref<jni::array<java::security::cert::X509Certificate>> signerChain, jni::ref<jni::array<jbyte>> content, jboolean internalsf, jboolean directsign, jni::ref<java::util::function::Function> ts) { return call_static_method<"generateSignedData", jni::ref<jni::array<jbyte>>>(sigalg, sigProvider, privateKey, signerChain, content, internalsf, directsign, ts); }
