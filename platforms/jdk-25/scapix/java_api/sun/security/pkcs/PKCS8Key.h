...
#include <scapix/java_api/sun/security/util/InternalPrivateKey.h>
...
namespace scapix::java_api { namespace sun::security::pkcs { class PKCS8Key; }}
...
struct scapix::jni::object_traits<scapix::java_api::sun::security::pkcs::PKCS8Key>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::security::PrivateKey, scapix::java_api::sun::security::util::InternalPrivateKey>;
};
...
public:
	...
	static jni::ref<sun::security::pkcs::PKCS8Key> new_object(jni::ref<jni::array<jbyte>> input) { return object_base::new_object(input); }
	...
	static jni::ref<java::security::PrivateKey> parseKey(jni::ref<jni::array<jbyte>> encoded, jni::ref<java::security::Provider> provider) { return call_static_method<"parseKey", jni::ref<java::security::PrivateKey>>(encoded, provider); }
	jni::ref<java::lang::String> getAlgorithm() { return call_method<"getAlgorithm", jni::ref<java::lang::String>>(); }
	jni::ref<jni::array<jbyte>> getPubKeyEncoded() { return call_method<"getPubKeyEncoded", jni::ref<jni::array<jbyte>>>(); }
	jboolean hasPublicKey() { return call_method<"hasPublicKey", jboolean>(); }
	...
	static jni::ref<jni::array<jbyte>> getEncoded(jni::ref<jni::array<jbyte>> pubKeyEncoded, jni::ref<jni::array<jbyte>> privKeyEncoded) { return call_static_method<"getEncoded", jni::ref<jni::array<jbyte>>>(pubKeyEncoded, privKeyEncoded); }
