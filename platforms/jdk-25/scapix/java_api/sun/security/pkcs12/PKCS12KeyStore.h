...
namespace scapix::java_api { namespace sun::security::pkcs12 { class PKCS12KeyStore; }}
...
public:
	...
	static jni::ref<sun::security::pkcs12::PKCS12KeyStore> new_object() { return object_base::new_object(); }
