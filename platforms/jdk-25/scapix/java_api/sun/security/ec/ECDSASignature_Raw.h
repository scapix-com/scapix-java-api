...
namespace scapix::java_api { namespace sun::security::ec { class ECDSASignature_Raw; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDSASignature_Raw> new_object() { return object_base::new_object(); }
