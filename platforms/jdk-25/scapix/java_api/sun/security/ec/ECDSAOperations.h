...
namespace scapix::java_api { namespace sun::security::ec { class ECDSAOperations; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDSAOperations> new_object(jni::ref<sun::security::ec::ECOperations> ecOps, jni::ref<java::security::spec::ECPoint> basePoint) { return object_base::new_object(ecOps, basePoint); }
