...
namespace scapix::java_api { namespace sun::security::ec { class ECDSASignature_SHA384inP1363Format; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDSASignature_SHA384inP1363Format> new_object() { return object_base::new_object(); }
