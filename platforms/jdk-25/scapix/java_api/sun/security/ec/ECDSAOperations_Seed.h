...
namespace scapix::java_api { namespace sun::security::ec { class ECDSAOperations_Seed; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDSAOperations_Seed> new_object(jni::ref<jni::array<jbyte>> seedValue) { return object_base::new_object(seedValue); }
