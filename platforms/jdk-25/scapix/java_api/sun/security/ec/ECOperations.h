...
namespace scapix::java_api { namespace sun::security::ec { class ECOperations; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECOperations> new_object(jni::ref<sun::security::util::math::IntegerModuloP> b, jni::ref<sun::security::util::math::IntegerFieldModuloP> orderField) { return object_base::new_object(b, orderField); }
	...
	void setSum(jni::ref<sun::security::ec::point::MutablePoint> p, jni::ref<sun::security::ec::point::MutablePoint> p2) { return call_method<"setSum", void>(p, p2); }
