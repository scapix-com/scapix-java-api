...
namespace scapix::java_api { namespace sun::security::ec { class ECDSASignature_SHA224; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDSASignature_SHA224> new_object() { return object_base::new_object(); }
