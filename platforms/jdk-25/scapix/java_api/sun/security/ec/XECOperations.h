...
namespace scapix::java_api { namespace sun::security::ec { class XECOperations; }}
...
public:
	...
	static jni::ref<sun::security::ec::XECOperations> new_object(jni::ref<sun::security::ec::XECParameters> c) { return object_base::new_object(c); }
