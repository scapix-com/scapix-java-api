...
namespace scapix::java_api { namespace sun::security::ec { class ECDSASignature_SHA3_512; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDSASignature_SHA3_512> new_object() { return object_base::new_object(); }
