...
namespace scapix::java_api { namespace sun::security::ec::point { class ProjectivePoint_Mutable; }}
...
public:
	...
	static jni::ref<sun::security::ec::point::ProjectivePoint_Mutable> new_object(jni::ref<sun::security::util::math::MutableIntegerModuloP> x, jni::ref<sun::security::util::math::MutableIntegerModuloP> y, jni::ref<sun::security::util::math::MutableIntegerModuloP> z) { return object_base::new_object(x, y, z); }
	static jni::ref<sun::security::ec::point::ProjectivePoint_Mutable> new_object(jni::ref<sun::security::util::math::IntegerFieldModuloP> field) { return object_base::new_object(field); }
