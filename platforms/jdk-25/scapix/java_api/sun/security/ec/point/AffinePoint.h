...
namespace scapix::java_api { namespace sun::security::ec::point { class AffinePoint; }}
...
public:
	...
	static jni::ref<sun::security::ec::point::AffinePoint> new_object(jni::ref<sun::security::util::math::ImmutableIntegerModuloP> x, jni::ref<sun::security::util::math::ImmutableIntegerModuloP> y) { return object_base::new_object(x, y); }
	...
	jni::ref<sun::security::util::math::ImmutableIntegerModuloP> getX(jboolean fieldCheck) { return call_method<"getX", jni::ref<sun::security::util::math::ImmutableIntegerModuloP>>(fieldCheck); }
	...
	jni::ref<sun::security::util::math::ImmutableIntegerModuloP> getY(jboolean fieldCheck) { return call_method<"getY", jni::ref<sun::security::util::math::ImmutableIntegerModuloP>>(fieldCheck); }
