...
namespace scapix::java_api { namespace sun::security::ec::point { class ExtendedHomogeneousPoint_Immutable; }}
...
public:
	...
	static jni::ref<sun::security::ec::point::ExtendedHomogeneousPoint_Immutable> new_object(jni::ref<sun::security::util::math::ImmutableIntegerModuloP> x, jni::ref<sun::security::util::math::ImmutableIntegerModuloP> y, jni::ref<sun::security::util::math::ImmutableIntegerModuloP> t, jni::ref<sun::security::util::math::ImmutableIntegerModuloP> z) { return object_base::new_object(x, y, t, z); }
