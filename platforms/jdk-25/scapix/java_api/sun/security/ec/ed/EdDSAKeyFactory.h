...
namespace scapix::java_api { namespace sun::security::ec::ed { class EdDSAKeyFactory; }}
...
public:
	...
	static jni::ref<sun::security::ec::ed::EdDSAKeyFactory> new_object() { return object_base::new_object(); }
