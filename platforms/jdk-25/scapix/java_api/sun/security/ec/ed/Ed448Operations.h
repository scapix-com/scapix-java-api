...
namespace scapix::java_api { namespace sun::security::ec::ed { class Ed448Operations; }}
...
public:
	...
	static jni::ref<sun::security::ec::ed::Ed448Operations> new_object(jni::ref<sun::security::util::math::ImmutableIntegerModuloP> d, jni::ref<java::math::BigInteger> baseX, jni::ref<java::math::BigInteger> baseY) { return object_base::new_object(d, baseX, baseY); }
