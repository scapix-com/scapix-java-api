...
namespace scapix::java_api { namespace sun::security::ec::ed { class EdECOperations; }}
...
public:
	...
	static jni::ref<sun::security::ec::ed::EdECOperations> new_object() { return object_base::new_object(); }
