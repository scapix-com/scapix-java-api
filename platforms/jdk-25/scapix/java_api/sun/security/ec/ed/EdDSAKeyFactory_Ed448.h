...
namespace scapix::java_api { namespace sun::security::ec::ed { class EdDSAKeyFactory_Ed448; }}
...
public:
	...
	static jni::ref<sun::security::ec::ed::EdDSAKeyFactory_Ed448> new_object() { return object_base::new_object(); }
