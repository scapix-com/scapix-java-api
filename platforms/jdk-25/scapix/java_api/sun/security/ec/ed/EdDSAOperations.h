...
namespace scapix::java_api { namespace sun::security::ec::ed { class EdDSAOperations; }}
...
public:
	...
	static jni::ref<sun::security::ec::ed::EdDSAOperations> new_object(jni::ref<sun::security::ec::ed::EdDSAParameters> params) { return object_base::new_object(params); }
