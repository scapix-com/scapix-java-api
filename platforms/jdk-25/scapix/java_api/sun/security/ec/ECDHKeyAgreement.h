...
namespace scapix::java_api { namespace sun::security::ec { class ECDHKeyAgreement; }}
...
public:
	...
	static jni::ref<sun::security::ec::ECDHKeyAgreement> new_object() { return object_base::new_object(); }
