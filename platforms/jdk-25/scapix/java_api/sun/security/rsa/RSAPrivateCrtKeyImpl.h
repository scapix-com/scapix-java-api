...
namespace scapix::java_api { namespace sun::security::rsa { class RSAPrivateCrtKeyImpl; }}
...
public:
	...
	static jni::ref<java::security::spec::KeySpec> getKeySpec(jni::ref<jni::array<jbyte>> encoded) { return call_static_method<"getKeySpec", jni::ref<java::security::spec::KeySpec>>(encoded); }
