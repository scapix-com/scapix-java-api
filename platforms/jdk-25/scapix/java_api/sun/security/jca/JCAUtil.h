...
namespace scapix::java_api { namespace sun::security::jca { class JCAUtil; }}
...
public:
	...
	static jint getTempArraySize(jint totalSize) { return call_static_method<"getTempArraySize", jint>(totalSize); }
	...
	static void tryCommitCertEvent(jni::ref<java::security::cert::Certificate> cert) { return call_static_method<"tryCommitCertEvent", void>(cert); }
