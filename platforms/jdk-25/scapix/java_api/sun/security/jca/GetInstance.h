...
public:
	...
	static jni::ref<java::util::Iterator> getServices(jni::ref<java::lang::String> type, jni::ref<java::lang::String> algorithm) { return call_static_method<"getServices", jni::ref<java::util::Iterator>>(type, algorithm); }
	static jni::ref<java::util::Iterator> getServices(jni::ref<java::util::List> ids) { return call_static_method<"getServices", jni::ref<java::util::Iterator>>(ids); }
