...
public:
	...
	jni::ref<java::util::Iterator> getServices(jni::ref<java::lang::String> type, jni::ref<java::lang::String> algorithm) { return call_method<"getServices", jni::ref<java::util::Iterator>>(type, algorithm); }
	jni::ref<java::util::Iterator> getServices(jni::ref<java::util::List> ids) { return call_method<"getServices", jni::ref<java::util::Iterator>>(ids); }
