...
namespace scapix::java_api { namespace sun::security::jca { class Providers; }}
...
public:
	...
	static void stopJarVerification(jni::ref<java::lang::Object> obj) { return call_static_method<"stopJarVerification", void>(obj); }
	...
	static void setProviderList(jni::ref<sun::security::jca::ProviderList> newList) { return call_static_method<"setProviderList", void>(newList); }
	...
	static jni::ref<sun::security::jca::ProviderList> beginThreadProviderList(jni::ref<sun::security::jca::ProviderList> list) { return call_static_method<"beginThreadProviderList", jni::ref<sun::security::jca::ProviderList>>(list); }
	static void endThreadProviderList(jni::ref<sun::security::jca::ProviderList> list) { return call_static_method<"endThreadProviderList", void>(list); }
