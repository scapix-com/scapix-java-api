...
namespace scapix::java_api { namespace sun::security::ssl { class SSLHandshake; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLHandshake> REQUEST_CONNECTION_ID() { return get_static_field<"REQUEST_CONNECTION_ID", jni::ref<sun::security::ssl::SSLHandshake>>(); }
	static jni::ref<sun::security::ssl::SSLHandshake> NEW_CONNECTION_ID() { return get_static_field<"NEW_CONNECTION_ID", jni::ref<sun::security::ssl::SSLHandshake>>(); }
	...
	static jni::ref<sun::security::ssl::SSLHandshake> CLIENT_CERTIFICATE_REQUEST() { return get_static_field<"CLIENT_CERTIFICATE_REQUEST", jni::ref<sun::security::ssl::SSLHandshake>>(); }
	...
	static jni::ref<sun::security::ssl::SSLHandshake> COMPRESSED_CERTIFICATE() { return get_static_field<"COMPRESSED_CERTIFICATE", jni::ref<sun::security::ssl::SSLHandshake>>(); }
	static jni::ref<sun::security::ssl::SSLHandshake> EKT_KEY() { return get_static_field<"EKT_KEY", jni::ref<sun::security::ssl::SSLHandshake>>(); }
