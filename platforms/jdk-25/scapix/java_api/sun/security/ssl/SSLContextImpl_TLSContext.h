...
namespace scapix::java_api { namespace sun::security::ssl { class SSLContextImpl_TLSContext; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLContextImpl_TLSContext> new_object() { return object_base::new_object(); }
