...
namespace scapix::java_api { namespace sun::security::ssl { class SSLSocketFactoryImpl; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLSocketFactoryImpl> new_object() { return object_base::new_object(); }
