...
namespace scapix::java_api { namespace sun::security::ssl { class SSLServerSocketFactoryImpl; }}
...
public:
	...
	static jni::ref<sun::security::ssl::SSLServerSocketFactoryImpl> new_object() { return object_base::new_object(); }
