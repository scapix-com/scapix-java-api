...
namespace scapix::java_api { namespace sun::security::ssl { class SSLSessionImpl; }}
...
public:
	...
	jboolean isPSK() { return call_method<"isPSK", jboolean>(); }
	...
	jni::ref<java::lang::Object> exportKeyingMaterial(jni::ref<java::lang::String> keyAlg, jni::ref<java::lang::String> label, jni::ref<jni::array<jbyte>> context, jint length) { return call_method<"exportKeyingMaterial", jni::ref<java::lang::Object>>(keyAlg, label, context, length); }
	jni::ref<javax::crypto::SecretKey> exportKeyingMaterialKey(jni::ref<java::lang::String> keyAlg, jni::ref<java::lang::String> label, jni::ref<jni::array<jbyte>> context, jint length) { return call_method<"exportKeyingMaterialKey", jni::ref<javax::crypto::SecretKey>>(keyAlg, label, context, length); }
	jni::ref<jni::array<jbyte>> exportKeyingMaterialData(jni::ref<java::lang::String> label, jni::ref<jni::array<jbyte>> context, jint length) { return call_method<"exportKeyingMaterialData", jni::ref<jni::array<jbyte>>>(label, context, length); }
