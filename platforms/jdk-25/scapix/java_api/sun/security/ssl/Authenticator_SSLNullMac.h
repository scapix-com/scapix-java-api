...
namespace scapix::java_api { namespace sun::security::ssl { class Authenticator_SSLNullMac; }}
...
public:
	...
	static jni::ref<sun::security::ssl::Authenticator_SSLNullMac> new_object() { return object_base::new_object(); }
