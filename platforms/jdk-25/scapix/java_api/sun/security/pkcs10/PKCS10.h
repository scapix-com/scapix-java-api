...
namespace scapix::java_api { namespace sun::security::pkcs10 { class PKCS10; }}
...
public:
	...
	static jni::ref<sun::security::pkcs10::PKCS10> new_object(jni::ref<java::security::PublicKey> publicKey) { return object_base::new_object(publicKey); }
	static jni::ref<sun::security::pkcs10::PKCS10> new_object(jni::ref<java::security::PublicKey> publicKey, jni::ref<sun::security::pkcs10::PKCS10Attributes> attributes) { return object_base::new_object(publicKey, attributes); }
	static jni::ref<sun::security::pkcs10::PKCS10> new_object(jni::ref<jni::array<jbyte>> data) { return object_base::new_object(data); }
	void encodeAndSign(jni::ref<sun::security::x509::X500Name> subject, jni::ref<java::security::PrivateKey> key, jni::ref<java::lang::String> algorithm) { return call_method<"encodeAndSign", void>(subject, key, algorithm); }
