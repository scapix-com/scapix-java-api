...
namespace scapix::java_api { namespace sun::security::internal::spec { class TlsRsaPremasterSecretParameterSpec; }}
...
public:
	...
	static jni::ref<sun::security::internal::spec::TlsRsaPremasterSecretParameterSpec> new_object(jint clientVersion, jint serverVersion) { return object_base::new_object(clientVersion, serverVersion); }
	static jni::ref<sun::security::internal::spec::TlsRsaPremasterSecretParameterSpec> new_object(jint clientVersion, jint serverVersion, jni::ref<jni::array<jbyte>> encodedSecret) { return object_base::new_object(clientVersion, serverVersion, encodedSecret); }
