...
namespace scapix::java_api { namespace sun::net::www::protocol::http { class HttpCallerInfo; }}
...
public:
	...
	jni::ref<java::net::Authenticator> authenticator() { return get_field<"authenticator", jni::ref<java::net::Authenticator>>(); }
	...
	static jni::ref<sun::net::www::protocol::http::HttpCallerInfo> new_object(jni::ref<sun::net::www::protocol::http::HttpCallerInfo> old, jni::ref<java::lang::String> scheme) { return object_base::new_object(old, scheme); }
	static jni::ref<sun::net::www::protocol::http::HttpCallerInfo> new_object(jni::ref<java::net::URL> url, jni::ref<java::net::Authenticator> a) { return object_base::new_object(url, a); }
	static jni::ref<sun::net::www::protocol::http::HttpCallerInfo> new_object(jni::ref<java::net::URL> url, jni::ref<java::security::cert::X509Certificate> serverCert, jni::ref<java::net::Authenticator> a) { return object_base::new_object(url, serverCert, a); }
	static jni::ref<sun::net::www::protocol::http::HttpCallerInfo> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::String> host, jint port, jni::ref<java::net::Authenticator> a) { return object_base::new_object(url, host, port, a); }
	static jni::ref<sun::net::www::protocol::http::HttpCallerInfo> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::String> host, jint port, jni::ref<java::security::cert::X509Certificate> serverCert, jni::ref<java::net::Authenticator> a) { return object_base::new_object(url, host, port, serverCert, a); }
