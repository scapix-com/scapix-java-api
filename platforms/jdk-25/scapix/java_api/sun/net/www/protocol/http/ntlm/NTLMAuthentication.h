...
public:
	...
	static jni::ref<sun::net::www::protocol::http::ntlm::NTLMAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::net::PasswordAuthentication> pw) { return object_base::new_object(isProxy, url, pw); }
	static jni::ref<sun::net::www::protocol::http::ntlm::NTLMAuthentication> new_object(jboolean isProxy, jni::ref<java::lang::String> host, jint port, jni::ref<java::net::PasswordAuthentication> pw) { return object_base::new_object(isProxy, host, port, pw); }
