...
namespace scapix::java_api { namespace sun::net::www::protocol::jmod { class Handler; }}
...
public:
	...
	static jni::ref<sun::net::www::protocol::jmod::Handler> new_object() { return object_base::new_object(); }
