...
namespace scapix::java_api { namespace sun::net::www::http { class KeepAliveKey; }}
...
public:
	...
	static jni::ref<sun::net::www::http::KeepAliveKey> new_object(jni::ref<java::net::URL> url, jni::ref<java::lang::Object> obj) { return object_base::new_object(url, obj); }
