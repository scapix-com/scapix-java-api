...
namespace scapix::java_api { namespace sun::net::ftp { class FtpReplyCode; }}
...
public:
	...
	static jni::ref<sun::net::ftp::FtpReplyCode> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<sun::net::ftp::FtpReplyCode>>(name); }
	...
	static jni::ref<sun::net::ftp::FtpReplyCode> find(jint v) { return call_static_method<"find", jni::ref<sun::net::ftp::FtpReplyCode>>(v); }
