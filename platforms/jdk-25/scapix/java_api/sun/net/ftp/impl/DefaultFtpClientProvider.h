...
namespace scapix::java_api { namespace sun::net::ftp::impl { class DefaultFtpClientProvider; }}
...
public:
	...
	static jni::ref<sun::net::ftp::impl::DefaultFtpClientProvider> new_object() { return object_base::new_object(); }
