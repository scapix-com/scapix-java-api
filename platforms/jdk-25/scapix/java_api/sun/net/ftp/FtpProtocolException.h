...
namespace scapix::java_api { namespace sun::net::ftp { class FtpProtocolException; }}
...
public:
	...
	static jni::ref<sun::net::ftp::FtpProtocolException> new_object(jni::ref<java::lang::String> detail) { return object_base::new_object(detail); }
	static jni::ref<sun::net::ftp::FtpProtocolException> new_object(jni::ref<java::lang::String> detail, jni::ref<sun::net::ftp::FtpReplyCode> code) { return object_base::new_object(detail, code); }
