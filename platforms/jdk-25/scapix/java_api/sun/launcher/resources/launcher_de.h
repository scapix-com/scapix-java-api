...
namespace scapix::java_api { namespace sun::launcher::resources { class launcher_de; }}
...
public:
	...
	static jni::ref<sun::launcher::resources::launcher_de> new_object() { return object_base::new_object(); }
