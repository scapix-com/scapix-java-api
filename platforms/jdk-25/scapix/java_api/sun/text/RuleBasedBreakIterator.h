...
namespace scapix::java_api { namespace sun::text { class RuleBasedBreakIterator; }}
...
public:
	...
	static jni::ref<sun::text::RuleBasedBreakIterator> new_object(jni::ref<java::lang::String> ruleFile, jni::ref<jni::array<jbyte>> ruleData) { return object_base::new_object(ruleFile, ruleData); }
