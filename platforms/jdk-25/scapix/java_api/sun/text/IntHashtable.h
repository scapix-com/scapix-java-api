...
namespace scapix::java_api { namespace sun::text { class IntHashtable; }}
...
public:
	...
	static jni::ref<sun::text::IntHashtable> new_object(jint initialSize) { return object_base::new_object(initialSize); }
