...
namespace scapix::java_api { namespace sun::util { class BuddhistCalendar; }}
...
public:
	...
	static jni::ref<sun::util::BuddhistCalendar> new_object() { return object_base::new_object(); }
	static jni::ref<sun::util::BuddhistCalendar> new_object(jni::ref<java::util::TimeZone> zone) { return object_base::new_object(zone); }
	static jni::ref<sun::util::BuddhistCalendar> new_object(jni::ref<java::util::Locale> aLocale) { return object_base::new_object(aLocale); }
	static jni::ref<sun::util::BuddhistCalendar> new_object(jni::ref<java::util::TimeZone> zone, jni::ref<java::util::Locale> aLocale) { return object_base::new_object(zone, aLocale); }
