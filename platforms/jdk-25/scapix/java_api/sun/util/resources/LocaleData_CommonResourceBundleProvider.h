...
namespace scapix::java_api { namespace sun::util::resources { class LocaleData_CommonResourceBundleProvider; }}
...
public:
	...
	static jni::ref<sun::util::resources::LocaleData_CommonResourceBundleProvider> new_object() { return object_base::new_object(); }
