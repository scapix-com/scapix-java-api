...
namespace scapix::java_api { namespace sun::util::resources::cldr { class CalendarData; }}
...
public:
	...
	static jni::ref<sun::util::resources::cldr::CalendarData> new_object() { return object_base::new_object(); }
