...
namespace scapix::java_api { namespace sun::util::locale { class UnicodeLocaleExtension; }}
...
public:
	...
	static jboolean isSingletonChar(jchar c) { return call_static_method<"isSingletonChar", jboolean>(c); }
	static jboolean isAttribute(jni::ref<java::lang::String> s) { return call_static_method<"isAttribute", jboolean>(s); }
	static jboolean isKey(jni::ref<java::lang::String> s) { return call_static_method<"isKey", jboolean>(s); }
	static jboolean isTypeSubtag(jni::ref<java::lang::String> s) { return call_static_method<"isTypeSubtag", jboolean>(s); }
