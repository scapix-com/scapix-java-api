...
namespace scapix::java_api { namespace sun::util::locale::provider { class CollatorProviderImpl; }}
...
public:
	...
	static jni::ref<sun::util::locale::provider::CollatorProviderImpl> new_object(jni::ref<sun::util::locale::provider::LocaleProviderAdapter_Type> type, jni::ref<java::util::Set> langtags) { return object_base::new_object(type, langtags); }
