...
namespace scapix::java_api { namespace sun::util::locale::provider { class LocaleProviderAdapter; }}
...
public:
	...
	static jni::ref<sun::util::locale::provider::LocaleProviderAdapter> new_object() { return object_base::new_object(); }
