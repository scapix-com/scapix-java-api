...
namespace scapix::java_api { namespace sun::util::locale::provider { class AuxLocaleProviderAdapter; }}
...
public:
	...
	static jni::ref<sun::util::locale::provider::AuxLocaleProviderAdapter> new_object() { return object_base::new_object(); }
