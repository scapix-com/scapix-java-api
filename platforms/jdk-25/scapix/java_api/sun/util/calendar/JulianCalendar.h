...
public:
	...
	jni::ref<sun::util::calendar::JulianCalendar_Date> getCalendarDate(jlong millis, jni::ref<sun::util::calendar::CalendarDate> date) { return call_method<"getCalendarDate", jni::ref<sun::util::calendar::JulianCalendar_Date>>(millis, date); }
	jni::ref<sun::util::calendar::JulianCalendar_Date> getCalendarDate(jlong millis, jni::ref<java::util::TimeZone> zone) { return call_method<"getCalendarDate", jni::ref<sun::util::calendar::JulianCalendar_Date>>(millis, zone); }
