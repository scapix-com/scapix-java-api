...
namespace scapix::java_api { namespace sun::nio::cs { class SJIS_DecodeHolder; }}
...
public:
	...
	static jni::ref<sun::nio::cs::SJIS_DecodeHolder> new_object() { return object_base::new_object(); }
