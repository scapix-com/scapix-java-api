...
namespace scapix::java_api { namespace sun::nio::cs { class ThreadLocalCoders; }}
...
public:
	...
	static jni::ref<sun::nio::cs::ThreadLocalCoders> new_object() { return object_base::new_object(); }
	static jni::ref<java::nio::charset::CharsetDecoder> decoderFor(jni::ref<java::lang::Object> name) { return call_static_method<"decoderFor", jni::ref<java::nio::charset::CharsetDecoder>>(name); }
	static jni::ref<java::nio::charset::CharsetEncoder> encoderFor(jni::ref<java::lang::Object> name) { return call_static_method<"encoderFor", jni::ref<java::nio::charset::CharsetEncoder>>(name); }
