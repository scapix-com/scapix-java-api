...
namespace scapix::java_api { namespace sun::nio::cs { class DoubleByte_Encoder_EUC_SIM; }}
...
public:
	...
	static jni::ref<sun::nio::cs::DoubleByte_Encoder_EUC_SIM> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jchar>> c2b, jni::ref<jni::array<jchar>> c2bIndex, jboolean isASCIICompatible) { return object_base::new_object(cs, c2b, c2bIndex, isASCIICompatible); }
