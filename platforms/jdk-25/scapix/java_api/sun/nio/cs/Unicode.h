...
namespace scapix::java_api { namespace sun::nio::cs { class Unicode; }}
...
public:
	...
	static jni::ref<sun::nio::cs::Unicode> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<java::lang::String>> aliases) { return object_base::new_object(name, aliases); }
