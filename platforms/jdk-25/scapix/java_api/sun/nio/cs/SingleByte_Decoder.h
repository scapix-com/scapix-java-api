...
namespace scapix::java_api { namespace sun::nio::cs { class SingleByte_Decoder; }}
...
public:
	...
	static jni::ref<sun::nio::cs::SingleByte_Decoder> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jchar>> b2c) { return object_base::new_object(cs, b2c); }
	static jni::ref<sun::nio::cs::SingleByte_Decoder> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jchar>> b2c, jboolean isASCIICompatible) { return object_base::new_object(cs, b2c, isASCIICompatible); }
	static jni::ref<sun::nio::cs::SingleByte_Decoder> new_object(jni::ref<java::nio::charset::Charset> cs, jni::ref<jni::array<jchar>> b2c, jboolean isASCIICompatible, jboolean isLatin1Decodable) { return object_base::new_object(cs, b2c, isASCIICompatible, isLatin1Decodable); }
