...
namespace scapix::java_api { namespace sun::nio::cs { class StreamEncoder; }}
...
public:
	...
	static jni::ref<sun::nio::cs::StreamEncoder> forOutputStreamWriter(jni::ref<java::io::OutputStream> out, jni::ref<java::nio::charset::CharsetEncoder> enc) { return call_static_method<"forOutputStreamWriter", jni::ref<sun::nio::cs::StreamEncoder>>(out, enc); }
