...
namespace scapix::java_api { namespace sun::nio::ch { class SelectorProviderImpl; }}
...
public:
	...
	static jni::ref<sun::nio::ch::SelectorProviderImpl> new_object() { return object_base::new_object(); }
	...
	jni::ref<java::nio::channels::DatagramChannel> openUninterruptibleDatagramChannel() { return call_method<"openUninterruptibleDatagramChannel", jni::ref<java::nio::channels::DatagramChannel>>(); }
	jni::ref<java::nio::channels::DatagramChannel> openDatagramChannel(jni::ref<java::net::ProtocolFamily> family) { return call_method<"openDatagramChannel", jni::ref<java::nio::channels::DatagramChannel>>(family); }
	...
	jni::ref<java::nio::channels::SocketChannel> openSocketChannel(jni::ref<java::net::ProtocolFamily> family) { return call_method<"openSocketChannel", jni::ref<java::nio::channels::SocketChannel>>(family); }
	jni::ref<java::nio::channels::ServerSocketChannel> openServerSocketChannel(jni::ref<java::net::ProtocolFamily> family) { return call_method<"openServerSocketChannel", jni::ref<java::nio::channels::ServerSocketChannel>>(family); }
