...
namespace scapix::java_api { namespace sun::nio::ch { class SelectionKeyImpl; }}
...
public:
	...
	jni::ref<java::nio::channels::SelectionKey> interestOps(jint ops) { return call_method<"interestOps", jni::ref<java::nio::channels::SelectionKey>>(ops); }
	...
	void nioReadyOps(jint ops) { return call_method<"nioReadyOps", void>(ops); }
	jint nioReadyOps() { return call_method<"nioReadyOps", jint>(); }
	jni::ref<java::nio::channels::SelectionKey> nioInterestOps(jint ops) { return call_method<"nioInterestOps", jni::ref<java::nio::channels::SelectionKey>>(ops); }
