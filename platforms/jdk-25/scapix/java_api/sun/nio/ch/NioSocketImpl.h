...
namespace scapix::java_api { namespace sun::nio::ch { class NioSocketImpl; }}
...
public:
	...
	static jni::ref<sun::nio::ch::NioSocketImpl> new_object(jboolean server) { return object_base::new_object(server); }
