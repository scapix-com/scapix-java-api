...
namespace scapix::java_api { namespace sun::nio::ch { class WindowsAsynchronousFileChannelImpl; }}
...
public:
	...
	static jni::ref<java::nio::channels::AsynchronousFileChannel> open(jni::ref<java::io::FileDescriptor> fdo, jni::ref<java::lang::String> path, jboolean reading, jboolean writing, jni::ref<sun::nio::ch::ThreadPool> pool) { return call_static_method<"open", jni::ref<java::nio::channels::AsynchronousFileChannel>>(fdo, path, reading, writing, pool); }
