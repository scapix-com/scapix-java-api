...
namespace scapix::java_api { namespace sun::nio::fs { class WindowsFileSystemProvider; }}
...
public:
	...
	static jni::ref<sun::nio::fs::WindowsFileSystemProvider> new_object() { return object_base::new_object(); }
	...
	jni::ref<jni::array<jbyte>> getSunPathForSocketFile(jni::ref<java::nio::file::Path> obj) { return call_method<"getSunPathForSocketFile", jni::ref<jni::array<jbyte>>>(obj); }
