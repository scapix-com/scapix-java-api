...
namespace scapix::java_api { namespace sun::nio::fs { class RegistryFileTypeDetector; }}
...
public:
	...
	static jni::ref<sun::nio::fs::RegistryFileTypeDetector> new_object() { return object_base::new_object(); }
