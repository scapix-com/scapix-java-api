...
namespace scapix::java_api { namespace sun::nio::fs { class AbstractFileSystemProvider; }}
...
public:
	...
	jni::ref<jni::array<jbyte>> getSunPathForSocketFile(jni::ref<java::nio::file::Path> p1) { return call_method<"getSunPathForSocketFile", jni::ref<jni::array<jbyte>>>(p1); }
	jboolean isReadable(jni::ref<java::nio::file::Path> path) { return call_method<"isReadable", jboolean>(path); }
	jboolean isWritable(jni::ref<java::nio::file::Path> path) { return call_method<"isWritable", jboolean>(path); }
	jboolean isExecutable(jni::ref<java::nio::file::Path> path) { return call_method<"isExecutable", jboolean>(path); }
