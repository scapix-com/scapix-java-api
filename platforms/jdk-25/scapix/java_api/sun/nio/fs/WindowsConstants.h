...
namespace scapix::java_api { namespace sun::nio::fs { class WindowsConstants; }}
...
public:
	...
	static jint COPY_FILE_NO_BUFFERING() { return get_static_field<"COPY_FILE_NO_BUFFERING", jint>(); }
