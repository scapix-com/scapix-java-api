...
namespace scapix::java_api { namespace sun::reflect::annotation { class AnnotatedTypeFactory; }}
...
public:
	...
	static jni::ref<java::lang::reflect::AnnotatedType> buildAnnotatedType(jni::ref<java::lang::reflect::Type> type, jni::ref<sun::reflect::annotation::TypeAnnotation_LocationInfo> currentLoc, jni::ref<jni::array<sun::reflect::annotation::TypeAnnotation>> actualTypeAnnos, jni::ref<jni::array<sun::reflect::annotation::TypeAnnotation>> allOnSameTarget) { return call_static_method<"buildAnnotatedType", jni::ref<java::lang::reflect::AnnotatedType>>(type, currentLoc, actualTypeAnnos, allOnSameTarget); }
