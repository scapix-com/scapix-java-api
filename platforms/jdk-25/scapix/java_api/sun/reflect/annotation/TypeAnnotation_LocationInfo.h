...
public:
	...
	jni::ref<sun::reflect::annotation::TypeAnnotation_LocationInfo> popLocation(jbyte tag) { return call_method<"popLocation", jni::ref<sun::reflect::annotation::TypeAnnotation_LocationInfo>>(tag); }
