...
namespace scapix::java_api { namespace sun::reflect::annotation { class EnumConstantNotPresentExceptionProxy; }}
...
public:
	...
	static jni::ref<sun::reflect::annotation::EnumConstantNotPresentExceptionProxy> new_object(jni::ref<java::lang::Class> enumType, jni::ref<java::lang::String> constName) { return object_base::new_object(enumType, constName); }
