...
namespace scapix::java_api { namespace sun::reflect::annotation { class TypeNotPresentExceptionProxy; }}
...
public:
	...
	static jni::ref<sun::reflect::annotation::TypeNotPresentExceptionProxy> new_object(jni::ref<java::lang::String> typeName, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(typeName, cause); }
