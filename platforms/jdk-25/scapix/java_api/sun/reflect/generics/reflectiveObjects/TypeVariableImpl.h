...
namespace scapix::java_api { namespace sun::reflect::generics::reflectiveObjects { class TypeVariableImpl; }}
...
public:
	...
	static jni::ref<sun::reflect::generics::reflectiveObjects::TypeVariableImpl> make(jni::ref<java::lang::reflect::GenericDeclaration> decl, jni::ref<java::lang::String> name, jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> bs, jni::ref<sun::reflect::generics::factory::GenericsFactory> f) { return call_static_method<"make", jni::ref<sun::reflect::generics::reflectiveObjects::TypeVariableImpl>>(decl, name, bs, f); }
