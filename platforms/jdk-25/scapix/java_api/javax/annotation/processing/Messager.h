...
#ifndef SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_MESSAGER
...
public:
	...
	void printError(jni::ref<java::lang::CharSequence> msg) { return call_method<"printError", void>(msg); }
	void printError(jni::ref<java::lang::CharSequence> msg, jni::ref<javax::lang::model::element::Element> e) { return call_method<"printError", void>(msg, e); }
	void printWarning(jni::ref<java::lang::CharSequence> msg) { return call_method<"printWarning", void>(msg); }
	void printWarning(jni::ref<java::lang::CharSequence> msg, jni::ref<javax::lang::model::element::Element> e) { return call_method<"printWarning", void>(msg, e); }
	void printNote(jni::ref<java::lang::CharSequence> msg) { return call_method<"printNote", void>(msg); }
	void printNote(jni::ref<java::lang::CharSequence> msg, jni::ref<javax::lang::model::element::Element> e) { return call_method<"printNote", void>(msg, e); }
};
