...
#ifndef SCAPIX_JAVA_API_JAVAX_TOOLS_SIMPLEJAVAFILEOBJECT
...
public:
	...
	static jni::ref<javax::tools::JavaFileObject> forSource(jni::ref<java::net::URI> uri, jni::ref<java::lang::String> content) { return call_static_method<"forSource", jni::ref<javax::tools::JavaFileObject>>(uri, content); }
};
