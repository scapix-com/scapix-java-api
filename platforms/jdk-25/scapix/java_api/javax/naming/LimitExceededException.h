...
#ifndef SCAPIX_JAVA_API_JAVAX_NAMING_LIMITEXCEEDEDEXCEPTION
...
public:
	...
	static jni::ref<javax::naming::LimitExceededException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::naming::LimitExceededException> new_object(jni::ref<java::lang::String> explanation) { return object_base::new_object(explanation); }
};
