...
#ifndef SCAPIX_JAVA_API_JAVAX_NAMING_INSUFFICIENTRESOURCESEXCEPTION
...
public:
	...
	static jni::ref<javax::naming::InsufficientResourcesException> new_object(jni::ref<java::lang::String> explanation) { return object_base::new_object(explanation); }
	static jni::ref<javax::naming::InsufficientResourcesException> new_object() { return object_base::new_object(); }
};
