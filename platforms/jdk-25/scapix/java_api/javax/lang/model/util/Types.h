...
#ifndef SCAPIX_JAVA_API_JAVAX_LANG_MODEL_UTIL_TYPES
...
public:
	...
	jni::ref<javax::lang::model::type::TypeMirror> stripAnnotations(jni::ref<javax::lang::model::type::TypeMirror> t) { return call_method<"stripAnnotations", jni::ref<javax::lang::model::type::TypeMirror>>(t); }
};
