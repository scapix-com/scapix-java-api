...
#ifndef SCAPIX_JAVA_API_JAVAX_LANG_MODEL_ELEMENT_ELEMENTKIND
...
public:
	...
	static jni::ref<javax::lang::model::element::ElementKind> MODULE() { return get_static_field<"MODULE", jni::ref<javax::lang::model::element::ElementKind>>(); }
	static jni::ref<javax::lang::model::element::ElementKind> RECORD() { return get_static_field<"RECORD", jni::ref<javax::lang::model::element::ElementKind>>(); }
	static jni::ref<javax::lang::model::element::ElementKind> RECORD_COMPONENT() { return get_static_field<"RECORD_COMPONENT", jni::ref<javax::lang::model::element::ElementKind>>(); }
	static jni::ref<javax::lang::model::element::ElementKind> BINDING_VARIABLE() { return get_static_field<"BINDING_VARIABLE", jni::ref<javax::lang::model::element::ElementKind>>(); }
	...
	static jni::ref<javax::lang::model::element::ElementKind> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<javax::lang::model::element::ElementKind>>(name); }
	jboolean isClass() { return call_method<"isClass", jboolean>(); }
	jboolean isInterface() { return call_method<"isInterface", jboolean>(); }
	jboolean isDeclaredType() { return call_method<"isDeclaredType", jboolean>(); }
	jboolean isField() { return call_method<"isField", jboolean>(); }
	jboolean isExecutable() { return call_method<"isExecutable", jboolean>(); }
	jboolean isInitializer() { return call_method<"isInitializer", jboolean>(); }
	jboolean isVariable() { return call_method<"isVariable", jboolean>(); }
};
