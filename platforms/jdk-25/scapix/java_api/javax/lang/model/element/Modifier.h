...
#ifndef SCAPIX_JAVA_API_JAVAX_LANG_MODEL_ELEMENT_MODIFIER
...
public:
	...
	static jni::ref<javax::lang::model::element::Modifier> SEALED() { return get_static_field<"SEALED", jni::ref<javax::lang::model::element::Modifier>>(); }
	static jni::ref<javax::lang::model::element::Modifier> NON_SEALED() { return get_static_field<"NON_SEALED", jni::ref<javax::lang::model::element::Modifier>>(); }
	...
	static jni::ref<javax::lang::model::element::Modifier> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<javax::lang::model::element::Modifier>>(name); }
