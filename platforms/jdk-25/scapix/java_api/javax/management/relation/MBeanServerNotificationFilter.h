...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_RELATION_MBEANSERVERNOTIFICATIONFILTER
...
public:
	...
	static jni::ref<javax::management::relation::MBeanServerNotificationFilter> new_object() { return object_base::new_object(); }
	void disableAllObjectNames() { return call_method<"disableAllObjectNames", void>(); }
	void disableObjectName(jni::ref<javax::management::ObjectName> objectName) { return call_method<"disableObjectName", void>(objectName); }
	void enableAllObjectNames() { return call_method<"enableAllObjectNames", void>(); }
	void enableObjectName(jni::ref<javax::management::ObjectName> objectName) { return call_method<"enableObjectName", void>(objectName); }
	...
	jboolean isNotificationEnabled(jni::ref<javax::management::Notification> notif) { return call_method<"isNotificationEnabled", jboolean>(notif); }
};
