...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_SPI_IMAGEREADERSPI
...
public:
	...
	jboolean isOwnReader(jni::ref<javax::imageio::ImageReader> reader) { return call_method<"isOwnReader", jboolean>(reader); }
