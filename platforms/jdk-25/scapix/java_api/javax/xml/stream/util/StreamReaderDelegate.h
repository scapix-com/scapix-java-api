...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_STREAM_UTIL_STREAMREADERDELEGATE
...
public:
	...
	static jni::ref<javax::xml::stream::util::StreamReaderDelegate> new_object() { return object_base::new_object(); }
	static jni::ref<javax::xml::stream::util::StreamReaderDelegate> new_object(jni::ref<javax::xml::stream::XMLStreamReader> reader) { return object_base::new_object(reader); }
	void setParent(jni::ref<javax::xml::stream::XMLStreamReader> reader) { return call_method<"setParent", void>(reader); }
	...
	void require(jint type, jni::ref<java::lang::String> namespaceURI, jni::ref<java::lang::String> localName) { return call_method<"require", void>(type, namespaceURI, localName); }
	jboolean hasNext() { return call_method<"hasNext", jboolean>(); }
	void close() { return call_method<"close", void>(); }
	jni::ref<java::lang::String> getNamespaceURI(jni::ref<java::lang::String> prefix) { return call_method<"getNamespaceURI", jni::ref<java::lang::String>>(prefix); }
	...
	jni::ref<java::lang::String> getAttributeValue(jni::ref<java::lang::String> namespaceUri, jni::ref<java::lang::String> localName) { return call_method<"getAttributeValue", jni::ref<java::lang::String>>(namespaceUri, localName); }
	jint getAttributeCount() { return call_method<"getAttributeCount", jint>(); }
	jni::ref<javax::xml::namespace_::QName> getAttributeName(jint index) { return call_method<"getAttributeName", jni::ref<javax::xml::namespace_::QName>>(index); }
	jni::ref<java::lang::String> getAttributePrefix(jint index) { return call_method<"getAttributePrefix", jni::ref<java::lang::String>>(index); }
	...
	jni::ref<java::lang::String> getAttributeLocalName(jint index) { return call_method<"getAttributeLocalName", jni::ref<java::lang::String>>(index); }
	jni::ref<java::lang::String> getAttributeType(jint index) { return call_method<"getAttributeType", jni::ref<java::lang::String>>(index); }
	jni::ref<java::lang::String> getAttributeValue(jint index) { return call_method<"getAttributeValue", jni::ref<java::lang::String>>(index); }
	jboolean isAttributeSpecified(jint index) { return call_method<"isAttributeSpecified", jboolean>(index); }
	jint getNamespaceCount() { return call_method<"getNamespaceCount", jint>(); }
	jni::ref<java::lang::String> getNamespacePrefix(jint index) { return call_method<"getNamespacePrefix", jni::ref<java::lang::String>>(index); }
	jni::ref<java::lang::String> getNamespaceURI(jint index) { return call_method<"getNamespaceURI", jni::ref<java::lang::String>>(index); }
	...
	jint getTextCharacters(jint sourceStart, jni::ref<jni::array<jchar>> target, jint targetStart, jint length) { return call_method<"getTextCharacters", jint>(sourceStart, target, targetStart, length); }
