...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_STREAM_XMLINPUTFACTORY
...
public:
	...
	static jni::ref<javax::xml::stream::XMLInputFactory> newDefaultFactory() { return call_static_method<"newDefaultFactory", jni::ref<javax::xml::stream::XMLInputFactory>>(); }
	...
	static jni::ref<javax::xml::stream::XMLInputFactory> newFactory(jni::ref<java::lang::String> factoryId, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"newFactory", jni::ref<javax::xml::stream::XMLInputFactory>>(factoryId, classLoader); }
