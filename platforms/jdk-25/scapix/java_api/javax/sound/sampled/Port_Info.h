...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_PORT_INFO
...
public:
	...
	static jni::ref<javax::sound::sampled::Port_Info> new_object(jni::ref<java::lang::Class> lineClass, jni::ref<java::lang::String> name, jboolean isSource) { return object_base::new_object(lineClass, name, isSource); }
