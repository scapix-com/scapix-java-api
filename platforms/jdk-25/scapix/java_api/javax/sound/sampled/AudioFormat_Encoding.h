...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_AUDIOFORMAT_ENCODING
...
public:
	...
	static jni::ref<javax::sound::sampled::AudioFormat_Encoding> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
