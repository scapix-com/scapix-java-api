...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_SAMPLED_FLOATCONTROL
...
public:
	...
	void setValue(jfloat newValue) { return call_method<"setValue", void>(newValue); }
	...
	void shift(jfloat from, jfloat to, jint microseconds) { return call_method<"shift", void>(from, to, microseconds); }
