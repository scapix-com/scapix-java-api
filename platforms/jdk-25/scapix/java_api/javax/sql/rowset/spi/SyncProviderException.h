...
public:
	...
	static jni::ref<javax::sql::rowset::spi::SyncProviderException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<javax::sql::rowset::spi::SyncProviderException> new_object(jni::ref<javax::sql::rowset::spi::SyncResolver> syncResolver) { return object_base::new_object(syncResolver); }
	...
	void setSyncResolver(jni::ref<javax::sql::rowset::spi::SyncResolver> syncResolver) { return call_method<"setSyncResolver", void>(syncResolver); }
};
