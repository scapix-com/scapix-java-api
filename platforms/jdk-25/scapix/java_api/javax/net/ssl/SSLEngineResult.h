...
#ifndef SCAPIX_JAVA_API_JAVAX_NET_SSL_SSLENGINERESULT
...
public:
	...
	static jni::ref<javax::net::ssl::SSLEngineResult> new_object(jni::ref<javax::net::ssl::SSLEngineResult_Status> status, jni::ref<javax::net::ssl::SSLEngineResult_HandshakeStatus> handshakeStatus, jint bytesConsumed, jint bytesProduced) { return object_base::new_object(status, handshakeStatus, bytesConsumed, bytesProduced); }
	static jni::ref<javax::net::ssl::SSLEngineResult> new_object(jni::ref<javax::net::ssl::SSLEngineResult_Status> status, jni::ref<javax::net::ssl::SSLEngineResult_HandshakeStatus> handshakeStatus, jint bytesConsumed, jint bytesProduced, jlong sequenceNumber) { return object_base::new_object(status, handshakeStatus, bytesConsumed, bytesProduced, sequenceNumber); }
	...
	jlong sequenceNumber() { return call_method<"sequenceNumber", jlong>(); }
