...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_EVENT_TREEEXPANSIONEVENT
...
public:
	...
	static jni::ref<javax::swing::event::TreeExpansionEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<javax::swing::tree::TreePath> path) { return object_base::new_object(source, path); }
