...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_EVENT_TREESELECTIONEVENT
...
public:
	...
	static jni::ref<javax::swing::event::TreeSelectionEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<jni::array<javax::swing::tree::TreePath>> paths, jni::ref<jni::array<jboolean>> areNew, jni::ref<javax::swing::tree::TreePath> oldLeadSelectionPath, jni::ref<javax::swing::tree::TreePath> newLeadSelectionPath) { return object_base::new_object(source, paths, areNew, oldLeadSelectionPath, newLeadSelectionPath); }
	static jni::ref<javax::swing::event::TreeSelectionEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<javax::swing::tree::TreePath> path, jboolean isNew, jni::ref<javax::swing::tree::TreePath> oldLeadSelectionPath, jni::ref<javax::swing::tree::TreePath> newLeadSelectionPath) { return object_base::new_object(source, path, isNew, oldLeadSelectionPath, newLeadSelectionPath); }
	...
	jboolean isAddedPath(jni::ref<javax::swing::tree::TreePath> path) { return call_method<"isAddedPath", jboolean>(path); }
	jboolean isAddedPath(jint index) { return call_method<"isAddedPath", jboolean>(index); }
	...
	jni::ref<java::lang::Object> cloneWithSource(jni::ref<java::lang::Object> newSource) { return call_method<"cloneWithSource", jni::ref<java::lang::Object>>(newSource); }
};
