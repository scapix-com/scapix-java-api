...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PROGRESSMONITORINPUTSTREAM
...
public:
	...
	static jni::ref<javax::swing::ProgressMonitorInputStream> new_object(jni::ref<java::awt::Component> parentComponent, jni::ref<java::lang::Object> message, jni::ref<java::io::InputStream> in) { return object_base::new_object(parentComponent, message, in); }
