...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_SPINNERDATEMODEL
...
public:
	...
	static jni::ref<javax::swing::SpinnerDateModel> new_object(jni::ref<java::util::Date> value, jni::ref<java::lang::Comparable> start, jni::ref<java::lang::Comparable> end, jint calendarField) { return object_base::new_object(value, start, end, calendarField); }
	static jni::ref<javax::swing::SpinnerDateModel> new_object() { return object_base::new_object(); }
	void setStart(jni::ref<java::lang::Comparable> start) { return call_method<"setStart", void>(start); }
	jni::ref<java::lang::Comparable> getStart() { return call_method<"getStart", jni::ref<java::lang::Comparable>>(); }
	void setEnd(jni::ref<java::lang::Comparable> end) { return call_method<"setEnd", void>(end); }
	jni::ref<java::lang::Comparable> getEnd() { return call_method<"getEnd", jni::ref<java::lang::Comparable>>(); }
	void setCalendarField(jint calendarField) { return call_method<"setCalendarField", void>(calendarField); }
