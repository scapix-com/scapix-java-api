...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TREE_DEFAULTTREESELECTIONMODEL
...
public:
	...
	static jni::ref<javax::swing::tree::DefaultTreeSelectionModel> new_object() { return object_base::new_object(); }
	void setRowMapper(jni::ref<javax::swing::tree::RowMapper> newMapper) { return call_method<"setRowMapper", void>(newMapper); }
	jni::ref<javax::swing::tree::RowMapper> getRowMapper() { return call_method<"getRowMapper", jni::ref<javax::swing::tree::RowMapper>>(); }
	void setSelectionMode(jint mode) { return call_method<"setSelectionMode", void>(mode); }
	...
	void setSelectionPaths(jni::ref<jni::array<javax::swing::tree::TreePath>> pPaths) { return call_method<"setSelectionPaths", void>(pPaths); }
	...
	void addTreeSelectionListener(jni::ref<javax::swing::event::TreeSelectionListener> x) { return call_method<"addTreeSelectionListener", void>(x); }
	void removeTreeSelectionListener(jni::ref<javax::swing::event::TreeSelectionListener> x) { return call_method<"removeTreeSelectionListener", void>(x); }
