...
class AbstractDocument_DefaultDocumentEvent;
...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_ABSTRACTDOCUMENT_DEFAULTDOCUMENTEVENT
...
public:
	...
	static jni::ref<javax::swing::text::AbstractDocument_DefaultDocumentEvent> new_object(jni::ref<javax::swing::text::AbstractDocument> this_0, jint offs, jint len, jni::ref<javax::swing::event::DocumentEvent_EventType> type) { return object_base::new_object(this_0, offs, len, type); }
	...
	jni::ref<javax::swing::event::DocumentEvent_ElementChange> getChange(jni::ref<javax::swing::text::Element> elem) { return call_method<"getChange", jni::ref<javax::swing::event::DocumentEvent_ElementChange>>(elem); }
};
