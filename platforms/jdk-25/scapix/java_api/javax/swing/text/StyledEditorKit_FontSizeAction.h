...
class StyledEditorKit_FontSizeAction;
...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_STYLEDEDITORKIT_FONTSIZEACTION
...
public:
	...
	static jni::ref<javax::swing::text::StyledEditorKit_FontSizeAction> new_object(jni::ref<java::lang::String> nm, jint size) { return object_base::new_object(nm, size); }
