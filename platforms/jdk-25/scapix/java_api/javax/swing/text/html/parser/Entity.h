...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_HTML_PARSER_ENTITY
...
public:
	...
	static jni::ref<javax::swing::text::html::parser::Entity> new_object(jni::ref<java::lang::String> name, jint type, jni::ref<jni::array<jchar>> data) { return object_base::new_object(name, type, data); }
