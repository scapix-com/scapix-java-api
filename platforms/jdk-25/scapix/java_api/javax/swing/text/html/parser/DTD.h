...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_HTML_PARSER_DTD
...
public:
	...
	jni::ref<javax::swing::text::html::parser::Entity> getEntity(jni::ref<java::lang::String> name) { return call_method<"getEntity", jni::ref<javax::swing::text::html::parser::Entity>>(name); }
	jni::ref<javax::swing::text::html::parser::Entity> getEntity(jint ch) { return call_method<"getEntity", jni::ref<javax::swing::text::html::parser::Entity>>(ch); }
	jni::ref<javax::swing::text::html::parser::Element> getElement(jni::ref<java::lang::String> name) { return call_method<"getElement", jni::ref<javax::swing::text::html::parser::Element>>(name); }
	jni::ref<javax::swing::text::html::parser::Element> getElement(jint index) { return call_method<"getElement", jni::ref<javax::swing::text::html::parser::Element>>(index); }
	jni::ref<javax::swing::text::html::parser::Entity> defineEntity(jni::ref<java::lang::String> name, jint type, jni::ref<jni::array<jchar>> data) { return call_method<"defineEntity", jni::ref<javax::swing::text::html::parser::Entity>>(name, type, data); }
	jni::ref<javax::swing::text::html::parser::Element> defineElement(jni::ref<java::lang::String> name, jint type, jboolean omitStart, jboolean omitEnd, jni::ref<javax::swing::text::html::parser::ContentModel> content, jni::ref<java::util::BitSet> exclusions, jni::ref<java::util::BitSet> inclusions, jni::ref<javax::swing::text::html::parser::AttributeList> atts) { return call_method<"defineElement", jni::ref<javax::swing::text::html::parser::Element>>(name, type, omitStart, omitEnd, content, exclusions, inclusions, atts); }
	void defineAttributes(jni::ref<java::lang::String> name, jni::ref<javax::swing::text::html::parser::AttributeList> atts) { return call_method<"defineAttributes", void>(name, atts); }
	jni::ref<javax::swing::text::html::parser::Entity> defEntity(jni::ref<java::lang::String> name, jint type, jint ch) { return call_method<"defEntity", jni::ref<javax::swing::text::html::parser::Entity>>(name, type, ch); }
	jni::ref<java::lang::String> toString() { return call_method<"toString", jni::ref<java::lang::String>>(); }
	static void putDTDHash(jni::ref<java::lang::String> name, jni::ref<javax::swing::text::html::parser::DTD> dtd) { return call_static_method<"putDTDHash", void>(name, dtd); }
	static jni::ref<javax::swing::text::html::parser::DTD> getDTD(jni::ref<java::lang::String> name) { return call_static_method<"getDTD", jni::ref<javax::swing::text::html::parser::DTD>>(name); }
	void read(jni::ref<java::io::DataInputStream> in) { return call_method<"read", void>(in); }
};
