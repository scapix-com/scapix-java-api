...
public:
	...
	static void setDefaultQueue(jni::ref<javax::swing::text::LayoutQueue> q) { return call_static_method<"setDefaultQueue", void>(q); }
	void addTask(jni::ref<java::lang::Runnable> task) { return call_method<"addTask", void>(task); }
};
