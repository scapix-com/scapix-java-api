...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_ABSTRACTWRITER
...
public:
	...
	void setLineSeparator(jni::ref<java::lang::String> value) { return call_method<"setLineSeparator", void>(value); }
