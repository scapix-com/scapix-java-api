...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICDIRECTORYMODEL
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicDirectoryModel> new_object(jni::ref<javax::swing::JFileChooser> filechooser) { return object_base::new_object(filechooser); }
	...
	jboolean renameFile(jni::ref<java::io::File> oldFile, jni::ref<java::io::File> newFile) { return call_method<"renameFile", jboolean>(oldFile, newFile); }
