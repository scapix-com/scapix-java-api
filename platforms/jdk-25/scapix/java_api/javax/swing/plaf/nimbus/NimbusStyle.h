...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_NIMBUS_NIMBUSSTYLE
...
public:
	...
	void installDefaults(jni::ref<javax::swing::plaf::synth::SynthContext> ctx) { return call_method<"installDefaults", void>(ctx); }
	jni::ref<java::awt::Insets> getInsets(jni::ref<javax::swing::plaf::synth::SynthContext> ctx, jni::ref<java::awt::Insets> in) { return call_method<"getInsets", jni::ref<java::awt::Insets>>(ctx, in); }
	jni::ref<javax::swing::plaf::synth::SynthPainter> getPainter(jni::ref<javax::swing::plaf::synth::SynthContext> ctx) { return call_method<"getPainter", jni::ref<javax::swing::plaf::synth::SynthPainter>>(ctx); }
	jboolean isOpaque(jni::ref<javax::swing::plaf::synth::SynthContext> ctx) { return call_method<"isOpaque", jboolean>(ctx); }
	jni::ref<java::lang::Object> get(jni::ref<javax::swing::plaf::synth::SynthContext> ctx, jni::ref<java::lang::Object> key) { return call_method<"get", jni::ref<java::lang::Object>>(ctx, key); }
	jni::ref<javax::swing::Painter> getBackgroundPainter(jni::ref<javax::swing::plaf::synth::SynthContext> ctx) { return call_method<"getBackgroundPainter", jni::ref<javax::swing::Painter>>(ctx); }
	jni::ref<javax::swing::Painter> getForegroundPainter(jni::ref<javax::swing::plaf::synth::SynthContext> ctx) { return call_method<"getForegroundPainter", jni::ref<javax::swing::Painter>>(ctx); }
	jni::ref<javax::swing::Painter> getBorderPainter(jni::ref<javax::swing::plaf::synth::SynthContext> ctx) { return call_method<"getBorderPainter", jni::ref<javax::swing::Painter>>(ctx); }
};
