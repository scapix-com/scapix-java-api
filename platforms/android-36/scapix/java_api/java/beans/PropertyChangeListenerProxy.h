...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_PROPERTYCHANGELISTENERPROXY
...
public:
	...
	static jni::ref<java::beans::PropertyChangeListenerProxy> new_object(jni::ref<java::lang::String> propertyName, jni::ref<java::beans::PropertyChangeListener> listener) { return object_base::new_object(propertyName, listener); }
