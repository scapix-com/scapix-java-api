...
namespace scapix::java_api { namespace java::util { class SortedMap; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::util::SortedMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::Map, scapix::java_api::java::util::SequencedMap>;
};
