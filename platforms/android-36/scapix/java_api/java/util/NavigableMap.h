...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_NAVIGABLEMAP_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_NAVIGABLEMAP_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::util { class NavigableMap; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::NavigableMap>
{
	static constexpr fixed_string class_name = "java/util/NavigableMap";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::SortedMap>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_UTIL_NAVIGABLEMAP_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_NAVIGABLEMAP)
#define SCAPIX_JAVA_API_JAVA_UTIL_NAVIGABLEMAP
...
class java::util::NavigableMap : public jni::object_base<"java/util/NavigableMap",
	java::lang::Object,
	java::util::SortedMap>
{
public:
	...
	jni::ref<java::util::NavigableMap> reversed() { return call_method<"reversed", jni::ref<java::util::NavigableMap>>(); }
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_NAVIGABLEMAP
