...
public:
	...
	static jni::ref<java::util::ServiceConfigurationError> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<java::util::ServiceConfigurationError> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(msg, cause); }
};
