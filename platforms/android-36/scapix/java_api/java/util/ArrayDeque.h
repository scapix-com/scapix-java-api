...
struct scapix::jni::object_traits<scapix::java_api::java::util::ArrayDeque>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractCollection, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::Deque, scapix::java_api::java::io::Serializable>;
};
