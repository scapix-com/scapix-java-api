...
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::ConcurrentSkipListSet>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractSet, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::NavigableSet, scapix::java_api::java::io::Serializable>;
};
