...
namespace scapix::java_api { namespace java::util { class HashMap; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::util::HashMap>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractMap, scapix::java_api::java::lang::Cloneable, scapix::java_api::java::util::Map, scapix::java_api::java::io::Serializable>;
};
...
public:
	...
	static jni::ref<java::util::HashMap> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::HashMap> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
	static jni::ref<java::util::HashMap> new_object(jint initialCapacity, jfloat loadFactor) { return object_base::new_object(initialCapacity, loadFactor); }
	static jni::ref<java::util::HashMap> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
