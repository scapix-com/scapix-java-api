...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUTSTREAM_GETFIELD_FWD
#define SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUTSTREAM_GETFIELD_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::io { class ObjectInputStream_GetField; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::io::ObjectInputStream_GetField>
{
	static constexpr fixed_string class_name = "java/io/ObjectInputStream$GetField";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUTSTREAM_GETFIELD_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUTSTREAM_GETFIELD)
#define SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUTSTREAM_GETFIELD
...
class java::io::ObjectInputStream_GetField : public jni::object_base<"java/io/ObjectInputStream$GetField",
	java::lang::Object>
{
public:

	static jni::ref<java::io::ObjectInputStream_GetField> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_JAVA_IO_OBJECTINPUTSTREAM_GETFIELD
