...
struct scapix::jni::object_traits<scapix::java_api::java::nio::CharBuffer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::nio::Buffer, scapix::java_api::java::lang::Appendable, scapix::java_api::java::lang::CharSequence, scapix::java_api::java::lang::Comparable, scapix::java_api::java::lang::Readable>;
};
