...
public:
	...
	jni::ref<java::time::chrono::ThaiBuddhistDate> minus(jlong amountToAdd, jni::ref<java::time::temporal::TemporalUnit> unit) { return call_method<"minus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(amountToAdd, unit); }
