...
#ifndef SCAPIX_JAVA_API_ORG_W3C_DOM_DOMIMPLEMENTATION_FWD
#define SCAPIX_JAVA_API_ORG_W3C_DOM_DOMIMPLEMENTATION_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::w3c::dom { class DOMImplementation; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::w3c::dom::DOMImplementation>
{
	static constexpr fixed_string class_name = "org/w3c/dom/DOMImplementation";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_W3C_DOM_DOMIMPLEMENTATION_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_W3C_DOM_DOMIMPLEMENTATION)
#define SCAPIX_JAVA_API_ORG_W3C_DOM_DOMIMPLEMENTATION
...
class org::w3c::dom::DOMImplementation : public jni::object_base<"org/w3c/dom/DOMImplementation",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_ORG_W3C_DOM_DOMIMPLEMENTATION
