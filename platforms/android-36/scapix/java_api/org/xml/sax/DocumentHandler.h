...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_DOCUMENTHANDLER_FWD
#define SCAPIX_JAVA_API_ORG_XML_SAX_DOCUMENTHANDLER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::xml::sax { class DocumentHandler; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::xml::sax::DocumentHandler>
{
	static constexpr fixed_string class_name = "org/xml/sax/DocumentHandler";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_XML_SAX_DOCUMENTHANDLER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_XML_SAX_DOCUMENTHANDLER)
#define SCAPIX_JAVA_API_ORG_XML_SAX_DOCUMENTHANDLER
...
class org::xml::sax::DocumentHandler : public jni::object_base<"org/xml/sax/DocumentHandler",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_ORG_XML_SAX_DOCUMENTHANDLER
