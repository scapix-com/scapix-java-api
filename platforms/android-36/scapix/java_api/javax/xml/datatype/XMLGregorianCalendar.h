...
namespace scapix::java_api { namespace javax::xml::datatype { class XMLGregorianCalendar; }}
...
public:
	...
	static jni::ref<javax::xml::datatype::XMLGregorianCalendar> new_object() { return object_base::new_object(); }
