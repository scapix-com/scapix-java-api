...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_GSM_SMSMESSAGE_FWD
#define SCAPIX_JAVA_API_ANDROID_TELEPHONY_GSM_SMSMESSAGE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace android::telephony::gsm { class SmsMessage; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::android::telephony::gsm::SmsMessage>
{
	static constexpr fixed_string class_name = "android/telephony/gsm/SmsMessage";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ANDROID_TELEPHONY_GSM_SMSMESSAGE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ANDROID_TELEPHONY_GSM_SMSMESSAGE)
#define SCAPIX_JAVA_API_ANDROID_TELEPHONY_GSM_SMSMESSAGE
...
class android::telephony::gsm::SmsMessage : public jni::object_base<"android/telephony/gsm/SmsMessage",
	java::lang::Object>
{
public:
	...
	static jni::ref<android::telephony::gsm::SmsMessage> new_object() { return object_base::new_object(); }
	static jni::ref<jni::array<jint>> calculateLength(jni::ref<java::lang::CharSequence> messageBody, jboolean use7bitOnly) { return call_static_method<"calculateLength", jni::ref<jni::array<jint>>>(messageBody, use7bitOnly); }
	...
	static jni::ref<android::telephony::gsm::SmsMessage> createFromPdu(jni::ref<jni::array<jbyte>> pdu) { return call_static_method<"createFromPdu", jni::ref<android::telephony::gsm::SmsMessage>>(pdu); }
	...
	jni::ref<android::telephony::gsm::SmsMessage_MessageClass> getMessageClass() { return call_method<"getMessageClass", jni::ref<android::telephony::gsm::SmsMessage_MessageClass>>(); }
	...
	static jni::ref<android::telephony::gsm::SmsMessage_SubmitPdu> getSubmitPdu(jni::ref<java::lang::String> scAddress, jni::ref<java::lang::String> destinationAddress, jni::ref<java::lang::String> message, jboolean statusReportRequested) { return call_static_method<"getSubmitPdu", jni::ref<android::telephony::gsm::SmsMessage_SubmitPdu>>(scAddress, destinationAddress, message, statusReportRequested); }
	static jni::ref<android::telephony::gsm::SmsMessage_SubmitPdu> getSubmitPdu(jni::ref<java::lang::String> scAddress, jni::ref<java::lang::String> destinationAddress, jshort destinationPort, jni::ref<jni::array<jbyte>> data, jboolean statusReportRequested) { return call_static_method<"getSubmitPdu", jni::ref<android::telephony::gsm::SmsMessage_SubmitPdu>>(scAddress, destinationAddress, destinationPort, data, statusReportRequested); }
...
#endif // SCAPIX_JAVA_API_ANDROID_TELEPHONY_GSM_SMSMESSAGE
