...
class AppOpsManager_OnOpChangedListener;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_APPOPSMANAGER_ONOPCHANGEDLISTENER
...
public:
	...
	void onOpChanged(jni::ref<java::lang::String> op, jni::ref<java::lang::String> packageName, jint userId, jni::ref<java::lang::String> persistentDeviceId) { return call_method<"onOpChanged", void>(op, packageName, userId, persistentDeviceId); }
};
