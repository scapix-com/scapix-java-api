...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_STARTFOREGROUNDCALLEDONSTOPPEDSERVICEEXCEPTION
...
public:
	...
	static jni::ref<android::app::StartForegroundCalledOnStoppedServiceException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
