...
namespace scapix::java_api { namespace android::icu::number { class FormattedNumber; }}
...
public:
	...
	jni::ref<android::icu::util::MeasureUnit> getOutputUnit() { return call_method<"getOutputUnit", jni::ref<android::icu::util::MeasureUnit>>(); }
