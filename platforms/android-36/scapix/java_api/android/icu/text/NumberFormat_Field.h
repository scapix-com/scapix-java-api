...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_NUMBERFORMAT_FIELD
...
public:
	...
	static jni::ref<android::icu::text::NumberFormat_Field> APPROXIMATELY_SIGN() { return get_static_field<"APPROXIMATELY_SIGN", jni::ref<android::icu::text::NumberFormat_Field>>(); }
	static jni::ref<android::icu::text::NumberFormat_Field> COMPACT() { return get_static_field<"COMPACT", jni::ref<android::icu::text::NumberFormat_Field>>(); }
	...
	static jni::ref<android::icu::text::NumberFormat_Field> MEASURE_UNIT() { return get_static_field<"MEASURE_UNIT", jni::ref<android::icu::text::NumberFormat_Field>>(); }
