...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_FINGERPRINT_FINGERPRINTMANAGER_CRYPTOOBJECT
...
public:
	...
	static jni::ref<android::hardware::fingerprint::FingerprintManager_CryptoObject> new_object(jni::ref<java::security::Signature> signature) { return object_base::new_object(signature); }
	static jni::ref<android::hardware::fingerprint::FingerprintManager_CryptoObject> new_object(jni::ref<javax::crypto::Cipher> cipher) { return object_base::new_object(cipher); }
	static jni::ref<android::hardware::fingerprint::FingerprintManager_CryptoObject> new_object(jni::ref<javax::crypto::Mac> mac) { return object_base::new_object(mac); }
