...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_HTTPEXCEPTION
...
public:
	...
	static jni::ref<android::net::http::HttpException> new_object(jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(message, cause); }
};
