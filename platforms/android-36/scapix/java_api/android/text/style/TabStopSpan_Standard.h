...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_TABSTOPSPAN_STANDARD
...
public:
	...
	static jni::ref<android::text::style::TabStopSpan_Standard> new_object(jint offset) { return object_base::new_object(offset); }
