...
namespace scapix::java_api { namespace android::provider { class CalendarContract_EventsEntity; }}
...
struct scapix::jni::object_traits<scapix::java_api::android::provider::CalendarContract_EventsEntity>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::android::provider::BaseColumns, scapix::java_api::android::provider::CalendarContract_EventsColumns, scapix::java_api::android::provider::CalendarContract_SyncColumns>;
};
