...
namespace scapix::java_api { namespace android::provider { class Contacts_Intents_Insert; }}
...
public:
	...
	static jni::ref<android::provider::Contacts_Intents_Insert> new_object() { return object_base::new_object(); }
