...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMECOLORFILTER_FWD
#define SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMECOLORFILTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace android::graphics { class RuntimeColorFilter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::android::graphics::RuntimeColorFilter>
{
	static constexpr fixed_string class_name = "android/graphics/RuntimeColorFilter";
	using base_classes = std::tuple<scapix::java_api::android::graphics::ColorFilter>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMECOLORFILTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMECOLORFILTER)
#define SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMECOLORFILTER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/graphics/Color.h>
#include <scapix/java_api/android/graphics/RuntimeXfermode.h>
...
class android::graphics::RuntimeColorFilter : public jni::object_base<"android/graphics/RuntimeColorFilter",
	android::graphics::ColorFilter>
{
public:

	static jni::ref<android::graphics::RuntimeColorFilter> new_object(jni::ref<java::lang::String> agsl) { return object_base::new_object(agsl); }
...
#endif // SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMECOLORFILTER
