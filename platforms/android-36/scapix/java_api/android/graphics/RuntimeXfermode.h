...
namespace scapix::java_api { namespace android::graphics { class RuntimeXfermode; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ANDROID_GRAPHICS_RUNTIMEXFERMODE)
