...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYWINDOWINFO
...
public:
	...
	static jint TYPE_MAGNIFICATION_OVERLAY() { return get_static_field<"TYPE_MAGNIFICATION_OVERLAY", jint>(); }
	...
	static jint TYPE_WINDOW_CONTROL() { return get_static_field<"TYPE_WINDOW_CONTROL", jint>(); }

	static jni::ref<android::view::accessibility::AccessibilityWindowInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::view::accessibility::AccessibilityWindowInfo> new_object(jni::ref<android::view::accessibility::AccessibilityWindowInfo> info) { return object_base::new_object(info); }
	...
	void getRegionInScreen(jni::ref<android::graphics::Region> outRegion) { return call_method<"getRegionInScreen", void>(outRegion); }
	...
	jni::ref<android::view::accessibility::AccessibilityNodeInfo> getRoot(jint prefetchingStrategy) { return call_method<"getRoot", jni::ref<android::view::accessibility::AccessibilityNodeInfo>>(prefetchingStrategy); }
	jni::ref<java::lang::CharSequence> getTitle() { return call_method<"getTitle", jni::ref<java::lang::CharSequence>>(); }
	jlong getTransitionTimeMillis() { return call_method<"getTransitionTimeMillis", jlong>(); }
