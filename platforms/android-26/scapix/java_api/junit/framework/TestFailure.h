...
#ifndef SCAPIX_JAVA_API_JUNIT_FRAMEWORK_TESTFAILURE
...
public:
	...
	static jni::ref<junit::framework::TestFailure> new_object(jni::ref<junit::framework::Test> failedTest, jni::ref<java::lang::Throwable> thrownException) { return object_base::new_object(failedTest, thrownException); }
