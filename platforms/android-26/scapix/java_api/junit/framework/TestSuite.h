...
#ifndef SCAPIX_JAVA_API_JUNIT_FRAMEWORK_TESTSUITE
...
public:
	...
	static jni::ref<junit::framework::TestSuite> new_object() { return object_base::new_object(); }
	static jni::ref<junit::framework::TestSuite> new_object(jni::ref<java::lang::Class> theClass) { return object_base::new_object(theClass); }
	static jni::ref<junit::framework::TestSuite> new_object(jni::ref<java::lang::Class> theClass, jni::ref<java::lang::String> name) { return object_base::new_object(theClass, name); }
	static jni::ref<junit::framework::TestSuite> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<junit::framework::TestSuite> new_object(jni::ref<jni::array<java::lang::Class>> classes) { return object_base::new_object(classes); }
	static jni::ref<junit::framework::TestSuite> new_object(jni::ref<jni::array<java::lang::Class>> classes, jni::ref<java::lang::String> name) { return object_base::new_object(classes, name); }
