...
public:
	...
	static jni::ref<javax::crypto::spec::PBEParameterSpec> new_object(jni::ref<jni::array<jbyte>> salt, jint iterationCount, jni::ref<java::security::spec::AlgorithmParameterSpec> paramSpec) { return base_::new_object(salt, iterationCount, paramSpec); }
