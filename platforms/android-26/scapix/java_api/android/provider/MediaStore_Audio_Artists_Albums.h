...
class MediaStore_Audio_Artists_Albums;
...
struct scapix::jni::object_traits<scapix::java_api::android::provider::MediaStore_Audio_Artists_Albums>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::android::provider::MediaStore_Audio_AlbumColumns>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_AUDIO_ARTISTS_ALBUMS
...
public:
	...
	static jni::ref<android::provider::MediaStore_Audio_Artists_Albums> new_object() { return object_base::new_object(); }
