...
#ifndef SCAPIX_JAVA_API_ANDROID_OPENGL_GLSURFACEVIEW
...
public:
	...
	static jni::ref<android::opengl::GLSurfaceView> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::opengl::GLSurfaceView> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	...
	void surfaceRedrawNeededAsync(jni::ref<android::view::SurfaceHolder> holder, jni::ref<java::lang::Runnable> finishDrawing) { return call_method<"surfaceRedrawNeededAsync", void>(holder, finishDrawing); }
