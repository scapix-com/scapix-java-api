...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_DOWNLOADMANAGER
...
public:
	...
	jlong addCompletedDownload(jni::ref<java::lang::String> title, jni::ref<java::lang::String> description, jboolean isMediaScannerScannable, jni::ref<java::lang::String> mimeType, jni::ref<java::lang::String> path, jlong length, jboolean showNotification) { return call_method<"addCompletedDownload", jlong>(title, description, isMediaScannerScannable, mimeType, path, length, showNotification); }
	jlong addCompletedDownload(jni::ref<java::lang::String> title, jni::ref<java::lang::String> description, jboolean isMediaScannerScannable, jni::ref<java::lang::String> mimeType, jni::ref<java::lang::String> path, jlong length, jboolean showNotification, jni::ref<android::net::Uri> uri, jni::ref<android::net::Uri> referer) { return call_method<"addCompletedDownload", jlong>(title, description, isMediaScannerScannable, mimeType, path, length, showNotification, uri, referer); }
};
