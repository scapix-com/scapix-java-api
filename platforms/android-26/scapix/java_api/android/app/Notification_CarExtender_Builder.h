...
class Notification_CarExtender_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_NOTIFICATION_CAREXTENDER_BUILDER
...
public:
	...
	static jni::ref<android::app::Notification_CarExtender_Builder> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
