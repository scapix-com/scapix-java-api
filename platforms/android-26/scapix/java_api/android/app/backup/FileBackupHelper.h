...
namespace scapix::java_api { namespace android::app::backup { class FileBackupHelper; }}
...
public:
	...
	static jni::ref<android::app::backup::FileBackupHelper> new_object(jni::ref<android::content::Context> context, jni::ref<jni::array<java::lang::String>> files) { return object_base::new_object(context, files); }
