...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_FACEDETECTOR
...
public:
	...
	static jni::ref<android::media::FaceDetector> new_object(jint width, jint height, jint maxFaces) { return object_base::new_object(width, height, maxFaces); }
