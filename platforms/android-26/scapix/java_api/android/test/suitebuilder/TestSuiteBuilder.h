...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_SUITEBUILDER_TESTSUITEBUILDER
...
public:
	...
	static jni::ref<android::test::suitebuilder::TestSuiteBuilder> new_object(jni::ref<java::lang::Class> clazz) { return object_base::new_object(clazz); }
	static jni::ref<android::test::suitebuilder::TestSuiteBuilder> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::ClassLoader> classLoader) { return object_base::new_object(name, classLoader); }
