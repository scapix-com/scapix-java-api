...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTENTPROVIDER
...
public:
	...
	static jni::ref<android::test::mock::MockContentProvider> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::test::mock::MockContentProvider> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> readPermission, jni::ref<java::lang::String> writePermission, jni::ref<jni::array<android::content::pm::PathPermission>> pathPermissions) { return object_base::new_object(context, readPermission, writePermission, pathPermissions); }
