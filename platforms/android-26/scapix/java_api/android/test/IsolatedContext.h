...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_ISOLATEDCONTEXT
...
public:
	...
	static jni::ref<android::test::IsolatedContext> new_object(jni::ref<android::content::ContentResolver> resolver, jni::ref<android::content::Context> targetContext) { return object_base::new_object(resolver, targetContext); }
