...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_MEASUREFORMAT
...
public:
	...
	jni::ref<java::lang::StringBuilder> formatMeasures(jni::ref<java::lang::StringBuilder> appendTo, jni::ref<java::text::FieldPosition> fieldPosition, jni::ref<jni::array<android::icu::util::Measure>> measures) { return call_method<"formatMeasures", jni::ref<java::lang::StringBuilder>>(appendTo, fieldPosition, measures); }
