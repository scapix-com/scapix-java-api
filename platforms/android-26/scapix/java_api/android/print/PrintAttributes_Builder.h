...
#ifndef SCAPIX_JAVA_API_ANDROID_PRINT_PRINTATTRIBUTES_BUILDER
...
public:
	...
	static jni::ref<android::print::PrintAttributes_Builder> new_object() { return object_base::new_object(); }
