...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ANIMATION_TRANSFORMATION
...
public:
	...
	static jni::ref<android::view::animation::Transformation> new_object() { return object_base::new_object(); }
