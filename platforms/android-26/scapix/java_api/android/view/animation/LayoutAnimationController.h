...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ANIMATION_LAYOUTANIMATIONCONTROLLER
...
public:
	...
	static jni::ref<android::view::animation::LayoutAnimationController> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::view::animation::LayoutAnimationController> new_object(jni::ref<android::view::animation::Animation> animation) { return object_base::new_object(animation); }
	static jni::ref<android::view::animation::LayoutAnimationController> new_object(jni::ref<android::view::animation::Animation> animation, jfloat delay) { return object_base::new_object(animation, delay); }
