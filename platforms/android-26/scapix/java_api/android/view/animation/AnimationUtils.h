...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ANIMATION_ANIMATIONUTILS
...
public:
	...
	static jni::ref<android::view::animation::AnimationUtils> new_object() { return object_base::new_object(); }
