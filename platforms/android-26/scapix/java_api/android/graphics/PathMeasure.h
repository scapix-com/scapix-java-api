...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_PATHMEASURE
...
public:
	...
	static jni::ref<android::graphics::PathMeasure> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::PathMeasure> new_object(jni::ref<android::graphics::Path> path, jboolean forceClosed) { return object_base::new_object(path, forceClosed); }
