...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_BIDI
...
public:
	...
	static jni::ref<java::text::Bidi> new_object(jni::ref<java::lang::String> paragraph, jint flags) { return object_base::new_object(paragraph, flags); }
	static jni::ref<java::text::Bidi> new_object(jni::ref<java::text::AttributedCharacterIterator> paragraph) { return object_base::new_object(paragraph); }
	static jni::ref<java::text::Bidi> new_object(jni::ref<jni::array<jchar>> text, jint textStart, jni::ref<jni::array<jbyte>> embeddings, jint embStart, jint paragraphLength, jint flags) { return object_base::new_object(text, textStart, embeddings, embStart, paragraphLength, flags); }
