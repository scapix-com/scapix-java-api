...
public:
	...
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::Throwable> thrown) { return object_base::new_object(thrown); }
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
