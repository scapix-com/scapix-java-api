...
public:
	...
	static jni::ref<java::lang::ClassNotFoundException> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	static jni::ref<java::lang::ClassNotFoundException> new_object(jni::ref<java::lang::String> s, jni::ref<java::lang::Throwable> ex) { return object_base::new_object(s, ex); }
