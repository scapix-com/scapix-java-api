...
public:
	...
	static jni::ref<java::math::MathContext> new_object(jint precision) { return object_base::new_object(precision); }
	static jni::ref<java::math::MathContext> new_object(jint precision, jni::ref<java::math::RoundingMode> roundingMode) { return object_base::new_object(precision, roundingMode); }
	static jni::ref<java::math::MathContext> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
