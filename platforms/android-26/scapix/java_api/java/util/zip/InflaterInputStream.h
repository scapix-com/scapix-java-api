...
public:
	...
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<java::util::zip::Inflater> inf, jint size) { return base_::new_object(in, inf, size); }
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<java::util::zip::Inflater> inf) { return base_::new_object(in, inf); }
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> in) { return base_::new_object(in); }
