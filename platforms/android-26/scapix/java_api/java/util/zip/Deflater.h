...
public:
	...
	jint deflate(jni::ref<jni::array<jbyte>> b, jint off, jint len) { return call_method<"deflate", jint>(b, off, len); }
	jint deflate(jni::ref<jni::array<jbyte>> b) { return call_method<"deflate", jint>(b); }
	jint deflate(jni::ref<jni::array<jbyte>> b, jint off, jint len, jint flush) { return call_method<"deflate", jint>(b, off, len, flush); }
