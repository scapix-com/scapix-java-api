...
public:
	...
	static jni::ref<java::util::concurrent::atomic::DoubleAccumulator> new_object(jni::ref<java::util::function::DoubleBinaryOperator> accumulatorFunction, jdouble identity) { return object_base::new_object(accumulatorFunction, identity); }
