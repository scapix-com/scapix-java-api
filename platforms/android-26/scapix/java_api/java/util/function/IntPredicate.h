...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_FUNCTION_INTPREDICATE
...
public:
	...
	jni::ref<java::util::function::IntPredicate> and_(jni::ref<java::util::function::IntPredicate> other) { return call_method<"and", jni::ref<java::util::function::IntPredicate>>(other); }
	jni::ref<java::util::function::IntPredicate> negate() { return call_method<"negate", jni::ref<java::util::function::IntPredicate>>(); }
	jni::ref<java::util::function::IntPredicate> or_(jni::ref<java::util::function::IntPredicate> other) { return call_method<"or", jni::ref<java::util::function::IntPredicate>>(other); }
};
