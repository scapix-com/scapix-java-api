...
public:
	...
	static jni::ref<java::sql::SQLWarning> new_object(jni::ref<java::lang::String> reason, jni::ref<java::lang::String> SQLState, jint vendorCode) { return base_::new_object(reason, SQLState, vendorCode); }
	static jni::ref<java::sql::SQLWarning> new_object(jni::ref<java::lang::String> reason, jni::ref<java::lang::String> SQLState) { return base_::new_object(reason, SQLState); }
	static jni::ref<java::sql::SQLWarning> new_object(jni::ref<java::lang::String> reason) { return base_::new_object(reason); }
