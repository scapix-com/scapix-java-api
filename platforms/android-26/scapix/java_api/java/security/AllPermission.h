...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_ALLPERMISSION
...
public:
	...
	static jni::ref<java::security::AllPermission> new_object() { return object_base::new_object(); }
	static jni::ref<java::security::AllPermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions) { return object_base::new_object(name, actions); }
