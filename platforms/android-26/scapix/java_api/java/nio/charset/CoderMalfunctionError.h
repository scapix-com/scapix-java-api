...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHARSET_CODERMALFUNCTIONERROR
...
public:
	...
	static jni::ref<java::nio::charset::CoderMalfunctionError> new_object(jni::ref<java::lang::Exception> cause) { return object_base::new_object(cause); }
};
