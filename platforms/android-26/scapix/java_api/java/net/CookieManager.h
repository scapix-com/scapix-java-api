...
public:
	...
	static jni::ref<java::net::CookieManager> new_object(jni::ref<java::net::CookieStore> store, jni::ref<java::net::CookiePolicy> cookiePolicy) { return object_base::new_object(store, cookiePolicy); }
