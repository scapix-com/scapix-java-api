...
public:
	...
	static jni::ref<java::util::concurrent::Semaphore> new_object(jint permits) { return object_base::new_object(permits); }
	static jni::ref<java::util::concurrent::Semaphore> new_object(jint permits, jboolean fair) { return object_base::new_object(permits, fair); }
	...
	jboolean tryAcquire(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"tryAcquire", jboolean>(timeout, unit); }
	...
	jboolean tryAcquire(jint permits, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"tryAcquire", jboolean>(permits, timeout, unit); }
