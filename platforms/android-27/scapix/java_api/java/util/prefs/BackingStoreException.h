...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_PREFS_BACKINGSTOREEXCEPTION
...
public:
	...
	static jni::ref<java::util::prefs::BackingStoreException> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	static jni::ref<java::util::prefs::BackingStoreException> new_object(jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cause); }
};
