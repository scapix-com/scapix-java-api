...
#ifndef SCAPIX_JAVA_API_JAVA_NET_HTTPRETRYEXCEPTION
...
public:
	...
	static jni::ref<java::net::HttpRetryException> new_object(jni::ref<java::lang::String> detail, jint code) { return object_base::new_object(detail, code); }
	static jni::ref<java::net::HttpRetryException> new_object(jni::ref<java::lang::String> detail, jint code, jni::ref<java::lang::String> location) { return object_base::new_object(detail, code, location); }
