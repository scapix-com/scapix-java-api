...
#ifndef SCAPIX_JAVA_API_JAVA_NET_URISYNTAXEXCEPTION
...
public:
	...
	static jni::ref<java::net::URISyntaxException> new_object(jni::ref<java::lang::String> input, jni::ref<java::lang::String> reason, jint index) { return object_base::new_object(input, reason, index); }
	static jni::ref<java::net::URISyntaxException> new_object(jni::ref<java::lang::String> input, jni::ref<java::lang::String> reason) { return object_base::new_object(input, reason); }
