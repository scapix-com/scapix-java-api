...
public:
	...
	jni::ref<java::time::temporal::Temporal> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> p2) { return call_method<"minus", jni::ref<java::time::temporal::Temporal>>(amountToSubtract, p2); }
