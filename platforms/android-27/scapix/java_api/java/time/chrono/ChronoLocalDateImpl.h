...
namespace scapix::java_api { namespace java::time::chrono { class ChronoLocalDateImpl; }}
...
public:
	...
	jni::ref<java::time::chrono::ChronoLocalDate> with(jni::ref<java::time::temporal::TemporalField> field, jlong value) { return call_method<"with", jni::ref<java::time::chrono::ChronoLocalDate>>(field, value); }
