...
public:
	...
	static jni::ref<java::text::FieldPosition> new_object(jni::ref<java::text::Format_Field> attribute, jint fieldID) { return object_base::new_object(attribute, fieldID); }
