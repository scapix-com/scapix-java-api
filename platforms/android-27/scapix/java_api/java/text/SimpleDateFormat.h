...
public:
	...
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::util::Locale> locale) { return base_::new_object(pattern, locale); }
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::text::DateFormatSymbols> formatSymbols) { return base_::new_object(pattern, formatSymbols); }
