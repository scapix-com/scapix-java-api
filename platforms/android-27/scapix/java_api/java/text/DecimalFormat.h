...
public:
	...
	static jni::ref<java::text::DecimalFormat> new_object(jni::ref<java::lang::String> pattern, jni::ref<java::text::DecimalFormatSymbols> symbols) { return object_base::new_object(pattern, symbols); }
