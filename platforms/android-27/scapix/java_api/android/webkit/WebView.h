...
public:
	...
	static void setSafeBrowsingWhitelist(jni::ref<java::util::List> urls, jni::ref<android::webkit::ValueCallback> callback) { return call_static_method<"setSafeBrowsingWhitelist", void>(urls, callback); }
