...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_ANIMATION_ANIMATIONSET
...
public:
	...
	static jni::ref<android::view::animation::AnimationSet> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::view::animation::AnimationSet> new_object(jboolean shareInterpolator) { return object_base::new_object(shareInterpolator); }
	...
	jboolean getTransformation(jlong currentTime, jni::ref<android::view::animation::Transformation> t) { return call_method<"getTransformation", jboolean>(currentTime, t); }
