...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_PROVIDERTESTCASE2
...
public:
	...
	static jni::ref<android::test::ProviderTestCase2> new_object(jni::ref<java::lang::Class> providerClass, jni::ref<java::lang::String> providerAuthority) { return object_base::new_object(providerClass, providerAuthority); }
