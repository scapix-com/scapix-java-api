...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_INSTRUMENTATIONTESTSUITE
...
public:
	...
	static jni::ref<android::test::InstrumentationTestSuite> new_object(jni::ref<android::app::Instrumentation> instr) { return object_base::new_object(instr); }
	static jni::ref<android::test::InstrumentationTestSuite> new_object(jni::ref<java::lang::String> name, jni::ref<android::app::Instrumentation> instr) { return object_base::new_object(name, instr); }
	static jni::ref<android::test::InstrumentationTestSuite> new_object(jni::ref<java::lang::Class> theClass, jni::ref<android::app::Instrumentation> instr) { return object_base::new_object(theClass, instr); }
