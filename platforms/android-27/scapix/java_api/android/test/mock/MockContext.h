...
namespace scapix::java_api::android::test::mock { class MockContext; }
...
public:
	...
	static jni::ref<android::test::mock::MockContext> new_object() { return base_::new_object(); }
...
protected:
	...
	MockContext(handle_type h) : base_(h) {}
