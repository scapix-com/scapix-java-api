...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTEXT_FWD
#define SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTEXT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace android::test::mock { class MockContext; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::android::test::mock::MockContext>
{
	static constexpr fixed_string class_name = "android/test/mock/MockContext";
	using base_classes = std::tuple<scapix::java_api::android::content::Context>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTEXT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTEXT)
#define SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTEXT
...
class android::test::mock::MockContext : public jni::object_base<"android/test/mock/MockContext",
	android::content::Context>
{
public:

	static jni::ref<android::test::mock::MockContext> new_object() { return object_base::new_object(); }
	...
	jni::ref<android::database::sqlite::SQLiteDatabase> openOrCreateDatabase(jni::ref<java::lang::String> file, jint mode, jni::ref<android::database::sqlite::SQLiteDatabase_CursorFactory> factory) { return call_method<"openOrCreateDatabase", jni::ref<android::database::sqlite::SQLiteDatabase>>(file, mode, factory); }
	jni::ref<android::database::sqlite::SQLiteDatabase> openOrCreateDatabase(jni::ref<java::lang::String> file, jint mode, jni::ref<android::database::sqlite::SQLiteDatabase_CursorFactory> factory, jni::ref<android::database::DatabaseErrorHandler> errorHandler) { return call_method<"openOrCreateDatabase", jni::ref<android::database::sqlite::SQLiteDatabase>>(file, mode, factory, errorHandler); }
	...
	jboolean stopService(jni::ref<android::content::Intent> service) { return call_method<"stopService", jboolean>(service); }
...
#endif // SCAPIX_JAVA_API_ANDROID_TEST_MOCK_MOCKCONTEXT
