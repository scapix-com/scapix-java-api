...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_ACTIVITYINSTRUMENTATIONTESTCASE2
...
public:
	...
	static jni::ref<android::test::ActivityInstrumentationTestCase2> new_object(jni::ref<java::lang::String> pkg, jni::ref<java::lang::Class> activityClass) { return object_base::new_object(pkg, activityClass); }
	static jni::ref<android::test::ActivityInstrumentationTestCase2> new_object(jni::ref<java::lang::Class> activityClass) { return object_base::new_object(activityClass); }
