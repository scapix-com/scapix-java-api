...
#ifndef SCAPIX_JAVA_API_ANDROID_TEST_RENAMINGDELEGATINGCONTEXT
...
public:
	...
	static jni::ref<android::test::RenamingDelegatingContext> new_object(jni::ref<android::content::Context> context, jni::ref<java::lang::String> filePrefix) { return object_base::new_object(context, filePrefix); }
	static jni::ref<android::test::RenamingDelegatingContext> new_object(jni::ref<android::content::Context> context, jni::ref<android::content::Context> fileContext, jni::ref<java::lang::String> filePrefix) { return object_base::new_object(context, fileContext, filePrefix); }
