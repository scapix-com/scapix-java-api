...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODEC_BUFFERINFO
...
public:
	...
	static jni::ref<android::media::MediaCodec_BufferInfo> new_object() { return object_base::new_object(); }
	void set(jint newOffset, jint newSize, jlong newTimeUs, jint newFlags) { return call_method<"set", void>(newOffset, newSize, newTimeUs, newFlags); }
};
