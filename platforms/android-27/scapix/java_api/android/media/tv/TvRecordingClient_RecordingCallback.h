...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_TV_TVRECORDINGCLIENT_RECORDINGCALLBACK
...
public:
	...
	static jni::ref<android::media::tv::TvRecordingClient_RecordingCallback> new_object() { return object_base::new_object(); }
