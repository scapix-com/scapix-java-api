...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIACODECLIST
...
public:
	...
	static jni::ref<android::media::MediaCodecList> new_object(jint kind) { return object_base::new_object(kind); }
