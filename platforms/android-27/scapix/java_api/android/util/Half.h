...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_HALF
...
public:
	...
	static jni::ref<android::util::Half> new_object(jshort value) { return object_base::new_object(value); }
	static jni::ref<android::util::Half> new_object(jfloat value) { return object_base::new_object(value); }
	static jni::ref<android::util::Half> new_object(jdouble value) { return object_base::new_object(value); }
	static jni::ref<android::util::Half> new_object(jni::ref<java::lang::String> value) { return object_base::new_object(value); }
