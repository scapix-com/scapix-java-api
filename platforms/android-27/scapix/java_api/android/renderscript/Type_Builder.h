...
#ifndef SCAPIX_JAVA_API_ANDROID_RENDERSCRIPT_TYPE_BUILDER
...
public:
	...
	static jni::ref<android::renderscript::Type_Builder> new_object(jni::ref<android::renderscript::RenderScript> rs, jni::ref<android::renderscript::Element> e) { return object_base::new_object(rs, e); }
