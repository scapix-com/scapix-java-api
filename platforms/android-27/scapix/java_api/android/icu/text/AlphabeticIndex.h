...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_ALPHABETICINDEX
...
public:
	...
	static jni::ref<android::icu::text::AlphabeticIndex> new_object(jni::ref<android::icu::util::ULocale> locale) { return object_base::new_object(locale); }
	static jni::ref<android::icu::text::AlphabeticIndex> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
	static jni::ref<android::icu::text::AlphabeticIndex> new_object(jni::ref<android::icu::text::RuleBasedCollator> collator) { return object_base::new_object(collator); }
