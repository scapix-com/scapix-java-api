...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_SSLCERTIFICATE
...
public:
	...
	static jni::ref<android::net::http::SslCertificate> new_object(jni::ref<java::lang::String> issuedTo, jni::ref<java::lang::String> issuedBy, jni::ref<java::lang::String> validNotBefore, jni::ref<java::lang::String> validNotAfter) { return object_base::new_object(issuedTo, issuedBy, validNotBefore, validNotAfter); }
	static jni::ref<android::net::http::SslCertificate> new_object(jni::ref<java::lang::String> issuedTo, jni::ref<java::lang::String> issuedBy, jni::ref<java::util::Date> validNotBefore, jni::ref<java::util::Date> validNotAfter) { return object_base::new_object(issuedTo, issuedBy, validNotBefore, validNotAfter); }
	static jni::ref<android::net::http::SslCertificate> new_object(jni::ref<java::security::cert::X509Certificate> certificate) { return object_base::new_object(certificate); }
