...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FRAGMENTMANAGER_FRAGMENTLIFECYCLECALLBACKS
...
public:
	...
	static jni::ref<android::app::FragmentManager_FragmentLifecycleCallbacks> new_object() { return object_base::new_object(); }
