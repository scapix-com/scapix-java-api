...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FRAGMENT
...
public:
	...
	static jni::ref<android::app::Fragment> new_object() { return object_base::new_object(); }
	...
	void onAttachFragment(jni::ref<android::app::Fragment> childFragment) { return call_method<"onAttachFragment", void>(childFragment); }
