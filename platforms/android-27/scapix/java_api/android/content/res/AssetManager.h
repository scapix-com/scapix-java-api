...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_ASSETMANAGER
...
public:
	...
	jni::ref<jni::array<java::lang::String>> list(jni::ref<java::lang::String> p1) { return call_method<"list", jni::ref<jni::array<java::lang::String>>>(p1); }
