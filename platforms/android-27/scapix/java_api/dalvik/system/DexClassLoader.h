...
public:
	...
	static jni::ref<dalvik::system::DexClassLoader> new_object(jni::ref<java::lang::String> dexPath, jni::ref<java::lang::String> optimizedDirectory, jni::ref<java::lang::String> librarySearchPath, jni::ref<java::lang::ClassLoader> parent) { return base_::new_object(dexPath, optimizedDirectory, librarySearchPath, parent); }
