...
#ifndef SCAPIX_JAVA_API_ORG_W3C_DOM_LS_LSEXCEPTION
...
public:
	...
	static jni::ref<org::w3c::dom::ls::LSException> new_object(jshort code, jni::ref<java::lang::String> message) { return object_base::new_object(code, message); }
};
