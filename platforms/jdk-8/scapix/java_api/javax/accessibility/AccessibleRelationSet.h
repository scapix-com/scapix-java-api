...
public:
	...
	static jni::ref<javax::accessibility::AccessibleRelationSet> new_object(jni::ref<jni::array<javax::accessibility::AccessibleRelation>> p1) { return object_base::new_object(p1); }
