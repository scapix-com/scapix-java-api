...
public:
	...
	static jni::ref<javax::net::ssl::SSLParameters> new_object(jni::ref<jni::array<java::lang::String>> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::net::ssl::SSLParameters> new_object(jni::ref<jni::array<java::lang::String>> p1, jni::ref<jni::array<java::lang::String>> p2) { return object_base::new_object(p1, p2); }
