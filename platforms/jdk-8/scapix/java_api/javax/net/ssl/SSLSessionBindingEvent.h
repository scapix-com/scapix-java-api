...
public:
	...
	static jni::ref<javax::net::ssl::SSLSessionBindingEvent> new_object(jni::ref<javax::net::ssl::SSLSession> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
