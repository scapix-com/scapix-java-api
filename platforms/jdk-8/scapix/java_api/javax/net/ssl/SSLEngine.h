...
#ifndef SCAPIX_JAVA_API_JAVAX_NET_SSL_SSLENGINE
...
public:
	...
	jni::ref<javax::net::ssl::SSLEngineResult> wrap(jni::ref<java::nio::ByteBuffer> p1, jni::ref<java::nio::ByteBuffer> p2) { return call_method<"wrap", jni::ref<javax::net::ssl::SSLEngineResult>>(p1, p2); }
	jni::ref<javax::net::ssl::SSLEngineResult> wrap(jni::ref<jni::array<java::nio::ByteBuffer>> p1, jni::ref<java::nio::ByteBuffer> p2) { return call_method<"wrap", jni::ref<javax::net::ssl::SSLEngineResult>>(p1, p2); }
	...
	jni::ref<javax::net::ssl::SSLEngineResult> unwrap(jni::ref<java::nio::ByteBuffer> p1, jni::ref<java::nio::ByteBuffer> p2) { return call_method<"unwrap", jni::ref<javax::net::ssl::SSLEngineResult>>(p1, p2); }
	jni::ref<javax::net::ssl::SSLEngineResult> unwrap(jni::ref<java::nio::ByteBuffer> p1, jni::ref<jni::array<java::nio::ByteBuffer>> p2) { return call_method<"unwrap", jni::ref<javax::net::ssl::SSLEngineResult>>(p1, p2); }
