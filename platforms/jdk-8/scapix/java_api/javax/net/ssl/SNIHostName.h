...
public:
	...
	static jni::ref<javax::net::ssl::SNIHostName> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::net::ssl::SNIHostName> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
