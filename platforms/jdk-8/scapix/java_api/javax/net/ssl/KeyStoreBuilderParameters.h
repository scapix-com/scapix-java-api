...
public:
	...
	static jni::ref<javax::net::ssl::KeyStoreBuilderParameters> new_object(jni::ref<java::security::KeyStore_Builder> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::net::ssl::KeyStoreBuilderParameters> new_object(jni::ref<java::util::List> p1) { return object_base::new_object(p1); }
