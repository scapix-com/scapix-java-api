...
namespace scapix::java_api { namespace javax::net::ssl { class SSLSocket; }}
...
public:
	...
	void setHandshakeApplicationProtocolSelector(jni::ref<java::util::function::BiFunction> p1) { return call_method<"setHandshakeApplicationProtocolSelector", void>(p1); }
