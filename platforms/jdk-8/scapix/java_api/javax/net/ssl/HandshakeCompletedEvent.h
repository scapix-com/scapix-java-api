...
public:
	...
	static jni::ref<javax::net::ssl::HandshakeCompletedEvent> new_object(jni::ref<javax::net::ssl::SSLSocket> p1, jni::ref<javax::net::ssl::SSLSession> p2) { return object_base::new_object(p1, p2); }
