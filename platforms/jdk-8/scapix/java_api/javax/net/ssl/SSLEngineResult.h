...
public:
	...
	static jni::ref<javax::net::ssl::SSLEngineResult> new_object(jni::ref<javax::net::ssl::SSLEngineResult_Status> p1, jni::ref<javax::net::ssl::SSLEngineResult_HandshakeStatus> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
