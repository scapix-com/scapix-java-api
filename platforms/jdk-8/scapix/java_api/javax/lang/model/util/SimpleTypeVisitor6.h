...
namespace scapix::java_api { namespace javax::lang::model::util { class SimpleTypeVisitor6; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_LANG_MODEL_UTIL_SIMPLETYPEVISITOR6)
