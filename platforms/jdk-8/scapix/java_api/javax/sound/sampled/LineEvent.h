...
public:
	...
	static jni::ref<javax::sound::sampled::LineEvent> new_object(jni::ref<javax::sound::sampled::Line> p1, jni::ref<javax::sound::sampled::LineEvent_Type> p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
