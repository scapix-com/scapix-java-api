...
public:
	...
	static jni::ref<javax::sound::sampled::Port_Info> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
