...
public:
	...
	static jni::ref<javax::sound::sampled::AudioFileFormat> new_object(jni::ref<javax::sound::sampled::AudioFileFormat_Type> p1, jni::ref<javax::sound::sampled::AudioFormat> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::sound::sampled::AudioFileFormat> new_object(jni::ref<javax::sound::sampled::AudioFileFormat_Type> p1, jni::ref<javax::sound::sampled::AudioFormat> p2, jint p3, jni::ref<java::util::Map> p4) { return object_base::new_object(p1, p2, p3, p4); }
