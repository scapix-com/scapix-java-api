...
namespace scapix::java_api { namespace javax::sound::sampled::spi { class AudioFileReader; }}
...
public:
	...
	static jni::ref<javax::sound::sampled::spi::AudioFileReader> new_object() { return object_base::new_object(); }
