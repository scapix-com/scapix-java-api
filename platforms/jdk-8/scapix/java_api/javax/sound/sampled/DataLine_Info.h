...
public:
	...
	static jni::ref<javax::sound::sampled::DataLine_Info> new_object(jni::ref<java::lang::Class> p1, jni::ref<jni::array<javax::sound::sampled::AudioFormat>> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::sound::sampled::DataLine_Info> new_object(jni::ref<java::lang::Class> p1, jni::ref<javax::sound::sampled::AudioFormat> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::sound::sampled::DataLine_Info> new_object(jni::ref<java::lang::Class> p1, jni::ref<javax::sound::sampled::AudioFormat> p2) { return object_base::new_object(p1, p2); }
