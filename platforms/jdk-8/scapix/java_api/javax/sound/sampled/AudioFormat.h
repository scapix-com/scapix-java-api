...
public:
	...
	static jni::ref<javax::sound::sampled::AudioFormat> new_object(jni::ref<javax::sound::sampled::AudioFormat_Encoding> p1, jfloat p2, jint p3, jint p4, jint p5, jfloat p6, jboolean p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<javax::sound::sampled::AudioFormat> new_object(jni::ref<javax::sound::sampled::AudioFormat_Encoding> p1, jfloat p2, jint p3, jint p4, jint p5, jfloat p6, jboolean p7, jni::ref<java::util::Map> p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
	static jni::ref<javax::sound::sampled::AudioFormat> new_object(jfloat p1, jint p2, jint p3, jboolean p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
