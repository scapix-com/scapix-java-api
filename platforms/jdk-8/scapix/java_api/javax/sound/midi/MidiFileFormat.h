...
public:
	...
	static jni::ref<javax::sound::midi::MidiFileFormat> new_object(jint p1, jfloat p2, jint p3, jint p4, jlong p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::sound::midi::MidiFileFormat> new_object(jint p1, jfloat p2, jint p3, jint p4, jlong p5, jni::ref<java::util::Map> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
