...
namespace scapix::java_api { namespace javax::swing { class JWindow; }}
...
struct scapix::jni::object_traits<scapix::java_api::javax::swing::JWindow>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::awt::Window, scapix::java_api::javax::accessibility::Accessible, scapix::java_api::javax::swing::RootPaneContainer, scapix::java_api::javax::swing::TransferHandler_HasGetTransferHandler>;
};
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_JWINDOW)
...
public:
	...
	static jni::ref<javax::swing::JWindow> new_object(jni::ref<java::awt::GraphicsConfiguration> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JWindow> new_object(jni::ref<java::awt::Frame> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JWindow> new_object(jni::ref<java::awt::Window> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JWindow> new_object(jni::ref<java::awt::Window> p1, jni::ref<java::awt::GraphicsConfiguration> p2) { return object_base::new_object(p1, p2); }
