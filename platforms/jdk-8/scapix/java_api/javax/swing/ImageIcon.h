...
public:
	...
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<java::awt::Image> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<java::awt::Image> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<jni::array<jbyte>> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::ImageIcon> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
