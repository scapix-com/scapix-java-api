...
namespace scapix::java_api { namespace javax::swing { class DefaultRowSorter_Row; }}
...
public:
	...
	static jni::ref<javax::swing::DefaultRowSorter_Row> new_object(jni::ref<javax::swing::DefaultRowSorter> p1, jint p2) { return object_base::new_object(p1, p2); }
