...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_JMENU_ACCESSIBLEJMENU_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_JMENU_ACCESSIBLEJMENU_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::javax::swing { class JMenu_AccessibleJMenu; }

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::JMenu_AccessibleJMenu>
{
	static constexpr fixed_string class_name = "javax/swing/JMenu$AccessibleJMenu";
	using base_classes = std::tuple<scapix::java_api::javax::swing::JMenuItem_AccessibleJMenuItem, scapix::java_api::javax::accessibility::AccessibleSelection>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_JMENU_ACCESSIBLEJMENU_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_JMENU_ACCESSIBLEJMENU)
#define SCAPIX_JAVA_API_JAVAX_SWING_JMENU_ACCESSIBLEJMENU
...
class javax::swing::JMenu_AccessibleJMenu : public jni::object_base<"javax/swing/JMenu$AccessibleJMenu",
...
protected:
	...
	JMenu_AccessibleJMenu(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_JMENU_ACCESSIBLEJMENU
