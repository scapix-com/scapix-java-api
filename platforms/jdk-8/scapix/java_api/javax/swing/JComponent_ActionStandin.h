...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_JCOMPONENT_ACTIONSTANDIN_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_JCOMPONENT_ACTIONSTANDIN_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::javax::swing { class JComponent_ActionStandin; }

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::JComponent_ActionStandin>
{
	static constexpr fixed_string class_name = "javax/swing/JComponent$ActionStandin";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::swing::Action>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_JCOMPONENT_ACTIONSTANDIN_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_JCOMPONENT_ACTIONSTANDIN)
#define SCAPIX_JAVA_API_JAVAX_SWING_JCOMPONENT_ACTIONSTANDIN
...
// private
class javax::swing::JComponent_ActionStandin : public jni::object_base<"javax/swing/JComponent$ActionStandin",
	java::lang::Object,
	javax::swing::Action>
{
public:
...
protected:
	...
	JComponent_ActionStandin(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_JCOMPONENT_ACTIONSTANDIN
