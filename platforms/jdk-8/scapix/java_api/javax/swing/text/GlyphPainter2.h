...
namespace scapix::java_api::javax::swing::text { class GlyphPainter2; }
...
public:
	...
	static jni::ref<javax::swing::text::GlyphPainter2> new_object(jni::ref<java::awt::font::TextLayout> p1) { return base_::new_object(p1); }
...
protected:
	...
	GlyphPainter2(handle_type h) : base_(h) {}
