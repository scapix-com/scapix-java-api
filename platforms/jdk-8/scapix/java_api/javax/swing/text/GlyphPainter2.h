...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHPAINTER2_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHPAINTER2_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::swing::text { class GlyphPainter2; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::text::GlyphPainter2>
{
	static constexpr fixed_string class_name = "javax/swing/text/GlyphPainter2";
	using base_classes = std::tuple<scapix::java_api::javax::swing::text::GlyphView_GlyphPainter>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHPAINTER2_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHPAINTER2)
#define SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHPAINTER2
...
// private
class javax::swing::text::GlyphPainter2 : public jni::object_base<"javax/swing/text/GlyphPainter2",
	javax::swing::text::GlyphView_GlyphPainter>
{
public:

	static jni::ref<javax::swing::text::GlyphPainter2> new_object(jni::ref<java::awt::font::TextLayout> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHPAINTER2
