...
namespace scapix::java_api { namespace javax::swing::text { class GapVector; }}
...
public:
	...
	static jni::ref<javax::swing::text::GapVector> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::text::GapVector> new_object(jint p1) { return object_base::new_object(p1); }
