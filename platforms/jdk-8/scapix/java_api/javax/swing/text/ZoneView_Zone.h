...
namespace scapix::java_api { namespace javax::swing::text { class ZoneView_Zone; }}
...
public:
	...
	static jni::ref<javax::swing::text::ZoneView_Zone> new_object(jni::ref<javax::swing::text::ZoneView> p1, jni::ref<javax::swing::text::Element> p2, jni::ref<javax::swing::text::Position> p3, jni::ref<javax::swing::text::Position> p4) { return object_base::new_object(p1, p2, p3, p4); }
