...
public:
	...
	static jni::ref<javax::swing::text::JTextComponent_AccessibleJTextComponent> new_object(jni::ref<javax::swing::text::JTextComponent> p1) { return object_base::new_object(p1); }
