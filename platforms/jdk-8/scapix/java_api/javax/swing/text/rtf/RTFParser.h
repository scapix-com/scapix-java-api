...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFParser; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFParser> new_object() { return object_base::new_object(); }
