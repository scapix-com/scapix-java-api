...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFReader_TextHandlingDestination; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFReader_TextHandlingDestination> new_object(jni::ref<javax::swing::text::rtf::RTFReader> p1) { return object_base::new_object(p1); }
