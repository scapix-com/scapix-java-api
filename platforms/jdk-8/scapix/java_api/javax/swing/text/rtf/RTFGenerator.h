...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFGenerator; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFGenerator> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
