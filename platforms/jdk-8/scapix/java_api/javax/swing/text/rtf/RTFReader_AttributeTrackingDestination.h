...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFReader_AttributeTrackingDestination; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFReader_AttributeTrackingDestination> new_object(jni::ref<javax::swing::text::rtf::RTFReader> p1) { return object_base::new_object(p1); }
