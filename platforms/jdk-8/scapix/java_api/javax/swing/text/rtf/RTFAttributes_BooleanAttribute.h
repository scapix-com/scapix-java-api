...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFAttributes_BooleanAttribute; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFAttributes_BooleanAttribute> new_object(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::String> p3, jboolean p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::swing::text::rtf::RTFAttributes_BooleanAttribute> new_object(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
