...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFAttributes_NumericAttribute; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFAttributes_NumericAttribute> new_object(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::String> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::swing::text::rtf::RTFAttributes_NumericAttribute> new_object(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::Number> p4, jint p5, jfloat p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
