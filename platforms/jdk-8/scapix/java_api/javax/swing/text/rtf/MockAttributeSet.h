...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_RTF_MOCKATTRIBUTESET_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_TEXT_RTF_MOCKATTRIBUTESET_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::swing::text::rtf { class MockAttributeSet; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::text::rtf::MockAttributeSet>
{
	static constexpr fixed_string class_name = "javax/swing/text/rtf/MockAttributeSet";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::swing::text::AttributeSet, scapix::java_api::javax::swing::text::MutableAttributeSet>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_TEXT_RTF_MOCKATTRIBUTESET_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_TEXT_RTF_MOCKATTRIBUTESET)
#define SCAPIX_JAVA_API_JAVAX_SWING_TEXT_RTF_MOCKATTRIBUTESET
...
// private
class javax::swing::text::rtf::MockAttributeSet : public jni::object_base<"javax/swing/text/rtf/MockAttributeSet",
	java::lang::Object,
...
public:
	...
	jni::ref<java::util::Dictionary> backing() { return get_field<"backing", jni::ref<java::util::Dictionary>>(); }
	void backing(jni::ref<java::util::Dictionary> v) { set_field<"backing", jni::ref<java::util::Dictionary>>(v); }
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_TEXT_RTF_MOCKATTRIBUTESET
