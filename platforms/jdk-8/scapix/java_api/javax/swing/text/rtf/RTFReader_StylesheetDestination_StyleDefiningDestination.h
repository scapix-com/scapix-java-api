...
namespace scapix::java_api { namespace javax::swing::text::rtf { class RTFReader_StylesheetDestination_StyleDefiningDestination; }}
...
public:
	...
	static jni::ref<javax::swing::text::rtf::RTFReader_StylesheetDestination_StyleDefiningDestination> new_object(jni::ref<javax::swing::text::rtf::RTFReader_StylesheetDestination> p1) { return object_base::new_object(p1); }
