...
public:
	...
	static jni::ref<javax::swing::text::DefaultStyledDocument_AttributeUndoableEdit> new_object(jni::ref<javax::swing::text::Element> p1, jni::ref<javax::swing::text::AttributeSet> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
