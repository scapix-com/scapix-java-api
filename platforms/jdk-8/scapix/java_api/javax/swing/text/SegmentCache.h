...
namespace scapix::java_api { namespace javax::swing::text { class SegmentCache; }}
...
public:
	...
	static jni::ref<javax::swing::text::SegmentCache> new_object() { return object_base::new_object(); }
