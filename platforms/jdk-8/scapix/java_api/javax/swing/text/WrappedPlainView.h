...
public:
	...
	static jni::ref<javax::swing::text::WrappedPlainView> new_object(jni::ref<javax::swing::text::Element> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::text::WrappedPlainView> new_object(jni::ref<javax::swing::text::Element> p1, jboolean p2) { return object_base::new_object(p1, p2); }
