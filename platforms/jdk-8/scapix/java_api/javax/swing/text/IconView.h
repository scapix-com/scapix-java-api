...
namespace scapix::java_api { namespace javax::swing::text { class IconView; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_TEXT_ICONVIEW)
...
public:
	...
	static jni::ref<javax::swing::text::IconView> new_object(jni::ref<javax::swing::text::Element> p1) { return object_base::new_object(p1); }
