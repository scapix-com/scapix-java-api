...
namespace scapix::java_api::javax::swing::text { class IconView; }
...
public:
	...
	static jni::ref<javax::swing::text::IconView> new_object(jni::ref<javax::swing::text::Element> p1) { return base_::new_object(p1); }
...
protected:
	...
	IconView(handle_type h) : base_(h) {}
