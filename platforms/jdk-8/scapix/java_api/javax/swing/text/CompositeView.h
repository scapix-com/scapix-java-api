...
namespace scapix::java_api { namespace javax::swing::text { class CompositeView; }}
...
public:
	...
	static jni::ref<javax::swing::text::CompositeView> new_object(jni::ref<javax::swing::text::Element> p1) { return object_base::new_object(p1); }
