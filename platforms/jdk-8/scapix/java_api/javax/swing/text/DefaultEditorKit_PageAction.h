...
namespace scapix::java_api { namespace javax::swing::text { class DefaultEditorKit_PageAction; }}
...
public:
	...
	static jni::ref<javax::swing::text::DefaultEditorKit_PageAction> new_object(jni::ref<java::lang::String> p1, jboolean p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
