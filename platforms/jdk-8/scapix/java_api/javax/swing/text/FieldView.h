...
namespace scapix::java_api { namespace javax::swing::text { class FieldView; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_TEXT_FIELDVIEW)
...
public:
	...
	static jni::ref<javax::swing::text::FieldView> new_object(jni::ref<javax::swing::text::Element> p1) { return object_base::new_object(p1); }
