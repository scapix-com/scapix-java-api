...
namespace scapix::java_api::javax::swing::text { class FieldView; }
...
public:
	...
	static jni::ref<javax::swing::text::FieldView> new_object(jni::ref<javax::swing::text::Element> p1) { return base_::new_object(p1); }
...
protected:
	...
	FieldView(handle_type h) : base_(h) {}
