...
public:
	...
	static jni::ref<javax::swing::text::StyleContext_NamedStyle> new_object(jni::ref<javax::swing::text::StyleContext> p1, jni::ref<java::lang::String> p2, jni::ref<javax::swing::text::Style> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::text::StyleContext_NamedStyle> new_object(jni::ref<javax::swing::text::StyleContext> p1, jni::ref<javax::swing::text::Style> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::text::StyleContext_NamedStyle> new_object(jni::ref<javax::swing::text::StyleContext> p1) { return object_base::new_object(p1); }
