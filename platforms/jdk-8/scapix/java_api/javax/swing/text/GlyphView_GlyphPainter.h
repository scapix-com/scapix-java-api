...
namespace scapix::java_api::javax::swing::text { class GlyphView_GlyphPainter; }
...
public:
	...
	static jni::ref<javax::swing::text::GlyphView_GlyphPainter> new_object() { return base_::new_object(); }
...
protected:
	...
	GlyphView_GlyphPainter(handle_type h) : base_(h) {}
