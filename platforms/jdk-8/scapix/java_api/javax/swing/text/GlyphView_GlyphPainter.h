...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::swing::text { class GlyphView_GlyphPainter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::text::GlyphView_GlyphPainter>
{
	static constexpr fixed_string class_name = "javax/swing/text/GlyphView$GlyphPainter";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER)
#define SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER
...
class javax::swing::text::GlyphView_GlyphPainter : public jni::object_base<"javax/swing/text/GlyphView$GlyphPainter",
	java::lang::Object>
{
public:

	static jni::ref<javax::swing::text::GlyphView_GlyphPainter> new_object() { return object_base::new_object(); }
	...
	jni::ref<javax::swing::text::GlyphView_GlyphPainter> getPainter(jni::ref<javax::swing::text::GlyphView> p1, jint p2, jint p3) { return call_method<"getPainter", jni::ref<javax::swing::text::GlyphView_GlyphPainter>>(p1, p2, p3); }
	jint getNextVisualPositionFrom(jni::ref<javax::swing::text::GlyphView> p1, jint p2, jni::ref<javax::swing::text::Position_Bias> p3, jni::ref<java::awt::Shape> p4, jint p5, jni::ref<jni::array<javax::swing::text::Position_Bias>> p6) { return call_method<"getNextVisualPositionFrom", jint>(p1, p2, p3, p4, p5, p6); }
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_TEXT_GLYPHVIEW_GLYPHPAINTER
