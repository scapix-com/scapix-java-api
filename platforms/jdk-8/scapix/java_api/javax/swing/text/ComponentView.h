...
namespace scapix::java_api { namespace javax::swing::text { class ComponentView; }}
...
public:
	...
	static jni::ref<javax::swing::text::ComponentView> new_object(jni::ref<javax::swing::text::Element> p1) { return object_base::new_object(p1); }
