...
namespace scapix::java_api { namespace javax::swing::text { class FlowView; }}
...
public:
	...
	static jni::ref<javax::swing::text::FlowView> new_object(jni::ref<javax::swing::text::Element> p1, jint p2) { return object_base::new_object(p1, p2); }
