...
namespace scapix::java_api { namespace javax::swing::text::html { class BRView; }}
...
public:
	...
	static jni::ref<javax::swing::text::html::BRView> new_object(jni::ref<javax::swing::text::Element> p1) { return object_base::new_object(p1); }
