...
public:
	...
	static jni::ref<javax::swing::text::html::parser::Entity> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<jni::array<jchar>> p3) { return object_base::new_object(p1, p2, p3); }
