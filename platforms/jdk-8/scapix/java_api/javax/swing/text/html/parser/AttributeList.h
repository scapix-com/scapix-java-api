...
public:
	...
	static jni::ref<javax::swing::text::html::parser::AttributeList> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::text::html::parser::AttributeList> new_object(jni::ref<java::lang::String> p1, jint p2, jint p3, jni::ref<java::lang::String> p4, jni::ref<java::util::Vector> p5, jni::ref<javax::swing::text::html::parser::AttributeList> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
