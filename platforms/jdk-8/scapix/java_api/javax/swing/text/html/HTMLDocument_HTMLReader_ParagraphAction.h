...
public:
	...
	static jni::ref<javax::swing::text::html::HTMLDocument_HTMLReader_ParagraphAction> new_object(jni::ref<javax::swing::text::html::HTMLDocument_HTMLReader> p1) { return object_base::new_object(p1); }
