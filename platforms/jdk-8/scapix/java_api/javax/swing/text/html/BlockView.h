...
namespace scapix::java_api { namespace javax::swing::text::html { class BlockView; }}
...
public:
	...
	static jni::ref<javax::swing::text::html::BlockView> new_object(jni::ref<javax::swing::text::Element> p1, jint p2) { return object_base::new_object(p1, p2); }
