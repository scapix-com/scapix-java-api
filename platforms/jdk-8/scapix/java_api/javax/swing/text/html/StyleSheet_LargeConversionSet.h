...
namespace scapix::java_api { namespace javax::swing::text::html { class StyleSheet_LargeConversionSet; }}
...
public:
	...
	static jni::ref<javax::swing::text::html::StyleSheet_LargeConversionSet> new_object(jni::ref<javax::swing::text::html::StyleSheet> p1, jni::ref<javax::swing::text::AttributeSet> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::text::html::StyleSheet_LargeConversionSet> new_object(jni::ref<javax::swing::text::html::StyleSheet> p1) { return object_base::new_object(p1); }
