...
namespace scapix::java_api { namespace javax::swing::text::html::parser { class NPrintWriter; }}
...
public:
	...
	static jni::ref<javax::swing::text::html::parser::NPrintWriter> new_object(jint p1) { return object_base::new_object(p1); }
