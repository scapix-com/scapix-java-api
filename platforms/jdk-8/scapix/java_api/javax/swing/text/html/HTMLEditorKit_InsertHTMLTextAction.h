...
public:
	...
	static jni::ref<javax::swing::text::html::HTMLEditorKit_InsertHTMLTextAction> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<javax::swing::text::html::HTML_Tag> p3, jni::ref<javax::swing::text::html::HTML_Tag> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::text::html::HTMLEditorKit_InsertHTMLTextAction> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<javax::swing::text::html::HTML_Tag> p3, jni::ref<javax::swing::text::html::HTML_Tag> p4, jni::ref<javax::swing::text::html::HTML_Tag> p5, jni::ref<javax::swing::text::html::HTML_Tag> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
