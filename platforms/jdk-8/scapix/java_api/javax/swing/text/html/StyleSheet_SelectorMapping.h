...
namespace scapix::java_api { namespace javax::swing::text::html { class StyleSheet_SelectorMapping; }}
...
public:
	...
	static jni::ref<javax::swing::text::html::StyleSheet_SelectorMapping> new_object(jint p1) { return object_base::new_object(p1); }
