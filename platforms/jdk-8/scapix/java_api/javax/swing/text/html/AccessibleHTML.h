...
namespace scapix::java_api { namespace javax::swing::text::html { class AccessibleHTML; }}
...
public:
	...
	static jni::ref<javax::swing::text::html::AccessibleHTML> new_object(jni::ref<javax::swing::JEditorPane> p1) { return object_base::new_object(p1); }
