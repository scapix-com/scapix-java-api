...
public:
	...
	static jni::ref<javax::swing::text::DefaultStyledDocument_ElementBuffer> new_object(jni::ref<javax::swing::text::DefaultStyledDocument> p1, jni::ref<javax::swing::text::Element> p2) { return object_base::new_object(p1, p2); }
