...
public:
	...
	static jni::ref<javax::swing::text::TableView_TableCell> new_object(jni::ref<javax::swing::text::TableView> p1, jni::ref<javax::swing::text::Element> p2) { return object_base::new_object(p1, p2); }
