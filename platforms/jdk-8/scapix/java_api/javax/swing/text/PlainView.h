...
namespace scapix::java_api::javax::swing::text { class PlainView; }
...
public:
	...
	static jni::ref<javax::swing::text::PlainView> new_object(jni::ref<javax::swing::text::Element> p1) { return base_::new_object(p1); }
...
protected:
	...
	PlainView(handle_type h) : base_(h) {}
