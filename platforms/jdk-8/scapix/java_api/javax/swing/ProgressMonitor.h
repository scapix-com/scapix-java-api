...
public:
	...
	static jni::ref<javax::swing::ProgressMonitor> new_object(jni::ref<java::awt::Component> p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::String> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
