...
public:
	...
	static jni::ref<javax::swing::JTable> new_object(jni::ref<javax::swing::table::TableModel> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JTable> new_object(jni::ref<javax::swing::table::TableModel> p1, jni::ref<javax::swing::table::TableColumnModel> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JTable> new_object(jni::ref<javax::swing::table::TableModel> p1, jni::ref<javax::swing::table::TableColumnModel> p2, jni::ref<javax::swing::ListSelectionModel> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::JTable> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JTable> new_object(jni::ref<java::util::Vector> p1, jni::ref<java::util::Vector> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JTable> new_object(jni::ref<jni::array<jni::array<java::lang::Object>>> p1, jni::ref<jni::array<java::lang::Object>> p2) { return object_base::new_object(p1, p2); }
