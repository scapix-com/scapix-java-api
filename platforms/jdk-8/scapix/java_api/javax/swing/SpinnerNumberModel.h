...
public:
	...
	static jni::ref<javax::swing::SpinnerNumberModel> new_object(jni::ref<java::lang::Number> p1, jni::ref<java::lang::Comparable> p2, jni::ref<java::lang::Comparable> p3, jni::ref<java::lang::Number> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::SpinnerNumberModel> new_object(jint p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::SpinnerNumberModel> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4) { return object_base::new_object(p1, p2, p3, p4); }
