...
public:
	...
	static jni::ref<javax::swing::event::TreeExpansionEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<javax::swing::tree::TreePath> p2) { return object_base::new_object(p1, p2); }
