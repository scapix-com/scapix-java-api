...
public:
	...
	static jni::ref<javax::swing::event::MenuKeyEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jint p4, jint p5, jchar p6, jni::ref<jni::array<javax::swing::MenuElement>> p7, jni::ref<javax::swing::MenuSelectionManager> p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
