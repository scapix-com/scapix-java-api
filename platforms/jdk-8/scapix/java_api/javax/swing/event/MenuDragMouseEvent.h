...
public:
	...
	static jni::ref<javax::swing::event::MenuDragMouseEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jint p4, jint p5, jint p6, jint p7, jboolean p8, jni::ref<jni::array<javax::swing::MenuElement>> p9, jni::ref<javax::swing::MenuSelectionManager> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
	static jni::ref<javax::swing::event::MenuDragMouseEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jint p4, jint p5, jint p6, jint p7, jint p8, jint p9, jboolean p10, jni::ref<jni::array<javax::swing::MenuElement>> p11, jni::ref<javax::swing::MenuSelectionManager> p12) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); }
