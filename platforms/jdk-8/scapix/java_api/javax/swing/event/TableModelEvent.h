...
public:
	...
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::event::TableModelEvent> new_object(jni::ref<javax::swing::table::TableModel> p1, jint p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
