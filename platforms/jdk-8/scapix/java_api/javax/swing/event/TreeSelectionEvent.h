...
public:
	...
	static jni::ref<javax::swing::event::TreeSelectionEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<jni::array<javax::swing::tree::TreePath>> p2, jni::ref<jni::array<jboolean>> p3, jni::ref<javax::swing::tree::TreePath> p4, jni::ref<javax::swing::tree::TreePath> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::swing::event::TreeSelectionEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<javax::swing::tree::TreePath> p2, jboolean p3, jni::ref<javax::swing::tree::TreePath> p4, jni::ref<javax::swing::tree::TreePath> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
