...
public:
	...
	static jni::ref<javax::swing::event::TableColumnModelEvent> new_object(jni::ref<javax::swing::table::TableColumnModel> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
