...
public:
	...
	static jni::ref<javax::swing::JTextArea> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JTextArea> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JTextArea> new_object(jni::ref<java::lang::String> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::JTextArea> new_object(jni::ref<javax::swing::text::Document> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JTextArea> new_object(jni::ref<javax::swing::text::Document> p1, jni::ref<java::lang::String> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
