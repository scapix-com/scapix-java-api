...
namespace scapix::java_api::javax::swing { class JTabbedPane_Page; }
...
struct scapix::jni::object_traits<scapix::java_api::javax::swing::JTabbedPane_Page>
{
	...
	using base_classes = std::tuple<scapix::java_api::javax::accessibility::AccessibleContext, scapix::java_api::java::io::Serializable, scapix::java_api::javax::accessibility::Accessible, scapix::java_api::javax::accessibility::AccessibleComponent>;
};
...
protected:
	...
	JTabbedPane_Page(handle_type h) : base_(h) {}
