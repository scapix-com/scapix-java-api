...
namespace scapix::java_api { namespace javax::swing { class JList_AccessibleJList; }}
...
public:
	...
	static jni::ref<javax::swing::JList_AccessibleJList> new_object(jni::ref<javax::swing::JList> p1) { return object_base::new_object(p1); }
