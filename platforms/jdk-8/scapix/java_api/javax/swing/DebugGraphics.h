...
namespace scapix::java_api { namespace javax::swing { class DebugGraphics; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_DEBUGGRAPHICS)
...
public:
	...
	static jni::ref<javax::swing::DebugGraphics> new_object(jni::ref<java::awt::Graphics> p1, jni::ref<javax::swing::JComponent> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::DebugGraphics> new_object(jni::ref<java::awt::Graphics> p1) { return object_base::new_object(p1); }
	...
	static void setFlashColor(jni::ref<java::awt::Color> p1) { return call_static_method<"setFlashColor", void>(p1); }
	static jni::ref<java::awt::Color> flashColor() { return call_static_method<"flashColor", jni::ref<java::awt::Color>>(); }
	static void setFlashTime(jint p1) { return call_static_method<"setFlashTime", void>(p1); }
	static jint flashTime() { return call_static_method<"flashTime", jint>(); }
	static void setFlashCount(jint p1) { return call_static_method<"setFlashCount", void>(p1); }
	...
	void setDebugOptions(jint p1) { return call_method<"setDebugOptions", void>(p1); }
