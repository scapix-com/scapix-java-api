...
public:
	...
	static jni::ref<javax::swing::plaf::BorderUIResource_BevelBorderUIResource> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::plaf::BorderUIResource_BevelBorderUIResource> new_object(jint p1, jni::ref<java::awt::Color> p2, jni::ref<java::awt::Color> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::plaf::BorderUIResource_BevelBorderUIResource> new_object(jint p1, jni::ref<java::awt::Color> p2, jni::ref<java::awt::Color> p3, jni::ref<java::awt::Color> p4, jni::ref<java::awt::Color> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
};
