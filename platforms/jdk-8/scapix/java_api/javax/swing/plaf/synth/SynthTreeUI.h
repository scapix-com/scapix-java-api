...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthTreeUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthTreeUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthTreeUI(handle_type h) : base_(h) {}
