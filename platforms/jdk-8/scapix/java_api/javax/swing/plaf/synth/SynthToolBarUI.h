...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthToolBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthToolBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthToolBarUI(handle_type h) : base_(h) {}
