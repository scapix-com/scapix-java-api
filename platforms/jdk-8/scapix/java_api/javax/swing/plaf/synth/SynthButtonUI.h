...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthButtonUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthButtonUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthButtonUI(handle_type h) : base_(h) {}
