...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthColorChooserUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthColorChooserUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthColorChooserUI(handle_type h) : base_(h) {}
