...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthViewportUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthViewportUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthViewportUI(handle_type h) : base_(h) {}
