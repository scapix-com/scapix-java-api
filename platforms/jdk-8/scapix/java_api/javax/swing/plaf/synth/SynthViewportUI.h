...
namespace scapix::java_api { namespace javax::swing::plaf::synth { class SynthViewportUI; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_PLAF_SYNTH_SYNTHVIEWPORTUI)
