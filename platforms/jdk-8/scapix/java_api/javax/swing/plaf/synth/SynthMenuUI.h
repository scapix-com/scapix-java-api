...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthMenuUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthMenuUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthMenuUI(handle_type h) : base_(h) {}
