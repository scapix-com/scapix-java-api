...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthListUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthListUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthListUI(handle_type h) : base_(h) {}
