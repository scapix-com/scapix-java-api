...
namespace scapix::java_api { namespace javax::swing::plaf::synth { class SynthTabbedPaneUI_SynthScrollableTabButton; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthTabbedPaneUI_SynthScrollableTabButton> new_object(jni::ref<javax::swing::plaf::synth::SynthTabbedPaneUI> p1, jint p2) { return object_base::new_object(p1, p2); }
