...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthPanelUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthPanelUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthPanelUI(handle_type h) : base_(h) {}
