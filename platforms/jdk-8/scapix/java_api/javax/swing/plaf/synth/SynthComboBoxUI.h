...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthComboBoxUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthComboBoxUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthComboBoxUI(handle_type h) : base_(h) {}
