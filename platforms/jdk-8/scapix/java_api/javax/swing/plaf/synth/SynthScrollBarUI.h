...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthScrollBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthScrollBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthScrollBarUI(handle_type h) : base_(h) {}
