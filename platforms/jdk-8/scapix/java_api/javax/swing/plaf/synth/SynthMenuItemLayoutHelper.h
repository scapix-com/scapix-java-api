...
namespace scapix::java_api { namespace javax::swing::plaf::synth { class SynthMenuItemLayoutHelper; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthMenuItemLayoutHelper> new_object(jni::ref<javax::swing::plaf::synth::SynthContext> p1, jni::ref<javax::swing::plaf::synth::SynthContext> p2, jni::ref<javax::swing::JMenuItem> p3, jni::ref<javax::swing::Icon> p4, jni::ref<javax::swing::Icon> p5, jni::ref<java::awt::Rectangle> p6, jint p7, jni::ref<java::lang::String> p8, jboolean p9, jboolean p10, jni::ref<java::lang::String> p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
