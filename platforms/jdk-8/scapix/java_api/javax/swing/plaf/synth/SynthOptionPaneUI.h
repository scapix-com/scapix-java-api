...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthOptionPaneUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthOptionPaneUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthOptionPaneUI(handle_type h) : base_(h) {}
