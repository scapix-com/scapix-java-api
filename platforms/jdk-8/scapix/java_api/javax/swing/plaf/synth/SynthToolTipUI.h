...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthToolTipUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthToolTipUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthToolTipUI(handle_type h) : base_(h) {}
