...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthTableUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthTableUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthTableUI(handle_type h) : base_(h) {}
