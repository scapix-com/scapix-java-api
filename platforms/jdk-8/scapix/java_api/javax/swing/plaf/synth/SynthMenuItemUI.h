...
namespace scapix::java_api::javax::swing::plaf::synth { class SynthMenuItemUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthMenuItemUI> new_object() { return base_::new_object(); }
...
protected:
	...
	SynthMenuItemUI(handle_type h) : base_(h) {}
