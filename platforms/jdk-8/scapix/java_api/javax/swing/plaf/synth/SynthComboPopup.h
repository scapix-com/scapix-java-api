...
namespace scapix::java_api { namespace javax::swing::plaf::synth { class SynthComboPopup; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::synth::SynthComboPopup> new_object(jni::ref<javax::swing::JComboBox> p1) { return object_base::new_object(p1); }
