...
namespace scapix::java_api { namespace javax::swing::plaf::metal { class BumpBuffer; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::metal::BumpBuffer> new_object(jni::ref<java::awt::GraphicsConfiguration> p1, jni::ref<java::awt::Color> p2, jni::ref<java::awt::Color> p3, jni::ref<java::awt::Color> p4) { return object_base::new_object(p1, p2, p3, p4); }
