...
namespace scapix::java_api { namespace javax::swing::plaf::metal { class MetalFileChooserUI; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::metal::MetalFileChooserUI> new_object(jni::ref<javax::swing::JFileChooser> p1) { return object_base::new_object(p1); }
