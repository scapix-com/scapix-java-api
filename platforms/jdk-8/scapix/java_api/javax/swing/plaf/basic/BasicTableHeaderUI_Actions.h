...
namespace scapix::java_api { namespace javax::swing::plaf::basic { class BasicTableHeaderUI_Actions; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicTableHeaderUI_Actions> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
