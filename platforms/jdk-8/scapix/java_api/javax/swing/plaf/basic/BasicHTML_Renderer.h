...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICHTML_RENDERER_FWD
#define SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICHTML_RENDERER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::swing::plaf::basic { class BasicHTML_Renderer; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::swing::plaf::basic::BasicHTML_Renderer>
{
	static constexpr fixed_string class_name = "javax/swing/plaf/basic/BasicHTML$Renderer";
	using base_classes = std::tuple<scapix::java_api::javax::swing::text::View>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICHTML_RENDERER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICHTML_RENDERER)
#define SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICHTML_RENDERER
...
// private
class javax::swing::plaf::basic::BasicHTML_Renderer : public jni::object_base<"javax/swing/plaf/basic/BasicHTML$Renderer",
...
#endif // SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICHTML_RENDERER
