...
namespace scapix::java_api { namespace javax::swing::plaf::basic { class BasicButtonListener; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICBUTTONLISTENER)
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicButtonListener> new_object(jni::ref<javax::swing::AbstractButton> p1) { return object_base::new_object(p1); }
	void propertyChange(jni::ref<java::beans::PropertyChangeEvent> p1) { return call_method<"propertyChange", void>(p1); }
	void installKeyboardActions(jni::ref<javax::swing::JComponent> p1) { return call_method<"installKeyboardActions", void>(p1); }
	void uninstallKeyboardActions(jni::ref<javax::swing::JComponent> p1) { return call_method<"uninstallKeyboardActions", void>(p1); }
