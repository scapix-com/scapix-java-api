...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicComboPopup_InvocationKeyHandler> new_object(jni::ref<javax::swing::plaf::basic::BasicComboPopup> p1) { return object_base::new_object(p1); }
