...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicTreeUI_TreeToggleAction> new_object(jni::ref<javax::swing::plaf::basic::BasicTreeUI> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
