...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicTableUI_FocusHandler> new_object(jni::ref<javax::swing::plaf::basic::BasicTableUI> p1) { return object_base::new_object(p1); }
