...
namespace scapix::java_api { namespace javax::swing::plaf::basic { class BasicDesktopPaneUI; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICDESKTOPPANEUI)
