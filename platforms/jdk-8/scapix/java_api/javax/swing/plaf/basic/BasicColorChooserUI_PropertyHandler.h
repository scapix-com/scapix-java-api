...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicColorChooserUI_PropertyHandler> new_object(jni::ref<javax::swing::plaf::basic::BasicColorChooserUI> p1) { return object_base::new_object(p1); }
