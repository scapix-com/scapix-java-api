...
namespace scapix::java_api { namespace javax::swing::plaf::basic { class BasicPopupMenuUI_MouseGrabber; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicPopupMenuUI_MouseGrabber> new_object() { return object_base::new_object(); }
