...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicTreeUI_SelectionModelPropertyChangeHandler> new_object(jni::ref<javax::swing::plaf::basic::BasicTreeUI> p1) { return object_base::new_object(p1); }
