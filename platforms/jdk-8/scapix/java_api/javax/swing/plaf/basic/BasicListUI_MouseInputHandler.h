...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicListUI_MouseInputHandler> new_object(jni::ref<javax::swing::plaf::basic::BasicListUI> p1) { return object_base::new_object(p1); }
