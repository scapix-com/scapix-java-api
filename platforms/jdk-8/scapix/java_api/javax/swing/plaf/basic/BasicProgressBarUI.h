...
namespace scapix::java_api::javax::swing::plaf::basic { class BasicProgressBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicProgressBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	BasicProgressBarUI(handle_type h) : base_(h) {}
