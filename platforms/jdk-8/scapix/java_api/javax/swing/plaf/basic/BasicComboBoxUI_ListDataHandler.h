...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicComboBoxUI_ListDataHandler> new_object(jni::ref<javax::swing::plaf::basic::BasicComboBoxUI> p1) { return object_base::new_object(p1); }
