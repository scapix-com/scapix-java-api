...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicSplitPaneDivider> new_object(jni::ref<javax::swing::plaf::basic::BasicSplitPaneUI> p1) { return object_base::new_object(p1); }
