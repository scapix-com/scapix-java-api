...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicTabbedPaneUI_TabbedPaneLayout> new_object(jni::ref<javax::swing::plaf::basic::BasicTabbedPaneUI> p1) { return object_base::new_object(p1); }
