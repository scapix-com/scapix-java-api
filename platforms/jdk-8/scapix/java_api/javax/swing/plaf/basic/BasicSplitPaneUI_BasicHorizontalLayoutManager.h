...
namespace scapix::java_api::javax::swing::plaf::basic { class BasicSplitPaneUI_BasicHorizontalLayoutManager; }
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICSPLITPANEUI_BASICHORIZONTALLAYOUTMANAGER)
...
protected:
	...
	BasicSplitPaneUI_BasicHorizontalLayoutManager(handle_type h) : base_(h) {}
