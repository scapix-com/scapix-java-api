...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicInternalFrameUI_InternalFrameLayout> new_object(jni::ref<javax::swing::plaf::basic::BasicInternalFrameUI> p1) { return object_base::new_object(p1); }
