...
namespace scapix::java_api::javax::swing::plaf::basic { class BasicSeparatorUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicSeparatorUI> new_object() { return base_::new_object(); }
...
protected:
	...
	BasicSeparatorUI(handle_type h) : base_(h) {}
