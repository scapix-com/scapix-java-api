...
namespace scapix::java_api { namespace javax::swing::plaf { class SplitPaneUI; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::SplitPaneUI> new_object() { return object_base::new_object(); }
