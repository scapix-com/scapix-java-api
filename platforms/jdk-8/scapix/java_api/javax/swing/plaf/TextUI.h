...
namespace scapix::java_api::javax::swing::plaf { class TextUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::TextUI> new_object() { return base_::new_object(); }
