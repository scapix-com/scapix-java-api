...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_COLORUIRESOURCE
...
public:
	...
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jfloat p1, jfloat p2, jfloat p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jni::ref<java::awt::Color> p1) { return object_base::new_object(p1); }
};
