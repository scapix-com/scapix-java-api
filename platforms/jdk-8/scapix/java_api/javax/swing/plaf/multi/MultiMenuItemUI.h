...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiMenuItemUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiMenuItemUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiMenuItemUI(handle_type h) : base_(h) {}
