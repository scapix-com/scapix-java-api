...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiListUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiListUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiListUI(handle_type h) : base_(h) {}
