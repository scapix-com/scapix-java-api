...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiInternalFrameUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiInternalFrameUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiInternalFrameUI(handle_type h) : base_(h) {}
