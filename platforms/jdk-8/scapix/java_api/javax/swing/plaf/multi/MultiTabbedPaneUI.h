...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiTabbedPaneUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiTabbedPaneUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiTabbedPaneUI(handle_type h) : base_(h) {}
