...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiRootPaneUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiRootPaneUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiRootPaneUI(handle_type h) : base_(h) {}
