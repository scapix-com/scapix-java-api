...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiMenuBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiMenuBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiMenuBarUI(handle_type h) : base_(h) {}
