...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiToolTipUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiToolTipUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiToolTipUI(handle_type h) : base_(h) {}
