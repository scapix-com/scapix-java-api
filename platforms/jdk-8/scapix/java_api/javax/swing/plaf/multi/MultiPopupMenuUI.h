...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiPopupMenuUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiPopupMenuUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiPopupMenuUI(handle_type h) : base_(h) {}
