...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiViewportUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiViewportUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiViewportUI(handle_type h) : base_(h) {}
