...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiComboBoxUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiComboBoxUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiComboBoxUI(handle_type h) : base_(h) {}
