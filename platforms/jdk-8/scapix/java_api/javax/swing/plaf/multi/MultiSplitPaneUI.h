...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiSplitPaneUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiSplitPaneUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiSplitPaneUI(handle_type h) : base_(h) {}
