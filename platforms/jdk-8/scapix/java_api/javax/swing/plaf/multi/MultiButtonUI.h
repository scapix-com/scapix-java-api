...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiButtonUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiButtonUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiButtonUI(handle_type h) : base_(h) {}
