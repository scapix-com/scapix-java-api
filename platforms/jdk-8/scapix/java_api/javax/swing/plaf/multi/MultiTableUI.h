...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiTableUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiTableUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiTableUI(handle_type h) : base_(h) {}
