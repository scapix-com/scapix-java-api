...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiSeparatorUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiSeparatorUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiSeparatorUI(handle_type h) : base_(h) {}
