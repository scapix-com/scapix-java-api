...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiScrollPaneUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiScrollPaneUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiScrollPaneUI(handle_type h) : base_(h) {}
