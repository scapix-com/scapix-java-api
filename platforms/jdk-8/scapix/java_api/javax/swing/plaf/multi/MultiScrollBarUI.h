...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiScrollBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiScrollBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiScrollBarUI(handle_type h) : base_(h) {}
