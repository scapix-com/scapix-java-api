...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiProgressBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiProgressBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiProgressBarUI(handle_type h) : base_(h) {}
