...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiDesktopIconUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiDesktopIconUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiDesktopIconUI(handle_type h) : base_(h) {}
