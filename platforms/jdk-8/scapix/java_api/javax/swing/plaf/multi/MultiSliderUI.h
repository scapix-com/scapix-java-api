...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiSliderUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiSliderUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiSliderUI(handle_type h) : base_(h) {}
