...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiToolBarUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiToolBarUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiToolBarUI(handle_type h) : base_(h) {}
