...
namespace scapix::java_api { namespace javax::swing::plaf::multi { class MultiOptionPaneUI; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_PLAF_MULTI_MULTIOPTIONPANEUI)
