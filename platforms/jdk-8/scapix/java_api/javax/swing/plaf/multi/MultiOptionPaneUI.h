...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiOptionPaneUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiOptionPaneUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiOptionPaneUI(handle_type h) : base_(h) {}
