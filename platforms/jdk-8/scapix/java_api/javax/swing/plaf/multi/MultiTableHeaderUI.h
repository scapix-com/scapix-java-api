...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiTableHeaderUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiTableHeaderUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiTableHeaderUI(handle_type h) : base_(h) {}
