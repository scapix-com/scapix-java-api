...
namespace scapix::java_api::javax::swing::plaf::multi { class MultiSpinnerUI; }
...
public:
	...
	static jni::ref<javax::swing::plaf::multi::MultiSpinnerUI> new_object() { return base_::new_object(); }
...
protected:
	...
	MultiSpinnerUI(handle_type h) : base_(h) {}
