...
namespace scapix::java_api { namespace javax::swing::plaf::nimbus { class ImageCache; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::nimbus::ImageCache> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::plaf::nimbus::ImageCache> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
