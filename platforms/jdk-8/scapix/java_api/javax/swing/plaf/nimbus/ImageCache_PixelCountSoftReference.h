...
namespace scapix::java_api { namespace javax::swing::plaf::nimbus { class ImageCache_PixelCountSoftReference; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::nimbus::ImageCache_PixelCountSoftReference> new_object(jni::ref<java::awt::Image> p1, jni::ref<java::lang::ref::ReferenceQueue> p2, jint p3, jint p4, jni::ref<java::awt::GraphicsConfiguration> p5, jint p6, jint p7, jni::ref<jni::array<java::lang::Object>> p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
