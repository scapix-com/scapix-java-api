...
namespace scapix::java_api { namespace javax::swing::plaf::nimbus { class SpinnerNextButtonPainter; }}
...
public:
	...
	static jni::ref<javax::swing::plaf::nimbus::SpinnerNextButtonPainter> new_object(jni::ref<javax::swing::plaf::nimbus::AbstractRegionPainter_PaintContext> p1, jint p2) { return object_base::new_object(p1, p2); }
