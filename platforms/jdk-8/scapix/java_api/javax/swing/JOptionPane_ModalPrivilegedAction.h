...
namespace scapix::java_api { namespace javax::swing { class JOptionPane_ModalPrivilegedAction; }}
...
public:
	...
	static jni::ref<javax::swing::JOptionPane_ModalPrivilegedAction> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
