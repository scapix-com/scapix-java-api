...
namespace scapix::java_api { namespace javax::swing { class JPopupMenu; }}
...
public:
	...
	static jni::ref<javax::swing::JPopupMenu> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
