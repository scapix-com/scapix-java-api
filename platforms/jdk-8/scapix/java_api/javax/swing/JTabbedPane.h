...
public:
	...
	static jni::ref<javax::swing::JTabbedPane> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JTabbedPane> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
