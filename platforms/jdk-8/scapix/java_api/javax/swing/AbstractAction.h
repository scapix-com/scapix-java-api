...
public:
	...
	static jni::ref<javax::swing::AbstractAction> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::AbstractAction> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::swing::Icon> p2) { return object_base::new_object(p1, p2); }
