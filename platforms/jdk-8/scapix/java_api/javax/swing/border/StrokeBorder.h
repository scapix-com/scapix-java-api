...
public:
	...
	static jni::ref<javax::swing::border::StrokeBorder> new_object(jni::ref<java::awt::BasicStroke> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::border::StrokeBorder> new_object(jni::ref<java::awt::BasicStroke> p1, jni::ref<java::awt::Paint> p2) { return object_base::new_object(p1, p2); }
