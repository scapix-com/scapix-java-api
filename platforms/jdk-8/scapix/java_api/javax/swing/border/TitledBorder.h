...
public:
	...
	static jni::ref<javax::swing::border::TitledBorder> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::border::TitledBorder> new_object(jni::ref<javax::swing::border::Border> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::border::TitledBorder> new_object(jni::ref<javax::swing::border::Border> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::border::TitledBorder> new_object(jni::ref<javax::swing::border::Border> p1, jni::ref<java::lang::String> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::border::TitledBorder> new_object(jni::ref<javax::swing::border::Border> p1, jni::ref<java::lang::String> p2, jint p3, jint p4, jni::ref<java::awt::Font> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::swing::border::TitledBorder> new_object(jni::ref<javax::swing::border::Border> p1, jni::ref<java::lang::String> p2, jint p3, jint p4, jni::ref<java::awt::Font> p5, jni::ref<java::awt::Color> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
