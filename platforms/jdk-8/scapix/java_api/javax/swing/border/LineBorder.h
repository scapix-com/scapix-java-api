...
public:
	...
	static jni::ref<javax::swing::border::LineBorder> new_object(jni::ref<java::awt::Color> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::border::LineBorder> new_object(jni::ref<java::awt::Color> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::border::LineBorder> new_object(jni::ref<java::awt::Color> p1, jint p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
