...
public:
	...
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<javax::swing::Icon> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<javax::swing::Icon> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<javax::swing::Action> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::swing::Icon> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JCheckBox> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::swing::Icon> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
