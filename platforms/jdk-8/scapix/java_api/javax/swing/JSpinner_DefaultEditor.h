...
namespace scapix::java_api { namespace javax::swing { class JSpinner_DefaultEditor; }}
...
public:
	...
	static jni::ref<javax::swing::JSpinner_DefaultEditor> new_object(jni::ref<javax::swing::JSpinner> p1) { return object_base::new_object(p1); }
