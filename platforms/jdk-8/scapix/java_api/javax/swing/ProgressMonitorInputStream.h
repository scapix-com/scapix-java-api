...
public:
	...
	static jni::ref<javax::swing::ProgressMonitorInputStream> new_object(jni::ref<java::awt::Component> p1, jni::ref<java::lang::Object> p2, jni::ref<java::io::InputStream> p3) { return object_base::new_object(p1, p2, p3); }
