...
namespace scapix::java_api::javax::swing { class OverlayLayout; }
...
public:
	...
	static jni::ref<javax::swing::OverlayLayout> new_object(jni::ref<java::awt::Container> p1) { return base_::new_object(p1); }
...
protected:
	...
	OverlayLayout(handle_type h) : base_(h) {}
