...
namespace scapix::java_api { namespace javax::swing { class OverlayLayout; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_OVERLAYLAYOUT)
...
public:
	...
	static jni::ref<javax::swing::OverlayLayout> new_object(jni::ref<java::awt::Container> p1) { return object_base::new_object(p1); }
