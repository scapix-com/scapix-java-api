...
public:
	...
	static jni::ref<javax::swing::TransferHandler_TransferSupport> new_object(jni::ref<java::awt::Component> p1, jni::ref<java::awt::datatransfer::Transferable> p2) { return object_base::new_object(p1, p2); }
