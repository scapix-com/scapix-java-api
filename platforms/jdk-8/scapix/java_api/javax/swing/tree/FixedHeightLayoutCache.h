...
namespace scapix::java_api { namespace javax::swing::tree { class FixedHeightLayoutCache; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_SWING_TREE_FIXEDHEIGHTLAYOUTCACHE)
