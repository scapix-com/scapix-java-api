...
namespace scapix::java_api::javax::swing::tree { class FixedHeightLayoutCache; }
...
public:
	...
	static jni::ref<javax::swing::tree::FixedHeightLayoutCache> new_object() { return base_::new_object(); }
...
protected:
	...
	FixedHeightLayoutCache(handle_type h) : base_(h) {}
