...
namespace scapix::java_api { namespace javax::swing { class JTree_AccessibleJTree; }}
...
public:
	...
	static jni::ref<javax::swing::JTree_AccessibleJTree> new_object(jni::ref<javax::swing::JTree> p1) { return object_base::new_object(p1); }
