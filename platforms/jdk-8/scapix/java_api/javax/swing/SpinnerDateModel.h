...
public:
	...
	static jni::ref<javax::swing::SpinnerDateModel> new_object(jni::ref<java::util::Date> p1, jni::ref<java::lang::Comparable> p2, jni::ref<java::lang::Comparable> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
