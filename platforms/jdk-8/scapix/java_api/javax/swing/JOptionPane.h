...
public:
	...
	static jni::ref<javax::swing::JOptionPane> new_object(jni::ref<java::lang::Object> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JOptionPane> new_object(jni::ref<java::lang::Object> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JOptionPane> new_object(jni::ref<java::lang::Object> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::JOptionPane> new_object(jni::ref<java::lang::Object> p1, jint p2, jint p3, jni::ref<javax::swing::Icon> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::JOptionPane> new_object(jni::ref<java::lang::Object> p1, jint p2, jint p3, jni::ref<javax::swing::Icon> p4, jni::ref<jni::array<java::lang::Object>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::swing::JOptionPane> new_object(jni::ref<java::lang::Object> p1, jint p2, jint p3, jni::ref<javax::swing::Icon> p4, jni::ref<jni::array<java::lang::Object>> p5, jni::ref<java::lang::Object> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
