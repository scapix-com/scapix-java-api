...
public:
	...
	static jni::ref<javax::swing::JScrollBar> new_object(jint p1, jint p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::swing::JScrollBar> new_object(jint p1) { return object_base::new_object(p1); }
