...
namespace scapix::java_api { namespace javax::swing { class Spring_WidthSpring; }}
...
public:
	...
	static jni::ref<javax::swing::Spring_WidthSpring> new_object(jni::ref<java::awt::Component> p1) { return object_base::new_object(p1); }
