...
namespace scapix::java_api { namespace javax::swing { class SpringLayout_SpringProxy; }}
...
public:
	...
	static jni::ref<javax::swing::SpringLayout_SpringProxy> new_object(jni::ref<java::lang::String> p1, jni::ref<java::awt::Component> p2, jni::ref<javax::swing::SpringLayout> p3) { return object_base::new_object(p1, p2, p3); }
