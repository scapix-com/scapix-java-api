...
namespace scapix::java_api { namespace javax::swing::colorchooser { class SmartGridLayout; }}
...
public:
	...
	static jni::ref<javax::swing::colorchooser::SmartGridLayout> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
