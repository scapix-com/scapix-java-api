...
public:
	...
	static jni::ref<javax::swing::JInternalFrame> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::swing::JInternalFrame> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::swing::JInternalFrame> new_object(jni::ref<java::lang::String> p1, jboolean p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::swing::JInternalFrame> new_object(jni::ref<java::lang::String> p1, jboolean p2, jboolean p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::swing::JInternalFrame> new_object(jni::ref<java::lang::String> p1, jboolean p2, jboolean p3, jboolean p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
