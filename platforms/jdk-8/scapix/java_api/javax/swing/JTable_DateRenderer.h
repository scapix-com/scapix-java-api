...
namespace scapix::java_api { namespace javax::swing { class JTable_DateRenderer; }}
...
public:
	...
	static jni::ref<javax::swing::JTable_DateRenderer> new_object() { return object_base::new_object(); }
