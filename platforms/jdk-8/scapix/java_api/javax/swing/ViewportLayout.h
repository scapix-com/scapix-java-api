...
namespace scapix::java_api::javax::swing { class ViewportLayout; }
...
public:
	...
	static jni::ref<javax::swing::ViewportLayout> new_object() { return base_::new_object(); }
...
protected:
	...
	ViewportLayout(handle_type h) : base_(h) {}
