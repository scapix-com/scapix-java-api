...
#ifndef SCAPIX_JAVA_API_JAVAX_ACTIVATION_DATAHANDLER
...
public:
	...
	static jni::ref<javax::activation::DataHandler> new_object(jni::ref<javax::activation::DataSource> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::activation::DataHandler> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::activation::DataHandler> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
