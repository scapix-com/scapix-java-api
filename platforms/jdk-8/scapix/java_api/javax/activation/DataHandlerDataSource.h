...
namespace scapix::java_api { namespace javax::activation { class DataHandlerDataSource; }}
...
public:
	...
	static jni::ref<javax::activation::DataHandlerDataSource> new_object(jni::ref<javax::activation::DataHandler> p1) { return object_base::new_object(p1); }
