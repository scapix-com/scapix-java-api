...
namespace scapix::java_api { namespace javax::activation { class DataSourceDataContentHandler; }}
...
public:
	...
	static jni::ref<javax::activation::DataSourceDataContentHandler> new_object(jni::ref<javax::activation::DataContentHandler> p1, jni::ref<javax::activation::DataSource> p2) { return object_base::new_object(p1, p2); }
