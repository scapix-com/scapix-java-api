...
#ifndef SCAPIX_JAVA_API_JAVAX_ACTIVATION_URLDATASOURCE
...
public:
	...
	static jni::ref<javax::activation::URLDataSource> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
