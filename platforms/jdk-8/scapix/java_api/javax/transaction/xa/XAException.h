...
public:
	...
	static jni::ref<javax::transaction::xa::XAException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::transaction::xa::XAException> new_object(jint p1) { return object_base::new_object(p1); }
};
