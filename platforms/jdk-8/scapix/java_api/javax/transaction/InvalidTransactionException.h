...
#ifndef SCAPIX_JAVA_API_JAVAX_TRANSACTION_INVALIDTRANSACTIONEXCEPTION
...
public:
	...
	static jni::ref<javax::transaction::InvalidTransactionException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::transaction::InvalidTransactionException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
