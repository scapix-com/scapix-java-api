...
#ifndef SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_PROCESSOR_FWD
#define SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_PROCESSOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::annotation::processing { class Processor; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::annotation::processing::Processor>
{
	static constexpr fixed_string class_name = "javax/annotation/processing/Processor";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_PROCESSOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_PROCESSOR)
#define SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_PROCESSOR
...
class javax::annotation::processing::Processor : public jni::object_base<"javax/annotation/processing/Processor",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVAX_ANNOTATION_PROCESSING_PROCESSOR
