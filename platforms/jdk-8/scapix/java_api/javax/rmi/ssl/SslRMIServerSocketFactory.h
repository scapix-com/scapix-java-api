...
public:
	...
	static jni::ref<javax::rmi::ssl::SslRMIServerSocketFactory> new_object(jni::ref<jni::array<java::lang::String>> p1, jni::ref<jni::array<java::lang::String>> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::rmi::ssl::SslRMIServerSocketFactory> new_object(jni::ref<javax::net::ssl::SSLContext> p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<jni::array<java::lang::String>> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
