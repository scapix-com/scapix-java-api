...
namespace scapix::java_api { namespace javax::security::auth::kerberos { class KeyImpl; }}
...
public:
	...
	static jni::ref<javax::security::auth::kerberos::KeyImpl> new_object(jni::ref<jni::array<jbyte>> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::security::auth::kerberos::KeyImpl> new_object(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> p1, jni::ref<jni::array<jchar>> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
