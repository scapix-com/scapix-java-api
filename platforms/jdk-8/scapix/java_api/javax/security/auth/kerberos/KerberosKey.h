...
public:
	...
	static jni::ref<javax::security::auth::kerberos::KerberosKey> new_object(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> p1, jni::ref<jni::array<jbyte>> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::security::auth::kerberos::KerberosKey> new_object(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> p1, jni::ref<jni::array<jchar>> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
