...
public:
	...
	static jni::ref<javax::security::auth::kerberos::KerberosPrincipal> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::security::auth::kerberos::KerberosPrincipal> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
