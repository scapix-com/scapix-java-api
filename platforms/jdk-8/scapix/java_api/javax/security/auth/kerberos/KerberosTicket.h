...
public:
	...
	static jni::ref<javax::security::auth::kerberos::KerberosTicket> new_object(jni::ref<jni::array<jbyte>> p1, jni::ref<javax::security::auth::kerberos::KerberosPrincipal> p2, jni::ref<javax::security::auth::kerberos::KerberosPrincipal> p3, jni::ref<jni::array<jbyte>> p4, jint p5, jni::ref<jni::array<jboolean>> p6, jni::ref<java::util::Date> p7, jni::ref<java::util::Date> p8, jni::ref<java::util::Date> p9, jni::ref<java::util::Date> p10, jni::ref<jni::array<java::net::InetAddress>> p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
