...
public:
	...
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::security::auth::callback::UnsupportedCallbackException> new_object(jni::ref<javax::security::auth::callback::Callback> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
