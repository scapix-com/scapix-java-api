...
public:
	...
	static jni::ref<javax::security::auth::Subject> new_object(jboolean p1, jni::ref<java::util::Set> p2, jni::ref<java::util::Set> p3, jni::ref<java::util::Set> p4) { return object_base::new_object(p1, p2, p3, p4); }
