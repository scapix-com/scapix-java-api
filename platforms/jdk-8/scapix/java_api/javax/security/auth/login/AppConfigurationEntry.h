...
public:
	...
	static jni::ref<javax::security::auth::login::AppConfigurationEntry> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::security::auth::login::AppConfigurationEntry_LoginModuleControlFlag> p2, jni::ref<java::util::Map> p3) { return base_::new_object(p1, p2, p3); }
