...
public:
	...
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Map> p2) { return base_::new_object(p1, p2); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<jni::array<jbyte>> p1) { return base_::new_object(p1); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::io::InputStream> p1) { return base_::new_object(p1); }
