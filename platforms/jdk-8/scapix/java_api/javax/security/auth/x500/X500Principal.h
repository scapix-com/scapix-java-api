...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_X500_X500PRINCIPAL
...
public:
	...
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	jni::ref<java::lang::String> getName() { return call_method<"getName", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getName(jni::ref<java::lang::String> p1) { return call_method<"getName", jni::ref<java::lang::String>>(p1); }
	jni::ref<java::lang::String> getName(jni::ref<java::lang::String> p1, jni::ref<java::util::Map> p2) { return call_method<"getName", jni::ref<java::lang::String>>(p1, p2); }
