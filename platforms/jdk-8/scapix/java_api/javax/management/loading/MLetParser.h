...
namespace scapix::java_api { namespace javax::management::loading { class MLetParser; }}
...
public:
	...
	static jni::ref<javax::management::loading::MLetParser> new_object() { return object_base::new_object(); }
