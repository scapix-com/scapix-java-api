...
public:
	...
	static jni::ref<javax::management::loading::PrivateMLet> new_object(jni::ref<jni::array<java::net::URL>> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::management::loading::PrivateMLet> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::lang::ClassLoader> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::management::loading::PrivateMLet> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::lang::ClassLoader> p2, jni::ref<java::net::URLStreamHandlerFactory> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
};
