...
public:
	...
	static jni::ref<javax::management::MBeanServerNotification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3, jni::ref<javax::management::ObjectName> p4) { return object_base::new_object(p1, p2, p3, p4); }
