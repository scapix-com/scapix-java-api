...
namespace scapix::java_api { namespace javax::management::monitor { class Monitor_SchedulerTask; }}
...
public:
	...
	static jni::ref<javax::management::monitor::Monitor_SchedulerTask> new_object(jni::ref<javax::management::monitor::Monitor> p1) { return object_base::new_object(p1); }
