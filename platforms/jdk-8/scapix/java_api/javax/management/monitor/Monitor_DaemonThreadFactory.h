...
namespace scapix::java_api { namespace javax::management::monitor { class Monitor_DaemonThreadFactory; }}
...
public:
	...
	static jni::ref<javax::management::monitor::Monitor_DaemonThreadFactory> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::management::monitor::Monitor_DaemonThreadFactory> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::ThreadGroup> p2) { return object_base::new_object(p1, p2); }
