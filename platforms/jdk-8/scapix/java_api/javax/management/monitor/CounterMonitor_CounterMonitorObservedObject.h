...
namespace scapix::java_api { namespace javax::management::monitor { class CounterMonitor_CounterMonitorObservedObject; }}
...
public:
	...
	static jni::ref<javax::management::monitor::CounterMonitor_CounterMonitorObservedObject> new_object(jni::ref<javax::management::ObjectName> p1) { return object_base::new_object(p1); }
