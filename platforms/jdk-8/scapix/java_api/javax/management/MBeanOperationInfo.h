...
public:
	...
	static jni::ref<javax::management::MBeanOperationInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::reflect::Method> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::management::MBeanOperationInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<javax::management::MBeanParameterInfo>> p3, jni::ref<java::lang::String> p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<javax::management::MBeanOperationInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<javax::management::MBeanParameterInfo>> p3, jni::ref<java::lang::String> p4, jint p5, jni::ref<javax::management::Descriptor> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
