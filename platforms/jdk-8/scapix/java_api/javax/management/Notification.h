...
public:
	...
	static jni::ref<javax::management::Notification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::management::Notification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::management::Notification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3, jlong p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<javax::management::Notification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3, jlong p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
