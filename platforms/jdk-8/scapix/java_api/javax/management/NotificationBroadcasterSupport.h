...
public:
	...
	static jni::ref<javax::management::NotificationBroadcasterSupport> new_object(jni::ref<java::util::concurrent::Executor> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::management::NotificationBroadcasterSupport> new_object(jni::ref<jni::array<javax::management::MBeanNotificationInfo>> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::management::NotificationBroadcasterSupport> new_object(jni::ref<java::util::concurrent::Executor> p1, jni::ref<jni::array<javax::management::MBeanNotificationInfo>> p2) { return object_base::new_object(p1, p2); }
