...
namespace scapix::java_api { namespace javax::management { class MatchQueryExp; }}
...
public:
	...
	static jni::ref<javax::management::MatchQueryExp> new_object() { return object_base::new_object(); }
	static jni::ref<javax::management::MatchQueryExp> new_object(jni::ref<javax::management::AttributeValueExp> p1, jni::ref<javax::management::StringValueExp> p2) { return object_base::new_object(p1, p2); }
