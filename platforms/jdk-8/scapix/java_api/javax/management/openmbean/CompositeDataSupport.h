...
public:
	...
	static jni::ref<javax::management::openmbean::CompositeDataSupport> new_object(jni::ref<javax::management::openmbean::CompositeType> p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<jni::array<java::lang::Object>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::management::openmbean::CompositeDataSupport> new_object(jni::ref<javax::management::openmbean::CompositeType> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
