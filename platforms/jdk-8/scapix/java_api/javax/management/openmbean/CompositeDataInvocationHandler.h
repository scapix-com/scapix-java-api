...
public:
	...
	static jni::ref<javax::management::openmbean::CompositeDataInvocationHandler> new_object(jni::ref<javax::management::openmbean::CompositeData> p1) { return object_base::new_object(p1); }
