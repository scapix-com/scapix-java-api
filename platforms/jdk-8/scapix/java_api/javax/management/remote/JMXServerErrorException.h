...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_REMOTE_JMXSERVERERROREXCEPTION
...
public:
	...
	static jni::ref<javax::management::remote::JMXServerErrorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Error> p2) { return object_base::new_object(p1, p2); }
