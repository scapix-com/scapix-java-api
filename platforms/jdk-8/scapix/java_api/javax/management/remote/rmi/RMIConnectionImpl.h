...
namespace scapix::java_api { namespace javax::management::remote::rmi { class RMIConnectionImpl; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_MANAGEMENT_REMOTE_RMI_RMICONNECTIONIMPL)
...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnectionImpl> new_object(jni::ref<javax::management::remote::rmi::RMIServerImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::ClassLoader> p3, jni::ref<javax::security::auth::Subject> p4, jni::ref<java::util::Map> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
