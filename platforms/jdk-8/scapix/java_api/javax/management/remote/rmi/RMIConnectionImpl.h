...
namespace scapix::java_api::javax::management::remote::rmi { class RMIConnectionImpl; }
...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnectionImpl> new_object(jni::ref<javax::management::remote::rmi::RMIServerImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::ClassLoader> p3, jni::ref<javax::security::auth::Subject> p4, jni::ref<java::util::Map> p5) { return base_::new_object(p1, p2, p3, p4, p5); }
...
protected:
	...
	RMIConnectionImpl(handle_type h) : base_(h) {}
