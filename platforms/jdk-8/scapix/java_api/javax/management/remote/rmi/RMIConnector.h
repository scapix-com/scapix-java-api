...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnector> new_object(jni::ref<javax::management::remote::JMXServiceURL> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::management::remote::rmi::RMIConnector> new_object(jni::ref<javax::management::remote::rmi::RMIServer> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
