...
namespace scapix::java_api { namespace javax::management::remote::rmi { class RMIConnector_RMINotifClient; }}
...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnector_RMINotifClient> new_object(jni::ref<javax::management::remote::rmi::RMIConnector> p1, jni::ref<java::lang::ClassLoader> p2, jni::ref<java::util::Map> p3) { return object_base::new_object(p1, p2, p3); }
