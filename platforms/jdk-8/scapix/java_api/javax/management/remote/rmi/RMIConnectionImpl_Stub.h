...
namespace scapix::java_api::javax::management::remote::rmi { class RMIConnectionImpl_Stub; }
...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnectionImpl_Stub> new_object(jni::ref<java::rmi::server::RemoteRef> p1) { return base_::new_object(p1); }
...
protected:
	...
	RMIConnectionImpl_Stub(handle_type h) : base_(h) {}
