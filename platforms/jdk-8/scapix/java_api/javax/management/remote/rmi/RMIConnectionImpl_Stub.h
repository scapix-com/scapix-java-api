...
namespace scapix::java_api { namespace javax::management::remote::rmi { class RMIConnectionImpl_Stub; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_MANAGEMENT_REMOTE_RMI_RMICONNECTIONIMPL_STUB)
...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnectionImpl_Stub> new_object(jni::ref<java::rmi::server::RemoteRef> p1) { return object_base::new_object(p1); }
