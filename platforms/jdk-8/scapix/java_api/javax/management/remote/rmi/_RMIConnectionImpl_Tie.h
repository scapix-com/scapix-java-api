...
namespace scapix::java_api::javax::management::remote::rmi { class _RMIConnectionImpl_Tie; }
...
public:
	...
	static jni::ref<javax::management::remote::rmi::_RMIConnectionImpl_Tie> new_object() { return base_::new_object(); }
