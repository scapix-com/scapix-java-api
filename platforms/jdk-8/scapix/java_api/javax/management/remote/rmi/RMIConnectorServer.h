...
public:
	...
	static jni::ref<javax::management::remote::rmi::RMIConnectorServer> new_object(jni::ref<javax::management::remote::JMXServiceURL> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::management::remote::rmi::RMIConnectorServer> new_object(jni::ref<javax::management::remote::JMXServiceURL> p1, jni::ref<java::util::Map> p2, jni::ref<javax::management::MBeanServer> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::management::remote::rmi::RMIConnectorServer> new_object(jni::ref<javax::management::remote::JMXServiceURL> p1, jni::ref<java::util::Map> p2, jni::ref<javax::management::remote::rmi::RMIServerImpl> p3, jni::ref<javax::management::MBeanServer> p4) { return object_base::new_object(p1, p2, p3, p4); }
