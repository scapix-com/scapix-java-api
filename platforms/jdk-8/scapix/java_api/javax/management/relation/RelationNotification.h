...
public:
	...
	static jni::ref<javax::management::relation::RelationNotification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3, jlong p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6, jni::ref<java::lang::String> p7, jni::ref<javax::management::ObjectName> p8, jni::ref<java::util::List> p9) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static jni::ref<javax::management::relation::RelationNotification> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jlong p3, jlong p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6, jni::ref<java::lang::String> p7, jni::ref<javax::management::ObjectName> p8, jni::ref<java::lang::String> p9, jni::ref<java::util::List> p10, jni::ref<java::util::List> p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
