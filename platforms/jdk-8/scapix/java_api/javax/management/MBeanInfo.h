...
public:
	...
	static jni::ref<javax::management::MBeanInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<javax::management::MBeanAttributeInfo>> p3, jni::ref<jni::array<javax::management::MBeanConstructorInfo>> p4, jni::ref<jni::array<javax::management::MBeanOperationInfo>> p5, jni::ref<jni::array<javax::management::MBeanNotificationInfo>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<javax::management::MBeanInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<javax::management::MBeanAttributeInfo>> p3, jni::ref<jni::array<javax::management::MBeanConstructorInfo>> p4, jni::ref<jni::array<javax::management::MBeanOperationInfo>> p5, jni::ref<jni::array<javax::management::MBeanNotificationInfo>> p6, jni::ref<javax::management::Descriptor> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
