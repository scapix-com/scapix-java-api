...
namespace scapix::java_api { namespace javax::management { class MBeanServer; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER)
