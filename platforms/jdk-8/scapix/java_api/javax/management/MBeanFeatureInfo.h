...
public:
	...
	static jni::ref<javax::management::MBeanFeatureInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::management::MBeanFeatureInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<javax::management::Descriptor> p3) { return object_base::new_object(p1, p2, p3); }
