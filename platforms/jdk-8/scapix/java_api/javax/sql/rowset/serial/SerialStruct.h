...
public:
	...
	static jni::ref<javax::sql::rowset::serial::SerialStruct> new_object(jni::ref<java::sql::Struct> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::sql::rowset::serial::SerialStruct> new_object(jni::ref<java::sql::SQLData> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
