...
public:
	...
	static jni::ref<javax::sql::rowset::serial::SQLOutputImpl> new_object(jni::ref<java::util::Vector> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
