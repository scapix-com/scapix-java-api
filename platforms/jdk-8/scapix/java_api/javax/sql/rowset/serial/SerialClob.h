...
public:
	...
	static jni::ref<javax::sql::rowset::serial::SerialClob> new_object(jni::ref<jni::array<jchar>> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::sql::rowset::serial::SerialClob> new_object(jni::ref<java::sql::Clob> p1) { return object_base::new_object(p1); }
