...
public:
	...
	static jni::ref<javax::sql::rowset::serial::SerialBlob> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::sql::rowset::serial::SerialBlob> new_object(jni::ref<java::sql::Blob> p1) { return object_base::new_object(p1); }
