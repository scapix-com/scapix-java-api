...
public:
	...
	static jni::ref<javax::sql::rowset::serial::SerialArray> new_object(jni::ref<java::sql::Array> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
	void free() { return call_method<"free", void>(); }
	static jni::ref<javax::sql::rowset::serial::SerialArray> new_object(jni::ref<java::sql::Array> p1) { return object_base::new_object(p1); }
