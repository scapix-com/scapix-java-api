...
public:
	...
	static jni::ref<javax::sql::ConnectionEvent> new_object(jni::ref<javax::sql::PooledConnection> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::sql::ConnectionEvent> new_object(jni::ref<javax::sql::PooledConnection> p1, jni::ref<java::sql::SQLException> p2) { return object_base::new_object(p1, p2); }
