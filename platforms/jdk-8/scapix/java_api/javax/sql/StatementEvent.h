...
public:
	...
	static jni::ref<javax::sql::StatementEvent> new_object(jni::ref<javax::sql::PooledConnection> p1, jni::ref<java::sql::PreparedStatement> p2) { return base_::new_object(p1, p2); }
	static jni::ref<javax::sql::StatementEvent> new_object(jni::ref<javax::sql::PooledConnection> p1, jni::ref<java::sql::PreparedStatement> p2, jni::ref<java::sql::SQLException> p3) { return base_::new_object(p1, p2, p3); }
