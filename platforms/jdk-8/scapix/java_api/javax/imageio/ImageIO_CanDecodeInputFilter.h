...
namespace scapix::java_api { namespace javax::imageio { class ImageIO_CanDecodeInputFilter; }}
...
public:
	...
	static jni::ref<javax::imageio::ImageIO_CanDecodeInputFilter> new_object(jni::ref<java::lang::Object> p1) { return object_base::new_object(p1); }
