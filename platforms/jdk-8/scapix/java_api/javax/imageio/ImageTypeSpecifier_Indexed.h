...
namespace scapix::java_api { namespace javax::imageio { class ImageTypeSpecifier_Indexed; }}
...
public:
	...
	static jni::ref<javax::imageio::ImageTypeSpecifier_Indexed> new_object(jni::ref<jni::array<jbyte>> p1, jni::ref<jni::array<jbyte>> p2, jni::ref<jni::array<jbyte>> p3, jni::ref<jni::array<jbyte>> p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
