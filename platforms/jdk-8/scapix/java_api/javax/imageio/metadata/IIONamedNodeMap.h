...
namespace scapix::java_api { namespace javax::imageio::metadata { class IIONamedNodeMap; }}
...
public:
	...
	static jni::ref<javax::imageio::metadata::IIONamedNodeMap> new_object(jni::ref<java::util::List> p1) { return object_base::new_object(p1); }
