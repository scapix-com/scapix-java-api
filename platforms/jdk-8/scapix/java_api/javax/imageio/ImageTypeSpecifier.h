...
public:
	...
	static jni::ref<javax::imageio::ImageTypeSpecifier> new_object(jni::ref<java::awt::image::ColorModel> p1, jni::ref<java::awt::image::SampleModel> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::imageio::ImageTypeSpecifier> new_object(jni::ref<java::awt::image::RenderedImage> p1) { return object_base::new_object(p1); }
