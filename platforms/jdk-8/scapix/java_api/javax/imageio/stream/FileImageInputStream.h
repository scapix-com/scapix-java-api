...
public:
	...
	static jni::ref<javax::imageio::stream::FileImageInputStream> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::imageio::stream::FileImageInputStream> new_object(jni::ref<java::io::RandomAccessFile> p1) { return object_base::new_object(p1); }
