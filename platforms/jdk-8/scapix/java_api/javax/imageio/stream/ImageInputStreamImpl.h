...
namespace scapix::java_api::javax::imageio::stream { class ImageInputStreamImpl; }
...
public:
	...
	static jni::ref<javax::imageio::stream::ImageInputStreamImpl> new_object() { return base_::new_object(); }
...
protected:
	...
	ImageInputStreamImpl(handle_type h) : base_(h) {}
