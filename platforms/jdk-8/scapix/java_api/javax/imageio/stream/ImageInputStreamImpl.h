...
namespace scapix::java_api { namespace javax::imageio::stream { class ImageInputStreamImpl; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_IMAGEIO_STREAM_IMAGEINPUTSTREAMIMPL)
