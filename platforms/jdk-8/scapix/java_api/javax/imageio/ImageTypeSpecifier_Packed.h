...
namespace scapix::java_api { namespace javax::imageio { class ImageTypeSpecifier_Packed; }}
...
public:
	...
	static jni::ref<javax::imageio::ImageTypeSpecifier_Packed> new_object(jni::ref<java::awt::color::ColorSpace> p1, jint p2, jint p3, jint p4, jint p5, jint p6, jboolean p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
