...
public:
	...
	static jni::ref<javax::imageio::IIOImage> new_object(jni::ref<java::awt::image::RenderedImage> p1, jni::ref<java::util::List> p2, jni::ref<javax::imageio::metadata::IIOMetadata> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::imageio::IIOImage> new_object(jni::ref<java::awt::image::Raster> p1, jni::ref<java::util::List> p2, jni::ref<javax::imageio::metadata::IIOMetadata> p3) { return object_base::new_object(p1, p2, p3); }
