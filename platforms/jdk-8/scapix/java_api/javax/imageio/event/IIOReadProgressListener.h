...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_EVENT_IIOREADPROGRESSLISTENER_FWD
#define SCAPIX_JAVA_API_JAVAX_IMAGEIO_EVENT_IIOREADPROGRESSLISTENER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::javax::imageio::event { class IIOReadProgressListener; }

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::imageio::event::IIOReadProgressListener>
{
	static constexpr fixed_string class_name = "javax/imageio/event/IIOReadProgressListener";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::EventListener>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_IMAGEIO_EVENT_IIOREADPROGRESSLISTENER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_IMAGEIO_EVENT_IIOREADPROGRESSLISTENER)
#define SCAPIX_JAVA_API_JAVAX_IMAGEIO_EVENT_IIOREADPROGRESSLISTENER
...
class javax::imageio::event::IIOReadProgressListener : public jni::object_base<"javax/imageio/event/IIOReadProgressListener",
	java::lang::Object,
...
protected:
	...
	IIOReadProgressListener(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVAX_IMAGEIO_EVENT_IIOREADPROGRESSLISTENER
