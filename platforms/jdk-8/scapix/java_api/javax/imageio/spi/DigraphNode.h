...
namespace scapix::java_api { namespace javax::imageio::spi { class DigraphNode; }}
...
public:
	...
	static jni::ref<javax::imageio::spi::DigraphNode> new_object(jni::ref<java::lang::Object> p1) { return object_base::new_object(p1); }
