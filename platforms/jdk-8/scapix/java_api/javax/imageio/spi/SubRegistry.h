...
namespace scapix::java_api { namespace javax::imageio::spi { class SubRegistry; }}
...
public:
	...
	static jni::ref<javax::imageio::spi::SubRegistry> new_object(jni::ref<javax::imageio::spi::ServiceRegistry> p1, jni::ref<java::lang::Class> p2) { return object_base::new_object(p1, p2); }
