...
namespace scapix::java_api { namespace javax::imageio::spi { class PartiallyOrderedSet; }}
...
public:
	...
	static jni::ref<javax::imageio::spi::PartiallyOrderedSet> new_object() { return object_base::new_object(); }
