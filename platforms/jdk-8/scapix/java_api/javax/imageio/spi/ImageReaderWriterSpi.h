...
public:
	...
	static jni::ref<javax::imageio::spi::ImageReaderWriterSpi> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<java::lang::String>> p3, jni::ref<jni::array<java::lang::String>> p4, jni::ref<jni::array<java::lang::String>> p5, jni::ref<java::lang::String> p6, jboolean p7, jni::ref<java::lang::String> p8, jni::ref<java::lang::String> p9, jni::ref<jni::array<java::lang::String>> p10, jni::ref<jni::array<java::lang::String>> p11, jboolean p12, jni::ref<java::lang::String> p13, jni::ref<java::lang::String> p14, jni::ref<jni::array<java::lang::String>> p15, jni::ref<jni::array<java::lang::String>> p16) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16); }
