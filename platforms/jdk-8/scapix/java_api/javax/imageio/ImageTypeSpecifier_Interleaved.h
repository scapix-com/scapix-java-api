...
namespace scapix::java_api { namespace javax::imageio { class ImageTypeSpecifier_Interleaved; }}
...
public:
	...
	static jni::ref<javax::imageio::ImageTypeSpecifier_Interleaved> new_object(jni::ref<java::awt::color::ColorSpace> p1, jni::ref<jni::array<jint>> p2, jint p3, jboolean p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
