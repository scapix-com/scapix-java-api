...
namespace scapix::java_api { namespace javax::print { class MimeType; }}
...
public:
	...
	static jni::ref<javax::print::MimeType> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
