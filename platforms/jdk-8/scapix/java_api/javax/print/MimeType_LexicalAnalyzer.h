...
namespace scapix::java_api { namespace javax::print { class MimeType_LexicalAnalyzer; }}
...
public:
	...
	static jni::ref<javax::print::MimeType_LexicalAnalyzer> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
