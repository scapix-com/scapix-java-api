...
public:
	...
	static jni::ref<javax::print::attribute::standard::NumberUpSupported> new_object(jni::ref<jni::array<jni::array<jint>>> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::print::attribute::standard::NumberUpSupported> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<javax::print::attribute::standard::NumberUpSupported> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
