...
public:
	...
	static jni::ref<javax::print::attribute::standard::PrinterLocation> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Locale> p2) { return object_base::new_object(p1, p2); }
