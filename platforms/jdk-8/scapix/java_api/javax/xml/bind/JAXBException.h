...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_BIND_JAXBEXCEPTION
...
public:
	...
	static jni::ref<javax::xml::bind::JAXBException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::bind::JAXBException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::bind::JAXBException> new_object(jni::ref<java::lang::Throwable> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::bind::JAXBException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::bind::JAXBException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Throwable> p3) { return object_base::new_object(p1, p2, p3); }
