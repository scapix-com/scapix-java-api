...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_BIND_HELPERS_NOTIDENTIFIABLEEVENTIMPL
...
public:
	...
	static jni::ref<javax::xml::bind::helpers::NotIdentifiableEventImpl> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<javax::xml::bind::ValidationEventLocator> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::xml::bind::helpers::NotIdentifiableEventImpl> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<javax::xml::bind::ValidationEventLocator> p3, jni::ref<java::lang::Throwable> p4) { return object_base::new_object(p1, p2, p3, p4); }
};
