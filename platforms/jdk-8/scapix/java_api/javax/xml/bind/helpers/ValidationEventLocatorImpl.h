...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_BIND_HELPERS_VALIDATIONEVENTLOCATORIMPL
...
public:
	...
	static jni::ref<javax::xml::bind::helpers::ValidationEventLocatorImpl> new_object() { return object_base::new_object(); }
	static jni::ref<javax::xml::bind::helpers::ValidationEventLocatorImpl> new_object(jni::ref<org::xml::sax::Locator> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::bind::helpers::ValidationEventLocatorImpl> new_object(jni::ref<org::xml::sax::SAXParseException> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::bind::helpers::ValidationEventLocatorImpl> new_object(jni::ref<org::w3c::dom::Node> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::bind::helpers::ValidationEventLocatorImpl> new_object(jni::ref<java::lang::Object> p1) { return object_base::new_object(p1); }
