...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_BIND_JAXBPERMISSION
...
public:
	...
	static jni::ref<javax::xml::bind::JAXBPermission> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
