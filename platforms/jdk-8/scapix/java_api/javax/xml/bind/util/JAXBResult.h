...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_BIND_UTIL_JAXBRESULT
...
public:
	...
	static jni::ref<javax::xml::bind::util::JAXBResult> new_object(jni::ref<javax::xml::bind::JAXBContext> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::bind::util::JAXBResult> new_object(jni::ref<javax::xml::bind::Unmarshaller> p1) { return object_base::new_object(p1); }
