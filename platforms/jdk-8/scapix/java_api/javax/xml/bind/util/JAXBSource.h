...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_BIND_UTIL_JAXBSOURCE
...
public:
	...
	static jni::ref<javax::xml::bind::util::JAXBSource> new_object(jni::ref<javax::xml::bind::JAXBContext> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::bind::util::JAXBSource> new_object(jni::ref<javax::xml::bind::Marshaller> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
};
