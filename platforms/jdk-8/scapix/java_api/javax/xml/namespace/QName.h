...
public:
	...
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return base_::new_object(p1, p2); }
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
