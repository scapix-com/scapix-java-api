...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_NAMESPACE_QNAME
...
public:
	...
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::xml::namespace_::QName> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	...
	static jni::ref<javax::xml::namespace_::QName> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<javax::xml::namespace_::QName>>(p1); }
};
