...
public:
	...
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> p1, jni::ref<org::w3c::dom::Node> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::transform::dom::DOMResult> new_object(jni::ref<org::w3c::dom::Node> p1, jni::ref<org::w3c::dom::Node> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
