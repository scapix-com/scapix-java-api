...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_TRANSFORM_TRANSFORMERFACTORY
...
public:
	...
	static jni::ref<javax::xml::transform::TransformerFactory> newInstance(jni::ref<java::lang::String> p1, jni::ref<java::lang::ClassLoader> p2) { return call_static_method<"newInstance", jni::ref<javax::xml::transform::TransformerFactory>>(p1, p2); }
