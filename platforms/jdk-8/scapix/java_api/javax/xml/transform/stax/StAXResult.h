...
public:
	...
	static jni::ref<javax::xml::transform::stax::StAXResult> new_object(jni::ref<javax::xml::stream::XMLEventWriter> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::transform::stax::StAXResult> new_object(jni::ref<javax::xml::stream::XMLStreamWriter> p1) { return object_base::new_object(p1); }
