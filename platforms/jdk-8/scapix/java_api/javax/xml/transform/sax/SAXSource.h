...
public:
	...
	static jni::ref<javax::xml::transform::sax::SAXSource> new_object(jni::ref<org::xml::sax::XMLReader> p1, jni::ref<org::xml::sax::InputSource> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::transform::sax::SAXSource> new_object(jni::ref<org::xml::sax::InputSource> p1) { return object_base::new_object(p1); }
