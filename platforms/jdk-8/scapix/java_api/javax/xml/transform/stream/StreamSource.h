...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_TRANSFORM_STREAM_STREAMSOURCE
...
public:
	...
	static jni::ref<javax::xml::transform::stream::StreamSource> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::transform::stream::StreamSource> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::transform::stream::StreamSource> new_object(jni::ref<java::io::Reader> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::transform::stream::StreamSource> new_object(jni::ref<java::io::Reader> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::transform::stream::StreamSource> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::transform::stream::StreamSource> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	void setInputStream(jni::ref<java::io::InputStream> p1) { return call_method<"setInputStream", void>(p1); }
