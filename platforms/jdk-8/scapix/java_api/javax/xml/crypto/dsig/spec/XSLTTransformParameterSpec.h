...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::spec::XSLTTransformParameterSpec> new_object(jni::ref<javax::xml::crypto::XMLStructure> p1) { return object_base::new_object(p1); }
