...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<java::security::Key> p1, jni::ref<org::w3c::dom::Node> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<java::security::Key> p1, jni::ref<org::w3c::dom::Node> p2, jni::ref<org::w3c::dom::Node> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<javax::xml::crypto::KeySelector> p1, jni::ref<org::w3c::dom::Node> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::crypto::dsig::dom::DOMSignContext> new_object(jni::ref<javax::xml::crypto::KeySelector> p1, jni::ref<org::w3c::dom::Node> p2, jni::ref<org::w3c::dom::Node> p3) { return object_base::new_object(p1, p2, p3); }
