...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_WS_PROTOCOLEXCEPTION
...
public:
	...
	static jni::ref<javax::xml::ws::ProtocolException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::xml::ws::ProtocolException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::ws::ProtocolException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::xml::ws::ProtocolException> new_object(jni::ref<java::lang::Throwable> p1) { return object_base::new_object(p1); }
};
