...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_PARSERS_FACTORYCONFIGURATIONERROR
...
public:
	...
	static jni::ref<javax::xml::parsers::FactoryConfigurationError> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::parsers::FactoryConfigurationError> new_object(jni::ref<java::lang::Exception> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::xml::parsers::FactoryConfigurationError> new_object(jni::ref<java::lang::Exception> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
