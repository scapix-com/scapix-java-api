...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_SOAP_MIMEHEADER
...
public:
	...
	static jni::ref<javax::xml::soap::MimeHeader> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
