...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_DATATYPE_DURATION
...
public:
	...
	static jni::ref<javax::xml::datatype::Duration> new_object() { return object_base::new_object(); }
	...
	jboolean isLongerThan(jni::ref<javax::xml::datatype::Duration> p1) { return call_method<"isLongerThan", jboolean>(p1); }
	jboolean isShorterThan(jni::ref<javax::xml::datatype::Duration> p1) { return call_method<"isShorterThan", jboolean>(p1); }
