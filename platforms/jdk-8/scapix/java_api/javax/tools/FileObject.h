...
#ifndef SCAPIX_JAVA_API_JAVAX_TOOLS_FILEOBJECT_FWD
#define SCAPIX_JAVA_API_JAVAX_TOOLS_FILEOBJECT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::tools { class FileObject; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::tools::FileObject>
{
	static constexpr fixed_string class_name = "javax/tools/FileObject";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_TOOLS_FILEOBJECT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_TOOLS_FILEOBJECT)
#define SCAPIX_JAVA_API_JAVAX_TOOLS_FILEOBJECT
...
class javax::tools::FileObject : public jni::object_base<"javax/tools/FileObject",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVAX_TOOLS_FILEOBJECT
