...
namespace scapix::java_api { namespace javax::naming::ldap { class InitialLdapContext; }}
...
public:
	...
	static jni::ref<javax::naming::ldap::InitialLdapContext> new_object(jni::ref<java::util::Hashtable> p1, jni::ref<jni::array<javax::naming::ldap::Control>> p2) { return object_base::new_object(p1, p2); }
