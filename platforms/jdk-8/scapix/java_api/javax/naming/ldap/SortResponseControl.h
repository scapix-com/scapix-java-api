...
public:
	...
	static jni::ref<javax::naming::ldap::SortResponseControl> new_object(jni::ref<java::lang::String> p1, jboolean p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
