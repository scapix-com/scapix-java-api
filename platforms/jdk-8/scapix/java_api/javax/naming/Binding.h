...
public:
	...
	static jni::ref<javax::naming::Binding> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::naming::Binding> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::naming::Binding> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Object> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::naming::Binding> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Object> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
