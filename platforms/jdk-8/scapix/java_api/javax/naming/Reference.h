...
public:
	...
	static jni::ref<javax::naming::Reference> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::naming::Reference> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::naming::RefAddr> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::naming::Reference> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::naming::Reference> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::naming::RefAddr> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
