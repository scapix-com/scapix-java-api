...
namespace scapix::java_api { namespace javax::naming::directory { class BasicAttributes_AttrEnumImpl; }}
...
public:
	...
	static jni::ref<javax::naming::directory::BasicAttributes_AttrEnumImpl> new_object(jni::ref<javax::naming::directory::BasicAttributes> p1) { return object_base::new_object(p1); }
