...
public:
	...
	static jni::ref<javax::naming::directory::ModificationItem> new_object(jint p1, jni::ref<javax::naming::directory::Attribute> p2) { return object_base::new_object(p1, p2); }
