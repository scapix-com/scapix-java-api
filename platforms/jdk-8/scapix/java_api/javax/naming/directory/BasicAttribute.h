...
public:
	...
	static jni::ref<javax::naming::directory::BasicAttribute> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::naming::directory::BasicAttribute> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::naming::directory::BasicAttribute> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<javax::naming::directory::BasicAttribute> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
