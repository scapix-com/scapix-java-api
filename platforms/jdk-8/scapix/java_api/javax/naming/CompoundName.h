...
namespace scapix::java_api { namespace javax::naming { class CompoundName; }}
...
public:
	...
	static jni::ref<javax::naming::CompoundName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Properties> p2) { return object_base::new_object(p1, p2); }
