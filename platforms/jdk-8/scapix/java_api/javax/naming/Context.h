...
#ifndef SCAPIX_JAVA_API_JAVAX_NAMING_CONTEXT_FWD
#define SCAPIX_JAVA_API_JAVAX_NAMING_CONTEXT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace javax::naming { class Context; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::javax::naming::Context>
{
	static constexpr fixed_string class_name = "javax/naming/Context";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVAX_NAMING_CONTEXT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVAX_NAMING_CONTEXT)
#define SCAPIX_JAVA_API_JAVAX_NAMING_CONTEXT
...
class javax::naming::Context : public jni::object_base<"javax/naming/Context",
	java::lang::Object>
{
public:

	static jni::ref<java::lang::String> INITIAL_CONTEXT_FACTORY() { return get_static_field<"INITIAL_CONTEXT_FACTORY", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> OBJECT_FACTORIES() { return get_static_field<"OBJECT_FACTORIES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> STATE_FACTORIES() { return get_static_field<"STATE_FACTORIES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> URL_PKG_PREFIXES() { return get_static_field<"URL_PKG_PREFIXES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> PROVIDER_URL() { return get_static_field<"PROVIDER_URL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> DNS_URL() { return get_static_field<"DNS_URL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> AUTHORITATIVE() { return get_static_field<"AUTHORITATIVE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> BATCHSIZE() { return get_static_field<"BATCHSIZE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> REFERRAL() { return get_static_field<"REFERRAL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SECURITY_PROTOCOL() { return get_static_field<"SECURITY_PROTOCOL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SECURITY_AUTHENTICATION() { return get_static_field<"SECURITY_AUTHENTICATION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SECURITY_PRINCIPAL() { return get_static_field<"SECURITY_PRINCIPAL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> SECURITY_CREDENTIALS() { return get_static_field<"SECURITY_CREDENTIALS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> LANGUAGE() { return get_static_field<"LANGUAGE", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> APPLET() { return get_static_field<"APPLET", jni::ref<java::lang::String>>(); }
...
#endif // SCAPIX_JAVA_API_JAVAX_NAMING_CONTEXT
