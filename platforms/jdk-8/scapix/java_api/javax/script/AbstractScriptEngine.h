...
namespace scapix::java_api { namespace javax::script { class AbstractScriptEngine; }}
...
public:
	...
	static jni::ref<javax::script::AbstractScriptEngine> new_object(jni::ref<javax::script::Bindings> p1) { return object_base::new_object(p1); }
