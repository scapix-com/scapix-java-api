...
public:
	...
	static jni::ref<javax::script::ScriptException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::script::ScriptException> new_object(jni::ref<java::lang::Exception> p1) { return object_base::new_object(p1); }
	static jni::ref<javax::script::ScriptException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<javax::script::ScriptException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
