...
#ifndef SCAPIX_JAVA_API_JAVA_APPLET_APPLETCONTEXT_FWD
#define SCAPIX_JAVA_API_JAVA_APPLET_APPLETCONTEXT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::applet { class AppletContext; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::applet::AppletContext>
{
	static constexpr fixed_string class_name = "java/applet/AppletContext";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_APPLET_APPLETCONTEXT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_APPLET_APPLETCONTEXT)
#define SCAPIX_JAVA_API_JAVA_APPLET_APPLETCONTEXT
...
class java::applet::AppletContext : public jni::object_base<"java/applet/AppletContext",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVA_APPLET_APPLETCONTEXT
