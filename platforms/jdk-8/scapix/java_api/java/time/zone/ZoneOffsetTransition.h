...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_ZONE_ZONEOFFSETTRANSITION
...
public:
	...
	static jni::ref<java::time::zone::ZoneOffsetTransition> of(jni::ref<java::time::LocalDateTime> p1, jni::ref<java::time::ZoneOffset> p2, jni::ref<java::time::ZoneOffset> p3) { return call_static_method<"of", jni::ref<java::time::zone::ZoneOffsetTransition>>(p1, p2, p3); }
	...
	jboolean isValidOffset(jni::ref<java::time::ZoneOffset> p1) { return call_method<"isValidOffset", jboolean>(p1); }
	jint compareTo(jni::ref<java::time::zone::ZoneOffsetTransition> p1) { return call_method<"compareTo", jint>(p1); }
