...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_ZONE_ZONEOFFSETTRANSITIONRULE_TIMEDEFINITION
...
public:
	...
	static jni::ref<java::time::zone::ZoneOffsetTransitionRule_TimeDefinition> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::time::zone::ZoneOffsetTransitionRule_TimeDefinition>>(p1); }
	jni::ref<java::time::LocalDateTime> createDateTime(jni::ref<java::time::LocalDateTime> p1, jni::ref<java::time::ZoneOffset> p2, jni::ref<java::time::ZoneOffset> p3) { return call_method<"createDateTime", jni::ref<java::time::LocalDateTime>>(p1, p2, p3); }
};
