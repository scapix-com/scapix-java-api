...
public:
	...
	static jni::ref<java::time::zone::ZoneOffsetTransitionRule> of(jni::ref<java::time::Month> p1, jint p2, jni::ref<java::time::DayOfWeek> p3, jni::ref<java::time::LocalTime> p4, jboolean p5, jni::ref<java::time::zone::ZoneOffsetTransitionRule_TimeDefinition> p6, jni::ref<java::time::ZoneOffset> p7, jni::ref<java::time::ZoneOffset> p8, jni::ref<java::time::ZoneOffset> p9) { return call_static_method<"of", jni::ref<java::time::zone::ZoneOffsetTransitionRule>>(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	...
	jni::ref<java::time::zone::ZoneOffsetTransition> createTransition(jint p1) { return call_method<"createTransition", jni::ref<java::time::zone::ZoneOffsetTransition>>(p1); }
