...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_FORMAT_FORMATSTYLE
...
public:
	...
	static jni::ref<java::time::format::FormatStyle> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::time::format::FormatStyle>>(p1); }
};
