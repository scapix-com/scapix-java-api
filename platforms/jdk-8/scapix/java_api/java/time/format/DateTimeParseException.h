...
public:
	...
	static jni::ref<java::time::format::DateTimeParseException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::CharSequence> p2, jint p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<java::time::format::DateTimeParseException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::CharSequence> p2, jint p3, jni::ref<java::lang::Throwable> p4) { return base_::new_object(p1, p2, p3, p4); }
