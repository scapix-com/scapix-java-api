...
namespace scapix::java_api { namespace java::time::format { class ZoneName; }}
...
public:
	...
	static jni::ref<java::lang::String> toZid(jni::ref<java::lang::String> p1, jni::ref<java::util::Locale> p2) { return call_static_method<"toZid", jni::ref<java::lang::String>>(p1, p2); }
	static jni::ref<java::lang::String> toZid(jni::ref<java::lang::String> p1) { return call_static_method<"toZid", jni::ref<java::lang::String>>(p1); }
