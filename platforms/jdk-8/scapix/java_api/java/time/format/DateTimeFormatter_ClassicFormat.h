...
public:
	...
	static jni::ref<java::time::format::DateTimeFormatter_ClassicFormat> new_object(jni::ref<java::time::format::DateTimeFormatter> p1, jni::ref<java::time::temporal::TemporalQuery> p2) { return object_base::new_object(p1, p2); }
