...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CLOCK
...
public:
	...
	static jni::ref<java::time::Clock> system(jni::ref<java::time::ZoneId> p1) { return call_static_method<"system", jni::ref<java::time::Clock>>(p1); }
	static jni::ref<java::time::Clock> tickSeconds(jni::ref<java::time::ZoneId> p1) { return call_static_method<"tickSeconds", jni::ref<java::time::Clock>>(p1); }
	static jni::ref<java::time::Clock> tickMinutes(jni::ref<java::time::ZoneId> p1) { return call_static_method<"tickMinutes", jni::ref<java::time::Clock>>(p1); }
	static jni::ref<java::time::Clock> tick(jni::ref<java::time::Clock> p1, jni::ref<java::time::Duration> p2) { return call_static_method<"tick", jni::ref<java::time::Clock>>(p1, p2); }
	static jni::ref<java::time::Clock> fixed(jni::ref<java::time::Instant> p1, jni::ref<java::time::ZoneId> p2) { return call_static_method<"fixed", jni::ref<java::time::Clock>>(p1, p2); }
	static jni::ref<java::time::Clock> offset(jni::ref<java::time::Clock> p1, jni::ref<java::time::Duration> p2) { return call_static_method<"offset", jni::ref<java::time::Clock>>(p1, p2); }
