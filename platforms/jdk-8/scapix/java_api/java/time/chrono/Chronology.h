...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_CHRONOLOGY
...
public:
	...
	static jni::ref<java::time::chrono::Chronology> from(jni::ref<java::time::temporal::TemporalAccessor> p1) { return call_static_method<"from", jni::ref<java::time::chrono::Chronology>>(p1); }
	static jni::ref<java::time::chrono::Chronology> ofLocale(jni::ref<java::util::Locale> p1) { return call_static_method<"ofLocale", jni::ref<java::time::chrono::Chronology>>(p1); }
	static jni::ref<java::time::chrono::Chronology> of(jni::ref<java::lang::String> p1) { return call_static_method<"of", jni::ref<java::time::chrono::Chronology>>(p1); }
	...
	jni::ref<java::time::chrono::ChronoLocalDate> date(jni::ref<java::time::chrono::Era> p1, jint p2, jint p3, jint p4) { return call_method<"date", jni::ref<java::time::chrono::ChronoLocalDate>>(p1, p2, p3, p4); }
	...
	jni::ref<java::time::chrono::ChronoLocalDate> dateYearDay(jni::ref<java::time::chrono::Era> p1, jint p2, jint p3) { return call_method<"dateYearDay", jni::ref<java::time::chrono::ChronoLocalDate>>(p1, p2, p3); }
	...
	jni::ref<java::time::chrono::ChronoLocalDate> dateNow(jni::ref<java::time::ZoneId> p1) { return call_method<"dateNow", jni::ref<java::time::chrono::ChronoLocalDate>>(p1); }
	jni::ref<java::time::chrono::ChronoLocalDate> dateNow(jni::ref<java::time::Clock> p1) { return call_method<"dateNow", jni::ref<java::time::chrono::ChronoLocalDate>>(p1); }
	...
	jni::ref<java::time::chrono::ChronoPeriod> period(jint p1, jint p2, jint p3) { return call_method<"period", jni::ref<java::time::chrono::ChronoPeriod>>(p1, p2, p3); }
