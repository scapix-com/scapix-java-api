...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_THAIBUDDHISTDATE
...
public:
	...
	static jni::ref<java::time::chrono::ThaiBuddhistDate> now(jni::ref<java::time::ZoneId> p1) { return call_static_method<"now", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1); }
	static jni::ref<java::time::chrono::ThaiBuddhistDate> now(jni::ref<java::time::Clock> p1) { return call_static_method<"now", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1); }
	static jni::ref<java::time::chrono::ThaiBuddhistDate> of(jint p1, jint p2, jint p3) { return call_static_method<"of", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1, p2, p3); }
	static jni::ref<java::time::chrono::ThaiBuddhistDate> from(jni::ref<java::time::temporal::TemporalAccessor> p1) { return call_static_method<"from", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1); }
	...
	jni::ref<java::time::chrono::ThaiBuddhistDate> with(jni::ref<java::time::temporal::TemporalField> p1, jlong p2) { return call_method<"with", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1, p2); }
	jni::ref<java::time::chrono::ThaiBuddhistDate> with(jni::ref<java::time::temporal::TemporalAdjuster> p1) { return call_method<"with", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1); }
	jni::ref<java::time::chrono::ThaiBuddhistDate> plus(jni::ref<java::time::temporal::TemporalAmount> p1) { return call_method<"plus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1); }
	jni::ref<java::time::chrono::ThaiBuddhistDate> minus(jni::ref<java::time::temporal::TemporalAmount> p1) { return call_method<"minus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1); }
	jni::ref<java::time::chrono::ThaiBuddhistDate> plus(jlong p1, jni::ref<java::time::temporal::TemporalUnit> p2) { return call_method<"plus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1, p2); }
	jni::ref<java::time::chrono::ThaiBuddhistDate> minus(jlong p1, jni::ref<java::time::temporal::TemporalUnit> p2) { return call_method<"minus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(p1, p2); }
