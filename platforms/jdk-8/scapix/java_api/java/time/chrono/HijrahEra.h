...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_HIJRAHERA
...
public:
	...
	static jni::ref<java::time::chrono::HijrahEra> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::time::chrono::HijrahEra>>(p1); }
	static jni::ref<java::time::chrono::HijrahEra> of(jint p1) { return call_static_method<"of", jni::ref<java::time::chrono::HijrahEra>>(p1); }
