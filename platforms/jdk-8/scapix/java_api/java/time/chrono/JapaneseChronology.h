...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_JAPANESECHRONOLOGY
...
public:
	...
	jni::ref<java::time::chrono::JapaneseDate> date(jni::ref<java::time::chrono::Era> p1, jint p2, jint p3, jint p4) { return call_method<"date", jni::ref<java::time::chrono::JapaneseDate>>(p1, p2, p3, p4); }
	jni::ref<java::time::chrono::JapaneseDate> date(jint p1, jint p2, jint p3) { return call_method<"date", jni::ref<java::time::chrono::JapaneseDate>>(p1, p2, p3); }
	jni::ref<java::time::chrono::JapaneseDate> dateYearDay(jni::ref<java::time::chrono::Era> p1, jint p2, jint p3) { return call_method<"dateYearDay", jni::ref<java::time::chrono::JapaneseDate>>(p1, p2, p3); }
	jni::ref<java::time::chrono::JapaneseDate> dateYearDay(jint p1, jint p2) { return call_method<"dateYearDay", jni::ref<java::time::chrono::JapaneseDate>>(p1, p2); }
	jni::ref<java::time::chrono::JapaneseDate> dateEpochDay(jlong p1) { return call_method<"dateEpochDay", jni::ref<java::time::chrono::JapaneseDate>>(p1); }
	jni::ref<java::time::chrono::JapaneseDate> dateNow() { return call_method<"dateNow", jni::ref<java::time::chrono::JapaneseDate>>(); }
	jni::ref<java::time::chrono::JapaneseDate> dateNow(jni::ref<java::time::ZoneId> p1) { return call_method<"dateNow", jni::ref<java::time::chrono::JapaneseDate>>(p1); }
	jni::ref<java::time::chrono::JapaneseDate> dateNow(jni::ref<java::time::Clock> p1) { return call_method<"dateNow", jni::ref<java::time::chrono::JapaneseDate>>(p1); }
	jni::ref<java::time::chrono::JapaneseDate> date(jni::ref<java::time::temporal::TemporalAccessor> p1) { return call_method<"date", jni::ref<java::time::chrono::JapaneseDate>>(p1); }
	...
	jni::ref<java::time::chrono::JapaneseEra> eraOf(jint p1) { return call_method<"eraOf", jni::ref<java::time::chrono::JapaneseEra>>(p1); }
	...
	jni::ref<java::time::chrono::JapaneseDate> resolveDate(jni::ref<java::util::Map> p1, jni::ref<java::time::format::ResolverStyle> p2) { return call_method<"resolveDate", jni::ref<java::time::chrono::JapaneseDate>>(p1, p2); }
};
