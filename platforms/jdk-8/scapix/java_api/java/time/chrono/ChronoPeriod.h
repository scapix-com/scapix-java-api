...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_CHRONO_CHRONOPERIOD
...
public:
	...
	static jni::ref<java::time::chrono::ChronoPeriod> between(jni::ref<java::time::chrono::ChronoLocalDate> p1, jni::ref<java::time::chrono::ChronoLocalDate> p2) { return call_static_method<"between", jni::ref<java::time::chrono::ChronoPeriod>>(p1, p2); }
