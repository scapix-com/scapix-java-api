...
#ifndef SCAPIX_JAVA_API_JAVA_TIME_TEMPORAL_CHRONOFIELD
...
public:
	...
	static jni::ref<java::time::temporal::ChronoField> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::time::temporal::ChronoField>>(p1); }
	...
	jlong checkValidValue(jlong p1) { return call_method<"checkValidValue", jlong>(p1); }
	jint checkValidIntValue(jlong p1) { return call_method<"checkValidIntValue", jint>(p1); }
