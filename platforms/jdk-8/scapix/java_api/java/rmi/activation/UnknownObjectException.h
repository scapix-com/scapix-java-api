...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_ACTIVATION_UNKNOWNOBJECTEXCEPTION
...
public:
	...
	static jni::ref<java::rmi::activation::UnknownObjectException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
