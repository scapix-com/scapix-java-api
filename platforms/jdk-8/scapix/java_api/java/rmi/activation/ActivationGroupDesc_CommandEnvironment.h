...
public:
	...
	static jni::ref<java::rmi::activation::ActivationGroupDesc_CommandEnvironment> new_object(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::String>> p2) { return object_base::new_object(p1, p2); }
