...
#ifndef SCAPIX_JAVA_API_JAVA_RMI_SERVERRUNTIMEEXCEPTION
...
public:
	...
	static jni::ref<java::rmi::ServerRuntimeException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Exception> p2) { return object_base::new_object(p1, p2); }
};
