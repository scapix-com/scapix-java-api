...
public:
	...
	static jni::ref<java::security::KeyStore_CallbackHandlerProtection> new_object(jni::ref<javax::security::auth::callback::CallbackHandler> p1) { return object_base::new_object(p1); }
