...
public:
	...
	static jni::ref<java::security::DigestInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::security::MessageDigest> p2) { return object_base::new_object(p1, p2); }
