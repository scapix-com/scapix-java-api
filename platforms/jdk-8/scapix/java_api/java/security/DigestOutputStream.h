...
public:
	...
	static jni::ref<java::security::DigestOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::security::MessageDigest> p2) { return object_base::new_object(p1, p2); }
