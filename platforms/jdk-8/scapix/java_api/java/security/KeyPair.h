...
public:
	...
	static jni::ref<java::security::KeyPair> new_object(jni::ref<java::security::PublicKey> p1, jni::ref<java::security::PrivateKey> p2) { return object_base::new_object(p1, p2); }
