...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SIGNER
...
public:
	...
	static jni::ref<java::security::Signer> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::Signer> new_object(jni::ref<java::lang::String> p1, jni::ref<java::security::IdentityScope> p2) { return object_base::new_object(p1, p2); }
