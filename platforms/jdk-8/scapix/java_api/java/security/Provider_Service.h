...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_PROVIDER_SERVICE
...
public:
	...
	static jni::ref<java::security::Provider_Service> new_object(jni::ref<java::security::Provider> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<java::util::List> p5, jni::ref<java::util::Map> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	...
	jni::ref<java::lang::Object> newInstance(jni::ref<java::lang::Object> p1) { return call_method<"newInstance", jni::ref<java::lang::Object>>(p1); }
	jboolean supportsParameter(jni::ref<java::lang::Object> p1) { return call_method<"supportsParameter", jboolean>(p1); }
