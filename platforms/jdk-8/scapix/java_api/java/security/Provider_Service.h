...
public:
	...
	static jni::ref<java::security::Provider_Service> new_object(jni::ref<java::security::Provider> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<java::util::List> p5, jni::ref<java::util::Map> p6) { return base_::new_object(p1, p2, p3, p4, p5, p6); }
