...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_IDENTITYSCOPE
...
public:
	...
	static jni::ref<java::security::IdentityScope> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::IdentityScope> new_object(jni::ref<java::lang::String> p1, jni::ref<java::security::IdentityScope> p2) { return object_base::new_object(p1, p2); }
	...
	jni::ref<java::security::Identity> getIdentity(jni::ref<java::security::Principal> p1) { return call_method<"getIdentity", jni::ref<java::security::Identity>>(p1); }
