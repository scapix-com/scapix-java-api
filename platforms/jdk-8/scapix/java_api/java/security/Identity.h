...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_IDENTITY
...
public:
	...
	static jni::ref<java::security::Identity> new_object(jni::ref<java::lang::String> p1, jni::ref<java::security::IdentityScope> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::Identity> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	...
	void setPublicKey(jni::ref<java::security::PublicKey> p1) { return call_method<"setPublicKey", void>(p1); }
	void setInfo(jni::ref<java::lang::String> p1) { return call_method<"setInfo", void>(p1); }
	jni::ref<java::lang::String> getInfo() { return call_method<"getInfo", jni::ref<java::lang::String>>(); }
	void addCertificate(jni::ref<java::security::Certificate> p1) { return call_method<"addCertificate", void>(p1); }
	void removeCertificate(jni::ref<java::security::Certificate> p1) { return call_method<"removeCertificate", void>(p1); }
