...
public:
	...
	static jni::ref<java::security::Identity> new_object(jni::ref<java::lang::String> p1, jni::ref<java::security::IdentityScope> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::security::Identity> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
