...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CRYPTOPRIMITIVE
...
public:
	...
	static jni::ref<java::security::CryptoPrimitive> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::security::CryptoPrimitive>>(p1); }
};
