...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_KEYREP_TYPE
...
public:
	...
	static jni::ref<java::security::KeyRep_Type> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::security::KeyRep_Type>>(p1); }
};
