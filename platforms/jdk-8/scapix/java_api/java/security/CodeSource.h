...
public:
	...
	static jni::ref<java::security::CodeSource> new_object(jni::ref<java::net::URL> p1, jni::ref<jni::array<java::security::cert::Certificate>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::CodeSource> new_object(jni::ref<java::net::URL> p1, jni::ref<jni::array<java::security::CodeSigner>> p2) { return object_base::new_object(p1, p2); }
