...
public:
	...
	static jni::ref<java::security::cert::PKIXBuilderParameters> new_object(jni::ref<java::util::Set> p1, jni::ref<java::security::cert::CertSelector> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::cert::PKIXBuilderParameters> new_object(jni::ref<java::security::KeyStore> p1, jni::ref<java::security::cert::CertSelector> p2) { return object_base::new_object(p1, p2); }
