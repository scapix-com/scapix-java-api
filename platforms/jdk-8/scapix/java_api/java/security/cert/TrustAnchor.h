...
public:
	...
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<java::security::cert::X509Certificate> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<javax::security::auth::x500::X500Principal> p1, jni::ref<java::security::PublicKey> p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::security::cert::TrustAnchor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::security::PublicKey> p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
