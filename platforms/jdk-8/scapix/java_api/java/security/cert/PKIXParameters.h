...
public:
	...
	static jni::ref<java::security::cert::PKIXParameters> new_object(jni::ref<java::util::Set> p1) { return base_::new_object(p1); }
	static jni::ref<java::security::cert::PKIXParameters> new_object(jni::ref<java::security::KeyStore> p1) { return base_::new_object(p1); }
