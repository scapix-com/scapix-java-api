...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_CERTPATHVALIDATOREXCEPTION
...
public:
	...
	static jni::ref<java::security::cert::CertPathValidatorException> new_object() { return object_base::new_object(); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::Throwable> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2, jni::ref<java::security::cert::CertPath> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::security::cert::CertPathValidatorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2, jni::ref<java::security::cert::CertPath> p3, jint p4, jni::ref<java::security::cert::CertPathValidatorException_Reason> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
