...
public:
	...
	static jni::ref<java::security::cert::CertificateRevokedException> new_object(jni::ref<java::util::Date> p1, jni::ref<java::security::cert::CRLReason> p2, jni::ref<javax::security::auth::x500::X500Principal> p3, jni::ref<java::util::Map> p4) { return base_::new_object(p1, p2, p3, p4); }
