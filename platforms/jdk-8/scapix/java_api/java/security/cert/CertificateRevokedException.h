...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_CERT_CERTIFICATEREVOKEDEXCEPTION
...
public:
	...
	static jni::ref<java::security::cert::CertificateRevokedException> new_object(jni::ref<java::util::Date> p1, jni::ref<java::security::cert::CRLReason> p2, jni::ref<javax::security::auth::x500::X500Principal> p3, jni::ref<java::util::Map> p4) { return object_base::new_object(p1, p2, p3, p4); }
