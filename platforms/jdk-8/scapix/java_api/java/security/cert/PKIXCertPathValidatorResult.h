...
public:
	...
	static jni::ref<java::security::cert::PKIXCertPathValidatorResult> new_object(jni::ref<java::security::cert::TrustAnchor> p1, jni::ref<java::security::cert::PolicyNode> p2, jni::ref<java::security::PublicKey> p3) { return object_base::new_object(p1, p2, p3); }
