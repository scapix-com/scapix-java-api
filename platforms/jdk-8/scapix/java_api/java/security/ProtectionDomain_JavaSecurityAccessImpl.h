...
namespace scapix::java_api { namespace java::security { class ProtectionDomain_JavaSecurityAccessImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::security::ProtectionDomain_JavaSecurityAccessImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::sun::misc::JavaSecurityAccess>;
};
