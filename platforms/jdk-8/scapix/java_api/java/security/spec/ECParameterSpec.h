...
public:
	...
	static jni::ref<java::security::spec::ECParameterSpec> new_object(jni::ref<java::security::spec::EllipticCurve> p1, jni::ref<java::security::spec::ECPoint> p2, jni::ref<java::math::BigInteger> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
