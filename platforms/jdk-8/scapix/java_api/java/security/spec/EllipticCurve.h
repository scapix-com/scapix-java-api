...
public:
	...
	static jni::ref<java::security::spec::EllipticCurve> new_object(jni::ref<java::security::spec::ECField> p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::security::spec::EllipticCurve> new_object(jni::ref<java::security::spec::ECField> p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3, jni::ref<jni::array<jbyte>> p4) { return object_base::new_object(p1, p2, p3, p4); }
