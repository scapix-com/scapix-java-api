...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_DSAPARAMETERSPEC
...
public:
	...
	static jni::ref<java::security::spec::DSAParameterSpec> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3) { return object_base::new_object(p1, p2, p3); }
