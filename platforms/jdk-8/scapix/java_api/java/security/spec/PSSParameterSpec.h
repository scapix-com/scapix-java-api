...
public:
	...
	static jni::ref<java::security::spec::PSSParameterSpec> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::security::spec::AlgorithmParameterSpec> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::security::spec::PSSParameterSpec> new_object(jint p1) { return object_base::new_object(p1); }
