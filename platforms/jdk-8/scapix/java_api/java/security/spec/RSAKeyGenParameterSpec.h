...
public:
	...
	static jni::ref<java::security::spec::RSAKeyGenParameterSpec> new_object(jint p1, jni::ref<java::math::BigInteger> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::spec::RSAKeyGenParameterSpec> new_object(jint p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::security::spec::AlgorithmParameterSpec> p3) { return object_base::new_object(p1, p2, p3); }
