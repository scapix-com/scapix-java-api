...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_ECFIELDF2M
...
public:
	...
	static jni::ref<java::security::spec::ECFieldF2m> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::spec::ECFieldF2m> new_object(jint p1, jni::ref<java::math::BigInteger> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::security::spec::ECFieldF2m> new_object(jint p1, jni::ref<jni::array<jint>> p2) { return object_base::new_object(p1, p2); }
