...
public:
	...
	static jni::ref<java::security::spec::RSAMultiPrimePrivateCrtKeySpec> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3, jni::ref<java::math::BigInteger> p4, jni::ref<java::math::BigInteger> p5, jni::ref<java::math::BigInteger> p6, jni::ref<java::math::BigInteger> p7, jni::ref<java::math::BigInteger> p8, jni::ref<jni::array<java::security::spec::RSAOtherPrimeInfo>> p9) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static jni::ref<java::security::spec::RSAMultiPrimePrivateCrtKeySpec> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3, jni::ref<java::math::BigInteger> p4, jni::ref<java::math::BigInteger> p5, jni::ref<java::math::BigInteger> p6, jni::ref<java::math::BigInteger> p7, jni::ref<java::math::BigInteger> p8, jni::ref<jni::array<java::security::spec::RSAOtherPrimeInfo>> p9, jni::ref<java::security::spec::AlgorithmParameterSpec> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
