...
public:
	...
	static jni::ref<java::security::spec::RSAOtherPrimeInfo> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3) { return object_base::new_object(p1, p2, p3); }
