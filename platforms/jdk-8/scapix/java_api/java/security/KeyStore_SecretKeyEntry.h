...
public:
	...
	static jni::ref<java::security::KeyStore_SecretKeyEntry> new_object(jni::ref<javax::crypto::SecretKey> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::KeyStore_SecretKeyEntry> new_object(jni::ref<javax::crypto::SecretKey> p1, jni::ref<java::util::Set> p2) { return object_base::new_object(p1, p2); }
