...
public:
	...
	static jni::ref<java::security::KeyStore_PasswordProtection> new_object(jni::ref<jni::array<jchar>> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::KeyStore_PasswordProtection> new_object(jni::ref<jni::array<jchar>> p1, jni::ref<java::lang::String> p2, jni::ref<java::security::spec::AlgorithmParameterSpec> p3) { return object_base::new_object(p1, p2, p3); }
