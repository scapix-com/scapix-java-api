...
public:
	...
	static jni::ref<java::security::AccessControlContext> new_object(jni::ref<jni::array<java::security::ProtectionDomain>> p1) { return object_base::new_object(p1); }
	static jni::ref<java::security::AccessControlContext> new_object(jni::ref<java::security::AccessControlContext> p1, jni::ref<java::security::DomainCombiner> p2) { return object_base::new_object(p1, p2); }
