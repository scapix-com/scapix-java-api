...
public:
	...
	static jni::ref<java::security::Timestamp> new_object(jni::ref<java::util::Date> p1, jni::ref<java::security::cert::CertPath> p2) { return object_base::new_object(p1, p2); }
