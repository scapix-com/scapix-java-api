...
public:
	...
	static jni::ref<java::security::KeyStore_TrustedCertificateEntry> new_object(jni::ref<java::security::cert::Certificate> p1) { return base_::new_object(p1); }
	static jni::ref<java::security::KeyStore_TrustedCertificateEntry> new_object(jni::ref<java::security::cert::Certificate> p1, jni::ref<java::util::Set> p2) { return base_::new_object(p1, p2); }
