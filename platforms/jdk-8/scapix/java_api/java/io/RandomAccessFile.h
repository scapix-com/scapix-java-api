...
public:
	...
	static jni::ref<java::io::RandomAccessFile> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::io::RandomAccessFile> new_object(jni::ref<java::io::File> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
