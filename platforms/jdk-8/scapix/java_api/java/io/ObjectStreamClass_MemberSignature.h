...
public:
	...
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Field> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Constructor> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::ObjectStreamClass_MemberSignature> new_object(jni::ref<java::lang::reflect::Method> p1) { return object_base::new_object(p1); }
