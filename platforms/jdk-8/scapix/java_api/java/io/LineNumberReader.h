...
public:
	...
	static jni::ref<java::io::LineNumberReader> new_object(jni::ref<java::io::Reader> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::LineNumberReader> new_object(jni::ref<java::io::Reader> p1, jint p2) { return object_base::new_object(p1, p2); }
