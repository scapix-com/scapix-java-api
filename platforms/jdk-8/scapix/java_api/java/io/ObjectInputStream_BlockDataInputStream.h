...
namespace scapix::java_api { namespace java::io { class ObjectInputStream_BlockDataInputStream; }}
...
public:
	...
	void readFully(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3, jboolean p4) { return call_method<"readFully", void>(p1, p2, p3, p4); }
