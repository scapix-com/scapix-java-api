...
public:
	...
	static jni::ref<java::io::PipedReader> new_object(jni::ref<java::io::PipedWriter> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::PipedReader> new_object(jni::ref<java::io::PipedWriter> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::io::PipedReader> new_object() { return object_base::new_object(); }
	static jni::ref<java::io::PipedReader> new_object(jint p1) { return object_base::new_object(p1); }
