...
public:
	...
	static jni::ref<java::io::BufferedOutputStream> new_object(jni::ref<java::io::OutputStream> p1) { return base_::new_object(p1); }
	static jni::ref<java::io::BufferedOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jint p2) { return base_::new_object(p1, p2); }
