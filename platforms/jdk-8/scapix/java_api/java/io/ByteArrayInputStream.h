...
public:
	...
	static jni::ref<java::io::ByteArrayInputStream> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::ByteArrayInputStream> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
