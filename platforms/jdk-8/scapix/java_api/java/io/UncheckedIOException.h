...
public:
	...
	static jni::ref<java::io::UncheckedIOException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::io::IOException> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::io::UncheckedIOException> new_object(jni::ref<java::io::IOException> p1) { return object_base::new_object(p1); }
