...
namespace scapix::java_api { namespace java::io { class FilePermissionCollection; }}
...
public:
	...
	static jni::ref<java::io::FilePermissionCollection> new_object() { return object_base::new_object(); }
