...
public:
	...
	static jni::ref<java::io::SerialCallbackContext> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::io::ObjectStreamClass> p2) { return base_::new_object(p1, p2); }
