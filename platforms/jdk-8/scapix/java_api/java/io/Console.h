...
public:
	...
	jni::ref<java::io::Console> format(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::Object>> p2) { return call_method<"format", jni::ref<java::io::Console>>(p1, p2); }
	jni::ref<java::io::Console> printf(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::Object>> p2) { return call_method<"printf", jni::ref<java::io::Console>>(p1, p2); }
