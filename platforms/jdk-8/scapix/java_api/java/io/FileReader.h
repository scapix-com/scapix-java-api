...
public:
	...
	static jni::ref<java::io::FileReader> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::FileReader> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::FileReader> new_object(jni::ref<java::io::FileDescriptor> p1) { return object_base::new_object(p1); }
};
