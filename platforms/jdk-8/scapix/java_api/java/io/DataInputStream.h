...
#ifndef SCAPIX_JAVA_API_JAVA_IO_DATAINPUTSTREAM
...
public:
	...
	static jni::ref<java::io::DataInputStream> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
