...
#ifndef SCAPIX_JAVA_API_JAVA_IO_STREAMTOKENIZER
...
public:
	...
	static jni::ref<java::io::StreamTokenizer> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::StreamTokenizer> new_object(jni::ref<java::io::Reader> p1) { return object_base::new_object(p1); }
