...
#ifndef SCAPIX_JAVA_API_JAVA_IO_SEQUENCEINPUTSTREAM
...
public:
	...
	static jni::ref<java::io::SequenceInputStream> new_object(jni::ref<java::util::Enumeration> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::SequenceInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::io::InputStream> p2) { return object_base::new_object(p1, p2); }
