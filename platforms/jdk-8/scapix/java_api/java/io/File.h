...
#ifndef SCAPIX_JAVA_API_JAVA_IO_FILE
...
public:
	...
	static jni::ref<java::io::File> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::io::File> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::io::File> new_object(jni::ref<java::io::File> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::io::File> new_object(jni::ref<java::net::URI> p1) { return object_base::new_object(p1); }
	...
	jni::ref<jni::array<java::lang::String>> list(jni::ref<java::io::FilenameFilter> p1) { return call_method<"list", jni::ref<jni::array<java::lang::String>>>(p1); }
	jni::ref<jni::array<java::io::File>> listFiles() { return call_method<"listFiles", jni::ref<jni::array<java::io::File>>>(); }
	jni::ref<jni::array<java::io::File>> listFiles(jni::ref<java::io::FilenameFilter> p1) { return call_method<"listFiles", jni::ref<jni::array<java::io::File>>>(p1); }
	jni::ref<jni::array<java::io::File>> listFiles(jni::ref<java::io::FileFilter> p1) { return call_method<"listFiles", jni::ref<jni::array<java::io::File>>>(p1); }
	...
	jboolean setWritable(jboolean p1, jboolean p2) { return call_method<"setWritable", jboolean>(p1, p2); }
	jboolean setWritable(jboolean p1) { return call_method<"setWritable", jboolean>(p1); }
	jboolean setReadable(jboolean p1, jboolean p2) { return call_method<"setReadable", jboolean>(p1, p2); }
	jboolean setReadable(jboolean p1) { return call_method<"setReadable", jboolean>(p1); }
	jboolean setExecutable(jboolean p1, jboolean p2) { return call_method<"setExecutable", jboolean>(p1, p2); }
	jboolean setExecutable(jboolean p1) { return call_method<"setExecutable", jboolean>(p1); }
	...
	static jni::ref<java::io::File> createTempFile(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::io::File> p3) { return call_static_method<"createTempFile", jni::ref<java::io::File>>(p1, p2, p3); }
	static jni::ref<java::io::File> createTempFile(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return call_static_method<"createTempFile", jni::ref<java::io::File>>(p1, p2); }
