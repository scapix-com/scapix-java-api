...
public:
	...
	static jni::ref<java::text::DecimalFormat> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::text::DecimalFormat> new_object(jni::ref<java::lang::String> p1, jni::ref<java::text::DecimalFormatSymbols> p2) { return object_base::new_object(p1, p2); }
