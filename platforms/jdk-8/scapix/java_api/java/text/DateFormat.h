...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_DATEFORMAT
...
public:
	...
	jni::ref<java::lang::String> format(jni::ref<java::util::Date> p1) { return call_method<"format", jni::ref<java::lang::String>>(p1); }
	jni::ref<java::util::Date> parse(jni::ref<java::lang::String> p1) { return call_method<"parse", jni::ref<java::util::Date>>(p1); }
	...
	static jni::ref<java::text::DateFormat> getTimeInstance(jint p1) { return call_static_method<"getTimeInstance", jni::ref<java::text::DateFormat>>(p1); }
	static jni::ref<java::text::DateFormat> getTimeInstance(jint p1, jni::ref<java::util::Locale> p2) { return call_static_method<"getTimeInstance", jni::ref<java::text::DateFormat>>(p1, p2); }
	...
	static jni::ref<java::text::DateFormat> getDateInstance(jint p1) { return call_static_method<"getDateInstance", jni::ref<java::text::DateFormat>>(p1); }
	static jni::ref<java::text::DateFormat> getDateInstance(jint p1, jni::ref<java::util::Locale> p2) { return call_static_method<"getDateInstance", jni::ref<java::text::DateFormat>>(p1, p2); }
	...
	static jni::ref<java::text::DateFormat> getDateTimeInstance(jint p1, jint p2) { return call_static_method<"getDateTimeInstance", jni::ref<java::text::DateFormat>>(p1, p2); }
	static jni::ref<java::text::DateFormat> getDateTimeInstance(jint p1, jint p2, jni::ref<java::util::Locale> p3) { return call_static_method<"getDateTimeInstance", jni::ref<java::text::DateFormat>>(p1, p2, p3); }
	...
	void setCalendar(jni::ref<java::util::Calendar> p1) { return call_method<"setCalendar", void>(p1); }
	jni::ref<java::util::Calendar> getCalendar() { return call_method<"getCalendar", jni::ref<java::util::Calendar>>(); }
	void setNumberFormat(jni::ref<java::text::NumberFormat> p1) { return call_method<"setNumberFormat", void>(p1); }
