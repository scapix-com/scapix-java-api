...
public:
	...
	static jni::ref<java::text::EntryPair> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::text::EntryPair> new_object(jni::ref<java::lang::String> p1, jint p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
