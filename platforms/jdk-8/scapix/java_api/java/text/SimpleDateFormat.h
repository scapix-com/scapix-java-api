...
public:
	...
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Locale> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::text::SimpleDateFormat> new_object(jni::ref<java::lang::String> p1, jni::ref<java::text::DateFormatSymbols> p2) { return base_::new_object(p1, p2); }
