...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_NORMALIZER
...
public:
	...
	static jni::ref<java::lang::String> normalize(jni::ref<java::lang::CharSequence> p1, jni::ref<java::text::Normalizer_Form> p2) { return call_static_method<"normalize", jni::ref<java::lang::String>>(p1, p2); }
	static jboolean isNormalized(jni::ref<java::lang::CharSequence> p1, jni::ref<java::text::Normalizer_Form> p2) { return call_static_method<"isNormalized", jboolean>(p1, p2); }
};
