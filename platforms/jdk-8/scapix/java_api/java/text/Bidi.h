...
public:
	...
	static jni::ref<java::text::Bidi> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::text::Bidi> new_object(jni::ref<java::text::AttributedCharacterIterator> p1) { return object_base::new_object(p1); }
	static jni::ref<java::text::Bidi> new_object(jni::ref<jni::array<jchar>> p1, jint p2, jni::ref<jni::array<jbyte>> p3, jint p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
