...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_MESSAGEFORMAT
...
public:
	...
	static jni::ref<java::text::MessageFormat> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::text::MessageFormat> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Locale> p2) { return object_base::new_object(p1, p2); }
