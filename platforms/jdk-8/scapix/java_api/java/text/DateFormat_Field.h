...
#ifndef SCAPIX_JAVA_API_JAVA_TEXT_DATEFORMAT_FIELD
...
public:
	...
	static jni::ref<java::text::DateFormat_Field> ofCalendarField(jint p1) { return call_static_method<"ofCalendarField", jni::ref<java::text::DateFormat_Field>>(p1); }
