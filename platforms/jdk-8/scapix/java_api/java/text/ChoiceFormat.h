...
public:
	...
	static jni::ref<java::text::ChoiceFormat> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::text::ChoiceFormat> new_object(jni::ref<jni::array<jdouble>> p1, jni::ref<jni::array<java::lang::String>> p2) { return object_base::new_object(p1, p2); }
