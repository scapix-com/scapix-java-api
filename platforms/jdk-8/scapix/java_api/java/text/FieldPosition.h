...
public:
	...
	static jni::ref<java::text::FieldPosition> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::text::FieldPosition> new_object(jni::ref<java::text::Format_Field> p1) { return object_base::new_object(p1); }
	static jni::ref<java::text::FieldPosition> new_object(jni::ref<java::text::Format_Field> p1, jint p2) { return object_base::new_object(p1, p2); }
