...
public:
	...
	static jni::ref<java::text::Collator> getInstance(jni::ref<java::util::Locale> p1) { return call_static_method<"getInstance", jni::ref<java::text::Collator>>(p1); }
	...
	void setStrength(jint p1) { return call_method<"setStrength", void>(p1); }
	jint getDecomposition() { return call_method<"getDecomposition", jint>(); }
	void setDecomposition(jint p1) { return call_method<"setDecomposition", void>(p1); }
