...
namespace scapix::java_api { namespace java::text { class RBTableBuilder; }}
...
public:
	...
	static jni::ref<java::text::RBTableBuilder> new_object(jni::ref<java::text::RBCollationTables_BuildAPI> p1) { return object_base::new_object(p1); }
	void build(jni::ref<java::lang::String> p1, jint p2) { return call_method<"build", void>(p1, p2); }
