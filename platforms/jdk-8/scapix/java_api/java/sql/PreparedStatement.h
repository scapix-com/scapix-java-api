...
public:
	...
	void setObject(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::sql::SQLType> p3, jint p4) { return call_method<"setObject", void>(p1, p2, p3, p4); }
	void setObject(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::sql::SQLType> p3) { return call_method<"setObject", void>(p1, p2, p3); }
