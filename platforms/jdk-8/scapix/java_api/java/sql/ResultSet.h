...
public:
	...
	void updateObject(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::sql::SQLType> p3, jint p4) { return call_method<"updateObject", void>(p1, p2, p3, p4); }
	void updateObject(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jni::ref<java::sql::SQLType> p3, jint p4) { return call_method<"updateObject", void>(p1, p2, p3, p4); }
	void updateObject(jint p1, jni::ref<java::lang::Object> p2, jni::ref<java::sql::SQLType> p3) { return call_method<"updateObject", void>(p1, p2, p3); }
	void updateObject(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jni::ref<java::sql::SQLType> p3) { return call_method<"updateObject", void>(p1, p2, p3); }
};
