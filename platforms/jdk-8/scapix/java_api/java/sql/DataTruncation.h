...
public:
	...
	static jni::ref<java::sql::DataTruncation> new_object(jint p1, jboolean p2, jboolean p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::sql::DataTruncation> new_object(jint p1, jboolean p2, jboolean p3, jint p4, jint p5, jni::ref<java::lang::Throwable> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
