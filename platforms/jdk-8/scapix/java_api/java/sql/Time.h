...
public:
	...
	static jni::ref<java::sql::Time> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::sql::Time> new_object(jlong p1) { return object_base::new_object(p1); }
