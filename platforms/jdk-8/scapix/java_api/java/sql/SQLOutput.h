...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT_FWD
#define SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::sql { class SQLOutput; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::sql::SQLOutput>
{
	static constexpr fixed_string class_name = "java/sql/SQLOutput";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT)
#define SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT
...
class java::sql::SQLOutput : public jni::object_base<"java/sql/SQLOutput",
	java::lang::Object>
{
public:
	...
	void writeObject(jni::ref<java::lang::Object> p1, jni::ref<java::sql::SQLType> p2) { return call_method<"writeObject", void>(p1, p2); }
...
#endif // SCAPIX_JAVA_API_JAVA_SQL_SQLOUTPUT
