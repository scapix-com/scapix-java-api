...
public:
	...
	static jni::ref<java::sql::Timestamp> new_object(jint p1, jint p2, jint p3, jint p4, jint p5, jint p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::sql::Timestamp> new_object(jlong p1) { return object_base::new_object(p1); }
