...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_ROWIDLIFETIME
...
public:
	...
	static jni::ref<java::sql::RowIdLifetime> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::sql::RowIdLifetime>>(p1); }
};
