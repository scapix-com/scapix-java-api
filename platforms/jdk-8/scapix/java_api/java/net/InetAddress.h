...
#ifndef SCAPIX_JAVA_API_JAVA_NET_INETADDRESS
...
public:
	...
	jboolean isReachable(jint p1) { return call_method<"isReachable", jboolean>(p1); }
	jboolean isReachable(jni::ref<java::net::NetworkInterface> p1, jint p2, jint p3) { return call_method<"isReachable", jboolean>(p1, p2, p3); }
	...
	static jni::ref<java::net::InetAddress> getByAddress(jni::ref<java::lang::String> p1, jni::ref<jni::array<jbyte>> p2) { return call_static_method<"getByAddress", jni::ref<java::net::InetAddress>>(p1, p2); }
	static jni::ref<java::net::InetAddress> getByName(jni::ref<java::lang::String> p1) { return call_static_method<"getByName", jni::ref<java::net::InetAddress>>(p1); }
	static jni::ref<jni::array<java::net::InetAddress>> getAllByName(jni::ref<java::lang::String> p1) { return call_static_method<"getAllByName", jni::ref<jni::array<java::net::InetAddress>>>(p1); }
	...
	static jni::ref<java::net::InetAddress> getByAddress(jni::ref<jni::array<jbyte>> p1) { return call_static_method<"getByAddress", jni::ref<java::net::InetAddress>>(p1); }
