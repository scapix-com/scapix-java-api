...
namespace scapix::java_api { namespace java::net { class DualStackPlainSocketImpl; }}
...
public:
	...
	static jni::ref<java::net::DualStackPlainSocketImpl> new_object(jboolean p1, jboolean p2) { return object_base::new_object(p1, p2); }
