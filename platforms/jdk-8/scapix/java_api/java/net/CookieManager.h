...
#ifndef SCAPIX_JAVA_API_JAVA_NET_COOKIEMANAGER
...
public:
	...
	static jni::ref<java::net::CookieManager> new_object() { return object_base::new_object(); }
	static jni::ref<java::net::CookieManager> new_object(jni::ref<java::net::CookieStore> p1, jni::ref<java::net::CookiePolicy> p2) { return object_base::new_object(p1, p2); }
	void setCookiePolicy(jni::ref<java::net::CookiePolicy> p1) { return call_method<"setCookiePolicy", void>(p1); }
