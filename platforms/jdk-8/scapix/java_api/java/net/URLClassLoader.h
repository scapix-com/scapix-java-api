...
public:
	...
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::lang::ClassLoader> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::lang::ClassLoader> p2, jni::ref<java::net::URLStreamHandlerFactory> p3) { return object_base::new_object(p1, p2, p3); }
