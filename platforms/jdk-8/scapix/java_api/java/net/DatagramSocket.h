...
public:
	...
	static jni::ref<java::net::DatagramSocket> new_object(jni::ref<java::net::SocketAddress> p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::DatagramSocket> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::DatagramSocket> new_object(jint p1, jni::ref<java::net::InetAddress> p2) { return object_base::new_object(p1, p2); }
