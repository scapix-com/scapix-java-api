...
namespace scapix::java_api { namespace java::net { class InetAddress_Cache; }}
...
public:
	...
	static jni::ref<java::net::InetAddress_Cache> new_object(jni::ref<java::net::InetAddress_Cache_Type> p1) { return object_base::new_object(p1); }
