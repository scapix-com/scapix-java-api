...
#ifndef SCAPIX_JAVA_API_JAVA_NET_INET6ADDRESS
...
public:
	...
	static jni::ref<java::net::Inet6Address> getByAddress(jni::ref<java::lang::String> p1, jni::ref<jni::array<jbyte>> p2, jni::ref<java::net::NetworkInterface> p3) { return call_static_method<"getByAddress", jni::ref<java::net::Inet6Address>>(p1, p2, p3); }
	static jni::ref<java::net::Inet6Address> getByAddress(jni::ref<java::lang::String> p1, jni::ref<jni::array<jbyte>> p2, jint p3) { return call_static_method<"getByAddress", jni::ref<java::net::Inet6Address>>(p1, p2, p3); }
