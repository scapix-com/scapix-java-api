...
public:
	...
	static jni::ref<java::net::InetSocketAddress> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::net::InetAddress> p1, jint p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::lang::String> p1, jint p2) { return base_::new_object(p1, p2); }
