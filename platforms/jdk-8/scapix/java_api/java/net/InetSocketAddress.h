...
#ifndef SCAPIX_JAVA_API_JAVA_NET_INETSOCKETADDRESS
...
public:
	...
	static jni::ref<java::net::InetSocketAddress> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::net::InetAddress> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::InetSocketAddress> createUnresolved(jni::ref<java::lang::String> p1, jint p2) { return call_static_method<"createUnresolved", jni::ref<java::net::InetSocketAddress>>(p1, p2); }
