...
namespace scapix::java_api { namespace java::net { class InMemoryCookieStore; }}
...
public:
	...
	static jni::ref<java::net::InMemoryCookieStore> new_object() { return object_base::new_object(); }
