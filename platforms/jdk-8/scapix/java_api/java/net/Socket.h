...
public:
	...
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::Proxy> p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::InetAddress> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<java::net::InetAddress> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::InetAddress> p1, jint p2, jni::ref<java::net::InetAddress> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::lang::String> p1, jint p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::net::Socket> new_object(jni::ref<java::net::InetAddress> p1, jint p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
