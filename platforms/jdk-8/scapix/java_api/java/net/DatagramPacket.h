...
public:
	...
	static jni::ref<java::net::DatagramPacket> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::net::DatagramPacket> new_object(jni::ref<jni::array<jbyte>> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::DatagramPacket> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3, jni::ref<java::net::InetAddress> p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::net::DatagramPacket> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3, jni::ref<java::net::SocketAddress> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::net::DatagramPacket> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jni::ref<java::net::InetAddress> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::net::DatagramPacket> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jni::ref<java::net::SocketAddress> p3) { return object_base::new_object(p1, p2, p3); }
