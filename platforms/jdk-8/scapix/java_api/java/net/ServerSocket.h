...
public:
	...
	static jni::ref<java::net::ServerSocket> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<java::net::ServerSocket> new_object(jint p1, jint p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::net::ServerSocket> new_object(jint p1, jint p2, jni::ref<java::net::InetAddress> p3) { return base_::new_object(p1, p2, p3); }
