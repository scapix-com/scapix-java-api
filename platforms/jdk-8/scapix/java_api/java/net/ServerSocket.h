...
public:
	...
	static jni::ref<java::net::ServerSocket> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::ServerSocket> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::ServerSocket> new_object(jint p1, jint p2, jni::ref<java::net::InetAddress> p3) { return object_base::new_object(p1, p2, p3); }
	...
	static void setSocketFactory(jni::ref<java::net::SocketImplFactory> p1) { return call_static_method<"setSocketFactory", void>(p1); }
