...
#ifndef SCAPIX_JAVA_API_JAVA_NET_NETWORKINTERFACE
...
public:
	...
	static jni::ref<java::net::NetworkInterface> getByName(jni::ref<java::lang::String> p1) { return call_static_method<"getByName", jni::ref<java::net::NetworkInterface>>(p1); }
	static jni::ref<java::net::NetworkInterface> getByIndex(jint p1) { return call_static_method<"getByIndex", jni::ref<java::net::NetworkInterface>>(p1); }
	static jni::ref<java::net::NetworkInterface> getByInetAddress(jni::ref<java::net::InetAddress> p1) { return call_static_method<"getByInetAddress", jni::ref<java::net::NetworkInterface>>(p1); }
