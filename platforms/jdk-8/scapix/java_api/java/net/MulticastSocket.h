...
public:
	...
	static jni::ref<java::net::MulticastSocket> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::MulticastSocket> new_object(jni::ref<java::net::SocketAddress> p1) { return object_base::new_object(p1); }
