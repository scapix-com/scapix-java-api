...
public:
	...
	static jni::ref<java::net::URISyntaxException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::net::URISyntaxException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
