...
public:
	...
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3, jni::ref<java::lang::String> p4, jni::ref<java::net::URLStreamHandler> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::net::URL> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jni::ref<java::net::URLStreamHandler> p3) { return object_base::new_object(p1, p2, p3); }
