...
public:
	...
	static jni::ref<java::util::Locale_LanguageRange> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Locale_LanguageRange> new_object(jni::ref<java::lang::String> p1, jdouble p2) { return object_base::new_object(p1, p2); }
