...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST_LISTITR_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST_LISTITR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::util { class LinkedList_ListItr; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::LinkedList_ListItr>
{
	static constexpr fixed_string class_name = "java/util/LinkedList$ListItr";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::ListIterator>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST_LISTITR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST_LISTITR)
#define SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST_LISTITR
...
// private
class java::util::LinkedList_ListItr : public jni::object_base<"java/util/LinkedList$ListItr",
	java::lang::Object,
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_LINKEDLIST_LISTITR
