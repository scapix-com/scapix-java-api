...
public:
	...
	static jni::ref<java::util::Spliterators_DoubleArraySpliterator> new_object(jni::ref<jni::array<jdouble>> p1, jint p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::util::Spliterators_DoubleArraySpliterator> new_object(jni::ref<jni::array<jdouble>> p1, jint p2, jint p3, jint p4) { return base_::new_object(p1, p2, p3, p4); }
