...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDCOLLECTION_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDCOLLECTION_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::util { class Collections_SynchronizedCollection; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::Collections_SynchronizedCollection>
{
	static constexpr fixed_string class_name = "java/util/Collections$SynchronizedCollection";
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDCOLLECTION_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDCOLLECTION)
#define SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDCOLLECTION
...
// private
class java::util::Collections_SynchronizedCollection : public jni::object_base<"java/util/Collections$SynchronizedCollection",
	java::lang::Object,
...
protected:
	...
	Collections_SynchronizedCollection(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SYNCHRONIZEDCOLLECTION
