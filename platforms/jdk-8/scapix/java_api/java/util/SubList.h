...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_SUBLIST_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_SUBLIST_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::util { class SubList; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::SubList>
{
	static constexpr fixed_string class_name = "java/util/SubList";
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractList>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_UTIL_SUBLIST_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_SUBLIST)
#define SCAPIX_JAVA_API_JAVA_UTIL_SUBLIST
...
// private
class java::util::SubList : public jni::object_base<"java/util/SubList",
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_SUBLIST
