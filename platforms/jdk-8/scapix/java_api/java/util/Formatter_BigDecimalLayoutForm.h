...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_FORMATTER_BIGDECIMALLAYOUTFORM
...
public:
	...
	static jni::ref<java::util::Formatter_BigDecimalLayoutForm> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::util::Formatter_BigDecimalLayoutForm>>(p1); }
};
