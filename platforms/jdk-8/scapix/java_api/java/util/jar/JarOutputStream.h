...
public:
	...
	static jni::ref<java::util::jar::JarOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::util::jar::Manifest> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::jar::JarOutputStream> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
