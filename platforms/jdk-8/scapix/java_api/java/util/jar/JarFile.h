...
public:
	...
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::jar::JarFile> new_object(jni::ref<java::io::File> p1, jboolean p2, jint p3) { return object_base::new_object(p1, p2, p3); }
