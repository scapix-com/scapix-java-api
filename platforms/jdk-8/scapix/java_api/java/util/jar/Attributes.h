...
public:
	...
	static jni::ref<java::util::jar::Attributes> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::Attributes> new_object(jni::ref<java::util::jar::Attributes> p1) { return object_base::new_object(p1); }
