...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_JAR_MANIFEST
...
public:
	...
	static jni::ref<java::util::jar::Manifest> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::jar::Manifest> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::Manifest> new_object(jni::ref<java::util::jar::Manifest> p1) { return object_base::new_object(p1); }
	...
	jni::ref<java::util::jar::Attributes> getAttributes(jni::ref<java::lang::String> p1) { return call_method<"getAttributes", jni::ref<java::util::jar::Attributes>>(p1); }
