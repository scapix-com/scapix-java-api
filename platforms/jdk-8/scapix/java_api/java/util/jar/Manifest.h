...
public:
	...
	static jni::ref<java::util::jar::Manifest> new_object(jni::ref<java::io::InputStream> p1) { return base_::new_object(p1); }
	static jni::ref<java::util::jar::Manifest> new_object(jni::ref<java::util::jar::Manifest> p1) { return base_::new_object(p1); }
