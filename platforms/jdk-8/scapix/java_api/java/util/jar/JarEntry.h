...
public:
	...
	static jni::ref<java::util::jar::JarEntry> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::JarEntry> new_object(jni::ref<java::util::zip::ZipEntry> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::JarEntry> new_object(jni::ref<java::util::jar::JarEntry> p1) { return object_base::new_object(p1); }
