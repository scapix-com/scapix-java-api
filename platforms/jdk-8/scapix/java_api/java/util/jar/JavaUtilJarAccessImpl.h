...
namespace scapix::java_api { namespace java::util::jar { class JavaUtilJarAccessImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::java::util::jar::JavaUtilJarAccessImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::sun::misc::JavaUtilJarAccess>;
};
