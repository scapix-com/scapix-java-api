...
public:
	...
	static jni::ref<java::util::jar::JarInputStream> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::jar::JarInputStream> new_object(jni::ref<java::io::InputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
