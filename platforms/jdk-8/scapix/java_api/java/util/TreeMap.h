...
public:
	...
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Comparator> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::TreeMap> new_object(jni::ref<java::util::SortedMap> p1) { return object_base::new_object(p1); }
