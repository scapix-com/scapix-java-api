...
public:
	...
	static jni::ref<java::util::Spliterators_LongArraySpliterator> new_object(jni::ref<jni::array<jlong>> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::Spliterators_LongArraySpliterator> new_object(jni::ref<jni::array<jlong>> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
