...
public:
	...
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::lang::Readable> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::io::File> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::file::Path> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::file::Path> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Scanner> new_object(jni::ref<java::nio::channels::ReadableByteChannel> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
