...
namespace scapix::java_api { namespace java::util { class Currency_CurrencyNameGetter; }}
...
public:
	...
	jni::ref<java::lang::String> getObject(jni::ref<java::util::spi::CurrencyNameProvider> p1, jni::ref<java::util::Locale> p2, jni::ref<java::lang::String> p3, jni::ref<jni::array<java::lang::Object>> p4) { return call_method<"getObject", jni::ref<java::lang::String>>(p1, p2, p3, p4); }
