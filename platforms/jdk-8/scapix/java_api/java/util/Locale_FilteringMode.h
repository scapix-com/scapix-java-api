...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOCALE_FILTERINGMODE
...
public:
	...
	static jni::ref<java::util::Locale_FilteringMode> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::util::Locale_FilteringMode>>(p1); }
};
