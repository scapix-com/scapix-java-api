...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_OPTIONALLONG
...
public:
	...
	static jni::ref<java::util::OptionalLong> of(jlong p1) { return call_static_method<"of", jni::ref<java::util::OptionalLong>>(p1); }
	jlong getAsLong() { return call_method<"getAsLong", jlong>(); }
	jboolean isPresent() { return call_method<"isPresent", jboolean>(); }
	void ifPresent(jni::ref<java::util::function::LongConsumer> p1) { return call_method<"ifPresent", void>(p1); }
	jlong orElse(jlong p1) { return call_method<"orElse", jlong>(p1); }
	jlong orElseGet(jni::ref<java::util::function::LongSupplier> p1) { return call_method<"orElseGet", jlong>(p1); }
	jlong orElseThrow(jni::ref<java::util::function::Supplier> p1) { return call_method<"orElseThrow", jlong>(p1); }
