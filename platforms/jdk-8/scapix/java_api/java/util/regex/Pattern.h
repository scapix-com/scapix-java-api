...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_REGEX_PATTERN
...
public:
	...
	static jni::ref<java::util::regex::Pattern> compile(jni::ref<java::lang::String> p1) { return call_static_method<"compile", jni::ref<java::util::regex::Pattern>>(p1); }
	static jni::ref<java::util::regex::Pattern> compile(jni::ref<java::lang::String> p1, jint p2) { return call_static_method<"compile", jni::ref<java::util::regex::Pattern>>(p1, p2); }
	jni::ref<java::lang::String> pattern() { return call_method<"pattern", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> toString() { return call_method<"toString", jni::ref<java::lang::String>>(); }
	jni::ref<java::util::regex::Matcher> matcher(jni::ref<java::lang::CharSequence> p1) { return call_method<"matcher", jni::ref<java::util::regex::Matcher>>(p1); }
	jint flags() { return call_method<"flags", jint>(); }
	static jboolean matches(jni::ref<java::lang::String> p1, jni::ref<java::lang::CharSequence> p2) { return call_static_method<"matches", jboolean>(p1, p2); }
	jni::ref<jni::array<java::lang::String>> split(jni::ref<java::lang::CharSequence> p1, jint p2) { return call_method<"split", jni::ref<jni::array<java::lang::String>>>(p1, p2); }
	jni::ref<jni::array<java::lang::String>> split(jni::ref<java::lang::CharSequence> p1) { return call_method<"split", jni::ref<jni::array<java::lang::String>>>(p1); }
	...
	jni::ref<java::util::stream::Stream> splitAsStream(jni::ref<java::lang::CharSequence> p1) { return call_method<"splitAsStream", jni::ref<java::util::stream::Stream>>(p1); }
};
