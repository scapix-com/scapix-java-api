...
public:
	...
	static jni::ref<java::util::ArrayList> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<java::util::ArrayList> new_object() { return base_::new_object(); }
	static jni::ref<java::util::ArrayList> new_object(jni::ref<java::util::Collection> p1) { return base_::new_object(p1); }
