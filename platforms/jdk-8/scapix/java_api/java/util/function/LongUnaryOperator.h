...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_FUNCTION_LONGUNARYOPERATOR
...
public:
	...
	jni::ref<java::util::function::LongUnaryOperator> compose(jni::ref<java::util::function::LongUnaryOperator> p1) { return call_method<"compose", jni::ref<java::util::function::LongUnaryOperator>>(p1); }
	jni::ref<java::util::function::LongUnaryOperator> andThen(jni::ref<java::util::function::LongUnaryOperator> p1) { return call_method<"andThen", jni::ref<java::util::function::LongUnaryOperator>>(p1); }
