...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CURRENCY
...
public:
	...
	static jni::ref<java::util::Currency> getInstance(jni::ref<java::lang::String> p1) { return call_static_method<"getInstance", jni::ref<java::util::Currency>>(p1); }
	static jni::ref<java::util::Currency> getInstance(jni::ref<java::util::Locale> p1) { return call_static_method<"getInstance", jni::ref<java::util::Currency>>(p1); }
	...
	jni::ref<java::lang::String> getSymbol(jni::ref<java::util::Locale> p1) { return call_method<"getSymbol", jni::ref<java::lang::String>>(p1); }
