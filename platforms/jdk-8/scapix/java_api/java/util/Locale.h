...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_LOCALE
...
public:
	...
	static jni::ref<java::util::Locale> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::Locale> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::Locale> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Locale> getDefault() { return call_static_method<"getDefault", jni::ref<java::util::Locale>>(); }
	static jni::ref<java::util::Locale> getDefault(jni::ref<java::util::Locale_Category> p1) { return call_static_method<"getDefault", jni::ref<java::util::Locale>>(p1); }
	static void setDefault(jni::ref<java::util::Locale> p1) { return call_static_method<"setDefault", void>(p1); }
	static void setDefault(jni::ref<java::util::Locale_Category> p1, jni::ref<java::util::Locale> p2) { return call_static_method<"setDefault", void>(p1, p2); }
	...
	jni::ref<java::lang::String> getExtension(jchar p1) { return call_method<"getExtension", jni::ref<java::lang::String>>(p1); }
	...
	static jni::ref<java::util::Locale> forLanguageTag(jni::ref<java::lang::String> p1) { return call_static_method<"forLanguageTag", jni::ref<java::util::Locale>>(p1); }
	...
	jni::ref<java::lang::String> getDisplayLanguage(jni::ref<java::util::Locale> p1) { return call_method<"getDisplayLanguage", jni::ref<java::lang::String>>(p1); }
	jni::ref<java::lang::String> getDisplayScript() { return call_method<"getDisplayScript", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getDisplayScript(jni::ref<java::util::Locale> p1) { return call_method<"getDisplayScript", jni::ref<java::lang::String>>(p1); }
	jni::ref<java::lang::String> getDisplayCountry() { return call_method<"getDisplayCountry", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getDisplayCountry(jni::ref<java::util::Locale> p1) { return call_method<"getDisplayCountry", jni::ref<java::lang::String>>(p1); }
	jni::ref<java::lang::String> getDisplayVariant() { return call_method<"getDisplayVariant", jni::ref<java::lang::String>>(); }
	jni::ref<java::lang::String> getDisplayVariant(jni::ref<java::util::Locale> p1) { return call_method<"getDisplayVariant", jni::ref<java::lang::String>>(p1); }
	...
	static jni::ref<java::util::List> filter(jni::ref<java::util::List> p1, jni::ref<java::util::Collection> p2) { return call_static_method<"filter", jni::ref<java::util::List>>(p1, p2); }
	...
	static jni::ref<java::util::List> filterTags(jni::ref<java::util::List> p1, jni::ref<java::util::Collection> p2) { return call_static_method<"filterTags", jni::ref<java::util::List>>(p1, p2); }
