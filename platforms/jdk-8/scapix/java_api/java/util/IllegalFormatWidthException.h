...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ILLEGALFORMATWIDTHEXCEPTION
...
public:
	...
	static jni::ref<java::util::IllegalFormatWidthException> new_object(jint p1) { return object_base::new_object(p1); }
