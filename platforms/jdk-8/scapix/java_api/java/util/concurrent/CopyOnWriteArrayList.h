...
public:
	...
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::CopyOnWriteArrayList> new_object(jni::ref<jni::array<java::lang::Object>> p1) { return object_base::new_object(p1); }
