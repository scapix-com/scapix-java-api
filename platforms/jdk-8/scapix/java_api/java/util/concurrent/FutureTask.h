...
public:
	...
	static jni::ref<java::util::concurrent::FutureTask> new_object(jni::ref<java::util::concurrent::Callable> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::FutureTask> new_object(jni::ref<java::lang::Runnable> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
