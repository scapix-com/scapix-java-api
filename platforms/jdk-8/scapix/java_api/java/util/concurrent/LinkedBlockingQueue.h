...
public:
	...
	static jni::ref<java::util::concurrent::LinkedBlockingQueue> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<java::util::concurrent::LinkedBlockingQueue> new_object(jni::ref<java::util::Collection> p1) { return base_::new_object(p1); }
