...
public:
	...
	static jni::ref<java::util::concurrent::ForkJoinPool> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::ForkJoinPool> new_object(jint p1, jni::ref<java::util::concurrent::ForkJoinPool_ForkJoinWorkerThreadFactory> p2, jni::ref<java::lang::Thread_UncaughtExceptionHandler> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
