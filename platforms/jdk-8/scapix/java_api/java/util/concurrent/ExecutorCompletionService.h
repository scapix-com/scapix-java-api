...
public:
	...
	static jni::ref<java::util::concurrent::ExecutorCompletionService> new_object(jni::ref<java::util::concurrent::Executor> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::ExecutorCompletionService> new_object(jni::ref<java::util::concurrent::Executor> p1, jni::ref<java::util::concurrent::BlockingQueue> p2) { return object_base::new_object(p1, p2); }
