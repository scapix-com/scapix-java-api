...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_COPYONWRITEARRAYSET
...
public:
	...
	static jni::ref<java::util::concurrent::CopyOnWriteArraySet> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
