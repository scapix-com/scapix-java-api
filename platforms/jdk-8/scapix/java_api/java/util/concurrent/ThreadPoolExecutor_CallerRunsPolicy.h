...
class ThreadPoolExecutor_CallerRunsPolicy;
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_THREADPOOLEXECUTOR_CALLERRUNSPOLICY
...
public:
	...
	static jni::ref<java::util::concurrent::ThreadPoolExecutor_CallerRunsPolicy> new_object() { return object_base::new_object(); }
