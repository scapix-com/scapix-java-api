...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_DELAYQUEUE
...
public:
	...
	static jni::ref<java::util::concurrent::DelayQueue> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::DelayQueue> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
	jboolean add(jni::ref<java::util::concurrent::Delayed> p1) { return call_method<"add", jboolean>(p1); }
	jboolean offer(jni::ref<java::util::concurrent::Delayed> p1) { return call_method<"offer", jboolean>(p1); }
	void put(jni::ref<java::util::concurrent::Delayed> p1) { return call_method<"put", void>(p1); }
	jboolean offer(jni::ref<java::util::concurrent::Delayed> p1, jlong p2, jni::ref<java::util::concurrent::TimeUnit> p3) { return call_method<"offer", jboolean>(p1, p2, p3); }
	...
	jni::ref<java::util::concurrent::Delayed> poll(jlong p1, jni::ref<java::util::concurrent::TimeUnit> p2) { return call_method<"poll", jni::ref<java::util::concurrent::Delayed>>(p1, p2); }
