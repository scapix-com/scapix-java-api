...
public:
	...
	static jni::ref<java::util::concurrent::CyclicBarrier> new_object(jint p1, jni::ref<java::lang::Runnable> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::util::concurrent::CyclicBarrier> new_object(jint p1) { return base_::new_object(p1); }
