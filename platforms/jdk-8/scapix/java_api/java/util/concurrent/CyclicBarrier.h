...
public:
	...
	static jni::ref<java::util::concurrent::CyclicBarrier> new_object(jint p1, jni::ref<java::lang::Runnable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::concurrent::CyclicBarrier> new_object(jint p1) { return object_base::new_object(p1); }
	jint getParties() { return call_method<"getParties", jint>(); }
	jint await() { return call_method<"await", jint>(); }
	jint await(jlong p1, jni::ref<java::util::concurrent::TimeUnit> p2) { return call_method<"await", jint>(p1, p2); }
