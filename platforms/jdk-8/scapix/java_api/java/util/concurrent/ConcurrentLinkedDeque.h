...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTLINKEDDEQUE
...
public:
	...
	static jni::ref<java::util::concurrent::ConcurrentLinkedDeque> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::ConcurrentLinkedDeque> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
