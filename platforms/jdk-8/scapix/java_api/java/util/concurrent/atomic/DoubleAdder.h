...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ATOMIC_DOUBLEADDER
...
public:
	...
	static jni::ref<java::util::concurrent::atomic::DoubleAdder> new_object() { return object_base::new_object(); }
	void add(jdouble p1) { return call_method<"add", void>(p1); }
