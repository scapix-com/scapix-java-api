...
public:
	...
	static jni::ref<java::util::concurrent::atomic::AtomicLongArray> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::atomic::AtomicLongArray> new_object(jni::ref<jni::array<jlong>> p1) { return object_base::new_object(p1); }
