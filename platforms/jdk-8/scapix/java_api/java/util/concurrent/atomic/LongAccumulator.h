...
public:
	...
	static jni::ref<java::util::concurrent::atomic::LongAccumulator> new_object(jni::ref<java::util::function::LongBinaryOperator> p1, jlong p2) { return base_::new_object(p1, p2); }
