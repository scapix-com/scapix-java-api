...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ATOMIC_LONGACCUMULATOR
...
public:
	...
	static jni::ref<java::util::concurrent::atomic::LongAccumulator> new_object(jni::ref<java::util::function::LongBinaryOperator> p1, jlong p2) { return object_base::new_object(p1, p2); }
	void accumulate(jlong p1) { return call_method<"accumulate", void>(p1); }
