...
public:
	...
	static jni::ref<java::util::concurrent::atomic::DoubleAccumulator> new_object(jni::ref<java::util::function::DoubleBinaryOperator> p1, jdouble p2) { return base_::new_object(p1, p2); }
