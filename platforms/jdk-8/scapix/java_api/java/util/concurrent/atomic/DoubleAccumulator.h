...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ATOMIC_DOUBLEACCUMULATOR
...
public:
	...
	static jni::ref<java::util::concurrent::atomic::DoubleAccumulator> new_object(jni::ref<java::util::function::DoubleBinaryOperator> p1, jdouble p2) { return object_base::new_object(p1, p2); }
	void accumulate(jdouble p1) { return call_method<"accumulate", void>(p1); }
