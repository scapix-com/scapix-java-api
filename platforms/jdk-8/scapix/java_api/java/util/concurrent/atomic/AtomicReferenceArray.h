...
public:
	...
	static jni::ref<java::util::concurrent::atomic::AtomicReferenceArray> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::atomic::AtomicReferenceArray> new_object(jni::ref<jni::array<java::lang::Object>> p1) { return object_base::new_object(p1); }
