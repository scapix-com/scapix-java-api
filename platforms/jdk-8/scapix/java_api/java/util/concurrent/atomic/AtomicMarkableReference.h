...
public:
	...
	static jni::ref<java::util::concurrent::atomic::AtomicMarkableReference> new_object(jni::ref<java::lang::Object> p1, jboolean p2) { return object_base::new_object(p1, p2); }
