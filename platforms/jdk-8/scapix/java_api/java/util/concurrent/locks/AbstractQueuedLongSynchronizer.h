...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_LOCKS_ABSTRACTQUEUEDLONGSYNCHRONIZER
...
public:
	...
	void acquire(jlong p1) { return call_method<"acquire", void>(p1); }
	void acquireInterruptibly(jlong p1) { return call_method<"acquireInterruptibly", void>(p1); }
	jboolean tryAcquireNanos(jlong p1, jlong p2) { return call_method<"tryAcquireNanos", jboolean>(p1, p2); }
	jboolean release(jlong p1) { return call_method<"release", jboolean>(p1); }
	void acquireShared(jlong p1) { return call_method<"acquireShared", void>(p1); }
	void acquireSharedInterruptibly(jlong p1) { return call_method<"acquireSharedInterruptibly", void>(p1); }
	jboolean tryAcquireSharedNanos(jlong p1, jlong p2) { return call_method<"tryAcquireSharedNanos", jboolean>(p1, p2); }
	jboolean releaseShared(jlong p1) { return call_method<"releaseShared", jboolean>(p1); }
	...
	jboolean owns(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> p1) { return call_method<"owns", jboolean>(p1); }
	jboolean hasWaiters(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> p1) { return call_method<"hasWaiters", jboolean>(p1); }
	jint getWaitQueueLength(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> p1) { return call_method<"getWaitQueueLength", jint>(p1); }
	jni::ref<java::util::Collection> getWaitingThreads(jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer_ConditionObject> p1) { return call_method<"getWaitingThreads", jni::ref<java::util::Collection>>(p1); }
};
