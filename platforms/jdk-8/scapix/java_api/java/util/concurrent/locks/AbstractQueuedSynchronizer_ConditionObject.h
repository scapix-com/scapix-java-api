...
public:
	...
	static jni::ref<java::util::concurrent::locks::AbstractQueuedSynchronizer_ConditionObject> new_object(jni::ref<java::util::concurrent::locks::AbstractQueuedSynchronizer> p1) { return base_::new_object(p1); }
