...
public:
	...
	static jni::ref<java::util::concurrent::ArrayBlockingQueue> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<java::util::concurrent::ArrayBlockingQueue> new_object(jint p1, jboolean p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::util::concurrent::ArrayBlockingQueue> new_object(jint p1, jboolean p2, jni::ref<java::util::Collection> p3) { return base_::new_object(p1, p2, p3); }
