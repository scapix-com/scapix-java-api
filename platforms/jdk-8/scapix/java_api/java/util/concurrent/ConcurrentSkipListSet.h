...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTSET_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTSET_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::util::concurrent { class ConcurrentSkipListSet; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::concurrent::ConcurrentSkipListSet>
{
	static constexpr fixed_string class_name = "java/util/concurrent/ConcurrentSkipListSet";
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTSET_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTSET)
#define SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTSET
...
class java::util::concurrent::ConcurrentSkipListSet : public jni::object_base<"java/util/concurrent/ConcurrentSkipListSet",
...
public:
	...
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Comparator> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::SortedSet> p1) { return object_base::new_object(p1); }
	jni::ref<java::util::concurrent::ConcurrentSkipListSet> clone() { return call_method<"clone", jni::ref<java::util::concurrent::ConcurrentSkipListSet>>(); }
	...
	jni::ref<java::util::NavigableSet> subSet(jni::ref<java::lang::Object> p1, jni::ref<java::lang::Object> p2) { return call_method<"subSet", jni::ref<java::util::NavigableSet>>(p1, p2); }
	jni::ref<java::util::NavigableSet> headSet(jni::ref<java::lang::Object> p1) { return call_method<"headSet", jni::ref<java::util::NavigableSet>>(p1); }
	jni::ref<java::util::NavigableSet> tailSet(jni::ref<java::lang::Object> p1) { return call_method<"tailSet", jni::ref<java::util::NavigableSet>>(p1); }
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_CONCURRENTSKIPLISTSET
