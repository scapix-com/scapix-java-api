...
namespace scapix::java_api::java::util::concurrent { class ConcurrentSkipListSet; }
...
public:
	...
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object() { return base_::new_object(); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Comparator> p1) { return base_::new_object(p1); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::Collection> p1) { return base_::new_object(p1); }
	static jni::ref<java::util::concurrent::ConcurrentSkipListSet> new_object(jni::ref<java::util::SortedSet> p1) { return base_::new_object(p1); }
