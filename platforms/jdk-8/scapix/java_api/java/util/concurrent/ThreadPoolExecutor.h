...
public:
	...
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint p1, jint p2, jlong p3, jni::ref<java::util::concurrent::TimeUnit> p4, jni::ref<java::util::concurrent::BlockingQueue> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint p1, jint p2, jlong p3, jni::ref<java::util::concurrent::TimeUnit> p4, jni::ref<java::util::concurrent::BlockingQueue> p5, jni::ref<java::util::concurrent::ThreadFactory> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint p1, jint p2, jlong p3, jni::ref<java::util::concurrent::TimeUnit> p4, jni::ref<java::util::concurrent::BlockingQueue> p5, jni::ref<java::util::concurrent::RejectedExecutionHandler> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
