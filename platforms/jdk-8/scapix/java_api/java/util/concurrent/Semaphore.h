...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_SEMAPHORE
...
public:
	...
	static jni::ref<java::util::concurrent::Semaphore> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::Semaphore> new_object(jint p1, jboolean p2) { return object_base::new_object(p1, p2); }
