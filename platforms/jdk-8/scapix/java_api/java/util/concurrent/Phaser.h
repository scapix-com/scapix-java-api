...
public:
	...
	static jni::ref<java::util::concurrent::Phaser> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jni::ref<java::util::concurrent::Phaser> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jni::ref<java::util::concurrent::Phaser> p1, jint p2) { return object_base::new_object(p1, p2); }
