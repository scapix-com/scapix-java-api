...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_GREGORIANCALENDAR
...
public:
	...
	static jni::ref<java::util::GregorianCalendar> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::TimeZone> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::Locale> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::GregorianCalendar> new_object(jni::ref<java::util::TimeZone> p1, jni::ref<java::util::Locale> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint p1, jint p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::util::GregorianCalendar> new_object(jint p1, jint p2, jint p3, jint p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	void setGregorianChange(jni::ref<java::util::Date> p1) { return call_method<"setGregorianChange", void>(p1); }
	...
	static jni::ref<java::util::GregorianCalendar> from(jni::ref<java::time::ZonedDateTime> p1) { return call_static_method<"from", jni::ref<java::util::GregorianCalendar>>(p1); }
};
