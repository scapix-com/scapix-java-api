...
public:
	...
	static jni::ref<java::util::SimpleTimeZone> new_object(jint p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::SimpleTimeZone> new_object(jint p1, jni::ref<java::lang::String> p2, jint p3, jint p4, jint p5, jint p6, jint p7, jint p8, jint p9, jint p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
	static jni::ref<java::util::SimpleTimeZone> new_object(jint p1, jni::ref<java::lang::String> p2, jint p3, jint p4, jint p5, jint p6, jint p7, jint p8, jint p9, jint p10, jint p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
	static jni::ref<java::util::SimpleTimeZone> new_object(jint p1, jni::ref<java::lang::String> p2, jint p3, jint p4, jint p5, jint p6, jint p7, jint p8, jint p9, jint p10, jint p11, jint p12, jint p13) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); }
