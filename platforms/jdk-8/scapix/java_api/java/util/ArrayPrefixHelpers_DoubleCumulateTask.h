...
public:
	...
	static jni::ref<java::util::ArrayPrefixHelpers_DoubleCumulateTask> new_object(jni::ref<java::util::ArrayPrefixHelpers_DoubleCumulateTask> p1, jni::ref<java::util::function::DoubleBinaryOperator> p2, jni::ref<jni::array<jdouble>> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
