...
public:
	...
	static jni::ref<java::util::ArrayPrefixHelpers_LongCumulateTask> new_object(jni::ref<java::util::ArrayPrefixHelpers_LongCumulateTask> p1, jni::ref<java::util::function::LongBinaryOperator> p2, jni::ref<jni::array<jlong>> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
