...
public:
	...
	static jni::ref<java::util::HashSet> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::HashSet> new_object(jint p1, jfloat p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::HashSet> new_object(jint p1) { return object_base::new_object(p1); }
