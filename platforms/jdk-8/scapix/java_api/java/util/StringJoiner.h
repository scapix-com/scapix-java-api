...
public:
	...
	static jni::ref<java::util::StringJoiner> new_object(jni::ref<java::lang::CharSequence> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::StringJoiner> new_object(jni::ref<java::lang::CharSequence> p1, jni::ref<java::lang::CharSequence> p2, jni::ref<java::lang::CharSequence> p3) { return object_base::new_object(p1, p2, p3); }
