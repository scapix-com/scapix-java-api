...
public:
	...
	static jni::ref<java::util::AbstractMap_SimpleEntry> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::AbstractMap_SimpleEntry> new_object(jni::ref<java::util::Map_Entry> p1) { return object_base::new_object(p1); }
