...
public:
	...
	static jni::ref<java::util::Properties_LineReader> new_object(jni::ref<java::util::Properties> p1, jni::ref<java::io::InputStream> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::Properties_LineReader> new_object(jni::ref<java::util::Properties> p1, jni::ref<java::io::Reader> p2) { return object_base::new_object(p1, p2); }
