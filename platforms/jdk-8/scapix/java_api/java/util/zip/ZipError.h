...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_ZIPERROR
...
public:
	...
	static jni::ref<java::util::zip::ZipError> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
