...
public:
	...
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> p1, jint p2, jni::ref<java::nio::charset::Charset> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::lang::String> p1, jni::ref<java::nio::charset::Charset> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::zip::ZipFile> new_object(jni::ref<java::io::File> p1, jni::ref<java::nio::charset::Charset> p2) { return object_base::new_object(p1, p2); }
