...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_ZIPOUTPUTSTREAM
...
public:
	...
	static jni::ref<java::util::zip::ZipOutputStream> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::zip::ZipOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::nio::charset::Charset> p2) { return object_base::new_object(p1, p2); }
