...
public:
	...
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::util::zip::Inflater> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::util::zip::Inflater> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::zip::InflaterInputStream> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
