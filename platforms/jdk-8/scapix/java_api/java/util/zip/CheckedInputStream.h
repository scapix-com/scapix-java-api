...
public:
	...
	static jni::ref<java::util::zip::CheckedInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::util::zip::Checksum> p2) { return object_base::new_object(p1, p2); }
