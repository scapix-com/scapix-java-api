...
public:
	...
	static jni::ref<java::util::zip::ZipInputStream> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::zip::ZipInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::nio::charset::Charset> p2) { return object_base::new_object(p1, p2); }
