...
public:
	...
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> p1) { return base_::new_object(p1); }
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::util::zip::Inflater> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::util::zip::InflaterOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::util::zip::Inflater> p2, jint p3) { return base_::new_object(p1, p2, p3); }
