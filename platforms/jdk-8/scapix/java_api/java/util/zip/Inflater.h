...
public:
	...
	static jni::ref<java::util::zip::Inflater> new_object(jboolean p1) { return object_base::new_object(p1); }
	...
	jint inflate(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return call_method<"inflate", jint>(p1, p2, p3); }
	jint inflate(jni::ref<jni::array<jbyte>> p1) { return call_method<"inflate", jint>(p1); }
