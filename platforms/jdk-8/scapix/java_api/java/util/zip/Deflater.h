...
public:
	...
	static jni::ref<java::util::zip::Deflater> new_object(jint p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::zip::Deflater> new_object(jint p1) { return object_base::new_object(p1); }
