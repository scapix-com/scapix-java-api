...
public:
	...
	static jni::ref<java::util::zip::GZIPOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::zip::GZIPOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jint p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::zip::GZIPOutputStream> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::zip::GZIPOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
