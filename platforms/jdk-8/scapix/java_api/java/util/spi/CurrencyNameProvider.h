...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_SPI_CURRENCYNAMEPROVIDER
...
public:
	...
	jni::ref<java::lang::String> getDisplayName(jni::ref<java::lang::String> p1, jni::ref<java::util::Locale> p2) { return call_method<"getDisplayName", jni::ref<java::lang::String>>(p1, p2); }
};
