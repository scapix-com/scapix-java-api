...
public:
	...
	static jni::ref<java::util::Date> new_object(jlong p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Date> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::Date> new_object(jint p1, jint p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::util::Date> new_object(jint p1, jint p2, jint p3, jint p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::util::Date> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
