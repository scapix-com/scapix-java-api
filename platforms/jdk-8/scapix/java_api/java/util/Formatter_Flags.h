...
namespace scapix::java_api { namespace java::util { class Formatter_Flags; }}
...
public:
	...
	jboolean contains(jni::ref<java::util::Formatter_Flags> p1) { return call_method<"contains", jboolean>(p1); }
	jni::ref<java::util::Formatter_Flags> dup() { return call_method<"dup", jni::ref<java::util::Formatter_Flags>>(); }
	jni::ref<java::util::Formatter_Flags> remove(jni::ref<java::util::Formatter_Flags> p1) { return call_method<"remove", jni::ref<java::util::Formatter_Flags>>(p1); }
	static jni::ref<java::util::Formatter_Flags> parse(jni::ref<java::lang::String> p1) { return call_static_method<"parse", jni::ref<java::util::Formatter_Flags>>(p1); }
	static jni::ref<java::lang::String> toString(jni::ref<java::util::Formatter_Flags> p1) { return call_static_method<"toString", jni::ref<java::lang::String>>(p1); }
