...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ILLEGALFORMATCONVERSIONEXCEPTION
...
public:
	...
	static jni::ref<java::util::IllegalFormatConversionException> new_object(jchar p1, jni::ref<java::lang::Class> p2) { return object_base::new_object(p1, p2); }
