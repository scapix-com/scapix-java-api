...
public:
	...
	static jni::ref<java::util::prefs::BackingStoreException> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
	static jni::ref<java::util::prefs::BackingStoreException> new_object(jni::ref<java::lang::Throwable> p1) { return base_::new_object(p1); }
