...
public:
	...
	static jni::ref<java::util::prefs::Preferences> userNodeForPackage(jni::ref<java::lang::Class> p1) { return call_static_method<"userNodeForPackage", jni::ref<java::util::prefs::Preferences>>(p1); }
	static jni::ref<java::util::prefs::Preferences> systemNodeForPackage(jni::ref<java::lang::Class> p1) { return call_static_method<"systemNodeForPackage", jni::ref<java::util::prefs::Preferences>>(p1); }
	...
	static void importPreferences(jni::ref<java::io::InputStream> p1) { return call_static_method<"importPreferences", void>(p1); }
