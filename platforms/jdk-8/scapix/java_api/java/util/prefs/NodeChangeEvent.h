...
public:
	...
	static jni::ref<java::util::prefs::NodeChangeEvent> new_object(jni::ref<java::util::prefs::Preferences> p1, jni::ref<java::util::prefs::Preferences> p2) { return base_::new_object(p1, p2); }
