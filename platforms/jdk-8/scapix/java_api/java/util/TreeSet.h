...
public:
	...
	static jni::ref<java::util::TreeSet> new_object(jni::ref<java::util::Comparator> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::TreeSet> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::TreeSet> new_object(jni::ref<java::util::SortedSet> p1) { return object_base::new_object(p1); }
