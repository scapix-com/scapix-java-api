...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ENUMMAP
...
public:
	...
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::lang::Class> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::util::EnumMap> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::EnumMap> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
