...
public:
	...
	static jni::ref<java::util::Timer> new_object(jboolean p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Timer> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::Timer> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
