...
public:
	...
	static jni::ref<java::util::Spliterators_LongIteratorSpliterator> new_object(jni::ref<java::util::PrimitiveIterator_OfLong> p1, jlong p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::util::Spliterators_LongIteratorSpliterator> new_object(jni::ref<java::util::PrimitiveIterator_OfLong> p1, jint p2) { return object_base::new_object(p1, p2); }
