...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_STREAM_STREAM
...
public:
	...
	static jni::ref<java::util::stream::Stream> of(jni::ref<java::lang::Object> p1) { return call_static_method<"of", jni::ref<java::util::stream::Stream>>(p1); }
	static jni::ref<java::util::stream::Stream> of(jni::ref<jni::array<java::lang::Object>> p1) { return call_static_method<"of", jni::ref<java::util::stream::Stream>>(p1); }
	static jni::ref<java::util::stream::Stream> iterate(jni::ref<java::lang::Object> p1, jni::ref<java::util::function::UnaryOperator> p2) { return call_static_method<"iterate", jni::ref<java::util::stream::Stream>>(p1, p2); }
	static jni::ref<java::util::stream::Stream> generate(jni::ref<java::util::function::Supplier> p1) { return call_static_method<"generate", jni::ref<java::util::stream::Stream>>(p1); }
	static jni::ref<java::util::stream::Stream> concat(jni::ref<java::util::stream::Stream> p1, jni::ref<java::util::stream::Stream> p2) { return call_static_method<"concat", jni::ref<java::util::stream::Stream>>(p1, p2); }
};
