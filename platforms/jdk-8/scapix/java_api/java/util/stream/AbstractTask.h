...
namespace scapix::java_api { namespace java::util::stream { class AbstractTask; }}
...
public:
	...
	static jlong suggestTargetSize(jlong p1) { return call_static_method<"suggestTargetSize", jlong>(p1); }
