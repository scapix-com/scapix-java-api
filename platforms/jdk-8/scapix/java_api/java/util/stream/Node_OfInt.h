...
namespace scapix::java_api { namespace java::util::stream { class Node_OfInt; }}
...
public:
	...
	void copyInto(jni::ref<jni::array<java::lang::Integer>> p1, jint p2) { return call_method<"copyInto", void>(p1, p2); }
	jni::ref<java::util::stream::Node_OfInt> truncate(jlong p1, jlong p2, jni::ref<java::util::function::IntFunction> p3) { return call_method<"truncate", jni::ref<java::util::stream::Node_OfInt>>(p1, p2, p3); }
