...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_STREAM_INTSTREAM_BUILDER
...
public:
	...
	jni::ref<java::util::stream::IntStream_Builder> add(jint p1) { return call_method<"add", jni::ref<java::util::stream::IntStream_Builder>>(p1); }
