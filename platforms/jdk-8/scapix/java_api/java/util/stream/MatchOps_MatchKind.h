...
namespace scapix::java_api { namespace java::util::stream { class MatchOps_MatchKind; }}
...
public:
	...
	static jni::ref<java::util::stream::MatchOps_MatchKind> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::util::stream::MatchOps_MatchKind>>(p1); }
