...
namespace scapix::java_api { namespace java::util::stream { class Nodes_DoubleSpinedNodeBuilder; }}
...
public:
	...
	void copyInto(jni::ref<jni::array<jdouble>> p1, jint p2) { return call_method<"copyInto", void>(p1, p2); }
