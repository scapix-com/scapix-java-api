...
public:
	...
	static jni::ref<java::util::Hashtable> new_object(jint p1, jfloat p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::util::Hashtable> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<java::util::Hashtable> new_object() { return base_::new_object(); }
	static jni::ref<java::util::Hashtable> new_object(jni::ref<java::util::Map> p1) { return base_::new_object(p1); }
