...
public:
	...
	static jni::ref<java::util::IdentityHashMap> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::IdentityHashMap> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
