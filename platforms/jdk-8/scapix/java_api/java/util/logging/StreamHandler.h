...
public:
	...
	static jni::ref<java::util::logging::StreamHandler> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::util::logging::Formatter> p2) { return object_base::new_object(p1, p2); }
