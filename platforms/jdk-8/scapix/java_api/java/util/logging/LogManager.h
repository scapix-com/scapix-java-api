...
public:
	...
	jboolean addLogger(jni::ref<java::util::logging::Logger> p1) { return call_method<"addLogger", jboolean>(p1); }
	...
	void readConfiguration(jni::ref<java::io::InputStream> p1) { return call_method<"readConfiguration", void>(p1); }
