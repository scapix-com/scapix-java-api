...
public:
	...
	static jni::ref<java::util::logging::LogRecord> new_object(jni::ref<java::util::logging::Level> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
