...
public:
	...
	static jni::ref<java::util::LinkedHashMap> new_object(jint p1, jfloat p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::util::LinkedHashMap> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::LinkedHashMap> new_object() { return object_base::new_object(); }
	static jni::ref<java::util::LinkedHashMap> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
	static jni::ref<java::util::LinkedHashMap> new_object(jint p1, jfloat p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
