...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SINGLETONMAP_FWD
#define SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SINGLETONMAP_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::util { class Collections_SingletonMap; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::util::Collections_SingletonMap>
{
	static constexpr fixed_string class_name = "java/util/Collections$SingletonMap";
	using base_classes = std::tuple<scapix::java_api::java::util::AbstractMap, scapix::java_api::java::io::Serializable>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SINGLETONMAP_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SINGLETONMAP)
#define SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SINGLETONMAP
...
// private
class java::util::Collections_SingletonMap : public jni::object_base<"java/util/Collections$SingletonMap",
...
protected:
	...
	Collections_SingletonMap(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_UTIL_COLLECTIONS_SINGLETONMAP
