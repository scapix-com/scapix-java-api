...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_ASYNCHRONOUSFILECHANNEL
...
public:
	...
	static jni::ref<java::nio::channels::AsynchronousFileChannel> open(jni::ref<java::nio::file::Path> p1, jni::ref<java::util::Set> p2, jni::ref<java::util::concurrent::ExecutorService> p3, jni::ref<jni::array<java::nio::file::attribute::FileAttribute>> p4) { return call_static_method<"open", jni::ref<java::nio::channels::AsynchronousFileChannel>>(p1, p2, p3, p4); }
	static jni::ref<java::nio::channels::AsynchronousFileChannel> open(jni::ref<java::nio::file::Path> p1, jni::ref<jni::array<java::nio::file::OpenOption>> p2) { return call_static_method<"open", jni::ref<java::nio::channels::AsynchronousFileChannel>>(p1, p2); }
	...
	void lock(jni::ref<java::lang::Object> p1, jni::ref<java::nio::channels::CompletionHandler> p2) { return call_method<"lock", void>(p1, p2); }
