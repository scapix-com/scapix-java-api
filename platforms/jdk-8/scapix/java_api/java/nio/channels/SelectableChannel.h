...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_SELECTABLECHANNEL
...
public:
	...
	jni::ref<java::nio::channels::SelectionKey> register_(jni::ref<java::nio::channels::Selector> p1, jint p2) { return call_method<"register", jni::ref<java::nio::channels::SelectionKey>>(p1, p2); }
