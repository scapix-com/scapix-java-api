...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_FILECHANNEL
...
public:
	...
	static jni::ref<java::nio::channels::FileChannel> open(jni::ref<java::nio::file::Path> p1, jni::ref<java::util::Set> p2, jni::ref<jni::array<java::nio::file::attribute::FileAttribute>> p3) { return call_static_method<"open", jni::ref<java::nio::channels::FileChannel>>(p1, p2, p3); }
	static jni::ref<java::nio::channels::FileChannel> open(jni::ref<java::nio::file::Path> p1, jni::ref<jni::array<java::nio::file::OpenOption>> p2) { return call_static_method<"open", jni::ref<java::nio::channels::FileChannel>>(p1, p2); }
