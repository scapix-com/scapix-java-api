...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_DIRECTINTBUFFERS_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_DIRECTINTBUFFERS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class DirectIntBufferS; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::DirectIntBufferS>
{
	static constexpr fixed_string class_name = "java/nio/DirectIntBufferS";
	using base_classes = std::tuple<scapix::java_api::java::nio::IntBuffer, scapix::java_api::sun::nio::ch::DirectBuffer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_DIRECTINTBUFFERS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_DIRECTINTBUFFERS)
#define SCAPIX_JAVA_API_JAVA_NIO_DIRECTINTBUFFERS
...
// private
class java::nio::DirectIntBufferS : public jni::object_base<"java/nio/DirectIntBufferS",
	java::nio::IntBuffer,
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_DIRECTINTBUFFERS
