...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_SPI_FILESYSTEMPROVIDER
...
public:
	...
	jni::ref<java::nio::file::FileSystem> newFileSystem(jni::ref<java::nio::file::Path> p1, jni::ref<java::util::Map> p2) { return call_method<"newFileSystem", jni::ref<java::nio::file::FileSystem>>(p1, p2); }
	jni::ref<java::io::InputStream> newInputStream(jni::ref<java::nio::file::Path> p1, jni::ref<jni::array<java::nio::file::OpenOption>> p2) { return call_method<"newInputStream", jni::ref<java::io::InputStream>>(p1, p2); }
	jni::ref<java::io::OutputStream> newOutputStream(jni::ref<java::nio::file::Path> p1, jni::ref<jni::array<java::nio::file::OpenOption>> p2) { return call_method<"newOutputStream", jni::ref<java::io::OutputStream>>(p1, p2); }
	jni::ref<java::nio::channels::FileChannel> newFileChannel(jni::ref<java::nio::file::Path> p1, jni::ref<java::util::Set> p2, jni::ref<jni::array<java::nio::file::attribute::FileAttribute>> p3) { return call_method<"newFileChannel", jni::ref<java::nio::channels::FileChannel>>(p1, p2, p3); }
	jni::ref<java::nio::channels::AsynchronousFileChannel> newAsynchronousFileChannel(jni::ref<java::nio::file::Path> p1, jni::ref<java::util::Set> p2, jni::ref<java::util::concurrent::ExecutorService> p3, jni::ref<jni::array<java::nio::file::attribute::FileAttribute>> p4) { return call_method<"newAsynchronousFileChannel", jni::ref<java::nio::channels::AsynchronousFileChannel>>(p1, p2, p3, p4); }
	...
	void createSymbolicLink(jni::ref<java::nio::file::Path> p1, jni::ref<java::nio::file::Path> p2, jni::ref<jni::array<java::nio::file::attribute::FileAttribute>> p3) { return call_method<"createSymbolicLink", void>(p1, p2, p3); }
	void createLink(jni::ref<java::nio::file::Path> p1, jni::ref<java::nio::file::Path> p2) { return call_method<"createLink", void>(p1, p2); }
	void delete_(jni::ref<java::nio::file::Path> p1) { return call_method<"delete", void>(p1); }
	jboolean deleteIfExists(jni::ref<java::nio::file::Path> p1) { return call_method<"deleteIfExists", jboolean>(p1); }
	jni::ref<java::nio::file::Path> readSymbolicLink(jni::ref<java::nio::file::Path> p1) { return call_method<"readSymbolicLink", jni::ref<java::nio::file::Path>>(p1); }
