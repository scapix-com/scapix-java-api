...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_ATTRIBUTE_ACLENTRYTYPE
...
public:
	...
	static jni::ref<java::nio::file::attribute::AclEntryType> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::nio::file::attribute::AclEntryType>>(p1); }
};
