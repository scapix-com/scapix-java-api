...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_ATTRIBUTE_POSIXFILEPERMISSIONS
...
public:
	...
	static jni::ref<java::lang::String> toString(jni::ref<java::util::Set> p1) { return call_static_method<"toString", jni::ref<java::lang::String>>(p1); }
	static jni::ref<java::util::Set> fromString(jni::ref<java::lang::String> p1) { return call_static_method<"fromString", jni::ref<java::util::Set>>(p1); }
	static jni::ref<java::nio::file::attribute::FileAttribute> asFileAttribute(jni::ref<java::util::Set> p1) { return call_static_method<"asFileAttribute", jni::ref<java::nio::file::attribute::FileAttribute>>(p1); }
};
