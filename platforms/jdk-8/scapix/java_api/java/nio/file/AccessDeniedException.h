...
public:
	...
	static jni::ref<java::nio::file::AccessDeniedException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::nio::file::AccessDeniedException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
};
