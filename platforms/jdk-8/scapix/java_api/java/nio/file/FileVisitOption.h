...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_FILEVISITOPTION
...
public:
	...
	static jni::ref<java::nio::file::FileVisitOption> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::nio::file::FileVisitOption>>(p1); }
};
