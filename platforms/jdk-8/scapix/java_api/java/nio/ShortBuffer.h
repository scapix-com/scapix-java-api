...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_SHORTBUFFER
...
public:
	...
	static jni::ref<java::nio::ShortBuffer> allocate(jint p1) { return call_static_method<"allocate", jni::ref<java::nio::ShortBuffer>>(p1); }
	static jni::ref<java::nio::ShortBuffer> wrap(jni::ref<jni::array<jshort>> p1, jint p2, jint p3) { return call_static_method<"wrap", jni::ref<java::nio::ShortBuffer>>(p1, p2, p3); }
	static jni::ref<java::nio::ShortBuffer> wrap(jni::ref<jni::array<jshort>> p1) { return call_static_method<"wrap", jni::ref<java::nio::ShortBuffer>>(p1); }
	...
	jni::ref<java::nio::ShortBuffer> get(jni::ref<jni::array<jshort>> p1) { return call_method<"get", jni::ref<java::nio::ShortBuffer>>(p1); }
	...
	jni::ref<java::nio::ShortBuffer> put(jni::ref<jni::array<jshort>> p1) { return call_method<"put", jni::ref<java::nio::ShortBuffer>>(p1); }
	...
	jint compareTo(jni::ref<java::nio::ShortBuffer> p1) { return call_method<"compareTo", jint>(p1); }
