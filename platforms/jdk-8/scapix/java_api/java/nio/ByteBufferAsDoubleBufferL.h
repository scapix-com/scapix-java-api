...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERL_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class ByteBufferAsDoubleBufferL; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::ByteBufferAsDoubleBufferL>
{
	static constexpr fixed_string class_name = "java/nio/ByteBufferAsDoubleBufferL";
	using base_classes = std::tuple<scapix::java_api::java::nio::DoubleBuffer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERL)
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERL
...
// private
class java::nio::ByteBufferAsDoubleBufferL : public jni::object_base<"java/nio/ByteBufferAsDoubleBufferL",
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERL
