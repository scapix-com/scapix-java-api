...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERB_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERB_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class ByteBufferAsDoubleBufferB; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::ByteBufferAsDoubleBufferB>
{
	static constexpr fixed_string class_name = "java/nio/ByteBufferAsDoubleBufferB";
	using base_classes = std::tuple<scapix::java_api::java::nio::DoubleBuffer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERB_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERB)
#define SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERB
...
// private
class java::nio::ByteBufferAsDoubleBufferB : public jni::object_base<"java/nio/ByteBufferAsDoubleBufferB",
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_BYTEBUFFERASDOUBLEBUFFERB
