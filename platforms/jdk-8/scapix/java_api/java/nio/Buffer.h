...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_BUFFER
...
public:
	...
	jni::ref<java::nio::Buffer> position(jint p1) { return call_method<"position", jni::ref<java::nio::Buffer>>(p1); }
	jint limit() { return call_method<"limit", jint>(); }
	jni::ref<java::nio::Buffer> limit(jint p1) { return call_method<"limit", jni::ref<java::nio::Buffer>>(p1); }
