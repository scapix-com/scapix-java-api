...
public:
	...
	static jni::ref<java::nio::ByteBuffer> allocateDirect(jint p1) { return call_static_method<"allocateDirect", jni::ref<java::nio::ByteBuffer>>(p1); }
	static jni::ref<java::nio::ByteBuffer> allocate(jint p1) { return call_static_method<"allocate", jni::ref<java::nio::ByteBuffer>>(p1); }
	static jni::ref<java::nio::ByteBuffer> wrap(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return call_static_method<"wrap", jni::ref<java::nio::ByteBuffer>>(p1, p2, p3); }
	static jni::ref<java::nio::ByteBuffer> wrap(jni::ref<jni::array<jbyte>> p1) { return call_static_method<"wrap", jni::ref<java::nio::ByteBuffer>>(p1); }
	...
	jni::ref<java::nio::ByteBuffer> get(jni::ref<jni::array<jbyte>> p1) { return call_method<"get", jni::ref<java::nio::ByteBuffer>>(p1); }
	...
	jni::ref<java::nio::ByteBuffer> put(jni::ref<jni::array<jbyte>> p1) { return call_method<"put", jni::ref<java::nio::ByteBuffer>>(p1); }
	...
	jint compareTo(jni::ref<java::nio::ByteBuffer> p1) { return call_method<"compareTo", jint>(p1); }
	jni::ref<java::nio::ByteOrder> order() { return call_method<"order", jni::ref<java::nio::ByteOrder>>(); }
	jni::ref<java::nio::ByteBuffer> order(jni::ref<java::nio::ByteOrder> p1) { return call_method<"order", jni::ref<java::nio::ByteBuffer>>(p1); }
