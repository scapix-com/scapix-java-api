...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_DIRECTCHARBUFFERS_FWD
#define SCAPIX_JAVA_API_JAVA_NIO_DIRECTCHARBUFFERS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::nio { class DirectCharBufferS; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::nio::DirectCharBufferS>
{
	static constexpr fixed_string class_name = "java/nio/DirectCharBufferS";
	using base_classes = std::tuple<scapix::java_api::java::nio::CharBuffer, scapix::java_api::sun::nio::ch::DirectBuffer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_NIO_DIRECTCHARBUFFERS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_NIO_DIRECTCHARBUFFERS)
#define SCAPIX_JAVA_API_JAVA_NIO_DIRECTCHARBUFFERS
...
// private
class java::nio::DirectCharBufferS : public jni::object_base<"java/nio/DirectCharBufferS",
	java::nio::CharBuffer,
...
#endif // SCAPIX_JAVA_API_JAVA_NIO_DIRECTCHARBUFFERS
