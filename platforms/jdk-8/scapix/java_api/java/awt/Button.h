...
namespace scapix::java_api { namespace java::awt { class Button; }}
...
public:
	...
	static jni::ref<java::awt::Button> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
