...
public:
	...
	static jni::ref<java::awt::RenderingHints> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::RenderingHints> new_object(jni::ref<java::awt::RenderingHints_Key> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
