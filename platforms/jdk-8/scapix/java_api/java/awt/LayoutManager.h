...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_LAYOUTMANAGER_FWD
#define SCAPIX_JAVA_API_JAVA_AWT_LAYOUTMANAGER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::awt { class LayoutManager; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::awt::LayoutManager>
{
	static constexpr fixed_string class_name = "java/awt/LayoutManager";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_AWT_LAYOUTMANAGER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_LAYOUTMANAGER)
#define SCAPIX_JAVA_API_JAVA_AWT_LAYOUTMANAGER
...
class java::awt::LayoutManager : public jni::object_base<"java/awt/LayoutManager",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVA_AWT_LAYOUTMANAGER
