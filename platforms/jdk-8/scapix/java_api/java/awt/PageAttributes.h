...
public:
	...
	static jni::ref<java::awt::PageAttributes> new_object(jni::ref<java::awt::PageAttributes> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::PageAttributes> new_object(jni::ref<java::awt::PageAttributes_ColorType> p1, jni::ref<java::awt::PageAttributes_MediaType> p2, jni::ref<java::awt::PageAttributes_OrientationRequestedType> p3, jni::ref<java::awt::PageAttributes_OriginType> p4, jni::ref<java::awt::PageAttributes_PrintQualityType> p5, jni::ref<jni::array<jint>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
