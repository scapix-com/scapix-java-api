...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_SCROLLBAR_ACCESSIBLEAWTSCROLLBAR_FWD
#define SCAPIX_JAVA_API_JAVA_AWT_SCROLLBAR_ACCESSIBLEAWTSCROLLBAR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::awt { class Scrollbar_AccessibleAWTScrollBar; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::awt::Scrollbar_AccessibleAWTScrollBar>
{
	static constexpr fixed_string class_name = "java/awt/Scrollbar$AccessibleAWTScrollBar";
	using base_classes = std::tuple<scapix::java_api::java::awt::Component_AccessibleAWTComponent, scapix::java_api::javax::accessibility::AccessibleValue>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_AWT_SCROLLBAR_ACCESSIBLEAWTSCROLLBAR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_SCROLLBAR_ACCESSIBLEAWTSCROLLBAR)
#define SCAPIX_JAVA_API_JAVA_AWT_SCROLLBAR_ACCESSIBLEAWTSCROLLBAR
...
class java::awt::Scrollbar_AccessibleAWTScrollBar : public jni::object_base<"java/awt/Scrollbar$AccessibleAWTScrollBar",
...
protected:
	...
	Scrollbar_AccessibleAWTScrollBar(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_AWT_SCROLLBAR_ACCESSIBLEAWTSCROLLBAR
