...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_MENUITEM_ACCESSIBLEAWTMENUITEM_FWD
#define SCAPIX_JAVA_API_JAVA_AWT_MENUITEM_ACCESSIBLEAWTMENUITEM_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::awt { class MenuItem_AccessibleAWTMenuItem; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::awt::MenuItem_AccessibleAWTMenuItem>
{
	static constexpr fixed_string class_name = "java/awt/MenuItem$AccessibleAWTMenuItem";
	using base_classes = std::tuple<scapix::java_api::java::awt::MenuComponent_AccessibleAWTMenuComponent, scapix::java_api::javax::accessibility::AccessibleAction, scapix::java_api::javax::accessibility::AccessibleValue>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_AWT_MENUITEM_ACCESSIBLEAWTMENUITEM_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_MENUITEM_ACCESSIBLEAWTMENUITEM)
#define SCAPIX_JAVA_API_JAVA_AWT_MENUITEM_ACCESSIBLEAWTMENUITEM
...
class java::awt::MenuItem_AccessibleAWTMenuItem : public jni::object_base<"java/awt/MenuItem$AccessibleAWTMenuItem",
...
protected:
	...
	MenuItem_AccessibleAWTMenuItem(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_AWT_MENUITEM_ACCESSIBLEAWTMENUITEM
