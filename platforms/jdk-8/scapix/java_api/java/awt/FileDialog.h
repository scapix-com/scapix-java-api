...
public:
	...
	static jni::ref<java::awt::FileDialog> new_object(jni::ref<java::awt::Frame> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::FileDialog> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::FileDialog> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::FileDialog> new_object(jni::ref<java::awt::Dialog> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::FileDialog> new_object(jni::ref<java::awt::Dialog> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::FileDialog> new_object(jni::ref<java::awt::Dialog> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
