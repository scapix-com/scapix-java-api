...
namespace scapix::java_api { namespace java::awt { class SequencedEvent; }}
...
public:
	...
	static jni::ref<java::awt::SequencedEvent> new_object(jni::ref<java::awt::AWTEvent> p1) { return object_base::new_object(p1); }
