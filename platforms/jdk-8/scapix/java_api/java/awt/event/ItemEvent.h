...
public:
	...
	static jni::ref<java::awt::event::ItemEvent> new_object(jni::ref<java::awt::ItemSelectable> p1, jint p2, jni::ref<java::lang::Object> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
