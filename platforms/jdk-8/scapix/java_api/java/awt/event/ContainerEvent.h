...
public:
	...
	static jni::ref<java::awt::event::ContainerEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::Component> p3) { return object_base::new_object(p1, p2, p3); }
