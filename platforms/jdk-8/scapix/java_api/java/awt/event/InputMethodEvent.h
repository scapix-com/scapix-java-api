...
public:
	...
	static jni::ref<java::awt::event::InputMethodEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jni::ref<java::text::AttributedCharacterIterator> p4, jint p5, jni::ref<java::awt::font::TextHitInfo> p6, jni::ref<java::awt::font::TextHitInfo> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::awt::event::InputMethodEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::text::AttributedCharacterIterator> p3, jint p4, jni::ref<java::awt::font::TextHitInfo> p5, jni::ref<java::awt::font::TextHitInfo> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::event::InputMethodEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::font::TextHitInfo> p3, jni::ref<java::awt::font::TextHitInfo> p4) { return object_base::new_object(p1, p2, p3, p4); }
