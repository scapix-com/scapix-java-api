...
public:
	...
	static jni::ref<java::awt::event::ActionEvent> new_object(jni::ref<java::lang::Object> p1, jint p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::event::ActionEvent> new_object(jni::ref<java::lang::Object> p1, jint p2, jni::ref<java::lang::String> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::event::ActionEvent> new_object(jni::ref<java::lang::Object> p1, jint p2, jni::ref<java::lang::String> p3, jlong p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
