...
public:
	...
	static jni::ref<java::awt::event::HierarchyEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::Component> p3, jni::ref<java::awt::Container> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::event::HierarchyEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::Component> p3, jni::ref<java::awt::Container> p4, jlong p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
