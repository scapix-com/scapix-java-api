...
public:
	...
	static jni::ref<java::awt::event::InvocationEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::Runnable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::event::InvocationEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::Runnable> p2, jni::ref<java::lang::Object> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::event::InvocationEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::Runnable> p2, jni::ref<java::lang::Runnable> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
