...
public:
	...
	static jni::ref<java::awt::event::AdjustmentEvent> new_object(jni::ref<java::awt::Adjustable> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::event::AdjustmentEvent> new_object(jni::ref<java::awt::Adjustable> p1, jint p2, jint p3, jint p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
