...
public:
	...
	static jni::ref<java::awt::event::MouseEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jint p4, jint p5, jint p6, jint p7, jboolean p8, jint p9) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static jni::ref<java::awt::event::MouseEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jint p4, jint p5, jint p6, jint p7, jboolean p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
	jint getModifiersEx() { return call_method<"getModifiersEx", jint>(); }
	static jni::ref<java::awt::event::MouseEvent> new_object(jni::ref<java::awt::Component> p1, jint p2, jlong p3, jint p4, jint p5, jint p6, jint p7, jint p8, jint p9, jboolean p10, jint p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
