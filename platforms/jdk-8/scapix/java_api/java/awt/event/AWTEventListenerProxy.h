...
public:
	...
	static jni::ref<java::awt::event::AWTEventListenerProxy> new_object(jlong p1, jni::ref<java::awt::event::AWTEventListener> p2) { return object_base::new_object(p1, p2); }
