...
namespace scapix::java_api { namespace java::awt { class TextComponent_AccessibleAWTTextComponent; }}
...
public:
	...
	static jni::ref<java::awt::TextComponent_AccessibleAWTTextComponent> new_object(jni::ref<java::awt::TextComponent> p1) { return object_base::new_object(p1); }
