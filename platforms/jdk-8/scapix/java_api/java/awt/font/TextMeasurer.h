...
public:
	...
	static jni::ref<java::awt::font::TextMeasurer> new_object(jni::ref<java::text::AttributedCharacterIterator> p1, jni::ref<java::awt::font::FontRenderContext> p2) { return object_base::new_object(p1, p2); }
