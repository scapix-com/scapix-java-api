...
public:
	...
	static jni::ref<java::awt::font::FontRenderContext> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jboolean p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::font::FontRenderContext> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::Object> p3) { return object_base::new_object(p1, p2, p3); }
