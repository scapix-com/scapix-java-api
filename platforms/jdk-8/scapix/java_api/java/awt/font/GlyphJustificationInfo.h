...
public:
	...
	static jni::ref<java::awt::font::GlyphJustificationInfo> new_object(jfloat p1, jboolean p2, jint p3, jfloat p4, jfloat p5, jboolean p6, jint p7, jfloat p8, jfloat p9) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
};
