...
namespace scapix::java_api { namespace java::awt::font { class TextLine; }}
...
public:
	...
	static jni::ref<java::awt::font::TextLine> new_object(jni::ref<java::awt::font::FontRenderContext> p1, jni::ref<jni::array<sun::font::TextLineComponent>> p2, jni::ref<jni::array<jfloat>> p3, jni::ref<jni::array<jchar>> p4, jint p5, jint p6, jni::ref<jni::array<jint>> p7, jni::ref<jni::array<jbyte>> p8, jboolean p9) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
