...
namespace scapix::java_api { namespace java::awt::font { class StyledParagraph; }}
...
public:
	...
	static jni::ref<java::awt::font::StyledParagraph> new_object(jni::ref<java::text::AttributedCharacterIterator> p1, jni::ref<jni::array<jchar>> p2) { return object_base::new_object(p1, p2); }
