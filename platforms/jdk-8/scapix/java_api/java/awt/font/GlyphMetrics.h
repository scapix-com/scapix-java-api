...
public:
	...
	static jni::ref<java::awt::font::GlyphMetrics> new_object(jfloat p1, jni::ref<java::awt::geom::Rectangle2D> p2, jbyte p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::font::GlyphMetrics> new_object(jboolean p1, jfloat p2, jfloat p3, jni::ref<java::awt::geom::Rectangle2D> p4, jbyte p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
