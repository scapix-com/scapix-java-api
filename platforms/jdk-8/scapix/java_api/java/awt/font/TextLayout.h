...
public:
	...
	static jni::ref<java::awt::font::TextLayout> new_object(jni::ref<java::lang::String> p1, jni::ref<java::awt::Font> p2, jni::ref<java::awt::font::FontRenderContext> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::font::TextLayout> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Map> p2, jni::ref<java::awt::font::FontRenderContext> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::font::TextLayout> new_object(jni::ref<java::text::AttributedCharacterIterator> p1, jni::ref<java::awt::font::FontRenderContext> p2) { return object_base::new_object(p1, p2); }
