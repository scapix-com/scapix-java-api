...
public:
	...
	static jni::ref<java::awt::geom::FlatteningPathIterator> new_object(jni::ref<java::awt::geom::PathIterator> p1, jdouble p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::geom::FlatteningPathIterator> new_object(jni::ref<java::awt::geom::PathIterator> p1, jdouble p2, jint p3) { return object_base::new_object(p1, p2, p3); }
