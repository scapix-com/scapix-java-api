...
public:
	...
	static jni::ref<java::awt::geom::Arc2D_Float> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::geom::Arc2D_Float> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jfloat p5, jfloat p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::awt::geom::Arc2D_Float> new_object(jni::ref<java::awt::geom::Rectangle2D> p1, jfloat p2, jfloat p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
