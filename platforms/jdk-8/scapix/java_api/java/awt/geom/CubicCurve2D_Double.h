...
namespace scapix::java_api::java::awt::geom { class CubicCurve2D_Double; }
...
public:
	...
	static jni::ref<java::awt::geom::CubicCurve2D_Double> new_object() { return base_::new_object(); }
	static jni::ref<java::awt::geom::CubicCurve2D_Double> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6, jdouble p7, jdouble p8) { return base_::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
...
protected:
	...
	CubicCurve2D_Double(handle_type h) : base_(h) {}
