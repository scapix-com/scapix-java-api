...
namespace scapix::java_api { namespace java::awt::geom { class CubicCurve2D_Double; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_GEOM_CUBICCURVE2D_DOUBLE)
...
public:
	...
	static jni::ref<java::awt::geom::CubicCurve2D_Double> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6, jdouble p7, jdouble p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
