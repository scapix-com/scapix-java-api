...
namespace scapix::java_api { namespace java::awt::geom { class QuadCurve2D_Float; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_GEOM_QUADCURVE2D_FLOAT)
...
public:
	...
	static jni::ref<java::awt::geom::QuadCurve2D_Float> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jfloat p5, jfloat p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	...
	void setCurve(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jfloat p5, jfloat p6) { return call_method<"setCurve", void>(p1, p2, p3, p4, p5, p6); }
