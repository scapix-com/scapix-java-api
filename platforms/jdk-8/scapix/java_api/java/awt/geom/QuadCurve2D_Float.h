...
namespace scapix::java_api::java::awt::geom { class QuadCurve2D_Float; }
...
public:
	...
	static jni::ref<java::awt::geom::QuadCurve2D_Float> new_object() { return base_::new_object(); }
	static jni::ref<java::awt::geom::QuadCurve2D_Float> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jfloat p5, jfloat p6) { return base_::new_object(p1, p2, p3, p4, p5, p6); }
...
protected:
	...
	QuadCurve2D_Float(handle_type h) : base_(h) {}
