...
public:
	...
	static jni::ref<java::awt::geom::CubicCurve2D_Float> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jfloat p5, jfloat p6, jfloat p7, jfloat p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
