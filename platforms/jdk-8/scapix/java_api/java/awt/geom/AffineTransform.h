...
public:
	...
	static jni::ref<java::awt::geom::AffineTransform> new_object(jni::ref<java::awt::geom::AffineTransform> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::geom::AffineTransform> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jfloat p5, jfloat p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::geom::AffineTransform> new_object(jni::ref<jni::array<jfloat>> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::geom::AffineTransform> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::geom::AffineTransform> new_object(jni::ref<jni::array<jdouble>> p1) { return object_base::new_object(p1); }
