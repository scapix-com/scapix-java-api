...
public:
	...
	static jni::ref<java::awt::geom::QuadCurve2D_Double> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
