...
public:
	...
	static jni::ref<java::awt::geom::Path2D_Float> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::geom::Path2D_Float> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::geom::Path2D_Float> new_object(jni::ref<java::awt::Shape> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::geom::Path2D_Float> new_object(jni::ref<java::awt::Shape> p1, jni::ref<java::awt::geom::AffineTransform> p2) { return object_base::new_object(p1, p2); }
