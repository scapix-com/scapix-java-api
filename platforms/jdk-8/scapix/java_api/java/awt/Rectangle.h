...
public:
	...
	static jni::ref<java::awt::Rectangle> new_object(jni::ref<java::awt::Rectangle> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Rectangle> new_object(jint p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::Rectangle> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Rectangle> new_object(jni::ref<java::awt::Point> p1, jni::ref<java::awt::Dimension> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Rectangle> new_object(jni::ref<java::awt::Point> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Rectangle> new_object(jni::ref<java::awt::Dimension> p1) { return object_base::new_object(p1); }
