...
public:
	...
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Frame> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Frame> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2, jboolean p3, jni::ref<java::awt::GraphicsConfiguration> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Dialog> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Dialog> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Dialog> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Dialog> p1, jni::ref<java::lang::String> p2, jboolean p3, jni::ref<java::awt::GraphicsConfiguration> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Window> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Window> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Window> p1, jni::ref<java::awt::Dialog_ModalityType> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Window> p1, jni::ref<java::lang::String> p2, jni::ref<java::awt::Dialog_ModalityType> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::Dialog> new_object(jni::ref<java::awt::Window> p1, jni::ref<java::lang::String> p2, jni::ref<java::awt::Dialog_ModalityType> p3, jni::ref<java::awt::GraphicsConfiguration> p4) { return object_base::new_object(p1, p2, p3, p4); }
