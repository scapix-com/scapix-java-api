...
public:
	...
	static jni::ref<java::awt::Font> new_object(jni::ref<java::lang::String> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::Font> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
