...
namespace scapix::java_api { namespace java::awt { class List_AccessibleAWTList; }}
...
public:
	...
	static jni::ref<java::awt::List_AccessibleAWTList> new_object(jni::ref<java::awt::List> p1) { return object_base::new_object(p1); }
