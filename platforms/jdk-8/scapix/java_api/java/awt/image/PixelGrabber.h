...
public:
	...
	static jni::ref<java::awt::image::PixelGrabber> new_object(jni::ref<java::awt::Image> p1, jint p2, jint p3, jint p4, jint p5, jni::ref<jni::array<jint>> p6, jint p7, jint p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
	static jni::ref<java::awt::image::PixelGrabber> new_object(jni::ref<java::awt::image::ImageProducer> p1, jint p2, jint p3, jint p4, jint p5, jni::ref<jni::array<jint>> p6, jint p7, jint p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
	static jni::ref<java::awt::image::PixelGrabber> new_object(jni::ref<java::awt::Image> p1, jint p2, jint p3, jint p4, jint p5, jboolean p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
