...
public:
	...
	static jni::ref<java::awt::image::ComponentColorModel> new_object(jni::ref<java::awt::color::ColorSpace> p1, jni::ref<jni::array<jint>> p2, jboolean p3, jboolean p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::ComponentColorModel> new_object(jni::ref<java::awt::color::ColorSpace> p1, jboolean p2, jboolean p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
