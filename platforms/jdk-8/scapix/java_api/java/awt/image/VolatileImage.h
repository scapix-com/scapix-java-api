...
namespace scapix::java_api { namespace java::awt::image { class VolatileImage; }}
...
public:
	...
	static jni::ref<java::awt::image::VolatileImage> new_object() { return object_base::new_object(); }
