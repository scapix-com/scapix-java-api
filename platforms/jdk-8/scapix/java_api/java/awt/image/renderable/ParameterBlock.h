...
public:
	...
	static jni::ref<java::awt::image::renderable::ParameterBlock> new_object(jni::ref<java::util::Vector> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::image::renderable::ParameterBlock> new_object(jni::ref<java::util::Vector> p1, jni::ref<java::util::Vector> p2) { return object_base::new_object(p1, p2); }
