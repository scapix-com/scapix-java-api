...
public:
	...
	static jni::ref<java::awt::image::renderable::RenderableImageProducer> new_object(jni::ref<java::awt::image::renderable::RenderableImage> p1, jni::ref<java::awt::image::renderable::RenderContext> p2) { return object_base::new_object(p1, p2); }
