...
public:
	...
	static jni::ref<java::awt::image::renderable::RenderableImageOp> new_object(jni::ref<java::awt::image::renderable::ContextualRenderedImageFactory> p1, jni::ref<java::awt::image::renderable::ParameterBlock> p2) { return object_base::new_object(p1, p2); }
