...
public:
	...
	static jni::ref<java::awt::image::renderable::RenderContext> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jni::ref<java::awt::Shape> p2, jni::ref<java::awt::RenderingHints> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::image::renderable::RenderContext> new_object(jni::ref<java::awt::geom::AffineTransform> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::image::renderable::RenderContext> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jni::ref<java::awt::RenderingHints> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::renderable::RenderContext> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jni::ref<java::awt::Shape> p2) { return object_base::new_object(p1, p2); }
