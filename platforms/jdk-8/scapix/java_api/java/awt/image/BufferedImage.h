...
public:
	...
	static jni::ref<java::awt::image::BufferedImage> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::image::BufferedImage> new_object(jint p1, jint p2, jint p3, jni::ref<java::awt::image::IndexColorModel> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::image::BufferedImage> new_object(jni::ref<java::awt::image::ColorModel> p1, jni::ref<java::awt::image::WritableRaster> p2, jboolean p3, jni::ref<java::util::Hashtable> p4) { return object_base::new_object(p1, p2, p3, p4); }
