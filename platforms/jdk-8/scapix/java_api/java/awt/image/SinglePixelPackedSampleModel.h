...
namespace scapix::java_api { namespace java::awt::image { class SinglePixelPackedSampleModel; }}
...
public:
	...
	static jni::ref<java::awt::image::SinglePixelPackedSampleModel> new_object(jint p1, jint p2, jint p3, jni::ref<jni::array<jint>> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::image::SinglePixelPackedSampleModel> new_object(jint p1, jint p2, jint p3, jint p4, jni::ref<jni::array<jint>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
