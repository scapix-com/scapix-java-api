...
public:
	...
	static jni::ref<java::awt::image::DataBufferDouble> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::image::DataBufferDouble> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::DataBufferDouble> new_object(jni::ref<jni::array<jdouble>> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::DataBufferDouble> new_object(jni::ref<jni::array<jdouble>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::image::DataBufferDouble> new_object(jni::ref<jni::array<jni::array<jdouble>>> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::DataBufferDouble> new_object(jni::ref<jni::array<jni::array<jdouble>>> p1, jint p2, jni::ref<jni::array<jint>> p3) { return object_base::new_object(p1, p2, p3); }
