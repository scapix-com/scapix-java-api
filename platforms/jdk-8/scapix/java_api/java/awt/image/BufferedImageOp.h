...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BUFFEREDIMAGEOP_FWD
#define SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BUFFEREDIMAGEOP_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace java::awt::image { class BufferedImageOp; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::java::awt::image::BufferedImageOp>
{
	static constexpr fixed_string class_name = "java/awt/image/BufferedImageOp";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BUFFEREDIMAGEOP_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BUFFEREDIMAGEOP)
#define SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BUFFEREDIMAGEOP
...
class java::awt::image::BufferedImageOp : public jni::object_base<"java/awt/image/BufferedImageOp",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BUFFEREDIMAGEOP
