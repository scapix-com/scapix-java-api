...
namespace scapix::java_api { namespace java::awt::image { class ConvolveOp; }}
...
public:
	...
	static jni::ref<java::awt::image::ConvolveOp> new_object(jni::ref<java::awt::image::Kernel> p1, jint p2, jni::ref<java::awt::RenderingHints> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::image::ConvolveOp> new_object(jni::ref<java::awt::image::Kernel> p1) { return object_base::new_object(p1); }
