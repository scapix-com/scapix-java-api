...
namespace scapix::java_api { namespace java::awt::image { class ColorConvertOp; }}
...
public:
	...
	static jni::ref<java::awt::image::ColorConvertOp> new_object(jni::ref<java::awt::RenderingHints> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::image::ColorConvertOp> new_object(jni::ref<java::awt::color::ColorSpace> p1, jni::ref<java::awt::RenderingHints> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::ColorConvertOp> new_object(jni::ref<java::awt::color::ColorSpace> p1, jni::ref<java::awt::color::ColorSpace> p2, jni::ref<java::awt::RenderingHints> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::image::ColorConvertOp> new_object(jni::ref<jni::array<java::awt::color::ICC_Profile>> p1, jni::ref<java::awt::RenderingHints> p2) { return object_base::new_object(p1, p2); }
