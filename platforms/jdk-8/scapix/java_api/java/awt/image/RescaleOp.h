...
public:
	...
	static jni::ref<java::awt::image::RescaleOp> new_object(jni::ref<jni::array<jfloat>> p1, jni::ref<jni::array<jfloat>> p2, jni::ref<java::awt::RenderingHints> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::image::RescaleOp> new_object(jfloat p1, jfloat p2, jni::ref<java::awt::RenderingHints> p3) { return object_base::new_object(p1, p2, p3); }
