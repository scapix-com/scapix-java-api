...
public:
	...
	static jni::ref<java::awt::image::ByteLookupTable> new_object(jint p1, jni::ref<jni::array<jni::array<jbyte>>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::ByteLookupTable> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
