...
public:
	...
	static jni::ref<java::awt::image::DirectColorModel> new_object(jint p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::image::DirectColorModel> new_object(jint p1, jint p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::image::DirectColorModel> new_object(jni::ref<java::awt::color::ColorSpace> p1, jint p2, jint p3, jint p4, jint p5, jint p6, jboolean p7, jint p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
