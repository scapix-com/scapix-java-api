...
public:
	...
	static jni::ref<java::awt::image::FilteredImageSource> new_object(jni::ref<java::awt::image::ImageProducer> p1, jni::ref<java::awt::image::ImageFilter> p2) { return object_base::new_object(p1, p2); }
