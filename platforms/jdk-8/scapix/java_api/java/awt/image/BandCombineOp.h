...
namespace scapix::java_api { namespace java::awt::image { class BandCombineOp; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_IMAGE_BANDCOMBINEOP)
...
public:
	...
	static jni::ref<java::awt::image::BandCombineOp> new_object(jni::ref<jni::array<jni::array<jfloat>>> p1, jni::ref<java::awt::RenderingHints> p2) { return object_base::new_object(p1, p2); }
