...
public:
	...
	static jni::ref<java::awt::image::MemoryImageSource> new_object(jint p1, jint p2, jni::ref<java::awt::image::ColorModel> p3, jni::ref<jni::array<jbyte>> p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::MemoryImageSource> new_object(jint p1, jint p2, jni::ref<java::awt::image::ColorModel> p3, jni::ref<jni::array<jbyte>> p4, jint p5, jint p6, jni::ref<java::util::Hashtable> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::awt::image::MemoryImageSource> new_object(jint p1, jint p2, jni::ref<java::awt::image::ColorModel> p3, jni::ref<jni::array<jint>> p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::MemoryImageSource> new_object(jint p1, jint p2, jni::ref<java::awt::image::ColorModel> p3, jni::ref<jni::array<jint>> p4, jint p5, jint p6, jni::ref<java::util::Hashtable> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::awt::image::MemoryImageSource> new_object(jint p1, jint p2, jni::ref<jni::array<jint>> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::image::MemoryImageSource> new_object(jint p1, jint p2, jni::ref<jni::array<jint>> p3, jint p4, jint p5, jni::ref<java::util::Hashtable> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
