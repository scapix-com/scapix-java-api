...
public:
	...
	static jni::ref<java::awt::image::ComponentSampleModel> new_object(jint p1, jint p2, jint p3, jint p4, jint p5, jni::ref<jni::array<jint>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::ComponentSampleModel> new_object(jint p1, jint p2, jint p3, jint p4, jint p5, jni::ref<jni::array<jint>> p6, jni::ref<jni::array<jint>> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
