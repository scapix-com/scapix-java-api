...
namespace scapix::java_api { namespace java::awt::image { class LookupOp; }}
...
public:
	...
	static jni::ref<java::awt::image::LookupOp> new_object(jni::ref<java::awt::image::LookupTable> p1, jni::ref<java::awt::RenderingHints> p2) { return object_base::new_object(p1, p2); }
