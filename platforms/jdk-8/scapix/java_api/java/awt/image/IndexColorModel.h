...
public:
	...
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jbyte>> p3, jni::ref<jni::array<jbyte>> p4, jni::ref<jni::array<jbyte>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jbyte>> p3, jni::ref<jni::array<jbyte>> p4, jni::ref<jni::array<jbyte>> p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jbyte>> p3, jni::ref<jni::array<jbyte>> p4, jni::ref<jni::array<jbyte>> p5, jni::ref<jni::array<jbyte>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jbyte>> p3, jint p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jbyte>> p3, jint p4, jboolean p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jint>> p3, jint p4, jboolean p5, jint p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::awt::image::IndexColorModel> new_object(jint p1, jint p2, jni::ref<jni::array<jint>> p3, jint p4, jint p5, jni::ref<java::math::BigInteger> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
