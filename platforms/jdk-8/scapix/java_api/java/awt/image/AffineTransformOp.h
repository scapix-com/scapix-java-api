...
public:
	...
	static jni::ref<java::awt::image::AffineTransformOp> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jni::ref<java::awt::RenderingHints> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::image::AffineTransformOp> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jint p2) { return object_base::new_object(p1, p2); }
