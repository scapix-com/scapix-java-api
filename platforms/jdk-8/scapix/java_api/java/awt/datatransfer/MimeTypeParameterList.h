...
namespace scapix::java_api { namespace java::awt::datatransfer { class MimeTypeParameterList; }}
...
public:
	...
	static jni::ref<java::awt::datatransfer::MimeTypeParameterList> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::datatransfer::MimeTypeParameterList> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
