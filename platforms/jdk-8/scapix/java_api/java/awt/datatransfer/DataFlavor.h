...
public:
	...
	static jni::ref<java::awt::datatransfer::DataFlavor> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::datatransfer::DataFlavor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::datatransfer::DataFlavor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::ClassLoader> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::datatransfer::DataFlavor> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
