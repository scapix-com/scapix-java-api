...
namespace scapix::java_api { namespace java::awt::datatransfer { class Clipboard; }}
...
public:
	...
	static jni::ref<java::awt::datatransfer::Clipboard> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
