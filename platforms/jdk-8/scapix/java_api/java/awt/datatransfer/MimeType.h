...
namespace scapix::java_api { namespace java::awt::datatransfer { class MimeType; }}
...
public:
	...
	static jni::ref<java::awt::datatransfer::MimeType> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::datatransfer::MimeType> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::datatransfer::MimeType> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::datatransfer::MimeType> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::awt::datatransfer::MimeTypeParameterList> p3) { return object_base::new_object(p1, p2, p3); }
