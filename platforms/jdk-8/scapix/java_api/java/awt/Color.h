...
public:
	...
	static jni::ref<java::awt::Color> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::Color> new_object(jint p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::Color> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Color> new_object(jint p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::Color> new_object(jfloat p1, jfloat p2, jfloat p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::Color> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::Color> new_object(jni::ref<java::awt::color::ColorSpace> p1, jni::ref<jni::array<jfloat>> p2, jfloat p3) { return object_base::new_object(p1, p2, p3); }
