...
public:
	...
	static jni::ref<java::awt::JobAttributes> new_object(jni::ref<java::awt::JobAttributes> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::JobAttributes> new_object(jint p1, jni::ref<java::awt::JobAttributes_DefaultSelectionType> p2, jni::ref<java::awt::JobAttributes_DestinationType> p3, jni::ref<java::awt::JobAttributes_DialogType> p4, jni::ref<java::lang::String> p5, jint p6, jint p7, jni::ref<java::awt::JobAttributes_MultipleDocumentHandlingType> p8, jni::ref<jni::array<jni::array<jint>>> p9, jni::ref<java::lang::String> p10, jni::ref<java::awt::JobAttributes_SidesType> p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
