...
namespace scapix::java_api { namespace java::awt { class Cursor_CursorDisposer; }}
...
public:
	...
	static jni::ref<java::awt::Cursor_CursorDisposer> new_object(jlong p1) { return object_base::new_object(p1); }
