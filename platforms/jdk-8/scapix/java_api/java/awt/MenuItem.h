...
namespace scapix::java_api { namespace java::awt { class MenuItem; }}
...
public:
	...
	static jni::ref<java::awt::MenuItem> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::MenuItem> new_object(jni::ref<java::lang::String> p1, jni::ref<java::awt::MenuShortcut> p2) { return object_base::new_object(p1, p2); }
