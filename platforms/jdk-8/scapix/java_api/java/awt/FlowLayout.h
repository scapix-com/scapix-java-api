...
namespace scapix::java_api { namespace java::awt { class FlowLayout; }}
...
public:
	...
	static jni::ref<java::awt::FlowLayout> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::FlowLayout> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
