...
namespace scapix::java_api { namespace java::awt { class EventQueue_FwSecondaryLoopWrapper; }}
...
public:
	...
	static jni::ref<java::awt::EventQueue_FwSecondaryLoopWrapper> new_object(jni::ref<java::awt::EventQueue> p1, jni::ref<java::awt::SecondaryLoop> p2, jni::ref<java::awt::EventFilter> p3) { return object_base::new_object(p1, p2, p3); }
