...
public:
	...
	static jni::ref<java::awt::LinearGradientPaint> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jni::ref<jni::array<jfloat>> p5, jni::ref<jni::array<java::awt::Color>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::awt::LinearGradientPaint> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jni::ref<jni::array<jfloat>> p5, jni::ref<jni::array<java::awt::Color>> p6, jni::ref<java::awt::MultipleGradientPaint_CycleMethod> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::awt::LinearGradientPaint> new_object(jni::ref<java::awt::geom::Point2D> p1, jni::ref<java::awt::geom::Point2D> p2, jni::ref<jni::array<jfloat>> p3, jni::ref<jni::array<java::awt::Color>> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::LinearGradientPaint> new_object(jni::ref<java::awt::geom::Point2D> p1, jni::ref<java::awt::geom::Point2D> p2, jni::ref<jni::array<jfloat>> p3, jni::ref<jni::array<java::awt::Color>> p4, jni::ref<java::awt::MultipleGradientPaint_CycleMethod> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::LinearGradientPaint> new_object(jni::ref<java::awt::geom::Point2D> p1, jni::ref<java::awt::geom::Point2D> p2, jni::ref<jni::array<jfloat>> p3, jni::ref<jni::array<java::awt::Color>> p4, jni::ref<java::awt::MultipleGradientPaint_CycleMethod> p5, jni::ref<java::awt::MultipleGradientPaint_ColorSpaceType> p6, jni::ref<java::awt::geom::AffineTransform> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
