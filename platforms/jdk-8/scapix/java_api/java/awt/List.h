...
public:
	...
	static jni::ref<java::awt::List> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::List> new_object(jint p1, jboolean p2) { return object_base::new_object(p1, p2); }
