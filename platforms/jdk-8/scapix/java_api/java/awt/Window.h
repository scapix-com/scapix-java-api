...
public:
	...
	static jni::ref<java::awt::Window> new_object(jni::ref<java::awt::Frame> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Window> new_object(jni::ref<java::awt::Window> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Window> new_object(jni::ref<java::awt::Window> p1, jni::ref<java::awt::GraphicsConfiguration> p2) { return object_base::new_object(p1, p2); }
