...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_LIST_ACCESSIBLEAWTLIST_ACCESSIBLEAWTLISTCHILD_FWD
#define SCAPIX_JAVA_API_JAVA_AWT_LIST_ACCESSIBLEAWTLIST_ACCESSIBLEAWTLISTCHILD_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::awt { class List_AccessibleAWTList_AccessibleAWTListChild; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::awt::List_AccessibleAWTList_AccessibleAWTListChild>
{
	static constexpr fixed_string class_name = "java/awt/List$AccessibleAWTList$AccessibleAWTListChild";
	using base_classes = std::tuple<scapix::java_api::java::awt::Component_AccessibleAWTComponent, scapix::java_api::javax::accessibility::Accessible>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_AWT_LIST_ACCESSIBLEAWTLIST_ACCESSIBLEAWTLISTCHILD_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_LIST_ACCESSIBLEAWTLIST_ACCESSIBLEAWTLISTCHILD)
#define SCAPIX_JAVA_API_JAVA_AWT_LIST_ACCESSIBLEAWTLIST_ACCESSIBLEAWTLISTCHILD
...
#include <scapix/java_api/java/awt/List_AccessibleAWTList.h>
...
class java::awt::List_AccessibleAWTList_AccessibleAWTListChild : public jni::object_base<"java/awt/List$AccessibleAWTList$AccessibleAWTListChild",
	java::awt::Component_AccessibleAWTComponent,
	javax::accessibility::Accessible>
{
public:

	static jni::ref<java::awt::List_AccessibleAWTList_AccessibleAWTListChild> new_object(jni::ref<java::awt::List_AccessibleAWTList> p1, jni::ref<java::awt::List> p2, jint p3) { return base_::new_object(p1, p2, p3); }
...
protected:
	...
	List_AccessibleAWTList_AccessibleAWTListChild(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_AWT_LIST_ACCESSIBLEAWTLIST_ACCESSIBLEAWTLISTCHILD
