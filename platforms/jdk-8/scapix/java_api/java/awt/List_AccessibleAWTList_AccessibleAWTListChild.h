...
namespace scapix::java_api { namespace java::awt { class List_AccessibleAWTList_AccessibleAWTListChild; }}
...
public:
	...
	static jni::ref<java::awt::List_AccessibleAWTList_AccessibleAWTListChild> new_object(jni::ref<java::awt::List_AccessibleAWTList> p1, jni::ref<java::awt::List> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
