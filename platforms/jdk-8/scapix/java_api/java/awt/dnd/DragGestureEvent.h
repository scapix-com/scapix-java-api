...
public:
	...
	static jni::ref<java::awt::dnd::DragGestureEvent> new_object(jni::ref<java::awt::dnd::DragGestureRecognizer> p1, jint p2, jni::ref<java::awt::Point> p3, jni::ref<java::util::List> p4) { return object_base::new_object(p1, p2, p3, p4); }
