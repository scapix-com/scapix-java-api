...
public:
	...
	static jni::ref<java::awt::dnd::DropTarget> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::dnd::DropTargetListener> p3, jboolean p4, jni::ref<java::awt::datatransfer::FlavorMap> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::dnd::DropTarget> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::dnd::DropTargetListener> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::dnd::DropTarget> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::dnd::DropTarget> new_object(jni::ref<java::awt::Component> p1, jni::ref<java::awt::dnd::DropTargetListener> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::dnd::DropTarget> new_object(jni::ref<java::awt::Component> p1, jint p2, jni::ref<java::awt::dnd::DropTargetListener> p3) { return object_base::new_object(p1, p2, p3); }
