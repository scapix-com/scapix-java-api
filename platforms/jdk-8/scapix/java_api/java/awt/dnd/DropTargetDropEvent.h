...
namespace scapix::java_api { namespace java::awt::dnd { class DropTargetDropEvent; }}
...
public:
	...
	static jni::ref<java::awt::dnd::DropTargetDropEvent> new_object(jni::ref<java::awt::dnd::DropTargetContext> p1, jni::ref<java::awt::Point> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::awt::dnd::DropTargetDropEvent> new_object(jni::ref<java::awt::dnd::DropTargetContext> p1, jni::ref<java::awt::Point> p2, jint p3, jint p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
