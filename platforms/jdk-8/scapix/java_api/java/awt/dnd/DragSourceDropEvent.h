...
public:
	...
	static jni::ref<java::awt::dnd::DragSourceDropEvent> new_object(jni::ref<java::awt::dnd::DragSourceContext> p1, jint p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::awt::dnd::DragSourceDropEvent> new_object(jni::ref<java::awt::dnd::DragSourceContext> p1, jint p2, jboolean p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::awt::dnd::DragSourceDropEvent> new_object(jni::ref<java::awt::dnd::DragSourceContext> p1) { return object_base::new_object(p1); }
