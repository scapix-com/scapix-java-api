...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_COMPONENT_ACCESSIBLEAWTCOMPONENT_FWD
#define SCAPIX_JAVA_API_JAVA_AWT_COMPONENT_ACCESSIBLEAWTCOMPONENT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::java::awt { class Component_AccessibleAWTComponent; }

template<>
struct scapix::jni::object_traits<scapix::java_api::java::awt::Component_AccessibleAWTComponent>
{
	static constexpr fixed_string class_name = "java/awt/Component$AccessibleAWTComponent";
	using base_classes = std::tuple<scapix::java_api::javax::accessibility::AccessibleContext, scapix::java_api::java::io::Serializable, scapix::java_api::javax::accessibility::AccessibleComponent>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JAVA_AWT_COMPONENT_ACCESSIBLEAWTCOMPONENT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_AWT_COMPONENT_ACCESSIBLEAWTCOMPONENT)
#define SCAPIX_JAVA_API_JAVA_AWT_COMPONENT_ACCESSIBLEAWTCOMPONENT
...
class java::awt::Component_AccessibleAWTComponent : public jni::object_base<"java/awt/Component$AccessibleAWTComponent",
...
protected:
	...
	Component_AccessibleAWTComponent(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JAVA_AWT_COMPONENT_ACCESSIBLEAWTCOMPONENT
