...
public:
	...
	static jni::ref<java::awt::Frame> new_object(jni::ref<java::awt::GraphicsConfiguration> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Frame> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Frame> new_object(jni::ref<java::lang::String> p1, jni::ref<java::awt::GraphicsConfiguration> p2) { return object_base::new_object(p1, p2); }
