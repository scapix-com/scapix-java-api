...
public:
	...
	static jni::ref<java::awt::Point> new_object(jni::ref<java::awt::Point> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::Point> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
