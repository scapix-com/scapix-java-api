...
namespace scapix::java_api { namespace java::awt { class Checkbox_AccessibleAWTCheckbox; }}
...
public:
	...
	static jni::ref<java::awt::Checkbox_AccessibleAWTCheckbox> new_object(jni::ref<java::awt::Checkbox> p1) { return object_base::new_object(p1); }
