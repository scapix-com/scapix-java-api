...
public:
	...
	static jni::ref<java::awt::TrayIcon> new_object(jni::ref<java::awt::Image> p1) { return object_base::new_object(p1); }
	static jni::ref<java::awt::TrayIcon> new_object(jni::ref<java::awt::Image> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::awt::TrayIcon> new_object(jni::ref<java::awt::Image> p1, jni::ref<java::lang::String> p2, jni::ref<java::awt::PopupMenu> p3) { return object_base::new_object(p1, p2, p3); }
