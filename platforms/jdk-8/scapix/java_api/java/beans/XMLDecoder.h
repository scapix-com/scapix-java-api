...
public:
	...
	static jni::ref<java::beans::XMLDecoder> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::beans::XMLDecoder> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::beans::XMLDecoder> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::Object> p2, jni::ref<java::beans::ExceptionListener> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::beans::XMLDecoder> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::Object> p2, jni::ref<java::beans::ExceptionListener> p3, jni::ref<java::lang::ClassLoader> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::beans::XMLDecoder> new_object(jni::ref<org::xml::sax::InputSource> p1) { return object_base::new_object(p1); }
