...
public:
	...
	static jni::ref<java::beans::EventSetDescriptor> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Class> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::beans::EventSetDescriptor> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Class> p3, jni::ref<jni::array<java::lang::String>> p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::beans::EventSetDescriptor> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Class> p3, jni::ref<jni::array<java::lang::String>> p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6, jni::ref<java::lang::String> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<java::beans::EventSetDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2, jni::ref<jni::array<java::lang::reflect::Method>> p3, jni::ref<java::lang::reflect::Method> p4, jni::ref<java::lang::reflect::Method> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<java::beans::EventSetDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2, jni::ref<jni::array<java::lang::reflect::Method>> p3, jni::ref<java::lang::reflect::Method> p4, jni::ref<java::lang::reflect::Method> p5, jni::ref<java::lang::reflect::Method> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<java::beans::EventSetDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2, jni::ref<jni::array<java::beans::MethodDescriptor>> p3, jni::ref<java::lang::reflect::Method> p4, jni::ref<java::lang::reflect::Method> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
