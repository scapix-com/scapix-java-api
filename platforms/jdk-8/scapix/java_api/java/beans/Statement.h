...
public:
	...
	static jni::ref<java::beans::Statement> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<java::lang::Object>> p3) { return object_base::new_object(p1, p2, p3); }
