...
public:
	...
	static jni::ref<java::beans::PropertyDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::beans::PropertyDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::beans::PropertyDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::reflect::Method> p2, jni::ref<java::lang::reflect::Method> p3) { return object_base::new_object(p1, p2, p3); }
