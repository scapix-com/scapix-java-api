...
public:
	...
	static jni::ref<java::beans::beancontext::BeanContextChildSupport> new_object(jni::ref<java::beans::beancontext::BeanContextChild> p1) { return object_base::new_object(p1); }
