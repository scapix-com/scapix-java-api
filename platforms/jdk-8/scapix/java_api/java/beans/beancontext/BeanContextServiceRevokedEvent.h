...
public:
	...
	static jni::ref<java::beans::beancontext::BeanContextServiceRevokedEvent> new_object(jni::ref<java::beans::beancontext::BeanContextServices> p1, jni::ref<java::lang::Class> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
