...
public:
	...
	static jni::ref<java::beans::beancontext::BeanContextMembershipEvent> new_object(jni::ref<java::beans::beancontext::BeanContext> p1, jni::ref<java::util::Collection> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::beans::beancontext::BeanContextMembershipEvent> new_object(jni::ref<java::beans::beancontext::BeanContext> p1, jni::ref<jni::array<java::lang::Object>> p2) { return object_base::new_object(p1, p2); }
