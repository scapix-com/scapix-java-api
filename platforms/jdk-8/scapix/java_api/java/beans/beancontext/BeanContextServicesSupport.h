...
namespace scapix::java_api { namespace java::beans::beancontext { class BeanContextServicesSupport; }}
...
public:
	...
	static jni::ref<java::beans::beancontext::BeanContextServicesSupport> new_object(jni::ref<java::beans::beancontext::BeanContextServices> p1, jni::ref<java::util::Locale> p2, jboolean p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::beans::beancontext::BeanContextServicesSupport> new_object(jni::ref<java::beans::beancontext::BeanContextServices> p1, jni::ref<java::util::Locale> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::beans::beancontext::BeanContextServicesSupport> new_object(jni::ref<java::beans::beancontext::BeanContextServices> p1, jni::ref<java::util::Locale> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::beans::beancontext::BeanContextServicesSupport> new_object(jni::ref<java::beans::beancontext::BeanContextServices> p1) { return object_base::new_object(p1); }
