...
public:
	...
	static jni::ref<java::beans::VetoableChangeListenerProxy> new_object(jni::ref<java::lang::String> p1, jni::ref<java::beans::VetoableChangeListener> p2) { return object_base::new_object(p1, p2); }
