...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_PROPERTYCHANGEEVENT
...
public:
	...
	static jni::ref<java::beans::PropertyChangeEvent> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Object> p3, jni::ref<java::lang::Object> p4) { return object_base::new_object(p1, p2, p3, p4); }
