...
public:
	...
	static jni::ref<java::beans::XMLEncoder> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<java::beans::XMLEncoder> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::lang::String> p2, jboolean p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
