...
public:
	...
	static jni::ref<java::beans::BeanDescriptor> new_object(jni::ref<java::lang::Class> p1) { return object_base::new_object(p1); }
	static jni::ref<java::beans::BeanDescriptor> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::Class> p2) { return object_base::new_object(p1, p2); }
