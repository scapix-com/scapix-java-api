...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_PROPERTYCHANGESUPPORT
...
public:
	...
	static jni::ref<java::beans::PropertyChangeSupport> new_object(jni::ref<java::lang::Object> p1) { return object_base::new_object(p1); }
