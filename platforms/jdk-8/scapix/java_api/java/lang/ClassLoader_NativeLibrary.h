...
namespace scapix::java_api { namespace java::lang { class ClassLoader_NativeLibrary; }}
...
public:
	...
	static jni::ref<java::lang::ClassLoader_NativeLibrary> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
