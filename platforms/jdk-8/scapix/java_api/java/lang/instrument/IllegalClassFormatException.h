...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_ILLEGALCLASSFORMATEXCEPTION
...
public:
	...
	static jni::ref<java::lang::instrument::IllegalClassFormatException> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::instrument::IllegalClassFormatException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
