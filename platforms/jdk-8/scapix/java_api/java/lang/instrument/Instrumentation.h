...
namespace scapix::java_api { namespace java::lang::instrument { class Instrumentation; }}
...
#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JAVA_LANG_INSTRUMENT_INSTRUMENTATION)
