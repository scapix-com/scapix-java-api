...
public:
	...
	jint compareTo(jni::ref<java::lang::Enum> p1) { return call_method<"compareTo", jint>(p1); }
	jni::ref<java::lang::Class> getDeclaringClass() { return call_method<"getDeclaringClass", jni::ref<java::lang::Class>>(); }
	static jni::ref<java::lang::Enum> valueOf(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2) { return call_static_method<"valueOf", jni::ref<java::lang::Enum>>(p1, p2); }
};
