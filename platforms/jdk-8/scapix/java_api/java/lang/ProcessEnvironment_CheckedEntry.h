...
namespace scapix::java_api { namespace java::lang { class ProcessEnvironment_CheckedEntry; }}
...
public:
	...
	static jni::ref<java::lang::ProcessEnvironment_CheckedEntry> new_object(jni::ref<java::util::Map_Entry> p1) { return object_base::new_object(p1); }
