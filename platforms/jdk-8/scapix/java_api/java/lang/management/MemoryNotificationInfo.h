...
public:
	...
	static jni::ref<java::lang::management::MemoryNotificationInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::management::MemoryUsage> p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
