...
public:
	...
	static jni::ref<java::lang::Character_UnicodeScript> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::lang::Character_UnicodeScript>>(p1); }
	static jni::ref<java::lang::Character_UnicodeScript> of(jint p1) { return call_static_method<"of", jni::ref<java::lang::Character_UnicodeScript>>(p1); }
	static jni::ref<java::lang::Character_UnicodeScript> forName(jni::ref<java::lang::String> p1) { return call_static_method<"forName", jni::ref<java::lang::Character_UnicodeScript>>(p1); }
};
