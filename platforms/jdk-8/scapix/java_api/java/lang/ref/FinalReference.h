...
public:
	...
	static jni::ref<java::lang::ref::FinalReference> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::lang::ref::ReferenceQueue> p2) { return object_base::new_object(p1, p2); }
