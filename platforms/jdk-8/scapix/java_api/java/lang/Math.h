...
public:
	...
	static jint incrementExact(jint p1) { return call_static_method<"incrementExact", jint>(p1); }
	static jlong incrementExact(jlong p1) { return call_static_method<"incrementExact", jlong>(p1); }
	static jint decrementExact(jint p1) { return call_static_method<"decrementExact", jint>(p1); }
	static jlong decrementExact(jlong p1) { return call_static_method<"decrementExact", jlong>(p1); }
	static jint negateExact(jint p1) { return call_static_method<"negateExact", jint>(p1); }
	static jlong negateExact(jlong p1) { return call_static_method<"negateExact", jlong>(p1); }
