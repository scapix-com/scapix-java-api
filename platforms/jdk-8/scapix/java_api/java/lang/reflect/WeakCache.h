...
namespace scapix::java_api { namespace java::lang::reflect { class WeakCache; }}
...
public:
	...
	static jni::ref<java::lang::reflect::WeakCache> new_object(jni::ref<java::util::function::BiFunction> p1, jni::ref<java::util::function::BiFunction> p2) { return object_base::new_object(p1, p2); }
