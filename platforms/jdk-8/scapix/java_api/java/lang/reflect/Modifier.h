...
public:
	...
	static jboolean isPublic(jint p1) { return call_static_method<"isPublic", jboolean>(p1); }
	static jboolean isPrivate(jint p1) { return call_static_method<"isPrivate", jboolean>(p1); }
	static jboolean isProtected(jint p1) { return call_static_method<"isProtected", jboolean>(p1); }
	static jboolean isStatic(jint p1) { return call_static_method<"isStatic", jboolean>(p1); }
	static jboolean isFinal(jint p1) { return call_static_method<"isFinal", jboolean>(p1); }
	static jboolean isSynchronized(jint p1) { return call_static_method<"isSynchronized", jboolean>(p1); }
	static jboolean isVolatile(jint p1) { return call_static_method<"isVolatile", jboolean>(p1); }
	static jboolean isTransient(jint p1) { return call_static_method<"isTransient", jboolean>(p1); }
	static jboolean isNative(jint p1) { return call_static_method<"isNative", jboolean>(p1); }
	static jboolean isInterface(jint p1) { return call_static_method<"isInterface", jboolean>(p1); }
	static jboolean isAbstract(jint p1) { return call_static_method<"isAbstract", jboolean>(p1); }
	static jboolean isStrict(jint p1) { return call_static_method<"isStrict", jboolean>(p1); }
