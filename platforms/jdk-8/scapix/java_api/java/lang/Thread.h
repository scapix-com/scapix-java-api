...
public:
	...
	static void sleep(jlong p1) { return call_static_method<"sleep", void>(p1); }
	static void sleep(jlong p1, jint p2) { return call_static_method<"sleep", void>(p1, p2); }
	static jni::ref<java::lang::Thread> new_object() { return object_base::new_object(); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::Runnable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::Runnable> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::Runnable> p2, jni::ref<java::lang::String> p3, jlong p4) { return object_base::new_object(p1, p2, p3, p4); }
	void start() { return call_method<"start", void>(); }
	void run() { return call_method<"run", void>(); }
	void stop() { return call_method<"stop", void>(); }
	void stop(jni::ref<java::lang::Throwable> p1) { return call_method<"stop", void>(p1); }
	...
	void setPriority(jint p1) { return call_method<"setPriority", void>(p1); }
	...
	static jint enumerate(jni::ref<jni::array<java::lang::Thread>> p1) { return call_static_method<"enumerate", jint>(p1); }
	jint countStackFrames() { return call_method<"countStackFrames", jint>(); }
	void join(jlong p1) { return call_method<"join", void>(p1); }
	void join(jlong p1, jint p2) { return call_method<"join", void>(p1, p2); }
	...
	static void setDefaultUncaughtExceptionHandler(jni::ref<java::lang::Thread_UncaughtExceptionHandler> p1) { return call_static_method<"setDefaultUncaughtExceptionHandler", void>(p1); }
