...
public:
	...
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> p1) { return base_::new_object(p1); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::Runnable> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::String> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> p1, jni::ref<java::lang::String> p2) { return base_::new_object(p1, p2); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::Runnable> p2, jni::ref<java::lang::String> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::Runnable> p2, jni::ref<java::lang::String> p3, jlong p4) { return base_::new_object(p1, p2, p3, p4); }
