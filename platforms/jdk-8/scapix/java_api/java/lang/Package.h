...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_PACKAGE
...
public:
	...
	jboolean isSealed(jni::ref<java::net::URL> p1) { return call_method<"isSealed", jboolean>(p1); }
	jboolean isCompatibleWith(jni::ref<java::lang::String> p1) { return call_method<"isCompatibleWith", jboolean>(p1); }
	static jni::ref<java::lang::Package> getPackage(jni::ref<java::lang::String> p1) { return call_static_method<"getPackage", jni::ref<java::lang::Package>>(p1); }
