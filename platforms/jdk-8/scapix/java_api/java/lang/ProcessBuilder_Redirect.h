...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_PROCESSBUILDER_REDIRECT
...
public:
	...
	static jni::ref<java::lang::ProcessBuilder_Redirect> from(jni::ref<java::io::File> p1) { return call_static_method<"from", jni::ref<java::lang::ProcessBuilder_Redirect>>(p1); }
	static jni::ref<java::lang::ProcessBuilder_Redirect> to(jni::ref<java::io::File> p1) { return call_static_method<"to", jni::ref<java::lang::ProcessBuilder_Redirect>>(p1); }
	static jni::ref<java::lang::ProcessBuilder_Redirect> appendTo(jni::ref<java::io::File> p1) { return call_static_method<"appendTo", jni::ref<java::lang::ProcessBuilder_Redirect>>(p1); }
