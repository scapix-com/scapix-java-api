...
public:
	...
	static jni::ref<java::lang::annotation::ElementType> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::lang::annotation::ElementType>>(p1); }
};
