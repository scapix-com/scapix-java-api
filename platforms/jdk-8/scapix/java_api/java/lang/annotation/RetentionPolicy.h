...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_ANNOTATION_RETENTIONPOLICY
...
public:
	...
	static jni::ref<java::lang::annotation::RetentionPolicy> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::lang::annotation::RetentionPolicy>>(p1); }
};
