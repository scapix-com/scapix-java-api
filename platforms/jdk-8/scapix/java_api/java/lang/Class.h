...
struct scapix::jni::object_traits<scapix::java_api::java::lang::Class>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::io::Serializable, scapix::java_api::java::lang::reflect::GenericDeclaration, scapix::java_api::java::lang::reflect::Type, scapix::java_api::java::lang::reflect::AnnotatedElement>;
};
...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CLASS
...
public:
	...
	static jni::ref<java::lang::Class> forName(jni::ref<java::lang::String> p1) { return call_static_method<"forName", jni::ref<java::lang::Class>>(p1); }
	static jni::ref<java::lang::Class> forName(jni::ref<java::lang::String> p1, jboolean p2, jni::ref<java::lang::ClassLoader> p3) { return call_static_method<"forName", jni::ref<java::lang::Class>>(p1, p2, p3); }
	...
	jboolean isAssignableFrom(jni::ref<java::lang::Class> p1) { return call_method<"isAssignableFrom", jboolean>(p1); }
	...
	jni::ref<java::lang::reflect::Field> getField(jni::ref<java::lang::String> p1) { return call_method<"getField", jni::ref<java::lang::reflect::Field>>(p1); }
	jni::ref<java::lang::reflect::Method> getMethod(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::Class>> p2) { return call_method<"getMethod", jni::ref<java::lang::reflect::Method>>(p1, p2); }
	jni::ref<java::lang::reflect::Constructor> getConstructor(jni::ref<jni::array<java::lang::Class>> p1) { return call_method<"getConstructor", jni::ref<java::lang::reflect::Constructor>>(p1); }
	...
	jni::ref<java::lang::reflect::Method> getDeclaredMethod(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::Class>> p2) { return call_method<"getDeclaredMethod", jni::ref<java::lang::reflect::Method>>(p1, p2); }
	jni::ref<java::lang::reflect::Constructor> getDeclaredConstructor(jni::ref<jni::array<java::lang::Class>> p1) { return call_method<"getDeclaredConstructor", jni::ref<java::lang::reflect::Constructor>>(p1); }
	...
	jni::ref<java::lang::Object> cast(jni::ref<java::lang::Object> p1) { return call_method<"cast", jni::ref<java::lang::Object>>(p1); }
	jni::ref<java::lang::Class> asSubclass(jni::ref<java::lang::Class> p1) { return call_method<"asSubclass", jni::ref<java::lang::Class>>(p1); }
	...
	jni::ref<java::lang::reflect::AnnotatedType> getAnnotatedSuperclass() { return call_method<"getAnnotatedSuperclass", jni::ref<java::lang::reflect::AnnotatedType>>(); }
	jni::ref<jni::array<java::lang::reflect::AnnotatedType>> getAnnotatedInterfaces() { return call_method<"getAnnotatedInterfaces", jni::ref<jni::array<java::lang::reflect::AnnotatedType>>>(); }
};
