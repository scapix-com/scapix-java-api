...
public:
	...
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::Throwable> p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::ExceptionInInitializerError> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
