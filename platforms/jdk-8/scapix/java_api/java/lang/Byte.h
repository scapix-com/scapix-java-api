...
public:
	...
	static jni::ref<java::lang::Byte> new_object(jbyte p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::Byte> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
