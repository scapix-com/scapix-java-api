...
public:
	...
	static jni::ref<java::lang::ProcessBuilder> new_object(jni::ref<java::util::List> p1) { return base_::new_object(p1); }
	static jni::ref<java::lang::ProcessBuilder> new_object(jni::ref<jni::array<java::lang::String>> p1) { return base_::new_object(p1); }
