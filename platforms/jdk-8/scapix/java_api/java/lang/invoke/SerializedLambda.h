...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_INVOKE_SERIALIZEDLAMBDA
...
public:
	...
	static jni::ref<java::lang::invoke::SerializedLambda> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jint p5, jni::ref<java::lang::String> p6, jni::ref<java::lang::String> p7, jni::ref<java::lang::String> p8, jni::ref<java::lang::String> p9, jni::ref<jni::array<java::lang::Object>> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
