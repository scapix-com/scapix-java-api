...
public:
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Method> p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Method> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Constructor> p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Field> p1) { return object_base::new_object(p1); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::reflect::Field> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> p1) { return object_base::new_object(p1); }
	...
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Class> p3, jbyte p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::invoke::MethodType> p3, jbyte p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<java::lang::invoke::MemberName> new_object(jbyte p1, jni::ref<java::lang::Class> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::Object> p4) { return object_base::new_object(p1, p2, p3, p4); }
