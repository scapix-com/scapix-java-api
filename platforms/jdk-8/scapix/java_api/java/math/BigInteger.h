...
public:
	...
	static jni::ref<java::math::BigInteger> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<java::math::BigInteger> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::math::BigInteger> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<java::math::BigInteger> new_object(jint p1, jni::ref<java::util::Random> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::math::BigInteger> new_object(jint p1, jint p2, jni::ref<java::util::Random> p3) { return object_base::new_object(p1, p2, p3); }
