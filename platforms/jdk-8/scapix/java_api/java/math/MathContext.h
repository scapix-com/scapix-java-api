...
public:
	...
	static jni::ref<java::math::MathContext> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<java::math::MathContext> new_object(jint p1, jni::ref<java::math::RoundingMode> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<java::math::MathContext> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
