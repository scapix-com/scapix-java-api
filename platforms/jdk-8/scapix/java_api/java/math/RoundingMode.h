...
#ifndef SCAPIX_JAVA_API_JAVA_MATH_ROUNDINGMODE
...
public:
	...
	static jni::ref<java::math::RoundingMode> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<java::math::RoundingMode>>(p1); }
	static jni::ref<java::math::RoundingMode> valueOf(jint p1) { return call_static_method<"valueOf", jni::ref<java::math::RoundingMode>>(p1); }
};
