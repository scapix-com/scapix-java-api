...
public:
	...
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> p1, jni::ref<org::xml::sax::Locator> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> p1, jni::ref<org::xml::sax::Locator> p2, jni::ref<java::lang::Exception> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<org::xml::sax::SAXParseException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4, jint p5, jni::ref<java::lang::Exception> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
