...
public:
	...
	static jni::ref<org::ietf::jgss::MessageProp> new_object(jboolean p1) { return object_base::new_object(p1); }
	static jni::ref<org::ietf::jgss::MessageProp> new_object(jint p1, jboolean p2) { return object_base::new_object(p1, p2); }
