...
public:
	...
	static jni::ref<org::ietf::jgss::GSSException> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<org::ietf::jgss::GSSException> new_object(jint p1, jint p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
