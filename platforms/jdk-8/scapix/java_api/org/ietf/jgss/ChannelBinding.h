...
public:
	...
	static jni::ref<org::ietf::jgss::ChannelBinding> new_object(jni::ref<java::net::InetAddress> p1, jni::ref<java::net::InetAddress> p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<org::ietf::jgss::ChannelBinding> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
