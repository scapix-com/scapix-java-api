...
#ifndef SCAPIX_JAVA_API_ORG_OMG_IOP_ENCODING
...
public:
	...
	static jni::ref<org::omg::IOP::Encoding> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::IOP::Encoding> new_object(jshort p1, jbyte p2, jbyte p3) { return object_base::new_object(p1, p2, p3); }
};
