...
#ifndef SCAPIX_JAVA_API_ORG_OMG_IOP_CODECPACKAGE_INVALIDTYPEFORENCODING
...
public:
	...
	static jni::ref<org::omg::IOP::CodecPackage::InvalidTypeForEncoding> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::IOP::CodecPackage::InvalidTypeForEncoding> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
