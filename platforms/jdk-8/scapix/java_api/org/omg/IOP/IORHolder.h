...
#ifndef SCAPIX_JAVA_API_ORG_OMG_IOP_IORHOLDER
...
public:
	...
	static jni::ref<org::omg::IOP::IORHolder> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::IOP::IORHolder> new_object(jni::ref<org::omg::IOP::IOR> p1) { return object_base::new_object(p1); }
