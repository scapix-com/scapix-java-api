...
#ifndef SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBIDHELPER_FWD
#define SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBIDHELPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::omg::PortableInterceptor { class ORBIdHelper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::omg::PortableInterceptor::ORBIdHelper>
{
	static constexpr fixed_string class_name = "org/omg/PortableInterceptor/ORBIdHelper";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBIDHELPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBIDHELPER)
#define SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBIDHELPER
...
class org::omg::PortableInterceptor::ORBIdHelper : public jni::object_base<"org/omg/PortableInterceptor/ORBIdHelper",
	java::lang::Object>
{
public:

	static jni::ref<org::omg::PortableInterceptor::ORBIdHelper> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBIDHELPER
