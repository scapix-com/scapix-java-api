...
namespace scapix::java_api::org::omg::PortableInterceptor { class ORBIdHelper; }
...
public:
	...
	static jni::ref<org::omg::PortableInterceptor::ORBIdHelper> new_object() { return base_::new_object(); }
