...
#ifndef SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_ORBINITINFOPACKAGE_INVALIDNAME
...
public:
	...
	static jni::ref<org::omg::PortableInterceptor::ORBInitInfoPackage::InvalidName> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::PortableInterceptor::ORBInitInfoPackage::InvalidName> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
