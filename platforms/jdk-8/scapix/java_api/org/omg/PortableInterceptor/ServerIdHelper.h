...
namespace scapix::java_api::org::omg::PortableInterceptor { class ServerIdHelper; }
...
public:
	...
	static jni::ref<org::omg::PortableInterceptor::ServerIdHelper> new_object() { return base_::new_object(); }
