...
#ifndef SCAPIX_JAVA_API_ORG_OMG_PORTABLEINTERCEPTOR_INVALIDSLOTHELPER
...
public:
	...
	static jni::ref<org::omg::PortableInterceptor::InvalidSlotHelper> new_object() { return object_base::new_object(); }
