...
#ifndef SCAPIX_JAVA_API_ORG_OMG_COSNAMING_BINDINGLISTHOLDER
...
public:
	...
	static jni::ref<org::omg::CosNaming::BindingListHolder> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CosNaming::BindingListHolder> new_object(jni::ref<jni::array<org::omg::CosNaming::Binding>> p1) { return object_base::new_object(p1); }
