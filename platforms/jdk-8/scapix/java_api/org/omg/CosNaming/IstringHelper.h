...
namespace scapix::java_api::org::omg::CosNaming { class IstringHelper; }
...
public:
	...
	static jni::ref<org::omg::CosNaming::IstringHelper> new_object() { return base_::new_object(); }
...
protected:
	...
	IstringHelper(handle_type h) : base_(h) {}
