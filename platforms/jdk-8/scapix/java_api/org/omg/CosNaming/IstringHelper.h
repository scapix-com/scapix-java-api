...
#ifndef SCAPIX_JAVA_API_ORG_OMG_COSNAMING_ISTRINGHELPER_FWD
#define SCAPIX_JAVA_API_ORG_OMG_COSNAMING_ISTRINGHELPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::omg::CosNaming { class IstringHelper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::omg::CosNaming::IstringHelper>
{
	static constexpr fixed_string class_name = "org/omg/CosNaming/IstringHelper";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_OMG_COSNAMING_ISTRINGHELPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_OMG_COSNAMING_ISTRINGHELPER)
#define SCAPIX_JAVA_API_ORG_OMG_COSNAMING_ISTRINGHELPER
...
class org::omg::CosNaming::IstringHelper : public jni::object_base<"org/omg/CosNaming/IstringHelper",
	java::lang::Object>
{
public:

	static jni::ref<org::omg::CosNaming::IstringHelper> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ORG_OMG_COSNAMING_ISTRINGHELPER
