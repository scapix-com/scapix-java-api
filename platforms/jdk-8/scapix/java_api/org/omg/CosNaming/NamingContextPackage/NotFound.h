...
#ifndef SCAPIX_JAVA_API_ORG_OMG_COSNAMING_NAMINGCONTEXTPACKAGE_NOTFOUND
...
public:
	...
	static jni::ref<org::omg::CosNaming::NamingContextPackage::NotFound> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CosNaming::NamingContextPackage::NotFound> new_object(jni::ref<org::omg::CosNaming::NamingContextPackage::NotFoundReason> p1, jni::ref<jni::array<org::omg::CosNaming::NameComponent>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<org::omg::CosNaming::NamingContextPackage::NotFound> new_object(jni::ref<java::lang::String> p1, jni::ref<org::omg::CosNaming::NamingContextPackage::NotFoundReason> p2, jni::ref<jni::array<org::omg::CosNaming::NameComponent>> p3) { return object_base::new_object(p1, p2, p3); }
};
