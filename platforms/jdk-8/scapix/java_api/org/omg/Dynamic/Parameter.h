...
#ifndef SCAPIX_JAVA_API_ORG_OMG_DYNAMIC_PARAMETER
...
public:
	...
	static jni::ref<org::omg::Dynamic::Parameter> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::Dynamic::Parameter> new_object(jni::ref<org::omg::CORBA::Any> p1, jni::ref<org::omg::CORBA::ParameterMode> p2) { return object_base::new_object(p1, p2); }
};
