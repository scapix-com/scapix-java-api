...
namespace scapix::java_api::org::omg::DynamicAny { class _DynSequenceStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynSequenceStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynSequenceStub(handle_type h) : base_(h) {}
