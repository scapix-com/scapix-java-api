...
namespace scapix::java_api::org::omg::DynamicAny { class _DynEnumStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynEnumStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynEnumStub(handle_type h) : base_(h) {}
