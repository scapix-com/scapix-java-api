...
namespace scapix::java_api::org::omg::DynamicAny { class _DynStructStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynStructStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynStructStub(handle_type h) : base_(h) {}
