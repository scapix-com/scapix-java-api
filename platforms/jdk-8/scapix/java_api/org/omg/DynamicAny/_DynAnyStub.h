...
namespace scapix::java_api::org::omg::DynamicAny { class _DynAnyStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynAnyStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynAnyStub(handle_type h) : base_(h) {}
