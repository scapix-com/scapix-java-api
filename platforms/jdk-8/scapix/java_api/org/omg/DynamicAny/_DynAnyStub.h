...
#ifndef SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNANYSTUB_FWD
#define SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNANYSTUB_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::omg::DynamicAny { class _DynAnyStub; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::omg::DynamicAny::_DynAnyStub>
{
	static constexpr fixed_string class_name = "org/omg/DynamicAny/_DynAnyStub";
	using base_classes = std::tuple<scapix::java_api::org::omg::CORBA::portable::ObjectImpl, scapix::java_api::org::omg::DynamicAny::DynAny>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNANYSTUB_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNANYSTUB)
#define SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNANYSTUB
...
class org::omg::DynamicAny::_DynAnyStub : public jni::object_base<"org/omg/DynamicAny/_DynAnyStub",
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynAnyStub> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNANYSTUB
