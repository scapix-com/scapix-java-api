...
namespace scapix::java_api::org::omg::DynamicAny { class _DynArrayStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynArrayStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynArrayStub(handle_type h) : base_(h) {}
