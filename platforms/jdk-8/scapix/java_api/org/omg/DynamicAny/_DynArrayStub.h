...
#ifndef SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNARRAYSTUB_FWD
#define SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNARRAYSTUB_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::omg::DynamicAny { class _DynArrayStub; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::omg::DynamicAny::_DynArrayStub>
{
	static constexpr fixed_string class_name = "org/omg/DynamicAny/_DynArrayStub";
	using base_classes = std::tuple<scapix::java_api::org::omg::CORBA::portable::ObjectImpl, scapix::java_api::org::omg::DynamicAny::DynArray>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNARRAYSTUB_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNARRAYSTUB)
#define SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNARRAYSTUB
...
class org::omg::DynamicAny::_DynArrayStub : public jni::object_base<"org/omg/DynamicAny/_DynArrayStub",
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynArrayStub> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY__DYNARRAYSTUB
