...
namespace scapix::java_api::org::omg::DynamicAny { class _DynUnionStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynUnionStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynUnionStub(handle_type h) : base_(h) {}
