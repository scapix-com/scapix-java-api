...
namespace scapix::java_api::org::omg::DynamicAny { class _DynValueStub; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::_DynValueStub> new_object() { return base_::new_object(); }
...
protected:
	...
	_DynValueStub(handle_type h) : base_(h) {}
