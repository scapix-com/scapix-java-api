...
namespace scapix::java_api::org::omg::DynamicAny { class FieldNameHelper; }
...
public:
	...
	static jni::ref<org::omg::DynamicAny::FieldNameHelper> new_object() { return base_::new_object(); }
...
protected:
	...
	FieldNameHelper(handle_type h) : base_(h) {}
