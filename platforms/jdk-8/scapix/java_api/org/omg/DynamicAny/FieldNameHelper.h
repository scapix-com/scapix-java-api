...
#ifndef SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY_FIELDNAMEHELPER_FWD
#define SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY_FIELDNAMEHELPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::omg::DynamicAny { class FieldNameHelper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::omg::DynamicAny::FieldNameHelper>
{
	static constexpr fixed_string class_name = "org/omg/DynamicAny/FieldNameHelper";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY_FIELDNAMEHELPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY_FIELDNAMEHELPER)
#define SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY_FIELDNAMEHELPER
...
class org::omg::DynamicAny::FieldNameHelper : public jni::object_base<"org/omg/DynamicAny/FieldNameHelper",
	java::lang::Object>
{
public:

	static jni::ref<org::omg::DynamicAny::FieldNameHelper> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ORG_OMG_DYNAMICANY_FIELDNAMEHELPER
