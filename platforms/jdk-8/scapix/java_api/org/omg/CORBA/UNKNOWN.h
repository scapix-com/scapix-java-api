...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_UNKNOWN
...
public:
	...
	static jni::ref<org::omg::CORBA::UNKNOWN> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CORBA::UNKNOWN> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<org::omg::CORBA::UNKNOWN> new_object(jint p1, jni::ref<org::omg::CORBA::CompletionStatus> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<org::omg::CORBA::UNKNOWN> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<org::omg::CORBA::CompletionStatus> p3) { return object_base::new_object(p1, p2, p3); }
};
