...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_PORTABLE_APPLICATIONEXCEPTION
...
public:
	...
	static jni::ref<org::omg::CORBA::portable::ApplicationException> new_object(jni::ref<java::lang::String> p1, jni::ref<org::omg::CORBA::portable::InputStream> p2) { return object_base::new_object(p1, p2); }
