...
namespace scapix::java_api { namespace org::omg::CORBA::portable { class OutputStream; }}
...
public:
	...
	static jni::ref<org::omg::CORBA::portable::OutputStream> new_object() { return object_base::new_object(); }
