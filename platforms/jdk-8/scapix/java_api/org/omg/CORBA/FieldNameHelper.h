...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_FIELDNAMEHELPER_FWD
#define SCAPIX_JAVA_API_ORG_OMG_CORBA_FIELDNAMEHELPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace org::omg::CORBA { class FieldNameHelper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::org::omg::CORBA::FieldNameHelper>
{
	static constexpr fixed_string class_name = "org/omg/CORBA/FieldNameHelper";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_ORG_OMG_CORBA_FIELDNAMEHELPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_ORG_OMG_CORBA_FIELDNAMEHELPER)
#define SCAPIX_JAVA_API_ORG_OMG_CORBA_FIELDNAMEHELPER
...
class org::omg::CORBA::FieldNameHelper : public jni::object_base<"org/omg/CORBA/FieldNameHelper",
	java::lang::Object>
{
public:

	static jni::ref<org::omg::CORBA::FieldNameHelper> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_ORG_OMG_CORBA_FIELDNAMEHELPER
