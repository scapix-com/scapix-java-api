...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_SERVICEINFORMATION
...
public:
	...
	static jni::ref<org::omg::CORBA::ServiceInformation> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CORBA::ServiceInformation> new_object(jni::ref<jni::array<jint>> p1, jni::ref<jni::array<org::omg::CORBA::ServiceDetail>> p2) { return object_base::new_object(p1, p2); }
};
