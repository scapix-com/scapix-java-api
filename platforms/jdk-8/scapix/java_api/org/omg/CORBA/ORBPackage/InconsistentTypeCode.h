...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_ORBPACKAGE_INCONSISTENTTYPECODE
...
public:
	...
	static jni::ref<org::omg::CORBA::ORBPackage::InconsistentTypeCode> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CORBA::ORBPackage::InconsistentTypeCode> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
