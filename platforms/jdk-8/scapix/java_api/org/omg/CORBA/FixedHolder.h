...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_FIXEDHOLDER
...
public:
	...
	static jni::ref<org::omg::CORBA::FixedHolder> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CORBA::FixedHolder> new_object(jni::ref<java::math::BigDecimal> p1) { return object_base::new_object(p1); }
