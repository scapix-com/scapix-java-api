...
namespace scapix::java_api { namespace org::omg::CORBA { class VersionSpecHelper; }}
...
public:
	...
	static jni::ref<org::omg::CORBA::VersionSpecHelper> new_object() { return object_base::new_object(); }
