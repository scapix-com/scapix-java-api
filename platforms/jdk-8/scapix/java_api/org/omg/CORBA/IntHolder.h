...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_INTHOLDER
...
public:
	...
	static jni::ref<org::omg::CORBA::IntHolder> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CORBA::IntHolder> new_object(jint p1) { return object_base::new_object(p1); }
