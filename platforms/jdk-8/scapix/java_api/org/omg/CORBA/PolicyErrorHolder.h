...
#ifndef SCAPIX_JAVA_API_ORG_OMG_CORBA_POLICYERRORHOLDER
...
public:
	...
	static jni::ref<org::omg::CORBA::PolicyErrorHolder> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::CORBA::PolicyErrorHolder> new_object(jni::ref<org::omg::CORBA::PolicyError> p1) { return object_base::new_object(p1); }
