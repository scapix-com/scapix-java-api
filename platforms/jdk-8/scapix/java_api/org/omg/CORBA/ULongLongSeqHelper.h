...
namespace scapix::java_api::org::omg::CORBA { class ULongLongSeqHelper; }
...
public:
	...
	static jni::ref<org::omg::CORBA::ULongLongSeqHelper> new_object() { return base_::new_object(); }
...
protected:
	...
	ULongLongSeqHelper(handle_type h) : base_(h) {}
