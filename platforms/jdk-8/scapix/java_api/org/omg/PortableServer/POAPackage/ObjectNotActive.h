...
#ifndef SCAPIX_JAVA_API_ORG_OMG_PORTABLESERVER_POAPACKAGE_OBJECTNOTACTIVE
...
public:
	...
	static jni::ref<org::omg::PortableServer::POAPackage::ObjectNotActive> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::PortableServer::POAPackage::ObjectNotActive> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
