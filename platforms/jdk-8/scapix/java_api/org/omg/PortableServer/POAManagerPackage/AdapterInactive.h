...
#ifndef SCAPIX_JAVA_API_ORG_OMG_PORTABLESERVER_POAMANAGERPACKAGE_ADAPTERINACTIVE
...
public:
	...
	static jni::ref<org::omg::PortableServer::POAManagerPackage::AdapterInactive> new_object() { return object_base::new_object(); }
	static jni::ref<org::omg::PortableServer::POAManagerPackage::AdapterInactive> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
