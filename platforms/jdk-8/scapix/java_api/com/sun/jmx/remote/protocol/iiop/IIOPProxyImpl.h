...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_PROTOCOL_IIOP_IIOPPROXYIMPL
...
public:
	...
	static jni::ref<com::sun::jmx::remote::protocol::iiop::IIOPProxyImpl> new_object() { return object_base::new_object(); }
