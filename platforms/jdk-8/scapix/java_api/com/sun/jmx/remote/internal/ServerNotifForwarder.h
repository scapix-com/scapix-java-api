...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_SERVERNOTIFFORWARDER
...
public:
	...
	static jni::ref<com::sun::jmx::remote::internal::ServerNotifForwarder> new_object(jni::ref<javax::management::MBeanServer> p1, jni::ref<java::util::Map> p2, jni::ref<com::sun::jmx::remote::internal::NotificationBuffer> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
