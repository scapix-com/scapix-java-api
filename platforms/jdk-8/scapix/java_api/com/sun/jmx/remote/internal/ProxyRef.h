...
namespace scapix::java_api { namespace com::sun::jmx::remote::internal { class ProxyRef; }}
...
public:
	...
	static jni::ref<com::sun::jmx::remote::internal::ProxyRef> new_object(jni::ref<java::rmi::server::RemoteRef> p1) { return object_base::new_object(p1); }
