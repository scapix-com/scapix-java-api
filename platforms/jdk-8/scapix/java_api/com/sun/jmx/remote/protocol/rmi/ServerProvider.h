...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_PROTOCOL_RMI_SERVERPROVIDER
...
public:
	...
	static jni::ref<com::sun::jmx::remote::protocol::rmi::ServerProvider> new_object() { return object_base::new_object(); }
