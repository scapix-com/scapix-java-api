...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_PROTOCOL_IIOP_PROXYINPUTSTREAM
...
public:
	...
	static jni::ref<com::sun::jmx::remote::protocol::iiop::ProxyInputStream> new_object(jni::ref<org::omg::CORBA::portable::InputStream> p1) { return object_base::new_object(p1); }
