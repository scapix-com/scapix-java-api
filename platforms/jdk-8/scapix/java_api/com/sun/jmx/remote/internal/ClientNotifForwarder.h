...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_CLIENTNOTIFFORWARDER
...
public:
	...
	static jni::ref<com::sun::jmx::remote::internal::ClientNotifForwarder> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::remote::internal::ClientNotifForwarder> new_object(jni::ref<java::lang::ClassLoader> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
