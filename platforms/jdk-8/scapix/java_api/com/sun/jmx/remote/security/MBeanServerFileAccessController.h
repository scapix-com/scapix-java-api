...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_SECURITY_MBEANSERVERFILEACCESSCONTROLLER
...
public:
	...
	static jni::ref<com::sun::jmx::remote::security::MBeanServerFileAccessController> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::remote::security::MBeanServerFileAccessController> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::management::MBeanServer> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::remote::security::MBeanServerFileAccessController> new_object(jni::ref<java::util::Properties> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::remote::security::MBeanServerFileAccessController> new_object(jni::ref<java::util::Properties> p1, jni::ref<javax::management::MBeanServer> p2) { return object_base::new_object(p1, p2); }
