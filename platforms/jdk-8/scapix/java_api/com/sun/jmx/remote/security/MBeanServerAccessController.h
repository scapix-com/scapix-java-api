...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_SECURITY_MBEANSERVERACCESSCONTROLLER
...
public:
	...
	static jni::ref<com::sun::jmx::remote::security::MBeanServerAccessController> new_object() { return object_base::new_object(); }
