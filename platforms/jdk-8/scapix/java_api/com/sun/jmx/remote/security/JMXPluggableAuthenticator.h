...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_SECURITY_JMXPLUGGABLEAUTHENTICATOR
...
public:
	...
	static jni::ref<com::sun::jmx::remote::security::JMXPluggableAuthenticator> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
