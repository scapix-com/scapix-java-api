...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_UTIL_CLASSLOGGER
...
public:
	...
	static jni::ref<com::sun::jmx::remote::util::ClassLogger> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
