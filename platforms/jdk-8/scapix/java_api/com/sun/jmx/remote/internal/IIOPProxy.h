...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_IIOPPROXY_FWD
#define SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_IIOPPROXY_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::jmx::remote::internal { class IIOPProxy; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jmx::remote::internal::IIOPProxy>
{
	static constexpr fixed_string class_name = "com/sun/jmx/remote/internal/IIOPProxy";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_IIOPPROXY_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_IIOPPROXY)
#define SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_IIOPPROXY
...
class com::sun::jmx::remote::internal::IIOPProxy : public jni::object_base<"com/sun/jmx/remote/internal/IIOPProxy",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_COM_SUN_JMX_REMOTE_INTERNAL_IIOPPROXY
