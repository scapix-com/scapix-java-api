...
#include <scapix/java_api/com/sun/jmx/mbeanserver/SunJmxMBeanServer.h>

#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_MBEANSERVER_JMXMBEANSERVER_FWD
#define SCAPIX_JAVA_API_COM_SUN_JMX_MBEANSERVER_JMXMBEANSERVER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::jmx::mbeanserver { class JmxMBeanServer; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jmx::mbeanserver::JmxMBeanServer>
{
	static constexpr fixed_string class_name = "com/sun/jmx/mbeanserver/JmxMBeanServer";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::com::sun::jmx::mbeanserver::SunJmxMBeanServer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JMX_MBEANSERVER_JMXMBEANSERVER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JMX_MBEANSERVER_JMXMBEANSERVER)
#define SCAPIX_JAVA_API_COM_SUN_JMX_MBEANSERVER_JMXMBEANSERVER
...
class com::sun::jmx::mbeanserver::JmxMBeanServer : public jni::object_base<"com/sun/jmx/mbeanserver/JmxMBeanServer",
	java::lang::Object,
	com::sun::jmx::mbeanserver::SunJmxMBeanServer>
{
public:

	static jboolean DEFAULT_FAIR_LOCK_POLICY() { return get_static_field<"DEFAULT_FAIR_LOCK_POLICY", jboolean>(); }
	...
	static jni::ref<javax::management::MBeanServerDelegate> newMBeanServerDelegate() { return call_static_method<"newMBeanServerDelegate", jni::ref<javax::management::MBeanServerDelegate>>(); }
	static jni::ref<javax::management::MBeanServer> newMBeanServer(jni::ref<java::lang::String> p1, jni::ref<javax::management::MBeanServer> p2, jni::ref<javax::management::MBeanServerDelegate> p3, jboolean p4) { return call_static_method<"newMBeanServer", jni::ref<javax::management::MBeanServer>>(p1, p2, p3, p4); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_JMX_MBEANSERVER_JMXMBEANSERVER
