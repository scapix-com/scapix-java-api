...
namespace scapix::java_api { namespace com::sun::jmx::mbeanserver { class SecureClassLoaderRepository; }}
...
public:
	...
	static jni::ref<com::sun::jmx::mbeanserver::SecureClassLoaderRepository> new_object(jni::ref<javax::management::loading::ClassLoaderRepository> p1) { return object_base::new_object(p1); }
