...
namespace scapix::java_api { namespace com::sun::jmx::mbeanserver { class ObjectInputStreamWithLoader; }}
...
public:
	...
	static jni::ref<com::sun::jmx::mbeanserver::ObjectInputStreamWithLoader> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::ClassLoader> p2) { return object_base::new_object(p1, p2); }
