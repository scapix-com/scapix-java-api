...
namespace scapix::java_api { namespace com::sun::jmx::mbeanserver { class MBeanServerDelegateImpl; }}
...
public:
	...
	static jni::ref<com::sun::jmx::mbeanserver::MBeanServerDelegateImpl> new_object() { return object_base::new_object(); }
