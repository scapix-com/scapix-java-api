...
namespace com::sun::jmx::snmp::IPAcl {
...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_SNMPACL
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::SnmpAcl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::SnmpAcl> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
