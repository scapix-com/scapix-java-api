...
namespace scapix::java_api { namespace com::sun::jmx::snmp::daemon { class SnmpSession; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpSession> new_object(jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpSession> new_object() { return object_base::new_object(); }
