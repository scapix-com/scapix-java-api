...
namespace scapix::java_api { namespace com::sun::jmx::snmp::agent { class SnmpRequestTree_Handler; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::agent::SnmpRequestTree_Handler> new_object(jint p1) { return object_base::new_object(p1); }
