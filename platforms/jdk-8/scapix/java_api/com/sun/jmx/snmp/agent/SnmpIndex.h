...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_AGENT_SNMPINDEX
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::agent::SnmpIndex> new_object(jni::ref<jni::array<com::sun::jmx::snmp::SnmpOid>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::agent::SnmpIndex> new_object(jni::ref<com::sun::jmx::snmp::SnmpOid> p1) { return object_base::new_object(p1); }
