...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPUNKNOWNSUBSYSTEMEXCEPTION
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpUnknownSubSystemException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
