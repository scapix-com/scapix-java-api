...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPVARBIND
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpVarBind> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBind> new_object(jni::ref<com::sun::jmx::snmp::SnmpOid> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBind> new_object(jni::ref<com::sun::jmx::snmp::SnmpOid> p1, jni::ref<com::sun::jmx::snmp::SnmpValue> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBind> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
