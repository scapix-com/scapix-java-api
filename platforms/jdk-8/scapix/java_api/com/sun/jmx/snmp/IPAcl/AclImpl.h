...
namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class AclImpl; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::AclImpl> new_object(jni::ref<com::sun::jmx::snmp::IPAcl::PrincipalImpl> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
