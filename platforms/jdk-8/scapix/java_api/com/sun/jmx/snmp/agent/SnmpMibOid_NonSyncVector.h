...
namespace scapix::java_api { namespace com::sun::jmx::snmp::agent { class SnmpMibOid_NonSyncVector; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::agent::SnmpMibOid_NonSyncVector> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMibOid> p1, jint p2) { return object_base::new_object(p1, p2); }
