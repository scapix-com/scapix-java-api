...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_ENUMERATED
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::Enumerated> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::Enumerated> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::Enumerated> new_object(jni::ref<java::lang::Integer> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::Enumerated> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
