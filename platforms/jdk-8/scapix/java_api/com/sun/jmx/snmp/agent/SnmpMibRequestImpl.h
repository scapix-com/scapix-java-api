...
namespace scapix::java_api { namespace com::sun::jmx::snmp::agent { class SnmpMibRequestImpl; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::agent::SnmpMibRequestImpl> new_object(jni::ref<com::sun::jmx::snmp::SnmpEngine> p1, jni::ref<com::sun::jmx::snmp::SnmpPdu> p2, jni::ref<java::util::Vector> p3, jint p4, jni::ref<java::lang::Object> p5, jni::ref<java::lang::String> p6, jint p7, jint p8, jni::ref<jni::array<jbyte>> p9, jni::ref<jni::array<jbyte>> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
