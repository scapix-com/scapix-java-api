...
namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class Parser; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::Parser> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	void ReInit(jni::ref<java::io::InputStream> p1) { return call_method<"ReInit", void>(p1); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::Parser> new_object(jni::ref<java::io::Reader> p1) { return object_base::new_object(p1); }
	void ReInit(jni::ref<java::io::Reader> p1) { return call_method<"ReInit", void>(p1); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::Parser> new_object(jni::ref<com::sun::jmx::snmp::IPAcl::ParserTokenManager> p1) { return object_base::new_object(p1); }
