...
namespace com::sun::jmx::snmp::daemon {
...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_DAEMON_SNMPADAPTORSERVER
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jni::ref<com::sun::jmx::snmp::InetAddressAcl> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jni::ref<java::net::InetAddress> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jni::ref<com::sun::jmx::snmp::InetAddressAcl> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jint p1, jni::ref<java::net::InetAddress> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jni::ref<com::sun::jmx::snmp::InetAddressAcl> p1, jni::ref<java::net::InetAddress> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jni::ref<com::sun::jmx::snmp::InetAddressAcl> p1, jint p2, jni::ref<java::net::InetAddress> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpAdaptorServer> new_object(jboolean p1, jint p2, jni::ref<java::net::InetAddress> p3) { return object_base::new_object(p1, p2, p3); }
