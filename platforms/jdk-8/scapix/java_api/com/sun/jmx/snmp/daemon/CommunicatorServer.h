...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_DAEMON_COMMUNICATORSERVER
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::daemon::CommunicatorServer> new_object(jint p1) { return object_base::new_object(p1); }
