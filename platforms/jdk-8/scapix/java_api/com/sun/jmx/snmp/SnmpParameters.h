...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPPARAMETERS
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpParameters> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::SnmpParameters> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::SnmpParameters> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
