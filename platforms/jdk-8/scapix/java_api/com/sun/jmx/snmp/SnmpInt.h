...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPINT
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpInt> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpInt> new_object(jni::ref<java::lang::Integer> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpInt> new_object(jlong p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpInt> new_object(jni::ref<java::lang::Long> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpInt> new_object(jni::ref<com::sun::jmx::snmp::Enumerated> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpInt> new_object(jboolean p1) { return object_base::new_object(p1); }
