...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPPEER
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpPeer> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpPeer> new_object(jni::ref<java::net::InetAddress> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::SnmpPeer> new_object(jni::ref<java::net::InetAddress> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpPeer> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
