...
namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class ASCII_CharStream; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::ASCII_CharStream> new_object(jni::ref<java::io::Reader> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::ASCII_CharStream> new_object(jni::ref<java::io::Reader> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::ASCII_CharStream> new_object(jni::ref<java::io::InputStream> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::ASCII_CharStream> new_object(jni::ref<java::io::InputStream> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
