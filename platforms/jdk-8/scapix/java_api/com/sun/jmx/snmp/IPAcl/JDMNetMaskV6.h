...
namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class JDMNetMaskV6; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::JDMNetMaskV6> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::JDMNetMaskV6> new_object(jni::ref<com::sun::jmx::snmp::IPAcl::Parser> p1, jint p2) { return object_base::new_object(p1, p2); }
