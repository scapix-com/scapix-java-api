...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_BERENCODER
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::BerEncoder> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
