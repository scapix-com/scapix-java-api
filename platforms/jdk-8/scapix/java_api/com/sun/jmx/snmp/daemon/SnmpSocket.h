...
namespace scapix::java_api { namespace com::sun::jmx::snmp::daemon { class SnmpSocket; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::daemon::SnmpSocket> new_object(jni::ref<com::sun::jmx::snmp::daemon::SnmpResponseHandler> p1, jni::ref<java::net::InetAddress> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
