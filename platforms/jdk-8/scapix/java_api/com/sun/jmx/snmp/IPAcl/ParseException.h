...
namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class ParseException; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::ParseException> new_object(jni::ref<com::sun::jmx::snmp::IPAcl::Token> p1, jni::ref<jni::array<jni::array<jint>>> p2, jni::ref<jni::array<java::lang::String>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::ParseException> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::ParseException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
