...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_AGENT_SNMPMIBTABLE
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::agent::SnmpMibTable> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1) { return object_base::new_object(p1); }
