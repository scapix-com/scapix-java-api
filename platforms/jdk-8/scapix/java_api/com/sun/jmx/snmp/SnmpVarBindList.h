...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPVARBINDLIST
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpVarBindList> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBindList> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBindList> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBindList> new_object(jni::ref<com::sun::jmx::snmp::SnmpVarBindList> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBindList> new_object(jni::ref<java::util::Vector> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpVarBindList> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Vector> p2) { return object_base::new_object(p1, p2); }
