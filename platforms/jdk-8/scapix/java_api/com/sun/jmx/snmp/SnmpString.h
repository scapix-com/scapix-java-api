...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPSTRING
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpString> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::SnmpString> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpString> new_object(jni::ref<jni::array<java::lang::Byte>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpString> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpString> new_object(jni::ref<java::net::InetAddress> p1) { return object_base::new_object(p1); }
