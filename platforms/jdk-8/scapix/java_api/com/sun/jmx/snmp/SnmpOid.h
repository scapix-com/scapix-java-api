...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPOID
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpOid> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::SnmpOid> new_object(jni::ref<jni::array<jlong>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpOid> new_object(jlong p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpOid> new_object(jlong p1, jlong p2, jlong p3, jlong p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::jmx::snmp::SnmpOid> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
