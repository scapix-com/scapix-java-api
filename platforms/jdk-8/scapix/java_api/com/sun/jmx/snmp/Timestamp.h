...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_TIMESTAMP
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::Timestamp> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::Timestamp> new_object(jlong p1, jlong p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jmx::snmp::Timestamp> new_object(jlong p1) { return object_base::new_object(p1); }
