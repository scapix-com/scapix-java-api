...
namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class AclEntryImpl; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::IPAcl::AclEntryImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::IPAcl::AclEntryImpl> new_object(jni::ref<java::security::Principal> p1) { return object_base::new_object(p1); }
