...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPOIDDATABASESUPPORT
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpOidDatabaseSupport> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jmx::snmp::SnmpOidDatabaseSupport> new_object(jni::ref<com::sun::jmx::snmp::SnmpOidTable> p1) { return object_base::new_object(p1); }
