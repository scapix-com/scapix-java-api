...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_JDMINFORMBLOCK_FWD
#define SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_JDMINFORMBLOCK_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::jmx::snmp::IPAcl { class JDMInformBlock; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jmx::snmp::IPAcl::JDMInformBlock>
{
	static constexpr fixed_string class_name = "com/sun/jmx/snmp/IPAcl/JDMInformBlock";
	using base_classes = std::tuple<scapix::java_api::com::sun::jmx::snmp::IPAcl::SimpleNode>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_JDMINFORMBLOCK_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_JDMINFORMBLOCK)
#define SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_JDMINFORMBLOCK
...
// private
class com::sun::jmx::snmp::IPAcl::JDMInformBlock : public jni::object_base<"com/sun/jmx/snmp/IPAcl/JDMInformBlock",
...
#endif // SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_IPACL_JDMINFORMBLOCK
