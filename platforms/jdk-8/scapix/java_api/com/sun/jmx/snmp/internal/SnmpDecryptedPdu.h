...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_INTERNAL_SNMPDECRYPTEDPDU
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::internal::SnmpDecryptedPdu> new_object() { return object_base::new_object(); }
};
