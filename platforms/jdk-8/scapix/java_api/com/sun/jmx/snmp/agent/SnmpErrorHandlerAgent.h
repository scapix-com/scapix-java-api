...
namespace scapix::java_api { namespace com::sun::jmx::snmp::agent { class SnmpErrorHandlerAgent; }}
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::agent::SnmpErrorHandlerAgent> new_object() { return object_base::new_object(); }
