...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_INTERNAL_SNMPENGINEIMPL
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::internal::SnmpEngineImpl> new_object(jni::ref<com::sun::jmx::snmp::SnmpEngineFactory> p1, jni::ref<com::sun::jmx::snmp::internal::SnmpLcd> p2, jni::ref<com::sun::jmx::snmp::SnmpEngineId> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::jmx::snmp::internal::SnmpEngineImpl> new_object(jni::ref<com::sun::jmx::snmp::SnmpEngineFactory> p1, jni::ref<com::sun::jmx::snmp::internal::SnmpLcd> p2, jni::ref<java::net::InetAddress> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::jmx::snmp::internal::SnmpEngineImpl> new_object(jni::ref<com::sun::jmx::snmp::SnmpEngineFactory> p1, jni::ref<com::sun::jmx::snmp::internal::SnmpLcd> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::jmx::snmp::internal::SnmpEngineImpl> new_object(jni::ref<com::sun::jmx::snmp::SnmpEngineFactory> p1, jni::ref<com::sun::jmx::snmp::internal::SnmpLcd> p2) { return object_base::new_object(p1, p2); }
