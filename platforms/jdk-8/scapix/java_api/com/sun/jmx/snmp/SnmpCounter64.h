...
namespace scapix::java_api::com::sun::jmx::snmp { class SnmpCounter64; }
...
public:
	...
	static jni::ref<com::sun::jmx::snmp::SnmpCounter64> new_object(jlong p1) { return base_::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpCounter64> new_object(jni::ref<java::lang::Long> p1) { return base_::new_object(p1); }
...
protected:
	...
	SnmpCounter64(handle_type h) : base_(h) {}
