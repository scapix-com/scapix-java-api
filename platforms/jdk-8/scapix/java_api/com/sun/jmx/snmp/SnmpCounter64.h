...
#ifndef SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPCOUNTER64_FWD
#define SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPCOUNTER64_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::jmx::snmp { class SnmpCounter64; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jmx::snmp::SnmpCounter64>
{
	static constexpr fixed_string class_name = "com/sun/jmx/snmp/SnmpCounter64";
	using base_classes = std::tuple<scapix::java_api::com::sun::jmx::snmp::SnmpValue>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPCOUNTER64_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPCOUNTER64)
#define SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPCOUNTER64
...
class com::sun::jmx::snmp::SnmpCounter64 : public jni::object_base<"com/sun/jmx/snmp/SnmpCounter64",
	com::sun::jmx::snmp::SnmpValue>
{
public:

	static jni::ref<com::sun::jmx::snmp::SnmpCounter64> new_object(jlong p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jmx::snmp::SnmpCounter64> new_object(jni::ref<java::lang::Long> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_JMX_SNMP_SNMPCOUNTER64
