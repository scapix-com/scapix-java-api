...
#ifndef SCAPIX_JAVA_API_COM_SUN_SECURITY_SASL_PLAINCLIENT_FWD
#define SCAPIX_JAVA_API_COM_SUN_SECURITY_SASL_PLAINCLIENT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::security::sasl { class PlainClient; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::security::sasl::PlainClient>
{
	static constexpr fixed_string class_name = "com/sun/security/sasl/PlainClient";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::security::sasl::SaslClient>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_SECURITY_SASL_PLAINCLIENT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_SECURITY_SASL_PLAINCLIENT)
#define SCAPIX_JAVA_API_COM_SUN_SECURITY_SASL_PLAINCLIENT
...
// private
class com::sun::security::sasl::PlainClient : public jni::object_base<"com/sun/security/sasl/PlainClient",
	java::lang::Object,
...
#endif // SCAPIX_JAVA_API_COM_SUN_SECURITY_SASL_PLAINCLIENT
