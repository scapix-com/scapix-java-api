...
public:
	...
	static jni::ref<com::sun::security::cert::internal::x509::X509V1CertImpl> new_object(jni::ref<jni::array<jbyte>> p1) { return base_::new_object(p1); }
	static jni::ref<com::sun::security::cert::internal::x509::X509V1CertImpl> new_object(jni::ref<java::io::InputStream> p1) { return base_::new_object(p1); }
