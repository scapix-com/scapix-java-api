...
namespace scapix::java_api::com::sun::media::sound { class WaveFileWriter; }
...
public:
	...
	static jni::ref<com::sun::media::sound::WaveFileWriter> new_object() { return base_::new_object(); }
...
protected:
	...
	WaveFileWriter(handle_type h) : base_(h) {}
