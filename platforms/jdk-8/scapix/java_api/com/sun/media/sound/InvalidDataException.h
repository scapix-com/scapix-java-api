...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_INVALIDDATAEXCEPTION
...
public:
	...
	static jni::ref<com::sun::media::sound::InvalidDataException> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::InvalidDataException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
