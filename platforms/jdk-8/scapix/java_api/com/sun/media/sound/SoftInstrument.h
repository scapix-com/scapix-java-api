...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTINSTRUMENT
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftInstrument> new_object(jni::ref<com::sun::media::sound::ModelInstrument> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::SoftInstrument> new_object(jni::ref<com::sun::media::sound::ModelInstrument> p1, jni::ref<jni::array<com::sun::media::sound::ModelPerformer>> p2) { return object_base::new_object(p1, p2); }
