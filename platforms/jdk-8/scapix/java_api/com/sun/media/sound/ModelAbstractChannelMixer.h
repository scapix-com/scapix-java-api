...
namespace scapix::java_api { namespace com::sun::media::sound { class ModelAbstractChannelMixer; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelAbstractChannelMixer> new_object() { return object_base::new_object(); }
