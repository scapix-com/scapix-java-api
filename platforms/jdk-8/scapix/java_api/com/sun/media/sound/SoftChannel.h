...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTCHANNEL
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftChannel> new_object(jni::ref<com::sun::media::sound::SoftSynthesizer> p1, jint p2) { return object_base::new_object(p1, p2); }
