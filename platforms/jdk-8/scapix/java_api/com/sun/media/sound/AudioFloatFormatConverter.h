...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AUDIOFLOATFORMATCONVERTER
...
public:
	...
	static jni::ref<com::sun::media::sound::AudioFloatFormatConverter> new_object() { return object_base::new_object(); }
