...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_RIFFWRITER
...
public:
	...
	static jni::ref<com::sun::media::sound::RIFFWriter> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::RIFFWriter> new_object(jni::ref<java::io::File> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::RIFFWriter> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
