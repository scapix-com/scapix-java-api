...
namespace scapix::java_api { namespace com::sun::media::sound { class SoftChannelProxy; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftChannelProxy> new_object() { return object_base::new_object(); }
