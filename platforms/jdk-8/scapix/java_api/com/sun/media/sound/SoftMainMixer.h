...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTMAINMIXER
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftMainMixer> new_object(jni::ref<com::sun::media::sound::SoftSynthesizer> p1) { return object_base::new_object(p1); }
