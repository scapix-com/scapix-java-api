...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTLINEARRESAMPLER2
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftLinearResampler2> new_object() { return object_base::new_object(); }
