...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_MODELCONNECTIONBLOCK
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelConnectionBlock> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::ModelConnectionBlock> new_object(jdouble p1, jni::ref<com::sun::media::sound::ModelDestination> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::ModelConnectionBlock> new_object(jni::ref<com::sun::media::sound::ModelSource> p1, jni::ref<com::sun::media::sound::ModelDestination> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::ModelConnectionBlock> new_object(jni::ref<com::sun::media::sound::ModelSource> p1, jdouble p2, jni::ref<com::sun::media::sound::ModelDestination> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::media::sound::ModelConnectionBlock> new_object(jni::ref<com::sun::media::sound::ModelSource> p1, jni::ref<com::sun::media::sound::ModelSource> p2, jni::ref<com::sun::media::sound::ModelDestination> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::media::sound::ModelConnectionBlock> new_object(jni::ref<com::sun::media::sound::ModelSource> p1, jni::ref<com::sun::media::sound::ModelSource> p2, jdouble p3, jni::ref<com::sun::media::sound::ModelDestination> p4) { return object_base::new_object(p1, p2, p3, p4); }
