...
namespace scapix::java_api { namespace com::sun::media::sound { class AuFileReader; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::AuFileReader> new_object() { return object_base::new_object(); }
