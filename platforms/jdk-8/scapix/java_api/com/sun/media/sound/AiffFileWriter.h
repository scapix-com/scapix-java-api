...
namespace scapix::java_api::com::sun::media::sound { class AiffFileWriter; }
...
public:
	...
	static jni::ref<com::sun::media::sound::AiffFileWriter> new_object() { return base_::new_object(); }
...
protected:
	...
	AiffFileWriter(handle_type h) : base_(h) {}
