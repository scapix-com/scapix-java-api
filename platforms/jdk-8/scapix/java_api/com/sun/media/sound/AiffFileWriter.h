...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEWRITER_FWD
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEWRITER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::media::sound { class AiffFileWriter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::media::sound::AiffFileWriter>
{
	static constexpr fixed_string class_name = "com/sun/media/sound/AiffFileWriter";
	using base_classes = std::tuple<scapix::java_api::com::sun::media::sound::SunFileWriter>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEWRITER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEWRITER)
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEWRITER
...
class com::sun::media::sound::AiffFileWriter : public jni::object_base<"com/sun/media/sound/AiffFileWriter",
	com::sun::media::sound::SunFileWriter>
{
public:

	static jni::ref<com::sun::media::sound::AiffFileWriter> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEWRITER
