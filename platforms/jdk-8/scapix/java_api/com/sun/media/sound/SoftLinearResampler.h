...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTLINEARRESAMPLER
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftLinearResampler> new_object() { return object_base::new_object(); }
