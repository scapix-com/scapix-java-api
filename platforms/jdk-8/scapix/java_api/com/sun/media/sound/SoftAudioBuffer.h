...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTAUDIOBUFFER
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftAudioBuffer> new_object(jint p1, jni::ref<javax::sound::sampled::AudioFormat> p2) { return object_base::new_object(p1, p2); }
