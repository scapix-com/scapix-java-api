...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_MODELMAPPEDINSTRUMENT
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelMappedInstrument> new_object(jni::ref<com::sun::media::sound::ModelInstrument> p1, jni::ref<javax::sound::midi::Patch> p2) { return object_base::new_object(p1, p2); }
