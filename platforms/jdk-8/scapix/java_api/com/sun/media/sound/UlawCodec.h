...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_ULAWCODEC_FWD
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_ULAWCODEC_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::media::sound { class UlawCodec; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::media::sound::UlawCodec>
{
	static constexpr fixed_string class_name = "com/sun/media/sound/UlawCodec";
	using base_classes = std::tuple<scapix::java_api::com::sun::media::sound::SunCodec>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_ULAWCODEC_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_ULAWCODEC)
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_ULAWCODEC
...
class com::sun::media::sound::UlawCodec : public jni::object_base<"com/sun/media/sound/UlawCodec",
	com::sun::media::sound::SunCodec>
{
public:

	static jni::ref<com::sun::media::sound::UlawCodec> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_ULAWCODEC
