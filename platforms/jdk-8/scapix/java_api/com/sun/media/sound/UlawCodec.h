...
namespace scapix::java_api::com::sun::media::sound { class UlawCodec; }
...
public:
	...
	static jni::ref<com::sun::media::sound::UlawCodec> new_object() { return base_::new_object(); }
...
protected:
	...
	UlawCodec(handle_type h) : base_(h) {}
