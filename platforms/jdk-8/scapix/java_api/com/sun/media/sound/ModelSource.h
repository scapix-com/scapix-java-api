...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_MODELSOURCE
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelSource> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::ModelSource> new_object(jni::ref<com::sun::media::sound::ModelIdentifier> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::ModelSource> new_object(jni::ref<com::sun::media::sound::ModelIdentifier> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::ModelSource> new_object(jni::ref<com::sun::media::sound::ModelIdentifier> p1, jboolean p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::media::sound::ModelSource> new_object(jni::ref<com::sun::media::sound::ModelIdentifier> p1, jboolean p2, jboolean p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::media::sound::ModelSource> new_object(jni::ref<com::sun::media::sound::ModelIdentifier> p1, jni::ref<com::sun::media::sound::ModelTransform> p2) { return object_base::new_object(p1, p2); }
