...
namespace scapix::java_api::com::sun::media::sound { class SoftChorus; }
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftChorus> new_object() { return base_::new_object(); }
...
protected:
	...
	SoftChorus(handle_type h) : base_(h) {}
