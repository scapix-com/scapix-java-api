...
namespace scapix::java_api { namespace com::sun::media::sound { class SoftLimiter; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftLimiter> new_object() { return object_base::new_object(); }
