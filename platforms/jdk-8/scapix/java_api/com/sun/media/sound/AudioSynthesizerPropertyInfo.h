...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AUDIOSYNTHESIZERPROPERTYINFO
...
public:
	...
	static jni::ref<com::sun::media::sound::AudioSynthesizerPropertyInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
};
