...
namespace scapix::java_api { namespace com::sun::media::sound { class DLSInstrument; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::DLSInstrument> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::DLSInstrument> new_object(jni::ref<com::sun::media::sound::DLSSoundbank> p1) { return object_base::new_object(p1); }
