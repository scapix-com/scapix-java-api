...
namespace scapix::java_api::com::sun::media::sound { class WaveFloatFileReader; }
...
public:
	...
	static jni::ref<com::sun::media::sound::WaveFloatFileReader> new_object() { return base_::new_object(); }
...
protected:
	...
	WaveFloatFileReader(handle_type h) : base_(h) {}
