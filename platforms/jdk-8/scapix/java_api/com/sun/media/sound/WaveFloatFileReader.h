...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEFLOATFILEREADER_FWD
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEFLOATFILEREADER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::media::sound { class WaveFloatFileReader; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::media::sound::WaveFloatFileReader>
{
	static constexpr fixed_string class_name = "com/sun/media/sound/WaveFloatFileReader";
	using base_classes = std::tuple<scapix::java_api::javax::sound::sampled::spi::AudioFileReader>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEFLOATFILEREADER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEFLOATFILEREADER)
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEFLOATFILEREADER
...
class com::sun::media::sound::WaveFloatFileReader : public jni::object_base<"com/sun/media/sound/WaveFloatFileReader",
	javax::sound::sampled::spi::AudioFileReader>
{
public:

	static jni::ref<com::sun::media::sound::WaveFloatFileReader> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEFLOATFILEREADER
