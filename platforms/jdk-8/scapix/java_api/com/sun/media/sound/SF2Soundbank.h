...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SF2SOUNDBANK
...
public:
	...
	static jni::ref<com::sun::media::sound::SF2Soundbank> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::SF2Soundbank> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::SF2Soundbank> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::SF2Soundbank> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
