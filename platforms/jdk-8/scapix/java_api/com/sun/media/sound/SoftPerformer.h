...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTPERFORMER
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftPerformer> new_object(jni::ref<com::sun::media::sound::ModelPerformer> p1) { return object_base::new_object(p1); }
};
