...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_MODELSTANDARDTRANSFORM
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelStandardTransform> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::ModelStandardTransform> new_object(jboolean p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::ModelStandardTransform> new_object(jboolean p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::ModelStandardTransform> new_object(jboolean p1, jboolean p2, jint p3) { return object_base::new_object(p1, p2, p3); }
