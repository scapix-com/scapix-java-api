...
namespace scapix::java_api { namespace com::sun::media::sound { class SoftSynthesizer_WeakAudioStream; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftSynthesizer_WeakAudioStream> new_object(jni::ref<javax::sound::sampled::AudioInputStream> p1) { return object_base::new_object(p1); }
