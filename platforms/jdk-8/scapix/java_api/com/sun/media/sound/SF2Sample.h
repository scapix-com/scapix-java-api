...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SF2SAMPLE
...
public:
	...
	static jni::ref<com::sun::media::sound::SF2Sample> new_object(jni::ref<javax::sound::midi::Soundbank> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::SF2Sample> new_object() { return object_base::new_object(); }
