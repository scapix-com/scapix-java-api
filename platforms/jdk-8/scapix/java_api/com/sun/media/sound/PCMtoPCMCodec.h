...
namespace scapix::java_api::com::sun::media::sound { class PCMtoPCMCodec; }
...
public:
	...
	static jni::ref<com::sun::media::sound::PCMtoPCMCodec> new_object() { return base_::new_object(); }
...
protected:
	...
	PCMtoPCMCodec(handle_type h) : base_(h) {}
