...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SF2INSTRUMENT
...
public:
	...
	static jni::ref<com::sun::media::sound::SF2Instrument> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::media::sound::SF2Instrument> new_object(jni::ref<com::sun::media::sound::SF2Soundbank> p1) { return object_base::new_object(p1); }
