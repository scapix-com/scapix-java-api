...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_RIFFREADER
...
public:
	...
	static jni::ref<com::sun::media::sound::RIFFReader> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
