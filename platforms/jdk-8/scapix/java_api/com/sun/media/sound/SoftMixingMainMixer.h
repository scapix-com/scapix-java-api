...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_SOFTMIXINGMAINMIXER
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftMixingMainMixer> new_object(jni::ref<com::sun::media::sound::SoftMixingMixer> p1) { return object_base::new_object(p1); }
