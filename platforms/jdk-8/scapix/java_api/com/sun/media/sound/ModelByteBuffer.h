...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_MODELBYTEBUFFER
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelByteBuffer> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::ModelByteBuffer> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::media::sound::ModelByteBuffer> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::ModelByteBuffer> new_object(jni::ref<java::io::File> p1, jlong p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
