...
namespace scapix::java_api { namespace com::sun::media::sound { class AlawCodec; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::AlawCodec> new_object() { return object_base::new_object(); }
