...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEREADER_FWD
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEREADER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::media::sound { class AiffFileReader; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::media::sound::AiffFileReader>
{
	static constexpr fixed_string class_name = "com/sun/media/sound/AiffFileReader";
	using base_classes = std::tuple<scapix::java_api::com::sun::media::sound::SunFileReader>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEREADER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEREADER)
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEREADER
...
class com::sun::media::sound::AiffFileReader : public jni::object_base<"com/sun/media/sound/AiffFileReader",
	com::sun::media::sound::SunFileReader>
{
public:

	static jni::ref<com::sun::media::sound::AiffFileReader> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_AIFFFILEREADER
