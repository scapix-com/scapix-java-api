...
namespace scapix::java_api::com::sun::media::sound { class AiffFileReader; }
...
public:
	...
	static jni::ref<com::sun::media::sound::AiffFileReader> new_object() { return base_::new_object(); }
...
protected:
	...
	AiffFileReader(handle_type h) : base_(h) {}
