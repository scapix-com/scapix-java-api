...
namespace scapix::java_api { namespace com::sun::media::sound { class SoftMixingDataLine_AudioFloatInputStreamResampler; }}
...
public:
	...
	static jni::ref<com::sun::media::sound::SoftMixingDataLine_AudioFloatInputStreamResampler> new_object(jni::ref<com::sun::media::sound::AudioFloatInputStream> p1, jni::ref<javax::sound::sampled::AudioFormat> p2) { return object_base::new_object(p1, p2); }
