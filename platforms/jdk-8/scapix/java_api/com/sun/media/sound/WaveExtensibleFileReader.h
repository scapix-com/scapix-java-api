...
namespace scapix::java_api::com::sun::media::sound { class WaveExtensibleFileReader; }
...
public:
	...
	static jni::ref<com::sun::media::sound::WaveExtensibleFileReader> new_object() { return base_::new_object(); }
...
protected:
	...
	WaveExtensibleFileReader(handle_type h) : base_(h) {}
