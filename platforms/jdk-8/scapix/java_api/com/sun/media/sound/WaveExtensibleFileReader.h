...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEEXTENSIBLEFILEREADER_FWD
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEEXTENSIBLEFILEREADER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::media::sound { class WaveExtensibleFileReader; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::media::sound::WaveExtensibleFileReader>
{
	static constexpr fixed_string class_name = "com/sun/media/sound/WaveExtensibleFileReader";
	using base_classes = std::tuple<scapix::java_api::javax::sound::sampled::spi::AudioFileReader>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEEXTENSIBLEFILEREADER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEEXTENSIBLEFILEREADER)
#define SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEEXTENSIBLEFILEREADER
...
class com::sun::media::sound::WaveExtensibleFileReader : public jni::object_base<"com/sun/media/sound/WaveExtensibleFileReader",
	javax::sound::sampled::spi::AudioFileReader>
{
public:

	static jni::ref<com::sun::media::sound::WaveExtensibleFileReader> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_WAVEEXTENSIBLEFILEREADER
