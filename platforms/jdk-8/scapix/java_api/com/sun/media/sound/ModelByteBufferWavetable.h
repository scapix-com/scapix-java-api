...
#ifndef SCAPIX_JAVA_API_COM_SUN_MEDIA_SOUND_MODELBYTEBUFFERWAVETABLE
...
public:
	...
	static jni::ref<com::sun::media::sound::ModelByteBufferWavetable> new_object(jni::ref<com::sun::media::sound::ModelByteBuffer> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::media::sound::ModelByteBufferWavetable> new_object(jni::ref<com::sun::media::sound::ModelByteBuffer> p1, jfloat p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::ModelByteBufferWavetable> new_object(jni::ref<com::sun::media::sound::ModelByteBuffer> p1, jni::ref<javax::sound::sampled::AudioFormat> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::media::sound::ModelByteBufferWavetable> new_object(jni::ref<com::sun::media::sound::ModelByteBuffer> p1, jni::ref<javax::sound::sampled::AudioFormat> p2, jfloat p3) { return object_base::new_object(p1, p2, p3); }
