...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_BASICCONTROL
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::BasicControl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jndi::ldap::BasicControl> new_object(jni::ref<java::lang::String> p1, jboolean p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
