...
namespace scapix::java_api { namespace com::sun::jndi::ldap { class NameClassPairWithControls; }}
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::NameClassPairWithControls> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<javax::naming::ldap::Control>> p3) { return object_base::new_object(p1, p2, p3); }
