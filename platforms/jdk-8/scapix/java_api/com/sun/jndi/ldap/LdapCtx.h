...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPCTX
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::LdapCtx> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3, jni::ref<java::util::Hashtable> p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
