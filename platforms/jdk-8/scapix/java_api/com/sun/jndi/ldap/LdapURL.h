...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPURL
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::LdapURL> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
