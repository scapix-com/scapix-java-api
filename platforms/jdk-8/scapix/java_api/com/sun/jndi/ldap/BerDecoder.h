...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_BERDECODER
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::BerDecoder> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
