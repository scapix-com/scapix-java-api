...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPNAME_FWD
#define SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPNAME_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::jndi::ldap { class LdapName; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jndi::ldap::LdapName>
{
	static constexpr fixed_string class_name = "com/sun/jndi/ldap/LdapName";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::naming::Name>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPNAME_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPNAME)
#define SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPNAME
...
class com::sun::jndi::ldap::LdapName : public jni::object_base<"com/sun/jndi/ldap/LdapName",
	java::lang::Object,
	javax::naming::Name>
{
public:

	static jni::ref<com::sun::jndi::ldap::LdapName> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	...
	void setValuesCaseSensitive(jboolean p1) { return call_method<"setValuesCaseSensitive", void>(p1); }
	...
	static jni::ref<java::lang::String> escapeAttributeValue(jni::ref<java::lang::Object> p1) { return call_static_method<"escapeAttributeValue", jni::ref<java::lang::String>>(p1); }
	static jni::ref<java::lang::Object> unescapeAttributeValue(jni::ref<java::lang::String> p1) { return call_static_method<"unescapeAttributeValue", jni::ref<java::lang::Object>>(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_LDAPNAME
