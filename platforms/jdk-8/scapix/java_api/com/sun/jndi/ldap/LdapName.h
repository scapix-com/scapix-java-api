...
namespace scapix::java_api::com::sun::jndi::ldap { class LdapName; }
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::LdapName> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
