...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_LDAP_POOL_POOLCLEANER
...
public:
	...
	static jni::ref<com::sun::jndi::ldap::pool::PoolCleaner> new_object(jlong p1, jni::ref<jni::array<com::sun::jndi::ldap::pool::Pool>> p2) { return object_base::new_object(p1, p2); }
