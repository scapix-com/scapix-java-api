...
namespace com::sun::jndi::url::ldap {
...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_URL_LDAP_LDAPURLCONTEXTFACTORY
...
public:
	...
	static jni::ref<com::sun::jndi::url::ldap::ldapURLContextFactory> new_object() { return object_base::new_object(); }
