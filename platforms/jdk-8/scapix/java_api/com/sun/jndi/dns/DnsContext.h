...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_DNS_DNSCONTEXT
...
public:
	...
	static jni::ref<com::sun::jndi::dns::DnsContext> new_object(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<java::util::Hashtable> p3) { return object_base::new_object(p1, p2, p3); }
