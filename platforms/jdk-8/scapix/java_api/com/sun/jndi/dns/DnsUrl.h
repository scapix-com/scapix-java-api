...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_DNS_DNSURL
...
public:
	...
	static jni::ref<com::sun::jndi::dns::DnsUrl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
