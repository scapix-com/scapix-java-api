...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLCONTEXT_FWD
#define SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLCONTEXT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::jndi::toolkit::url { class GenericURLContext; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jndi::toolkit::url::GenericURLContext>
{
	static constexpr fixed_string class_name = "com/sun/jndi/toolkit/url/GenericURLContext";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::naming::Context>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLCONTEXT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLCONTEXT)
#define SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLCONTEXT
...
class com::sun::jndi::toolkit::url::GenericURLContext : public jni::object_base<"com/sun/jndi/toolkit/url/GenericURLContext",
	java::lang::Object,
	javax::naming::Context>
{
public:

	static jni::ref<com::sun::jndi::toolkit::url::GenericURLContext> new_object(jni::ref<java::util::Hashtable> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLCONTEXT
