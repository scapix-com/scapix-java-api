...
namespace scapix::java_api::com::sun::jndi::toolkit::url { class GenericURLContext; }
...
public:
	...
	static jni::ref<com::sun::jndi::toolkit::url::GenericURLContext> new_object(jni::ref<java::util::Hashtable> p1) { return base_::new_object(p1); }
...
protected:
	...
	GenericURLContext(handle_type h) : base_(h) {}
