...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_DIR_SEARCHFILTER
...
public:
	...
	static jni::ref<com::sun::jndi::toolkit::dir::SearchFilter> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
