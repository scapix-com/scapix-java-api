...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_STRINGHEADTAIL
...
public:
	...
	static jni::ref<com::sun::jndi::toolkit::ctx::StringHeadTail> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::jndi::toolkit::ctx::StringHeadTail> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
