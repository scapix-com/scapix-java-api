...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLDIRCONTEXT_FWD
#define SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLDIRCONTEXT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::jndi::toolkit::url { class GenericURLDirContext; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jndi::toolkit::url::GenericURLDirContext>
{
	static constexpr fixed_string class_name = "com/sun/jndi/toolkit/url/GenericURLDirContext";
	using base_classes = std::tuple<scapix::java_api::com::sun::jndi::toolkit::url::GenericURLContext, scapix::java_api::javax::naming::directory::DirContext>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLDIRCONTEXT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLDIRCONTEXT)
#define SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLDIRCONTEXT
...
class com::sun::jndi::toolkit::url::GenericURLDirContext : public jni::object_base<"com/sun/jndi/toolkit/url/GenericURLDirContext",
...
protected:
	...
	GenericURLDirContext(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_URL_GENERICURLDIRCONTEXT
