...
#include <scapix/java_api/javax/naming/spi/Resolver.h>

#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_PARTIALCOMPOSITECONTEXT_FWD
#define SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_PARTIALCOMPOSITECONTEXT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::jndi::toolkit::ctx { class PartialCompositeContext; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::jndi::toolkit::ctx::PartialCompositeContext>
{
	static constexpr fixed_string class_name = "com/sun/jndi/toolkit/ctx/PartialCompositeContext";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::naming::Context, scapix::java_api::javax::naming::spi::Resolver>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_PARTIALCOMPOSITECONTEXT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_PARTIALCOMPOSITECONTEXT)
#define SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_PARTIALCOMPOSITECONTEXT
...
class com::sun::jndi::toolkit::ctx::PartialCompositeContext : public jni::object_base<"com/sun/jndi/toolkit/ctx/PartialCompositeContext",
	java::lang::Object,
...
protected:
	...
	PartialCompositeContext(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_JNDI_TOOLKIT_CTX_PARTIALCOMPOSITECONTEXT
