...
namespace scapix::java_api { namespace com::sun::jndi::toolkit::dir { class HierMemDirCtx; }}
...
public:
	...
	static jni::ref<com::sun::jndi::toolkit::dir::HierMemDirCtx> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::jndi::toolkit::dir::HierMemDirCtx> new_object(jboolean p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::jndi::toolkit::dir::HierMemDirCtx> new_object(jni::ref<java::util::Hashtable> p1, jboolean p2) { return object_base::new_object(p1, p2); }
