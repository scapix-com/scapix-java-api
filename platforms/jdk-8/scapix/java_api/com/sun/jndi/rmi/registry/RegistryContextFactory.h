...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_RMI_REGISTRY_REGISTRYCONTEXTFACTORY
...
public:
	...
	static jni::ref<com::sun::jndi::rmi::registry::RegistryContextFactory> new_object() { return object_base::new_object(); }
