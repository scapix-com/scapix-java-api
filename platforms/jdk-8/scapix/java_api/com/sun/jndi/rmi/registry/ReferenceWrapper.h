...
#ifndef SCAPIX_JAVA_API_COM_SUN_JNDI_RMI_REGISTRY_REFERENCEWRAPPER
...
public:
	...
	static jni::ref<com::sun::jndi::rmi::registry::ReferenceWrapper> new_object(jni::ref<javax::naming::Reference> p1) { return object_base::new_object(p1); }
