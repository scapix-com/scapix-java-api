...
namespace scapix::java_api { namespace com::sun::jndi::rmi::registry { class RegistryContext; }}
...
public:
	...
	static jni::ref<com::sun::jndi::rmi::registry::RegistryContext> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<java::util::Hashtable> p3) { return object_base::new_object(p1, p2, p3); }
