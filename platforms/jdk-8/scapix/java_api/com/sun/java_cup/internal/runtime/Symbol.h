...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_CUP_INTERNAL_RUNTIME_SYMBOL
...
public:
	...
	static jni::ref<com::sun::java_cup::internal::runtime::Symbol> new_object(jint p1, jint p2, jint p3, jni::ref<java::lang::Object> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::java_cup::internal::runtime::Symbol> new_object(jint p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::java_cup::internal::runtime::Symbol> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::java_cup::internal::runtime::Symbol> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::java_cup::internal::runtime::Symbol> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
