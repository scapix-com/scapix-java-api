...
#ifndef SCAPIX_JAVA_API_COM_SUN_SWING_INTERNAL_PLAF_SYNTH_RESOURCES_SYNTH_DE
...
public:
	...
	static jni::ref<com::sun::swing::internal::plaf::synth::resources::synth_de> new_object() { return object_base::new_object(); }
};
