...
#ifndef SCAPIX_JAVA_API_COM_SUN_SWING_INTERNAL_PLAF_METAL_RESOURCES_METAL_SV
...
public:
	...
	static jni::ref<com::sun::swing::internal::plaf::metal::resources::metal_sv> new_object() { return object_base::new_object(); }
};
