...
#ifndef SCAPIX_JAVA_API_COM_SUN_SWING_INTERNAL_PLAF_BASIC_RESOURCES_BASIC
...
public:
	...
	static jni::ref<com::sun::swing::internal::plaf::basic::resources::basic> new_object() { return object_base::new_object(); }
};
