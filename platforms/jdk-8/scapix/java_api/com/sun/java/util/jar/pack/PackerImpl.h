...
struct scapix::jni::object_traits<scapix::java_api::com::sun::java::util::jar::pack::PackerImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::util::jar::Pack200_Packer>;
};
...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_UTIL_JAR_PACK_PACKERIMPL
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::PackerImpl> new_object() { return object_base::new_object(); }
