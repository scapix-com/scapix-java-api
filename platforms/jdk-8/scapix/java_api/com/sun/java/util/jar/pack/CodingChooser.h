...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class CodingChooser; }}
...
public:
	...
	void computeSize(jni::ref<com::sun::java::util::jar::pack::CodingMethod> p1, jni::ref<jni::array<jint>> p2, jint p3, jint p4, jni::ref<jni::array<jint>> p5) { return call_method<"computeSize", void>(p1, p2, p3, p4, p5); }
	void computeSize(jni::ref<com::sun::java::util::jar::pack::CodingMethod> p1, jni::ref<jni::array<jint>> p2, jni::ref<jni::array<jint>> p3) { return call_method<"computeSize", void>(p1, p2, p3); }
	jni::ref<jni::array<jint>> computeSize(jni::ref<com::sun::java::util::jar::pack::CodingMethod> p1, jni::ref<jni::array<jint>> p2, jint p3, jint p4) { return call_method<"computeSize", jni::ref<jni::array<jint>>>(p1, p2, p3, p4); }
	jni::ref<jni::array<jint>> computeSize(jni::ref<com::sun::java::util::jar::pack::CodingMethod> p1, jni::ref<jni::array<jint>> p2) { return call_method<"computeSize", jni::ref<jni::array<jint>>>(p1, p2); }
	jint computeByteSize(jni::ref<com::sun::java::util::jar::pack::CodingMethod> p1, jni::ref<jni::array<jint>> p2, jint p3, jint p4) { return call_method<"computeByteSize", jint>(p1, p2, p3, p4); }
