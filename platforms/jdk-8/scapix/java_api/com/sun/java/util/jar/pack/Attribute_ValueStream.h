...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Attribute_ValueStream; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Attribute_ValueStream> new_object() { return object_base::new_object(); }
	jint getInt(jint p1) { return call_method<"getInt", jint>(p1); }
	void putInt(jint p1, jint p2) { return call_method<"putInt", void>(p1, p2); }
	...
	void putRef(jint p1, jni::ref<com::sun::java::util::jar::pack::ConstantPool_Entry> p2) { return call_method<"putRef", void>(p1, p2); }
	jint decodeBCI(jint p1) { return call_method<"decodeBCI", jint>(p1); }
	jint encodeBCI(jint p1) { return call_method<"encodeBCI", jint>(p1); }
	void noteBackCall(jint p1) { return call_method<"noteBackCall", void>(p1); }
