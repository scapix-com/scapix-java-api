...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Attribute_Layout; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Attribute_Layout> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
