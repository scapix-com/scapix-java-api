...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::AdaptiveCoding> new_object(jint p1, jni::ref<com::sun::java::util::jar::pack::CodingMethod> p2, jni::ref<com::sun::java::util::jar::pack::CodingMethod> p3) { return object_base::new_object(p1, p2, p3); }
