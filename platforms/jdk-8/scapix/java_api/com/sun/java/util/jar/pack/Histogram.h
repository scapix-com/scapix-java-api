...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Histogram> new_object(jni::ref<jni::array<jint>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::java::util::jar::pack::Histogram> new_object(jni::ref<jni::array<jint>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::java::util::jar::pack::Histogram> new_object(jni::ref<jni::array<jni::array<jint>>> p1) { return object_base::new_object(p1); }
