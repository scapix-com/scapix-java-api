...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class BandStructure_ByteCounter; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::BandStructure_ByteCounter> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
	jlong getCount() { return call_method<"getCount", jlong>(); }
	void setCount(jlong p1) { return call_method<"setCount", void>(p1); }
