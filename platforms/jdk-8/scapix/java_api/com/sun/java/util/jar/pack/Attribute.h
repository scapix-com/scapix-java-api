...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Attribute> new_object(jni::ref<com::sun::java::util::jar::pack::Attribute_Layout> p1, jni::ref<jni::array<jbyte>> p2, jni::ref<java::lang::Object> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::java::util::jar::pack::Attribute> new_object(jni::ref<com::sun::java::util::jar::pack::Attribute_Layout> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
