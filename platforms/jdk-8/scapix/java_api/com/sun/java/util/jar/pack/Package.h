...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Package; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Package> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::java::util::jar::pack::Package> new_object(jni::ref<com::sun::java::util::jar::pack::Package_Version> p1, jni::ref<com::sun::java::util::jar::pack::Package_Version> p2, jni::ref<com::sun::java::util::jar::pack::Package_Version> p3) { return object_base::new_object(p1, p2, p3); }
	...
	void setAllInnerClasses(jni::ref<java::util::Collection> p1) { return call_method<"setAllInnerClasses", void>(p1); }
	jni::ref<com::sun::java::util::jar::pack::Package_InnerClass> getGlobalInnerClass(jni::ref<com::sun::java::util::jar::pack::ConstantPool_Entry> p1) { return call_method<"getGlobalInnerClass", jni::ref<com::sun::java::util::jar::pack::Package_InnerClass>>(p1); }
