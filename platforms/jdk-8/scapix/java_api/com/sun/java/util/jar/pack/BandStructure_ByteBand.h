...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class BandStructure_ByteBand; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::BandStructure_ByteBand> new_object(jni::ref<com::sun::java::util::jar::pack::BandStructure> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	...
	void writeDataTo(jni::ref<java::io::OutputStream> p1) { return call_method<"writeDataTo", void>(p1); }
	void readDataFrom(jni::ref<java::io::InputStream> p1) { return call_method<"readDataFrom", void>(p1); }
	void readyToDisburse() { return call_method<"readyToDisburse", void>(); }
	void doneDisbursing() { return call_method<"doneDisbursing", void>(); }
	void setInputStreamFrom(jni::ref<java::io::InputStream> p1) { return call_method<"setInputStreamFrom", void>(p1); }
	...
	void putByte(jint p1) { return call_method<"putByte", void>(p1); }
