...
namespace scapix::java_api { namespace com::sun::java::util::jar::pack { class Package_Class_Field; }}
...
public:
	...
	static jni::ref<com::sun::java::util::jar::pack::Package_Class_Field> new_object(jni::ref<com::sun::java::util::jar::pack::Package_Class> p1, jint p2, jni::ref<com::sun::java::util::jar::pack::ConstantPool_DescriptorEntry> p3) { return object_base::new_object(p1, p2, p3); }
