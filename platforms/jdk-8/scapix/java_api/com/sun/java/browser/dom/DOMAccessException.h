...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_BROWSER_DOM_DOMACCESSEXCEPTION
...
public:
	...
	static jni::ref<com::sun::java::browser::dom::DOMAccessException> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::java::browser::dom::DOMAccessException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::java::browser::dom::DOMAccessException> new_object(jni::ref<java::lang::Exception> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::java::browser::dom::DOMAccessException> new_object(jni::ref<java::lang::Exception> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
