...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFSLIDERUI
...
public:
	...
	static jni::ref<com::sun::java::swing::plaf::motif::MotifSliderUI> new_object(jni::ref<javax::swing::JSlider> p1) { return object_base::new_object(p1); }
