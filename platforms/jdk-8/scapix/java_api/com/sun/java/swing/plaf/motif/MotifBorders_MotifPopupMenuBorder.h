...
class MotifBorders_MotifPopupMenuBorder;
...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFBORDERS_MOTIFPOPUPMENUBORDER
...
public:
	...
	static jni::ref<com::sun::java::swing::plaf::motif::MotifBorders_MotifPopupMenuBorder> new_object(jni::ref<java::awt::Font> p1, jni::ref<java::awt::Color> p2, jni::ref<java::awt::Color> p3, jni::ref<java::awt::Color> p4, jni::ref<java::awt::Color> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
