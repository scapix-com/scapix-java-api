...
namespace scapix::java_api { namespace com::sun::java::swing::plaf::windows { class WindowsLookAndFeel_AudioAction; }}
...
public:
	...
	static jni::ref<com::sun::java::swing::plaf::windows::WindowsLookAndFeel_AudioAction> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
