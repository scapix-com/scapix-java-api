...
namespace scapix::java_api::com::sun::java::swing::plaf::motif { class MotifFileChooserUI; }
...
public:
	...
	static jni::ref<com::sun::java::swing::plaf::motif::MotifFileChooserUI> new_object(jni::ref<javax::swing::JFileChooser> p1) { return base_::new_object(p1); }
...
protected:
	...
	MotifFileChooserUI(handle_type h) : base_(h) {}
