...
#ifndef SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFFILECHOOSERUI_FWD
#define SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFFILECHOOSERUI_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::java::swing::plaf::motif { class MotifFileChooserUI; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::java::swing::plaf::motif::MotifFileChooserUI>
{
	static constexpr fixed_string class_name = "com/sun/java/swing/plaf/motif/MotifFileChooserUI";
	using base_classes = std::tuple<scapix::java_api::javax::swing::plaf::basic::BasicFileChooserUI>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFFILECHOOSERUI_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFFILECHOOSERUI)
#define SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFFILECHOOSERUI
...
#include <scapix/java_api/com/sun/java/swing/plaf/motif/MotifFileChooserUI_FilterComboBoxRenderer.h>
...
class com::sun::java::swing::plaf::motif::MotifFileChooserUI : public jni::object_base<"com/sun/java/swing/plaf/motif/MotifFileChooserUI",
	javax::swing::plaf::basic::BasicFileChooserUI>
{
public:

	using FilterComboBoxRenderer = MotifFileChooserUI_FilterComboBoxRenderer;

	static jni::ref<com::sun::java::swing::plaf::motif::MotifFileChooserUI> new_object(jni::ref<javax::swing::JFileChooser> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_JAVA_SWING_PLAF_MOTIF_MOTIFFILECHOOSERUI
