...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_TRAX_XSLTCSOURCE
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::XSLTCSource> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::XSLTCSource> new_object(jni::ref<javax::xml::transform::Source> p1) { return object_base::new_object(p1); }
