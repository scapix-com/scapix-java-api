...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_JAXP_VALIDATION_VALIDATORIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_JAXP_VALIDATION_VALIDATORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::jaxp::validation { class ValidatorImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorImpl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/jaxp/validation/ValidatorImpl";
	using base_classes = std::tuple<scapix::java_api::javax::xml::validation::Validator, scapix::java_api::com::sun::org::apache::xerces::internal::xs::PSVIProvider>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_JAXP_VALIDATION_VALIDATORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_JAXP_VALIDATION_VALIDATORIMPL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_JAXP_VALIDATION_VALIDATORIMPL
...
// private
class com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorImpl : public jni::object_base<"com/sun/org/apache/xerces/internal/jaxp/validation/ValidatorImpl",
	javax::xml::validation::Validator,
	com::sun::org::apache::xerces::internal::xs::PSVIProvider>
{
public:

	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::XSGrammarPoolContainer> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_JAXP_VALIDATION_VALIDATORIMPL
