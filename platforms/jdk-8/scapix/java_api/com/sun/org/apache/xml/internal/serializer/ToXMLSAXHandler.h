...
namespace scapix::java_api::com::sun::org::apache::xml::internal::serializer { class ToXMLSAXHandler; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToXMLSAXHandler> new_object() { return base_::new_object(); }
	...
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToXMLSAXHandler> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<java::lang::String> p2) { return base_::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToXMLSAXHandler> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<org::xml::sax::ext::LexicalHandler> p2, jni::ref<java::lang::String> p3) { return base_::new_object(p1, p2, p3); }
...
protected:
	...
	ToXMLSAXHandler(handle_type h) : base_(h) {}
