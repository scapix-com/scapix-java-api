...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSANNOTATIONIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::XSAnnotationImpl> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar> p2) { return object_base::new_object(p1, p2); }
