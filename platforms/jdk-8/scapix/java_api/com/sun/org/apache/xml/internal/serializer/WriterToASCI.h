...
namespace scapix::java_api { namespace com::sun::org::apache::xml::internal::serializer { class WriterToASCI; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serializer::WriterToASCI> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
