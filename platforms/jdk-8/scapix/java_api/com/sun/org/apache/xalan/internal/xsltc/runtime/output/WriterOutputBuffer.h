...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::runtime::output { class WriterOutputBuffer; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::runtime::output::WriterOutputBuffer> new_object(jni::ref<java::io::Writer> p1) { return object_base::new_object(p1); }
