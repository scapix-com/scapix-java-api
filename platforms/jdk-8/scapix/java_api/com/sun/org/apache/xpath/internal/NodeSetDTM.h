...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_NODESETDTM
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTMManager> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jint p1, jint p2, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMManager> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTMIterator> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jni::ref<org::w3c::dom::traversal::NodeIterator> p1, jni::ref<com::sun::org::apache::xpath::internal::XPathContext> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jni::ref<org::w3c::dom::NodeList> p1, jni::ref<com::sun::org::apache::xpath::internal::XPathContext> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xpath::internal::NodeSetDTM> new_object(jint p1, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMManager> p2) { return object_base::new_object(p1, p2); }
