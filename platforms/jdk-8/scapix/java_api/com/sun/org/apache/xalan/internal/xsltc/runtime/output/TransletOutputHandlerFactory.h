...
namespace com::sun::org::apache::xalan::internal::xsltc::runtime::output {
...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_RUNTIME_OUTPUT_TRANSLETOUTPUTHANDLERFACTORY
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::runtime::output::TransletOutputHandlerFactory> new_object(jboolean p1) { return object_base::new_object(p1); }
