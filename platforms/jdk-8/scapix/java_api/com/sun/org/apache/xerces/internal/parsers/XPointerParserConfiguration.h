...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_PARSERS_XPOINTERPARSERCONFIGURATION
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::XPointerParserConfiguration> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::XPointerParserConfiguration> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::XPointerParserConfiguration> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1, jni::ref<com::sun::org::apache::xerces::internal::xni::grammars::XMLGrammarPool> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::XPointerParserConfiguration> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1, jni::ref<com::sun::org::apache::xerces::internal::xni::grammars::XMLGrammarPool> p2, jni::ref<com::sun::org::apache::xerces::internal::xni::parser::XMLComponentManager> p3) { return object_base::new_object(p1, p2, p3); }
