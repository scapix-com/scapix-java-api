...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKESPECIAL
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::INVOKESPECIAL> new_object(jint p1) { return object_base::new_object(p1); }
