...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXLOCATIONWRAPPER_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXLOCATIONWRAPPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::util { class StAXLocationWrapper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::util::StAXLocationWrapper>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/util/StAXLocationWrapper";
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXLOCATIONWRAPPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXLOCATIONWRAPPER)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXLOCATIONWRAPPER
...
class com::sun::org::apache::xerces::internal::util::StAXLocationWrapper : public jni::object_base<"com/sun/org/apache/xerces/internal/util/StAXLocationWrapper",
	java::lang::Object,
	com::sun::org::apache::xerces::internal::xni::XMLLocator>
{
public:

	static jni::ref<com::sun::org::apache::xerces::internal::util::StAXLocationWrapper> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXLOCATIONWRAPPER
