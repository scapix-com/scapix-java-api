...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_PATTERNS_NODETEST
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::patterns::NodeTest> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xpath::internal::patterns::NodeTest> new_object(jint p1) { return object_base::new_object(p1); }
	jboolean deepEquals(jni::ref<com::sun::org::apache::xpath::internal::Expression> p1) { return call_method<"deepEquals", jboolean>(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::patterns::NodeTest> new_object() { return object_base::new_object(); }
