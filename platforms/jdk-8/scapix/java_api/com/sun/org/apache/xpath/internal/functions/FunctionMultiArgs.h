...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_FUNCTIONS_FUNCTIONMULTIARGS
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::functions::FunctionMultiArgs> new_object() { return object_base::new_object(); }
