...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class ProcessingInstructionPattern; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::ProcessingInstructionPattern> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
