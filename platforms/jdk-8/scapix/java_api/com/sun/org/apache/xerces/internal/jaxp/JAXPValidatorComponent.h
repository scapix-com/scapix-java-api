...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::jaxp { class JAXPValidatorComponent; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::JAXPValidatorComponent> new_object(jni::ref<javax::xml::validation::ValidatorHandler> p1) { return object_base::new_object(p1); }
