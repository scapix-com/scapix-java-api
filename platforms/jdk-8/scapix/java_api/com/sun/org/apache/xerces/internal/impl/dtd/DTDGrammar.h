...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_DTD_DTDGRAMMAR
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::DTDGrammar> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1, jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLDTDDescription> p2) { return object_base::new_object(p1, p2); }
