...
namespace scapix::java_api::com::sun::org::apache::xml::internal::res { class XMLErrorResources_sv; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::res::XMLErrorResources_sv> new_object() { return base_::new_object(); }

protected:

	XMLErrorResources_sv(handle_type h) : base_(h) {}
