...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_STRINGCOMPARABLE
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::StringComparable> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Locale> p2, jni::ref<java::text::Collator> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
