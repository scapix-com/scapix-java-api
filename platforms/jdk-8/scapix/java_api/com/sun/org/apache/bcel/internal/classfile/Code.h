...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_CLASSFILE_CODE
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Code> new_object(jni::ref<com::sun::org::apache::bcel::internal::classfile::Code> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Code> new_object(jint p1, jint p2, jint p3, jint p4, jni::ref<jni::array<jbyte>> p5, jni::ref<jni::array<com::sun::org::apache::bcel::internal::classfile::CodeException>> p6, jni::ref<jni::array<com::sun::org::apache::bcel::internal::classfile::Attribute>> p7, jni::ref<com::sun::org::apache::bcel::internal::classfile::ConstantPool> p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
	...
	jni::ref<com::sun::org::apache::bcel::internal::classfile::StackMap> getStackMap() { return call_method<"getStackMap", jni::ref<com::sun::org::apache::bcel::internal::classfile::StackMap>>(); }
