...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_TREEWALKER
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::TreeWalker> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::TreeWalker> new_object(jni::ref<org::xml::sax::ContentHandler> p1) { return object_base::new_object(p1); }
