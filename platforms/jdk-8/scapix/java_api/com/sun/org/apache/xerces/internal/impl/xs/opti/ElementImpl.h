...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_ELEMENTIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::ElementImpl> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::ElementImpl> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::ElementImpl> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jint p5, jint p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::ElementImpl> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jint p5, jint p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
