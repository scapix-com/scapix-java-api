...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class FunctionCall_JavaType; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::FunctionCall_JavaType> new_object(jni::ref<java::lang::Class> p1, jint p2) { return object_base::new_object(p1, p2); }
