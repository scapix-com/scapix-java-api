...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_COREDOCUMENTIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> new_object(jboolean p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> new_object(jni::ref<org::w3c::dom::DocumentType> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> new_object(jni::ref<org::w3c::dom::DocumentType> p1, jboolean p2) { return object_base::new_object(p1, p2); }
