...
namespace scapix::java_api::com::sun::org::apache::xml::internal::res { class XMLErrorResources; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::res::XMLErrorResources> new_object() { return base_::new_object(); }

protected:

	XMLErrorResources(handle_type h) : base_(h) {}
