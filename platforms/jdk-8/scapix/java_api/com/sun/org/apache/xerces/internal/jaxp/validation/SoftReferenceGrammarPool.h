...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::jaxp::validation { class SoftReferenceGrammarPool; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::SoftReferenceGrammarPool> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::SoftReferenceGrammarPool> new_object(jint p1) { return object_base::new_object(p1); }
