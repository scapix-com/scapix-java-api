...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_CMDLINE_TRANSFORM
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::cmdline::Transform> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jboolean p3, jboolean p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
