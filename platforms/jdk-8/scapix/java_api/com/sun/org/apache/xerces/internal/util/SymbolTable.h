...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_SYMBOLTABLE
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> new_object(jint p1, jfloat p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> new_object() { return object_base::new_object(); }
