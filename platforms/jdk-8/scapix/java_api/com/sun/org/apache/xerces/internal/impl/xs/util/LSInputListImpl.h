...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_UTIL_LSINPUTLISTIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::util::LSInputListImpl> new_object(jni::ref<jni::array<org::w3c::dom::ls::LSInput>> p1, jint p2) { return object_base::new_object(p1, p2); }
