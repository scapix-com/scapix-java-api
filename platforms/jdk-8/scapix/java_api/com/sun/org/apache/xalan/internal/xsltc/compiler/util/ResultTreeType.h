...
namespace scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::compiler::util { class ResultTreeType; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ResultTreeType> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
...
protected:
	...
	ResultTreeType(handle_type h) : base_(h) {}
