...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_XPATHEXCEPTION
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::XPathException> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::org::apache::xpath::internal::ExpressionNode> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPathException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	...
	static jni::ref<com::sun::org::apache::xpath::internal::XPathException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPathException> new_object(jni::ref<java::lang::String> p1, jni::ref<org::w3c::dom::Node> p2, jni::ref<java::lang::Exception> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPathException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Exception> p2) { return object_base::new_object(p1, p2); }
