...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XNI_PARSER_XMLPARSEEXCEPTION
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::xni::parser::XMLParseException> new_object(jni::ref<com::sun::org::apache::xerces::internal::xni::XMLLocator> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::xni::parser::XMLParseException> new_object(jni::ref<com::sun::org::apache::xerces::internal::xni::XMLLocator> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::Exception> p3) { return object_base::new_object(p1, p2, p3); }
