...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_OBJECTPOOL
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectPool> new_object(jni::ref<java::lang::Class> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectPool> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectPool> new_object(jni::ref<java::lang::Class> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectPool> new_object() { return object_base::new_object(); }
