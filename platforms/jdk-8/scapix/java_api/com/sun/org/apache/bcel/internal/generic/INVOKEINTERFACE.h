...
namespace scapix::java_api::com::sun::org::apache::bcel::internal::generic { class INVOKEINTERFACE; }
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::INVOKEINTERFACE> new_object(jint p1, jint p2) { return base_::new_object(p1, p2); }
...
protected:
	...
	INVOKEINTERFACE(handle_type h) : base_(h) {}
