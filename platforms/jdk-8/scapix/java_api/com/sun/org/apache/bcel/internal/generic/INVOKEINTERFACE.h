...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKEINTERFACE_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKEINTERFACE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::bcel::internal::generic { class INVOKEINTERFACE; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::bcel::internal::generic::INVOKEINTERFACE>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/bcel/internal/generic/INVOKEINTERFACE";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::bcel::internal::generic::InvokeInstruction>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKEINTERFACE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKEINTERFACE)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKEINTERFACE
...
class com::sun::org::apache::bcel::internal::generic::INVOKEINTERFACE : public jni::object_base<"com/sun/org/apache/bcel/internal/generic/INVOKEINTERFACE",
	com::sun::org::apache::bcel::internal::generic::InvokeInstruction>
{
public:

	static jni::ref<com::sun::org::apache::bcel::internal::generic::INVOKEINTERFACE> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INVOKEINTERFACE
