...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_FUNCTIONS_WRONGNUMBERARGSEXCEPTION
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::functions::WrongNumberArgsException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
