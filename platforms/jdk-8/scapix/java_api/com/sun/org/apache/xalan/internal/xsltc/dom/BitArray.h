...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_BITARRAY
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::BitArray> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::BitArray> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::BitArray> new_object(jint p1, jni::ref<jni::array<jint>> p2) { return object_base::new_object(p1, p2); }
