...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_STAXINPUTSOURCE
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::StAXInputSource> new_object(jni::ref<javax::xml::stream::XMLStreamReader> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::StAXInputSource> new_object(jni::ref<javax::xml::stream::XMLStreamReader> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::StAXInputSource> new_object(jni::ref<javax::xml::stream::XMLEventReader> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::StAXInputSource> new_object(jni::ref<javax::xml::stream::XMLEventReader> p1, jboolean p2) { return object_base::new_object(p1, p2); }
