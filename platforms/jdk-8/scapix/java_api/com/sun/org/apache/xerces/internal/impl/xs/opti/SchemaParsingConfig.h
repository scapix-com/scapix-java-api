...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_SCHEMAPARSINGCONFIG_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_SCHEMAPARSINGCONFIG_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::impl::xs::opti { class SchemaParsingConfig; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::impl::xs::opti::SchemaParsingConfig>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/impl/xs/opti/SchemaParsingConfig";
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_SCHEMAPARSINGCONFIG_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_SCHEMAPARSINGCONFIG)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_SCHEMAPARSINGCONFIG
...
class com::sun::org::apache::xerces::internal::impl::xs::opti::SchemaParsingConfig : public jni::object_base<"com/sun/org/apache/xerces/internal/impl/xs/opti/SchemaParsingConfig",
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::SchemaParsingConfig> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::SchemaParsingConfig> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::SchemaParsingConfig> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1, jni::ref<com::sun::org::apache::xerces::internal::xni::grammars::XMLGrammarPool> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::SchemaParsingConfig> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1, jni::ref<com::sun::org::apache::xerces::internal::xni::grammars::XMLGrammarPool> p2, jni::ref<com::sun::org::apache::xerces::internal::xni::parser::XMLComponentManager> p3) { return object_base::new_object(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_SCHEMAPARSINGCONFIG
