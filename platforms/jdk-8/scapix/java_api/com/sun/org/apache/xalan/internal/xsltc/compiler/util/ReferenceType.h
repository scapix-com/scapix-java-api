...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_REFERENCETYPE_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_REFERENCETYPE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler::util { class ReferenceType; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::compiler::util::ReferenceType>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xalan/internal/xsltc/compiler/util/ReferenceType";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_REFERENCETYPE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_REFERENCETYPE)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_REFERENCETYPE
...
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/compiler/util/NodeSetType.h>
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/compiler/util/NodeType.h>
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/compiler/util/ObjectType.h>
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/compiler/util/RealType.h>
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/compiler/util/ResultTreeType.h>
...
class com::sun::org::apache::xalan::internal::xsltc::compiler::util::ReferenceType : public jni::object_base<"com/sun/org/apache/xalan/internal/xsltc/compiler/util/ReferenceType",
...
public:
	...
	void translateTo(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ClassGenerator> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator> p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::NodeSetType> p3) { return call_method<"translateTo", void>(p1, p2, p3); }
	void translateTo(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ClassGenerator> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator> p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::NodeType> p3) { return call_method<"translateTo", void>(p1, p2, p3); }
	void translateTo(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ClassGenerator> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator> p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ResultTreeType> p3) { return call_method<"translateTo", void>(p1, p2, p3); }
	void translateTo(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ClassGenerator> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator> p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::ObjectType> p3) { return call_method<"translateTo", void>(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_REFERENCETYPE
