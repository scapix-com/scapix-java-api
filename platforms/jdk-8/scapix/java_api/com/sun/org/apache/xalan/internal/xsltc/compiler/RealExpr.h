...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class RealExpr; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::RealExpr> new_object(jdouble p1) { return object_base::new_object(p1); }
