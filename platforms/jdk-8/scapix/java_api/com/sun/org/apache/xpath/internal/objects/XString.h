...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XSTRING_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XSTRING_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xpath::internal::objects { class XString; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xpath::internal::objects::XString>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xpath/internal/objects/XString";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xpath::internal::objects::XObject, scapix::java_api::com::sun::org::apache::xml::internal::utils::XMLString>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XSTRING_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XSTRING)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XSTRING
...
class com::sun::org::apache::xpath::internal::objects::XString : public jni::object_base<"com/sun/org/apache/xpath/internal/objects/XString",
	com::sun::org::apache::xpath::internal::objects::XObject,
	com::sun::org::apache::xml::internal::utils::XMLString>
{
public:

	static jni::ref<com::sun::org::apache::xpath::internal::objects::XString> EMPTYSTRING() { return get_static_field<"EMPTYSTRING", jni::ref<com::sun::org::apache::xpath::internal::objects::XString>>(); }

	static jni::ref<com::sun::org::apache::xpath::internal::objects::XString> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XSTRING
