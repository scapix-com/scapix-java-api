...
class DTMDefaultBaseIterators_TypedRootIterator;
...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_DTM_REF_DTMDEFAULTBASEITERATORS_TYPEDROOTITERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::dtm::ref::DTMDefaultBaseIterators_TypedRootIterator> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::ref::DTMDefaultBaseIterators> p1, jint p2) { return object_base::new_object(p1, p2); }
