...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_WHEN_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_WHEN_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class When; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::compiler::When>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xalan/internal/xsltc/compiler/When";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::compiler::Instruction>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_WHEN_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_WHEN)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_WHEN
...
// private
class com::sun::org::apache::xalan::internal::xsltc::compiler::When : public jni::object_base<"com/sun/org/apache/xalan/internal/xsltc/compiler/When",
	com::sun::org::apache::xalan::internal::xsltc::compiler::Instruction>
{
public:

	void display(jint p1) { return call_method<"display", void>(p1); }
	jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::Expression> getTest() { return call_method<"getTest", jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::Expression>>(); }
	jboolean ignore() { return call_method<"ignore", jboolean>(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_WHEN
