...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_IDENTITY_KEYREF
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::identity::KeyRef> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<com::sun::org::apache::xerces::internal::impl::xs::identity::UniqueOrKey> p4) { return object_base::new_object(p1, p2, p3, p4); }
