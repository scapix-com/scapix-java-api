...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_SAXINPUTSOURCE
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::SAXInputSource> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::SAXInputSource> new_object(jni::ref<org::xml::sax::InputSource> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::SAXInputSource> new_object(jni::ref<org::xml::sax::XMLReader> p1, jni::ref<org::xml::sax::InputSource> p2) { return object_base::new_object(p1, p2); }
