...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_MODELS_XSCMVALIDATOR_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_MODELS_XSCMVALIDATOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::impl::xs::models { class XSCMValidator; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::impl::xs::models::XSCMValidator>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/impl/xs/models/XSCMValidator";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_MODELS_XSCMVALIDATOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_MODELS_XSCMVALIDATOR)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_MODELS_XSCMVALIDATOR
...
class com::sun::org::apache::xerces::internal::impl::xs::models::XSCMValidator : public jni::object_base<"com/sun/org/apache/xerces/internal/impl/xs/models/XSCMValidator",
	java::lang::Object>
{
public:

	static jshort FIRST_ERROR() { return get_static_field<"FIRST_ERROR", jshort>(); }
	static jshort SUBSEQUENT_ERROR() { return get_static_field<"SUBSEQUENT_ERROR", jshort>(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_MODELS_XSCMVALIDATOR
