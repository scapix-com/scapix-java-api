...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_MULTIPLENODECOUNTER
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::MultipleNodeCounter> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::Translet> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::DOM> p2, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMAxisIterator> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::MultipleNodeCounter> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::Translet> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::DOM> p2, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMAxisIterator> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
