...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_URI
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::URI> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::URI> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::URI> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::URI> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6, jni::ref<java::lang::String> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
