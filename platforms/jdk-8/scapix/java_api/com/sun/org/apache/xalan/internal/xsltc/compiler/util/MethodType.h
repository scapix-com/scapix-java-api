...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_METHODTYPE
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodType> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodType> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodType> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodType> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p3, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodType> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::Type> p1, jni::ref<java::util::List> p2) { return object_base::new_object(p1, p2); }
