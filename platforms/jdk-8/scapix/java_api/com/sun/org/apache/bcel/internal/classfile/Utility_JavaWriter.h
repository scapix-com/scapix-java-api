...
namespace scapix::java_api { namespace com::sun::org::apache::bcel::internal::classfile { class Utility_JavaWriter; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Utility_JavaWriter> new_object(jni::ref<java::io::Writer> p1) { return object_base::new_object(p1); }
