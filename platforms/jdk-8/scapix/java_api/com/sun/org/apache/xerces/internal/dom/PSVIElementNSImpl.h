...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIELEMENTNSIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIELEMENTNSIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::dom { class PSVIElementNSImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::dom::PSVIElementNSImpl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/dom/PSVIElementNSImpl";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xerces::internal::dom::ElementNSImpl, scapix::java_api::com::sun::org::apache::xerces::internal::xs::ElementPSVI>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIELEMENTNSIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIELEMENTNSIMPL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIELEMENTNSIMPL
...
class com::sun::org::apache::xerces::internal::dom::PSVIElementNSImpl : public jni::object_base<"com/sun/org/apache/xerces/internal/dom/PSVIElementNSImpl",
	com::sun::org::apache::xerces::internal::dom::ElementNSImpl,
	com::sun::org::apache::xerces::internal::xs::ElementPSVI>
{
public:

	static jni::ref<com::sun::org::apache::xerces::internal::dom::PSVIElementNSImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::org::apache::xerces::internal::dom::PSVIElementNSImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	...
	void setPSVI(jni::ref<com::sun::org::apache::xerces::internal::xs::ElementPSVI> p1) { return call_method<"setPSVI", void>(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIELEMENTNSIMPL
