...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_JAXP_JAXPEXTENSIONSPROVIDER
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::jaxp::JAXPExtensionsProvider> new_object(jni::ref<javax::xml::xpath::XPathFunctionResolver> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::jaxp::JAXPExtensionsProvider> new_object(jni::ref<javax::xml::xpath::XPathFunctionResolver> p1, jboolean p2, jni::ref<jdk::xml::internal::JdkXmlFeatures> p3) { return object_base::new_object(p1, p2, p3); }
