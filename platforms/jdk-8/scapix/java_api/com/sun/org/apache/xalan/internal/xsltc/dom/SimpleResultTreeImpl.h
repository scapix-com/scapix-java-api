...
#include <scapix/java_api/com/sun/org/apache/xml/internal/serializer/EmptySerializer.h>
...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SIMPLERESULTTREEIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SIMPLERESULTTREEIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::dom { class SimpleResultTreeImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::dom::SimpleResultTreeImpl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xalan/internal/xsltc/dom/SimpleResultTreeImpl";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xml::internal::serializer::EmptySerializer, scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::DOM, scapix::java_api::com::sun::org::apache::xml::internal::dtm::DTM>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SIMPLERESULTTREEIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SIMPLERESULTTREEIMPL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SIMPLERESULTTREEIMPL
...
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/dom/SimpleResultTreeImpl_SimpleIterator.h>
#include <scapix/java_api/com/sun/org/apache/xalan/internal/xsltc/dom/SimpleResultTreeImpl_SingletonIterator.h>
...
class com::sun::org::apache::xalan::internal::xsltc::dom::SimpleResultTreeImpl : public jni::object_base<"com/sun/org/apache/xalan/internal/xsltc/dom/SimpleResultTreeImpl",
...
public:
	...
	using SimpleIterator = SimpleResultTreeImpl_SimpleIterator;
	using SingletonIterator = SimpleResultTreeImpl_SingletonIterator;

	static jint RTF_ROOT() { return get_static_field<"RTF_ROOT", jint>(); }
	static jint RTF_TEXT() { return get_static_field<"RTF_TEXT", jint>(); }
	static jint NUMBER_OF_NODES() { return get_static_field<"NUMBER_OF_NODES", jint>(); }

	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SimpleResultTreeImpl> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::XSLTCDTMManager> p1, jint p2) { return object_base::new_object(p1, p2); }
	jni::ref<com::sun::org::apache::xml::internal::dtm::ref::DTMManagerDefault> getDTMManager() { return call_method<"getDTMManager", jni::ref<com::sun::org::apache::xml::internal::dtm::ref::DTMManagerDefault>>(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SIMPLERESULTTREEIMPL
