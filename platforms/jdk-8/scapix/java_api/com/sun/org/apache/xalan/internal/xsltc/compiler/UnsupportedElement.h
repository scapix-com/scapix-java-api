...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class UnsupportedElement; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::UnsupportedElement> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
