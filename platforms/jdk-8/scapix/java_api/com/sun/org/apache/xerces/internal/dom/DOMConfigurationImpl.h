...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMCONFIGURATIONIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMCONFIGURATIONIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::org::apache::xerces::internal::dom { class DOMConfigurationImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::dom::DOMConfigurationImpl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/dom/DOMConfigurationImpl";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xerces::internal::util::ParserConfigurationSettings, scapix::java_api::com::sun::org::apache::xerces::internal::xni::parser::XMLParserConfiguration, scapix::java_api::org::w3c::dom::DOMConfiguration>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMCONFIGURATIONIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMCONFIGURATIONIMPL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMCONFIGURATIONIMPL
...
class com::sun::org::apache::xerces::internal::dom::DOMConfigurationImpl : public jni::object_base<"com/sun/org/apache/xerces/internal/dom/DOMConfigurationImpl",
...
protected:
	...
	DOMConfigurationImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMCONFIGURATIONIMPL
