...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_UTIL_XSNAMEDMAPIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::util::XSNamedMapImpl> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::org::apache::xerces::internal::util::SymbolHash> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::util::XSNamedMapImpl> new_object(jni::ref<jni::array<java::lang::String>> p1, jni::ref<jni::array<com::sun::org::apache::xerces::internal::util::SymbolHash>> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::util::XSNamedMapImpl> new_object(jni::ref<jni::array<com::sun::org::apache::xerces::internal::xs::XSObject>> p1, jint p2) { return object_base::new_object(p1, p2); }
