...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XS_XSEXCEPTION
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::xs::XSException> new_object(jshort p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
};
