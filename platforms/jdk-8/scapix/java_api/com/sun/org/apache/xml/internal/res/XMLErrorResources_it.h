...
namespace scapix::java_api::com::sun::org::apache::xml::internal::res { class XMLErrorResources_it; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::res::XMLErrorResources_it> new_object() { return base_::new_object(); }

protected:

	XMLErrorResources_it(handle_type h) : base_(h) {}
