...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_PARSERS_DOMPARSERIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::DOMParserImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::xni::parser::XMLParserConfiguration> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::DOMParserImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::xni::parser::XMLParserConfiguration> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::DOMParserImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::parsers::DOMParserImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p1, jni::ref<com::sun::org::apache::xerces::internal::xni::grammars::XMLGrammarPool> p2) { return object_base::new_object(p1, p2); }
