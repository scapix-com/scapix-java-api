...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_DTD_DTDGRAMMARBUCKET
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::DTDGrammarBucket> new_object() { return object_base::new_object(); }
