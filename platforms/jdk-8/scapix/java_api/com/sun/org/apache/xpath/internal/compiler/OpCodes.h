...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_COMPILER_OPCODES
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::compiler::OpCodes> new_object() { return object_base::new_object(); }
};
