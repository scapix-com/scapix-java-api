...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::jaxp::validation { class ValidatorHandlerImpl_ResolutionForwarder; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorHandlerImpl_ResolutionForwarder> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorHandlerImpl_ResolutionForwarder> new_object(jni::ref<org::w3c::dom::ls::LSResourceResolver> p1) { return object_base::new_object(p1); }
