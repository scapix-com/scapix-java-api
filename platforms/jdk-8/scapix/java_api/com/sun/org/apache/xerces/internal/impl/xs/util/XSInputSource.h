...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_UTIL_XSINPUTSOURCE
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::util::XSInputSource> new_object(jni::ref<jni::array<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::util::XSInputSource> new_object(jni::ref<jni::array<com::sun::org::apache::xerces::internal::xs::XSObject>> p1) { return object_base::new_object(p1); }
