...
class SAXImpl_NamespaceAttributeIterator;
...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SAXIMPL_NAMESPACEATTRIBUTEITERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SAXImpl_NamespaceAttributeIterator> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SAXImpl> p1, jint p2) { return object_base::new_object(p1, p2); }
