...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZE_OUTPUTFORMAT_DEFAULTS
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat_Defaults> new_object() { return object_base::new_object(); }
};
