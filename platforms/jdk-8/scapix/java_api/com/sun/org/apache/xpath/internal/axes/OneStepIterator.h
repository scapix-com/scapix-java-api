...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_AXES_ONESTEPITERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::axes::OneStepIterator> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTMAxisIterator> p1, jint p2) { return object_base::new_object(p1, p2); }
