...
namespace scapix::java_api { namespace com::sun::org::apache::xml::internal::utils { class AttList; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::AttList> new_object(jni::ref<org::w3c::dom::NamedNodeMap> p1) { return object_base::new_object(p1); }
