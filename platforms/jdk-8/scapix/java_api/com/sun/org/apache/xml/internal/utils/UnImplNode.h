...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_UNIMPLNODE_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_UNIMPLNODE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xml::internal::utils { class UnImplNode; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xml::internal::utils::UnImplNode>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xml/internal/utils/UnImplNode";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::org::w3c::dom::Node, scapix::java_api::org::w3c::dom::Element, scapix::java_api::org::w3c::dom::NodeList, scapix::java_api::org::w3c::dom::Document>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_UNIMPLNODE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_UNIMPLNODE)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_UNIMPLNODE
...
class com::sun::org::apache::xml::internal::utils::UnImplNode : public jni::object_base<"com/sun/org/apache/xml/internal/utils/UnImplNode",
	java::lang::Object,
	org::w3c::dom::Node,
	org::w3c::dom::Element,
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::UnImplNode> new_object() { return object_base::new_object(); }
	void error(jni::ref<java::lang::String> p1) { return call_method<"error", void>(p1); }
	...
	jboolean isWhitespaceInElementContent() { return call_method<"isWhitespaceInElementContent", jboolean>(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_UNIMPLNODE
