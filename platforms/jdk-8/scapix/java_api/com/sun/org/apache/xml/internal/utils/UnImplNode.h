...
namespace scapix::java_api::com::sun::org::apache::xml::internal::utils { class UnImplNode; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::UnImplNode> new_object() { return base_::new_object(); }
...
protected:
	...
	UnImplNode(handle_type h) : base_(h) {}
