...
namespace scapix::java_api::com::sun::org::apache::bcel::internal::generic { class NEW; }
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::NEW> new_object(jint p1) { return base_::new_object(p1); }
