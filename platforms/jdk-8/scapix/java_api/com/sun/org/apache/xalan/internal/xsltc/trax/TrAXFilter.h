...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_TRAX_TRAXFILTER
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::TrAXFilter> new_object(jni::ref<javax::xml::transform::Templates> p1) { return object_base::new_object(p1); }
