...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_COMPILER_COMPILER
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::compiler::Compiler> new_object(jni::ref<javax::xml::transform::ErrorListener> p1, jni::ref<javax::xml::transform::SourceLocator> p2, jni::ref<com::sun::org::apache::xpath::internal::compiler::FunctionTable> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xpath::internal::compiler::Compiler> new_object() { return object_base::new_object(); }
