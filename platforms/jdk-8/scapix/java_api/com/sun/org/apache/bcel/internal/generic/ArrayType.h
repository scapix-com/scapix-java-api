...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_ARRAYTYPE
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::ArrayType> new_object(jbyte p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::bcel::internal::generic::ArrayType> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::bcel::internal::generic::ArrayType> new_object(jni::ref<com::sun::org::apache::bcel::internal::generic::Type> p1, jint p2) { return object_base::new_object(p1, p2); }
