...
namespace scapix::java_api::com::sun::org::apache::xml::internal::res { class XMLErrorResources_de; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::res::XMLErrorResources_de> new_object() { return base_::new_object(); }

protected:

	XMLErrorResources_de(handle_type h) : base_(h) {}
