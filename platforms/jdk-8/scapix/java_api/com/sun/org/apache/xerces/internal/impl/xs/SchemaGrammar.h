...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::org::apache::xerces::internal::impl::xs::XSDDescription> p2, jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar> new_object(jni::ref<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar> p1) { return object_base::new_object(p1); }
