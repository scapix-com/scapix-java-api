...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_RUNTIME_ATTRIBUTES
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::runtime::Attributes> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::DOM> p1, jint p2) { return object_base::new_object(p1, p2); }
