...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_CLASSFILE_RUNTIMEVISIBLEPARAMETERANNOTATIONS
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::RuntimeVisibleParameterAnnotations> new_object(jint p1, jint p2, jni::ref<java::io::DataInput> p3, jni::ref<com::sun::org::apache::bcel::internal::classfile::ConstantPool> p4) { return object_base::new_object(p1, p2, p3, p4); }
};
