...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_IO_MALFORMEDBYTESEQUENCEEXCEPTION
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::io::MalformedByteSequenceException> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::MessageFormatter> p1, jni::ref<java::util::Locale> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<jni::array<java::lang::Object>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
