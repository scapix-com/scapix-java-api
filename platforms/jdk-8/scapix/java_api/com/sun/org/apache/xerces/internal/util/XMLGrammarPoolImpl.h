...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLGRAMMARPOOLIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLGRAMMARPOOLIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::util { class XMLGrammarPoolImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::util::XMLGrammarPoolImpl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/util/XMLGrammarPoolImpl";
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLGRAMMARPOOLIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLGRAMMARPOOLIMPL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLGRAMMARPOOLIMPL
...
class com::sun::org::apache::xerces::internal::util::XMLGrammarPoolImpl : public jni::object_base<"com/sun/org/apache/xerces/internal/util/XMLGrammarPoolImpl",
	java::lang::Object,
	com::sun::org::apache::xerces::internal::xni::grammars::XMLGrammarPool>
{
public:

	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLGrammarPoolImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLGrammarPoolImpl> new_object(jint p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLGRAMMARPOOLIMPL
