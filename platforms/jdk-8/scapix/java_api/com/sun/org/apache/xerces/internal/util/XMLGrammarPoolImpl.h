...
namespace scapix::java_api::com::sun::org::apache::xerces::internal::util { class XMLGrammarPoolImpl; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLGrammarPoolImpl> new_object() { return base_::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLGrammarPoolImpl> new_object(jint p1) { return base_::new_object(p1); }
...
protected:
	...
	XMLGrammarPoolImpl(handle_type h) : base_(h) {}
