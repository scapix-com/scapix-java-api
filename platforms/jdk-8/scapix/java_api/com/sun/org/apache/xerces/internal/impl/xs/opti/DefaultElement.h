...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_OPTI_DEFAULTELEMENT
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::DefaultElement> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::opti::DefaultElement> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jshort p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
