...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XNODESET
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::objects::XNodeSet> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTMIterator> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::objects::XNodeSet> new_object(jni::ref<com::sun::org::apache::xpath::internal::objects::XNodeSet> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::objects::XNodeSet> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTMManager> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xpath::internal::objects::XNodeSet> new_object(jint p1, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMManager> p2) { return object_base::new_object(p1, p2); }
