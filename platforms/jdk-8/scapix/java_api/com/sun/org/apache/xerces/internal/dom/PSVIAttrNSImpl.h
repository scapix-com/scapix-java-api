...
namespace scapix::java_api::com::sun::org::apache::xerces::internal::dom { class PSVIAttrNSImpl; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::dom::PSVIAttrNSImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return base_::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::org::apache::xerces::internal::dom::PSVIAttrNSImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return base_::new_object(p1, p2, p3); }
...
protected:
	...
	PSVIAttrNSImpl(handle_type h) : base_(h) {}
