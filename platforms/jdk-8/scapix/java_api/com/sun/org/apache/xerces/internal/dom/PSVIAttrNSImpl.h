...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIATTRNSIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIATTRNSIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::dom { class PSVIAttrNSImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::dom::PSVIAttrNSImpl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/dom/PSVIAttrNSImpl";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xerces::internal::dom::AttrNSImpl, scapix::java_api::com::sun::org::apache::xerces::internal::xs::AttributePSVI>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIATTRNSIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIATTRNSIMPL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIATTRNSIMPL
...
class com::sun::org::apache::xerces::internal::dom::PSVIAttrNSImpl : public jni::object_base<"com/sun/org/apache/xerces/internal/dom/PSVIAttrNSImpl",
	com::sun::org::apache::xerces::internal::dom::AttrNSImpl,
	com::sun::org::apache::xerces::internal::xs::AttributePSVI>
{
public:

	static jni::ref<com::sun::org::apache::xerces::internal::dom::PSVIAttrNSImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::org::apache::xerces::internal::dom::PSVIAttrNSImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	...
	void setPSVI(jni::ref<com::sun::org::apache::xerces::internal::xs::AttributePSVI> p1) { return call_method<"setPSVI", void>(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_PSVIATTRNSIMPL
