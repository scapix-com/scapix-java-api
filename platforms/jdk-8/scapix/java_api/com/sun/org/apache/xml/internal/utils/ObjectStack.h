...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_OBJECTSTACK
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectStack> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectStack> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectStack> new_object(jni::ref<com::sun::org::apache::xml::internal::utils::ObjectStack> p1) { return object_base::new_object(p1); }
