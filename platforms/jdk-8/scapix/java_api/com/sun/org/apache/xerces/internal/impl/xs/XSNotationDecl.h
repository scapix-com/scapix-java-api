...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSNOTATIONDECL_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSNOTATIONDECL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::impl::xs { class XSNotationDecl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::impl::xs::XSNotationDecl>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/impl/xs/XSNotationDecl";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::com::sun::org::apache::xerces::internal::xs::XSNotationDeclaration>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSNOTATIONDECL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSNOTATIONDECL)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSNOTATIONDECL
...
class com::sun::org::apache::xerces::internal::impl::xs::XSNotationDecl : public jni::object_base<"com/sun/org/apache/xerces/internal/impl/xs/XSNotationDecl",
	java::lang::Object,
...
public:
	...
	jni::ref<java::lang::String> fPublicId() { return get_field<"fPublicId", jni::ref<java::lang::String>>(); }
	void fPublicId(jni::ref<java::lang::String> v) { set_field<"fPublicId", jni::ref<java::lang::String>>(v); }
	jni::ref<java::lang::String> fSystemId() { return get_field<"fSystemId", jni::ref<java::lang::String>>(); }
	void fSystemId(jni::ref<java::lang::String> v) { set_field<"fSystemId", jni::ref<java::lang::String>>(v); }
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::XSNotationDecl> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSNOTATIONDECL
