...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_LOOKUPSWITCH
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::LOOKUPSWITCH> new_object(jni::ref<jni::array<jint>> p1, jni::ref<jni::array<com::sun::org::apache::bcel::internal::generic::InstructionHandle>> p2, jni::ref<com::sun::org::apache::bcel::internal::generic::InstructionHandle> p3) { return object_base::new_object(p1, p2, p3); }
