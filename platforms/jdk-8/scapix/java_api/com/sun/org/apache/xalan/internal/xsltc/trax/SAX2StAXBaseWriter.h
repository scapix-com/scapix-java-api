...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_TRAX_SAX2STAXBASEWRITER
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::SAX2StAXBaseWriter> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::SAX2StAXBaseWriter> new_object(jni::ref<javax::xml::stream::XMLReporter> p1) { return object_base::new_object(p1); }
