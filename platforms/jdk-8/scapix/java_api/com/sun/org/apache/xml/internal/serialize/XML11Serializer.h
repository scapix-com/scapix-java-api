...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZE_XML11SERIALIZER
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serialize::XML11Serializer> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xml::internal::serialize::XML11Serializer> new_object(jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::serialize::XML11Serializer> new_object(jni::ref<java::io::Writer> p1, jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::serialize::XML11Serializer> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> p2) { return object_base::new_object(p1, p2); }
