...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOHTMLSAXHANDLER_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOHTMLSAXHANDLER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::apache::xml::internal::serializer { class ToHTMLSAXHandler; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xml::internal::serializer::ToHTMLSAXHandler>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xml/internal/serializer/ToHTMLSAXHandler";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xml::internal::serializer::ToSAXHandler>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOHTMLSAXHANDLER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOHTMLSAXHANDLER)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOHTMLSAXHANDLER
...
class com::sun::org::apache::xml::internal::serializer::ToHTMLSAXHandler : public jni::object_base<"com/sun/org/apache/xml/internal/serializer/ToHTMLSAXHandler",
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToHTMLSAXHandler> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToHTMLSAXHandler> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<org::xml::sax::ext::LexicalHandler> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOHTMLSAXHANDLER
