...
namespace scapix::java_api { namespace com::sun::org::apache::xpath::internal::patterns { class StepPattern; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::patterns::StepPattern> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::org::apache::xpath::internal::patterns::StepPattern> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
