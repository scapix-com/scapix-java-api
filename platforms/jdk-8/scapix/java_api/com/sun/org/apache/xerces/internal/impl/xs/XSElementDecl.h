...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_XSELEMENTDECL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::XSElementDecl> new_object() { return object_base::new_object(); }
