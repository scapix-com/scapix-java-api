...
namespace scapix::java_api::com::sun::org::apache::xml::internal::res { class XMLErrorResources_ja; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::res::XMLErrorResources_ja> new_object() { return base_::new_object(); }

protected:

	XMLErrorResources_ja(handle_type h) : base_(h) {}
