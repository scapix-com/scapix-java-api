...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_AXES_RTFITERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::axes::RTFIterator> new_object(jint p1, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMManager> p2) { return object_base::new_object(p1, p2); }
};
