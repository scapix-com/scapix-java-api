...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_NSINFO
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::NSInfo> new_object(jboolean p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::NSInfo> new_object(jboolean p1, jboolean p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::NSInfo> new_object(jni::ref<java::lang::String> p1, jboolean p2) { return object_base::new_object(p1, p2); }
};
