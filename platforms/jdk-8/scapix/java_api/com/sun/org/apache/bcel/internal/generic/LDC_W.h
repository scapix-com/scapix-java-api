...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_LDC_W
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::LDC_W> new_object(jint p1) { return object_base::new_object(p1); }
};
