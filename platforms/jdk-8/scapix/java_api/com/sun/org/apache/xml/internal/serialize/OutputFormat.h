...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZE_OUTPUTFORMAT
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> new_object(jni::ref<org::w3c::dom::Document> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> new_object(jni::ref<org::w3c::dom::Document> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
