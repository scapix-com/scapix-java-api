...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_DOMADAPTER
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::DOMAdapter> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::DOM> p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<jni::array<java::lang::String>> p3, jni::ref<jni::array<jint>> p4, jni::ref<jni::array<java::lang::String>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
