...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::impl::xs::identity { class Field_Matcher; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::identity::Field_Matcher> new_object(jni::ref<com::sun::org::apache::xerces::internal::impl::xs::identity::Field> p1, jni::ref<com::sun::org::apache::xerces::internal::impl::xs::identity::Field_XPath> p2, jni::ref<com::sun::org::apache::xerces::internal::impl::xs::identity::ValueStore> p3) { return object_base::new_object(p1, p2, p3); }
