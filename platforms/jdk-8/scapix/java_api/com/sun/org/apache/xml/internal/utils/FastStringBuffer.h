...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_FASTSTRINGBUFFER
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::FastStringBuffer> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::FastStringBuffer> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::FastStringBuffer> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::FastStringBuffer> new_object() { return object_base::new_object(); }
