...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMNORMALIZER_XMLATTRIBUTESPROXY_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMNORMALIZER_XMLATTRIBUTESPROXY_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::org::apache::xerces::internal::dom { class DOMNormalizer_XMLAttributesProxy; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::dom::DOMNormalizer_XMLAttributesProxy>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/dom/DOMNormalizer$XMLAttributesProxy";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::com::sun::org::apache::xerces::internal::xni::XMLAttributes>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMNORMALIZER_XMLATTRIBUTESPROXY_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMNORMALIZER_XMLATTRIBUTESPROXY)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMNORMALIZER_XMLATTRIBUTESPROXY

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/com/sun/org/apache/xerces/internal/dom/AttributeMap.h>
...
class com::sun::org::apache::xerces::internal::dom::DOMNormalizer_XMLAttributesProxy : public jni::object_base<"com/sun/org/apache/xerces/internal/dom/DOMNormalizer$XMLAttributesProxy",
	java::lang::Object,
	com::sun::org::apache::xerces::internal::xni::XMLAttributes>
{
public:

	void setAttributes(jni::ref<com::sun::org::apache::xerces::internal::dom::AttributeMap> p1, jni::ref<com::sun::org::apache::xerces::internal::dom::CoreDocumentImpl> p2, jni::ref<com::sun::org::apache::xerces::internal::dom::ElementImpl> p3) { return call_method<"setAttributes", void>(p1, p2, p3); }
...
protected:
	...
	DOMNormalizer_XMLAttributesProxy(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_DOMNORMALIZER_XMLATTRIBUTESPROXY
