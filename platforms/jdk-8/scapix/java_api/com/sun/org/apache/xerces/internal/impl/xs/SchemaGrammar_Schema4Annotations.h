...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR_SCHEMA4ANNOTATIONS_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR_SCHEMA4ANNOTATIONS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::org::apache::xerces::internal::impl::xs { class SchemaGrammar_Schema4Annotations; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar_Schema4Annotations>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar$Schema4Annotations";
	using base_classes = std::tuple<scapix::java_api::com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR_SCHEMA4ANNOTATIONS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR_SCHEMA4ANNOTATIONS)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR_SCHEMA4ANNOTATIONS
...
class com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar_Schema4Annotations : public jni::object_base<"com/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar$Schema4Annotations",
	com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar>
{
public:

	static jni::ref<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar_Schema4Annotations> INSTANCE() { return get_static_field<"INSTANCE", jni::ref<com::sun::org::apache::xerces::internal::impl::xs::SchemaGrammar_Schema4Annotations>>(); }
	...
	void addGlobalAttributeDecl(jni::ref<com::sun::org::apache::xerces::internal::impl::xs::XSAttributeGroupDecl> p1, jni::ref<java::lang::String> p2) { return call_method<"addGlobalAttributeDecl", void>(p1, p2); }
...
protected:
	...
	SchemaGrammar_Schema4Annotations(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XS_SCHEMAGRAMMAR_SCHEMA4ANNOTATIONS
