...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::trax { class StAXEvent2SAX; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::StAXEvent2SAX> new_object(jni::ref<javax::xml::stream::XMLEventReader> p1) { return object_base::new_object(p1); }
