...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_CLASSFILE_ANNOTATIONS
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Annotations> new_object(jbyte p1, jint p2, jint p3, jni::ref<jni::array<com::sun::org::apache::bcel::internal::classfile::AnnotationEntry>> p4, jni::ref<com::sun::org::apache::bcel::internal::classfile::ConstantPool> p5, jboolean p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
