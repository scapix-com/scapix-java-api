...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_COMPILER_OPMAPVECTOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::compiler::OpMapVector> new_object(jint p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
