...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_OBJECTVECTOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectVector> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectVector> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectVector> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ObjectVector> new_object(jni::ref<com::sun::org::apache::xml::internal::utils::ObjectVector> p1) { return object_base::new_object(p1); }
