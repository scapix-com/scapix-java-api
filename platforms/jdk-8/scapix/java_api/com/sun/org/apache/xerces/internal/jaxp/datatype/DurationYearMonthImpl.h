...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::jaxp::datatype { class DurationYearMonthImpl; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::datatype::DurationYearMonthImpl> new_object(jboolean p1, jni::ref<java::math::BigInteger> p2, jni::ref<java::math::BigInteger> p3) { return object_base::new_object(p1, p2, p3); }
