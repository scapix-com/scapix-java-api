...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_UTILS_LISTINGERRORHANDLER
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::utils::ListingErrorHandler> new_object(jni::ref<java::io::PrintWriter> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xml::internal::utils::ListingErrorHandler> new_object() { return object_base::new_object(); }
