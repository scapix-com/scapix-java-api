...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_TRAX_SAX2DOM
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::SAX2DOM> new_object(jboolean p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::SAX2DOM> new_object(jni::ref<org::w3c::dom::Node> p1, jni::ref<org::w3c::dom::Node> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::SAX2DOM> new_object(jni::ref<org::w3c::dom::Node> p1, jboolean p2) { return object_base::new_object(p1, p2); }
