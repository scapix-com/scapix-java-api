...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_DTM_REF_EXTENDEDTYPE
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::dtm::ref::ExtendedType> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xml::internal::dtm::ref::ExtendedType> new_object(jint p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
