...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_DOM_TREEWALKERIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::dom::TreeWalkerImpl> new_object(jni::ref<org::w3c::dom::Node> p1, jint p2, jni::ref<org::w3c::dom::traversal::NodeFilter> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
