...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_INSTRUCTION
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::Instruction> new_object(jshort p1, jshort p2) { return object_base::new_object(p1, p2); }
