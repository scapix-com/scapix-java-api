...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_XPATH
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::XPath> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::xml::transform::SourceLocator> p2, jni::ref<com::sun::org::apache::xml::internal::utils::PrefixResolver> p3, jint p4, jni::ref<javax::xml::transform::ErrorListener> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPath> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::xml::transform::SourceLocator> p2, jni::ref<com::sun::org::apache::xml::internal::utils::PrefixResolver> p3, jint p4, jni::ref<javax::xml::transform::ErrorListener> p5, jni::ref<com::sun::org::apache::xpath::internal::compiler::FunctionTable> p6, jni::ref<jdk::xml::internal::XMLSecurityManager> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPath> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::xml::transform::SourceLocator> p2, jni::ref<com::sun::org::apache::xml::internal::utils::PrefixResolver> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPath> new_object(jni::ref<java::lang::String> p1, jni::ref<javax::xml::transform::SourceLocator> p2, jni::ref<com::sun::org::apache::xml::internal::utils::PrefixResolver> p3, jint p4, jni::ref<javax::xml::transform::ErrorListener> p5, jni::ref<com::sun::org::apache::xpath::internal::compiler::FunctionTable> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<com::sun::org::apache::xpath::internal::XPath> new_object(jni::ref<com::sun::org::apache::xpath::internal::Expression> p1) { return object_base::new_object(p1); }
