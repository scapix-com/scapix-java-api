...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XMLSTREAMFILTERIMPL
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::XMLStreamFilterImpl> new_object(jni::ref<javax::xml::stream::XMLStreamReader> p1, jni::ref<javax::xml::stream::StreamFilter> p2) { return object_base::new_object(p1, p2); }
