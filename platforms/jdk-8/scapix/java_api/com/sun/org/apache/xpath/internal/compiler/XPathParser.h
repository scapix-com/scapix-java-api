...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_COMPILER_XPATHPARSER
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::compiler::XPathParser> new_object(jni::ref<javax::xml::transform::ErrorListener> p1, jni::ref<javax::xml::transform::SourceLocator> p2, jni::ref<jdk::xml::internal::XMLSecurityManager> p3) { return object_base::new_object(p1, p2, p3); }
