...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_DTD_XMLCONTENTSPEC
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLContentSpec> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLContentSpec> new_object(jshort p1, jni::ref<java::lang::Object> p2, jni::ref<java::lang::Object> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLContentSpec> new_object(jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLContentSpec> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLContentSpec> new_object(jni::ref<com::sun::org::apache::xerces::internal::impl::dtd::XMLContentSpec_Provider> p1, jint p2) { return object_base::new_object(p1, p2); }
