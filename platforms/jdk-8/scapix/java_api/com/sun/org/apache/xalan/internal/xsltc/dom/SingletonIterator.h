...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SINGLETONITERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SingletonIterator> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SingletonIterator> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SingletonIterator> new_object(jint p1, jboolean p2) { return object_base::new_object(p1, p2); }
