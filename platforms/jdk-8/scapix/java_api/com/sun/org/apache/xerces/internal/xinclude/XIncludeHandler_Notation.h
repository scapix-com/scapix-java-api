...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XINCLUDE_XINCLUDEHANDLER_NOTATION_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XINCLUDE_XINCLUDEHANDLER_NOTATION_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::org::apache::xerces::internal::xinclude { class XIncludeHandler_Notation; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::apache::xerces::internal::xinclude::XIncludeHandler_Notation>
{
	static constexpr fixed_string class_name = "com/sun/org/apache/xerces/internal/xinclude/XIncludeHandler$Notation";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XINCLUDE_XINCLUDEHANDLER_NOTATION_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XINCLUDE_XINCLUDEHANDLER_NOTATION)
#define SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XINCLUDE_XINCLUDEHANDLER_NOTATION
...
class com::sun::org::apache::xerces::internal::xinclude::XIncludeHandler_Notation : public jni::object_base<"com/sun/org/apache/xerces/internal/xinclude/XIncludeHandler$Notation",
	java::lang::Object>
{
public:
...
protected:
	...
	XIncludeHandler_Notation(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_XINCLUDE_XINCLUDEHANDLER_NOTATION
