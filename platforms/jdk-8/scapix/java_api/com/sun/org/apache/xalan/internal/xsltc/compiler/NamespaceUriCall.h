...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class NamespaceUriCall; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::NamespaceUriCall> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::QName> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::NamespaceUriCall> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::QName> p1, jni::ref<java::util::List> p2) { return object_base::new_object(p1, p2); }
