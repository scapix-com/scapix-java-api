...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_CLASSFILE_METHOD
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Method> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Method> new_object(jint p1, jint p2, jint p3, jni::ref<jni::array<com::sun::org::apache::bcel::internal::classfile::Attribute>> p4, jni::ref<com::sun::org::apache::bcel::internal::classfile::ConstantPool> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::org::apache::bcel::internal::classfile::Method> new_object(jni::ref<com::sun::org::apache::bcel::internal::classfile::Method> p1) { return object_base::new_object(p1); }
