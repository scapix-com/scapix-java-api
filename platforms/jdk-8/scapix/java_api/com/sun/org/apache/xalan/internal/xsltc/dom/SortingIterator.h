...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_DOM_SORTINGITERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::SortingIterator> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTMAxisIterator> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::NodeSortRecordFactory> p2) { return object_base::new_object(p1, p2); }
