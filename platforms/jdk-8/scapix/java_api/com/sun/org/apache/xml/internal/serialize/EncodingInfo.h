...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZE_ENCODINGINFO
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serialize::EncodingInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
