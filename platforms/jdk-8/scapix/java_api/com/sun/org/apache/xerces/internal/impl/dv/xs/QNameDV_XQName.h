...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::impl::dv::xs { class QNameDV_XQName; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dv::xs::QNameDV_XQName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
