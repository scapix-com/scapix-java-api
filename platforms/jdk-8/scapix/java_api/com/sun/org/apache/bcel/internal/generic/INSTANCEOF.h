...
namespace scapix::java_api::com::sun::org::apache::bcel::internal::generic { class INSTANCEOF; }
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::INSTANCEOF> new_object(jint p1) { return base_::new_object(p1); }
...
protected:
	...
	INSTANCEOF(handle_type h) : base_(h) {}
