...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::util { class NamespaceSupport_IteratorPrefixes; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::NamespaceSupport_IteratorPrefixes> new_object(jni::ref<com::sun::org::apache::xerces::internal::util::NamespaceSupport> p1, jni::ref<jni::array<java::lang::String>> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
