...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::impl::dv::xs { class AbstractDateTimeDV_DateTimeData; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV_DateTimeData> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV_DateTimeData> new_object(jint p1, jint p2, jint p3, jint p4, jint p5, jdouble p6, jint p7, jni::ref<java::lang::String> p8, jboolean p9, jni::ref<com::sun::org::apache::xerces::internal::impl::dv::xs::AbstractDateTimeDV> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
