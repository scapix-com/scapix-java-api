...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_UTIL_XMLCATALOGRESOLVER
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLCatalogResolver> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLCatalogResolver> new_object(jni::ref<jni::array<java::lang::String>> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::util::XMLCatalogResolver> new_object(jni::ref<jni::array<java::lang::String>> p1, jboolean p2) { return object_base::new_object(p1, p2); }
