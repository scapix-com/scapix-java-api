...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class StepPattern; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::StepPattern> new_object(jint p1, jint p2, jni::ref<java::util::List> p3) { return object_base::new_object(p1, p2, p3); }
