...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZER_TOSAXHANDLER
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToSAXHandler> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToSAXHandler> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<org::xml::sax::ext::LexicalHandler> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::xml::internal::serializer::ToSAXHandler> new_object(jni::ref<org::xml::sax::ContentHandler> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
