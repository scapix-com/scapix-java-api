...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XPATH_XPATH
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xpath::XPath> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::org::apache::xerces::internal::util::SymbolTable> p2, jni::ref<com::sun::org::apache::xerces::internal::xni::NamespaceContext> p3) { return object_base::new_object(p1, p2, p3); }
