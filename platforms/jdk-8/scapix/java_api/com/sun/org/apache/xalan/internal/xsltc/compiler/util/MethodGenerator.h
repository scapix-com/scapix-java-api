...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XALAN_INTERNAL_XSLTC_COMPILER_UTIL_METHODGENERATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::util::MethodGenerator> new_object(jint p1, jni::ref<com::sun::org::apache::bcel::internal::generic::Type> p2, jni::ref<jni::array<com::sun::org::apache::bcel::internal::generic::Type>> p3, jni::ref<jni::array<java::lang::String>> p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6, jni::ref<com::sun::org::apache::bcel::internal::generic::InstructionList> p7, jni::ref<com::sun::org::apache::bcel::internal::generic::ConstantPoolGen> p8) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8); }
