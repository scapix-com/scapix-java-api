...
namespace scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::trax { class DOM2SAX; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::trax::DOM2SAX> new_object(jni::ref<org::w3c::dom::Node> p1) { return base_::new_object(p1); }
