...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_XPATH_REGEX_REGULAREXPRESSION
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xpath::regex::RegularExpression> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xpath::regex::RegularExpression> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::xpath::regex::RegularExpression> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::util::Locale> p3) { return object_base::new_object(p1, p2, p3); }
