...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XPATH_INTERNAL_OBJECTS_XBOOLEANSTATIC
...
public:
	...
	static jni::ref<com::sun::org::apache::xpath::internal::objects::XBooleanStatic> new_object(jboolean p1) { return object_base::new_object(p1); }
