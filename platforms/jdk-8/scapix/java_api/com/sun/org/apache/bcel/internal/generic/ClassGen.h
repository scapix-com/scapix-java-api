...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_CLASSGEN
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::ClassGen> new_object(jni::ref<com::sun::org::apache::bcel::internal::classfile::JavaClass> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::bcel::internal::generic::ClassGen> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4, jni::ref<jni::array<java::lang::String>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::org::apache::bcel::internal::generic::ClassGen> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4, jni::ref<jni::array<java::lang::String>> p5, jni::ref<com::sun::org::apache::bcel::internal::generic::ConstantPoolGen> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
