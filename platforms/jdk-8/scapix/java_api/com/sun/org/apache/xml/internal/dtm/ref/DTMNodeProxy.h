...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_DTM_REF_DTMNODEPROXY
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::dtm::ref::DTMNodeProxy> new_object(jni::ref<com::sun::org::apache::xml::internal::dtm::DTM> p1, jint p2) { return object_base::new_object(p1, p2); }
