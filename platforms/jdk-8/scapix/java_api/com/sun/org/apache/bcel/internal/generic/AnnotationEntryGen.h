...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_BCEL_INTERNAL_GENERIC_ANNOTATIONENTRYGEN
...
public:
	...
	static jni::ref<com::sun::org::apache::bcel::internal::generic::AnnotationEntryGen> new_object(jni::ref<com::sun::org::apache::bcel::internal::classfile::AnnotationEntry> p1, jni::ref<com::sun::org::apache::bcel::internal::generic::ConstantPoolGen> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::org::apache::bcel::internal::generic::AnnotationEntryGen> new_object(jni::ref<com::sun::org::apache::bcel::internal::generic::ObjectType> p1, jni::ref<java::util::List> p2, jboolean p3, jni::ref<com::sun::org::apache::bcel::internal::generic::ConstantPoolGen> p4) { return object_base::new_object(p1, p2, p3, p4); }
