...
namespace scapix::java_api { namespace com::sun::org::apache::xerces::internal::jaxp::validation { class ValidatorHandlerImpl; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorHandlerImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::XSGrammarPoolContainer> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::ValidatorHandlerImpl> new_object(jni::ref<com::sun::org::apache::xerces::internal::jaxp::validation::XMLSchemaValidatorComponentManager> p1) { return object_base::new_object(p1); }
