...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZE_PRINTER
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serialize::Printer> new_object(jni::ref<java::io::Writer> p1, jni::ref<com::sun::org::apache::xml::internal::serialize::OutputFormat> p2) { return object_base::new_object(p1, p2); }
