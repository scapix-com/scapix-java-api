...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::compiler { class TestSeq; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::TestSeq> new_object(jni::ref<java::util::Vector> p1, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::Mode> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::TestSeq> new_object(jni::ref<java::util::Vector> p1, jint p2, jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::Mode> p3) { return object_base::new_object(p1, p2, p3); }
