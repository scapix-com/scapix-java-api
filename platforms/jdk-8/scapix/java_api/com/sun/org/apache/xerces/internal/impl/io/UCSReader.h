...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XERCES_INTERNAL_IMPL_IO_UCSREADER
...
public:
	...
	static jni::ref<com::sun::org::apache::xerces::internal::impl::io::UCSReader> new_object(jni::ref<java::io::InputStream> p1, jshort p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::org::apache::xerces::internal::impl::io::UCSReader> new_object(jni::ref<java::io::InputStream> p1, jint p2, jshort p3) { return object_base::new_object(p1, p2, p3); }
