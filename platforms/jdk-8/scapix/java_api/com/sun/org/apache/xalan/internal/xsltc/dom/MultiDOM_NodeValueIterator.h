...
namespace scapix::java_api { namespace com::sun::org::apache::xalan::internal::xsltc::dom { class MultiDOM_NodeValueIterator; }}
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::MultiDOM_NodeValueIterator> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::dom::MultiDOM> p1, jni::ref<com::sun::org::apache::xml::internal::dtm::DTMAxisIterator> p2, jint p3, jni::ref<java::lang::String> p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
