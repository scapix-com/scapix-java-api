...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_APACHE_XML_INTERNAL_SERIALIZE_LINESEPARATOR
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::serialize::LineSeparator> new_object() { return object_base::new_object(); }
};
