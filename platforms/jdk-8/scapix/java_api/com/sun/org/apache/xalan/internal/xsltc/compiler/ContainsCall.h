...
namespace scapix::java_api::com::sun::org::apache::xalan::internal::xsltc::compiler { class ContainsCall; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::ContainsCall> new_object(jni::ref<com::sun::org::apache::xalan::internal::xsltc::compiler::QName> p1, jni::ref<java::util::List> p2) { return base_::new_object(p1, p2); }
...
protected:
	...
	ContainsCall(handle_type h) : base_(h) {}
