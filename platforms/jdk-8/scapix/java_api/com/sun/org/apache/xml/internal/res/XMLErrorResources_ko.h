...
namespace scapix::java_api::com::sun::org::apache::xml::internal::res { class XMLErrorResources_ko; }
...
public:
	...
	static jni::ref<com::sun::org::apache::xml::internal::res::XMLErrorResources_ko> new_object() { return base_::new_object(); }

protected:

	XMLErrorResources_ko(handle_type h) : base_(h) {}
