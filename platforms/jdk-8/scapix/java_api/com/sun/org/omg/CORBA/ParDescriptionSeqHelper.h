...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_PARDESCRIPTIONSEQHELPER
...
public:
	...
	static jni::ref<com::sun::org::omg::CORBA::ParDescriptionSeqHelper> new_object() { return object_base::new_object(); }
