...
#ifndef SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_VERSIONSPECHELPER_FWD
#define SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_VERSIONSPECHELPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::org::omg::CORBA { class VersionSpecHelper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::org::omg::CORBA::VersionSpecHelper>
{
	static constexpr fixed_string class_name = "com/sun/org/omg/CORBA/VersionSpecHelper";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_VERSIONSPECHELPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_VERSIONSPECHELPER)
#define SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_VERSIONSPECHELPER
...
class com::sun::org::omg::CORBA::VersionSpecHelper : public jni::object_base<"com/sun/org/omg/CORBA/VersionSpecHelper",
	java::lang::Object>
{
public:

	static jni::ref<com::sun::org::omg::CORBA::VersionSpecHelper> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_ORG_OMG_CORBA_VERSIONSPECHELPER
