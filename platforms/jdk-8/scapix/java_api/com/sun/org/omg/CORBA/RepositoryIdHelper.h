...
namespace scapix::java_api::com::sun::org::omg::CORBA { class RepositoryIdHelper; }
...
public:
	...
	static jni::ref<com::sun::org::omg::CORBA::RepositoryIdHelper> new_object() { return base_::new_object(); }
...
protected:
	...
	RepositoryIdHelper(handle_type h) : base_(h) {}
