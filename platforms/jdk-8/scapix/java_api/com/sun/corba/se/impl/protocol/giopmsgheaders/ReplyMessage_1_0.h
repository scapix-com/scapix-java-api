...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_REPLYMESSAGE_1_0_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_REPLYMESSAGE_1_0_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::protocol::giopmsgheaders { class ReplyMessage_1_0; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders::ReplyMessage_1_0>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/protocol/giopmsgheaders/ReplyMessage_1_0";
	using base_classes = std::tuple<scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders::Message_1_0, scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders::ReplyMessage>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_REPLYMESSAGE_1_0_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_REPLYMESSAGE_1_0)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_REPLYMESSAGE_1_0
...
class com::sun::corba::se::impl::protocol::giopmsgheaders::ReplyMessage_1_0 : public jni::object_base<"com/sun/corba/se/impl/protocol/giopmsgheaders/ReplyMessage_1_0",
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_REPLYMESSAGE_1_0
