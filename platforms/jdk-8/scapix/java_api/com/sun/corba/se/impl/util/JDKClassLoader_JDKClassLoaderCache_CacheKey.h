...
namespace scapix::java_api { namespace com::sun::corba::se::impl::util { class JDKClassLoader_JDKClassLoaderCache_CacheKey; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::util::JDKClassLoader_JDKClassLoaderCache_CacheKey> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::ClassLoader> p2) { return object_base::new_object(p1, p2); }
