...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_MONITORING_MONITOREDATTRIBUTEBASE
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::monitoring::MonitoredAttributeBase> new_object(jni::ref<java::lang::String> p1, jni::ref<com::sun::corba::se::spi::monitoring::MonitoredAttributeInfo> p2) { return object_base::new_object(p1, p2); }
