...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_FREEZABLELIST
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::FreezableList> new_object(jni::ref<java::util::List> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::ior::FreezableList> new_object(jni::ref<java::util::List> p1) { return object_base::new_object(p1); }
