...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_GRAPH_GRAPHIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orbutil::graph::GraphImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::impl::orbutil::graph::GraphImpl> new_object(jni::ref<java::util::Collection> p1) { return object_base::new_object(p1); }
