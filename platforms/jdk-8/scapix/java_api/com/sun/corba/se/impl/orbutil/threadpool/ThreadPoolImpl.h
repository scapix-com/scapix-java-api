...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_THREADPOOL_THREADPOOLIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::ThreadPoolImpl> new_object(jni::ref<java::lang::ThreadGroup> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::ThreadPoolImpl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::ThreadPoolImpl> new_object(jint p1, jint p2, jlong p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
