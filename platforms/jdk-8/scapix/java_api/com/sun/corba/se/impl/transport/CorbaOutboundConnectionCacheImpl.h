...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_TRANSPORT_CORBAOUTBOUNDCONNECTIONCACHEIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::transport::CorbaOutboundConnectionCacheImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::pept::transport::ContactInfo> p2) { return object_base::new_object(p1, p2); }
