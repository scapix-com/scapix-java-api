...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_NAMING_COSNAMING_TRANSIENTNAMINGCONTEXT
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::naming::cosnaming::TransientNamingContext> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<org::omg::CORBA::Object> p2, jni::ref<org::omg::PortableServer::POA> p3) { return object_base::new_object(p1, p2, p3); }
