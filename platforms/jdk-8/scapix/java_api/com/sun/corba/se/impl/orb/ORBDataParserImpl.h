...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_ORBDATAPARSERIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orb::ORBDataParserImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::orb::DataCollector> p2) { return object_base::new_object(p1, p2); }
