...
namespace scapix::java_api { namespace com::sun::corba::se::impl::naming::cosnaming { class NamingContextImpl; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::naming::cosnaming::NamingContextImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<org::omg::PortableServer::POA> p2) { return object_base::new_object(p1, p2); }
