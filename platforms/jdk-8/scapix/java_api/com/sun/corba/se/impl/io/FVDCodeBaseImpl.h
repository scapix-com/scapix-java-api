...
namespace scapix::java_api { namespace com::sun::corba::se::impl::io { class FVDCodeBaseImpl; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::io::FVDCodeBaseImpl> new_object() { return object_base::new_object(); }
