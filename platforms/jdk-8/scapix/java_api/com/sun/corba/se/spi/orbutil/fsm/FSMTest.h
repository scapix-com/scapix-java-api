...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ORBUTIL_FSM_FSMTEST
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orbutil::fsm::FSMTest> new_object() { return object_base::new_object(); }
