...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_GENERICTAGGEDCOMPONENT
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::GenericTaggedComponent> new_object(jint p1, jni::ref<org::omg::CORBA_2_3::portable::InputStream> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::ior::GenericTaggedComponent> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
