...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_TRANSPORT_CORBACONTACTINFOLISTITERATORIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::transport::CorbaContactInfoListIteratorImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::transport::CorbaContactInfoList> p2, jni::ref<com::sun::corba::se::pept::transport::ContactInfo> p3, jni::ref<java::util::List> p4) { return object_base::new_object(p1, p2, p3, p4); }
