...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_WRAPPERINPUTSTREAM
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::WrapperInputStream> new_object(jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream> p1) { return object_base::new_object(p1); }
