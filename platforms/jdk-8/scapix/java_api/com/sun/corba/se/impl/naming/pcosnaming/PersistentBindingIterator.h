...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_NAMING_PCOSNAMING_PERSISTENTBINDINGITERATOR
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::naming::pcosnaming::PersistentBindingIterator> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<java::util::Hashtable> p2, jni::ref<org::omg::PortableServer::POA> p3) { return object_base::new_object(p1, p2, p3); }
