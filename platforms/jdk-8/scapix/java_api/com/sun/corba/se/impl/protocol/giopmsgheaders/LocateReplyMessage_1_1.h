...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_LOCATEREPLYMESSAGE_1_1_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_LOCATEREPLYMESSAGE_1_1_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders { class LocateReplyMessage_1_1; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders::LocateReplyMessage_1_1>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/protocol/giopmsgheaders/LocateReplyMessage_1_1";
	using base_classes = std::tuple<scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders::Message_1_1, scapix::java_api::com::sun::corba::se::impl::protocol::giopmsgheaders::LocateReplyMessage>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_LOCATEREPLYMESSAGE_1_1_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_LOCATEREPLYMESSAGE_1_1)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_LOCATEREPLYMESSAGE_1_1
...
class com::sun::corba::se::impl::protocol::giopmsgheaders::LocateReplyMessage_1_1 : public jni::object_base<"com/sun/corba/se/impl/protocol/giopmsgheaders/LocateReplyMessage_1_1",
...
protected:
	...
	LocateReplyMessage_1_1(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_LOCATEREPLYMESSAGE_1_1
