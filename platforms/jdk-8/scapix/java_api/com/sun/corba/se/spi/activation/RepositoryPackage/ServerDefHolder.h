...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ACTIVATION_REPOSITORYPACKAGE_SERVERDEFHOLDER
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::activation::RepositoryPackage::ServerDefHolder> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::spi::activation::RepositoryPackage::ServerDefHolder> new_object(jni::ref<com::sun::corba::se::spi::activation::RepositoryPackage::ServerDef> p1) { return object_base::new_object(p1); }
