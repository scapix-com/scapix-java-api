...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ACTIVATION_SERVERMAIN
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::activation::ServerMain> new_object() { return object_base::new_object(); }
