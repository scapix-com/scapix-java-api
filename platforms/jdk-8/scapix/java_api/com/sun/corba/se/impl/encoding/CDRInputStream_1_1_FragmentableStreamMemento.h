...
namespace scapix::java_api { namespace com::sun::corba::se::impl::encoding { class CDRInputStream_1_1_FragmentableStreamMemento; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream_1_1_FragmentableStreamMemento> new_object(jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream_1_1> p1) { return object_base::new_object(p1); }
