...
namespace scapix::java_api { namespace com::sun::corba::se::spi::orb { class ParserImplTableBase_FieldMap; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orb::ParserImplTableBase_FieldMap> new_object(jni::ref<jni::array<com::sun::corba::se::spi::orb::ParserData>> p1, jboolean p2) { return object_base::new_object(p1, p2); }
