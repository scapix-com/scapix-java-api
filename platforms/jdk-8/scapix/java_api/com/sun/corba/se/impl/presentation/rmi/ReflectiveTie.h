...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_REFLECTIVETIE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::presentation::rmi::ReflectiveTie> new_object(jni::ref<com::sun::corba::se::spi::presentation::rmi::PresentationManager> p1, jni::ref<com::sun::corba::se::impl::logging::ORBUtilSystemException> p2) { return object_base::new_object(p1, p2); }
