...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_CORBA_ANYIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::corba::AnyImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::corba::AnyImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<org::omg::CORBA::Any> p2) { return object_base::new_object(p1, p2); }
