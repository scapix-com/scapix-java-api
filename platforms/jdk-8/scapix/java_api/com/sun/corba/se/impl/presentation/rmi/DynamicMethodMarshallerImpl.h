...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_DYNAMICMETHODMARSHALLERIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_DYNAMICMETHODMARSHALLERIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::corba::se::impl::presentation::rmi { class DynamicMethodMarshallerImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::presentation::rmi::DynamicMethodMarshallerImpl>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/presentation/rmi/DynamicMethodMarshallerImpl";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::com::sun::corba::se::spi::presentation::rmi::DynamicMethodMarshaller>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_DYNAMICMETHODMARSHALLERIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_DYNAMICMETHODMARSHALLERIMPL)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_DYNAMICMETHODMARSHALLERIMPL
...
class com::sun::corba::se::impl::presentation::rmi::DynamicMethodMarshallerImpl : public jni::object_base<"com/sun/corba/se/impl/presentation/rmi/DynamicMethodMarshallerImpl",
	java::lang::Object,
	com::sun::corba::se::spi::presentation::rmi::DynamicMethodMarshaller>
{
public:

	using ReaderWriter = DynamicMethodMarshallerImpl_ReaderWriter;

	static jni::ref<com::sun::corba::se::impl::presentation::rmi::DynamicMethodMarshallerImpl_ReaderWriter> makeReaderWriter(jni::ref<java::lang::Class> p1) { return call_static_method<"makeReaderWriter", jni::ref<com::sun::corba::se::impl::presentation::rmi::DynamicMethodMarshallerImpl_ReaderWriter>>(p1); }
	static jni::ref<com::sun::corba::se::impl::presentation::rmi::DynamicMethodMarshallerImpl> new_object(jni::ref<java::lang::reflect::Method> p1) { return base_::new_object(p1); }
...
protected:
	...
	DynamicMethodMarshallerImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_DYNAMICMETHODMARSHALLERIMPL
