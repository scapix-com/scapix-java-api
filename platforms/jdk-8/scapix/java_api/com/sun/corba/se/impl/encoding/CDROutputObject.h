...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTOBJECT
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::CDROutputObject> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::pept::protocol::MessageMediator> p2, jni::ref<com::sun::corba::se::impl::protocol::giopmsgheaders::Message> p3, jbyte p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::corba::se::impl::encoding::CDROutputObject> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::pept::protocol::MessageMediator> p2, jni::ref<com::sun::corba::se::impl::protocol::giopmsgheaders::Message> p3, jbyte p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::corba::se::impl::encoding::CDROutputObject> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::protocol::CorbaMessageMediator> p2, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p3, jni::ref<com::sun::corba::se::spi::transport::CorbaConnection> p4, jni::ref<com::sun::corba::se::impl::protocol::giopmsgheaders::Message> p5, jbyte p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
