...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_EXTENSION_REQUESTPARTITIONINGPOLICY
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::extension::RequestPartitioningPolicy> new_object(jint p1) { return object_base::new_object(p1); }
