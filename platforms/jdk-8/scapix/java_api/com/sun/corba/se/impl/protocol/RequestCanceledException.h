...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_REQUESTCANCELEDEXCEPTION
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::protocol::RequestCanceledException> new_object(jint p1) { return object_base::new_object(p1); }
