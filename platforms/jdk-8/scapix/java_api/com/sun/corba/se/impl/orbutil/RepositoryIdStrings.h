...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_REPOSITORYIDSTRINGS_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_REPOSITORYIDSTRINGS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::orbutil { class RepositoryIdStrings; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::orbutil::RepositoryIdStrings>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/orbutil/RepositoryIdStrings";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_REPOSITORYIDSTRINGS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_REPOSITORYIDSTRINGS)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_REPOSITORYIDSTRINGS
...
class com::sun::corba::se::impl::orbutil::RepositoryIdStrings : public jni::object_base<"com/sun/corba/se/impl/orbutil/RepositoryIdStrings",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_REPOSITORYIDSTRINGS
