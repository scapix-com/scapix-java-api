...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ORB_STRINGPAIR
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orb::StringPair> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
