...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_CORBA_CONTEXTIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::corba::ContextImpl> new_object(jni::ref<org::omg::CORBA::ORB> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::corba::ContextImpl> new_object(jni::ref<org::omg::CORBA::Context> p1) { return object_base::new_object(p1); }
