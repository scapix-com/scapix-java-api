...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_TRANSPORT_SHAREDCDRCONTACTINFOIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::transport::SharedCDRContactInfoImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::transport::CorbaContactInfoList> p2, jni::ref<com::sun::corba::se::spi::ior::IOR> p3, jshort p4) { return object_base::new_object(p1, p2, p3, p4); }
