...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_IDLJAVASERIALIZATIONOUTPUTSTREAM_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_IDLJAVASERIALIZATIONOUTPUTSTREAM_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::corba::se::impl::encoding { class IDLJavaSerializationOutputStream; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::encoding::IDLJavaSerializationOutputStream>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/encoding/IDLJavaSerializationOutputStream";
	using base_classes = std::tuple<scapix::java_api::com::sun::corba::se::impl::encoding::CDROutputStreamBase>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_IDLJAVASERIALIZATIONOUTPUTSTREAM_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_IDLJAVASERIALIZATIONOUTPUTSTREAM)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_IDLJAVASERIALIZATIONOUTPUTSTREAM
...
// private
class com::sun::corba::se::impl::encoding::IDLJavaSerializationOutputStream : public jni::object_base<"com/sun/corba/se/impl/encoding/IDLJavaSerializationOutputStream",
	com::sun::corba::se::impl::encoding::CDROutputStreamBase>
{
public:

	static jni::ref<com::sun::corba::se::impl::encoding::IDLJavaSerializationOutputStream> new_object(jbyte p1) { return base_::new_object(p1); }
...
protected:
	...
	IDLJavaSerializationOutputStream(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_IDLJAVASERIALIZATIONOUTPUTSTREAM
