...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IORIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::IORImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::ior::IORImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::ior::IORImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<java::lang::String> p2, jni::ref<com::sun::corba::se::spi::ior::IORTemplate> p3, jni::ref<com::sun::corba::se::spi::ior::ObjectId> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::corba::se::impl::ior::IORImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<java::lang::String> p2, jni::ref<com::sun::corba::se::spi::ior::IORTemplateList> p3, jni::ref<com::sun::corba::se::spi::ior::ObjectId> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::corba::se::impl::ior::IORImpl> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1) { return object_base::new_object(p1); }
