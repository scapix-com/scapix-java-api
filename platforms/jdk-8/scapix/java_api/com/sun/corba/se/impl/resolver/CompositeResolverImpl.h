...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_RESOLVER_COMPOSITERESOLVERIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::resolver::CompositeResolverImpl> new_object(jni::ref<com::sun::corba::se::spi::resolver::Resolver> p1, jni::ref<com::sun::corba::se::spi::resolver::Resolver> p2) { return object_base::new_object(p1, p2); }
