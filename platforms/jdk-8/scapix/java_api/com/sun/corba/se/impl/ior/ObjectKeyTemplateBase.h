...
namespace scapix::java_api { namespace com::sun::corba::se::impl::ior { class ObjectKeyTemplateBase; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::ObjectKeyTemplateBase> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jint p3, jint p4, jni::ref<java::lang::String> p5, jni::ref<com::sun::corba::se::spi::ior::ObjectAdapterId> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
