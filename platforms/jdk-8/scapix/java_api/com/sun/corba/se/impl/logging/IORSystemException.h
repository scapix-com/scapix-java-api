...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_LOGGING_IORSYSTEMEXCEPTION
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::logging::IORSystemException> new_object(jni::ref<java::util::logging::Logger> p1) { return object_base::new_object(p1); }
