...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_TYPECODEINPUTSTREAM
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::TypeCodeInputStream> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<jni::array<jbyte>> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::corba::se::impl::encoding::TypeCodeInputStream> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<jni::array<jbyte>> p2, jint p3, jboolean p4, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::corba::se::impl::encoding::TypeCodeInputStream> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<java::nio::ByteBuffer> p2, jint p3, jboolean p4, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
