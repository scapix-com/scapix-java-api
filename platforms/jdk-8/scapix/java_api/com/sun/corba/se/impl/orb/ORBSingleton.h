...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_ORBSINGLETON
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orb::ORBSingleton> new_object() { return object_base::new_object(); }
