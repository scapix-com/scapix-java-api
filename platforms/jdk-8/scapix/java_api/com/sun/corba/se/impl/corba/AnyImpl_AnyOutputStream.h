...
namespace scapix::java_api { namespace com::sun::corba::se::impl::corba { class AnyImpl_AnyOutputStream; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::corba::AnyImpl_AnyOutputStream> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
