...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_OA_TOA_TOAIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::oa::toa::TOAImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::impl::oa::toa::TransientObjectManager> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
