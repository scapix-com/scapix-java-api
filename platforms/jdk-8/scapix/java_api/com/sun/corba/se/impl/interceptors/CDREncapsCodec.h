...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_CDRENCAPSCODEC
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::interceptors::CDREncapsCodec> new_object(jni::ref<org::omg::CORBA::ORB> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
