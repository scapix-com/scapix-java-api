...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ORBUTIL_FSM_FSMIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orbutil::fsm::FSMImpl> new_object(jni::ref<com::sun::corba::se::spi::orbutil::fsm::StateEngine> p1, jni::ref<com::sun::corba::se::spi::orbutil::fsm::State> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::spi::orbutil::fsm::FSMImpl> new_object(jni::ref<com::sun::corba::se::spi::orbutil::fsm::StateEngine> p1, jni::ref<com::sun::corba::se::spi::orbutil::fsm::State> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
