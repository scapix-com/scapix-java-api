...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_CONCURRENT_CONDVAR
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orbutil::concurrent::CondVar> new_object(jni::ref<com::sun::corba::se::impl::orbutil::concurrent::Sync> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::orbutil::concurrent::CondVar> new_object(jni::ref<com::sun::corba::se::impl::orbutil::concurrent::Sync> p1) { return object_base::new_object(p1); }
