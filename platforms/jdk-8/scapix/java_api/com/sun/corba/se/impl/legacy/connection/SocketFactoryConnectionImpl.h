...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_LEGACY_CONNECTION_SOCKETFACTORYCONNECTIONIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::legacy::connection::SocketFactoryConnectionImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::transport::CorbaContactInfo> p2, jboolean p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
