...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_STUBIORIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::StubIORImpl> new_object() { return object_base::new_object(); }
	jni::ref<java::lang::String> getRepositoryId() { return call_method<"getRepositoryId", jni::ref<java::lang::String>>(); }
	static jni::ref<com::sun::corba::se::impl::ior::StubIORImpl> new_object(jni::ref<org::omg::CORBA::Object> p1) { return object_base::new_object(p1); }
