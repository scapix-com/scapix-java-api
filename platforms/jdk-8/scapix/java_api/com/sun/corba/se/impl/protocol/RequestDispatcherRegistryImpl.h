...
namespace scapix::java_api { namespace com::sun::corba::se::impl::protocol { class RequestDispatcherRegistryImpl; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::protocol::RequestDispatcherRegistryImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2) { return object_base::new_object(p1, p2); }
