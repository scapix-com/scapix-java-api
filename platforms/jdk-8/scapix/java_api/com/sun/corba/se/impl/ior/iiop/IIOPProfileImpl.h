...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IIOP_IIOPPROFILEIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::iiop::IIOPProfileImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::ior::ObjectKeyTemplate> p2, jni::ref<com::sun::corba::se::spi::ior::ObjectId> p3, jni::ref<com::sun::corba::se::spi::ior::iiop::IIOPProfileTemplate> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::corba::se::impl::ior::iiop::IIOPProfileImpl> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::ior::iiop::IIOPProfileImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<org::omg::IOP::TaggedProfile> p2) { return object_base::new_object(p1, p2); }
