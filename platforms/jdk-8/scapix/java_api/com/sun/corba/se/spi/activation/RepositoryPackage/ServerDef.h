...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ACTIVATION_REPOSITORYPACKAGE_SERVERDEF
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::activation::RepositoryPackage::ServerDef> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::spi::activation::RepositoryPackage::ServerDef> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
};
