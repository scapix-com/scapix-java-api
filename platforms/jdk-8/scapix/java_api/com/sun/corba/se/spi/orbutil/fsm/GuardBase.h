...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ORBUTIL_FSM_GUARDBASE
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orbutil::fsm::GuardBase> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
