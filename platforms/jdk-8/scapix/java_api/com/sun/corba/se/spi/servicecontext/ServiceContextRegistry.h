...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_SERVICECONTEXT_SERVICECONTEXTREGISTRY
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::servicecontext::ServiceContextRegistry> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
