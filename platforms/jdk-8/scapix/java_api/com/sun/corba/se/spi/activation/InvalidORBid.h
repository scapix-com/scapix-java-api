...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ACTIVATION_INVALIDORBID
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::activation::InvalidORBid> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::spi::activation::InvalidORBid> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
