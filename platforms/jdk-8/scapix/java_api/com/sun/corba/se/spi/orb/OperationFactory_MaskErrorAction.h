...
namespace scapix::java_api { namespace com::sun::corba::se::spi::orb { class OperationFactory_MaskErrorAction; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orb::OperationFactory_MaskErrorAction> new_object(jni::ref<com::sun::corba::se::spi::orb::Operation> p1) { return object_base::new_object(p1); }
