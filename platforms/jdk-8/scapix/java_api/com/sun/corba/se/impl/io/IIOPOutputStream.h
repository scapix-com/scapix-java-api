...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_IIOPOUTPUTSTREAM
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::io::IIOPOutputStream> new_object() { return object_base::new_object(); }
