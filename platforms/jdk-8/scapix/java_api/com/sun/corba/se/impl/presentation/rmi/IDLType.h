...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PRESENTATION_RMI_IDLTYPE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::presentation::rmi::IDLType> new_object(jni::ref<java::lang::Class> p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::corba::se::impl::presentation::rmi::IDLType> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
