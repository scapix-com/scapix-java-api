...
namespace scapix::java_api { namespace com::sun::corba::se::impl::encoding { class CDRInputStream; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream> new_object(jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<java::nio::ByteBuffer> p2, jint p3, jboolean p4, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p5, jbyte p6, jni::ref<com::sun::corba::se::impl::encoding::BufferManagerRead> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
