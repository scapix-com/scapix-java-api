...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_TRANSPORT_LISTENERTHREADIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::transport::ListenerThreadImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::pept::transport::Acceptor> p2, jni::ref<com::sun::corba::se::pept::transport::Selector> p3) { return object_base::new_object(p1, p2, p3); }
