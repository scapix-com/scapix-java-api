...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_GENERICTAGGEDPROFILE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::GenericTaggedProfile> new_object(jint p1, jni::ref<org::omg::CORBA_2_3::portable::InputStream> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::ior::GenericTaggedProfile> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
