...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IIOP_JAVACODEBASECOMPONENTIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::iiop::JavaCodebaseComponentImpl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
