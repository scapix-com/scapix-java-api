...
namespace scapix::java_api { namespace com::sun::corba::se::impl::orbutil { class ObjectWriter_IndentingObjectWriter; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orbutil::ObjectWriter_IndentingObjectWriter> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
