...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IORTEMPLATEIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::IORTemplateImpl> new_object(jni::ref<com::sun::corba::se::spi::ior::ObjectKeyTemplate> p1) { return object_base::new_object(p1); }
	...
	static jni::ref<com::sun::corba::se::impl::ior::IORTemplateImpl> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1) { return object_base::new_object(p1); }
};
