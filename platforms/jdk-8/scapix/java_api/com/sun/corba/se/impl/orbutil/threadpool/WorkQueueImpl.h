...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_THREADPOOL_WORKQUEUEIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::WorkQueueImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::WorkQueueImpl> new_object(jni::ref<com::sun::corba::se::spi::orbutil::threadpool::ThreadPool> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::WorkQueueImpl> new_object(jni::ref<com::sun::corba::se::spi::orbutil::threadpool::ThreadPool> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
