...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_UTIL_JDKBRIDGE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::util::JDKBridge> new_object() { return object_base::new_object(); }
