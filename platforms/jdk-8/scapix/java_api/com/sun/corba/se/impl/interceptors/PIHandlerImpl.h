...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_PIHANDLERIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_PIHANDLERIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::interceptors { class PIHandlerImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::interceptors::PIHandlerImpl>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/interceptors/PIHandlerImpl";
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_PIHANDLERIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_PIHANDLERIMPL)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_PIHANDLERIMPL
...
class com::sun::corba::se::impl::interceptors::PIHandlerImpl : public jni::object_base<"com/sun/corba/se/impl/interceptors/PIHandlerImpl",
	java::lang::Object,
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::interceptors::PIHandlerImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<jni::array<java::lang::String>> p2) { return object_base::new_object(p1, p2); }
	...
	jni::ref<java::lang::Exception> handleClientPIEndingPoint(jint p1, jni::ref<java::lang::Exception> p2, jboolean p3) { return call_method<"handleClientPIEndingPoint", jni::ref<java::lang::Exception>>(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_INTERCEPTORS_PIHANDLERIMPL
