...
namespace scapix::java_api::com::sun::corba::se::impl::interceptors { class PIHandlerImpl; }
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::interceptors::PIHandlerImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<jni::array<java::lang::String>> p2) { return base_::new_object(p1, p2); }
...
protected:
	...
	PIHandlerImpl(handle_type h) : base_(h) {}
