...
namespace com::sun::corba::se::spi::resolver {
...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_RESOLVER_RESOLVERDEFAULT
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::resolver::ResolverDefault> new_object() { return object_base::new_object(); }
