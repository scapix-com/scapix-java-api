...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_WIREOBJECTKEYTEMPLATE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::WireObjectKeyTemplate> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::ior::WireObjectKeyTemplate> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1, jni::ref<org::omg::CORBA::OctetSeqHolder> p2) { return object_base::new_object(p1, p2); }
