...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IIOP_MAXSTREAMFORMATVERSIONCOMPONENTIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::iiop::MaxStreamFormatVersionComponentImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::impl::ior::iiop::MaxStreamFormatVersionComponentImpl> new_object(jbyte p1) { return object_base::new_object(p1); }
