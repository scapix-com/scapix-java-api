...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_OUTPUTSTREAMHOOK_HOOKPUTFIELDS_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_OUTPUTSTREAMHOOK_HOOKPUTFIELDS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::corba::se::impl::io { class OutputStreamHook_HookPutFields; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::io::OutputStreamHook_HookPutFields>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/io/OutputStreamHook$HookPutFields";
	using base_classes = std::tuple<scapix::java_api::java::io::ObjectOutputStream_PutField>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_OUTPUTSTREAMHOOK_HOOKPUTFIELDS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_OUTPUTSTREAMHOOK_HOOKPUTFIELDS)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_OUTPUTSTREAMHOOK_HOOKPUTFIELDS
...
// private
class com::sun::corba::se::impl::io::OutputStreamHook_HookPutFields : public jni::object_base<"com/sun/corba/se/impl/io/OutputStreamHook$HookPutFields",
...
protected:
	...
	OutputStreamHook_HookPutFields(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IO_OUTPUTSTREAMHOOK_HOOKPUTFIELDS
