...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_OBJECTREFERENCEFACTORYIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::ObjectReferenceFactoryImpl> new_object(jni::ref<org::omg::CORBA::portable::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::impl::ior::ObjectReferenceFactoryImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::ior::IORTemplateList> p2) { return object_base::new_object(p1, p2); }
