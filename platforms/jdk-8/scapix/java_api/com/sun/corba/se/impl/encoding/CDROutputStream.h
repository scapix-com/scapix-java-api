...
#include <scapix/java_api/org/omg/CORBA/portable/ValueOutputStream.h>

#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAM_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAM_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::com::sun::corba::se::impl::encoding { class CDROutputStream; }

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::encoding::CDROutputStream>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/encoding/CDROutputStream";
	using base_classes = std::tuple<scapix::java_api::org::omg::CORBA_2_3::portable::OutputStream, scapix::java_api::com::sun::corba::se::impl::encoding::MarshalOutputStream, scapix::java_api::org::omg::CORBA::DataOutputStream, scapix::java_api::org::omg::CORBA::portable::ValueOutputStream>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAM_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAM)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAM
...
class com::sun::corba::se::impl::encoding::CDROutputStream : public jni::object_base<"com/sun/corba/se/impl/encoding/CDROutputStream",
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::CDROutputStream> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p2, jbyte p3, jboolean p4, jni::ref<com::sun::corba::se::impl::encoding::BufferManagerWrite> p5, jbyte p6, jboolean p7) { return base_::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<com::sun::corba::se::impl::encoding::CDROutputStream> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p2, jbyte p3, jboolean p4, jni::ref<com::sun::corba::se::impl::encoding::BufferManagerWrite> p5, jbyte p6) { return base_::new_object(p1, p2, p3, p4, p5, p6); }
...
protected:
	...
	CDROutputStream(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAM
