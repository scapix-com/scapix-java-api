...
namespace scapix::java_api::com::sun::corba::se::impl::orb { class ORBImpl; }
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orb::ORBImpl> new_object() { return base_::new_object(); }
