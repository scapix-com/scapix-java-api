...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_JIDLOBJECTKEYTEMPLATE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::JIDLObjectKeyTemplate> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jint p3, jni::ref<org::omg::CORBA_2_3::portable::InputStream> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<com::sun::corba::se::impl::ior::JIDLObjectKeyTemplate> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jint p3, jni::ref<org::omg::CORBA_2_3::portable::InputStream> p4, jni::ref<org::omg::CORBA::OctetSeqHolder> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::corba::se::impl::ior::JIDLObjectKeyTemplate> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
};
