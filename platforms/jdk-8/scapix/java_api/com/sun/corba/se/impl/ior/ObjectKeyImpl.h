...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_OBJECTKEYIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::ObjectKeyImpl> new_object(jni::ref<com::sun::corba::se::spi::ior::ObjectKeyTemplate> p1, jni::ref<com::sun::corba::se::spi::ior::ObjectId> p2) { return object_base::new_object(p1, p2); }
