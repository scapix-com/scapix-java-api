...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_NEWOBJECTKEYTEMPLATEBASE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::NewObjectKeyTemplateBase> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jint p3, jint p4, jni::ref<java::lang::String> p5, jni::ref<com::sun::corba::se::spi::ior::ObjectAdapterId> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
