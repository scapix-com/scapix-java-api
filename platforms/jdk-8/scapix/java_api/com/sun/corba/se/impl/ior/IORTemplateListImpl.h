...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IORTEMPLATELISTIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::IORTemplateListImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::impl::ior::IORTemplateListImpl> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1) { return object_base::new_object(p1); }
