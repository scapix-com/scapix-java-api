...
namespace com::sun::corba::se::internal::Interceptors {
...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_INTERNAL_INTERCEPTORS_PIORB
...
public:
	...
	static jni::ref<com::sun::corba::se::internal::Interceptors::PIORB> new_object() { return object_base::new_object(); }
};
