...
namespace scapix::java_api { namespace com::sun::corba::se::impl::encoding { class IDLJavaSerializationInputStream; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::IDLJavaSerializationInputStream> new_object(jbyte p1) { return object_base::new_object(p1); }
