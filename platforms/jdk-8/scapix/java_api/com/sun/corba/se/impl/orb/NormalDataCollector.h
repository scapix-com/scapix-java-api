...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_NORMALDATACOLLECTOR
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orb::NormalDataCollector> new_object(jni::ref<jni::array<java::lang::String>> p1, jni::ref<java::util::Properties> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
