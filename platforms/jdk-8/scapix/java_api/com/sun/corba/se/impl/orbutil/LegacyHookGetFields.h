...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_LEGACYHOOKGETFIELDS_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_LEGACYHOOKGETFIELDS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::orbutil { class LegacyHookGetFields; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::orbutil::LegacyHookGetFields>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/orbutil/LegacyHookGetFields";
	using base_classes = std::tuple<scapix::java_api::java::io::ObjectInputStream_GetField>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_LEGACYHOOKGETFIELDS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_LEGACYHOOKGETFIELDS)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_LEGACYHOOKGETFIELDS
...
// private
class com::sun::corba::se::impl::orbutil::LegacyHookGetFields : public jni::object_base<"com/sun/corba/se/impl/orbutil/LegacyHookGetFields",
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_LEGACYHOOKGETFIELDS
