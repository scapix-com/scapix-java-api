...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_NAMING_PCOSNAMING_NAMESERVICE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::naming::pcosnaming::NameService> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<java::io::File> p2) { return object_base::new_object(p1, p2); }
