...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_TRANSPORT_SOCKETORCHANNELCONNECTIONIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::transport::SocketOrChannelConnectionImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::transport::CorbaContactInfo> p2, jboolean p3, jboolean p4, jni::ref<java::lang::String> p5, jni::ref<java::lang::String> p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<com::sun::corba::se::impl::transport::SocketOrChannelConnectionImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::transport::CorbaContactInfo> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::corba::se::impl::transport::SocketOrChannelConnectionImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::pept::transport::Acceptor> p2, jni::ref<java::net::Socket> p3, jboolean p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<com::sun::corba::se::impl::transport::SocketOrChannelConnectionImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::pept::transport::Acceptor> p2, jni::ref<java::net::Socket> p3) { return object_base::new_object(p1, p2, p3); }
