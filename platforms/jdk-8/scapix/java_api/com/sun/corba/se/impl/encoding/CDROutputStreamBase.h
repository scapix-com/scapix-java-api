...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAMBASE_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAMBASE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::encoding { class CDROutputStreamBase; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::encoding::CDROutputStreamBase>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/encoding/CDROutputStreamBase";
	using base_classes = std::tuple<scapix::java_api::java::io::OutputStream>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAMBASE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAMBASE)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAMBASE
...
// private
class com::sun::corba::se::impl::encoding::CDROutputStreamBase : public jni::object_base<"com/sun/corba/se/impl/encoding/CDROutputStreamBase",
	java::io::OutputStream>
{
public:

	void setParent(jni::ref<com::sun::corba::se::impl::encoding::CDROutputStream> p1) { return call_method<"setParent", void>(p1); }
	void init(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<com::sun::corba::se::impl::encoding::BufferManagerWrite> p2, jbyte p3) { return call_method<"init", void>(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDROUTPUTSTREAMBASE
