...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_ACTIVATION_SERVERALREADYUNINSTALLED
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::activation::ServerAlreadyUninstalled> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::spi::activation::ServerAlreadyUninstalled> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::spi::activation::ServerAlreadyUninstalled> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
};
