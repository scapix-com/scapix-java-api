...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_CORBA_SERVERREQUESTIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::corba::ServerRequestImpl> new_object(jni::ref<com::sun::corba::se::spi::protocol::CorbaMessageMediator> p1, jni::ref<com::sun::corba::se::spi::orb::ORB> p2) { return object_base::new_object(p1, p2); }
