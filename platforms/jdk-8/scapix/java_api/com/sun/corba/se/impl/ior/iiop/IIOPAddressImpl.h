...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IIOP_IIOPADDRESSIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::iiop::IIOPAddressImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::corba::se::impl::ior::iiop::IIOPAddressImpl> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1) { return object_base::new_object(p1); }
