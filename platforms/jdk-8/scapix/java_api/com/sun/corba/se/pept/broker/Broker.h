...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_PEPT_BROKER_BROKER_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_PEPT_BROKER_BROKER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::pept::broker { class Broker; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::pept::broker::Broker>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/pept/broker/Broker";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_PEPT_BROKER_BROKER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_PEPT_BROKER_BROKER)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_PEPT_BROKER_BROKER
...
class com::sun::corba::se::pept::broker::Broker : public jni::object_base<"com/sun/corba/se/pept/broker/Broker",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_PEPT_BROKER_BROKER
