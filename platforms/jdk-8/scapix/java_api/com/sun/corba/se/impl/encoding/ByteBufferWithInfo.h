...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_BYTEBUFFERWITHINFO
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::ByteBufferWithInfo> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<java::nio::ByteBuffer> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::corba::se::impl::encoding::ByteBufferWithInfo> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<java::nio::ByteBuffer> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::encoding::ByteBufferWithInfo> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<com::sun::corba::se::impl::encoding::BufferManagerWrite> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::impl::encoding::ByteBufferWithInfo> new_object(jni::ref<org::omg::CORBA::ORB> p1, jni::ref<com::sun::corba::se::impl::encoding::BufferManagerWrite> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<com::sun::corba::se::impl::encoding::ByteBufferWithInfo> new_object(jni::ref<com::sun::corba::se::impl::encoding::ByteBufferWithInfo> p1) { return object_base::new_object(p1); }
