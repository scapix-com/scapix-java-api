...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_PARSERTABLE_TESTACCEPTOR1_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_PARSERTABLE_TESTACCEPTOR1_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::orb { class ParserTable_TestAcceptor1; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::orb::ParserTable_TestAcceptor1>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/orb/ParserTable$TestAcceptor1";
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_PARSERTABLE_TESTACCEPTOR1_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_PARSERTABLE_TESTACCEPTOR1)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_PARSERTABLE_TESTACCEPTOR1
...
class com::sun::corba::se::impl::orb::ParserTable_TestAcceptor1 : public jni::object_base<"com/sun/corba/se/impl/orb/ParserTable$TestAcceptor1",
	java::lang::Object,
	com::sun::corba::se::pept::transport::Acceptor>
{
public:

	static jni::ref<com::sun::corba::se::impl::orb::ParserTable_TestAcceptor1> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORB_PARSERTABLE_TESTACCEPTOR1
