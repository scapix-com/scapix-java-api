...
namespace scapix::java_api { namespace com::sun::corba::se::impl::transport { class EventHandlerBase; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::transport::EventHandlerBase> new_object() { return object_base::new_object(); }
