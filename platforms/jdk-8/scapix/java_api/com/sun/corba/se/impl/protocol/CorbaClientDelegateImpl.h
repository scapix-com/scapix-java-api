...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_CORBACLIENTDELEGATEIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::protocol::CorbaClientDelegateImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jni::ref<com::sun::corba::se::spi::transport::CorbaContactInfoList> p2) { return object_base::new_object(p1, p2); }
