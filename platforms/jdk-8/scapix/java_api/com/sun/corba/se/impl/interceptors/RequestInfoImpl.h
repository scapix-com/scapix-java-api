...
namespace scapix::java_api { namespace com::sun::corba::se::impl::interceptors { class RequestInfoImpl; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::interceptors::RequestInfoImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
