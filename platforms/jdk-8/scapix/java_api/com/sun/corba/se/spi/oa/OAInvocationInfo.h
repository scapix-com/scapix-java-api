...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_OA_OAINVOCATIONINFO
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::oa::OAInvocationInfo> new_object(jni::ref<com::sun::corba::se::spi::oa::ObjectAdapter> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<com::sun::corba::se::spi::oa::OAInvocationInfo> new_object(jni::ref<com::sun::corba::se::spi::oa::OAInvocationInfo> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
