...
namespace scapix::java_api { namespace com::sun::corba::se::spi::orb { class OperationFactory_IndexAction; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::orb::OperationFactory_IndexAction> new_object(jint p1) { return object_base::new_object(p1); }
