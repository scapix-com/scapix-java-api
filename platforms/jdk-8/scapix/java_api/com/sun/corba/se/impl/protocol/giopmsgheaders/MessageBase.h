...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_GIOPMSGHEADERS_MESSAGEBASE
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::protocol::giopmsgheaders::MessageBase> new_object() { return object_base::new_object(); }
