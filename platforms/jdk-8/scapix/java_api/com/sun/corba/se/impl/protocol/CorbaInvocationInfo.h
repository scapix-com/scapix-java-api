...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_CORBAINVOCATIONINFO
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::protocol::CorbaInvocationInfo> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1) { return object_base::new_object(p1); }
