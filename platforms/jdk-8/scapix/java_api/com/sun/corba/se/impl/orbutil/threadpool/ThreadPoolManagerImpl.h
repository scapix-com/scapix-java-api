...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ORBUTIL_THREADPOOL_THREADPOOLMANAGERIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::orbutil::threadpool::ThreadPoolManagerImpl> new_object() { return object_base::new_object(); }
