...
namespace scapix::java_api::com::sun::corba::se::impl::encoding { class CDRInputStream_1_0; }
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream_1_0> new_object() { return base_::new_object(); }
...
protected:
	...
	CDRInputStream_1_0(handle_type h) : base_(h) {}
