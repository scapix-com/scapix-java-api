...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDRINPUTSTREAM_1_0_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDRINPUTSTREAM_1_0_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::impl::encoding { class CDRInputStream_1_0; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::impl::encoding::CDRInputStream_1_0>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/impl/encoding/CDRInputStream_1_0";
	using base_classes = std::tuple<scapix::java_api::com::sun::corba::se::impl::encoding::CDRInputStreamBase, scapix::java_api::com::sun::corba::se::impl::encoding::RestorableInputStream>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDRINPUTSTREAM_1_0_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDRINPUTSTREAM_1_0)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDRINPUTSTREAM_1_0
...
class com::sun::corba::se::impl::encoding::CDRInputStream_1_0 : public jni::object_base<"com/sun/corba/se/impl/encoding/CDRInputStream_1_0",
	com::sun::corba::se::impl::encoding::CDRInputStreamBase,
	com::sun::corba::se::impl::encoding::RestorableInputStream>
{
public:

	static jni::ref<com::sun::corba::se::impl::encoding::CDRInputStream_1_0> new_object() { return object_base::new_object(); }
	...
	jdouble read_longdouble() { return call_method<"read_longdouble", jdouble>(); }
	...
	static jni::ref<org::omg::CORBA::Object> internalIORToObject(jni::ref<com::sun::corba::se::spi::ior::IOR> p1, jni::ref<com::sun::corba::se::spi::presentation::rmi::PresentationManager_StubFactory> p2, jni::ref<com::sun::corba::se::spi::orb::ORB> p3) { return call_static_method<"internalIORToObject", jni::ref<org::omg::CORBA::Object>>(p1, p2, p3); }
	...
	void read_any_array(jni::ref<jni::array<org::omg::CORBA::Any>> p1, jint p2, jint p3) { return call_method<"read_any_array", void>(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_ENCODING_CDRINPUTSTREAM_1_0
