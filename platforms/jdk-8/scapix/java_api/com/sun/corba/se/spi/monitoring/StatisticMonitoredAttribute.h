...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_MONITORING_STATISTICMONITOREDATTRIBUTE
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::monitoring::StatisticMonitoredAttribute> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<com::sun::corba::se::spi::monitoring::StatisticsAccumulator> p3, jni::ref<java::lang::Object> p4) { return object_base::new_object(p1, p2, p3, p4); }
