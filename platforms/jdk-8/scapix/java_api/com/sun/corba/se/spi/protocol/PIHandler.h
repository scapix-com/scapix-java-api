...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_PROTOCOL_PIHANDLER_FWD
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_PROTOCOL_PIHANDLER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::corba::se::spi::protocol { class PIHandler; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::corba::se::spi::protocol::PIHandler>
{
	static constexpr fixed_string class_name = "com/sun/corba/se/spi/protocol/PIHandler";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::io::Closeable>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_PROTOCOL_PIHANDLER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_PROTOCOL_PIHANDLER)
#define SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_PROTOCOL_PIHANDLER
...
class com::sun::corba::se::spi::protocol::PIHandler : public jni::object_base<"com/sun/corba/se/spi/protocol/PIHandler",
	java::lang::Object,
	java::io::Closeable>
{
public:
...
#endif // SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_PROTOCOL_PIHANDLER
