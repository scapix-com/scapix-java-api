...
namespace scapix::java_api { namespace com::sun::corba::se::impl::legacy::connection { class DefaultSocketFactory; }}
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::legacy::connection::DefaultSocketFactory> new_object() { return object_base::new_object(); }
