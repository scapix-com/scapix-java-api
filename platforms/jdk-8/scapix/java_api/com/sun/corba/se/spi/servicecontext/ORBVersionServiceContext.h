...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_SPI_SERVICECONTEXT_ORBVERSIONSERVICECONTEXT
...
public:
	...
	static jni::ref<com::sun::corba::se::spi::servicecontext::ORBVersionServiceContext> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::corba::se::spi::servicecontext::ORBVersionServiceContext> new_object(jni::ref<com::sun::corba::se::spi::orb::ORBVersion> p1) { return object_base::new_object(p1); }
	static jni::ref<com::sun::corba::se::spi::servicecontext::ORBVersionServiceContext> new_object(jni::ref<org::omg::CORBA_2_3::portable::InputStream> p1, jni::ref<com::sun::corba::se::spi::ior::iiop::GIOPVersion> p2) { return object_base::new_object(p1, p2); }
