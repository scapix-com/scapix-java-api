...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_PROTOCOL_FULLSERVANTCACHELOCALCRDIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::protocol::FullServantCacheLocalCRDImpl> new_object(jni::ref<com::sun::corba::se::spi::orb::ORB> p1, jint p2, jni::ref<com::sun::corba::se::spi::ior::IOR> p3) { return object_base::new_object(p1, p2, p3); }
