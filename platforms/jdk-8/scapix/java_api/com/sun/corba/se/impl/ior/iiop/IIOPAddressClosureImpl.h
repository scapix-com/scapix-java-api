...
#ifndef SCAPIX_JAVA_API_COM_SUN_CORBA_SE_IMPL_IOR_IIOP_IIOPADDRESSCLOSUREIMPL
...
public:
	...
	static jni::ref<com::sun::corba::se::impl::ior::iiop::IIOPAddressClosureImpl> new_object(jni::ref<com::sun::corba::se::spi::orbutil::closure::Closure> p1, jni::ref<com::sun::corba::se::spi::orbutil::closure::Closure> p2) { return object_base::new_object(p1, p2); }
