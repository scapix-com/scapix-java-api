...
namespace scapix::java_api { namespace com::sun::imageio::plugins::jpeg { class JPEGImageReader; }}
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::jpeg::JPEGImageReader> new_object(jni::ref<javax::imageio::spi::ImageReaderSpi> p1) { return object_base::new_object(p1); }
