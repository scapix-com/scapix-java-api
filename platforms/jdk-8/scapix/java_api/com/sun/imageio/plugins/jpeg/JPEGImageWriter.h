...
namespace scapix::java_api { namespace com::sun::imageio::plugins::jpeg { class JPEGImageWriter; }}
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::jpeg::JPEGImageWriter> new_object(jni::ref<javax::imageio::spi::ImageWriterSpi> p1) { return object_base::new_object(p1); }
