...
namespace scapix::java_api { namespace com::sun::imageio::plugins::png { class PNGImageDataEnumeration; }}
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::png::PNGImageDataEnumeration> new_object(jni::ref<javax::imageio::stream::ImageInputStream> p1) { return object_base::new_object(p1); }
