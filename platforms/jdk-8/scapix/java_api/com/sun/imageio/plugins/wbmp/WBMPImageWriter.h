...
namespace scapix::java_api::com::sun::imageio::plugins::wbmp { class WBMPImageWriter; }
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::wbmp::WBMPImageWriter> new_object(jni::ref<javax::imageio::spi::ImageWriterSpi> p1) { return base_::new_object(p1); }
...
protected:
	...
	WBMPImageWriter(handle_type h) : base_(h) {}
