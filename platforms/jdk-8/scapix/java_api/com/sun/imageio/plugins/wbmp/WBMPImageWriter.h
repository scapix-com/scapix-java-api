...
#ifndef SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEWRITER_FWD
#define SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEWRITER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::imageio::plugins::wbmp { class WBMPImageWriter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::imageio::plugins::wbmp::WBMPImageWriter>
{
	static constexpr fixed_string class_name = "com/sun/imageio/plugins/wbmp/WBMPImageWriter";
	using base_classes = std::tuple<scapix::java_api::javax::imageio::ImageWriter>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEWRITER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEWRITER)
#define SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEWRITER
...
class com::sun::imageio::plugins::wbmp::WBMPImageWriter : public jni::object_base<"com/sun/imageio/plugins/wbmp/WBMPImageWriter",
	javax::imageio::ImageWriter>
{
public:

	static jni::ref<com::sun::imageio::plugins::wbmp::WBMPImageWriter> new_object(jni::ref<javax::imageio::spi::ImageWriterSpi> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEWRITER
