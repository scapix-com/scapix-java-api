...
namespace scapix::java_api { namespace com::sun::imageio::plugins::png { class PNGImageWriteParam; }}
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::png::PNGImageWriteParam> new_object(jni::ref<java::util::Locale> p1) { return object_base::new_object(p1); }
