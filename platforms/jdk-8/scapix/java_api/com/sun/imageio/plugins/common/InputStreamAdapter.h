...
#ifndef SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_COMMON_INPUTSTREAMADAPTER
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::common::InputStreamAdapter> new_object(jni::ref<javax::imageio::stream::ImageInputStream> p1) { return object_base::new_object(p1); }
