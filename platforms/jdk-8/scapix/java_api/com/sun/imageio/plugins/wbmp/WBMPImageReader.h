...
#ifndef SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEREADER_FWD
#define SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEREADER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::imageio::plugins::wbmp { class WBMPImageReader; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::imageio::plugins::wbmp::WBMPImageReader>
{
	static constexpr fixed_string class_name = "com/sun/imageio/plugins/wbmp/WBMPImageReader";
	using base_classes = std::tuple<scapix::java_api::javax::imageio::ImageReader>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEREADER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEREADER)
#define SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEREADER
...
class com::sun::imageio::plugins::wbmp::WBMPImageReader : public jni::object_base<"com/sun/imageio/plugins/wbmp/WBMPImageReader",
	javax::imageio::ImageReader>
{
public:

	static jni::ref<com::sun::imageio::plugins::wbmp::WBMPImageReader> new_object(jni::ref<javax::imageio::spi::ImageReaderSpi> p1) { return object_base::new_object(p1); }
	...
	void readHeader() { return call_method<"readHeader", void>(); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_IMAGEIO_PLUGINS_WBMP_WBMPIMAGEREADER
