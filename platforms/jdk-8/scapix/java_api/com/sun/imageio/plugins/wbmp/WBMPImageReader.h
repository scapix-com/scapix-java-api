...
namespace scapix::java_api::com::sun::imageio::plugins::wbmp { class WBMPImageReader; }
...
public:
	...
	static jni::ref<com::sun::imageio::plugins::wbmp::WBMPImageReader> new_object(jni::ref<javax::imageio::spi::ImageReaderSpi> p1) { return base_::new_object(p1); }
...
protected:
	...
	WBMPImageReader(handle_type h) : base_(h) {}
