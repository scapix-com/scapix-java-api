...
namespace scapix::java_api { namespace com::sun::rowset { class CachedRowSetImpl; }}
...
public:
	...
	static jni::ref<com::sun::rowset::CachedRowSetImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::rowset::CachedRowSetImpl> new_object(jni::ref<java::util::Hashtable> p1) { return object_base::new_object(p1); }
