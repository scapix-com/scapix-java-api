...
namespace scapix::java_api::com::sun::rowset { class JdbcRowSetImpl; }
...
public:
	...
	static jni::ref<com::sun::rowset::JdbcRowSetImpl> new_object() { return base_::new_object(); }
	static jni::ref<com::sun::rowset::JdbcRowSetImpl> new_object(jni::ref<java::sql::Connection> p1) { return base_::new_object(p1); }
	static jni::ref<com::sun::rowset::JdbcRowSetImpl> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<com::sun::rowset::JdbcRowSetImpl> new_object(jni::ref<java::sql::ResultSet> p1) { return base_::new_object(p1); }
...
protected:
	...
	JdbcRowSetImpl(handle_type h) : base_(h) {}
