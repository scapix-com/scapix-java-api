...
namespace scapix::java_api { namespace com::sun::rowset { class JoinRowSetImpl; }}
...
public:
	...
	static jni::ref<com::sun::rowset::JoinRowSetImpl> new_object() { return object_base::new_object(); }
