...
#ifndef SCAPIX_JAVA_API_COM_SUN_ROWSET_FILTEREDROWSETIMPL
...
public:
	...
	static jni::ref<com::sun::rowset::FilteredRowSetImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::rowset::FilteredRowSetImpl> new_object(jni::ref<java::util::Hashtable> p1) { return object_base::new_object(p1); }
