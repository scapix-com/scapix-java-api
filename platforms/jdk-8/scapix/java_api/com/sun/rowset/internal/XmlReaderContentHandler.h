...
#ifndef SCAPIX_JAVA_API_COM_SUN_ROWSET_INTERNAL_XMLREADERCONTENTHANDLER
...
public:
	...
	static jni::ref<com::sun::rowset::internal::XmlReaderContentHandler> new_object(jni::ref<javax::sql::RowSet> p1) { return object_base::new_object(p1); }
