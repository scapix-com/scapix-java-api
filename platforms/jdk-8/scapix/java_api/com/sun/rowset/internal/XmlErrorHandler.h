...
#ifndef SCAPIX_JAVA_API_COM_SUN_ROWSET_INTERNAL_XMLERRORHANDLER
...
public:
	...
	static jni::ref<com::sun::rowset::internal::XmlErrorHandler> new_object() { return object_base::new_object(); }
