...
namespace scapix::java_api { namespace com::sun::rowset::internal { class SyncResolverImpl; }}
...
public:
	...
	static jni::ref<com::sun::rowset::internal::SyncResolverImpl> new_object() { return object_base::new_object(); }
