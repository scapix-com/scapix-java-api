...
#ifndef SCAPIX_JAVA_API_COM_SUN_ROWSET_INTERNAL_INSERTROW
...
public:
	...
	static jni::ref<com::sun::rowset::internal::InsertRow> new_object(jint p1) { return object_base::new_object(p1); }
