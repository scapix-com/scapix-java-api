...
#ifndef SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_SERVICENAME_FWD
#define SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_SERVICENAME_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::management::jmx { class ServiceName; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::management::jmx::ServiceName>
{
	static constexpr fixed_string class_name = "com/sun/management/jmx/ServiceName";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_SERVICENAME_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_SERVICENAME)
#define SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_SERVICENAME
...
class com::sun::management::jmx::ServiceName : public jni::object_base<"com/sun/management/jmx/ServiceName",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_SERVICENAME
