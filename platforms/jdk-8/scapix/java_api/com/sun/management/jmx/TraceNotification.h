...
#ifndef SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_TRACENOTIFICATION
...
public:
	...
	static jni::ref<com::sun::management::jmx::TraceNotification> new_object(jni::ref<java::lang::Object> p1, jlong p2, jlong p3, jint p4, jint p5, jni::ref<java::lang::String> p6, jni::ref<java::lang::String> p7, jni::ref<java::lang::String> p8, jni::ref<java::lang::Throwable> p9) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
};
