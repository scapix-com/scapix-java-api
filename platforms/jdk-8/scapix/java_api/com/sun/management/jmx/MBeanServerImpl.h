...
#ifndef SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_MBEANSERVERIMPL_FWD
#define SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_MBEANSERVERIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace com::sun::management::jmx { class MBeanServerImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::com::sun::management::jmx::MBeanServerImpl>
{
	static constexpr fixed_string class_name = "com/sun/management/jmx/MBeanServerImpl";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::javax::management::MBeanServer>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_MBEANSERVERIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_MBEANSERVERIMPL)
#define SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_MBEANSERVERIMPL
...
class com::sun::management::jmx::MBeanServerImpl : public jni::object_base<"com/sun/management/jmx/MBeanServerImpl",
	java::lang::Object,
	javax::management::MBeanServer>
{
public:

	static jni::ref<com::sun::management::jmx::MBeanServerImpl> new_object() { return object_base::new_object(); }
	static jni::ref<com::sun::management::jmx::MBeanServerImpl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_JMX_MBEANSERVERIMPL
