...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_HTTPSERVER_AUTHENTICATOR_SUCCESS
...
public:
	...
	static jni::ref<com::sun::net::httpserver::Authenticator_Success> new_object(jni::ref<com::sun::net::httpserver::HttpPrincipal> p1) { return object_base::new_object(p1); }
