...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_SSL_HTTPSURLCONNECTION
...
public:
	...
	static jni::ref<com::sun::net::ssl::HttpsURLConnection> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
