...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_SSL_KEYMANAGERFACTORYSPI
...
public:
	...
	static jni::ref<com::sun::net::ssl::KeyManagerFactorySpi> new_object() { return object_base::new_object(); }
};
