...
namespace scapix::java_api { namespace sun::nio::cs { class UTF_16LE_BOM_Encoder; }}
...
public:
	...
	static jni::ref<sun::nio::cs::UTF_16LE_BOM_Encoder> new_object(jni::ref<java::nio::charset::Charset> p1) { return object_base::new_object(p1); }
