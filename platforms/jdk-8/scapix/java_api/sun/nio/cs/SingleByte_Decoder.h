...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CS_SINGLEBYTE_DECODER
...
public:
	...
	static jni::ref<sun::nio::cs::SingleByte_Decoder> new_object(jni::ref<java::nio::charset::Charset> p1, jni::ref<jni::array<jchar>> p2) { return object_base::new_object(p1, p2); }
