...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CS_SURROGATE
...
public:
	...
	static jboolean isHigh(jint p1) { return call_static_method<"isHigh", jboolean>(p1); }
	static jboolean isLow(jint p1) { return call_static_method<"isLow", jboolean>(p1); }
	static jboolean is(jint p1) { return call_static_method<"is", jboolean>(p1); }
	static jboolean neededFor(jint p1) { return call_static_method<"neededFor", jboolean>(p1); }
	static jchar high(jint p1) { return call_static_method<"high", jchar>(p1); }
	static jchar low(jint p1) { return call_static_method<"low", jchar>(p1); }
	static jint toUCS4(jchar p1, jchar p2) { return call_static_method<"toUCS4", jint>(p1, p2); }
};
