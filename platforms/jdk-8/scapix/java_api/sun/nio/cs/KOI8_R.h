...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CS_KOI8_R_FWD
#define SCAPIX_JAVA_API_SUN_NIO_CS_KOI8_R_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::nio::cs { class KOI8_R; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::nio::cs::KOI8_R>
{
	static constexpr fixed_string class_name = "sun/nio/cs/KOI8_R";
...
#endif // SCAPIX_JAVA_API_SUN_NIO_CS_KOI8_R_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_NIO_CS_KOI8_R)
#define SCAPIX_JAVA_API_SUN_NIO_CS_KOI8_R
...
class sun::nio::cs::KOI8_R : public jni::object_base<"sun/nio/cs/KOI8_R",
	java::nio::charset::Charset,
	sun::nio::cs::HistoricallyNamedCharset>
{
public:

	static jni::ref<sun::nio::cs::KOI8_R> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_SUN_NIO_CS_KOI8_R
