...
namespace scapix::java_api::sun::nio::cs { class ISO_8859_15; }
...
public:
	...
	static jni::ref<sun::nio::cs::ISO_8859_15> new_object() { return base_::new_object(); }
...
protected:
	...
	ISO_8859_15(handle_type h) : base_(h) {}
