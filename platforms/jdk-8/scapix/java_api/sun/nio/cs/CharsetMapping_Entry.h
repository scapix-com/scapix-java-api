...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CS_CHARSETMAPPING_ENTRY
...
public:
	...
	static jni::ref<sun::nio::cs::CharsetMapping_Entry> new_object() { return object_base::new_object(); }
};
