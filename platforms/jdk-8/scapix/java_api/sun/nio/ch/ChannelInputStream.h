...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CH_CHANNELINPUTSTREAM
...
public:
	...
	static jint read(jni::ref<java::nio::channels::ReadableByteChannel> p1, jni::ref<java::nio::ByteBuffer> p2, jboolean p3) { return call_static_method<"read", jint>(p1, p2, p3); }
	static jni::ref<sun::nio::ch::ChannelInputStream> new_object(jni::ref<java::nio::channels::ReadableByteChannel> p1) { return object_base::new_object(p1); }
