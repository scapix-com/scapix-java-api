...
public:
	...
	static jni::ref<sun::nio::ch::DatagramChannelImpl> new_object(jni::ref<java::nio::channels::spi::SelectorProvider> p1) { return base_::new_object(p1); }
	static jni::ref<sun::nio::ch::DatagramChannelImpl> new_object(jni::ref<java::nio::channels::spi::SelectorProvider> p1, jni::ref<java::net::ProtocolFamily> p2) { return base_::new_object(p1, p2); }
	static jni::ref<sun::nio::ch::DatagramChannelImpl> new_object(jni::ref<java::nio::channels::spi::SelectorProvider> p1, jni::ref<java::io::FileDescriptor> p2) { return base_::new_object(p1, p2); }
