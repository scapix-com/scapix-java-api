...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CH_SECRETS
...
public:
	...
	static jni::ref<java::nio::channels::SocketChannel> newSocketChannel(jni::ref<java::io::FileDescriptor> p1) { return call_static_method<"newSocketChannel", jni::ref<java::nio::channels::SocketChannel>>(p1); }
	static jni::ref<java::nio::channels::ServerSocketChannel> newServerSocketChannel(jni::ref<java::io::FileDescriptor> p1) { return call_static_method<"newServerSocketChannel", jni::ref<java::nio::channels::ServerSocketChannel>>(p1); }
};
