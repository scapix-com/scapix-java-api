...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CH_NET
...
public:
	...
	static jni::ref<java::net::InetSocketAddress> checkAddress(jni::ref<java::net::SocketAddress> p1) { return call_static_method<"checkAddress", jni::ref<java::net::InetSocketAddress>>(p1); }
	static jboolean isFastTcpLoopbackRequested() { return call_static_method<"isFastTcpLoopbackRequested", jboolean>(); }
	static void bind(jni::ref<java::io::FileDescriptor> p1, jni::ref<java::net::InetAddress> p2, jint p3) { return call_static_method<"bind", void>(p1, p2, p3); }
	static jni::ref<java::net::InetSocketAddress> localAddress(jni::ref<java::io::FileDescriptor> p1) { return call_static_method<"localAddress", jni::ref<java::net::InetSocketAddress>>(p1); }
};
