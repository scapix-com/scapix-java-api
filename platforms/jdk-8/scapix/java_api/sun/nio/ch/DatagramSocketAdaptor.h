...
namespace scapix::java_api { namespace sun::nio::ch { class DatagramSocketAdaptor; }}
...
#include <scapix/java_api/sun/nio/ch/DatagramChannelImpl.h>
...
public:
	...
	static jni::ref<java::net::DatagramSocket> create(jni::ref<sun::nio::ch::DatagramChannelImpl> p1) { return call_static_method<"create", jni::ref<java::net::DatagramSocket>>(p1); }
