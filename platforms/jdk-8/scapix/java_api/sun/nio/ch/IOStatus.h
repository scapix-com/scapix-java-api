...
#ifndef SCAPIX_JAVA_API_SUN_NIO_CH_IOSTATUS
...
public:
	...
	static jint normalize(jint p1) { return call_static_method<"normalize", jint>(p1); }
	static jboolean check(jint p1) { return call_static_method<"check", jboolean>(p1); }
	static jlong normalize(jlong p1) { return call_static_method<"normalize", jlong>(p1); }
	static jboolean check(jlong p1) { return call_static_method<"check", jboolean>(p1); }
	static jboolean checkAll(jlong p1) { return call_static_method<"checkAll", jboolean>(p1); }
};
