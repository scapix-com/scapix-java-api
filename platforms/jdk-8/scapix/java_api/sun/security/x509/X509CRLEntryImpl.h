...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_X509CRLENTRYIMPL
...
public:
	...
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::util::Date> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::util::Date> p2, jni::ref<sun::security::x509::CRLExtensions> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
