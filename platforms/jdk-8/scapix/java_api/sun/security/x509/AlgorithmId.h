...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_ALGORITHMID
...
public:
	...
	static jni::ref<sun::security::x509::AlgorithmId> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::AlgorithmId> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1, jni::ref<java::security::AlgorithmParameters> p2) { return object_base::new_object(p1, p2); }
