...
namespace scapix::java_api { namespace sun::security::x509 { class X509CRLImpl_X509IssuerSerial; }}
...
public:
	...
	jint compareTo(jni::ref<sun::security::x509::X509CRLImpl_X509IssuerSerial> p1) { return call_method<"compareTo", jint>(p1); }
