...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CERTIFICATEVALIDITY
...
public:
	...
	static jni::ref<sun::security::x509::CertificateValidity> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::CertificateValidity> new_object(jni::ref<java::util::Date> p1, jni::ref<java::util::Date> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::CertificateValidity> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
