...
public:
	...
	static jni::ref<sun::security::x509::CRLNumberExtension> new_object(jint p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::CRLNumberExtension> new_object(jni::ref<java::math::BigInteger> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::CRLNumberExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return base_::new_object(p1, p2); }
