...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CRLNUMBEREXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::CRLNumberExtension> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::CRLNumberExtension> new_object(jni::ref<java::math::BigInteger> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::CRLNumberExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	void set(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return call_method<"set", void>(p1, p2); }
	jni::ref<java::math::BigInteger> get(jni::ref<java::lang::String> p1) { return call_method<"get", jni::ref<java::math::BigInteger>>(p1); }
