...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_NAMECONSTRAINTSEXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::NameConstraintsExtension> new_object(jni::ref<sun::security::x509::GeneralSubtrees> p1, jni::ref<sun::security::x509::GeneralSubtrees> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::NameConstraintsExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
