...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_X509CERTIMPL
...
public:
	...
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::x509::X509CertInfo> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CertImpl> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
