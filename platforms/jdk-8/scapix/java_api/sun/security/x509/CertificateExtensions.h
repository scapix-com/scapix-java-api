...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CERTIFICATEEXTENSIONS
...
public:
	...
	static jni::ref<sun::security::x509::CertificateExtensions> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::CertificateExtensions> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
