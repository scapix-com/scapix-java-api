...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_KEYIDENTIFIER
...
public:
	...
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::KeyIdentifier> new_object(jni::ref<java::security::PublicKey> p1) { return object_base::new_object(p1); }
