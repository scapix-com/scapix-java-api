...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CRLEXTENSIONS
...
public:
	...
	static jni::ref<sun::security::x509::CRLExtensions> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
