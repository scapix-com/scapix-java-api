...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_RFC822NAME
...
public:
	...
	static jni::ref<sun::security::x509::RFC822Name> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::RFC822Name> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
