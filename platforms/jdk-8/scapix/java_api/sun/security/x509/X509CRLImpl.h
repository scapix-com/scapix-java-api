...
public:
	...
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<jni::array<jbyte>> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::util::DerValue> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<java::io::InputStream> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::util::Date> p2, jni::ref<java::util::Date> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::util::Date> p2, jni::ref<java::util::Date> p3, jni::ref<jni::array<java::security::cert::X509CRLEntry>> p4) { return base_::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::util::Date> p2, jni::ref<java::util::Date> p3, jni::ref<jni::array<java::security::cert::X509CRLEntry>> p4, jni::ref<sun::security::x509::CRLExtensions> p5) { return base_::new_object(p1, p2, p3, p4, p5); }
