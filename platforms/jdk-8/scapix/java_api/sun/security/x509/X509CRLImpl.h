...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_X509CRLIMPL
...
public:
	...
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::util::Date> p2, jni::ref<java::util::Date> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::util::Date> p2, jni::ref<java::util::Date> p3, jni::ref<jni::array<java::security::cert::X509CRLEntry>> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::x509::X509CRLImpl> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::util::Date> p2, jni::ref<java::util::Date> p3, jni::ref<jni::array<java::security::cert::X509CRLEntry>> p4, jni::ref<sun::security::x509::CRLExtensions> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	...
	void encodeInfo(jni::ref<java::io::OutputStream> p1) { return call_method<"encodeInfo", void>(p1); }
	...
	jni::ref<java::lang::String> toStringWithAlgName(jni::ref<java::lang::String> p1) { return call_method<"toStringWithAlgName", jni::ref<java::lang::String>>(p1); }
	...
	jni::ref<java::security::cert::X509CRLEntry> getRevokedCertificate(jni::ref<java::security::cert::X509Certificate> p1) { return call_method<"getRevokedCertificate", jni::ref<java::security::cert::X509CRLEntry>>(p1); }
	...
	jni::ref<java::lang::Object> getExtension(jni::ref<sun::security::util::ObjectIdentifier> p1) { return call_method<"getExtension", jni::ref<java::lang::Object>>(p1); }
	static jni::ref<javax::security::auth::x500::X500Principal> getIssuerX500Principal(jni::ref<java::security::cert::X509CRL> p1) { return call_static_method<"getIssuerX500Principal", jni::ref<javax::security::auth::x500::X500Principal>>(p1); }
	static jni::ref<jni::array<jbyte>> getEncodedInternal(jni::ref<java::security::cert::X509CRL> p1) { return call_static_method<"getEncodedInternal", jni::ref<jni::array<jbyte>>>(p1); }
	static jni::ref<sun::security::x509::X509CRLImpl> toImpl(jni::ref<java::security::cert::X509CRL> p1) { return call_static_method<"toImpl", jni::ref<sun::security::x509::X509CRLImpl>>(p1); }
