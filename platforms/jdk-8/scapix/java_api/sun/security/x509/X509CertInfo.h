...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_X509CERTINFO
...
public:
	...
	static jni::ref<sun::security::x509::X509CertInfo> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::X509CertInfo> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::X509CertInfo> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
