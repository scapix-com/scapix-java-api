...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_REASONFLAGS
...
public:
	...
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<jni::array<jboolean>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::BitArray> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
