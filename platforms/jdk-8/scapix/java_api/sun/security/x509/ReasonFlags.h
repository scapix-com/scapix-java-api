...
public:
	...
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<jni::array<jbyte>> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<jni::array<jboolean>> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::BitArray> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::ReasonFlags> new_object(jni::ref<sun::security::util::DerValue> p1) { return base_::new_object(p1); }
