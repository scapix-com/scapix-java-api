...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_KEYUSAGEEXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<jni::array<jboolean>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<sun::security::util::BitArray> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object() { return object_base::new_object(); }
	void set(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return call_method<"set", void>(p1, p2); }
	jni::ref<java::lang::Boolean> get(jni::ref<java::lang::String> p1) { return call_method<"get", jni::ref<java::lang::Boolean>>(p1); }
