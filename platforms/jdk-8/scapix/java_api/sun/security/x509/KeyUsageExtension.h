...
public:
	...
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<jni::array<jbyte>> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<jni::array<jboolean>> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<sun::security::util::BitArray> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::KeyUsageExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return base_::new_object(p1, p2); }
