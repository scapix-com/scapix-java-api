...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_SERIALNUMBER
...
public:
	...
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<java::math::BigInteger> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::SerialNumber> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
