...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CERTIFICATEVERSION
...
public:
	...
	static jni::ref<sun::security::x509::CertificateVersion> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::CertificateVersion> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
