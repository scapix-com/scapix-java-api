...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_POLICYINFORMATION
...
public:
	...
	static jni::ref<sun::security::x509::PolicyInformation> new_object(jni::ref<sun::security::x509::CertificatePolicyId> p1, jni::ref<java::util::Set> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::PolicyInformation> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
