...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_INHIBITANYPOLICYEXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::InhibitAnyPolicyExtension> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::InhibitAnyPolicyExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
