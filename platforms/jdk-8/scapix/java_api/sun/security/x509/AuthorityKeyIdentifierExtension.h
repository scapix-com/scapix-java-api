...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_AUTHORITYKEYIDENTIFIEREXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::AuthorityKeyIdentifierExtension> new_object(jni::ref<sun::security::x509::KeyIdentifier> p1, jni::ref<sun::security::x509::GeneralNames> p2, jni::ref<sun::security::x509::SerialNumber> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::AuthorityKeyIdentifierExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
