...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_ISSUINGDISTRIBUTIONPOINTEXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::IssuingDistributionPointExtension> new_object(jni::ref<sun::security::x509::DistributionPointName> p1, jni::ref<sun::security::x509::ReasonFlags> p2, jboolean p3, jboolean p4, jboolean p5, jboolean p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<sun::security::x509::IssuingDistributionPointExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
