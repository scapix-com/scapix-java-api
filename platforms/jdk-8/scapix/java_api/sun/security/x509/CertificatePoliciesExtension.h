...
public:
	...
	static jni::ref<sun::security::x509::CertificatePoliciesExtension> new_object(jni::ref<java::util::List> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::x509::CertificatePoliciesExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::util::List> p2) { return base_::new_object(p1, p2); }
	static jni::ref<sun::security::x509::CertificatePoliciesExtension> new_object(jni::ref<java::lang::Boolean> p1, jni::ref<java::lang::Object> p2) { return base_::new_object(p1, p2); }
