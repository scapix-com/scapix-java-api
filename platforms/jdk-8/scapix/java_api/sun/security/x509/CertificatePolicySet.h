...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CERTIFICATEPOLICYSET
...
public:
	...
	static jni::ref<sun::security::x509::CertificatePolicySet> new_object(jni::ref<java::util::Vector> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::CertificatePolicySet> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
