...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_RDN
...
public:
	...
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::Map> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<sun::security::x509::AVA> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::RDN> new_object(jni::ref<jni::array<sun::security::x509::AVA>> p1) { return object_base::new_object(p1); }
