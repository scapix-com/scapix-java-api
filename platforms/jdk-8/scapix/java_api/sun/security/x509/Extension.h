...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_EXTENSION
...
public:
	...
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1, jboolean p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::x509::Extension> p1) { return object_base::new_object(p1); }
