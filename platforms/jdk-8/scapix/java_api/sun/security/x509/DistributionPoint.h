...
public:
	...
	static jni::ref<sun::security::x509::DistributionPoint> new_object(jni::ref<sun::security::x509::GeneralNames> p1, jni::ref<jni::array<jboolean>> p2, jni::ref<sun::security::x509::GeneralNames> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::DistributionPoint> new_object(jni::ref<sun::security::x509::RDN> p1, jni::ref<jni::array<jboolean>> p2, jni::ref<sun::security::x509::GeneralNames> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<sun::security::x509::DistributionPoint> new_object(jni::ref<sun::security::util::DerValue> p1) { return base_::new_object(p1); }
