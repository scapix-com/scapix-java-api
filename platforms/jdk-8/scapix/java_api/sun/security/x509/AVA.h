...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_AVA
...
public:
	...
	static jni::ref<sun::security::x509::AVA> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1, jni::ref<sun::security::util::DerValue> p2) { return object_base::new_object(p1, p2); }
