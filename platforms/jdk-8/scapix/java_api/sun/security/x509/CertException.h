...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_X509_CERTEXCEPTION
...
public:
	...
	static jni::ref<sun::security::x509::CertException> new_object(jint p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::x509::CertException> new_object(jint p1) { return object_base::new_object(p1); }
