...
public:
	...
	static jni::ref<sun::security::x509::CertException> new_object(jint p1, jni::ref<java::lang::String> p2) { return base_::new_object(p1, p2); }
	static jni::ref<sun::security::x509::CertException> new_object(jint p1) { return base_::new_object(p1); }
