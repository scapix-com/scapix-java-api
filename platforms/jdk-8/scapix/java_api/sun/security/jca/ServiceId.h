...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_JCA_SERVICEID
...
public:
	...
	static jni::ref<sun::security::jca::ServiceId> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
};
