...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_ACTION_GETINTEGERACTION
...
public:
	...
	static jni::ref<sun::security::action::GetIntegerAction> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::action::GetIntegerAction> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
