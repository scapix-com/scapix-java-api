...
public:
	...
	static jni::ref<sun::security::action::GetIntegerAction> new_object(jni::ref<java::lang::String> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::action::GetIntegerAction> new_object(jni::ref<java::lang::String> p1, jint p2) { return base_::new_object(p1, p2); }
