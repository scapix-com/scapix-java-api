...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_ACTION_GETPROPERTYACTION
...
public:
	...
	static jni::ref<sun::security::action::GetPropertyAction> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::action::GetPropertyAction> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	jni::ref<java::lang::String> run() { return call_method<"run", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> privilegedGetProperty(jni::ref<java::lang::String> p1) { return call_static_method<"privilegedGetProperty", jni::ref<java::lang::String>>(p1); }
	static jni::ref<java::lang::String> privilegedGetProperty(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return call_static_method<"privilegedGetProperty", jni::ref<java::lang::String>>(p1, p2); }
};
