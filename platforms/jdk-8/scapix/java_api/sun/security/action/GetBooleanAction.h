...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_ACTION_GETBOOLEANACTION
...
public:
	...
	static jni::ref<sun::security::action::GetBooleanAction> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
