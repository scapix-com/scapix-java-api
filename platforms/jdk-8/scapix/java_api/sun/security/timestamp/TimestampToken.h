...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_TIMESTAMP_TIMESTAMPTOKEN
...
public:
	...
	static jni::ref<sun::security::timestamp::TimestampToken> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
