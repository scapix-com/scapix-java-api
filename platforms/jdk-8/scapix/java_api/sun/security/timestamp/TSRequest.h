...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_TIMESTAMP_TSREQUEST
...
public:
	...
	static jni::ref<sun::security::timestamp::TSRequest> new_object(jni::ref<java::lang::String> p1, jni::ref<jni::array<jbyte>> p2, jni::ref<java::security::MessageDigest> p3) { return object_base::new_object(p1, p2, p3); }
