...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_KRBAPREQ
...
public:
	...
	static jni::ref<sun::security::krb5::KrbApReq> new_object(jni::ref<sun::security::krb5::Credentials> p1, jboolean p2, jboolean p3, jboolean p4, jni::ref<sun::security::krb5::Checksum> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::security::krb5::KrbApReq> new_object(jni::ref<jni::array<jbyte>> p1, jni::ref<sun::security::jgss::krb5::Krb5AcceptCredential> p2, jni::ref<java::net::InetAddress> p3) { return object_base::new_object(p1, p2, p3); }
