...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_KRBEXCEPTION
...
public:
	...
	static jni::ref<sun::security::krb5::KrbException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::KrbException> new_object(jni::ref<java::lang::Throwable> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::KrbException> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::KrbException> new_object(jint p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::KrbException> new_object(jni::ref<sun::security::krb5::internal::KRBError> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::KrbException> new_object(jni::ref<sun::security::krb5::internal::KRBError> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
