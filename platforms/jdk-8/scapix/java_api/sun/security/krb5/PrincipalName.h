...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_PRINCIPALNAME
...
public:
	...
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jint p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<sun::security::krb5::Realm> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jni::ref<jni::array<java::lang::String>> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	jni::ref<java::lang::Object> clone() { return call_method<"clone", jni::ref<java::lang::Object>>(); }
	jboolean equals(jni::ref<java::lang::Object> p1) { return call_method<"equals", jboolean>(p1); }
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jni::ref<sun::security::util::DerValue> p1, jni::ref<sun::security::krb5::Realm> p2) { return object_base::new_object(p1, p2); }
	...
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::PrincipalName> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
