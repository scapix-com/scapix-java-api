...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_ENCRYPTIONKEY
...
public:
	...
	static jni::ref<sun::security::krb5::EncryptionKey> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jni::ref<java::lang::Integer> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::krb5::EncryptionKey> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::EncryptionKey> new_object(jni::ref<jni::array<jchar>> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::krb5::EncryptionKey> new_object(jni::ref<sun::security::krb5::EncryptionKey> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::EncryptionKey> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
