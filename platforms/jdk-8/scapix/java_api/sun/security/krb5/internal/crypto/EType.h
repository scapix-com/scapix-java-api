...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_ETYPE
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::EType> new_object() { return object_base::new_object(); }
	...
	static jboolean isNewer(jint p1) { return call_static_method<"isNewer", jboolean>(p1); }
