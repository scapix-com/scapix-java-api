...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_TGSREP
...
public:
	...
	static jni::ref<sun::security::krb5::internal::TGSRep> new_object(jni::ref<jni::array<sun::security::krb5::internal::PAData>> p1, jni::ref<sun::security::krb5::PrincipalName> p2, jni::ref<sun::security::krb5::internal::Ticket> p3, jni::ref<sun::security::krb5::EncryptedData> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::krb5::internal::TGSRep> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::TGSRep> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
};
