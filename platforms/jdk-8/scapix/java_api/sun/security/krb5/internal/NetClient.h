...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_NETCLIENT
...
public:
	...
	static jni::ref<sun::security::krb5::internal::NetClient> new_object() { return object_base::new_object(); }
