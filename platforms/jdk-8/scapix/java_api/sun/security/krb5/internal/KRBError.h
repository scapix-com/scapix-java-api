...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KRBERROR
...
public:
	...
	static jni::ref<sun::security::krb5::internal::KRBError> new_object(jni::ref<sun::security::krb5::internal::APOptions> p1, jni::ref<sun::security::krb5::internal::KerberosTime> p2, jni::ref<java::lang::Integer> p3, jni::ref<sun::security::krb5::internal::KerberosTime> p4, jni::ref<java::lang::Integer> p5, jint p6, jni::ref<sun::security::krb5::PrincipalName> p7, jni::ref<sun::security::krb5::PrincipalName> p8, jni::ref<java::lang::String> p9, jni::ref<jni::array<jbyte>> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
	static jni::ref<sun::security::krb5::internal::KRBError> new_object(jni::ref<sun::security::krb5::internal::APOptions> p1, jni::ref<sun::security::krb5::internal::KerberosTime> p2, jni::ref<java::lang::Integer> p3, jni::ref<sun::security::krb5::internal::KerberosTime> p4, jni::ref<java::lang::Integer> p5, jint p6, jni::ref<sun::security::krb5::PrincipalName> p7, jni::ref<sun::security::krb5::PrincipalName> p8, jni::ref<java::lang::String> p9, jni::ref<jni::array<jbyte>> p10, jni::ref<sun::security::krb5::Checksum> p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
	static jni::ref<sun::security::krb5::internal::KRBError> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::KRBError> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
