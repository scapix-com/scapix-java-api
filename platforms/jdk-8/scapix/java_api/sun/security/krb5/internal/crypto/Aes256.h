...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::krb5::internal::crypto { class Aes256; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::krb5::internal::crypto::Aes256>
{
	static constexpr fixed_string class_name = "sun/security/krb5/internal/crypto/Aes256";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256)
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256
...
class sun::security::krb5::internal::crypto::Aes256 : public jni::object_base<"sun/security/krb5/internal/crypto/Aes256",
	java::lang::Object>
{
public:

	static jni::ref<jni::array<jbyte>> stringToKey(jni::ref<jni::array<jchar>> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<jbyte>> p3) { return call_static_method<"stringToKey", jni::ref<jni::array<jbyte>>>(p1, p2, p3); }
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256
