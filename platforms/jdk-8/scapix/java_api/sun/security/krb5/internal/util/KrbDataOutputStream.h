...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_UTIL_KRBDATAOUTPUTSTREAM
...
public:
	...
	static jni::ref<sun::security::krb5::internal::util::KrbDataOutputStream> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
