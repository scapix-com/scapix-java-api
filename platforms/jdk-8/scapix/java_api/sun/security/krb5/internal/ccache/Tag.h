...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CCACHE_TAG
...
public:
	...
	static jni::ref<sun::security::krb5::internal::ccache::Tag> new_object(jint p1, jint p2, jni::ref<java::lang::Integer> p3, jni::ref<java::lang::Integer> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::krb5::internal::ccache::Tag> new_object(jint p1) { return object_base::new_object(p1); }
