...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_DES3CBCHMACSHA1KDETYPE
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::Des3CbcHmacSha1KdEType> new_object() { return object_base::new_object(); }
