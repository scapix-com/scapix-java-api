...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_DESMACCKSUMTYPE
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::DesMacCksumType> new_object() { return object_base::new_object(); }
