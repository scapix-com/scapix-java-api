...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KERBEROSTIME
...
public:
	...
	static jni::ref<sun::security::krb5::internal::KerberosTime> new_object(jlong p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::KerberosTime> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::KerberosTime> new_object(jni::ref<java::util::Date> p1) { return object_base::new_object(p1); }
