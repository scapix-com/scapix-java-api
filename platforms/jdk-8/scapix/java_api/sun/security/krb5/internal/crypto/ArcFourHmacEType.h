...
namespace scapix::java_api { namespace sun::security::krb5::internal::crypto { class ArcFourHmacEType; }}
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::ArcFourHmacEType> new_object() { return object_base::new_object(); }
