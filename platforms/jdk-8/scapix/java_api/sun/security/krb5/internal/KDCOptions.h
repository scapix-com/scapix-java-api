...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KDCOPTIONS
...
public:
	...
	static jni::ref<sun::security::krb5::internal::KDCOptions> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::krb5::internal::KDCOptions> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::internal::KDCOptions> new_object(jni::ref<jni::array<jboolean>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::KDCOptions> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::KDCOptions> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
