...
namespace scapix::java_api { namespace sun::security::krb5::internal::tools { class KinitOptions; }}
...
public:
	...
	static jni::ref<sun::security::krb5::internal::tools::KinitOptions> new_object() { return object_base::new_object(); }
	...
	static jni::ref<sun::security::krb5::internal::tools::KinitOptions> new_object(jni::ref<jni::array<java::lang::String>> p1) { return object_base::new_object(p1); }
