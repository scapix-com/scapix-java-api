...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_RCACHE_AUTHTIME
...
public:
	...
	static jni::ref<sun::security::krb5::internal::rcache::AuthTime> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
