...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_PAFORUSERENC
...
public:
	...
	static jni::ref<sun::security::krb5::internal::PAForUserEnc> new_object(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<sun::security::krb5::EncryptionKey> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::internal::PAForUserEnc> new_object(jni::ref<sun::security::util::DerValue> p1, jni::ref<sun::security::krb5::EncryptionKey> p2) { return object_base::new_object(p1, p2); }
