...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KTAB_KEYTABENTRY
...
public:
	...
	static jni::ref<sun::security::krb5::internal::ktab::KeyTabEntry> new_object(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<sun::security::krb5::Realm> p2, jni::ref<sun::security::krb5::internal::KerberosTime> p3, jint p4, jint p5, jni::ref<jni::array<jbyte>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
