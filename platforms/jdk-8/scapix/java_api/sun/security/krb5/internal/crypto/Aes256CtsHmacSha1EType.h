...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256CTSHMACSHA1ETYPE_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256CTSHMACSHA1ETYPE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::krb5::internal::crypto { class Aes256CtsHmacSha1EType; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::krb5::internal::crypto::Aes256CtsHmacSha1EType>
{
	static constexpr fixed_string class_name = "sun/security/krb5/internal/crypto/Aes256CtsHmacSha1EType";
	using base_classes = std::tuple<scapix::java_api::sun::security::krb5::internal::crypto::EType>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256CTSHMACSHA1ETYPE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256CTSHMACSHA1ETYPE)
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256CTSHMACSHA1ETYPE

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class sun::security::krb5::internal::crypto::Aes256CtsHmacSha1EType : public jni::object_base<"sun/security/krb5/internal/crypto/Aes256CtsHmacSha1EType",
	sun::security::krb5::internal::crypto::EType>
{
public:

	static jni::ref<sun::security::krb5::internal::crypto::Aes256CtsHmacSha1EType> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES256CTSHMACSHA1ETYPE
