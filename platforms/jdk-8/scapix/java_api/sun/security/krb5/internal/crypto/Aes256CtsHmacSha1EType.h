...
namespace scapix::java_api::sun::security::krb5::internal::crypto { class Aes256CtsHmacSha1EType; }
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::Aes256CtsHmacSha1EType> new_object() { return base_::new_object(); }
...
protected:
	...
	Aes256CtsHmacSha1EType(handle_type h) : base_(h) {}
