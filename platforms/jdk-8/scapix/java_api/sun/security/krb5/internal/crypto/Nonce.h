...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NONCE
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::Nonce> new_object() { return object_base::new_object(); }
