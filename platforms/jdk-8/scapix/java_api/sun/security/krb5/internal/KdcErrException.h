...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KDCERREXCEPTION
...
public:
	...
	static jni::ref<sun::security::krb5::internal::KdcErrException> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::KdcErrException> new_object(jint p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
};
