...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_TICKET
...
public:
	...
	static jni::ref<sun::security::krb5::internal::Ticket> new_object(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<sun::security::krb5::EncryptedData> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::internal::Ticket> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::Ticket> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
