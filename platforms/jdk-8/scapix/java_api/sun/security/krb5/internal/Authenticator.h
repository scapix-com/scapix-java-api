...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_AUTHENTICATOR
...
public:
	...
	static jni::ref<sun::security::krb5::internal::Authenticator> new_object(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<sun::security::krb5::Checksum> p2, jint p3, jni::ref<sun::security::krb5::internal::KerberosTime> p4, jni::ref<sun::security::krb5::EncryptionKey> p5, jni::ref<java::lang::Integer> p6, jni::ref<sun::security::krb5::internal::AuthorizationData> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<sun::security::krb5::internal::Authenticator> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::Authenticator> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
