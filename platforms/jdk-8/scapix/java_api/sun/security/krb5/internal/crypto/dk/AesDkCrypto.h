...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_DK_AESDKCRYPTO
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::dk::AesDkCrypto> new_object(jint p1) { return object_base::new_object(p1); }
