...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_DK_DKCRYPTO
...
public:
	...
	static jboolean ALLOW_WEAK_PBKDF2_ITERATION_COUNT() { return get_static_field<"ALLOW_WEAK_PBKDF2_ITERATION_COUNT", jboolean>(); }
	static void ALLOW_WEAK_PBKDF2_ITERATION_COUNT(jboolean v) { set_static_field<"ALLOW_WEAK_PBKDF2_ITERATION_COUNT", jboolean>(v); }

	static jni::ref<sun::security::krb5::internal::crypto::dk::DkCrypto> new_object() { return object_base::new_object(); }
