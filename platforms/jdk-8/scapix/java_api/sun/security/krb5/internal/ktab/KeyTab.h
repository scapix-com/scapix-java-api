...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KTAB_KEYTAB
...
public:
	...
	void addEntry(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<jni::array<sun::security::krb5::EncryptionKey>> p2, jint p3, jboolean p4) { return call_method<"addEntry", void>(p1, p2, p3, p4); }
