...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES128_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES128_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::krb5::internal::crypto { class Aes128; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::krb5::internal::crypto::Aes128>
{
	static constexpr fixed_string class_name = "sun/security/krb5/internal/crypto/Aes128";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES128_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES128)
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES128
...
class sun::security::krb5::internal::crypto::Aes128 : public jni::object_base<"sun/security/krb5/internal/crypto/Aes128",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_AES128
