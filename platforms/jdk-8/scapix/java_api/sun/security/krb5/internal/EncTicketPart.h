...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_ENCTICKETPART
...
public:
	...
	static jni::ref<sun::security::krb5::internal::EncTicketPart> new_object(jni::ref<sun::security::krb5::internal::TicketFlags> p1, jni::ref<sun::security::krb5::EncryptionKey> p2, jni::ref<sun::security::krb5::PrincipalName> p3, jni::ref<sun::security::krb5::internal::TransitedEncoding> p4, jni::ref<sun::security::krb5::internal::KerberosTime> p5, jni::ref<sun::security::krb5::internal::KerberosTime> p6, jni::ref<sun::security::krb5::internal::KerberosTime> p7, jni::ref<sun::security::krb5::internal::KerberosTime> p8, jni::ref<sun::security::krb5::internal::HostAddresses> p9, jni::ref<sun::security::krb5::internal::AuthorizationData> p10) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); }
	static jni::ref<sun::security::krb5::internal::EncTicketPart> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::EncTicketPart> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
