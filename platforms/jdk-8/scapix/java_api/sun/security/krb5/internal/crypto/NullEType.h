...
namespace scapix::java_api::sun::security::krb5::internal::crypto { class NullEType; }
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::NullEType> new_object() { return base_::new_object(); }
...
protected:
	...
	NullEType(handle_type h) : base_(h) {}
