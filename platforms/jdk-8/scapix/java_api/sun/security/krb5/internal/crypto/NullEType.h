...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NULLETYPE_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NULLETYPE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::krb5::internal::crypto { class NullEType; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::krb5::internal::crypto::NullEType>
{
	static constexpr fixed_string class_name = "sun/security/krb5/internal/crypto/NullEType";
	using base_classes = std::tuple<scapix::java_api::sun::security::krb5::internal::crypto::EType>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NULLETYPE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NULLETYPE)
#define SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NULLETYPE

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class sun::security::krb5::internal::crypto::NullEType : public jni::object_base<"sun/security/krb5/internal/crypto/NullEType",
	sun::security::krb5::internal::crypto::EType>
{
public:

	static jni::ref<sun::security::krb5::internal::crypto::NullEType> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_CRYPTO_NULLETYPE
