...
namespace scapix::java_api::sun::security::krb5::internal::crypto { class Aes128CtsHmacSha1EType; }
...
public:
	...
	static jni::ref<sun::security::krb5::internal::crypto::Aes128CtsHmacSha1EType> new_object() { return base_::new_object(); }
...
protected:
	...
	Aes128CtsHmacSha1EType(handle_type h) : base_(h) {}
