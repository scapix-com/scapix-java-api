...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_UTIL_KERBEROSFLAGS
...
public:
	...
	static jni::ref<sun::security::krb5::internal::util::KerberosFlags> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::krb5::internal::util::KerberosFlags> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::internal::util::KerberosFlags> new_object(jni::ref<jni::array<jboolean>> p1) { return object_base::new_object(p1); }
