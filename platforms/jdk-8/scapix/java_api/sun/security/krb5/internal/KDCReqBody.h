...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_INTERNAL_KDCREQBODY
...
public:
	...
	static jni::ref<sun::security::krb5::internal::KDCReqBody> new_object(jni::ref<sun::security::krb5::internal::KDCOptions> p1, jni::ref<sun::security::krb5::PrincipalName> p2, jni::ref<sun::security::krb5::PrincipalName> p3, jni::ref<sun::security::krb5::internal::KerberosTime> p4, jni::ref<sun::security::krb5::internal::KerberosTime> p5, jni::ref<sun::security::krb5::internal::KerberosTime> p6, jint p7, jni::ref<jni::array<jint>> p8, jni::ref<sun::security::krb5::internal::HostAddresses> p9, jni::ref<sun::security::krb5::EncryptedData> p10, jni::ref<jni::array<sun::security::krb5::internal::Ticket>> p11) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); }
	static jni::ref<sun::security::krb5::internal::KDCReqBody> new_object(jni::ref<sun::security::util::DerValue> p1, jint p2) { return object_base::new_object(p1, p2); }
