...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_CHECKSUM
...
public:
	...
	static jni::ref<sun::security::krb5::Checksum> new_object(jni::ref<jni::array<jbyte>> p1, jint p2) { return object_base::new_object(p1, p2); }
	...
	static jni::ref<sun::security::krb5::Checksum> new_object(jint p1, jni::ref<jni::array<jbyte>> p2, jni::ref<sun::security::krb5::EncryptionKey> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	...
	static jni::ref<sun::security::krb5::Checksum> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
