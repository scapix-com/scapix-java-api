...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_REALM
...
public:
	...
	static jni::ref<sun::security::krb5::Realm> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	...
	static jni::ref<sun::security::krb5::Realm> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
