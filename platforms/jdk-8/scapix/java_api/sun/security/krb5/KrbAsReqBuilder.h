...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_KRBASREQBUILDER
...
public:
	...
	static jni::ref<sun::security::krb5::KrbAsReqBuilder> new_object(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<javax::security::auth::kerberos::KeyTab> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::krb5::KrbAsReqBuilder> new_object(jni::ref<sun::security::krb5::PrincipalName> p1, jni::ref<jni::array<jchar>> p2) { return object_base::new_object(p1, p2); }
