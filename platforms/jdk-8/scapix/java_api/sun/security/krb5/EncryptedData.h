...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_KRB5_ENCRYPTEDDATA
...
public:
	...
	static jni::ref<sun::security::krb5::EncryptedData> new_object(jint p1, jni::ref<java::lang::Integer> p2, jni::ref<jni::array<jbyte>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::krb5::EncryptedData> new_object(jni::ref<sun::security::krb5::EncryptionKey> p1, jni::ref<jni::array<jbyte>> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
