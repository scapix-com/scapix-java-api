...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_RSA_RSAKEYFACTORY
...
public:
	...
	static jni::ref<sun::security::rsa::RSAKeyFactory> new_object(jni::ref<sun::security::rsa::RSAUtil_KeyType> p1) { return object_base::new_object(p1); }
};
