...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_PKCS9ATTRIBUTE
...
public:
	...
	static jni::ref<sun::security::pkcs::PKCS9Attribute> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::pkcs::PKCS9Attribute> new_object(jni::ref<sun::security::util::DerValue> p1) { return object_base::new_object(p1); }
