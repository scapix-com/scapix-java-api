...
public:
	...
	static jni::ref<sun::security::pkcs::SignerInfo_AlgorithmInfo> new_object(jni::ref<sun::security::pkcs::SignerInfo> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
