...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_CONTENTINFO
...
public:
	...
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1, jni::ref<sun::security::util::DerValue> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::ContentInfo> new_object(jni::ref<sun::security::util::DerInputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
