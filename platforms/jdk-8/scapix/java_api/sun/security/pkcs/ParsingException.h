...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_PARSINGEXCEPTION
...
public:
	...
	static jni::ref<sun::security::pkcs::ParsingException> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::pkcs::ParsingException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
