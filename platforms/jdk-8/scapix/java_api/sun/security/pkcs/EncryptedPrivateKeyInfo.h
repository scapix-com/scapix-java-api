...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_ENCRYPTEDPRIVATEKEYINFO
...
public:
	...
	static jni::ref<sun::security::pkcs::EncryptedPrivateKeyInfo> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::EncryptedPrivateKeyInfo> new_object(jni::ref<sun::security::x509::AlgorithmId> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
