...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_PKCS9ATTRIBUTES
...
public:
	...
	static jni::ref<sun::security::pkcs::PKCS9Attributes> new_object(jni::ref<jni::array<sun::security::util::ObjectIdentifier>> p1, jni::ref<sun::security::util::DerInputStream> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::pkcs::PKCS9Attributes> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::PKCS9Attributes> new_object(jni::ref<sun::security::util::DerInputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::pkcs::PKCS9Attributes> new_object(jni::ref<jni::array<sun::security::pkcs::PKCS9Attribute>> p1) { return object_base::new_object(p1); }
