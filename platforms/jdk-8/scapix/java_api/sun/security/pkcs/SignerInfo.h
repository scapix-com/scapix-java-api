...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_SIGNERINFO
...
public:
	...
	static jni::ref<sun::security::pkcs::SignerInfo> new_object(jni::ref<sun::security::x509::X500Name> p1, jni::ref<java::math::BigInteger> p2, jni::ref<sun::security::x509::AlgorithmId> p3, jni::ref<sun::security::x509::AlgorithmId> p4, jni::ref<jni::array<jbyte>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	...
	static jni::ref<sun::security::pkcs::SignerInfo> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::SignerInfo> new_object(jni::ref<sun::security::util::DerInputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
