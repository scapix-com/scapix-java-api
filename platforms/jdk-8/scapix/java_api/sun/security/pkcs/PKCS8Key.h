...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_PKCS8KEY
...
public:
	...
	static jni::ref<sun::security::pkcs::PKCS8Key> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::pkcs::PKCS8Key> parse(jni::ref<sun::security::util::DerValue> p1) { return call_static_method<"parse", jni::ref<sun::security::pkcs::PKCS8Key>>(p1); }
	static jni::ref<java::security::PrivateKey> parseKey(jni::ref<sun::security::util::DerValue> p1) { return call_static_method<"parseKey", jni::ref<java::security::PrivateKey>>(p1); }
