...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PKCS_PKCS7
...
public:
	...
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<jni::array<sun::security::x509::AlgorithmId>> p1, jni::ref<sun::security::pkcs::ContentInfo> p2, jni::ref<jni::array<java::security::cert::X509Certificate>> p3, jni::ref<jni::array<java::security::cert::X509CRL>> p4, jni::ref<jni::array<sun::security::pkcs::SignerInfo>> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::security::pkcs::PKCS7> new_object(jni::ref<jni::array<sun::security::x509::AlgorithmId>> p1, jni::ref<sun::security::pkcs::ContentInfo> p2, jni::ref<jni::array<java::security::cert::X509Certificate>> p3, jni::ref<jni::array<sun::security::pkcs::SignerInfo>> p4) { return object_base::new_object(p1, p2, p3, p4); }
