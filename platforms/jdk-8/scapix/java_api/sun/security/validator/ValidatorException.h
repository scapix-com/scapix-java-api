...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_VALIDATOR_VALIDATOREXCEPTION
...
public:
	...
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::Object> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::security::cert::X509Certificate> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::Object> p1, jni::ref<java::security::cert::X509Certificate> p2, jni::ref<java::lang::Throwable> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jni::ref<java::security::cert::X509Certificate> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jni::ref<java::security::cert::X509Certificate> p3, jni::ref<java::lang::Throwable> p4) { return object_base::new_object(p1, p2, p3, p4); }
