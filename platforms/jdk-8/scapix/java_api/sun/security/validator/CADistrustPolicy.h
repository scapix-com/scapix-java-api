...
namespace scapix::java_api { namespace sun::security::validator { class CADistrustPolicy; }}
...
public:
	...
	static jni::ref<sun::security::validator::CADistrustPolicy> ENTRUST_TLS() { return get_static_field<"ENTRUST_TLS", jni::ref<sun::security::validator::CADistrustPolicy>>(); }
	static jni::ref<sun::security::validator::CADistrustPolicy> CAMERFIRMA_TLS() { return get_static_field<"CAMERFIRMA_TLS", jni::ref<sun::security::validator::CADistrustPolicy>>(); }
	static jni::ref<sun::security::validator::CADistrustPolicy> CHUNGHWA_TLS() { return get_static_field<"CHUNGHWA_TLS", jni::ref<sun::security::validator::CADistrustPolicy>>(); }
