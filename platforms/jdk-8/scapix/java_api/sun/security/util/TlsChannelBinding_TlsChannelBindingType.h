...
class TlsChannelBinding_TlsChannelBindingType;
...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_TLSCHANNELBINDING_TLSCHANNELBINDINGTYPE
...
public:
	...
	static jni::ref<sun::security::util::TlsChannelBinding_TlsChannelBindingType> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<sun::security::util::TlsChannelBinding_TlsChannelBindingType>>(p1); }
