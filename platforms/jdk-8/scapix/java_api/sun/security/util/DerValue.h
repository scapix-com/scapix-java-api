...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_DERVALUE
...
public:
	...
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::util::DerValue> new_object(jbyte p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::util::DerValue> new_object(jbyte p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::util::DerValue> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
