...
public:
	...
	static jni::ref<sun::security::util::ManifestDigester_Section> new_object(jint p1, jint p2, jint p3, jni::ref<jni::array<jbyte>> p4) { return object_base::new_object(p1, p2, p3, p4); }
