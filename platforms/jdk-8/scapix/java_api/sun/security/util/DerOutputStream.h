...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_DEROUTPUTSTREAM
...
public:
	...
	static jni::ref<sun::security::util::DerOutputStream> new_object(jint p1) { return object_base::new_object(p1); }
