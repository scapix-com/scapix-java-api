...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_DEBUG
...
public:
	...
	void println(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return call_method<"println", void>(p1, p2); }
