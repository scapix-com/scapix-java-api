...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_MANIFESTDIGESTER
...
public:
	...
	static jni::ref<sun::security::util::ManifestDigester> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
