...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_MANIFESTENTRYVERIFIER
...
public:
	...
	static jni::ref<sun::security::util::ManifestEntryVerifier> new_object(jni::ref<java::util::jar::Manifest> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
