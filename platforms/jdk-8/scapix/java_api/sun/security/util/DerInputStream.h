...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_DERINPUTSTREAM
...
public:
	...
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::util::DerInputStream> new_object(jni::ref<jni::array<jbyte>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
