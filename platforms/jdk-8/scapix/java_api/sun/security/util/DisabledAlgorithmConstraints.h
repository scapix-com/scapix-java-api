...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_DISABLEDALGORITHMCONSTRAINTS
...
public:
	...
	static jni::ref<sun::security::util::DisabledAlgorithmConstraints> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::util::DisabledAlgorithmConstraints> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::security::util::AlgorithmDecomposer> p2) { return object_base::new_object(p1, p2); }
	...
	jboolean permits(jni::ref<java::lang::String> p1, jni::ref<java::util::Set> p2) { return call_method<"permits", jboolean>(p1, p2); }
