...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_SIGNATUREFILEVERIFIER
...
public:
	...
	static jni::ref<sun::security::util::SignatureFileVerifier> new_object(jni::ref<java::util::ArrayList> p1, jni::ref<sun::security::util::ManifestDigester> p2, jni::ref<java::lang::String> p3, jni::ref<jni::array<jbyte>> p4) { return object_base::new_object(p1, p2, p3, p4); }
