...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_UTIL_BITARRAY
...
public:
	...
	static jni::ref<sun::security::util::BitArray> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::util::BitArray> new_object(jint p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::util::BitArray> new_object(jint p1, jni::ref<jni::array<jbyte>> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::util::BitArray> new_object(jni::ref<jni::array<jboolean>> p1) { return object_base::new_object(p1); }
