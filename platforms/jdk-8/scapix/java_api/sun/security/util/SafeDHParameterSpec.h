...
public:
	...
	static jni::ref<sun::security::util::SafeDHParameterSpec> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::math::BigInteger> p2) { return base_::new_object(p1, p2); }
	static jni::ref<sun::security::util::SafeDHParameterSpec> new_object(jni::ref<java::math::BigInteger> p1, jni::ref<java::math::BigInteger> p2, jint p3) { return base_::new_object(p1, p2, p3); }
