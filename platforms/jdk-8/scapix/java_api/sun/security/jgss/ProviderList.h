...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_JGSS_PROVIDERLIST
...
public:
	...
	static jni::ref<sun::security::jgss::ProviderList> new_object(jni::ref<sun::security::jgss::GSSCaller> p1, jboolean p2) { return object_base::new_object(p1, p2); }
