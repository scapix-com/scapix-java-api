...
namespace scapix::java_api { namespace sun::security::jgss { class GSSCredentialImpl; }}
...
public:
	...
	static jni::ref<sun::security::jgss::GSSCredentialImpl> new_object(jni::ref<sun::security::jgss::GSSManagerImpl> p1, jni::ref<sun::security::jgss::spi::GSSCredentialSpi> p2) { return object_base::new_object(p1, p2); }
