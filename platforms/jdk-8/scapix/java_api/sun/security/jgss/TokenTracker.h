...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_JGSS_TOKENTRACKER
...
public:
	...
	static jni::ref<sun::security::jgss::TokenTracker> new_object(jint p1) { return object_base::new_object(p1); }
