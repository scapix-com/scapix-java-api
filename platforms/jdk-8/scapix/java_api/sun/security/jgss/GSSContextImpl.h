...
namespace scapix::java_api { namespace sun::security::jgss { class GSSContextImpl; }}
...
public:
	...
	static jni::ref<sun::security::jgss::GSSContextImpl> new_object(jni::ref<sun::security::jgss::GSSManagerImpl> p1, jni::ref<org::ietf::jgss::GSSName> p2, jni::ref<org::ietf::jgss::Oid> p3, jni::ref<org::ietf::jgss::GSSCredential> p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::security::jgss::GSSContextImpl> new_object(jni::ref<sun::security::jgss::GSSManagerImpl> p1, jni::ref<org::ietf::jgss::GSSCredential> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::jgss::GSSContextImpl> new_object(jni::ref<sun::security::jgss::GSSManagerImpl> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
