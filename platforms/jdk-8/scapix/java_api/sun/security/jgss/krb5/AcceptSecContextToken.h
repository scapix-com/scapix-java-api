...
namespace scapix::java_api { namespace sun::security::jgss::krb5 { class AcceptSecContextToken; }}
...
public:
	...
	static jni::ref<sun::security::jgss::krb5::AcceptSecContextToken> new_object(jni::ref<sun::security::jgss::krb5::Krb5Context> p1, jni::ref<sun::security::krb5::KrbApReq> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::jgss::krb5::AcceptSecContextToken> new_object(jni::ref<sun::security::jgss::krb5::Krb5Context> p1, jni::ref<sun::security::krb5::Credentials> p2, jni::ref<sun::security::krb5::KrbApReq> p3, jni::ref<java::io::InputStream> p4) { return object_base::new_object(p1, p2, p3, p4); }
