...
namespace scapix::java_api { namespace sun::security::jgss::krb5 { class MessageToken_MessageTokenHeader; }}
...
public:
	...
	static jni::ref<sun::security::jgss::krb5::MessageToken_MessageTokenHeader> new_object(jni::ref<sun::security::jgss::krb5::MessageToken> p1, jint p2, jboolean p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::jgss::krb5::MessageToken_MessageTokenHeader> new_object(jni::ref<sun::security::jgss::krb5::MessageToken> p1, jni::ref<java::io::InputStream> p2, jni::ref<org::ietf::jgss::MessageProp> p3) { return object_base::new_object(p1, p2, p3); }
