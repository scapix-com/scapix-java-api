...
namespace scapix::java_api { namespace sun::security::jgss::krb5 { class Krb5Context; }}
...
public:
	...
	static jni::ref<sun::security::jgss::krb5::Krb5Context> new_object(jni::ref<sun::security::jgss::GSSCaller> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
