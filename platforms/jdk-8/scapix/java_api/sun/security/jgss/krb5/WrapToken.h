...
namespace scapix::java_api { namespace sun::security::jgss::krb5 { class WrapToken; }}
...
public:
	...
	static jni::ref<sun::security::jgss::krb5::WrapToken> new_object(jni::ref<sun::security::jgss::krb5::Krb5Context> p1, jni::ref<jni::array<jbyte>> p2, jint p3, jint p4, jni::ref<org::ietf::jgss::MessageProp> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::security::jgss::krb5::WrapToken> new_object(jni::ref<sun::security::jgss::krb5::Krb5Context> p1, jni::ref<java::io::InputStream> p2, jni::ref<org::ietf::jgss::MessageProp> p3) { return object_base::new_object(p1, p2, p3); }
	...
	static jni::ref<sun::security::jgss::krb5::WrapToken> new_object(jni::ref<sun::security::jgss::krb5::Krb5Context> p1, jni::ref<org::ietf::jgss::MessageProp> p2, jni::ref<jni::array<jbyte>> p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
