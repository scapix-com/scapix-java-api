...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_JGSS_GSSHEADER
...
public:
	...
	static jni::ref<sun::security::jgss::GSSHeader> new_object(jni::ref<sun::security::util::ObjectIdentifier> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::jgss::GSSHeader> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
