...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_ACL_WORLDGROUPIMPL
...
public:
	...
	static jni::ref<sun::security::acl::WorldGroupImpl> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
