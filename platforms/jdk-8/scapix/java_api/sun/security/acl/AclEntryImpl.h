...
namespace scapix::java_api::sun::security::acl { class AclEntryImpl; }
...
public:
	...
	static jni::ref<sun::security::acl::AclEntryImpl> new_object(jni::ref<java::security::Principal> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::acl::AclEntryImpl> new_object() { return base_::new_object(); }
