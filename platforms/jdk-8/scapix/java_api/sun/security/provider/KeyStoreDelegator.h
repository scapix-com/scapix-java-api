...
namespace scapix::java_api::sun::security::provider { class KeyStoreDelegator; }
...
public:
	...
	static jni::ref<sun::security::provider::KeyStoreDelegator> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::Class> p4) { return base_::new_object(p1, p2, p3, p4); }
