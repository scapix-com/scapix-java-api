...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_KEYSTOREDELEGATOR_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_KEYSTOREDELEGATOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::provider { class KeyStoreDelegator; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::provider::KeyStoreDelegator>
{
	static constexpr fixed_string class_name = "sun/security/provider/KeyStoreDelegator";
	using base_classes = std::tuple<scapix::java_api::java::security::KeyStoreSpi>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_KEYSTOREDELEGATOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_KEYSTOREDELEGATOR)
#define SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_KEYSTOREDELEGATOR
...
// private
class sun::security::provider::KeyStoreDelegator : public jni::object_base<"sun/security/provider/KeyStoreDelegator",
	java::security::KeyStoreSpi>
{
public:

	static jni::ref<sun::security::provider::KeyStoreDelegator> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Class> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::Class> p4) { return object_base::new_object(p1, p2, p3, p4); }
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_KEYSTOREDELEGATOR
