...
namespace scapix::java_api { namespace sun::security::provider { class DSAKeyPairGenerator_Legacy; }}
...
public:
	...
	static jni::ref<sun::security::provider::DSAKeyPairGenerator_Legacy> new_object() { return object_base::new_object(); }
