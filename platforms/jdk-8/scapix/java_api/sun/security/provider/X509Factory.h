...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_X509FACTORY
...
public:
	...
	static jint BER_ITERATION_COUNT() { return get_static_field<"BER_ITERATION_COUNT", jint>(); }

	static jni::ref<sun::security::provider::X509Factory> new_object() { return object_base::new_object(); }
