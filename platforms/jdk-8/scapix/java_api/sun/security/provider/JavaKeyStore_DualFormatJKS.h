...
#include <scapix/java_api/sun/security/provider/KeyStoreDelegator.h>
...
namespace scapix::java_api { namespace sun::security::provider { class JavaKeyStore_DualFormatJKS; }}
...
struct scapix::jni::object_traits<scapix::java_api::sun::security::provider::JavaKeyStore_DualFormatJKS>
{
	...
	using base_classes = std::tuple<scapix::java_api::sun::security::provider::KeyStoreDelegator>;
};
...
public:
	...
	static jni::ref<sun::security::provider::JavaKeyStore_DualFormatJKS> new_object() { return object_base::new_object(); }
