...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_ADJACENCYLIST
...
public:
	...
	static jni::ref<sun::security::provider::certpath::AdjacencyList> new_object(jni::ref<java::util::List> p1) { return object_base::new_object(p1); }
