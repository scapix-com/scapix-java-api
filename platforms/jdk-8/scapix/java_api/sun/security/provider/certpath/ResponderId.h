...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_RESPONDERID
...
public:
	...
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<javax::security::auth::x500::X500Principal> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<java::security::PublicKey> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::provider::certpath::ResponderId> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
