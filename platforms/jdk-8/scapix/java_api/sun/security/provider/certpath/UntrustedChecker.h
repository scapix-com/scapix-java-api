...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_UNTRUSTEDCHECKER
...
public:
	...
	static jni::ref<sun::security::provider::certpath::UntrustedChecker> new_object() { return object_base::new_object(); }
