...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_ALGORITHMCHECKER
...
public:
	...
	static jni::ref<sun::security::provider::certpath::AlgorithmChecker> new_object(jni::ref<java::security::cert::TrustAnchor> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::provider::certpath::AlgorithmChecker> new_object(jni::ref<java::security::AlgorithmConstraints> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::provider::certpath::AlgorithmChecker> new_object(jni::ref<java::security::cert::TrustAnchor> p1, jni::ref<java::security::AlgorithmConstraints> p2, jni::ref<java::util::Date> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::security::provider::certpath::AlgorithmChecker> new_object(jni::ref<java::security::cert::TrustAnchor> p1, jni::ref<java::util::Date> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
