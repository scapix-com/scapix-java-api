...
class OCSPResponse_ResponseStatus;
...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_OCSPRESPONSE_RESPONSESTATUS
...
public:
	...
	static jni::ref<sun::security::provider::certpath::OCSPResponse_ResponseStatus> valueOf(jni::ref<java::lang::String> p1) { return call_static_method<"valueOf", jni::ref<sun::security::provider::certpath::OCSPResponse_ResponseStatus>>(p1); }
};
