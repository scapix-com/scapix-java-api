...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_PKIXEXTENDEDPARAMETERS
...
public:
	...
	static jni::ref<sun::security::provider::certpath::PKIXExtendedParameters> new_object(jni::ref<java::security::cert::PKIXBuilderParameters> p1, jni::ref<java::security::Timestamp> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
