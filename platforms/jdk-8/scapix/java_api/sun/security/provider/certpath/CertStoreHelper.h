...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_CERTSTOREHELPER
...
public:
	...
	static jni::ref<sun::security::provider::certpath::CertStoreHelper> new_object() { return object_base::new_object(); }
