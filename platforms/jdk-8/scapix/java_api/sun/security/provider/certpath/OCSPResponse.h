...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_OCSPRESPONSE
...
public:
	...
	static jni::ref<sun::security::provider::certpath::OCSPResponse> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	...
	jni::ref<sun::security::provider::certpath::OCSPResponse_SingleResponse> getSingleResponse(jni::ref<sun::security::provider::certpath::CertId> p1) { return call_method<"getSingleResponse", jni::ref<sun::security::provider::certpath::OCSPResponse_SingleResponse>>(p1); }
