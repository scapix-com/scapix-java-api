...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_CERTID
...
public:
	...
	static jni::ref<sun::security::provider::certpath::CertId> new_object(jni::ref<java::security::cert::X509Certificate> p1, jni::ref<sun::security::x509::SerialNumber> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::security::provider::certpath::CertId> new_object(jni::ref<javax::security::auth::x500::X500Principal> p1, jni::ref<java::security::PublicKey> p2, jni::ref<sun::security::x509::SerialNumber> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::security::provider::certpath::CertId> new_object(jni::ref<sun::security::util::DerInputStream> p1) { return object_base::new_object(p1); }
