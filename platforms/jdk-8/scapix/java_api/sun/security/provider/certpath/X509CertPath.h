...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_X509CERTPATH
...
public:
	...
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::util::List> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
