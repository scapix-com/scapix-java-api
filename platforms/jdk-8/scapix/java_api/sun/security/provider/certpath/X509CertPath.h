...
public:
	...
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::util::List> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::io::InputStream> p1) { return base_::new_object(p1); }
	static jni::ref<sun::security::provider::certpath::X509CertPath> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::String> p2) { return base_::new_object(p1, p2); }
