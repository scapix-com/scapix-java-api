...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_CERTPATH_PKIXTIMESTAMPPARAMETERS
...
public:
	...
	static jni::ref<sun::security::provider::certpath::PKIXTimestampParameters> new_object(jni::ref<java::security::cert::PKIXBuilderParameters> p1, jni::ref<java::security::Timestamp> p2) { return object_base::new_object(p1, p2); }
