...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_POLICYFILE
...
public:
	...
	static jni::ref<sun::security::provider::PolicyFile> new_object() { return object_base::new_object(); }
	static jni::ref<sun::security::provider::PolicyFile> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
