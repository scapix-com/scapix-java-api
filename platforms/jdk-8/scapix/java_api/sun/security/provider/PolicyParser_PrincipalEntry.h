...
class PolicyParser_PrincipalEntry;
...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_PROVIDER_POLICYPARSER_PRINCIPALENTRY
...
public:
	...
	static jni::ref<sun::security::provider::PolicyParser_PrincipalEntry> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
