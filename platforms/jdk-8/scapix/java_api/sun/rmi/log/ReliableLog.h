...
#ifndef SCAPIX_JAVA_API_SUN_RMI_LOG_RELIABLELOG
...
public:
	...
	static jni::ref<sun::rmi::log::ReliableLog> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::rmi::log::LogHandler> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::log::ReliableLog> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::rmi::log::LogHandler> p2) { return object_base::new_object(p1, p2); }
