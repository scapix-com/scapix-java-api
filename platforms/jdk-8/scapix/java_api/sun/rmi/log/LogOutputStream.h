...
#ifndef SCAPIX_JAVA_API_SUN_RMI_LOG_LOGOUTPUTSTREAM
...
public:
	...
	static jni::ref<sun::rmi::log::LogOutputStream> new_object(jni::ref<java::io::RandomAccessFile> p1) { return object_base::new_object(p1); }
