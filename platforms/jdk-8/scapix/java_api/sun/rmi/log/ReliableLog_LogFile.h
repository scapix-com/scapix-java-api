...
#ifndef SCAPIX_JAVA_API_SUN_RMI_LOG_RELIABLELOG_LOGFILE
...
public:
	...
	static jni::ref<sun::rmi::log::ReliableLog_LogFile> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
};
