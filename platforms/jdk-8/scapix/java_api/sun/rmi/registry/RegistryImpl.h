...
#ifndef SCAPIX_JAVA_API_SUN_RMI_REGISTRY_REGISTRYIMPL
...
public:
	...
	static jni::ref<sun::rmi::registry::RegistryImpl> new_object(jint p1, jni::ref<java::rmi::server::RMIClientSocketFactory> p2, jni::ref<java::rmi::server::RMIServerSocketFactory> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::registry::RegistryImpl> new_object(jint p1, jni::ref<java::rmi::server::RMIClientSocketFactory> p2, jni::ref<java::rmi::server::RMIServerSocketFactory> p3, jni::ref<sun::misc::ObjectInputFilter> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::rmi::registry::RegistryImpl> new_object(jint p1) { return object_base::new_object(p1); }
