...
#ifndef SCAPIX_JAVA_API_SUN_RMI_REGISTRY_REGISTRYIMPL_STUB
...
public:
	...
	static jni::ref<sun::rmi::registry::RegistryImpl_Stub> new_object() { return object_base::new_object(); }
	static jni::ref<sun::rmi::registry::RegistryImpl_Stub> new_object(jni::ref<java::rmi::server::RemoteRef> p1) { return object_base::new_object(p1); }
