...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_STREAMREMOTECALL
...
public:
	...
	static jni::ref<sun::rmi::transport::StreamRemoteCall> new_object(jni::ref<sun::rmi::transport::Connection> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::rmi::transport::StreamRemoteCall> new_object(jni::ref<sun::rmi::transport::Connection> p1, jni::ref<java::rmi::server::ObjID> p2, jint p3, jlong p4) { return object_base::new_object(p1, p2, p3, p4); }
