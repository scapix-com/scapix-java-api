...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_TCP_TCPENDPOINT
...
public:
	...
	static jni::ref<sun::rmi::transport::tcp::TCPEndpoint> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::rmi::transport::tcp::TCPEndpoint> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<java::rmi::server::RMIClientSocketFactory> p3, jni::ref<java::rmi::server::RMIServerSocketFactory> p4) { return object_base::new_object(p1, p2, p3, p4); }
