...
namespace scapix::java_api { namespace sun::rmi::transport::tcp { class ConnectionMultiplexer; }}
...
public:
	...
	static jni::ref<sun::rmi::transport::tcp::ConnectionMultiplexer> new_object(jni::ref<sun::rmi::transport::tcp::TCPChannel> p1, jni::ref<java::io::InputStream> p2, jni::ref<java::io::OutputStream> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
