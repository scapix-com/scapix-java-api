...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_PROXY_RMIDIRECTSOCKETFACTORY
...
public:
	...
	static jni::ref<sun::rmi::transport::proxy::RMIDirectSocketFactory> new_object() { return object_base::new_object(); }
