...
namespace scapix::java_api { namespace sun::rmi::transport::proxy { class HttpSendOutputStream; }}
...
public:
	...
	static jni::ref<sun::rmi::transport::proxy::HttpSendOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<sun::rmi::transport::proxy::HttpSendSocket> p2) { return object_base::new_object(p1, p2); }
