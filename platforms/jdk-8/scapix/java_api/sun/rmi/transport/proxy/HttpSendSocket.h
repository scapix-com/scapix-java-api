...
namespace scapix::java_api { namespace sun::rmi::transport::proxy { class HttpSendSocket; }}
...
public:
	...
	static jni::ref<sun::rmi::transport::proxy::HttpSendSocket> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<java::net::URL> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::transport::proxy::HttpSendSocket> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::rmi::transport::proxy::HttpSendSocket> new_object(jni::ref<java::net::InetAddress> p1, jint p2) { return object_base::new_object(p1, p2); }
