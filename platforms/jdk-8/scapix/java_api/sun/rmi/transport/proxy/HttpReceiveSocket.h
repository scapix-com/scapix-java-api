...
struct scapix::jni::object_traits<scapix::java_api::sun::rmi::transport::proxy::HttpReceiveSocket>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::sun::rmi::transport::proxy::RMISocketInfo>;
};
...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_PROXY_HTTPRECEIVESOCKET
...
public:
	...
	static jni::ref<sun::rmi::transport::proxy::HttpReceiveSocket> new_object(jni::ref<java::net::Socket> p1, jni::ref<java::io::InputStream> p2, jni::ref<java::io::OutputStream> p3) { return object_base::new_object(p1, p2, p3); }
