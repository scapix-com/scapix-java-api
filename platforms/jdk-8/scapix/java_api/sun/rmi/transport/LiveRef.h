...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_LIVEREF
...
public:
	...
	static jni::ref<sun::rmi::transport::LiveRef> new_object(jni::ref<java::rmi::server::ObjID> p1, jni::ref<sun::rmi::transport::Endpoint> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::transport::LiveRef> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::rmi::transport::LiveRef> new_object(jint p1, jni::ref<java::rmi::server::RMIClientSocketFactory> p2, jni::ref<java::rmi::server::RMIServerSocketFactory> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::transport::LiveRef> new_object(jni::ref<java::rmi::server::ObjID> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::rmi::transport::LiveRef> new_object(jni::ref<java::rmi::server::ObjID> p1, jint p2, jni::ref<java::rmi::server::RMIClientSocketFactory> p3, jni::ref<java::rmi::server::RMIServerSocketFactory> p4) { return object_base::new_object(p1, p2, p3, p4); }
