...
namespace scapix::java_api { namespace sun::rmi::transport { class DGCClient_EndpointEntry_RefEntry; }}
...
public:
	...
	static jni::ref<sun::rmi::transport::DGCClient_EndpointEntry_RefEntry> new_object(jni::ref<sun::rmi::transport::DGCClient_EndpointEntry> p1, jni::ref<sun::rmi::transport::LiveRef> p2) { return object_base::new_object(p1, p2); }
