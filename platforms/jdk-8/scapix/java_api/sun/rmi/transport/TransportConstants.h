...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_TRANSPORTCONSTANTS
...
public:
	...
	static jni::ref<sun::rmi::transport::TransportConstants> new_object() { return object_base::new_object(); }
};
