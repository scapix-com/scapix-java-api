...
#ifndef SCAPIX_JAVA_API_SUN_RMI_TRANSPORT_TARGET
...
public:
	...
	static jni::ref<sun::rmi::transport::Target> new_object(jni::ref<java::rmi::Remote> p1, jni::ref<sun::rmi::server::Dispatcher> p2, jni::ref<java::rmi::Remote> p3, jni::ref<java::rmi::server::ObjID> p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
