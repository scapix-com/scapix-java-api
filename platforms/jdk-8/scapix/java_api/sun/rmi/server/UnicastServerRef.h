...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_UNICASTSERVERREF
...
public:
	...
	static jni::ref<sun::rmi::server::UnicastServerRef> new_object() { return object_base::new_object(); }
	static jni::ref<sun::rmi::server::UnicastServerRef> new_object(jni::ref<sun::rmi::transport::LiveRef> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::rmi::server::UnicastServerRef> new_object(jni::ref<sun::rmi::transport::LiveRef> p1, jni::ref<sun::misc::ObjectInputFilter> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::rmi::server::UnicastServerRef> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::rmi::server::UnicastServerRef> new_object(jboolean p1) { return object_base::new_object(p1); }
