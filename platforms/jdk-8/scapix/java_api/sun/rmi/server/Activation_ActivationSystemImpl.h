...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL_FWD
#define SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::rmi::server { class Activation_ActivationSystemImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::rmi::server::Activation_ActivationSystemImpl>
{
	static constexpr fixed_string class_name = "sun/rmi/server/Activation$ActivationSystemImpl";
	using base_classes = std::tuple<scapix::java_api::java::rmi::server::RemoteServer, scapix::java_api::java::rmi::activation::ActivationSystem>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL)
#define SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL
...
// private
class sun::rmi::server::Activation_ActivationSystemImpl : public jni::object_base<"sun/rmi/server/Activation$ActivationSystemImpl",
...
protected:
	...
	Activation_ActivationSystemImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL
