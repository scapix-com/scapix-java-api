...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_UNICASTSERVERREF2
...
public:
	...
	static jni::ref<sun::rmi::server::UnicastServerRef2> new_object() { return object_base::new_object(); }
	static jni::ref<sun::rmi::server::UnicastServerRef2> new_object(jni::ref<sun::rmi::transport::LiveRef> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::rmi::server::UnicastServerRef2> new_object(jni::ref<sun::rmi::transport::LiveRef> p1, jni::ref<sun::misc::ObjectInputFilter> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::rmi::server::UnicastServerRef2> new_object(jint p1, jni::ref<java::rmi::server::RMIClientSocketFactory> p2, jni::ref<java::rmi::server::RMIServerSocketFactory> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::server::UnicastServerRef2> new_object(jint p1, jni::ref<java::rmi::server::RMIClientSocketFactory> p2, jni::ref<java::rmi::server::RMIServerSocketFactory> p3, jni::ref<sun::misc::ObjectInputFilter> p4) { return object_base::new_object(p1, p2, p3, p4); }
