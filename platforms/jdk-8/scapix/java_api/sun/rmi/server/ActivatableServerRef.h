...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATABLESERVERREF
...
public:
	...
	static jni::ref<sun::rmi::server::ActivatableServerRef> new_object(jni::ref<java::rmi::activation::ActivationID> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::rmi::server::ActivatableServerRef> new_object(jni::ref<java::rmi::activation::ActivationID> p1, jint p2, jni::ref<java::rmi::server::RMIClientSocketFactory> p3, jni::ref<java::rmi::server::RMIServerSocketFactory> p4) { return object_base::new_object(p1, p2, p3, p4); }
