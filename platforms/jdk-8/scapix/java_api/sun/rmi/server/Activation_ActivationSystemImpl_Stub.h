...
class Activation_ActivationSystemImpl_Stub;
...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_ACTIVATION_ACTIVATIONSYSTEMIMPL_STUB
...
public:
	...
	static jni::ref<sun::rmi::server::Activation_ActivationSystemImpl_Stub> new_object(jni::ref<java::rmi::server::RemoteRef> p1) { return object_base::new_object(p1); }
