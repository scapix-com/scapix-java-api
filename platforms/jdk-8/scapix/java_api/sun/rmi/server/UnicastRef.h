...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_UNICASTREF
...
public:
	...
	static jni::ref<sun::rmi::server::UnicastRef> new_object() { return object_base::new_object(); }
	static jni::ref<sun::rmi::server::UnicastRef> new_object(jni::ref<sun::rmi::transport::LiveRef> p1) { return object_base::new_object(p1); }
