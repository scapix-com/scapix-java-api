...
#ifndef SCAPIX_JAVA_API_SUN_RMI_SERVER_MARSHALINPUTSTREAM
...
public:
	...
	static jni::ref<sun::rmi::server::MarshalInputStream> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
