...
namespace scapix::java_api { namespace sun::rmi::server { class LoaderHandler_LoaderKey; }}
...
public:
	...
	static jni::ref<sun::rmi::server::LoaderHandler_LoaderKey> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::lang::ClassLoader> p2) { return object_base::new_object(p1, p2); }
