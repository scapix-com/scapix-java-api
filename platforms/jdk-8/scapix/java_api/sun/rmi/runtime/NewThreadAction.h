...
#ifndef SCAPIX_JAVA_API_SUN_RMI_RUNTIME_NEWTHREADACTION
...
public:
	...
	static jni::ref<sun::rmi::runtime::NewThreadAction> new_object(jni::ref<java::lang::Runnable> p1, jni::ref<java::lang::String> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::rmi::runtime::NewThreadAction> new_object(jni::ref<java::lang::Runnable> p1, jni::ref<java::lang::String> p2, jboolean p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
