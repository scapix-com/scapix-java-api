...
#ifndef SCAPIX_JAVA_API_SUN_FONT_FONTLINEMETRICS
...
public:
	...
	static jni::ref<sun::font::FontLineMetrics> new_object(jint p1, jni::ref<sun::font::CoreMetrics> p2, jni::ref<java::awt::font::FontRenderContext> p3) { return object_base::new_object(p1, p2, p3); }
