...
#ifndef SCAPIX_JAVA_API_SUN_FONT_FONT2DHANDLE
...
public:
	...
	static jni::ref<sun::font::Font2DHandle> new_object(jni::ref<sun::font::Font2D> p1) { return object_base::new_object(p1); }
};
