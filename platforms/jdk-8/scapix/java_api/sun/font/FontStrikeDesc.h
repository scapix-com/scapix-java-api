...
#ifndef SCAPIX_JAVA_API_SUN_FONT_FONTSTRIKEDESC
...
public:
	...
	static jni::ref<sun::font::FontStrikeDesc> new_object(jni::ref<java::awt::geom::AffineTransform> p1, jni::ref<java::awt::geom::AffineTransform> p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
