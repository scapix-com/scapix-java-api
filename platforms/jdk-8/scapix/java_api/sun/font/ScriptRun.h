...
#ifndef SCAPIX_JAVA_API_SUN_FONT_SCRIPTRUN
...
public:
	...
	static jni::ref<sun::font::ScriptRun> new_object() { return object_base::new_object(); }
	static jni::ref<sun::font::ScriptRun> new_object(jni::ref<jni::array<jchar>> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
