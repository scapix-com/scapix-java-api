...
namespace scapix::java_api { namespace sun::font { class GraphicComponent; }}
...
public:
	...
	static jni::ref<sun::font::GraphicComponent> new_object(jni::ref<java::awt::font::GraphicAttribute> p1, jni::ref<sun::font::Decoration> p2, jni::ref<jni::array<jint>> p3, jni::ref<jni::array<jbyte>> p4, jint p5, jint p6, jni::ref<java::awt::geom::AffineTransform> p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
