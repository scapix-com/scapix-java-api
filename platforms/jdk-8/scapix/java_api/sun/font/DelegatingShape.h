...
#ifndef SCAPIX_JAVA_API_SUN_FONT_DELEGATINGSHAPE
...
public:
	...
	static jni::ref<sun::font::DelegatingShape> new_object(jni::ref<java::awt::Shape> p1) { return object_base::new_object(p1); }
