...
#ifndef SCAPIX_JAVA_API_SUN_FONT_FONTFAMILY
...
public:
	...
	static jni::ref<sun::font::FontFamily> new_object(jni::ref<java::lang::String> p1, jboolean p2, jint p3) { return object_base::new_object(p1, p2, p3); }
