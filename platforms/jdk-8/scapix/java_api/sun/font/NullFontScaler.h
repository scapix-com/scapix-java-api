...
namespace scapix::java_api { namespace sun::font { class NullFontScaler; }}
...
public:
	...
	static jni::ref<sun::font::NullFontScaler> new_object(jni::ref<sun::font::Font2D> p1, jint p2, jboolean p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
