...
#ifndef SCAPIX_JAVA_API_SUN_FONT_EXTENDEDTEXTSOURCELABEL_FWD
#define SCAPIX_JAVA_API_SUN_FONT_EXTENDEDTEXTSOURCELABEL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::font { class ExtendedTextSourceLabel; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::font::ExtendedTextSourceLabel>
{
	static constexpr fixed_string class_name = "sun/font/ExtendedTextSourceLabel";
	using base_classes = std::tuple<scapix::java_api::sun::font::ExtendedTextLabel, scapix::java_api::sun::font::Decoration_Label>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_FONT_EXTENDEDTEXTSOURCELABEL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_FONT_EXTENDEDTEXTSOURCELABEL)
#define SCAPIX_JAVA_API_SUN_FONT_EXTENDEDTEXTSOURCELABEL
...
// private
class sun::font::ExtendedTextSourceLabel : public jni::object_base<"sun/font/ExtendedTextSourceLabel",
	sun::font::ExtendedTextLabel,
	sun::font::Decoration_Label>
{
public:

	static jni::ref<sun::font::ExtendedTextSourceLabel> new_object(jni::ref<sun::font::TextSource> p1, jni::ref<sun::font::Decoration> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::font::ExtendedTextSourceLabel> new_object(jni::ref<sun::font::TextSource> p1, jni::ref<sun::font::ExtendedTextSourceLabel> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	...
	jni::ref<java::awt::geom::Rectangle2D> createItalicBounds() { return call_method<"createItalicBounds", jni::ref<java::awt::geom::Rectangle2D>>(); }
...
#endif // SCAPIX_JAVA_API_SUN_FONT_EXTENDEDTEXTSOURCELABEL
