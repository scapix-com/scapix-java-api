...
#ifndef SCAPIX_JAVA_API_SUN_FONT_COREMETRICS
...
public:
	...
	static jni::ref<sun::font::CoreMetrics> new_object(jfloat p1, jfloat p2, jfloat p3, jfloat p4, jint p5, jni::ref<jni::array<jfloat>> p6, jfloat p7, jfloat p8, jfloat p9, jfloat p10, jfloat p11, jfloat p12) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); }
