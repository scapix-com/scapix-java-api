...
#ifndef SCAPIX_JAVA_API_SUN_FONT_TYPE1FONT
...
public:
	...
	static jni::ref<sun::font::Type1Font> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::font::Type1Font> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Object> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
