...
#ifndef SCAPIX_JAVA_API_SUN_FONT_COMPOSITEFONTDESCRIPTOR
...
public:
	...
	static jni::ref<sun::font::CompositeFontDescriptor> new_object(jni::ref<java::lang::String> p1, jint p2, jni::ref<jni::array<java::lang::String>> p3, jni::ref<jni::array<java::lang::String>> p4, jni::ref<jni::array<jint>> p5, jni::ref<jni::array<jint>> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
