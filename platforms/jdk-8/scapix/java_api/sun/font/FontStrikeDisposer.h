...
namespace scapix::java_api { namespace sun::font { class FontStrikeDisposer; }}
...
public:
	...
	static jni::ref<sun::font::FontStrikeDisposer> new_object(jni::ref<sun::font::Font2D> p1, jni::ref<sun::font::FontStrikeDesc> p2, jlong p3, jni::ref<jni::array<jint>> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::font::FontStrikeDisposer> new_object(jni::ref<sun::font::Font2D> p1, jni::ref<sun::font::FontStrikeDesc> p2, jlong p3, jni::ref<jni::array<jlong>> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::font::FontStrikeDisposer> new_object(jni::ref<sun::font::Font2D> p1, jni::ref<sun::font::FontStrikeDesc> p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::font::FontStrikeDisposer> new_object(jni::ref<sun::font::Font2D> p1, jni::ref<sun::font::FontStrikeDesc> p2) { return object_base::new_object(p1, p2); }
