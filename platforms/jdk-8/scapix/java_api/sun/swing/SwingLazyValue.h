...
#ifndef SCAPIX_JAVA_API_SUN_SWING_SWINGLAZYVALUE
...
public:
	...
	static jni::ref<sun::swing::SwingLazyValue> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::swing::SwingLazyValue> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::swing::SwingLazyValue> new_object(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::Object>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::swing::SwingLazyValue> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<jni::array<java::lang::Object>> p3) { return object_base::new_object(p1, p2, p3); }
