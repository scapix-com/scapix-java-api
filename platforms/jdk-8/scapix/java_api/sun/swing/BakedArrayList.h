...
#ifndef SCAPIX_JAVA_API_SUN_SWING_BAKEDARRAYLIST
...
public:
	...
	static jni::ref<sun::swing::BakedArrayList> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::swing::BakedArrayList> new_object(jni::ref<java::util::List> p1) { return object_base::new_object(p1); }
