...
#ifndef SCAPIX_JAVA_API_SUN_SWING_WINDOWSPLACESBAR
...
public:
	...
	static jni::ref<sun::swing::WindowsPlacesBar> new_object(jni::ref<javax::swing::JFileChooser> p1, jboolean p2) { return object_base::new_object(p1, p2); }
