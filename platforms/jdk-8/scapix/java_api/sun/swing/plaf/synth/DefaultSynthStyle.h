...
#ifndef SCAPIX_JAVA_API_SUN_SWING_PLAF_SYNTH_DEFAULTSYNTHSTYLE
...
public:
	...
	static jni::ref<sun::swing::plaf::synth::DefaultSynthStyle> new_object() { return object_base::new_object(); }
	static jni::ref<sun::swing::plaf::synth::DefaultSynthStyle> new_object(jni::ref<sun::swing::plaf::synth::DefaultSynthStyle> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::swing::plaf::synth::DefaultSynthStyle> new_object(jni::ref<java::awt::Insets> p1, jboolean p2, jni::ref<jni::array<sun::swing::plaf::synth::DefaultSynthStyle_StateInfo>> p3, jni::ref<java::util::Map> p4) { return object_base::new_object(p1, p2, p3, p4); }
