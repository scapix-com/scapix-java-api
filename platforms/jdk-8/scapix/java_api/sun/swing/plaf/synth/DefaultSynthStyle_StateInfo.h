...
class DefaultSynthStyle_StateInfo;
...
#ifndef SCAPIX_JAVA_API_SUN_SWING_PLAF_SYNTH_DEFAULTSYNTHSTYLE_STATEINFO
...
public:
	...
	static jni::ref<sun::swing::plaf::synth::DefaultSynthStyle_StateInfo> new_object() { return object_base::new_object(); }
	static jni::ref<sun::swing::plaf::synth::DefaultSynthStyle_StateInfo> new_object(jint p1, jni::ref<java::awt::Font> p2, jni::ref<jni::array<java::awt::Color>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::swing::plaf::synth::DefaultSynthStyle_StateInfo> new_object(jni::ref<sun::swing::plaf::synth::DefaultSynthStyle_StateInfo> p1) { return object_base::new_object(p1); }
