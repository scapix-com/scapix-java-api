...
#ifndef SCAPIX_JAVA_API_SUN_SWING_PLAF_SYNTH_SYNTHFILECHOOSERUI
...
public:
	...
	static jni::ref<sun::swing::plaf::synth::SynthFileChooserUI> new_object(jni::ref<javax::swing::JFileChooser> p1) { return object_base::new_object(p1); }
