...
#ifndef SCAPIX_JAVA_API_SUN_SWING_PLAF_SYNTH_PAINT9PAINTER
...
public:
	...
	static jni::ref<sun::swing::plaf::synth::Paint9Painter> new_object(jint p1) { return object_base::new_object(p1); }
