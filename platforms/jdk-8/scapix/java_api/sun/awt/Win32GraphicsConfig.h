...
#ifndef SCAPIX_JAVA_API_SUN_AWT_WIN32GRAPHICSCONFIG
...
public:
	...
	static jni::ref<sun::awt::Win32GraphicsConfig> new_object(jni::ref<java::awt::GraphicsDevice> p1, jint p2) { return object_base::new_object(p1, p2); }
