...
namespace scapix::java_api { namespace sun::awt::geom { class CurveLink; }}
...
public:
	...
	static jni::ref<sun::awt::geom::CurveLink> new_object(jni::ref<sun::awt::geom::Curve> p1, jdouble p2, jdouble p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
