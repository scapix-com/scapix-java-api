...
#ifndef SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER2_FWD
#define SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER2_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::geom { class Order2; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::geom::Order2>
{
	static constexpr fixed_string class_name = "sun/awt/geom/Order2";
	using base_classes = std::tuple<scapix::java_api::sun::awt::geom::Curve>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER2_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER2)
#define SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER2
...
// private
class sun::awt::geom::Order2 : public jni::object_base<"sun/awt/geom/Order2",
	sun::awt::geom::Curve>
{
public:

	static void insert(jni::ref<java::util::Vector> p1, jni::ref<jni::array<jdouble>> p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6, jdouble p7, jdouble p8, jint p9) { return call_static_method<"insert", void>(p1, p2, p3, p4, p5, p6, p7, p8, p9); }
	static void addInstance(jni::ref<java::util::Vector> p1, jdouble p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6, jdouble p7, jint p8) { return call_static_method<"addInstance", void>(p1, p2, p3, p4, p5, p6, p7, p8); }
	static jint getHorizontalParams(jdouble p1, jdouble p2, jdouble p3, jni::ref<jni::array<jdouble>> p4) { return call_static_method<"getHorizontalParams", jint>(p1, p2, p3, p4); }
	static void split(jni::ref<jni::array<jdouble>> p1, jint p2, jdouble p3) { return call_static_method<"split", void>(p1, p2, p3); }
	static jni::ref<sun::awt::geom::Order2> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jdouble p5, jdouble p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	...
	static jdouble TforY(jdouble p1, jdouble p2, jdouble p3, jdouble p4) { return call_static_method<"TforY", jdouble>(p1, p2, p3, p4); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER2
