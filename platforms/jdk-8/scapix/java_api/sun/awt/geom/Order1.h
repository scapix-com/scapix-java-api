...
#ifndef SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER1_FWD
#define SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER1_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::geom { class Order1; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::geom::Order1>
{
	static constexpr fixed_string class_name = "sun/awt/geom/Order1";
	using base_classes = std::tuple<scapix::java_api::sun::awt::geom::Curve>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER1_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER1)
#define SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER1
...
// private
class sun::awt::geom::Order1 : public jni::object_base<"sun/awt/geom/Order1",
	sun::awt::geom::Curve>
{
public:

	static jni::ref<sun::awt::geom::Order1> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_GEOM_ORDER1
