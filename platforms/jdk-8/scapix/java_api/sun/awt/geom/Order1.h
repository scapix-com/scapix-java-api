...
namespace scapix::java_api::sun::awt::geom { class Order1; }
...
public:
	...
	static jni::ref<sun::awt::geom::Order1> new_object(jdouble p1, jdouble p2, jdouble p3, jdouble p4, jint p5) { return base_::new_object(p1, p2, p3, p4, p5); }
