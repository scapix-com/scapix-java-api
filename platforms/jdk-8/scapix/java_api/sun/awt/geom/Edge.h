...
namespace scapix::java_api { namespace sun::awt::geom { class Edge; }}
...
public:
	...
	static jni::ref<sun::awt::geom::Edge> new_object(jni::ref<sun::awt::geom::Curve> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::geom::Edge> new_object(jni::ref<sun::awt::geom::Curve> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
