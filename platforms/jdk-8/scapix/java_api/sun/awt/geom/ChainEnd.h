...
namespace scapix::java_api { namespace sun::awt::geom { class ChainEnd; }}
...
public:
	...
	static jni::ref<sun::awt::geom::ChainEnd> new_object(jni::ref<sun::awt::geom::CurveLink> p1, jni::ref<sun::awt::geom::ChainEnd> p2) { return object_base::new_object(p1, p2); }
