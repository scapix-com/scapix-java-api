...
namespace scapix::java_api { namespace sun::awt::geom { class Order0; }}
...
public:
	...
	static jni::ref<sun::awt::geom::Order0> new_object(jdouble p1, jdouble p2) { return object_base::new_object(p1, p2); }
