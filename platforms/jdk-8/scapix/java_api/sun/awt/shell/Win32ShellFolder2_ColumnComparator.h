...
namespace scapix::java_api { namespace sun::awt::shell { class Win32ShellFolder2_ColumnComparator; }}
...
public:
	...
	static jni::ref<sun::awt::shell::Win32ShellFolder2_ColumnComparator> new_object(jni::ref<sun::awt::shell::Win32ShellFolder2> p1, jint p2) { return object_base::new_object(p1, p2); }
