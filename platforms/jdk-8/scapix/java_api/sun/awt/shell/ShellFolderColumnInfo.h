...
#ifndef SCAPIX_JAVA_API_SUN_AWT_SHELL_SHELLFOLDERCOLUMNINFO
...
public:
	...
	static jni::ref<sun::awt::shell::ShellFolderColumnInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Integer> p2, jni::ref<java::lang::Integer> p3, jboolean p4, jni::ref<javax::swing::SortOrder> p5, jni::ref<java::util::Comparator> p6, jboolean p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
	static jni::ref<sun::awt::shell::ShellFolderColumnInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Integer> p2, jni::ref<java::lang::Integer> p3, jboolean p4, jni::ref<javax::swing::SortOrder> p5, jni::ref<java::util::Comparator> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
	static jni::ref<sun::awt::shell::ShellFolderColumnInfo> new_object(jni::ref<java::lang::String> p1, jint p2, jint p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
