...
#ifndef SCAPIX_JAVA_API_SUN_AWT_UNGRABEVENT
...
public:
	...
	static jni::ref<sun::awt::UngrabEvent> new_object(jni::ref<java::awt::Component> p1) { return object_base::new_object(p1); }
