...
struct scapix::jni::object_traits<scapix::java_api::sun::awt::windows::WLightweightFramePeer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::sun::awt::OverrideNativeWindowHandle>;
};
...
#ifndef SCAPIX_JAVA_API_SUN_AWT_WINDOWS_WLIGHTWEIGHTFRAMEPEER
...
public:
	...
	static jni::ref<sun::awt::windows::WLightweightFramePeer> new_object(jni::ref<sun::awt::LightweightFrame> p1) { return object_base::new_object(p1); }
