...
namespace scapix::java_api { namespace sun::awt::windows { class WInputMethod; }}
...
public:
	...
	static jni::ref<sun::awt::windows::WInputMethod> new_object() { return object_base::new_object(); }
