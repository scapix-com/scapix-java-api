...
namespace scapix::java_api { namespace sun::awt::windows { class WFontMetrics; }}
...
public:
	...
	static jni::ref<sun::awt::windows::WFontMetrics> new_object(jni::ref<java::awt::Font> p1) { return object_base::new_object(p1); }
