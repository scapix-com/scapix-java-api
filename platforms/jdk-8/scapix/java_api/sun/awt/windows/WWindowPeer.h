...
struct scapix::jni::object_traits<scapix::java_api::sun::awt::windows::WWindowPeer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::awt::peer::WindowPeer, scapix::java_api::sun::awt::DisplayChangedListener>;
};
...
#ifndef SCAPIX_JAVA_API_SUN_AWT_WINDOWS_WWINDOWPEER
