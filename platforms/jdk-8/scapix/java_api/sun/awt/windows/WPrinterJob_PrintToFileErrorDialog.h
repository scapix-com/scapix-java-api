...
namespace scapix::java_api { namespace sun::awt::windows { class WPrinterJob_PrintToFileErrorDialog; }}
...
public:
	...
	static jni::ref<sun::awt::windows::WPrinterJob_PrintToFileErrorDialog> new_object(jni::ref<sun::awt::windows::WPrinterJob> p1, jni::ref<java::awt::Frame> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::awt::windows::WPrinterJob_PrintToFileErrorDialog> new_object(jni::ref<sun::awt::windows::WPrinterJob> p1, jni::ref<java::awt::Dialog> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
