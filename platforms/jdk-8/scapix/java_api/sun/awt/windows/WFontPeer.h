...
namespace scapix::java_api { namespace sun::awt::windows { class WFontPeer; }}
...
public:
	...
	static jni::ref<sun::awt::windows::WFontPeer> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
