...
namespace scapix::java_api { namespace sun::awt::windows { class WingDings_Encoder; }}
...
public:
	...
	static jni::ref<sun::awt::windows::WingDings_Encoder> new_object(jni::ref<java::nio::charset::Charset> p1) { return object_base::new_object(p1); }
