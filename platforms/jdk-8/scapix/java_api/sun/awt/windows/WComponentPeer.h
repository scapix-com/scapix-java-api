...
struct scapix::jni::object_traits<scapix::java_api::sun::awt::windows::WComponentPeer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::awt::peer::ComponentPeer, scapix::java_api::java::awt::dnd::peer::DropTargetPeer>;
};
...
#ifndef SCAPIX_JAVA_API_SUN_AWT_WINDOWS_WCOMPONENTPEER
