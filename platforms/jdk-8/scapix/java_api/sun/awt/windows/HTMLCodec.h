...
namespace scapix::java_api { namespace sun::awt::windows { class HTMLCodec; }}
...
public:
	...
	static jni::ref<sun::awt::windows::HTMLCodec> new_object(jni::ref<java::io::InputStream> p1, jni::ref<sun::awt::windows::EHTMLReadMode> p2) { return object_base::new_object(p1, p2); }
