...
#ifndef SCAPIX_JAVA_API_SUN_AWT_FONTDESCRIPTOR
...
public:
	...
	static jni::ref<sun::awt::FontDescriptor> new_object(jni::ref<java::lang::String> p1, jni::ref<java::nio::charset::CharsetEncoder> p2, jni::ref<jni::array<jint>> p3) { return object_base::new_object(p1, p2, p3); }
