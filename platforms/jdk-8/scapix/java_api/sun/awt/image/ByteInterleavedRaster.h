...
namespace scapix::java_api { namespace sun::awt::image { class ByteInterleavedRaster; }}
...
public:
	...
	static jni::ref<sun::awt::image::ByteInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::image::ByteInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::ByteInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::ByteInterleavedRaster> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
