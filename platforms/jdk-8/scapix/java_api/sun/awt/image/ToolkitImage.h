...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_TOOLKITIMAGE
...
public:
	...
	static jni::ref<sun::awt::image::ToolkitImage> new_object(jni::ref<java::awt::image::ImageProducer> p1) { return object_base::new_object(p1); }
