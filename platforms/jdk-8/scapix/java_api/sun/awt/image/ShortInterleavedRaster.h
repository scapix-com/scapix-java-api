...
#include <scapix/java_api/sun/awt/image/ShortComponentRaster.h>

#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTINTERLEAVEDRASTER_FWD
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTINTERLEAVEDRASTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::image { class ShortInterleavedRaster; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::image::ShortInterleavedRaster>
{
	static constexpr fixed_string class_name = "sun/awt/image/ShortInterleavedRaster";
	using base_classes = std::tuple<scapix::java_api::sun::awt::image::ShortComponentRaster>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTINTERLEAVEDRASTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTINTERLEAVEDRASTER)
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTINTERLEAVEDRASTER
...
class sun::awt::image::ShortInterleavedRaster : public jni::object_base<"sun/awt/image/ShortInterleavedRaster",
	sun::awt::image::ShortComponentRaster>
{
public:

	static jni::ref<sun::awt::image::ShortInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::image::ShortInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::ShortInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::ShortInterleavedRaster> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	...
	jni::ref<jni::array<jshort>> getDataStorage() { return call_method<"getDataStorage", jni::ref<jni::array<jshort>>>(); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTINTERLEAVEDRASTER
