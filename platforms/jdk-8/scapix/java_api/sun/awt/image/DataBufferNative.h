...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_DATABUFFERNATIVE
...
public:
	...
	static jni::ref<sun::awt::image::DataBufferNative> new_object(jni::ref<sun::java2d::SurfaceData> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
