...
#include <scapix/java_api/sun/awt/image/IntegerComponentRaster.h>

#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERINTERLEAVEDRASTER_FWD
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERINTERLEAVEDRASTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::image { class IntegerInterleavedRaster; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::image::IntegerInterleavedRaster>
{
	static constexpr fixed_string class_name = "sun/awt/image/IntegerInterleavedRaster";
	using base_classes = std::tuple<scapix::java_api::sun::awt::image::IntegerComponentRaster>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERINTERLEAVEDRASTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERINTERLEAVEDRASTER)
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERINTERLEAVEDRASTER
...
class sun::awt::image::IntegerInterleavedRaster : public jni::object_base<"sun/awt/image/IntegerInterleavedRaster",
	sun::awt::image::IntegerComponentRaster>
{
public:

	static jni::ref<sun::awt::image::IntegerInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::image::IntegerInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::IntegerInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::IntegerInterleavedRaster> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	...
	jni::ref<jni::array<jint>> getDataStorage() { return call_method<"getDataStorage", jni::ref<jni::array<jint>>>(); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERINTERLEAVEDRASTER
