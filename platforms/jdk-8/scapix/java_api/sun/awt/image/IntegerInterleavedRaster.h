...
namespace scapix::java_api::sun::awt::image { class IntegerInterleavedRaster; }
...
public:
	...
	static jni::ref<sun::awt::image::IntegerInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return base_::new_object(p1, p2); }
	static jni::ref<sun::awt::image::IntegerInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return base_::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::IntegerInterleavedRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::IntegerInterleavedRaster> p5) { return base_::new_object(p1, p2, p3, p4, p5); }
...
protected:
	...
	IntegerInterleavedRaster(handle_type h) : base_(h) {}
