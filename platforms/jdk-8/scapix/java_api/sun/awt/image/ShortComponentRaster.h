...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTCOMPONENTRASTER_FWD
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTCOMPONENTRASTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::image { class ShortComponentRaster; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::image::ShortComponentRaster>
{
	static constexpr fixed_string class_name = "sun/awt/image/ShortComponentRaster";
	using base_classes = std::tuple<scapix::java_api::sun::awt::image::SunWritableRaster>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTCOMPONENTRASTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTCOMPONENTRASTER)
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTCOMPONENTRASTER
...
class sun::awt::image::ShortComponentRaster : public jni::object_base<"sun/awt/image/ShortComponentRaster",
	sun::awt::image::SunWritableRaster>
{
public:

	static jni::ref<sun::awt::image::ShortComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::image::ShortComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::ShortComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::ShortComponentRaster> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_SHORTCOMPONENTRASTER
