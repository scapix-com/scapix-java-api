...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_IMAGEREPRESENTATION
...
public:
	...
	static jni::ref<sun::awt::image::ImageRepresentation> new_object(jni::ref<sun::awt::image::ToolkitImage> p1, jni::ref<java::awt::image::ColorModel> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
