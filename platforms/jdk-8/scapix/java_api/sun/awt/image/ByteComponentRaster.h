...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_BYTECOMPONENTRASTER_FWD
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_BYTECOMPONENTRASTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::image { class ByteComponentRaster; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::image::ByteComponentRaster>
{
	static constexpr fixed_string class_name = "sun/awt/image/ByteComponentRaster";
	using base_classes = std::tuple<scapix::java_api::sun::awt::image::SunWritableRaster>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_BYTECOMPONENTRASTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_IMAGE_BYTECOMPONENTRASTER)
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_BYTECOMPONENTRASTER
...
class sun::awt::image::ByteComponentRaster : public jni::object_base<"sun/awt/image/ByteComponentRaster",
	sun::awt::image::SunWritableRaster>
{
public:

	static jni::ref<sun::awt::image::ByteComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::image::ByteComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::ByteComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::ByteComponentRaster> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_BYTECOMPONENTRASTER
