...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERCOMPONENTRASTER_FWD
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERCOMPONENTRASTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt::image { class IntegerComponentRaster; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::image::IntegerComponentRaster>
{
	static constexpr fixed_string class_name = "sun/awt/image/IntegerComponentRaster";
	using base_classes = std::tuple<scapix::java_api::sun::awt::image::SunWritableRaster>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERCOMPONENTRASTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERCOMPONENTRASTER)
#define SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERCOMPONENTRASTER
...
class sun::awt::image::IntegerComponentRaster : public jni::object_base<"sun/awt/image/IntegerComponentRaster",
	sun::awt::image::SunWritableRaster>
{
public:

	static jni::ref<sun::awt::image::IntegerComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::Point> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::awt::image::IntegerComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Point> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::IntegerComponentRaster> new_object(jni::ref<java::awt::image::SampleModel> p1, jni::ref<java::awt::image::DataBuffer> p2, jni::ref<java::awt::Rectangle> p3, jni::ref<java::awt::Point> p4, jni::ref<sun::awt::image::IntegerComponentRaster> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_IMAGE_INTEGERCOMPONENTRASTER
