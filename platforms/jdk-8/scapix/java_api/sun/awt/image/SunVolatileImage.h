...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_SUNVOLATILEIMAGE
...
public:
	...
	static jni::ref<sun::awt::image::SunVolatileImage> new_object(jni::ref<java::awt::Component> p1, jint p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::SunVolatileImage> new_object(jni::ref<java::awt::Component> p1, jint p2, jint p3, jni::ref<java::lang::Object> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::awt::image::SunVolatileImage> new_object(jni::ref<java::awt::GraphicsConfiguration> p1, jint p2, jint p3, jint p4, jni::ref<java::awt::ImageCapabilities> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
