...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_BUFIMGSURFACEDATA
...
public:
	...
	static jni::ref<sun::awt::image::BufImgSurfaceData> new_object(jni::ref<java::awt::image::DataBuffer> p1, jni::ref<java::awt::image::BufferedImage> p2, jni::ref<sun::java2d::loops::SurfaceType> p3) { return object_base::new_object(p1, p2, p3); }
