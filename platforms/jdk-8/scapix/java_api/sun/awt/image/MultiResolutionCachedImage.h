...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_MULTIRESOLUTIONCACHEDIMAGE
...
public:
	...
	static jni::ref<sun::awt::image::MultiResolutionCachedImage> new_object(jint p1, jint p2, jni::ref<java::util::function::BiFunction> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::awt::image::MultiResolutionCachedImage> new_object(jint p1, jint p2, jni::ref<jni::array<java::awt::geom::Dimension2D>> p3, jni::ref<java::util::function::BiFunction> p4) { return object_base::new_object(p1, p2, p3, p4); }
