...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_CODEC_JPEGIMAGEENCODERIMPL
...
public:
	...
	static jni::ref<sun::awt::image::codec::JPEGImageEncoderImpl> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::image::codec::JPEGImageEncoderImpl> new_object(jni::ref<java::io::OutputStream> p1, jni::ref<com::sun::image::codec::jpeg::JPEGEncodeParam> p2) { return object_base::new_object(p1, p2); }
