...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_CODEC_JPEGPARAM
...
public:
	...
	static jni::ref<sun::awt::image::codec::JPEGParam> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::image::codec::JPEGParam> new_object(jni::ref<com::sun::image::codec::jpeg::JPEGDecodeParam> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::image::codec::JPEGParam> new_object(jni::ref<com::sun::image::codec::jpeg::JPEGEncodeParam> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::image::codec::JPEGParam> new_object(jint p1, jint p2) { return object_base::new_object(p1, p2); }
