...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_IMAGEDECODER
...
public:
	...
	static jni::ref<sun::awt::image::ImageDecoder> new_object(jni::ref<sun::awt::image::InputStreamImageSource> p1, jni::ref<java::io::InputStream> p2) { return object_base::new_object(p1, p2); }
