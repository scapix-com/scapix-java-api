...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IMAGE_MULTIRESOLUTIONTOOLKITIMAGE
...
public:
	...
	static jni::ref<sun::awt::image::MultiResolutionToolkitImage> new_object(jni::ref<java::awt::Image> p1, jni::ref<java::awt::Image> p2) { return object_base::new_object(p1, p2); }
