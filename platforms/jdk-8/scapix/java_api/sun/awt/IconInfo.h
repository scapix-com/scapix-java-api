...
#ifndef SCAPIX_JAVA_API_SUN_AWT_ICONINFO
...
public:
	...
	static jni::ref<sun::awt::IconInfo> new_object(jni::ref<jni::array<jint>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::IconInfo> new_object(jni::ref<jni::array<jlong>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::IconInfo> new_object(jni::ref<java::awt::Image> p1) { return object_base::new_object(p1); }
