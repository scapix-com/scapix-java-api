...
#ifndef SCAPIX_JAVA_API_SUN_AWT_EVENTLISTENERAGGREGATE
...
public:
	...
	static jni::ref<sun::awt::EventListenerAggregate> new_object(jni::ref<java::lang::Class> p1) { return object_base::new_object(p1); }
