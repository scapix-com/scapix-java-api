...
#ifndef SCAPIX_JAVA_API_SUN_AWT_IM_INPUTMETHODJFRAME
...
public:
	...
	static jni::ref<sun::awt::im::InputMethodJFrame> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::awt::im::InputContext> p2) { return object_base::new_object(p1, p2); }
