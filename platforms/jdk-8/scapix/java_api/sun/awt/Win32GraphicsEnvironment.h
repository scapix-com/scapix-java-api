...
class Win32GraphicsEnvironment;
...
#ifndef SCAPIX_JAVA_API_SUN_AWT_WIN32GRAPHICSENVIRONMENT
...
public:
	...
	static jni::ref<sun::awt::Win32GraphicsEnvironment> new_object() { return object_base::new_object(); }
