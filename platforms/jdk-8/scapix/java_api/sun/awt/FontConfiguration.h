...
#ifndef SCAPIX_JAVA_API_SUN_AWT_FONTCONFIGURATION
...
public:
	...
	static jni::ref<sun::awt::FontConfiguration> new_object(jni::ref<sun::font::SunFontManager> p1) { return object_base::new_object(p1); }
	jboolean init() { return call_method<"init", jboolean>(); }
	static jni::ref<sun::awt::FontConfiguration> new_object(jni::ref<sun::font::SunFontManager> p1, jboolean p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
