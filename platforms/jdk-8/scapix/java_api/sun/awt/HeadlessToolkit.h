...
#ifndef SCAPIX_JAVA_API_SUN_AWT_HEADLESSTOOLKIT_FWD
#define SCAPIX_JAVA_API_SUN_AWT_HEADLESSTOOLKIT_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::awt { class HeadlessToolkit; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::awt::HeadlessToolkit>
{
	static constexpr fixed_string class_name = "sun/awt/HeadlessToolkit";
	using base_classes = std::tuple<scapix::java_api::java::awt::Toolkit, scapix::java_api::sun::awt::ComponentFactory, scapix::java_api::sun::awt::KeyboardFocusManagerPeerProvider>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_AWT_HEADLESSTOOLKIT_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_AWT_HEADLESSTOOLKIT)
#define SCAPIX_JAVA_API_SUN_AWT_HEADLESSTOOLKIT
...
class sun::awt::HeadlessToolkit : public jni::object_base<"sun/awt/HeadlessToolkit",
	java::awt::Toolkit,
...
public:
	...
	static jni::ref<sun::awt::HeadlessToolkit> new_object(jni::ref<java::awt::Toolkit> p1) { return object_base::new_object(p1); }
	jni::ref<java::awt::Toolkit> getUnderlyingToolkit() { return call_method<"getUnderlyingToolkit", jni::ref<java::awt::Toolkit>>(); }
	...
	jni::ref<java::awt::EventQueue> getSystemEventQueueImpl() { return call_method<"getSystemEventQueueImpl", jni::ref<java::awt::EventQueue>>(); }
...
#endif // SCAPIX_JAVA_API_SUN_AWT_HEADLESSTOOLKIT
