...
namespace scapix::java_api::sun::awt { class HeadlessToolkit; }
...
public:
	...
	static jni::ref<sun::awt::HeadlessToolkit> new_object(jni::ref<java::awt::Toolkit> p1) { return base_::new_object(p1); }
...
protected:
	...
	HeadlessToolkit(handle_type h) : base_(h) {}
