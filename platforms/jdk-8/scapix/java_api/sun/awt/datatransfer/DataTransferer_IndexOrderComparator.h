...
class DataTransferer_IndexOrderComparator;
...
#ifndef SCAPIX_JAVA_API_SUN_AWT_DATATRANSFER_DATATRANSFERER_INDEXORDERCOMPARATOR
...
public:
	...
	static jni::ref<sun::awt::datatransfer::DataTransferer_IndexOrderComparator> new_object(jni::ref<java::util::Map> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::awt::datatransfer::DataTransferer_IndexOrderComparator> new_object(jni::ref<java::util::Map> p1, jboolean p2) { return object_base::new_object(p1, p2); }
