...
#ifndef SCAPIX_JAVA_API_SUN_AWT_DATATRANSFER_SUNCLIPBOARD
...
public:
	...
	static jni::ref<sun::awt::datatransfer::SunClipboard> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
