...
#ifndef SCAPIX_JAVA_API_SUN_AWT_SUNTOOLKIT
...
public:
	...
	static jni::ref<sun::awt::SunToolkit> new_object() { return object_base::new_object(); }
	...
	jboolean isRunningOnWayland() { return call_method<"isRunningOnWayland", jboolean>(); }
	void dismissPopupOnFocusLostIfNeeded(jni::ref<java::awt::Window> p1) { return call_method<"dismissPopupOnFocusLostIfNeeded", void>(p1); }
	void dismissPopupOnFocusLostIfNeededCleanUp(jni::ref<java::awt::Window> p1) { return call_method<"dismissPopupOnFocusLostIfNeededCleanUp", void>(p1); }
