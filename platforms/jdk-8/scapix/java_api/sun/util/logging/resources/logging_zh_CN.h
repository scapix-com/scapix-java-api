...
#ifndef SCAPIX_JAVA_API_SUN_UTIL_LOGGING_RESOURCES_LOGGING_ZH_CN
...
public:
	...
	static jni::ref<sun::util::logging::resources::logging_zh_CN> new_object() { return object_base::new_object(); }
};
