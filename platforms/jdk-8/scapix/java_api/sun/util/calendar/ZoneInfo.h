...
#ifndef SCAPIX_JAVA_API_SUN_UTIL_CALENDAR_ZONEINFO
...
public:
	...
	static jni::ref<sun::util::calendar::ZoneInfo> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
