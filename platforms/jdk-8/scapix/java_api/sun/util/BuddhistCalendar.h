...
#ifndef SCAPIX_JAVA_API_SUN_UTIL_BUDDHISTCALENDAR
...
public:
	...
	static jni::ref<sun::util::BuddhistCalendar> new_object(jni::ref<java::util::TimeZone> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::util::BuddhistCalendar> new_object(jni::ref<java::util::Locale> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::util::BuddhistCalendar> new_object(jni::ref<java::util::TimeZone> p1, jni::ref<java::util::Locale> p2) { return object_base::new_object(p1, p2); }
