...
namespace scapix::java_api { namespace sun::util::locale { class BaseLocale_Key; }}
...
public:
	...
	static jni::ref<sun::util::locale::BaseLocale_Key> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
