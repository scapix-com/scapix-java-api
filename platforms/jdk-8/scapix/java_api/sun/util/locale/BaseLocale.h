...
#ifndef SCAPIX_JAVA_API_SUN_UTIL_LOCALE_BASELOCALE
...
public:
	...
	static jni::ref<sun::util::locale::BaseLocale> createInstance(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return call_static_method<"createInstance", jni::ref<sun::util::locale::BaseLocale>>(p1, p2); }
	static jni::ref<sun::util::locale::BaseLocale> getInstance(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return call_static_method<"getInstance", jni::ref<sun::util::locale::BaseLocale>>(p1, p2, p3, p4); }
