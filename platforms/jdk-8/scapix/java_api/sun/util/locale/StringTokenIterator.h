...
#ifndef SCAPIX_JAVA_API_SUN_UTIL_LOCALE_STRINGTOKENITERATOR
...
public:
	...
	static jni::ref<sun::util::locale::StringTokenIterator> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
