...
namespace scapix::java_api { namespace sun::java2d::opengl { class OGLSurfaceDataProxy; }}
...
public:
	...
	static jni::ref<sun::java2d::opengl::OGLSurfaceDataProxy> new_object(jni::ref<sun::java2d::opengl::OGLGraphicsConfig> p1, jint p2) { return object_base::new_object(p1, p2); }
