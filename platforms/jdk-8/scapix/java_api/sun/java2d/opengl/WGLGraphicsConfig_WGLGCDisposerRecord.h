...
namespace scapix::java_api { namespace sun::java2d::opengl { class WGLGraphicsConfig_WGLGCDisposerRecord; }}
...
public:
	...
	static jni::ref<sun::java2d::opengl::WGLGraphicsConfig_WGLGCDisposerRecord> new_object(jlong p1, jint p2) { return object_base::new_object(p1, p2); }
