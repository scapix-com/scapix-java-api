...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_PIXELTOPARALLELOGRAMCONVERTER
...
public:
	...
	static jni::ref<sun::java2d::pipe::PixelToParallelogramConverter> new_object(jni::ref<sun::java2d::pipe::ShapeDrawPipe> p1, jni::ref<sun::java2d::pipe::ParallelogramPipe> p2, jdouble p3, jdouble p4, jboolean p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
