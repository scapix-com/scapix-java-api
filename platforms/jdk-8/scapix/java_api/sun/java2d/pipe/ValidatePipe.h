...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_VALIDATEPIPE_FWD
#define SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_VALIDATEPIPE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::java2d::pipe { class ValidatePipe; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::java2d::pipe::ValidatePipe>
{
	static constexpr fixed_string class_name = "sun/java2d/pipe/ValidatePipe";
...
#endif // SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_VALIDATEPIPE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_VALIDATEPIPE)
#define SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_VALIDATEPIPE
...
class sun::java2d::pipe::ValidatePipe : public jni::object_base<"sun/java2d/pipe/ValidatePipe",
	java::lang::Object,
...
public:
	...
	static jni::ref<sun::java2d::pipe::ValidatePipe> new_object() { return object_base::new_object(); }
	jboolean validate(jni::ref<sun::java2d::SunGraphics2D> p1) { return call_method<"validate", jboolean>(p1); }
...
#endif // SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_VALIDATEPIPE
