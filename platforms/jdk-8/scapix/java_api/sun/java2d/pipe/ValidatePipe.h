...
namespace scapix::java_api::sun::java2d::pipe { class ValidatePipe; }
...
public:
	...
	static jni::ref<sun::java2d::pipe::ValidatePipe> new_object() { return base_::new_object(); }
...
protected:
	...
	ValidatePipe(handle_type h) : base_(h) {}
