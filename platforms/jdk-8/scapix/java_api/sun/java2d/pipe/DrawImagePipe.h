...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_DRAWIMAGEPIPE_FWD
#define SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_DRAWIMAGEPIPE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::java2d::pipe { class DrawImagePipe; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::java2d::pipe::DrawImagePipe>
{
	static constexpr fixed_string class_name = "sun/java2d/pipe/DrawImagePipe";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_DRAWIMAGEPIPE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_DRAWIMAGEPIPE)
#define SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_DRAWIMAGEPIPE
...
class sun::java2d::pipe::DrawImagePipe : public jni::object_base<"sun/java2d/pipe/DrawImagePipe",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_DRAWIMAGEPIPE
