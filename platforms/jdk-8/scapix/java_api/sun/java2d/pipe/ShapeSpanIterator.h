...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_SHAPESPANITERATOR
...
public:
	...
	static jni::ref<sun::java2d::pipe::ShapeSpanIterator> new_object(jboolean p1) { return object_base::new_object(p1); }
