...
namespace scapix::java_api { namespace sun::java2d::pipe { class BufferedRenderPipe; }}
...
public:
	...
	static jni::ref<sun::java2d::pipe::BufferedRenderPipe> new_object(jni::ref<sun::java2d::pipe::RenderQueue> p1) { return object_base::new_object(p1); }
