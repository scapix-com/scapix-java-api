...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_ALPHAPAINTPIPE_FWD
#define SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_ALPHAPAINTPIPE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::java2d::pipe { class AlphaPaintPipe; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::java2d::pipe::AlphaPaintPipe>
{
	static constexpr fixed_string class_name = "sun/java2d/pipe/AlphaPaintPipe";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::sun::java2d::pipe::CompositePipe>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_ALPHAPAINTPIPE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_ALPHAPAINTPIPE)
#define SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_ALPHAPAINTPIPE
...
class sun::java2d::pipe::AlphaPaintPipe : public jni::object_base<"sun/java2d/pipe/AlphaPaintPipe",
	java::lang::Object,
	sun::java2d::pipe::CompositePipe>
{
public:

	static jni::ref<sun::java2d::pipe::AlphaPaintPipe> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_ALPHAPAINTPIPE
