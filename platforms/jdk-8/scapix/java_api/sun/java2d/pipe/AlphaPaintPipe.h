...
namespace scapix::java_api::sun::java2d::pipe { class AlphaPaintPipe; }
...
public:
	...
	static jni::ref<sun::java2d::pipe::AlphaPaintPipe> new_object() { return base_::new_object(); }
...
protected:
	...
	AlphaPaintPipe(handle_type h) : base_(h) {}
