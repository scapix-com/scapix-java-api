...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_SPANCLIPRENDERER
...
public:
	...
	static jni::ref<sun::java2d::pipe::SpanClipRenderer> new_object(jni::ref<sun::java2d::pipe::CompositePipe> p1) { return object_base::new_object(p1); }
