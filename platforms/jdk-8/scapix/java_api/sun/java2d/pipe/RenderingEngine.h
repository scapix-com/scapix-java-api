...
namespace scapix::java_api { namespace sun::java2d::pipe { class RenderingEngine; }}
...
public:
	...
	static jni::ref<sun::java2d::pipe::RenderingEngine> new_object() { return object_base::new_object(); }
