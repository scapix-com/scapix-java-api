...
namespace scapix::java_api { namespace sun::java2d::pipe { class GeneralCompositePipe; }}
...
public:
	...
	static jni::ref<sun::java2d::pipe::GeneralCompositePipe> new_object() { return object_base::new_object(); }
