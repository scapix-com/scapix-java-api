...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_PIPE_PIXELTOSHAPECONVERTER
...
public:
	...
	static jni::ref<sun::java2d::pipe::PixelToShapeConverter> new_object(jni::ref<sun::java2d::pipe::ShapeDrawPipe> p1) { return object_base::new_object(p1); }
