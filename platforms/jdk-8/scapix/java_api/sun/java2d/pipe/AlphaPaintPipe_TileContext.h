...
namespace scapix::java_api { namespace sun::java2d::pipe { class AlphaPaintPipe_TileContext; }}
...
public:
	...
	static jni::ref<sun::java2d::pipe::AlphaPaintPipe_TileContext> new_object(jni::ref<sun::java2d::SunGraphics2D> p1, jni::ref<java::awt::PaintContext> p2) { return object_base::new_object(p1, p2); }
