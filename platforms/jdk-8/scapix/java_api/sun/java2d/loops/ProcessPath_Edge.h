...
namespace scapix::java_api { namespace sun::java2d::loops { class ProcessPath_Edge; }}
...
public:
	...
	static jni::ref<sun::java2d::loops::ProcessPath_Edge> new_object(jni::ref<sun::java2d::loops::ProcessPath_Point> p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
