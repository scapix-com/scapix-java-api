...
namespace scapix::java_api { namespace sun::java2d::loops { class DrawRect_TraceDrawRect; }}
...
public:
	...
	static jni::ref<sun::java2d::loops::DrawRect_TraceDrawRect> new_object(jni::ref<sun::java2d::loops::DrawRect> p1) { return object_base::new_object(p1); }
