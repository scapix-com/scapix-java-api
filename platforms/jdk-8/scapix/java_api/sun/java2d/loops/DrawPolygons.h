...
namespace scapix::java_api::sun::java2d::loops { class DrawPolygons; }
...
public:
	...
	static jni::ref<sun::java2d::loops::DrawPolygons> new_object(jlong p1, jni::ref<sun::java2d::loops::SurfaceType> p2, jni::ref<sun::java2d::loops::CompositeType> p3, jni::ref<sun::java2d::loops::SurfaceType> p4) { return base_::new_object(p1, p2, p3, p4); }
...
protected:
	...
	DrawPolygons(handle_type h) : base_(h) {}
