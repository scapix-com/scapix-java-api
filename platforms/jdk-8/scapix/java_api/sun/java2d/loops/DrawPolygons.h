...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_DRAWPOLYGONS_FWD
#define SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_DRAWPOLYGONS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::java2d::loops { class DrawPolygons; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::java2d::loops::DrawPolygons>
{
	static constexpr fixed_string class_name = "sun/java2d/loops/DrawPolygons";
	using base_classes = std::tuple<scapix::java_api::sun::java2d::loops::GraphicsPrimitive>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_DRAWPOLYGONS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_DRAWPOLYGONS)
#define SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_DRAWPOLYGONS
...
class sun::java2d::loops::DrawPolygons : public jni::object_base<"sun/java2d/loops/DrawPolygons",
...
public:
	...
	static jni::ref<sun::java2d::loops::DrawPolygons> locate(jni::ref<sun::java2d::loops::SurfaceType> p1, jni::ref<sun::java2d::loops::CompositeType> p2, jni::ref<sun::java2d::loops::SurfaceType> p3) { return call_static_method<"locate", jni::ref<sun::java2d::loops::DrawPolygons>>(p1, p2, p3); }
	static jni::ref<sun::java2d::loops::DrawPolygons> new_object(jlong p1, jni::ref<sun::java2d::loops::SurfaceType> p2, jni::ref<sun::java2d::loops::CompositeType> p3, jni::ref<sun::java2d::loops::SurfaceType> p4) { return object_base::new_object(p1, p2, p3, p4); }
...
#endif // SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_DRAWPOLYGONS
