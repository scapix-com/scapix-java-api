...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_LOOPS_PROCESSPATH_DRAWHANDLER
...
public:
	...
	static jni::ref<sun::java2d::loops::ProcessPath_DrawHandler> new_object(jint p1, jint p2, jint p3, jint p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	...
	static jni::ref<sun::java2d::loops::ProcessPath_DrawHandler> new_object(jint p1, jint p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
