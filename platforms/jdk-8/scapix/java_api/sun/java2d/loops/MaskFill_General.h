...
namespace scapix::java_api { namespace sun::java2d::loops { class MaskFill_General; }}
...
public:
	...
	static jni::ref<sun::java2d::loops::MaskFill_General> new_object(jni::ref<sun::java2d::loops::SurfaceType> p1, jni::ref<sun::java2d::loops::CompositeType> p2, jni::ref<sun::java2d::loops::SurfaceType> p3) { return object_base::new_object(p1, p2, p3); }
