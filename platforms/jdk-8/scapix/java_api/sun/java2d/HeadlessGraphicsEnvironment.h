...
namespace scapix::java_api { namespace sun::java2d { class HeadlessGraphicsEnvironment; }}
...
public:
	...
	static jni::ref<sun::java2d::HeadlessGraphicsEnvironment> new_object(jni::ref<java::awt::GraphicsEnvironment> p1) { return object_base::new_object(p1); }
