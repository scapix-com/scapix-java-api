...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_SUNGRAPHICS2D
...
public:
	...
	static jni::ref<sun::java2d::SunGraphics2D> new_object(jni::ref<sun::java2d::SurfaceData> p1, jni::ref<java::awt::Color> p2, jni::ref<java::awt::Color> p3, jni::ref<java::awt::Font> p4) { return object_base::new_object(p1, p2, p3, p4); }
