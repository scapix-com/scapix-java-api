...
#ifndef SCAPIX_JAVA_API_SUN_JAVA2D_SUNCOMPOSITECONTEXT
...
public:
	...
	static jni::ref<sun::java2d::SunCompositeContext> new_object(jni::ref<java::awt::AlphaComposite> p1, jni::ref<java::awt::image::ColorModel> p2, jni::ref<java::awt::image::ColorModel> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::java2d::SunCompositeContext> new_object(jni::ref<sun::java2d::loops::XORComposite> p1, jni::ref<java::awt::image::ColorModel> p2, jni::ref<java::awt::image::ColorModel> p3) { return object_base::new_object(p1, p2, p3); }
