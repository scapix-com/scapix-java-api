...
#ifndef SCAPIX_JAVA_API_SUN_TOOLS_JAR_SIGNATUREFILE
...
public:
	...
	static jni::ref<sun::tools::jar::SignatureFile> new_object(jni::ref<sun::tools::jar::Manifest> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::tools::jar::SignatureFile> new_object(jni::ref<sun::tools::jar::Manifest> p1, jni::ref<jni::array<java::lang::String>> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::tools::jar::SignatureFile> new_object(jni::ref<java::io::InputStream> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::tools::jar::SignatureFile> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::tools::jar::SignatureFile> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
