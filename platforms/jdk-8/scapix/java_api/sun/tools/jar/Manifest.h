...
#ifndef SCAPIX_JAVA_API_SUN_TOOLS_JAR_MANIFEST
...
public:
	...
	static jni::ref<sun::tools::jar::Manifest> new_object() { return object_base::new_object(); }
	static jni::ref<sun::tools::jar::Manifest> new_object(jni::ref<jni::array<jbyte>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::tools::jar::Manifest> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::tools::jar::Manifest> new_object(jni::ref<java::io::InputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::tools::jar::Manifest> new_object(jni::ref<jni::array<java::lang::String>> p1) { return object_base::new_object(p1); }
