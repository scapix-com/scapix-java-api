...
#ifndef SCAPIX_JAVA_API_SUN_TOOLS_JAR_MAIN
...
public:
	...
	static jni::ref<sun::tools::jar::Main> new_object(jni::ref<java::io::PrintStream> p1, jni::ref<java::io::PrintStream> p2, jni::ref<java::lang::String> p3) { return object_base::new_object(p1, p2, p3); }
