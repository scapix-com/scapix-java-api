...
#ifndef SCAPIX_JAVA_API_SUN_PRINT_SUNALTERNATEMEDIA
...
public:
	...
	static jni::ref<sun::print::SunAlternateMedia> new_object(jni::ref<javax::print::attribute::standard::Media> p1) { return object_base::new_object(p1); }
