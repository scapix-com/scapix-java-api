...
namespace scapix::java_api::sun::print { class ProxyGraphics; }
...
public:
	...
	static jni::ref<sun::print::ProxyGraphics> new_object(jni::ref<java::awt::Graphics> p1) { return base_::new_object(p1); }
...
protected:
	...
	ProxyGraphics(handle_type h) : base_(h) {}
