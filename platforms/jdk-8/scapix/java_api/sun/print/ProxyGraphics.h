...
#ifndef SCAPIX_JAVA_API_SUN_PRINT_PROXYGRAPHICS_FWD
#define SCAPIX_JAVA_API_SUN_PRINT_PROXYGRAPHICS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::print { class ProxyGraphics; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::print::ProxyGraphics>
{
	static constexpr fixed_string class_name = "sun/print/ProxyGraphics";
	using base_classes = std::tuple<scapix::java_api::java::awt::Graphics>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_PRINT_PROXYGRAPHICS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_PRINT_PROXYGRAPHICS)
#define SCAPIX_JAVA_API_SUN_PRINT_PROXYGRAPHICS
...
class sun::print::ProxyGraphics : public jni::object_base<"sun/print/ProxyGraphics",
	java::awt::Graphics>
{
public:

	static jni::ref<sun::print::ProxyGraphics> new_object(jni::ref<java::awt::Graphics> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_SUN_PRINT_PROXYGRAPHICS
