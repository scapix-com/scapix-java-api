...
namespace scapix::java_api { namespace sun::print { class ProxyGraphics2D; }}
...
public:
	...
	static jni::ref<sun::print::ProxyGraphics2D> new_object(jni::ref<java::awt::Graphics2D> p1, jni::ref<java::awt::print::PrinterJob> p2) { return object_base::new_object(p1, p2); }
