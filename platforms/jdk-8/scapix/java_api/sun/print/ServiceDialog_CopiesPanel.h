...
namespace scapix::java_api { namespace sun::print { class ServiceDialog_CopiesPanel; }}
...
public:
	...
	static jni::ref<sun::print::ServiceDialog_CopiesPanel> new_object(jni::ref<sun::print::ServiceDialog> p1) { return object_base::new_object(p1); }
