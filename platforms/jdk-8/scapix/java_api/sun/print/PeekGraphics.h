...
namespace scapix::java_api::sun::print { class PeekGraphics; }
...
public:
	...
	static jni::ref<sun::print::PeekGraphics> new_object(jni::ref<java::awt::Graphics2D> p1, jni::ref<java::awt::print::PrinterJob> p2) { return base_::new_object(p1, p2); }
...
protected:
	...
	PeekGraphics(handle_type h) : base_(h) {}
