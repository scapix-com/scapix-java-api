...
#ifndef SCAPIX_JAVA_API_SUN_PRINT_PRINTJOB2D
...
public:
	...
	static jni::ref<sun::print::PrintJob2D> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2, jni::ref<java::util::Properties> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::print::PrintJob2D> new_object(jni::ref<java::awt::Frame> p1, jni::ref<java::lang::String> p2, jni::ref<java::awt::JobAttributes> p3, jni::ref<java::awt::PageAttributes> p4) { return object_base::new_object(p1, p2, p3, p4); }
