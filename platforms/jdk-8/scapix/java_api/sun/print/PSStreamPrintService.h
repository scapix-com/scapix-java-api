...
namespace scapix::java_api::sun::print { class PSStreamPrintService; }
...
public:
	...
	static jni::ref<sun::print::PSStreamPrintService> new_object(jni::ref<java::io::OutputStream> p1) { return base_::new_object(p1); }
...
protected:
	...
	PSStreamPrintService(handle_type h) : base_(h) {}
