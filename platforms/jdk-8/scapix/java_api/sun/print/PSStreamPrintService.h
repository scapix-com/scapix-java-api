...
#ifndef SCAPIX_JAVA_API_SUN_PRINT_PSSTREAMPRINTSERVICE_FWD
#define SCAPIX_JAVA_API_SUN_PRINT_PSSTREAMPRINTSERVICE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::print { class PSStreamPrintService; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::print::PSStreamPrintService>
{
	static constexpr fixed_string class_name = "sun/print/PSStreamPrintService";
	using base_classes = std::tuple<scapix::java_api::javax::print::StreamPrintService, scapix::java_api::sun::print::SunPrinterJobService>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_PRINT_PSSTREAMPRINTSERVICE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_PRINT_PSSTREAMPRINTSERVICE)
#define SCAPIX_JAVA_API_SUN_PRINT_PSSTREAMPRINTSERVICE
...
class sun::print::PSStreamPrintService : public jni::object_base<"sun/print/PSStreamPrintService",
	javax::print::StreamPrintService,
	sun::print::SunPrinterJobService>
{
public:

	static jni::ref<sun::print::PSStreamPrintService> new_object(jni::ref<java::io::OutputStream> p1) { return object_base::new_object(p1); }
...
#endif // SCAPIX_JAVA_API_SUN_PRINT_PSSTREAMPRINTSERVICE
