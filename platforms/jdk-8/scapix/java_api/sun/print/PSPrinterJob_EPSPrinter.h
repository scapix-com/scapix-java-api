...
#ifndef SCAPIX_JAVA_API_SUN_PRINT_PSPRINTERJOB_EPSPRINTER
...
public:
	...
	static jni::ref<sun::print::PSPrinterJob_EPSPrinter> new_object(jni::ref<java::awt::print::Printable> p1, jni::ref<java::lang::String> p2, jni::ref<java::io::PrintStream> p3, jint p4, jint p5, jint p6, jint p7) { return object_base::new_object(p1, p2, p3, p4, p5, p6, p7); }
