...
namespace scapix::java_api { namespace sun::print { class Win32MediaSize; }}
...
public:
	...
	static jni::ref<sun::print::Win32MediaSize> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
