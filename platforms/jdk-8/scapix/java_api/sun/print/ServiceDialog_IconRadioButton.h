...
namespace scapix::java_api { namespace sun::print { class ServiceDialog_IconRadioButton; }}
...
public:
	...
	static jni::ref<sun::print::ServiceDialog_IconRadioButton> new_object(jni::ref<sun::print::ServiceDialog> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jboolean p4, jni::ref<javax::swing::ButtonGroup> p5, jni::ref<java::awt::event::ActionListener> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
