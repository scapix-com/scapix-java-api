...
#ifndef SCAPIX_JAVA_API_SUN_PRINT_PROXYPRINTGRAPHICS
...
public:
	...
	static jni::ref<sun::print::ProxyPrintGraphics> new_object(jni::ref<java::awt::Graphics> p1, jni::ref<java::awt::PrintJob> p2) { return object_base::new_object(p1, p2); }
