...
#ifndef SCAPIX_JAVA_API_SUN_MISC_PROXYGENERATOR_PROXYMETHOD_FWD
#define SCAPIX_JAVA_API_SUN_MISC_PROXYGENERATOR_PROXYMETHOD_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::misc { class ProxyGenerator_ProxyMethod; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::misc::ProxyGenerator_ProxyMethod>
{
	static constexpr fixed_string class_name = "sun/misc/ProxyGenerator$ProxyMethod";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_MISC_PROXYGENERATOR_PROXYMETHOD_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MISC_PROXYGENERATOR_PROXYMETHOD)
#define SCAPIX_JAVA_API_SUN_MISC_PROXYGENERATOR_PROXYMETHOD
...
// private
class sun::misc::ProxyGenerator_ProxyMethod : public jni::object_base<"sun/misc/ProxyGenerator$ProxyMethod",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_MISC_PROXYGENERATOR_PROXYMETHOD
