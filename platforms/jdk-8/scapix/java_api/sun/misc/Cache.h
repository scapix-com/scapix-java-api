...
#ifndef SCAPIX_JAVA_API_SUN_MISC_CACHE
...
public:
	...
	static jni::ref<sun::misc::Cache> new_object(jint p1, jfloat p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::misc::Cache> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::misc::Cache> new_object() { return object_base::new_object(); }
