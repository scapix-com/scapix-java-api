...
namespace scapix::java_api { namespace sun::misc { class ProxyGenerator_MethodInfo; }}
...
public:
	...
	static jni::ref<sun::misc::ProxyGenerator_MethodInfo> new_object(jni::ref<sun::misc::ProxyGenerator> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
