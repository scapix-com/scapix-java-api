...
#ifndef SCAPIX_JAVA_API_SUN_MISC_FDBIGINTEGER
...
public:
	...
	static jni::ref<sun::misc::FDBigInteger> new_object(jlong p1, jni::ref<jni::array<jchar>> p2, jint p3, jint p4) { return object_base::new_object(p1, p2, p3, p4); }
