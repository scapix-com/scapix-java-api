...
#ifndef SCAPIX_JAVA_API_SUN_MISC_EXTENSIONINFO
...
public:
	...
	static jni::ref<sun::misc::ExtensionInfo> new_object() { return object_base::new_object(); }
	static jni::ref<sun::misc::ExtensionInfo> new_object(jni::ref<java::lang::String> p1, jni::ref<java::util::jar::Attributes> p2) { return object_base::new_object(p1, p2); }
