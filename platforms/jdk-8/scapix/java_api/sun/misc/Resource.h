...
#ifndef SCAPIX_JAVA_API_SUN_MISC_RESOURCE_FWD
#define SCAPIX_JAVA_API_SUN_MISC_RESOURCE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::misc { class Resource; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::misc::Resource>
{
	static constexpr fixed_string class_name = "sun/misc/Resource";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_MISC_RESOURCE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MISC_RESOURCE)
#define SCAPIX_JAVA_API_SUN_MISC_RESOURCE
...
class sun::misc::Resource : public jni::object_base<"sun/misc/Resource",
	java::lang::Object>
{
public:

	static jni::ref<sun::misc::Resource> new_object() { return object_base::new_object(); }
...
#endif // SCAPIX_JAVA_API_SUN_MISC_RESOURCE
