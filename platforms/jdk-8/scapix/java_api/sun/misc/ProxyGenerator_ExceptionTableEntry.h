...
namespace scapix::java_api { namespace sun::misc { class ProxyGenerator_ExceptionTableEntry; }}
...
public:
	...
	static jni::ref<sun::misc::ProxyGenerator_ExceptionTableEntry> new_object(jshort p1, jshort p2, jshort p3, jshort p4) { return object_base::new_object(p1, p2, p3, p4); }
