...
#ifndef SCAPIX_JAVA_API_SUN_MISC_URLCLASSPATH
...
public:
	...
	static jni::ref<sun::misc::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::net::URLStreamHandlerFactory> p2, jni::ref<java::security::AccessControlContext> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::misc::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::misc::URLClassPath> new_object(jni::ref<jni::array<java::net::URL>> p1, jni::ref<java::security::AccessControlContext> p2) { return object_base::new_object(p1, p2); }
