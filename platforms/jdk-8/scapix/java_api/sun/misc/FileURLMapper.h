...
#ifndef SCAPIX_JAVA_API_SUN_MISC_FILEURLMAPPER
...
public:
	...
	static jni::ref<sun::misc::FileURLMapper> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
