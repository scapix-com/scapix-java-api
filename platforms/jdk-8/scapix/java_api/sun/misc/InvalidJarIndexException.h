...
#ifndef SCAPIX_JAVA_API_SUN_MISC_INVALIDJARINDEXEXCEPTION
...
public:
	...
	static jni::ref<sun::misc::InvalidJarIndexException> new_object() { return object_base::new_object(); }
	static jni::ref<sun::misc::InvalidJarIndexException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
