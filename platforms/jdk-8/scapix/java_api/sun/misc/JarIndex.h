...
#ifndef SCAPIX_JAVA_API_SUN_MISC_JARINDEX
...
public:
	...
	static jni::ref<sun::misc::JarIndex> new_object() { return object_base::new_object(); }
	static jni::ref<sun::misc::JarIndex> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::misc::JarIndex> new_object(jni::ref<jni::array<java::lang::String>> p1) { return object_base::new_object(p1); }
