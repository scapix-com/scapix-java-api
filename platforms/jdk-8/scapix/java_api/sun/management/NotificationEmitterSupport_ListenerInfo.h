...
namespace scapix::java_api { namespace sun::management { class NotificationEmitterSupport_ListenerInfo; }}
...
public:
	...
	static jni::ref<sun::management::NotificationEmitterSupport_ListenerInfo> new_object(jni::ref<sun::management::NotificationEmitterSupport> p1, jni::ref<javax::management::NotificationListener> p2, jni::ref<javax::management::NotificationFilter> p3, jni::ref<java::lang::Object> p4) { return object_base::new_object(p1, p2, p3, p4); }
