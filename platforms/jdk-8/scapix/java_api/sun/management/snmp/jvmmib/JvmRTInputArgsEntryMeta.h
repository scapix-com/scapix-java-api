...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTINPUTARGSENTRYMETA_FWD
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTINPUTARGSENTRYMETA_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::management::snmp::jvmmib { class JvmRTInputArgsEntryMeta; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::management::snmp::jvmmib::JvmRTInputArgsEntryMeta>
{
	static constexpr fixed_string class_name = "sun/management/snmp/jvmmib/JvmRTInputArgsEntryMeta";
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTINPUTARGSENTRYMETA_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTINPUTARGSENTRYMETA)
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTINPUTARGSENTRYMETA
...
class sun::management::snmp::jvmmib::JvmRTInputArgsEntryMeta : public jni::object_base<"sun/management/snmp/jvmmib/JvmRTInputArgsEntryMeta",
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmRTInputArgsEntryMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return object_base::new_object(p1, p2); }
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTINPUTARGSENTRYMETA
