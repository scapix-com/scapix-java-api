...
class EnumJvmClassesVerboseLevel;
...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_ENUMJVMCLASSESVERBOSELEVEL
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmClassesVerboseLevel> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmClassesVerboseLevel> new_object(jni::ref<java::lang::Integer> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmClassesVerboseLevel> new_object() { return object_base::new_object(); }
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmClassesVerboseLevel> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
