...
namespace scapix::java_api { namespace sun::management::snmp::jvmmib { class JvmThreadInstanceEntryMeta; }}
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmThreadInstanceEntryMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return object_base::new_object(p1, p2); }
