...
class EnumJvmMemPoolThreshdSupport;
...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_ENUMJVMMEMPOOLTHRESHDSUPPORT
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmMemPoolThreshdSupport> new_object(jint p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmMemPoolThreshdSupport> new_object(jni::ref<java::lang::Integer> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmMemPoolThreshdSupport> new_object() { return object_base::new_object(); }
	static jni::ref<sun::management::snmp::jvmmib::EnumJvmMemPoolThreshdSupport> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
