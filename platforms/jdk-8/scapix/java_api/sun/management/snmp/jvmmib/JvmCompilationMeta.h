...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMCOMPILATIONMETA_FWD
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMCOMPILATIONMETA_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::management::snmp::jvmmib { class JvmCompilationMeta; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::management::snmp::jvmmib::JvmCompilationMeta>
{
	static constexpr fixed_string class_name = "sun/management/snmp/jvmmib/JvmCompilationMeta";
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMCOMPILATIONMETA_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMCOMPILATIONMETA)
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMCOMPILATIONMETA
...
class sun::management::snmp::jvmmib::JvmCompilationMeta : public jni::object_base<"sun/management/snmp/jvmmib/JvmCompilationMeta",
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmCompilationMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return object_base::new_object(p1, p2); }
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMCOMPILATIONMETA
