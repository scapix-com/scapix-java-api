...
namespace scapix::java_api::sun::management::snmp::jvmmib { class JvmMemManagerEntryMeta; }
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmMemManagerEntryMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return base_::new_object(p1, p2); }
...
protected:
	...
	JvmMemManagerEntryMeta(handle_type h) : base_(h) {}
