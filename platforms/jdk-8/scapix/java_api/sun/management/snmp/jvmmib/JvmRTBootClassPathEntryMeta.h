...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTBOOTCLASSPATHENTRYMETA_FWD
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTBOOTCLASSPATHENTRYMETA_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::management::snmp::jvmmib { class JvmRTBootClassPathEntryMeta; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::management::snmp::jvmmib::JvmRTBootClassPathEntryMeta>
{
	static constexpr fixed_string class_name = "sun/management/snmp/jvmmib/JvmRTBootClassPathEntryMeta";
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTBOOTCLASSPATHENTRYMETA_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTBOOTCLASSPATHENTRYMETA)
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTBOOTCLASSPATHENTRYMETA
...
class sun::management::snmp::jvmmib::JvmRTBootClassPathEntryMeta : public jni::object_base<"sun/management/snmp/jvmmib/JvmRTBootClassPathEntryMeta",
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmRTBootClassPathEntryMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return base_::new_object(p1, p2); }
...
protected:
	...
	JvmRTBootClassPathEntryMeta(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRTBOOTCLASSPATHENTRYMETA
