...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRUNTIMEMETA_FWD
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRUNTIMEMETA_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::management::snmp::jvmmib { class JvmRuntimeMeta; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::management::snmp::jvmmib::JvmRuntimeMeta>
{
	static constexpr fixed_string class_name = "sun/management/snmp/jvmmib/JvmRuntimeMeta";
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRUNTIMEMETA_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRUNTIMEMETA)
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRUNTIMEMETA
...
class sun::management::snmp::jvmmib::JvmRuntimeMeta : public jni::object_base<"sun/management/snmp/jvmmib/JvmRuntimeMeta",
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmRuntimeMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return object_base::new_object(p1, p2); }
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMRUNTIMEMETA
