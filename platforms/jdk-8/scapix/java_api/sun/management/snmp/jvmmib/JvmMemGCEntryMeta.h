...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMMEMGCENTRYMETA_FWD
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMMEMGCENTRYMETA_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::management::snmp::jvmmib { class JvmMemGCEntryMeta; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::management::snmp::jvmmib::JvmMemGCEntryMeta>
{
	static constexpr fixed_string class_name = "sun/management/snmp/jvmmib/JvmMemGCEntryMeta";
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMMEMGCENTRYMETA_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMMEMGCENTRYMETA)
#define SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMMEMGCENTRYMETA
...
class sun::management::snmp::jvmmib::JvmMemGCEntryMeta : public jni::object_base<"sun/management/snmp/jvmmib/JvmMemGCEntryMeta",
...
public:
	...
	static jni::ref<sun::management::snmp::jvmmib::JvmMemGCEntryMeta> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<com::sun::jmx::snmp::agent::SnmpStandardObjectServer> p2) { return object_base::new_object(p1, p2); }
...
#endif // SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMMIB_JVMMEMGCENTRYMETA
