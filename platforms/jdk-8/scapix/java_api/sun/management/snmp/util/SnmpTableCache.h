...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_UTIL_SNMPTABLECACHE
...
public:
	...
	static jni::ref<sun::management::snmp::util::SnmpTableCache> new_object() { return object_base::new_object(); }
