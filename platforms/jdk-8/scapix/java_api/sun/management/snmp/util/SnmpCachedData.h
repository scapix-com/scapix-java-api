...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_UTIL_SNMPCACHEDDATA
...
public:
	...
	static jni::ref<sun::management::snmp::util::SnmpCachedData> new_object(jlong p1, jni::ref<jni::array<com::sun::jmx::snmp::SnmpOid>> p2, jni::ref<jni::array<java::lang::Object>> p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::management::snmp::util::SnmpCachedData> new_object(jlong p1, jni::ref<java::util::TreeMap> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::management::snmp::util::SnmpCachedData> new_object(jlong p1, jni::ref<java::util::TreeMap> p2, jboolean p3) { return object_base::new_object(p1, p2, p3); }
