...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_UTIL_MIBLOGGER
...
public:
	...
	static jni::ref<sun::management::snmp::util::MibLogger> new_object(jni::ref<java::lang::Class> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::util::MibLogger> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::management::snmp::util::MibLogger> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::util::MibLogger> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
