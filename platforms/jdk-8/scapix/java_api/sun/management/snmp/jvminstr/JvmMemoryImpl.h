...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMINSTR_JVMMEMORYIMPL
...
public:
	...
	static jni::ref<sun::management::snmp::jvminstr::JvmMemoryImpl> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::snmp::jvminstr::JvmMemoryImpl> new_object(jni::ref<com::sun::jmx::snmp::agent::SnmpMib> p1, jni::ref<javax::management::MBeanServer> p2) { return object_base::new_object(p1, p2); }
