...
class JvmRTBootClassPathEntryImpl;
...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_SNMP_JVMINSTR_JVMRTBOOTCLASSPATHENTRYIMPL
...
public:
	...
	static jni::ref<sun::management::snmp::jvminstr::JvmRTBootClassPathEntryImpl> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
