...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_AGENTCONFIGURATIONERROR
...
public:
	...
	static jni::ref<sun::management::AgentConfigurationError> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::management::AgentConfigurationError> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::management::AgentConfigurationError> new_object(jni::ref<java::lang::String> p1, jni::ref<jni::array<java::lang::String>> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::management::AgentConfigurationError> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2, jni::ref<jni::array<java::lang::String>> p3) { return object_base::new_object(p1, p2, p3); }
