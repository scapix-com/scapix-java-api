...
class GarbageCollectionNotifInfoCompositeData;
...
#ifndef SCAPIX_JAVA_API_SUN_MANAGEMENT_GARBAGECOLLECTIONNOTIFINFOCOMPOSITEDATA
...
public:
	...
	static jni::ref<sun::management::GarbageCollectionNotifInfoCompositeData> new_object(jni::ref<com::sun::management::GarbageCollectionNotificationInfo> p1) { return object_base::new_object(p1); }
