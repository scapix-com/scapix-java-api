...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_COMPACTBYTEARRAY
...
public:
	...
	static jni::ref<sun::text::CompactByteArray> new_object(jbyte p1) { return object_base::new_object(p1); }
	static jni::ref<sun::text::CompactByteArray> new_object(jni::ref<jni::array<jshort>> p1, jni::ref<jni::array<jbyte>> p2) { return object_base::new_object(p1, p2); }
