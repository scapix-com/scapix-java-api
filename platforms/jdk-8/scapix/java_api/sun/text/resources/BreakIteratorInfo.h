...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_RESOURCES_BREAKITERATORINFO
...
public:
	...
	static jni::ref<sun::text::resources::BreakIteratorInfo> new_object() { return object_base::new_object(); }
};
