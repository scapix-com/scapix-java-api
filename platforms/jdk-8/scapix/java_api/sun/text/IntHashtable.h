...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_INTHASHTABLE
...
public:
	...
	static jni::ref<sun::text::IntHashtable> new_object() { return object_base::new_object(); }
	static jni::ref<sun::text::IntHashtable> new_object(jint p1) { return object_base::new_object(p1); }
