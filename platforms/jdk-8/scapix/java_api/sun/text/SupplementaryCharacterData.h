...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_SUPPLEMENTARYCHARACTERDATA
...
public:
	...
	static jni::ref<sun::text::SupplementaryCharacterData> new_object(jni::ref<jni::array<jint>> p1) { return object_base::new_object(p1); }
	jint getValue(jint p1) { return call_method<"getValue", jint>(p1); }
