...
#ifndef SCAPIX_JAVA_API_SUN_TEXT_UCOMPACTINTARRAY
...
public:
	...
	static jni::ref<sun::text::UCompactIntArray> new_object() { return object_base::new_object(); }
	static jni::ref<sun::text::UCompactIntArray> new_object(jint p1) { return object_base::new_object(p1); }
