...
#ifndef SCAPIX_JAVA_API_SUN_DC_PR_PREXCEPTION
...
public:
	...
	static jni::ref<sun::dc::pr::PRException> new_object() { return object_base::new_object(); }
	static jni::ref<sun::dc::pr::PRException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
