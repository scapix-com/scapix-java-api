...
#ifndef SCAPIX_JAVA_API_SUN_DC_PR_PATHSTROKER
...
public:
	...
	static jni::ref<sun::dc::pr::PathStroker> new_object(jni::ref<sun::dc::path::PathConsumer> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::dc::pr::PathStroker> new_object(jni::ref<sun::awt::geom::PathConsumer2D> p1) { return object_base::new_object(p1); }
