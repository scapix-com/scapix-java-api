...
namespace scapix::java_api { namespace sun::dc::pr { class PathDasher; }}
...
public:
	...
	static jni::ref<sun::dc::pr::PathDasher> new_object(jni::ref<sun::dc::path::PathConsumer> p1) { return object_base::new_object(p1); }
