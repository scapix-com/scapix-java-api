...
#ifndef SCAPIX_JAVA_API_SUN_DC_PATH_PATHEXCEPTION
...
public:
	...
	static jni::ref<sun::dc::path::PathException> new_object() { return object_base::new_object(); }
	static jni::ref<sun::dc::path::PathException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
};
