...
class AppletIllegalArgumentException;
...
#ifndef SCAPIX_JAVA_API_SUN_APPLET_APPLETILLEGALARGUMENTEXCEPTION
...
public:
	...
	static jni::ref<sun::applet::AppletIllegalArgumentException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
