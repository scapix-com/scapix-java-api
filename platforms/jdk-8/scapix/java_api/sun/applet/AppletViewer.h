...
#ifndef SCAPIX_JAVA_API_SUN_APPLET_APPLETVIEWER
...
public:
	...
	static jni::ref<sun::applet::AppletViewer> new_object(jint p1, jint p2, jni::ref<java::net::URL> p3, jni::ref<java::util::Hashtable> p4, jni::ref<java::io::PrintStream> p5, jni::ref<sun::applet::AppletViewerFactory> p6) { return object_base::new_object(p1, p2, p3, p4, p5, p6); }
