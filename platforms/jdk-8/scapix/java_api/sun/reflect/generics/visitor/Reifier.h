...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_GENERICS_VISITOR_REIFIER
...
public:
	...
	static jni::ref<sun::reflect::generics::visitor::Reifier> make(jni::ref<sun::reflect::generics::factory::GenericsFactory> p1) { return call_static_method<"make", jni::ref<sun::reflect::generics::visitor::Reifier>>(p1); }
