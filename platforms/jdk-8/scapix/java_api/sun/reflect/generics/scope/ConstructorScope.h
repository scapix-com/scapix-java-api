...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_GENERICS_SCOPE_CONSTRUCTORSCOPE
...
public:
	...
	static jni::ref<sun::reflect::generics::scope::ConstructorScope> make(jni::ref<java::lang::reflect::Constructor> p1) { return call_static_method<"make", jni::ref<sun::reflect::generics::scope::ConstructorScope>>(p1); }
};
