...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_GENERICS_SCOPE_METHODSCOPE
...
public:
	...
	static jni::ref<sun::reflect::generics::scope::MethodScope> make(jni::ref<java::lang::reflect::Method> p1) { return call_static_method<"make", jni::ref<sun::reflect::generics::scope::MethodScope>>(p1); }
};
