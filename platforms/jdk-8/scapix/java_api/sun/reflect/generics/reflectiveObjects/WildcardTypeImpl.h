...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_GENERICS_REFLECTIVEOBJECTS_WILDCARDTYPEIMPL
...
public:
	...
	static jni::ref<sun::reflect::generics::reflectiveObjects::WildcardTypeImpl> make(jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> p1, jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> p2, jni::ref<sun::reflect::generics::factory::GenericsFactory> p3) { return call_static_method<"make", jni::ref<sun::reflect::generics::reflectiveObjects::WildcardTypeImpl>>(p1, p2, p3); }
