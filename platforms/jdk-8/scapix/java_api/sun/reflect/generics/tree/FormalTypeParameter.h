...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_GENERICS_TREE_FORMALTYPEPARAMETER
...
public:
	...
	static jni::ref<sun::reflect::generics::tree::FormalTypeParameter> make(jni::ref<java::lang::String> p1, jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> p2) { return call_static_method<"make", jni::ref<sun::reflect::generics::tree::FormalTypeParameter>>(p1, p2); }
