...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_GENERICS_REPOSITORY_METHODREPOSITORY
...
public:
	...
	static jni::ref<sun::reflect::generics::repository::MethodRepository> make(jni::ref<java::lang::String> p1, jni::ref<sun::reflect::generics::factory::GenericsFactory> p2) { return call_static_method<"make", jni::ref<sun::reflect::generics::repository::MethodRepository>>(p1, p2); }
