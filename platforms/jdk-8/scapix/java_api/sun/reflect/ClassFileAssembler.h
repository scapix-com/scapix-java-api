...
namespace scapix::java_api { namespace sun::reflect { class ClassFileAssembler; }}
...
public:
	...
	static jni::ref<sun::reflect::ClassFileAssembler> new_object() { return object_base::new_object(); }
	static jni::ref<sun::reflect::ClassFileAssembler> new_object(jni::ref<sun::reflect::ByteVector> p1) { return object_base::new_object(p1); }
