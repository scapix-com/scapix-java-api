...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_ANNOTATION_TYPEANNOTATION
...
public:
	...
	static jni::ref<sun::reflect::annotation::TypeAnnotation> new_object(jni::ref<sun::reflect::annotation::TypeAnnotation_TypeAnnotationTargetInfo> p1, jni::ref<sun::reflect::annotation::TypeAnnotation_LocationInfo> p2, jni::ref<java::lang::annotation::Annotation> p3, jni::ref<java::lang::reflect::AnnotatedElement> p4) { return object_base::new_object(p1, p2, p3, p4); }
