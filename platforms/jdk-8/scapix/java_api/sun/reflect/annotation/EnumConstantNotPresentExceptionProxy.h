...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_ANNOTATION_ENUMCONSTANTNOTPRESENTEXCEPTIONPROXY
...
public:
	...
	static jni::ref<sun::reflect::annotation::EnumConstantNotPresentExceptionProxy> new_object(jni::ref<java::lang::Class> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
};
