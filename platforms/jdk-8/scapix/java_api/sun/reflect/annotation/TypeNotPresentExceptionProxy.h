...
public:
	...
	static jni::ref<sun::reflect::annotation::TypeNotPresentExceptionProxy> new_object(jni::ref<java::lang::String> p1, jni::ref<java::lang::Throwable> p2) { return base_::new_object(p1, p2); }
