...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_ANNOTATION_ANNOTATEDTYPEFACTORY
...
public:
	...
	static jni::ref<sun::reflect::annotation::AnnotatedTypeFactory> new_object() { return object_base::new_object(); }
