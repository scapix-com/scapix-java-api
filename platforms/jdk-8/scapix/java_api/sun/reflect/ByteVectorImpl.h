...
namespace scapix::java_api { namespace sun::reflect { class ByteVectorImpl; }}
...
public:
	...
	static jni::ref<sun::reflect::ByteVectorImpl> new_object() { return object_base::new_object(); }
	static jni::ref<sun::reflect::ByteVectorImpl> new_object(jint p1) { return object_base::new_object(p1); }
