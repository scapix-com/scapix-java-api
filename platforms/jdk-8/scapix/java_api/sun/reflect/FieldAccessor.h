...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSOR_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::reflect { class FieldAccessor; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::FieldAccessor>
{
	static constexpr fixed_string class_name = "sun/reflect/FieldAccessor";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSOR)
#define SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSOR

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class sun::reflect::FieldAccessor : public jni::object_base<"sun/reflect/FieldAccessor",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSOR
