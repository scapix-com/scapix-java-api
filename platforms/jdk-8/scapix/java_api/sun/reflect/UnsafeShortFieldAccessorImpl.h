...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_UNSAFESHORTFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFESHORTFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::reflect { class UnsafeShortFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::UnsafeShortFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "sun/reflect/UnsafeShortFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::sun::reflect::UnsafeFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFESHORTFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_UNSAFESHORTFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFESHORTFIELDACCESSORIMPL
...
// private
class sun::reflect::UnsafeShortFieldAccessorImpl : public jni::object_base<"sun/reflect/UnsafeShortFieldAccessorImpl",
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFESHORTFIELDACCESSORIMPL
