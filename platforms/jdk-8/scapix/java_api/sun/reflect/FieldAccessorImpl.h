...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::reflect { class FieldAccessorImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::FieldAccessorImpl>
{
	static constexpr fixed_string class_name = "sun/reflect/FieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::sun::reflect::MagicAccessorImpl, scapix::java_api::sun::reflect::FieldAccessor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSORIMPL
...
// private
class sun::reflect::FieldAccessorImpl : public jni::object_base<"sun/reflect/FieldAccessorImpl",
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_FIELDACCESSORIMPL
