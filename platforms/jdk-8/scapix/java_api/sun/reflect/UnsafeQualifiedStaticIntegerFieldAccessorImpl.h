...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::reflect { class UnsafeQualifiedStaticIntegerFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::UnsafeQualifiedStaticIntegerFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "sun/reflect/UnsafeQualifiedStaticIntegerFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::sun::reflect::UnsafeQualifiedStaticFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL
...
// private
class sun::reflect::UnsafeQualifiedStaticIntegerFieldAccessorImpl : public jni::object_base<"sun/reflect/UnsafeQualifiedStaticIntegerFieldAccessorImpl",
...
protected:
	...
	UnsafeQualifiedStaticIntegerFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL
