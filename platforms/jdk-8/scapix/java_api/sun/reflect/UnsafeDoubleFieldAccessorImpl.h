...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEDOUBLEFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEDOUBLEFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::reflect { class UnsafeDoubleFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::UnsafeDoubleFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "sun/reflect/UnsafeDoubleFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::sun::reflect::UnsafeFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEDOUBLEFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEDOUBLEFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEDOUBLEFIELDACCESSORIMPL
...
// private
class sun::reflect::UnsafeDoubleFieldAccessorImpl : public jni::object_base<"sun/reflect/UnsafeDoubleFieldAccessorImpl",
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEDOUBLEFIELDACCESSORIMPL
