...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICOBJECTFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICOBJECTFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::reflect { class UnsafeQualifiedStaticObjectFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::UnsafeQualifiedStaticObjectFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "sun/reflect/UnsafeQualifiedStaticObjectFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::sun::reflect::UnsafeQualifiedStaticFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICOBJECTFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICOBJECTFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICOBJECTFIELDACCESSORIMPL
...
// private
class sun::reflect::UnsafeQualifiedStaticObjectFieldAccessorImpl : public jni::object_base<"sun/reflect/UnsafeQualifiedStaticObjectFieldAccessorImpl",
...
protected:
	...
	UnsafeQualifiedStaticObjectFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICOBJECTFIELDACCESSORIMPL
