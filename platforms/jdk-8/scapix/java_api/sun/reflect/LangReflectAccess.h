...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_LANGREFLECTACCESS_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_LANGREFLECTACCESS_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::reflect { class LangReflectAccess; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::LangReflectAccess>
{
	static constexpr fixed_string class_name = "sun/reflect/LangReflectAccess";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_LANGREFLECTACCESS_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_LANGREFLECTACCESS)
#define SCAPIX_JAVA_API_SUN_REFLECT_LANGREFLECTACCESS
...
class sun::reflect::LangReflectAccess : public jni::object_base<"sun/reflect/LangReflectAccess",
	java::lang::Object>
{
public:
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_LANGREFLECTACCESS
