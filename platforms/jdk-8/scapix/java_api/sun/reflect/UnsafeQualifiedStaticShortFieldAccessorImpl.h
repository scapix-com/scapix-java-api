...
#ifndef SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICSHORTFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICSHORTFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::reflect { class UnsafeQualifiedStaticShortFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::reflect::UnsafeQualifiedStaticShortFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "sun/reflect/UnsafeQualifiedStaticShortFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::sun::reflect::UnsafeQualifiedStaticFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICSHORTFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICSHORTFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICSHORTFIELDACCESSORIMPL
...
// private
class sun::reflect::UnsafeQualifiedStaticShortFieldAccessorImpl : public jni::object_base<"sun/reflect/UnsafeQualifiedStaticShortFieldAccessorImpl",
...
protected:
	...
	UnsafeQualifiedStaticShortFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_REFLECT_UNSAFEQUALIFIEDSTATICSHORTFIELDACCESSORIMPL
