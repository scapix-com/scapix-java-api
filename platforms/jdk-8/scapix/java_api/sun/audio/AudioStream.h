...
#ifndef SCAPIX_JAVA_API_SUN_AUDIO_AUDIOSTREAM
...
public:
	...
	static jni::ref<sun::audio::AudioStream> new_object(jni::ref<java::io::InputStream> p1) { return object_base::new_object(p1); }
