...
#ifndef SCAPIX_JAVA_API_SUN_AUDIO_CONTINUOUSAUDIODATASTREAM
...
public:
	...
	static jni::ref<sun::audio::ContinuousAudioDataStream> new_object(jni::ref<sun::audio::AudioData> p1) { return object_base::new_object(p1); }
