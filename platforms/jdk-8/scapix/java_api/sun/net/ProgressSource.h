...
#ifndef SCAPIX_JAVA_API_SUN_NET_PROGRESSSOURCE
...
public:
	...
	static jni::ref<sun::net::ProgressSource> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::net::ProgressSource> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
