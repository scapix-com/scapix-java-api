...
#ifndef SCAPIX_JAVA_API_SUN_NET_FTP_FTPPROTOCOLEXCEPTION
...
public:
	...
	static jni::ref<sun::net::ftp::FtpProtocolException> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::net::ftp::FtpProtocolException> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::net::ftp::FtpReplyCode> p2) { return object_base::new_object(p1, p2); }
