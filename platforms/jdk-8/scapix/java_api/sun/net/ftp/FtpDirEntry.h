...
#ifndef SCAPIX_JAVA_API_SUN_NET_FTP_FTPDIRENTRY
...
public:
	...
	static jni::ref<sun::net::ftp::FtpDirEntry> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
