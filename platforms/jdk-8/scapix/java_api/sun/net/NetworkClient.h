...
#ifndef SCAPIX_JAVA_API_SUN_NET_NETWORKCLIENT
...
public:
	...
	static jni::ref<sun::net::NetworkClient> new_object(jni::ref<java::lang::String> p1, jint p2) { return object_base::new_object(p1, p2); }
	static jni::ref<sun::net::NetworkClient> new_object() { return object_base::new_object(); }
