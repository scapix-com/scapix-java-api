...
#ifndef SCAPIX_JAVA_API_SUN_NET_SPI_DEFAULTPROXYSELECTOR
...
public:
	...
	static jni::ref<sun::net::spi::DefaultProxySelector> new_object() { return object_base::new_object(); }
