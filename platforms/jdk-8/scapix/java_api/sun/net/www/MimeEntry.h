...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_MIMEENTRY
...
public:
	...
	static jni::ref<sun::net::www::MimeEntry> new_object(jni::ref<java::lang::String> p1) { return object_base::new_object(p1); }
