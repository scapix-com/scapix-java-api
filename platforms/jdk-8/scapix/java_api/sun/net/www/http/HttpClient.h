...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_HTTP_HTTPCLIENT
...
public:
	...
	static jni::ref<sun::net::www::http::HttpClient> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::net::www::http::HttpClient> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jint p3, jboolean p4, jint p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
