...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_HTTP_KEEPALIVECACHE
...
public:
	...
	static jni::ref<sun::net::www::http::KeepAliveCache> new_object() { return object_base::new_object(); }
	void put(jni::ref<java::net::URL> p1, jni::ref<java::lang::Object> p2, jni::ref<sun::net::www::http::HttpClient> p3) { return call_method<"put", void>(p1, p2, p3); }
	jni::ref<sun::net::www::http::HttpClient> get(jni::ref<java::net::URL> p1, jni::ref<java::lang::Object> p2) { return call_method<"get", jni::ref<sun::net::www::http::HttpClient>>(p1, p2); }
