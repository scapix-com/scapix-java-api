...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_HTTP_CHUNKEDINPUTSTREAM
...
public:
	...
	static jni::ref<sun::net::www::http::ChunkedInputStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<sun::net::www::http::HttpClient> p2, jni::ref<sun::net::www::MessageHeader> p3) { return object_base::new_object(p1, p2, p3); }
