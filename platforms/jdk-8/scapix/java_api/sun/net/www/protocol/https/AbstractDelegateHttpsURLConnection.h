...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_HTTPS_ABSTRACTDELEGATEHTTPSURLCONNECTION
...
public:
	...
	void setNewClient(jni::ref<java::net::URL> p1) { return call_method<"setNewClient", void>(p1); }
	void setNewClient(jni::ref<java::net::URL> p1, jboolean p2) { return call_method<"setNewClient", void>(p1, p2); }
	void setProxiedClient(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jint p3) { return call_method<"setProxiedClient", void>(p1, p2, p3); }
	void setProxiedClient(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jint p3, jboolean p4) { return call_method<"setProxiedClient", void>(p1, p2, p3, p4); }
	jboolean isConnected() { return call_method<"isConnected", jboolean>(); }
	void setConnected(jboolean p1) { return call_method<"setConnected", void>(p1); }
