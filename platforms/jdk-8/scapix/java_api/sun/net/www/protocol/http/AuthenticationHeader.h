...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_HTTP_AUTHENTICATIONHEADER
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::AuthenticationHeader> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::net::www::MessageHeader> p2, jni::ref<sun::net::www::protocol::http::HttpCallerInfo> p3, jboolean p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::net::www::protocol::http::AuthenticationHeader> new_object(jni::ref<java::lang::String> p1, jni::ref<sun::net::www::MessageHeader> p2, jni::ref<sun::net::www::protocol::http::HttpCallerInfo> p3, jboolean p4, jni::ref<java::util::Set> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
