...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_FTP_FTPURLCONNECTION
...
public:
	...
	static jni::ref<sun::net::www::protocol::ftp::FtpURLConnection> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
