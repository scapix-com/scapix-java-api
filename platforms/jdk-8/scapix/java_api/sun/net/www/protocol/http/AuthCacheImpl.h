...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_HTTP_AUTHCACHEIMPL
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::AuthCacheImpl> new_object() { return object_base::new_object(); }
	void setMap(jni::ref<java::util::HashMap> p1) { return call_method<"setMap", void>(p1); }
