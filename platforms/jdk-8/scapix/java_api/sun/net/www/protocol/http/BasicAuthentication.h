...
public:
	...
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean p1, jni::ref<java::lang::String> p2, jint p3, jni::ref<java::lang::String> p4, jni::ref<java::net::PasswordAuthentication> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean p1, jni::ref<java::lang::String> p2, jint p3, jni::ref<java::lang::String> p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean p1, jni::ref<java::net::URL> p2, jni::ref<java::lang::String> p3, jni::ref<java::net::PasswordAuthentication> p4) { return object_base::new_object(p1, p2, p3, p4); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean p1, jni::ref<java::net::URL> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
