...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_JAR_JARURLCONNECTION
...
public:
	...
	static jni::ref<sun::net::www::protocol::jar::JarURLConnection> new_object(jni::ref<java::net::URL> p1, jni::ref<sun::net::www::protocol::jar::Handler> p2) { return object_base::new_object(p1, p2); }
