...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_HTTP_NEGOTIATOR
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::Negotiator> new_object() { return object_base::new_object(); }
