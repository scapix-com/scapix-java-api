...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_JAR_URLJARFILE
...
public:
	...
	static jni::ref<sun::net::www::protocol::jar::URLJarFile> new_object(jni::ref<java::io::File> p1) { return object_base::new_object(p1); }
	static jni::ref<sun::net::www::protocol::jar::URLJarFile> new_object(jni::ref<java::io::File> p1, jni::ref<sun::net::www::protocol::jar::URLJarFile_URLJarFileCloseController> p2) { return object_base::new_object(p1, p2); }
