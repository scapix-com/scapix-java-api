...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_HTTP_HTTPURLCONNECTION
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::HttpURLConnection> new_object(jni::ref<java::net::URL> p1, jni::ref<java::lang::String> p2, jint p3) { return object_base::new_object(p1, p2, p3); }
	static jni::ref<sun::net::www::protocol::http::HttpURLConnection> new_object(jni::ref<java::net::URL> p1, jni::ref<java::net::Proxy> p2) { return object_base::new_object(p1, p2); }
