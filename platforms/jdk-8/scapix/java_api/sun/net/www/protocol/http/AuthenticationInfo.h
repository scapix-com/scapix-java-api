...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_PROTOCOL_HTTP_AUTHENTICATIONINFO
...
public:
	...
	static jni::ref<sun::net::www::protocol::http::AuthenticationInfo> new_object(jchar p1, jni::ref<sun::net::www::protocol::http::AuthScheme> p2, jni::ref<java::lang::String> p3, jint p4, jni::ref<java::lang::String> p5) { return object_base::new_object(p1, p2, p3, p4, p5); }
	jni::ref<java::lang::Object> clone() { return call_method<"clone", jni::ref<java::lang::Object>>(); }
	static jni::ref<sun::net::www::protocol::http::AuthenticationInfo> new_object(jchar p1, jni::ref<sun::net::www::protocol::http::AuthScheme> p2, jni::ref<java::net::URL> p3, jni::ref<java::lang::String> p4) { return object_base::new_object(p1, p2, p3, p4); }
