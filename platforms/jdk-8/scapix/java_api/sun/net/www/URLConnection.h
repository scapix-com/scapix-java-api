...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_URLCONNECTION
...
public:
	...
	static jni::ref<sun::net::www::URLConnection> new_object(jni::ref<java::net::URL> p1) { return object_base::new_object(p1); }
