...
#ifndef SCAPIX_JAVA_API_SUN_NET_WWW_METEREDSTREAM
...
public:
	...
	static jni::ref<sun::net::www::MeteredStream> new_object(jni::ref<java::io::InputStream> p1, jni::ref<sun::net::ProgressSource> p2, jlong p3) { return object_base::new_object(p1, p2, p3); }
