...
#ifndef SCAPIX_JAVA_API_SUN_NET_NETWORKSERVER
...
public:
	...
	void startServer(jint p1) { return call_method<"startServer", void>(p1); }
	...
	static jni::ref<sun::net::NetworkServer> new_object() { return object_base::new_object(); }
};
