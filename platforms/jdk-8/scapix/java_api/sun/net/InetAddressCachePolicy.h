...
#ifndef SCAPIX_JAVA_API_SUN_NET_INETADDRESSCACHEPOLICY
...
public:
	...
	static jni::ref<sun::net::InetAddressCachePolicy> new_object() { return object_base::new_object(); }
	static jint get() { return call_static_method<"get", jint>(); }
	static jint getNegative() { return call_static_method<"getNegative", jint>(); }
	static void setIfNotSet(jint p1) { return call_static_method<"setIfNotSet", void>(p1); }
	static void setNegativeIfNotSet(jint p1) { return call_static_method<"setNegativeIfNotSet", void>(p1); }
};
