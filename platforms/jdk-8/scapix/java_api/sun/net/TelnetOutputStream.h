...
#ifndef SCAPIX_JAVA_API_SUN_NET_TELNETOUTPUTSTREAM
...
public:
	...
	static jni::ref<sun::net::TelnetOutputStream> new_object(jni::ref<java::io::OutputStream> p1, jboolean p2) { return object_base::new_object(p1, p2); }
