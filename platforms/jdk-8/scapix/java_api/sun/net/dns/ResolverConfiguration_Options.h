...
class ResolverConfiguration_Options;
...
#ifndef SCAPIX_JAVA_API_SUN_NET_DNS_RESOLVERCONFIGURATION_OPTIONS
...
public:
	...
	static jni::ref<sun::net::dns::ResolverConfiguration_Options> new_object() { return object_base::new_object(); }
