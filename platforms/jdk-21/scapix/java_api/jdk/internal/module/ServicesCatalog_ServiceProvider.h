...
public:
	...
	static jni::ref<jdk::internal::module::ServicesCatalog_ServiceProvider> new_object(jni::ref<java::lang::Module> module, jni::ref<java::lang::String> providerName) { return object_base::new_object(module, providerName); }
