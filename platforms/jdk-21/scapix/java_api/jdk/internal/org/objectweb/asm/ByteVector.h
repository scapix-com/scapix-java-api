...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ByteVector; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ByteVector> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ByteVector> new_object(jint initialCapacity) { return object_base::new_object(initialCapacity); }
