...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class TypeReference; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::TypeReference> new_object(jint typeRef) { return object_base::new_object(typeRef); }
