...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ClassReader; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<jni::array<jbyte>> classFile) { return object_base::new_object(classFile); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<jni::array<jbyte>> classFileBuffer, jint classFileOffset, jint classFileLength) { return object_base::new_object(classFileBuffer, classFileOffset, classFileLength); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<java::io::InputStream> inputStream) { return object_base::new_object(inputStream); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> new_object(jni::ref<java::lang::String> className) { return object_base::new_object(className); }
