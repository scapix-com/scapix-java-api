...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class TraceClassVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceClassVisitor> new_object(jni::ref<java::io::PrintWriter> printWriter) { return object_base::new_object(printWriter); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceClassVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor, jni::ref<java::io::PrintWriter> printWriter) { return object_base::new_object(classVisitor, printWriter); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceClassVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer, jni::ref<java::io::PrintWriter> printWriter) { return object_base::new_object(classVisitor, printer, printWriter); }
