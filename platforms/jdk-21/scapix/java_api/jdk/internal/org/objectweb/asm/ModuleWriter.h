...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_MODULEWRITER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_MODULEWRITER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ModuleWriter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::ModuleWriter>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/ModuleWriter";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::ModuleVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_MODULEWRITER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_MODULEWRITER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_MODULEWRITER
...
// private
class jdk::internal::org::objectweb::asm_::ModuleWriter : public jni::object_base<"jdk/internal/org/objectweb/asm/ModuleWriter",
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_MODULEWRITER
