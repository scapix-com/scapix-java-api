...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckMethodAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodvisitor) { return object_base::new_object(methodvisitor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckMethodAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jni::ref<java::util::Map> labelInsnIndices) { return object_base::new_object(methodVisitor, labelInsnIndices); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckMethodAdapter> new_object(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jni::ref<java::util::Map> labelInsnIndices) { return object_base::new_object(access, name, descriptor, methodVisitor, labelInsnIndices); }
