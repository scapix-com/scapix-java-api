...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_TRACEMETHODVISITOR_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_TRACEMETHODVISITOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class TraceMethodVisitor; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/util/TraceMethodVisitor";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::MethodVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_TRACEMETHODVISITOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_TRACEMETHODVISITOR)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_TRACEMETHODVISITOR
...
class jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor : public jni::object_base<"jdk/internal/org/objectweb/asm/util/TraceMethodVisitor",
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return object_base::new_object(printer); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceMethodVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return object_base::new_object(methodVisitor, printer); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_TRACEMETHODVISITOR
