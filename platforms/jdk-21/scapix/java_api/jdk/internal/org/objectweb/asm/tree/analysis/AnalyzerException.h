...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree::analysis { class AnalyzerException; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::AnalyzerException> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::AbstractInsnNode> insn, jni::ref<java::lang::String> message) { return object_base::new_object(insn, message); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::AnalyzerException> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::AbstractInsnNode> insn, jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(insn, message, cause); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::AnalyzerException> new_object(jni::ref<jdk::internal::org::objectweb::asm_::tree::AbstractInsnNode> insn, jni::ref<java::lang::String> message, jni::ref<java::lang::Object> expected, jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value> actual) { return object_base::new_object(insn, message, expected, actual); }
