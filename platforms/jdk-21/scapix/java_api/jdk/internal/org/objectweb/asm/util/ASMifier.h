...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class ASMifier; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> new_object() { return object_base::new_object(); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitClassAnnotation(jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitClassAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitClassTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitClassTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	...
	void visitPermittedSubclass(jni::ref<java::lang::String> permittedSubclass) { return call_method<"visitPermittedSubclass", void>(permittedSubclass); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitRecordComponent(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature) { return call_method<"visitRecordComponent", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(name, descriptor, signature); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitField(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature, jni::ref<java::lang::Object> value) { return call_method<"visitField", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(access, name, descriptor, signature, value); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitMethod(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature, jni::ref<jni::array<java::lang::String>> exceptions) { return call_method<"visitMethod", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(access, name, descriptor, signature, exceptions); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitAnnotation(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return call_method<"visitAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(name, descriptor); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitRecordComponentAnnotation(jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitRecordComponentAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitRecordComponentTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitRecordComponentTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitFieldAnnotation(jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitFieldAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitFieldTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitFieldTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitMethodAnnotation(jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitMethodAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitMethodTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitMethodTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitAnnotableParameterCount(jint parameterCount, jboolean visible) { return call_method<"visitAnnotableParameterCount", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(parameterCount, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitParameterAnnotation(jint parameter, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitParameterAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(parameter, descriptor, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitInsnAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitInsnAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitTryCatchAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitTryCatchAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	...
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitAnnotation(jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitTypeAnnotation(jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(typeRef, typePath, descriptor, visible); }
	jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier> visitTypeAnnotation(jni::ref<java::lang::String> method, jint typeRef, jni::ref<jdk::internal::org::objectweb::asm_::TypePath> typePath, jni::ref<java::lang::String> descriptor, jboolean visible) { return call_method<"visitTypeAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::util::ASMifier>>(method, typeRef, typePath, descriptor, visible); }
