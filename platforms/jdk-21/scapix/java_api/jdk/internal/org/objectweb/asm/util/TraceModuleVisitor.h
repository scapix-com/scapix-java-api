...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class TraceModuleVisitor; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceModuleVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return object_base::new_object(printer); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceModuleVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> moduleVisitor, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return object_base::new_object(moduleVisitor, printer); }
