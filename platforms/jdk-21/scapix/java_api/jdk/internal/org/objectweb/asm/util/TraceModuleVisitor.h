...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceModuleVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return base_::new_object(printer); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::TraceModuleVisitor> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> moduleVisitor, jni::ref<jdk::internal::org::objectweb::asm_::util::Printer> printer) { return base_::new_object(moduleVisitor, printer); }
