...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_CLASSREMAPPER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_CLASSREMAPPER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class ClassRemapper; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::commons::ClassRemapper>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/commons/ClassRemapper";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::ClassVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_CLASSREMAPPER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_CLASSREMAPPER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_CLASSREMAPPER
...
class jdk::internal::org::objectweb::asm_::commons::ClassRemapper : public jni::object_base<"jdk/internal/org/objectweb/asm/commons/ClassRemapper",
	jdk::internal::org::objectweb::asm_::ClassVisitor>
{
public:

	static jni::ref<jdk::internal::org::objectweb::asm_::commons::ClassRemapper> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return object_base::new_object(classVisitor, remapper); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_COMMONS_CLASSREMAPPER
