...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::FieldInsnNode> new_object(jint opcode, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return base_::new_object(opcode, owner, name, descriptor); }
