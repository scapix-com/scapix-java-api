...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKCLASSADAPTER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKCLASSADAPTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class CheckClassAdapter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::util::CheckClassAdapter>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/util/CheckClassAdapter";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::ClassVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKCLASSADAPTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKCLASSADAPTER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKCLASSADAPTER
...
class jdk::internal::org::objectweb::asm_::util::CheckClassAdapter : public jni::object_base<"jdk/internal/org/objectweb/asm/util/CheckClassAdapter",
	jdk::internal::org::objectweb::asm_::ClassVisitor>
{
public:

	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor) { return object_base::new_object(classVisitor); }
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckClassAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassVisitor> classVisitor, jboolean checkDataFlow) { return object_base::new_object(classVisitor, checkDataFlow); }
	...
	static void checkClassSignature(jni::ref<java::lang::String> signature) { return call_static_method<"checkClassSignature", void>(signature); }
	static void checkMethodSignature(jni::ref<java::lang::String> signature) { return call_static_method<"checkMethodSignature", void>(signature); }
	static void checkFieldSignature(jni::ref<java::lang::String> signature) { return call_static_method<"checkFieldSignature", void>(signature); }
	static void main(jni::ref<jni::array<java::lang::String>> args) { return call_static_method<"main", void>(args); }
	static void verify(jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> classReader, jboolean printResults, jni::ref<java::io::PrintWriter> printWriter) { return call_static_method<"verify", void>(classReader, printResults, printWriter); }
	static void verify(jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> classReader, jni::ref<java::lang::ClassLoader> loader, jboolean printResults, jni::ref<java::io::PrintWriter> printWriter) { return call_static_method<"verify", void>(classReader, loader, printResults, printWriter); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKCLASSADAPTER
