...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_METHODWRITER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_METHODWRITER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class MethodWriter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::MethodWriter>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/MethodWriter";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::MethodVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_METHODWRITER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_METHODWRITER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_METHODWRITER
...
// private
class jdk::internal::org::objectweb::asm_::MethodWriter : public jni::object_base<"jdk/internal/org/objectweb/asm/MethodWriter",
...
public:
	...
	jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> visitParameterAnnotation(jint parameter, jni::ref<java::lang::String> annotationDescriptor, jboolean visible) { return call_method<"visitParameterAnnotation", jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor>>(parameter, annotationDescriptor, visible); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_METHODWRITER
