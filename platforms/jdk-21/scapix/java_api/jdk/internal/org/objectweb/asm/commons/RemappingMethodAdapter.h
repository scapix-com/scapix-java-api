...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::RemappingMethodAdapter> new_object(jint access, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::MethodVisitor> methodVisitor, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return base_::new_object(access, descriptor, methodVisitor, remapper); }
