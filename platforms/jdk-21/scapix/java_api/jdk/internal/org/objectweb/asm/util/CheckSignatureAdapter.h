...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class CheckSignatureAdapter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckSignatureAdapter> new_object(jint type, jni::ref<jdk::internal::org::objectweb::asm_::signature::SignatureVisitor> signatureVisitor) { return object_base::new_object(type, signatureVisitor); }
