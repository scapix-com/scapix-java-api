...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class CheckAnnotationAdapter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckAnnotationAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::AnnotationVisitor> annotationVisitor) { return object_base::new_object(annotationVisitor); }
