...
namespace scapix::java_api::jdk::internal::org::objectweb::asm_::util { class CheckFieldAdapter; }
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckFieldAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::FieldVisitor> fieldVisitor) { return base_::new_object(fieldVisitor); }
...
protected:
	...
	CheckFieldAdapter(handle_type h) : base_(h) {}
