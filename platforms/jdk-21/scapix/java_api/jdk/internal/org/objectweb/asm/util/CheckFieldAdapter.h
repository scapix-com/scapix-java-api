...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKFIELDADAPTER_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKFIELDADAPTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::util { class CheckFieldAdapter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::util::CheckFieldAdapter>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/util/CheckFieldAdapter";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::FieldVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKFIELDADAPTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKFIELDADAPTER)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKFIELDADAPTER
...
class jdk::internal::org::objectweb::asm_::util::CheckFieldAdapter : public jni::object_base<"jdk/internal/org/objectweb/asm/util/CheckFieldAdapter",
	jdk::internal::org::objectweb::asm_::FieldVisitor>
{
public:

	static jni::ref<jdk::internal::org::objectweb::asm_::util::CheckFieldAdapter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::FieldVisitor> fieldVisitor) { return object_base::new_object(fieldVisitor); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_UTIL_CHECKFIELDADAPTER
