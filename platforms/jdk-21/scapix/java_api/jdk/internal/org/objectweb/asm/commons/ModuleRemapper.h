...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::commons { class ModuleRemapper; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::ModuleRemapper> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ModuleVisitor> moduleVisitor, jni::ref<jdk::internal::org::objectweb::asm_::commons::Remapper> remapper) { return object_base::new_object(moduleVisitor, remapper); }
