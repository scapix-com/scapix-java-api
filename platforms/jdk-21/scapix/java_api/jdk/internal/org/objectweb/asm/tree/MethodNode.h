...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> new_object(jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature, jni::ref<jni::array<java::lang::String>> exceptions) { return object_base::new_object(access, name, descriptor, signature, exceptions); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::MethodNode> new_object(jint api, jint access, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature, jni::ref<jni::array<java::lang::String>> exceptions) { return object_base::new_object(api, access, name, descriptor, signature, exceptions); }
