...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class ClassNode; }}
...
public:
	...
	jni::ref<java::util::List> permittedSubclasses() { return get_field<"permittedSubclasses", jni::ref<java::util::List>>(); }
	void permittedSubclasses(jni::ref<java::util::List> v) { set_field<"permittedSubclasses", jni::ref<java::util::List>>(v); }
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::ClassNode> new_object() { return object_base::new_object(); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::ClassNode> new_object(jint api) { return object_base::new_object(api); }
