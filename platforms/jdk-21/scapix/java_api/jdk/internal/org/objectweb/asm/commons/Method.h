...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::commons::Method> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return object_base::new_object(name, descriptor); }
