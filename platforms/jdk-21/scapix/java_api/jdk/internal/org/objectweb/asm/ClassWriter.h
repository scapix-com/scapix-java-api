...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_ { class ClassWriter; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassWriter> new_object(jint flags) { return object_base::new_object(flags); }
	static jni::ref<jdk::internal::org::objectweb::asm_::ClassWriter> new_object(jni::ref<jdk::internal::org::objectweb::asm_::ClassReader> classReader, jint flags) { return object_base::new_object(classReader, flags); }
	jboolean hasFlags(jint flags) { return call_method<"hasFlags", jboolean>(flags); }
	...
	jint newConst(jni::ref<java::lang::Object> value) { return call_method<"newConst", jint>(value); }
	...
	jint newMethodType(jni::ref<java::lang::String> methodDescriptor) { return call_method<"newMethodType", jint>(methodDescriptor); }
	...
	jint newHandle(jint tag, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return call_method<"newHandle", jint>(tag, owner, name, descriptor); }
	jint newHandle(jint tag, jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jboolean isInterface) { return call_method<"newHandle", jint>(tag, owner, name, descriptor, isInterface); }
	jint newConstantDynamic(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::Handle> bootstrapMethodHandle, jni::ref<jni::array<java::lang::Object>> bootstrapMethodArguments) { return call_method<"newConstantDynamic", jint>(name, descriptor, bootstrapMethodHandle, bootstrapMethodArguments); }
	jint newInvokeDynamic(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<jdk::internal::org::objectweb::asm_::Handle> bootstrapMethodHandle, jni::ref<jni::array<java::lang::Object>> bootstrapMethodArguments) { return call_method<"newInvokeDynamic", jint>(name, descriptor, bootstrapMethodHandle, bootstrapMethodArguments); }
	jint newField(jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return call_method<"newField", jint>(owner, name, descriptor); }
	jint newMethod(jni::ref<java::lang::String> owner, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jboolean isInterface) { return call_method<"newMethod", jint>(owner, name, descriptor, isInterface); }
	jint newNameType(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor) { return call_method<"newNameType", jint>(name, descriptor); }
