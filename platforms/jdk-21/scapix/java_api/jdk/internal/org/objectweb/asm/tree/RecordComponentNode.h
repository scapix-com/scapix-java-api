...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_TREE_RECORDCOMPONENTNODE_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_TREE_RECORDCOMPONENTNODE_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class RecordComponentNode; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::org::objectweb::asm_::tree::RecordComponentNode>
{
	static constexpr fixed_string class_name = "jdk/internal/org/objectweb/asm/tree/RecordComponentNode";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::org::objectweb::asm_::RecordComponentVisitor>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_TREE_RECORDCOMPONENTNODE_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_TREE_RECORDCOMPONENTNODE)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_TREE_RECORDCOMPONENTNODE
...
class jdk::internal::org::objectweb::asm_::tree::RecordComponentNode : public jni::object_base<"jdk/internal/org/objectweb/asm/tree/RecordComponentNode",
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::RecordComponentNode> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature) { return object_base::new_object(name, descriptor, signature); }
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::RecordComponentNode> new_object(jint api, jni::ref<java::lang::String> name, jni::ref<java::lang::String> descriptor, jni::ref<java::lang::String> signature) { return object_base::new_object(api, name, descriptor, signature); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ORG_OBJECTWEB_ASM_TREE_RECORDCOMPONENTNODE
