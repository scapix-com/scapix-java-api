...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> new_object(jint numLocals, jint maxStack) { return object_base::new_object(numLocals, maxStack); }
