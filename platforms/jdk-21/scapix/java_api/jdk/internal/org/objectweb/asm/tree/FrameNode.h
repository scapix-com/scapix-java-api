...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class FrameNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::FrameNode> new_object(jint type, jint numLocal, jni::ref<jni::array<java::lang::Object>> local, jint numStack, jni::ref<jni::array<java::lang::Object>> stack) { return object_base::new_object(type, numLocal, local, numStack, stack); }
