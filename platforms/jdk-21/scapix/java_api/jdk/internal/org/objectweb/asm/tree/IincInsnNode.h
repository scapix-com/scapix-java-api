...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree { class IincInsnNode; }}
...
public:
	...
	static jni::ref<jdk::internal::org::objectweb::asm_::tree::IincInsnNode> new_object(jint varIndex, jint incr) { return object_base::new_object(varIndex, incr); }
