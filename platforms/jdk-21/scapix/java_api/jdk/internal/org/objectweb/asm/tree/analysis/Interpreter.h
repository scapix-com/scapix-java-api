...
namespace scapix::java_api { namespace jdk::internal::org::objectweb::asm_::tree::analysis { class Interpreter; }}
...
#include <scapix/java_api/jdk/internal/org/objectweb/asm/tree/TryCatchBlockNode.h>
...
public:
	...
	jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value> newParameterValue(jboolean isInstanceMethod, jint local, jni::ref<jdk::internal::org::objectweb::asm_::Type> type) { return call_method<"newParameterValue", jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value>>(isInstanceMethod, local, type); }
	jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value> newReturnTypeValue(jni::ref<jdk::internal::org::objectweb::asm_::Type> type) { return call_method<"newReturnTypeValue", jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value>>(type); }
	jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value> newEmptyValue(jint local) { return call_method<"newEmptyValue", jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value>>(local); }
	jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value> newExceptionValue(jni::ref<jdk::internal::org::objectweb::asm_::tree::TryCatchBlockNode> tryCatchBlockNode, jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Frame> handlerFrame, jni::ref<jdk::internal::org::objectweb::asm_::Type> exceptionType) { return call_method<"newExceptionValue", jni::ref<jdk::internal::org::objectweb::asm_::tree::analysis::Value>>(tryCatchBlockNode, handlerFrame, exceptionType); }
