...
namespace scapix::java_api { namespace jdk::internal::vm { class VMSupport; }}
...
public:
	...
	static jni::ref<jdk::internal::vm::VMSupport> new_object() { return object_base::new_object(); }
	...
	static void decodeAndThrowThrowable(jint format, jlong buffer, jboolean inJVMHeap) { return call_static_method<"decodeAndThrowThrowable", void>(format, buffer, inJVMHeap); }
	static jint encodeThrowable(jni::ref<java::lang::Throwable> throwable, jlong buffer, jint bufferSize) { return call_static_method<"encodeThrowable", jint>(throwable, buffer, bufferSize); }
