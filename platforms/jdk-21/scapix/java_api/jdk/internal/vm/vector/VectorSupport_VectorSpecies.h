...
namespace scapix::java_api { namespace jdk::internal::vm::vector { class VectorSupport_VectorSpecies; }}
...
public:
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorSpecies> new_object() { return object_base::new_object(); }
