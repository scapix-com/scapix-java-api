...
namespace scapix::java_api { namespace jdk::internal::vm::vector { class VectorSupport_VectorMask; }}
...
public:
	...
	static jni::ref<jdk::internal::vm::vector::VectorSupport_VectorMask> new_object(jni::ref<java::lang::Object> payload) { return object_base::new_object(payload); }
