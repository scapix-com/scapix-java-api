...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEBYTEFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEBYTEFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class UnsafeByteFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::UnsafeByteFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/UnsafeByteFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::UnsafeFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEBYTEFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEBYTEFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEBYTEFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::UnsafeByteFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/UnsafeByteFieldAccessorImpl",
...
protected:
	...
	UnsafeByteFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEBYTEFIELDACCESSORIMPL
