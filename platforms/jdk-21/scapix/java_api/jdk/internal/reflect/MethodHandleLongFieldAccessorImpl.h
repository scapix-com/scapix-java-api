...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLELONGFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLELONGFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class MethodHandleLongFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::MethodHandleLongFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/MethodHandleLongFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::MethodHandleFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLELONGFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLELONGFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLELONGFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::MethodHandleLongFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/MethodHandleLongFieldAccessorImpl",
...
protected:
	...
	MethodHandleLongFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLELONGFIELDACCESSORIMPL
