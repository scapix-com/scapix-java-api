...
namespace scapix::java_api { namespace jdk::internal::reflect { class ReflectionFactory_Config; }}
...
public:
	...
	jboolean noInflation() { return call_method<"noInflation", jboolean>(); }
	jint inflationThreshold() { return call_method<"inflationThreshold", jint>(); }
	jint useDirectMethodHandle() { return call_method<"useDirectMethodHandle", jint>(); }
