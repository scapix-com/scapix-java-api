...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLESHORTFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLESHORTFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class MethodHandleShortFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::MethodHandleShortFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/MethodHandleShortFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::MethodHandleFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLESHORTFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLESHORTFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLESHORTFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::MethodHandleShortFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/MethodHandleShortFieldAccessorImpl",
...
protected:
	...
	MethodHandleShortFieldAccessorImpl(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_METHODHANDLESHORTFIELDACCESSORIMPL
