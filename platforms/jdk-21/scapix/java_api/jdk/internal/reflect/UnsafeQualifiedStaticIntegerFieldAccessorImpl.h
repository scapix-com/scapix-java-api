...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::reflect { class UnsafeQualifiedStaticIntegerFieldAccessorImpl; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::reflect::UnsafeQualifiedStaticIntegerFieldAccessorImpl>
{
	static constexpr fixed_string class_name = "jdk/internal/reflect/UnsafeQualifiedStaticIntegerFieldAccessorImpl";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::reflect::UnsafeQualifiedStaticFieldAccessorImpl>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL)
#define SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL
...
// private
class jdk::internal::reflect::UnsafeQualifiedStaticIntegerFieldAccessorImpl : public jni::object_base<"jdk/internal/reflect/UnsafeQualifiedStaticIntegerFieldAccessorImpl",
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_REFLECT_UNSAFEQUALIFIEDSTATICINTEGERFIELDACCESSORIMPL
