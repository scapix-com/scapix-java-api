...
namespace scapix::java_api { namespace jdk::internal::jimage { class ImageReader; }}
...
public:
	...
	jboolean verifyLocation(jni::ref<java::lang::String> mn, jni::ref<java::lang::String> rn) { return call_method<"verifyLocation", jboolean>(mn, rn); }
