...
namespace scapix::java_api { namespace jdk::internal::jimage::decompressor { class StringSharingDecompressor; }}
...
public:
	...
	static jni::ref<jdk::internal::jimage::decompressor::StringSharingDecompressor> new_object(jni::ref<java::util::Properties> properties) { return object_base::new_object(properties); }
