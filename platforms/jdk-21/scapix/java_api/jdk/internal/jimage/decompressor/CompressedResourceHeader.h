...
namespace scapix::java_api { namespace jdk::internal::jimage::decompressor { class CompressedResourceHeader; }}
...
public:
	...
	static jni::ref<jdk::internal::jimage::decompressor::CompressedResourceHeader> new_object(jlong compressedSize, jlong uncompressedSize, jint decompressorNameOffset, jint contentOffset, jboolean isTerminal) { return object_base::new_object(compressedSize, uncompressedSize, decompressorNameOffset, contentOffset, isTerminal); }
