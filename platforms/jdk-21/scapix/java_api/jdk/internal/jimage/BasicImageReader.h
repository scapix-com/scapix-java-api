...
namespace scapix::java_api { namespace jdk::internal::jimage { class BasicImageReader; }}
...
public:
	...
	jboolean verifyLocation(jni::ref<java::lang::String> module, jni::ref<java::lang::String> name) { return call_method<"verifyLocation", jboolean>(module, name); }
	jint getLocationIndex(jni::ref<java::lang::String> name) { return call_method<"getLocationIndex", jint>(name); }
