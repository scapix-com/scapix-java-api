...
public:
	...
	static jni::ref<java::lang::Thread> newSystemThread(jni::ref<java::lang::String> name, jni::ref<java::lang::Runnable> target, jlong stackSize, jint p4) { return call_static_method<"newSystemThread", jni::ref<java::lang::Thread>>(name, target, stackSize, p4); }
