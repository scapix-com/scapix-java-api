...
namespace scapix::java_api { namespace jdk::internal::access { class SharedSecrets; }}
...
#include <scapix/java_api/jdk/internal/access/JavaIOPrintStreamAccess.h>
#include <scapix/java_api/jdk/internal/access/JavaIOPrintWriterAccess.h>
...
#include <scapix/java_api/jdk/internal/access/JavaUtilConcurrentFJPAccess.h>
#include <scapix/java_api/jdk/internal/access/JavaUtilConcurrentTLRAccess.h>
...
public:
	...
	static jni::ref<jdk::internal::access::SharedSecrets> new_object() { return object_base::new_object(); }
	...
	static void setJavaUtilConcurrentTLRAccess(jni::ref<jdk::internal::access::JavaUtilConcurrentTLRAccess> access) { return call_static_method<"setJavaUtilConcurrentTLRAccess", void>(access); }
	static jni::ref<jdk::internal::access::JavaUtilConcurrentTLRAccess> getJavaUtilConcurrentTLRAccess() { return call_static_method<"getJavaUtilConcurrentTLRAccess", jni::ref<jdk::internal::access::JavaUtilConcurrentTLRAccess>>(); }
	static void setJavaUtilConcurrentFJPAccess(jni::ref<jdk::internal::access::JavaUtilConcurrentFJPAccess> access) { return call_static_method<"setJavaUtilConcurrentFJPAccess", void>(access); }
	static jni::ref<jdk::internal::access::JavaUtilConcurrentFJPAccess> getJavaUtilConcurrentFJPAccess() { return call_static_method<"getJavaUtilConcurrentFJPAccess", jni::ref<jdk::internal::access::JavaUtilConcurrentFJPAccess>>(); }
	...
	static void setJavaIOCPrintWriterAccess(jni::ref<jdk::internal::access::JavaIOPrintWriterAccess> a) { return call_static_method<"setJavaIOCPrintWriterAccess", void>(a); }
	static jni::ref<jdk::internal::access::JavaIOPrintWriterAccess> getJavaIOPrintWriterAccess() { return call_static_method<"getJavaIOPrintWriterAccess", jni::ref<jdk::internal::access::JavaIOPrintWriterAccess>>(); }
	static void setJavaIOCPrintStreamAccess(jni::ref<jdk::internal::access::JavaIOPrintStreamAccess> a) { return call_static_method<"setJavaIOCPrintStreamAccess", void>(a); }
	static jni::ref<jdk::internal::access::JavaIOPrintStreamAccess> getJavaIOPrintStreamAccess() { return call_static_method<"getJavaIOPrintStreamAccess", jni::ref<jdk::internal::access::JavaIOPrintStreamAccess>>(); }
	...
	static void setJavaTemplateAccess(jni::ref<jdk::internal::access::JavaTemplateAccess> jta) { return call_static_method<"setJavaTemplateAccess", void>(jta); }
	static jni::ref<jdk::internal::access::JavaTemplateAccess> getJavaTemplateAccess() { return call_static_method<"getJavaTemplateAccess", jni::ref<jdk::internal::access::JavaTemplateAccess>>(); }
