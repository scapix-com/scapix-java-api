...
public:
	...
	void ensureNativeAccess(jni::ref<java::lang::Module> p1, jni::ref<java::lang::Class> p2, jni::ref<java::lang::String> p3) { return call_method<"ensureNativeAccess", void>(p1, p2, p3); }
