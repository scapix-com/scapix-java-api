...
namespace scapix::java_api { namespace jdk::internal::icu::text { class NormalizerBase; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::text::NormalizerBase> new_object(jni::ref<java::lang::String> str, jni::ref<jdk::internal::icu::text::NormalizerBase_Mode> mode, jint opt) { return object_base::new_object(str, mode, opt); }
	static jni::ref<jdk::internal::icu::text::NormalizerBase> new_object(jni::ref<java::lang::String> str, jni::ref<jdk::internal::icu::text::NormalizerBase_Mode> mode) { return object_base::new_object(str, mode); }
	static jni::ref<jdk::internal::icu::text::NormalizerBase> new_object(jni::ref<java::text::CharacterIterator> iter, jni::ref<jdk::internal::icu::text::NormalizerBase_Mode> mode, jint opt) { return object_base::new_object(iter, mode, opt); }
	static jni::ref<jdk::internal::icu::text::NormalizerBase> new_object(jni::ref<java::text::CharacterIterator> iter, jni::ref<jdk::internal::icu::text::NormalizerBase_Mode> mode) { return object_base::new_object(iter, mode); }
