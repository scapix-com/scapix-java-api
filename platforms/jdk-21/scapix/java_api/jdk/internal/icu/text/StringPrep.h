...
namespace scapix::java_api { namespace jdk::internal::icu::text { class StringPrep; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::text::StringPrep> new_object(jni::ref<java::io::InputStream> inputStream) { return object_base::new_object(inputStream); }
