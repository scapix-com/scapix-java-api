...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class UnicodeSetStringSpan_OffsetList; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::UnicodeSetStringSpan_OffsetList> new_object() { return object_base::new_object(); }
