...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_ICU_IMPL_NORM2ALLMODES_NOOPNORMALIZER2_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_ICU_IMPL_NORM2ALLMODES_NOOPNORMALIZER2_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::icu::impl { class Norm2AllModes_NoopNormalizer2; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::icu::impl::Norm2AllModes_NoopNormalizer2>
{
	static constexpr fixed_string class_name = "jdk/internal/icu/impl/Norm2AllModes$NoopNormalizer2";
	using base_classes = std::tuple<scapix::java_api::jdk::internal::icu::text::Normalizer2>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ICU_IMPL_NORM2ALLMODES_NOOPNORMALIZER2_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_ICU_IMPL_NORM2ALLMODES_NOOPNORMALIZER2)
#define SCAPIX_JAVA_API_JDK_INTERNAL_ICU_IMPL_NORM2ALLMODES_NOOPNORMALIZER2
...
class jdk::internal::icu::impl::Norm2AllModes_NoopNormalizer2 : public jni::object_base<"jdk/internal/icu/impl/Norm2AllModes$NoopNormalizer2",
	jdk::internal::icu::text::Normalizer2>
{
public:

	static jni::ref<jdk::internal::icu::impl::Norm2AllModes_NoopNormalizer2> new_object() { return base_::new_object(); }
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_ICU_IMPL_NORM2ALLMODES_NOOPNORMALIZER2
