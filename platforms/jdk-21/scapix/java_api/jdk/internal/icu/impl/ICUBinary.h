...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class ICUBinary; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::ICUBinary> new_object() { return object_base::new_object(); }
