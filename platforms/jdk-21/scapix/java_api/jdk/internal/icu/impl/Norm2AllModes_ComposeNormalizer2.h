...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class Norm2AllModes_ComposeNormalizer2; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::Norm2AllModes_ComposeNormalizer2> new_object(jni::ref<jdk::internal::icu::impl::NormalizerImpl> ni, jboolean fcc) { return object_base::new_object(ni, fcc); }
