...
namespace scapix::java_api { namespace jdk::internal::icu::impl { class UnicodeSetStringSpan; }}
...
public:
	...
	static jni::ref<jdk::internal::icu::impl::UnicodeSetStringSpan> new_object(jni::ref<jdk::internal::icu::text::UnicodeSet> set, jni::ref<java::util::ArrayList> setStrings, jint which) { return object_base::new_object(set, setStrings, which); }
