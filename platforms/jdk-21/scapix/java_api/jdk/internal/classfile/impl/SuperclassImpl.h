...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class SuperclassImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SuperclassImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> superclassEntry) { return object_base::new_object(superclassEntry); }
