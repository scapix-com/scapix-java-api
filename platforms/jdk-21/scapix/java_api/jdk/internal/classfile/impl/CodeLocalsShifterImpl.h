...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class CodeLocalsShifterImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::CodeLocalsShifterImpl> new_object(jint fixed) { return object_base::new_object(fixed); }
