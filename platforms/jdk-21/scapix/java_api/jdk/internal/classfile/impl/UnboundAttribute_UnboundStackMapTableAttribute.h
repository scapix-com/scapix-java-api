...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundStackMapTableAttribute; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundStackMapTableAttribute> new_object(jni::ref<java::util::List> entries) { return object_base::new_object(entries); }
