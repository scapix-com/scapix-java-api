...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundAttribute_BoundLineNumberTableAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute_BoundLineNumberTableAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute, scapix::java_api::jdk::internal::classfile::attribute::LineNumberTableAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundLineNumberTableAttribute> new_object(jni::ref<jdk::internal::classfile::ClassReader> cf, jni::ref<jdk::internal::classfile::AttributeMapper> mapper, jint pos) { return object_base::new_object(cf, mapper, pos); }
