...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SplitConstantPool> new_object(jni::ref<jdk::internal::classfile::impl::Options> options) { return object_base::new_object(options); }
	static jni::ref<jdk::internal::classfile::impl::SplitConstantPool> new_object(jni::ref<jdk::internal::classfile::ClassReader> parent) { return object_base::new_object(parent); }
