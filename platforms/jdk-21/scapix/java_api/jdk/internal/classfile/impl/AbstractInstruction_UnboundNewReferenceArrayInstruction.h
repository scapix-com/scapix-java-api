...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction_UnboundNewReferenceArrayInstruction; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundNewReferenceArrayInstruction>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundInstruction, scapix::java_api::jdk::internal::classfile::instruction::NewReferenceArrayInstruction>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundNewReferenceArrayInstruction> new_object(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> componentTypeEntry) { return object_base::new_object(componentTypeEntry); }
