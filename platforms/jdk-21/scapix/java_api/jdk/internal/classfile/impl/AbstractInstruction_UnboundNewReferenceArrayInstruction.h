...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundNewReferenceArrayInstruction> new_object(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> componentTypeEntry) { return base_::new_object(componentTypeEntry); }
