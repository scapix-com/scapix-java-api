...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundInnerClassInfo; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundInnerClassInfo>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::attribute::InnerClassInfo>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundInnerClassInfo> new_object(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> innerClass, jni::ref<java::util::Optional> outerClass, jni::ref<java::util::Optional> innerName, jint flagsMask) { return object_base::new_object(innerClass, outerClass, innerName, flagsMask); }
