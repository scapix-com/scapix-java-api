...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractAttributeMapper> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<jdk::internal::classfile::impl::AbstractAttributeMapper> new_object(jni::ref<java::lang::String> name, jboolean allowMultiple) { return object_base::new_object(name, allowMultiple); }
	static jni::ref<jdk::internal::classfile::impl::AbstractAttributeMapper> new_object(jni::ref<java::lang::String> name, jint majorVersion) { return object_base::new_object(name, majorVersion); }
	static jni::ref<jdk::internal::classfile::impl::AbstractAttributeMapper> new_object(jni::ref<java::lang::String> name, jboolean allowMultiple, jint majorVersion) { return object_base::new_object(name, allowMultiple, majorVersion); }
