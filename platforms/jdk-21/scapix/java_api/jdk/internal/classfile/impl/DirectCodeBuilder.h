...
#include <scapix/java_api/jdk/internal/classfile/instruction/ExceptionCatch.h>
#include <scapix/java_api/jdk/internal/classfile/instruction/LocalVariable.h>
#include <scapix/java_api/jdk/internal/classfile/instruction/LocalVariableType.h>
...
public:
	...
	static jni::ref<jdk::internal::classfile::Attribute> build(jni::ref<jdk::internal::classfile::impl::MethodInfo> methodInfo, jni::ref<java::util::function::Consumer> handler, jni::ref<jdk::internal::classfile::impl::SplitConstantPool> constantPool, jni::ref<jdk::internal::classfile::CodeModel> original) { return call_static_method<"build", jni::ref<jdk::internal::classfile::Attribute>>(methodInfo, handler, constantPool, original); }
	...
	void writeBytecode(jni::ref<jdk::internal::classfile::Opcode> opcode) { return call_method<"writeBytecode", void>(opcode); }
	void writeLocalVar(jni::ref<jdk::internal::classfile::Opcode> opcode, jint localVar) { return call_method<"writeLocalVar", void>(opcode, localVar); }
	void writeIncrement(jint slot, jint val) { return call_method<"writeIncrement", void>(slot, val); }
	void writeBranch(jni::ref<jdk::internal::classfile::Opcode> op, jni::ref<jdk::internal::classfile::Label> target) { return call_method<"writeBranch", void>(op, target); }
	void writeLookupSwitch(jni::ref<jdk::internal::classfile::Label> defaultTarget, jni::ref<java::util::List> cases) { return call_method<"writeLookupSwitch", void>(defaultTarget, cases); }
	void writeTableSwitch(jint low, jint high, jni::ref<jdk::internal::classfile::Label> defaultTarget, jni::ref<java::util::List> cases) { return call_method<"writeTableSwitch", void>(low, high, defaultTarget, cases); }
	void writeFieldAccess(jni::ref<jdk::internal::classfile::Opcode> opcode, jni::ref<jdk::internal::classfile::constantpool::FieldRefEntry> ref) { return call_method<"writeFieldAccess", void>(opcode, ref); }
	void writeInvokeNormal(jni::ref<jdk::internal::classfile::Opcode> opcode, jni::ref<jdk::internal::classfile::constantpool::MemberRefEntry> ref) { return call_method<"writeInvokeNormal", void>(opcode, ref); }
	void writeInvokeInterface(jni::ref<jdk::internal::classfile::Opcode> opcode, jni::ref<jdk::internal::classfile::constantpool::InterfaceMethodRefEntry> ref, jint count) { return call_method<"writeInvokeInterface", void>(opcode, ref, count); }
	void writeInvokeDynamic(jni::ref<jdk::internal::classfile::constantpool::InvokeDynamicEntry> ref) { return call_method<"writeInvokeDynamic", void>(ref); }
	void writeNewObject(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> type) { return call_method<"writeNewObject", void>(type); }
	void writeNewPrimitiveArray(jint newArrayCode) { return call_method<"writeNewPrimitiveArray", void>(newArrayCode); }
	void writeNewReferenceArray(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> type) { return call_method<"writeNewReferenceArray", void>(type); }
	void writeNewMultidimensionalArray(jint dimensions, jni::ref<jdk::internal::classfile::constantpool::ClassEntry> type) { return call_method<"writeNewMultidimensionalArray", void>(dimensions, type); }
	void writeTypeCheck(jni::ref<jdk::internal::classfile::Opcode> opcode, jni::ref<jdk::internal::classfile::constantpool::ClassEntry> type) { return call_method<"writeTypeCheck", void>(opcode, type); }
	void writeArgumentConstant(jni::ref<jdk::internal::classfile::Opcode> opcode, jint value) { return call_method<"writeArgumentConstant", void>(opcode, value); }
	void writeLoadConstant(jni::ref<jdk::internal::classfile::Opcode> opcode, jni::ref<jdk::internal::classfile::constantpool::LoadableConstantEntry> value) { return call_method<"writeLoadConstant", void>(opcode, value); }
	...
	void setLabelTarget(jni::ref<jdk::internal::classfile::Label> label) { return call_method<"setLabelTarget", void>(label); }
	void setLabelTarget(jni::ref<jdk::internal::classfile::Label> label, jint bci) { return call_method<"setLabelTarget", void>(label, bci); }
	void addCharacterRange(jni::ref<jdk::internal::classfile::instruction::CharacterRange> element) { return call_method<"addCharacterRange", void>(element); }
	void addHandler(jni::ref<jdk::internal::classfile::instruction::ExceptionCatch> element) { return call_method<"addHandler", void>(element); }
	void addLocalVariable(jni::ref<jdk::internal::classfile::instruction::LocalVariable> element) { return call_method<"addLocalVariable", void>(element); }
	void addLocalVariableType(jni::ref<jdk::internal::classfile::instruction::LocalVariableType> element) { return call_method<"addLocalVariableType", void>(element); }
