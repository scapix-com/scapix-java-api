...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ChainedMethodBuilder; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ChainedMethodBuilder> new_object(jni::ref<jdk::internal::classfile::MethodBuilder> downstream, jni::ref<java::util::function::Consumer> consumer) { return object_base::new_object(downstream, consumer); }
