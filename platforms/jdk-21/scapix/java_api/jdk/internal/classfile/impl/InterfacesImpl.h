...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class InterfacesImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::InterfacesImpl> new_object(jni::ref<java::util::List> interfaces) { return object_base::new_object(interfaces); }
