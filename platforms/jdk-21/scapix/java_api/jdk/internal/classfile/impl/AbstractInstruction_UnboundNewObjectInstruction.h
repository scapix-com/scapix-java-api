...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundNewObjectInstruction> new_object(jni::ref<jdk::internal::classfile::constantpool::ClassEntry> classEntry) { return object_base::new_object(classEntry); }
