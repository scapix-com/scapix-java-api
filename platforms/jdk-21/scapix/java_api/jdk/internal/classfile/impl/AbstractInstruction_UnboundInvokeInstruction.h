...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundInvokeInstruction> new_object(jni::ref<jdk::internal::classfile::Opcode> op, jni::ref<jdk::internal::classfile::constantpool::MemberRefEntry> methodEntry) { return object_base::new_object(op, methodEntry); }
