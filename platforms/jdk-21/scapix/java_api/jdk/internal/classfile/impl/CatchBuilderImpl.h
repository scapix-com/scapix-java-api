...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::CatchBuilderImpl> new_object(jni::ref<jdk::internal::classfile::CodeBuilder> b, jni::ref<jdk::internal::classfile::impl::BlockCodeBuilderImpl> tryBlock, jni::ref<jdk::internal::classfile::Label> tryCatchEnd) { return object_base::new_object(b, tryBlock, tryCatchEnd); }
