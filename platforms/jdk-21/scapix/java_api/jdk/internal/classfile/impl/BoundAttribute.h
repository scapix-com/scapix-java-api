...
public:
	...
	static jni::ref<java::util::List> readAttributes(jni::ref<jdk::internal::classfile::AttributedElement> enclosing, jni::ref<jdk::internal::classfile::ClassReader> reader, jint pos, jni::ref<java::util::function::Function> customAttributes) { return call_static_method<"readAttributes", jni::ref<java::util::List>>(enclosing, reader, pos, customAttributes); }
