...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::CodeStackTrackerImpl> new_object(jni::ref<jni::array<jdk::internal::classfile::TypeKind>> initialStack) { return object_base::new_object(initialStack); }
