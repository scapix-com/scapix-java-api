...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TransformImpl_ChainedMethodTransform> new_object(jni::ref<jdk::internal::classfile::MethodTransform> t, jni::ref<jdk::internal::classfile::MethodTransform> next) { return object_base::new_object(t, next); }
