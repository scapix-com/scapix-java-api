...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class Options; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::Options> new_object(jni::ref<java::util::Collection> options) { return object_base::new_object(options); }
