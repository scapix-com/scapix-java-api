...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPoolEntry_MethodHandleEntryImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_MethodHandleEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry, scapix::java_api::jdk::internal::classfile::constantpool::MethodHandleEntry>;
};
...
public:
	...
	jni::ref<jdk::internal::classfile::constantpool::MethodHandleEntry> clone(jni::ref<jdk::internal::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<jdk::internal::classfile::constantpool::MethodHandleEntry>>(cp); }
