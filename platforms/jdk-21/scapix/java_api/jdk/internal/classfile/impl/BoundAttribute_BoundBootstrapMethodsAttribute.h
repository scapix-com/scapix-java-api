...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundBootstrapMethodsAttribute> new_object(jni::ref<jdk::internal::classfile::ClassReader> reader, jni::ref<jdk::internal::classfile::AttributeMapper> mapper, jint pos) { return base_::new_object(reader, mapper, pos); }
