...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundAttribute_BoundBootstrapMethodsAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute_BoundBootstrapMethodsAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute, scapix::java_api::jdk::internal::classfile::attribute::BootstrapMethodsAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundBootstrapMethodsAttribute> new_object(jni::ref<jdk::internal::classfile::ClassReader> reader, jni::ref<jdk::internal::classfile::AttributeMapper> mapper, jint pos) { return object_base::new_object(reader, mapper, pos); }
