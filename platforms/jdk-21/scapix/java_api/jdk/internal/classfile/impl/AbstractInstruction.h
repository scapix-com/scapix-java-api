...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction> new_object(jni::ref<jdk::internal::classfile::Opcode> op, jint size) { return object_base::new_object(op, size); }
