...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TransformImpl_ClassMethodTransform> new_object(jni::ref<jdk::internal::classfile::MethodTransform> transform, jni::ref<java::util::function::Predicate> filter) { return object_base::new_object(transform, filter); }
