...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::DirectMethodBuilder>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractDirectBuilder, scapix::java_api::jdk::internal::classfile::impl::TerminalMethodBuilder, scapix::java_api::jdk::internal::classfile::WritableElement, scapix::java_api::jdk::internal::classfile::impl::MethodInfo>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::DirectMethodBuilder> new_object(jni::ref<jdk::internal::classfile::impl::SplitConstantPool> constantPool, jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> nameInfo, jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> typeInfo, jint flags, jni::ref<jdk::internal::classfile::MethodModel> original) { return object_base::new_object(constantPool, nameInfo, typeInfo, flags, original); }
