...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundTypeAnnotation; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundTypeAnnotation>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::TypeAnnotation>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundTypeAnnotation> new_object(jni::ref<jdk::internal::classfile::TypeAnnotation_TargetInfo> targetInfo, jni::ref<java::util::List> targetPath, jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> className, jni::ref<java::util::List> elements) { return object_base::new_object(targetInfo, targetPath, className, elements); }
