...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundMonitorInstruction> new_object(jni::ref<jdk::internal::classfile::Opcode> op) { return base_::new_object(op); }
