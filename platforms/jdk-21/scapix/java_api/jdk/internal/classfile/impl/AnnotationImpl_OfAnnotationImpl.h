...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfAnnotationImpl> new_object(jni::ref<jdk::internal::classfile::Annotation> annotation) { return object_base::new_object(annotation); }
