...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassHierarchyImpl_StaticClassHierarchyResolver; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassHierarchyImpl_StaticClassHierarchyResolver> new_object(jni::ref<java::util::Collection> interfaceNames, jni::ref<java::util::Map> classToSuperClass) { return object_base::new_object(interfaceNames, classToSuperClass); }
