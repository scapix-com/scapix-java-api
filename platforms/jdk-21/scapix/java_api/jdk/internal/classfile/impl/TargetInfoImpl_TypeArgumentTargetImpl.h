...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TargetInfoImpl_TypeArgumentTargetImpl> new_object(jni::ref<jdk::internal::classfile::TypeAnnotation_TargetType> targetType, jni::ref<jdk::internal::classfile::Label> target, jint typeArgumentIndex) { return base_::new_object(targetType, target, typeArgumentIndex); }
