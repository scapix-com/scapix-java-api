...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class TargetInfoImpl_TypeArgumentTargetImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::TargetInfoImpl_TypeArgumentTargetImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::TypeAnnotation_TypeArgumentTarget>;
};
...
class jdk::internal::classfile::impl::TargetInfoImpl_TypeArgumentTargetImpl : public jni::object_base<"jdk/internal/classfile/impl/TargetInfoImpl$TypeArgumentTargetImpl",
	java::lang::Record,
	jdk::internal::classfile::TypeAnnotation_TypeArgumentTarget>
{
public:

	static jni::ref<jdk::internal::classfile::impl::TargetInfoImpl_TypeArgumentTargetImpl> new_object(jni::ref<jdk::internal::classfile::TypeAnnotation_TargetType> targetType, jni::ref<jdk::internal::classfile::Label> target, jint typeArgumentIndex) { return object_base::new_object(targetType, target, typeArgumentIndex); }
