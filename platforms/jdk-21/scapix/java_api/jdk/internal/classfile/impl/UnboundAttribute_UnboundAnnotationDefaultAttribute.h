...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundAnnotationDefaultAttribute> new_object(jni::ref<jdk::internal::classfile::AnnotationValue> annotationDefault) { return object_base::new_object(annotationDefault); }
