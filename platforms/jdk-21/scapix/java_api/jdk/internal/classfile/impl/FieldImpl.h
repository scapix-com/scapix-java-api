...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::FieldImpl> new_object(jni::ref<jdk::internal::classfile::ClassReader> reader, jint startPos, jint endPos, jint attributesPos) { return object_base::new_object(reader, startPos, endPos, attributesPos); }
