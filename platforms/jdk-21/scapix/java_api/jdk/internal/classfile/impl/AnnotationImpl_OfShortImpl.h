...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfShortImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::IntegerEntry> constant) { return object_base::new_object(constant); }
