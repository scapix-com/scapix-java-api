...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> className, jni::ref<java::util::List> elems) { return object_base::new_object(className, elems); }
