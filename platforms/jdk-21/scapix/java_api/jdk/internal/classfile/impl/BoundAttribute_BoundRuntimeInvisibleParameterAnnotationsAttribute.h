...
#include <scapix/java_api/jdk/internal/classfile/attribute/RuntimeInvisibleParameterAnnotationsAttribute.h>
...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundAttribute_BoundRuntimeInvisibleParameterAnnotationsAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute_BoundRuntimeInvisibleParameterAnnotationsAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::BoundAttribute, scapix::java_api::jdk::internal::classfile::attribute::RuntimeInvisibleParameterAnnotationsAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundRuntimeInvisibleParameterAnnotationsAttribute> new_object(jni::ref<jdk::internal::classfile::ClassReader> cf, jni::ref<jdk::internal::classfile::AttributeMapper> mapper, jint pos) { return object_base::new_object(cf, mapper, pos); }
