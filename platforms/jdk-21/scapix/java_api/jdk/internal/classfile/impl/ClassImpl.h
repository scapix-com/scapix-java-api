...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassImpl> new_object(jni::ref<jni::array<jbyte>> cfbytes, jni::ref<java::util::Collection> options) { return base_::new_object(cfbytes, options); }
