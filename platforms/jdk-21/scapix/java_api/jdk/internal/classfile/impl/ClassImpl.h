...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::ClassImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::jdk::internal::classfile::ClassModel>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassImpl> new_object(jni::ref<jni::array<jbyte>> cfbytes, jni::ref<java::util::Collection> options) { return object_base::new_object(cfbytes, options); }
	...
	jni::ref<jni::array<jbyte>> transform(jni::ref<jdk::internal::classfile::ClassTransform> transform) { return call_method<"transform", jni::ref<jni::array<jbyte>>>(transform); }
