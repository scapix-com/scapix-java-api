...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class TargetInfoImpl_TypeParameterTargetImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::TargetInfoImpl_TypeParameterTargetImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::TypeAnnotation_TypeParameterTarget>;
};
...
class jdk::internal::classfile::impl::TargetInfoImpl_TypeParameterTargetImpl : public jni::object_base<"jdk/internal/classfile/impl/TargetInfoImpl$TypeParameterTargetImpl",
	java::lang::Record,
	jdk::internal::classfile::TypeAnnotation_TypeParameterTarget>
{
public:

	static jni::ref<jdk::internal::classfile::impl::TargetInfoImpl_TypeParameterTargetImpl> new_object(jni::ref<jdk::internal::classfile::TypeAnnotation_TargetType> targetType, jint typeParameterIndex) { return object_base::new_object(targetType, typeParameterIndex); }
