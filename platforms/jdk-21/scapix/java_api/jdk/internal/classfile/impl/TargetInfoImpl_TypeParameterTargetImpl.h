...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::TargetInfoImpl_TypeParameterTargetImpl> new_object(jni::ref<jdk::internal::classfile::TypeAnnotation_TargetType> targetType, jint typeParameterIndex) { return base_::new_object(targetType, typeParameterIndex); }
