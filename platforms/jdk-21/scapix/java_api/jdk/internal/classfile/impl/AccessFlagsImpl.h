...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AccessFlagsImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AccessFlagsImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::jdk::internal::classfile::AccessFlags>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AccessFlagsImpl> new_object(jni::ref<java::lang::reflect::AccessFlag_Location> location, jni::ref<jni::array<java::lang::reflect::AccessFlag>> flags) { return object_base::new_object(location, flags); }
	static jni::ref<jdk::internal::classfile::impl::AccessFlagsImpl> new_object(jni::ref<java::lang::reflect::AccessFlag_Location> location, jint mask) { return object_base::new_object(location, mask); }
