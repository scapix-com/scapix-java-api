...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_TypeArgImpl> new_object(jni::ref<jdk::internal::classfile::Signature_TypeArg_WildcardIndicator> wildcardIndicator, jni::ref<java::util::Optional> boundType) { return object_base::new_object(wildcardIndicator, boundType); }
