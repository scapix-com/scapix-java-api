...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_ClassSignatureImpl> new_object(jni::ref<java::util::List> typeParameters, jni::ref<jdk::internal::classfile::Signature_RefTypeSig> superclassSignature, jni::ref<java::util::List> superinterfaceSignatures) { return object_base::new_object(typeParameters, superclassSignature, superinterfaceSignatures); }
