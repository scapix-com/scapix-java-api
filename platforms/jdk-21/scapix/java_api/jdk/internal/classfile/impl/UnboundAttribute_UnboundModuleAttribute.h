...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundModuleAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute, scapix::java_api::jdk::internal::classfile::attribute::ModuleAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleAttribute> new_object(jni::ref<jdk::internal::classfile::constantpool::ModuleEntry> moduleName, jint moduleFlags, jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> moduleVersion, jni::ref<java::util::Collection> requires_, jni::ref<java::util::Collection> exports, jni::ref<java::util::Collection> opens, jni::ref<java::util::Collection> uses, jni::ref<java::util::Collection> provides) { return object_base::new_object(moduleName, moduleFlags, moduleVersion, requires_, exports, opens, uses, provides); }
