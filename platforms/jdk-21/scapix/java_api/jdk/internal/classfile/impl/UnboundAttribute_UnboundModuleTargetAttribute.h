...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleTargetAttribute> new_object(jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> moduleTarget) { return base_::new_object(moduleTarget); }
