...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundModuleTargetAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleTargetAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute, scapix::java_api::jdk::internal::classfile::attribute::ModuleTargetAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleTargetAttribute> new_object(jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> moduleTarget) { return object_base::new_object(moduleTarget); }
