...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::DirectClassBuilder> new_object(jni::ref<jdk::internal::classfile::impl::SplitConstantPool> constantPool, jni::ref<jdk::internal::classfile::constantpool::ClassEntry> thisClass) { return object_base::new_object(constantPool, thisClass); }
