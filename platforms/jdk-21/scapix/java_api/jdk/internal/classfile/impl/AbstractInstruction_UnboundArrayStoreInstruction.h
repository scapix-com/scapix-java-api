...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundArrayStoreInstruction> new_object(jni::ref<jdk::internal::classfile::Opcode> op) { return object_base::new_object(op); }
