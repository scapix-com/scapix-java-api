...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl> new_object() { return object_base::new_object(); }
	jni::ref<jdk::internal::classfile::ClassSignature> parseClassSignature(jni::ref<java::lang::String> signature) { return call_method<"parseClassSignature", jni::ref<jdk::internal::classfile::ClassSignature>>(signature); }
	jni::ref<jdk::internal::classfile::MethodSignature> parseMethodSignature(jni::ref<java::lang::String> signature) { return call_method<"parseMethodSignature", jni::ref<jdk::internal::classfile::MethodSignature>>(signature); }
	jni::ref<jdk::internal::classfile::Signature> parseSignature(jni::ref<java::lang::String> signature) { return call_method<"parseSignature", jni::ref<jdk::internal::classfile::Signature>>(signature); }
