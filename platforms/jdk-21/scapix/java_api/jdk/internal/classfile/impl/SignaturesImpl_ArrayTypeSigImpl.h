...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class SignaturesImpl_ArrayTypeSigImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_ArrayTypeSigImpl> new_object(jint arrayDepth, jni::ref<jdk::internal::classfile::Signature> elemType) { return object_base::new_object(arrayDepth, elemType); }
