...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class SignaturesImpl_ClassTypeSigImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::SignaturesImpl_ClassTypeSigImpl> new_object(jni::ref<java::util::Optional> outerType, jni::ref<java::lang::String> className, jni::ref<java::util::List> typeArgs) { return object_base::new_object(outerType, className, typeArgs); }
