...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ChainedClassBuilder; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ChainedClassBuilder> new_object(jni::ref<jdk::internal::classfile::ClassBuilder> downstream, jni::ref<java::util::function::Consumer> consumer) { return object_base::new_object(downstream, consumer); }
