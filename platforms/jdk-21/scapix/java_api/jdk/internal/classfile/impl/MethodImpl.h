...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::MethodImpl> new_object(jni::ref<jdk::internal::classfile::ClassReader> reader, jint startPos, jint endPos, jint attrStart) { return object_base::new_object(reader, startPos, endPos, attrStart); }
