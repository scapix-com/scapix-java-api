...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundCharacterRangeInfo; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundCharacterRangeInfo> new_object(jint startPc, jint endPc, jint characterRangeStart, jint characterRangeEnd, jint flags) { return object_base::new_object(startPc, endPc, characterRangeStart, characterRangeEnd, flags); }
