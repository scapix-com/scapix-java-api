...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction_UnboundLookupSwitchInstruction; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundLookupSwitchInstruction>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundInstruction, scapix::java_api::jdk::internal::classfile::instruction::LookupSwitchInstruction>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundLookupSwitchInstruction> new_object(jni::ref<jdk::internal::classfile::Label> defaultTarget, jni::ref<java::util::List> cases) { return object_base::new_object(defaultTarget, cases); }
