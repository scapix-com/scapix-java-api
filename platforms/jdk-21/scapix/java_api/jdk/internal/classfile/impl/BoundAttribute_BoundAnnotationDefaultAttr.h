...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundAttribute_BoundAnnotationDefaultAttr> new_object(jni::ref<jdk::internal::classfile::ClassReader> cf, jni::ref<jdk::internal::classfile::AttributeMapper> mapper, jint pos) { return object_base::new_object(cf, mapper, pos); }
