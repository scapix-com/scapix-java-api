...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPseudoInstruction_ExceptionCatchImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction_ExceptionCatchImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction, scapix::java_api::jdk::internal::classfile::instruction::ExceptionCatch>;
};
...
public:
	...
	jni::ref<jdk::internal::classfile::constantpool::ClassEntry> catchTypeEntry() { return get_field<"catchTypeEntry", jni::ref<jdk::internal::classfile::constantpool::ClassEntry>>(); }
	jni::ref<jdk::internal::classfile::Label> handler_() { return get_field<"handler", jni::ref<jdk::internal::classfile::Label>>(); }
	jni::ref<jdk::internal::classfile::Label> tryStart_() { return get_field<"tryStart", jni::ref<jdk::internal::classfile::Label>>(); }
	jni::ref<jdk::internal::classfile::Label> tryEnd_() { return get_field<"tryEnd", jni::ref<jdk::internal::classfile::Label>>(); }

	static jni::ref<jdk::internal::classfile::impl::AbstractPseudoInstruction_ExceptionCatchImpl> new_object(jni::ref<jdk::internal::classfile::Label> handler, jni::ref<jdk::internal::classfile::Label> tryStart, jni::ref<jdk::internal::classfile::Label> tryEnd, jni::ref<jdk::internal::classfile::constantpool::ClassEntry> catchTypeEntry) { return object_base::new_object(handler, tryStart, tryEnd, catchTypeEntry); }
	static jni::ref<jdk::internal::classfile::impl::AbstractPseudoInstruction_ExceptionCatchImpl> new_object(jni::ref<jdk::internal::classfile::Label> handler, jni::ref<jdk::internal::classfile::Label> tryStart, jni::ref<jdk::internal::classfile::Label> tryEnd, jni::ref<java::util::Optional> catchTypeEntry) { return object_base::new_object(handler, tryStart, tryEnd, catchTypeEntry); }
