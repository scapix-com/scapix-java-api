...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfFloatImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::FloatEntry> constant) { return object_base::new_object(constant); }
