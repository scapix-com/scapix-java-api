...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction_UnboundIncrementInstruction; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundIncrementInstruction>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractInstruction_UnboundInstruction, scapix::java_api::jdk::internal::classfile::instruction::IncrementInstruction>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundIncrementInstruction> new_object(jint slot, jint constant) { return object_base::new_object(slot, constant); }
