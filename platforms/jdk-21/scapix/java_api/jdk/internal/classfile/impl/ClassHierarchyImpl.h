...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class ClassHierarchyImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::ClassHierarchyResolver> DEFAULT_RESOLVER() { return get_static_field<"DEFAULT_RESOLVER", jni::ref<jdk::internal::classfile::ClassHierarchyResolver>>(); }

	static jni::ref<jdk::internal::classfile::impl::ClassHierarchyImpl> new_object(jni::ref<jdk::internal::classfile::ClassHierarchyResolver> classHierarchyResolver) { return object_base::new_object(classHierarchyResolver); }
