...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ClassHierarchyImpl> new_object(jni::ref<jdk::internal::classfile::ClassHierarchyResolver> classHierarchyResolver) { return base_::new_object(classHierarchyResolver); }
