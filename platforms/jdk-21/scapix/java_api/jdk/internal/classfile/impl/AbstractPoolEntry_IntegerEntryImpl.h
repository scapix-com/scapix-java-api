...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_IntegerEntryImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractPoolEntry_PrimitiveEntry, scapix::java_api::jdk::internal::classfile::constantpool::IntegerEntry>;
};
...
public:
	...
	jni::ref<jdk::internal::classfile::constantpool::IntegerEntry> clone(jni::ref<jdk::internal::classfile::constantpool::ConstantPoolBuilder> cp) { return call_method<"clone", jni::ref<jdk::internal::classfile::constantpool::IntegerEntry>>(cp); }
