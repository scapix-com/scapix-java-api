...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::ModuleAttributeBuilderImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::ModuleEntry> moduleName) { return object_base::new_object(moduleName); }
