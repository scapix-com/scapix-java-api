...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BlockCodeBuilderImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BlockCodeBuilderImpl> new_object(jni::ref<jdk::internal::classfile::CodeBuilder> parent, jni::ref<jdk::internal::classfile::Label> breakLabel) { return object_base::new_object(parent, breakLabel); }
