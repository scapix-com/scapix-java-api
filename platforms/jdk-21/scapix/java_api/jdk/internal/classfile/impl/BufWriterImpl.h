...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BufWriterImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::ConstantPoolBuilder> constantPool) { return object_base::new_object(constantPool); }
	static jni::ref<jdk::internal::classfile::impl::BufWriterImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::ConstantPoolBuilder> constantPool, jint initialSize) { return object_base::new_object(constantPool, initialSize); }
	static jni::ref<jdk::internal::classfile::impl::BufWriterImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::ConstantPoolBuilder> constantPool, jint initialSize, jni::ref<jdk::internal::classfile::constantpool::ClassEntry> thisClass, jint majorVersion) { return object_base::new_object(constantPool, initialSize, thisClass, majorVersion); }
