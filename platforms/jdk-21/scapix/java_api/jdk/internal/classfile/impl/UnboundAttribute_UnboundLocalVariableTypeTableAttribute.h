...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundLocalVariableTypeTableAttribute; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundLocalVariableTypeTableAttribute> new_object(jni::ref<java::util::List> locals) { return object_base::new_object(locals); }
