...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AnnotationImpl_OfStringImpl> new_object(jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> constant) { return object_base::new_object(constant); }
