...
#include <scapix/java_api/jdk/internal/classfile/attribute/StackMapFrameInfo.h>
...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class StackMapDecoder_StackMapFrameImpl; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::StackMapDecoder_StackMapFrameImpl>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Record, scapix::java_api::jdk::internal::classfile::attribute::StackMapFrameInfo>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::StackMapDecoder_StackMapFrameImpl> new_object(jint frameType, jni::ref<jdk::internal::classfile::Label> target, jni::ref<java::util::List> locals, jni::ref<java::util::List> stack) { return object_base::new_object(frameType, target, locals, stack); }
