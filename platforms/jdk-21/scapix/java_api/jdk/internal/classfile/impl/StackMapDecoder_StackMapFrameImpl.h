...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::StackMapDecoder_StackMapFrameImpl> new_object(jint frameType, jni::ref<jdk::internal::classfile::Label> target, jni::ref<java::util::List> locals, jni::ref<java::util::List> stack) { return base_::new_object(frameType, target, locals, stack); }
