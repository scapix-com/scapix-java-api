...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModuleOpenInfo> new_object(jni::ref<jdk::internal::classfile::constantpool::PackageEntry> openedPackage, jint opensFlagsMask, jni::ref<java::util::List> opensTo) { return object_base::new_object(openedPackage, opensFlagsMask, opensTo); }
