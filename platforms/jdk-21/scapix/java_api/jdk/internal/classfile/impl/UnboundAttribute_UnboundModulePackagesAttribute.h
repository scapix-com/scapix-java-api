...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundModulePackagesAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundModulePackagesAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute, scapix::java_api::jdk::internal::classfile::attribute::ModulePackagesAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundModulePackagesAttribute> new_object(jni::ref<java::util::Collection> packages) { return object_base::new_object(packages); }
