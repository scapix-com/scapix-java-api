...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundRecordComponentInfo> new_object(jni::ref<jdk::internal::classfile::ClassReader> reader, jint startPos) { return base_::new_object(reader, startPos); }
