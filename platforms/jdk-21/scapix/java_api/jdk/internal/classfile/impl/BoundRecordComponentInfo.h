...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BoundRecordComponentInfo; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::BoundRecordComponentInfo>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::jdk::internal::classfile::attribute::RecordComponentInfo>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BoundRecordComponentInfo> new_object(jni::ref<jdk::internal::classfile::ClassReader> reader, jint startPos) { return object_base::new_object(reader, startPos); }
