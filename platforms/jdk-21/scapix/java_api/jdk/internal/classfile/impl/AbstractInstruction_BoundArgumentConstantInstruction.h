...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_BoundArgumentConstantInstruction> new_object(jni::ref<jdk::internal::classfile::Opcode> op, jni::ref<jdk::internal::classfile::impl::CodeImpl> code, jint pos) { return object_base::new_object(op, code, pos); }
