...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_AdHocAttribute> new_object(jni::ref<jdk::internal::classfile::AttributeMapper> mapper) { return base_::new_object(mapper); }
