...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_AdHocAttribute> new_object(jni::ref<jdk::internal::classfile::AttributeMapper> mapper) { return object_base::new_object(mapper); }
	void writeBody(jni::ref<jdk::internal::classfile::BufWriter> p1) { return call_method<"writeBody", void>(p1); }
