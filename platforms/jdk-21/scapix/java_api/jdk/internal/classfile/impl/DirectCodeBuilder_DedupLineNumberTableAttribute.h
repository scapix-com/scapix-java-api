...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::DirectCodeBuilder_DedupLineNumberTableAttribute> new_object(jni::ref<jdk::internal::classfile::constantpool::ConstantPoolBuilder> constantPool) { return object_base::new_object(constantPool); }
