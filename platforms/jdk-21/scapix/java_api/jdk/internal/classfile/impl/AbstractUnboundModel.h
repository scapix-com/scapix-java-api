...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractUnboundModel; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractUnboundModel>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::jdk::internal::classfile::CompoundElement, scapix::java_api::jdk::internal::classfile::AttributedElement>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractUnboundModel> new_object(jni::ref<java::util::List> elements) { return object_base::new_object(elements); }
