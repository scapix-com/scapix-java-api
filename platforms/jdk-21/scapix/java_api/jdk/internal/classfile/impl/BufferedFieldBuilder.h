...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class BufferedFieldBuilder; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::BufferedFieldBuilder> new_object(jni::ref<jdk::internal::classfile::impl::SplitConstantPool> constantPool, jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> name, jni::ref<jdk::internal::classfile::constantpool::Utf8Entry> type, jni::ref<jdk::internal::classfile::FieldModel> original) { return object_base::new_object(constantPool, name, type, original); }
	...
	jni::ref<jdk::internal::classfile::FieldModel> toModel() { return call_method<"toModel", jni::ref<jdk::internal::classfile::FieldModel>>(); }
