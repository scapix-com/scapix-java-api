...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractInstruction_UnboundOperatorInstruction; }}
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractInstruction_UnboundOperatorInstruction> new_object(jni::ref<jdk::internal::classfile::Opcode> op) { return object_base::new_object(op); }
