...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class UnboundAttribute_UnboundRuntimeInvisibleParameterAnnotationsAttribute; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute_UnboundRuntimeInvisibleParameterAnnotationsAttribute>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::UnboundAttribute, scapix::java_api::jdk::internal::classfile::attribute::RuntimeInvisibleParameterAnnotationsAttribute>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::UnboundAttribute_UnboundRuntimeInvisibleParameterAnnotationsAttribute> new_object(jni::ref<java::util::List> elements) { return object_base::new_object(elements); }
