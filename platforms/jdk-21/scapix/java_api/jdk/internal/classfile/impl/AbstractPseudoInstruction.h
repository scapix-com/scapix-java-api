...
namespace scapix::java_api { namespace jdk::internal::classfile::impl { class AbstractPseudoInstruction; }}
...
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::classfile::impl::AbstractPseudoInstruction>
{
	...
	using base_classes = std::tuple<scapix::java_api::jdk::internal::classfile::impl::AbstractElement, scapix::java_api::jdk::internal::classfile::PseudoInstruction>;
};
...
public:
	...
	static jni::ref<jdk::internal::classfile::impl::AbstractPseudoInstruction> new_object() { return object_base::new_object(); }
