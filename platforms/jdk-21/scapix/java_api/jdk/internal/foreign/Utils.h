...
public:
	...
	static void copy(jni::ref<java::lang::foreign::MemorySegment> addr, jni::ref<jni::array<jbyte>> bytes) { return call_static_method<"copy", void>(addr, bytes); }
	static jni::ref<java::lang::foreign::MemorySegment> toCString(jni::ref<jni::array<jbyte>> bytes, jni::ref<java::lang::foreign::SegmentAllocator> allocator) { return call_static_method<"toCString", jni::ref<java::lang::foreign::MemorySegment>>(bytes, allocator); }
