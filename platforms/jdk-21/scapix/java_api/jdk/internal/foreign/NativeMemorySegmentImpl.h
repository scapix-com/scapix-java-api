...
namespace scapix::java_api { namespace jdk::internal::foreign { class NativeMemorySegmentImpl; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::NativeMemorySegmentImpl> new_object() { return object_base::new_object(); }
	...
	static jni::ref<java::lang::foreign::MemorySegment> makeNativeSegment(jlong byteSize, jlong byteAlignment, jni::ref<jdk::internal::foreign::MemorySessionImpl> sessionImpl) { return call_static_method<"makeNativeSegment", jni::ref<java::lang::foreign::MemorySegment>>(byteSize, byteAlignment, sessionImpl); }
	static jni::ref<java::lang::foreign::MemorySegment> makeNativeSegmentUnchecked(jlong min, jlong byteSize, jni::ref<jdk::internal::foreign::MemorySessionImpl> sessionImpl, jni::ref<java::lang::Runnable> action) { return call_static_method<"makeNativeSegmentUnchecked", jni::ref<java::lang::foreign::MemorySegment>>(min, byteSize, sessionImpl, action); }
	static jni::ref<java::lang::foreign::MemorySegment> makeNativeSegmentUnchecked(jlong min, jlong byteSize, jni::ref<jdk::internal::foreign::MemorySessionImpl> sessionImpl) { return call_static_method<"makeNativeSegmentUnchecked", jni::ref<java::lang::foreign::MemorySegment>>(min, byteSize, sessionImpl); }
	static jni::ref<java::lang::foreign::MemorySegment> makeNativeSegmentUnchecked(jlong min, jlong byteSize) { return call_static_method<"makeNativeSegmentUnchecked", jni::ref<java::lang::foreign::MemorySegment>>(min, byteSize); }
