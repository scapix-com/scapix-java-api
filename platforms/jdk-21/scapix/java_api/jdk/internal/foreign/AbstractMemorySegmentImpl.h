...
public:
	...
	jni::ref<java::lang::foreign::MemorySegment> reinterpretInternal(jni::ref<java::lang::Class> callerClass, jlong newSize, jni::ref<java::lang::foreign::MemorySegment_Scope> scope, jni::ref<java::util::function::Consumer> cleanup) { return call_method<"reinterpretInternal", jni::ref<java::lang::foreign::MemorySegment>>(callerClass, newSize, scope, cleanup); }
