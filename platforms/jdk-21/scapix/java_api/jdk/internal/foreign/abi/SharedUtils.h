...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class SharedUtils; }}
...
#include <scapix/java_api/jdk/internal/foreign/abi/SharedUtils_SimpleVaArg.h>
...
public:
	...
	using SimpleVaArg = SharedUtils_SimpleVaArg;
	...
	static jlong alignUp(jlong addr, jlong alignment) { return call_static_method<"alignUp", jlong>(addr, alignment); }
	...
	static jni::ref<java::lang::Class> primitiveCarrierForSize(jlong size, jboolean useFloat) { return call_static_method<"primitiveCarrierForSize", jni::ref<java::lang::Class>>(size, useFloat); }
	static jni::ref<java::lang::foreign::ValueLayout> primitiveLayoutForSize(jlong size, jboolean useFloat) { return call_static_method<"primitiveLayoutForSize", jni::ref<java::lang::foreign::ValueLayout>>(size, useFloat); }
	...
	static jni::ref<java::lang::String> toJavaStringInternal(jni::ref<java::lang::foreign::MemorySegment> segment, jlong start) { return call_static_method<"toJavaStringInternal", jni::ref<java::lang::String>>(segment, start); }
