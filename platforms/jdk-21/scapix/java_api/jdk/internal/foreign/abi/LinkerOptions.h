...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class LinkerOptions; }}
...
#include <scapix/java_api/jdk/internal/foreign/abi/LinkerOptions_IsTrivial.h>
...
public:
	...
	using IsTrivial = LinkerOptions_IsTrivial;
