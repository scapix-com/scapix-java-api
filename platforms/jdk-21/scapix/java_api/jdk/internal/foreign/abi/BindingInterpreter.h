...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class BindingInterpreter; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::BindingInterpreter> new_object() { return object_base::new_object(); }
