...
namespace scapix::java_api { namespace jdk::internal::foreign::abi { class VMStorage; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::abi::VMStorage> new_object(jbyte type, jshort segmentMaskOrSize, jint indexOrOffset) { return object_base::new_object(type, segmentMaskOrSize, indexOrOffset); }
	static jni::ref<jdk::internal::foreign::abi::VMStorage> new_object(jbyte type, jshort segmentMaskOrSize, jint indexOrOffset, jni::ref<java::lang::String> debugName) { return object_base::new_object(type, segmentMaskOrSize, indexOrOffset, debugName); }
