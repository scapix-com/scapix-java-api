...
namespace scapix::java_api { namespace jdk::internal::foreign { class ImplicitSession; }}
...
public:
	...
	static jni::ref<jdk::internal::foreign::ImplicitSession> new_object(jni::ref<java::lang::ref::Cleaner> cleaner) { return object_base::new_object(cleaner); }
