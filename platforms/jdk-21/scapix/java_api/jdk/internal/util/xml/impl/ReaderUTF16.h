...
namespace scapix::java_api { namespace jdk::internal::util::xml::impl { class ReaderUTF16; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::impl::ReaderUTF16> new_object(jni::ref<java::io::InputStream> is, jchar bo) { return object_base::new_object(is, bo); }
