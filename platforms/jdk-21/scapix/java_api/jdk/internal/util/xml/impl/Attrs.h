...
namespace scapix::java_api { namespace jdk::internal::util::xml::impl { class Attrs; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::impl::Attrs> new_object() { return object_base::new_object(); }
