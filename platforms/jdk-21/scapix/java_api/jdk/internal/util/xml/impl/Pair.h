...
namespace scapix::java_api { namespace jdk::internal::util::xml::impl { class Pair; }}
...
public:
	...
	static jni::ref<jdk::internal::util::xml::impl::Pair> new_object() { return object_base::new_object(); }
