...
#ifndef SCAPIX_JAVA_API_JDK_INTERNAL_UTIL_BYTEARRAYLITTLEENDIAN_FWD
#define SCAPIX_JAVA_API_JDK_INTERNAL_UTIL_BYTEARRAYLITTLEENDIAN_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::jdk::internal::util { class ByteArrayLittleEndian; }

template<>
struct scapix::jni::object_traits<scapix::java_api::jdk::internal::util::ByteArrayLittleEndian>
{
	static constexpr fixed_string class_name = "jdk/internal/util/ByteArrayLittleEndian";
	using base_classes = std::tuple<scapix::java_api::java::lang::Object>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_JDK_INTERNAL_UTIL_BYTEARRAYLITTLEENDIAN_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_JDK_INTERNAL_UTIL_BYTEARRAYLITTLEENDIAN)
#define SCAPIX_JAVA_API_JDK_INTERNAL_UTIL_BYTEARRAYLITTLEENDIAN

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api {

class jdk::internal::util::ByteArrayLittleEndian : public jni::object_base<"jdk/internal/util/ByteArrayLittleEndian",
	java::lang::Object>
{
public:
...
protected:
	...
	ByteArrayLittleEndian(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_JDK_INTERNAL_UTIL_BYTEARRAYLITTLEENDIAN
