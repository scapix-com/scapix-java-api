...
namespace scapix::java_api { namespace jdk::internal::event { class X509ValidationEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::X509ValidationEvent> new_object() { return object_base::new_object(); }
