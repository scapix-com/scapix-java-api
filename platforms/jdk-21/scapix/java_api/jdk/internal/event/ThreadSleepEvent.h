...
namespace scapix::java_api { namespace jdk::internal::event { class ThreadSleepEvent; }}
...
public:
	...
	static jni::ref<jdk::internal::event::ThreadSleepEvent> new_object() { return object_base::new_object(); }
