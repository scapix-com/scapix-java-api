...
namespace scapix::java_api { namespace jdk::internal::loader { class BootLoader; }}
...
public:
	...
	static jni::ref<jdk::internal::loader::NativeLibraries> getNativeLibraries() { return call_static_method<"getNativeLibraries", jni::ref<jdk::internal::loader::NativeLibraries>>(); }
	...
	static void loadLibrary(jni::ref<java::lang::String> name) { return call_static_method<"loadLibrary", void>(name); }
