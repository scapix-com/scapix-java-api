...
public:
	...
	static jni::ref<java::lang::Appendable> appendTo(jdouble v, jni::ref<java::lang::Appendable> app) { return call_static_method<"appendTo", jni::ref<java::lang::Appendable>>(v, app); }
