...
#ifndef SCAPIX_JAVA_API_JDK_NET_EXTENDEDSOCKETOPTIONS
...
public:
	...
	static jni::ref<java::net::SocketOption> TCP_QUICKACK() { return get_static_field<"TCP_QUICKACK", jni::ref<java::net::SocketOption>>(); }
	...
	static jni::ref<java::net::SocketOption> SO_INCOMING_NAPI_ID() { return get_static_field<"SO_INCOMING_NAPI_ID", jni::ref<java::net::SocketOption>>(); }
	static jni::ref<java::net::SocketOption> SO_PEERCRED() { return get_static_field<"SO_PEERCRED", jni::ref<java::net::SocketOption>>(); }
	static jni::ref<java::net::SocketOption> IP_DONTFRAGMENT() { return get_static_field<"IP_DONTFRAGMENT", jni::ref<java::net::SocketOption>>(); }
};
