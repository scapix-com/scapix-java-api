...
public:
	...
	static jni::ref<java::rmi::ServerRuntimeException> new_object(jni::ref<java::lang::String> s, jni::ref<java::lang::Exception> ex) { return object_base::new_object(s, ex); }
};
