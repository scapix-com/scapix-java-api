...
public:
	...
	static jni::ref<java::math::BigDecimal> TWO() { return get_static_field<"TWO", jni::ref<java::math::BigDecimal>>(); }
	...
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<jni::array<jchar>> in, jint offset, jint len) { return object_base::new_object(in, offset, len); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<jni::array<jchar>> in, jint offset, jint len, jni::ref<java::math::MathContext> mc) { return object_base::new_object(in, offset, len, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<jni::array<jchar>> in) { return object_base::new_object(in); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<jni::array<jchar>> in, jni::ref<java::math::MathContext> mc) { return object_base::new_object(in, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<java::lang::String> val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<java::lang::String> val, jni::ref<java::math::MathContext> mc) { return object_base::new_object(val, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jdouble val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigDecimal> new_object(jdouble val, jni::ref<java::math::MathContext> mc) { return object_base::new_object(val, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<java::math::BigInteger> val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<java::math::BigInteger> val, jni::ref<java::math::MathContext> mc) { return object_base::new_object(val, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<java::math::BigInteger> unscaledVal, jint scale) { return object_base::new_object(unscaledVal, scale); }
	static jni::ref<java::math::BigDecimal> new_object(jni::ref<java::math::BigInteger> unscaledVal, jint scale, jni::ref<java::math::MathContext> mc) { return object_base::new_object(unscaledVal, scale, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jint val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigDecimal> new_object(jint val, jni::ref<java::math::MathContext> mc) { return object_base::new_object(val, mc); }
	static jni::ref<java::math::BigDecimal> new_object(jlong val) { return object_base::new_object(val); }
	static jni::ref<java::math::BigDecimal> new_object(jlong val, jni::ref<java::math::MathContext> mc) { return object_base::new_object(val, mc); }
	static jni::ref<java::math::BigDecimal> valueOf(jlong unscaledVal, jint scale) { return call_static_method<"valueOf", jni::ref<java::math::BigDecimal>>(unscaledVal, scale); }
