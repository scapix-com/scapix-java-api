...
namespace scapix::java_api { namespace java::text { class RBCollationTables; }}
...
public:
	...
	static jni::ref<java::text::RBCollationTables> new_object(jni::ref<java::lang::String> rules, jint decmp) { return object_base::new_object(rules, decmp); }
