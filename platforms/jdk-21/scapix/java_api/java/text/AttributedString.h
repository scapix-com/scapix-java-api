...
public:
	...
	static jni::ref<java::text::AttributedString> new_object(jni::ref<java::lang::String> text) { return object_base::new_object(text); }
	static jni::ref<java::text::AttributedString> new_object(jni::ref<java::lang::String> text, jni::ref<java::util::Map> attributes) { return object_base::new_object(text, attributes); }
	static jni::ref<java::text::AttributedString> new_object(jni::ref<java::text::AttributedCharacterIterator> text) { return object_base::new_object(text); }
	static jni::ref<java::text::AttributedString> new_object(jni::ref<java::text::AttributedCharacterIterator> text, jint beginIndex, jint endIndex) { return object_base::new_object(text, beginIndex, endIndex); }
	static jni::ref<java::text::AttributedString> new_object(jni::ref<java::text::AttributedCharacterIterator> text, jint beginIndex, jint endIndex, jni::ref<jni::array<java::text::AttributedCharacterIterator_Attribute>> attributes) { return object_base::new_object(text, beginIndex, endIndex, attributes); }
