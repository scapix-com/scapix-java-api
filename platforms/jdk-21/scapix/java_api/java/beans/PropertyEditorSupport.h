...
#ifndef SCAPIX_JAVA_API_JAVA_BEANS_PROPERTYEDITORSUPPORT
...
public:
	...
	static jni::ref<java::beans::PropertyEditorSupport> new_object() { return object_base::new_object(); }
	static jni::ref<java::beans::PropertyEditorSupport> new_object(jni::ref<java::lang::Object> source) { return object_base::new_object(source); }
	...
	void paintValue(jni::ref<java::awt::Graphics> gfx, jni::ref<java::awt::Rectangle> box) { return call_method<"paintValue", void>(gfx, box); }
	...
	void setAsText(jni::ref<java::lang::String> text) { return call_method<"setAsText", void>(text); }
