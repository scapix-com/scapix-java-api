...
namespace scapix::java_api { namespace java::lang::ref { class NativeReferenceQueue; }}
...
public:
	...
	static jni::ref<java::lang::ref::NativeReferenceQueue> new_object() { return object_base::new_object(); }
