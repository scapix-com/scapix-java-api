...
namespace scapix::java_api { namespace java::lang::ref { class FinalReference; }}
...
public:
	...
	static jni::ref<java::lang::ref::FinalReference> new_object(jni::ref<java::lang::Object> referent, jni::ref<java::lang::ref::ReferenceQueue> q) { return object_base::new_object(referent, q); }
