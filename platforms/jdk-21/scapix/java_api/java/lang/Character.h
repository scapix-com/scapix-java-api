...
public:
	...
	static jni::ref<java::lang::Character> new_object(jchar value) { return object_base::new_object(value); }
	...
	static jboolean isEmoji(jint codePoint) { return call_static_method<"isEmoji", jboolean>(codePoint); }
	static jboolean isEmojiPresentation(jint codePoint) { return call_static_method<"isEmojiPresentation", jboolean>(codePoint); }
	static jboolean isEmojiModifier(jint codePoint) { return call_static_method<"isEmojiModifier", jboolean>(codePoint); }
	static jboolean isEmojiModifierBase(jint codePoint) { return call_static_method<"isEmojiModifierBase", jboolean>(codePoint); }
	static jboolean isEmojiComponent(jint codePoint) { return call_static_method<"isEmojiComponent", jboolean>(codePoint); }
	static jboolean isExtendedPictographic(jint codePoint) { return call_static_method<"isExtendedPictographic", jboolean>(codePoint); }
