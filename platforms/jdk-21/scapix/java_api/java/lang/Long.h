...
public:
	...
	static jni::ref<java::lang::String> toString(jlong i, jint radix) { return call_static_method<"toString", jni::ref<java::lang::String>>(i, radix); }
	static jni::ref<java::lang::String> toUnsignedString(jlong i, jint radix) { return call_static_method<"toUnsignedString", jni::ref<java::lang::String>>(i, radix); }
	...
	static jni::ref<java::lang::Long> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	...
	static jint compare(jlong x, jlong y) { return call_static_method<"compare", jint>(x, y); }
	static jint compareUnsigned(jlong x, jlong y) { return call_static_method<"compareUnsigned", jint>(x, y); }
	static jlong divideUnsigned(jlong dividend, jlong divisor) { return call_static_method<"divideUnsigned", jlong>(dividend, divisor); }
	static jlong remainderUnsigned(jlong dividend, jlong divisor) { return call_static_method<"remainderUnsigned", jlong>(dividend, divisor); }
	...
	static jlong rotateLeft(jlong i, jint distance) { return call_static_method<"rotateLeft", jlong>(i, distance); }
	static jlong rotateRight(jlong i, jint distance) { return call_static_method<"rotateRight", jlong>(i, distance); }
	static jlong reverse(jlong i) { return call_static_method<"reverse", jlong>(i); }
	static jlong compress(jlong i, jlong mask) { return call_static_method<"compress", jlong>(i, mask); }
	static jlong expand(jlong i, jlong mask) { return call_static_method<"expand", jlong>(i, mask); }
	...
	static jlong sum(jlong a, jlong b) { return call_static_method<"sum", jlong>(a, b); }
	...
	jni::ref<java::lang::Long> resolveConstantDesc(jni::ref<java::lang::invoke::MethodHandles_Lookup> lookup) { return call_method<"resolveConstantDesc", jni::ref<java::lang::Long>>(lookup); }
};
