...
public:
	...
	static jlong compress(jlong i, jlong p2) { return call_static_method<"compress", jlong>(i, p2); }
	static jlong expand(jlong i, jlong p2) { return call_static_method<"expand", jlong>(i, p2); }
