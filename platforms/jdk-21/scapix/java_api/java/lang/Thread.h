...
public:
	...
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> task) { return object_base::new_object(task); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> task) { return object_base::new_object(group, task); }
	...
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::Runnable> task, jni::ref<java::lang::String> name) { return object_base::new_object(task, name); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> task, jni::ref<java::lang::String> name) { return object_base::new_object(group, task, name); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> task, jni::ref<java::lang::String> name, jlong stackSize) { return object_base::new_object(group, task, name, stackSize); }
	static jni::ref<java::lang::Thread> new_object(jni::ref<java::lang::ThreadGroup> group, jni::ref<java::lang::Runnable> task, jni::ref<java::lang::String> name, jlong stackSize, jboolean inheritInheritableThreadLocals) { return object_base::new_object(group, task, name, stackSize, inheritInheritableThreadLocals); }
