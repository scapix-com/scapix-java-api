...
public:
	...
	static jni::ref<java::lang::Float> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	...
	static jfloat float16ToFloat(jshort floatBinary16) { return call_static_method<"float16ToFloat", jfloat>(floatBinary16); }
	static jshort floatToFloat16(jfloat f) { return call_static_method<"floatToFloat16", jshort>(f); }
