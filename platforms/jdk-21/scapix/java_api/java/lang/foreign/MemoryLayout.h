...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_FOREIGN_MEMORYLAYOUT
...
public:
	...
	jlong byteOffset(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"byteOffset", jlong>(elements); }
	jni::ref<java::lang::invoke::MethodHandle> byteOffsetHandle(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"byteOffsetHandle", jni::ref<java::lang::invoke::MethodHandle>>(elements); }
	jni::ref<java::lang::invoke::VarHandle> varHandle(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"varHandle", jni::ref<java::lang::invoke::VarHandle>>(elements); }
	jni::ref<java::lang::invoke::MethodHandle> sliceHandle(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"sliceHandle", jni::ref<java::lang::invoke::MethodHandle>>(elements); }
	jni::ref<java::lang::foreign::MemoryLayout> select(jni::ref<jni::array<java::lang::foreign::MemoryLayout_PathElement>> elements) { return call_method<"select", jni::ref<java::lang::foreign::MemoryLayout>>(elements); }
	...
	static jni::ref<java::lang::foreign::SequenceLayout> sequenceLayout(jlong elementCount, jni::ref<java::lang::foreign::MemoryLayout> elementLayout) { return call_static_method<"sequenceLayout", jni::ref<java::lang::foreign::SequenceLayout>>(elementCount, elementLayout); }
	static jni::ref<java::lang::foreign::SequenceLayout> sequenceLayout(jni::ref<java::lang::foreign::MemoryLayout> elementLayout) { return call_static_method<"sequenceLayout", jni::ref<java::lang::foreign::SequenceLayout>>(elementLayout); }
