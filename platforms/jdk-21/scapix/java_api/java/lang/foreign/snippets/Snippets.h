...
namespace scapix::java_api { namespace java::lang::foreign::snippets { class Snippets; }}
...
public:
	...
	static jni::ref<java::lang::foreign::snippets::Snippets> new_object() { return object_base::new_object(); }
