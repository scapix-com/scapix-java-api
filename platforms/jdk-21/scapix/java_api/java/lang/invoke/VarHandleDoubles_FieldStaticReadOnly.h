...
namespace scapix::java_api { namespace java::lang::invoke { class VarHandleDoubles_FieldStaticReadOnly; }}
...
public:
	...
	jni::ref<java::lang::invoke::VarHandleDoubles_FieldStaticReadOnly> withInvokeExactBehavior() { return call_method<"withInvokeExactBehavior", jni::ref<java::lang::invoke::VarHandleDoubles_FieldStaticReadOnly>>(); }
	jni::ref<java::lang::invoke::VarHandleDoubles_FieldStaticReadOnly> withInvokeBehavior() { return call_method<"withInvokeBehavior", jni::ref<java::lang::invoke::VarHandleDoubles_FieldStaticReadOnly>>(); }
