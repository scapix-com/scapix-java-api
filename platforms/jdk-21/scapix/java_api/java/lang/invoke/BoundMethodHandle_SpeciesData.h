...
namespace scapix::java_api { namespace java::lang::invoke { class BoundMethodHandle_SpeciesData; }}
...
public:
	...
	static jni::ref<java::lang::invoke::BoundMethodHandle_SpeciesData> new_object(jni::ref<java::lang::invoke::BoundMethodHandle_Specializer> outer, jni::ref<java::lang::String> key) { return object_base::new_object(outer, key); }
