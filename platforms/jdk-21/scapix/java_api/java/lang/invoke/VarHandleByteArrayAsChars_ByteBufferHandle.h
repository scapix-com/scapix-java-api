...
namespace scapix::java_api { namespace java::lang::invoke { class VarHandleByteArrayAsChars_ByteBufferHandle; }}
...
public:
	...
	jni::ref<java::lang::invoke::VarHandleByteArrayAsChars_ByteBufferHandle> withInvokeExactBehavior() { return call_method<"withInvokeExactBehavior", jni::ref<java::lang::invoke::VarHandleByteArrayAsChars_ByteBufferHandle>>(); }
	jni::ref<java::lang::invoke::VarHandleByteArrayAsChars_ByteBufferHandle> withInvokeBehavior() { return call_method<"withInvokeBehavior", jni::ref<java::lang::invoke::VarHandleByteArrayAsChars_ByteBufferHandle>>(); }
