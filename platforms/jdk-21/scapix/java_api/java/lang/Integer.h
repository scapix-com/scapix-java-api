...
public:
	...
	static jni::ref<java::lang::Integer> new_object(jint value) { return object_base::new_object(value); }
	static jni::ref<java::lang::Integer> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	...
	static jint compress(jint i, jint mask) { return call_static_method<"compress", jint>(i, mask); }
	static jint expand(jint i, jint mask) { return call_static_method<"expand", jint>(i, mask); }
	...
	jni::ref<java::lang::Integer> resolveConstantDesc(jni::ref<java::lang::invoke::MethodHandles_Lookup> lookup) { return call_method<"resolveConstantDesc", jni::ref<java::lang::Integer>>(lookup); }
};
