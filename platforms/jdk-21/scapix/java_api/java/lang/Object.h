...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_OBJECT
...
public:
	...
	static jni::ref<java::lang::Object> new_object() { return object_base::new_object(); }
	...
	void wait(jlong timeoutMillis) { return call_method<"wait", void>(timeoutMillis); }
	void wait(jlong timeoutMillis, jint nanos) { return call_method<"wait", void>(timeoutMillis, nanos); }
};
