...
namespace scapix::java_api { namespace java::lang { class ProcessHandleImpl_Info; }}
...
public:
	...
	static jni::ref<java::lang::ProcessHandle_Info> info(jlong pid, jlong startTime) { return call_static_method<"info", jni::ref<java::lang::ProcessHandle_Info>>(pid, startTime); }
