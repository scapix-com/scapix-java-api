...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_MANAGEMENT_THREADMXBEAN
...
public:
	...
	jni::ref<jni::array<java::lang::management::ThreadInfo>> getThreadInfo(jni::ref<jni::array<jlong>> ids, jboolean lockedMonitors, jboolean lockedSynchronizers, jint maxDepth) { return call_method<"getThreadInfo", jni::ref<jni::array<java::lang::management::ThreadInfo>>>(ids, lockedMonitors, lockedSynchronizers, maxDepth); }
	...
	jni::ref<jni::array<java::lang::management::ThreadInfo>> dumpAllThreads(jboolean lockedMonitors, jboolean lockedSynchronizers, jint maxDepth) { return call_method<"dumpAllThreads", jni::ref<jni::array<java::lang::management::ThreadInfo>>>(lockedMonitors, lockedSynchronizers, maxDepth); }
};
