...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_DOUBLE
...
public:
	...
	static jni::ref<java::lang::Double> new_object(jdouble value) { return object_base::new_object(value); }
	static jni::ref<java::lang::Double> new_object(jni::ref<java::lang::String> s) { return object_base::new_object(s); }
	...
	static jint compare(jdouble d1, jdouble d2) { return call_static_method<"compare", jint>(d1, d2); }
	static jdouble sum(jdouble a, jdouble b) { return call_static_method<"sum", jdouble>(a, b); }
