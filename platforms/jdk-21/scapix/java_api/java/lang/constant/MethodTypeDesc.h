...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CONSTANT_METHODTYPEDESC
...
public:
	...
	static jni::ref<java::lang::constant::MethodTypeDesc> of(jni::ref<java::lang::constant::ClassDesc> returnDesc) { return call_static_method<"of", jni::ref<java::lang::constant::MethodTypeDesc>>(returnDesc); }
	static jni::ref<java::lang::constant::MethodTypeDesc> of(jni::ref<java::lang::constant::ClassDesc> returnDesc, jni::ref<java::util::List> paramDescs) { return call_static_method<"of", jni::ref<java::lang::constant::MethodTypeDesc>>(returnDesc, paramDescs); }
	...
	jni::ref<java::lang::invoke::MethodType> resolveConstantDesc(jni::ref<java::lang::invoke::MethodHandles_Lookup> p1) { return call_method<"resolveConstantDesc", jni::ref<java::lang::invoke::MethodType>>(p1); }
