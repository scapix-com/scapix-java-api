...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_CONSTANT_METHODHANDLEDESC
...
public:
	...
	jni::ref<java::lang::invoke::MethodHandle> resolveConstantDesc(jni::ref<java::lang::invoke::MethodHandles_Lookup> p1) { return call_method<"resolveConstantDesc", jni::ref<java::lang::invoke::MethodHandle>>(p1); }
