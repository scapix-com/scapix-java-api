...
public:
	...
	jni::ref<java::time::chrono::ThaiBuddhistDate> minus(jlong amountToSubtract, jni::ref<java::time::temporal::TemporalUnit> p2) { return call_method<"minus", jni::ref<java::time::chrono::ThaiBuddhistDate>>(amountToSubtract, p2); }
