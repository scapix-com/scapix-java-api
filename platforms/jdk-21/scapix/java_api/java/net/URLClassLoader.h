...
#ifndef SCAPIX_JAVA_API_JAVA_NET_URLCLASSLOADER
...
public:
	...
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::lang::ClassLoader> parent) { return object_base::new_object(urls, parent); }
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> urls) { return object_base::new_object(urls); }
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::lang::ClassLoader> parent, jni::ref<java::net::URLStreamHandlerFactory> factory) { return object_base::new_object(urls, parent, factory); }
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::lang::ClassLoader> parent) { return object_base::new_object(name, urls, parent); }
	static jni::ref<java::net::URLClassLoader> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::lang::ClassLoader> parent, jni::ref<java::net::URLStreamHandlerFactory> factory) { return object_base::new_object(name, urls, parent, factory); }
