...
#ifndef SCAPIX_JAVA_API_JAVA_IO_INVALIDCLASSEXCEPTION
...
public:
	...
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> reason) { return object_base::new_object(reason); }
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> cname, jni::ref<java::lang::String> reason) { return object_base::new_object(cname, reason); }
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> reason, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(reason, cause); }
	static jni::ref<java::io::InvalidClassException> new_object(jni::ref<java::lang::String> cname, jni::ref<java::lang::String> reason, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(cname, reason, cause); }
