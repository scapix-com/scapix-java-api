...
#ifndef SCAPIX_JAVA_API_JAVA_IO_INVALIDOBJECTEXCEPTION
...
public:
	...
	static jni::ref<java::io::InvalidObjectException> new_object(jni::ref<java::lang::String> reason) { return object_base::new_object(reason); }
	static jni::ref<java::io::InvalidObjectException> new_object(jni::ref<java::lang::String> reason, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(reason, cause); }
};
