...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_PSEUDOCOLUMNUSAGE
...
public:
	...
	static jni::ref<java::sql::PseudoColumnUsage> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::sql::PseudoColumnUsage>>(name); }
};
