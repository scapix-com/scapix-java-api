...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_JDBCTYPE
...
public:
	...
	static jni::ref<java::sql::JDBCType> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::sql::JDBCType>>(name); }
	...
	static jni::ref<java::sql::JDBCType> valueOf(jint type) { return call_static_method<"valueOf", jni::ref<java::sql::JDBCType>>(type); }
};
