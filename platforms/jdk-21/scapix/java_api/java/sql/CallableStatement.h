...
#ifndef SCAPIX_JAVA_API_JAVA_SQL_CALLABLESTATEMENT
...
public:
	...
	void setObject(jni::ref<java::lang::String> parameterName, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType, jint scaleOrLength) { return call_method<"setObject", void>(parameterName, x, targetSqlType, scaleOrLength); }
	void setObject(jni::ref<java::lang::String> parameterName, jni::ref<java::lang::Object> x, jni::ref<java::sql::SQLType> targetSqlType) { return call_method<"setObject", void>(parameterName, x, targetSqlType); }
	void registerOutParameter(jint parameterIndex, jni::ref<java::sql::SQLType> sqlType) { return call_method<"registerOutParameter", void>(parameterIndex, sqlType); }
	void registerOutParameter(jint parameterIndex, jni::ref<java::sql::SQLType> sqlType, jint scale) { return call_method<"registerOutParameter", void>(parameterIndex, sqlType, scale); }
	void registerOutParameter(jint parameterIndex, jni::ref<java::sql::SQLType> sqlType, jni::ref<java::lang::String> typeName) { return call_method<"registerOutParameter", void>(parameterIndex, sqlType, typeName); }
	void registerOutParameter(jni::ref<java::lang::String> parameterName, jni::ref<java::sql::SQLType> sqlType) { return call_method<"registerOutParameter", void>(parameterName, sqlType); }
	void registerOutParameter(jni::ref<java::lang::String> parameterName, jni::ref<java::sql::SQLType> sqlType, jint scale) { return call_method<"registerOutParameter", void>(parameterName, sqlType, scale); }
	void registerOutParameter(jni::ref<java::lang::String> parameterName, jni::ref<java::sql::SQLType> sqlType, jni::ref<java::lang::String> typeName) { return call_method<"registerOutParameter", void>(parameterName, sqlType, typeName); }
};
