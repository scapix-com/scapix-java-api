...
namespace scapix::java_api { namespace java::nio::file { class FileTreeWalker_EventType; }}
...
public:
	...
	static jni::ref<java::nio::file::FileTreeWalker_EventType> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::nio::file::FileTreeWalker_EventType>>(name); }
