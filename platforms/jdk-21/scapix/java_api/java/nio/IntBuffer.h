...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_INTBUFFER
...
public:
	...
	jni::ref<java::nio::IntBuffer> get(jint index, jni::ref<jni::array<jint>> dst) { return call_method<"get", jni::ref<java::nio::IntBuffer>>(index, dst); }
	...
	jni::ref<java::nio::IntBuffer> put(jint index, jni::ref<jni::array<jint>> src) { return call_method<"put", jni::ref<java::nio::IntBuffer>>(index, src); }
	...
	jni::ref<java::nio::IntBuffer> position(jint newPosition) { return call_method<"position", jni::ref<java::nio::IntBuffer>>(newPosition); }
	jni::ref<java::nio::IntBuffer> limit(jint newLimit) { return call_method<"limit", jni::ref<java::nio::IntBuffer>>(newLimit); }
	jni::ref<java::nio::IntBuffer> mark() { return call_method<"mark", jni::ref<java::nio::IntBuffer>>(); }
	jni::ref<java::nio::IntBuffer> reset() { return call_method<"reset", jni::ref<java::nio::IntBuffer>>(); }
	jni::ref<java::nio::IntBuffer> clear() { return call_method<"clear", jni::ref<java::nio::IntBuffer>>(); }
	jni::ref<java::nio::IntBuffer> flip() { return call_method<"flip", jni::ref<java::nio::IntBuffer>>(); }
	jni::ref<java::nio::IntBuffer> rewind() { return call_method<"rewind", jni::ref<java::nio::IntBuffer>>(); }
