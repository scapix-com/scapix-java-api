...
public:
	...
	jni::ref<java::nio::CharBuffer> slice(jint p1, jint p2) { return call_method<"slice", jni::ref<java::nio::CharBuffer>>(p1, p2); }
	...
	jni::ref<java::nio::CharBuffer> get(jint index, jni::ref<jni::array<jchar>> dst, jint offset, jint length) { return call_method<"get", jni::ref<java::nio::CharBuffer>>(index, dst, offset, length); }
	jni::ref<java::nio::CharBuffer> get(jint index, jni::ref<jni::array<jchar>> dst) { return call_method<"get", jni::ref<java::nio::CharBuffer>>(index, dst); }
	...
	jni::ref<java::nio::CharBuffer> put(jint index, jni::ref<jni::array<jchar>> src) { return call_method<"put", jni::ref<java::nio::CharBuffer>>(index, src); }
	...
	jni::ref<java::nio::CharBuffer> position(jint newPosition) { return call_method<"position", jni::ref<java::nio::CharBuffer>>(newPosition); }
	jni::ref<java::nio::CharBuffer> limit(jint newLimit) { return call_method<"limit", jni::ref<java::nio::CharBuffer>>(newLimit); }
	jni::ref<java::nio::CharBuffer> mark() { return call_method<"mark", jni::ref<java::nio::CharBuffer>>(); }
	jni::ref<java::nio::CharBuffer> reset() { return call_method<"reset", jni::ref<java::nio::CharBuffer>>(); }
	jni::ref<java::nio::CharBuffer> clear() { return call_method<"clear", jni::ref<java::nio::CharBuffer>>(); }
	jni::ref<java::nio::CharBuffer> flip() { return call_method<"flip", jni::ref<java::nio::CharBuffer>>(); }
	jni::ref<java::nio::CharBuffer> rewind() { return call_method<"rewind", jni::ref<java::nio::CharBuffer>>(); }
	...
	jint mismatch(jni::ref<java::nio::CharBuffer> that) { return call_method<"mismatch", jint>(that); }
