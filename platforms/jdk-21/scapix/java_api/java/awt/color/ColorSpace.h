...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_COLOR_COLORSPACE
...
public:
	...
	static jni::ref<java::awt::color::ColorSpace> getInstance(jint cspace) { return call_static_method<"getInstance", jni::ref<java::awt::color::ColorSpace>>(cspace); }
	...
	jni::ref<java::lang::String> getName(jint component) { return call_method<"getName", jni::ref<java::lang::String>>(component); }
