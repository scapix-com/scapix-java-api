...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_COLOR_ICC_COLORSPACE
...
public:
	...
	static jni::ref<java::awt::color::ICC_ColorSpace> new_object(jni::ref<java::awt::color::ICC_Profile> profile) { return object_base::new_object(profile); }
	jni::ref<java::awt::color::ICC_Profile> getProfile() { return call_method<"getProfile", jni::ref<java::awt::color::ICC_Profile>>(); }
	jni::ref<jni::array<jfloat>> toRGB(jni::ref<jni::array<jfloat>> colorvalue) { return call_method<"toRGB", jni::ref<jni::array<jfloat>>>(colorvalue); }
	jni::ref<jni::array<jfloat>> fromRGB(jni::ref<jni::array<jfloat>> rgbvalue) { return call_method<"fromRGB", jni::ref<jni::array<jfloat>>>(rgbvalue); }
	jni::ref<jni::array<jfloat>> toCIEXYZ(jni::ref<jni::array<jfloat>> colorvalue) { return call_method<"toCIEXYZ", jni::ref<jni::array<jfloat>>>(colorvalue); }
	jni::ref<jni::array<jfloat>> fromCIEXYZ(jni::ref<jni::array<jfloat>> colorvalue) { return call_method<"fromCIEXYZ", jni::ref<jni::array<jfloat>>>(colorvalue); }
