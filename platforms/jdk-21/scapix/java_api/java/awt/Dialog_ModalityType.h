...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_DIALOG_MODALITYTYPE
...
public:
	...
	static jni::ref<java::awt::Dialog_ModalityType> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::awt::Dialog_ModalityType>>(name); }
};
