...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_SCROLLPANE
...
public:
	...
	static jni::ref<java::awt::ScrollPane> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::ScrollPane> new_object(jint scrollbarDisplayPolicy) { return object_base::new_object(scrollbarDisplayPolicy); }
	...
	void setScrollPosition(jint x, jint y) { return call_method<"setScrollPosition", void>(x, y); }
	void setScrollPosition(jni::ref<java::awt::Point> p) { return call_method<"setScrollPosition", void>(p); }
