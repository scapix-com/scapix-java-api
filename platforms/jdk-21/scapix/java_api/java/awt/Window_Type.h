...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_WINDOW_TYPE
...
public:
	...
	static jni::ref<java::awt::Window_Type> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::awt::Window_Type>>(name); }
};
