...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_GEOM_RECTANGLE2D_FLOAT
...
public:
	...
	static jni::ref<java::awt::geom::Rectangle2D_Float> new_object() { return object_base::new_object(); }
	static jni::ref<java::awt::geom::Rectangle2D_Float> new_object(jfloat x, jfloat y, jfloat w, jfloat h) { return object_base::new_object(x, y, w, h); }
	...
	void setRect(jfloat x, jfloat y, jfloat w, jfloat h) { return call_method<"setRect", void>(x, y, w, h); }
