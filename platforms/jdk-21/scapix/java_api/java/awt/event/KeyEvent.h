...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_KEYEVENT
...
public:
	...
	static jni::ref<java::awt::event::KeyEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jint modifiers, jint keyCode, jchar keyChar, jint keyLocation) { return object_base::new_object(source, id, when, modifiers, keyCode, keyChar, keyLocation); }
	static jni::ref<java::awt::event::KeyEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jint modifiers, jint keyCode, jchar keyChar) { return object_base::new_object(source, id, when, modifiers, keyCode, keyChar); }
	static jni::ref<java::awt::event::KeyEvent> new_object(jni::ref<java::awt::Component> source, jint id, jlong when, jint modifiers, jint keyCode) { return object_base::new_object(source, id, when, modifiers, keyCode); }
	jint getKeyCode() { return call_method<"getKeyCode", jint>(); }
	void setKeyCode(jint keyCode) { return call_method<"setKeyCode", void>(keyCode); }
	jchar getKeyChar() { return call_method<"getKeyChar", jchar>(); }
	void setKeyChar(jchar keyChar) { return call_method<"setKeyChar", void>(keyChar); }
	void setModifiers(jint modifiers) { return call_method<"setModifiers", void>(modifiers); }
	jint getKeyLocation() { return call_method<"getKeyLocation", jint>(); }
	static jni::ref<java::lang::String> getKeyText(jint keyCode) { return call_static_method<"getKeyText", jni::ref<java::lang::String>>(keyCode); }
	static jni::ref<java::lang::String> getKeyModifiersText(jint modifiers) { return call_static_method<"getKeyModifiersText", jni::ref<java::lang::String>>(modifiers); }
	...
	static jint getExtendedKeyCodeForChar(jint c) { return call_static_method<"getExtendedKeyCodeForChar", jint>(c); }
};
