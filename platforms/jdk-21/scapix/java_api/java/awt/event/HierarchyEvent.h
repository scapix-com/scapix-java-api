...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_HIERARCHYEVENT
...
public:
	...
	static jni::ref<java::awt::event::HierarchyEvent> new_object(jni::ref<java::awt::Component> source, jint id, jni::ref<java::awt::Component> changed, jni::ref<java::awt::Container> changedParent) { return object_base::new_object(source, id, changed, changedParent); }
	static jni::ref<java::awt::event::HierarchyEvent> new_object(jni::ref<java::awt::Component> source, jint id, jni::ref<java::awt::Component> changed, jni::ref<java::awt::Container> changedParent, jlong changeFlags) { return object_base::new_object(source, id, changed, changedParent, changeFlags); }
