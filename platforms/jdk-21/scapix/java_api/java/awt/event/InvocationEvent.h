...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_EVENT_INVOCATIONEVENT
...
public:
	...
	static jni::ref<java::awt::event::InvocationEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<java::lang::Runnable> runnable) { return object_base::new_object(source, runnable); }
	static jni::ref<java::awt::event::InvocationEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<java::lang::Runnable> runnable, jni::ref<java::lang::Object> notifier, jboolean catchThrowables) { return object_base::new_object(source, runnable, notifier, catchThrowables); }
	static jni::ref<java::awt::event::InvocationEvent> new_object(jni::ref<java::lang::Object> source, jni::ref<java::lang::Runnable> runnable, jni::ref<java::lang::Runnable> listener, jboolean catchThrowables) { return object_base::new_object(source, runnable, listener, catchThrowables); }
