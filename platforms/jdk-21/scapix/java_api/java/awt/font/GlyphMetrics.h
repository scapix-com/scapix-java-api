...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_FONT_GLYPHMETRICS
...
public:
	...
	static jni::ref<java::awt::font::GlyphMetrics> new_object(jfloat advance, jni::ref<java::awt::geom::Rectangle2D> bounds, jbyte glyphType) { return object_base::new_object(advance, bounds, glyphType); }
	static jni::ref<java::awt::font::GlyphMetrics> new_object(jboolean horizontal, jfloat advanceX, jfloat advanceY, jni::ref<java::awt::geom::Rectangle2D> bounds, jbyte glyphType) { return object_base::new_object(horizontal, advanceX, advanceY, bounds, glyphType); }
