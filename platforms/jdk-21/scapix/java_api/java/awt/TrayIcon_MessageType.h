...
#ifndef SCAPIX_JAVA_API_JAVA_AWT_TRAYICON_MESSAGETYPE
...
public:
	...
	static jni::ref<java::awt::TrayIcon_MessageType> valueOf(jni::ref<java::lang::String> name) { return call_static_method<"valueOf", jni::ref<java::awt::TrayIcon_MessageType>>(name); }
};
