...
class KeyStore_CallbackHandlerProtection;
...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_KEYSTORE_CALLBACKHANDLERPROTECTION
...
public:
	...
	static jni::ref<java::security::KeyStore_CallbackHandlerProtection> new_object(jni::ref<javax::security::auth::callback::CallbackHandler> handler) { return object_base::new_object(handler); }
