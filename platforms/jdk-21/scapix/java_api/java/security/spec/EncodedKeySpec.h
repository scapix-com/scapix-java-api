...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_ENCODEDKEYSPEC
...
public:
	...
	static jni::ref<java::security::spec::EncodedKeySpec> new_object(jni::ref<jni::array<jbyte>> encodedKey) { return object_base::new_object(encodedKey); }
