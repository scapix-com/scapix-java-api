...
#ifndef SCAPIX_JAVA_API_JAVA_SECURITY_SPEC_RSAPUBLICKEYSPEC
...
public:
	...
	static jni::ref<java::security::spec::RSAPublicKeySpec> new_object(jni::ref<java::math::BigInteger> modulus, jni::ref<java::math::BigInteger> publicExponent) { return object_base::new_object(modulus, publicExponent); }
	static jni::ref<java::security::spec::RSAPublicKeySpec> new_object(jni::ref<java::math::BigInteger> modulus, jni::ref<java::math::BigInteger> publicExponent, jni::ref<java::security::spec::AlgorithmParameterSpec> params) { return object_base::new_object(modulus, publicExponent, params); }
