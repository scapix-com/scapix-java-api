...
namespace scapix::java_api { namespace java::util::stream { class Nodes_ArrayNode; }}
...
public:
	...
	void copyInto(jni::ref<jni::array<java::lang::Object>> dest, jint destOffset) { return call_method<"copyInto", void>(dest, destOffset); }
