...
public:
	...
	jni::ref<jni::array<java::lang::String>> splitWithDelimiters(jni::ref<java::lang::CharSequence> input, jint limit) { return call_method<"splitWithDelimiters", jni::ref<jni::array<java::lang::String>>>(input, limit); }
	...
	jni::ref<java::util::function::Predicate> asMatchPredicate() { return call_method<"asMatchPredicate", jni::ref<java::util::function::Predicate>>(); }
