...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_DEFLATER
...
public:
	...
	static jni::ref<java::util::zip::Deflater> new_object(jint level, jboolean nowrap) { return object_base::new_object(level, nowrap); }
	static jni::ref<java::util::zip::Deflater> new_object(jint level) { return object_base::new_object(level); }
	static jni::ref<java::util::zip::Deflater> new_object() { return object_base::new_object(); }
