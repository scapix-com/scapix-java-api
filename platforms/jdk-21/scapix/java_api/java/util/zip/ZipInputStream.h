...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_ZIP_ZIPINPUTSTREAM
...
public:
	...
	static jni::ref<java::util::zip::ZipInputStream> new_object(jni::ref<java::io::InputStream> in) { return object_base::new_object(in); }
	static jni::ref<java::util::zip::ZipInputStream> new_object(jni::ref<java::io::InputStream> in, jni::ref<java::nio::charset::Charset> charset) { return object_base::new_object(in, charset); }
	...
	void skipNBytes(jlong n) { return call_method<"skipNBytes", void>(n); }
