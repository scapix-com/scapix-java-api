...
namespace scapix::java_api { namespace java::util { class ArrayPrefixHelpers_DoubleCumulateTask; }}
...
public:
	...
	static jni::ref<java::util::ArrayPrefixHelpers_DoubleCumulateTask> new_object(jni::ref<java::util::ArrayPrefixHelpers_DoubleCumulateTask> parent, jni::ref<java::util::function::DoubleBinaryOperator> function, jni::ref<jni::array<jdouble>> array, jint lo, jint hi) { return object_base::new_object(parent, function, array, lo, hi); }
