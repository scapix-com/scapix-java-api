...
public:
	...
	static jni::ref<java::util::concurrent::StructuredTaskScope> new_object(jni::ref<java::lang::String> name, jni::ref<java::util::concurrent::ThreadFactory> factory) { return object_base::new_object(name, factory); }
	static jni::ref<java::util::concurrent::StructuredTaskScope> new_object() { return object_base::new_object(); }
