...
class StructuredTaskScope_ShutdownOnSuccess;
...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_STRUCTUREDTASKSCOPE_SHUTDOWNONSUCCESS
...
public:
	...
	static jni::ref<java::util::concurrent::StructuredTaskScope_ShutdownOnSuccess> new_object(jni::ref<java::lang::String> name, jni::ref<java::util::concurrent::ThreadFactory> factory) { return object_base::new_object(name, factory); }
	static jni::ref<java::util::concurrent::StructuredTaskScope_ShutdownOnSuccess> new_object() { return object_base::new_object(); }
