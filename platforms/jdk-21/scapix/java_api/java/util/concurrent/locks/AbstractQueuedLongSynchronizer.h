...
public:
	...
	static jni::ref<java::util::concurrent::locks::AbstractQueuedLongSynchronizer> new_object() { return object_base::new_object(); }
	...
	jboolean tryAcquireNanos(jlong arg, jlong nanosTimeout) { return call_method<"tryAcquireNanos", jboolean>(arg, nanosTimeout); }
	...
	jboolean tryAcquireSharedNanos(jlong arg, jlong nanosTimeout) { return call_method<"tryAcquireSharedNanos", jboolean>(arg, nanosTimeout); }
