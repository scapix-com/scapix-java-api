...
public:
	...
	static jni::ref<java::util::concurrent::Phaser> new_object(jint parties) { return base_::new_object(parties); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jni::ref<java::util::concurrent::Phaser> parent) { return base_::new_object(parent); }
	static jni::ref<java::util::concurrent::Phaser> new_object(jni::ref<java::util::concurrent::Phaser> parent, jint parties) { return base_::new_object(parent, parties); }
	...
	jint awaitAdvanceInterruptibly(jint phase, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> p3) { return call_method<"awaitAdvanceInterruptibly", jint>(phase, timeout, p3); }
