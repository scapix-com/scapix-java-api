...
public:
	...
	static jni::ref<java::util::concurrent::DelayQueue> new_object(jni::ref<java::util::Collection> c) { return object_base::new_object(c); }
	...
	jboolean offer(jni::ref<java::util::concurrent::Delayed> e, jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"offer", jboolean>(e, timeout, unit); }
	...
	jni::ref<java::util::concurrent::Delayed> poll(jlong timeout, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"poll", jni::ref<java::util::concurrent::Delayed>>(timeout, unit); }
	jni::ref<java::util::concurrent::Delayed> remove() { return call_method<"remove", jni::ref<java::util::concurrent::Delayed>>(); }
