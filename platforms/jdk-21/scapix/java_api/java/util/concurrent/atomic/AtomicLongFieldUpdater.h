...
public:
	...
	jlong getAndUpdate(jni::ref<java::lang::Object> obj, jni::ref<java::util::function::LongUnaryOperator> updateFunction) { return call_method<"getAndUpdate", jlong>(obj, updateFunction); }
	jlong updateAndGet(jni::ref<java::lang::Object> obj, jni::ref<java::util::function::LongUnaryOperator> updateFunction) { return call_method<"updateAndGet", jlong>(obj, updateFunction); }
	jlong getAndAccumulate(jni::ref<java::lang::Object> obj, jlong x, jni::ref<java::util::function::LongBinaryOperator> accumulatorFunction) { return call_method<"getAndAccumulate", jlong>(obj, x, accumulatorFunction); }
	jlong accumulateAndGet(jni::ref<java::lang::Object> obj, jlong x, jni::ref<java::util::function::LongBinaryOperator> accumulatorFunction) { return call_method<"accumulateAndGet", jlong>(obj, x, accumulatorFunction); }
};
