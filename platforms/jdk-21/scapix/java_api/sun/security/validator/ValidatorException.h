...
namespace scapix::java_api { namespace sun::security::validator { class ValidatorException; }}
...
public:
	...
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(msg, cause); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::Object> type) { return object_base::new_object(type); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::Object> type, jni::ref<java::security::cert::X509Certificate> cert) { return object_base::new_object(type, cert); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::Object> type, jni::ref<java::security::cert::X509Certificate> cert, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(type, cert, cause); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Object> type, jni::ref<java::security::cert::X509Certificate> cert) { return object_base::new_object(msg, type, cert); }
	static jni::ref<sun::security::validator::ValidatorException> new_object(jni::ref<java::lang::String> msg, jni::ref<java::lang::Object> type, jni::ref<java::security::cert::X509Certificate> cert, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(msg, type, cert, cause); }
