...
namespace scapix::java_api { namespace sun::security::util { class Event_ReporterCategory; }}
...
public:
	...
	static jni::ref<sun::security::util::Event_ReporterCategory> CRLCHECK() { return get_static_field<"CRLCHECK", jni::ref<sun::security::util::Event_ReporterCategory>>(); }
