...
namespace scapix::java_api { namespace sun::security::util { class LocalizedMessage; }}
...
public:
	...
	static jni::ref<sun::security::util::LocalizedMessage> new_object(jni::ref<java::lang::String> key) { return object_base::new_object(key); }
