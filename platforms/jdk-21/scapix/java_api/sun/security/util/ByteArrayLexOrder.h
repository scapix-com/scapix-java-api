...
namespace scapix::java_api { namespace sun::security::util { class ByteArrayLexOrder; }}
...
public:
	...
	static jni::ref<sun::security::util::ByteArrayLexOrder> new_object() { return object_base::new_object(); }
