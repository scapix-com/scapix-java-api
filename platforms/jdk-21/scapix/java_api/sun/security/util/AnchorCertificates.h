...
namespace scapix::java_api { namespace sun::security::util { class AnchorCertificates; }}
...
public:
	...
	static jboolean contains(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"contains", jboolean>(cert); }
	static jboolean issuerOf(jni::ref<java::security::cert::X509Certificate> cert) { return call_static_method<"issuerOf", jboolean>(cert); }
