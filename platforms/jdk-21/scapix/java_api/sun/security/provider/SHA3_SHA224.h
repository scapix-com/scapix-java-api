...
namespace scapix::java_api { namespace sun::security::provider { class SHA3_SHA224; }}
...
public:
	...
	static jni::ref<sun::security::provider::SHA3_SHA224> new_object() { return object_base::new_object(); }
