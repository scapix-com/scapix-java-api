...
public:
	...
	jni::ref<jni::array<jbyte>> unpadForTls(jni::ref<jni::array<jbyte>> padded, jint clientVersion, jint serverVersion) { return call_method<"unpadForTls", jni::ref<jni::array<jbyte>>>(padded, clientVersion, serverVersion); }
