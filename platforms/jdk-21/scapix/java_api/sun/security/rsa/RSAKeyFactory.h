...
namespace scapix::java_api { namespace sun::security::rsa { class RSAKeyFactory; }}
...
public:
	...
	static jni::ref<sun::security::rsa::RSAKeyFactory> new_object(jni::ref<sun::security::rsa::RSAUtil_KeyType> type) { return object_base::new_object(type); }
