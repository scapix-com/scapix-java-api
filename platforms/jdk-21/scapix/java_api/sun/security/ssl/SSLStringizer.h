...
namespace scapix::java_api { namespace sun::security::ssl { class SSLStringizer; }}
...
public:
	...
	jni::ref<java::lang::String> toString(jni::ref<sun::security::ssl::HandshakeContext> p1, jni::ref<java::nio::ByteBuffer> p2) { return call_method<"toString", jni::ref<java::lang::String>>(p1, p2); }
