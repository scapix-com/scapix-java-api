...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMWRITECIPHERGENERATOR_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMWRITECIPHERGENERATOR_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api::sun::security::ssl { class SSLCipher_StreamWriteCipherGenerator; }

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::SSLCipher_StreamWriteCipherGenerator>
{
	static constexpr fixed_string class_name = "sun/security/ssl/SSLCipher$StreamWriteCipherGenerator";
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMWRITECIPHERGENERATOR_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMWRITECIPHERGENERATOR)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMWRITECIPHERGENERATOR
...
// private
class sun::security::ssl::SSLCipher_StreamWriteCipherGenerator : public jni::object_base<"sun/security/ssl/SSLCipher$StreamWriteCipherGenerator",
	java::lang::Object,
...
protected:
	...
	SSLCipher_StreamWriteCipherGenerator(handle_type h) : base_(h) {}
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_SSLCIPHER_STREAMWRITECIPHERGENERATOR
