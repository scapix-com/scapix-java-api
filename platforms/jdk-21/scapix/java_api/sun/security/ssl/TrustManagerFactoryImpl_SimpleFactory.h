...
namespace scapix::java_api { namespace sun::security::ssl { class TrustManagerFactoryImpl_SimpleFactory; }}
...
public:
	...
	static jni::ref<sun::security::ssl::TrustManagerFactoryImpl_SimpleFactory> new_object() { return object_base::new_object(); }
