...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_BASESSLSOCKETIMPL_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_BASESSLSOCKETIMPL_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::ssl { class BaseSSLSocketImpl; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::BaseSSLSocketImpl>
{
	static constexpr fixed_string class_name = "sun/security/ssl/BaseSSLSocketImpl";
	using base_classes = std::tuple<scapix::java_api::javax::net::ssl::SSLSocket>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_BASESSLSOCKETIMPL_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_BASESSLSOCKETIMPL)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_BASESSLSOCKETIMPL
...
// private
class sun::security::ssl::BaseSSLSocketImpl : public jni::object_base<"sun/security/ssl/BaseSSLSocketImpl",
...
public:
	...
	void setTcpNoDelay(jboolean value) { return call_method<"setTcpNoDelay", void>(value); }
	jboolean getTcpNoDelay() { return call_method<"getTcpNoDelay", jboolean>(); }
	void setSoLinger(jboolean flag, jint linger) { return call_method<"setSoLinger", void>(flag, linger); }
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_BASESSLSOCKETIMPL
