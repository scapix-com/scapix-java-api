...
#ifndef SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509KEYMANAGER_FWD
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509KEYMANAGER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::security::ssl { class DummyX509KeyManager; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::security::ssl::DummyX509KeyManager>
{
	static constexpr fixed_string class_name = "sun/security/ssl/DummyX509KeyManager";
	using base_classes = std::tuple<scapix::java_api::javax::net::ssl::X509ExtendedKeyManager>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509KEYMANAGER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509KEYMANAGER)
#define SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509KEYMANAGER
...
// private
class sun::security::ssl::DummyX509KeyManager : public jni::object_base<"sun/security/ssl/DummyX509KeyManager",
...
#endif // SCAPIX_JAVA_API_SUN_SECURITY_SSL_DUMMYX509KEYMANAGER
