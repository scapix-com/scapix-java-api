...
namespace scapix::java_api { namespace sun::security::action { class GetIntegerAction; }}
...
public:
	...
	static jni::ref<sun::security::action::GetIntegerAction> new_object(jni::ref<java::lang::String> theProp) { return object_base::new_object(theProp); }
	static jni::ref<sun::security::action::GetIntegerAction> new_object(jni::ref<java::lang::String> theProp, jint defaultVal) { return object_base::new_object(theProp, defaultVal); }
