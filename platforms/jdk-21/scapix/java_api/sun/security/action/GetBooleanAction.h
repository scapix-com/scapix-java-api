...
namespace scapix::java_api { namespace sun::security::action { class GetBooleanAction; }}
...
public:
	...
	static jni::ref<sun::security::action::GetBooleanAction> new_object(jni::ref<java::lang::String> theProp) { return object_base::new_object(theProp); }
	jni::ref<java::lang::Boolean> run() { return call_method<"run", jni::ref<java::lang::Boolean>>(); }
	static jboolean privilegedGetProperty(jni::ref<java::lang::String> theProp) { return call_static_method<"privilegedGetProperty", jboolean>(theProp); }
