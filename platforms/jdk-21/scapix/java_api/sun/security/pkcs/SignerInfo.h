...
namespace scapix::java_api { namespace sun::security::pkcs { class SignerInfo; }}
...
public:
	...
	static jni::ref<java::lang::String> makeSigAlg(jni::ref<sun::security::x509::AlgorithmId> digAlgId, jni::ref<sun::security::x509::AlgorithmId> encAlgId, jboolean directSign) { return call_static_method<"makeSigAlg", jni::ref<java::lang::String>>(digAlgId, encAlgId, directSign); }
