...
namespace scapix::java_api { namespace sun::security::x509 { class PolicyInformation; }}
...
public:
	...
	static jni::ref<sun::security::x509::PolicyInformation> new_object(jni::ref<sun::security::x509::CertificatePolicyId> policyIdentifier, jni::ref<java::util::Set> policyQualifiers) { return object_base::new_object(policyIdentifier, policyQualifiers); }
	static jni::ref<sun::security::x509::PolicyInformation> new_object(jni::ref<sun::security::util::DerValue> val) { return object_base::new_object(val); }
