...
public:
	...
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<java::math::BigInteger> num, jni::ref<java::util::Date> date) { return object_base::new_object(num, date); }
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<java::math::BigInteger> num, jni::ref<java::util::Date> date, jni::ref<sun::security::x509::CRLExtensions> crlEntryExts) { return object_base::new_object(num, date, crlEntryExts); }
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<jni::array<jbyte>> revokedCert) { return object_base::new_object(revokedCert); }
	static jni::ref<sun::security::x509::X509CRLEntryImpl> new_object(jni::ref<sun::security::util::DerValue> derValue) { return object_base::new_object(derValue); }
