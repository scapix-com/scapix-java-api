...
public:
	...
	static jni::ref<sun::security::x509::CertificatePolicySet> new_object(jni::ref<java::util::Vector> ids) { return base_::new_object(ids); }
	static jni::ref<sun::security::x509::CertificatePolicySet> new_object(jni::ref<sun::security::util::DerInputStream> in) { return base_::new_object(in); }
