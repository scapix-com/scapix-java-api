...
public:
	...
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::util::DerValue> derVal) { return base_::new_object(derVal); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::util::ObjectIdentifier> extensionId, jboolean critical, jni::ref<jni::array<jbyte>> extensionValue) { return base_::new_object(extensionId, critical, extensionValue); }
	static jni::ref<sun::security::x509::Extension> new_object(jni::ref<sun::security::x509::Extension> ext) { return base_::new_object(ext); }
