...
public:
	...
	static jni::ref<sun::reflect::annotation::TypeAnnotation_TypeAnnotationTarget> RECORD_COMPONENT() { return get_static_field<"RECORD_COMPONENT", jni::ref<sun::reflect::annotation::TypeAnnotation_TypeAnnotationTarget>>(); }
