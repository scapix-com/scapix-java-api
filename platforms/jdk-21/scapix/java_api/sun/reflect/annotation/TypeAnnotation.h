...
namespace scapix::java_api { namespace sun::reflect::annotation { class TypeAnnotation; }}
...
public:
	...
	static jni::ref<sun::reflect::annotation::TypeAnnotation> new_object(jni::ref<sun::reflect::annotation::TypeAnnotation_TypeAnnotationTargetInfo> targetInfo, jni::ref<sun::reflect::annotation::TypeAnnotation_LocationInfo> loc, jni::ref<java::lang::annotation::Annotation> annotation, jni::ref<java::lang::reflect::AnnotatedElement> baseDeclaration) { return object_base::new_object(targetInfo, loc, annotation, baseDeclaration); }
