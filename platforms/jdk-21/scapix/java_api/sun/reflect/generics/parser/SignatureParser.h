...
namespace scapix::java_api { namespace sun::reflect::generics::parser { class SignatureParser; }}
...
public:
	...
	jni::ref<sun::reflect::generics::tree::ClassSignature> parseClassSig(jni::ref<java::lang::String> s) { return call_method<"parseClassSig", jni::ref<sun::reflect::generics::tree::ClassSignature>>(s); }
	jni::ref<sun::reflect::generics::tree::MethodTypeSignature> parseMethodSig(jni::ref<java::lang::String> s) { return call_method<"parseMethodSig", jni::ref<sun::reflect::generics::tree::MethodTypeSignature>>(s); }
	jni::ref<sun::reflect::generics::tree::TypeSignature> parseTypeSig(jni::ref<java::lang::String> s) { return call_method<"parseTypeSig", jni::ref<sun::reflect::generics::tree::TypeSignature>>(s); }
