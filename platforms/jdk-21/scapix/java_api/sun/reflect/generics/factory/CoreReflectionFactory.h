...
namespace scapix::java_api { namespace sun::reflect::generics::factory { class CoreReflectionFactory; }}
...
public:
	...
	static jni::ref<sun::reflect::generics::factory::CoreReflectionFactory> make(jni::ref<java::lang::reflect::GenericDeclaration> d, jni::ref<sun::reflect::generics::scope::Scope> s) { return call_static_method<"make", jni::ref<sun::reflect::generics::factory::CoreReflectionFactory>>(d, s); }
	jni::ref<java::lang::reflect::TypeVariable> makeTypeVariable(jni::ref<java::lang::String> name, jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> bounds) { return call_method<"makeTypeVariable", jni::ref<java::lang::reflect::TypeVariable>>(name, bounds); }
	jni::ref<java::lang::reflect::WildcardType> makeWildcard(jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> ubs, jni::ref<jni::array<sun::reflect::generics::tree::FieldTypeSignature>> lbs) { return call_method<"makeWildcard", jni::ref<java::lang::reflect::WildcardType>>(ubs, lbs); }
	jni::ref<java::lang::reflect::ParameterizedType> makeParameterizedType(jni::ref<java::lang::reflect::Type> declaration, jni::ref<jni::array<java::lang::reflect::Type>> typeArgs, jni::ref<java::lang::reflect::Type> owner) { return call_method<"makeParameterizedType", jni::ref<java::lang::reflect::ParameterizedType>>(declaration, typeArgs, owner); }
	jni::ref<java::lang::reflect::TypeVariable> findTypeVariable(jni::ref<java::lang::String> name) { return call_method<"findTypeVariable", jni::ref<java::lang::reflect::TypeVariable>>(name); }
	jni::ref<java::lang::reflect::Type> makeNamedType(jni::ref<java::lang::String> name) { return call_method<"makeNamedType", jni::ref<java::lang::reflect::Type>>(name); }
	jni::ref<java::lang::reflect::Type> makeArrayType(jni::ref<java::lang::reflect::Type> componentType) { return call_method<"makeArrayType", jni::ref<java::lang::reflect::Type>>(componentType); }
