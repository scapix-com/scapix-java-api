...
namespace scapix::java_api { namespace sun::reflect::generics::tree { class ClassSignature; }}
...
public:
	...
	static jni::ref<sun::reflect::generics::tree::ClassSignature> make(jni::ref<jni::array<sun::reflect::generics::tree::FormalTypeParameter>> ftps, jni::ref<sun::reflect::generics::tree::ClassTypeSignature> sc, jni::ref<jni::array<sun::reflect::generics::tree::ClassTypeSignature>> sis) { return call_static_method<"make", jni::ref<sun::reflect::generics::tree::ClassSignature>>(ftps, sc, sis); }
