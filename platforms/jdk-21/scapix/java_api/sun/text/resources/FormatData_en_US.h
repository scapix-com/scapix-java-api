...
namespace scapix::java_api { namespace sun::text::resources { class FormatData_en_US; }}
...
public:
	...
	static jni::ref<sun::text::resources::FormatData_en_US> new_object() { return object_base::new_object(); }
