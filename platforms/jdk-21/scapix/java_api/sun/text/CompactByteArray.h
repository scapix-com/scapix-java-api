...
namespace scapix::java_api { namespace sun::text { class CompactByteArray; }}
...
public:
	...
	static jni::ref<sun::text::CompactByteArray> new_object(jbyte defaultValue) { return object_base::new_object(defaultValue); }
	static jni::ref<sun::text::CompactByteArray> new_object(jni::ref<jni::array<jshort>> indexArray, jni::ref<jni::array<jbyte>> newValues) { return object_base::new_object(indexArray, newValues); }
