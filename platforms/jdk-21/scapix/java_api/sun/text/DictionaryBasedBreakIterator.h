...
namespace scapix::java_api { namespace sun::text { class DictionaryBasedBreakIterator; }}
...
public:
	...
	static jni::ref<sun::text::DictionaryBasedBreakIterator> new_object(jni::ref<java::lang::String> ruleFile, jni::ref<jni::array<jbyte>> ruleData, jni::ref<java::lang::String> dictionaryFile, jni::ref<jni::array<jbyte>> dictionaryData) { return object_base::new_object(ruleFile, ruleData, dictionaryFile, dictionaryData); }
