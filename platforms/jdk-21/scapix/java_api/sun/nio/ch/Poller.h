...
public:
	...
	static void poll(jint fdVal, jint event, jlong nanos, jni::ref<java::util::function::BooleanSupplier> supplier) { return call_static_method<"poll", void>(fdVal, event, nanos, supplier); }
