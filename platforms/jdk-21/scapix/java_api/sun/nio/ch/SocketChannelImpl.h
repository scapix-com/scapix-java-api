...
namespace scapix::java_api { namespace sun::nio::ch { class SocketChannelImpl; }}
...
public:
	...
	jboolean connect(jni::ref<java::net::SocketAddress> remote) { return call_method<"connect", jboolean>(remote); }
