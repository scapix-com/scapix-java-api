...
namespace scapix::java_api { namespace sun::nio::cs { class UTF_8; }}
...
public:
	...
	static jni::ref<sun::nio::cs::UTF_8> INSTANCE() { return get_static_field<"INSTANCE", jni::ref<sun::nio::cs::UTF_8>>(); }

	static jni::ref<sun::nio::cs::UTF_8> new_object() { return object_base::new_object(); }
