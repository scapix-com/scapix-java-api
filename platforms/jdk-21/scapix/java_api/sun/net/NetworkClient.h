...
namespace scapix::java_api { namespace sun::net { class NetworkClient; }}
...
public:
	...
	static jni::ref<sun::net::NetworkClient> new_object(jni::ref<java::lang::String> host, jint port) { return object_base::new_object(host, port); }
