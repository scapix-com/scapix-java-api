...
public:
	...
	static jni::ref<sun::net::www::protocol::jar::URLJarFile> new_object(jni::ref<java::io::File> file) { return object_base::new_object(file); }
	static jni::ref<sun::net::www::protocol::jar::URLJarFile> new_object(jni::ref<java::io::File> file, jni::ref<sun::net::www::protocol::jar::URLJarFile_URLJarFileCloseController> closeController) { return object_base::new_object(file, closeController); }
