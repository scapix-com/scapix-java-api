...
public:
	...
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm, jni::ref<java::net::PasswordAuthentication> pw, jboolean isUTF8) { return base_::new_object(isProxy, host, port, realm, pw, isUTF8); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::lang::String> host, jint port, jni::ref<java::lang::String> realm, jni::ref<java::lang::String> auth) { return base_::new_object(isProxy, host, port, realm, auth); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::lang::String> realm, jni::ref<java::net::PasswordAuthentication> pw, jboolean isUTF8) { return base_::new_object(isProxy, url, realm, pw, isUTF8); }
	static jni::ref<sun::net::www::protocol::http::BasicAuthentication> new_object(jboolean isProxy, jni::ref<java::net::URL> url, jni::ref<java::lang::String> realm, jni::ref<java::lang::String> auth) { return base_::new_object(isProxy, url, realm, auth); }
