...
public:
	...
	static jni::ref<sun::net::www::protocol::jar::JarURLConnection> new_object(jni::ref<java::net::URL> url, jni::ref<sun::net::www::protocol::jar::Handler> handler) { return base_::new_object(url, handler); }
