...
namespace scapix::java_api { namespace sun::net { class SocksProxy; }}
...
public:
	...
	static jni::ref<sun::net::SocksProxy> create(jni::ref<java::net::SocketAddress> addr, jint version) { return call_static_method<"create", jni::ref<sun::net::SocksProxy>>(addr, version); }
