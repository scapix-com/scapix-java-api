...
namespace scapix::java_api { namespace sun::net::util { class SocketExceptions; }}
...
public:
	...
	static jni::ref<java::io::IOException> of(jni::ref<java::io::IOException> e, jni::ref<java::net::SocketAddress> addr) { return call_static_method<"of", jni::ref<java::io::IOException>>(e, addr); }
