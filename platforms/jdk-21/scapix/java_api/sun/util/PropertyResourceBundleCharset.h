...
namespace scapix::java_api { namespace sun::util { class PropertyResourceBundleCharset; }}
...
public:
	...
	static jni::ref<sun::util::PropertyResourceBundleCharset> new_object(jboolean strictUTF8) { return object_base::new_object(strictUTF8); }
	static jni::ref<sun::util::PropertyResourceBundleCharset> new_object(jni::ref<java::lang::String> canonicalName, jni::ref<jni::array<java::lang::String>> aliases) { return object_base::new_object(canonicalName, aliases); }
