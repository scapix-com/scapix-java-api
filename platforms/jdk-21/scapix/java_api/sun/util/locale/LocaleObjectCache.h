...
namespace scapix::java_api { namespace sun::util::locale { class LocaleObjectCache; }}
...
public:
	...
	static jni::ref<sun::util::locale::LocaleObjectCache> new_object() { return object_base::new_object(); }
	static jni::ref<sun::util::locale::LocaleObjectCache> new_object(jint initialCapacity, jfloat loadFactor, jint concurrencyLevel) { return object_base::new_object(initialCapacity, loadFactor, concurrencyLevel); }
