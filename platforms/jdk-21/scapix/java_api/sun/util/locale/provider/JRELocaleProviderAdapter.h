...
#include <scapix/java_api/sun/util/locale/provider/ResourceBundleBasedAdapter.h>

#ifndef SCAPIX_JAVA_API_SUN_UTIL_LOCALE_PROVIDER_JRELOCALEPROVIDERADAPTER_FWD
#define SCAPIX_JAVA_API_SUN_UTIL_LOCALE_PROVIDER_JRELOCALEPROVIDERADAPTER_FWD

#include <scapix/jni/java_api/macros_push.h>

namespace scapix::java_api { namespace sun::util::locale::provider { class JRELocaleProviderAdapter; }}

template<>
struct scapix::jni::object_traits<scapix::java_api::sun::util::locale::provider::JRELocaleProviderAdapter>
{
	static constexpr fixed_string class_name = "sun/util/locale/provider/JRELocaleProviderAdapter";
	using base_classes = std::tuple<scapix::java_api::sun::util::locale::provider::LocaleProviderAdapter, scapix::java_api::sun::util::locale::provider::ResourceBundleBasedAdapter>;
};

#include <scapix/jni/java_api/macros_pop.h>

#endif // SCAPIX_JAVA_API_SUN_UTIL_LOCALE_PROVIDER_JRELOCALEPROVIDERADAPTER_FWD

#if !defined(SCAPIX_JAVA_API_FWD) && !defined(SCAPIX_JAVA_API_SUN_UTIL_LOCALE_PROVIDER_JRELOCALEPROVIDERADAPTER)
#define SCAPIX_JAVA_API_SUN_UTIL_LOCALE_PROVIDER_JRELOCALEPROVIDERADAPTER
...
class sun::util::locale::provider::JRELocaleProviderAdapter : public jni::object_base<"sun/util/locale/provider/JRELocaleProviderAdapter",
	sun::util::locale::provider::LocaleProviderAdapter,
	sun::util::locale::provider::ResourceBundleBasedAdapter>
{
public:

	static jni::ref<sun::util::locale::provider::JRELocaleProviderAdapter> new_object() { return object_base::new_object(); }
	...
	jni::ref<java::util::Set> getLanguageTagSet(jni::ref<java::lang::String> category) { return call_method<"getLanguageTagSet", jni::ref<java::util::Set>>(category); }
...
#endif // SCAPIX_JAVA_API_SUN_UTIL_LOCALE_PROVIDER_JRELOCALEPROVIDERADAPTER
