...
namespace scapix::java_api { namespace sun::util::resources { class LocaleData_SupplementaryResourceBundleProvider; }}
...
public:
	...
	static jni::ref<sun::util::resources::LocaleData_SupplementaryResourceBundleProvider> new_object() { return object_base::new_object(); }
