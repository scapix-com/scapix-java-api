...
namespace scapix::java_api { namespace sun::util::resources { class LocaleNames; }}
...
public:
	...
	static jni::ref<sun::util::resources::LocaleNames> new_object() { return object_base::new_object(); }
