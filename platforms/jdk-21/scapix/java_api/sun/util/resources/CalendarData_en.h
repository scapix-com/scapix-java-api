...
namespace scapix::java_api { namespace sun::util::resources { class CalendarData_en; }}
...
public:
	...
	static jni::ref<sun::util::resources::CalendarData_en> new_object() { return object_base::new_object(); }
