...
namespace scapix::java_api { namespace sun::util::resources { class LocaleData; }}
...
public:
	...
	static jni::ref<sun::util::resources::LocaleData> new_object(jni::ref<sun::util::locale::provider::LocaleProviderAdapter_Type> type) { return object_base::new_object(type); }
