...
namespace scapix::java_api { namespace sun::util::calendar { class BaseCalendar_Date; }}
...
public:
	...
	jni::ref<sun::util::calendar::BaseCalendar_Date> setNormalizedDate(jint normalizedYear, jint month, jint dayOfMonth) { return call_method<"setNormalizedDate", jni::ref<sun::util::calendar::BaseCalendar_Date>>(normalizedYear, month, dayOfMonth); }
