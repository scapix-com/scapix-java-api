...
namespace scapix::java_api { namespace sun::util::cldr { class CLDRLocaleProviderAdapter; }}
...
public:
	...
	static jni::ref<sun::util::cldr::CLDRLocaleProviderAdapter> new_object() { return object_base::new_object(); }
