...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_SAXNOTRECOGNIZEDEXCEPTION
...
public:
	...
	static jni::ref<org::xml::sax::SAXNotRecognizedException> new_object() { return object_base::new_object(); }
	static jni::ref<org::xml::sax::SAXNotRecognizedException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
};
