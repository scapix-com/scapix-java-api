...
#ifndef SCAPIX_JAVA_API_ORG_IETF_JGSS_CHANNELBINDING
...
public:
	...
	static jni::ref<org::ietf::jgss::ChannelBinding> new_object(jni::ref<java::net::InetAddress> initAddr, jni::ref<java::net::InetAddress> acceptAddr, jni::ref<jni::array<jbyte>> appData) { return object_base::new_object(initAddr, acceptAddr, appData); }
	static jni::ref<org::ietf::jgss::ChannelBinding> new_object(jni::ref<jni::array<jbyte>> appData) { return object_base::new_object(appData); }
