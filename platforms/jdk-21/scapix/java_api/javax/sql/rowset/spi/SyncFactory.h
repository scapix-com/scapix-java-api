...
#ifndef SCAPIX_JAVA_API_JAVAX_SQL_ROWSET_SPI_SYNCFACTORY
...
public:
	...
	static void registerProvider(jni::ref<java::lang::String> providerID) { return call_static_method<"registerProvider", void>(providerID); }
	...
	static void unregisterProvider(jni::ref<java::lang::String> providerID) { return call_static_method<"unregisterProvider", void>(providerID); }
	static jni::ref<javax::sql::rowset::spi::SyncProvider> getInstance(jni::ref<java::lang::String> providerID) { return call_static_method<"getInstance", jni::ref<javax::sql::rowset::spi::SyncProvider>>(providerID); }
	...
	static void setLogger(jni::ref<java::util::logging::Logger> logger) { return call_static_method<"setLogger", void>(logger); }
	static void setLogger(jni::ref<java::util::logging::Logger> logger, jni::ref<java::util::logging::Level> level) { return call_static_method<"setLogger", void>(logger, level); }
	static jni::ref<java::util::logging::Logger> getLogger() { return call_static_method<"getLogger", jni::ref<java::util::logging::Logger>>(); }
	static void setJNDIContext(jni::ref<javax::naming::Context> ctx) { return call_static_method<"setJNDIContext", void>(ctx); }
};
