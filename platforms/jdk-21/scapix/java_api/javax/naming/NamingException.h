...
#ifndef SCAPIX_JAVA_API_JAVAX_NAMING_NAMINGEXCEPTION
...
public:
	...
	static jni::ref<javax::naming::NamingException> new_object(jni::ref<java::lang::String> explanation) { return object_base::new_object(explanation); }
	static jni::ref<javax::naming::NamingException> new_object() { return object_base::new_object(); }
	...
	void setResolvedName(jni::ref<javax::naming::Name> name) { return call_method<"setResolvedName", void>(name); }
	...
	void setRootCause(jni::ref<java::lang::Throwable> e) { return call_method<"setRootCause", void>(e); }
	...
	jni::ref<java::lang::String> toString(jboolean detail) { return call_method<"toString", jni::ref<java::lang::String>>(detail); }
};
