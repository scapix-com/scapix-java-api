...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_STREAM_FILEIMAGEINPUTSTREAM
...
public:
	...
	static jni::ref<javax::imageio::stream::FileImageInputStream> new_object(jni::ref<java::io::File> f) { return object_base::new_object(f); }
	static jni::ref<javax::imageio::stream::FileImageInputStream> new_object(jni::ref<java::io::RandomAccessFile> raf) { return object_base::new_object(raf); }
