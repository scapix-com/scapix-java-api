...
#ifndef SCAPIX_JAVA_API_JAVAX_IMAGEIO_PLUGINS_JPEG_JPEGIMAGEWRITEPARAM
...
public:
	...
	static jni::ref<javax::imageio::plugins::jpeg::JPEGImageWriteParam> new_object(jni::ref<java::util::Locale> locale) { return object_base::new_object(locale); }
	...
	void setEncodeTables(jni::ref<jni::array<javax::imageio::plugins::jpeg::JPEGQTable>> qTables, jni::ref<jni::array<javax::imageio::plugins::jpeg::JPEGHuffmanTable>> DCHuffmanTables, jni::ref<jni::array<javax::imageio::plugins::jpeg::JPEGHuffmanTable>> ACHuffmanTables) { return call_method<"setEncodeTables", void>(qTables, DCHuffmanTables, ACHuffmanTables); }
	...
	void setOptimizeHuffmanTables(jboolean optimize) { return call_method<"setOptimizeHuffmanTables", void>(optimize); }
