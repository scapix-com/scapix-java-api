...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_UNDO_UNDOABLEEDITSUPPORT
...
public:
	...
	static jni::ref<javax::swing::undo::UndoableEditSupport> new_object() { return object_base::new_object(); }
	static jni::ref<javax::swing::undo::UndoableEditSupport> new_object(jni::ref<java::lang::Object> r) { return object_base::new_object(r); }
	void addUndoableEditListener(jni::ref<javax::swing::event::UndoableEditListener> l) { return call_method<"addUndoableEditListener", void>(l); }
	void removeUndoableEditListener(jni::ref<javax::swing::event::UndoableEditListener> l) { return call_method<"removeUndoableEditListener", void>(l); }
	...
	void postEdit(jni::ref<javax::swing::undo::UndoableEdit> e) { return call_method<"postEdit", void>(e); }
