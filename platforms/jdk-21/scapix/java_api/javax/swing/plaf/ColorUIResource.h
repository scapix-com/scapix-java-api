...
public:
	...
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jint r, jint g, jint b) { return object_base::new_object(r, g, b); }
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jint rgb) { return object_base::new_object(rgb); }
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jfloat r, jfloat g, jfloat b) { return object_base::new_object(r, g, b); }
	static jni::ref<javax::swing::plaf::ColorUIResource> new_object(jni::ref<java::awt::Color> c) { return object_base::new_object(c); }
};
