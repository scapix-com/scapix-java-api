...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICCOMBOPOPUP
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicComboPopup> new_object(jni::ref<javax::swing::JComboBox> combo) { return object_base::new_object(combo); }
