...
class BasicTreeUI_TreeToggleAction;
...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PLAF_BASIC_BASICTREEUI_TREETOGGLEACTION
...
public:
	...
	static jni::ref<javax::swing::plaf::basic::BasicTreeUI_TreeToggleAction> new_object(jni::ref<javax::swing::plaf::basic::BasicTreeUI> this_0, jni::ref<java::lang::String> name) { return object_base::new_object(this_0, name); }
