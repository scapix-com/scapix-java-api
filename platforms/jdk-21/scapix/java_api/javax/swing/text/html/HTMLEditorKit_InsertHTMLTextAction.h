...
class HTMLEditorKit_InsertHTMLTextAction;
...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_HTML_HTMLEDITORKIT_INSERTHTMLTEXTACTION
...
public:
	...
	static jni::ref<javax::swing::text::html::HTMLEditorKit_InsertHTMLTextAction> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> html, jni::ref<javax::swing::text::html::HTML_Tag> parentTag, jni::ref<javax::swing::text::html::HTML_Tag> addTag) { return object_base::new_object(name, html, parentTag, addTag); }
	static jni::ref<javax::swing::text::html::HTMLEditorKit_InsertHTMLTextAction> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> html, jni::ref<javax::swing::text::html::HTML_Tag> parentTag, jni::ref<javax::swing::text::html::HTML_Tag> addTag, jni::ref<javax::swing::text::html::HTML_Tag> alternateParentTag, jni::ref<javax::swing::text::html::HTML_Tag> alternateAddTag) { return object_base::new_object(name, html, parentTag, addTag, alternateParentTag, alternateAddTag); }
