...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_TEXT_HTML_PARSER_ATTRIBUTELIST
...
public:
	...
	static jni::ref<javax::swing::text::html::parser::AttributeList> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<javax::swing::text::html::parser::AttributeList> new_object(jni::ref<java::lang::String> name, jint type, jint modifier, jni::ref<java::lang::String> value, jni::ref<java::util::Vector> values, jni::ref<javax::swing::text::html::parser::AttributeList> next) { return object_base::new_object(name, type, modifier, value, values, next); }
	...
	static jint name2type(jni::ref<java::lang::String> nm) { return call_static_method<"name2type", jint>(nm); }
	static jni::ref<java::lang::String> type2name(jint tp) { return call_static_method<"type2name", jni::ref<java::lang::String>>(tp); }
};
