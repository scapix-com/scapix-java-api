...
#ifndef SCAPIX_JAVA_API_JAVAX_SWING_PROGRESSMONITOR
...
public:
	...
	static jni::ref<javax::swing::ProgressMonitor> new_object(jni::ref<java::awt::Component> parentComponent, jni::ref<java::lang::Object> message, jni::ref<java::lang::String> note, jint min, jint max) { return object_base::new_object(parentComponent, message, note, min, max); }
	void setProgress(jint nv) { return call_method<"setProgress", void>(nv); }
	void close() { return call_method<"close", void>(); }
	jint getMinimum() { return call_method<"getMinimum", jint>(); }
	void setMinimum(jint m) { return call_method<"setMinimum", void>(m); }
	jint getMaximum() { return call_method<"getMaximum", jint>(); }
	void setMaximum(jint m) { return call_method<"setMaximum", void>(m); }
	jboolean isCanceled() { return call_method<"isCanceled", jboolean>(); }
	void setMillisToDecideToPopup(jint millisToDecideToPopup) { return call_method<"setMillisToDecideToPopup", void>(millisToDecideToPopup); }
	jint getMillisToDecideToPopup() { return call_method<"getMillisToDecideToPopup", jint>(); }
	void setMillisToPopup(jint millisToPopup) { return call_method<"setMillisToPopup", void>(millisToPopup); }
	jint getMillisToPopup() { return call_method<"getMillisToPopup", jint>(); }
	void setNote(jni::ref<java::lang::String> note) { return call_method<"setNote", void>(note); }
