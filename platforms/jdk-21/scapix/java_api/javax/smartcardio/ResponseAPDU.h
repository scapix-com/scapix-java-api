...
#ifndef SCAPIX_JAVA_API_JAVAX_SMARTCARDIO_RESPONSEAPDU
...
public:
	...
	static jni::ref<javax::smartcardio::ResponseAPDU> new_object(jni::ref<jni::array<jbyte>> apdu) { return object_base::new_object(apdu); }
