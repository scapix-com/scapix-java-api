...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_MIDI_SEQUENCE
...
public:
	...
	static jni::ref<javax::sound::midi::Sequence> new_object(jfloat divisionType, jint resolution) { return object_base::new_object(divisionType, resolution); }
	static jni::ref<javax::sound::midi::Sequence> new_object(jfloat divisionType, jint resolution, jint numTracks) { return object_base::new_object(divisionType, resolution, numTracks); }
	...
	jboolean deleteTrack(jni::ref<javax::sound::midi::Track> track) { return call_method<"deleteTrack", jboolean>(track); }
