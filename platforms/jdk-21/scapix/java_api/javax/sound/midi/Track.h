...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_MIDI_TRACK
...
public:
	...
	jboolean add(jni::ref<javax::sound::midi::MidiEvent> event) { return call_method<"add", jboolean>(event); }
	jboolean remove(jni::ref<javax::sound::midi::MidiEvent> event) { return call_method<"remove", jboolean>(event); }
	jni::ref<javax::sound::midi::MidiEvent> get(jint index) { return call_method<"get", jni::ref<javax::sound::midi::MidiEvent>>(index); }
