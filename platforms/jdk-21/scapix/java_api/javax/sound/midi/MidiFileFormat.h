...
#ifndef SCAPIX_JAVA_API_JAVAX_SOUND_MIDI_MIDIFILEFORMAT
...
public:
	...
	static jni::ref<javax::sound::midi::MidiFileFormat> new_object(jint type, jfloat divisionType, jint resolution, jint bytes, jlong microseconds) { return object_base::new_object(type, divisionType, resolution, bytes, microseconds); }
	static jni::ref<javax::sound::midi::MidiFileFormat> new_object(jint type, jfloat divisionType, jint resolution, jint bytes, jlong microseconds, jni::ref<java::util::Map> properties) { return object_base::new_object(type, divisionType, resolution, bytes, microseconds, properties); }
