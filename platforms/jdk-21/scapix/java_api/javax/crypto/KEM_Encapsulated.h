...
#ifndef SCAPIX_JAVA_API_JAVAX_CRYPTO_KEM_ENCAPSULATED
...
public:
	...
	static jni::ref<javax::crypto::KEM_Encapsulated> new_object(jni::ref<javax::crypto::SecretKey> key, jni::ref<jni::array<jbyte>> encapsulation, jni::ref<jni::array<jbyte>> params) { return object_base::new_object(key, encapsulation, params); }
