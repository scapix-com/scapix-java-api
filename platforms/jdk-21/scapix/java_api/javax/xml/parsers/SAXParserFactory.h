...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_PARSERS_SAXPARSERFACTORY
...
public:
	...
	static jni::ref<javax::xml::parsers::SAXParserFactory> newDefaultNSInstance() { return call_static_method<"newDefaultNSInstance", jni::ref<javax::xml::parsers::SAXParserFactory>>(); }
	static jni::ref<javax::xml::parsers::SAXParserFactory> newNSInstance() { return call_static_method<"newNSInstance", jni::ref<javax::xml::parsers::SAXParserFactory>>(); }
	static jni::ref<javax::xml::parsers::SAXParserFactory> newNSInstance(jni::ref<java::lang::String> factoryClassName, jni::ref<java::lang::ClassLoader> classLoader) { return call_static_method<"newNSInstance", jni::ref<javax::xml::parsers::SAXParserFactory>>(factoryClassName, classLoader); }
	static jni::ref<javax::xml::parsers::SAXParserFactory> newDefaultInstance() { return call_static_method<"newDefaultInstance", jni::ref<javax::xml::parsers::SAXParserFactory>>(); }
