...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_XMLSIGNATUREFACTORY
...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::XMLSignatureFactory> getInstance(jni::ref<java::lang::String> mechanismType) { return call_static_method<"getInstance", jni::ref<javax::xml::crypto::dsig::XMLSignatureFactory>>(mechanismType); }
	static jni::ref<javax::xml::crypto::dsig::XMLSignatureFactory> getInstance(jni::ref<java::lang::String> mechanismType, jni::ref<java::security::Provider> provider) { return call_static_method<"getInstance", jni::ref<javax::xml::crypto::dsig::XMLSignatureFactory>>(mechanismType, provider); }
	static jni::ref<javax::xml::crypto::dsig::XMLSignatureFactory> getInstance(jni::ref<java::lang::String> mechanismType, jni::ref<java::lang::String> provider) { return call_static_method<"getInstance", jni::ref<javax::xml::crypto::dsig::XMLSignatureFactory>>(mechanismType, provider); }
