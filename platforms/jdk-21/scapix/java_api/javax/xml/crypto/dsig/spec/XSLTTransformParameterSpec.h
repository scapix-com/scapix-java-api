...
#ifndef SCAPIX_JAVA_API_JAVAX_XML_CRYPTO_DSIG_SPEC_XSLTTRANSFORMPARAMETERSPEC
...
public:
	...
	static jni::ref<javax::xml::crypto::dsig::spec::XSLTTransformParameterSpec> new_object(jni::ref<javax::xml::crypto::XMLStructure> stylesheet) { return object_base::new_object(stylesheet); }
