...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVERINVOCATIONHANDLER
...
public:
	...
	static jni::ref<javax::management::MBeanServerInvocationHandler> new_object(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName) { return object_base::new_object(connection, objectName); }
	static jni::ref<javax::management::MBeanServerInvocationHandler> new_object(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName, jboolean isMXBean) { return object_base::new_object(connection, objectName, isMXBean); }
	...
	static jni::ref<java::lang::Object> newProxyInstance(jni::ref<javax::management::MBeanServerConnection> connection, jni::ref<javax::management::ObjectName> objectName, jni::ref<java::lang::Class> interfaceClass, jboolean notificationBroadcaster) { return call_static_method<"newProxyInstance", jni::ref<java::lang::Object>>(connection, objectName, interfaceClass, notificationBroadcaster); }
