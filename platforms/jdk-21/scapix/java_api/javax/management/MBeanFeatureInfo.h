...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANFEATUREINFO
...
public:
	...
	static jni::ref<javax::management::MBeanFeatureInfo> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> description) { return object_base::new_object(name, description); }
	static jni::ref<javax::management::MBeanFeatureInfo> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> description, jni::ref<javax::management::Descriptor> descriptor) { return object_base::new_object(name, description, descriptor); }
