...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANINFO
...
public:
	...
	static jni::ref<javax::management::MBeanInfo> new_object(jni::ref<java::lang::String> className, jni::ref<java::lang::String> description, jni::ref<jni::array<javax::management::MBeanAttributeInfo>> attributes, jni::ref<jni::array<javax::management::MBeanConstructorInfo>> constructors, jni::ref<jni::array<javax::management::MBeanOperationInfo>> operations, jni::ref<jni::array<javax::management::MBeanNotificationInfo>> notifications) { return object_base::new_object(className, description, attributes, constructors, operations, notifications); }
	static jni::ref<javax::management::MBeanInfo> new_object(jni::ref<java::lang::String> className, jni::ref<java::lang::String> description, jni::ref<jni::array<javax::management::MBeanAttributeInfo>> attributes, jni::ref<jni::array<javax::management::MBeanConstructorInfo>> constructors, jni::ref<jni::array<javax::management::MBeanOperationInfo>> operations, jni::ref<jni::array<javax::management::MBeanNotificationInfo>> notifications, jni::ref<javax::management::Descriptor> descriptor) { return object_base::new_object(className, description, attributes, constructors, operations, notifications, descriptor); }
