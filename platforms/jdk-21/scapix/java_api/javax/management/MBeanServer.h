...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER_FWD
#define SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER_FWD
...
template<>
struct scapix::jni::object_traits<scapix::java_api::javax::management::MBeanServer>
{
	static constexpr fixed_string class_name = "javax/management/MBeanServer";
...
#endif // SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER_FWD

#ifndef SCAPIX_JAVA_API_FWD
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER
#define SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER
...
class javax::management::MBeanServer : public jni::object_base<"javax/management/MBeanServer",
	java::lang::Object,
...
public:
	...
	jni::ref<java::io::ObjectInputStream> deserialize(jni::ref<javax::management::ObjectName> name, jni::ref<jni::array<jbyte>> data) { return call_method<"deserialize", jni::ref<java::io::ObjectInputStream>>(name, data); }
	jni::ref<java::io::ObjectInputStream> deserialize(jni::ref<java::lang::String> className, jni::ref<jni::array<jbyte>> data) { return call_method<"deserialize", jni::ref<java::io::ObjectInputStream>>(className, data); }
	jni::ref<java::io::ObjectInputStream> deserialize(jni::ref<java::lang::String> className, jni::ref<javax::management::ObjectName> loaderName, jni::ref<jni::array<jbyte>> data) { return call_method<"deserialize", jni::ref<java::io::ObjectInputStream>>(className, loaderName, data); }
...
#endif // SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVER
