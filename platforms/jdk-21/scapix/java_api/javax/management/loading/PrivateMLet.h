...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_LOADING_PRIVATEMLET
...
public:
	...
	static jni::ref<javax::management::loading::PrivateMLet> new_object(jni::ref<jni::array<java::net::URL>> urls, jboolean delegateToCLR) { return object_base::new_object(urls, delegateToCLR); }
	static jni::ref<javax::management::loading::PrivateMLet> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::lang::ClassLoader> parent, jboolean delegateToCLR) { return object_base::new_object(urls, parent, delegateToCLR); }
	static jni::ref<javax::management::loading::PrivateMLet> new_object(jni::ref<jni::array<java::net::URL>> urls, jni::ref<java::lang::ClassLoader> parent, jni::ref<java::net::URLStreamHandlerFactory> factory, jboolean delegateToCLR) { return object_base::new_object(urls, parent, factory, delegateToCLR); }
};
