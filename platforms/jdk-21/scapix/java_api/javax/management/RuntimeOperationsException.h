...
public:
	...
	static jni::ref<javax::management::RuntimeOperationsException> new_object(jni::ref<java::lang::RuntimeException> e) { return object_base::new_object(e); }
	static jni::ref<javax::management::RuntimeOperationsException> new_object(jni::ref<java::lang::RuntimeException> e, jni::ref<java::lang::String> message) { return object_base::new_object(e, message); }
