...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_OPENMBEAN_KEYALREADYEXISTSEXCEPTION
...
public:
	...
	static jni::ref<javax::management::openmbean::KeyAlreadyExistsException> new_object() { return object_base::new_object(); }
	static jni::ref<javax::management::openmbean::KeyAlreadyExistsException> new_object(jni::ref<java::lang::String> msg) { return object_base::new_object(msg); }
};
