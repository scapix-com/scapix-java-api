...
#ifndef SCAPIX_JAVA_API_JAVAX_MANAGEMENT_MBEANSERVERPERMISSION
...
public:
	...
	static jni::ref<javax::management::MBeanServerPermission> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<javax::management::MBeanServerPermission> new_object(jni::ref<java::lang::String> name, jni::ref<java::lang::String> actions) { return object_base::new_object(name, actions); }
