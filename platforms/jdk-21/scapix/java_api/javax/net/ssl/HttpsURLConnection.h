...
#ifndef SCAPIX_JAVA_API_JAVAX_NET_SSL_HTTPSURLCONNECTION
...
public:
	...
	static void setDefaultHostnameVerifier(jni::ref<javax::net::ssl::HostnameVerifier> v) { return call_static_method<"setDefaultHostnameVerifier", void>(v); }
	...
	void setHostnameVerifier(jni::ref<javax::net::ssl::HostnameVerifier> v) { return call_method<"setHostnameVerifier", void>(v); }
