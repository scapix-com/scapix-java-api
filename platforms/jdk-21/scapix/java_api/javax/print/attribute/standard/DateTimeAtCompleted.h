...
#ifndef SCAPIX_JAVA_API_JAVAX_PRINT_ATTRIBUTE_STANDARD_DATETIMEATCOMPLETED
...
public:
	...
	static jni::ref<javax::print::attribute::standard::DateTimeAtCompleted> new_object(jni::ref<java::util::Date> dateTime) { return object_base::new_object(dateTime); }
