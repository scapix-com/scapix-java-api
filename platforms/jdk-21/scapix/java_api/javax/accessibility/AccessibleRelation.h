...
#ifndef SCAPIX_JAVA_API_JAVAX_ACCESSIBILITY_ACCESSIBLERELATION
...
public:
	...
	static jni::ref<javax::accessibility::AccessibleRelation> new_object(jni::ref<java::lang::String> key) { return object_base::new_object(key); }
	static jni::ref<javax::accessibility::AccessibleRelation> new_object(jni::ref<java::lang::String> key, jni::ref<java::lang::Object> target) { return object_base::new_object(key, target); }
	static jni::ref<javax::accessibility::AccessibleRelation> new_object(jni::ref<java::lang::String> key, jni::ref<jni::array<java::lang::Object>> target) { return object_base::new_object(key, target); }
	...
	void setTarget(jni::ref<jni::array<java::lang::Object>> target) { return call_method<"setTarget", void>(target); }
};
