...
public:
	...
	static jni::ref<javax::security::sasl::RealmCallback> new_object(jni::ref<java::lang::String> prompt) { return object_base::new_object(prompt); }
	static jni::ref<javax::security::sasl::RealmCallback> new_object(jni::ref<java::lang::String> prompt, jni::ref<java::lang::String> defaultRealmInfo) { return object_base::new_object(prompt, defaultRealmInfo); }
};
