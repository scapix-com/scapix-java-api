...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_KERBEROS_KEYTAB
...
public:
	...
	static jni::ref<javax::security::auth::kerberos::KeyTab> getInstance(jni::ref<java::io::File> file) { return call_static_method<"getInstance", jni::ref<javax::security::auth::kerberos::KeyTab>>(file); }
	static jni::ref<javax::security::auth::kerberos::KeyTab> getUnboundInstance(jni::ref<java::io::File> file) { return call_static_method<"getUnboundInstance", jni::ref<javax::security::auth::kerberos::KeyTab>>(file); }
	static jni::ref<javax::security::auth::kerberos::KeyTab> getInstance(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> princ, jni::ref<java::io::File> file) { return call_static_method<"getInstance", jni::ref<javax::security::auth::kerberos::KeyTab>>(princ, file); }
	...
	static jni::ref<javax::security::auth::kerberos::KeyTab> getInstance(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> princ) { return call_static_method<"getInstance", jni::ref<javax::security::auth::kerberos::KeyTab>>(princ); }
	jni::ref<jni::array<javax::security::auth::kerberos::KerberosKey>> getKeys(jni::ref<javax::security::auth::kerberos::KerberosPrincipal> principal) { return call_method<"getKeys", jni::ref<jni::array<javax::security::auth::kerberos::KerberosKey>>>(principal); }
