...
#ifndef SCAPIX_JAVA_API_JAVAX_SECURITY_AUTH_SUBJECT
...
public:
	...
	static jni::ref<javax::security::auth::Subject> new_object() { return object_base::new_object(); }
	static jni::ref<javax::security::auth::Subject> new_object(jboolean readOnly, jni::ref<java::util::Set> principals, jni::ref<java::util::Set> pubCredentials, jni::ref<java::util::Set> privCredentials) { return object_base::new_object(readOnly, principals, pubCredentials, privCredentials); }
