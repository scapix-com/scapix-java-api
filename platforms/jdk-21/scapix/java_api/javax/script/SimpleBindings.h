...
#ifndef SCAPIX_JAVA_API_JAVAX_SCRIPT_SIMPLEBINDINGS
...
public:
	...
	static jni::ref<javax::script::SimpleBindings> new_object(jni::ref<java::util::Map> m) { return object_base::new_object(m); }
	static jni::ref<javax::script::SimpleBindings> new_object() { return object_base::new_object(); }
	jni::ref<java::lang::Object> put(jni::ref<java::lang::String> name, jni::ref<java::lang::Object> value) { return call_method<"put", jni::ref<java::lang::Object>>(name, value); }
	void putAll(jni::ref<java::util::Map> toMerge) { return call_method<"putAll", void>(toMerge); }
