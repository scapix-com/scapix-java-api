...
#ifndef SCAPIX_JAVA_API_COM_SUN_NIO_SCTP_SCTPMULTICHANNEL
...
public:
	...
	jni::ref<com::sun::nio::sctp::SctpMultiChannel> bind(jni::ref<java::net::SocketAddress> local) { return call_method<"bind", jni::ref<com::sun::nio::sctp::SctpMultiChannel>>(local); }
