...
#ifndef SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_THREADMXBEAN
...
public:
	...
	jlong getTotalThreadAllocatedBytes() { return call_method<"getTotalThreadAllocatedBytes", jlong>(); }
	jlong getCurrentThreadAllocatedBytes() { return call_method<"getCurrentThreadAllocatedBytes", jlong>(); }
