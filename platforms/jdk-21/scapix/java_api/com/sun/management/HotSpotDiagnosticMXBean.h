...
#ifndef SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_HOTSPOTDIAGNOSTICMXBEAN
#define SCAPIX_JAVA_API_COM_SUN_MANAGEMENT_HOTSPOTDIAGNOSTICMXBEAN

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/com/sun/management/HotSpotDiagnosticMXBean_ThreadDumpFormat.h>
...
public:
	...
	using ThreadDumpFormat = HotSpotDiagnosticMXBean_ThreadDumpFormat;
	...
	void dumpThreads(jni::ref<java::lang::String> outputFile, jni::ref<com::sun::management::HotSpotDiagnosticMXBean_ThreadDumpFormat> format) { return call_method<"dumpThreads", void>(outputFile, format); }
};
