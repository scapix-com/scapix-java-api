...
namespace scapix::java_api { namespace com::sun::crypto::provider { class KeyWrapCipher; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::KeyWrapCipher> new_object(jni::ref<com::sun::crypto::provider::FeedbackCipher> cipher, jni::ref<com::sun::crypto::provider::Padding> padding, jint keySize) { return object_base::new_object(cipher, padding, keySize); }
