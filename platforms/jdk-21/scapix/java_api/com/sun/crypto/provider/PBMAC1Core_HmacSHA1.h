...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBMAC1Core_HmacSHA1; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBMAC1Core_HmacSHA1> new_object() { return object_base::new_object(); }
