...
namespace scapix::java_api { namespace com::sun::crypto::provider { class TlsPrfGenerator_V10; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::TlsPrfGenerator_V10> new_object() { return object_base::new_object(); }
