...
namespace scapix::java_api { namespace com::sun::crypto::provider { class HmacPKCS12PBECore_HmacPKCS12PBE_SHA1; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::HmacPKCS12PBECore_HmacPKCS12PBE_SHA1> new_object() { return object_base::new_object(); }
