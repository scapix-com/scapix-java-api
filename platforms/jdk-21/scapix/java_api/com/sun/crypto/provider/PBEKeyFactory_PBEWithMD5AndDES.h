...
namespace scapix::java_api { namespace com::sun::crypto::provider { class PBEKeyFactory_PBEWithMD5AndDES; }}
...
public:
	...
	static jni::ref<com::sun::crypto::provider::PBEKeyFactory_PBEWithMD5AndDES> new_object() { return object_base::new_object(); }
