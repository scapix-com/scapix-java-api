...
#include <scapix/java_api/com/sun/net/httpserver/Request.h>
...
struct scapix::jni::object_traits<scapix::java_api::com::sun::net::httpserver::HttpExchange>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::java::lang::AutoCloseable, scapix::java_api::com::sun::net::httpserver::Request>;
};
...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_HTTPSERVER_HTTPEXCHANGE
