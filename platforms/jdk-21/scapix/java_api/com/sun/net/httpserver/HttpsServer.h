...
#ifndef SCAPIX_JAVA_API_COM_SUN_NET_HTTPSERVER_HTTPSSERVER
...
public:
	...
	static jni::ref<com::sun::net::httpserver::HttpsServer> create(jni::ref<java::net::InetSocketAddress> addr, jint backlog) { return call_static_method<"create", jni::ref<com::sun::net::httpserver::HttpsServer>>(addr, backlog); }
	static jni::ref<com::sun::net::httpserver::HttpsServer> create(jni::ref<java::net::InetSocketAddress> addr, jint backlog, jni::ref<java::lang::String> path, jni::ref<com::sun::net::httpserver::HttpHandler> handler, jni::ref<jni::array<com::sun::net::httpserver::Filter>> filters) { return call_static_method<"create", jni::ref<com::sun::net::httpserver::HttpsServer>>(addr, backlog, path, handler, filters); }
