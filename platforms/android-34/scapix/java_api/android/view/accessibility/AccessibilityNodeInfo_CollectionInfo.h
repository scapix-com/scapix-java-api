...
public:
	...
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_CollectionInfo> new_object(jint rowCount, jint columnCount, jboolean hierarchical) { return base_::new_object(rowCount, columnCount, hierarchical); }
	static jni::ref<android::view::accessibility::AccessibilityNodeInfo_CollectionInfo> new_object(jint rowCount, jint columnCount, jboolean hierarchical, jint selectionMode) { return base_::new_object(rowCount, columnCount, hierarchical, selectionMode); }
