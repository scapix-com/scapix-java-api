...
#ifndef SCAPIX_JAVA_API_ANDROID_CREDENTIALS_CREATECREDENTIALEXCEPTION
...
public:
	...
	static jni::ref<android::credentials::CreateCredentialException> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::String> message) { return object_base::new_object(type, message); }
	static jni::ref<android::credentials::CreateCredentialException> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::String> message, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(type, message, cause); }
	static jni::ref<android::credentials::CreateCredentialException> new_object(jni::ref<java::lang::String> type, jni::ref<java::lang::Throwable> cause) { return object_base::new_object(type, cause); }
	static jni::ref<android::credentials::CreateCredentialException> new_object(jni::ref<java::lang::String> type) { return object_base::new_object(type); }
