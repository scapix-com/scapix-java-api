...
#ifndef SCAPIX_JAVA_API_ANDROID_CREDENTIALS_GETCREDENTIALRESPONSE
...
public:
	...
	static jni::ref<android::credentials::GetCredentialResponse> new_object(jni::ref<android::credentials::Credential> credential) { return object_base::new_object(credential); }
