...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_UTIL_LINKIFY
...
public:
	...
	static jni::ref<android::text::util::Linkify> new_object() { return object_base::new_object(); }
	...
	static jboolean addLinks(jni::ref<android::text::Spannable> text, jint mask, jni::ref<java::util::function::Function> urlSpanFactory) { return call_static_method<"addLinks", jboolean>(text, mask, urlSpanFactory); }
	...
	static jboolean addLinks(jni::ref<android::text::Spannable> spannable, jni::ref<java::util::regex::Pattern> pattern, jni::ref<java::lang::String> defaultScheme, jni::ref<jni::array<java::lang::String>> schemes, jni::ref<android::text::util::Linkify_MatchFilter> matchFilter, jni::ref<android::text::util::Linkify_TransformFilter> transformFilter, jni::ref<java::util::function::Function> urlSpanFactory) { return call_static_method<"addLinks", jboolean>(spannable, pattern, defaultScheme, schemes, matchFilter, transformFilter, urlSpanFactory); }
};
