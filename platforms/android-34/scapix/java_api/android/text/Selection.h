...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_SELECTION
...
public:
	...
	static jboolean moveToParagraphStart(jni::ref<android::text::Spannable> text, jni::ref<android::text::Layout> layout) { return call_static_method<"moveToParagraphStart", jboolean>(text, layout); }
	static jboolean moveToParagraphEnd(jni::ref<android::text::Spannable> text, jni::ref<android::text::Layout> layout) { return call_static_method<"moveToParagraphEnd", jboolean>(text, layout); }
	static jboolean extendToParagraphStart(jni::ref<android::text::Spannable> text) { return call_static_method<"extendToParagraphStart", jboolean>(text); }
	static jboolean extendToParagraphEnd(jni::ref<android::text::Spannable> text) { return call_static_method<"extendToParagraphEnd", jboolean>(text); }
