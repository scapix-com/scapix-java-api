...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_METHOD_LINKMOVEMENTMETHOD
...
public:
	...
	static jni::ref<android::text::method::LinkMovementMethod> new_object() { return object_base::new_object(); }
