...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_SUGGESTIONSPAN
...
public:
	...
	static jint FLAG_GRAMMAR_ERROR() { return get_static_field<"FLAG_GRAMMAR_ERROR", jint>(); }
	...
	static jni::ref<android::text::style::SuggestionSpan> new_object(jni::ref<android::content::Context> context, jni::ref<jni::array<java::lang::String>> suggestions, jint flags) { return object_base::new_object(context, suggestions, flags); }
	static jni::ref<android::text::style::SuggestionSpan> new_object(jni::ref<java::util::Locale> locale, jni::ref<jni::array<java::lang::String>> suggestions, jint flags) { return object_base::new_object(locale, suggestions, flags); }
	static jni::ref<android::text::style::SuggestionSpan> new_object(jni::ref<android::content::Context> context, jni::ref<java::util::Locale> locale, jni::ref<jni::array<java::lang::String>> suggestions, jint flags, jni::ref<java::lang::Class> notificationTargetClass) { return object_base::new_object(context, locale, suggestions, flags, notificationTargetClass); }
	static jni::ref<android::text::style::SuggestionSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
