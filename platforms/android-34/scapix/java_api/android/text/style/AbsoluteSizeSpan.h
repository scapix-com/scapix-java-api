...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_ABSOLUTESIZESPAN
...
public:
	...
	static jni::ref<android::text::style::AbsoluteSizeSpan> new_object(jint size) { return object_base::new_object(size); }
	static jni::ref<android::text::style::AbsoluteSizeSpan> new_object(jint size, jboolean dip) { return object_base::new_object(size, dip); }
	static jni::ref<android::text::style::AbsoluteSizeSpan> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
