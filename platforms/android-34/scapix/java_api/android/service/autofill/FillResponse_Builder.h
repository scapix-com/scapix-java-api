...
#ifndef SCAPIX_JAVA_API_ANDROID_SERVICE_AUTOFILL_FILLRESPONSE_BUILDER
...
public:
	...
	static jni::ref<android::service::autofill::FillResponse_Builder> new_object() { return object_base::new_object(); }
	jni::ref<android::service::autofill::FillResponse_Builder> setDetectedFieldClassifications(jni::ref<java::util::Set> fieldInfos) { return call_method<"setDetectedFieldClassifications", jni::ref<android::service::autofill::FillResponse_Builder>>(fieldInfos); }
	...
	jni::ref<android::service::autofill::FillResponse_Builder> setIconResourceId(jint id) { return call_method<"setIconResourceId", jni::ref<android::service::autofill::FillResponse_Builder>>(id); }
	jni::ref<android::service::autofill::FillResponse_Builder> setServiceDisplayNameResourceId(jint id) { return call_method<"setServiceDisplayNameResourceId", jni::ref<android::service::autofill::FillResponse_Builder>>(id); }
	jni::ref<android::service::autofill::FillResponse_Builder> setShowFillDialogIcon(jboolean show) { return call_method<"setShowFillDialogIcon", jni::ref<android::service::autofill::FillResponse_Builder>>(show); }
	jni::ref<android::service::autofill::FillResponse_Builder> setShowSaveDialogIcon(jboolean show) { return call_method<"setShowSaveDialogIcon", jni::ref<android::service::autofill::FillResponse_Builder>>(show); }
