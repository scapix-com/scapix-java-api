...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_LOCALELIST
...
public:
	...
	static jni::ref<android::os::LocaleList> new_object(jni::ref<jni::array<java::util::Locale>> list) { return object_base::new_object(list); }
	...
	static jboolean matchesLanguageAndScript(jni::ref<java::util::Locale> supported, jni::ref<java::util::Locale> desired) { return call_static_method<"matchesLanguageAndScript", jboolean>(supported, desired); }
