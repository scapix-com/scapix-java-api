...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_STORAGE_STORAGEMANAGER
...
public:
	...
	jni::ref<java::util::List> getStorageVolumesIncludingSharedProfiles() { return call_method<"getStorageVolumesIncludingSharedProfiles", jni::ref<java::util::List>>(); }
