...
class GnssAutomaticGainControl_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_LOCATION_GNSSAUTOMATICGAINCONTROL_BUILDER
...
public:
	...
	static jni::ref<android::location::GnssAutomaticGainControl_Builder> new_object() { return object_base::new_object(); }
	static jni::ref<android::location::GnssAutomaticGainControl_Builder> new_object(jni::ref<android::location::GnssAutomaticGainControl> agc) { return object_base::new_object(agc); }
