...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_UTIL_ULOCALE_BUILDER
...
public:
	...
	static jni::ref<android::icu::util::ULocale_Builder> new_object() { return object_base::new_object(); }
