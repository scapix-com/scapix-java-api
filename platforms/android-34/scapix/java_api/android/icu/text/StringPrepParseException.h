...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_STRINGPREPPARSEEXCEPTION
...
public:
	...
	static jni::ref<android::icu::text::StringPrepParseException> new_object(jni::ref<java::lang::String> message, jint error) { return object_base::new_object(message, error); }
	static jni::ref<android::icu::text::StringPrepParseException> new_object(jni::ref<java::lang::String> message, jint error, jni::ref<java::lang::String> rules, jint pos) { return object_base::new_object(message, error, rules, pos); }
	static jni::ref<android::icu::text::StringPrepParseException> new_object(jni::ref<java::lang::String> message, jint error, jni::ref<java::lang::String> rules, jint pos, jint lineNumber) { return object_base::new_object(message, error, rules, pos, lineNumber); }
