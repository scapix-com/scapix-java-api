...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_TEXT_MESSAGEPATTERN
...
public:
	...
	static jni::ref<android::icu::text::MessagePattern> new_object() { return object_base::new_object(); }
	static jni::ref<android::icu::text::MessagePattern> new_object(jni::ref<android::icu::text::MessagePattern_ApostropheMode> mode) { return object_base::new_object(mode); }
	static jni::ref<android::icu::text::MessagePattern> new_object(jni::ref<java::lang::String> pattern) { return object_base::new_object(pattern); }
