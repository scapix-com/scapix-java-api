...
class PowerRecord_PowerRecordSample;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_POWERRECORD_POWERRECORDSAMPLE
...
public:
	...
	static jni::ref<android::health::connect::datatypes::PowerRecord_PowerRecordSample> new_object(jni::ref<android::health::connect::datatypes::units::Power> power, jni::ref<java::time::Instant> time) { return object_base::new_object(power, time); }
