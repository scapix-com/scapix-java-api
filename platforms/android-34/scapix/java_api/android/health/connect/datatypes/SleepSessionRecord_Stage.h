...
class SleepSessionRecord_Stage;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_SLEEPSESSIONRECORD_STAGE
...
public:
	...
	static jni::ref<android::health::connect::datatypes::SleepSessionRecord_Stage> new_object(jni::ref<java::time::Instant> startTime, jni::ref<java::time::Instant> endTime, jint stageType) { return object_base::new_object(startTime, endTime, stageType); }
