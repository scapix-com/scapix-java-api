...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_SPEEDRECORD_BUILDER
...
public:
	...
	static jni::ref<android::health::connect::datatypes::SpeedRecord_Builder> new_object(jni::ref<android::health::connect::datatypes::Metadata> metadata, jni::ref<java::time::Instant> startTime, jni::ref<java::time::Instant> endTime, jni::ref<java::util::List> speedRecordSamples) { return object_base::new_object(metadata, startTime, endTime, speedRecordSamples); }
