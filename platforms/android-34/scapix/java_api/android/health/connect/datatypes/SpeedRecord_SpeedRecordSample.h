...
class SpeedRecord_SpeedRecordSample;
...
#ifndef SCAPIX_JAVA_API_ANDROID_HEALTH_CONNECT_DATATYPES_SPEEDRECORD_SPEEDRECORDSAMPLE
...
public:
	...
	static jni::ref<android::health::connect::datatypes::SpeedRecord_SpeedRecordSample> new_object(jni::ref<android::health::connect::datatypes::units::Velocity> speed, jni::ref<java::time::Instant> time) { return object_base::new_object(speed, time); }
