...
#ifndef SCAPIX_JAVA_API_ANDROID_NFC_NFCANTENNAINFO
...
public:
	...
	static jni::ref<android::nfc::NfcAntennaInfo> new_object(jint deviceWidth, jint deviceHeight, jboolean deviceFoldable, jni::ref<java::util::List> availableNfcAntennas) { return object_base::new_object(deviceWidth, deviceHeight, deviceFoldable, availableNfcAntennas); }
