...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_ALPHABETINDEXER
...
public:
	...
	static jni::ref<android::widget::AlphabetIndexer> new_object(jni::ref<android::database::Cursor> cursor, jint sortedColumnIndex, jni::ref<java::lang::CharSequence> alphabet) { return object_base::new_object(cursor, sortedColumnIndex, alphabet); }
