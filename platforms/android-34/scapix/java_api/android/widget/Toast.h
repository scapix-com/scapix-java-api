...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_TOAST
#define SCAPIX_JAVA_API_ANDROID_WIDGET_TOAST

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/content/Context.h>
#include <scapix/java_api/android/view/View.h>
#include <scapix/java_api/android/widget/Toast_Callback.h>
...
public:
	...
	static jni::ref<android::widget::Toast> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	void addCallback(jni::ref<android::widget::Toast_Callback> callback) { return call_method<"addCallback", void>(callback); }
	void removeCallback(jni::ref<android::widget::Toast_Callback> callback) { return call_method<"removeCallback", void>(callback); }
