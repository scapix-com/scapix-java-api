...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_SPEECHRECOGNIZER
...
public:
	...
	static jni::ref<java::lang::String> DETECTED_LANGUAGE() { return get_static_field<"DETECTED_LANGUAGE", jni::ref<java::lang::String>>(); }
	...
	static jint ERROR_CANNOT_LISTEN_TO_DOWNLOAD_EVENTS() { return get_static_field<"ERROR_CANNOT_LISTEN_TO_DOWNLOAD_EVENTS", jint>(); }
	...
	static jni::ref<java::lang::String> LANGUAGE_DETECTION_CONFIDENCE_LEVEL() { return get_static_field<"LANGUAGE_DETECTION_CONFIDENCE_LEVEL", jni::ref<java::lang::String>>(); }
	static jint LANGUAGE_DETECTION_CONFIDENCE_LEVEL_CONFIDENT() { return get_static_field<"LANGUAGE_DETECTION_CONFIDENCE_LEVEL_CONFIDENT", jint>(); }
	static jint LANGUAGE_DETECTION_CONFIDENCE_LEVEL_HIGHLY_CONFIDENT() { return get_static_field<"LANGUAGE_DETECTION_CONFIDENCE_LEVEL_HIGHLY_CONFIDENT", jint>(); }
	static jint LANGUAGE_DETECTION_CONFIDENCE_LEVEL_NOT_CONFIDENT() { return get_static_field<"LANGUAGE_DETECTION_CONFIDENCE_LEVEL_NOT_CONFIDENT", jint>(); }
	static jint LANGUAGE_DETECTION_CONFIDENCE_LEVEL_UNKNOWN() { return get_static_field<"LANGUAGE_DETECTION_CONFIDENCE_LEVEL_UNKNOWN", jint>(); }
	static jni::ref<java::lang::String> LANGUAGE_SWITCH_RESULT() { return get_static_field<"LANGUAGE_SWITCH_RESULT", jni::ref<java::lang::String>>(); }
	static jint LANGUAGE_SWITCH_RESULT_FAILED() { return get_static_field<"LANGUAGE_SWITCH_RESULT_FAILED", jint>(); }
	static jint LANGUAGE_SWITCH_RESULT_NOT_ATTEMPTED() { return get_static_field<"LANGUAGE_SWITCH_RESULT_NOT_ATTEMPTED", jint>(); }
	static jint LANGUAGE_SWITCH_RESULT_SKIPPED_NO_MODEL() { return get_static_field<"LANGUAGE_SWITCH_RESULT_SKIPPED_NO_MODEL", jint>(); }
	static jint LANGUAGE_SWITCH_RESULT_SUCCEEDED() { return get_static_field<"LANGUAGE_SWITCH_RESULT_SUCCEEDED", jint>(); }
	static jni::ref<java::lang::String> RECOGNITION_PARTS() { return get_static_field<"RECOGNITION_PARTS", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> RESULTS_ALTERNATIVES() { return get_static_field<"RESULTS_ALTERNATIVES", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> RESULTS_RECOGNITION() { return get_static_field<"RESULTS_RECOGNITION", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> TOP_LOCALE_ALTERNATIVES() { return get_static_field<"TOP_LOCALE_ALTERNATIVES", jni::ref<java::lang::String>>(); }
	...
	void triggerModelDownload(jni::ref<android::content::Intent> recognizerIntent, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::speech::ModelDownloadListener> listener) { return call_method<"triggerModelDownload", void>(recognizerIntent, executor, listener); }
