...
#ifndef SCAPIX_JAVA_API_ANDROID_SE_OMAPI_SESERVICE
...
public:
	...
	static jni::ref<java::lang::String> ACTION_SECURE_ELEMENT_STATE_CHANGED() { return get_static_field<"ACTION_SECURE_ELEMENT_STATE_CHANGED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_READER_NAME() { return get_static_field<"EXTRA_READER_NAME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> EXTRA_READER_STATE() { return get_static_field<"EXTRA_READER_STATE", jni::ref<java::lang::String>>(); }

	static jni::ref<android::se::omapi::SEService> new_object(jni::ref<android::content::Context> context, jni::ref<java::util::concurrent::Executor> executor, jni::ref<android::se::omapi::SEService_OnConnectedListener> listener) { return object_base::new_object(context, executor, listener); }
