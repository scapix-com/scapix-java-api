...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_DISCONNECTCAUSE
...
public:
	...
	static jni::ref<java::lang::String> REASON_EMERGENCY_CALL_PLACED() { return get_static_field<"REASON_EMERGENCY_CALL_PLACED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> REASON_EMULATING_SINGLE_CALL() { return get_static_field<"REASON_EMULATING_SINGLE_CALL", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> REASON_IMS_ACCESS_BLOCKED() { return get_static_field<"REASON_IMS_ACCESS_BLOCKED", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> REASON_WIFI_ON_BUT_WFC_OFF() { return get_static_field<"REASON_WIFI_ON_BUT_WFC_OFF", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::telecom::DisconnectCause> new_object(jint code) { return object_base::new_object(code); }
	static jni::ref<android::telecom::DisconnectCause> new_object(jint code, jni::ref<java::lang::String> reason) { return object_base::new_object(code, reason); }
	static jni::ref<android::telecom::DisconnectCause> new_object(jint code, jni::ref<java::lang::CharSequence> label, jni::ref<java::lang::CharSequence> description, jni::ref<java::lang::String> reason) { return object_base::new_object(code, label, description, reason); }
	static jni::ref<android::telecom::DisconnectCause> new_object(jint code, jni::ref<java::lang::CharSequence> label, jni::ref<java::lang::CharSequence> description, jni::ref<java::lang::String> reason, jint toneToPlay) { return object_base::new_object(code, label, description, reason, toneToPlay); }
