...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_CALLENDPOINTEXCEPTION
...
public:
	...
	static jni::ref<android::telecom::CallEndpointException> new_object(jni::ref<java::lang::String> message, jint code) { return object_base::new_object(message, code); }
