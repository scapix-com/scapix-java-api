...
public:
	...
	void queryLocationForEmergency(jlong timeoutMillis, jni::ref<java::lang::String> p2, jni::ref<java::util::concurrent::Executor> provider, jni::ref<android::os::OutcomeReceiver> executor) { return call_method<"queryLocationForEmergency", void>(timeoutMillis, p2, provider, executor); }
