...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_VIDEOPROFILE
...
public:
	...
	static jni::ref<android::telecom::VideoProfile> new_object(jint videoState) { return object_base::new_object(videoState); }
	static jni::ref<android::telecom::VideoProfile> new_object(jint videoState, jint quality) { return object_base::new_object(videoState, quality); }
