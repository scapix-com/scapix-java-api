...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_LOGPRINTER
...
public:
	...
	static jni::ref<android::util::LogPrinter> new_object(jint priority, jni::ref<java::lang::String> tag) { return object_base::new_object(priority, tag); }
