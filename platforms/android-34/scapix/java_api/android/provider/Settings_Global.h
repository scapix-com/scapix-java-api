...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_SETTINGS_GLOBAL
...
public:
	...
	static jni::ref<java::lang::String> APPLY_RAMPING_RINGER() { return get_static_field<"APPLY_RAMPING_RINGER", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> DEVICE_NAME() { return get_static_field<"DEVICE_NAME", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> SECURE_FRP_MODE() { return get_static_field<"SECURE_FRP_MODE", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<android::provider::Settings_Global> new_object() { return object_base::new_object(); }
