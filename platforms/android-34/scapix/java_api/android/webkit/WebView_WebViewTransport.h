...
class WebView_WebViewTransport;
...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_WEBVIEW_WEBVIEWTRANSPORT
...
public:
	...
	static jni::ref<android::webkit::WebView_WebViewTransport> new_object(jni::ref<android::webkit::WebView> this_0) { return object_base::new_object(this_0); }
