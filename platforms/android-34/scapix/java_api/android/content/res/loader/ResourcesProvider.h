...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_RES_LOADER_RESOURCESPROVIDER
#define SCAPIX_JAVA_API_ANDROID_CONTENT_RES_LOADER_RESOURCESPROVIDER

#define SCAPIX_JAVA_API_FWD
#include <scapix/java_api/android/content/Context.h>
#include <scapix/java_api/android/content/om/OverlayInfo.h>
...
public:
	...
	static jni::ref<android::content::res::loader::ResourcesProvider> loadOverlay(jni::ref<android::content::om::OverlayInfo> overlayInfo) { return call_static_method<"loadOverlay", jni::ref<android::content::res::loader::ResourcesProvider>>(overlayInfo); }
