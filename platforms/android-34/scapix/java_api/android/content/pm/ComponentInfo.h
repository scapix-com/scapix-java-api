...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_PM_COMPONENTINFO
...
public:
	...
	jni::ref<jni::array<java::lang::String>> attributionTags() { return get_field<"attributionTags", jni::ref<jni::array<java::lang::String>>>(); }
	void attributionTags(jni::ref<jni::array<java::lang::String>> v) { set_field<"attributionTags", jni::ref<jni::array<java::lang::String>>>(v); }
	...
	static jni::ref<android::content::pm::ComponentInfo> new_object() { return object_base::new_object(); }
	static jni::ref<android::content::pm::ComponentInfo> new_object(jni::ref<android::content::pm::ComponentInfo> orig) { return object_base::new_object(orig); }
