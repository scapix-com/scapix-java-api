...
public:
	...
	static jni::ref<android::content::pm::VersionedPackage> new_object(jni::ref<java::lang::String> packageName, jlong versionCode) { return base_::new_object(packageName, versionCode); }
