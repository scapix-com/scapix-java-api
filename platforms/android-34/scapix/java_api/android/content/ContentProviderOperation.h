...
#ifndef SCAPIX_JAVA_API_ANDROID_CONTENT_CONTENTPROVIDEROPERATION
...
public:
	...
	static jni::ref<android::content::ContentProviderOperation_Builder> newCall(jni::ref<android::net::Uri> uri, jni::ref<java::lang::String> method, jni::ref<java::lang::String> arg) { return call_static_method<"newCall", jni::ref<android::content::ContentProviderOperation_Builder>>(uri, method, arg); }
	...
	jboolean isExceptionAllowed() { return call_method<"isExceptionAllowed", jboolean>(); }
	...
	jboolean isCall() { return call_method<"isCall", jboolean>(); }
	...
	jni::ref<android::os::Bundle> resolveExtrasBackReferences(jni::ref<jni::array<android::content::ContentProviderResult>> backRefs, jint numBackRefs) { return call_method<"resolveExtrasBackReferences", jni::ref<android::os::Bundle>>(backRefs, numBackRefs); }
