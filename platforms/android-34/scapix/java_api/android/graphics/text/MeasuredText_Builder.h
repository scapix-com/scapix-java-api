...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_TEXT_MEASUREDTEXT_BUILDER
...
public:
	...
	static jint HYPHENATION_MODE_FAST() { return get_static_field<"HYPHENATION_MODE_FAST", jint>(); }
	static jint HYPHENATION_MODE_NONE() { return get_static_field<"HYPHENATION_MODE_NONE", jint>(); }
	static jint HYPHENATION_MODE_NORMAL() { return get_static_field<"HYPHENATION_MODE_NORMAL", jint>(); }

	static jni::ref<android::graphics::text::MeasuredText_Builder> new_object(jni::ref<jni::array<jchar>> text) { return object_base::new_object(text); }
	static jni::ref<android::graphics::text::MeasuredText_Builder> new_object(jni::ref<android::graphics::text::MeasuredText> text) { return object_base::new_object(text); }
	...
	jni::ref<android::graphics::text::MeasuredText_Builder> appendStyleRun(jni::ref<android::graphics::Paint> paint, jni::ref<android::graphics::text::LineBreakConfig> lineBreakConfig, jint length, jboolean isRtl) { return call_method<"appendStyleRun", jni::ref<android::graphics::text::MeasuredText_Builder>>(paint, lineBreakConfig, length, isRtl); }
	...
	jni::ref<android::graphics::text::MeasuredText_Builder> setComputeHyphenation(jint mode) { return call_method<"setComputeHyphenation", jni::ref<android::graphics::text::MeasuredText_Builder>>(mode); }
