...
class MeshSpecification_Attribute;
...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_MESHSPECIFICATION_ATTRIBUTE
...
public:
	...
	static jni::ref<android::graphics::MeshSpecification_Attribute> new_object(jint type, jint offset, jni::ref<java::lang::String> name) { return object_base::new_object(type, offset, name); }
