...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_COLORSPACE_RGB
...
public:
	...
	static jni::ref<android::graphics::ColorSpace_Rgb> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jfloat>> toXYZ, jni::ref<java::util::function::DoubleUnaryOperator> oetf, jni::ref<java::util::function::DoubleUnaryOperator> eotf) { return object_base::new_object(name, toXYZ, oetf, eotf); }
	static jni::ref<android::graphics::ColorSpace_Rgb> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jfloat>> primaries, jni::ref<jni::array<jfloat>> whitePoint, jni::ref<java::util::function::DoubleUnaryOperator> oetf, jni::ref<java::util::function::DoubleUnaryOperator> eotf, jfloat min, jfloat max) { return object_base::new_object(name, primaries, whitePoint, oetf, eotf, min, max); }
	static jni::ref<android::graphics::ColorSpace_Rgb> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jfloat>> toXYZ, jni::ref<android::graphics::ColorSpace_Rgb_TransferParameters> function) { return object_base::new_object(name, toXYZ, function); }
	static jni::ref<android::graphics::ColorSpace_Rgb> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jfloat>> primaries, jni::ref<jni::array<jfloat>> whitePoint, jni::ref<android::graphics::ColorSpace_Rgb_TransferParameters> function) { return object_base::new_object(name, primaries, whitePoint, function); }
	static jni::ref<android::graphics::ColorSpace_Rgb> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jfloat>> toXYZ, jdouble gamma) { return object_base::new_object(name, toXYZ, gamma); }
	static jni::ref<android::graphics::ColorSpace_Rgb> new_object(jni::ref<java::lang::String> name, jni::ref<jni::array<jfloat>> primaries, jni::ref<jni::array<jfloat>> whitePoint, jdouble gamma) { return object_base::new_object(name, primaries, whitePoint, gamma); }
