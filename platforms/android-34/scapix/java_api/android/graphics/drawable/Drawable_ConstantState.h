...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_DRAWABLE_DRAWABLE_CONSTANTSTATE
...
public:
	...
	static jni::ref<android::graphics::drawable::Drawable_ConstantState> new_object() { return object_base::new_object(); }
