...
public:
	...
	static jni::ref<android::accessibilityservice::AccessibilityGestureEvent> new_object(jint gestureId, jint displayId, jni::ref<java::util::List> motionEvents) { return base_::new_object(gestureId, displayId, motionEvents); }
