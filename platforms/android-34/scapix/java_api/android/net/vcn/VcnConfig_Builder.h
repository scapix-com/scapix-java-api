...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_VCN_VCNCONFIG_BUILDER
...
public:
	...
	static jni::ref<android::net::vcn::VcnConfig_Builder> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
