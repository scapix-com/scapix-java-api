...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_HTTP_QUICOPTIONS_BUILDER
...
public:
	...
	static jni::ref<android::net::http::QuicOptions_Builder> new_object() { return object_base::new_object(); }
