...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_NETWORK
...
public:
	...
	jni::ref<java::net::URLConnection> openConnection(jni::ref<java::net::URL> url, jni::ref<java::net::Proxy> proxy) { return call_method<"openConnection", jni::ref<java::net::URLConnection>>(url, proxy); }
	void bindSocket(jni::ref<java::net::DatagramSocket> socket) { return call_method<"bindSocket", void>(socket); }
	void bindSocket(jni::ref<java::net::Socket> socket) { return call_method<"bindSocket", void>(socket); }
	void bindSocket(jni::ref<java::io::FileDescriptor> fd) { return call_method<"bindSocket", void>(fd); }
	static jni::ref<android::net::Network> fromNetworkHandle(jlong networkHandle) { return call_static_method<"fromNetworkHandle", jni::ref<android::net::Network>>(networkHandle); }
	jlong getNetworkHandle() { return call_method<"getNetworkHandle", jlong>(); }
