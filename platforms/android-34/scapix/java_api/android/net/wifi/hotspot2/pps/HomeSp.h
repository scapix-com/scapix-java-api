...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_HOTSPOT2_PPS_HOMESP
...
public:
	...
	static jni::ref<android::net::wifi::hotspot2::pps::HomeSp> new_object() { return object_base::new_object(); }
	static jni::ref<android::net::wifi::hotspot2::pps::HomeSp> new_object(jni::ref<android::net::wifi::hotspot2::pps::HomeSp> source) { return object_base::new_object(source); }
	...
	void setMatchAllOis(jni::ref<jni::array<jlong>> matchAllOis) { return call_method<"setMatchAllOis", void>(matchAllOis); }
	jni::ref<jni::array<jlong>> getMatchAllOis() { return call_method<"getMatchAllOis", jni::ref<jni::array<jlong>>>(); }
	void setMatchAnyOis(jni::ref<jni::array<jlong>> matchAnyOis) { return call_method<"setMatchAnyOis", void>(matchAnyOis); }
	jni::ref<jni::array<jlong>> getMatchAnyOis() { return call_method<"getMatchAnyOis", jni::ref<jni::array<jlong>>>(); }
	void setOtherHomePartnersList(jni::ref<java::util::Collection> otherHomePartners) { return call_method<"setOtherHomePartnersList", void>(otherHomePartners); }
	jni::ref<java::util::Collection> getOtherHomePartnersList() { return call_method<"getOtherHomePartnersList", jni::ref<java::util::Collection>>(); }
