...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_AWARE_IDENTITYCHANGEDLISTENER
...
public:
	...
	static jni::ref<android::net::wifi::aware::IdentityChangedListener> new_object() { return object_base::new_object(); }
