...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFIMANAGER_ADDNETWORKRESULT
...
public:
	...
	static jni::ref<android::net::wifi::WifiManager_AddNetworkResult> new_object(jint statusCode, jint networkId) { return object_base::new_object(statusCode, networkId); }
