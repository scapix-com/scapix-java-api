...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFIMANAGER_LOCALONLYHOTSPOTCALLBACK
...
public:
	...
	static jni::ref<android::net::wifi::WifiManager_LocalOnlyHotspotCallback> new_object() { return object_base::new_object(); }
