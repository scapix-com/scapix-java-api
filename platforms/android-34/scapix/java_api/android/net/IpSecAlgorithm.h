...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSECALGORITHM
...
public:
	...
	static jni::ref<java::lang::String> AUTH_AES_CMAC() { return get_static_field<"AUTH_AES_CMAC", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> AUTH_AES_XCBC() { return get_static_field<"AUTH_AES_XCBC", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> AUTH_CRYPT_AES_GCM() { return get_static_field<"AUTH_CRYPT_AES_GCM", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> AUTH_CRYPT_CHACHA20_POLY1305() { return get_static_field<"AUTH_CRYPT_CHACHA20_POLY1305", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> CRYPT_AES_CTR() { return get_static_field<"CRYPT_AES_CTR", jni::ref<java::lang::String>>(); }

	static jni::ref<android::net::IpSecAlgorithm> new_object(jni::ref<java::lang::String> algorithm, jni::ref<jni::array<jbyte>> key) { return object_base::new_object(algorithm, key); }
	static jni::ref<android::net::IpSecAlgorithm> new_object(jni::ref<java::lang::String> algorithm, jni::ref<jni::array<jbyte>> key, jint truncLenBits) { return object_base::new_object(algorithm, key, truncLenBits); }
	...
	static jni::ref<java::util::Set> getSupportedAlgorithms() { return call_static_method<"getSupportedAlgorithms", jni::ref<java::util::Set>>(); }
