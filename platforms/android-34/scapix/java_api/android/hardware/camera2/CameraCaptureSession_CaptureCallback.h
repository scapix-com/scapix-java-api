...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERACAPTURESESSION_CAPTURECALLBACK
...
public:
	...
	static jni::ref<android::hardware::camera2::CameraCaptureSession_CaptureCallback> new_object() { return object_base::new_object(); }
	void onCaptureStarted(jni::ref<android::hardware::camera2::CameraCaptureSession> session, jni::ref<android::hardware::camera2::CaptureRequest> request, jlong timestamp, jlong frameNumber) { return call_method<"onCaptureStarted", void>(session, request, timestamp, frameNumber); }
	void onReadoutStarted(jni::ref<android::hardware::camera2::CameraCaptureSession> session, jni::ref<android::hardware::camera2::CaptureRequest> request, jlong timestamp, jlong frameNumber) { return call_method<"onReadoutStarted", void>(session, request, timestamp, frameNumber); }
