...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERACAPTURESESSION_STATECALLBACK
...
public:
	...
	static jni::ref<android::hardware::camera2::CameraCaptureSession_StateCallback> new_object() { return object_base::new_object(); }
