...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERAMANAGER_TORCHCALLBACK
...
public:
	...
	static jni::ref<android::hardware::camera2::CameraManager_TorchCallback> new_object() { return object_base::new_object(); }
	...
	void onTorchStrengthLevelChanged(jni::ref<java::lang::String> cameraId, jint newStrengthLevel) { return call_method<"onTorchStrengthLevelChanged", void>(cameraId, newStrengthLevel); }
};
