...
public:
	...
	static jni::ref<android::media::MediaCas> new_object(jint casSystemId) { return base_::new_object(casSystemId); }
	...
	static jni::ref<android::media::MediaCas> new_object(jni::ref<android::content::Context> context, jint casSystemId, jni::ref<java::lang::String> tvInputServiceSessionId, jint priorityHint, jni::ref<android::os::Handler> handler, jni::ref<android::media::MediaCas_EventListener> listener) { return base_::new_object(context, casSystemId, tvInputServiceSessionId, priorityHint, handler, listener); }
