...
struct scapix::jni::object_traits<scapix::java_api::android::media::MediaPlayer>
{
	...
	using base_classes = std::tuple<scapix::java_api::java::lang::Object, scapix::java_api::android::media::VolumeAutomation, scapix::java_api::android::media::AudioRouting>;
};
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_MEDIAPLAYER
...
public:
	...
	static jint MEDIA_INFO_STARTED_AS_NEXT() { return get_static_field<"MEDIA_INFO_STARTED_AS_NEXT", jint>(); }
	...
	static jni::ref<android::media::MediaPlayer> new_object() { return object_base::new_object(); }
	static jni::ref<android::media::MediaPlayer> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	...
	void seekTo(jlong msec, jint mode) { return call_method<"seekTo", void>(msec, mode); }
	...
	void setAudioSessionId(jint sessionId) { return call_method<"setAudioSessionId", void>(sessionId); }
	...
	void addTimedTextSource(jni::ref<java::io::FileDescriptor> fd, jlong offset, jlong length, jni::ref<java::lang::String> mime) { return call_method<"addTimedTextSource", void>(fd, offset, length, mime); }
	...
	void setOnSubtitleDataListener(jni::ref<android::media::MediaPlayer_OnSubtitleDataListener> listener, jni::ref<android::os::Handler> handler) { return call_method<"setOnSubtitleDataListener", void>(listener, handler); }
	void setOnSubtitleDataListener(jni::ref<android::media::MediaPlayer_OnSubtitleDataListener> listener) { return call_method<"setOnSubtitleDataListener", void>(listener); }
	void clearOnSubtitleDataListener() { return call_method<"clearOnSubtitleDataListener", void>(); }
	void setOnMediaTimeDiscontinuityListener(jni::ref<android::media::MediaPlayer_OnMediaTimeDiscontinuityListener> listener, jni::ref<android::os::Handler> handler) { return call_method<"setOnMediaTimeDiscontinuityListener", void>(listener, handler); }
	void setOnMediaTimeDiscontinuityListener(jni::ref<android::media::MediaPlayer_OnMediaTimeDiscontinuityListener> listener) { return call_method<"setOnMediaTimeDiscontinuityListener", void>(listener); }
	void clearOnMediaTimeDiscontinuityListener() { return call_method<"clearOnMediaTimeDiscontinuityListener", void>(); }
