...
public:
	...
	jni::ref<android::graphics::Bitmap> getFrameAtTime(jlong timeUs, jint p2, jni::ref<android::media::MediaMetadataRetriever_BitmapParams> option) { return call_method<"getFrameAtTime", jni::ref<android::graphics::Bitmap>>(timeUs, p2, option); }
	...
	jni::ref<android::graphics::Bitmap> getScaledFrameAtTime(jlong timeUs, jint p2, jint option, jint dstWidth, jni::ref<android::media::MediaMetadataRetriever_BitmapParams> dstHeight) { return call_method<"getScaledFrameAtTime", jni::ref<android::graphics::Bitmap>>(timeUs, p2, option, dstWidth, dstHeight); }
