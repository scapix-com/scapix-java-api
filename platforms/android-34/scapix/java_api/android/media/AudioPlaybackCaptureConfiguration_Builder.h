...
class AudioPlaybackCaptureConfiguration_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOPLAYBACKCAPTURECONFIGURATION_BUILDER
...
public:
	...
	static jni::ref<android::media::AudioPlaybackCaptureConfiguration_Builder> new_object(jni::ref<android::media::projection::MediaProjection> projection) { return object_base::new_object(projection); }
