...
public:
	...
	static jni::ref<android::media::MediaCrypto> new_object(jni::ref<java::util::UUID> uuid, jni::ref<jni::array<jbyte>> sessionId) { return base_::new_object(uuid, sessionId); }
