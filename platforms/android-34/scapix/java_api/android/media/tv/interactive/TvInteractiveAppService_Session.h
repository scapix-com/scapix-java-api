...
public:
	...
	void requestScheduleRecording(jni::ref<java::lang::String> requestId, jni::ref<java::lang::String> inputId, jni::ref<android::net::Uri> channelUri, jlong startTime, jlong p5, jint duration, jni::ref<android::os::Bundle> p7) { return call_method<"requestScheduleRecording", void>(requestId, inputId, channelUri, startTime, p5, duration, p7); }
