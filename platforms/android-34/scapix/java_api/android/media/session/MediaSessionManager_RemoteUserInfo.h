...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_SESSION_MEDIASESSIONMANAGER_REMOTEUSERINFO
...
public:
	...
	static jni::ref<android::media::session::MediaSessionManager_RemoteUserInfo> new_object(jni::ref<java::lang::String> packageName, jint pid, jint uid) { return object_base::new_object(packageName, pid, uid); }
