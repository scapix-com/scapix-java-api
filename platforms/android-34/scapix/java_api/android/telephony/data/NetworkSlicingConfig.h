...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_DATA_NETWORKSLICINGCONFIG
...
public:
	...
	static jni::ref<android::telephony::data::NetworkSlicingConfig> new_object() { return object_base::new_object(); }
