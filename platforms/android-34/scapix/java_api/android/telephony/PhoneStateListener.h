...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_PHONESTATELISTENER
...
public:
	...
	static jni::ref<android::telephony::PhoneStateListener> new_object() { return object_base::new_object(); }
	static jni::ref<android::telephony::PhoneStateListener> new_object(jni::ref<java::util::concurrent::Executor> executor) { return object_base::new_object(executor); }
