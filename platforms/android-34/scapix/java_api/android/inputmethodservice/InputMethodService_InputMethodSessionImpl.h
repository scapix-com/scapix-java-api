...
public:
	...
	static jni::ref<android::inputmethodservice::InputMethodService_InputMethodSessionImpl> new_object(jni::ref<android::inputmethodservice::InputMethodService> this_0) { return base_::new_object(this_0); }
