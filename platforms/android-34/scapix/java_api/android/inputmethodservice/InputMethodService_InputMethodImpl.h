...
class InputMethodService_InputMethodImpl;
...
#ifndef SCAPIX_JAVA_API_ANDROID_INPUTMETHODSERVICE_INPUTMETHODSERVICE_INPUTMETHODIMPL
...
public:
	...
	static jni::ref<android::inputmethodservice::InputMethodService_InputMethodImpl> new_object(jni::ref<android::inputmethodservice::InputMethodService> this_0) { return object_base::new_object(this_0); }
	...
	void startInput(jni::ref<android::view::inputmethod::InputConnection> ic, jni::ref<android::view::inputmethod::EditorInfo> editorInfo) { return call_method<"startInput", void>(ic, editorInfo); }
	void restartInput(jni::ref<android::view::inputmethod::InputConnection> ic, jni::ref<android::view::inputmethod::EditorInfo> editorInfo) { return call_method<"restartInput", void>(ic, editorInfo); }
