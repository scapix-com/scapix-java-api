...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_IDENTITY_CREDENTIALDATARESULT
...
public:
	...
	jni::ref<jni::array<jbyte>> getDeviceSignature() { return call_method<"getDeviceSignature", jni::ref<jni::array<jbyte>>>(); }
