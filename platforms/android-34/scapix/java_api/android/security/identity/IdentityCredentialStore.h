...
#ifndef SCAPIX_JAVA_API_ANDROID_SECURITY_IDENTITY_IDENTITYCREDENTIALSTORE
...
public:
	...
	jni::ref<android::security::identity::PresentationSession> createPresentationSession(jint cipherSuite) { return call_method<"createPresentationSession", jni::ref<android::security::identity::PresentationSession>>(cipherSuite); }
};
