...
public:
	...
	void set(jint type, jlong triggerAtMillis, jni::ref<java::lang::String> p3, jni::ref<android::app::AlarmManager_OnAlarmListener> tag, jni::ref<android::os::Handler> listener) { return call_method<"set", void>(type, triggerAtMillis, p3, tag, listener); }
	...
	void setWindow(jint type, jlong windowStartMillis, jlong p3, jni::ref<java::lang::String> windowLengthMillis, jni::ref<android::app::AlarmManager_OnAlarmListener> p5, jni::ref<android::os::Handler> tag) { return call_method<"setWindow", void>(type, windowStartMillis, p3, windowLengthMillis, p5, tag); }
	void setWindow(jint type, jlong windowStartMillis, jlong p3, jni::ref<java::lang::String> windowLengthMillis, jni::ref<java::util::concurrent::Executor> p5, jni::ref<android::app::AlarmManager_OnAlarmListener> tag) { return call_method<"setWindow", void>(type, windowStartMillis, p3, windowLengthMillis, p5, tag); }
	...
	void setExact(jint type, jlong triggerAtMillis, jni::ref<java::lang::String> p3, jni::ref<android::app::AlarmManager_OnAlarmListener> tag, jni::ref<android::os::Handler> listener) { return call_method<"setExact", void>(type, triggerAtMillis, p3, tag, listener); }
