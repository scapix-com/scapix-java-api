...
public:
	...
	static jni::ref<android::app::NotificationManager_Policy> new_object(jint priorityCategories, jint priorityCallSenders, jint priorityMessageSenders, jint suppressedVisualEffects, jint priorityConversationSenders) { return base_::new_object(priorityCategories, priorityCallSenders, priorityMessageSenders, suppressedVisualEffects, priorityConversationSenders); }
