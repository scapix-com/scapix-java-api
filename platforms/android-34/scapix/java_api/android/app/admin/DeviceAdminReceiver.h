...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ADMIN_DEVICEADMINRECEIVER
...
public:
	...
	static jni::ref<android::app::admin::DeviceAdminReceiver> new_object() { return object_base::new_object(); }
	...
	void onNetworkLogsAvailable(jni::ref<android::content::Context> context, jni::ref<android::content::Intent> intent, jlong batchToken, jint networkLogsCount) { return call_method<"onNetworkLogsAvailable", void>(context, intent, batchToken, networkLogsCount); }
