...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SLICE_SLICEMETRICS
...
public:
	...
	static jni::ref<android::app::slice::SliceMetrics> new_object(jni::ref<android::content::Context> context, jni::ref<android::net::Uri> uri) { return object_base::new_object(context, uri); }
