...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_REMOTEINPUT_BUILDER
...
public:
	...
	static jni::ref<android::app::RemoteInput_Builder> new_object(jni::ref<java::lang::String> resultKey) { return object_base::new_object(resultKey); }
