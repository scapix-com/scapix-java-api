...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_FOREGROUNDSERVICESTARTNOTALLOWEDEXCEPTION
...
public:
	...
	static jni::ref<android::app::ForegroundServiceStartNotAllowedException> new_object(jni::ref<java::lang::String> message) { return object_base::new_object(message); }
