...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_SYNCNOTEDAPPOP
...
public:
	...
	static jni::ref<android::app::SyncNotedAppOp> new_object(jint opCode, jni::ref<java::lang::String> attributionTag) { return object_base::new_object(opCode, attributionTag); }
