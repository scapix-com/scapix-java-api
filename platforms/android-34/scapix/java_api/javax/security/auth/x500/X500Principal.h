...
public:
	...
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::lang::String> name, jni::ref<java::util::Map> keywordMap) { return object_base::new_object(name, keywordMap); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<jni::array<jbyte>> name) { return object_base::new_object(name); }
	static jni::ref<javax::security::auth::x500::X500Principal> new_object(jni::ref<java::io::InputStream> is) { return object_base::new_object(is); }
