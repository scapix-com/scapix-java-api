...
public:
	...
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::net::InetAddress> addr, jint port) { return base_::new_object(addr, port); }
	static jni::ref<java::net::InetSocketAddress> new_object(jni::ref<java::lang::String> hostname, jint port) { return base_::new_object(hostname, port); }
