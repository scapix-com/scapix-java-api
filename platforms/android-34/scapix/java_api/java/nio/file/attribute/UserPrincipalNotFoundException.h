...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_ATTRIBUTE_USERPRINCIPALNOTFOUNDEXCEPTION
...
public:
	...
	static jni::ref<java::nio::file::attribute::UserPrincipalNotFoundException> new_object(jni::ref<java::lang::String> name) { return object_base::new_object(name); }
