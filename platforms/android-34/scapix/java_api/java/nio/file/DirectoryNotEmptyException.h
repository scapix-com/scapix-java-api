...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_DIRECTORYNOTEMPTYEXCEPTION
...
public:
	...
	static jni::ref<java::nio::file::DirectoryNotEmptyException> new_object(jni::ref<java::lang::String> dir) { return object_base::new_object(dir); }
};
