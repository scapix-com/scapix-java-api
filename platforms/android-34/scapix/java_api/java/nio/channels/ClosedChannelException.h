...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_CHANNELS_CLOSEDCHANNELEXCEPTION
...
public:
	...
	static jni::ref<java::nio::channels::ClosedChannelException> new_object() { return object_base::new_object(); }
};
