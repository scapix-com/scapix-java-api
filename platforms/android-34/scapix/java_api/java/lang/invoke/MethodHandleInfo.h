...
#ifndef SCAPIX_JAVA_API_JAVA_LANG_INVOKE_METHODHANDLEINFO
...
public:
	...
	static jni::ref<java::lang::String> referenceKindToString(jint referenceKind) { return call_static_method<"referenceKindToString", jni::ref<java::lang::String>>(referenceKind); }
	static jni::ref<java::lang::String> toString(jint kind, jni::ref<java::lang::Class> defc, jni::ref<java::lang::String> name, jni::ref<java::lang::invoke::MethodType> type) { return call_static_method<"toString", jni::ref<java::lang::String>>(kind, defc, name, type); }
	static jboolean refKindIsValid(jint refKind) { return call_static_method<"refKindIsValid", jboolean>(refKind); }
	static jboolean refKindIsField(jint refKind) { return call_static_method<"refKindIsField", jboolean>(refKind); }
