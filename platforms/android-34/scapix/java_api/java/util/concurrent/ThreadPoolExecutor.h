...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_THREADPOOLEXECUTOR
...
public:
	...
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint corePoolSize, jint maximumPoolSize, jlong keepAliveTime, jni::ref<java::util::concurrent::TimeUnit> unit, jni::ref<java::util::concurrent::BlockingQueue> workQueue) { return object_base::new_object(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue); }
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint corePoolSize, jint maximumPoolSize, jlong keepAliveTime, jni::ref<java::util::concurrent::TimeUnit> unit, jni::ref<java::util::concurrent::BlockingQueue> workQueue, jni::ref<java::util::concurrent::ThreadFactory> threadFactory) { return object_base::new_object(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, threadFactory); }
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint corePoolSize, jint maximumPoolSize, jlong keepAliveTime, jni::ref<java::util::concurrent::TimeUnit> unit, jni::ref<java::util::concurrent::BlockingQueue> workQueue, jni::ref<java::util::concurrent::RejectedExecutionHandler> handler) { return object_base::new_object(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, handler); }
	static jni::ref<java::util::concurrent::ThreadPoolExecutor> new_object(jint corePoolSize, jint maximumPoolSize, jlong keepAliveTime, jni::ref<java::util::concurrent::TimeUnit> unit, jni::ref<java::util::concurrent::BlockingQueue> workQueue, jni::ref<java::util::concurrent::ThreadFactory> threadFactory, jni::ref<java::util::concurrent::RejectedExecutionHandler> handler) { return object_base::new_object(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, threadFactory, handler); }
	...
	void setKeepAliveTime(jlong time, jni::ref<java::util::concurrent::TimeUnit> unit) { return call_method<"setKeepAliveTime", void>(time, unit); }
