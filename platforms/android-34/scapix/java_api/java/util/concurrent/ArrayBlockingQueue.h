...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ARRAYBLOCKINGQUEUE
...
public:
	...
	static jni::ref<java::util::concurrent::ArrayBlockingQueue> new_object(jint capacity) { return object_base::new_object(capacity); }
	static jni::ref<java::util::concurrent::ArrayBlockingQueue> new_object(jint capacity, jboolean fair) { return object_base::new_object(capacity, fair); }
	static jni::ref<java::util::concurrent::ArrayBlockingQueue> new_object(jint capacity, jboolean fair, jni::ref<java::util::Collection> c) { return object_base::new_object(capacity, fair, c); }
