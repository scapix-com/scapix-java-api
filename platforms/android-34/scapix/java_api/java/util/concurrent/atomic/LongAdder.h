...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_CONCURRENT_ATOMIC_LONGADDER
...
public:
	...
	static jni::ref<java::util::concurrent::atomic::LongAdder> new_object() { return object_base::new_object(); }
