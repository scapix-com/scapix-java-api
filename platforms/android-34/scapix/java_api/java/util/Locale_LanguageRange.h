...
public:
	...
	static jni::ref<java::util::Locale_LanguageRange> new_object(jni::ref<java::lang::String> range) { return base_::new_object(range); }
	static jni::ref<java::util::Locale_LanguageRange> new_object(jni::ref<java::lang::String> range, jdouble weight) { return base_::new_object(range, weight); }
