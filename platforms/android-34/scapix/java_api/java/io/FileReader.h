...
public:
	...
	static jni::ref<java::io::FileReader> new_object(jni::ref<java::lang::String> fileName, jni::ref<java::nio::charset::Charset> charset) { return base_::new_object(fileName, charset); }
	static jni::ref<java::io::FileReader> new_object(jni::ref<java::io::File> file, jni::ref<java::nio::charset::Charset> charset) { return base_::new_object(file, charset); }
