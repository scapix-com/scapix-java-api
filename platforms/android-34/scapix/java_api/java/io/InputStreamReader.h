...
public:
	...
	static jni::ref<java::io::InputStreamReader> new_object(jni::ref<java::io::InputStream> in, jni::ref<java::nio::charset::Charset> cs) { return object_base::new_object(in, cs); }
