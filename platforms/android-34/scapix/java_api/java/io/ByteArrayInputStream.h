...
#ifndef SCAPIX_JAVA_API_JAVA_IO_BYTEARRAYINPUTSTREAM
...
public:
	...
	static jni::ref<java::io::ByteArrayInputStream> new_object(jni::ref<jni::array<jbyte>> buf) { return object_base::new_object(buf); }
	static jni::ref<java::io::ByteArrayInputStream> new_object(jni::ref<jni::array<jbyte>> buf, jint offset, jint length) { return object_base::new_object(buf, offset, length); }
