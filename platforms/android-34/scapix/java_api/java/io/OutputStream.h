...
#ifndef SCAPIX_JAVA_API_JAVA_IO_OUTPUTSTREAM
...
public:
	...
	static jni::ref<java::io::OutputStream> new_object() { return object_base::new_object(); }
	static jni::ref<java::io::OutputStream> nullOutputStream() { return call_static_method<"nullOutputStream", jni::ref<java::io::OutputStream>>(); }
