...
#ifndef SCAPIX_JAVA_API_ORG_XML_SAX_EXT_LOCATOR2IMPL
...
public:
	...
	static jni::ref<org::xml::sax::ext::Locator2Impl> new_object() { return object_base::new_object(); }
	static jni::ref<org::xml::sax::ext::Locator2Impl> new_object(jni::ref<org::xml::sax::Locator> locator) { return object_base::new_object(locator); }
	...
	void setXMLVersion(jni::ref<java::lang::String> version) { return call_method<"setXMLVersion", void>(version); }
