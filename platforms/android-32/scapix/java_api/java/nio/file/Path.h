...
#ifndef SCAPIX_JAVA_API_JAVA_NIO_FILE_PATH
...
public:
	...
	jni::ref<java::nio::file::Path> resolve(jni::ref<java::lang::String> p1) { return call_method<"resolve", jni::ref<java::nio::file::Path>>(p1); }
	jni::ref<java::nio::file::Path> resolveSibling(jni::ref<java::nio::file::Path> p1) { return call_method<"resolveSibling", jni::ref<java::nio::file::Path>>(p1); }
	jni::ref<java::nio::file::Path> resolveSibling(jni::ref<java::lang::String> p1) { return call_method<"resolveSibling", jni::ref<java::nio::file::Path>>(p1); }
