...
public:
	...
	static jni::ref<java::beans::PropertyChangeListenerProxy> new_object(jni::ref<java::lang::String> propertyName, jni::ref<java::beans::PropertyChangeListener> listener) { return base_::new_object(propertyName, listener); }
