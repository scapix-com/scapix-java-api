...
public:
	...
	static jni::ref<java::security::DigestOutputStream> new_object(jni::ref<java::io::OutputStream> stream, jni::ref<java::security::MessageDigest> digest) { return base_::new_object(stream, digest); }
