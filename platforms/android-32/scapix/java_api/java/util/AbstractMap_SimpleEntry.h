...
public:
	...
	static jni::ref<java::util::AbstractMap_SimpleEntry> new_object(jni::ref<java::lang::Object> key, jni::ref<java::lang::Object> value) { return object_base::new_object(key, value); }
	static jni::ref<java::util::AbstractMap_SimpleEntry> new_object(jni::ref<java::util::Map_Entry> entry) { return object_base::new_object(entry); }
