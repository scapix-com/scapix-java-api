...
public:
	...
	static jni::ref<java::util::prefs::PreferenceChangeEvent> new_object(jni::ref<java::util::prefs::Preferences> node, jni::ref<java::lang::String> key, jni::ref<java::lang::String> newValue) { return base_::new_object(node, key, newValue); }
