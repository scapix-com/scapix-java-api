...
#ifndef SCAPIX_JAVA_API_JAVA_UTIL_PREFS_PREFERENCECHANGEEVENT
...
public:
	...
	static jni::ref<java::util::prefs::PreferenceChangeEvent> new_object(jni::ref<java::util::prefs::Preferences> node, jni::ref<java::lang::String> key, jni::ref<java::lang::String> newValue) { return object_base::new_object(node, key, newValue); }
