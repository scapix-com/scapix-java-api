...
public:
	...
	static jni::ref<java::util::concurrent::atomic::AtomicReference> new_object(jni::ref<java::lang::Object> initialValue) { return object_base::new_object(initialValue); }
	...
	jboolean compareAndSet(jni::ref<java::lang::Object> expect, jni::ref<java::lang::Object> update) { return call_method<"compareAndSet", jboolean>(expect, update); }
	jboolean weakCompareAndSet(jni::ref<java::lang::Object> expect, jni::ref<java::lang::Object> update) { return call_method<"weakCompareAndSet", jboolean>(expect, update); }
