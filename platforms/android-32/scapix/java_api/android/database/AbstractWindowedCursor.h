...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_ABSTRACTWINDOWEDCURSOR
...
public:
	...
	static jni::ref<android::database::AbstractWindowedCursor> new_object() { return object_base::new_object(); }
