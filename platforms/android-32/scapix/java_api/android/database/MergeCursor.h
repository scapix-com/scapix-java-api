...
#ifndef SCAPIX_JAVA_API_ANDROID_DATABASE_MERGECURSOR
...
public:
	...
	static jni::ref<android::database::MergeCursor> new_object(jni::ref<jni::array<android::database::Cursor>> cursors) { return object_base::new_object(cursors); }
