...
#ifndef SCAPIX_JAVA_API_ANDROID_TEXT_STYLE_LINEHEIGHTSPAN_STANDARD
...
public:
	...
	static jni::ref<android::text::style::LineHeightSpan_Standard> new_object(jint height) { return object_base::new_object(height); }
	static jni::ref<android::text::style::LineHeightSpan_Standard> new_object(jni::ref<android::os::Parcel> src) { return object_base::new_object(src); }
