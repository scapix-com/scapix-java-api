...
#ifndef SCAPIX_JAVA_API_ANDROID_OS_BINDER
...
public:
	...
	static jni::ref<android::os::Binder> new_object() { return object_base::new_object(); }
	static jni::ref<android::os::Binder> new_object(jni::ref<java::lang::String> descriptor) { return object_base::new_object(descriptor); }
	...
	static jint getCallingUidOrThrow() { return call_static_method<"getCallingUidOrThrow", jint>(); }
	...
	static jlong setCallingWorkSourceUid(jint p1) { return call_static_method<"setCallingWorkSourceUid", jlong>(p1); }
	static jint getCallingWorkSourceUid() { return call_static_method<"getCallingWorkSourceUid", jint>(); }
	static jlong clearCallingWorkSource() { return call_static_method<"clearCallingWorkSource", jlong>(); }
	static void restoreCallingWorkSource(jlong p1) { return call_static_method<"restoreCallingWorkSource", void>(p1); }
