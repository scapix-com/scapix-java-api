...
#ifndef SCAPIX_JAVA_API_ANDROID_WEBKIT_WEBVIEWDATABASE
...
public:
	...
	static jni::ref<android::webkit::WebViewDatabase> new_object() { return object_base::new_object(); }
	...
	void setHttpAuthUsernamePassword(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2, jni::ref<java::lang::String> p3, jni::ref<java::lang::String> p4) { return call_method<"setHttpAuthUsernamePassword", void>(p1, p2, p3, p4); }
	jni::ref<jni::array<java::lang::String>> getHttpAuthUsernamePassword(jni::ref<java::lang::String> p1, jni::ref<java::lang::String> p2) { return call_method<"getHttpAuthUsernamePassword", jni::ref<jni::array<java::lang::String>>>(p1, p2); }
