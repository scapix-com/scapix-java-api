...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_TTS_SYNTHESISREQUEST
...
public:
	...
	static jni::ref<android::speech::tts::SynthesisRequest> new_object(jni::ref<java::lang::String> text, jni::ref<android::os::Bundle> params) { return object_base::new_object(text, params); }
	static jni::ref<android::speech::tts::SynthesisRequest> new_object(jni::ref<java::lang::CharSequence> text, jni::ref<android::os::Bundle> params) { return object_base::new_object(text, params); }
