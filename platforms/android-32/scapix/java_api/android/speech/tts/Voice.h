...
#ifndef SCAPIX_JAVA_API_ANDROID_SPEECH_TTS_VOICE
...
public:
	...
	static jni::ref<android::speech::tts::Voice> new_object(jni::ref<java::lang::String> name, jni::ref<java::util::Locale> locale, jint quality, jint latency, jboolean requiresNetworkConnection, jni::ref<java::util::Set> features) { return object_base::new_object(name, locale, quality, latency, requiresNetworkConnection, features); }
