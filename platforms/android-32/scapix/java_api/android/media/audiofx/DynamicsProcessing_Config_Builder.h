...
class DynamicsProcessing_Config_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_MEDIA_AUDIOFX_DYNAMICSPROCESSING_CONFIG_BUILDER
...
public:
	...
	static jni::ref<android::media::audiofx::DynamicsProcessing_Config_Builder> new_object(jint variant, jint channelCount, jboolean preEqInUse, jint preEqBandCount, jboolean mbcInUse, jint mbcBandCount, jboolean postEqInUse, jint postEqBandCount, jboolean limiterInUse) { return object_base::new_object(variant, channelCount, preEqInUse, preEqBandCount, mbcInUse, mbcBandCount, postEqInUse, postEqBandCount, limiterInUse); }
