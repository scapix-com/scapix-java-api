...
#ifndef SCAPIX_JAVA_API_ANDROID_TELECOM_REMOTECONNECTION_CALLBACK
...
public:
	...
	static jni::ref<android::telecom::RemoteConnection_Callback> new_object() { return object_base::new_object(); }
	...
	void onConnectionPropertiesChanged(jni::ref<android::telecom::RemoteConnection> connection, jint connectionProperties) { return call_method<"onConnectionPropertiesChanged", void>(connection, connectionProperties); }
	...
	void onConnectionEvent(jni::ref<android::telecom::RemoteConnection> connection, jni::ref<java::lang::String> event, jni::ref<android::os::Bundle> extras) { return call_method<"onConnectionEvent", void>(connection, event, extras); }
};
