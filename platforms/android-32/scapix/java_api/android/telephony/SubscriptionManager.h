...
#ifndef SCAPIX_JAVA_API_ANDROID_TELEPHONY_SUBSCRIPTIONMANAGER
...
public:
	...
	void setSubscriptionOverrideUnmetered(jint subId, jboolean overrideUnmetered, jlong timeoutMillis) { return call_method<"setSubscriptionOverrideUnmetered", void>(subId, overrideUnmetered, timeoutMillis); }
	void setSubscriptionOverrideUnmetered(jint subId, jboolean overrideUnmetered, jni::ref<jni::array<jint>> networkTypes, jlong timeoutMillis) { return call_method<"setSubscriptionOverrideUnmetered", void>(subId, overrideUnmetered, networkTypes, timeoutMillis); }
	void setSubscriptionOverrideCongested(jint subId, jboolean overrideCongested, jlong timeoutMillis) { return call_method<"setSubscriptionOverrideCongested", void>(subId, overrideCongested, timeoutMillis); }
	void setSubscriptionOverrideCongested(jint subId, jboolean overrideCongested, jni::ref<jni::array<jint>> networkTypes, jlong timeoutMillis) { return call_method<"setSubscriptionOverrideCongested", void>(subId, overrideCongested, networkTypes, timeoutMillis); }
