...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_SIMPLEADAPTER
...
public:
	...
	static jni::ref<android::widget::SimpleAdapter> new_object(jni::ref<android::content::Context> context, jni::ref<java::util::List> data, jint resource, jni::ref<jni::array<java::lang::String>> from, jni::ref<jni::array<jint>> to) { return object_base::new_object(context, data, resource, from, to); }
