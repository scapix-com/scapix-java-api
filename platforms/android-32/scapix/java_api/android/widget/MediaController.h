...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_MEDIACONTROLLER
...
public:
	...
	static jni::ref<android::widget::MediaController> new_object(jni::ref<android::content::Context> context, jni::ref<android::util::AttributeSet> attrs) { return object_base::new_object(context, attrs); }
	static jni::ref<android::widget::MediaController> new_object(jni::ref<android::content::Context> context, jboolean useFastForward) { return object_base::new_object(context, useFastForward); }
	static jni::ref<android::widget::MediaController> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
