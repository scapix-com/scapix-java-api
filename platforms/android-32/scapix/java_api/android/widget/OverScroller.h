...
#ifndef SCAPIX_JAVA_API_ANDROID_WIDGET_OVERSCROLLER
...
public:
	...
	static jni::ref<android::widget::OverScroller> new_object(jni::ref<android::content::Context> context) { return object_base::new_object(context); }
	static jni::ref<android::widget::OverScroller> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::animation::Interpolator> interpolator) { return object_base::new_object(context, interpolator); }
	static jni::ref<android::widget::OverScroller> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::animation::Interpolator> interpolator, jfloat bounceCoefficientX, jfloat bounceCoefficientY) { return object_base::new_object(context, interpolator, bounceCoefficientX, bounceCoefficientY); }
	static jni::ref<android::widget::OverScroller> new_object(jni::ref<android::content::Context> context, jni::ref<android::view::animation::Interpolator> interpolator, jfloat bounceCoefficientX, jfloat bounceCoefficientY, jboolean flywheel) { return object_base::new_object(context, interpolator, bounceCoefficientX, bounceCoefficientY, flywheel); }
