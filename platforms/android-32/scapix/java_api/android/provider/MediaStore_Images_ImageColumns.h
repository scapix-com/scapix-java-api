...
class MediaStore_Images_ImageColumns;
...
#ifndef SCAPIX_JAVA_API_ANDROID_PROVIDER_MEDIASTORE_IMAGES_IMAGECOLUMNS
...
public:
	...
	static jni::ref<java::lang::String> EXPOSURE_TIME() { return get_static_field<"EXPOSURE_TIME", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> F_NUMBER() { return get_static_field<"F_NUMBER", jni::ref<java::lang::String>>(); }
	static jni::ref<java::lang::String> ISO() { return get_static_field<"ISO", jni::ref<java::lang::String>>(); }
	...
	static jni::ref<java::lang::String> SCENE_CAPTURE_TYPE() { return get_static_field<"SCENE_CAPTURE_TYPE", jni::ref<java::lang::String>>(); }
};
