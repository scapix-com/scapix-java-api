...
class ViewTranslationResponse_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_TRANSLATION_VIEWTRANSLATIONRESPONSE_BUILDER
...
public:
	...
	static jni::ref<android::view::translation::ViewTranslationResponse_Builder> new_object(jni::ref<android::view::autofill::AutofillId> autofillId) { return object_base::new_object(autofillId); }
