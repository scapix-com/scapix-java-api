...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_CONTENTINFO_BUILDER
...
public:
	...
	static jni::ref<android::view::ContentInfo_Builder> new_object(jni::ref<android::view::ContentInfo> other) { return object_base::new_object(other); }
	static jni::ref<android::view::ContentInfo_Builder> new_object(jni::ref<android::content::ClipData> clip, jint source) { return object_base::new_object(clip, source); }
