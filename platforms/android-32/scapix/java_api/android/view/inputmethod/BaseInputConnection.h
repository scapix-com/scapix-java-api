...
#ifndef SCAPIX_JAVA_API_ANDROID_VIEW_INPUTMETHOD_BASEINPUTCONNECTION
...
public:
	...
	static jni::ref<android::view::inputmethod::BaseInputConnection> new_object(jni::ref<android::view::View> targetView, jboolean fullEditor) { return object_base::new_object(targetView, fullEditor); }
