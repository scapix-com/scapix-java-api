...
#ifndef SCAPIX_JAVA_API_ANDROID_DRM_DRMCONVERTEDSTATUS
...
public:
	...
	static jni::ref<android::drm::DrmConvertedStatus> new_object(jint statusCode, jni::ref<jni::array<jbyte>> convertedData, jint offset) { return object_base::new_object(statusCode, convertedData, offset); }
};
