...
public:
	...
	jlong getPartialObject(jint objectHandle, jlong offset, jlong p3, jni::ref<jni::array<jbyte>> size) { return call_method<"getPartialObject", jlong>(objectHandle, offset, p3, size); }
	jlong getPartialObject64(jint objectHandle, jlong offset, jlong p3, jni::ref<jni::array<jbyte>> size) { return call_method<"getPartialObject64", jlong>(objectHandle, offset, p3, size); }
	...
	jboolean sendObject(jint objectHandle, jlong size, jni::ref<android::os::ParcelFileDescriptor> p3) { return call_method<"sendObject", jboolean>(objectHandle, size, p3); }
