...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_MATRIX
...
public:
	...
	static jni::ref<android::graphics::Matrix> IDENTITY_MATRIX() { return get_static_field<"IDENTITY_MATRIX", jni::ref<android::graphics::Matrix>>(); }
	...
	static jni::ref<android::graphics::Matrix> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::Matrix> new_object(jni::ref<android::graphics::Matrix> src) { return object_base::new_object(src); }
