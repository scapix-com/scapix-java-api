...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_BITMAPREGIONDECODER
...
public:
	...
	static jni::ref<android::graphics::BitmapRegionDecoder> newInstance(jni::ref<jni::array<jbyte>> data, jint offset, jint length) { return call_static_method<"newInstance", jni::ref<android::graphics::BitmapRegionDecoder>>(data, offset, length); }
	...
	static jni::ref<android::graphics::BitmapRegionDecoder> newInstance(jni::ref<android::os::ParcelFileDescriptor> pfd) { return call_static_method<"newInstance", jni::ref<android::graphics::BitmapRegionDecoder>>(pfd); }
	...
	static jni::ref<android::graphics::BitmapRegionDecoder> newInstance(jni::ref<java::io::InputStream> is) { return call_static_method<"newInstance", jni::ref<android::graphics::BitmapRegionDecoder>>(is); }
	...
	static jni::ref<android::graphics::BitmapRegionDecoder> newInstance(jni::ref<java::lang::String> pathName) { return call_static_method<"newInstance", jni::ref<android::graphics::BitmapRegionDecoder>>(pathName); }
