...
#ifndef SCAPIX_JAVA_API_ANDROID_GRAPHICS_POINT
...
public:
	...
	static jni::ref<android::graphics::Point> new_object() { return object_base::new_object(); }
	static jni::ref<android::graphics::Point> new_object(jint x, jint y) { return object_base::new_object(x, y); }
	static jni::ref<android::graphics::Point> new_object(jni::ref<android::graphics::Point> src) { return object_base::new_object(src); }
