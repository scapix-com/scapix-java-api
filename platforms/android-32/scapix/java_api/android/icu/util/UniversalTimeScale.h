...
#ifndef SCAPIX_JAVA_API_ANDROID_ICU_UTIL_UNIVERSALTIMESCALE
...
public:
	...
	static jlong from(jlong otherTime, jint timeScale) { return call_static_method<"from", jlong>(otherTime, timeScale); }
	static jni::ref<android::icu::math::BigDecimal> bigDecimalFrom(jdouble otherTime, jint timeScale) { return call_static_method<"bigDecimalFrom", jni::ref<android::icu::math::BigDecimal>>(otherTime, timeScale); }
	static jni::ref<android::icu::math::BigDecimal> bigDecimalFrom(jlong otherTime, jint timeScale) { return call_static_method<"bigDecimalFrom", jni::ref<android::icu::math::BigDecimal>>(otherTime, timeScale); }
	...
	static jlong toLong(jlong universalTime, jint timeScale) { return call_static_method<"toLong", jlong>(universalTime, timeScale); }
	static jni::ref<android::icu::math::BigDecimal> toBigDecimal(jlong universalTime, jint timeScale) { return call_static_method<"toBigDecimal", jni::ref<android::icu::math::BigDecimal>>(universalTime, timeScale); }
