...
#ifndef SCAPIX_JAVA_API_ANDROID_HARDWARE_CAMERA2_CAMERAEXTENSIONSESSION_STATECALLBACK
...
public:
	...
	static jni::ref<android::hardware::camera2::CameraExtensionSession_StateCallback> new_object() { return object_base::new_object(); }
