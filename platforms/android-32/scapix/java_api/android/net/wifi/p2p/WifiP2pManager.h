...
public:
	...
	void createGroup(jni::ref<android::net::wifi::p2p::WifiP2pManager_Channel> c, jni::ref<android::net::wifi::p2p::WifiP2pConfig> config, jni::ref<android::net::wifi::p2p::WifiP2pManager_ActionListener> listener) { return call_method<"createGroup", void>(c, config, listener); }
