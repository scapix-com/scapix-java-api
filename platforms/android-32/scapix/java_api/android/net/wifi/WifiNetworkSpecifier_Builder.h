...
class WifiNetworkSpecifier_Builder;
...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_WIFI_WIFINETWORKSPECIFIER_BUILDER
...
public:
	...
	static jni::ref<android::net::wifi::WifiNetworkSpecifier_Builder> new_object() { return object_base::new_object(); }
