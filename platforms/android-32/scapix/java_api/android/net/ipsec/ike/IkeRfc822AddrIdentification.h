...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_IKERFC822ADDRIDENTIFICATION
...
public:
	...
	static jni::ref<android::net::ipsec::ike::IkeRfc822AddrIdentification> new_object(jni::ref<java::lang::String> rfc822Name) { return object_base::new_object(rfc822Name); }
