...
#ifndef SCAPIX_JAVA_API_ANDROID_NET_IPSEC_IKE_EXCEPTIONS_INVALIDKEEXCEPTION
...
public:
	...
	static jni::ref<android::net::ipsec::ike::exceptions::InvalidKeException> new_object(jint dhGroup) { return object_base::new_object(dhGroup); }
