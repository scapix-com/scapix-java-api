...
#ifndef SCAPIX_JAVA_API_ANDROID_UTIL_JSONWRITER
...
public:
	...
	static jni::ref<android::util::JsonWriter> new_object(jni::ref<java::io::Writer> out) { return object_base::new_object(out); }
