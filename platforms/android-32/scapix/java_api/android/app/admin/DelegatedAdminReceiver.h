...
#ifndef SCAPIX_JAVA_API_ANDROID_APP_ADMIN_DELEGATEDADMINRECEIVER
...
public:
	...
	static jni::ref<android::app::admin::DelegatedAdminReceiver> new_object() { return object_base::new_object(); }
